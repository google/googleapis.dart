...
buildCreateProfileRequest() {
  ...
  if (buildCounterCreateProfileRequest < 3) {
    ...
    o.profileType = buildUnnamed3386();
  }
  buildCounterCreateProfileRequest--;
  return o;
}
...
checkCreateProfileRequest(api.CreateProfileRequest o) {
  ...
  if (buildCounterCreateProfileRequest < 3) {
    ...
    checkUnnamed3386(o.profileType);
  }
  buildCounterCreateProfileRequest--;
}
...
checkUnnamed3387(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3388(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
