...
checkUnnamed284(core.List<api.Assignment> o) {
...
checkUnnamed285(core.List<api.CapacityCommitment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListCapacityCommitmentsResponse() {
  ...
  if (buildCounterListCapacityCommitmentsResponse < 3) {
    o.capacityCommitments = buildUnnamed285();
    o.nextPageToken = "foo";
  }
  buildCounterListCapacityCommitmentsResponse--;
  return o;
...
checkListCapacityCommitmentsResponse(api.ListCapacityCommitmentsResponse o) {
  buildCounterListCapacityCommitmentsResponse++;
  if (buildCounterListCapacityCommitmentsResponse < 3) {
    checkUnnamed285(o.capacityCommitments);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListCapacityCommitmentsResponse--;
}
...
checkUnnamed286(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkUnnamed287(core.List<api.Reservation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListReservationsResponse() {
  ...
  if (buildCounterListReservationsResponse < 3) {
    o.nextPageToken = "foo";
    o.reservations = buildUnnamed287();
  }
  buildCounterListReservationsResponse--;
  return o;
}
...
checkListReservationsResponse(api.ListReservationsResponse o) {
  ...
  if (buildCounterListReservationsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed287(o.reservations);
  }
  buildCounterListReservationsResponse--;
}
...
buildMergeCapacityCommitmentsRequest() {
  ...
  if (buildCounterMergeCapacityCommitmentsRequest < 3) {
    o.capacityCommitmentIds = buildUnnamed288();
  }
  buildCounterMergeCapacityCommitmentsRequest--;
  return o;
}
...
checkMergeCapacityCommitmentsRequest(api.MergeCapacityCommitmentsRequest o) {
  buildCounterMergeCapacityCommitmentsRequest++;
  if (buildCounterMergeCapacityCommitmentsRequest < 3) {
    checkUnnamed288(o.capacityCommitmentIds);
  }
  buildCounterMergeCapacityCommitmentsRequest--;
}
...
checkUnnamed289(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed290(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed289();
    o.name = "foo";
    o.response = buildUnnamed290();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed289(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed290(o.response);
  }
  buildCounterOperation--;
}
...
checkUnnamed291(core.List<api.Assignment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAssignment(o[0]);
  checkAssignment(o[1]);
}
...
checkUnnamed292(core.List<api.Assignment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAssignment(o[0]);
  checkAssignment(o[1]);
}
