...
core.List<api.Assignment> buildUnnamed4389() {
  var o = <api.Assignment>[];
...
void checkUnnamed4389(core.List<api.Assignment> o) {
...
api.ListAssignmentsResponse buildListAssignmentsResponse() {
  ...
  if (buildCounterListAssignmentsResponse < 3) {
    o.assignments = buildUnnamed4389();
    o.nextPageToken = 'foo';
  }
  buildCounterListAssignmentsResponse--;
  return o;
...
void checkListAssignmentsResponse(api.ListAssignmentsResponse o) {
  buildCounterListAssignmentsResponse++;
  if (buildCounterListAssignmentsResponse < 3) {
    checkUnnamed4389(o.assignments);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListAssignmentsResponse--;
}

core.List<api.CapacityCommitment> buildUnnamed4390() {
  var o = <api.CapacityCommitment>[];
...
void checkUnnamed4390(core.List<api.CapacityCommitment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListCapacityCommitmentsResponse buildListCapacityCommitmentsResponse() {
  ...
  if (buildCounterListCapacityCommitmentsResponse < 3) {
    o.capacityCommitments = buildUnnamed4390();
    o.nextPageToken = 'foo';
  }
  buildCounterListCapacityCommitmentsResponse--;
  return o;
...
void checkListCapacityCommitmentsResponse(
  ...
  buildCounterListCapacityCommitmentsResponse++;
  if (buildCounterListCapacityCommitmentsResponse < 3) {
    checkUnnamed4390(o.capacityCommitments);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListCapacityCommitmentsResponse--;
}

core.List<api.Operation> buildUnnamed4391() {
  var o = <api.Operation>[];
...
void checkUnnamed4391(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListOperationsResponse(api.ListOperationsResponse o) {
  ...
  if (buildCounterListOperationsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4391(o.operations);
  }
  buildCounterListOperationsResponse--;
}

core.List<api.Reservation> buildUnnamed4392() {
...
void checkUnnamed4392(core.List<api.Reservation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListReservationsResponse buildListReservationsResponse() {
  ...
  if (buildCounterListReservationsResponse < 3) {
    o.nextPageToken = 'foo';
    o.reservations = buildUnnamed4392();
  }
  buildCounterListReservationsResponse--;
  return o;
}
...
void checkListReservationsResponse(api.ListReservationsResponse o) {
  ...
  if (buildCounterListReservationsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4392(o.reservations);
  }
  buildCounterListReservationsResponse--;
}
...
api.MergeCapacityCommitmentsRequest buildMergeCapacityCommitmentsRequest() {
  ...
  if (buildCounterMergeCapacityCommitmentsRequest < 3) {
    o.capacityCommitmentIds = buildUnnamed4393();
  }
  buildCounterMergeCapacityCommitmentsRequest--;
  return o;
}
...
void checkMergeCapacityCommitmentsRequest(
  ...
  buildCounterMergeCapacityCommitmentsRequest++;
  if (buildCounterMergeCapacityCommitmentsRequest < 3) {
    checkUnnamed4393(o.capacityCommitmentIds);
  }
  buildCounterMergeCapacityCommitmentsRequest--;
}
...
core.Map<core.String, core.Object> buildUnnamed4394() {
...
void checkUnnamed4394(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed4395() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed4395(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed4394();
    o.name = 'foo';
    o.response = buildUnnamed4395();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkUnnamed4394(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed4395(o.response);
  }
  buildCounterOperation--;
}
...
core.List<api.Assignment> buildUnnamed4396() {
  var o = <api.Assignment>[];
  o.add(buildAssignment());
  o.add(buildAssignment());
  return o;
...
void checkUnnamed4396(core.List<api.Assignment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAssignment(o[0] as api.Assignment);
  checkAssignment(o[1] as api.Assignment);
}
...
api.SearchAllAssignmentsResponse buildSearchAllAssignmentsResponse() {
  ...
  if (buildCounterSearchAllAssignmentsResponse < 3) {
    o.assignments = buildUnnamed4396();
    o.nextPageToken = 'foo';
  }
  buildCounterSearchAllAssignmentsResponse--;
  return o;
...
void checkSearchAllAssignmentsResponse(api.SearchAllAssignmentsResponse o) {
  buildCounterSearchAllAssignmentsResponse++;
  if (buildCounterSearchAllAssignmentsResponse < 3) {
    checkUnnamed4396(o.assignments);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterSearchAllAssignmentsResponse--;
}

core.List<api.Assignment> buildUnnamed4397() {
  var o = <api.Assignment>[];
  o.add(buildAssignment());
  o.add(buildAssignment());
  return o;
...
void checkUnnamed4397(core.List<api.Assignment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAssignment(o[0] as api.Assignment);
  checkAssignment(o[1] as api.Assignment);
}
...
api.SearchAssignmentsResponse buildSearchAssignmentsResponse() {
  ...
  if (buildCounterSearchAssignmentsResponse < 3) {
    o.assignments = buildUnnamed4397();
    o.nextPageToken = 'foo';
  }
  buildCounterSearchAssignmentsResponse--;
  return o;
...
void checkSearchAssignmentsResponse(api.SearchAssignmentsResponse o) {
  buildCounterSearchAssignmentsResponse++;
  if (buildCounterSearchAssignmentsResponse < 3) {
    checkUnnamed4397(o.assignments);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterSearchAssignmentsResponse--;
}
...
core.Map<core.String, core.Object> buildUnnamed4398() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed4398(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed4399() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed4398());
  o.add(buildUnnamed4398());
  return o;
}

void checkUnnamed4399(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed4398(o[0]);
  checkUnnamed4398(o[1]);
}
