...
core.List<api.Assignment> buildUnnamed4339() {
  var o = <api.Assignment>[];
...
void checkUnnamed4339(core.List<api.Assignment> o) {
...
api.ListAssignmentsResponse buildListAssignmentsResponse() {
  ...
  if (buildCounterListAssignmentsResponse < 3) {
    o.assignments = buildUnnamed4339();
    o.nextPageToken = 'foo';
  }
  buildCounterListAssignmentsResponse--;
  return o;
...
void checkListAssignmentsResponse(api.ListAssignmentsResponse o) {
  buildCounterListAssignmentsResponse++;
  if (buildCounterListAssignmentsResponse < 3) {
    checkUnnamed4339(o.assignments);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListAssignmentsResponse--;
}

core.List<api.CapacityCommitment> buildUnnamed4340() {
  var o = <api.CapacityCommitment>[];
...
void checkUnnamed4340(core.List<api.CapacityCommitment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListCapacityCommitmentsResponse buildListCapacityCommitmentsResponse() {
  ...
  if (buildCounterListCapacityCommitmentsResponse < 3) {
    o.capacityCommitments = buildUnnamed4340();
    o.nextPageToken = 'foo';
  }
  buildCounterListCapacityCommitmentsResponse--;
  return o;
...
void checkListCapacityCommitmentsResponse(
  ...
  buildCounterListCapacityCommitmentsResponse++;
  if (buildCounterListCapacityCommitmentsResponse < 3) {
    checkUnnamed4340(o.capacityCommitments);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListCapacityCommitmentsResponse--;
}

core.List<api.Operation> buildUnnamed4341() {
  var o = <api.Operation>[];
...
void checkUnnamed4341(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListOperationsResponse(api.ListOperationsResponse o) {
  ...
  if (buildCounterListOperationsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4341(o.operations);
  }
  buildCounterListOperationsResponse--;
}

core.List<api.Reservation> buildUnnamed4342() {
...
void checkUnnamed4342(core.List<api.Reservation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListReservationsResponse buildListReservationsResponse() {
  ...
  if (buildCounterListReservationsResponse < 3) {
    o.nextPageToken = 'foo';
    o.reservations = buildUnnamed4342();
  }
  buildCounterListReservationsResponse--;
  return o;
}
...
void checkListReservationsResponse(api.ListReservationsResponse o) {
  ...
  if (buildCounterListReservationsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4342(o.reservations);
  }
  buildCounterListReservationsResponse--;
}
...
api.MergeCapacityCommitmentsRequest buildMergeCapacityCommitmentsRequest() {
  ...
  if (buildCounterMergeCapacityCommitmentsRequest < 3) {
    o.capacityCommitmentIds = buildUnnamed4343();
  }
  buildCounterMergeCapacityCommitmentsRequest--;
  return o;
}
...
void checkMergeCapacityCommitmentsRequest(
  ...
  buildCounterMergeCapacityCommitmentsRequest++;
  if (buildCounterMergeCapacityCommitmentsRequest < 3) {
    checkUnnamed4343(o.capacityCommitmentIds);
  }
  buildCounterMergeCapacityCommitmentsRequest--;
}
...
core.Map<core.String, core.Object> buildUnnamed4344() {
...
void checkUnnamed4344(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed4345() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed4345(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed4344();
    o.name = 'foo';
    o.response = buildUnnamed4345();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkUnnamed4344(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed4345(o.response);
  }
  buildCounterOperation--;
}
...
core.List<api.Assignment> buildUnnamed4346() {
  var o = <api.Assignment>[];
  o.add(buildAssignment());
  o.add(buildAssignment());
  return o;
...
void checkUnnamed4346(core.List<api.Assignment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAssignment(o[0] as api.Assignment);
  checkAssignment(o[1] as api.Assignment);
}
...
api.SearchAllAssignmentsResponse buildSearchAllAssignmentsResponse() {
  ...
  if (buildCounterSearchAllAssignmentsResponse < 3) {
    o.assignments = buildUnnamed4346();
    o.nextPageToken = 'foo';
  }
  buildCounterSearchAllAssignmentsResponse--;
  return o;
...
void checkSearchAllAssignmentsResponse(api.SearchAllAssignmentsResponse o) {
  buildCounterSearchAllAssignmentsResponse++;
  if (buildCounterSearchAllAssignmentsResponse < 3) {
    checkUnnamed4346(o.assignments);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterSearchAllAssignmentsResponse--;
}

core.List<api.Assignment> buildUnnamed4347() {
  var o = <api.Assignment>[];
  o.add(buildAssignment());
  o.add(buildAssignment());
  return o;
...
void checkUnnamed4347(core.List<api.Assignment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAssignment(o[0] as api.Assignment);
  checkAssignment(o[1] as api.Assignment);
}
...
api.SearchAssignmentsResponse buildSearchAssignmentsResponse() {
  ...
  if (buildCounterSearchAssignmentsResponse < 3) {
    o.assignments = buildUnnamed4347();
    o.nextPageToken = 'foo';
  }
  buildCounterSearchAssignmentsResponse--;
  return o;
...
void checkSearchAssignmentsResponse(api.SearchAssignmentsResponse o) {
  buildCounterSearchAssignmentsResponse++;
  if (buildCounterSearchAssignmentsResponse < 3) {
    checkUnnamed4347(o.assignments);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterSearchAssignmentsResponse--;
}
...
core.Map<core.String, core.Object> buildUnnamed4348() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed4348(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed4349() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed4348());
  o.add(buildUnnamed4348());
  return o;
}

void checkUnnamed4349(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed4348(o[0]);
  checkUnnamed4348(o[1]);
}
