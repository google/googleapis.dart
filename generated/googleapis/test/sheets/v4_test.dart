...
core.List<api.DimensionGroup> buildUnnamed161() => [
      buildDimensionGroup(),
      buildDimensionGroup(),
    ];

void checkUnnamed161(core.List<api.DimensionGroup> o) {
...
api.AddDimensionGroupResponse buildAddDimensionGroupResponse() {
  ...
  if (buildCounterAddDimensionGroupResponse < 3) {
    o.dimensionGroups = buildUnnamed161();
  }
  buildCounterAddDimensionGroupResponse--;
  return o;
}
...
void checkAddDimensionGroupResponse(api.AddDimensionGroupResponse o) {
  buildCounterAddDimensionGroupResponse++;
  if (buildCounterAddDimensionGroupResponse < 3) {
    checkUnnamed161(o.dimensionGroups!);
  }
  buildCounterAddDimensionGroupResponse--;
}
...
core.List<api.RowData> buildUnnamed162() => [
      buildRowData(),
      buildRowData(),
    ];

void checkUnnamed162(core.List<api.RowData> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRowData(o[0]);
  checkRowData(o[1]);
}
...
core.List<api.BasicSeriesDataPointStyleOverride> buildUnnamed163() => [
      buildBasicSeriesDataPointStyleOverride(),
      buildBasicSeriesDataPointStyleOverride(),
    ];

void checkUnnamed163(core.List<api.BasicSeriesDataPointStyleOverride> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BasicChartSeries buildBasicChartSeries() {
  ...
  if (buildCounterBasicChartSeries < 3) {
    ...
    o.styleOverrides = buildUnnamed163();
    o.targetAxis = 'foo';
    o.type = 'foo';
  }
  buildCounterBasicChartSeries--;
...
void checkBasicChartSeries(api.BasicChartSeries o) {
  ...
  if (buildCounterBasicChartSeries < 3) {
    ...
    checkUnnamed163(o.styleOverrides!);
    unittest.expect(
      o.targetAxis!,
      unittest.equals('foo'),
    );
...
core.List<api.BasicChartAxis> buildUnnamed164() => [
      buildBasicChartAxis(),
      buildBasicChartAxis(),
    ];

void checkUnnamed164(core.List<api.BasicChartAxis> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBasicChartAxis(o[0]);
  checkBasicChartAxis(o[1]);
}

core.List<api.BasicChartDomain> buildUnnamed165() => [
      buildBasicChartDomain(),
      buildBasicChartDomain(),
    ];

void checkUnnamed165(core.List<api.BasicChartDomain> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBasicChartDomain(o[0]);
  checkBasicChartDomain(o[1]);
}

core.List<api.BasicChartSeries> buildUnnamed166() => [
      buildBasicChartSeries(),
      buildBasicChartSeries(),
    ];

void checkUnnamed166(core.List<api.BasicChartSeries> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BasicChartSpec buildBasicChartSpec() {
  ...
  if (buildCounterBasicChartSpec < 3) {
    o.axis = buildUnnamed164();
    o.chartType = 'foo';
    o.compareMode = 'foo';
    o.domains = buildUnnamed165();
    o.headerCount = 42;
    o.interpolateNulls = true;
    o.legendPosition = 'foo';
    o.lineSmoothing = true;
    o.series = buildUnnamed166();
    o.stackedType = 'foo';
...
core.Map<core.String, api.FilterCriteria> buildUnnamed167() => {
      'x': buildFilterCriteria(),
      'y': buildFilterCriteria(),
    };

void checkUnnamed167(core.Map<core.String, api.FilterCriteria> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFilterCriteria(o['x']!);
  checkFilterCriteria(o['y']!);
}

core.List<api.FilterSpec> buildUnnamed168() => [
      buildFilterSpec(),
      buildFilterSpec(),
    ];

void checkUnnamed168(core.List<api.FilterSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFilterSpec(o[0]);
  checkFilterSpec(o[1]);
}

core.List<api.SortSpec> buildUnnamed169() => [
      buildSortSpec(),
      buildSortSpec(),
    ];

void checkUnnamed169(core.List<api.SortSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSortSpec(o[0]);
  checkSortSpec(o[1]);
}
...
api.BasicFilter buildBasicFilter() {
  ...
  if (buildCounterBasicFilter < 3) {
    o.criteria = buildUnnamed167();
    o.filterSpecs = buildUnnamed168();
    o.range = buildGridRange();
    o.sortSpecs = buildUnnamed169();
  }
  buildCounterBasicFilter--;
  return o;
}
...
void checkBasicFilter(api.BasicFilter o) {
  buildCounterBasicFilter++;
  if (buildCounterBasicFilter < 3) {
    checkUnnamed167(o.criteria!);
    checkUnnamed168(o.filterSpecs!);
    checkGridRange(o.range!);
    checkUnnamed169(o.sortSpecs!);
  }
  buildCounterBasicFilter--;
}
...
core.List<api.DataFilter> buildUnnamed170() => [
      buildDataFilter(),
      buildDataFilter(),
    ];

void checkUnnamed170(core.List<api.DataFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataFilter(o[0]);
  checkDataFilter(o[1]);
}
...
api.BatchClearValuesByDataFilterResponse
  ...
  if (buildCounterBatchClearValuesByDataFilterResponse < 3) {
    o.clearedRanges = buildUnnamed171();
    o.spreadsheetId = 'foo';
  }
  buildCounterBatchClearValuesByDataFilterResponse--;
  return o;
...
void checkBatchClearValuesByDataFilterResponse(
  ...
  buildCounterBatchClearValuesByDataFilterResponse++;
  if (buildCounterBatchClearValuesByDataFilterResponse < 3) {
    checkUnnamed171(o.clearedRanges!);
    unittest.expect(
      o.spreadsheetId!,
      unittest.equals('foo'),
    );
...
api.BatchClearValuesResponse buildBatchClearValuesResponse() {
  ...
  if (buildCounterBatchClearValuesResponse < 3) {
    o.clearedRanges = buildUnnamed173();
    o.spreadsheetId = 'foo';
  }
  buildCounterBatchClearValuesResponse--;
  return o;
...
void checkBatchClearValuesResponse(api.BatchClearValuesResponse o) {
  buildCounterBatchClearValuesResponse++;
  if (buildCounterBatchClearValuesResponse < 3) {
    checkUnnamed173(o.clearedRanges!);
    unittest.expect(
      o.spreadsheetId!,
      unittest.equals('foo'),
    );
...
core.List<api.DataFilter> buildUnnamed174() => [
      buildDataFilter(),
      buildDataFilter(),
    ];

void checkUnnamed174(core.List<api.DataFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataFilter(o[0]);
  checkDataFilter(o[1]);
}
...
core.List<api.MatchedValueRange> buildUnnamed175() => [
      buildMatchedValueRange(),
      buildMatchedValueRange(),
    ];

void checkUnnamed175(core.List<api.MatchedValueRange> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkBatchGetValuesByDataFilterResponse(
  ...
  if (buildCounterBatchGetValuesByDataFilterResponse < 3) {
    ...
    checkUnnamed175(o.valueRanges!);
  }
  buildCounterBatchGetValuesByDataFilterResponse--;
}

core.List<api.ValueRange> buildUnnamed176() => [
      buildValueRange(),
      buildValueRange(),
    ];

void checkUnnamed176(core.List<api.ValueRange> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValueRange(o[0]);
  checkValueRange(o[1]);
}
...
void checkBatchGetValuesResponse(api.BatchGetValuesResponse o) {
  ...
  if (buildCounterBatchGetValuesResponse < 3) {
    ...
    checkUnnamed176(o.valueRanges!);
  }
  buildCounterBatchGetValuesResponse--;
}

core.List<api.Request> buildUnnamed177() => [
      buildRequest(),
      buildRequest(),
    ];

void checkUnnamed177(core.List<api.Request> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRequest(o[0]);
  checkRequest(o[1]);
}
...
api.BatchUpdateSpreadsheetRequest buildBatchUpdateSpreadsheetRequest() {
  ...
  if (buildCounterBatchUpdateSpreadsheetRequest < 3) {
    ...
    o.requests = buildUnnamed177();
    o.responseIncludeGridData = true;
    o.responseRanges = buildUnnamed178();
  }
  buildCounterBatchUpdateSpreadsheetRequest--;
  return o;
}
...
void checkBatchUpdateSpreadsheetRequest(api.BatchUpdateSpreadsheetRequest o) {
  ...
  if (buildCounterBatchUpdateSpreadsheetRequest < 3) {
    ...
    checkUnnamed177(o.requests!);
    unittest.expect(o.responseIncludeGridData!, unittest.isTrue);
    checkUnnamed178(o.responseRanges!);
  }
  buildCounterBatchUpdateSpreadsheetRequest--;
}

core.List<api.Response> buildUnnamed179() => [
      buildResponse(),
      buildResponse(),
    ];

void checkUnnamed179(core.List<api.Response> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResponse(o[0]);
  checkResponse(o[1]);
}
...
core.List<api.DataFilterValueRange> buildUnnamed180() => [
      buildDataFilterValueRange(),
      buildDataFilterValueRange(),
    ];

void checkUnnamed180(core.List<api.DataFilterValueRange> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.UpdateValuesByDataFilterResponse> buildUnnamed181() => [
      buildUpdateValuesByDataFilterResponse(),
      buildUpdateValuesByDataFilterResponse(),
    ];

void checkUnnamed181(core.List<api.UpdateValuesByDataFilterResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ValueRange> buildUnnamed182() => [
      buildValueRange(),
      buildValueRange(),
    ];

void checkUnnamed182(core.List<api.ValueRange> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValueRange(o[0]);
  checkValueRange(o[1]);
}
...
core.List<api.UpdateValuesResponse> buildUnnamed183() => [
      buildUpdateValuesResponse(),
      buildUpdateValuesResponse(),
    ];

void checkUnnamed183(core.List<api.UpdateValuesResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ConditionValue> buildUnnamed184() => [
      buildConditionValue(),
      buildConditionValue(),
    ];

void checkUnnamed184(core.List<api.ConditionValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.CandlestickData> buildUnnamed185() => [
      buildCandlestickData(),
      buildCandlestickData(),
    ];

void checkUnnamed185(core.List<api.CandlestickData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.TextFormatRun> buildUnnamed186() => [
      buildTextFormatRun(),
      buildTextFormatRun(),
    ];

void checkUnnamed186(core.List<api.TextFormatRun> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.CellData buildCellData() {
  ...
  if (buildCounterCellData < 3) {
    ...
    o.textFormatRuns = buildUnnamed186();
...
void checkCellData(api.CellData o) {
  ...
  if (buildCounterCellData < 3) {
    ...
    checkUnnamed186(o.textFormatRuns!);
...
core.List<api.GridRange> buildUnnamed187() => [
      buildGridRange(),
      buildGridRange(),
    ];

void checkUnnamed187(core.List<api.GridRange> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGridRange(o[0]);
  checkGridRange(o[1]);
}
...
void checkChartSourceRange(api.ChartSourceRange o) {
  buildCounterChartSourceRange++;
  if (buildCounterChartSourceRange < 3) {
    checkUnnamed187(o.sources!);
  }
  buildCounterChartSourceRange--;
}

core.List<api.FilterSpec> buildUnnamed188() => [
      buildFilterSpec(),
      buildFilterSpec(),
    ];

void checkUnnamed188(core.List<api.FilterSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFilterSpec(o[0]);
  checkFilterSpec(o[1]);
}

core.List<api.SortSpec> buildUnnamed189() => [
      buildSortSpec(),
      buildSortSpec(),
    ];

void checkUnnamed189(core.List<api.SortSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSortSpec(o[0]);
  checkSortSpec(o[1]);
}
...
core.List<api.GridRange> buildUnnamed190() => [
      buildGridRange(),
      buildGridRange(),
    ];

void checkUnnamed190(core.List<api.GridRange> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGridRange(o[0]);
  checkGridRange(o[1]);
}
...
core.List<core.Object> buildUnnamed191() => [
      {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed191(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.List<core.Object>> buildUnnamed192() => [
      buildUnnamed191(),
      buildUnnamed191(),
    ];

void checkUnnamed192(core.List<core.List<core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed191(o[0]);
  checkUnnamed191(o[1]);
}
...
core.List<api.DataSourceColumn> buildUnnamed193() => [
      buildDataSourceColumn(),
      buildDataSourceColumn(),
    ];

void checkUnnamed193(core.List<api.DataSourceColumn> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DataSource buildDataSource() {
  ...
  if (buildCounterDataSource < 3) {
    o.calculatedColumns = buildUnnamed193();
    o.dataSourceId = 'foo';
    o.sheetId = 42;
...
void checkDataSource(api.DataSource o) {
  buildCounterDataSource++;
  if (buildCounterDataSource < 3) {
    checkUnnamed193(o.calculatedColumns!);
    unittest.expect(
      o.dataSourceId!,
      unittest.equals('foo'),
    );
...
core.List<api.DataSourceObjectReference> buildUnnamed194() => [
      buildDataSourceObjectReference(),
      buildDataSourceObjectReference(),
    ];

void checkUnnamed194(core.List<api.DataSourceObjectReference> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.int> buildUnnamed195() => [
      42,
      42,
    ];
...
void checkDataSourceRefreshWeeklySchedule(
  ...
  buildCounterDataSourceRefreshWeeklySchedule++;
  if (buildCounterDataSourceRefreshWeeklySchedule < 3) {
    checkUnnamed196(o.daysOfWeek!);
    checkTimeOfDay(o.startTime!);
  }
  buildCounterDataSourceRefreshWeeklySchedule--;
}

core.List<api.DataSourceColumnReference> buildUnnamed197() => [
      buildDataSourceColumnReference(),
      buildDataSourceColumnReference(),
    ];

void checkUnnamed197(core.List<api.DataSourceColumnReference> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DataSourceSheetDimensionRange buildDataSourceSheetDimensionRange() {
  ...
  if (buildCounterDataSourceSheetDimensionRange < 3) {
    o.columnReferences = buildUnnamed197();
    o.sheetId = 42;
  }
  buildCounterDataSourceSheetDimensionRange--;
  return o;
...
void checkDataSourceSheetDimensionRange(api.DataSourceSheetDimensionRange o) {
  buildCounterDataSourceSheetDimensionRange++;
  if (buildCounterDataSourceSheetDimensionRange < 3) {
    checkUnnamed197(o.columnReferences!);
    unittest.expect(
      o.sheetId!,
      unittest.equals(42),
    );
...
core.List<api.DataSourceColumn> buildUnnamed198() => [
      buildDataSourceColumn(),
      buildDataSourceColumn(),
    ];

void checkUnnamed198(core.List<api.DataSourceColumn> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataSourceColumn(o[0]);
  checkDataSourceColumn(o[1]);
}
...
core.List<api.DataSourceParameter> buildUnnamed199() => [
      buildDataSourceParameter(),
      buildDataSourceParameter(),
    ];

void checkUnnamed199(core.List<api.DataSourceParameter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkDataSourceSpec(api.DataSourceSpec o) {
  ...
  if (buildCounterDataSourceSpec < 3) {
    ...
    checkUnnamed199(o.parameters!);
  }
  buildCounterDataSourceSpec--;
}

core.List<api.DataSourceColumnReference> buildUnnamed200() => [
      buildDataSourceColumnReference(),
      buildDataSourceColumnReference(),
    ];

void checkUnnamed200(core.List<api.DataSourceColumnReference> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataSourceColumnReference(o[0]);
  checkDataSourceColumnReference(o[1]);
}

core.List<api.FilterSpec> buildUnnamed201() => [
      buildFilterSpec(),
      buildFilterSpec(),
    ];

void checkUnnamed201(core.List<api.FilterSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFilterSpec(o[0]);
  checkFilterSpec(o[1]);
}

core.List<api.SortSpec> buildUnnamed202() => [
      buildSortSpec(),
      buildSortSpec(),
    ];

void checkUnnamed202(core.List<api.SortSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSortSpec(o[0]);
  checkSortSpec(o[1]);
}
...
api.DataSourceTable buildDataSourceTable() {
  ...
  if (buildCounterDataSourceTable < 3) {
    ...
    o.columns = buildUnnamed200();
    o.dataExecutionStatus = buildDataExecutionStatus();
    o.dataSourceId = 'foo';
    o.filterSpecs = buildUnnamed201();
    o.rowLimit = 42;
    o.sortSpecs = buildUnnamed202();
  }
  buildCounterDataSourceTable--;
  return o;
}
...
void checkDataSourceTable(api.DataSourceTable o) {
  ...
  if (buildCounterDataSourceTable < 3) {
    ...
    checkUnnamed200(o.columns!);
    checkDataExecutionStatus(o.dataExecutionStatus!);
    unittest.expect(
      o.dataSourceId!,
      unittest.equals('foo'),
    );
    checkUnnamed201(o.filterSpecs!);
    unittest.expect(
      o.rowLimit!,
      unittest.equals(42),
    );
    checkUnnamed202(o.sortSpecs!);
  }
  buildCounterDataSourceTable--;
}
...
core.List<api.DeveloperMetadata> buildUnnamed203() => [
      buildDeveloperMetadata(),
      buildDeveloperMetadata(),
    ];

void checkUnnamed203(core.List<api.DeveloperMetadata> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DeleteDeveloperMetadataResponse buildDeleteDeveloperMetadataResponse() {
  ...
  if (buildCounterDeleteDeveloperMetadataResponse < 3) {
    o.deletedDeveloperMetadata = buildUnnamed203();
  }
  buildCounterDeleteDeveloperMetadataResponse--;
  return o;
}
...
void checkDeleteDeveloperMetadataResponse(
  ...
  buildCounterDeleteDeveloperMetadataResponse++;
  if (buildCounterDeleteDeveloperMetadataResponse < 3) {
    checkUnnamed203(o.deletedDeveloperMetadata!);
  }
  buildCounterDeleteDeveloperMetadataResponse--;
}
...
core.List<api.DimensionGroup> buildUnnamed204() => [
      buildDimensionGroup(),
      buildDimensionGroup(),
    ];

void checkUnnamed204(core.List<api.DimensionGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimensionGroup(o[0]);
  checkDimensionGroup(o[1]);
}
...
api.DeleteDimensionGroupResponse buildDeleteDimensionGroupResponse() {
  ...
  if (buildCounterDeleteDimensionGroupResponse < 3) {
    o.dimensionGroups = buildUnnamed204();
  }
  buildCounterDeleteDimensionGroupResponse--;
  return o;
}
...
void checkDeleteDimensionGroupResponse(api.DeleteDimensionGroupResponse o) {
  buildCounterDeleteDimensionGroupResponse++;
  if (buildCounterDeleteDimensionGroupResponse < 3) {
    checkUnnamed204(o.dimensionGroups!);
  }
  buildCounterDeleteDimensionGroupResponse--;
}
...
core.List<api.DimensionRange> buildUnnamed205() => [
      buildDimensionRange(),
      buildDimensionRange(),
    ];

void checkUnnamed205(core.List<api.DimensionRange> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DeleteDuplicatesRequest buildDeleteDuplicatesRequest() {
  ...
  if (buildCounterDeleteDuplicatesRequest < 3) {
    o.comparisonColumns = buildUnnamed205();
    o.range = buildGridRange();
  }
  buildCounterDeleteDuplicatesRequest--;
  return o;
...
void checkDeleteDuplicatesRequest(api.DeleteDuplicatesRequest o) {
  buildCounterDeleteDuplicatesRequest++;
  if (buildCounterDeleteDuplicatesRequest < 3) {
    checkUnnamed205(o.comparisonColumns!);
    checkGridRange(o.range!);
  }
  buildCounterDeleteDuplicatesRequest--;
}
...
core.List<api.DeveloperMetadata> buildUnnamed206() => [
      buildDeveloperMetadata(),
      buildDeveloperMetadata(),
    ];

void checkUnnamed206(core.List<api.DeveloperMetadata> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDeveloperMetadata(o[0]);
  checkDeveloperMetadata(o[1]);
}
...
api.DimensionProperties buildDimensionProperties() {
  ...
  if (buildCounterDimensionProperties < 3) {
    ...
    o.developerMetadata = buildUnnamed206();
...
void checkDimensionProperties(api.DimensionProperties o) {
  ...
  if (buildCounterDimensionProperties < 3) {
    ...
    checkUnnamed206(o.developerMetadata!);
...
api.Editors buildEditors() {
  ...
  if (buildCounterEditors < 3) {
    ...
    o.groups = buildUnnamed207();
    o.users = buildUnnamed208();
  }
  buildCounterEditors--;
  return o;
}
...
void checkEditors(api.Editors o) {
  ...
  if (buildCounterEditors < 3) {
    ...
    checkUnnamed207(o.groups!);
    checkUnnamed208(o.users!);
  }
  buildCounterEditors--;
}
...
api.FilterCriteria buildFilterCriteria() {
  ...
  if (buildCounterFilterCriteria < 3) {
    o.condition = buildBooleanCondition();
    o.hiddenValues = buildUnnamed209();
...
void checkFilterCriteria(api.FilterCriteria o) {
  ...
  if (buildCounterFilterCriteria < 3) {
    checkBooleanCondition(o.condition!);
    checkUnnamed209(o.hiddenValues!);
...
core.Map<core.String, api.FilterCriteria> buildUnnamed210() => {
      'x': buildFilterCriteria(),
      'y': buildFilterCriteria(),
    };

void checkUnnamed210(core.Map<core.String, api.FilterCriteria> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFilterCriteria(o['x']!);
  checkFilterCriteria(o['y']!);
}

core.List<api.FilterSpec> buildUnnamed211() => [
      buildFilterSpec(),
      buildFilterSpec(),
    ];

void checkUnnamed211(core.List<api.FilterSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFilterSpec(o[0]);
  checkFilterSpec(o[1]);
}

core.List<api.SortSpec> buildUnnamed212() => [
      buildSortSpec(),
      buildSortSpec(),
    ];

void checkUnnamed212(core.List<api.SortSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSortSpec(o[0]);
  checkSortSpec(o[1]);
}
...
api.FilterView buildFilterView() {
  ...
  if (buildCounterFilterView < 3) {
    o.criteria = buildUnnamed210();
    o.filterSpecs = buildUnnamed211();
    o.filterViewId = 42;
    o.namedRangeId = 'foo';
    o.range = buildGridRange();
    o.sortSpecs = buildUnnamed212();
    o.title = 'foo';
  }
  buildCounterFilterView--;
  return o;
...
void checkFilterView(api.FilterView o) {
  buildCounterFilterView++;
  if (buildCounterFilterView < 3) {
    checkUnnamed210(o.criteria!);
    checkUnnamed211(o.filterSpecs!);
    unittest.expect(
      o.filterViewId!,
      unittest.equals(42),
    );
...
core.List<api.DataFilter> buildUnnamed213() => [
      buildDataFilter(),
      buildDataFilter(),
    ];

void checkUnnamed213(core.List<api.DataFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataFilter(o[0]);
  checkDataFilter(o[1]);
}
...
core.List<api.DimensionProperties> buildUnnamed214() => [
      buildDimensionProperties(),
      buildDimensionProperties(),
    ];

void checkUnnamed214(core.List<api.DimensionProperties> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimensionProperties(o[0]);
  checkDimensionProperties(o[1]);
}

core.List<api.RowData> buildUnnamed215() => [
      buildRowData(),
      buildRowData(),
    ];

void checkUnnamed215(core.List<api.RowData> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRowData(o[0]);
  checkRowData(o[1]);
}

core.List<api.DimensionProperties> buildUnnamed216() => [
      buildDimensionProperties(),
      buildDimensionProperties(),
    ];

void checkUnnamed216(core.List<api.DimensionProperties> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimensionProperties(o[0]);
  checkDimensionProperties(o[1]);
}
...
api.GridData buildGridData() {
  ...
  if (buildCounterGridData < 3) {
    o.columnMetadata = buildUnnamed214();
    o.rowData = buildUnnamed215();
    o.rowMetadata = buildUnnamed216();
    o.startColumn = 42;
    o.startRow = 42;
  }
  buildCounterGridData--;
...
void checkGridData(api.GridData o) {
  buildCounterGridData++;
  if (buildCounterGridData < 3) {
    checkUnnamed214(o.columnMetadata!);
    checkUnnamed215(o.rowData!);
    checkUnnamed216(o.rowMetadata!);
    unittest.expect(
      o.startColumn!,
      unittest.equals(42),
    );
...
core.List<api.HistogramSeries> buildUnnamed217() => [
      buildHistogramSeries(),
      buildHistogramSeries(),
    ];

void checkUnnamed217(core.List<api.HistogramSeries> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ManualRuleGroup> buildUnnamed218() => [
      buildManualRuleGroup(),
      buildManualRuleGroup(),
    ];

void checkUnnamed218(core.List<api.ManualRuleGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkManualRule(api.ManualRule o) {
  buildCounterManualRule++;
  if (buildCounterManualRule < 3) {
    checkUnnamed218(o.groups!);
  }
  buildCounterManualRule--;
}

core.List<api.ExtendedValue> buildUnnamed219() => [
      buildExtendedValue(),
      buildExtendedValue(),
    ];

void checkUnnamed219(core.List<api.ExtendedValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.DataFilter> buildUnnamed220() => [
      buildDataFilter(),
      buildDataFilter(),
    ];

void checkUnnamed220(core.List<api.DataFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataFilter(o[0]);
  checkDataFilter(o[1]);
}
...
void checkMatchedDeveloperMetadata(api.MatchedDeveloperMetadata o) {
  buildCounterMatchedDeveloperMetadata++;
  if (buildCounterMatchedDeveloperMetadata < 3) {
    checkUnnamed220(o.dataFilters!);
    checkDeveloperMetadata(o.developerMetadata!);
  }
  buildCounterMatchedDeveloperMetadata--;
}

core.List<api.DataFilter> buildUnnamed221() => [
      buildDataFilter(),
      buildDataFilter(),
    ];

void checkUnnamed221(core.List<api.DataFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataFilter(o[0]);
  checkDataFilter(o[1]);
}
...
api.PivotFilterCriteria buildPivotFilterCriteria() {
  ...
  if (buildCounterPivotFilterCriteria < 3) {
    ...
    o.visibleValues = buildUnnamed222();
  }
  buildCounterPivotFilterCriteria--;
  return o;
}
...
void checkPivotFilterCriteria(api.PivotFilterCriteria o) {
  ...
  if (buildCounterPivotFilterCriteria < 3) {
    ...
    checkUnnamed222(o.visibleValues!);
  }
  buildCounterPivotFilterCriteria--;
}
...
core.List<api.PivotGroupValueMetadata> buildUnnamed223() => [
      buildPivotGroupValueMetadata(),
      buildPivotGroupValueMetadata(),
    ];

void checkUnnamed223(core.List<api.PivotGroupValueMetadata> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PivotGroup buildPivotGroup() {
  ...
  if (buildCounterPivotGroup < 3) {
    ...
    o.valueMetadata = buildUnnamed223();
  }
  buildCounterPivotGroup--;
  return o;
}
...
void checkPivotGroup(api.PivotGroup o) {
  ...
  if (buildCounterPivotGroup < 3) {
    ...
    checkUnnamed223(o.valueMetadata!);
  }
  buildCounterPivotGroup--;
}
...
core.List<api.ExtendedValue> buildUnnamed224() => [
      buildExtendedValue(),
      buildExtendedValue(),
    ];

void checkUnnamed224(core.List<api.ExtendedValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkExtendedValue(o[0]);
  checkExtendedValue(o[1]);
}
...
core.List<api.PivotGroup> buildUnnamed225() => [
      buildPivotGroup(),
      buildPivotGroup(),
    ];

void checkUnnamed225(core.List<api.PivotGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPivotGroup(o[0]);
  checkPivotGroup(o[1]);
}

core.Map<core.String, api.PivotFilterCriteria> buildUnnamed226() => {
      'x': buildPivotFilterCriteria(),
      'y': buildPivotFilterCriteria(),
    };

void checkUnnamed226(core.Map<core.String, api.PivotFilterCriteria> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPivotFilterCriteria(o['x']!);
  checkPivotFilterCriteria(o['y']!);
}

core.List<api.PivotFilterSpec> buildUnnamed227() => [
      buildPivotFilterSpec(),
      buildPivotFilterSpec(),
    ];

void checkUnnamed227(core.List<api.PivotFilterSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPivotFilterSpec(o[0]);
  checkPivotFilterSpec(o[1]);
}

core.List<api.PivotGroup> buildUnnamed228() => [
      buildPivotGroup(),
      buildPivotGroup(),
    ];

void checkUnnamed228(core.List<api.PivotGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPivotGroup(o[0]);
  checkPivotGroup(o[1]);
}

core.List<api.PivotValue> buildUnnamed229() => [
      buildPivotValue(),
      buildPivotValue(),
    ];

void checkUnnamed229(core.List<api.PivotValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPivotValue(o[0]);
  checkPivotValue(o[1]);
}
...
api.PivotTable buildPivotTable() {
  ...
  if (buildCounterPivotTable < 3) {
    o.columns = buildUnnamed225();
    o.criteria = buildUnnamed226();
    o.dataExecutionStatus = buildDataExecutionStatus();
    o.dataSourceId = 'foo';
    o.filterSpecs = buildUnnamed227();
    o.rows = buildUnnamed228();
    o.source = buildGridRange();
    o.valueLayout = 'foo';
    o.values = buildUnnamed229();
  }
  buildCounterPivotTable--;
  return o;
}
...
void checkPivotTable(api.PivotTable o) {
  buildCounterPivotTable++;
  if (buildCounterPivotTable < 3) {
    checkUnnamed225(o.columns!);
    checkUnnamed226(o.criteria!);
    checkDataExecutionStatus(o.dataExecutionStatus!);
    unittest.expect(
      o.dataSourceId!,
      unittest.equals('foo'),
    );
    checkUnnamed227(o.filterSpecs!);
...
core.List<api.GridRange> buildUnnamed230() => [
      buildGridRange(),
      buildGridRange(),
    ];

void checkUnnamed230(core.List<api.GridRange> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGridRange(o[0]);
  checkGridRange(o[1]);
}
...
api.ProtectedRange buildProtectedRange() {
  ...
  if (buildCounterProtectedRange < 3) {
    ...
    o.unprotectedRanges = buildUnnamed230();
    o.warningOnly = true;
  }
  buildCounterProtectedRange--;
  return o;
...
void checkProtectedRange(api.ProtectedRange o) {
  ...
  if (buildCounterProtectedRange < 3) {
    ...
    checkUnnamed230(o.unprotectedRanges!);
...
core.List<api.RefreshDataSourceObjectExecutionStatus> buildUnnamed231() => [
      buildRefreshDataSourceObjectExecutionStatus(),
      buildRefreshDataSourceObjectExecutionStatus(),
    ];

void checkUnnamed231(core.List<api.RefreshDataSourceObjectExecutionStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.CellData> buildUnnamed232() => [
      buildCellData(),
      buildCellData(),
    ];

void checkUnnamed232(core.List<api.CellData> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCellData(o[0]);
  checkCellData(o[1]);
}
...
core.List<api.DataFilter> buildUnnamed233() => [
      buildDataFilter(),
      buildDataFilter(),
    ];

void checkUnnamed233(core.List<api.DataFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataFilter(o[0]);
  checkDataFilter(o[1]);
}
...
void checkSearchDeveloperMetadataRequest(api.SearchDeveloperMetadataRequest o) {
  buildCounterSearchDeveloperMetadataRequest++;
  if (buildCounterSearchDeveloperMetadataRequest < 3) {
    checkUnnamed233(o.dataFilters!);
  }
  buildCounterSearchDeveloperMetadataRequest--;
}

core.List<api.MatchedDeveloperMetadata> buildUnnamed234() => [
      buildMatchedDeveloperMetadata(),
      buildMatchedDeveloperMetadata(),
    ];

void checkUnnamed234(core.List<api.MatchedDeveloperMetadata> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SearchDeveloperMetadataResponse buildSearchDeveloperMetadataResponse() {
  ...
  if (buildCounterSearchDeveloperMetadataResponse < 3) {
    o.matchedDeveloperMetadata = buildUnnamed234();
  }
  buildCounterSearchDeveloperMetadataResponse--;
  return o;
}
...
void checkSearchDeveloperMetadataResponse(
  ...
  buildCounterSearchDeveloperMetadataResponse++;
  if (buildCounterSearchDeveloperMetadataResponse < 3) {
    checkUnnamed234(o.matchedDeveloperMetadata!);
  }
  buildCounterSearchDeveloperMetadataResponse--;
}
...
core.List<api.BandedRange> buildUnnamed235() => [
      buildBandedRange(),
      buildBandedRange(),
    ];

void checkUnnamed235(core.List<api.BandedRange> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBandedRange(o[0]);
  checkBandedRange(o[1]);
}

core.List<api.EmbeddedChart> buildUnnamed236() => [
      buildEmbeddedChart(),
      buildEmbeddedChart(),
    ];

void checkUnnamed236(core.List<api.EmbeddedChart> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEmbeddedChart(o[0]);
  checkEmbeddedChart(o[1]);
}

core.List<api.DimensionGroup> buildUnnamed237() => [
      buildDimensionGroup(),
      buildDimensionGroup(),
    ];

void checkUnnamed237(core.List<api.DimensionGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimensionGroup(o[0]);
  checkDimensionGroup(o[1]);
}

core.List<api.ConditionalFormatRule> buildUnnamed238() => [
      buildConditionalFormatRule(),
      buildConditionalFormatRule(),
    ];

void checkUnnamed238(core.List<api.ConditionalFormatRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkConditionalFormatRule(o[0]);
  checkConditionalFormatRule(o[1]);
}

core.List<api.GridData> buildUnnamed239() => [
      buildGridData(),
      buildGridData(),
    ];

void checkUnnamed239(core.List<api.GridData> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGridData(o[0]);
  checkGridData(o[1]);
}

core.List<api.DeveloperMetadata> buildUnnamed240() => [
      buildDeveloperMetadata(),
      buildDeveloperMetadata(),
    ];

void checkUnnamed240(core.List<api.DeveloperMetadata> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDeveloperMetadata(o[0]);
  checkDeveloperMetadata(o[1]);
}

core.List<api.FilterView> buildUnnamed241() => [
      buildFilterView(),
      buildFilterView(),
    ];

void checkUnnamed241(core.List<api.FilterView> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFilterView(o[0]);
  checkFilterView(o[1]);
}

core.List<api.GridRange> buildUnnamed242() => [
      buildGridRange(),
      buildGridRange(),
    ];

void checkUnnamed242(core.List<api.GridRange> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGridRange(o[0]);
  checkGridRange(o[1]);
}

core.List<api.ProtectedRange> buildUnnamed243() => [
      buildProtectedRange(),
      buildProtectedRange(),
    ];

void checkUnnamed243(core.List<api.ProtectedRange> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProtectedRange(o[0]);
  checkProtectedRange(o[1]);
}

core.List<api.DimensionGroup> buildUnnamed244() => [
      buildDimensionGroup(),
      buildDimensionGroup(),
    ];

void checkUnnamed244(core.List<api.DimensionGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimensionGroup(o[0]);
  checkDimensionGroup(o[1]);
}

core.List<api.Slicer> buildUnnamed245() => [
      buildSlicer(),
      buildSlicer(),
    ];

void checkUnnamed245(core.List<api.Slicer> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSlicer(o[0]);
  checkSlicer(o[1]);
}
...
api.Sheet buildSheet() {
  ...
  if (buildCounterSheet < 3) {
    o.bandedRanges = buildUnnamed235();
    o.basicFilter = buildBasicFilter();
    o.charts = buildUnnamed236();
    o.columnGroups = buildUnnamed237();
    o.conditionalFormats = buildUnnamed238();
    o.data = buildUnnamed239();
    o.developerMetadata = buildUnnamed240();
    o.filterViews = buildUnnamed241();
    o.merges = buildUnnamed242();
    o.properties = buildSheetProperties();
    o.protectedRanges = buildUnnamed243();
    o.rowGroups = buildUnnamed244();
    o.slicers = buildUnnamed245();
  }
  buildCounterSheet--;
  return o;
}
...
void checkSheet(api.Sheet o) {
  buildCounterSheet++;
  if (buildCounterSheet < 3) {
    checkUnnamed235(o.bandedRanges!);
    checkBasicFilter(o.basicFilter!);
    checkUnnamed236(o.charts!);
    checkUnnamed237(o.columnGroups!);
    checkUnnamed238(o.conditionalFormats!);
    checkUnnamed239(o.data!);
    checkUnnamed240(o.developerMetadata!);
    checkUnnamed241(o.filterViews!);
    checkUnnamed242(o.merges!);
    checkSheetProperties(o.properties!);
    checkUnnamed243(o.protectedRanges!);
    checkUnnamed244(o.rowGroups!);
    checkUnnamed245(o.slicers!);
  }
  buildCounterSheet--;
}
...
core.List<api.SortSpec> buildUnnamed246() => [
      buildSortSpec(),
      buildSortSpec(),
    ];

void checkUnnamed246(core.List<api.SortSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSortSpec(o[0]);
  checkSortSpec(o[1]);
}
...
core.List<api.DataSourceRefreshSchedule> buildUnnamed247() => [
      buildDataSourceRefreshSchedule(),
      buildDataSourceRefreshSchedule(),
    ];

void checkUnnamed247(core.List<api.DataSourceRefreshSchedule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataSourceRefreshSchedule(o[0]);
  checkDataSourceRefreshSchedule(o[1]);
}

core.List<api.DataSource> buildUnnamed248() => [
      buildDataSource(),
      buildDataSource(),
    ];

void checkUnnamed248(core.List<api.DataSource> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataSource(o[0]);
  checkDataSource(o[1]);
}

core.List<api.DeveloperMetadata> buildUnnamed249() => [
      buildDeveloperMetadata(),
      buildDeveloperMetadata(),
    ];

void checkUnnamed249(core.List<api.DeveloperMetadata> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDeveloperMetadata(o[0]);
  checkDeveloperMetadata(o[1]);
}

core.List<api.NamedRange> buildUnnamed250() => [
      buildNamedRange(),
      buildNamedRange(),
    ];

void checkUnnamed250(core.List<api.NamedRange> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNamedRange(o[0]);
  checkNamedRange(o[1]);
}

core.List<api.Sheet> buildUnnamed251() => [
      buildSheet(),
      buildSheet(),
    ];

void checkUnnamed251(core.List<api.Sheet> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSheet(o[0]);
  checkSheet(o[1]);
}
...
api.Spreadsheet buildSpreadsheet() {
  ...
  if (buildCounterSpreadsheet < 3) {
    o.dataSourceSchedules = buildUnnamed247();
    o.dataSources = buildUnnamed248();
    o.developerMetadata = buildUnnamed249();
    o.namedRanges = buildUnnamed250();
    o.properties = buildSpreadsheetProperties();
    o.sheets = buildUnnamed251();
    o.spreadsheetId = 'foo';
...
void checkSpreadsheet(api.Spreadsheet o) {
  buildCounterSpreadsheet++;
  if (buildCounterSpreadsheet < 3) {
    checkUnnamed247(o.dataSourceSchedules!);
    checkUnnamed248(o.dataSources!);
    checkUnnamed249(o.developerMetadata!);
    checkUnnamed250(o.namedRanges!);
    checkSpreadsheetProperties(o.properties!);
    checkUnnamed251(o.sheets!);
    unittest.expect(
      o.spreadsheetId!,
      unittest.equals('foo'),
    );
...
core.List<api.ThemeColorPair> buildUnnamed252() => [
      buildThemeColorPair(),
      buildThemeColorPair(),
    ];

void checkUnnamed252(core.List<api.ThemeColorPair> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.RowData> buildUnnamed253() => [
      buildRowData(),
      buildRowData(),
    ];

void checkUnnamed253(core.List<api.RowData> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRowData(o[0]);
  checkRowData(o[1]);
}
...
core.List<api.DataFilter> buildUnnamed254() => [
      buildDataFilter(),
      buildDataFilter(),
    ];

void checkUnnamed254(core.List<api.DataFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataFilter(o[0]);
  checkDataFilter(o[1]);
}
...
core.List<api.DeveloperMetadata> buildUnnamed255() => [
      buildDeveloperMetadata(),
      buildDeveloperMetadata(),
    ];

void checkUnnamed255(core.List<api.DeveloperMetadata> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDeveloperMetadata(o[0]);
  checkDeveloperMetadata(o[1]);
}
...
api.UpdateDeveloperMetadataResponse buildUpdateDeveloperMetadataResponse() {
  ...
  if (buildCounterUpdateDeveloperMetadataResponse < 3) {
    o.developerMetadata = buildUnnamed255();
  }
  buildCounterUpdateDeveloperMetadataResponse--;
  return o;
}
...
void checkUpdateDeveloperMetadataResponse(
  ...
  buildCounterUpdateDeveloperMetadataResponse++;
  if (buildCounterUpdateDeveloperMetadataResponse < 3) {
    checkUnnamed255(o.developerMetadata!);
  }
  buildCounterUpdateDeveloperMetadataResponse--;
}
...
core.List<core.Object> buildUnnamed256() => [
      {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed256(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.List<core.Object>> buildUnnamed257() => [
      buildUnnamed256(),
      buildUnnamed256(),
    ];

void checkUnnamed257(core.List<core.List<core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed256(o[0]);
  checkUnnamed256(o[1]);
}
...
core.List<api.WaterfallChartCustomSubtotal> buildUnnamed258() => [
      buildWaterfallChartCustomSubtotal(),
      buildWaterfallChartCustomSubtotal(),
    ];

void checkUnnamed258(core.List<api.WaterfallChartCustomSubtotal> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.WaterfallChartSeries buildWaterfallChartSeries() {
  ...
  if (buildCounterWaterfallChartSeries < 3) {
    o.customSubtotals = buildUnnamed258();
    o.data = buildChartData();
    o.dataLabel = buildDataLabel();
...
void checkWaterfallChartSeries(api.WaterfallChartSeries o) {
  buildCounterWaterfallChartSeries++;
  if (buildCounterWaterfallChartSeries < 3) {
    checkUnnamed258(o.customSubtotals!);
    checkChartData(o.data!);
    checkDataLabel(o.dataLabel!);
...
core.List<api.WaterfallChartSeries> buildUnnamed259() => [
      buildWaterfallChartSeries(),
      buildWaterfallChartSeries(),
    ];

void checkUnnamed259(core.List<api.WaterfallChartSeries> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void main() {
  ...
  unittest.group('resource-SpreadsheetsResource', () {
    ...
    unittest.test('method--get', () async {
      ...
      final arg_ranges = buildUnnamed260();
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group('resource-SpreadsheetsValuesResource', () {
    ...
    unittest.test('method--batchGet', () async {
      ...
      final arg_ranges = buildUnnamed261();
