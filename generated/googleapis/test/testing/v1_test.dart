...
checkUnnamed97(core.List<api.AndroidModel> o) {
...
checkUnnamed98(core.List<api.AndroidVersion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed99(core.List<api.AndroidDevice> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAndroidDeviceList() {
  ...
  if (buildCounterAndroidDeviceList < 3) {
    o.androidDevices = buildUnnamed99();
  }
  buildCounterAndroidDeviceList--;
  return o;
}
...
checkAndroidDeviceList(api.AndroidDeviceList o) {
  buildCounterAndroidDeviceList++;
  if (buildCounterAndroidDeviceList < 3) {
    checkUnnamed99(o.androidDevices);
  }
  buildCounterAndroidDeviceList--;
}
...
buildAndroidMatrix() {
  ...
  if (buildCounterAndroidMatrix < 3) {
    o.androidModelIds = buildUnnamed101();
    o.androidVersionIds = buildUnnamed102();
    o.locales = buildUnnamed103();
    o.orientations = buildUnnamed104();
  }
  buildCounterAndroidMatrix--;
  return o;
}
...
checkAndroidMatrix(api.AndroidMatrix o) {
  buildCounterAndroidMatrix++;
  if (buildCounterAndroidMatrix < 3) {
    checkUnnamed101(o.androidModelIds);
    checkUnnamed102(o.androidVersionIds);
    checkUnnamed103(o.locales);
    checkUnnamed104(o.orientations);
  }
  buildCounterAndroidMatrix--;
}
...
buildAndroidModel() {
  ...
  if (buildCounterAndroidModel < 3) {
    ...
    o.screenX = 42;
    o.screenY = 42;
    o.supportedAbis = buildUnnamed105();
    o.supportedVersionIds = buildUnnamed106();
...
checkAndroidModel(api.AndroidModel o) {
  ...
  if (buildCounterAndroidModel < 3) {
    ...
    checkUnnamed105(o.supportedAbis);
    checkUnnamed106(o.supportedVersionIds);
...
checkUnnamed108(core.List<api.RoboDirective> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed109(core.List<api.RoboStartingIntent> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAndroidRoboTest() {
  ...
  if (buildCounterAndroidRoboTest < 3) {
    ...
    o.maxDepth = 42;
    o.maxSteps = 42;
    o.roboDirectives = buildUnnamed108();
    o.roboScript = buildFileReference();
    o.startingIntents = buildUnnamed109();
  }
  buildCounterAndroidRoboTest--;
  return o;
}
...
checkAndroidRoboTest(api.AndroidRoboTest o) {
  ...
  if (buildCounterAndroidRoboTest < 3) {
    ...
    checkUnnamed108(o.roboDirectives);
    checkFileReference(o.roboScript);
    checkUnnamed109(o.startingIntents);
  }
  buildCounterAndroidRoboTest--;
}
...
checkUnnamed110(core.List<api.Locale> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocale(o[0]);
  checkLocale(o[1]);
}
...
checkUnnamed111(core.List<api.Orientation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAndroidRuntimeConfiguration() {
  ...
  if (buildCounterAndroidRuntimeConfiguration < 3) {
    o.locales = buildUnnamed110();
    o.orientations = buildUnnamed111();
  }
  buildCounterAndroidRuntimeConfiguration--;
  return o;
}
...
checkAndroidRuntimeConfiguration(api.AndroidRuntimeConfiguration o) {
  buildCounterAndroidRuntimeConfiguration++;
  if (buildCounterAndroidRuntimeConfiguration < 3) {
    checkUnnamed110(o.locales);
    checkUnnamed111(o.orientations);
  }
  buildCounterAndroidRuntimeConfiguration--;
}
...
checkUnnamed113(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAndroidTestLoop() {
  ...
  if (buildCounterAndroidTestLoop < 3) {
    ...
    o.appBundle = buildAppBundle();
    o.appPackageId = "foo";
    o.scenarioLabels = buildUnnamed112();
    o.scenarios = buildUnnamed113();
  }
  buildCounterAndroidTestLoop--;
  return o;
}
...
checkAndroidTestLoop(api.AndroidTestLoop o) {
  ...
  if (buildCounterAndroidTestLoop < 3) {
    ...
    checkAppBundle(o.appBundle);
    unittest.expect(o.appPackageId, unittest.equals('foo'));
    checkUnnamed112(o.scenarioLabels);
    checkUnnamed113(o.scenarios);
  }
  buildCounterAndroidTestLoop--;
}
...
checkUnnamed115(core.List<api.IntentFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildApkManifest() {
  ...
  if (buildCounterApkManifest < 3) {
    ...
    o.intentFilters = buildUnnamed115();
    o.maxSdkVersion = 42;
    o.minSdkVersion = 42;
    o.packageName = "foo";
...
checkApkManifest(api.ApkManifest o) {
  ...
  if (buildCounterApkManifest < 3) {
    ...
    checkUnnamed115(o.intentFilters);
...
checkUnnamed116(core.List<api.ClientInfoDetail> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildClientInfo() {
  ...
  if (buildCounterClientInfo < 3) {
    o.clientInfoDetails = buildUnnamed116();
    o.name = "foo";
  }
  buildCounterClientInfo--;
  return o;
...
checkClientInfo(api.ClientInfo o) {
  buildCounterClientInfo++;
  if (buildCounterClientInfo < 3) {
    checkUnnamed116(o.clientInfoDetails);
    unittest.expect(o.name, unittest.equals('foo'));
  }
  buildCounterClientInfo--;
}
...
buildIntentFilter() {
  ...
  if (buildCounterIntentFilter < 3) {
    o.actionNames = buildUnnamed117();
    o.categoryNames = buildUnnamed118();
    o.mimeType = "foo";
  }
  buildCounterIntentFilter--;
  return o;
...
checkIntentFilter(api.IntentFilter o) {
  buildCounterIntentFilter++;
  if (buildCounterIntentFilter < 3) {
    checkUnnamed117(o.actionNames);
    checkUnnamed118(o.categoryNames);
...
checkUnnamed119(core.List<api.IosModel> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIosModel(o[0]);
  checkIosModel(o[1]);
}
...
checkUnnamed120(core.List<api.IosVersion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIosVersion(o[0]);
  checkIosVersion(o[1]);
}
...
checkUnnamed121(core.List<api.XcodeVersion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildIosDeviceCatalog() {
  ...
  if (buildCounterIosDeviceCatalog < 3) {
    o.models = buildUnnamed119();
    o.runtimeConfiguration = buildIosRuntimeConfiguration();
    o.versions = buildUnnamed120();
    o.xcodeVersions = buildUnnamed121();
  }
  buildCounterIosDeviceCatalog--;
  return o;
}
...
checkIosDeviceCatalog(api.IosDeviceCatalog o) {
  buildCounterIosDeviceCatalog++;
  if (buildCounterIosDeviceCatalog < 3) {
    checkUnnamed119(o.models);
    checkIosRuntimeConfiguration(o.runtimeConfiguration);
    checkUnnamed120(o.versions);
    checkUnnamed121(o.xcodeVersions);
  }
  buildCounterIosDeviceCatalog--;
}
...
checkUnnamed122(core.List<api.IosDevice> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIosDevice(o[0]);
  checkIosDevice(o[1]);
}
...
buildIosModel() {
  ...
  if (buildCounterIosModel < 3) {
    o.deviceCapabilities = buildUnnamed123();
    o.formFactor = "foo";
    o.id = "foo";
    o.name = "foo";
    o.screenDensity = 42;
    o.screenX = 42;
    o.screenY = 42;
    o.supportedVersionIds = buildUnnamed124();
    o.tags = buildUnnamed125();
  }
  buildCounterIosModel--;
  return o;
}
...
checkIosModel(api.IosModel o) {
  buildCounterIosModel++;
  if (buildCounterIosModel < 3) {
    checkUnnamed123(o.deviceCapabilities);
    unittest.expect(o.formFactor, unittest.equals('foo'));
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.name, unittest.equals('foo'));
    unittest.expect(o.screenDensity, unittest.equals(42));
    unittest.expect(o.screenX, unittest.equals(42));
    unittest.expect(o.screenY, unittest.equals(42));
    checkUnnamed124(o.supportedVersionIds);
    checkUnnamed125(o.tags);
  }
  buildCounterIosModel--;
}
...
checkUnnamed126(core.List<api.Locale> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocale(o[0]);
  checkLocale(o[1]);
}
...
checkUnnamed127(core.List<api.Orientation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrientation(o[0]);
  checkOrientation(o[1]);
}
...
buildIosRuntimeConfiguration() {
  ...
  if (buildCounterIosRuntimeConfiguration < 3) {
    o.locales = buildUnnamed126();
    o.orientations = buildUnnamed127();
  }
  buildCounterIosRuntimeConfiguration--;
  return o;
}
...
checkIosRuntimeConfiguration(api.IosRuntimeConfiguration o) {
  buildCounterIosRuntimeConfiguration++;
  if (buildCounterIosRuntimeConfiguration < 3) {
    checkUnnamed126(o.locales);
    checkUnnamed127(o.orientations);
  }
  buildCounterIosRuntimeConfiguration--;
}
...
checkUnnamed132(core.List<api.TestTargetsForShard> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildManualSharding() {
  ...
  if (buildCounterManualSharding < 3) {
    o.testTargetsForShard = buildUnnamed132();
  }
  buildCounterManualSharding--;
  return o;
}
...
checkManualSharding(api.ManualSharding o) {
  buildCounterManualSharding++;
  if (buildCounterManualSharding < 3) {
    checkUnnamed132(o.testTargetsForShard);
  }
  buildCounterManualSharding--;
}
...
checkUnnamed133(core.List<api.NetworkConfiguration> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildNetworkConfigurationCatalog() {
  ...
  if (buildCounterNetworkConfigurationCatalog < 3) {
    o.configurations = buildUnnamed133();
  }
  buildCounterNetworkConfigurationCatalog--;
  return o;
}
...
checkNetworkConfigurationCatalog(api.NetworkConfigurationCatalog o) {
  buildCounterNetworkConfigurationCatalog++;
  if (buildCounterNetworkConfigurationCatalog < 3) {
    checkUnnamed133(o.configurations);
  }
  buildCounterNetworkConfigurationCatalog--;
}
...
buildTestDetails() {
  ...
  if (buildCounterTestDetails < 3) {
    o.errorMessage = "foo";
    o.progressMessages = buildUnnamed136();
  }
  buildCounterTestDetails--;
  return o;
}
...
checkTestDetails(api.TestDetails o) {
  ...
  if (buildCounterTestDetails < 3) {
    ...
    checkUnnamed136(o.progressMessages);
  }
  buildCounterTestDetails--;
}
...
checkUnnamed137(core.List<api.TestExecution> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildTestMatrix() {
  ...
  if (buildCounterTestMatrix < 3) {
    ...
    o.state = "foo";
    o.testExecutions = buildUnnamed137();
    o.testMatrixId = "foo";
    o.testSpecification = buildTestSpecification();
    o.timestamp = "foo";
  }
...
checkTestMatrix(api.TestMatrix o) {
  ...
  if (buildCounterTestMatrix < 3) {
    ...
    unittest.expect(o.state, unittest.equals('foo'));
    checkUnnamed137(o.testExecutions);
...
checkUnnamed138(core.List<api.Apk> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApk(o[0]);
  checkApk(o[1]);
}
...
checkUnnamed140(core.List<api.EnvironmentVariable> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed141(core.List<api.DeviceFile> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDeviceFile(o[0]);
  checkDeviceFile(o[1]);
}
...
buildTestSetup() {
  ...
  if (buildCounterTestSetup < 3) {
    ...
    o.additionalApks = buildUnnamed138();
    o.directoriesToPull = buildUnnamed139();
    o.environmentVariables = buildUnnamed140();
    o.filesToPush = buildUnnamed141();
    o.networkProfile = "foo";
  }
  buildCounterTestSetup--;
  return o;
...
checkTestSetup(api.TestSetup o) {
  ...
  if (buildCounterTestSetup < 3) {
    ...
    checkUnnamed138(o.additionalApks);
    checkUnnamed139(o.directoriesToPull);
    checkUnnamed140(o.environmentVariables);
    checkUnnamed141(o.filesToPush);
    unittest.expect(o.networkProfile, unittest.equals('foo'));
  }
  buildCounterTestSetup--;
}
