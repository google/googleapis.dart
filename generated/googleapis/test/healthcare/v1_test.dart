...
core.List<api.AuditLogConfig> buildUnnamed2918() {
...
void checkUnnamed2918(core.List<api.AuditLogConfig> o) {
...
api.AuditConfig buildAuditConfig() {
  ...
  if (buildCounterAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed2918();
    o.service = 'foo';
  }
  buildCounterAuditConfig--;
  return o;
...
void checkAuditConfig(api.AuditConfig o) {
  buildCounterAuditConfig++;
  if (buildCounterAuditConfig < 3) {
    checkUnnamed2918(o.auditLogConfigs);
...
api.AuditLogConfig buildAuditLogConfig() {
  ...
  if (buildCounterAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed2919();
    o.logType = 'foo';
  }
  buildCounterAuditLogConfig--;
  return o;
...
void checkAuditLogConfig(api.AuditLogConfig o) {
  buildCounterAuditLogConfig++;
  if (buildCounterAuditLogConfig < 3) {
    checkUnnamed2919(o.exemptedMembers);
...
core.List<api.FieldMetadata> buildUnnamed2922() {
...
void checkUnnamed2922(core.List<api.FieldMetadata> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.FhirConfig buildFhirConfig() {
  ...
  if (buildCounterFhirConfig < 3) {
    o.fieldMetadataList = buildUnnamed2922();
  }
  buildCounterFhirConfig--;
  return o;
}
...
void checkFhirConfig(api.FhirConfig o) {
  buildCounterFhirConfig++;
  if (buildCounterFhirConfig < 3) {
    checkUnnamed2922(o.fieldMetadataList);
  }
  buildCounterFhirConfig--;
}
...
core.List<api.StreamConfig> buildUnnamed2924() {
...
void checkUnnamed2924(core.List<api.StreamConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.FhirStore buildFhirStore() {
  ...
  if (buildCounterFhirStore < 3) {
    ...
    o.name = 'foo';
    o.notificationConfig = buildNotificationConfig();
    o.streamConfigs = buildUnnamed2924();
    o.version = 'foo';
  }
  buildCounterFhirStore--;
  return o;
...
void checkFhirStore(api.FhirStore o) {
  ...
  if (buildCounterFhirStore < 3) {
    ...
    unittest.expect(o.name, unittest.equals('foo'));
    checkNotificationConfig(o.notificationConfig as api.NotificationConfig);
    checkUnnamed2924(o.streamConfigs);
...
core.Map<core.String, core.String> buildUnnamed2926() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed2926(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o['x'], unittest.equals('foo'));
  unittest.expect(o['y'], unittest.equals('foo'));
}

core.List<api.Hl7V2NotificationConfig> buildUnnamed2927() {
  var o = <api.Hl7V2NotificationConfig>[];
...
void checkUnnamed2927(core.List<api.Hl7V2NotificationConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Hl7V2Store buildHl7V2Store() {
  ...
  if (buildCounterHl7V2Store < 3) {
    ...
    o.name = 'foo';
    o.notificationConfigs = buildUnnamed2927();
...
void checkHl7V2Store(api.Hl7V2Store o) {
  ...
  if (buildCounterHl7V2Store < 3) {
    ...
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed2927(o.notificationConfigs);
...
core.Map<core.String, core.Object> buildUnnamed2928() {
...
void checkUnnamed2928(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed2929() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed2928());
  o.add(buildUnnamed2928());
  return o;
}

void checkUnnamed2929(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2928(o[0]);
  checkUnnamed2928(o[1]);
}
...
core.List<api.Dataset> buildUnnamed2931() {
  var o = <api.Dataset>[];
  o.add(buildDataset());
  o.add(buildDataset());
  return o;
...
void checkUnnamed2931(core.List<api.Dataset> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListDatasetsResponse(api.ListDatasetsResponse o) {
  buildCounterListDatasetsResponse++;
  if (buildCounterListDatasetsResponse < 3) {
    checkUnnamed2931(o.datasets);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListDatasetsResponse--;
}

core.List<api.DicomStore> buildUnnamed2932() {
  var o = <api.DicomStore>[];
...
void checkUnnamed2932(core.List<api.DicomStore> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListDicomStoresResponse buildListDicomStoresResponse() {
  ...
  if (buildCounterListDicomStoresResponse < 3) {
    o.dicomStores = buildUnnamed2932();
    o.nextPageToken = 'foo';
  }
  buildCounterListDicomStoresResponse--;
  return o;
...
void checkListDicomStoresResponse(api.ListDicomStoresResponse o) {
  buildCounterListDicomStoresResponse++;
  if (buildCounterListDicomStoresResponse < 3) {
    checkUnnamed2932(o.dicomStores);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListDicomStoresResponse--;
}

core.List<api.FhirStore> buildUnnamed2933() {
  var o = <api.FhirStore>[];
...
void checkUnnamed2933(core.List<api.FhirStore> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListFhirStoresResponse(api.ListFhirStoresResponse o) {
  buildCounterListFhirStoresResponse++;
  if (buildCounterListFhirStoresResponse < 3) {
    checkUnnamed2933(o.fhirStores);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListFhirStoresResponse--;
}

core.List<api.Hl7V2Store> buildUnnamed2934() {
  var o = <api.Hl7V2Store>[];
...
void checkUnnamed2934(core.List<api.Hl7V2Store> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListHl7V2StoresResponse buildListHl7V2StoresResponse() {
  ...
  if (buildCounterListHl7V2StoresResponse < 3) {
    o.hl7V2Stores = buildUnnamed2934();
    o.nextPageToken = 'foo';
  }
  buildCounterListHl7V2StoresResponse--;
  return o;
...
void checkListHl7V2StoresResponse(api.ListHl7V2StoresResponse o) {
  buildCounterListHl7V2StoresResponse++;
  if (buildCounterListHl7V2StoresResponse < 3) {
    checkUnnamed2934(o.hl7V2Stores);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListHl7V2StoresResponse--;
}

core.List<api.Location> buildUnnamed2935() {
  var o = <api.Location>[];
  o.add(buildLocation());
  o.add(buildLocation());
  return o;
...
void checkUnnamed2935(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Message> buildUnnamed2936() {
  var o = <api.Message>[];
  o.add(buildMessage());
  o.add(buildMessage());
  return o;
...
void checkUnnamed2936(core.List<api.Message> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListMessagesResponse buildListMessagesResponse() {
  ...
  if (buildCounterListMessagesResponse < 3) {
    o.hl7V2Messages = buildUnnamed2936();
    o.nextPageToken = 'foo';
  }
  buildCounterListMessagesResponse--;
  return o;
...
void checkListMessagesResponse(api.ListMessagesResponse o) {
  buildCounterListMessagesResponse++;
  if (buildCounterListMessagesResponse < 3) {
    checkUnnamed2936(o.hl7V2Messages);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListMessagesResponse--;
}

core.List<api.Operation> buildUnnamed2937() {
  var o = <api.Operation>[];
...
void checkUnnamed2937(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed2939() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed2939(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.PatientId> buildUnnamed2941() {
  var o = <api.PatientId>[];
...
void checkUnnamed2941(core.List<api.PatientId> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed2942() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed2942(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed2943() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed2943(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed2942();
    o.name = 'foo';
    o.response = buildUnnamed2943();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkUnnamed2942(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed2943(o.response);
  }
  buildCounterOperation--;
}
...
core.List<api.Segment> buildUnnamed2944() {
  var o = <api.Segment>[];
  o.add(buildSegment());
  o.add(buildSegment());
  return o;
...
void checkUnnamed2944(core.List<api.Segment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.AuditConfig> buildUnnamed2945() {
  var o = <api.AuditConfig>[];
...
void checkUnnamed2945(core.List<api.AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAuditConfig(o[0] as api.AuditConfig);
  checkAuditConfig(o[1] as api.AuditConfig);
}

core.List<api.Binding> buildUnnamed2946() {
  var o = <api.Binding>[];
  o.add(buildBinding());
  o.add(buildBinding());
  return o;
...
void checkUnnamed2946(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Policy buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.auditConfigs = buildUnnamed2945();
    o.bindings = buildUnnamed2946();
    o.etag = 'foo';
    o.version = 42;
  }
  buildCounterPolicy--;
...
void checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed2945(o.auditConfigs);
    checkUnnamed2946(o.bindings);
...
api.StreamConfig buildStreamConfig() {
  ...
  if (buildCounterStreamConfig < 3) {
    o.bigqueryDestination =
        buildGoogleCloudHealthcareV1FhirBigQueryDestination();
    o.resourceTypes = buildUnnamed2951();
  }
  buildCounterStreamConfig--;
  return o;
}
...
void checkStreamConfig(api.StreamConfig o) {
  ...
  if (buildCounterStreamConfig < 3) {
    checkGoogleCloudHealthcareV1FhirBigQueryDestination(o.bigqueryDestination
        as api.GoogleCloudHealthcareV1FhirBigQueryDestination);
    checkUnnamed2951(o.resourceTypes);
  }
  buildCounterStreamConfig--;
}
...
api.TestIamPermissionsResponse buildTestIamPermissionsResponse() {
  ...
  if (buildCounterTestIamPermissionsResponse < 3) {
    o.permissions = buildUnnamed2954();
  }
  buildCounterTestIamPermissionsResponse--;
  return o;
}
...
void checkTestIamPermissionsResponse(api.TestIamPermissionsResponse o) {
  buildCounterTestIamPermissionsResponse++;
  if (buildCounterTestIamPermissionsResponse < 3) {
    checkUnnamed2954(o.permissions);
  }
  buildCounterTestIamPermissionsResponse--;
}

core.List<api.InfoTypeTransformation> buildUnnamed2955() {
  var o = <api.InfoTypeTransformation>[];
...
void checkUnnamed2955(core.List<api.InfoTypeTransformation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TextConfig buildTextConfig() {
  ...
  if (buildCounterTextConfig < 3) {
    o.transformations = buildUnnamed2955();
  }
  buildCounterTextConfig--;
  return o;
}
...
void checkTextConfig(api.TextConfig o) {
  buildCounterTextConfig++;
  if (buildCounterTextConfig < 3) {
    checkUnnamed2955(o.transformations);
  }
  buildCounterTextConfig--;
}
