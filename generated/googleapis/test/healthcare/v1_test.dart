...
core.List<api.Entity> buildUnnamed2() => [
      buildEntity(),
      buildEntity(),
    ];
...
core.List<api.Type> buildUnnamed43() => [
      buildType(),
      buildType(),
    ];
...
core.List<api.Consent> buildUnnamed53() => [
      buildConsent(),
      buildConsent(),
    ];
...
core.List<api.Consent> buildUnnamed55() => [
      buildConsent(),
      buildConsent(),
    ];
...
core.List<api.Dataset> buildUnnamed56() => [
      buildDataset(),
      buildDataset(),
    ];
...
core.List<api.Location> buildUnnamed60() => [
      buildLocation(),
      buildLocation(),
    ];
...
core.List<api.UserDataMapping> buildUnnamed63() => [
      buildUserDataMapping(),
      buildUserDataMapping(),
    ];

void checkUnnamed63(core.List<api.UserDataMapping> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListUserDataMappingsResponse buildListUserDataMappingsResponse() {
  ...
  if (buildCounterListUserDataMappingsResponse < 3) {
    o.nextPageToken = 'foo';
    o.userDataMappings = buildUnnamed63();
  }
  buildCounterListUserDataMappingsResponse--;
  return o;
}
...
void checkListUserDataMappingsResponse(api.ListUserDataMappingsResponse o) {
  ...
  if (buildCounterListUserDataMappingsResponse < 3) {
    ...
    checkUnnamed63(o.userDataMappings!);
  }
  buildCounterListUserDataMappingsResponse--;
}
...
core.List<api.PatientId> buildUnnamed67() => [
      buildPatientId(),
      buildPatientId(),
    ];

void checkUnnamed67(core.List<api.PatientId> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPatientId(o[0]);
  checkPatientId(o[1]);
}
...
core.List<api.Segment> buildUnnamed70() => [
      buildSegment(),
      buildSegment(),
    ];

void checkUnnamed70(core.List<api.Segment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSegment(o[0]);
  checkSegment(o[1]);
}
...
api.QueryAccessibleDataRequest buildQueryAccessibleDataRequest() {
  ...
  if (buildCounterQueryAccessibleDataRequest < 3) {
    ...
    o.requestAttributes = buildUnnamed74();
    o.resourceAttributes = buildUnnamed75();
  }
  buildCounterQueryAccessibleDataRequest--;
  return o;
}
...
void checkQueryAccessibleDataRequest(api.QueryAccessibleDataRequest o) {
  ...
  if (buildCounterQueryAccessibleDataRequest < 3) {
    ...
    checkUnnamed74(o.requestAttributes!);
    checkUnnamed75(o.resourceAttributes!);
  }
  buildCounterQueryAccessibleDataRequest--;
}
...
core.Map<core.String, api.ConsentEvaluation> buildUnnamed77() => {
      'x': buildConsentEvaluation(),
      'y': buildConsentEvaluation(),
    };

void checkUnnamed77(core.Map<core.String, api.ConsentEvaluation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkConsentEvaluation(o['x']!);
  checkConsentEvaluation(o['y']!);
}
...
api.Result buildResult() {
  ...
  if (buildCounterResult < 3) {
    o.consentDetails = buildUnnamed77();
    o.consented = true;
    o.dataId = 'foo';
  }
  buildCounterResult--;
...
void checkResult(api.Result o) {
  buildCounterResult++;
  if (buildCounterResult < 3) {
    checkUnnamed77(o.consentDetails!);
    unittest.expect(o.consented!, unittest.isTrue);
    unittest.expect(
      o.dataId!,
      unittest.equals('foo'),
...
core.List<api.GroupOrSegment> buildUnnamed81() => [
      buildGroupOrSegment(),
      buildGroupOrSegment(),
    ];

void checkUnnamed81(core.List<api.GroupOrSegment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Hl7SchemaConfig> buildUnnamed82() => [
      buildHl7SchemaConfig(),
      buildHl7SchemaConfig(),
    ];

void checkUnnamed82(core.List<api.Hl7SchemaConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHl7SchemaConfig(o[0]);
  checkHl7SchemaConfig(o[1]);
}

core.List<api.Hl7TypesConfig> buildUnnamed83() => [
      buildHl7TypesConfig(),
      buildHl7TypesConfig(),
    ];

void checkUnnamed83(core.List<api.Hl7TypesConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.StreamConfig buildStreamConfig() {
  ...
  if (buildCounterStreamConfig < 3) {
    ...
    o.resourceTypes = buildUnnamed88();
  }
  buildCounterStreamConfig--;
  return o;
}
...
void checkStreamConfig(api.StreamConfig o) {
  ...
  if (buildCounterStreamConfig < 3) {
    ...
    checkUnnamed88(o.resourceTypes!);
  }
  buildCounterStreamConfig--;
}
...
core.List<api.InfoTypeTransformation> buildUnnamed92() => [
      buildInfoTypeTransformation(),
      buildInfoTypeTransformation(),
    ];

void checkUnnamed92(core.List<api.InfoTypeTransformation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.InfoTypeTransformation> buildUnnamed94() => [
      buildInfoTypeTransformation(),
      buildInfoTypeTransformation(),
    ];

void checkUnnamed94(core.List<api.InfoTypeTransformation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInfoTypeTransformation(o[0]);
  checkInfoTypeTransformation(o[1]);
}
...
api.TextConfig buildTextConfig() {
  ...
  if (buildCounterTextConfig < 3) {
    o.additionalTransformations = buildUnnamed92();
    o.excludeInfoTypes = buildUnnamed93();
    o.transformations = buildUnnamed94();
  }
  buildCounterTextConfig--;
  return o;
}
...
void checkTextConfig(api.TextConfig o) {
  buildCounterTextConfig++;
  if (buildCounterTextConfig < 3) {
    checkUnnamed92(o.additionalTransformations!);
    checkUnnamed93(o.excludeInfoTypes!);
    checkUnnamed94(o.transformations!);
  }
  buildCounterTextConfig--;
}
...
core.List<api.Attribute> buildUnnamed96() => [
      buildAttribute(),
      buildAttribute(),
    ];

void checkUnnamed96(core.List<api.Attribute> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttribute(o[0]);
  checkAttribute(o[1]);
}
...
api.UserDataMapping buildUserDataMapping() {
  ...
  if (buildCounterUserDataMapping < 3) {
    ...
    o.dataId = 'foo';
    o.name = 'foo';
    o.resourceAttributes = buildUnnamed96();
    o.userId = 'foo';
  }
  buildCounterUserDataMapping--;
  return o;
...
void checkUserDataMapping(api.UserDataMapping o) {
  ...
  if (buildCounterUserDataMapping < 3) {
    ...
    checkUnnamed96(o.resourceAttributes!);
    unittest.expect(
      o.userId!,
      unittest.equals('foo'),
    );
...
api.ValidationConfig buildValidationConfig() {
  ...
  if (buildCounterValidationConfig < 3) {
    ...
    o.enabledImplementationGuides = buildUnnamed97();
  }
  buildCounterValidationConfig--;
  return o;
}
...
void checkValidationConfig(api.ValidationConfig o) {
  ...
  if (buildCounterValidationConfig < 3) {
    ...
    checkUnnamed97(o.enabledImplementationGuides!);
  }
  buildCounterValidationConfig--;
}
...
void main() {
  ...
  unittest.group('resource-ProjectsLocationsDatasetsDicomStoresResource', () {
    ...
    unittest.test('method--getDICOMStoreMetrics', () async {
      ...
      final response =
          await res.getDICOMStoreMetrics(arg_name, $fields: arg_$fields);
  ...
  unittest.group(
    ...
    unittest.test('method--getStudyMetrics', () async {
      ...
      final response =
          await res.getStudyMetrics(arg_study, $fields: arg_$fields);
  ...
  unittest.group(
    ...
    unittest.test('method--getSeriesMetrics', () async {
      ...
      final response =
          await res.getSeriesMetrics(arg_series, $fields: arg_$fields);
  ...
  unittest.group(
    ...
    unittest.test('method--getStorageInfo', () async {
      ...
      final response =
          await res.getStorageInfo(arg_resource, $fields: arg_$fields);
  ...
  unittest.group(
    ...
    unittest.test('method--retrieveRendered', () async {
      ...
      final response = await res.retrieveRendered(arg_parent, arg_dicomWebPath,
          viewport: arg_viewport, $fields: arg_$fields);
      checkHttpBody(response as api.HttpBody);
    });
  });
  ...
  unittest.group(
    ...
    unittest.test('method--retrieveBulkdata', () async {
      ...
      final response = await res.retrieveBulkdata(arg_parent, arg_dicomWebPath,
          $fields: arg_$fields);
      checkHttpBody(response as api.HttpBody);
    });
  });
  ...
  unittest.group('resource-ProjectsLocationsDatasetsFhirStoresResource', () {
    unittest.test('method--applyAdminConsents', () async {
      ...
      final response = await res.applyAdminConsents(arg_request, arg_name,
          $fields: arg_$fields);
      checkOperation(response as api.Operation);
    });
    ...
    unittest.test('method--applyConsents', () async {
      ...
      final response =
          await res.applyConsents(arg_request, arg_name, $fields: arg_$fields);
      checkOperation(response as api.Operation);
    });
    ...
    unittest.test('method--bulkExportGroup', () async {
      ...
      final response = await res.bulkExportGroup(arg_name,
          P_since: arg_P_since,
          P_type: arg_P_type,
    ...
    unittest.test('method--explainDataAccess', () async {
      ...
      final response = await res.explainDataAccess(arg_name,
          resourceId: arg_resourceId, $fields: arg_$fields);
    ...
    unittest.test('method--getFHIRStoreMetrics', () async {
      ...
      final response =
          await res.getFHIRStoreMetrics(arg_name, $fields: arg_$fields);
  ...
  unittest.group('resource-ProjectsLocationsDatasetsFhirStoresFhirResource',
    ...
    unittest.test('method--BinaryCreate', () async {
      ...
      final response =
          await res.BinaryCreate(arg_request, arg_parent, $fields: arg_$fields);
      checkHttpBody(response as api.HttpBody);
    });
    ...
    unittest.test('method--BinaryUpdate', () async {
      ...
      final response =
          await res.BinaryUpdate(arg_request, arg_name, $fields: arg_$fields);
      checkHttpBody(response as api.HttpBody);
    });
    ...
    unittest.test('method--ConsentEnforcementStatus', () async {
      ...
      final response =
          await res.ConsentEnforcementStatus(arg_name, $fields: arg_$fields);
      checkHttpBody(response as api.HttpBody);
    });
    ...
    unittest.test('method--PatientConsentEnforcementStatus', () async {
      ...
      final response = await res.PatientConsentEnforcementStatus(arg_name,
          P_count: arg_P_count,
    ...
    unittest.test('method--bulkExport', () async {
      ...
      final response = await res.bulkExport(arg_name,
          P_since: arg_P_since,
          P_type: arg_P_type,
          outputFormat: arg_outputFormat,
          $fields: arg_$fields);
    ...
    unittest.test('method--conditionalDelete', () async {
      ...
      final response = await res.conditionalDelete(arg_parent, arg_type,
          $fields: arg_$fields);
      checkEmpty(response as api.Empty);
    });
  ...
  unittest.group(
    ...
    unittest.test('method--deleteFhirOperation', () async {
      ...
      final response =
          await res.deleteFhirOperation(arg_name, $fields: arg_$fields);
      checkHttpBody(response as api.HttpBody);
    });
    ...
    unittest.test('method--getFhirOperationStatus', () async {
      ...
      final response =
          await res.getFhirOperationStatus(arg_name, $fields: arg_$fields);
      checkHttpBody(response as api.HttpBody);
    });
  });
  ...
  unittest.group('resource-ProjectsLocationsDatasetsHl7V2StoresResource', () {
    ...
    unittest.test('method--getHL7v2StoreMetrics', () async {
      ...
      final response =
          await res.getHL7v2StoreMetrics(arg_name, $fields: arg_$fields);
