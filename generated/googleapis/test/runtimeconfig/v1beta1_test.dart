...
import 'package:googleapis/runtimeconfig/v1beta1.dart' as api;
...
api.Cardinality buildCardinality() {
  final o = api.Cardinality();
...
void checkCardinality(api.Cardinality o) {
  buildCounterCardinality++;
  if (buildCounterCardinality < 3) {
...
api.EndCondition buildEndCondition() {
  final o = api.EndCondition();
...
core.List<api.RuntimeConfig> buildUnnamed1() => [
  buildRuntimeConfig(),
  buildRuntimeConfig(),
];

void checkUnnamed1(core.List<api.RuntimeConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListConfigsResponse buildListConfigsResponse() {
  final o = api.ListConfigsResponse();
...
void checkListConfigsResponse(api.ListConfigsResponse o) {
  buildCounterListConfigsResponse++;
  if (buildCounterListConfigsResponse < 3) {
...
core.List<api.Variable> buildUnnamed2() => [buildVariable(), buildVariable()];

void checkUnnamed2(core.List<api.Variable> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVariable(o[0]);
  checkVariable(o[1]);
}
...
core.List<api.Waiter> buildUnnamed3() => [buildWaiter(), buildWaiter()];

void checkUnnamed3(core.List<api.Waiter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWaiter(o[0]);
  checkWaiter(o[1]);
}
...
api.ListWaitersResponse buildListWaitersResponse() {
  final o = api.ListWaitersResponse();
  buildCounterListWaitersResponse++;
  if (buildCounterListWaitersResponse < 3) {
    o.nextPageToken = 'foo';
    o.waiters = buildUnnamed3();
  }
  buildCounterListWaitersResponse--;
  return o;
}

void checkListWaitersResponse(api.ListWaitersResponse o) {
  buildCounterListWaitersResponse++;
  if (buildCounterListWaitersResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed3(o.waiters!);
  }
  buildCounterListWaitersResponse--;
}
...
api.WatchVariableRequest buildWatchVariableRequest() {
  final o = api.WatchVariableRequest();
...
void checkWatchVariableRequest(api.WatchVariableRequest o) {
  buildCounterWatchVariableRequest++;
  if (buildCounterWatchVariableRequest < 3) {
...
void main() {
  ...
  unittest.group('obj-schema-Cardinality', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCardinality();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Cardinality.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCardinality(od);
    });
  ...
  unittest.group('obj-schema-EndCondition', () {
    unittest.test('to-json--from-json', () async {
      final o = buildEndCondition();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.EndCondition.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
  ...
  unittest.group('obj-schema-ListConfigsResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildListConfigsResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListConfigsResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
  ...
  unittest.group('obj-schema-ListWaitersResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildListWaitersResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListWaitersResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
  ...
  unittest.group('obj-schema-WatchVariableRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildWatchVariableRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.WatchVariableRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
  ...
  unittest.group('resource-ProjectsConfigsResource', () {
    unittest.test('method--create', () async {
      ...
      final res = api.CloudRuntimeConfigApi(mock).projects.configs;
      final arg_request = buildRuntimeConfig();
      final arg_parent = 'foo';
      final arg_requestId = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.RuntimeConfig.fromJson(
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildListConfigsResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
  ...
  unittest.group('resource-ProjectsConfigsOperationsResource', () {
    unittest.test('method--get', () async {
      final mock = HttpServerMock();
      final res = api.CloudRuntimeConfigApi(mock).projects.configs.operations;
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
  ...
  unittest.group('resource-ProjectsConfigsVariablesResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.CloudRuntimeConfigApi(mock).projects.configs.variables;
    ...
    unittest.test('method--watch', () async {
      final mock = HttpServerMock();
      final res = api.CloudRuntimeConfigApi(mock).projects.configs.variables;
      final arg_request = buildWatchVariableRequest();
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.WatchVariableRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
  ...
  unittest.group('resource-ProjectsConfigsWaitersResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.CloudRuntimeConfigApi(mock).projects.configs.waiters;
      final arg_request = buildWaiter();
      final arg_parent = 'foo';
      final arg_requestId = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Waiter.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkWaiter(obj);
    ...
    unittest.test('method--get', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildWaiter());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildListWaitersResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
