...
checkUnnamed1049(core.List<core.Object> o) {
...
buildSearchResponse() {
  ...
  if (buildCounterSearchResponse < 3) {
    ...
    o.itemListElement = buildUnnamed1049();
...
checkSearchResponse(api.SearchResponse o) {
  ...
  if (buildCounterSearchResponse < 3) {
    ...
    checkUnnamed1049(o.itemListElement);
...
main() {
  ...
  unittest.group("resource-EntitiesResourceApi", () {
    unittest.test("method--search", () {
      ...
      var arg_languages = buildUnnamed1051();
      var arg_types = buildUnnamed1052();
      var arg_indent = true;
      var arg_prefix = true;
      var arg_limit = 42;
