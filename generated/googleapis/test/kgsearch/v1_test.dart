...
buildSearchResponse() {
  ...
  if (buildCounterSearchResponse < 3) {
    ...
    o.itemListElement = buildUnnamed2487();
...
checkSearchResponse(api.SearchResponse o) {
  ...
  if (buildCounterSearchResponse < 3) {
    ...
    checkUnnamed2487(o.itemListElement);
...
main() {
  ...
  unittest.group("resource-EntitiesResourceApi", () {
    unittest.test("method--search", () {
      ...
      var arg_query = "foo";
      var arg_ids = buildUnnamed2488();
      var arg_languages = buildUnnamed2489();
      var arg_types = buildUnnamed2490();
      var arg_indent = true;
      var arg_prefix = true;
      var arg_limit = 42;
