...
checkUnnamed4325(core.List<core.Object> o) {
...
buildSearchResponse() {
  ...
  if (buildCounterSearchResponse < 3) {
    ...
    o.itemListElement = buildUnnamed4325();
  }
  buildCounterSearchResponse--;
  return o;
}
...
checkSearchResponse(api.SearchResponse o) {
  ...
  if (buildCounterSearchResponse < 3) {
    ...
    checkUnnamed4325(o.itemListElement);
  }
  buildCounterSearchResponse--;
}
...
main() {
  ...
  unittest.group("resource-EntitiesResourceApi", () {
    unittest.test("method--search", () {
      ...
      var arg_types = buildUnnamed4326();
      var arg_indent = true;
      var arg_languages = buildUnnamed4327();
      var arg_ids = buildUnnamed4328();
      var arg_limit = 42;
      var arg_prefix = true;
      var arg_query = "foo";
      var arg_$fields = "foo";
