...
checkUnnamed1618(core.List<core.Object> o) {
...
buildSearchResponse() {
  ...
  if (buildCounterSearchResponse < 3) {
    ...
    o.itemListElement = buildUnnamed1618();
  }
  buildCounterSearchResponse--;
  return o;
}
...
checkSearchResponse(api.SearchResponse o) {
  ...
  if (buildCounterSearchResponse < 3) {
    ...
    checkUnnamed1618(o.itemListElement);
  }
  buildCounterSearchResponse--;
}
...
main() {
  ...
  unittest.group("resource-EntitiesResourceApi", () {
    unittest.test("method--search", () {
      ...
      var arg_query = "foo";
      var arg_types = buildUnnamed1619();
      var arg_indent = true;
      var arg_languages = buildUnnamed1620();
