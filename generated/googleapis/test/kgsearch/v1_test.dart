...
checkUnnamed365(core.List<core.Object> o) {
...
buildSearchResponse() {
  ...
  if (buildCounterSearchResponse < 3) {
    ...
    o.itemListElement = buildUnnamed365();
  }
  buildCounterSearchResponse--;
  return o;
}
...
checkSearchResponse(api.SearchResponse o) {
  ...
  if (buildCounterSearchResponse < 3) {
    ...
    checkUnnamed365(o.itemListElement);
  }
  buildCounterSearchResponse--;
}
...
main() {
  ...
  unittest.group("resource-EntitiesResourceApi", () {
    unittest.test("method--search", () {
      ...
      var arg_prefix = true;
      var arg_query = "foo";
      var arg_types = buildUnnamed366();
      var arg_indent = true;
      var arg_languages = buildUnnamed367();
