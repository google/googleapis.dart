...
checkUnnamed1498(core.List<core.Object> o) {
...
buildSearchResponse() {
  ...
  if (buildCounterSearchResponse < 3) {
    ...
    o.itemListElement = buildUnnamed1498();
...
checkSearchResponse(api.SearchResponse o) {
  ...
  if (buildCounterSearchResponse < 3) {
    ...
    checkUnnamed1498(o.itemListElement);
...
main() {
  ...
  unittest.group("resource-EntitiesResourceApi", () {
    unittest.test("method--search", () {
      ...
      var arg_languages = buildUnnamed1500();
      var arg_types = buildUnnamed1501();
      var arg_indent = true;
      var arg_prefix = true;
      var arg_limit = 42;
