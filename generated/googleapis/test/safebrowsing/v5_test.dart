...
void checkGoogleSecuritySafebrowsingV5HashListMetadata(
  ...
  if (buildCounterGoogleSecuritySafebrowsingV5HashListMetadata < 3) {
    ...
    unittest.expect(o.hashLength!, unittest.equals('foo'));
...
void checkGoogleSecuritySafebrowsingV5RiceDeltaEncoded128Bit(
  ...
  if (buildCounterGoogleSecuritySafebrowsingV5RiceDeltaEncoded128Bit < 3) {
    ...
    unittest.expect(o.entriesCount!, unittest.equals(42));
    unittest.expect(o.firstValueHi!, unittest.equals('foo'));
    unittest.expect(o.firstValueLo!, unittest.equals('foo'));
...
void checkGoogleSecuritySafebrowsingV5RiceDeltaEncoded256Bit(
  ...
  if (buildCounterGoogleSecuritySafebrowsingV5RiceDeltaEncoded256Bit < 3) {
    unittest.expect(o.encodedData!, unittest.equals('foo'));
    unittest.expect(o.entriesCount!, unittest.equals(42));
    unittest.expect(o.firstValueFirstPart!, unittest.equals('foo'));
    unittest.expect(o.firstValueFourthPart!, unittest.equals('foo'));
    unittest.expect(o.firstValueSecondPart!, unittest.equals('foo'));
    unittest.expect(o.firstValueThirdPart!, unittest.equals('foo'));
    unittest.expect(o.riceParameter!, unittest.equals(42));
  }
  buildCounterGoogleSecuritySafebrowsingV5RiceDeltaEncoded256Bit--;
}
...
void checkGoogleSecuritySafebrowsingV5RiceDeltaEncoded32Bit(
  ...
  if (buildCounterGoogleSecuritySafebrowsingV5RiceDeltaEncoded32Bit < 3) {
    unittest.expect(o.encodedData!, unittest.equals('foo'));
    unittest.expect(o.entriesCount!, unittest.equals(42));
    unittest.expect(o.firstValue!, unittest.equals(42));
    unittest.expect(o.riceParameter!, unittest.equals(42));
  }
  buildCounterGoogleSecuritySafebrowsingV5RiceDeltaEncoded32Bit--;
}
...
void main() {
  ...
  unittest.group(
    'obj-schema-GoogleSecuritySafebrowsingV5ListHashListsResponse',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleSecuritySafebrowsingV5RiceDeltaEncoded32Bit',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleSecuritySafebrowsingV5RiceDeltaEncoded64Bit',
    () {
      unittest.test('to-json--from-json', () async {
    ...
    unittest.test('method--get', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            core.int.parse(
              queryMap['sizeConstraints.maxDatabaseEntries']!.first,
            ),
      ...
      final response = await res.get(
        ...
        sizeConstraints_maxUpdateEntries: arg_sizeConstraints_maxUpdateEntries,
        version: arg_version,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--batchGet', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(queryMap['version']!, unittest.equals(arg_version));
          unittest.expect(
            queryMap['fields']!.first,
            unittest.equals(arg_$fields),
          );
      ...
      checkGoogleSecuritySafebrowsingV5BatchGetHashListsResponse(
        response as api.GoogleSecuritySafebrowsingV5BatchGetHashListsResponse,
      );
    });
