...
checkUnnamed844(core.List<api.FieldMask> o) {
...
checkUnnamed846(core.List<api.MobileAppPanel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed847(core.List<api.FieldMask> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFieldMask(o[0]);
  checkFieldMask(o[1]);
}
...
checkUnnamed849(core.List<api.SurveyQuestion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSurvey() {
  ...
  if (buildCounterSurvey < 3) {
    ...
    o.customerData = "foo";
    o.description = "foo";
    o.owners = buildUnnamed848();
    o.questions = buildUnnamed849();
    o.state = "foo";
    o.surveyUrlId = "foo";
    o.title = "foo";
...
checkSurvey(api.Survey o) {
  ...
  if (buildCounterSurvey < 3) {
    ...
    checkUnnamed848(o.owners);
    checkUnnamed849(o.questions);
...
buildSurveyAudience() {
  ...
  if (buildCounterSurveyAudience < 3) {
    o.ages = buildUnnamed850();
    o.country = "foo";
    o.countrySubdivision = "foo";
    o.gender = "foo";
    o.languages = buildUnnamed851();
    o.mobileAppPanelId = "foo";
...
checkUnnamed853(core.List<api.SurveyQuestionImage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkSurveyQuestion(api.SurveyQuestion o) {
  ...
  if (buildCounterSurveyQuestion < 3) {
    ...
    checkUnnamed854(o.openTextSuggestions);
    ...
    checkUnnamed855(o.thresholdAnswers);
...
checkUnnamed856(core.List<api.Survey> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSurvey(o[0]);
  checkSurvey(o[1]);
}
