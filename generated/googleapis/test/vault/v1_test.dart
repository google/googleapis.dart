...
buildAddHeldAccountsRequest() {
  ...
  if (buildCounterAddHeldAccountsRequest < 3) {
    o.accountIds = buildUnnamed2308();
    o.emails = buildUnnamed2309();
  }
  buildCounterAddHeldAccountsRequest--;
  return o;
}
...
checkAddHeldAccountsRequest(api.AddHeldAccountsRequest o) {
  buildCounterAddHeldAccountsRequest++;
  if (buildCounterAddHeldAccountsRequest < 3) {
    checkUnnamed2308(o.accountIds);
    checkUnnamed2309(o.emails);
  }
  buildCounterAddHeldAccountsRequest--;
}
...
checkUnnamed2310(core.List<api.AddHeldAccountResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2311(core.List<api.CloudStorageFile> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2313(core.List<api.HeldAccount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2314(core.List<api.Export> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkExport(o[0]);
  checkExport(o[1]);
}
...
checkUnnamed2315(core.List<api.HeldAccount> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHeldAccount(o[0]);
  checkHeldAccount(o[1]);
}
...
checkUnnamed2316(core.List<api.Hold> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHold(o[0]);
  checkHold(o[1]);
}
...
checkUnnamed2317(core.List<api.Matter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMatter(o[0]);
  checkMatter(o[1]);
}
...
checkUnnamed2318(core.List<api.MatterPermission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildMatter() {
  ...
  if (buildCounterMatter < 3) {
    o.description = "foo";
    o.matterId = "foo";
    o.matterPermissions = buildUnnamed2318();
    o.name = "foo";
    o.state = "foo";
  }
  buildCounterMatter--;
...
checkMatter(api.Matter o) {
  ...
  if (buildCounterMatter < 3) {
    ...
    unittest.expect(o.matterId, unittest.equals('foo'));
    checkUnnamed2318(o.matterPermissions);
    unittest.expect(o.name, unittest.equals('foo'));
...
checkUnnamed2320(core.List<api.Status> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatus(o[0]);
  checkStatus(o[1]);
}
...
checkUnnamed2321(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2322(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildTeamDriveInfo() {
  ...
  if (buildCounterTeamDriveInfo < 3) {
    o.teamDriveIds = buildUnnamed2323();
  }
  buildCounterTeamDriveInfo--;
  return o;
}
...
checkTeamDriveInfo(api.TeamDriveInfo o) {
  buildCounterTeamDriveInfo++;
  if (buildCounterTeamDriveInfo < 3) {
    checkUnnamed2323(o.teamDriveIds);
  }
  buildCounterTeamDriveInfo--;
}
