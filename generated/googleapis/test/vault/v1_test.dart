...
core.int buildCounterCalendarExportOptions = 0;
api.CalendarExportOptions buildCalendarExportOptions() {
  final o = api.CalendarExportOptions();
  buildCounterCalendarExportOptions++;
  if (buildCounterCalendarExportOptions < 3) {
    o.exportFormat = 'foo';
  }
  buildCounterCalendarExportOptions--;
  return o;
...
void checkCalendarExportOptions(api.CalendarExportOptions o) {
  buildCounterCalendarExportOptions++;
  if (buildCounterCalendarExportOptions < 3) {
...
core.int buildCounterCalendarOptions = 0;
api.CalendarOptions buildCalendarOptions() {
  final o = api.CalendarOptions();
  buildCounterCalendarOptions++;
  if (buildCounterCalendarOptions < 3) {
    o.locationQuery = buildUnnamed4();
    o.minusWords = buildUnnamed5();
    o.peopleQuery = buildUnnamed6();
    o.responseStatuses = buildUnnamed7();
    o.versionDate = 'foo';
  }
  buildCounterCalendarOptions--;
  return o;
...
void checkCalendarOptions(api.CalendarOptions o) {
  buildCounterCalendarOptions++;
  if (buildCounterCalendarOptions < 3) {
    checkUnnamed4(o.locationQuery!);
    checkUnnamed5(o.minusWords!);
    checkUnnamed6(o.peopleQuery!);
    checkUnnamed7(o.responseStatuses!);
...
core.List<api.CloudStorageFile> buildUnnamed8() => [
  buildCloudStorageFile(),
  buildCloudStorageFile(),
];

void checkUnnamed8(core.List<api.CloudStorageFile> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.int buildCounterDriveDocumentIds = 0;
api.DriveDocumentIds buildDriveDocumentIds() {
  final o = api.DriveDocumentIds();
  buildCounterDriveDocumentIds++;
  if (buildCounterDriveDocumentIds < 3) {
    o.ids = buildUnnamed9();
  }
  buildCounterDriveDocumentIds--;
  return o;
...
void checkDriveDocumentIds(api.DriveDocumentIds o) {
  buildCounterDriveDocumentIds++;
  if (buildCounterDriveDocumentIds < 3) {
    checkUnnamed9(o.ids!);
  }
...
core.int buildCounterDriveDocumentInfo = 0;
api.DriveDocumentInfo buildDriveDocumentInfo() {
  final o = api.DriveDocumentInfo();
  buildCounterDriveDocumentInfo++;
  if (buildCounterDriveDocumentInfo < 3) {
    o.documentIds = buildDriveDocumentIds();
  }
  buildCounterDriveDocumentInfo--;
  return o;
}

void checkDriveDocumentInfo(api.DriveDocumentInfo o) {
  buildCounterDriveDocumentInfo++;
  if (buildCounterDriveDocumentInfo < 3) {
    checkDriveDocumentIds(o.documentIds!);
  }
  buildCounterDriveDocumentInfo--;
}
...
void checkDriveOptions(api.DriveOptions o) {
  buildCounterDriveOptions++;
  if (buildCounterDriveOptions < 3) {
    unittest.expect(o.clientSideEncryptedOption!, unittest.equals('foo'));
    unittest.expect(o.includeSharedDrives!, unittest.isTrue);
    unittest.expect(o.includeTeamDrives!, unittest.isTrue);
    unittest.expect(o.sharedDrivesOption!, unittest.equals('foo'));
    unittest.expect(o.versionDate!, unittest.equals('foo'));
  }
  buildCounterDriveOptions--;
}
...
void checkExport(api.Export o) {
  ...
  if (buildCounterExport < 3) {
    ...
    unittest.expect(o.parentExportId!, unittest.equals('foo'));
    checkQuery(o.query!);
...
api.ExportOptions buildExportOptions() {
  ...
  if (buildCounterExportOptions < 3) {
    o.calendarOptions = buildCalendarExportOptions();
    o.driveOptions = buildDriveExportOptions();
    o.geminiOptions = buildGeminiExportOptions();
...
void checkExportOptions(api.ExportOptions o) {
  buildCounterExportOptions++;
  if (buildCounterExportOptions < 3) {
    checkCalendarExportOptions(o.calendarOptions!);
    checkDriveExportOptions(o.driveOptions!);
    checkGeminiExportOptions(o.geminiOptions!);
...
core.int buildCounterGeminiExportOptions = 0;
api.GeminiExportOptions buildGeminiExportOptions() {
  final o = api.GeminiExportOptions();
  buildCounterGeminiExportOptions++;
  if (buildCounterGeminiExportOptions < 3) {
    o.exportFormat = 'foo';
  }
  buildCounterGeminiExportOptions--;
  return o;
...
void checkGeminiExportOptions(api.GeminiExportOptions o) {
  buildCounterGeminiExportOptions++;
  if (buildCounterGeminiExportOptions < 3) {
    unittest.expect(o.exportFormat!, unittest.equals('foo'));
  }
...
core.int buildCounterGeminiOptions = 0;
api.GeminiOptions buildGeminiOptions() {
  final o = api.GeminiOptions();
  buildCounterGeminiOptions++;
  if (buildCounterGeminiOptions < 3) {}
  buildCounterGeminiOptions--;
  return o;
}

void checkGeminiOptions(api.GeminiOptions o) {
  buildCounterGeminiOptions++;
  if (buildCounterGeminiOptions < 3) {}
  buildCounterGeminiOptions--;
}
...
void checkHeldVoiceQuery(api.HeldVoiceQuery o) {
  buildCounterHeldVoiceQuery++;
  if (buildCounterHeldVoiceQuery < 3) {
    checkUnnamed11(o.coveredData!);
  }
  buildCounterHeldVoiceQuery--;
}

core.List<api.HeldAccount> buildUnnamed12() => [
  buildHeldAccount(),
  buildHeldAccount(),
];

void checkUnnamed12(core.List<api.HeldAccount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Export> buildUnnamed13() => [buildExport(), buildExport()];

void checkUnnamed13(core.List<api.Export> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkExport(o[0]);
  checkExport(o[1]);
}
...
void checkListExportsResponse(api.ListExportsResponse o) {
  buildCounterListExportsResponse++;
  if (buildCounterListExportsResponse < 3) {
    checkUnnamed13(o.exports!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListExportsResponse--;
}

core.List<api.HeldAccount> buildUnnamed14() => [
  buildHeldAccount(),
  buildHeldAccount(),
];

void checkUnnamed14(core.List<api.HeldAccount> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHeldAccount(o[0]);
  checkHeldAccount(o[1]);
}
...
core.List<api.Hold> buildUnnamed15() => [buildHold(), buildHold()];

void checkUnnamed15(core.List<api.Hold> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHold(o[0]);
  checkHold(o[1]);
}
...
void checkListHoldsResponse(api.ListHoldsResponse o) {
  buildCounterListHoldsResponse++;
  if (buildCounterListHoldsResponse < 3) {
    checkUnnamed15(o.holds!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListHoldsResponse--;
}

core.List<api.Matter> buildUnnamed16() => [buildMatter(), buildMatter()];

void checkUnnamed16(core.List<api.Matter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMatter(o[0]);
  checkMatter(o[1]);
}
...
void checkMailExportOptions(api.MailExportOptions o) {
  ...
  if (buildCounterMailExportOptions < 3) {
    unittest.expect(o.exportFormat!, unittest.equals('foo'));
    unittest.expect(o.exportLinkedDriveFiles!, unittest.isTrue);
...
core.List<api.MatterPermission> buildUnnamed20() => [
  buildMatterPermission(),
  buildMatterPermission(),
];

void checkUnnamed20(core.List<api.MatterPermission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Matter buildMatter() {
  ...
  if (buildCounterMatter < 3) {
    o.description = 'foo';
    o.matterId = 'foo';
    o.matterPermissions = buildUnnamed20();
    o.matterRegion = 'foo';
    o.name = 'foo';
    o.state = 'foo';
  }
...
void checkMatter(api.Matter o) {
  ...
  if (buildCounterMatter < 3) {
    ...
    unittest.expect(o.matterId!, unittest.equals('foo'));
    checkUnnamed20(o.matterPermissions!);
    unittest.expect(o.matterRegion!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
...
api.Query buildQuery() {
  ...
  if (buildCounterQuery < 3) {
    ...
    o.calendarOptions = buildCalendarOptions();
    o.corpus = 'foo';
    o.dataScope = 'foo';
    o.driveDocumentInfo = buildDriveDocumentInfo();
    o.driveOptions = buildDriveOptions();
    o.endTime = 'foo';
    o.geminiOptions = buildGeminiOptions();
...
void checkQuery(api.Query o) {
  ...
  if (buildCounterQuery < 3) {
    ...
    checkCalendarOptions(o.calendarOptions!);
    unittest.expect(o.corpus!, unittest.equals('foo'));
    unittest.expect(o.dataScope!, unittest.equals('foo'));
    checkDriveDocumentInfo(o.driveDocumentInfo!);
    checkDriveOptions(o.driveOptions!);
    unittest.expect(o.endTime!, unittest.equals('foo'));
    checkGeminiOptions(o.geminiOptions!);
...
api.SharedDriveInfo buildSharedDriveInfo() {
  ...
  if (buildCounterSharedDriveInfo < 3) {
    o.sharedDriveIds = buildUnnamed25();
  }
  buildCounterSharedDriveInfo--;
  return o;
}
...
void checkSharedDriveInfo(api.SharedDriveInfo o) {
  buildCounterSharedDriveInfo++;
  if (buildCounterSharedDriveInfo < 3) {
    checkUnnamed25(o.sharedDriveIds!);
  }
  buildCounterSharedDriveInfo--;
}
...
void main() {
  ...
  unittest.group('obj-schema-CalendarExportOptions', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCalendarExportOptions();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CalendarExportOptions.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCalendarExportOptions(od);
    });
  });

  unittest.group('obj-schema-CalendarOptions', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCalendarOptions();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CalendarOptions.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCalendarOptions(od);
    });
  });
  ...
  unittest.group('obj-schema-DriveDocumentIds', () {
    unittest.test('to-json--from-json', () async {
      final o = buildDriveDocumentIds();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.DriveDocumentIds.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkDriveDocumentIds(od);
    });
  });

  unittest.group('obj-schema-DriveDocumentInfo', () {
    unittest.test('to-json--from-json', () async {
      final o = buildDriveDocumentInfo();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.DriveDocumentInfo.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkDriveDocumentInfo(od);
    });
  });
  ...
  unittest.group('obj-schema-GeminiExportOptions', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGeminiExportOptions();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GeminiExportOptions.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGeminiExportOptions(od);
    });
  });

  unittest.group('obj-schema-GeminiOptions', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGeminiOptions();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GeminiOptions.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGeminiOptions(od);
    });
  });
  ...
  unittest.group('resource-MattersResource', () {
    unittest.test('method--addPermissions', () async {
      ...
      final response = await res.addPermissions(
        arg_request,
        arg_matterId,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--count', () async {
      ...
      final response = await res.count(
        arg_request,
        arg_matterId,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--removePermissions', () async {
      ...
      final response = await res.removePermissions(
        arg_request,
        arg_matterId,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--reopen', () async {
      ...
      final response = await res.reopen(
        arg_request,
        arg_matterId,
        $fields: arg_$fields,
      );
