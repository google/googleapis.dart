...
core.List<api.GuestUnitType> buildUnnamed4786() {
  var o = <api.GuestUnitType>[];
...
void checkUnnamed4786(core.List<api.GuestUnitType> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.LanguageSpoken> buildUnnamed4787() {
  var o = <api.LanguageSpoken>[];
...
void checkUnnamed4787(core.List<api.LanguageSpoken> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Services buildServices() {
  ...
  if (buildCounterServices < 3) {
    ...
    o.languagesSpoken = buildUnnamed4787();
...
void checkServices(api.Services o) {
  ...
  if (buildCounterServices < 3) {
    ...
    checkUnnamed4787(o.languagesSpoken!);
