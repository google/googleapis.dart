...
core.List<api.GuestUnitType> buildUnnamed3572() => [
      buildGuestUnitType(),
      buildGuestUnitType(),
    ];

void checkUnnamed3572(core.List<api.GuestUnitType> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.LanguageSpoken> buildUnnamed3573() => [
      buildLanguageSpoken(),
      buildLanguageSpoken(),
    ];

void checkUnnamed3573(core.List<api.LanguageSpoken> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Services buildServices() {
  ...
  if (buildCounterServices < 3) {
    ...
    o.languagesSpoken = buildUnnamed3573();
...
void checkServices(api.Services o) {
  ...
  if (buildCounterServices < 3) {
    ...
    checkUnnamed3573(o.languagesSpoken!);
