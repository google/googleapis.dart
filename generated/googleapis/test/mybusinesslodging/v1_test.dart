...
core.List<api.GuestUnitType> buildUnnamed5272() => [
      buildGuestUnitType(),
      buildGuestUnitType(),
    ];

void checkUnnamed5272(core.List<api.GuestUnitType> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.LanguageSpoken> buildUnnamed5273() => [
      buildLanguageSpoken(),
      buildLanguageSpoken(),
    ];

void checkUnnamed5273(core.List<api.LanguageSpoken> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Services buildServices() {
  ...
  if (buildCounterServices < 3) {
    ...
    o.languagesSpoken = buildUnnamed5273();
...
void checkServices(api.Services o) {
  ...
  if (buildCounterServices < 3) {
    ...
    checkUnnamed5273(o.languagesSpoken!);
