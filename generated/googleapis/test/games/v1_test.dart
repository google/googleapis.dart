...
core.List<api.AchievementDefinition> buildUnnamed5069() => [
      buildAchievementDefinition(),
      buildAchievementDefinition(),
    ];

void checkUnnamed5069(core.List<api.AchievementDefinition> o) {
...
core.List<api.AchievementUpdateRequest> buildUnnamed5070() => [
      buildAchievementUpdateRequest(),
      buildAchievementUpdateRequest(),
    ];

void checkUnnamed5070(core.List<api.AchievementUpdateRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkAchievementUpdateMultipleRequest(
  ...
  if (buildCounterAchievementUpdateMultipleRequest < 3) {
    ...
    checkUnnamed5070(o.updates!);
  }
  buildCounterAchievementUpdateMultipleRequest--;
}

core.List<api.AchievementUpdateResponse> buildUnnamed5071() => [
      buildAchievementUpdateResponse(),
      buildAchievementUpdateResponse(),
    ];

void checkUnnamed5071(core.List<api.AchievementUpdateResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AchievementUpdateMultipleResponse buildAchievementUpdateMultipleResponse() {
  ...
  if (buildCounterAchievementUpdateMultipleResponse < 3) {
    o.kind = 'foo';
    o.updatedAchievements = buildUnnamed5071();
  }
  buildCounterAchievementUpdateMultipleResponse--;
  return o;
}
...
void checkAchievementUpdateMultipleResponse(
  ...
  if (buildCounterAchievementUpdateMultipleResponse < 3) {
    ...
    checkUnnamed5071(o.updatedAchievements!);
  }
  buildCounterAchievementUpdateMultipleResponse--;
}
...
core.List<api.ImageAsset> buildUnnamed5072() => [
      buildImageAsset(),
      buildImageAsset(),
    ];

void checkUnnamed5072(core.List<api.ImageAsset> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkImageAsset(o[0]);
  checkImageAsset(o[1]);
}
...
core.List<api.Instance> buildUnnamed5074() => [
      buildInstance(),
      buildInstance(),
    ];

void checkUnnamed5074(core.List<api.Instance> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInstance(o[0]);
  checkInstance(o[1]);
}
...
api.Application buildApplication() {
  ...
  if (buildCounterApplication < 3) {
    ...
    o.assets = buildUnnamed5072();
    o.author = 'foo';
    o.category = buildApplicationCategory();
    o.description = 'foo';
    o.enabledFeatures = buildUnnamed5073();
    o.id = 'foo';
    o.instances = buildUnnamed5074();
    o.kind = 'foo';
...
void checkApplication(api.Application o) {
  ...
  if (buildCounterApplication < 3) {
    ...
    checkUnnamed5073(o.enabledFeatures!);
    unittest.expect(
      o.id!,
      unittest.equals('foo'),
    );
    checkUnnamed5074(o.instances!);
    unittest.expect(
      o.kind!,
      unittest.equals('foo'),
    );
...
core.List<api.Category> buildUnnamed5075() => [
      buildCategory(),
      buildCategory(),
    ];

void checkUnnamed5075(core.List<api.Category> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCategory(o[0]);
  checkCategory(o[1]);
}
...
core.List<api.EventChild> buildUnnamed5076() => [
      buildEventChild(),
      buildEventChild(),
    ];

void checkUnnamed5076(core.List<api.EventChild> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEventChild(o[0]);
  checkEventChild(o[1]);
}
...
api.EventDefinition buildEventDefinition() {
  ...
  if (buildCounterEventDefinition < 3) {
    o.childEvents = buildUnnamed5076();
    o.description = 'foo';
    o.displayName = 'foo';
    o.id = 'foo';
    o.imageUrl = 'foo';
...
void checkEventDefinition(api.EventDefinition o) {
  buildCounterEventDefinition++;
  if (buildCounterEventDefinition < 3) {
    checkUnnamed5076(o.childEvents!);
    unittest.expect(
      o.description!,
      unittest.equals('foo'),
    );
...
core.List<api.EventDefinition> buildUnnamed5077() => [
      buildEventDefinition(),
      buildEventDefinition(),
    ];

void checkUnnamed5077(core.List<api.EventDefinition> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.EventUpdateRequest> buildUnnamed5078() => [
      buildEventUpdateRequest(),
      buildEventUpdateRequest(),
    ];

void checkUnnamed5078(core.List<api.EventUpdateRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.EventPeriodUpdate> buildUnnamed5079() => [
      buildEventPeriodUpdate(),
      buildEventPeriodUpdate(),
    ];

void checkUnnamed5079(core.List<api.EventPeriodUpdate> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.EventRecordRequest buildEventRecordRequest() {
  ...
  if (buildCounterEventRecordRequest < 3) {
    ...
    o.kind = 'foo';
    o.requestId = 'foo';
    o.timePeriods = buildUnnamed5079();
  }
  buildCounterEventRecordRequest--;
  return o;
}
...
void checkEventRecordRequest(api.EventRecordRequest o) {
  ...
  if (buildCounterEventRecordRequest < 3) {
    ...
    checkUnnamed5079(o.timePeriods!);
  }
  buildCounterEventRecordRequest--;
}
...
core.List<api.EventBatchRecordFailure> buildUnnamed5080() => [
      buildEventBatchRecordFailure(),
      buildEventBatchRecordFailure(),
    ];

void checkUnnamed5080(core.List<api.EventBatchRecordFailure> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEventBatchRecordFailure(o[0]);
  checkEventBatchRecordFailure(o[1]);
}

core.List<api.EventRecordFailure> buildUnnamed5081() => [
      buildEventRecordFailure(),
      buildEventRecordFailure(),
    ];

void checkUnnamed5081(core.List<api.EventRecordFailure> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEventRecordFailure(o[0]);
  checkEventRecordFailure(o[1]);
}

core.List<api.PlayerEvent> buildUnnamed5082() => [
      buildPlayerEvent(),
      buildPlayerEvent(),
    ];

void checkUnnamed5082(core.List<api.PlayerEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.EventUpdateResponse buildEventUpdateResponse() {
  ...
  if (buildCounterEventUpdateResponse < 3) {
    o.batchFailures = buildUnnamed5080();
    o.eventFailures = buildUnnamed5081();
    o.kind = 'foo';
    o.playerEvents = buildUnnamed5082();
  }
  buildCounterEventUpdateResponse--;
  return o;
}
...
void checkEventUpdateResponse(api.EventUpdateResponse o) {
  buildCounterEventUpdateResponse++;
  if (buildCounterEventUpdateResponse < 3) {
    checkUnnamed5080(o.batchFailures!);
    checkUnnamed5081(o.eventFailures!);
    unittest.expect(
      o.kind!,
      unittest.equals('foo'),
    );
    checkUnnamed5082(o.playerEvents!);
  }
  buildCounterEventUpdateResponse--;
}
...
core.List<api.Leaderboard> buildUnnamed5083() => [
      buildLeaderboard(),
      buildLeaderboard(),
    ];

void checkUnnamed5083(core.List<api.Leaderboard> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.LeaderboardEntry> buildUnnamed5084() => [
      buildLeaderboardEntry(),
      buildLeaderboardEntry(),
    ];

void checkUnnamed5084(core.List<api.LeaderboardEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.PlayerLevel> buildUnnamed5085() => [
      buildPlayerLevel(),
      buildPlayerLevel(),
    ];

void checkUnnamed5085(core.List<api.PlayerLevel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MetagameConfig buildMetagameConfig() {
  ...
  if (buildCounterMetagameConfig < 3) {
    o.currentVersion = 42;
    o.kind = 'foo';
    o.playerLevels = buildUnnamed5085();
  }
  buildCounterMetagameConfig--;
  return o;
}
...
void checkMetagameConfig(api.MetagameConfig o) {
  ...
  if (buildCounterMetagameConfig < 3) {
    ...
    checkUnnamed5085(o.playerLevels!);
  }
  buildCounterMetagameConfig--;
}
...
core.List<api.PlayerAchievement> buildUnnamed5086() => [
      buildPlayerAchievement(),
      buildPlayerAchievement(),
    ];

void checkUnnamed5086(core.List<api.PlayerAchievement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.PlayerEvent> buildUnnamed5087() => [
      buildPlayerEvent(),
      buildPlayerEvent(),
    ];

void checkUnnamed5087(core.List<api.PlayerEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPlayerEvent(o[0]);
  checkPlayerEvent(o[1]);
}
...
core.List<api.PlayerLeaderboardScore> buildUnnamed5088() => [
      buildPlayerLeaderboardScore(),
      buildPlayerLeaderboardScore(),
    ];

void checkUnnamed5088(core.List<api.PlayerLeaderboardScore> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Player> buildUnnamed5089() => [
      buildPlayer(),
      buildPlayer(),
    ];

void checkUnnamed5089(core.List<api.Player> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPlayer(o[0]);
  checkPlayer(o[1]);
}
...
core.List<api.PlayerScoreResponse> buildUnnamed5090() => [
      buildPlayerScoreResponse(),
      buildPlayerScoreResponse(),
    ];

void checkUnnamed5090(core.List<api.PlayerScoreResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PlayerScoreListResponse buildPlayerScoreListResponse() {
  ...
  if (buildCounterPlayerScoreListResponse < 3) {
    o.kind = 'foo';
    o.submittedScores = buildUnnamed5090();
  }
  buildCounterPlayerScoreListResponse--;
  return o;
}
...
void checkPlayerScoreListResponse(api.PlayerScoreListResponse o) {
  ...
  if (buildCounterPlayerScoreListResponse < 3) {
    ...
    checkUnnamed5090(o.submittedScores!);
  }
  buildCounterPlayerScoreListResponse--;
}
...
core.List<api.PlayerScore> buildUnnamed5092() => [
      buildPlayerScore(),
      buildPlayerScore(),
    ];

void checkUnnamed5092(core.List<api.PlayerScore> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PlayerScoreResponse buildPlayerScoreResponse() {
  ...
  if (buildCounterPlayerScoreResponse < 3) {
    o.beatenScoreTimeSpans = buildUnnamed5091();
    o.formattedScore = 'foo';
    o.kind = 'foo';
    o.leaderboardId = 'foo';
    o.scoreTag = 'foo';
    o.unbeatenScores = buildUnnamed5092();
  }
  buildCounterPlayerScoreResponse--;
  return o;
}
...
void checkPlayerScoreResponse(api.PlayerScoreResponse o) {
  buildCounterPlayerScoreResponse++;
  if (buildCounterPlayerScoreResponse < 3) {
    checkUnnamed5091(o.beatenScoreTimeSpans!);
    unittest.expect(
      o.formattedScore!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed5092(o.unbeatenScores!);
  }
  buildCounterPlayerScoreResponse--;
}

core.List<api.ScoreSubmission> buildUnnamed5093() => [
      buildScoreSubmission(),
      buildScoreSubmission(),
    ];

void checkUnnamed5093(core.List<api.ScoreSubmission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Snapshot> buildUnnamed5094() => [
      buildSnapshot(),
      buildSnapshot(),
    ];

void checkUnnamed5094(core.List<api.Snapshot> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSnapshot(o[0]);
  checkSnapshot(o[1]);
}
