...
checkUnnamed1812(core.List<api.AchievementDefinition> o) {
...
checkUnnamed1813(core.List<api.AchievementUpdateRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1814(core.List<api.AchievementUpdateResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAchievementUpdateMultipleResponse() {
  ...
  if (buildCounterAchievementUpdateMultipleResponse < 3) {
    o.kind = "foo";
    o.updatedAchievements = buildUnnamed1814();
  }
  buildCounterAchievementUpdateMultipleResponse--;
  return o;
}
...
checkAchievementUpdateMultipleResponse(api.AchievementUpdateMultipleResponse o) {
  ...
  if (buildCounterAchievementUpdateMultipleResponse < 3) {
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1814(o.updatedAchievements);
  }
  buildCounterAchievementUpdateMultipleResponse--;
}
...
checkUnnamed1815(core.List<api.ImageAsset> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkImageAsset(o[0]);
  checkImageAsset(o[1]);
}
...
checkUnnamed1817(core.List<api.Instance> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInstance(o[0]);
  checkInstance(o[1]);
}
...
buildApplication() {
  ...
  if (buildCounterApplication < 3) {
    ...
    o.assets = buildUnnamed1815();
    o.author = "foo";
    o.category = buildApplicationCategory();
    o.description = "foo";
    o.enabledFeatures = buildUnnamed1816();
    o.id = "foo";
    o.instances = buildUnnamed1817();
    o.kind = "foo";
...
checkApplication(api.Application o) {
  ...
  if (buildCounterApplication < 3) {
    ...
    checkUnnamed1815(o.assets);
    unittest.expect(o.author, unittest.equals('foo'));
    checkApplicationCategory(o.category);
    unittest.expect(o.description, unittest.equals('foo'));
    checkUnnamed1816(o.enabledFeatures);
    unittest.expect(o.id, unittest.equals('foo'));
    checkUnnamed1817(o.instances);
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed1818(core.List<api.Category> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCategory(o[0]);
  checkCategory(o[1]);
}
...
checkUnnamed1819(core.List<api.EventChild> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEventChild(o[0]);
  checkEventChild(o[1]);
}
...
buildEventDefinition() {
  ...
  if (buildCounterEventDefinition < 3) {
    o.childEvents = buildUnnamed1819();
    o.description = "foo";
    o.displayName = "foo";
    o.id = "foo";
    o.imageUrl = "foo";
...
checkEventDefinition(api.EventDefinition o) {
  buildCounterEventDefinition++;
  if (buildCounterEventDefinition < 3) {
    checkUnnamed1819(o.childEvents);
    unittest.expect(o.description, unittest.equals('foo'));
    unittest.expect(o.displayName, unittest.equals('foo'));
    unittest.expect(o.id, unittest.equals('foo'));
...
checkUnnamed1820(core.List<api.EventDefinition> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1821(core.List<api.EventUpdateRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1822(core.List<api.EventPeriodUpdate> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildEventRecordRequest() {
  ...
  if (buildCounterEventRecordRequest < 3) {
    ...
    o.kind = "foo";
    o.requestId = "foo";
    o.timePeriods = buildUnnamed1822();
  }
  buildCounterEventRecordRequest--;
  return o;
}
...
checkEventRecordRequest(api.EventRecordRequest o) {
  ...
  if (buildCounterEventRecordRequest < 3) {
    ...
    checkUnnamed1822(o.timePeriods);
  }
  buildCounterEventRecordRequest--;
}
...
checkUnnamed1823(core.List<api.EventBatchRecordFailure> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1824(core.List<api.EventRecordFailure> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1825(core.List<api.PlayerEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildEventUpdateResponse() {
  ...
  if (buildCounterEventUpdateResponse < 3) {
    o.batchFailures = buildUnnamed1823();
    o.eventFailures = buildUnnamed1824();
    o.kind = "foo";
    o.playerEvents = buildUnnamed1825();
  }
  buildCounterEventUpdateResponse--;
  return o;
}
...
checkEventUpdateResponse(api.EventUpdateResponse o) {
  buildCounterEventUpdateResponse++;
  if (buildCounterEventUpdateResponse < 3) {
    checkUnnamed1823(o.batchFailures);
    checkUnnamed1824(o.eventFailures);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1825(o.playerEvents);
  }
  buildCounterEventUpdateResponse--;
}
...
checkUnnamed1826(core.List<api.Leaderboard> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1827(core.List<api.LeaderboardEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1828(core.List<api.PlayerLevel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildMetagameConfig() {
  ...
  if (buildCounterMetagameConfig < 3) {
    o.currentVersion = 42;
    o.kind = "foo";
    o.playerLevels = buildUnnamed1828();
  }
  buildCounterMetagameConfig--;
  return o;
}
...
checkMetagameConfig(api.MetagameConfig o) {
  ...
  if (buildCounterMetagameConfig < 3) {
    ...
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1828(o.playerLevels);
  }
  buildCounterMetagameConfig--;
}
...
checkUnnamed1829(core.List<api.PlayerAchievement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1830(core.List<api.PlayerEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPlayerEvent(o[0]);
  checkPlayerEvent(o[1]);
}
...
checkUnnamed1831(core.List<api.PlayerLeaderboardScore> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1832(core.List<api.Player> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPlayer(o[0]);
  checkPlayer(o[1]);
}
...
checkUnnamed1833(core.List<api.PlayerScoreResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPlayerScoreListResponse() {
  ...
  if (buildCounterPlayerScoreListResponse < 3) {
    o.kind = "foo";
    o.submittedScores = buildUnnamed1833();
  }
  buildCounterPlayerScoreListResponse--;
  return o;
}
...
checkPlayerScoreListResponse(api.PlayerScoreListResponse o) {
  ...
  if (buildCounterPlayerScoreListResponse < 3) {
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1833(o.submittedScores);
  }
  buildCounterPlayerScoreListResponse--;
}
...
checkUnnamed1835(core.List<api.PlayerScore> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPlayerScoreResponse() {
  ...
  if (buildCounterPlayerScoreResponse < 3) {
    o.beatenScoreTimeSpans = buildUnnamed1834();
    o.formattedScore = "foo";
    o.kind = "foo";
    o.leaderboardId = "foo";
    o.scoreTag = "foo";
    o.unbeatenScores = buildUnnamed1835();
  }
  buildCounterPlayerScoreResponse--;
  return o;
}
...
checkPlayerScoreResponse(api.PlayerScoreResponse o) {
  buildCounterPlayerScoreResponse++;
  if (buildCounterPlayerScoreResponse < 3) {
    checkUnnamed1834(o.beatenScoreTimeSpans);
    unittest.expect(o.formattedScore, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.leaderboardId, unittest.equals('foo'));
    unittest.expect(o.scoreTag, unittest.equals('foo'));
    checkUnnamed1835(o.unbeatenScores);
  }
  buildCounterPlayerScoreResponse--;
}
...
checkUnnamed1836(core.List<api.ScoreSubmission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1837(core.List<api.QuestMilestone> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1838(core.List<api.Quest> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQuest(o[0]);
  checkQuest(o[1]);
}
...
checkUnnamed1839(core.List<api.QuestCriterion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1840(core.List<api.RoomParticipant> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildRoom() {
  ...
  if (buildCounterRoom < 3) {
    ...
    o.participants = buildUnnamed1840();
    o.roomId = "foo";
...
checkRoom(api.Room o) {
  ...
  if (buildCounterRoom < 3) {
    ...
    checkUnnamed1840(o.participants);
...
buildRoomCreateRequest() {
  ...
  if (buildCounterRoomCreateRequest < 3) {
    o.autoMatchingCriteria = buildRoomAutoMatchingCriteria();
    o.capabilities = buildUnnamed1841();
    o.clientAddress = buildRoomClientAddress();
    o.invitedPlayerIds = buildUnnamed1842();
    o.kind = "foo";
...
checkRoomCreateRequest(api.RoomCreateRequest o) {
  ...
  if (buildCounterRoomCreateRequest < 3) {
    checkRoomAutoMatchingCriteria(o.autoMatchingCriteria);
    checkUnnamed1841(o.capabilities);
    checkRoomClientAddress(o.clientAddress);
    checkUnnamed1842(o.invitedPlayerIds);
    unittest.expect(o.kind, unittest.equals('foo'));
...
buildRoomJoinRequest() {
  ...
  if (buildCounterRoomJoinRequest < 3) {
    o.capabilities = buildUnnamed1843();
    o.clientAddress = buildRoomClientAddress();
    o.kind = "foo";
    o.networkDiagnostics = buildNetworkDiagnostics();
  }
...
checkRoomJoinRequest(api.RoomJoinRequest o) {
  buildCounterRoomJoinRequest++;
  if (buildCounterRoomJoinRequest < 3) {
    checkUnnamed1843(o.capabilities);
    checkRoomClientAddress(o.clientAddress);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkNetworkDiagnostics(o.networkDiagnostics);
  }
...
checkUnnamed1844(core.List<api.PeerSessionDiagnostics> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildRoomLeaveDiagnostics() {
  ...
  if (buildCounterRoomLeaveDiagnostics < 3) {
    ...
    o.networkOperatorCode = "foo";
    o.networkOperatorName = "foo";
    o.peerSession = buildUnnamed1844();
    o.socketsUsed = true;
  }
  buildCounterRoomLeaveDiagnostics--;
  return o;
...
checkRoomLeaveDiagnostics(api.RoomLeaveDiagnostics o) {
  ...
  if (buildCounterRoomLeaveDiagnostics < 3) {
    ...
    unittest.expect(o.networkOperatorCode, unittest.equals('foo'));
    unittest.expect(o.networkOperatorName, unittest.equals('foo'));
    checkUnnamed1844(o.peerSession);
...
checkUnnamed1845(core.List<api.Room> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRoom(o[0]);
  checkRoom(o[1]);
}
...
checkUnnamed1846(core.List<api.RoomP2PStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildRoomParticipant() {
  ...
  if (buildCounterRoomParticipant < 3) {
    ...
    o.capabilities = buildUnnamed1847();
    o.clientAddress = buildRoomClientAddress();
    o.connected = true;
    o.id = "foo";
    o.kind = "foo";
...
checkRoomParticipant(api.RoomParticipant o) {
  ...
  if (buildCounterRoomParticipant < 3) {
    ...
    checkUnnamed1847(o.capabilities);
    checkRoomClientAddress(o.clientAddress);
...
checkUnnamed1848(core.List<api.RoomParticipant> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRoomParticipant(o[0]);
  checkRoomParticipant(o[1]);
}
...
buildRoomStatus() {
  ...
  if (buildCounterRoomStatus < 3) {
    o.autoMatchingStatus = buildRoomAutoMatchStatus();
    o.kind = "foo";
    o.participants = buildUnnamed1848();
    o.roomId = "foo";
    o.status = "foo";
    o.statusVersion = 42;
  }
...
checkRoomStatus(api.RoomStatus o) {
  ...
  if (buildCounterRoomStatus < 3) {
    checkRoomAutoMatchStatus(o.autoMatchingStatus);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1848(o.participants);
    unittest.expect(o.roomId, unittest.equals('foo'));
    unittest.expect(o.status, unittest.equals('foo'));
...
checkUnnamed1849(core.List<api.Snapshot> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSnapshot(o[0]);
  checkSnapshot(o[1]);
}
...
checkUnnamed1850(core.List<api.TurnBasedMatchParticipant> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1851(core.List<api.ParticipantResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkTurnBasedMatch(api.TurnBasedMatch o) {
  ...
  if (buildCounterTurnBasedMatch < 3) {
    ...
    checkUnnamed1850(o.participants);
...
buildTurnBasedMatchCreateRequest() {
  ...
  if (buildCounterTurnBasedMatchCreateRequest < 3) {
    o.autoMatchingCriteria = buildTurnBasedAutoMatchingCriteria();
    o.invitedPlayerIds = buildUnnamed1852();
    o.kind = "foo";
    o.requestId = "foo";
    o.variant = 42;
  }
...
checkTurnBasedMatchCreateRequest(api.TurnBasedMatchCreateRequest o) {
  ...
  if (buildCounterTurnBasedMatchCreateRequest < 3) {
    checkTurnBasedAutoMatchingCriteria(o.autoMatchingCriteria);
    checkUnnamed1852(o.invitedPlayerIds);
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.requestId, unittest.equals('foo'));
    unittest.expect(o.variant, unittest.equals(42));
  }
...
checkUnnamed1853(core.List<api.TurnBasedMatch> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1854(core.List<api.ParticipantResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkParticipantResult(o[0]);
  checkParticipantResult(o[1]);
}
...
checkUnnamed1855(core.List<api.TurnBasedMatch> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTurnBasedMatch(o[0]);
  checkTurnBasedMatch(o[1]);
}
...
checkUnnamed1856(core.List<api.ParticipantResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkParticipantResult(o[0]);
  checkParticipantResult(o[1]);
}
