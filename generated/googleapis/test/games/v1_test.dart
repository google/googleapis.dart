...
core.List<api.AchievementDefinition> buildUnnamed0() => [
  buildAchievementDefinition(),
  buildAchievementDefinition(),
];

void checkUnnamed0(core.List<api.AchievementDefinition> o) {
...
core.List<api.AchievementUpdateRequest> buildUnnamed1() => [
  buildAchievementUpdateRequest(),
  buildAchievementUpdateRequest(),
];

void checkUnnamed1(core.List<api.AchievementUpdateRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkAchievementUpdateMultipleRequest(
  ...
  if (buildCounterAchievementUpdateMultipleRequest < 3) {
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed1(o.updates!);
  }
  buildCounterAchievementUpdateMultipleRequest--;
}

core.List<api.AchievementUpdateResponse> buildUnnamed2() => [
  buildAchievementUpdateResponse(),
  buildAchievementUpdateResponse(),
];

void checkUnnamed2(core.List<api.AchievementUpdateResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AchievementUpdateMultipleResponse buildAchievementUpdateMultipleResponse() {
  ...
  if (buildCounterAchievementUpdateMultipleResponse < 3) {
    o.kind = 'foo';
    o.updatedAchievements = buildUnnamed2();
  }
  buildCounterAchievementUpdateMultipleResponse--;
  return o;
}
...
void checkAchievementUpdateMultipleResponse(
  ...
  if (buildCounterAchievementUpdateMultipleResponse < 3) {
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed2(o.updatedAchievements!);
  }
  buildCounterAchievementUpdateMultipleResponse--;
}
...
core.List<api.ImageAsset> buildUnnamed3() => [
  buildImageAsset(),
  buildImageAsset(),
];

void checkUnnamed3(core.List<api.ImageAsset> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkImageAsset(o[0]);
  checkImageAsset(o[1]);
}
...
api.Application buildApplication() {
  ...
  if (buildCounterApplication < 3) {
    ...
    o.description = 'foo';
    o.enabledFeatures = buildUnnamed4();
    o.id = 'foo';
...
void checkApplication(api.Application o) {
  ...
  if (buildCounterApplication < 3) {
    ...
    unittest.expect(o.description!, unittest.equals('foo'));
    checkUnnamed4(o.enabledFeatures!);
    unittest.expect(o.id!, unittest.equals('foo'));
...
core.int buildCounterApplicationPlayerId = 0;
api.ApplicationPlayerId buildApplicationPlayerId() {
  final o = api.ApplicationPlayerId();
  buildCounterApplicationPlayerId++;
  if (buildCounterApplicationPlayerId < 3) {
    o.applicationId = 'foo';
    o.playerId = 'foo';
  }
  buildCounterApplicationPlayerId--;
...
void checkApplicationPlayerId(api.ApplicationPlayerId o) {
  buildCounterApplicationPlayerId++;
  if (buildCounterApplicationPlayerId < 3) {
...
core.List<api.PlayerGameEvent> buildUnnamed6() => [
  buildPlayerGameEvent(),
  buildPlayerGameEvent(),
];

void checkUnnamed6(core.List<api.PlayerGameEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPlayerGameEvent(o[0]);
  checkPlayerGameEvent(o[1]);
}

core.int buildCounterBatchRecordEventsRequest = 0;
api.BatchRecordEventsRequest buildBatchRecordEventsRequest() {
  final o = api.BatchRecordEventsRequest();
  buildCounterBatchRecordEventsRequest++;
  if (buildCounterBatchRecordEventsRequest < 3) {
    o.droidGuardBlob = 'foo';
    o.events = buildUnnamed6();
    o.packageName = 'foo';
    o.requestTime = 'foo';
    o.salt = 'foo';
  }
...
void checkBatchRecordEventsRequest(api.BatchRecordEventsRequest o) {
  buildCounterBatchRecordEventsRequest++;
  if (buildCounterBatchRecordEventsRequest < 3) {
    unittest.expect(o.droidGuardBlob!, unittest.equals('foo'));
    checkUnnamed6(o.events!);
...
core.Map<core.String, api.Status> buildUnnamed7() => {
  'x': buildStatus(),
  'y': buildStatus(),
};

void checkUnnamed7(core.Map<core.String, api.Status> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatus(o['x']!);
  checkStatus(o['y']!);
}

core.int buildCounterBatchRecordEventsResponse = 0;
api.BatchRecordEventsResponse buildBatchRecordEventsResponse() {
  final o = api.BatchRecordEventsResponse();
  buildCounterBatchRecordEventsResponse++;
  if (buildCounterBatchRecordEventsResponse < 3) {
    o.failedRequests = buildUnnamed7();
  }
  buildCounterBatchRecordEventsResponse--;
  return o;
}

void checkBatchRecordEventsResponse(api.BatchRecordEventsResponse o) {
  buildCounterBatchRecordEventsResponse++;
  if (buildCounterBatchRecordEventsResponse < 3) {
    checkUnnamed7(o.failedRequests!);
  }
  buildCounterBatchRecordEventsResponse--;
}
...
core.List<api.Category> buildUnnamed8() => [buildCategory(), buildCategory()];

void checkUnnamed8(core.List<api.Category> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCategory(o[0]);
  checkCategory(o[1]);
}
...
core.List<api.EventChild> buildUnnamed9() => [
  buildEventChild(),
  buildEventChild(),
];

void checkUnnamed9(core.List<api.EventChild> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEventChild(o[0]);
  checkEventChild(o[1]);
}
...
core.List<api.EventDefinition> buildUnnamed10() => [
  buildEventDefinition(),
  buildEventDefinition(),
];

void checkUnnamed10(core.List<api.EventDefinition> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.EventUpdateRequest> buildUnnamed11() => [
  buildEventUpdateRequest(),
  buildEventUpdateRequest(),
];

void checkUnnamed11(core.List<api.EventUpdateRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.EventPeriodUpdate> buildUnnamed12() => [
  buildEventPeriodUpdate(),
  buildEventPeriodUpdate(),
];

void checkUnnamed12(core.List<api.EventPeriodUpdate> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.EventBatchRecordFailure> buildUnnamed13() => [
  buildEventBatchRecordFailure(),
  buildEventBatchRecordFailure(),
];

void checkUnnamed13(core.List<api.EventBatchRecordFailure> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEventBatchRecordFailure(o[0]);
  checkEventBatchRecordFailure(o[1]);
}

core.List<api.EventRecordFailure> buildUnnamed14() => [
  buildEventRecordFailure(),
  buildEventRecordFailure(),
];

void checkUnnamed14(core.List<api.EventRecordFailure> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEventRecordFailure(o[0]);
  checkEventRecordFailure(o[1]);
}

core.List<api.PlayerEvent> buildUnnamed15() => [
  buildPlayerEvent(),
  buildPlayerEvent(),
];

void checkUnnamed15(core.List<api.PlayerEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.EventUpdateResponse buildEventUpdateResponse() {
  ...
  if (buildCounterEventUpdateResponse < 3) {
    o.batchFailures = buildUnnamed13();
    o.eventFailures = buildUnnamed14();
    o.kind = 'foo';
    o.playerEvents = buildUnnamed15();
  }
  buildCounterEventUpdateResponse--;
  return o;
}
...
void checkEventUpdateResponse(api.EventUpdateResponse o) {
  buildCounterEventUpdateResponse++;
  if (buildCounterEventUpdateResponse < 3) {
    checkUnnamed13(o.batchFailures!);
    checkUnnamed14(o.eventFailures!);
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed15(o.playerEvents!);
  }
  buildCounterEventUpdateResponse--;
}
...
api.GamePlayerToken buildGamePlayerToken() {
  ...
  if (buildCounterGamePlayerToken < 3) {
    o.applicationId = 'foo';
    o.recallToken = buildRecallToken();
  }
  buildCounterGamePlayerToken--;
  return o;
}
...
void checkGamePlayerToken(api.GamePlayerToken o) {
  ...
  if (buildCounterGamePlayerToken < 3) {
    unittest.expect(o.applicationId!, unittest.equals('foo'));
    checkRecallToken(o.recallToken!);
  }
  buildCounterGamePlayerToken--;
}
...
core.int buildCounterGeneratePlayGroupingApiTokenResponse = 0;
api.GeneratePlayGroupingApiTokenResponse
buildGeneratePlayGroupingApiTokenResponse() {
  final o = api.GeneratePlayGroupingApiTokenResponse();
  buildCounterGeneratePlayGroupingApiTokenResponse++;
  if (buildCounterGeneratePlayGroupingApiTokenResponse < 3) {
    o.token = buildPlayGroupingApiToken();
  }
  buildCounterGeneratePlayGroupingApiTokenResponse--;
  return o;
}

void checkGeneratePlayGroupingApiTokenResponse(
  api.GeneratePlayGroupingApiTokenResponse o,
) {
  buildCounterGeneratePlayGroupingApiTokenResponse++;
  if (buildCounterGeneratePlayGroupingApiTokenResponse < 3) {
    checkPlayGroupingApiToken(o.token!);
  }
  buildCounterGeneratePlayGroupingApiTokenResponse--;
}

core.int buildCounterGenerateRecallPlayGroupingApiTokenResponse = 0;
api.GenerateRecallPlayGroupingApiTokenResponse
buildGenerateRecallPlayGroupingApiTokenResponse() {
  final o = api.GenerateRecallPlayGroupingApiTokenResponse();
  buildCounterGenerateRecallPlayGroupingApiTokenResponse++;
  if (buildCounterGenerateRecallPlayGroupingApiTokenResponse < 3) {
    o.token = buildPlayGroupingApiToken();
  }
  buildCounterGenerateRecallPlayGroupingApiTokenResponse--;
  return o;
...
void checkGenerateRecallPlayGroupingApiTokenResponse(
  api.GenerateRecallPlayGroupingApiTokenResponse o,
) {
  buildCounterGenerateRecallPlayGroupingApiTokenResponse++;
  if (buildCounterGenerateRecallPlayGroupingApiTokenResponse < 3) {
    checkPlayGroupingApiToken(o.token!);
...
core.List<api.ApplicationPlayerId> buildUnnamed16() => [
  buildApplicationPlayerId(),
  buildApplicationPlayerId(),
];

void checkUnnamed16(core.List<api.ApplicationPlayerId> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApplicationPlayerId(o[0]);
  checkApplicationPlayerId(o[1]);
}

core.int buildCounterGetMultipleApplicationPlayerIdsResponse = 0;
api.GetMultipleApplicationPlayerIdsResponse
buildGetMultipleApplicationPlayerIdsResponse() {
  ...
  if (buildCounterGetMultipleApplicationPlayerIdsResponse < 3) {
    o.playerIds = buildUnnamed16();
  }
  buildCounterGetMultipleApplicationPlayerIdsResponse--;
  return o;
}

void checkGetMultipleApplicationPlayerIdsResponse(
  api.GetMultipleApplicationPlayerIdsResponse o,
) {
  buildCounterGetMultipleApplicationPlayerIdsResponse++;
  if (buildCounterGetMultipleApplicationPlayerIdsResponse < 3) {
    checkUnnamed16(o.playerIds!);
  }
  buildCounterGetMultipleApplicationPlayerIdsResponse--;
}
...
core.List<api.Leaderboard> buildUnnamed17() => [
  buildLeaderboard(),
  buildLeaderboard(),
];

void checkUnnamed17(core.List<api.Leaderboard> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.LeaderboardEntry> buildUnnamed18() => [
  buildLeaderboardEntry(),
  buildLeaderboardEntry(),
];

void checkUnnamed18(core.List<api.LeaderboardEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkLinkPersonaRequest(api.LinkPersonaRequest o) {
  buildCounterLinkPersonaRequest++;
  if (buildCounterLinkPersonaRequest < 3) {
    unittest.expect(o.cardinalityConstraint!, unittest.equals('foo'));
    unittest.expect(
...
core.List<api.PlayerLevel> buildUnnamed19() => [
  buildPlayerLevel(),
  buildPlayerLevel(),
];

void checkUnnamed19(core.List<api.PlayerLevel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkMetagameConfig(api.MetagameConfig o) {
  ...
  if (buildCounterMetagameConfig < 3) {
    ...
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed19(o.playerLevels!);
  }
  buildCounterMetagameConfig--;
}

core.int buildCounterPlayGroupingApiToken = 0;
api.PlayGroupingApiToken buildPlayGroupingApiToken() {
  final o = api.PlayGroupingApiToken();
  buildCounterPlayGroupingApiToken++;
  if (buildCounterPlayGroupingApiToken < 3) {
    o.tokenValue = 'foo';
  }
  buildCounterPlayGroupingApiToken--;
  return o;
...
void checkPlayGroupingApiToken(api.PlayGroupingApiToken o) {
  buildCounterPlayGroupingApiToken++;
  if (buildCounterPlayGroupingApiToken < 3) {
    unittest.expect(o.tokenValue!, unittest.equals('foo'));
  }
  buildCounterPlayGroupingApiToken--;
}
...
core.List<api.PlayerAchievement> buildUnnamed20() => [
  buildPlayerAchievement(),
  buildPlayerAchievement(),
];

void checkUnnamed20(core.List<api.PlayerAchievement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.PlayerEvent> buildUnnamed21() => [
  buildPlayerEvent(),
  buildPlayerEvent(),
];

void checkUnnamed21(core.List<api.PlayerEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPlayerEvent(o[0]);
  checkPlayerEvent(o[1]);
}
...
core.Map<core.String, api.PropertyValue> buildUnnamed22() => {
  'x': buildPropertyValue(),
  'y': buildPropertyValue(),
};

void checkUnnamed22(core.Map<core.String, api.PropertyValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPropertyValue(o['x']!);
  checkPropertyValue(o['y']!);
}

core.int buildCounterPlayerGameEvent = 0;
api.PlayerGameEvent buildPlayerGameEvent() {
  final o = api.PlayerGameEvent();
  buildCounterPlayerGameEvent++;
  if (buildCounterPlayerGameEvent < 3) {
    o.eventId = 'foo';
    o.eventName = 'foo';
    o.eventProperties = buildUnnamed22();
    o.eventTime = 'foo';
  }
  buildCounterPlayerGameEvent--;
  return o;
...
void checkPlayerGameEvent(api.PlayerGameEvent o) {
  buildCounterPlayerGameEvent++;
  if (buildCounterPlayerGameEvent < 3) {
    unittest.expect(o.eventId!, unittest.equals('foo'));
    unittest.expect(o.eventName!, unittest.equals('foo'));
    checkUnnamed22(o.eventProperties!);
...
core.List<api.PlayerLeaderboardScore> buildUnnamed23() => [
  buildPlayerLeaderboardScore(),
  buildPlayerLeaderboardScore(),
];

void checkUnnamed23(core.List<api.PlayerLeaderboardScore> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Player> buildUnnamed24() => [buildPlayer(), buildPlayer()];

void checkUnnamed24(core.List<api.Player> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPlayer(o[0]);
  checkPlayer(o[1]);
}
...
core.List<api.PlayerScoreResponse> buildUnnamed25() => [
  buildPlayerScoreResponse(),
  buildPlayerScoreResponse(),
];

void checkUnnamed25(core.List<api.PlayerScoreResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PlayerScoreListResponse buildPlayerScoreListResponse() {
  ...
  if (buildCounterPlayerScoreListResponse < 3) {
    o.kind = 'foo';
    o.submittedScores = buildUnnamed25();
  }
  buildCounterPlayerScoreListResponse--;
  return o;
}
...
void checkPlayerScoreListResponse(api.PlayerScoreListResponse o) {
  ...
  if (buildCounterPlayerScoreListResponse < 3) {
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed25(o.submittedScores!);
  }
  buildCounterPlayerScoreListResponse--;
}
...
core.List<api.PlayerScore> buildUnnamed27() => [
  buildPlayerScore(),
  buildPlayerScore(),
];

void checkUnnamed27(core.List<api.PlayerScore> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PlayerScoreResponse buildPlayerScoreResponse() {
  ...
  if (buildCounterPlayerScoreResponse < 3) {
    o.beatenScoreTimeSpans = buildUnnamed26();
    o.formattedScore = 'foo';
    o.kind = 'foo';
    o.leaderboardId = 'foo';
    o.scoreTag = 'foo';
    o.unbeatenScores = buildUnnamed27();
  }
  buildCounterPlayerScoreResponse--;
  return o;
}
...
void checkPlayerScoreResponse(api.PlayerScoreResponse o) {
  buildCounterPlayerScoreResponse++;
  if (buildCounterPlayerScoreResponse < 3) {
    checkUnnamed26(o.beatenScoreTimeSpans!);
    unittest.expect(o.formattedScore!, unittest.equals('foo'));
    unittest.expect(o.kind!, unittest.equals('foo'));
    unittest.expect(o.leaderboardId!, unittest.equals('foo'));
    unittest.expect(o.scoreTag!, unittest.equals('foo'));
    checkUnnamed27(o.unbeatenScores!);
  }
  buildCounterPlayerScoreResponse--;
}

core.List<api.ScoreSubmission> buildUnnamed28() => [
  buildScoreSubmission(),
  buildScoreSubmission(),
];

void checkUnnamed28(core.List<api.ScoreSubmission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildRetrieveDeveloperGamesLastPlayerTokenResponse() {
  ...
  if (buildCounterRetrieveDeveloperGamesLastPlayerTokenResponse < 3) {
    o.gamePlayerToken = buildGamePlayerToken();
  }
  buildCounterRetrieveDeveloperGamesLastPlayerTokenResponse--;
  return o;
}
...
void checkRetrieveDeveloperGamesLastPlayerTokenResponse(
  ...
  buildCounterRetrieveDeveloperGamesLastPlayerTokenResponse++;
  if (buildCounterRetrieveDeveloperGamesLastPlayerTokenResponse < 3) {
    checkGamePlayerToken(o.gamePlayerToken!);
  }
  buildCounterRetrieveDeveloperGamesLastPlayerTokenResponse--;
}

core.List<api.GamePlayerToken> buildUnnamed29() => [
  buildGamePlayerToken(),
  buildGamePlayerToken(),
];

void checkUnnamed29(core.List<api.GamePlayerToken> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.RetrieveGamesPlayerTokensResponse buildRetrieveGamesPlayerTokensResponse() {
  ...
  if (buildCounterRetrieveGamesPlayerTokensResponse < 3) {
    o.gamePlayerTokens = buildUnnamed29();
  }
  buildCounterRetrieveGamesPlayerTokensResponse--;
  return o;
}
...
void checkRetrieveGamesPlayerTokensResponse(
  ...
  buildCounterRetrieveGamesPlayerTokensResponse++;
  if (buildCounterRetrieveGamesPlayerTokensResponse < 3) {
    checkUnnamed29(o.gamePlayerTokens!);
  }
  buildCounterRetrieveGamesPlayerTokensResponse--;
}

core.List<api.RecallToken> buildUnnamed30() => [
  buildRecallToken(),
  buildRecallToken(),
];

void checkUnnamed30(core.List<api.RecallToken> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkScopedPlayerIds(api.ScopedPlayerIds o) {
  buildCounterScopedPlayerIds++;
  if (buildCounterScopedPlayerIds < 3) {
    unittest.expect(o.developerPlayerKey!, unittest.equals('foo'));
    unittest.expect(o.gamePlayerId!, unittest.equals('foo'));
  }
  buildCounterScopedPlayerIds--;
}
...
core.List<api.Snapshot> buildUnnamed31() => [buildSnapshot(), buildSnapshot()];

void checkUnnamed31(core.List<api.Snapshot> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSnapshot(o[0]);
  checkSnapshot(o[1]);
}
...
void main() {
  ...
  unittest.group('obj-schema-ApplicationPlayerId', () {
    unittest.test('to-json--from-json', () async {
      final o = buildApplicationPlayerId();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ApplicationPlayerId.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkApplicationPlayerId(od);
    });
  });
  ...
  unittest.group('obj-schema-BatchRecordEventsRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildBatchRecordEventsRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.BatchRecordEventsRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkBatchRecordEventsRequest(od);
    });
  });

  unittest.group('obj-schema-BatchRecordEventsResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildBatchRecordEventsResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.BatchRecordEventsResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkBatchRecordEventsResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-EventChild', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.EventChild.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkEventChild(od);
    });
  ...
  unittest.group('obj-schema-GeneratePlayGroupingApiTokenResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGeneratePlayGroupingApiTokenResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GeneratePlayGroupingApiTokenResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGeneratePlayGroupingApiTokenResponse(od);
    });
  });

  unittest.group('obj-schema-GenerateRecallPlayGroupingApiTokenResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGenerateRecallPlayGroupingApiTokenResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GenerateRecallPlayGroupingApiTokenResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGenerateRecallPlayGroupingApiTokenResponse(od);
    });
  });

  unittest.group('obj-schema-GetMultipleApplicationPlayerIdsResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGetMultipleApplicationPlayerIdsResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GetMultipleApplicationPlayerIdsResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGetMultipleApplicationPlayerIdsResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-PlayGroupingApiToken', () {
    unittest.test('to-json--from-json', () async {
      final o = buildPlayGroupingApiToken();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.PlayGroupingApiToken.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPlayGroupingApiToken(od);
    });
  });
  ...
  unittest.group('obj-schema-PlayerGameEvent', () {
    unittest.test('to-json--from-json', () async {
      final o = buildPlayerGameEvent();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.PlayerGameEvent.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPlayerGameEvent(od);
    });
  });
  ...
  unittest.group(
    'obj-schema-RetrieveDeveloperGamesLastPlayerTokenResponse',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group('resource-AccesstokensResource', () {
    unittest.test('method--generatePlayGroupingApiToken', () async {
      final mock = HttpServerMock();
      final res = api.GamesApi(mock).accesstokens;
      final arg_packageName = 'foo';
      final arg_persona = 'foo';
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            queryMap['packageName']!.first,
            unittest.equals(arg_packageName),
          );
          unittest.expect(
            queryMap['persona']!.first,
            unittest.equals(arg_persona),
          );
          unittest.expect(
      ...
      final response = await res.generatePlayGroupingApiToken(
        packageName: arg_packageName,
        persona: arg_persona,
        $fields: arg_$fields,
      );
      checkGeneratePlayGroupingApiTokenResponse(
        response as api.GeneratePlayGroupingApiTokenResponse,
      );
    });

    unittest.test('method--generateRecallPlayGroupingApiToken', () async {
      final mock = HttpServerMock();
      final res = api.GamesApi(mock).accesstokens;
      final arg_packageName = 'foo';
      final arg_persona = 'foo';
      final arg_recallSessionId = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final path = req.url.path;
          ...
          unittest.expect(
            queryMap['recallSessionId']!.first,
            unittest.equals(arg_recallSessionId),
          );
          unittest.expect(
            queryMap['fields']!.first,
            unittest.equals(arg_$fields),
      ...
      final response = await res.generateRecallPlayGroupingApiToken(
        packageName: arg_packageName,
        persona: arg_persona,
        recallSessionId: arg_recallSessionId,
        $fields: arg_$fields,
      );
      checkGenerateRecallPlayGroupingApiTokenResponse(
        response as api.GenerateRecallPlayGroupingApiTokenResponse,
      );
    });
  });
  ...
  unittest.group('resource-AchievementsResource', () {
    ...
    unittest.test('method--reveal', () async {
      ...
      final response = await res.reveal(
        arg_achievementId,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--setStepsAtLeast', () async {
      ...
      final response = await res.setStepsAtLeast(
        arg_achievementId,
        arg_steps,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--updateMultiple', () async {
      ...
      final response = await res.updateMultiple(
        arg_request,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-EventsResource', () {
    ...
    unittest.test('method--record', () async {
      ...
      final response = await res.record(
        arg_request,
        language: arg_language,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-GameStatsResource', () {
    unittest.test('method--batchRecordEvents', () async {
      final mock = HttpServerMock();
      final res = api.GamesApi(mock).gameStats;
      final arg_request = buildBatchRecordEventsRequest();
      final arg_playerId = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.BatchRecordEventsRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkBatchRecordEventsRequest(obj);
          ...
          pathOffset += 17;
          index = path.indexOf('/gameStats:batchRecordEvents', pathOffset);
          unittest.expect(index >= 0, unittest.isTrue);
          subPart = core.Uri.decodeQueryComponent(
            path.substring(pathOffset, index),
          );
          ...
          unittest.expect(
            path.substring(pathOffset, pathOffset + 28),
            unittest.equals('/gameStats:batchRecordEvents'),
          );
          pathOffset += 28;
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildBatchRecordEventsResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.batchRecordEvents(
        arg_request,
        arg_playerId,
        $fields: arg_$fields,
      );
      checkBatchRecordEventsResponse(response as api.BatchRecordEventsResponse);
    });
  });
  ...
  unittest.group('resource-PlayersResource', () {
    ...
    unittest.test('method--getMultipleApplicationPlayerIds', () async {
      final mock = HttpServerMock();
      final res = api.GamesApi(mock).players;
      final arg_applicationIds = buildUnnamed34();
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final path = req.url.path;
          ...
          unittest.expect(
            ...
            unittest.equals('games/v1/players/me/multipleApplicationPlayerIds'),
          );
          pathOffset += 48;
      ...
      final response = await res.getMultipleApplicationPlayerIds(
        applicationIds: arg_applicationIds,
        $fields: arg_$fields,
      );
      checkGetMultipleApplicationPlayerIdsResponse(
        response as api.GetMultipleApplicationPlayerIdsResponse,
      );
    });
  ...
  unittest.group('resource-RecallResource', () {
    unittest.test('method--gamesPlayerTokens', () async {
      ...
      final arg_applicationIds = buildUnnamed35();
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final path = req.url.path;
          ...
          subPart = core.Uri.decodeQueryComponent(path.substring(pathOffset));
          pathOffset = path.length;
          unittest.expect(subPart, unittest.equals('$arg_sessionId'));
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildRetrieveGamesPlayerTokensResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.gamesPlayerTokens(
        arg_sessionId,
        applicationIds: arg_applicationIds,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--lastTokenFromAllDeveloperGames', () async {
      ...
      final response = await res.lastTokenFromAllDeveloperGames(
        arg_sessionId,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--resetPersona', () async {
      ...
      final response = await res.resetPersona(
        arg_request,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--retrieveTokens', () async {
      ...
      final response = await res.retrieveTokens(
        arg_sessionId,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--unlinkPersona', () async {
      ...
      final response = await res.unlinkPersona(
        arg_request,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-ScoresResource', () {
    ...
    unittest.test('method--submitMultiple', () async {
      ...
      final response = await res.submitMultiple(
        arg_request,
        language: arg_language,
        $fields: arg_$fields,
      );
