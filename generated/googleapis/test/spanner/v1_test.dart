...
api.Backup buildBackup() {
  ...
  if (buildCounterBackup < 3) {
    ...
    o.expireTime = 'foo';
    o.name = 'foo';
    o.referencingDatabases = buildUnnamed4855();
    o.sizeBytes = 'foo';
    o.state = 'foo';
    o.versionTime = 'foo';
  }
...
void checkBackup(api.Backup o) {
  ...
  if (buildCounterBackup < 3) {
    ...
    checkUnnamed4855(o.referencingDatabases!);
    unittest.expect(
      o.sizeBytes!,
      unittest.equals('foo'),
    );
...
core.List<api.Session> buildUnnamed4856() => [
      buildSession(),
      buildSession(),
    ];

void checkUnnamed4856(core.List<api.Session> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSession(o[0]);
  checkSession(o[1]);
}
...
core.List<api.Mutation> buildUnnamed4858() => [
      buildMutation(),
      buildMutation(),
    ];

void checkUnnamed4858(core.List<api.Mutation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMutation(o[0]);
  checkMutation(o[1]);
}
...
api.CreateDatabaseRequest buildCreateDatabaseRequest() {
  ...
  if (buildCounterCreateDatabaseRequest < 3) {
    ...
    o.extraStatements = buildUnnamed4859();
  }
  buildCounterCreateDatabaseRequest--;
  return o;
}
...
void checkCreateDatabaseRequest(api.CreateDatabaseRequest o) {
  ...
  if (buildCounterCreateDatabaseRequest < 3) {
    ...
    checkUnnamed4859(o.extraStatements!);
  }
  buildCounterCreateDatabaseRequest--;
}
...
core.List<api.EncryptionInfo> buildUnnamed4860() => [
      buildEncryptionInfo(),
      buildEncryptionInfo(),
    ];

void checkUnnamed4860(core.List<api.EncryptionInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Database buildDatabase() {
  ...
  if (buildCounterDatabase < 3) {
    ...
    o.encryptionConfig = buildEncryptionConfig();
    o.encryptionInfo = buildUnnamed4860();
    o.name = 'foo';
...
void checkDatabase(api.Database o) {
  ...
  if (buildCounterDatabase < 3) {
    ...
    checkEncryptionConfig(o.encryptionConfig!);
    checkUnnamed4860(o.encryptionInfo!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
core.List<api.Statement> buildUnnamed4861() => [
      buildStatement(),
      buildStatement(),
    ];

void checkUnnamed4861(core.List<api.Statement> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatement(o[0]);
  checkStatement(o[1]);
}
...
void checkExecuteBatchDmlRequest(api.ExecuteBatchDmlRequest o) {
  ...
  if (buildCounterExecuteBatchDmlRequest < 3) {
    ...
    checkUnnamed4861(o.statements!);
    checkTransactionSelector(o.transaction!);
  }
  buildCounterExecuteBatchDmlRequest--;
}

core.List<api.ResultSet> buildUnnamed4862() => [
      buildResultSet(),
      buildResultSet(),
    ];

void checkUnnamed4862(core.List<api.ResultSet> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResultSet(o[0]);
  checkResultSet(o[1]);
}
...
void checkExecuteBatchDmlResponse(api.ExecuteBatchDmlResponse o) {
  buildCounterExecuteBatchDmlResponse++;
  if (buildCounterExecuteBatchDmlResponse < 3) {
    checkUnnamed4862(o.resultSets!);
    checkStatus(o.status!);
  }
  buildCounterExecuteBatchDmlResponse--;
}

core.Map<core.String, api.Type> buildUnnamed4863() => {
      'x': buildType(),
      'y': buildType(),
    };

void checkUnnamed4863(core.Map<core.String, api.Type> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkType(o['x']!);
  checkType(o['y']!);
}
...
api.ExecuteSqlRequest buildExecuteSqlRequest() {
  ...
  if (buildCounterExecuteSqlRequest < 3) {
    o.paramTypes = buildUnnamed4863();
    o.params = buildUnnamed4864();
...
void checkExecuteSqlRequest(api.ExecuteSqlRequest o) {
  buildCounterExecuteSqlRequest++;
  if (buildCounterExecuteSqlRequest < 3) {
    checkUnnamed4863(o.paramTypes!);
    checkUnnamed4864(o.params!);
    unittest.expect(
      o.partitionToken!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.int> buildUnnamed4866() => {
      'x': 42,
      'y': 42,
    };

void checkUnnamed4866(core.Map<core.String, core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals(42),
...
api.IndexedHotKey buildIndexedHotKey() {
  ...
  if (buildCounterIndexedHotKey < 3) {
    o.sparseHotKeys = buildUnnamed4866();
  }
  buildCounterIndexedHotKey--;
  return o;
}
...
void checkIndexedHotKey(api.IndexedHotKey o) {
  buildCounterIndexedHotKey++;
  if (buildCounterIndexedHotKey < 3) {
    checkUnnamed4866(o.sparseHotKeys!);
  }
  buildCounterIndexedHotKey--;
}

core.Map<core.String, api.KeyRangeInfos> buildUnnamed4867() => {
      'x': buildKeyRangeInfos(),
      'y': buildKeyRangeInfos(),
    };

void checkUnnamed4867(core.Map<core.String, api.KeyRangeInfos> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.IndexedKeyRangeInfos buildIndexedKeyRangeInfos() {
  ...
  if (buildCounterIndexedKeyRangeInfos < 3) {
    o.keyRangeInfos = buildUnnamed4867();
  }
  buildCounterIndexedKeyRangeInfos--;
  return o;
}
...
void checkIndexedKeyRangeInfos(api.IndexedKeyRangeInfos o) {
  buildCounterIndexedKeyRangeInfos++;
  if (buildCounterIndexedKeyRangeInfos < 3) {
    checkUnnamed4867(o.keyRangeInfos!);
  }
  buildCounterIndexedKeyRangeInfos--;
}
...
core.Map<core.String, core.String> buildUnnamed4869() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed4869(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.Instance buildInstance() {
  ...
  if (buildCounterInstance < 3) {
    o.config = 'foo';
    o.displayName = 'foo';
    o.endpointUris = buildUnnamed4868();
    o.labels = buildUnnamed4869();
    o.name = 'foo';
    o.nodeCount = 42;
...
void checkInstance(api.Instance o) {
  ...
  if (buildCounterInstance < 3) {
    ...
    checkUnnamed4868(o.endpointUris!);
    checkUnnamed4869(o.labels!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
core.List<api.ReplicaInfo> buildUnnamed4871() => [
      buildReplicaInfo(),
      buildReplicaInfo(),
    ];

void checkUnnamed4871(core.List<api.ReplicaInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.InstanceConfig buildInstanceConfig() {
  ...
  if (buildCounterInstanceConfig < 3) {
    o.displayName = 'foo';
    o.leaderOptions = buildUnnamed4870();
    o.name = 'foo';
    o.replicas = buildUnnamed4871();
  }
  buildCounterInstanceConfig--;
  return o;
}
...
void checkInstanceConfig(api.InstanceConfig o) {
  ...
  if (buildCounterInstanceConfig < 3) {
    ...
    checkUnnamed4870(o.leaderOptions!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed4871(o.replicas!);
  }
  buildCounterInstanceConfig--;
}

core.List<core.Object> buildUnnamed4872() => [
      {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed4872(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Object> buildUnnamed4873() => [
      {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed4873(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Object> buildUnnamed4874() => [
      {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed4874(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Object> buildUnnamed4875() => [
      {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed4875(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.KeyRange buildKeyRange() {
  ...
  if (buildCounterKeyRange < 3) {
    o.endClosed = buildUnnamed4872();
    o.endOpen = buildUnnamed4873();
    o.startClosed = buildUnnamed4874();
    o.startOpen = buildUnnamed4875();
  }
  buildCounterKeyRange--;
  return o;
}
...
void checkKeyRange(api.KeyRange o) {
  buildCounterKeyRange++;
  if (buildCounterKeyRange < 3) {
    checkUnnamed4872(o.endClosed!);
    checkUnnamed4873(o.endOpen!);
    checkUnnamed4874(o.startClosed!);
    checkUnnamed4875(o.startOpen!);
  }
  buildCounterKeyRange--;
}

core.List<api.ContextValue> buildUnnamed4876() => [
      buildContextValue(),
      buildContextValue(),
    ];

void checkUnnamed4876(core.List<api.ContextValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.KeyRangeInfo buildKeyRangeInfo() {
  ...
  if (buildCounterKeyRangeInfo < 3) {
    o.contextValues = buildUnnamed4876();
    o.endKeyIndex = 42;
    o.info = buildLocalizedString();
    o.keysCount = 'foo';
    o.metric = buildLocalizedString();
...
void checkKeyRangeInfo(api.KeyRangeInfo o) {
  buildCounterKeyRangeInfo++;
  if (buildCounterKeyRangeInfo < 3) {
    checkUnnamed4876(o.contextValues!);
    unittest.expect(
      o.endKeyIndex!,
      unittest.equals(42),
    );
...
core.List<api.KeyRangeInfo> buildUnnamed4877() => [
      buildKeyRangeInfo(),
      buildKeyRangeInfo(),
    ];

void checkUnnamed4877(core.List<api.KeyRangeInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Object> buildUnnamed4878() => [
      {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed4878(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.List<core.Object>> buildUnnamed4879() => [
      buildUnnamed4878(),
      buildUnnamed4878(),
    ];

void checkUnnamed4879(core.List<core.List<core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed4878(o[0]);
  checkUnnamed4878(o[1]);
}

core.List<api.KeyRange> buildUnnamed4880() => [
      buildKeyRange(),
      buildKeyRange(),
    ];

void checkUnnamed4880(core.List<api.KeyRange> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkKeyRange(o[0]);
  checkKeyRange(o[1]);
}
...
api.KeySet buildKeySet() {
  ...
  if (buildCounterKeySet < 3) {
    o.all = true;
    o.keys = buildUnnamed4879();
    o.ranges = buildUnnamed4880();
  }
  buildCounterKeySet--;
  return o;
}
...
void checkKeySet(api.KeySet o) {
  ...
  if (buildCounterKeySet < 3) {
    ...
    checkUnnamed4879(o.keys!);
    checkUnnamed4880(o.ranges!);
  }
  buildCounterKeySet--;
}

core.List<api.Operation> buildUnnamed4881() => [
      buildOperation(),
      buildOperation(),
    ];

void checkUnnamed4881(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
void checkListBackupOperationsResponse(api.ListBackupOperationsResponse o) {
  ...
  if (buildCounterListBackupOperationsResponse < 3) {
    ...
    checkUnnamed4881(o.operations!);
  }
  buildCounterListBackupOperationsResponse--;
}

core.List<api.Backup> buildUnnamed4882() => [
      buildBackup(),
      buildBackup(),
    ];

void checkUnnamed4882(core.List<api.Backup> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBackup(o[0]);
  checkBackup(o[1]);
}
...
core.List<api.Operation> buildUnnamed4883() => [
      buildOperation(),
      buildOperation(),
    ];

void checkUnnamed4883(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
void checkListDatabaseOperationsResponse(api.ListDatabaseOperationsResponse o) {
  ...
  if (buildCounterListDatabaseOperationsResponse < 3) {
    ...
    checkUnnamed4883(o.operations!);
  }
  buildCounterListDatabaseOperationsResponse--;
}

core.List<api.Database> buildUnnamed4884() => [
      buildDatabase(),
      buildDatabase(),
    ];

void checkUnnamed4884(core.List<api.Database> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDatabase(o[0]);
  checkDatabase(o[1]);
}
...
core.List<api.InstanceConfig> buildUnnamed4885() => [
      buildInstanceConfig(),
      buildInstanceConfig(),
    ];

void checkUnnamed4885(core.List<api.InstanceConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListInstanceConfigsResponse buildListInstanceConfigsResponse() {
  ...
  if (buildCounterListInstanceConfigsResponse < 3) {
    o.instanceConfigs = buildUnnamed4885();
    o.nextPageToken = 'foo';
  }
  buildCounterListInstanceConfigsResponse--;
  return o;
...
void checkListInstanceConfigsResponse(api.ListInstanceConfigsResponse o) {
  buildCounterListInstanceConfigsResponse++;
  if (buildCounterListInstanceConfigsResponse < 3) {
    checkUnnamed4885(o.instanceConfigs!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Instance> buildUnnamed4886() => [
      buildInstance(),
      buildInstance(),
    ];

void checkUnnamed4886(core.List<api.Instance> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInstance(o[0]);
  checkInstance(o[1]);
}
...
api.ListInstancesResponse buildListInstancesResponse() {
  ...
  if (buildCounterListInstancesResponse < 3) {
    o.instances = buildUnnamed4886();
    o.nextPageToken = 'foo';
    o.unreachable = buildUnnamed4887();
  }
  buildCounterListInstancesResponse--;
  return o;
}
...
void checkListInstancesResponse(api.ListInstancesResponse o) {
  buildCounterListInstancesResponse++;
  if (buildCounterListInstancesResponse < 3) {
    checkUnnamed4886(o.instances!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
    checkUnnamed4887(o.unreachable!);
  }
  buildCounterListInstancesResponse--;
}

core.List<api.Operation> buildUnnamed4888() => [
      buildOperation(),
      buildOperation(),
    ];

void checkUnnamed4888(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
void checkListOperationsResponse(api.ListOperationsResponse o) {
  ...
  if (buildCounterListOperationsResponse < 3) {
    ...
    checkUnnamed4888(o.operations!);
  }
  buildCounterListOperationsResponse--;
}

core.List<api.Scan> buildUnnamed4889() => [
      buildScan(),
      buildScan(),
    ];

void checkUnnamed4889(core.List<api.Scan> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkScan(o[0]);
  checkScan(o[1]);
}
...
void checkListScansResponse(api.ListScansResponse o) {
  ...
  if (buildCounterListScansResponse < 3) {
    ...
    checkUnnamed4889(o.scans!);
  }
  buildCounterListScansResponse--;
}

core.List<api.Session> buildUnnamed4890() => [
      buildSession(),
      buildSession(),
    ];

void checkUnnamed4890(core.List<api.Session> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSession(o[0]);
  checkSession(o[1]);
}
...
void checkListSessionsResponse(api.ListSessionsResponse o) {
  ...
  if (buildCounterListSessionsResponse < 3) {
    ...
    checkUnnamed4890(o.sessions!);
  }
  buildCounterListSessionsResponse--;
}

core.Map<core.String, core.String> buildUnnamed4891() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed4891(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.Map<core.String, api.IndexedHotKey> buildUnnamed4892() => {
      'x': buildIndexedHotKey(),
      'y': buildIndexedHotKey(),
    };

void checkUnnamed4892(core.Map<core.String, api.IndexedHotKey> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIndexedHotKey(o['x']!);
  checkIndexedHotKey(o['y']!);
}

core.Map<core.String, api.IndexedKeyRangeInfos> buildUnnamed4893() => {
      'x': buildIndexedKeyRangeInfos(),
      'y': buildIndexedKeyRangeInfos(),
    };

void checkUnnamed4893(core.Map<core.String, api.IndexedKeyRangeInfos> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Metric buildMetric() {
  ...
  if (buildCounterMetric < 3) {
    ...
    o.hotValue = 42.0;
    o.indexedHotKeys = buildUnnamed4892();
    o.indexedKeyRangeInfos = buildUnnamed4893();
    o.info = buildLocalizedString();
...
void checkMetric(api.Metric o) {
  ...
  if (buildCounterMetric < 3) {
    ...
    checkUnnamed4892(o.indexedHotKeys!);
    checkUnnamed4893(o.indexedKeyRangeInfos!);
    checkLocalizedString(o.info!);
...
core.List<api.MetricMatrixRow> buildUnnamed4894() => [
      buildMetricMatrixRow(),
      buildMetricMatrixRow(),
    ];

void checkUnnamed4894(core.List<api.MetricMatrixRow> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkMetricMatrix(api.MetricMatrix o) {
  buildCounterMetricMatrix++;
  if (buildCounterMetricMatrix < 3) {
    checkUnnamed4894(o.rows!);
  }
  buildCounterMetricMatrix--;
}

core.List<core.double> buildUnnamed4895() => [
      42.0,
      42.0,
    ];

void checkUnnamed4895(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42.0),
...
core.Map<core.String, core.Object> buildUnnamed4897() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed4897(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed4896();
    o.name = 'foo';
    o.response = buildUnnamed4897();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error!);
    checkUnnamed4896(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed4897(o.response!);
  }
  buildCounterOperation--;
}
...
core.List<core.Object> buildUnnamed4898() => [
      {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed4898(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, api.Type> buildUnnamed4899() => {
      'x': buildType(),
      'y': buildType(),
    };

void checkUnnamed4899(core.Map<core.String, api.Type> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkType(o['x']!);
  checkType(o['y']!);
}
...
api.PartitionQueryRequest buildPartitionQueryRequest() {
  ...
  if (buildCounterPartitionQueryRequest < 3) {
    o.paramTypes = buildUnnamed4899();
    o.params = buildUnnamed4900();
...
void checkPartitionQueryRequest(api.PartitionQueryRequest o) {
  buildCounterPartitionQueryRequest++;
  if (buildCounterPartitionQueryRequest < 3) {
    checkUnnamed4899(o.paramTypes!);
    checkUnnamed4900(o.params!);
...
core.List<api.Partition> buildUnnamed4902() => [
      buildPartition(),
      buildPartition(),
    ];

void checkUnnamed4902(core.List<api.Partition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPartition(o[0]);
  checkPartition(o[1]);
}
...
core.List<api.ChildLink> buildUnnamed4903() => [
      buildChildLink(),
      buildChildLink(),
    ];

void checkUnnamed4903(core.List<api.ChildLink> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkChildLink(o[0]);
  checkChildLink(o[1]);
}
...
api.PlanNode buildPlanNode() {
  ...
  if (buildCounterPlanNode < 3) {
    o.childLinks = buildUnnamed4903();
    o.displayName = 'foo';
    o.executionStats = buildUnnamed4904();
    o.index = 42;
    o.kind = 'foo';
    o.metadata = buildUnnamed4905();
...
void checkPlanNode(api.PlanNode o) {
  buildCounterPlanNode++;
  if (buildCounterPlanNode < 3) {
    checkUnnamed4903(o.childLinks!);
    unittest.expect(
      o.displayName!,
      unittest.equals('foo'),
    );
    checkUnnamed4904(o.executionStats!);
    unittest.expect(
      o.index!,
      unittest.equals(42),
    );
    ...
    checkUnnamed4905(o.metadata!);
    checkShortRepresentation(o.shortRepresentation!);
  }
  buildCounterPlanNode--;
}

core.List<api.Binding> buildUnnamed4906() => [
      buildBinding(),
      buildBinding(),
    ];

void checkUnnamed4906(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
core.List<api.PlanNode> buildUnnamed4907() => [
      buildPlanNode(),
      buildPlanNode(),
    ];

void checkUnnamed4907(core.List<api.PlanNode> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPlanNode(o[0]);
  checkPlanNode(o[1]);
}
...
core.List<core.Object> buildUnnamed4909() => [
      {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed4909(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.List<core.Object>> buildUnnamed4910() => [
      buildUnnamed4909(),
      buildUnnamed4909(),
    ];

void checkUnnamed4910(core.List<core.List<core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed4909(o[0]);
  checkUnnamed4909(o[1]);
}
...
core.Map<core.String, core.Object> buildUnnamed4911() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed4911(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.String> buildUnnamed4913() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed4913(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.Map<core.String, core.int> buildUnnamed4914() => {
      'x': 42,
      'y': 42,
    };

void checkUnnamed4914(core.Map<core.String, core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals(42),
...
void checkShortRepresentation(api.ShortRepresentation o) {
  ...
  if (buildCounterShortRepresentation < 3) {
    ...
    checkUnnamed4914(o.subqueries!);
  }
  buildCounterShortRepresentation--;
}

core.Map<core.String, api.Type> buildUnnamed4915() => {
      'x': buildType(),
      'y': buildType(),
    };

void checkUnnamed4915(core.Map<core.String, api.Type> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkType(o['x']!);
  checkType(o['y']!);
}
...
api.Statement buildStatement() {
  ...
  if (buildCounterStatement < 3) {
    o.paramTypes = buildUnnamed4915();
    o.params = buildUnnamed4916();
    o.sql = 'foo';
  }
  buildCounterStatement--;
  return o;
...
void checkStatement(api.Statement o) {
  buildCounterStatement++;
  if (buildCounterStatement < 3) {
    checkUnnamed4915(o.paramTypes!);
    checkUnnamed4916(o.params!);
    unittest.expect(
      o.sql!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.Object> buildUnnamed4917() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed4917(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed4918() => [
      buildUnnamed4917(),
      buildUnnamed4917(),
    ];

void checkUnnamed4918(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed4917(o[0]);
  checkUnnamed4917(o[1]);
}
...
core.List<api.Field> buildUnnamed4919() => [
      buildField(),
      buildField(),
    ];

void checkUnnamed4919(core.List<api.Field> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkField(o[0]);
  checkField(o[1]);
}
...
core.List<api.OperationProgress> buildUnnamed4923() => [
      buildOperationProgress(),
      buildOperationProgress(),
    ];

void checkUnnamed4923(core.List<api.OperationProgress> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.UpdateDatabaseDdlMetadata buildUpdateDatabaseDdlMetadata() {
  ...
  if (buildCounterUpdateDatabaseDdlMetadata < 3) {
    o.commitTimestamps = buildUnnamed4922();
    o.database = 'foo';
    o.progress = buildUnnamed4923();
    o.statements = buildUnnamed4924();
    o.throttled = true;
  }
  buildCounterUpdateDatabaseDdlMetadata--;
  return o;
...
void checkUpdateDatabaseDdlMetadata(api.UpdateDatabaseDdlMetadata o) {
  buildCounterUpdateDatabaseDdlMetadata++;
  if (buildCounterUpdateDatabaseDdlMetadata < 3) {
    checkUnnamed4922(o.commitTimestamps!);
    unittest.expect(
      o.database!,
      unittest.equals('foo'),
    );
    checkUnnamed4923(o.progress!);
    checkUnnamed4924(o.statements!);
...
core.List<api.DiagnosticMessage> buildUnnamed4926() => [
      buildDiagnosticMessage(),
      buildDiagnosticMessage(),
    ];

void checkUnnamed4926(core.List<api.DiagnosticMessage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Metric> buildUnnamed4929() => [
      buildMetric(),
      buildMetric(),
    ];

void checkUnnamed4929(core.List<api.Metric> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetric(o[0]);
  checkMetric(o[1]);
}

core.List<api.PrefixNode> buildUnnamed4930() => [
      buildPrefixNode(),
      buildPrefixNode(),
    ];

void checkUnnamed4930(core.List<api.PrefixNode> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPrefixNode(o[0]);
  checkPrefixNode(o[1]);
}
...
api.VisualizationData buildVisualizationData() {
  ...
  if (buildCounterVisualizationData < 3) {
    ...
    o.diagnosticMessages = buildUnnamed4926();
    o.endKeyStrings = buildUnnamed4927();
    o.hasPii = true;
    o.indexedKeys = buildUnnamed4928();
    o.keySeparator = 'foo';
    o.keyUnit = 'foo';
    o.metrics = buildUnnamed4929();
    o.prefixNodes = buildUnnamed4930();
  }
  buildCounterVisualizationData--;
  return o;
}
...
void checkVisualizationData(api.VisualizationData o) {
  ...
  if (buildCounterVisualizationData < 3) {
    ...
    checkUnnamed4926(o.diagnosticMessages!);
    checkUnnamed4927(o.endKeyStrings!);
    unittest.expect(o.hasPii!, unittest.isTrue);
    checkUnnamed4928(o.indexedKeys!);
    unittest.expect(
      o.keySeparator!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed4929(o.metrics!);
    checkUnnamed4930(o.prefixNodes!);
  }
  buildCounterVisualizationData--;
}
...
core.List<core.Object> buildUnnamed4932() => [
      {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed4932(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.List<core.Object>> buildUnnamed4933() => [
      buildUnnamed4932(),
      buildUnnamed4932(),
    ];

void checkUnnamed4933(core.List<core.List<core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed4932(o[0]);
  checkUnnamed4932(o[1]);
}
...
api.Write buildWrite() {
  ...
  if (buildCounterWrite < 3) {
    o.columns = buildUnnamed4931();
    o.table = 'foo';
    o.values = buildUnnamed4933();
  }
  buildCounterWrite--;
  return o;
}
...
void checkWrite(api.Write o) {
  buildCounterWrite++;
  if (buildCounterWrite < 3) {
    checkUnnamed4931(o.columns!);
    unittest.expect(
      o.table!,
      unittest.equals('foo'),
    );
    checkUnnamed4933(o.values!);
  }
  buildCounterWrite--;
}
