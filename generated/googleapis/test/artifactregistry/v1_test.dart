...
core.Map<core.String, core.Object> buildUnnamed4096() {
...
void checkUnnamed4096(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed4096();
    o.name = 'foo';
    o.response = buildUnnamed4097();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkUnnamed4096(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed4097(o.response);
  }
  buildCounterOperation--;
}
...
core.List<core.Map<core.String, core.Object>> buildUnnamed4099() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed4098());
  o.add(buildUnnamed4098());
  return o;
}

void checkUnnamed4099(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed4098(o[0]);
  checkUnnamed4098(o[1]);
}
