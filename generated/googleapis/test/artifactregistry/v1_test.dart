...
api.Attachment buildAttachment() {
  ...
  if (buildCounterAttachment < 3) {
    ...
    o.attachmentNamespace = 'foo';
    o.createTime = 'foo';
    o.files = buildUnnamed1();
    o.name = 'foo';
    o.ociVersionName = 'foo';
    o.target = 'foo';
    o.type = 'foo';
    o.updateTime = 'foo';
  }
...
void checkAttachment(api.Attachment o) {
  ...
  if (buildCounterAttachment < 3) {
    ...
    unittest.expect(o.attachmentNamespace!, unittest.equals('foo'));
    unittest.expect(o.createTime!, unittest.equals('foo'));
    checkUnnamed1(o.files!);
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.ociVersionName!, unittest.equals('foo'));
...
core.int buildCounterCheckPrewarmedArtifactRequest = 0;
api.CheckPrewarmedArtifactRequest buildCheckPrewarmedArtifactRequest() {
  final o = api.CheckPrewarmedArtifactRequest();
  buildCounterCheckPrewarmedArtifactRequest++;
  if (buildCounterCheckPrewarmedArtifactRequest < 3) {
    o.streamLocation = 'foo';
    o.tag = 'foo';
    o.version = 'foo';
  }
  buildCounterCheckPrewarmedArtifactRequest--;
...
void checkCheckPrewarmedArtifactRequest(api.CheckPrewarmedArtifactRequest o) {
  buildCounterCheckPrewarmedArtifactRequest++;
  if (buildCounterCheckPrewarmedArtifactRequest < 3) {
    unittest.expect(o.streamLocation!, unittest.equals('foo'));
...
core.int buildCounterCheckPrewarmedArtifactResponse = 0;
api.CheckPrewarmedArtifactResponse buildCheckPrewarmedArtifactResponse() {
  final o = api.CheckPrewarmedArtifactResponse();
  buildCounterCheckPrewarmedArtifactResponse++;
  if (buildCounterCheckPrewarmedArtifactResponse < 3) {
    o.prewarmedArtifact = buildPrewarmedArtifact();
  }
  buildCounterCheckPrewarmedArtifactResponse--;
  return o;
}

void checkCheckPrewarmedArtifactResponse(api.CheckPrewarmedArtifactResponse o) {
  buildCounterCheckPrewarmedArtifactResponse++;
  if (buildCounterCheckPrewarmedArtifactResponse < 3) {
    checkPrewarmedArtifact(o.prewarmedArtifact!);
  }
  buildCounterCheckPrewarmedArtifactResponse--;
}
...
api.CleanupPolicyCondition buildCleanupPolicyCondition() {
  ...
  if (buildCounterCleanupPolicyCondition < 3) {
    o.newerThan = 'foo';
    o.olderThan = 'foo';
    o.packageNamePrefixes = buildUnnamed4();
    o.tagPrefixes = buildUnnamed5();
    o.tagState = 'foo';
    o.versionNamePrefixes = buildUnnamed6();
  }
  buildCounterCleanupPolicyCondition--;
  return o;
}
...
void checkCleanupPolicyCondition(api.CleanupPolicyCondition o) {
  ...
  if (buildCounterCleanupPolicyCondition < 3) {
    ...
    unittest.expect(o.olderThan!, unittest.equals('foo'));
    checkUnnamed4(o.packageNamePrefixes!);
    checkUnnamed5(o.tagPrefixes!);
    unittest.expect(o.tagState!, unittest.equals('foo'));
    checkUnnamed6(o.versionNamePrefixes!);
  }
  buildCounterCleanupPolicyCondition--;
}
...
api.CleanupPolicyMostRecentVersions buildCleanupPolicyMostRecentVersions() {
  ...
  if (buildCounterCleanupPolicyMostRecentVersions < 3) {
    o.keepCount = 42;
    o.packageNamePrefixes = buildUnnamed7();
  }
  buildCounterCleanupPolicyMostRecentVersions--;
  return o;
}
...
void checkCleanupPolicyMostRecentVersions(
  ...
  buildCounterCleanupPolicyMostRecentVersions++;
  if (buildCounterCleanupPolicyMostRecentVersions < 3) {
    unittest.expect(o.keepCount!, unittest.equals(42));
    checkUnnamed7(o.packageNamePrefixes!);
  }
  buildCounterCleanupPolicyMostRecentVersions--;
}

core.int buildCounterCommonRemoteRepository = 0;
api.CommonRemoteRepository buildCommonRemoteRepository() {
  final o = api.CommonRemoteRepository();
  buildCounterCommonRemoteRepository++;
  if (buildCounterCommonRemoteRepository < 3) {
    o.uri = 'foo';
  }
  buildCounterCommonRemoteRepository--;
  return o;
...
void checkCommonRemoteRepository(api.CommonRemoteRepository o) {
  buildCounterCommonRemoteRepository++;
  if (buildCounterCommonRemoteRepository < 3) {
...
core.List<api.ImageManifest> buildUnnamed8() => [
  buildImageManifest(),
  buildImageManifest(),
];

void checkUnnamed8(core.List<api.ImageManifest> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkImageManifest(o[0]);
  checkImageManifest(o[1]);
}
...
api.DockerImage buildDockerImage() {
  ...
  if (buildCounterDockerImage < 3) {
    o.artifactType = 'foo';
    o.buildTime = 'foo';
    o.imageManifests = buildUnnamed8();
...
void checkDockerImage(api.DockerImage o) {
  buildCounterDockerImage++;
  if (buildCounterDockerImage < 3) {
    unittest.expect(o.artifactType!, unittest.equals('foo'));
    unittest.expect(o.buildTime!, unittest.equals('foo'));
    checkUnnamed8(o.imageManifests!);
    unittest.expect(o.imageSizeBytes!, unittest.equals('foo'));
...
void checkDockerRepository(api.DockerRepository o) {
  ...
  if (buildCounterDockerRepository < 3) {
    ...
    unittest.expect(o.publicRepository!, unittest.equals('foo'));
  }
  buildCounterDockerRepository--;
}
...
core.int buildCounterExportArtifactRequest = 0;
api.ExportArtifactRequest buildExportArtifactRequest() {
  final o = api.ExportArtifactRequest();
  buildCounterExportArtifactRequest++;
  if (buildCounterExportArtifactRequest < 3) {
    o.gcsPath = 'foo';
    o.sourceTag = 'foo';
    o.sourceVersion = 'foo';
  }
...
void checkExportArtifactRequest(api.ExportArtifactRequest o) {
  buildCounterExportArtifactRequest++;
  if (buildCounterExportArtifactRequest < 3) {
    unittest.expect(o.gcsPath!, unittest.equals('foo'));
    unittest.expect(o.sourceTag!, unittest.equals('foo'));
...
core.List<api.Hash> buildUnnamed11() => [buildHash(), buildHash()];

void checkUnnamed11(core.List<api.Hash> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHash(o[0]);
  checkHash(o[1]);
}
...
checkGoogleDevtoolsArtifactregistryV1RemoteRepositoryConfigAptRepositoryPublicRepository(
  ...
  if (buildCounterGoogleDevtoolsArtifactregistryV1RemoteRepositoryConfigAptRepositoryPublicRepository <
      3) {
    unittest.expect(o.repositoryBase!, unittest.equals('foo'));
    unittest.expect(o.repositoryPath!, unittest.equals('foo'));
  }
  buildCounterGoogleDevtoolsArtifactregistryV1RemoteRepositoryConfigAptRepositoryPublicRepository--;
}
...
core.int buildCounterGoogleDevtoolsArtifactregistryV1Rule = 0;
api.GoogleDevtoolsArtifactregistryV1Rule
buildGoogleDevtoolsArtifactregistryV1Rule() {
  final o = api.GoogleDevtoolsArtifactregistryV1Rule();
  buildCounterGoogleDevtoolsArtifactregistryV1Rule++;
  if (buildCounterGoogleDevtoolsArtifactregistryV1Rule < 3) {
    o.action = 'foo';
    o.condition = buildExpr();
    o.name = 'foo';
    o.operation = 'foo';
...
void checkGoogleDevtoolsArtifactregistryV1Rule(
  api.GoogleDevtoolsArtifactregistryV1Rule o,
) {
  buildCounterGoogleDevtoolsArtifactregistryV1Rule++;
  if (buildCounterGoogleDevtoolsArtifactregistryV1Rule < 3) {
    unittest.expect(o.action!, unittest.equals('foo'));
...
core.int buildCounterImageManifest = 0;
api.ImageManifest buildImageManifest() {
  final o = api.ImageManifest();
  buildCounterImageManifest++;
  if (buildCounterImageManifest < 3) {
    o.architecture = 'foo';
    o.digest = 'foo';
    o.mediaType = 'foo';
    o.os = 'foo';
    o.osFeatures = buildUnnamed12();
    o.osVersion = 'foo';
    o.variant = 'foo';
  }
  buildCounterImageManifest--;
...
void checkImageManifest(api.ImageManifest o) {
  buildCounterImageManifest++;
  if (buildCounterImageManifest < 3) {
...
core.List<api.Attachment> buildUnnamed16() => [
  buildAttachment(),
  buildAttachment(),
];

void checkUnnamed16(core.List<api.Attachment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachment(o[0]);
  checkAttachment(o[1]);
}
...
void checkListAttachmentsResponse(api.ListAttachmentsResponse o) {
  buildCounterListAttachmentsResponse++;
  if (buildCounterListAttachmentsResponse < 3) {
    checkUnnamed16(o.attachments!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListAttachmentsResponse--;
}

core.List<api.DockerImage> buildUnnamed17() => [
  buildDockerImage(),
  buildDockerImage(),
];

void checkUnnamed17(core.List<api.DockerImage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListDockerImagesResponse(api.ListDockerImagesResponse o) {
  buildCounterListDockerImagesResponse++;
  if (buildCounterListDockerImagesResponse < 3) {
    checkUnnamed17(o.dockerImages!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListDockerImagesResponse--;
}

core.List<api.GoogleDevtoolsArtifactregistryV1File> buildUnnamed18() => [
  buildGoogleDevtoolsArtifactregistryV1File(),
  buildGoogleDevtoolsArtifactregistryV1File(),
];

void checkUnnamed18(core.List<api.GoogleDevtoolsArtifactregistryV1File> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Location> buildUnnamed19() => [buildLocation(), buildLocation()];
...
core.List<api.MavenArtifact> buildUnnamed20() => [
  buildMavenArtifact(),
  buildMavenArtifact(),
];

void checkUnnamed20(core.List<api.MavenArtifact> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListMavenArtifactsResponse buildListMavenArtifactsResponse() {
  ...
  if (buildCounterListMavenArtifactsResponse < 3) {
    o.mavenArtifacts = buildUnnamed20();
    o.nextPageToken = 'foo';
  }
  buildCounterListMavenArtifactsResponse--;
  return o;
...
void checkListMavenArtifactsResponse(api.ListMavenArtifactsResponse o) {
  buildCounterListMavenArtifactsResponse++;
  if (buildCounterListMavenArtifactsResponse < 3) {
    checkUnnamed20(o.mavenArtifacts!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListMavenArtifactsResponse--;
}

core.List<api.NpmPackage> buildUnnamed21() => [
  buildNpmPackage(),
  buildNpmPackage(),
];

void checkUnnamed21(core.List<api.NpmPackage> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNpmPackage(o[0]);
  checkNpmPackage(o[1]);
}
...
void checkListNpmPackagesResponse(api.ListNpmPackagesResponse o) {
  ...
  if (buildCounterListNpmPackagesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed21(o.npmPackages!);
  }
  buildCounterListNpmPackagesResponse--;
}

core.List<api.Package> buildUnnamed22() => [buildPackage(), buildPackage()];

void checkUnnamed22(core.List<api.Package> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPackage(o[0]);
  checkPackage(o[1]);
}
...
void checkListPackagesResponse(api.ListPackagesResponse o) {
  ...
  if (buildCounterListPackagesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed22(o.packages!);
  }
  buildCounterListPackagesResponse--;
}

core.List<api.PrewarmedArtifact> buildUnnamed23() => [
  buildPrewarmedArtifact(),
  buildPrewarmedArtifact(),
];

void checkUnnamed23(core.List<api.PrewarmedArtifact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPrewarmedArtifact(o[0]);
  checkPrewarmedArtifact(o[1]);
}

core.int buildCounterListPrewarmedArtifactsResponse = 0;
api.ListPrewarmedArtifactsResponse buildListPrewarmedArtifactsResponse() {
  final o = api.ListPrewarmedArtifactsResponse();
  buildCounterListPrewarmedArtifactsResponse++;
  if (buildCounterListPrewarmedArtifactsResponse < 3) {
    o.nextPageToken = 'foo';
    o.prewarmedArtifacts = buildUnnamed23();
  }
  buildCounterListPrewarmedArtifactsResponse--;
  return o;
}

void checkListPrewarmedArtifactsResponse(api.ListPrewarmedArtifactsResponse o) {
  buildCounterListPrewarmedArtifactsResponse++;
  if (buildCounterListPrewarmedArtifactsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed23(o.prewarmedArtifacts!);
  }
  buildCounterListPrewarmedArtifactsResponse--;
}

core.List<api.PythonPackage> buildUnnamed24() => [
  buildPythonPackage(),
  buildPythonPackage(),
];

void checkUnnamed24(core.List<api.PythonPackage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListPythonPackagesResponse buildListPythonPackagesResponse() {
  ...
  if (buildCounterListPythonPackagesResponse < 3) {
    o.nextPageToken = 'foo';
    o.pythonPackages = buildUnnamed24();
  }
  buildCounterListPythonPackagesResponse--;
  return o;
}
...
void checkListPythonPackagesResponse(api.ListPythonPackagesResponse o) {
  ...
  if (buildCounterListPythonPackagesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed24(o.pythonPackages!);
  }
  buildCounterListPythonPackagesResponse--;
}

core.List<api.Repository> buildUnnamed25() => [
  buildRepository(),
  buildRepository(),
];

void checkUnnamed25(core.List<api.Repository> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRepository(o[0]);
  checkRepository(o[1]);
}
...
void checkListRepositoriesResponse(api.ListRepositoriesResponse o) {
  ...
  if (buildCounterListRepositoriesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed25(o.repositories!);
  }
  buildCounterListRepositoriesResponse--;
}

core.List<api.GoogleDevtoolsArtifactregistryV1Rule> buildUnnamed26() => [
  buildGoogleDevtoolsArtifactregistryV1Rule(),
  buildGoogleDevtoolsArtifactregistryV1Rule(),
];

void checkUnnamed26(core.List<api.GoogleDevtoolsArtifactregistryV1Rule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleDevtoolsArtifactregistryV1Rule(o[0]);
  checkGoogleDevtoolsArtifactregistryV1Rule(o[1]);
}
...
core.List<api.Tag> buildUnnamed27() => [buildTag(), buildTag()];
...
core.List<api.Version> buildUnnamed28() => [buildVersion(), buildVersion()];

void checkUnnamed28(core.List<api.Version> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVersion(o[0]);
  checkVersion(o[1]);
}
...
void checkMavenArtifact(api.MavenArtifact o) {
  ...
  if (buildCounterMavenArtifact < 3) {
    ...
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.pomUri!, unittest.equals('foo'));
    unittest.expect(o.updateTime!, unittest.equals('foo'));
    unittest.expect(o.version!, unittest.equals('foo'));
  }
  buildCounterMavenArtifact--;
...
void checkMavenRepositoryConfig(api.MavenRepositoryConfig o) {
  ...
  if (buildCounterMavenRepositoryConfig < 3) {
    ...
    unittest.expect(o.versionPolicy!, unittest.equals('foo'));
  }
  buildCounterMavenRepositoryConfig--;
}

core.int buildCounterNoCacheFetching = 0;
api.NoCacheFetching buildNoCacheFetching() {
  final o = api.NoCacheFetching();
  buildCounterNoCacheFetching++;
  if (buildCounterNoCacheFetching < 3) {}
  buildCounterNoCacheFetching--;
  return o;
}

void checkNoCacheFetching(api.NoCacheFetching o) {
  buildCounterNoCacheFetching++;
  if (buildCounterNoCacheFetching < 3) {}
  buildCounterNoCacheFetching--;
}
...
core.int buildCounterPrewarmArtifactRequest = 0;
api.PrewarmArtifactRequest buildPrewarmArtifactRequest() {
  final o = api.PrewarmArtifactRequest();
  buildCounterPrewarmArtifactRequest++;
  if (buildCounterPrewarmArtifactRequest < 3) {
    o.force = true;
    o.platform = buildPrewarmPlatform();
    o.retentionDays = 'foo';
    o.streamLocation = 'foo';
    o.tag = 'foo';
    o.version = 'foo';
...
void checkPrewarmArtifactRequest(api.PrewarmArtifactRequest o) {
  buildCounterPrewarmArtifactRequest++;
  if (buildCounterPrewarmArtifactRequest < 3) {
    unittest.expect(o.force!, unittest.isTrue);
    checkPrewarmPlatform(o.platform!);
    unittest.expect(o.retentionDays!, unittest.equals('foo'));
    unittest.expect(o.streamLocation!, unittest.equals('foo'));
    unittest.expect(o.tag!, unittest.equals('foo'));
    unittest.expect(o.version!, unittest.equals('foo'));
  }
...
core.int buildCounterPrewarmPlatform = 0;
api.PrewarmPlatform buildPrewarmPlatform() {
  final o = api.PrewarmPlatform();
  buildCounterPrewarmPlatform++;
  if (buildCounterPrewarmPlatform < 3) {
    o.architecture = 'foo';
    o.os = 'foo';
  }
  buildCounterPrewarmPlatform--;
...
void checkPrewarmPlatform(api.PrewarmPlatform o) {
  buildCounterPrewarmPlatform++;
  if (buildCounterPrewarmPlatform < 3) {
    unittest.expect(o.architecture!, unittest.equals('foo'));
    unittest.expect(o.os!, unittest.equals('foo'));
...
core.int buildCounterPrewarmedArtifact = 0;
api.PrewarmedArtifact buildPrewarmedArtifact() {
  final o = api.PrewarmedArtifact();
  buildCounterPrewarmedArtifact++;
  if (buildCounterPrewarmedArtifact < 3) {
...
void checkPrewarmedArtifact(api.PrewarmedArtifact o) {
  buildCounterPrewarmedArtifact++;
  if (buildCounterPrewarmedArtifact < 3) {
...
void checkProjectSettings(api.ProjectSettings o) {
  buildCounterProjectSettings++;
  if (buildCounterProjectSettings < 3) {
    unittest.expect(o.legacyRedirectionState!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.pullPercent!, unittest.equals(42));
  }
  buildCounterProjectSettings--;
}
...
void checkRemoteRepositoryConfig(api.RemoteRepositoryConfig o) {
  ...
  if (buildCounterRemoteRepositoryConfig < 3) {
    ...
    checkCommonRemoteRepository(o.commonRepository!);
    unittest.expect(o.description!, unittest.equals('foo'));
    ...
    checkNoCacheFetching(o.noCache!);
...
core.int buildCounterRemovePrewarmedArtifactRequest = 0;
api.RemovePrewarmedArtifactRequest buildRemovePrewarmedArtifactRequest() {
  final o = api.RemovePrewarmedArtifactRequest();
  buildCounterRemovePrewarmedArtifactRequest++;
  if (buildCounterRemovePrewarmedArtifactRequest < 3) {
    o.streamLocation = 'foo';
    o.tag = 'foo';
    o.version = 'foo';
  }
...
void checkRemovePrewarmedArtifactRequest(api.RemovePrewarmedArtifactRequest o) {
  buildCounterRemovePrewarmedArtifactRequest++;
  if (buildCounterRemovePrewarmedArtifactRequest < 3) {
    unittest.expect(o.streamLocation!, unittest.equals('foo'));
    unittest.expect(o.tag!, unittest.equals('foo'));
...
core.int buildCounterRemovePrewarmedArtifactResponse = 0;
api.RemovePrewarmedArtifactResponse buildRemovePrewarmedArtifactResponse() {
  final o = api.RemovePrewarmedArtifactResponse();
  buildCounterRemovePrewarmedArtifactResponse++;
  if (buildCounterRemovePrewarmedArtifactResponse < 3) {
    o.prewarmedArtifact = buildPrewarmedArtifact();
  }
  buildCounterRemovePrewarmedArtifactResponse--;
  return o;
...
void checkRemovePrewarmedArtifactResponse(
  api.RemovePrewarmedArtifactResponse o,
) {
  buildCounterRemovePrewarmedArtifactResponse++;
  if (buildCounterRemovePrewarmedArtifactResponse < 3) {
    checkPrewarmedArtifact(o.prewarmedArtifact!);
...
core.Map<core.String, api.CleanupPolicy> buildUnnamed36() => {
  'x': buildCleanupPolicy(),
  'y': buildCleanupPolicy(),
};

void checkUnnamed36(core.Map<core.String, api.CleanupPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Repository buildRepository() {
  ...
  if (buildCounterRepository < 3) {
    o.cleanupPolicies = buildUnnamed36();
    ...
    o.vulnerabilityScanningConfig = buildVulnerabilityScanningConfig();
  }
  buildCounterRepository--;
  return o;
}
...
void checkRepository(api.Repository o) {
  buildCounterRepository++;
  if (buildCounterRepository < 3) {
    checkUnnamed36(o.cleanupPolicies!);
    ...
    checkVulnerabilityScanningConfig(o.vulnerabilityScanningConfig!);
  }
  buildCounterRepository--;
}
...
core.int buildCounterUploadFileMediaResponse = 0;
api.UploadFileMediaResponse buildUploadFileMediaResponse() {
  final o = api.UploadFileMediaResponse();
  buildCounterUploadFileMediaResponse++;
  if (buildCounterUploadFileMediaResponse < 3) {
    o.operation = buildOperation();
  }
  buildCounterUploadFileMediaResponse--;
  return o;
...
void checkUploadFileMediaResponse(api.UploadFileMediaResponse o) {
  buildCounterUploadFileMediaResponse++;
  if (buildCounterUploadFileMediaResponse < 3) {
    checkOperation(o.operation!);
  }
...
core.int buildCounterUploadFileRequest = 0;
api.UploadFileRequest buildUploadFileRequest() {
  final o = api.UploadFileRequest();
...
void checkUploadFileRequest(api.UploadFileRequest o) {
  buildCounterUploadFileRequest++;
  if (buildCounterUploadFileRequest < 3) {
...
void checkVPCSCConfig(api.VPCSCConfig o) {
  ...
  if (buildCounterVPCSCConfig < 3) {
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.vpcscPolicy!, unittest.equals('foo'));
  }
  buildCounterVPCSCConfig--;
}
...
core.int buildCounterVulnerabilityScanningConfig = 0;
api.VulnerabilityScanningConfig buildVulnerabilityScanningConfig() {
  final o = api.VulnerabilityScanningConfig();
  buildCounterVulnerabilityScanningConfig++;
  if (buildCounterVulnerabilityScanningConfig < 3) {
    o.enablementConfig = 'foo';
    o.enablementState = 'foo';
    o.enablementStateReason = 'foo';
...
void checkVulnerabilityScanningConfig(api.VulnerabilityScanningConfig o) {
  buildCounterVulnerabilityScanningConfig++;
  if (buildCounterVulnerabilityScanningConfig < 3) {
    unittest.expect(o.enablementConfig!, unittest.equals('foo'));
    unittest.expect(o.enablementState!, unittest.equals('foo'));
    unittest.expect(o.enablementStateReason!, unittest.equals('foo'));
    unittest.expect(o.lastEnableTime!, unittest.equals('foo'));
  }
  buildCounterVulnerabilityScanningConfig--;
}
...
void main() {
  ...
  unittest.group('obj-schema-Attachment', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Attachment.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkAttachment(od);
    });
  ...
  unittest.group('obj-schema-CheckPrewarmedArtifactRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCheckPrewarmedArtifactRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CheckPrewarmedArtifactRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCheckPrewarmedArtifactRequest(od);
    });
  });

  unittest.group('obj-schema-CheckPrewarmedArtifactResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCheckPrewarmedArtifactResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CheckPrewarmedArtifactResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCheckPrewarmedArtifactResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-CommonRemoteRepository', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCommonRemoteRepository();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CommonRemoteRepository.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCommonRemoteRepository(od);
    });
  });
  ...
  unittest.group('obj-schema-ExportArtifactRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildExportArtifactRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ExportArtifactRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkExportArtifactRequest(od);
    });
  });
  ...
  unittest.group('obj-schema-GoogleDevtoolsArtifactregistryV1Rule', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleDevtoolsArtifactregistryV1Rule();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleDevtoolsArtifactregistryV1Rule.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleDevtoolsArtifactregistryV1Rule(od);
    });
  });
  ...
  unittest.group('obj-schema-ImageManifest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildImageManifest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ImageManifest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkImageManifest(od);
    });
  });
  ...
  unittest.group('obj-schema-ListPrewarmedArtifactsResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildListPrewarmedArtifactsResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListPrewarmedArtifactsResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkListPrewarmedArtifactsResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-NoCacheFetching', () {
    unittest.test('to-json--from-json', () async {
      final o = buildNoCacheFetching();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.NoCacheFetching.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkNoCacheFetching(od);
    });
  });
  ...
  unittest.group('obj-schema-NpmPackage', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.NpmPackage.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkNpmPackage(od);
    });
  ...
  unittest.group('obj-schema-PrewarmArtifactRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildPrewarmArtifactRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.PrewarmArtifactRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPrewarmArtifactRequest(od);
    });
  });

  unittest.group('obj-schema-PrewarmPlatform', () {
    unittest.test('to-json--from-json', () async {
      final o = buildPrewarmPlatform();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.PrewarmPlatform.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPrewarmPlatform(od);
    });
  });

  unittest.group('obj-schema-PrewarmedArtifact', () {
    unittest.test('to-json--from-json', () async {
      final o = buildPrewarmedArtifact();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.PrewarmedArtifact.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPrewarmedArtifact(od);
    });
  });
  ...
  unittest.group('obj-schema-RemovePrewarmedArtifactRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildRemovePrewarmedArtifactRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.RemovePrewarmedArtifactRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkRemovePrewarmedArtifactRequest(od);
    });
  });

  unittest.group('obj-schema-RemovePrewarmedArtifactResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildRemovePrewarmedArtifactResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.RemovePrewarmedArtifactResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkRemovePrewarmedArtifactResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-UploadFileMediaResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildUploadFileMediaResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.UploadFileMediaResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkUploadFileMediaResponse(od);
    });
  });

  unittest.group('obj-schema-UploadFileRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildUploadFileRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.UploadFileRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkUploadFileRequest(od);
    });
  });
  ...
  unittest.group('obj-schema-VulnerabilityScanningConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildVulnerabilityScanningConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.VulnerabilityScanningConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkVulnerabilityScanningConfig(od);
    });
  });
  ...
  unittest.group('resource-ProjectsResource', () {
    unittest.test('method--getProjectSettings', () async {
      ...
      final response = await res.getProjectSettings(
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--updateProjectSettings', () async {
      ...
      final response = await res.updateProjectSettings(
        arg_request,
        arg_name,
  ...
  unittest.group('resource-ProjectsLocationsResource', () {
    ...
    unittest.test('method--updateVpcscConfig', () async {
      ...
      final response = await res.updateVpcscConfig(
        arg_request,
        arg_name,
        updateMask: arg_updateMask,
        $fields: arg_$fields,
  ...
  unittest.group('resource-ProjectsLocationsRepositoriesResource', () {
    unittest.test('method--checkPrewarmedArtifact', () async {
      final mock = HttpServerMock();
      final res = api.ArtifactRegistryApi(mock).projects.locations.repositories;
      final arg_request = buildCheckPrewarmedArtifactRequest();
      final arg_repository = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.CheckPrewarmedArtifactRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkCheckPrewarmedArtifactRequest(obj);
          ...
          final resp = convert.json.encode(
            buildCheckPrewarmedArtifactResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.checkPrewarmedArtifact(
        arg_request,
        arg_repository,
        $fields: arg_$fields,
      );
      checkCheckPrewarmedArtifactResponse(
        response as api.CheckPrewarmedArtifactResponse,
      );
    });
    ...
    unittest.test('method--exportArtifact', () async {
      final mock = HttpServerMock();
      final res = api.ArtifactRegistryApi(mock).projects.locations.repositories;
      final arg_request = buildExportArtifactRequest();
      final arg_repository = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.ExportArtifactRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkExportArtifactRequest(obj);
      ...
      final response = await res.exportArtifact(
        arg_request,
        arg_repository,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--prewarmArtifact', () async {
      final mock = HttpServerMock();
      final res = api.ArtifactRegistryApi(mock).projects.locations.repositories;
      final arg_request = buildPrewarmArtifactRequest();
      final arg_repository = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.PrewarmArtifactRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkPrewarmArtifactRequest(obj);
      ...
      final response = await res.prewarmArtifact(
        arg_request,
        arg_repository,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--removePrewarmedArtifact', () async {
      final mock = HttpServerMock();
      final res = api.ArtifactRegistryApi(mock).projects.locations.repositories;
      final arg_request = buildRemovePrewarmedArtifactRequest();
      final arg_repository = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.RemovePrewarmedArtifactRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkRemovePrewarmedArtifactRequest(obj);
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildRemovePrewarmedArtifactResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.removePrewarmedArtifact(
        arg_request,
        arg_repository,
        $fields: arg_$fields,
      );
      checkRemovePrewarmedArtifactResponse(
        response as api.RemovePrewarmedArtifactResponse,
      );
    });
  ...
  unittest.group('resource-ProjectsLocationsRepositoriesAttachmentsResource', () {
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Attachment.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkAttachment(obj);
  ...
  unittest.group('resource-ProjectsLocationsRepositoriesFilesResource', () {
    ...
    unittest.test('method--patch', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.GoogleDevtoolsArtifactregistryV1File.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkGoogleDevtoolsArtifactregistryV1File(obj);
    ...
    unittest.test('method--upload', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.UploadFileRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkUploadFileRequest(obj);
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildUploadFileMediaResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      ...
      checkUploadFileMediaResponse(response as api.UploadFileMediaResponse);
    });
  });
      ...
      unittest.test('method--upload', () async {
        ...
        mock.register(
          unittest.expectAsync2((http.BaseRequest req, json) {
            ...
            final h = {'content-type': 'application/json; charset=utf-8'};
            final resp = convert.json.encode(
              buildUploadGoogetArtifactMediaResponse(),
            );
            return async.Future.value(stringResponse(200, h, resp));
          }),
          true,
  ...
  unittest.group(
    'resource-ProjectsLocationsRepositoriesKfpArtifactsResource',
    () {
      unittest.test('method--upload', () async {
        // TODO: Implement tests for media upload;
        // TODO: Implement tests for media download;
        ...
        mock.register(
          unittest.expectAsync2((http.BaseRequest req, json) {
            ...
            final h = {'content-type': 'application/json; charset=utf-8'};
            final resp = convert.json.encode(
              buildUploadKfpArtifactMediaResponse(),
            );
            return async.Future.value(stringResponse(200, h, resp));
          }),
          true,
  ...
  unittest.group(
    'resource-ProjectsLocationsRepositoriesMavenArtifactsResource',
    () {
      unittest.test('method--get', () async {
        final mock = HttpServerMock();
        final res = api.ArtifactRegistryApi(
  ...
  unittest.group('resource-ProjectsLocationsRepositoriesPackagesResource', () {
    ...
    unittest.test('method--patch', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Package.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkPackage(obj);
  ...
  unittest.group(
    'resource-ProjectsLocationsRepositoriesPrewarmedArtifactsResource',
    () {
      unittest.test('method--list', () async {
        final mock = HttpServerMock();
        final res = api.ArtifactRegistryApi(
          mock,
        ).projects.locations.repositories.prewarmedArtifacts;
        final arg_parent = 'foo';
        final arg_filter = 'foo';
        final arg_pageSize = 42;
        final arg_pageToken = 'foo';
        ...
        mock.register(
          unittest.expectAsync2((http.BaseRequest req, json) {
            ...
            final h = {'content-type': 'application/json; charset=utf-8'};
            final resp = convert.json.encode(
              buildListPrewarmedArtifactsResponse(),
            );
            return async.Future.value(stringResponse(200, h, resp));
          }),
          true,
        ...
        checkListPrewarmedArtifactsResponse(
          response as api.ListPrewarmedArtifactsResponse,
        );
      });
    },
  );
  ...
  unittest.group(
    'resource-ProjectsLocationsRepositoriesPythonPackagesResource',
    () {
      unittest.test('method--get', () async {
        final mock = HttpServerMock();
        final res = api.ArtifactRegistryApi(
  ...
  unittest.group('resource-ProjectsLocationsRepositoriesRulesResource', () {
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.GoogleDevtoolsArtifactregistryV1Rule.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkGoogleDevtoolsArtifactregistryV1Rule(obj);
      ...
      checkGoogleDevtoolsArtifactregistryV1Rule(
        response as api.GoogleDevtoolsArtifactregistryV1Rule,
      );
    });
    ...
    unittest.test('method--upload', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildUploadYumArtifactMediaResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
