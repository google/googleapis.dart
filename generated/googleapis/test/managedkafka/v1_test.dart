...
api.AccessConfig buildAccessConfig() {
  ...
  if (buildCounterAccessConfig < 3) {
    ...
    o.publicClusterConfig = buildPublicClusterConfig();
  }
  buildCounterAccessConfig--;
  return o;
}
...
void checkAccessConfig(api.AccessConfig o) {
  ...
  if (buildCounterAccessConfig < 3) {
    ...
    checkPublicClusterConfig(o.publicClusterConfig!);
  }
  buildCounterAccessConfig--;
}
...
core.int buildCounterBrokerCapacityConfig = 0;
api.BrokerCapacityConfig buildBrokerCapacityConfig() {
  final o = api.BrokerCapacityConfig();
  buildCounterBrokerCapacityConfig++;
  if (buildCounterBrokerCapacityConfig < 3) {
    o.diskSizeGib = 'foo';
  }
  buildCounterBrokerCapacityConfig--;
  return o;
...
void checkBrokerCapacityConfig(api.BrokerCapacityConfig o) {
  buildCounterBrokerCapacityConfig++;
  if (buildCounterBrokerCapacityConfig < 3) {
    unittest.expect(o.diskSizeGib!, unittest.equals('foo'));
  }
  buildCounterBrokerCapacityConfig--;
}

core.int buildCounterBrokerDetails = 0;
api.BrokerDetails buildBrokerDetails() {
  final o = api.BrokerDetails();
  buildCounterBrokerDetails++;
  if (buildCounterBrokerDetails < 3) {
    o.brokerIndex = 'foo';
    o.nodeId = 'foo';
    o.rack = 'foo';
  }
...
void checkBrokerDetails(api.BrokerDetails o) {
  buildCounterBrokerDetails++;
  if (buildCounterBrokerDetails < 3) {
    unittest.expect(o.brokerIndex!, unittest.equals('foo'));
    unittest.expect(o.nodeId!, unittest.equals('foo'));
    unittest.expect(o.rack!, unittest.equals('foo'));
  }
  buildCounterBrokerDetails--;
}
...
core.List<api.BrokerDetails> buildUnnamed4() => [
  buildBrokerDetails(),
  buildBrokerDetails(),
];

void checkUnnamed4(core.List<api.BrokerDetails> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBrokerDetails(o[0]);
  checkBrokerDetails(o[1]);
}
...
api.Cluster buildCluster() {
  ...
  if (buildCounterCluster < 3) {
    o.bootstrapAddress = 'foo';
    o.brokerCapacityConfig = buildBrokerCapacityConfig();
    o.brokerDetails = buildUnnamed4();
    o.capacityConfig = buildCapacityConfig();
    o.createTime = 'foo';
    o.effectiveCapacityConfig = buildEffectiveCapacityConfig();
    o.gcpConfig = buildGcpConfig();
    o.kafkaVersion = 'foo';
    o.labels = buildUnnamed5();
    o.name = 'foo';
    o.publicClusterDetails = buildPublicClusterDetails();
...
void checkCluster(api.Cluster o) {
  buildCounterCluster++;
  if (buildCounterCluster < 3) {
    unittest.expect(o.bootstrapAddress!, unittest.equals('foo'));
    checkBrokerCapacityConfig(o.brokerCapacityConfig!);
    checkUnnamed4(o.brokerDetails!);
    checkCapacityConfig(o.capacityConfig!);
    unittest.expect(o.createTime!, unittest.equals('foo'));
    checkEffectiveCapacityConfig(o.effectiveCapacityConfig!);
    checkGcpConfig(o.gcpConfig!);
    unittest.expect(o.kafkaVersion!, unittest.equals('foo'));
    checkUnnamed5(o.labels!);
    unittest.expect(o.name!, unittest.equals('foo'));
    checkPublicClusterDetails(o.publicClusterDetails!);
...
core.List<api.ConnectNetworkConfig> buildUnnamed6() => [
  buildConnectNetworkConfig(),
  buildConnectNetworkConfig(),
];

void checkUnnamed6(core.List<api.ConnectNetworkConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ConnectAccessConfig buildConnectAccessConfig() {
  ...
  if (buildCounterConnectAccessConfig < 3) {
    o.networkConfigs = buildUnnamed6();
  }
  buildCounterConnectAccessConfig--;
  return o;
}
...
void checkConnectAccessConfig(api.ConnectAccessConfig o) {
  buildCounterConnectAccessConfig++;
  if (buildCounterConnectAccessConfig < 3) {
    checkUnnamed6(o.networkConfigs!);
  }
  buildCounterConnectAccessConfig--;
}
...
api.ConnectNetworkConfig buildConnectNetworkConfig() {
  ...
  if (buildCounterConnectNetworkConfig < 3) {
    o.additionalSubnets = buildUnnamed10();
    o.dnsDomainNames = buildUnnamed11();
    o.primarySubnet = 'foo';
  }
  buildCounterConnectNetworkConfig--;
  return o;
...
void checkConnectNetworkConfig(api.ConnectNetworkConfig o) {
  buildCounterConnectNetworkConfig++;
  if (buildCounterConnectNetworkConfig < 3) {
    checkUnnamed10(o.additionalSubnets!);
    checkUnnamed11(o.dnsDomainNames!);
...
core.Map<core.String, api.ConsumerTopicMetadata> buildUnnamed13() => {
  'x': buildConsumerTopicMetadata(),
  'y': buildConsumerTopicMetadata(),
};

void checkUnnamed13(core.Map<core.String, api.ConsumerTopicMetadata> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, api.ConsumerPartitionMetadata> buildUnnamed14() => {
  'x': buildConsumerPartitionMetadata(),
  'y': buildConsumerPartitionMetadata(),
};

void checkUnnamed14(core.Map<core.String, api.ConsumerPartitionMetadata> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.SchemaReference> buildUnnamed16() => [
  buildSchemaReference(),
  buildSchemaReference(),
];

void checkUnnamed16(core.List<api.SchemaReference> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSchemaReference(o[0]);
  checkSchemaReference(o[1]);
}
...
core.int buildCounterEffectiveCapacityConfig = 0;
api.EffectiveCapacityConfig buildEffectiveCapacityConfig() {
  final o = api.EffectiveCapacityConfig();
  buildCounterEffectiveCapacityConfig++;
  if (buildCounterEffectiveCapacityConfig < 3) {
    o.brokerCount = 'foo';
    o.brokerDiskSizeGib = 'foo';
  }
  buildCounterEffectiveCapacityConfig--;
  return o;
}

void checkEffectiveCapacityConfig(api.EffectiveCapacityConfig o) {
  buildCounterEffectiveCapacityConfig++;
  if (buildCounterEffectiveCapacityConfig < 3) {
    unittest.expect(o.brokerCount!, unittest.equals('foo'));
    unittest.expect(o.brokerDiskSizeGib!, unittest.equals('foo'));
  }
  buildCounterEffectiveCapacityConfig--;
}
...
void checkHttpBody(api.HttpBody o) {
  ...
  if (buildCounterHttpBody < 3) {
    ...
    checkUnnamed18(o.extensions!);
  }
  buildCounterHttpBody--;
}

core.List<api.Acl> buildUnnamed19() => [buildAcl(), buildAcl()];

void checkUnnamed19(core.List<api.Acl> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAcl(o[0]);
  checkAcl(o[1]);
}
...
core.List<api.ConnectCluster> buildUnnamed22() => [
  buildConnectCluster(),
  buildConnectCluster(),
];

void checkUnnamed22(core.List<api.ConnectCluster> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListConnectClustersResponse buildListConnectClustersResponse() {
  ...
  if (buildCounterListConnectClustersResponse < 3) {
    o.connectClusters = buildUnnamed22();
    o.nextPageToken = 'foo';
...
void checkListConnectClustersResponse(api.ListConnectClustersResponse o) {
  buildCounterListConnectClustersResponse++;
  if (buildCounterListConnectClustersResponse < 3) {
    checkUnnamed22(o.connectClusters!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
...
core.List<api.ConsumerGroup> buildUnnamed25() => [
  buildConsumerGroup(),
  buildConsumerGroup(),
];

void checkUnnamed25(core.List<api.ConsumerGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListConsumerGroupsResponse buildListConsumerGroupsResponse() {
  ...
  if (buildCounterListConsumerGroupsResponse < 3) {
    o.consumerGroups = buildUnnamed25();
    o.nextPageToken = 'foo';
  }
  buildCounterListConsumerGroupsResponse--;
  return o;
...
void checkListConsumerGroupsResponse(api.ListConsumerGroupsResponse o) {
  buildCounterListConsumerGroupsResponse++;
  if (buildCounterListConsumerGroupsResponse < 3) {
    checkUnnamed25(o.consumerGroups!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListConsumerGroupsResponse--;
}

core.List<api.Location> buildUnnamed26() => [buildLocation(), buildLocation()];
...
core.List<api.SchemaRegistry> buildUnnamed29() => [
  buildSchemaRegistry(),
  buildSchemaRegistry(),
];

void checkUnnamed29(core.List<api.SchemaRegistry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListSchemaRegistriesResponse buildListSchemaRegistriesResponse() {
  ...
  if (buildCounterListSchemaRegistriesResponse < 3) {
    o.schemaRegistries = buildUnnamed29();
  }
  buildCounterListSchemaRegistriesResponse--;
  return o;
}
...
void checkListSchemaRegistriesResponse(api.ListSchemaRegistriesResponse o) {
  buildCounterListSchemaRegistriesResponse++;
  if (buildCounterListSchemaRegistriesResponse < 3) {
    checkUnnamed29(o.schemaRegistries!);
  }
  buildCounterListSchemaRegistriesResponse--;
}

core.List<api.Topic> buildUnnamed30() => [buildTopic(), buildTopic()];

void checkUnnamed30(core.List<api.Topic> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTopic(o[0]);
  checkTopic(o[1]);
}
...
core.List<api.SchemaReference> buildUnnamed33() => [
  buildSchemaReference(),
  buildSchemaReference(),
];

void checkUnnamed33(core.List<api.SchemaReference> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSchemaReference(o[0]);
  checkSchemaReference(o[1]);
}
...
core.int buildCounterPublicClusterConfig = 0;
api.PublicClusterConfig buildPublicClusterConfig() {
  final o = api.PublicClusterConfig();
  buildCounterPublicClusterConfig++;
  if (buildCounterPublicClusterConfig < 3) {
    o.allowedSourceIpRanges = buildUnnamed36();
  }
  buildCounterPublicClusterConfig--;
  return o;
}

void checkPublicClusterConfig(api.PublicClusterConfig o) {
  buildCounterPublicClusterConfig++;
  if (buildCounterPublicClusterConfig < 3) {
    checkUnnamed36(o.allowedSourceIpRanges!);
  }
  buildCounterPublicClusterConfig--;
}
...
core.int buildCounterPublicClusterDetails = 0;
api.PublicClusterDetails buildPublicClusterDetails() {
  final o = api.PublicClusterDetails();
  buildCounterPublicClusterDetails++;
  if (buildCounterPublicClusterDetails < 3) {
    o.discoveryDnsRecords = buildUnnamed37();
    o.externalIpAddresses = buildUnnamed38();
  }
  buildCounterPublicClusterDetails--;
  return o;
}

void checkPublicClusterDetails(api.PublicClusterDetails o) {
  buildCounterPublicClusterDetails++;
  if (buildCounterPublicClusterDetails < 3) {
    checkUnnamed37(o.discoveryDnsRecords!);
    checkUnnamed38(o.externalIpAddresses!);
  }
  buildCounterPublicClusterDetails--;
}
...
core.List<api.SchemaReference> buildUnnamed39() => [
  buildSchemaReference(),
  buildSchemaReference(),
];

void checkUnnamed39(core.List<api.SchemaReference> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSchemaReference(o[0]);
  checkSchemaReference(o[1]);
}
...
void checkSchemaRegistry(api.SchemaRegistry o) {
  buildCounterSchemaRegistry++;
  if (buildCounterSchemaRegistry < 3) {
    checkUnnamed40(o.contexts!);
    unittest.expect(o.name!, unittest.equals('foo'));
  }
  buildCounterSchemaRegistry--;
}

core.List<api.SchemaReference> buildUnnamed41() => [
  buildSchemaReference(),
  buildSchemaReference(),
];

void checkUnnamed41(core.List<api.SchemaReference> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSchemaReference(o[0]);
  checkSchemaReference(o[1]);
}
...
void checkTaskRetryPolicy(api.TaskRetryPolicy o) {
  ...
  if (buildCounterTaskRetryPolicy < 3) {
    ...
    unittest.expect(o.taskRetryDisabled!, unittest.isTrue);
  }
  buildCounterTaskRetryPolicy--;
}
...
core.List<api.CertificateAuthorityServiceConfig> buildUnnamed45() => [
  buildCertificateAuthorityServiceConfig(),
  buildCertificateAuthorityServiceConfig(),
];

void checkUnnamed45(core.List<api.CertificateAuthorityServiceConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void main() {
  ...
  unittest.group('obj-schema-BrokerCapacityConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildBrokerCapacityConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.BrokerCapacityConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkBrokerCapacityConfig(od);
    });
  });

  unittest.group('obj-schema-BrokerDetails', () {
    unittest.test('to-json--from-json', () async {
      final o = buildBrokerDetails();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.BrokerDetails.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkBrokerDetails(od);
    });
  });
  ...
  unittest.group('obj-schema-EffectiveCapacityConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildEffectiveCapacityConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.EffectiveCapacityConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkEffectiveCapacityConfig(od);
    });
  });
  ...
  unittest.group('obj-schema-PublicClusterConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildPublicClusterConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.PublicClusterConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPublicClusterConfig(od);
    });
  });

  unittest.group('obj-schema-PublicClusterDetails', () {
    unittest.test('to-json--from-json', () async {
      final o = buildPublicClusterDetails();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.PublicClusterDetails.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPublicClusterDetails(od);
    });
  });
