...
core.List<api.AclEntry> buildUnnamed1() => [
      buildAclEntry(),
      buildAclEntry(),
    ];
...
core.List<api.Acl> buildUnnamed18() => [
      buildAcl(),
      buildAcl(),
    ];
...
core.List<api.Topic> buildUnnamed28() => [
      buildTopic(),
      buildTopic(),
    ];
...
void main() {
  ...
  unittest.group('obj-schema-GcpConfig', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od =
          api.GcpConfig.fromJson(oJson as core.Map<core.String, core.dynamic>);
      checkGcpConfig(od);
    });
  });
  ...
  unittest.group('obj-schema-SchemaMode', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od =
          api.SchemaMode.fromJson(oJson as core.Map<core.String, core.dynamic>);
      checkSchemaMode(od);
    });
  });
  ...
  unittest.group('obj-schema-TlsConfig', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od =
          api.TlsConfig.fromJson(oJson as core.Map<core.String, core.dynamic>);
      checkTlsConfig(od);
    });
  });
  ...
  unittest.group('resource-ProjectsLocationsClustersAclsResource', () {
    unittest.test('method--addAclEntry', () async {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final obj =
            api.AclEntry.fromJson(json as core.Map<core.String, core.dynamic>);
        checkAclEntry(obj);
      ...
      final response =
          await res.addAclEntry(arg_request, arg_acl, $fields: arg_$fields);
    ...
    unittest.test('method--create', () async {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final obj =
            api.Acl.fromJson(json as core.Map<core.String, core.dynamic>);
        checkAcl(obj);
        ...
        unittest.expect(
          queryMap['aclId']!.first,
          unittest.equals(arg_aclId),
        );
        unittest.expect(
          queryMap['fields']!.first,
          unittest.equals(arg_$fields),
      ...
      final response = await res.create(arg_request, arg_parent,
          aclId: arg_aclId, $fields: arg_$fields);
    ...
    unittest.test('method--removeAclEntry', () async {
      ...
      final response =
          await res.removeAclEntry(arg_request, arg_acl, $fields: arg_$fields);
  ...
  unittest.group(
    ...
    unittest.test('method--checkCompatibility', () async {
      ...
      final response = await res.checkCompatibility(arg_request, arg_name,
          $fields: arg_$fields);
  ...
  unittest.group('resource-ProjectsLocationsSchemaRegistriesConfigResource',
    ...
    unittest.test('method--get', () async {
      ...
      final response = await res.get(arg_name,
          defaultToGlobal: arg_defaultToGlobal, $fields: arg_$fields);
      checkSchemaConfig(response as api.SchemaConfig);
    });
  ...
  unittest.group(
    ...
    unittest.test('method--get', () async {
      ...
      final response =
          await res.get(arg_name, subject: arg_subject, $fields: arg_$fields);
    ...
    unittest.test('method--getSchema', () async {
      ...
      final response = await res.getSchema(arg_name,
          subject: arg_subject, $fields: arg_$fields);
      checkHttpBody(response as api.HttpBody);
    });
  });
  ...
  unittest.group(
    ...
    unittest.test('method--list', () async {
      ...
      final response = await res.list(arg_parent,
          deleted: arg_deleted, subject: arg_subject, $fields: arg_$fields);
      checkHttpBody(response as api.HttpBody);
    });
  });
  ...
  unittest.group(
    ...
    unittest.test('method--delete', () async {
      ...
      final response = await res.delete(arg_name,
          permanent: arg_permanent, $fields: arg_$fields);
      checkHttpBody(response as api.HttpBody);
    });
    ...
    unittest.test('method--lookupVersion', () async {
      ...
      final response = await res.lookupVersion(arg_request, arg_parent,
          $fields: arg_$fields);
  ...
  unittest.group(
    ...
    unittest.test('method--get', () async {
      ...
      final response =
          await res.get(arg_name, deleted: arg_deleted, $fields: arg_$fields);
      checkSchemaVersion(response as api.SchemaVersion);
    });
    ...
    unittest.test('method--getSchema', () async {
      ...
      final response = await res.getSchema(arg_name,
          deleted: arg_deleted, $fields: arg_$fields);
      checkHttpBody(response as api.HttpBody);
    });
