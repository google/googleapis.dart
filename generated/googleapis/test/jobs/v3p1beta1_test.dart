...
import 'package:googleapis/jobs/v3p1beta1.dart' as api;
...
core.List<api.CompensationHistogramResult> buildUnnamed15() => [
  buildCompensationHistogramResult(),
  buildCompensationHistogramResult(),
];

void checkUnnamed15(core.List<api.CompensationHistogramResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCompensationHistogramResult(o[0]);
  checkCompensationHistogramResult(o[1]);
}

core.List<api.CustomAttributeHistogramResult> buildUnnamed16() => [
  buildCustomAttributeHistogramResult(),
  buildCustomAttributeHistogramResult(),
];

void checkUnnamed16(core.List<api.CustomAttributeHistogramResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCustomAttributeHistogramResult(o[0]);
  checkCustomAttributeHistogramResult(o[1]);
}

core.List<api.HistogramResult> buildUnnamed17() => [
  buildHistogramResult(),
  buildHistogramResult(),
];

void checkUnnamed17(core.List<api.HistogramResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.HistogramResults buildHistogramResults() {
  ...
  if (buildCounterHistogramResults < 3) {
    o.compensationHistogramResults = buildUnnamed15();
    o.customAttributeHistogramResults = buildUnnamed16();
    o.simpleHistogramResults = buildUnnamed17();
  }
  buildCounterHistogramResults--;
  return o;
}
...
void checkHistogramResults(api.HistogramResults o) {
  buildCounterHistogramResults++;
  if (buildCounterHistogramResults < 3) {
    checkUnnamed15(o.compensationHistogramResults!);
    checkUnnamed16(o.customAttributeHistogramResults!);
    checkUnnamed17(o.simpleHistogramResults!);
  }
  buildCounterHistogramResults--;
}
...
core.Map<core.String, api.CustomAttribute> buildUnnamed19() => {
  'x': buildCustomAttribute(),
  'y': buildCustomAttribute(),
};

void checkUnnamed19(core.Map<core.String, api.CustomAttribute> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Job buildJob() {
  ...
  if (buildCounterJob < 3) {
    o.addresses = buildUnnamed18();
    o.applicationInfo = buildApplicationInfo();
    o.companyDisplayName = 'foo';
    o.companyName = 'foo';
    o.compensationInfo = buildCompensationInfo();
    o.customAttributes = buildUnnamed19();
    o.degreeTypes = buildUnnamed20();
    o.department = 'foo';
    o.derivedInfo = buildJobDerivedInfo();
    o.description = 'foo';
    o.employmentTypes = buildUnnamed21();
    o.incentives = 'foo';
    o.jobBenefits = buildUnnamed22();
    o.jobEndTime = 'foo';
    o.jobLevel = 'foo';
    o.jobStartTime = 'foo';
    o.languageCode = 'foo';
...
api.JobDerivedInfo buildJobDerivedInfo() {
  ...
  if (buildCounterJobDerivedInfo < 3) {
    o.jobCategories = buildUnnamed23();
...
void checkJobDerivedInfo(api.JobDerivedInfo o) {
  buildCounterJobDerivedInfo++;
  if (buildCounterJobDerivedInfo < 3) {
    checkUnnamed23(o.jobCategories!);
...
core.List<api.LocationFilter> buildUnnamed32() => [
  buildLocationFilter(),
  buildLocationFilter(),
];

void checkUnnamed32(core.List<api.LocationFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.JobQuery buildJobQuery() {
  ...
  if (buildCounterJobQuery < 3) {
    ...
    o.companyDisplayNames = buildUnnamed26();
    o.companyNames = buildUnnamed27();
    o.compensationFilter = buildCompensationFilter();
    o.customAttributeFilter = 'foo';
    o.disableSpellCheck = true;
    o.employmentTypes = buildUnnamed28();
    o.excludedJobs = buildUnnamed29();
    o.jobCategories = buildUnnamed30();
    o.languageCodes = buildUnnamed31();
    o.locationFilters = buildUnnamed32();
...
void checkJobQuery(api.JobQuery o) {
  ...
  if (buildCounterJobQuery < 3) {
    ...
    checkUnnamed26(o.companyDisplayNames!);
    checkUnnamed27(o.companyNames!);
    ...
    checkUnnamed28(o.employmentTypes!);
    checkUnnamed29(o.excludedJobs!);
    checkUnnamed30(o.jobCategories!);
    checkUnnamed31(o.languageCodes!);
    checkUnnamed32(o.locationFilters!);
...
core.List<api.Company> buildUnnamed33() => [buildCompany(), buildCompany()];

void checkUnnamed33(core.List<api.Company> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCompany(o[0]);
  checkCompany(o[1]);
}
...
core.List<api.Job> buildUnnamed34() => [buildJob(), buildJob()];

void checkUnnamed34(core.List<api.Job> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJob(o[0]);
  checkJob(o[1]);
}
...
void checkNumericBucketingOption(api.NumericBucketingOption o) {
  buildCounterNumericBucketingOption++;
  if (buildCounterNumericBucketingOption < 3) {
    checkUnnamed35(o.bucketBounds!);
    unittest.expect(o.requiresMinMax!, unittest.isTrue);
  }
  buildCounterNumericBucketingOption--;
}

core.List<api.BucketizedCount> buildUnnamed36() => [
  buildBucketizedCount(),
  buildBucketizedCount(),
];

void checkUnnamed36(core.List<api.BucketizedCount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.HistogramQuery> buildUnnamed41() => [
  buildHistogramQuery(),
  buildHistogramQuery(),
];

void checkUnnamed41(core.List<api.HistogramQuery> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SearchJobsRequest buildSearchJobsRequest() {
  ...
  if (buildCounterSearchJobsRequest < 3) {
    ...
    o.histogramQueries = buildUnnamed41();
...
void checkSearchJobsRequest(api.SearchJobsRequest o) {
  ...
  if (buildCounterSearchJobsRequest < 3) {
    ...
    checkUnnamed41(o.histogramQueries!);
...
core.List<api.HistogramQueryResult> buildUnnamed42() => [
  buildHistogramQueryResult(),
  buildHistogramQueryResult(),
];

void checkUnnamed42(core.List<api.HistogramQueryResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.MatchingJob> buildUnnamed44() => [
  buildMatchingJob(),
  buildMatchingJob(),
];

void checkUnnamed44(core.List<api.MatchingJob> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SearchJobsResponse buildSearchJobsResponse() {
  ...
  if (buildCounterSearchJobsResponse < 3) {
    ...
    o.histogramQueryResults = buildUnnamed42();
    o.histogramResults = buildHistogramResults();
    o.locationFilters = buildUnnamed43();
    o.matchingJobs = buildUnnamed44();
    o.metadata = buildResponseMetadata();
    o.nextPageToken = 'foo';
...
void checkSearchJobsResponse(api.SearchJobsResponse o) {
  ...
  if (buildCounterSearchJobsResponse < 3) {
    ...
    checkUnnamed42(o.histogramQueryResults!);
    checkHistogramResults(o.histogramResults!);
    checkUnnamed43(o.locationFilters!);
    checkUnnamed44(o.matchingJobs!);
    checkResponseMetadata(o.metadata!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
...
void main() {
  ...
  unittest.group('resource-ProjectsResource', () {
    unittest.test('method--complete', () async {
      ...
      final arg_languageCodes = buildUnnamed47();
