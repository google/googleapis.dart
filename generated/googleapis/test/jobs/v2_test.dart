...
checkUnnamed446(core.List<api.CompanyInfoSource> o) {
...
buildCompany() {
  ...
  if (buildCounterCompany < 3) {
    ...
    o.companyInfoSources = buildUnnamed446();
    o.companySize = "foo";
    ...
    o.hqLocation = "foo";
    o.imageUrl = "foo";
    o.keywordSearchableCustomAttributes = buildUnnamed447();
    o.keywordSearchableCustomFields = buildUnnamed448();
    o.name = "foo";
...
checkCompany(api.Company o) {
  ...
  if (buildCounterCompany < 3) {
    ...
    checkUnnamed446(o.companyInfoSources);
    ...
    checkUnnamed447(o.keywordSearchableCustomAttributes);
    checkUnnamed448(o.keywordSearchableCustomFields);
...
checkUnnamed450(core.List<api.CompensationEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed451(core.List<api.CompletionResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildCompleteQueryResponse() {
  ...
  if (buildCounterCompleteQueryResponse < 3) {
    o.completionResults = buildUnnamed451();
...
checkCompleteQueryResponse(api.CompleteQueryResponse o) {
  buildCounterCompleteQueryResponse++;
  if (buildCounterCompleteQueryResponse < 3) {
    checkUnnamed451(o.completionResults);
...
checkUnnamed452(core.Map<core.String, core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildCustomAttributeHistogramResult() {
  ...
  if (buildCounterCustomAttributeHistogramResult < 3) {
    ...
    o.stringValueHistogramResult = buildUnnamed452();
  }
  buildCounterCustomAttributeHistogramResult--;
  return o;
}
...
checkCustomAttributeHistogramResult(api.CustomAttributeHistogramResult o) {
  ...
  if (buildCounterCustomAttributeHistogramResult < 3) {
    ...
    checkUnnamed452(o.stringValueHistogramResult);
  }
  buildCounterCustomAttributeHistogramResult--;
}
...
buildExtendedCompensationFilter() {
  ...
  if (buildCounterExtendedCompensationFilter < 3) {
    ...
    o.compensationUnits = buildUnnamed455();
    o.currency = "foo";
...
checkExtendedCompensationFilter(api.ExtendedCompensationFilter o) {
  ...
  if (buildCounterExtendedCompensationFilter < 3) {
    ...
    checkUnnamed455(o.compensationUnits);
...
checkUnnamed456(core.List<api.ExtendedCompensationInfoCompensationEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed458(core.List<api.HistogramResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed459(core.List<api.CompensationHistogramRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed460(core.List<api.CustomAttributeHistogramRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildHistogramFacets() {
  ...
  if (buildCounterHistogramFacets < 3) {
    o.compensationHistogramFacets = buildUnnamed459();
    o.customAttributeHistogramFacets = buildUnnamed460();
    o.simpleHistogramFacets = buildUnnamed461();
  }
  buildCounterHistogramFacets--;
  return o;
}
...
checkHistogramFacets(api.HistogramFacets o) {
  buildCounterHistogramFacets++;
  if (buildCounterHistogramFacets < 3) {
    checkUnnamed459(o.compensationHistogramFacets);
    checkUnnamed460(o.customAttributeHistogramFacets);
    checkUnnamed461(o.simpleHistogramFacets);
  }
  buildCounterHistogramFacets--;
}
...
checkUnnamed462(core.Map<core.String, core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals(42));
  unittest.expect(o["y"], unittest.equals(42));
}
...
checkUnnamed463(core.List<api.CompensationHistogramResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed464(core.List<api.CustomAttributeHistogramResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed465(core.List<api.HistogramResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHistogramResult(o[0]);
  checkHistogramResult(o[1]);
}
...
buildHistogramResults() {
  ...
  if (buildCounterHistogramResults < 3) {
    o.compensationHistogramResults = buildUnnamed463();
    o.customAttributeHistogramResults = buildUnnamed464();
    o.simpleHistogramResults = buildUnnamed465();
  }
  buildCounterHistogramResults--;
  return o;
}
...
checkHistogramResults(api.HistogramResults o) {
  buildCounterHistogramResults++;
  if (buildCounterHistogramResults < 3) {
    checkUnnamed463(o.compensationHistogramResults);
    checkUnnamed464(o.customAttributeHistogramResults);
    checkUnnamed465(o.simpleHistogramResults);
  }
  buildCounterHistogramResults--;
}
...
checkUnnamed469(core.Map<core.String, api.CustomAttribute> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed472(core.Map<core.String, api.CustomField> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed473(core.List<api.JobLocation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed475(core.Map<core.String, api.CustomField> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCustomField(o["x"]);
  checkCustomField(o["y"]);
}
...
buildJob() {
  ...
  if (buildCounterJob < 3) {
    o.applicationEmailList = buildUnnamed466();
    o.applicationInstruction = "foo";
    o.applicationUrls = buildUnnamed467();
    o.benefits = buildUnnamed468();
    o.companyDisplayName = "foo";
    o.companyName = "foo";
    o.companyTitle = "foo";
    o.compensationInfo = buildCompensationInfo();
    o.createTime = "foo";
    o.customAttributes = buildUnnamed469();
    o.department = "foo";
    o.description = "foo";
    o.distributorCompanyId = "foo";
    o.educationLevels = buildUnnamed470();
    o.employmentTypes = buildUnnamed471();
    o.endDate = buildDate();
    o.expireTime = "foo";
    o.expiryDate = buildDate();
    o.extendedCompensationInfo = buildExtendedCompensationInfo();
    o.filterableCustomFields = buildUnnamed472();
    o.incentives = "foo";
    o.jobLocations = buildUnnamed473();
    o.jobTitle = "foo";
    o.languageCode = "foo";
    o.level = "foo";
    o.locations = buildUnnamed474();
    o.name = "foo";
    o.promotionValue = 42;
    ...
    o.unindexedCustomFields = buildUnnamed475();
    o.updateTime = "foo";
    o.visibility = "foo";
  }
  buildCounterJob--;
...
checkJob(api.Job o) {
  buildCounterJob++;
  if (buildCounterJob < 3) {
    checkUnnamed466(o.applicationEmailList);
    unittest.expect(o.applicationInstruction, unittest.equals('foo'));
    checkUnnamed467(o.applicationUrls);
    checkUnnamed468(o.benefits);
    ...
    checkUnnamed475(o.unindexedCustomFields);
...
checkUnnamed479(core.Map<core.String, api.CustomFieldFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed482(core.List<api.LocationFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildJobFilters() {
  ...
  if (buildCounterJobFilters < 3) {
    o.categories = buildUnnamed476();
    o.commuteFilter = buildCommutePreference();
    o.companyNames = buildUnnamed477();
    o.companyTitles = buildUnnamed478();
    o.compensationFilter = buildCompensationFilter();
    o.customAttributeFilter = "foo";
    o.customFieldFilters = buildUnnamed479();
    o.disableSpellCheck = true;
    o.employmentTypes = buildUnnamed480();
    o.extendedCompensationFilter = buildExtendedCompensationFilter();
    o.languageCodes = buildUnnamed481();
    o.locationFilters = buildUnnamed482();
...
checkUnnamed488(core.List<api.LocationFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocationFilter(o[0]);
  checkLocationFilter(o[1]);
}
...
buildJobQuery() {
  ...
  if (buildCounterJobQuery < 3) {
    o.categories = buildUnnamed483();
    o.commuteFilter = buildCommutePreference();
    o.companyDisplayNames = buildUnnamed484();
    o.companyNames = buildUnnamed485();
    o.compensationFilter = buildCompensationFilter();
    o.customAttributeFilter = "foo";
    o.disableSpellCheck = true;
    o.employmentTypes = buildUnnamed486();
    o.languageCodes = buildUnnamed487();
    o.locationFilters = buildUnnamed488();
    o.publishDateRange = "foo";
    o.query = "foo";
  }
  buildCounterJobQuery--;
...
checkJobQuery(api.JobQuery o) {
  buildCounterJobQuery++;
  if (buildCounterJobQuery < 3) {
    checkUnnamed483(o.categories);
    checkCommutePreference(o.commuteFilter);
    checkUnnamed484(o.companyDisplayNames);
    checkUnnamed485(o.companyNames);
    checkCompensationFilter(o.compensationFilter);
    unittest.expect(o.customAttributeFilter, unittest.equals('foo'));
    unittest.expect(o.disableSpellCheck, unittest.isTrue);
    checkUnnamed486(o.employmentTypes);
    checkUnnamed487(o.languageCodes);
    checkUnnamed488(o.locationFilters);
    unittest.expect(o.publishDateRange, unittest.equals('foo'));
    unittest.expect(o.query, unittest.equals('foo'));
  }
  buildCounterJobQuery--;
...
checkUnnamed489(core.List<api.Company> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCompany(o[0]);
  checkCompany(o[1]);
}
...
checkUnnamed490(core.List<api.Job> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJob(o[0]);
  checkJob(o[1]);
}
...
checkUnnamed492(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildNumericBucketingOption() {
  ...
  if (buildCounterNumericBucketingOption < 3) {
    o.bucketBounds = buildUnnamed492();
...
checkNumericBucketingOption(api.NumericBucketingOption o) {
  buildCounterNumericBucketingOption++;
  if (buildCounterNumericBucketingOption < 3) {
    checkUnnamed492(o.bucketBounds);
...
checkUnnamed493(core.List<api.BucketizedCount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPostalAddress() {
  ...
  if (buildCounterPostalAddress < 3) {
    o.addressLines = buildUnnamed494();
    o.administrativeArea = "foo";
    o.languageCode = "foo";
    o.locality = "foo";
    o.organization = "foo";
    o.postalCode = "foo";
    o.recipients = buildUnnamed495();
    o.regionCode = "foo";
    o.revision = 42;
    o.sortingCode = "foo";
    o.sublocality = "foo";
...
checkPostalAddress(api.PostalAddress o) {
  buildCounterPostalAddress++;
  if (buildCounterPostalAddress < 3) {
    checkUnnamed494(o.addressLines);
...
checkUnnamed496(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42));
  unittest.expect(o[1], unittest.equals(42));
}
...
buildResponseMetadata() {
  ...
  if (buildCounterResponseMetadata < 3) {
    o.experimentIdList = buildUnnamed496();
    o.mode = "foo";
    o.requestId = "foo";
  }
  buildCounterResponseMetadata--;
...
checkResponseMetadata(api.ResponseMetadata o) {
  buildCounterResponseMetadata++;
  if (buildCounterResponseMetadata < 3) {
    checkUnnamed496(o.experimentIdList);
...
checkUnnamed497(core.List<api.JobLocation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJobLocation(o[0]);
  checkJobLocation(o[1]);
}
...
checkUnnamed498(core.List<api.MatchingJob> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSearchJobsResponse() {
  ...
  if (buildCounterSearchJobsResponse < 3) {
    ...
    o.appliedJobLocationFilters = buildUnnamed497();
    o.estimatedTotalSize = "foo";
    o.histogramResults = buildHistogramResults();
    o.jobView = "foo";
    o.matchingJobs = buildUnnamed498();
    o.metadata = buildResponseMetadata();
    o.nextPageToken = "foo";
