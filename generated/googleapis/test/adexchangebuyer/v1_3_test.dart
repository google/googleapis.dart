...
checkUnnamed1003(core.List<api.AccountBidderLocation> o) {
...
buildAccount() {
  ...
  if (buildCounterAccount < 3) {
    o.bidderLocation = buildUnnamed1003();
...
checkAccount(api.Account o) {
  buildCounterAccount++;
  if (buildCounterAccount < 3) {
    checkUnnamed1003(o.bidderLocation);
...
checkUnnamed1004(core.List<api.Account> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAccount(o[0]);
  checkAccount(o[1]);
}
...
checkUnnamed1006(core.List<api.BillingInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1011(core.List<api.CreativeCorrections> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1013(core.List<api.CreativeDisapprovalReasons> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1014(core.List<api.CreativeFilteringReasonsReasons> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildCreativeNativeAd() {
  ...
  if (buildCounterCreativeNativeAd < 3) {
    ...
    o.impressionTrackingUrl = buildUnnamed1016();
...
checkCreativeNativeAd(api.CreativeNativeAd o) {
  ...
  if (buildCounterCreativeNativeAd < 3) {
    ...
    checkUnnamed1016(o.impressionTrackingUrl);
...
checkUnnamed1017(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42));
  unittest.expect(o[1], unittest.equals(42));
}
...
checkUnnamed1018(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42));
  unittest.expect(o[1], unittest.equals(42));
}
...
checkUnnamed1019(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42));
  unittest.expect(o[1], unittest.equals(42));
}
...
buildCreative() {
  ...
  if (buildCounterCreative < 3) {
    o.HTMLSnippet = "foo";
    o.accountId = 42;
    o.advertiserId = buildUnnamed1007();
    o.advertiserName = "foo";
    o.agencyId = "foo";
    o.apiUploadTimestamp = core.DateTime.parse("2002-02-27T14:01:02");
    o.attribute = buildUnnamed1008();
    o.buyerCreativeId = "foo";
    o.clickThroughUrl = buildUnnamed1009();
    o.corrections = buildUnnamed1011();
    o.disapprovalReasons = buildUnnamed1013();
    o.filteringReasons = buildCreativeFilteringReasons();
    o.height = 42;
    o.impressionTrackingUrl = buildUnnamed1015();
    o.kind = "foo";
    o.nativeAd = buildCreativeNativeAd();
    o.productCategories = buildUnnamed1017();
    o.restrictedCategories = buildUnnamed1018();
    o.sensitiveCategories = buildUnnamed1019();
    o.status = "foo";
    o.vendorType = buildUnnamed1020();
    o.version = 42;
    o.videoURL = "foo";
    o.width = 42;
  }
...
checkCreative(api.Creative o) {
  ...
  if (buildCounterCreative < 3) {
    ...
    unittest.expect(o.accountId, unittest.equals(42));
    checkUnnamed1007(o.advertiserId);
    unittest.expect(o.advertiserName, unittest.equals('foo'));
    unittest.expect(o.agencyId, unittest.equals('foo'));
    unittest.expect(o.apiUploadTimestamp, unittest.equals(core.DateTime.parse("2002-02-27T14:01:02")));
    checkUnnamed1008(o.attribute);
    unittest.expect(o.buyerCreativeId, unittest.equals('foo'));
    checkUnnamed1009(o.clickThroughUrl);
    checkUnnamed1011(o.corrections);
    checkUnnamed1013(o.disapprovalReasons);
    checkCreativeFilteringReasons(o.filteringReasons);
    unittest.expect(o.height, unittest.equals(42));
    checkUnnamed1015(o.impressionTrackingUrl);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkCreativeNativeAd(o.nativeAd);
    checkUnnamed1017(o.productCategories);
    checkUnnamed1018(o.restrictedCategories);
    checkUnnamed1019(o.sensitiveCategories);
    unittest.expect(o.status, unittest.equals('foo'));
    checkUnnamed1020(o.vendorType);
...
checkUnnamed1021(core.List<api.Creative> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCreative(o[0]);
  checkCreative(o[1]);
}
...
checkUnnamed1022(core.List<api.DirectDeal> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDirectDeal(o[0]);
  checkDirectDeal(o[1]);
}
...
buildDirectDealsList() {
  ...
  if (buildCounterDirectDealsList < 3) {
    o.directDeals = buildUnnamed1022();
    o.kind = "foo";
  }
  buildCounterDirectDealsList--;
  return o;
...
checkDirectDealsList(api.DirectDealsList o) {
  buildCounterDirectDealsList++;
  if (buildCounterDirectDealsList < 3) {
    checkUnnamed1022(o.directDeals);
    unittest.expect(o.kind, unittest.equals('foo'));
  }
  buildCounterDirectDealsList--;
}
...
checkUnnamed1023(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1024(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPerformanceReport() {
  ...
  if (buildCounterPerformanceReport < 3) {
    ...
    o.calloutStatusRate = buildUnnamed1023();
    o.cookieMatcherStatusRate = buildUnnamed1024();
    o.creativeStatusRate = buildUnnamed1025();
    o.filteredBidRate = 42.0;
    o.hostedMatchStatusRate = buildUnnamed1026();
...
checkPerformanceReport(api.PerformanceReport o) {
  ...
  if (buildCounterPerformanceReport < 3) {
    ...
    checkUnnamed1023(o.calloutStatusRate);
    checkUnnamed1024(o.cookieMatcherStatusRate);
    checkUnnamed1025(o.creativeStatusRate);
    unittest.expect(o.filteredBidRate, unittest.equals(42.0));
    checkUnnamed1026(o.hostedMatchStatusRate);
...
checkUnnamed1027(core.List<api.PerformanceReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPerformanceReportList() {
  ...
  if (buildCounterPerformanceReportList < 3) {
    o.kind = "foo";
    o.performanceReport = buildUnnamed1027();
  }
  buildCounterPerformanceReportList--;
  return o;
}
...
checkPerformanceReportList(api.PerformanceReportList o) {
  ...
  if (buildCounterPerformanceReportList < 3) {
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1027(o.performanceReport);
  }
  buildCounterPerformanceReportList--;
}
...
checkUnnamed1029(core.List<api.PretargetingConfigDimensions> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1032(core.List<api.PretargetingConfigExcludedPlacements> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1040(core.List<api.PretargetingConfigPlacements> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPretargetingConfig() {
  ...
  if (buildCounterPretargetingConfig < 3) {
    ...
    o.configId = "foo";
    o.configName = "foo";
    o.creativeType = buildUnnamed1028();
    o.dimensions = buildUnnamed1029();
    o.excludedContentLabels = buildUnnamed1030();
    o.excludedGeoCriteriaIds = buildUnnamed1031();
    o.excludedPlacements = buildUnnamed1032();
    o.excludedUserLists = buildUnnamed1033();
    o.excludedVerticals = buildUnnamed1034();
    o.geoCriteriaIds = buildUnnamed1035();
    o.isActive = true;
    o.kind = "foo";
    o.languages = buildUnnamed1036();
    o.mobileCarriers = buildUnnamed1037();
    o.mobileDevices = buildUnnamed1038();
    o.mobileOperatingSystemVersions = buildUnnamed1039();
    o.placements = buildUnnamed1040();
    o.platforms = buildUnnamed1041();
    o.supportedCreativeAttributes = buildUnnamed1042();
    o.userLists = buildUnnamed1043();
    o.vendorTypes = buildUnnamed1044();
    o.verticals = buildUnnamed1045();
  }
  buildCounterPretargetingConfig--;
  return o;
}
...
checkPretargetingConfig(api.PretargetingConfig o) {
  ...
  if (buildCounterPretargetingConfig < 3) {
    ...
    checkUnnamed1028(o.creativeType);
    checkUnnamed1029(o.dimensions);
    checkUnnamed1030(o.excludedContentLabels);
    checkUnnamed1031(o.excludedGeoCriteriaIds);
    checkUnnamed1032(o.excludedPlacements);
    checkUnnamed1033(o.excludedUserLists);
    checkUnnamed1034(o.excludedVerticals);
    checkUnnamed1035(o.geoCriteriaIds);
    unittest.expect(o.isActive, unittest.isTrue);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1036(o.languages);
    checkUnnamed1037(o.mobileCarriers);
    checkUnnamed1038(o.mobileDevices);
    checkUnnamed1039(o.mobileOperatingSystemVersions);
    checkUnnamed1040(o.placements);
    checkUnnamed1041(o.platforms);
    checkUnnamed1042(o.supportedCreativeAttributes);
    checkUnnamed1043(o.userLists);
    checkUnnamed1044(o.vendorTypes);
    checkUnnamed1045(o.verticals);
  }
  buildCounterPretargetingConfig--;
}
...
checkUnnamed1046(core.List<api.PretargetingConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1047(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42));
  unittest.expect(o[1], unittest.equals(42));
}
...
main() {
  ...
  unittest.group("resource-CreativesResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var mock = new HttpServerMock();
      api.CreativesResourceApi res = new api.AdexchangebuyerApi(mock).creatives;
      var arg_accountId = buildUnnamed1047();
      var arg_buyerCreativeId = buildUnnamed1048();
