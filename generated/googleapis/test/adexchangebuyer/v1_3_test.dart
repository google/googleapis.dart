...
checkUnnamed827(core.List<api.AccountBidderLocation> o) {
...
buildAccount() {
  ...
  if (buildCounterAccount < 3) {
    o.bidderLocation = buildUnnamed827();
...
checkAccount(api.Account o) {
  buildCounterAccount++;
  if (buildCounterAccount < 3) {
    checkUnnamed827(o.bidderLocation);
...
checkUnnamed830(core.List<api.BillingInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed835(core.List<api.CreativeCorrections> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed837(core.List<api.CreativeDisapprovalReasons> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed838(core.List<api.CreativeFilteringReasonsReasons> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed840(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42));
  unittest.expect(o[1], unittest.equals(42));
}
...
checkUnnamed842(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42));
  unittest.expect(o[1], unittest.equals(42));
}
...
buildCreative() {
  ...
  if (buildCounterCreative < 3) {
    o.HTMLSnippet = "foo";
    o.accountId = 42;
    o.advertiserId = buildUnnamed831();
    o.advertiserName = "foo";
    o.agencyId = "foo";
    o.attribute = buildUnnamed832();
    o.buyerCreativeId = "foo";
    o.clickThroughUrl = buildUnnamed833();
    o.corrections = buildUnnamed835();
    o.disapprovalReasons = buildUnnamed837();
    o.filteringReasons = buildCreativeFilteringReasons();
    o.height = 42;
    o.kind = "foo";
    o.productCategories = buildUnnamed839();
    o.restrictedCategories = buildUnnamed840();
    o.sensitiveCategories = buildUnnamed841();
    o.status = "foo";
    o.vendorType = buildUnnamed842();
    o.videoURL = "foo";
    o.width = 42;
  }
  buildCounterCreative--;
...
checkCreative(api.Creative o) {
  ...
  if (buildCounterCreative < 3) {
    ...
    unittest.expect(o.accountId, unittest.equals(42));
    checkUnnamed831(o.advertiserId);
    unittest.expect(o.advertiserName, unittest.equals('foo'));
    unittest.expect(o.agencyId, unittest.equals('foo'));
    checkUnnamed832(o.attribute);
    unittest.expect(o.buyerCreativeId, unittest.equals('foo'));
    checkUnnamed833(o.clickThroughUrl);
    checkUnnamed835(o.corrections);
    checkUnnamed837(o.disapprovalReasons);
    checkCreativeFilteringReasons(o.filteringReasons);
    unittest.expect(o.height, unittest.equals(42));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed839(o.productCategories);
    checkUnnamed840(o.restrictedCategories);
    checkUnnamed841(o.sensitiveCategories);
    unittest.expect(o.status, unittest.equals('foo'));
    checkUnnamed842(o.vendorType);
...
checkUnnamed843(core.List<api.Creative> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCreative(o[0]);
  checkCreative(o[1]);
}
...
checkUnnamed844(core.List<api.DirectDeal> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDirectDeal(o[0]);
  checkDirectDeal(o[1]);
}
...
checkUnnamed847(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPerformanceReport() {
  ...
  if (buildCounterPerformanceReport < 3) {
    o.calloutStatusRate = buildUnnamed845();
    o.cookieMatcherStatusRate = buildUnnamed846();
    o.creativeStatusRate = buildUnnamed847();
    o.hostedMatchStatusRate = buildUnnamed848();
    o.kind = "foo";
...
checkPerformanceReport(api.PerformanceReport o) {
  buildCounterPerformanceReport++;
  if (buildCounterPerformanceReport < 3) {
    checkUnnamed845(o.calloutStatusRate);
    checkUnnamed846(o.cookieMatcherStatusRate);
    checkUnnamed847(o.creativeStatusRate);
    checkUnnamed848(o.hostedMatchStatusRate);
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed849(core.List<api.PerformanceReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPerformanceReportList() {
  ...
  if (buildCounterPerformanceReportList < 3) {
    o.kind = "foo";
    o.performanceReport = buildUnnamed849();
  }
  buildCounterPerformanceReportList--;
  return o;
}
...
checkPerformanceReportList(api.PerformanceReportList o) {
  ...
  if (buildCounterPerformanceReportList < 3) {
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed849(o.performanceReport);
  }
  buildCounterPerformanceReportList--;
}
...
checkUnnamed851(core.List<api.PretargetingConfigDimensions> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed854(core.List<api.PretargetingConfigExcludedPlacements> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed862(core.List<api.PretargetingConfigPlacements> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPretargetingConfig() {
  ...
  if (buildCounterPretargetingConfig < 3) {
    ...
    o.configId = "foo";
    o.configName = "foo";
    o.creativeType = buildUnnamed850();
    o.dimensions = buildUnnamed851();
    o.excludedContentLabels = buildUnnamed852();
    o.excludedGeoCriteriaIds = buildUnnamed853();
    o.excludedPlacements = buildUnnamed854();
    o.excludedUserLists = buildUnnamed855();
    o.excludedVerticals = buildUnnamed856();
    o.geoCriteriaIds = buildUnnamed857();
    o.isActive = true;
    o.kind = "foo";
    o.languages = buildUnnamed858();
    o.mobileCarriers = buildUnnamed859();
    o.mobileDevices = buildUnnamed860();
    o.mobileOperatingSystemVersions = buildUnnamed861();
    o.placements = buildUnnamed862();
    o.platforms = buildUnnamed863();
    o.supportedCreativeAttributes = buildUnnamed864();
    o.userLists = buildUnnamed865();
    o.vendorTypes = buildUnnamed866();
    o.verticals = buildUnnamed867();
  }
  buildCounterPretargetingConfig--;
  return o;
}
...
checkPretargetingConfig(api.PretargetingConfig o) {
  ...
  if (buildCounterPretargetingConfig < 3) {
    ...
    checkUnnamed850(o.creativeType);
    checkUnnamed851(o.dimensions);
    checkUnnamed852(o.excludedContentLabels);
    checkUnnamed853(o.excludedGeoCriteriaIds);
    checkUnnamed854(o.excludedPlacements);
    checkUnnamed855(o.excludedUserLists);
    checkUnnamed856(o.excludedVerticals);
    checkUnnamed857(o.geoCriteriaIds);
    unittest.expect(o.isActive, unittest.isTrue);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed858(o.languages);
    checkUnnamed859(o.mobileCarriers);
    checkUnnamed860(o.mobileDevices);
    checkUnnamed861(o.mobileOperatingSystemVersions);
    checkUnnamed862(o.placements);
    checkUnnamed863(o.platforms);
    checkUnnamed864(o.supportedCreativeAttributes);
    checkUnnamed865(o.userLists);
    checkUnnamed866(o.vendorTypes);
    checkUnnamed867(o.verticals);
  }
  buildCounterPretargetingConfig--;
}
...
checkUnnamed868(core.List<api.PretargetingConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
main() {
  ...
  unittest.group("resource-CreativesResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var mock = new HttpServerMock();
      api.CreativesResourceApi res = new api.AdexchangebuyerApi(mock).creatives;
      var arg_accountId = buildUnnamed869();
      var arg_buyerCreativeId = buildUnnamed870();
