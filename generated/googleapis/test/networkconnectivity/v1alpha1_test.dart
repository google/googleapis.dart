...
import 'package:googleapis/networkconnectivity/v1alpha1.dart' as api;
...
api.InternalRange buildInternalRange() {
  ...
  if (buildCounterInternalRange < 3) {
    ...
    o.createTime = 'foo';
    o.description = 'foo';
    o.excludeCidrRanges = buildUnnamed10();
    o.immutable = true;
    o.ipCidrRange = 'foo';
...
void checkInternalRange(api.InternalRange o) {
  ...
  if (buildCounterInternalRange < 3) {
    ...
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    checkUnnamed10(o.excludeCidrRanges!);
...
core.List<api.Hub> buildUnnamed15() => [buildHub(), buildHub()];

void checkUnnamed15(core.List<api.Hub> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHub(o[0]);
  checkHub(o[1]);
}
...
core.List<api.InternalRange> buildUnnamed17() => [
  buildInternalRange(),
  buildInternalRange(),
];

void checkUnnamed17(core.List<api.InternalRange> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListInternalRangesResponse buildListInternalRangesResponse() {
  ...
  if (buildCounterListInternalRangesResponse < 3) {
    o.internalRanges = buildUnnamed17();
    o.nextPageToken = 'foo';
...
void checkListInternalRangesResponse(api.ListInternalRangesResponse o) {
  buildCounterListInternalRangesResponse++;
  if (buildCounterListInternalRangesResponse < 3) {
    checkUnnamed17(o.internalRanges!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
...
core.List<api.Spoke> buildUnnamed20() => [buildSpoke(), buildSpoke()];

void checkUnnamed20(core.List<api.Spoke> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSpoke(o[0]);
  checkSpoke(o[1]);
}
...
core.List<api.RouterApplianceInstance> buildUnnamed28() => [
  buildRouterApplianceInstance(),
  buildRouterApplianceInstance(),
];

void checkUnnamed28(core.List<api.RouterApplianceInstance> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Spoke buildSpoke() {
  ...
  if (buildCounterSpoke < 3) {
    ...
    o.linkedInterconnectAttachments = buildUnnamed27();
    o.linkedRouterApplianceInstances = buildUnnamed28();
    o.linkedVpnTunnels = buildUnnamed29();
    o.name = 'foo';
    o.state = 'foo';
    o.uniqueId = 'foo';
    o.updateTime = 'foo';
...
void checkSpoke(api.Spoke o) {
  ...
  if (buildCounterSpoke < 3) {
    ...
    checkUnnamed27(o.linkedInterconnectAttachments!);
    checkUnnamed28(o.linkedRouterApplianceInstances!);
    checkUnnamed29(o.linkedVpnTunnels!);
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.state!, unittest.equals('foo'));
    unittest.expect(o.uniqueId!, unittest.equals('foo'));
    unittest.expect(o.updateTime!, unittest.equals('foo'));
