...
import 'package:googleapis/workflowexecutions/v1beta.dart' as api;
...
void checkExecution(api.Execution o) {
  ...
  if (buildCounterExecution < 3) {
    ...
    unittest.expect(o.callLogLevel!, unittest.equals('foo'));
    ...
    unittest.expect(o.workflowRevisionId!, unittest.equals('foo'));
  }
  buildCounterExecution--;
}
...
core.List<api.Step> buildUnnamed2() => [buildStep(), buildStep()];

void checkUnnamed2(core.List<api.Step> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStep(o[0]);
  checkStep(o[1]);
}
...
void main() {
  ...
  unittest.group('obj-schema-StackTrace', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.StackTrace.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkStackTrace(od);
    });
