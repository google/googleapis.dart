...
import 'package:googleapis/gkehub/v1beta.dart' as api;
...
api.MembershipFeatureSpec buildMembershipFeatureSpec() {
  ...
  if (buildCounterMembershipFeatureSpec < 3) {
    o.cloudbuild = buildMembershipSpec();
    o.configmanagement = buildConfigManagementMembershipSpec();
...
void checkMembershipFeatureSpec(api.MembershipFeatureSpec o) {
  buildCounterMembershipFeatureSpec++;
  if (buildCounterMembershipFeatureSpec < 3) {
    checkMembershipSpec(o.cloudbuild!);
    checkConfigManagementMembershipSpec(o.configmanagement!);
...
api.MembershipFeatureState buildMembershipFeatureState() {
  ...
  if (buildCounterMembershipFeatureState < 3) {
    ...
    o.metering = buildMeteringMembershipState();
...
void checkMembershipFeatureState(api.MembershipFeatureState o) {
  ...
  if (buildCounterMembershipFeatureState < 3) {
    ...
    checkMeteringMembershipState(o.metering!);
...
core.int buildCounterMembershipSpec = 0;
api.MembershipSpec buildMembershipSpec() {
  final o = api.MembershipSpec();
  buildCounterMembershipSpec++;
  if (buildCounterMembershipSpec < 3) {
...
void checkMembershipSpec(api.MembershipSpec o) {
  buildCounterMembershipSpec++;
  if (buildCounterMembershipSpec < 3) {
...
core.int buildCounterMeteringMembershipState = 0;
api.MeteringMembershipState buildMeteringMembershipState() {
  final o = api.MeteringMembershipState();
  buildCounterMeteringMembershipState++;
  if (buildCounterMeteringMembershipState < 3) {
...
void checkMeteringMembershipState(api.MeteringMembershipState o) {
  buildCounterMeteringMembershipState++;
  if (buildCounterMeteringMembershipState < 3) {
...
void checkMultiClusterIngressFeatureSpec(api.MultiClusterIngressFeatureSpec o) {
  buildCounterMultiClusterIngressFeatureSpec++;
  if (buildCounterMultiClusterIngressFeatureSpec < 3) {
    unittest.expect(o.billing!, unittest.equals('foo'));
...
void main() {
  ...
  unittest.group('obj-schema-MembershipSpec', () {
    unittest.test('to-json--from-json', () async {
      final o = buildMembershipSpec();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.MembershipSpec.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkMembershipSpec(od);
    });
  });
  ...
  unittest.group('obj-schema-MeteringMembershipState', () {
    unittest.test('to-json--from-json', () async {
      final o = buildMeteringMembershipState();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.MeteringMembershipState.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkMeteringMembershipState(od);
    });
  });
