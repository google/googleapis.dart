...
import 'package:googleapis/gkehub/v1alpha.dart' as api;
...
core.int buildCounterCloudAuditLoggingFeatureSpec = 0;
api.CloudAuditLoggingFeatureSpec buildCloudAuditLoggingFeatureSpec() {
  final o = api.CloudAuditLoggingFeatureSpec();
  buildCounterCloudAuditLoggingFeatureSpec++;
  if (buildCounterCloudAuditLoggingFeatureSpec < 3) {
    o.allowlistedServiceAccounts = buildUnnamed4();
  }
  buildCounterCloudAuditLoggingFeatureSpec--;
  return o;
}

void checkCloudAuditLoggingFeatureSpec(api.CloudAuditLoggingFeatureSpec o) {
  buildCounterCloudAuditLoggingFeatureSpec++;
  if (buildCounterCloudAuditLoggingFeatureSpec < 3) {
    checkUnnamed4(o.allowlistedServiceAccounts!);
  }
  buildCounterCloudAuditLoggingFeatureSpec--;
}

core.int buildCounterCloudBuildMembershipSpec = 0;
api.CloudBuildMembershipSpec buildCloudBuildMembershipSpec() {
  final o = api.CloudBuildMembershipSpec();
  buildCounterCloudBuildMembershipSpec++;
  if (buildCounterCloudBuildMembershipSpec < 3) {
...
void checkCloudBuildMembershipSpec(api.CloudBuildMembershipSpec o) {
  buildCounterCloudBuildMembershipSpec++;
  if (buildCounterCloudBuildMembershipSpec < 3) {
...
core.List<api.ClusterUpgradeMembershipGKEUpgradeState> buildUnnamed13() => [
  buildClusterUpgradeMembershipGKEUpgradeState(),
  buildClusterUpgradeMembershipGKEUpgradeState(),
];

void checkUnnamed13(core.List<api.ClusterUpgradeMembershipGKEUpgradeState> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ClusterUpgradeMembershipState buildClusterUpgradeMembershipState() {
  ...
  if (buildCounterClusterUpgradeMembershipState < 3) {
    ...
    o.scopes = buildUnnamed12();
    o.upgrades = buildUnnamed13();
  }
  buildCounterClusterUpgradeMembershipState--;
  return o;
}
...
void checkClusterUpgradeMembershipState(api.ClusterUpgradeMembershipState o) {
  ...
  if (buildCounterClusterUpgradeMembershipState < 3) {
    ...
    checkUnnamed12(o.scopes!);
    checkUnnamed13(o.upgrades!);
  }
  buildCounterClusterUpgradeMembershipState--;
}
...
core.List<api.ClusterUpgradeGKEUpgradeOverride> buildUnnamed14() => [
  buildClusterUpgradeGKEUpgradeOverride(),
  buildClusterUpgradeGKEUpgradeOverride(),
];

void checkUnnamed14(core.List<api.ClusterUpgradeGKEUpgradeOverride> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkClusterUpgradeGKEUpgradeOverride(o[0]);
  checkClusterUpgradeGKEUpgradeOverride(o[1]);
}
...
core.int buildCounterClusterUpgradeScopeSpec = 0;
api.ClusterUpgradeScopeSpec buildClusterUpgradeScopeSpec() {
  final o = api.ClusterUpgradeScopeSpec();
  buildCounterClusterUpgradeScopeSpec++;
  if (buildCounterClusterUpgradeScopeSpec < 3) {
    o.gkeUpgradeOverrides = buildUnnamed14();
    o.postConditions = buildClusterUpgradePostConditions();
    o.upstreamScopes = buildUnnamed15();
  }
  buildCounterClusterUpgradeScopeSpec--;
  return o;
}

void checkClusterUpgradeScopeSpec(api.ClusterUpgradeScopeSpec o) {
  buildCounterClusterUpgradeScopeSpec++;
  if (buildCounterClusterUpgradeScopeSpec < 3) {
    checkUnnamed14(o.gkeUpgradeOverrides!);
    checkClusterUpgradePostConditions(o.postConditions!);
    checkUnnamed15(o.upstreamScopes!);
  }
  buildCounterClusterUpgradeScopeSpec--;
}
...
core.Map<core.String, api.ClusterUpgradeIgnoredMembership> buildUnnamed17() => {
  'x': buildClusterUpgradeIgnoredMembership(),
  'y': buildClusterUpgradeIgnoredMembership(),
};
...
core.int buildCounterClusterUpgradeScopeState = 0;
api.ClusterUpgradeScopeState buildClusterUpgradeScopeState() {
  final o = api.ClusterUpgradeScopeState();
  buildCounterClusterUpgradeScopeState++;
  if (buildCounterClusterUpgradeScopeState < 3) {
    o.downstreamScopes = buildUnnamed16();
    o.gkeState = buildClusterUpgradeGKEUpgradeFeatureState();
    o.ignored = buildUnnamed17();
  }
  buildCounterClusterUpgradeScopeState--;
  return o;
}

void checkClusterUpgradeScopeState(api.ClusterUpgradeScopeState o) {
  buildCounterClusterUpgradeScopeState++;
  if (buildCounterClusterUpgradeScopeState < 3) {
    checkUnnamed16(o.downstreamScopes!);
    checkClusterUpgradeGKEUpgradeFeatureState(o.gkeState!);
    checkUnnamed17(o.ignored!);
  }
  buildCounterClusterUpgradeScopeState--;
}
...
api.CommonFeatureSpec buildCommonFeatureSpec() {
  ...
  if (buildCounterCommonFeatureSpec < 3) {
    ...
    o.cloudauditlogging = buildCloudAuditLoggingFeatureSpec();
    ...
    o.namespaceactuation = buildNamespaceActuationFeatureSpec();
    o.rbacrolebindingactuation = buildRBACRoleBindingActuationFeatureSpec();
    o.workloadcertificate = buildFeatureSpec();
...
void checkCommonFeatureSpec(api.CommonFeatureSpec o) {
  ...
  if (buildCounterCommonFeatureSpec < 3) {
    ...
    checkCloudAuditLoggingFeatureSpec(o.cloudauditlogging!);
    ...
    checkNamespaceActuationFeatureSpec(o.namespaceactuation!);
    checkRBACRoleBindingActuationFeatureSpec(o.rbacrolebindingactuation!);
    checkFeatureSpec(o.workloadcertificate!);
...
api.CommonFeatureState buildCommonFeatureState() {
  ...
  if (buildCounterCommonFeatureState < 3) {
    ...
    o.namespaceactuation = buildNamespaceActuationFeatureState();
...
void checkCommonFeatureState(api.CommonFeatureState o) {
  ...
  if (buildCounterCommonFeatureState < 3) {
    ...
    checkNamespaceActuationFeatureState(o.namespaceactuation!);
...
core.List<api.ComplianceStandard> buildUnnamed18() => [
  buildComplianceStandard(),
  buildComplianceStandard(),
];

void checkUnnamed18(core.List<api.ComplianceStandard> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.CompliancePostureConfig buildCompliancePostureConfig() {
  ...
  if (buildCounterCompliancePostureConfig < 3) {
    o.complianceStandards = buildUnnamed18();
    o.mode = 'foo';
  }
  buildCounterCompliancePostureConfig--;
  return o;
...
void checkCompliancePostureConfig(api.CompliancePostureConfig o) {
  buildCounterCompliancePostureConfig++;
  if (buildCounterCompliancePostureConfig < 3) {
    checkUnnamed18(o.complianceStandards!);
...
core.List<api.ConfigManagementDeploymentOverride> buildUnnamed19() => [
  buildConfigManagementDeploymentOverride(),
  buildConfigManagementDeploymentOverride(),
];

void checkUnnamed19(core.List<api.ConfigManagementDeploymentOverride> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ConfigManagementConfigSync buildConfigManagementConfigSync() {
  ...
  if (buildCounterConfigManagementConfigSync < 3) {
    o.deploymentOverrides = buildUnnamed19();
    o.enabled = true;
...
void checkConfigManagementConfigSync(api.ConfigManagementConfigSync o) {
  buildCounterConfigManagementConfigSync++;
  if (buildCounterConfigManagementConfigSync < 3) {
    checkUnnamed19(o.deploymentOverrides!);
    unittest.expect(o.enabled!, unittest.isTrue);
...
core.List<api.ConfigManagementConfigSyncError> buildUnnamed20() => [
  buildConfigManagementConfigSyncError(),
  buildConfigManagementConfigSyncError(),
];

void checkUnnamed20(core.List<api.ConfigManagementConfigSyncError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ConfigManagementContainerOverride> buildUnnamed21() => [
  buildConfigManagementContainerOverride(),
  buildConfigManagementContainerOverride(),
];

void checkUnnamed21(core.List<api.ConfigManagementContainerOverride> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ConfigManagementInstallError> buildUnnamed22() => [
  buildConfigManagementInstallError(),
  buildConfigManagementInstallError(),
];

void checkUnnamed22(core.List<api.ConfigManagementInstallError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ConfigManagementErrorResource> buildUnnamed25() => [
  buildConfigManagementErrorResource(),
  buildConfigManagementErrorResource(),
];

void checkUnnamed25(core.List<api.ConfigManagementErrorResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ConfigManagementSyncError buildConfigManagementSyncError() {
  ...
  if (buildCounterConfigManagementSyncError < 3) {
    o.code = 'foo';
    o.errorMessage = 'foo';
    o.errorResources = buildUnnamed25();
  }
  buildCounterConfigManagementSyncError--;
  return o;
}
...
void checkConfigManagementSyncError(api.ConfigManagementSyncError o) {
  ...
  if (buildCounterConfigManagementSyncError < 3) {
    unittest.expect(o.code!, unittest.equals('foo'));
    unittest.expect(o.errorMessage!, unittest.equals('foo'));
    checkUnnamed25(o.errorResources!);
  }
  buildCounterConfigManagementSyncError--;
}

core.List<api.ConfigManagementSyncError> buildUnnamed26() => [
  buildConfigManagementSyncError(),
  buildConfigManagementSyncError(),
];

void checkUnnamed26(core.List<api.ConfigManagementSyncError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, api.MembershipFeatureSpec> buildUnnamed28() => {
  'x': buildMembershipFeatureSpec(),
  'y': buildMembershipFeatureSpec(),
};

void checkUnnamed28(core.Map<core.String, api.MembershipFeatureSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMembershipFeatureSpec(o['x']!);
  checkMembershipFeatureSpec(o['y']!);
}

core.Map<core.String, api.MembershipFeatureState> buildUnnamed29() => {
  'x': buildMembershipFeatureState(),
  'y': buildMembershipFeatureState(),
};

void checkUnnamed29(core.Map<core.String, api.MembershipFeatureState> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMembershipFeatureState(o['x']!);
  checkMembershipFeatureState(o['y']!);
}

core.Map<core.String, api.ScopeFeatureSpec> buildUnnamed30() => {
  'x': buildScopeFeatureSpec(),
  'y': buildScopeFeatureSpec(),
};

void checkUnnamed30(core.Map<core.String, api.ScopeFeatureSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkScopeFeatureSpec(o['x']!);
  checkScopeFeatureSpec(o['y']!);
}

core.Map<core.String, api.ScopeFeatureState> buildUnnamed31() => {
  'x': buildScopeFeatureState(),
  'y': buildScopeFeatureState(),
};

void checkUnnamed31(core.Map<core.String, api.ScopeFeatureState> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Feature buildFeature() {
  ...
  if (buildCounterFeature < 3) {
    ...
    o.membershipSpecs = buildUnnamed28();
    o.membershipStates = buildUnnamed29();
    o.name = 'foo';
    o.resourceState = buildFeatureResourceState();
    o.scopeSpecs = buildUnnamed30();
    o.scopeStates = buildUnnamed31();
...
void checkFeature(api.Feature o) {
  ...
  if (buildCounterFeature < 3) {
    ...
    checkUnnamed28(o.membershipSpecs!);
    checkUnnamed29(o.membershipStates!);
    unittest.expect(o.name!, unittest.equals('foo'));
    checkFeatureResourceState(o.resourceState!);
    checkUnnamed30(o.scopeSpecs!);
    checkUnnamed31(o.scopeStates!);
...
api.FeatureSpec buildFeatureSpec() {
  ...
  if (buildCounterFeatureSpec < 3) {
    o.defaultConfig = buildMembershipSpec();
    o.provisionGoogleCa = 'foo';
  }
  buildCounterFeatureSpec--;
  return o;
}
...
void checkFeatureSpec(api.FeatureSpec o) {
  buildCounterFeatureSpec++;
  if (buildCounterFeatureSpec < 3) {
    checkMembershipSpec(o.defaultConfig!);
    unittest.expect(o.provisionGoogleCa!, unittest.equals('foo'));
  }
  buildCounterFeatureSpec--;
}
...
core.List<api.FleetObservabilityFeatureError> buildUnnamed34() => [
  buildFleetObservabilityFeatureError(),
  buildFleetObservabilityFeatureError(),
];

void checkUnnamed34(core.List<api.FleetObservabilityFeatureError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ConnectAgentResource> buildUnnamed35() => [
  buildConnectAgentResource(),
  buildConnectAgentResource(),
];

void checkUnnamed35(core.List<api.ConnectAgentResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.IdentityServiceAuthMethod> buildUnnamed38() => [
  buildIdentityServiceAuthMethod(),
  buildIdentityServiceAuthMethod(),
];

void checkUnnamed38(core.List<api.IdentityServiceAuthMethod> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.IdentityServiceSamlConfig buildIdentityServiceSamlConfig() {
  ...
  if (buildCounterIdentityServiceSamlConfig < 3) {
    o.attributeMapping = buildUnnamed39();
    o.groupPrefix = 'foo';
    o.groupsAttribute = 'foo';
    o.identityProviderCertificates = buildUnnamed40();
...
void checkIdentityServiceSamlConfig(api.IdentityServiceSamlConfig o) {
  buildCounterIdentityServiceSamlConfig++;
  if (buildCounterIdentityServiceSamlConfig < 3) {
    checkUnnamed39(o.attributeMapping!);
    unittest.expect(o.groupPrefix!, unittest.equals('foo'));
    unittest.expect(o.groupsAttribute!, unittest.equals('foo'));
    checkUnnamed40(o.identityProviderCertificates!);
...
core.List<api.ResourceManifest> buildUnnamed41() => [
  buildResourceManifest(),
  buildResourceManifest(),
];

void checkUnnamed41(core.List<api.ResourceManifest> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResourceManifest(o[0]);
  checkResourceManifest(o[1]);
}

core.List<api.ResourceManifest> buildUnnamed42() => [
  buildResourceManifest(),
  buildResourceManifest(),
];

void checkUnnamed42(core.List<api.ResourceManifest> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResourceManifest(o[0]);
  checkResourceManifest(o[1]);
}
...
api.KubernetesResource buildKubernetesResource() {
  ...
  if (buildCounterKubernetesResource < 3) {
    o.connectResources = buildUnnamed41();
    o.membershipCrManifest = 'foo';
    o.membershipResources = buildUnnamed42();
...
void checkKubernetesResource(api.KubernetesResource o) {
  buildCounterKubernetesResource++;
  if (buildCounterKubernetesResource < 3) {
    checkUnnamed41(o.connectResources!);
    unittest.expect(o.membershipCrManifest!, unittest.equals('foo'));
    checkUnnamed42(o.membershipResources!);
    checkResourceOptions(o.resourceOptions!);
  }
  buildCounterKubernetesResource--;
}

core.List<api.Membership> buildUnnamed43() => [
  buildMembership(),
  buildMembership(),
];

void checkUnnamed43(core.List<api.Membership> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMembership(o[0]);
  checkMembership(o[1]);
}
...
core.int buildCounterListAdminClusterMembershipsResponse = 0;
api.ListAdminClusterMembershipsResponse
buildListAdminClusterMembershipsResponse() {
  final o = api.ListAdminClusterMembershipsResponse();
  buildCounterListAdminClusterMembershipsResponse++;
  if (buildCounterListAdminClusterMembershipsResponse < 3) {
    o.adminClusterMemberships = buildUnnamed43();
    o.nextPageToken = 'foo';
...
void checkListAdminClusterMembershipsResponse(
  api.ListAdminClusterMembershipsResponse o,
) {
  buildCounterListAdminClusterMembershipsResponse++;
  if (buildCounterListAdminClusterMembershipsResponse < 3) {
    checkUnnamed43(o.adminClusterMemberships!);
...
core.List<api.Membership> buildUnnamed45() => [
  buildMembership(),
  buildMembership(),
];

void checkUnnamed45(core.List<api.Membership> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMembership(o[0]);
  checkMembership(o[1]);
}
...
core.List<api.Feature> buildUnnamed47() => [buildFeature(), buildFeature()];

void checkUnnamed47(core.List<api.Feature> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFeature(o[0]);
  checkFeature(o[1]);
}
...
core.List<api.Fleet> buildUnnamed48() => [buildFleet(), buildFleet()];

void checkUnnamed48(core.List<api.Fleet> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFleet(o[0]);
  checkFleet(o[1]);
}
...
core.List<api.MembershipBinding> buildUnnamed50() => [
  buildMembershipBinding(),
  buildMembershipBinding(),
];

void checkUnnamed50(core.List<api.MembershipBinding> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListMembershipBindingsResponse buildListMembershipBindingsResponse() {
  ...
  if (buildCounterListMembershipBindingsResponse < 3) {
    o.membershipBindings = buildUnnamed50();
    o.nextPageToken = 'foo';
...
void checkListMembershipBindingsResponse(api.ListMembershipBindingsResponse o) {
  buildCounterListMembershipBindingsResponse++;
  if (buildCounterListMembershipBindingsResponse < 3) {
    checkUnnamed50(o.membershipBindings!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
...
core.List<api.Scope> buildUnnamed57() => [buildScope(), buildScope()];

void checkUnnamed57(core.List<api.Scope> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkScope(o[0]);
  checkScope(o[1]);
}
...
void checkListPermittedScopesResponse(api.ListPermittedScopesResponse o) {
  ...
  if (buildCounterListPermittedScopesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed57(o.scopes!);
  }
  buildCounterListPermittedScopesResponse--;
}

core.List<api.Namespace> buildUnnamed58() => [
  buildNamespace(),
  buildNamespace(),
];

void checkUnnamed58(core.List<api.Namespace> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNamespace(o[0]);
  checkNamespace(o[1]);
}
...
api.ListScopeNamespacesResponse buildListScopeNamespacesResponse() {
  ...
  if (buildCounterListScopeNamespacesResponse < 3) {
    o.nextPageToken = 'foo';
    o.scopeNamespaces = buildUnnamed58();
  }
  buildCounterListScopeNamespacesResponse--;
  return o;
}
...
void checkListScopeNamespacesResponse(api.ListScopeNamespacesResponse o) {
  ...
  if (buildCounterListScopeNamespacesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed58(o.scopeNamespaces!);
  }
  buildCounterListScopeNamespacesResponse--;
}

core.List<api.RBACRoleBinding> buildUnnamed59() => [
  buildRBACRoleBinding(),
  buildRBACRoleBinding(),
];

void checkUnnamed59(core.List<api.RBACRoleBinding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRBACRoleBinding(o[0]);
  checkRBACRoleBinding(o[1]);
}
...
api.ListScopeRBACRoleBindingsResponse buildListScopeRBACRoleBindingsResponse() {
  ...
  if (buildCounterListScopeRBACRoleBindingsResponse < 3) {
    o.nextPageToken = 'foo';
    o.rbacrolebindings = buildUnnamed59();
  }
  buildCounterListScopeRBACRoleBindingsResponse--;
  return o;
}
...
void checkListScopeRBACRoleBindingsResponse(
  ...
  if (buildCounterListScopeRBACRoleBindingsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed59(o.rbacrolebindings!);
  }
  buildCounterListScopeRBACRoleBindingsResponse--;
}

core.List<api.Scope> buildUnnamed60() => [buildScope(), buildScope()];

void checkUnnamed60(core.List<api.Scope> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkScope(o[0]);
  checkScope(o[1]);
}
...
api.MembershipFeatureSpec buildMembershipFeatureSpec() {
  ...
  if (buildCounterMembershipFeatureSpec < 3) {
    o.cloudbuild = buildCloudBuildMembershipSpec();
    o.configmanagement = buildConfigManagementMembershipSpec();
    o.fleetobservability = buildFleetObservabilityMembershipSpec();
    o.identityservice = buildIdentityServiceMembershipSpec();
    o.mesh = buildServiceMeshMembershipSpec();
    o.namespaceactuation = buildNamespaceActuationMembershipSpec();
    o.origin = buildOrigin();
    o.policycontroller = buildPolicyControllerMembershipSpec();
    o.workloadcertificate = buildMembershipSpec();
  }
  buildCounterMembershipFeatureSpec--;
  return o;
}
...
void checkMembershipFeatureSpec(api.MembershipFeatureSpec o) {
  buildCounterMembershipFeatureSpec++;
  if (buildCounterMembershipFeatureSpec < 3) {
    checkCloudBuildMembershipSpec(o.cloudbuild!);
    checkConfigManagementMembershipSpec(o.configmanagement!);
    checkFleetObservabilityMembershipSpec(o.fleetobservability!);
    checkIdentityServiceMembershipSpec(o.identityservice!);
    checkServiceMeshMembershipSpec(o.mesh!);
    checkNamespaceActuationMembershipSpec(o.namespaceactuation!);
    checkOrigin(o.origin!);
    checkPolicyControllerMembershipSpec(o.policycontroller!);
    checkMembershipSpec(o.workloadcertificate!);
  }
  buildCounterMembershipFeatureSpec--;
}
...
api.MembershipFeatureState buildMembershipFeatureState() {
  ...
  if (buildCounterMembershipFeatureState < 3) {
    ...
    o.namespaceactuation = buildNamespaceActuationMembershipState();
...
void checkMembershipFeatureState(api.MembershipFeatureState o) {
  ...
  if (buildCounterMembershipFeatureState < 3) {
    ...
    checkNamespaceActuationMembershipState(o.namespaceactuation!);
...
core.int buildCounterNamespaceActuationFeatureSpec = 0;
api.NamespaceActuationFeatureSpec buildNamespaceActuationFeatureSpec() {
  final o = api.NamespaceActuationFeatureSpec();
  buildCounterNamespaceActuationFeatureSpec++;
  if (buildCounterNamespaceActuationFeatureSpec < 3) {
    o.actuationMode = 'foo';
  }
  buildCounterNamespaceActuationFeatureSpec--;
  return o;
...
void checkNamespaceActuationFeatureSpec(api.NamespaceActuationFeatureSpec o) {
  buildCounterNamespaceActuationFeatureSpec++;
  if (buildCounterNamespaceActuationFeatureSpec < 3) {
    unittest.expect(o.actuationMode!, unittest.equals('foo'));
  }
  buildCounterNamespaceActuationFeatureSpec--;
}

core.int buildCounterNamespaceActuationFeatureState = 0;
api.NamespaceActuationFeatureState buildNamespaceActuationFeatureState() {
  final o = api.NamespaceActuationFeatureState();
  buildCounterNamespaceActuationFeatureState++;
  if (buildCounterNamespaceActuationFeatureState < 3) {}
  buildCounterNamespaceActuationFeatureState--;
  return o;
}

void checkNamespaceActuationFeatureState(api.NamespaceActuationFeatureState o) {
  buildCounterNamespaceActuationFeatureState++;
  if (buildCounterNamespaceActuationFeatureState < 3) {}
  buildCounterNamespaceActuationFeatureState--;
}

core.int buildCounterNamespaceActuationMembershipSpec = 0;
api.NamespaceActuationMembershipSpec buildNamespaceActuationMembershipSpec() {
  final o = api.NamespaceActuationMembershipSpec();
  buildCounterNamespaceActuationMembershipSpec++;
  if (buildCounterNamespaceActuationMembershipSpec < 3) {}
  buildCounterNamespaceActuationMembershipSpec--;
  return o;
}

void checkNamespaceActuationMembershipSpec(
  api.NamespaceActuationMembershipSpec o,
) {
  buildCounterNamespaceActuationMembershipSpec++;
  if (buildCounterNamespaceActuationMembershipSpec < 3) {}
  buildCounterNamespaceActuationMembershipSpec--;
...
core.int buildCounterNamespaceActuationMembershipState = 0;
api.NamespaceActuationMembershipState buildNamespaceActuationMembershipState() {
  final o = api.NamespaceActuationMembershipState();
  buildCounterNamespaceActuationMembershipState++;
  if (buildCounterNamespaceActuationMembershipState < 3) {}
  buildCounterNamespaceActuationMembershipState--;
  return o;
}

void checkNamespaceActuationMembershipState(
  api.NamespaceActuationMembershipState o,
) {
  buildCounterNamespaceActuationMembershipState++;
  if (buildCounterNamespaceActuationMembershipState < 3) {}
  buildCounterNamespaceActuationMembershipState--;
...
core.List<api.Binding> buildUnnamed70() => [buildBinding(), buildBinding()];
...
api.PolicyControllerBundleInstallSpec buildPolicyControllerBundleInstallSpec() {
  ...
  if (buildCounterPolicyControllerBundleInstallSpec < 3) {
    o.exemptedNamespaces = buildUnnamed71();
  }
  buildCounterPolicyControllerBundleInstallSpec--;
  return o;
}
...
void checkPolicyControllerBundleInstallSpec(
  ...
  buildCounterPolicyControllerBundleInstallSpec++;
  if (buildCounterPolicyControllerBundleInstallSpec < 3) {
    checkUnnamed71(o.exemptedNamespaces!);
  }
  buildCounterPolicyControllerBundleInstallSpec--;
}
...
api.PolicyControllerHubConfig buildPolicyControllerHubConfig() {
  ...
  if (buildCounterPolicyControllerHubConfig < 3) {
    ...
    o.deploymentConfigs = buildUnnamed72();
    o.exemptableNamespaces = buildUnnamed73();
    o.installSpec = 'foo';
    o.logDeniesEnabled = true;
...
void checkPolicyControllerHubConfig(api.PolicyControllerHubConfig o) {
  ...
  if (buildCounterPolicyControllerHubConfig < 3) {
    ...
    checkUnnamed72(o.deploymentConfigs!);
    checkUnnamed73(o.exemptableNamespaces!);
...
core.Map<core.String, api.PolicyControllerOnClusterState> buildUnnamed74() => {
...
api.PolicyControllerMembershipState buildPolicyControllerMembershipState() {
  ...
  if (buildCounterPolicyControllerMembershipState < 3) {
    o.componentStates = buildUnnamed74();
...
void checkPolicyControllerMembershipState(
  ...
  buildCounterPolicyControllerMembershipState++;
  if (buildCounterPolicyControllerMembershipState < 3) {
    checkUnnamed74(o.componentStates!);
...
core.Map<core.String, api.PolicyControllerBundleInstallSpec> buildUnnamed76() =>
    {
...
core.Map<core.String, api.PolicyControllerOnClusterState> buildUnnamed77() => {
  'x': buildPolicyControllerOnClusterState(),
  'y': buildPolicyControllerOnClusterState(),
};
...
core.List<api.PolicyControllerToleration> buildUnnamed78() => [
  buildPolicyControllerToleration(),
  buildPolicyControllerToleration(),
];

void checkUnnamed78(core.List<api.PolicyControllerToleration> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPolicyControllerPolicyControllerDeploymentConfig() {
  ...
  if (buildCounterPolicyControllerPolicyControllerDeploymentConfig < 3) {
    ...
    o.podTolerations = buildUnnamed78();
    o.replicaCount = 'foo';
  }
  buildCounterPolicyControllerPolicyControllerDeploymentConfig--;
  return o;
...
void checkPolicyControllerPolicyControllerDeploymentConfig(
  ...
  if (buildCounterPolicyControllerPolicyControllerDeploymentConfig < 3) {
    ...
    checkUnnamed78(o.podTolerations!);
...
buildRBACRoleBindingActuationFeatureSpec() {
  ...
  if (buildCounterRBACRoleBindingActuationFeatureSpec < 3) {
    o.allowedCustomRoles = buildUnnamed80();
  }
  buildCounterRBACRoleBindingActuationFeatureSpec--;
  return o;
}
...
void checkRBACRoleBindingActuationFeatureSpec(
  ...
  buildCounterRBACRoleBindingActuationFeatureSpec++;
  if (buildCounterRBACRoleBindingActuationFeatureSpec < 3) {
    checkUnnamed80(o.allowedCustomRoles!);
  }
  buildCounterRBACRoleBindingActuationFeatureSpec--;
}
...
api.Scope buildScope() {
  ...
  if (buildCounterScope < 3) {
    ...
    o.name = 'foo';
    o.namespaceLabels = buildUnnamed82();
...
void checkScope(api.Scope o) {
  ...
  if (buildCounterScope < 3) {
    ...
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed82(o.namespaceLabels!);
...
api.ScopeFeatureSpec buildScopeFeatureSpec() {
  ...
  if (buildCounterScopeFeatureSpec < 3) {
    o.clusterupgrade = buildClusterUpgradeScopeSpec();
  }
  buildCounterScopeFeatureSpec--;
  return o;
}
...
void checkScopeFeatureSpec(api.ScopeFeatureSpec o) {
  buildCounterScopeFeatureSpec++;
  if (buildCounterScopeFeatureSpec < 3) {
    checkClusterUpgradeScopeSpec(o.clusterupgrade!);
  }
  buildCounterScopeFeatureSpec--;
}
...
api.ScopeFeatureState buildScopeFeatureState() {
  ...
  if (buildCounterScopeFeatureState < 3) {
    o.clusterupgrade = buildClusterUpgradeScopeState();
    o.state = buildFeatureState();
  }
  buildCounterScopeFeatureState--;
  return o;
...
void checkScopeFeatureState(api.ScopeFeatureState o) {
  buildCounterScopeFeatureState++;
  if (buildCounterScopeFeatureState < 3) {
    checkClusterUpgradeScopeState(o.clusterupgrade!);
    checkFeatureState(o.state!);
  }
  buildCounterScopeFeatureState--;
}
...
api.ServiceMeshAnalysisMessage buildServiceMeshAnalysisMessage() {
  ...
  if (buildCounterServiceMeshAnalysisMessage < 3) {
    ...
    o.resourcePaths = buildUnnamed84();
  }
  buildCounterServiceMeshAnalysisMessage--;
  return o;
}
...
void checkServiceMeshAnalysisMessage(api.ServiceMeshAnalysisMessage o) {
  ...
  if (buildCounterServiceMeshAnalysisMessage < 3) {
    ...
    checkUnnamed84(o.resourcePaths!);
  }
  buildCounterServiceMeshAnalysisMessage--;
}
...
core.List<api.ServiceMeshStatusDetails> buildUnnamed85() => [
  buildServiceMeshStatusDetails(),
  buildServiceMeshStatusDetails(),
];

void checkUnnamed85(core.List<api.ServiceMeshStatusDetails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ServiceMeshStatusDetails> buildUnnamed86() => [
  buildServiceMeshStatusDetails(),
  buildServiceMeshStatusDetails(),
];

void checkUnnamed86(core.List<api.ServiceMeshStatusDetails> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkServiceMeshStatusDetails(o[0]);
  checkServiceMeshStatusDetails(o[1]);
}
...
core.List<api.ServiceMeshAnalysisMessage> buildUnnamed87() => [
  buildServiceMeshAnalysisMessage(),
  buildServiceMeshAnalysisMessage(),
];

void checkUnnamed87(core.List<api.ServiceMeshAnalysisMessage> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkServiceMeshAnalysisMessage(o[0]);
  checkServiceMeshAnalysisMessage(o[1]);
}

core.List<api.ServiceMeshFeatureCondition> buildUnnamed88() => [
  buildServiceMeshFeatureCondition(),
  buildServiceMeshFeatureCondition(),
];

void checkUnnamed88(core.List<api.ServiceMeshFeatureCondition> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ServiceMeshFeatureState buildServiceMeshFeatureState() {
  ...
  if (buildCounterServiceMeshFeatureState < 3) {
    o.analysisMessages = buildUnnamed87();
    o.conditions = buildUnnamed88();
  }
  buildCounterServiceMeshFeatureState--;
  return o;
}
...
void checkServiceMeshFeatureState(api.ServiceMeshFeatureState o) {
  buildCounterServiceMeshFeatureState++;
  if (buildCounterServiceMeshFeatureState < 3) {
    checkUnnamed87(o.analysisMessages!);
    checkUnnamed88(o.conditions!);
  }
  buildCounterServiceMeshFeatureState--;
}
...
core.List<api.ServiceMeshAnalysisMessage> buildUnnamed89() => [
  buildServiceMeshAnalysisMessage(),
  buildServiceMeshAnalysisMessage(),
];

void checkUnnamed89(core.List<api.ServiceMeshAnalysisMessage> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkServiceMeshAnalysisMessage(o[0]);
  checkServiceMeshAnalysisMessage(o[1]);
}

core.List<api.ServiceMeshCondition> buildUnnamed90() => [
  buildServiceMeshCondition(),
  buildServiceMeshCondition(),
];

void checkUnnamed90(core.List<api.ServiceMeshCondition> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ServiceMeshMembershipState buildServiceMeshMembershipState() {
  ...
  if (buildCounterServiceMeshMembershipState < 3) {
    o.analysisMessages = buildUnnamed89();
...
void checkServiceMeshMembershipState(api.ServiceMeshMembershipState o) {
  buildCounterServiceMeshMembershipState++;
  if (buildCounterServiceMeshMembershipState < 3) {
    checkUnnamed89(o.analysisMessages!);
...
core.int buildCounterValidateCreateMembershipRequest = 0;
api.ValidateCreateMembershipRequest buildValidateCreateMembershipRequest() {
  final o = api.ValidateCreateMembershipRequest();
  buildCounterValidateCreateMembershipRequest++;
  if (buildCounterValidateCreateMembershipRequest < 3) {
...
void checkValidateCreateMembershipRequest(
  api.ValidateCreateMembershipRequest o,
) {
  buildCounterValidateCreateMembershipRequest++;
  if (buildCounterValidateCreateMembershipRequest < 3) {
    checkMembership(o.membership!);
    unittest.expect(o.membershipId!, unittest.equals('foo'));
  }
  buildCounterValidateCreateMembershipRequest--;
}

core.List<api.ValidationResult> buildUnnamed93() => [
  buildValidationResult(),
  buildValidationResult(),
];

void checkUnnamed93(core.List<api.ValidationResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValidationResult(o[0]);
  checkValidationResult(o[1]);
}

core.int buildCounterValidateCreateMembershipResponse = 0;
api.ValidateCreateMembershipResponse buildValidateCreateMembershipResponse() {
  final o = api.ValidateCreateMembershipResponse();
  buildCounterValidateCreateMembershipResponse++;
  if (buildCounterValidateCreateMembershipResponse < 3) {
    o.validationResults = buildUnnamed93();
  }
  buildCounterValidateCreateMembershipResponse--;
  return o;
}

void checkValidateCreateMembershipResponse(
  api.ValidateCreateMembershipResponse o,
) {
  buildCounterValidateCreateMembershipResponse++;
  if (buildCounterValidateCreateMembershipResponse < 3) {
    checkUnnamed93(o.validationResults!);
  }
  buildCounterValidateCreateMembershipResponse--;
}
...
core.int buildCounterValidationResult = 0;
api.ValidationResult buildValidationResult() {
  final o = api.ValidationResult();
  buildCounterValidationResult++;
  if (buildCounterValidationResult < 3) {
    o.result = 'foo';
    o.success = true;
    o.validator = 'foo';
  }
...
void checkValidationResult(api.ValidationResult o) {
  buildCounterValidationResult++;
  if (buildCounterValidationResult < 3) {
    unittest.expect(o.result!, unittest.equals('foo'));
    unittest.expect(o.success!, unittest.isTrue);
    unittest.expect(o.validator!, unittest.equals('foo'));
  }
  buildCounterValidationResult--;
}
...
api.WorkloadIdentityFeatureState buildWorkloadIdentityFeatureState() {
  ...
  if (buildCounterWorkloadIdentityFeatureState < 3) {
    o.namespaceStateDetails = buildUnnamed94();
    o.namespaceStates = buildUnnamed95();
    o.scopeTenancyWorkloadIdentityPool = 'foo';
    o.workloadIdentityPool = 'foo';
    o.workloadIdentityPoolStateDetails = buildUnnamed96();
  }
  buildCounterWorkloadIdentityFeatureState--;
  return o;
}
...
void checkWorkloadIdentityFeatureState(api.WorkloadIdentityFeatureState o) {
  buildCounterWorkloadIdentityFeatureState++;
  if (buildCounterWorkloadIdentityFeatureState < 3) {
    checkUnnamed94(o.namespaceStateDetails!);
    checkUnnamed95(o.namespaceStates!);
    unittest.expect(
      o.scopeTenancyWorkloadIdentityPool!,
      unittest.equals('foo'),
    );
    unittest.expect(o.workloadIdentityPool!, unittest.equals('foo'));
    checkUnnamed96(o.workloadIdentityPoolStateDetails!);
  }
  buildCounterWorkloadIdentityFeatureState--;
}
...
void main() {
  ...
  unittest.group('obj-schema-CloudAuditLoggingFeatureSpec', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCloudAuditLoggingFeatureSpec();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CloudAuditLoggingFeatureSpec.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCloudAuditLoggingFeatureSpec(od);
    });
  });

  unittest.group('obj-schema-CloudBuildMembershipSpec', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCloudBuildMembershipSpec();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CloudBuildMembershipSpec.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCloudBuildMembershipSpec(od);
    });
  });
  ...
  unittest.group('obj-schema-ClusterUpgradeScopeSpec', () {
    unittest.test('to-json--from-json', () async {
      final o = buildClusterUpgradeScopeSpec();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ClusterUpgradeScopeSpec.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkClusterUpgradeScopeSpec(od);
    });
  });

  unittest.group('obj-schema-ClusterUpgradeScopeState', () {
    unittest.test('to-json--from-json', () async {
      final o = buildClusterUpgradeScopeState();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ClusterUpgradeScopeState.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkClusterUpgradeScopeState(od);
    });
  });
  ...
  unittest.group('obj-schema-ListAdminClusterMembershipsResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildListAdminClusterMembershipsResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListAdminClusterMembershipsResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkListAdminClusterMembershipsResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-NamespaceActuationFeatureSpec', () {
    unittest.test('to-json--from-json', () async {
      final o = buildNamespaceActuationFeatureSpec();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.NamespaceActuationFeatureSpec.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkNamespaceActuationFeatureSpec(od);
    });
  });

  unittest.group('obj-schema-NamespaceActuationFeatureState', () {
    unittest.test('to-json--from-json', () async {
      final o = buildNamespaceActuationFeatureState();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.NamespaceActuationFeatureState.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkNamespaceActuationFeatureState(od);
    });
  });

  unittest.group('obj-schema-NamespaceActuationMembershipSpec', () {
    unittest.test('to-json--from-json', () async {
      final o = buildNamespaceActuationMembershipSpec();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.NamespaceActuationMembershipSpec.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkNamespaceActuationMembershipSpec(od);
    });
  });

  unittest.group('obj-schema-NamespaceActuationMembershipState', () {
    unittest.test('to-json--from-json', () async {
      final o = buildNamespaceActuationMembershipState();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.NamespaceActuationMembershipState.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkNamespaceActuationMembershipState(od);
    });
  });
  ...
  unittest.group('obj-schema-ValidateCreateMembershipRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildValidateCreateMembershipRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ValidateCreateMembershipRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkValidateCreateMembershipRequest(od);
    });
  });

  unittest.group('obj-schema-ValidateCreateMembershipResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildValidateCreateMembershipResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ValidateCreateMembershipResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkValidateCreateMembershipResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-ValidationResult', () {
    unittest.test('to-json--from-json', () async {
      final o = buildValidationResult();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ValidationResult.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkValidationResult(od);
    });
  });
  ...
  unittest.group('resource-ProjectsLocationsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.GKEHubApi(mock).projects.locations;
      final arg_name = 'foo';
      final arg_extraLocationTypes = buildUnnamed97();
  ...
  unittest.group('resource-ProjectsLocationsMembershipsResource', () {
    ...
    unittest.test('method--listAdmin', () async {
      final mock = HttpServerMock();
      final res = api.GKEHubApi(mock).projects.locations.memberships;
      final arg_parent = 'foo';
      final arg_filter = 'foo';
      ...
      final response = await res.listAdmin(
        arg_parent,
        filter: arg_filter,
        orderBy: arg_orderBy,
        pageSize: arg_pageSize,
      ...
      checkListAdminClusterMembershipsResponse(
        response as api.ListAdminClusterMembershipsResponse,
      );
    });
    ...
    unittest.test('method--validateCreate', () async {
      final mock = HttpServerMock();
      final res = api.GKEHubApi(mock).projects.locations.memberships;
      final arg_request = buildValidateCreateMembershipRequest();
      final arg_parent = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.ValidateCreateMembershipRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkValidateCreateMembershipRequest(obj);
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildValidateCreateMembershipResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.validateCreate(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
      checkValidateCreateMembershipResponse(
        response as api.ValidateCreateMembershipResponse,
      );
    });
