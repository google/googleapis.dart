...
checkUnnamed1361(core.List<api.Method> o) {
...
checkUnnamed1362(core.List<api.Mixin> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMixin(o[0]);
  checkMixin(o[1]);
}
...
checkUnnamed1363(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
buildApi() {
  ...
  if (buildCounterApi < 3) {
    o.methods = buildUnnamed1361();
    o.mixins = buildUnnamed1362();
    o.name = "foo";
    o.options = buildUnnamed1363();
...
checkApi(api.Api o) {
  buildCounterApi++;
  if (buildCounterApi < 3) {
    checkUnnamed1361(o.methods);
    checkUnnamed1362(o.mixins);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed1363(o.options);
...
checkUnnamed1364(core.List<api.AuthProvider> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1365(core.List<api.AuthenticationRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAuthentication() {
  ...
  if (buildCounterAuthentication < 3) {
    o.providers = buildUnnamed1364();
    o.rules = buildUnnamed1365();
  }
  buildCounterAuthentication--;
  return o;
}
...
checkAuthentication(api.Authentication o) {
  buildCounterAuthentication++;
  if (buildCounterAuthentication < 3) {
    checkUnnamed1364(o.providers);
    checkUnnamed1365(o.rules);
  }
  buildCounterAuthentication--;
}
...
checkUnnamed1366(core.List<api.AuthRequirement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAuthenticationRule() {
  ...
  if (buildCounterAuthenticationRule < 3) {
    ...
    o.requirements = buildUnnamed1366();
    o.selector = "foo";
  }
  buildCounterAuthenticationRule--;
  return o;
...
checkAuthenticationRule(api.AuthenticationRule o) {
  ...
  if (buildCounterAuthenticationRule < 3) {
    ...
    checkUnnamed1366(o.requirements);
...
checkUnnamed1367(core.List<api.BackendRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1369(core.List<api.EnableFailure> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1370(core.List<api.GoogleApiServiceusageV1Service> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildBatchEnableServicesResponse() {
  ...
  if (buildCounterBatchEnableServicesResponse < 3) {
    o.failures = buildUnnamed1369();
    o.services = buildUnnamed1370();
  }
  buildCounterBatchEnableServicesResponse--;
  return o;
}
...
checkBatchEnableServicesResponse(api.BatchEnableServicesResponse o) {
  buildCounterBatchEnableServicesResponse++;
  if (buildCounterBatchEnableServicesResponse < 3) {
    checkUnnamed1369(o.failures);
    checkUnnamed1370(o.services);
  }
  buildCounterBatchEnableServicesResponse--;
}
...
checkUnnamed1371(core.List<api.BillingDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildBilling() {
  ...
  if (buildCounterBilling < 3) {
    o.consumerDestinations = buildUnnamed1371();
  }
  buildCounterBilling--;
  return o;
}
...
checkBilling(api.Billing o) {
  buildCounterBilling++;
  if (buildCounterBilling < 3) {
    checkUnnamed1371(o.consumerDestinations);
  }
  buildCounterBilling--;
}
...
checkUnnamed1373(core.List<api.ContextRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildContextRule() {
  ...
  if (buildCounterContextRule < 3) {
    o.allowedRequestExtensions = buildUnnamed1374();
    o.allowedResponseExtensions = buildUnnamed1375();
    o.provided = buildUnnamed1376();
    o.requested = buildUnnamed1377();
    o.selector = "foo";
  }
  buildCounterContextRule--;
  return o;
...
checkContextRule(api.ContextRule o) {
  buildCounterContextRule++;
  if (buildCounterContextRule < 3) {
    checkUnnamed1374(o.allowedRequestExtensions);
    checkUnnamed1375(o.allowedResponseExtensions);
    checkUnnamed1376(o.provided);
    checkUnnamed1377(o.requested);
    unittest.expect(o.selector, unittest.equals('foo'));
  }
  buildCounterContextRule--;
}
...
checkUnnamed1378(core.List<api.CustomErrorRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildCustomError() {
  ...
  if (buildCounterCustomError < 3) {
    o.rules = buildUnnamed1378();
    o.types = buildUnnamed1379();
  }
  buildCounterCustomError--;
  return o;
}
...
checkCustomError(api.CustomError o) {
  buildCounterCustomError++;
  if (buildCounterCustomError < 3) {
    checkUnnamed1378(o.rules);
    checkUnnamed1379(o.types);
  }
  buildCounterCustomError--;
}
...
checkUnnamed1381(core.List<api.DocumentationRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildDocumentation() {
  ...
  if (buildCounterDocumentation < 3) {
    ...
    o.overview = "foo";
    o.pages = buildUnnamed1380();
    o.rules = buildUnnamed1381();
    o.summary = "foo";
  }
  buildCounterDocumentation--;
  return o;
...
checkDocumentation(api.Documentation o) {
  ...
  if (buildCounterDocumentation < 3) {
    ...
    checkUnnamed1380(o.pages);
    checkUnnamed1381(o.rules);
...
buildEndpoint() {
  ...
  if (buildCounterEndpoint < 3) {
    o.aliases = buildUnnamed1382();
    o.allowCors = true;
    o.features = buildUnnamed1383();
    o.name = "foo";
    o.target = "foo";
  }
  buildCounterEndpoint--;
...
checkEndpoint(api.Endpoint o) {
  buildCounterEndpoint++;
  if (buildCounterEndpoint < 3) {
    checkUnnamed1382(o.aliases);
    unittest.expect(o.allowCors, unittest.isTrue);
    checkUnnamed1383(o.features);
    unittest.expect(o.name, unittest.equals('foo'));
...
checkUnnamed1384(core.List<api.EnumValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEnumValue(o[0]);
  checkEnumValue(o[1]);
}
...
checkUnnamed1385(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
buildEnum() {
  ...
  if (buildCounterEnum < 3) {
    o.enumvalue = buildUnnamed1384();
    o.name = "foo";
    o.options = buildUnnamed1385();
    o.sourceContext = buildSourceContext();
    o.syntax = "foo";
  }
  buildCounterEnum--;
...
checkEnum(api.Enum o) {
  buildCounterEnum++;
  if (buildCounterEnum < 3) {
    checkUnnamed1384(o.enumvalue);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed1385(o.options);
    checkSourceContext(o.sourceContext);
    unittest.expect(o.syntax, unittest.equals('foo'));
  }
  buildCounterEnum--;
...
checkUnnamed1386(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
checkUnnamed1388(core.List<api.Api> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApi(o[0]);
  checkApi(o[1]);
}
...
checkUnnamed1389(core.List<api.Endpoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEndpoint(o[0]);
  checkEndpoint(o[1]);
}
...
checkUnnamed1390(core.List<api.Enum> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEnum(o[0]);
  checkEnum(o[1]);
}
...
checkUnnamed1391(core.List<api.LogDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1392(core.List<api.MetricDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1393(core.List<api.MonitoredResourceDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1394(core.List<api.Type> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkType(o[0]);
  checkType(o[1]);
}
...
checkUnnamed1395(core.List<api.Type> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkType(o[0]);
  checkType(o[1]);
}
...
buildGoogleApiService() {
  ...
  if (buildCounterGoogleApiService < 3) {
    ...
    o.endpoints = buildUnnamed1389();
    o.enums = buildUnnamed1390();
    o.experimental = buildExperimental();
    o.http = buildHttp();
    o.id = "foo";
    o.logging = buildLogging();
    o.logs = buildUnnamed1391();
    o.metrics = buildUnnamed1392();
    o.monitoredResources = buildUnnamed1393();
    ...
    o.systemTypes = buildUnnamed1394();
    o.title = "foo";
    o.types = buildUnnamed1395();
    o.usage = buildUsage();
  }
  buildCounterGoogleApiService--;
  return o;
...
checkGoogleApiService(api.GoogleApiService o) {
  ...
  if (buildCounterGoogleApiService < 3) {
    ...
    checkUnnamed1389(o.endpoints);
    checkUnnamed1390(o.enums);
    checkExperimental(o.experimental);
    checkHttp(o.http);
    unittest.expect(o.id, unittest.equals('foo'));
    checkLogging(o.logging);
    checkUnnamed1391(o.logs);
    checkUnnamed1392(o.metrics);
    checkUnnamed1393(o.monitoredResources);
    ...
    checkUnnamed1394(o.systemTypes);
    unittest.expect(o.title, unittest.equals('foo'));
    checkUnnamed1395(o.types);
    checkUsage(o.usage);
  }
  buildCounterGoogleApiService--;
}
...
buildGoogleApiServiceusageV1OperationMetadata() {
  ...
  if (buildCounterGoogleApiServiceusageV1OperationMetadata < 3) {
    o.resourceNames = buildUnnamed1396();
  }
  buildCounterGoogleApiServiceusageV1OperationMetadata--;
  return o;
}
...
checkGoogleApiServiceusageV1OperationMetadata(
  ...
  buildCounterGoogleApiServiceusageV1OperationMetadata++;
  if (buildCounterGoogleApiServiceusageV1OperationMetadata < 3) {
    checkUnnamed1396(o.resourceNames);
  }
  buildCounterGoogleApiServiceusageV1OperationMetadata--;
}
...
checkUnnamed1397(core.List<api.Api> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApi(o[0]);
  checkApi(o[1]);
}
...
checkUnnamed1398(core.List<api.Endpoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEndpoint(o[0]);
  checkEndpoint(o[1]);
}
...
buildGoogleApiServiceusageV1ServiceConfig() {
  ...
  if (buildCounterGoogleApiServiceusageV1ServiceConfig < 3) {
    o.apis = buildUnnamed1397();
    o.authentication = buildAuthentication();
    o.documentation = buildDocumentation();
    o.endpoints = buildUnnamed1398();
    o.name = "foo";
    o.quota = buildQuota();
    o.title = "foo";
    o.usage = buildUsage();
...
checkGoogleApiServiceusageV1ServiceConfig(
  ...
  buildCounterGoogleApiServiceusageV1ServiceConfig++;
  if (buildCounterGoogleApiServiceusageV1ServiceConfig < 3) {
    checkUnnamed1397(o.apis);
    checkAuthentication(o.authentication);
    checkDocumentation(o.documentation);
    checkUnnamed1398(o.endpoints);
    unittest.expect(o.name, unittest.equals('foo'));
    checkQuota(o.quota);
    unittest.expect(o.title, unittest.equals('foo'));
    checkUsage(o.usage);
...
checkUnnamed1399(core.List<api.HttpRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHttpRule(o[0]);
  checkHttpRule(o[1]);
}
...
checkUnnamed1400(core.List<api.HttpRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHttpRule(o[0]);
  checkHttpRule(o[1]);
}
...
checkUnnamed1401(core.List<api.AuthorizationRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildHttpRule() {
  ...
  if (buildCounterHttpRule < 3) {
    o.additionalBindings = buildUnnamed1400();
    o.authorizations = buildUnnamed1401();
    o.body = "foo";
...
checkHttpRule(api.HttpRule o) {
  buildCounterHttpRule++;
  if (buildCounterHttpRule < 3) {
    checkUnnamed1400(o.additionalBindings);
    checkUnnamed1401(o.authorizations);
...
checkUnnamed1402(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkUnnamed1403(core.List<api.GoogleApiServiceusageV1Service> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleApiServiceusageV1Service(o[0]);
  checkGoogleApiServiceusageV1Service(o[1]);
}
...
checkUnnamed1404(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1405(core.List<api.LoggingDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1406(core.List<api.LoggingDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLoggingDestination(o[0]);
  checkLoggingDestination(o[1]);
}
...
buildLogging() {
  ...
  if (buildCounterLogging < 3) {
    o.consumerDestinations = buildUnnamed1405();
    o.producerDestinations = buildUnnamed1406();
  }
  buildCounterLogging--;
  return o;
}
...
checkLogging(api.Logging o) {
  buildCounterLogging++;
  if (buildCounterLogging < 3) {
    checkUnnamed1405(o.consumerDestinations);
    checkUnnamed1406(o.producerDestinations);
  }
  buildCounterLogging--;
}
...
checkUnnamed1409(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
checkUnnamed1410(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelDescriptor(o[0]);
  checkLabelDescriptor(o[1]);
}
...
buildMetricRule() {
  ...
  if (buildCounterMetricRule < 3) {
    o.metricCosts = buildUnnamed1411();
    o.selector = "foo";
  }
  buildCounterMetricRule--;
  return o;
...
checkMetricRule(api.MetricRule o) {
  buildCounterMetricRule++;
  if (buildCounterMetricRule < 3) {
    checkUnnamed1411(o.metricCosts);
    unittest.expect(o.selector, unittest.equals('foo'));
  }
  buildCounterMetricRule--;
}
...
checkUnnamed1412(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelDescriptor(o[0]);
  checkLabelDescriptor(o[1]);
}
...
checkUnnamed1413(core.List<api.MonitoringDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1414(core.List<api.MonitoringDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMonitoringDestination(o[0]);
  checkMonitoringDestination(o[1]);
}
...
buildMonitoring() {
  ...
  if (buildCounterMonitoring < 3) {
    o.consumerDestinations = buildUnnamed1413();
    o.producerDestinations = buildUnnamed1414();
  }
  buildCounterMonitoring--;
  return o;
}
...
checkMonitoring(api.Monitoring o) {
  buildCounterMonitoring++;
  if (buildCounterMonitoring < 3) {
    checkUnnamed1413(o.consumerDestinations);
    checkUnnamed1414(o.producerDestinations);
  }
  buildCounterMonitoring--;
}
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed1416();
    o.name = "foo";
    o.response = buildUnnamed1417();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed1416(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed1417(o.response);
  }
  buildCounterOperation--;
}
...
buildOperationMetadata() {
  ...
  if (buildCounterOperationMetadata < 3) {
    o.resourceNames = buildUnnamed1418();
  }
  buildCounterOperationMetadata--;
  return o;
}
...
checkOperationMetadata(api.OperationMetadata o) {
  buildCounterOperationMetadata++;
  if (buildCounterOperationMetadata < 3) {
    checkUnnamed1418(o.resourceNames);
  }
  buildCounterOperationMetadata--;
}
...
checkUnnamed1420(core.List<api.Page> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPage(o[0]);
  checkPage(o[1]);
}
...
checkUnnamed1421(core.List<api.QuotaLimit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQuotaLimit(o[0]);
  checkQuotaLimit(o[1]);
}
...
checkUnnamed1422(core.List<api.MetricRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetricRule(o[0]);
  checkMetricRule(o[1]);
}
...
buildQuota() {
  ...
  if (buildCounterQuota < 3) {
    o.limits = buildUnnamed1421();
    o.metricRules = buildUnnamed1422();
  }
  buildCounterQuota--;
  return o;
}
...
checkQuota(api.Quota o) {
  buildCounterQuota++;
  if (buildCounterQuota < 3) {
    checkUnnamed1421(o.limits);
    checkUnnamed1422(o.metricRules);
  }
  buildCounterQuota--;
}
...
buildSourceInfo() {
  ...
  if (buildCounterSourceInfo < 3) {
    o.sourceFiles = buildUnnamed1425();
  }
  buildCounterSourceInfo--;
  return o;
}
...
checkSourceInfo(api.SourceInfo o) {
  buildCounterSourceInfo++;
  if (buildCounterSourceInfo < 3) {
    checkUnnamed1425(o.sourceFiles);
  }
  buildCounterSourceInfo--;
}
...
buildUnnamed1427() {
  var o = new core.List<core.Map<core.String, core.Object>>();
  o.add(buildUnnamed1426());
  o.add(buildUnnamed1426());
  return o;
}

checkUnnamed1427(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1426(o[0]);
  checkUnnamed1426(o[1]);
}
...
checkUnnamed1428(core.List<api.SystemParameter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1429(core.List<api.SystemParameterRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1430(core.List<api.Field> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkField(o[0]);
  checkField(o[1]);
}
...
checkUnnamed1432(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
buildType() {
  ...
  if (buildCounterType < 3) {
    o.fields = buildUnnamed1430();
    o.name = "foo";
    o.oneofs = buildUnnamed1431();
    o.options = buildUnnamed1432();
    o.sourceContext = buildSourceContext();
    o.syntax = "foo";
  }
  buildCounterType--;
...
checkType(api.Type o) {
  buildCounterType++;
  if (buildCounterType < 3) {
    checkUnnamed1430(o.fields);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed1431(o.oneofs);
    checkUnnamed1432(o.options);
    checkSourceContext(o.sourceContext);
    unittest.expect(o.syntax, unittest.equals('foo'));
  }
  buildCounterType--;
...
checkUnnamed1434(core.List<api.UsageRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUsageRule(o[0]);
  checkUsageRule(o[1]);
}
...
buildUsage() {
  ...
  if (buildCounterUsage < 3) {
    ...
    o.requirements = buildUnnamed1433();
    o.rules = buildUnnamed1434();
  }
  buildCounterUsage--;
  return o;
}
...
checkUsage(api.Usage o) {
  ...
  if (buildCounterUsage < 3) {
    ...
    checkUnnamed1433(o.requirements);
    checkUnnamed1434(o.rules);
  }
  buildCounterUsage--;
}
