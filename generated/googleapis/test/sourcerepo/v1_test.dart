...
checkUnnamed2911(core.List<api.AuditLogConfig> o) {
...
buildAuditConfig() {
  ...
  if (buildCounterAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed2911();
    o.service = "foo";
  }
  buildCounterAuditConfig--;
  return o;
...
checkAuditConfig(api.AuditConfig o) {
  buildCounterAuditConfig++;
  if (buildCounterAuditConfig < 3) {
    checkUnnamed2911(o.auditLogConfigs);
...
buildAuditLogConfig() {
  ...
  if (buildCounterAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed2912();
    o.logType = "foo";
  }
  buildCounterAuditLogConfig--;
  return o;
...
checkAuditLogConfig(api.AuditLogConfig o) {
  buildCounterAuditLogConfig++;
  if (buildCounterAuditLogConfig < 3) {
    checkUnnamed2912(o.exemptedMembers);
...
checkUnnamed2914(core.List<api.Repo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRepo(o[0]);
  checkRepo(o[1]);
}
...
checkUnnamed2915(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2917(core.List<api.AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2918(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.auditConfigs = buildUnnamed2917();
    o.bindings = buildUnnamed2918();
    o.etag = "foo";
    o.version = 42;
  }
  buildCounterPolicy--;
...
checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed2917(o.auditConfigs);
    checkUnnamed2918(o.bindings);
...
checkUnnamed2919(core.Map<core.String, api.PubsubConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildProjectConfig() {
  ...
  if (buildCounterProjectConfig < 3) {
    ...
    o.name = "foo";
    o.pubsubConfigs = buildUnnamed2919();
  }
  buildCounterProjectConfig--;
  return o;
}
...
checkProjectConfig(api.ProjectConfig o) {
  ...
  if (buildCounterProjectConfig < 3) {
    ...
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed2919(o.pubsubConfigs);
  }
  buildCounterProjectConfig--;
}
...
checkUnnamed2920(core.Map<core.String, api.PubsubConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPubsubConfig(o["x"]);
  checkPubsubConfig(o["y"]);
}
...
buildRepo() {
  ...
  if (buildCounterRepo < 3) {
    ...
    o.name = "foo";
    o.pubsubConfigs = buildUnnamed2920();
    o.size = "foo";
    o.url = "foo";
  }
  buildCounterRepo--;
...
checkRepo(api.Repo o) {
  ...
  if (buildCounterRepo < 3) {
    ...
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed2920(o.pubsubConfigs);
...
checkUnnamed2921(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed2922() {
  ...
  o.add(buildUnnamed2921());
  o.add(buildUnnamed2921());
  return o;
}

checkUnnamed2922(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2921(o[0]);
  checkUnnamed2921(o[1]);
}
...
buildTestIamPermissionsRequest() {
  ...
  if (buildCounterTestIamPermissionsRequest < 3) {
    o.permissions = buildUnnamed2923();
  }
  buildCounterTestIamPermissionsRequest--;
  return o;
}
...
checkTestIamPermissionsRequest(api.TestIamPermissionsRequest o) {
  buildCounterTestIamPermissionsRequest++;
  if (buildCounterTestIamPermissionsRequest < 3) {
    checkUnnamed2923(o.permissions);
  }
  buildCounterTestIamPermissionsRequest--;
}
...
buildTestIamPermissionsResponse() {
  ...
  if (buildCounterTestIamPermissionsResponse < 3) {
    o.permissions = buildUnnamed2924();
  }
  buildCounterTestIamPermissionsResponse--;
  return o;
}
...
checkTestIamPermissionsResponse(api.TestIamPermissionsResponse o) {
  buildCounterTestIamPermissionsResponse++;
  if (buildCounterTestIamPermissionsResponse < 3) {
    checkUnnamed2924(o.permissions);
  }
  buildCounterTestIamPermissionsResponse--;
}
