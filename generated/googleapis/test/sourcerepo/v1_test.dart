...
core.List<api.AuditLogConfig> buildUnnamed4033() {
...
void checkUnnamed4033(core.List<api.AuditLogConfig> o) {
...
api.AuditConfig buildAuditConfig() {
  ...
  if (buildCounterAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed4033();
    o.service = 'foo';
  }
  buildCounterAuditConfig--;
  return o;
...
void checkAuditConfig(api.AuditConfig o) {
  buildCounterAuditConfig++;
  if (buildCounterAuditConfig < 3) {
    checkUnnamed4033(o.auditLogConfigs!);
    unittest.expect(
      o.service!,
      unittest.equals('foo'),
    );
...
api.AuditLogConfig buildAuditLogConfig() {
  ...
  if (buildCounterAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed4034();
    o.logType = 'foo';
  }
  buildCounterAuditLogConfig--;
  return o;
...
void checkAuditLogConfig(api.AuditLogConfig o) {
  buildCounterAuditLogConfig++;
  if (buildCounterAuditLogConfig < 3) {
    checkUnnamed4034(o.exemptedMembers!);
    unittest.expect(
      o.logType!,
      unittest.equals('foo'),
    );
...
core.List<api.Repo> buildUnnamed4036() {
  var o = <api.Repo>[];
  o.add(buildRepo());
  o.add(buildRepo());
  return o;
...
void checkUnnamed4036(core.List<api.Repo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed4037() {
...
void checkUnnamed4037(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed4038() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed4038(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed4037();
    o.name = 'foo';
    o.response = buildUnnamed4038();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkUnnamed4037(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed4038(o.response!);
  }
  buildCounterOperation--;
}

core.List<api.AuditConfig> buildUnnamed4039() {
  var o = <api.AuditConfig>[];
...
void checkUnnamed4039(core.List<api.AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAuditConfig(o[0] as api.AuditConfig);
  checkAuditConfig(o[1] as api.AuditConfig);
}

core.List<api.Binding> buildUnnamed4040() {
  var o = <api.Binding>[];
  o.add(buildBinding());
  o.add(buildBinding());
  return o;
...
void checkUnnamed4040(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Policy buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.auditConfigs = buildUnnamed4039();
    o.bindings = buildUnnamed4040();
    o.etag = 'foo';
    o.version = 42;
  }
  buildCounterPolicy--;
...
void checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed4039(o.auditConfigs!);
    checkUnnamed4040(o.bindings!);
    unittest.expect(
      o.etag!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, api.PubsubConfig> buildUnnamed4041() {
...
void checkUnnamed4041(core.Map<core.String, api.PubsubConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ProjectConfig buildProjectConfig() {
  ...
  if (buildCounterProjectConfig < 3) {
    ...
    o.name = 'foo';
    o.pubsubConfigs = buildUnnamed4041();
  }
  buildCounterProjectConfig--;
  return o;
}
...
void checkProjectConfig(api.ProjectConfig o) {
  ...
  if (buildCounterProjectConfig < 3) {
    ...
    checkUnnamed4041(o.pubsubConfigs!);
  }
  buildCounterProjectConfig--;
}
...
core.Map<core.String, api.PubsubConfig> buildUnnamed4042() {
  var o = <core.String, api.PubsubConfig>{};
  o['x'] = buildPubsubConfig();
  o['y'] = buildPubsubConfig();
  return o;
...
void checkUnnamed4042(core.Map<core.String, api.PubsubConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPubsubConfig(o['x']! as api.PubsubConfig);
  checkPubsubConfig(o['y']! as api.PubsubConfig);
}
...
api.Repo buildRepo() {
  ...
  if (buildCounterRepo < 3) {
    ...
    o.name = 'foo';
    o.pubsubConfigs = buildUnnamed4042();
    o.size = 'foo';
    o.url = 'foo';
  }
  buildCounterRepo--;
...
void checkRepo(api.Repo o) {
  ...
  if (buildCounterRepo < 3) {
    ...
    checkUnnamed4042(o.pubsubConfigs!);
    unittest.expect(
      o.size!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.Object> buildUnnamed4043() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed4043(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed4044() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed4043());
  o.add(buildUnnamed4043());
  return o;
}

void checkUnnamed4044(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed4043(o[0]);
  checkUnnamed4043(o[1]);
}
...
api.TestIamPermissionsRequest buildTestIamPermissionsRequest() {
  ...
  if (buildCounterTestIamPermissionsRequest < 3) {
    o.permissions = buildUnnamed4045();
  }
  buildCounterTestIamPermissionsRequest--;
  return o;
}
...
void checkTestIamPermissionsRequest(api.TestIamPermissionsRequest o) {
  buildCounterTestIamPermissionsRequest++;
  if (buildCounterTestIamPermissionsRequest < 3) {
    checkUnnamed4045(o.permissions!);
  }
  buildCounterTestIamPermissionsRequest--;
}
