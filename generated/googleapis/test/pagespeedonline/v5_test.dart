...
checkUnnamed2987(core.List<api.AuditRefs> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAuditRefs(o[0]);
  checkAuditRefs(o[1]);
}
...
checkUnnamed2988(core.Map<core.String, api.LighthouseAuditResultV5> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2989(core.Map<core.String, api.CategoryGroupV5> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2990(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2991(core.List<api.StackPack> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStackPack(o[0]);
  checkStackPack(o[1]);
}
...
buildLighthouseResultV5() {
  ...
  if (buildCounterLighthouseResultV5 < 3) {
    o.audits = buildUnnamed2988();
    o.categories = buildCategories();
    o.categoryGroups = buildUnnamed2989();
    ...
    o.requestedUrl = "foo";
    o.runWarnings = buildUnnamed2990();
    o.runtimeError = buildRuntimeError();
    o.stackPacks = buildUnnamed2991();
...
checkLighthouseResultV5(api.LighthouseResultV5 o) {
  buildCounterLighthouseResultV5++;
  if (buildCounterLighthouseResultV5 < 3) {
    checkUnnamed2988(o.audits);
    checkCategories(o.categories);
    checkUnnamed2989(o.categoryGroups);
    ...
    checkUnnamed2990(o.runWarnings);
    checkRuntimeError(o.runtimeError);
    checkUnnamed2991(o.stackPacks);
...
checkUnnamed2992(core.Map<core.String, api.UserPageLoadMetricV5> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildStackPack() {
  ...
  if (buildCounterStackPack < 3) {
    o.descriptions = buildUnnamed2993();
    o.iconDataURL = "foo";
    o.id = "foo";
    o.title = "foo";
  }
...
checkStackPack(api.StackPack o) {
  buildCounterStackPack++;
  if (buildCounterStackPack < 3) {
    checkUnnamed2993(o.descriptions);
...
checkUnnamed2994(core.List<api.Bucket> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBucket(o[0]);
  checkBucket(o[1]);
}
...
buildUserPageLoadMetricV5() {
  ...
  if (buildCounterUserPageLoadMetricV5 < 3) {
    o.category = "foo";
    o.distributions = buildUnnamed2994();
    o.formFactor = "foo";
    o.median = 42;
    o.metricId = "foo";
    o.percentile = 42;
...
checkUserPageLoadMetricV5(api.UserPageLoadMetricV5 o) {
  ...
  if (buildCounterUserPageLoadMetricV5 < 3) {
    ...
    checkUnnamed2994(o.distributions);
...
main() {
  ...
  unittest.group("resource-PagespeedapiResourceApi", () {
    unittest.test("method--runpagespeed", () {
      ...
      var arg_category = buildUnnamed2995();
