...
api.AuditRefs buildAuditRefs() {
  ...
  if (buildCounterAuditRefs < 3) {
    ...
    o.group = 'foo';
    o.id = 'foo';
    o.relevantAudits = buildUnnamed2558();
    o.weight = 42.0;
  }
  buildCounterAuditRefs--;
  return o;
...
void checkAuditRefs(api.AuditRefs o) {
  ...
  if (buildCounterAuditRefs < 3) {
    ...
    checkUnnamed2558(o.relevantAudits!);
    unittest.expect(
      o.weight!,
...
core.Map<core.String, core.Object> buildUnnamed2559() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed2559(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.AuditRefs> buildUnnamed2560() => [
      buildAuditRefs(),
      buildAuditRefs(),
    ];

void checkUnnamed2560(core.List<api.AuditRefs> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAuditRefs(o[0]);
  checkAuditRefs(o[1]);
}
...
core.Map<core.String, api.LighthouseAuditResultV5> buildUnnamed2561() => {
      'x': buildLighthouseAuditResultV5(),
      'y': buildLighthouseAuditResultV5(),
    };

void checkUnnamed2561(core.Map<core.String, api.LighthouseAuditResultV5> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLighthouseAuditResultV5(o['x']!);
  checkLighthouseAuditResultV5(o['y']!);
}

core.Map<core.String, api.CategoryGroupV5> buildUnnamed2562() => {
      'x': buildCategoryGroupV5(),
      'y': buildCategoryGroupV5(),
    };

void checkUnnamed2562(core.Map<core.String, api.CategoryGroupV5> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.StackPack> buildUnnamed2564() => [
      buildStackPack(),
      buildStackPack(),
    ];

void checkUnnamed2564(core.List<api.StackPack> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStackPack(o[0]);
  checkStackPack(o[1]);
}
...
api.LighthouseResultV5 buildLighthouseResultV5() {
  ...
  if (buildCounterLighthouseResultV5 < 3) {
    o.audits = buildUnnamed2561();
    o.categories = buildCategories();
    o.categoryGroups = buildUnnamed2562();
    ...
    o.requestedUrl = 'foo';
    o.runWarnings = buildUnnamed2563();
    o.runtimeError = buildRuntimeError();
    o.stackPacks = buildUnnamed2564();
...
void checkLighthouseResultV5(api.LighthouseResultV5 o) {
  buildCounterLighthouseResultV5++;
  if (buildCounterLighthouseResultV5 < 3) {
    checkUnnamed2561(o.audits!);
    checkCategories(o.categories!);
    checkUnnamed2562(o.categoryGroups!);
    ...
    checkUnnamed2563(o.runWarnings!);
    checkRuntimeError(o.runtimeError!);
    checkUnnamed2564(o.stackPacks!);
...
core.Map<core.String, api.UserPageLoadMetricV5> buildUnnamed2565() => {
      'x': buildUserPageLoadMetricV5(),
      'y': buildUserPageLoadMetricV5(),
    };

void checkUnnamed2565(core.Map<core.String, api.UserPageLoadMetricV5> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.StackPack buildStackPack() {
  ...
  if (buildCounterStackPack < 3) {
    o.descriptions = buildUnnamed2566();
    o.iconDataURL = 'foo';
    o.id = 'foo';
    o.title = 'foo';
  }
...
void checkStackPack(api.StackPack o) {
  buildCounterStackPack++;
  if (buildCounterStackPack < 3) {
    checkUnnamed2566(o.descriptions!);
    unittest.expect(
      o.iconDataURL!,
      unittest.equals('foo'),
    );
...
core.List<api.Bucket> buildUnnamed2567() => [
      buildBucket(),
      buildBucket(),
    ];

void checkUnnamed2567(core.List<api.Bucket> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBucket(o[0]);
  checkBucket(o[1]);
}
...
api.UserPageLoadMetricV5 buildUserPageLoadMetricV5() {
  ...
  if (buildCounterUserPageLoadMetricV5 < 3) {
    o.category = 'foo';
    o.distributions = buildUnnamed2567();
    o.formFactor = 'foo';
    o.median = 42;
    o.metricId = 'foo';
    o.percentile = 42;
...
void checkUserPageLoadMetricV5(api.UserPageLoadMetricV5 o) {
  ...
  if (buildCounterUserPageLoadMetricV5 < 3) {
    ...
    checkUnnamed2567(o.distributions!);
    unittest.expect(
      o.formFactor!,
      unittest.equals('foo'),
    );
...
void main() {
  ...
  unittest.group('resource-PagespeedapiResource', () {
    unittest.test('method--runpagespeed', () async {
      ...
      final arg_category = buildUnnamed2568();
