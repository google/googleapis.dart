...
checkUnnamed2369(core.List<api.PagespeedApiFormatStringV2ArgsRects> o) {
...
checkUnnamed2370(core.List<api.PagespeedApiFormatStringV2ArgsSecondaryRects> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPagespeedApiFormatStringV2Args() {
  ...
  if (buildCounterPagespeedApiFormatStringV2Args < 3) {
    o.key = "foo";
    o.rects = buildUnnamed2369();
    o.secondaryRects = buildUnnamed2370();
    o.type = "foo";
    o.value = "foo";
  }
  buildCounterPagespeedApiFormatStringV2Args--;
...
checkPagespeedApiFormatStringV2Args(api.PagespeedApiFormatStringV2Args o) {
  ...
  if (buildCounterPagespeedApiFormatStringV2Args < 3) {
    ...
    checkUnnamed2369(o.rects);
    checkUnnamed2370(o.secondaryRects);
...
checkUnnamed2371(core.List<api.PagespeedApiFormatStringV2Args> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2373(core.List<api.PagespeedApiFormatStringV2> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2374(core.List<api.ResultFormattedResultsRuleResultsValueUrlBlocksUrls> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2375(core.List<api.ResultFormattedResultsRuleResultsValueUrlBlocks> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2376(core.Map<core.String, api.ResultFormattedResultsRuleResultsValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildResultFormattedResults() {
  ...
  if (buildCounterResultFormattedResults < 3) {
    o.locale = "foo";
    o.ruleResults = buildUnnamed2376();
  }
  buildCounterResultFormattedResults--;
  return o;
}
...
checkResultFormattedResults(api.ResultFormattedResults o) {
  ...
  if (buildCounterResultFormattedResults < 3) {
    ...
    checkUnnamed2376(o.ruleResults);
  }
  buildCounterResultFormattedResults--;
}
...
checkUnnamed2378(core.Map<core.String, api.ResultRuleGroupsValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildResult() {
  ...
  if (buildCounterResult < 3) {
    ...
    o.id = "foo";
    o.invalidRules = buildUnnamed2377();
    o.kind = "foo";
    o.pageStats = buildResultPageStats();
    o.responseCode = 42;
    o.ruleGroups = buildUnnamed2378();
