...
checkUnnamed1347(core.List<api.PagespeedApiFormatStringV2ArgsRects> o) {
...
checkUnnamed1348(core.List<api.PagespeedApiFormatStringV2ArgsSecondaryRects> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPagespeedApiFormatStringV2Args() {
  ...
  if (buildCounterPagespeedApiFormatStringV2Args < 3) {
    o.key = "foo";
    o.rects = buildUnnamed1347();
    o.secondaryRects = buildUnnamed1348();
    o.type = "foo";
    o.value = "foo";
  }
  buildCounterPagespeedApiFormatStringV2Args--;
...
checkPagespeedApiFormatStringV2Args(api.PagespeedApiFormatStringV2Args o) {
  ...
  if (buildCounterPagespeedApiFormatStringV2Args < 3) {
    ...
    checkUnnamed1347(o.rects);
    checkUnnamed1348(o.secondaryRects);
...
checkUnnamed1349(core.List<api.PagespeedApiFormatStringV2Args> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1351(core.List<api.PagespeedApiFormatStringV2> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1352(core.List<api.ResultFormattedResultsRuleResultsValueUrlBlocksUrls> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1353(core.List<api.ResultFormattedResultsRuleResultsValueUrlBlocks> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1354(core.Map<core.String, api.ResultFormattedResultsRuleResultsValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildResultFormattedResults() {
  ...
  if (buildCounterResultFormattedResults < 3) {
    o.locale = "foo";
    o.ruleResults = buildUnnamed1354();
  }
  buildCounterResultFormattedResults--;
  return o;
}
...
checkResultFormattedResults(api.ResultFormattedResults o) {
  ...
  if (buildCounterResultFormattedResults < 3) {
    ...
    checkUnnamed1354(o.ruleResults);
  }
  buildCounterResultFormattedResults--;
}
...
checkUnnamed1356(core.Map<core.String, api.ResultRuleGroupsValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildResult() {
  ...
  if (buildCounterResult < 3) {
    ...
    o.id = "foo";
    o.invalidRules = buildUnnamed1355();
    o.kind = "foo";
    o.pageStats = buildResultPageStats();
    o.responseCode = 42;
    o.ruleGroups = buildUnnamed1356();
