...
import 'package:googleapis/networkmanagement/v1beta1.dart' as api;
...
void checkEndpoint(api.Endpoint o) {
  buildCounterEndpoint++;
  if (buildCounterEndpoint < 3) {
    unittest.expect(o.alloyDbInstance!, unittest.equals('foo'));
...
core.List<api.SingleEdgeResponse> buildUnnamed25() => [
  buildSingleEdgeResponse(),
  buildSingleEdgeResponse(),
];

void checkUnnamed25(core.List<api.SingleEdgeResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ProbingDetails buildProbingDetails() {
  ...
  if (buildCounterProbingDetails < 3) {
    ...
    o.edgeResponses = buildUnnamed25();
...
void checkProbingDetails(api.ProbingDetails o) {
  ...
  if (buildCounterProbingDetails < 3) {
    ...
    checkUnnamed25(o.edgeResponses!);
...
core.List<api.VpcFlowLogsConfig> buildUnnamed27() => [
  buildVpcFlowLogsConfig(),
  buildVpcFlowLogsConfig(),
];

void checkUnnamed27(core.List<api.VpcFlowLogsConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVpcFlowLogsConfig(o[0]);
  checkVpcFlowLogsConfig(o[1]);
}
...
buildQueryOrgVpcFlowLogsConfigsResponse() {
  ...
  if (buildCounterQueryOrgVpcFlowLogsConfigsResponse < 3) {
    ...
    o.vpcFlowLogsConfigs = buildUnnamed27();
  }
  buildCounterQueryOrgVpcFlowLogsConfigsResponse--;
  return o;
}
...
void checkQueryOrgVpcFlowLogsConfigsResponse(
  ...
  if (buildCounterQueryOrgVpcFlowLogsConfigsResponse < 3) {
    ...
    checkUnnamed27(o.vpcFlowLogsConfigs!);
  }
  buildCounterQueryOrgVpcFlowLogsConfigsResponse--;
}

core.List<api.Trace> buildUnnamed28() => [buildTrace(), buildTrace()];

void checkUnnamed28(core.List<api.Trace> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTrace(o[0]);
  checkTrace(o[1]);
}
...
api.RouteInfo buildRouteInfo() {
  ...
  if (buildCounterRouteInfo < 3) {
    ...
    o.destIpRange = 'foo';
    o.destPortRanges = buildUnnamed29();
    o.displayName = 'foo';
    o.instanceTags = buildUnnamed30();
    ...
    o.priority = 42;
    o.protocols = buildUnnamed31();
    o.region = 'foo';
    o.routeScope = 'foo';
    o.routeType = 'foo';
    o.srcIpRange = 'foo';
    o.srcPortRanges = buildUnnamed32();
    o.uri = 'foo';
  }
  buildCounterRouteInfo--;
  return o;
...
void checkRouteInfo(api.RouteInfo o) {
  ...
  if (buildCounterRouteInfo < 3) {
    ...
    checkUnnamed29(o.destPortRanges!);
    unittest.expect(o.displayName!, unittest.equals('foo'));
    checkUnnamed30(o.instanceTags!);
    ...
    checkUnnamed32(o.srcPortRanges!);
    unittest.expect(o.uri!, unittest.equals('foo'));
  }
  buildCounterRouteInfo--;
}
...
core.List<api.Step> buildUnnamed37() => [buildStep(), buildStep()];

void checkUnnamed37(core.List<api.Step> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStep(o[0]);
  checkStep(o[1]);
}
...
api.VpcFlowLogsConfig buildVpcFlowLogsConfig() {
  ...
  if (buildCounterVpcFlowLogsConfig < 3) {
    ...
    o.metadata = 'foo';
    o.metadataFields = buildUnnamed39();
    o.name = 'foo';
    o.network = 'foo';
    o.state = 'foo';
    o.subnet = 'foo';
...
void checkVpcFlowLogsConfig(api.VpcFlowLogsConfig o) {
  ...
  if (buildCounterVpcFlowLogsConfig < 3) {
    ...
    checkUnnamed39(o.metadataFields!);
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.network!, unittest.equals('foo'));
    unittest.expect(o.state!, unittest.equals('foo'));
