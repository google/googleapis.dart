...
core.List<api.Operation> buildUnnamed5919() {
  var o = <api.Operation>[];
...
void checkUnnamed5919(core.List<api.Operation> o) {
...
core.Map<core.String, core.Object> buildUnnamed5921() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed5921(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed5920();
    o.name = 'foo';
    o.response = buildUnnamed5921();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkUnnamed5920(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed5921(o.response);
  }
  buildCounterOperation--;
}
...
core.List<core.Map<core.String, core.Object>> buildUnnamed5923() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed5922());
  o.add(buildUnnamed5922());
  return o;
}

void checkUnnamed5923(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed5922(o[0]);
  checkUnnamed5922(o[1]);
}
