...
core.List<api.GoogleExampleLibraryagentV1Book> buildUnnamed7651() => [
      buildGoogleExampleLibraryagentV1Book(),
      buildGoogleExampleLibraryagentV1Book(),
    ];

void checkUnnamed7651(core.List<api.GoogleExampleLibraryagentV1Book> o) {
...
core.List<api.GoogleExampleLibraryagentV1Shelf> buildUnnamed7652() => [
      buildGoogleExampleLibraryagentV1Shelf(),
      buildGoogleExampleLibraryagentV1Shelf(),
    ];

void checkUnnamed7652(core.List<api.GoogleExampleLibraryagentV1Shelf> o) {
  unittest.expect(o, unittest.hasLength(2));
