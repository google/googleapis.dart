...
core.List<api.GoogleCloudAssuredworkloadsV1Workload> buildUnnamed6132() => [
      buildGoogleCloudAssuredworkloadsV1Workload(),
      buildGoogleCloudAssuredworkloadsV1Workload(),
    ];

void checkUnnamed6132(core.List<api.GoogleCloudAssuredworkloadsV1Workload> o) {
...
api.GoogleCloudAssuredworkloadsV1Workload
  ...
  if (buildCounterGoogleCloudAssuredworkloadsV1Workload < 3) {
    ...
    o.resourceSettings = buildUnnamed6134();
    o.resources = buildUnnamed6135();
  }
  buildCounterGoogleCloudAssuredworkloadsV1Workload--;
  return o;
}
...
void checkGoogleCloudAssuredworkloadsV1Workload(
  ...
  if (buildCounterGoogleCloudAssuredworkloadsV1Workload < 3) {
    ...
    checkUnnamed6134(o.resourceSettings!);
    checkUnnamed6135(o.resources!);
  }
  buildCounterGoogleCloudAssuredworkloadsV1Workload--;
}
...
api.GoogleCloudAssuredworkloadsV1beta1CreateWorkloadOperationMetadata
  ...
  if (buildCounterGoogleCloudAssuredworkloadsV1beta1CreateWorkloadOperationMetadata <
    ...
    o.displayName = 'foo';
    o.parent = 'foo';
    o.resourceSettings = buildUnnamed6136();
  }
  buildCounterGoogleCloudAssuredworkloadsV1beta1CreateWorkloadOperationMetadata--;
  return o;
}
...
void checkGoogleCloudAssuredworkloadsV1beta1CreateWorkloadOperationMetadata(
  ...
  if (buildCounterGoogleCloudAssuredworkloadsV1beta1CreateWorkloadOperationMetadata <
    ...
    checkUnnamed6136(o.resourceSettings!);
  }
  buildCounterGoogleCloudAssuredworkloadsV1beta1CreateWorkloadOperationMetadata--;
}
...
api.GoogleCloudAssuredworkloadsV1beta1Workload
  ...
  if (buildCounterGoogleCloudAssuredworkloadsV1beta1Workload < 3) {
    ...
    o.labels = buildUnnamed6137();
    o.name = 'foo';
    o.provisionedResourcesParent = 'foo';
    o.resourceSettings = buildUnnamed6138();
    o.resources = buildUnnamed6139();
  }
  buildCounterGoogleCloudAssuredworkloadsV1beta1Workload--;
  return o;
}
...
void checkGoogleCloudAssuredworkloadsV1beta1Workload(
  ...
  if (buildCounterGoogleCloudAssuredworkloadsV1beta1Workload < 3) {
    ...
    checkUnnamed6138(o.resourceSettings!);
    checkUnnamed6139(o.resources!);
  }
  buildCounterGoogleCloudAssuredworkloadsV1beta1Workload--;
}
...
core.List<api.GoogleLongrunningOperation> buildUnnamed6140() => [
      buildGoogleLongrunningOperation(),
      buildGoogleLongrunningOperation(),
    ];

void checkUnnamed6140(core.List<api.GoogleLongrunningOperation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed6142() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed6142(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
