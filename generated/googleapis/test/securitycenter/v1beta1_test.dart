...
import 'package:googleapis/securitycenter/v1beta1.dart' as api;
...
api.Asset buildAsset() {
  ...
  if (buildCounterAsset < 3) {
    ...
    o.securityMarks = buildGoogleCloudSecuritycenterV1beta1SecurityMarks();
    o.updateTime = 'foo';
  }
  buildCounterAsset--;
  return o;
...
void checkAsset(api.Asset o) {
  ...
  if (buildCounterAsset < 3) {
    ...
    checkGoogleCloudSecuritycenterV1beta1SecurityMarks(o.securityMarks!);
...
core.int buildCounterGoogleCloudSecuritycenterV1beta1Finding = 0;
api.GoogleCloudSecuritycenterV1beta1Finding
buildGoogleCloudSecuritycenterV1beta1Finding() {
  final o = api.GoogleCloudSecuritycenterV1beta1Finding();
  buildCounterGoogleCloudSecuritycenterV1beta1Finding++;
  if (buildCounterGoogleCloudSecuritycenterV1beta1Finding < 3) {
    o.category = 'foo';
    o.createTime = 'foo';
    o.eventTime = 'foo';
    o.externalUri = 'foo';
    ...
    o.resourceName = 'foo';
    o.securityMarks = buildGoogleCloudSecuritycenterV1beta1SecurityMarks();
    o.sourceProperties = buildUnnamed5();
    o.state = 'foo';
  }
  buildCounterGoogleCloudSecuritycenterV1beta1Finding--;
  return o;
...
void checkGoogleCloudSecuritycenterV1beta1Finding(
  api.GoogleCloudSecuritycenterV1beta1Finding o,
) {
  buildCounterGoogleCloudSecuritycenterV1beta1Finding++;
  if (buildCounterGoogleCloudSecuritycenterV1beta1Finding < 3) {
    ...
    checkGoogleCloudSecuritycenterV1beta1SecurityMarks(o.securityMarks!);
    checkUnnamed5(o.sourceProperties!);
...
core.int buildCounterGoogleCloudSecuritycenterV1beta1SecurityMarks = 0;
api.GoogleCloudSecuritycenterV1beta1SecurityMarks
buildGoogleCloudSecuritycenterV1beta1SecurityMarks() {
  final o = api.GoogleCloudSecuritycenterV1beta1SecurityMarks();
  buildCounterGoogleCloudSecuritycenterV1beta1SecurityMarks++;
  if (buildCounterGoogleCloudSecuritycenterV1beta1SecurityMarks < 3) {
    o.marks = buildUnnamed6();
    o.name = 'foo';
  }
  buildCounterGoogleCloudSecuritycenterV1beta1SecurityMarks--;
  return o;
...
void checkGoogleCloudSecuritycenterV1beta1SecurityMarks(
  api.GoogleCloudSecuritycenterV1beta1SecurityMarks o,
) {
  buildCounterGoogleCloudSecuritycenterV1beta1SecurityMarks++;
  if (buildCounterGoogleCloudSecuritycenterV1beta1SecurityMarks < 3) {
    checkUnnamed6(o.marks!);
    unittest.expect(o.name!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudSecuritycenterV1beta1SecurityMarks--;
}
...
core.List<api.GroupResult> buildUnnamed7() => [
  buildGroupResult(),
  buildGroupResult(),
];

void checkUnnamed7(core.List<api.GroupResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GroupAssetsResponse buildGroupAssetsResponse() {
  ...
  if (buildCounterGroupAssetsResponse < 3) {
    o.groupByResults = buildUnnamed7();
    o.nextPageToken = 'foo';
    o.readTime = 'foo';
  }
  buildCounterGroupAssetsResponse--;
...
void checkGroupAssetsResponse(api.GroupAssetsResponse o) {
  buildCounterGroupAssetsResponse++;
  if (buildCounterGroupAssetsResponse < 3) {
    checkUnnamed7(o.groupByResults!);
...
core.List<api.ListAssetsResult> buildUnnamed10() => [
  buildListAssetsResult(),
  buildListAssetsResult(),
];

void checkUnnamed10(core.List<api.ListAssetsResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListAssetsResponse buildListAssetsResponse() {
  ...
  if (buildCounterListAssetsResponse < 3) {
    o.listAssetsResults = buildUnnamed10();
    o.nextPageToken = 'foo';
    o.readTime = 'foo';
    o.totalSize = 42;
  }
...
void checkListAssetsResponse(api.ListAssetsResponse o) {
  buildCounterListAssetsResponse++;
  if (buildCounterListAssetsResponse < 3) {
    checkUnnamed10(o.listAssetsResults!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    unittest.expect(o.readTime!, unittest.equals('foo'));
...
core.List<api.GoogleCloudSecuritycenterV1beta1Finding> buildUnnamed11() => [
  buildGoogleCloudSecuritycenterV1beta1Finding(),
  buildGoogleCloudSecuritycenterV1beta1Finding(),
];

void checkUnnamed11(core.List<api.GoogleCloudSecuritycenterV1beta1Finding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudSecuritycenterV1beta1Finding(o[0]);
  checkGoogleCloudSecuritycenterV1beta1Finding(o[1]);
}
...
core.List<api.Source> buildUnnamed13() => [buildSource(), buildSource()];

void checkUnnamed13(core.List<api.Source> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSource(o[0]);
  checkSource(o[1]);
}
...
api.SecurityCenterProperties buildSecurityCenterProperties() {
  ...
  if (buildCounterSecurityCenterProperties < 3) {
    o.resourceName = 'foo';
    o.resourceOwners = buildUnnamed18();
...
void checkSecurityCenterProperties(api.SecurityCenterProperties o) {
  ...
  if (buildCounterSecurityCenterProperties < 3) {
    unittest.expect(o.resourceName!, unittest.equals('foo'));
    checkUnnamed18(o.resourceOwners!);
...
void main() {
  ...
  unittest.group('obj-schema-GoogleCloudSecuritycenterV1beta1Finding', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudSecuritycenterV1beta1Finding();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudSecuritycenterV1beta1Finding.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudSecuritycenterV1beta1Finding(od);
    });
  });

  unittest.group(
    'obj-schema-GoogleCloudSecuritycenterV1beta1SecurityMarks',
    () {
      unittest.test('to-json--from-json', () async {
        final o = buildGoogleCloudSecuritycenterV1beta1SecurityMarks();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudSecuritycenterV1beta1SecurityMarks.fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
        checkGoogleCloudSecuritycenterV1beta1SecurityMarks(od);
      });
    },
  );
  ...
  unittest.group('resource-OrganizationsAssetsResource', () {
    ...
    unittest.test('method--updateSecurityMarks', () async {
      final mock = HttpServerMock();
      final res = api.SecurityCommandCenterApi(mock).organizations.assets;
      final arg_request = buildGoogleCloudSecuritycenterV1beta1SecurityMarks();
      final arg_name = 'foo';
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          checkGoogleCloudSecuritycenterV1beta1SecurityMarks(obj);
      ...
      checkGoogleCloudSecuritycenterV1beta1SecurityMarks(
        response as api.GoogleCloudSecuritycenterV1beta1SecurityMarks,
      );
    });
  });
  ...
  unittest.group('resource-OrganizationsSourcesFindingsResource', () {
    unittest.test('method--create', () async {
      ...
      final arg_request = buildGoogleCloudSecuritycenterV1beta1Finding();
      final arg_parent = 'foo';
      final arg_findingId = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.GoogleCloudSecuritycenterV1beta1Finding.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkGoogleCloudSecuritycenterV1beta1Finding(obj);
      ...
      checkGoogleCloudSecuritycenterV1beta1Finding(
        response as api.GoogleCloudSecuritycenterV1beta1Finding,
      );
    });
