...
api.GenerateIdTokenRequest buildGenerateIdTokenRequest() {
  ...
  if (buildCounterGenerateIdTokenRequest < 3) {
    ...
    o.includeEmail = true;
    o.organizationNumberIncluded = true;
  }
  buildCounterGenerateIdTokenRequest--;
  return o;
}
...
void checkGenerateIdTokenRequest(api.GenerateIdTokenRequest o) {
  ...
  if (buildCounterGenerateIdTokenRequest < 3) {
    ...
    unittest.expect(o.organizationNumberIncluded!, unittest.isTrue);
  }
  buildCounterGenerateIdTokenRequest--;
}
...
void checkServiceAccountAllowedLocations(api.ServiceAccountAllowedLocations o) {
  buildCounterServiceAccountAllowedLocations++;
  if (buildCounterServiceAccountAllowedLocations < 3) {
    unittest.expect(o.encodedLocations!, unittest.equals('foo'));
...
core.int buildCounterWorkforcePoolAllowedLocations = 0;
api.WorkforcePoolAllowedLocations buildWorkforcePoolAllowedLocations() {
  final o = api.WorkforcePoolAllowedLocations();
  buildCounterWorkforcePoolAllowedLocations++;
  if (buildCounterWorkforcePoolAllowedLocations < 3) {
    o.encodedLocations = 'foo';
...
void checkWorkforcePoolAllowedLocations(api.WorkforcePoolAllowedLocations o) {
  buildCounterWorkforcePoolAllowedLocations++;
  if (buildCounterWorkforcePoolAllowedLocations < 3) {
    unittest.expect(o.encodedLocations!, unittest.equals('foo'));
...
core.int buildCounterWorkloadIdentityPoolAllowedLocations = 0;
api.WorkloadIdentityPoolAllowedLocations
buildWorkloadIdentityPoolAllowedLocations() {
  final o = api.WorkloadIdentityPoolAllowedLocations();
  buildCounterWorkloadIdentityPoolAllowedLocations++;
  if (buildCounterWorkloadIdentityPoolAllowedLocations < 3) {
    o.encodedLocations = 'foo';
...
void checkWorkloadIdentityPoolAllowedLocations(
  api.WorkloadIdentityPoolAllowedLocations o,
) {
  buildCounterWorkloadIdentityPoolAllowedLocations++;
  if (buildCounterWorkloadIdentityPoolAllowedLocations < 3) {
    unittest.expect(o.encodedLocations!, unittest.equals('foo'));
...
void main() {
  ...
  unittest.group('obj-schema-WorkforcePoolAllowedLocations', () {
    unittest.test('to-json--from-json', () async {
      final o = buildWorkforcePoolAllowedLocations();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.WorkforcePoolAllowedLocations.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkWorkforcePoolAllowedLocations(od);
    });
  });

  unittest.group('obj-schema-WorkloadIdentityPoolAllowedLocations', () {
    unittest.test('to-json--from-json', () async {
      final o = buildWorkloadIdentityPoolAllowedLocations();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.WorkloadIdentityPoolAllowedLocations.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkWorkloadIdentityPoolAllowedLocations(od);
    });
  });
  ...
  unittest.group('resource-LocationsWorkforcePoolsResource', () {
    unittest.test('method--getAllowedLocations', () async {
      ...
      final res = api.IAMCredentialsApi(mock).locations.workforcePools;
      final arg_name = 'foo';
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final resp = convert.json.encode(
            buildWorkforcePoolAllowedLocations(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.getAllowedLocations(
        arg_name,
        $fields: arg_$fields,
      );
      checkWorkforcePoolAllowedLocations(
        response as api.WorkforcePoolAllowedLocations,
      );
    });
  });
  ...
  unittest.group('resource-ProjectsLocationsWorkloadIdentityPoolsResource', () {
    unittest.test('method--getAllowedLocations', () async {
      ...
      checkWorkloadIdentityPoolAllowedLocations(
        response as api.WorkloadIdentityPoolAllowedLocations,
      );
    });
  });
  ...
  unittest.group('resource-ProjectsServiceAccountsResource', () {
    ...
    unittest.test('method--generateIdToken', () async {
      ...
      final response = await res.generateIdToken(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--getAllowedLocations', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildServiceAccountAllowedLocations(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
