...
core.List<api.Filter> buildUnnamed4616() => [
      buildFilter(),
      buildFilter(),
    ];

void checkUnnamed4616(core.List<api.Filter> o) {
...
core.List<api.ItemCountByStatus> buildUnnamed4618() => [
      buildItemCountByStatus(),
      buildItemCountByStatus(),
    ];

void checkUnnamed4618(core.List<api.ItemCountByStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.CustomerIndexStats buildCustomerIndexStats() {
  ...
  if (buildCounterCustomerIndexStats < 3) {
    o.date = buildDate();
    o.itemCountByStatus = buildUnnamed4618();
  }
  buildCounterCustomerIndexStats--;
  return o;
}
...
core.List<api.QueryCountByStatus> buildUnnamed4619() => [
      buildQueryCountByStatus(),
      buildQueryCountByStatus(),
    ];

void checkUnnamed4619(core.List<api.QueryCountByStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.CustomerQueryStats buildCustomerQueryStats() {
  ...
  if (buildCounterCustomerQueryStats < 3) {
    o.date = buildDate();
    o.queryCountByStatus = buildUnnamed4619();
  }
  buildCounterCustomerQueryStats--;
  return o;
}
...
core.List<api.GSuitePrincipal> buildUnnamed4621() => [
      buildGSuitePrincipal(),
      buildGSuitePrincipal(),
    ];

void checkUnnamed4621(core.List<api.GSuitePrincipal> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DataSource buildDataSource() {
  ...
  if (buildCounterDataSource < 3) {
    ...
    o.displayName = 'foo';
    o.indexingServiceAccounts = buildUnnamed4620();
    o.itemsVisibility = buildUnnamed4621();
    o.name = 'foo';
    o.operationIds = buildUnnamed4622();
    o.shortName = 'foo';
  }
  buildCounterDataSource--;
  return o;
...
void checkDataSource(api.DataSource o) {
  ...
  if (buildCounterDataSource < 3) {
    ...
    checkUnnamed4620(o.indexingServiceAccounts!);
    checkUnnamed4621(o.itemsVisibility!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed4622(o.operationIds!);
    unittest.expect(
      o.shortName!,
      unittest.equals('foo'),
    );
...
core.List<api.ItemCountByStatus> buildUnnamed4623() => [
      buildItemCountByStatus(),
      buildItemCountByStatus(),
    ];

void checkUnnamed4623(core.List<api.ItemCountByStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkItemCountByStatus(o[0]);
  checkItemCountByStatus(o[1]);
}
...
api.DataSourceIndexStats buildDataSourceIndexStats() {
  ...
  if (buildCounterDataSourceIndexStats < 3) {
    o.date = buildDate();
    o.itemCountByStatus = buildUnnamed4623();
  }
  buildCounterDataSourceIndexStats--;
  return o;
}
...
core.List<api.FilterOptions> buildUnnamed4624() => [
      buildFilterOptions(),
      buildFilterOptions(),
    ];

void checkUnnamed4624(core.List<api.FilterOptions> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DataSourceRestriction buildDataSourceRestriction() {
  ...
  if (buildCounterDataSourceRestriction < 3) {
    o.filterOptions = buildUnnamed4624();
...
core.List<api.Date> buildUnnamed4625() => [
      buildDate(),
      buildDate(),
    ];

void checkUnnamed4625(core.List<api.Date> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDate(o[0]);
  checkDate(o[1]);
}
...
core.List<core.double> buildUnnamed4626() => [
      42.0,
      42.0,
    ];

void checkUnnamed4626(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
...
core.List<api.EnumValuePair> buildUnnamed4627() => [
      buildEnumValuePair(),
      buildEnumValuePair(),
    ];

void checkUnnamed4627(core.List<api.EnumValuePair> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.EnumPropertyOptions buildEnumPropertyOptions() {
  ...
  if (buildCounterEnumPropertyOptions < 3) {
    ...
    o.possibleValues = buildUnnamed4627();
  }
  buildCounterEnumPropertyOptions--;
  return o;
}
...
void checkEnumPropertyOptions(api.EnumPropertyOptions o) {
  ...
  if (buildCounterEnumPropertyOptions < 3) {
    ...
    checkUnnamed4627(o.possibleValues!);
  }
  buildCounterEnumPropertyOptions--;
}
...
void checkEnumValues(api.EnumValues o) {
  buildCounterEnumValues++;
  if (buildCounterEnumValues < 3) {
    checkUnnamed4628(o.values!);
  }
  buildCounterEnumValues--;
}

core.List<api.ErrorMessage> buildUnnamed4629() => [
      buildErrorMessage(),
      buildErrorMessage(),
    ];

void checkUnnamed4629(core.List<api.ErrorMessage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ErrorInfo buildErrorInfo() {
  ...
  if (buildCounterErrorInfo < 3) {
    o.errorMessages = buildUnnamed4629();
  }
  buildCounterErrorInfo--;
  return o;
}
...
void checkErrorInfo(api.ErrorInfo o) {
  buildCounterErrorInfo++;
  if (buildCounterErrorInfo < 3) {
    checkUnnamed4629(o.errorMessages!);
  }
  buildCounterErrorInfo--;
}
...
core.List<api.FacetBucket> buildUnnamed4630() => [
      buildFacetBucket(),
      buildFacetBucket(),
    ];

void checkUnnamed4630(core.List<api.FacetBucket> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.CustomerIndexStats> buildUnnamed4631() => [
      buildCustomerIndexStats(),
      buildCustomerIndexStats(),
    ];

void checkUnnamed4631(core.List<api.CustomerIndexStats> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkGetCustomerIndexStatsResponse(api.GetCustomerIndexStatsResponse o) {
  buildCounterGetCustomerIndexStatsResponse++;
  if (buildCounterGetCustomerIndexStatsResponse < 3) {
    checkUnnamed4631(o.stats!);
  }
  buildCounterGetCustomerIndexStatsResponse--;
}

core.List<api.CustomerQueryStats> buildUnnamed4632() => [
      buildCustomerQueryStats(),
      buildCustomerQueryStats(),
    ];

void checkUnnamed4632(core.List<api.CustomerQueryStats> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkGetCustomerQueryStatsResponse(api.GetCustomerQueryStatsResponse o) {
  buildCounterGetCustomerQueryStatsResponse++;
  if (buildCounterGetCustomerQueryStatsResponse < 3) {
    checkUnnamed4632(o.stats!);
  }
  buildCounterGetCustomerQueryStatsResponse--;
}

core.List<api.CustomerSessionStats> buildUnnamed4633() => [
      buildCustomerSessionStats(),
      buildCustomerSessionStats(),
    ];

void checkUnnamed4633(core.List<api.CustomerSessionStats> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkGetCustomerSessionStatsResponse(
  ...
  buildCounterGetCustomerSessionStatsResponse++;
  if (buildCounterGetCustomerSessionStatsResponse < 3) {
    checkUnnamed4633(o.stats!);
  }
  buildCounterGetCustomerSessionStatsResponse--;
}

core.List<api.CustomerUserStats> buildUnnamed4634() => [
      buildCustomerUserStats(),
      buildCustomerUserStats(),
    ];

void checkUnnamed4634(core.List<api.CustomerUserStats> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkGetCustomerUserStatsResponse(api.GetCustomerUserStatsResponse o) {
  buildCounterGetCustomerUserStatsResponse++;
  if (buildCounterGetCustomerUserStatsResponse < 3) {
    checkUnnamed4634(o.stats!);
  }
  buildCounterGetCustomerUserStatsResponse--;
}

core.List<api.DataSourceIndexStats> buildUnnamed4635() => [
      buildDataSourceIndexStats(),
      buildDataSourceIndexStats(),
    ];

void checkUnnamed4635(core.List<api.DataSourceIndexStats> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkGetDataSourceIndexStatsResponse(
  ...
  buildCounterGetDataSourceIndexStatsResponse++;
  if (buildCounterGetDataSourceIndexStatsResponse < 3) {
    checkUnnamed4635(o.stats!);
  }
  buildCounterGetDataSourceIndexStatsResponse--;
}

core.List<api.SearchApplicationQueryStats> buildUnnamed4636() => [
      buildSearchApplicationQueryStats(),
      buildSearchApplicationQueryStats(),
    ];

void checkUnnamed4636(core.List<api.SearchApplicationQueryStats> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkGetSearchApplicationQueryStatsResponse(
  ...
  buildCounterGetSearchApplicationQueryStatsResponse++;
  if (buildCounterGetSearchApplicationQueryStatsResponse < 3) {
    checkUnnamed4636(o.stats!);
  }
  buildCounterGetSearchApplicationQueryStatsResponse--;
}

core.List<api.SearchApplicationSessionStats> buildUnnamed4637() => [
      buildSearchApplicationSessionStats(),
      buildSearchApplicationSessionStats(),
    ];

void checkUnnamed4637(core.List<api.SearchApplicationSessionStats> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkGetSearchApplicationSessionStatsResponse(
  ...
  buildCounterGetSearchApplicationSessionStatsResponse++;
  if (buildCounterGetSearchApplicationSessionStatsResponse < 3) {
    checkUnnamed4637(o.stats!);
  }
  buildCounterGetSearchApplicationSessionStatsResponse--;
}

core.List<api.SearchApplicationUserStats> buildUnnamed4638() => [
      buildSearchApplicationUserStats(),
      buildSearchApplicationUserStats(),
    ];

void checkUnnamed4638(core.List<api.SearchApplicationUserStats> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Principal> buildUnnamed4641() => [
      buildPrincipal(),
      buildPrincipal(),
    ];

void checkUnnamed4641(core.List<api.Principal> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPrincipal(o[0]);
  checkPrincipal(o[1]);
}

core.List<api.Principal> buildUnnamed4642() => [
      buildPrincipal(),
      buildPrincipal(),
    ];

void checkUnnamed4642(core.List<api.Principal> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPrincipal(o[0]);
  checkPrincipal(o[1]);
}

core.List<api.Principal> buildUnnamed4643() => [
      buildPrincipal(),
      buildPrincipal(),
    ];

void checkUnnamed4643(core.List<api.Principal> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPrincipal(o[0]);
  checkPrincipal(o[1]);
}
...
api.ItemAcl buildItemAcl() {
  ...
  if (buildCounterItemAcl < 3) {
    ...
    o.deniedReaders = buildUnnamed4641();
    o.inheritAclFrom = 'foo';
    o.owners = buildUnnamed4642();
    o.readers = buildUnnamed4643();
  }
  buildCounterItemAcl--;
  return o;
}
...
void checkItemAcl(api.ItemAcl o) {
  ...
  if (buildCounterItemAcl < 3) {
    ...
    checkUnnamed4641(o.deniedReaders!);
    unittest.expect(
      o.inheritAclFrom!,
      unittest.equals('foo'),
    );
    checkUnnamed4642(o.owners!);
    checkUnnamed4643(o.readers!);
  }
  buildCounterItemAcl--;
}
...
core.List<api.ContextAttribute> buildUnnamed4644() => [
      buildContextAttribute(),
      buildContextAttribute(),
    ];

void checkUnnamed4644(core.List<api.ContextAttribute> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContextAttribute(o[0]);
  checkContextAttribute(o[1]);
}

core.List<api.Interaction> buildUnnamed4645() => [
      buildInteraction(),
      buildInteraction(),
    ];

void checkUnnamed4645(core.List<api.Interaction> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ItemMetadata buildItemMetadata() {
  ...
  if (buildCounterItemMetadata < 3) {
    ...
    o.contextAttributes = buildUnnamed4644();
    o.createTime = 'foo';
    o.hash = 'foo';
    o.interactions = buildUnnamed4645();
    o.keywords = buildUnnamed4646();
    o.mimeType = 'foo';
    o.objectType = 'foo';
...
void checkItemMetadata(api.ItemMetadata o) {
  ...
  if (buildCounterItemMetadata < 3) {
    ...
    checkUnnamed4644(o.contextAttributes!);
    unittest.expect(
      o.createTime!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed4645(o.interactions!);
    checkUnnamed4646(o.keywords!);
    unittest.expect(
      o.mimeType!,
      unittest.equals('foo'),
    );
...
core.List<api.ProcessingError> buildUnnamed4647() => [
      buildProcessingError(),
      buildProcessingError(),
    ];

void checkUnnamed4647(core.List<api.ProcessingError> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProcessingError(o[0]);
  checkProcessingError(o[1]);
}

core.List<api.RepositoryError> buildUnnamed4648() => [
      buildRepositoryError(),
      buildRepositoryError(),
    ];

void checkUnnamed4648(core.List<api.RepositoryError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ItemStatus buildItemStatus() {
  ...
  if (buildCounterItemStatus < 3) {
    o.code = 'foo';
    o.processingErrors = buildUnnamed4647();
    o.repositoryErrors = buildUnnamed4648();
  }
  buildCounterItemStatus--;
  return o;
}
...
void checkItemStatus(api.ItemStatus o) {
  ...
  if (buildCounterItemStatus < 3) {
    ...
    checkUnnamed4647(o.processingErrors!);
    checkUnnamed4648(o.repositoryErrors!);
  }
  buildCounterItemStatus--;
}
...
core.List<api.DataSource> buildUnnamed4649() => [
      buildDataSource(),
      buildDataSource(),
    ];

void checkUnnamed4649(core.List<api.DataSource> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataSource(o[0]);
  checkDataSource(o[1]);
}
...
core.List<api.Item> buildUnnamed4651() => [
      buildItem(),
      buildItem(),
    ];

void checkUnnamed4651(core.List<api.Item> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkItem(o[0]);
  checkItem(o[1]);
}
...
core.List<api.Operation> buildUnnamed4652() => [
      buildOperation(),
      buildOperation(),
    ];

void checkUnnamed4652(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
void checkListOperationsResponse(api.ListOperationsResponse o) {
  ...
  if (buildCounterListOperationsResponse < 3) {
    ...
    checkUnnamed4652(o.operations!);
  }
  buildCounterListOperationsResponse--;
}

core.List<api.QuerySource> buildUnnamed4653() => [
      buildQuerySource(),
      buildQuerySource(),
    ];

void checkUnnamed4653(core.List<api.QuerySource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.SearchApplication> buildUnnamed4654() => [
      buildSearchApplication(),
      buildSearchApplication(),
    ];

void checkUnnamed4654(core.List<api.SearchApplication> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListSearchApplicationsResponse buildListSearchApplicationsResponse() {
  ...
  if (buildCounterListSearchApplicationsResponse < 3) {
    o.nextPageToken = 'foo';
    o.searchApplications = buildUnnamed4654();
  }
  buildCounterListSearchApplicationsResponse--;
  return o;
}
...
void checkListSearchApplicationsResponse(api.ListSearchApplicationsResponse o) {
  ...
  if (buildCounterListSearchApplicationsResponse < 3) {
    ...
    checkUnnamed4654(o.searchApplications!);
  }
  buildCounterListSearchApplicationsResponse--;
}

core.List<api.UnmappedIdentity> buildUnnamed4655() => [
      buildUnmappedIdentity(),
      buildUnmappedIdentity(),
    ];

void checkUnnamed4655(core.List<api.UnmappedIdentity> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListUnmappedIdentitiesResponse buildListUnmappedIdentitiesResponse() {
  ...
  if (buildCounterListUnmappedIdentitiesResponse < 3) {
    o.nextPageToken = 'foo';
    o.unmappedIdentities = buildUnnamed4655();
  }
  buildCounterListUnmappedIdentitiesResponse--;
  return o;
}
...
void checkListUnmappedIdentitiesResponse(api.ListUnmappedIdentitiesResponse o) {
  ...
  if (buildCounterListUnmappedIdentitiesResponse < 3) {
    ...
    checkUnnamed4655(o.unmappedIdentities!);
  }
  buildCounterListUnmappedIdentitiesResponse--;
}
...
core.List<api.NamedProperty> buildUnnamed4656() => [
      buildNamedProperty(),
      buildNamedProperty(),
    ];

void checkUnnamed4656(core.List<api.NamedProperty> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.DisplayedProperty> buildUnnamed4657() => [
      buildDisplayedProperty(),
      buildDisplayedProperty(),
    ];

void checkUnnamed4657(core.List<api.DisplayedProperty> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.PropertyDefinition> buildUnnamed4658() => [
      buildPropertyDefinition(),
      buildPropertyDefinition(),
    ];

void checkUnnamed4658(core.List<api.PropertyDefinition> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ObjectDefinition buildObjectDefinition() {
  ...
  if (buildCounterObjectDefinition < 3) {
    ...
    o.propertyDefinitions = buildUnnamed4658();
  }
  buildCounterObjectDefinition--;
  return o;
}
...
void checkObjectDefinition(api.ObjectDefinition o) {
  ...
  if (buildCounterObjectDefinition < 3) {
    ...
    checkUnnamed4658(o.propertyDefinitions!);
  }
  buildCounterObjectDefinition--;
}

core.List<api.Metaline> buildUnnamed4659() => [
      buildMetaline(),
      buildMetaline(),
    ];

void checkUnnamed4659(core.List<api.Metaline> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetaline(o[0]);
  checkMetaline(o[1]);
}
...
core.List<api.PropertyDefinition> buildUnnamed4660() => [
      buildPropertyDefinition(),
      buildPropertyDefinition(),
    ];

void checkUnnamed4660(core.List<api.PropertyDefinition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPropertyDefinition(o[0]);
  checkPropertyDefinition(o[1]);
}
...
void checkObjectPropertyOptions(api.ObjectPropertyOptions o) {
  buildCounterObjectPropertyOptions++;
  if (buildCounterObjectPropertyOptions < 3) {
    checkUnnamed4660(o.subobjectProperties!);
  }
  buildCounterObjectPropertyOptions--;
}

core.List<api.StructuredDataObject> buildUnnamed4661() => [
      buildStructuredDataObject(),
      buildStructuredDataObject(),
    ];

void checkUnnamed4661(core.List<api.StructuredDataObject> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkObjectValues(api.ObjectValues o) {
  buildCounterObjectValues++;
  if (buildCounterObjectValues < 3) {
    checkUnnamed4661(o.values!);
  }
  buildCounterObjectValues--;
}

core.Map<core.String, core.Object> buildUnnamed4662() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed4662(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed4662();
    o.name = 'foo';
    o.response = buildUnnamed4663();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error!);
    checkUnnamed4662(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed4663(o.response!);
  }
  buildCounterOperation--;
}
...
core.List<api.EmailAddress> buildUnnamed4664() => [
      buildEmailAddress(),
      buildEmailAddress(),
    ];

void checkUnnamed4664(core.List<api.EmailAddress> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEmailAddress(o[0]);
  checkEmailAddress(o[1]);
}

core.List<api.Name> buildUnnamed4665() => [
      buildName(),
      buildName(),
    ];

void checkUnnamed4665(core.List<api.Name> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkName(o[0]);
  checkName(o[1]);
}

core.List<api.Photo> buildUnnamed4666() => [
      buildPhoto(),
      buildPhoto(),
    ];

void checkUnnamed4666(core.List<api.Photo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPhoto(o[0]);
  checkPhoto(o[1]);
}
...
api.Person buildPerson() {
  ...
  if (buildCounterPerson < 3) {
    o.emailAddresses = buildUnnamed4664();
    o.name = 'foo';
    o.obfuscatedId = 'foo';
    o.personNames = buildUnnamed4665();
    o.photos = buildUnnamed4666();
  }
  buildCounterPerson--;
  return o;
}
...
void checkPerson(api.Person o) {
  buildCounterPerson++;
  if (buildCounterPerson < 3) {
    checkUnnamed4664(o.emailAddresses!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed4665(o.personNames!);
    checkUnnamed4666(o.photos!);
  }
  buildCounterPerson--;
}
...
api.PollItemsRequest buildPollItemsRequest() {
  ...
  if (buildCounterPollItemsRequest < 3) {
    ...
    o.limit = 42;
    o.queue = 'foo';
    o.statusCodes = buildUnnamed4667();
  }
  buildCounterPollItemsRequest--;
  return o;
}
...
void checkPollItemsRequest(api.PollItemsRequest o) {
  ...
  if (buildCounterPollItemsRequest < 3) {
    ...
    checkUnnamed4667(o.statusCodes!);
  }
  buildCounterPollItemsRequest--;
}

core.List<api.Item> buildUnnamed4668() => [
      buildItem(),
      buildItem(),
    ];

void checkUnnamed4668(core.List<api.Item> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkItem(o[0]);
  checkItem(o[1]);
}
...
core.List<api.FieldViolation> buildUnnamed4669() => [
      buildFieldViolation(),
      buildFieldViolation(),
    ];

void checkUnnamed4669(core.List<api.FieldViolation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ProcessingError buildProcessingError() {
  ...
  if (buildCounterProcessingError < 3) {
    o.code = 'foo';
    o.errorMessage = 'foo';
    o.fieldViolations = buildUnnamed4669();
  }
  buildCounterProcessingError--;
  return o;
}
...
void checkProcessingError(api.ProcessingError o) {
  ...
  if (buildCounterProcessingError < 3) {
    ...
    checkUnnamed4669(o.fieldViolations!);
  }
  buildCounterProcessingError--;
}
...
core.List<api.QueryOperator> buildUnnamed4671() => [
      buildQueryOperator(),
      buildQueryOperator(),
    ];

void checkUnnamed4671(core.List<api.QueryOperator> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.SourceResultCount> buildUnnamed4672() => [
      buildSourceResultCount(),
      buildSourceResultCount(),
    ];

void checkUnnamed4672(core.List<api.SourceResultCount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ResultCounts buildResultCounts() {
  ...
  if (buildCounterResultCounts < 3) {
    o.sourceResultCounts = buildUnnamed4672();
  }
  buildCounterResultCounts--;
  return o;
}
...
void checkResultCounts(api.ResultCounts o) {
  buildCounterResultCounts++;
  if (buildCounterResultCounts < 3) {
    checkUnnamed4672(o.sourceResultCounts!);
  }
  buildCounterResultCounts--;
}
...
core.List<api.ResultDisplayField> buildUnnamed4673() => [
      buildResultDisplayField(),
      buildResultDisplayField(),
    ];

void checkUnnamed4673(core.List<api.ResultDisplayField> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ResultDisplayLine> buildUnnamed4674() => [
      buildResultDisplayLine(),
      buildResultDisplayLine(),
    ];

void checkUnnamed4674(core.List<api.ResultDisplayLine> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ObjectDefinition> buildUnnamed4675() => [
      buildObjectDefinition(),
      buildObjectDefinition(),
    ];

void checkUnnamed4675(core.List<api.ObjectDefinition> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Schema buildSchema() {
  ...
  if (buildCounterSchema < 3) {
    o.objectDefinitions = buildUnnamed4675();
    o.operationIds = buildUnnamed4676();
  }
  buildCounterSchema--;
  return o;
}
...
void checkSchema(api.Schema o) {
  buildCounterSchema++;
  if (buildCounterSchema < 3) {
    checkUnnamed4675(o.objectDefinitions!);
    checkUnnamed4676(o.operationIds!);
  }
  buildCounterSchema--;
}
...
core.List<api.DataSourceRestriction> buildUnnamed4677() => [
      buildDataSourceRestriction(),
      buildDataSourceRestriction(),
    ];

void checkUnnamed4677(core.List<api.DataSourceRestriction> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataSourceRestriction(o[0]);
  checkDataSourceRestriction(o[1]);
}

core.List<api.FacetOptions> buildUnnamed4678() => [
      buildFacetOptions(),
      buildFacetOptions(),
    ];

void checkUnnamed4678(core.List<api.FacetOptions> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.SourceConfig> buildUnnamed4680() => [
      buildSourceConfig(),
      buildSourceConfig(),
    ];

void checkUnnamed4680(core.List<api.SourceConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkSearchApplication(api.SearchApplication o) {
  buildCounterSearchApplication++;
  if (buildCounterSearchApplication < 3) {
    checkUnnamed4677(o.dataSourceRestrictions!);
    checkUnnamed4678(o.defaultFacetOptions!);
    ...
    checkUnnamed4679(o.operationIds!);
    checkQueryInterpretationConfig(o.queryInterpretationConfig!);
    checkScoringConfig(o.scoringConfig!);
    checkUnnamed4680(o.sourceConfig!);
  }
  buildCounterSearchApplication--;
}

core.List<api.QueryCountByStatus> buildUnnamed4681() => [
      buildQueryCountByStatus(),
      buildQueryCountByStatus(),
    ];

void checkUnnamed4681(core.List<api.QueryCountByStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQueryCountByStatus(o[0]);
  checkQueryCountByStatus(o[1]);
}
...
api.SearchApplicationQueryStats buildSearchApplicationQueryStats() {
  ...
  if (buildCounterSearchApplicationQueryStats < 3) {
    o.date = buildDate();
    o.queryCountByStatus = buildUnnamed4681();
  }
  buildCounterSearchApplicationQueryStats--;
  return o;
}
...
void checkSearchApplicationQueryStats(api.SearchApplicationQueryStats o) {
  ...
  if (buildCounterSearchApplicationQueryStats < 3) {
    checkDate(o.date!);
    checkUnnamed4681(o.queryCountByStatus!);
  }
  buildCounterSearchApplicationQueryStats--;
}
...
core.List<api.Item> buildUnnamed4682() => [
      buildItem(),
      buildItem(),
    ];

void checkUnnamed4682(core.List<api.Item> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkItem(o[0]);
  checkItem(o[1]);
}
...
core.List<api.ContextAttribute> buildUnnamed4683() => [
      buildContextAttribute(),
      buildContextAttribute(),
    ];

void checkUnnamed4683(core.List<api.ContextAttribute> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContextAttribute(o[0]);
  checkContextAttribute(o[1]);
}

core.List<api.DataSourceRestriction> buildUnnamed4684() => [
      buildDataSourceRestriction(),
      buildDataSourceRestriction(),
    ];

void checkUnnamed4684(core.List<api.DataSourceRestriction> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataSourceRestriction(o[0]);
  checkDataSourceRestriction(o[1]);
}

core.List<api.FacetOptions> buildUnnamed4685() => [
      buildFacetOptions(),
      buildFacetOptions(),
    ];

void checkUnnamed4685(core.List<api.FacetOptions> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFacetOptions(o[0]);
  checkFacetOptions(o[1]);
}
...
api.SearchRequest buildSearchRequest() {
  ...
  if (buildCounterSearchRequest < 3) {
    o.contextAttributes = buildUnnamed4683();
    o.dataSourceRestrictions = buildUnnamed4684();
    o.facetOptions = buildUnnamed4685();
    o.pageSize = 42;
    o.query = 'foo';
...
void checkSearchRequest(api.SearchRequest o) {
  buildCounterSearchRequest++;
  if (buildCounterSearchRequest < 3) {
    checkUnnamed4683(o.contextAttributes!);
    checkUnnamed4684(o.dataSourceRestrictions!);
    checkUnnamed4685(o.facetOptions!);
    unittest.expect(
      o.pageSize!,
      unittest.equals(42),
    );
...
core.List<api.FacetResult> buildUnnamed4686() => [
      buildFacetResult(),
      buildFacetResult(),
    ];

void checkUnnamed4686(core.List<api.FacetResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFacetResult(o[0]);
  checkFacetResult(o[1]);
}

core.List<api.SearchResult> buildUnnamed4687() => [
      buildSearchResult(),
      buildSearchResult(),
    ];

void checkUnnamed4687(core.List<api.SearchResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSearchResult(o[0]);
  checkSearchResult(o[1]);
}

core.List<api.SpellResult> buildUnnamed4688() => [
      buildSpellResult(),
      buildSpellResult(),
    ];

void checkUnnamed4688(core.List<api.SpellResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSpellResult(o[0]);
  checkSpellResult(o[1]);
}

core.List<api.StructuredResult> buildUnnamed4689() => [
      buildStructuredResult(),
      buildStructuredResult(),
    ];

void checkUnnamed4689(core.List<api.StructuredResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SearchResponse buildSearchResponse() {
  ...
  if (buildCounterSearchResponse < 3) {
    ...
    o.facetResults = buildUnnamed4686();
    ...
    o.results = buildUnnamed4687();
    o.spellResults = buildUnnamed4688();
    o.structuredResults = buildUnnamed4689();
  }
  buildCounterSearchResponse--;
  return o;
}
...
void checkSearchResponse(api.SearchResponse o) {
  ...
  if (buildCounterSearchResponse < 3) {
    ...
    checkUnnamed4686(o.facetResults!);
    ...
    checkUnnamed4687(o.results!);
    checkUnnamed4688(o.spellResults!);
    checkUnnamed4689(o.structuredResults!);
  }
  buildCounterSearchResponse--;
}

core.List<api.SearchResult> buildUnnamed4690() => [
      buildSearchResult(),
      buildSearchResult(),
    ];

void checkUnnamed4690(core.List<api.SearchResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSearchResult(o[0]);
  checkSearchResult(o[1]);
}
...
api.SearchResult buildSearchResult() {
  ...
  if (buildCounterSearchResult < 3) {
    o.clusteredResults = buildUnnamed4690();
...
void checkSearchResult(api.SearchResult o) {
  buildCounterSearchResult++;
  if (buildCounterSearchResult < 3) {
    checkUnnamed4690(o.clusteredResults!);
...
core.List<api.MatchRange> buildUnnamed4691() => [
      buildMatchRange(),
      buildMatchRange(),
    ];

void checkUnnamed4691(core.List<api.MatchRange> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMatchRange(o[0]);
  checkMatchRange(o[1]);
}
...
api.Snippet buildSnippet() {
  ...
  if (buildCounterSnippet < 3) {
    o.matchRanges = buildUnnamed4691();
    o.snippet = 'foo';
  }
  buildCounterSnippet--;
  return o;
...
void checkSnippet(api.Snippet o) {
  buildCounterSnippet++;
  if (buildCounterSnippet < 3) {
    checkUnnamed4691(o.matchRanges!);
    unittest.expect(
      o.snippet!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.Object> buildUnnamed4692() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed4692(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed4693() => [
      buildUnnamed4692(),
      buildUnnamed4692(),
    ];

void checkUnnamed4693(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.NamedProperty> buildUnnamed4694() => [
      buildNamedProperty(),
      buildNamedProperty(),
    ];

void checkUnnamed4694(core.List<api.NamedProperty> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNamedProperty(o[0]);
  checkNamedProperty(o[1]);
}
...
core.List<api.DataSourceRestriction> buildUnnamed4695() => [
      buildDataSourceRestriction(),
      buildDataSourceRestriction(),
    ];

void checkUnnamed4695(core.List<api.DataSourceRestriction> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataSourceRestriction(o[0]);
  checkDataSourceRestriction(o[1]);
}
...
api.SuggestRequest buildSuggestRequest() {
  ...
  if (buildCounterSuggestRequest < 3) {
    o.dataSourceRestrictions = buildUnnamed4695();
    o.query = 'foo';
    o.requestOptions = buildRequestOptions();
  }
  buildCounterSuggestRequest--;
...
void checkSuggestRequest(api.SuggestRequest o) {
  buildCounterSuggestRequest++;
  if (buildCounterSuggestRequest < 3) {
    checkUnnamed4695(o.dataSourceRestrictions!);
    unittest.expect(
      o.query!,
      unittest.equals('foo'),
    );
...
core.List<api.SuggestResult> buildUnnamed4696() => [
      buildSuggestResult(),
      buildSuggestResult(),
    ];

void checkUnnamed4696(core.List<api.SuggestResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SuggestResponse buildSuggestResponse() {
  ...
  if (buildCounterSuggestResponse < 3) {
    o.suggestResults = buildUnnamed4696();
  }
  buildCounterSuggestResponse--;
  return o;
}
