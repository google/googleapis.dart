...
checkUnnamed1025(core.Map<core.String, core.Object> o) {
...
checkUnnamed1027(core.List<api.AgentOtherDeviceId> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildDevice() {
  ...
  if (buildCounterDevice < 3) {
    o.attributes = buildUnnamed1025();
    o.customData = buildUnnamed1026();
    o.deviceInfo = buildDeviceInfo();
    o.id = "foo";
    o.name = buildDeviceNames();
    o.notificationSupportedByAgent = true;
    o.otherDeviceIds = buildUnnamed1027();
    o.roomHint = "foo";
    o.structureHint = "foo";
    o.traits = buildUnnamed1028();
    o.type = "foo";
...
buildDeviceNames() {
  ...
  if (buildCounterDeviceNames < 3) {
    o.defaultNames = buildUnnamed1029();
    o.name = "foo";
    o.nicknames = buildUnnamed1030();
  }
  buildCounterDeviceNames--;
  return o;
}
...
checkDeviceNames(api.DeviceNames o) {
  buildCounterDeviceNames++;
  if (buildCounterDeviceNames < 3) {
    checkUnnamed1029(o.defaultNames);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed1030(o.nicknames);
  }
  buildCounterDeviceNames--;
}
...
checkUnnamed1031(core.List<api.QueryRequestInput> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1032(core.List<api.AgentDeviceId> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed1034() {
  ...
  o["x"] = buildUnnamed1033();
  o["y"] = buildUnnamed1033();
  return o;
}

checkUnnamed1034(core.Map<core.String, core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1033(o["x"]);
  checkUnnamed1033(o["y"]);
}
...
checkUnnamed1035(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1036(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildReportStateAndNotificationDevice() {
  ...
  if (buildCounterReportStateAndNotificationDevice < 3) {
    o.notifications = buildUnnamed1035();
    o.states = buildUnnamed1036();
  }
  buildCounterReportStateAndNotificationDevice--;
  return o;
}
...
checkReportStateAndNotificationDevice(api.ReportStateAndNotificationDevice o) {
  buildCounterReportStateAndNotificationDevice++;
  if (buildCounterReportStateAndNotificationDevice < 3) {
    checkUnnamed1035(o.notifications);
    checkUnnamed1036(o.states);
  }
  buildCounterReportStateAndNotificationDevice--;
}
...
checkUnnamed1037(core.List<api.Device> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDevice(o[0]);
  checkDevice(o[1]);
}
