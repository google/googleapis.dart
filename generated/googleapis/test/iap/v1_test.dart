...
core.List<api.Brand> buildUnnamed5() => [
      buildBrand(),
      buildBrand(),
    ];
...
api.TagsPartialState buildTagsPartialState() {
  ...
  if (buildCounterTagsPartialState < 3) {
    o.tagKeysToRemove = buildUnnamed15();
    o.tagsToUpsert = buildUnnamed16();
  }
  buildCounterTagsPartialState--;
  return o;
}
...
void checkTagsPartialState(api.TagsPartialState o) {
  buildCounterTagsPartialState++;
  if (buildCounterTagsPartialState < 3) {
    checkUnnamed15(o.tagKeysToRemove!);
    checkUnnamed16(o.tagsToUpsert!);
  }
  buildCounterTagsPartialState--;
}
...
api.TunnelDestGroup buildTunnelDestGroup() {
  ...
  if (buildCounterTunnelDestGroup < 3) {
    o.cidrs = buildUnnamed19();
    o.fqdns = buildUnnamed20();
    o.name = 'foo';
  }
  buildCounterTunnelDestGroup--;
  return o;
...
void checkTunnelDestGroup(api.TunnelDestGroup o) {
  buildCounterTunnelDestGroup++;
  if (buildCounterTunnelDestGroup < 3) {
    checkUnnamed19(o.cidrs!);
    checkUnnamed20(o.fqdns!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
api.WorkforceIdentitySettings buildWorkforceIdentitySettings() {
  ...
  if (buildCounterWorkforceIdentitySettings < 3) {
    ...
    o.workforcePools = buildUnnamed21();
  }
  buildCounterWorkforceIdentitySettings--;
  return o;
}
...
void checkWorkforceIdentitySettings(api.WorkforceIdentitySettings o) {
  ...
  if (buildCounterWorkforceIdentitySettings < 3) {
    ...
    checkUnnamed21(o.workforcePools!);
  }
  buildCounterWorkforceIdentitySettings--;
}
...
void main() {
  ...
  unittest.group('obj-schema-OAuth2', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od =
          api.OAuth2.fromJson(oJson as core.Map<core.String, core.dynamic>);
      checkOAuth2(od);
    });
  });
  ...
  unittest.group('resource-V1Resource', () {
    ...
    unittest.test('method--validateAttributeExpression', () async {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        final resp =
            convert.json.encode(buildValidateIapAttributeExpressionResponse());
        return async.Future.value(stringResponse(200, h, resp));
      }), true);
      final response = await res.validateAttributeExpression(arg_name,
          expression: arg_expression, $fields: arg_$fields);
