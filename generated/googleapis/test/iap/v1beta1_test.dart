...
import 'package:googleapis/iap/v1beta1.dart' as api;
...
core.List<api.Binding> buildUnnamed1() => [buildBinding(), buildBinding()];

void checkUnnamed1(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
void main() {
  ...
  unittest.group('resource-V1beta1Resource', () {
    unittest.test('method--getIamPolicy', () async {
      ...
      final res = api.CloudIAPApi(mock).v1beta1;
