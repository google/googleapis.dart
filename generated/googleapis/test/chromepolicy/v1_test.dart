...
core.List<api.GoogleChromePolicyV1PolicySchema> buildUnnamed5643() => [
      buildGoogleChromePolicyV1PolicySchema(),
      buildGoogleChromePolicyV1PolicySchema(),
    ];

void checkUnnamed5643(core.List<api.GoogleChromePolicyV1PolicySchema> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleChromePolicyV1ListPolicySchemasResponse
  ...
  if (buildCounterGoogleChromePolicyV1ListPolicySchemasResponse < 3) {
    o.nextPageToken = 'foo';
    o.policySchemas = buildUnnamed5643();
  }
  buildCounterGoogleChromePolicyV1ListPolicySchemasResponse--;
  return o;
}
...
void checkGoogleChromePolicyV1ListPolicySchemasResponse(
  ...
  if (buildCounterGoogleChromePolicyV1ListPolicySchemasResponse < 3) {
    ...
    checkUnnamed5643(o.policySchemas!);
  }
  buildCounterGoogleChromePolicyV1ListPolicySchemasResponse--;
}
...
core.List<api.GoogleChromePolicyV1AdditionalTargetKeyName> buildUnnamed5645() =>
    [
      buildGoogleChromePolicyV1AdditionalTargetKeyName(),
      buildGoogleChromePolicyV1AdditionalTargetKeyName(),
    ];
...
api.GoogleChromePolicyV1PolicySchema buildGoogleChromePolicyV1PolicySchema() {
  ...
  if (buildCounterGoogleChromePolicyV1PolicySchema < 3) {
    o.accessRestrictions = buildUnnamed5644();
    o.additionalTargetKeyNames = buildUnnamed5645();
    o.definition = buildProto2FileDescriptorProto();
    o.fieldDescriptions = buildUnnamed5646();
    o.name = 'foo';
    o.notices = buildUnnamed5647();
...
void checkGoogleChromePolicyV1PolicySchema(
  ...
  buildCounterGoogleChromePolicyV1PolicySchema++;
  if (buildCounterGoogleChromePolicyV1PolicySchema < 3) {
    checkUnnamed5644(o.accessRestrictions!);
    checkUnnamed5645(o.additionalTargetKeyNames!);
    checkProto2FileDescriptorProto(o.definition!);
    checkUnnamed5646(o.fieldDescriptions!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed5647(o.notices!);
    unittest.expect(
      o.policyDescription!,
      unittest.equals('foo'),
    );
...
api.GoogleChromePolicyV1PolicySchemaFieldDescription
  ...
  if (buildCounterGoogleChromePolicyV1PolicySchemaFieldDescription < 3) {
    ...
    o.knownValueDescriptions = buildUnnamed5648();
    o.nestedFieldDescriptions = buildUnnamed5649();
  }
  buildCounterGoogleChromePolicyV1PolicySchemaFieldDescription--;
  return o;
}
...
void checkGoogleChromePolicyV1PolicySchemaFieldDescription(
  ...
  if (buildCounterGoogleChromePolicyV1PolicySchemaFieldDescription < 3) {
    ...
    checkUnnamed5648(o.knownValueDescriptions!);
    checkUnnamed5649(o.nestedFieldDescriptions!);
  }
  buildCounterGoogleChromePolicyV1PolicySchemaFieldDescription--;
}
...
api.GoogleChromePolicyV1PolicyTargetKey
  ...
  if (buildCounterGoogleChromePolicyV1PolicyTargetKey < 3) {
    o.additionalTargetKeys = buildUnnamed5650();
...
void checkGoogleChromePolicyV1PolicyTargetKey(
  ...
  buildCounterGoogleChromePolicyV1PolicyTargetKey++;
  if (buildCounterGoogleChromePolicyV1PolicyTargetKey < 3) {
    checkUnnamed5650(o.additionalTargetKeys!);
    unittest.expect(
      o.targetResource!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.Object> buildUnnamed5651() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed5651(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleChromePolicyV1ResolvedPolicy> buildUnnamed5652() => [
      buildGoogleChromePolicyV1ResolvedPolicy(),
      buildGoogleChromePolicyV1ResolvedPolicy(),
    ];

void checkUnnamed5652(core.List<api.GoogleChromePolicyV1ResolvedPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleChromePolicyV1ResolveResponse
  ...
  if (buildCounterGoogleChromePolicyV1ResolveResponse < 3) {
    o.nextPageToken = 'foo';
    o.resolvedPolicies = buildUnnamed5652();
  }
  buildCounterGoogleChromePolicyV1ResolveResponse--;
  return o;
}
...
void checkGoogleChromePolicyV1ResolveResponse(
  ...
  if (buildCounterGoogleChromePolicyV1ResolveResponse < 3) {
    ...
    checkUnnamed5652(o.resolvedPolicies!);
  }
  buildCounterGoogleChromePolicyV1ResolveResponse--;
}
...
core.List<api.Proto2EnumDescriptorProto> buildUnnamed5653() => [
      buildProto2EnumDescriptorProto(),
      buildProto2EnumDescriptorProto(),
    ];

void checkUnnamed5653(core.List<api.Proto2EnumDescriptorProto> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProto2EnumDescriptorProto(o[0]);
  checkProto2EnumDescriptorProto(o[1]);
}

core.List<api.Proto2FieldDescriptorProto> buildUnnamed5654() => [
      buildProto2FieldDescriptorProto(),
      buildProto2FieldDescriptorProto(),
    ];

void checkUnnamed5654(core.List<api.Proto2FieldDescriptorProto> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProto2FieldDescriptorProto(o[0]);
  checkProto2FieldDescriptorProto(o[1]);
}

core.List<api.Proto2DescriptorProto> buildUnnamed5655() => [
      buildProto2DescriptorProto(),
      buildProto2DescriptorProto(),
    ];

void checkUnnamed5655(core.List<api.Proto2DescriptorProto> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProto2DescriptorProto(o[0]);
  checkProto2DescriptorProto(o[1]);
}

core.List<api.Proto2OneofDescriptorProto> buildUnnamed5656() => [
      buildProto2OneofDescriptorProto(),
      buildProto2OneofDescriptorProto(),
    ];

void checkUnnamed5656(core.List<api.Proto2OneofDescriptorProto> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Proto2DescriptorProto buildProto2DescriptorProto() {
  ...
  if (buildCounterProto2DescriptorProto < 3) {
    o.enumType = buildUnnamed5653();
    o.field = buildUnnamed5654();
    o.name = 'foo';
    o.nestedType = buildUnnamed5655();
    o.oneofDecl = buildUnnamed5656();
  }
  buildCounterProto2DescriptorProto--;
  return o;
}
...
void checkProto2DescriptorProto(api.Proto2DescriptorProto o) {
  buildCounterProto2DescriptorProto++;
  if (buildCounterProto2DescriptorProto < 3) {
    checkUnnamed5653(o.enumType!);
    checkUnnamed5654(o.field!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed5655(o.nestedType!);
    checkUnnamed5656(o.oneofDecl!);
  }
  buildCounterProto2DescriptorProto--;
}

core.List<api.Proto2EnumValueDescriptorProto> buildUnnamed5657() => [
      buildProto2EnumValueDescriptorProto(),
      buildProto2EnumValueDescriptorProto(),
    ];

void checkUnnamed5657(core.List<api.Proto2EnumValueDescriptorProto> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Proto2EnumDescriptorProto> buildUnnamed5658() => [
      buildProto2EnumDescriptorProto(),
      buildProto2EnumDescriptorProto(),
    ];

void checkUnnamed5658(core.List<api.Proto2EnumDescriptorProto> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProto2EnumDescriptorProto(o[0]);
  checkProto2EnumDescriptorProto(o[1]);
}

core.List<api.Proto2DescriptorProto> buildUnnamed5659() => [
      buildProto2DescriptorProto(),
      buildProto2DescriptorProto(),
    ];

void checkUnnamed5659(core.List<api.Proto2DescriptorProto> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProto2DescriptorProto(o[0]);
  checkProto2DescriptorProto(o[1]);
}
...
api.Proto2FileDescriptorProto buildProto2FileDescriptorProto() {
  ...
  if (buildCounterProto2FileDescriptorProto < 3) {
    o.enumType = buildUnnamed5658();
    o.messageType = buildUnnamed5659();
    o.name = 'foo';
    o.package = 'foo';
    o.syntax = 'foo';
  }
...
void checkProto2FileDescriptorProto(api.Proto2FileDescriptorProto o) {
  buildCounterProto2FileDescriptorProto++;
  if (buildCounterProto2FileDescriptorProto < 3) {
    checkUnnamed5658(o.enumType!);
    checkUnnamed5659(o.messageType!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
