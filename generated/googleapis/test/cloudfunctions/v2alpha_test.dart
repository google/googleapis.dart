...
import 'package:googleapis/cloudfunctions/v2alpha.dart' as api;
...
core.List<api.GoogleCloudFunctionsV2alphaStateMessage> buildUnnamed6() => [
  buildGoogleCloudFunctionsV2alphaStateMessage(),
  buildGoogleCloudFunctionsV2alphaStateMessage(),
];

void checkUnnamed6(core.List<api.GoogleCloudFunctionsV2alphaStateMessage> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudFunctionsV2alphaStateMessage(o[0]);
  checkGoogleCloudFunctionsV2alphaStateMessage(o[1]);
}
...
core.int buildCounterGoogleCloudFunctionsV2alphaStateMessage = 0;
api.GoogleCloudFunctionsV2alphaStateMessage
buildGoogleCloudFunctionsV2alphaStateMessage() {
  final o = api.GoogleCloudFunctionsV2alphaStateMessage();
  buildCounterGoogleCloudFunctionsV2alphaStateMessage++;
  if (buildCounterGoogleCloudFunctionsV2alphaStateMessage < 3) {
    o.message = 'foo';
    o.severity = 'foo';
    o.type = 'foo';
  }
...
void checkGoogleCloudFunctionsV2alphaStateMessage(
  api.GoogleCloudFunctionsV2alphaStateMessage o,
) {
  buildCounterGoogleCloudFunctionsV2alphaStateMessage++;
  if (buildCounterGoogleCloudFunctionsV2alphaStateMessage < 3) {
...
core.List<api.Runtime> buildUnnamed11() => [buildRuntime(), buildRuntime()];
...
core.List<api.Binding> buildUnnamed17() => [buildBinding(), buildBinding()];
...
void main() {
  ...
  unittest.group('obj-schema-GoogleCloudFunctionsV2alphaStateMessage', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudFunctionsV2alphaStateMessage();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudFunctionsV2alphaStateMessage.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudFunctionsV2alphaStateMessage(od);
    });
  });
