...
checkUnnamed2818(core.List<api.AnalyzeDataDescriptionFeaturesCategoricalValues> o) {
...
checkUnnamed2819(core.List<api.AnalyzeDataDescriptionFeatures> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2820(core.List<api.AnalyzeDataDescriptionOutputFeatureText> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2821(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed2822() {
  ...
  o.add(buildUnnamed2821());
  o.add(buildUnnamed2821());
  return o;
}

checkUnnamed2822(core.List<core.Map<core.String, core.String>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2821(o[0]);
  checkUnnamed2821(o[1]);
}
...
buildUnnamed2824() {
  ...
  o["x"] = buildUnnamed2823();
  o["y"] = buildUnnamed2823();
  return o;
}

checkUnnamed2824(core.Map<core.String, core.Map<core.String, core.String>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2823(o["x"]);
  checkUnnamed2823(o["y"]);
}
...
buildAnalyzeModelDescription() {
  ...
  if (buildCounterAnalyzeModelDescription < 3) {
    o.confusionMatrix = buildUnnamed2824();
    o.confusionMatrixRowTotals = buildUnnamed2825();
...
checkAnalyzeModelDescription(api.AnalyzeModelDescription o) {
  buildCounterAnalyzeModelDescription++;
  if (buildCounterAnalyzeModelDescription < 3) {
    checkUnnamed2824(o.confusionMatrix);
    checkUnnamed2825(o.confusionMatrixRowTotals);
...
checkUnnamed2826(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildInputInput() {
  ...
  if (buildCounterInputInput < 3) {
    o.csvInstance = buildUnnamed2826();
  }
  buildCounterInputInput--;
  return o;
}
...
checkInputInput(api.InputInput o) {
  buildCounterInputInput++;
  if (buildCounterInputInput < 3) {
    checkUnnamed2826(o.csvInstance);
  }
  buildCounterInputInput--;
}
...
checkUnnamed2827(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildInsertTrainingInstances() {
  ...
  if (buildCounterInsertTrainingInstances < 3) {
    o.csvInstance = buildUnnamed2827();
    o.output = "foo";
  }
  buildCounterInsertTrainingInstances--;
  return o;
...
checkInsertTrainingInstances(api.InsertTrainingInstances o) {
  buildCounterInsertTrainingInstances++;
  if (buildCounterInsertTrainingInstances < 3) {
    checkUnnamed2827(o.csvInstance);
...
checkUnnamed2828(core.List<api.InsertTrainingInstances> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2829(core.Map<core.String, core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed2830() {
  ...
  o.add(buildUnnamed2829());
  o.add(buildUnnamed2829());
  return o;
}

checkUnnamed2830(core.List<core.Map<core.String, core.double>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2829(o[0]);
  checkUnnamed2829(o[1]);
}
...
buildInsert() {
  ...
  if (buildCounterInsert < 3) {
    ...
    o.trainingInstances = buildUnnamed2828();
    o.utility = buildUnnamed2830();
  }
  buildCounterInsert--;
  return o;
}
...
checkInsert(api.Insert o) {
  ...
  if (buildCounterInsert < 3) {
    ...
    checkUnnamed2828(o.trainingInstances);
    checkUnnamed2830(o.utility);
  }
  buildCounterInsert--;
}
...
checkUnnamed2831(core.List<api.Insert2> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInsert2(o[0]);
  checkInsert2(o[1]);
}
...
checkUnnamed2832(core.List<api.OutputOutputMulti> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOutput() {
  ...
  if (buildCounterOutput < 3) {
    ...
    o.kind = "foo";
    o.outputLabel = "foo";
    o.outputMulti = buildUnnamed2832();
    o.outputValue = 42.0;
    o.selfLink = "foo";
  }
  buildCounterOutput--;
...
checkOutput(api.Output o) {
  ...
  if (buildCounterOutput < 3) {
    ...
    checkUnnamed2832(o.outputMulti);
...
checkUnnamed2833(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUpdate() {
  ...
  if (buildCounterUpdate < 3) {
    o.csvInstance = buildUnnamed2833();
    o.output = "foo";
  }
  buildCounterUpdate--;
  return o;
...
checkUpdate(api.Update o) {
  buildCounterUpdate++;
  if (buildCounterUpdate < 3) {
    checkUnnamed2833(o.csvInstance);
    unittest.expect(o.output, unittest.equals('foo'));
  }
  buildCounterUpdate--;
}
