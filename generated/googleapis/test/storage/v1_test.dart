...
core.List<api.BucketAccessControl> buildUnnamed4872() {
...
void checkUnnamed4872(core.List<api.BucketAccessControl> o) {
...
api.BucketCors buildBucketCors() {
  ...
  if (buildCounterBucketCors < 3) {
    o.maxAgeSeconds = 42;
    o.method = buildUnnamed4873();
    o.origin = buildUnnamed4874();
    o.responseHeader = buildUnnamed4875();
  }
  buildCounterBucketCors--;
  return o;
}
...
void checkBucketCors(api.BucketCors o) {
  ...
  if (buildCounterBucketCors < 3) {
    ...
    checkUnnamed4873(o.method!);
    checkUnnamed4874(o.origin!);
    checkUnnamed4875(o.responseHeader!);
  }
  buildCounterBucketCors--;
}

core.List<api.BucketCors> buildUnnamed4876() {
  var o = <api.BucketCors>[];
...
void checkUnnamed4876(core.List<api.BucketCors> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBucketCors(o[0] as api.BucketCors);
  checkBucketCors(o[1] as api.BucketCors);
}

core.List<api.ObjectAccessControl> buildUnnamed4877() {
...
void checkUnnamed4877(core.List<api.ObjectAccessControl> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.String> buildUnnamed4878() {
...
void checkUnnamed4878(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.BucketLifecycleRuleCondition buildBucketLifecycleRuleCondition() {
  ...
  if (buildCounterBucketLifecycleRuleCondition < 3) {
    ...
    o.matchesStorageClass = buildUnnamed4879();
...
void checkBucketLifecycleRuleCondition(api.BucketLifecycleRuleCondition o) {
  ...
  if (buildCounterBucketLifecycleRuleCondition < 3) {
    ...
    checkUnnamed4879(o.matchesStorageClass!);
    unittest.expect(
...
core.List<api.BucketLifecycleRule> buildUnnamed4880() {
  var o = <api.BucketLifecycleRule>[];
...
void checkUnnamed4880(core.List<api.BucketLifecycleRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Bucket buildBucket() {
  ...
  if (buildCounterBucket < 3) {
    ...
    o.zoneAffinity = buildUnnamed4881();
  }
  buildCounterBucket--;
  return o;
}
...
void checkBucket(api.Bucket o) {
  ...
  if (buildCounterBucket < 3) {
    ...
    checkUnnamed4881(o.zoneAffinity!);
  }
  buildCounterBucket--;
}
...
core.List<api.BucketAccessControl> buildUnnamed4882() {
  var o = <api.BucketAccessControl>[];
  o.add(buildBucketAccessControl());
  o.add(buildBucketAccessControl());
  return o;
...
void checkUnnamed4882(core.List<api.BucketAccessControl> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBucketAccessControl(o[0] as api.BucketAccessControl);
  checkBucketAccessControl(o[1] as api.BucketAccessControl);
}
...
core.List<api.Bucket> buildUnnamed4883() {
  var o = <api.Bucket>[];
  o.add(buildBucket());
  o.add(buildBucket());
  return o;
...
void checkUnnamed4883(core.List<api.Bucket> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.String> buildUnnamed4884() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed4884(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.ComposeRequestSourceObjects> buildUnnamed4885() {
  var o = <api.ComposeRequestSourceObjects>[];
...
void checkUnnamed4885(core.List<api.ComposeRequestSourceObjects> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ComposeRequest buildComposeRequest() {
  ...
  if (buildCounterComposeRequest < 3) {
    ...
    o.kind = 'foo';
    o.sourceObjects = buildUnnamed4885();
  }
  buildCounterComposeRequest--;
  return o;
}
...
void checkComposeRequest(api.ComposeRequest o) {
  ...
  if (buildCounterComposeRequest < 3) {
    ...
    checkUnnamed4885(o.sourceObjects!);
  }
  buildCounterComposeRequest--;
}
...
core.List<api.HmacKeyMetadata> buildUnnamed4886() {
  var o = <api.HmacKeyMetadata>[];
...
void checkUnnamed4886(core.List<api.HmacKeyMetadata> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Notification buildNotification() {
  ...
  if (buildCounterNotification < 3) {
    o.customAttributes = buildUnnamed4887();
    o.etag = 'foo';
    o.eventTypes = buildUnnamed4888();
    o.id = 'foo';
    o.kind = 'foo';
...
void checkNotification(api.Notification o) {
  buildCounterNotification++;
  if (buildCounterNotification < 3) {
    checkUnnamed4887(o.customAttributes!);
    unittest.expect(
      o.etag!,
      unittest.equals('foo'),
    );
    checkUnnamed4888(o.eventTypes!);
    unittest.expect(
      o.id!,
      unittest.equals('foo'),
    );
...
core.List<api.Notification> buildUnnamed4889() {
  var o = <api.Notification>[];
...
void checkUnnamed4889(core.List<api.Notification> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ObjectAccessControl> buildUnnamed4890() {
  var o = <api.ObjectAccessControl>[];
  o.add(buildObjectAccessControl());
  o.add(buildObjectAccessControl());
  return o;
...
void checkUnnamed4890(core.List<api.ObjectAccessControl> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkObjectAccessControl(o[0] as api.ObjectAccessControl);
  checkObjectAccessControl(o[1] as api.ObjectAccessControl);
}
...
core.List<api.ObjectAccessControl> buildUnnamed4892() {
  var o = <api.ObjectAccessControl>[];
  o.add(buildObjectAccessControl());
  o.add(buildObjectAccessControl());
  return o;
...
void checkUnnamed4892(core.List<api.ObjectAccessControl> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkObjectAccessControl(o[0] as api.ObjectAccessControl);
  checkObjectAccessControl(o[1] as api.ObjectAccessControl);
}
...
core.List<api.Object> buildUnnamed4893() {
  var o = <api.Object>[];
  o.add(buildObject());
  o.add(buildObject());
  return o;
...
void checkUnnamed4893(core.List<api.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Objects buildObjects() {
  ...
  if (buildCounterObjects < 3) {
    o.items = buildUnnamed4893();
    o.kind = 'foo';
    o.nextPageToken = 'foo';
    o.prefixes = buildUnnamed4894();
  }
  buildCounterObjects--;
  return o;
}
...
core.List<api.PolicyBindings> buildUnnamed4896() {
  var o = <api.PolicyBindings>[];
...
void checkUnnamed4896(core.List<api.PolicyBindings> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TestIamPermissionsResponse buildTestIamPermissionsResponse() {
  ...
  if (buildCounterTestIamPermissionsResponse < 3) {
    o.kind = 'foo';
    o.permissions = buildUnnamed4897();
  }
  buildCounterTestIamPermissionsResponse--;
  return o;
}
...
void checkTestIamPermissionsResponse(api.TestIamPermissionsResponse o) {
  ...
  if (buildCounterTestIamPermissionsResponse < 3) {
    ...
    checkUnnamed4897(o.permissions!);
  }
  buildCounterTestIamPermissionsResponse--;
}
...
void main() {
  ...
  unittest.group('resource-BucketsResource', () {
    ...
    unittest.test('method--testIamPermissions', () async {
      ...
      var res = api.StorageApi(mock).buckets;
      var arg_bucket = 'foo';
      var arg_permissions = buildUnnamed4898();
      var arg_provisionalUserProject = 'foo';
      var arg_userProject = 'foo';
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
  ...
  unittest.group('resource-ObjectsResource', () {
    ...
    unittest.test('method--testIamPermissions', () async {
      ...
      var arg_bucket = 'foo';
      var arg_object = 'foo';
      var arg_permissions = buildUnnamed4899();
      var arg_generation = 'foo';
      var arg_provisionalUserProject = 'foo';
      var arg_userProject = 'foo';
      var arg_$fields = 'foo';
