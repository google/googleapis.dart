...
core.List<api.BucketAccessControl> buildUnnamed5350() => [
      buildBucketAccessControl(),
      buildBucketAccessControl(),
    ];

void checkUnnamed5350(core.List<api.BucketAccessControl> o) {
...
api.BucketCors buildBucketCors() {
  ...
  if (buildCounterBucketCors < 3) {
    o.maxAgeSeconds = 42;
    o.method = buildUnnamed5351();
    o.origin = buildUnnamed5352();
    o.responseHeader = buildUnnamed5353();
  }
  buildCounterBucketCors--;
  return o;
}
...
void checkBucketCors(api.BucketCors o) {
  ...
  if (buildCounterBucketCors < 3) {
    ...
    checkUnnamed5351(o.method!);
    checkUnnamed5352(o.origin!);
    checkUnnamed5353(o.responseHeader!);
  }
  buildCounterBucketCors--;
}

core.List<api.BucketCors> buildUnnamed5354() => [
      buildBucketCors(),
      buildBucketCors(),
    ];

void checkUnnamed5354(core.List<api.BucketCors> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBucketCors(o[0]);
  checkBucketCors(o[1]);
}

core.List<api.ObjectAccessControl> buildUnnamed5355() => [
      buildObjectAccessControl(),
      buildObjectAccessControl(),
    ];

void checkUnnamed5355(core.List<api.ObjectAccessControl> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.String> buildUnnamed5356() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed5356(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.BucketLifecycleRuleCondition buildBucketLifecycleRuleCondition() {
  ...
  if (buildCounterBucketLifecycleRuleCondition < 3) {
    ...
    o.matchesStorageClass = buildUnnamed5357();
...
void checkBucketLifecycleRuleCondition(api.BucketLifecycleRuleCondition o) {
  ...
  if (buildCounterBucketLifecycleRuleCondition < 3) {
    ...
    checkUnnamed5357(o.matchesStorageClass!);
    unittest.expect(
...
core.List<api.BucketLifecycleRule> buildUnnamed5358() => [
      buildBucketLifecycleRule(),
      buildBucketLifecycleRule(),
    ];

void checkUnnamed5358(core.List<api.BucketLifecycleRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Bucket buildBucket() {
  ...
  if (buildCounterBucket < 3) {
    ...
    o.zoneAffinity = buildUnnamed5359();
  }
  buildCounterBucket--;
  return o;
}
...
void checkBucket(api.Bucket o) {
  ...
  if (buildCounterBucket < 3) {
    ...
    checkUnnamed5359(o.zoneAffinity!);
  }
  buildCounterBucket--;
}
...
core.List<api.BucketAccessControl> buildUnnamed5360() => [
      buildBucketAccessControl(),
      buildBucketAccessControl(),
    ];

void checkUnnamed5360(core.List<api.BucketAccessControl> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBucketAccessControl(o[0]);
  checkBucketAccessControl(o[1]);
}
...
core.List<api.Bucket> buildUnnamed5361() => [
      buildBucket(),
      buildBucket(),
    ];

void checkUnnamed5361(core.List<api.Bucket> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBucket(o[0]);
  checkBucket(o[1]);
}
...
core.Map<core.String, core.String> buildUnnamed5362() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed5362(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.ComposeRequestSourceObjects> buildUnnamed5363() => [
      buildComposeRequestSourceObjects(),
      buildComposeRequestSourceObjects(),
    ];

void checkUnnamed5363(core.List<api.ComposeRequestSourceObjects> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ComposeRequest buildComposeRequest() {
  ...
  if (buildCounterComposeRequest < 3) {
    ...
    o.kind = 'foo';
    o.sourceObjects = buildUnnamed5363();
  }
  buildCounterComposeRequest--;
  return o;
}
...
void checkComposeRequest(api.ComposeRequest o) {
  ...
  if (buildCounterComposeRequest < 3) {
    ...
    checkUnnamed5363(o.sourceObjects!);
  }
  buildCounterComposeRequest--;
}
...
core.List<api.HmacKeyMetadata> buildUnnamed5364() => [
      buildHmacKeyMetadata(),
      buildHmacKeyMetadata(),
    ];

void checkUnnamed5364(core.List<api.HmacKeyMetadata> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Notification buildNotification() {
  ...
  if (buildCounterNotification < 3) {
    o.customAttributes = buildUnnamed5365();
    o.etag = 'foo';
    o.eventTypes = buildUnnamed5366();
    o.id = 'foo';
    o.kind = 'foo';
...
void checkNotification(api.Notification o) {
  buildCounterNotification++;
  if (buildCounterNotification < 3) {
    checkUnnamed5365(o.customAttributes!);
    unittest.expect(
      o.etag!,
      unittest.equals('foo'),
    );
    checkUnnamed5366(o.eventTypes!);
    unittest.expect(
      o.id!,
      unittest.equals('foo'),
    );
...
core.List<api.Notification> buildUnnamed5367() => [
      buildNotification(),
      buildNotification(),
    ];

void checkUnnamed5367(core.List<api.Notification> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ObjectAccessControl> buildUnnamed5368() => [
      buildObjectAccessControl(),
      buildObjectAccessControl(),
    ];

void checkUnnamed5368(core.List<api.ObjectAccessControl> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkObjectAccessControl(o[0]);
  checkObjectAccessControl(o[1]);
}
...
core.List<api.ObjectAccessControl> buildUnnamed5370() => [
      buildObjectAccessControl(),
      buildObjectAccessControl(),
    ];

void checkUnnamed5370(core.List<api.ObjectAccessControl> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkObjectAccessControl(o[0]);
  checkObjectAccessControl(o[1]);
}
...
core.List<api.Object> buildUnnamed5371() => [
      buildObject(),
      buildObject(),
    ];

void checkUnnamed5371(core.List<api.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkObject(o[0]);
  checkObject(o[1]);
}
...
core.List<api.PolicyBindings> buildUnnamed5374() => [
      buildPolicyBindings(),
      buildPolicyBindings(),
    ];

void checkUnnamed5374(core.List<api.PolicyBindings> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TestIamPermissionsResponse buildTestIamPermissionsResponse() {
  ...
  if (buildCounterTestIamPermissionsResponse < 3) {
    o.kind = 'foo';
    o.permissions = buildUnnamed5375();
  }
  buildCounterTestIamPermissionsResponse--;
  return o;
}
...
void checkTestIamPermissionsResponse(api.TestIamPermissionsResponse o) {
  ...
  if (buildCounterTestIamPermissionsResponse < 3) {
    ...
    checkUnnamed5375(o.permissions!);
  }
  buildCounterTestIamPermissionsResponse--;
}
...
void main() {
  ...
  unittest.group('resource-BucketsResource', () {
    ...
    unittest.test('method--testIamPermissions', () async {
      ...
      final res = api.StorageApi(mock).buckets;
      final arg_bucket = 'foo';
      final arg_permissions = buildUnnamed5376();
      final arg_provisionalUserProject = 'foo';
      final arg_userProject = 'foo';
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
