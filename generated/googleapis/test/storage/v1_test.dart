...
checkUnnamed3544(core.List<api.BucketAccessControl> o) {
...
buildBucketCors() {
  ...
  if (buildCounterBucketCors < 3) {
    o.maxAgeSeconds = 42;
    o.method = buildUnnamed3545();
    o.origin = buildUnnamed3546();
    o.responseHeader = buildUnnamed3547();
  }
  buildCounterBucketCors--;
  return o;
}
...
checkBucketCors(api.BucketCors o) {
  ...
  if (buildCounterBucketCors < 3) {
    ...
    checkUnnamed3545(o.method);
    checkUnnamed3546(o.origin);
    checkUnnamed3547(o.responseHeader);
  }
  buildCounterBucketCors--;
}
...
checkUnnamed3548(core.List<api.BucketCors> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBucketCors(o[0]);
  checkBucketCors(o[1]);
}
...
checkUnnamed3549(core.List<api.ObjectAccessControl> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildBucketLifecycleRuleCondition() {
  ...
  if (buildCounterBucketLifecycleRuleCondition < 3) {
    ...
    o.matchesStorageClass = buildUnnamed3551();
...
checkBucketLifecycleRuleCondition(api.BucketLifecycleRuleCondition o) {
  ...
  if (buildCounterBucketLifecycleRuleCondition < 3) {
    ...
    checkUnnamed3551(o.matchesStorageClass);
...
checkUnnamed3552(core.List<api.BucketLifecycleRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3553(core.List<api.BucketAccessControl> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBucketAccessControl(o[0]);
  checkBucketAccessControl(o[1]);
}
...
checkUnnamed3554(core.List<api.Bucket> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBucket(o[0]);
  checkBucket(o[1]);
}
...
checkUnnamed3556(core.List<api.ComposeRequestSourceObjects> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildComposeRequest() {
  ...
  if (buildCounterComposeRequest < 3) {
    ...
    o.kind = "foo";
    o.sourceObjects = buildUnnamed3556();
  }
  buildCounterComposeRequest--;
  return o;
}
...
checkComposeRequest(api.ComposeRequest o) {
  ...
  if (buildCounterComposeRequest < 3) {
    ...
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed3556(o.sourceObjects);
  }
  buildCounterComposeRequest--;
}
...
checkUnnamed3557(core.List<api.HmacKeyMetadata> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildNotification() {
  ...
  if (buildCounterNotification < 3) {
    o.customAttributes = buildUnnamed3558();
    o.etag = "foo";
    o.eventTypes = buildUnnamed3559();
    o.id = "foo";
    o.kind = "foo";
...
checkNotification(api.Notification o) {
  buildCounterNotification++;
  if (buildCounterNotification < 3) {
    checkUnnamed3558(o.customAttributes);
    unittest.expect(o.etag, unittest.equals('foo'));
    checkUnnamed3559(o.eventTypes);
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed3560(core.List<api.Notification> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3561(core.List<api.ObjectAccessControl> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkObjectAccessControl(o[0]);
  checkObjectAccessControl(o[1]);
}
...
checkUnnamed3562(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed3563(core.List<api.ObjectAccessControl> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkObjectAccessControl(o[0]);
  checkObjectAccessControl(o[1]);
}
...
checkUnnamed3564(core.List<api.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkObject(o[0]);
  checkObject(o[1]);
}
...
checkUnnamed3567(core.List<api.PolicyBindings> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildTestIamPermissionsResponse() {
  ...
  if (buildCounterTestIamPermissionsResponse < 3) {
    o.kind = "foo";
    o.permissions = buildUnnamed3568();
  }
  buildCounterTestIamPermissionsResponse--;
  return o;
}
...
checkTestIamPermissionsResponse(api.TestIamPermissionsResponse o) {
  ...
  if (buildCounterTestIamPermissionsResponse < 3) {
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed3568(o.permissions);
  }
  buildCounterTestIamPermissionsResponse--;
}
...
main() {
  ...
  unittest.group("resource-BucketsResourceApi", () {
    ...
    unittest.test("method--testIamPermissions", () {
      ...
      api.BucketsResourceApi res = new api.StorageApi(mock).buckets;
      var arg_bucket = "foo";
      var arg_permissions = buildUnnamed3569();
      var arg_provisionalUserProject = "foo";
      var arg_userProject = "foo";
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
  ...
  unittest.group("resource-ObjectsResourceApi", () {
    ...
    unittest.test("method--testIamPermissions", () {
      ...
      var arg_bucket = "foo";
      var arg_object = "foo";
      var arg_permissions = buildUnnamed3570();
      var arg_generation = "foo";
      var arg_provisionalUserProject = "foo";
      var arg_userProject = "foo";
      var arg_$fields = "foo";
