...
core.Map<core.String, core.String> buildUnnamed1546() {
...
void checkUnnamed1546(core.Map<core.String, core.String> o) {
...
api.Webfont buildWebfont() {
  ...
  if (buildCounterWebfont < 3) {
    o.category = 'foo';
    o.family = 'foo';
    o.files = buildUnnamed1546();
    o.kind = 'foo';
    o.lastModified = 'foo';
    o.subsets = buildUnnamed1547();
    o.variants = buildUnnamed1548();
    o.version = 'foo';
  }
  buildCounterWebfont--;
  return o;
...
void checkWebfont(api.Webfont o) {
  ...
  if (buildCounterWebfont < 3) {
    ...
    checkUnnamed1546(o.files);
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.lastModified, unittest.equals('foo'));
    checkUnnamed1547(o.subsets);
    checkUnnamed1548(o.variants);
    unittest.expect(o.version, unittest.equals('foo'));
  }
  buildCounterWebfont--;
}

core.List<api.Webfont> buildUnnamed1549() {
  var o = <api.Webfont>[];
  o.add(buildWebfont());
  o.add(buildWebfont());
  return o;
...
void checkUnnamed1549(core.List<api.Webfont> o) {
  unittest.expect(o, unittest.hasLength(2));
