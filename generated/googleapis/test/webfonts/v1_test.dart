...
api.Webfont buildWebfont() {
  ...
  if (buildCounterWebfont < 3) {
    o.category = 'foo';
    o.family = 'foo';
    o.files = buildUnnamed1541();
    o.kind = 'foo';
    o.lastModified = 'foo';
    o.subsets = buildUnnamed1542();
    o.variants = buildUnnamed1543();
    o.version = 'foo';
  }
  buildCounterWebfont--;
  return o;
...
void checkWebfont(api.Webfont o) {
  ...
  if (buildCounterWebfont < 3) {
    ...
    checkUnnamed1541(o.files);
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.lastModified, unittest.equals('foo'));
    checkUnnamed1542(o.subsets);
    checkUnnamed1543(o.variants);
    unittest.expect(o.version, unittest.equals('foo'));
  }
  buildCounterWebfont--;
}

core.List<api.Webfont> buildUnnamed1544() {
  var o = <api.Webfont>[];
  o.add(buildWebfont());
  o.add(buildWebfont());
  return o;
...
void checkUnnamed1544(core.List<api.Webfont> o) {
  unittest.expect(o, unittest.hasLength(2));
