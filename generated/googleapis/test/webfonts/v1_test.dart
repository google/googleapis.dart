...
checkUnnamed1393(core.Map<core.String, core.String> o) {
...
buildWebfont() {
  ...
  if (buildCounterWebfont < 3) {
    o.category = "foo";
    o.family = "foo";
    o.files = buildUnnamed1393();
    o.kind = "foo";
    o.lastModified = core.DateTime.parse("2002-02-27T14:01:02Z");
    o.subsets = buildUnnamed1394();
    o.variants = buildUnnamed1395();
    o.version = "foo";
  }
  buildCounterWebfont--;
  return o;
...
checkUnnamed1396(core.List<api.Webfont> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWebfont(o[0]);
  checkWebfont(o[1]);
}
