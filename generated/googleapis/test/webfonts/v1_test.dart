...
core.Map<core.String, core.String> buildUnnamed1954() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed1954(core.Map<core.String, core.String> o) {
...
api.Webfont buildWebfont() {
  ...
  if (buildCounterWebfont < 3) {
    o.category = 'foo';
    o.family = 'foo';
    o.files = buildUnnamed1954();
    o.kind = 'foo';
    o.lastModified = 'foo';
    o.subsets = buildUnnamed1955();
    o.variants = buildUnnamed1956();
    o.version = 'foo';
  }
  buildCounterWebfont--;
  return o;
...
void checkWebfont(api.Webfont o) {
  ...
  if (buildCounterWebfont < 3) {
    ...
    checkUnnamed1955(o.subsets!);
    checkUnnamed1956(o.variants!);
    unittest.expect(
      o.version!,
      unittest.equals('foo'),
    );
...
core.List<api.Webfont> buildUnnamed1957() => [
      buildWebfont(),
      buildWebfont(),
    ];

void checkUnnamed1957(core.List<api.Webfont> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWebfont(o[0]);
  checkWebfont(o[1]);
}
