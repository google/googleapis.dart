...
core.List<api.PosixAccount> buildUnnamed3465() {
...
void checkUnnamed3465(core.List<api.PosixAccount> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPosixAccount(o[0] as api.PosixAccount);
  checkPosixAccount(o[1] as api.PosixAccount);
}

core.Map<core.String, api.SshPublicKey> buildUnnamed3466() {
...
void checkUnnamed3466(core.Map<core.String, api.SshPublicKey> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.LoginProfile buildLoginProfile() {
  ...
  if (buildCounterLoginProfile < 3) {
    o.name = 'foo';
    o.posixAccounts = buildUnnamed3465();
    o.sshPublicKeys = buildUnnamed3466();
  }
  buildCounterLoginProfile--;
  return o;
}
...
void checkLoginProfile(api.LoginProfile o) {
  ...
  if (buildCounterLoginProfile < 3) {
    ...
    checkUnnamed3465(o.posixAccounts!);
    checkUnnamed3466(o.sshPublicKeys!);
  }
  buildCounterLoginProfile--;
}
