...
checkUnnamed2431(core.List<api.PosixAccount> o) {
...
checkUnnamed2432(core.Map<core.String, api.SshPublicKey> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildLoginProfile() {
  ...
  if (buildCounterLoginProfile < 3) {
    o.name = "foo";
    o.posixAccounts = buildUnnamed2431();
    o.sshPublicKeys = buildUnnamed2432();
  }
  buildCounterLoginProfile--;
  return o;
}
...
checkLoginProfile(api.LoginProfile o) {
  ...
  if (buildCounterLoginProfile < 3) {
    ...
    checkUnnamed2431(o.posixAccounts);
    checkUnnamed2432(o.sshPublicKeys);
  }
  buildCounterLoginProfile--;
}
