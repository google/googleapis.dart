...
core.List<api.PosixAccount> buildUnnamed1937() => [
      buildPosixAccount(),
      buildPosixAccount(),
    ];

void checkUnnamed1937(core.List<api.PosixAccount> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPosixAccount(o[0]);
  checkPosixAccount(o[1]);
}

core.Map<core.String, api.SshPublicKey> buildUnnamed1938() => {
      'x': buildSshPublicKey(),
      'y': buildSshPublicKey(),
    };

void checkUnnamed1938(core.Map<core.String, api.SshPublicKey> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.LoginProfile buildLoginProfile() {
  ...
  if (buildCounterLoginProfile < 3) {
    o.name = 'foo';
    o.posixAccounts = buildUnnamed1937();
    o.sshPublicKeys = buildUnnamed1938();
  }
  buildCounterLoginProfile--;
  return o;
}
...
void checkLoginProfile(api.LoginProfile o) {
  ...
  if (buildCounterLoginProfile < 3) {
    ...
    checkUnnamed1937(o.posixAccounts!);
    checkUnnamed1938(o.sshPublicKeys!);
  }
  buildCounterLoginProfile--;
}
