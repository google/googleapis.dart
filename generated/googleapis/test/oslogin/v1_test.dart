...
checkUnnamed756(core.List<api.PosixAccount> o) {
...
checkUnnamed757(core.Map<core.String, api.SshPublicKey> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildLoginProfile() {
  ...
  if (buildCounterLoginProfile < 3) {
    o.name = "foo";
    o.posixAccounts = buildUnnamed756();
    o.sshPublicKeys = buildUnnamed757();
  }
  buildCounterLoginProfile--;
  return o;
}
...
checkLoginProfile(api.LoginProfile o) {
  ...
  if (buildCounterLoginProfile < 3) {
    ...
    checkUnnamed756(o.posixAccounts);
    checkUnnamed757(o.sshPublicKeys);
  }
  buildCounterLoginProfile--;
}
