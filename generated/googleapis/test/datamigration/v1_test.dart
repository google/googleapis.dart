...
core.List<api.AuditLogConfig> buildUnnamed2382() => [
      buildAuditLogConfig(),
      buildAuditLogConfig(),
    ];

void checkUnnamed2382(core.List<api.AuditLogConfig> o) {
...
api.AuditConfig buildAuditConfig() {
  ...
  if (buildCounterAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed2382();
    o.service = 'foo';
  }
  buildCounterAuditConfig--;
  return o;
...
void checkAuditConfig(api.AuditConfig o) {
  buildCounterAuditConfig++;
  if (buildCounterAuditConfig < 3) {
    checkUnnamed2382(o.auditLogConfigs!);
    unittest.expect(
      o.service!,
      unittest.equals('foo'),
    );
...
api.AuditLogConfig buildAuditLogConfig() {
  ...
  if (buildCounterAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed2383();
    o.logType = 'foo';
  }
  buildCounterAuditLogConfig--;
  return o;
...
void checkAuditLogConfig(api.AuditLogConfig o) {
  buildCounterAuditLogConfig++;
  if (buildCounterAuditLogConfig < 3) {
    checkUnnamed2383(o.exemptedMembers!);
    unittest.expect(
      o.logType!,
      unittest.equals('foo'),
    );
...
api.CloudSqlSettings buildCloudSqlSettings() {
  ...
  if (buildCounterCloudSqlSettings < 3) {
    ...
    o.dataDiskType = 'foo';
    o.databaseFlags = buildUnnamed2385();
...
void checkCloudSqlSettings(api.CloudSqlSettings o) {
  ...
  if (buildCounterCloudSqlSettings < 3) {
    ...
    checkUnnamed2385(o.databaseFlags!);
    unittest.expect(
      o.databaseVersion!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.String> buildUnnamed2387() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed2387(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.ConnectionProfile> buildUnnamed2388() => [
      buildConnectionProfile(),
      buildConnectionProfile(),
    ];

void checkUnnamed2388(core.List<api.ConnectionProfile> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListConnectionProfilesResponse buildListConnectionProfilesResponse() {
  ...
  if (buildCounterListConnectionProfilesResponse < 3) {
    o.connectionProfiles = buildUnnamed2388();
    o.nextPageToken = 'foo';
    o.unreachable = buildUnnamed2389();
  }
  buildCounterListConnectionProfilesResponse--;
  return o;
}
...
void checkListConnectionProfilesResponse(api.ListConnectionProfilesResponse o) {
  buildCounterListConnectionProfilesResponse++;
  if (buildCounterListConnectionProfilesResponse < 3) {
    checkUnnamed2388(o.connectionProfiles!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Location> buildUnnamed2390() => [
      buildLocation(),
      buildLocation(),
    ];

void checkUnnamed2390(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
core.List<api.MigrationJob> buildUnnamed2391() => [
      buildMigrationJob(),
      buildMigrationJob(),
    ];

void checkUnnamed2391(core.List<api.MigrationJob> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListMigrationJobsResponse buildListMigrationJobsResponse() {
  ...
  if (buildCounterListMigrationJobsResponse < 3) {
    o.migrationJobs = buildUnnamed2391();
    o.nextPageToken = 'foo';
    o.unreachable = buildUnnamed2392();
  }
  buildCounterListMigrationJobsResponse--;
  return o;
}
...
void checkListMigrationJobsResponse(api.ListMigrationJobsResponse o) {
  buildCounterListMigrationJobsResponse++;
  if (buildCounterListMigrationJobsResponse < 3) {
    checkUnnamed2391(o.migrationJobs!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Operation> buildUnnamed2393() => [
      buildOperation(),
      buildOperation(),
    ];

void checkUnnamed2393(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
core.Map<core.String, core.Object> buildUnnamed2398() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed2398(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed2397();
    o.name = 'foo';
    o.response = buildUnnamed2398();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error!);
    checkUnnamed2397(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed2398(o.response!);
  }
  buildCounterOperation--;
}

core.List<api.AuditConfig> buildUnnamed2399() => [
      buildAuditConfig(),
      buildAuditConfig(),
    ];

void checkUnnamed2399(core.List<api.AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAuditConfig(o[0]);
  checkAuditConfig(o[1]);
}

core.List<api.Binding> buildUnnamed2400() => [
      buildBinding(),
      buildBinding(),
    ];

void checkUnnamed2400(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
api.Policy buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.auditConfigs = buildUnnamed2399();
    o.bindings = buildUnnamed2400();
    o.etag = 'foo';
    o.version = 42;
  }
  buildCounterPolicy--;
...
void checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed2399(o.auditConfigs!);
    checkUnnamed2400(o.bindings!);
    unittest.expect(
      o.etag!,
      unittest.equals('foo'),
    );
...
core.List<api.SqlAclEntry> buildUnnamed2401() => [
      buildSqlAclEntry(),
      buildSqlAclEntry(),
    ];

void checkUnnamed2401(core.List<api.SqlAclEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SqlIpConfig buildSqlIpConfig() {
  ...
  if (buildCounterSqlIpConfig < 3) {
    o.authorizedNetworks = buildUnnamed2401();
    o.enableIpv4 = true;
...
void checkSqlIpConfig(api.SqlIpConfig o) {
  buildCounterSqlIpConfig++;
  if (buildCounterSqlIpConfig < 3) {
    checkUnnamed2401(o.authorizedNetworks!);
...
core.List<core.Map<core.String, core.Object>> buildUnnamed2403() => [
      buildUnnamed2402(),
      buildUnnamed2402(),
    ];

void checkUnnamed2403(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2402(o[0]);
  checkUnnamed2402(o[1]);
}
