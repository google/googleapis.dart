...
import 'package:googleapis/osconfig/v1alpha.dart' as api;
...
void checkInstanceOSPoliciesCompliance(api.InstanceOSPoliciesCompliance o) {
  buildCounterInstanceOSPoliciesCompliance++;
  if (buildCounterInstanceOSPoliciesCompliance < 3) {
    unittest.expect(o.detailedState!, unittest.equals('foo'));
    unittest.expect(o.detailedStateReason!, unittest.equals('foo'));
    unittest.expect(o.instance!, unittest.equals('foo'));
    unittest.expect(o.lastComplianceCheckTime!, unittest.equals('foo'));
    unittest.expect(o.lastComplianceRunId!, unittest.equals('foo'));
...
core.List<api.OSPolicy> buildUnnamed13() => [buildOSPolicy(), buildOSPolicy()];
...
void main() {
  ...
  unittest.group(
    'obj-schema-InstanceOSPoliciesComplianceOSPolicyCompliance',
    () {
      unittest.test('to-json--from-json', () async {
