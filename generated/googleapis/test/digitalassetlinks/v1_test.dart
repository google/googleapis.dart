...
core.List<api.Statement> buildUnnamed3669() => [
      buildStatement(),
      buildStatement(),
    ];

void checkUnnamed3669(core.List<api.Statement> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatement(o[0]);
  checkStatement(o[1]);
}
...
api.ListResponse buildListResponse() {
  ...
  if (buildCounterListResponse < 3) {
    o.debugString = 'foo';
    o.errorCode = buildUnnamed3668();
    o.maxAge = 'foo';
    o.statements = buildUnnamed3669();
  }
  buildCounterListResponse--;
  return o;
}
...
void checkListResponse(api.ListResponse o) {
  ...
  if (buildCounterListResponse < 3) {
    ...
    checkUnnamed3668(o.errorCode!);
    unittest.expect(
      o.maxAge!,
      unittest.equals('foo'),
    );
    checkUnnamed3669(o.statements!);
  }
  buildCounterListResponse--;
}
