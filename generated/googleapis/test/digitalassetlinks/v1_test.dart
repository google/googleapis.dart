...
core.List<api.Statement> buildUnnamed3613() => [
      buildStatement(),
      buildStatement(),
    ];

void checkUnnamed3613(core.List<api.Statement> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatement(o[0]);
  checkStatement(o[1]);
}
...
api.ListResponse buildListResponse() {
  ...
  if (buildCounterListResponse < 3) {
    o.debugString = 'foo';
    o.errorCode = buildUnnamed3612();
    o.maxAge = 'foo';
    o.statements = buildUnnamed3613();
  }
  buildCounterListResponse--;
  return o;
}
...
void checkListResponse(api.ListResponse o) {
  ...
  if (buildCounterListResponse < 3) {
    ...
    checkUnnamed3612(o.errorCode!);
    unittest.expect(
      o.maxAge!,
      unittest.equals('foo'),
    );
    checkUnnamed3613(o.statements!);
  }
  buildCounterListResponse--;
}
