...
checkUnnamed2608(core.List<api.Statement> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatement(o[0]);
  checkStatement(o[1]);
}
...
buildListResponse() {
  ...
  if (buildCounterListResponse < 3) {
    o.debugString = "foo";
    o.errorCode = buildUnnamed2607();
    o.maxAge = "foo";
    o.statements = buildUnnamed2608();
  }
  buildCounterListResponse--;
  return o;
}
...
checkListResponse(api.ListResponse o) {
  ...
  if (buildCounterListResponse < 3) {
    unittest.expect(o.debugString, unittest.equals('foo'));
    checkUnnamed2607(o.errorCode);
    unittest.expect(o.maxAge, unittest.equals('foo'));
    checkUnnamed2608(o.statements);
  }
  buildCounterListResponse--;
}
