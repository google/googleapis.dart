...
core.List<core.String> buildUnnamed1253() => [
      'foo',
      'foo',
    ];

void checkUnnamed1253(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.Statement> buildUnnamed1254() => [
      buildStatement(),
      buildStatement(),
    ];

void checkUnnamed1254(core.List<api.Statement> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatement(o[0]);
  checkStatement(o[1]);
}
...
api.ListResponse buildListResponse() {
  ...
  if (buildCounterListResponse < 3) {
    o.debugString = 'foo';
    o.errorCode = buildUnnamed1253();
    o.maxAge = 'foo';
    o.statements = buildUnnamed1254();
  }
  buildCounterListResponse--;
  return o;
}
...
void checkListResponse(api.ListResponse o) {
  ...
  if (buildCounterListResponse < 3) {
    ...
    checkUnnamed1253(o.errorCode!);
    unittest.expect(
      o.maxAge!,
      unittest.equals('foo'),
    );
    checkUnnamed1254(o.statements!);
  }
  buildCounterListResponse--;
}
