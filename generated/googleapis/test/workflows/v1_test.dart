...
core.List<api.Workflow> buildUnnamed3() => [buildWorkflow(), buildWorkflow()];

void checkUnnamed3(core.List<api.Workflow> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWorkflow(o[0]);
  checkWorkflow(o[1]);
}

core.int buildCounterListWorkflowRevisionsResponse = 0;
api.ListWorkflowRevisionsResponse buildListWorkflowRevisionsResponse() {
  final o = api.ListWorkflowRevisionsResponse();
  buildCounterListWorkflowRevisionsResponse++;
  if (buildCounterListWorkflowRevisionsResponse < 3) {
    o.nextPageToken = 'foo';
    o.workflows = buildUnnamed3();
  }
  buildCounterListWorkflowRevisionsResponse--;
  return o;
}

void checkListWorkflowRevisionsResponse(api.ListWorkflowRevisionsResponse o) {
  buildCounterListWorkflowRevisionsResponse++;
  if (buildCounterListWorkflowRevisionsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed3(o.workflows!);
  }
  buildCounterListWorkflowRevisionsResponse--;
}
...
core.List<api.Workflow> buildUnnamed5() => [buildWorkflow(), buildWorkflow()];

void checkUnnamed5(core.List<api.Workflow> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWorkflow(o[0]);
  checkWorkflow(o[1]);
}
...
api.Workflow buildWorkflow() {
  ...
  if (buildCounterWorkflow < 3) {
    o.allKmsKeys = buildUnnamed12();
    o.allKmsKeysVersions = buildUnnamed13();
    o.callLogLevel = 'foo';
    o.createTime = 'foo';
    o.cryptoKeyName = 'foo';
...
void checkWorkflow(api.Workflow o) {
  buildCounterWorkflow++;
  if (buildCounterWorkflow < 3) {
    checkUnnamed12(o.allKmsKeys!);
    checkUnnamed13(o.allKmsKeysVersions!);
    ...
    unittest.expect(o.executionHistoryLevel!, unittest.equals('foo'));
...
void main() {
  ...
  unittest.group('obj-schema-ListWorkflowRevisionsResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildListWorkflowRevisionsResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListWorkflowRevisionsResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkListWorkflowRevisionsResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-StateError', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.StateError.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkStateError(od);
    });
  ...
  unittest.group('obj-schema-Workflow', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Workflow.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkWorkflow(od);
    });
  ...
  unittest.group('resource-ProjectsLocationsWorkflowsResource', () {
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Workflow.fromJson(
    ...
    unittest.test('method--listRevisions', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final resp = convert.json.encode(
            buildListWorkflowRevisionsResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      ...
      checkListWorkflowRevisionsResponse(
        response as api.ListWorkflowRevisionsResponse,
      );
    });
