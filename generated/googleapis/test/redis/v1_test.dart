...
checkUnnamed2112(core.Map<core.String, api.GoogleCloudRedisV1ZoneMetadata> o) {
...
buildGoogleCloudRedisV1LocationMetadata() {
  ...
  if (buildCounterGoogleCloudRedisV1LocationMetadata < 3) {
    o.availableZones = buildUnnamed2112();
  }
  buildCounterGoogleCloudRedisV1LocationMetadata--;
  return o;
}
...
checkGoogleCloudRedisV1LocationMetadata(
  ...
  buildCounterGoogleCloudRedisV1LocationMetadata++;
  if (buildCounterGoogleCloudRedisV1LocationMetadata < 3) {
    checkUnnamed2112(o.availableZones);
  }
  buildCounterGoogleCloudRedisV1LocationMetadata--;
}
...
buildInstance() {
  ...
  if (buildCounterInstance < 3) {
    ...
    o.port = 42;
    o.redisConfigs = buildUnnamed2114();
    o.redisVersion = "foo";
...
checkInstance(api.Instance o) {
  ...
  if (buildCounterInstance < 3) {
    ...
    checkUnnamed2114(o.redisConfigs);
...
checkUnnamed2115(core.List<api.Instance> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInstance(o[0]);
  checkInstance(o[1]);
}
...
buildListInstancesResponse() {
  ...
  if (buildCounterListInstancesResponse < 3) {
    o.instances = buildUnnamed2115();
    o.nextPageToken = "foo";
    o.unreachable = buildUnnamed2116();
  }
  buildCounterListInstancesResponse--;
  return o;
}
...
checkListInstancesResponse(api.ListInstancesResponse o) {
  buildCounterListInstancesResponse++;
  if (buildCounterListInstancesResponse < 3) {
    checkUnnamed2115(o.instances);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed2116(o.unreachable);
  }
  buildCounterListInstancesResponse--;
}
...
checkUnnamed2117(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
checkUnnamed2118(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkUnnamed2119(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
buildLocation() {
  ...
  if (buildCounterLocation < 3) {
    o.displayName = "foo";
    o.labels = buildUnnamed2119();
    o.locationId = "foo";
    o.metadata = buildUnnamed2120();
    o.name = "foo";
  }
  buildCounterLocation--;
  return o;
...
checkLocation(api.Location o) {
  ...
  if (buildCounterLocation < 3) {
    unittest.expect(o.displayName, unittest.equals('foo'));
    checkUnnamed2119(o.labels);
    unittest.expect(o.locationId, unittest.equals('foo'));
    checkUnnamed2120(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
  }
  buildCounterLocation--;
}
...
buildUnnamed2124() {
  ...
  o.add(buildUnnamed2123());
  o.add(buildUnnamed2123());
  return o;
}

checkUnnamed2124(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2123(o[0]);
  checkUnnamed2123(o[1]);
}
