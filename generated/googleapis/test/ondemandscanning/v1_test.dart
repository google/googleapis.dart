...
core.List<api.File> buildUnnamed17() => [
      buildFile(),
      buildFile(),
    ];
...
core.List<api.Layer> buildUnnamed27() => [
      buildLayer(),
      buildLayer(),
    ];
...
core.List<api.Subject> buildUnnamed29() => [
      buildSubject(),
      buildSubject(),
    ];
...
core.List<api.Subject> buildUnnamed30() => [
      buildSubject(),
      buildSubject(),
    ];
...
core.List<api.Location> buildUnnamed43() => [
      buildLocation(),
      buildLocation(),
    ];
...
core.List<api.Subject> buildUnnamed55() => [
      buildSubject(),
      buildSubject(),
    ];
...
core.List<api.Material> buildUnnamed59() => [
      buildMaterial(),
      buildMaterial(),
    ];
...
core.List<api.Category> buildUnnamed76() => [
      buildCategory(),
      buildCategory(),
    ];
