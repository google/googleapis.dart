...
core.List<api.Artifact> buildUnnamed6() => [
      buildArtifact(),
      buildArtifact(),
    ];

void checkUnnamed6(core.List<api.Artifact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkArtifact(o[0]);
  checkArtifact(o[1]);
}

core.List<api.Command> buildUnnamed7() => [
      buildCommand(),
      buildCommand(),
    ];

void checkUnnamed7(core.List<api.Command> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCommand(o[0]);
  checkCommand(o[1]);
}
...
api.BuildProvenance buildBuildProvenance() {
  ...
  if (buildCounterBuildProvenance < 3) {
    o.buildOptions = buildUnnamed5();
    o.builderVersion = 'foo';
    o.builtArtifacts = buildUnnamed6();
    o.commands = buildUnnamed7();
    o.createTime = 'foo';
    o.creator = 'foo';
    o.endTime = 'foo';
    o.id = 'foo';
...
void checkBuildProvenance(api.BuildProvenance o) {
  buildCounterBuildProvenance++;
  if (buildCounterBuildProvenance < 3) {
    checkUnnamed5(o.buildOptions!);
    unittest.expect(
      o.builderVersion!,
      unittest.equals('foo'),
    );
    checkUnnamed6(o.builtArtifacts!);
    checkUnnamed7(o.commands!);
    unittest.expect(
      o.createTime!,
      unittest.equals('foo'),
    );
...
core.List<api.NonCompliantFile> buildUnnamed11() => [
      buildNonCompliantFile(),
      buildNonCompliantFile(),
    ];

void checkUnnamed11(core.List<api.NonCompliantFile> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ComplianceOccurrence buildComplianceOccurrence() {
  ...
  if (buildCounterComplianceOccurrence < 3) {
    ...
    o.nonCompliantFiles = buildUnnamed11();
  }
  buildCounterComplianceOccurrence--;
  return o;
}
...
void checkComplianceOccurrence(api.ComplianceOccurrence o) {
  ...
  if (buildCounterComplianceOccurrence < 3) {
    ...
    checkUnnamed11(o.nonCompliantFiles!);
  }
  buildCounterComplianceOccurrence--;
}
...
api.DiscoveryOccurrence buildDiscoveryOccurrence() {
  ...
  if (buildCounterDiscoveryOccurrence < 3) {
    ...
    o.analysisError = buildUnnamed13();
...
void checkDiscoveryOccurrence(api.DiscoveryOccurrence o) {
  ...
  if (buildCounterDiscoveryOccurrence < 3) {
    ...
    checkUnnamed13(o.analysisError!);
    unittest.expect(
      o.analysisStatus!,
      unittest.equals('foo'),
    );
...
core.List<api.EnvelopeSignature> buildUnnamed14() => [
      buildEnvelopeSignature(),
      buildEnvelopeSignature(),
    ];

void checkUnnamed14(core.List<api.EnvelopeSignature> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Hash> buildUnnamed15() => [
      buildHash(),
      buildHash(),
    ];

void checkUnnamed15(core.List<api.Hash> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHash(o[0]);
  checkHash(o[1]);
}
...
api.GrafeasV1SlsaProvenanceZeroTwoSlsaInvocation
  ...
  if (buildCounterGrafeasV1SlsaProvenanceZeroTwoSlsaInvocation < 3) {
    ...
    o.environment = buildUnnamed18();
    o.parameters = buildUnnamed19();
  }
  buildCounterGrafeasV1SlsaProvenanceZeroTwoSlsaInvocation--;
  return o;
}
...
void checkGrafeasV1SlsaProvenanceZeroTwoSlsaInvocation(
  ...
  if (buildCounterGrafeasV1SlsaProvenanceZeroTwoSlsaInvocation < 3) {
    ...
    checkUnnamed18(o.environment!);
    checkUnnamed19(o.parameters!);
  }
  buildCounterGrafeasV1SlsaProvenanceZeroTwoSlsaInvocation--;
}
...
core.List<api.Occurrence> buildUnnamed25() => [
      buildOccurrence(),
      buildOccurrence(),
    ];

void checkUnnamed25(core.List<api.Occurrence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOccurrence(o[0]);
  checkOccurrence(o[1]);
}
...
core.List<api.BinarySourceInfo> buildUnnamed29() => [
      buildBinarySourceInfo(),
      buildBinarySourceInfo(),
    ];

void checkUnnamed29(core.List<api.BinarySourceInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinarySourceInfo(o[0]);
  checkBinarySourceInfo(o[1]);
}

core.List<api.LanguagePackageDependency> buildUnnamed30() => [
      buildLanguagePackageDependency(),
      buildLanguagePackageDependency(),
    ];

void checkUnnamed30(core.List<api.LanguagePackageDependency> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLanguagePackageDependency(o[0]);
  checkLanguagePackageDependency(o[1]);
}

core.List<api.FileLocation> buildUnnamed31() => [
      buildFileLocation(),
      buildFileLocation(),
    ];

void checkUnnamed31(core.List<api.FileLocation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PackageData buildPackageData() {
  ...
  if (buildCounterPackageData < 3) {
    o.architecture = 'foo';
    o.binarySourceInfo = buildUnnamed29();
    o.binaryVersion = buildPackageVersion();
    o.cpeUri = 'foo';
    o.dependencyChain = buildUnnamed30();
    o.fileLocation = buildUnnamed31();
    o.hashDigest = 'foo';
...
void checkPackageData(api.PackageData o) {
  ...
  if (buildCounterPackageData < 3) {
    ...
    checkUnnamed29(o.binarySourceInfo!);
    checkPackageVersion(o.binaryVersion!);
    unittest.expect(
      o.cpeUri!,
      unittest.equals('foo'),
    );
    checkUnnamed30(o.dependencyChain!);
    checkUnnamed31(o.fileLocation!);
    unittest.expect(
      o.hashDigest!,
      unittest.equals('foo'),
    );
...
core.List<api.GrafeasV1FileLocation> buildUnnamed33() => [
      buildGrafeasV1FileLocation(),
      buildGrafeasV1FileLocation(),
    ];

void checkUnnamed33(core.List<api.GrafeasV1FileLocation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Recipe buildRecipe() {
  ...
  if (buildCounterRecipe < 3) {
    o.arguments = buildUnnamed36();
    o.definedInMaterial = 'foo';
    o.entryPoint = 'foo';
    o.environment = buildUnnamed38();
    o.type = 'foo';
  }
  buildCounterRecipe--;
  return o;
...
core.List<api.EnvelopeSignature> buildUnnamed39() => [
      buildEnvelopeSignature(),
      buildEnvelopeSignature(),
    ];

void checkUnnamed39(core.List<api.EnvelopeSignature> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEnvelopeSignature(o[0]);
  checkEnvelopeSignature(o[1]);
}
...
void checkSBOMReferenceOccurrence(api.SBOMReferenceOccurrence o) {
  ...
  if (buildCounterSBOMReferenceOccurrence < 3) {
    ...
    checkUnnamed39(o.signatures!);
  }
  buildCounterSBOMReferenceOccurrence--;
}

core.List<api.Subject> buildUnnamed40() => [
      buildSubject(),
      buildSubject(),
    ];
...
core.List<api.Material> buildUnnamed42() => [
      buildMaterial(),
      buildMaterial(),
    ];

void checkUnnamed42(core.List<api.Material> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMaterial(o[0]);
  checkMaterial(o[1]);
}
...
core.List<api.GrafeasV1SlsaProvenanceZeroTwoSlsaMaterial> buildUnnamed44() => [
      buildGrafeasV1SlsaProvenanceZeroTwoSlsaMaterial(),
      buildGrafeasV1SlsaProvenanceZeroTwoSlsaMaterial(),
    ];
...
api.SlsaRecipe buildSlsaRecipe() {
  ...
  if (buildCounterSlsaRecipe < 3) {
    o.arguments = buildUnnamed45();
    o.definedInMaterial = 'foo';
    o.entryPoint = 'foo';
    o.environment = buildUnnamed46();
    o.type = 'foo';
  }
  buildCounterSlsaRecipe--;
  return o;
...
core.List<api.SourceContext> buildUnnamed47() => [
      buildSourceContext(),
      buildSourceContext(),
    ];

void checkUnnamed47(core.List<api.SourceContext> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSourceContext(o[0]);
  checkSourceContext(o[1]);
}

core.Map<core.String, api.FileHashes> buildUnnamed48() => {
      'x': buildFileHashes(),
      'y': buildFileHashes(),
    };

void checkUnnamed48(core.Map<core.String, api.FileHashes> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFileHashes(o['x']!);
  checkFileHashes(o['y']!);
}
...
api.Source buildSource() {
  ...
  if (buildCounterSource < 3) {
    o.additionalContexts = buildUnnamed47();
    o.artifactStorageSourceUri = 'foo';
    o.context = buildSourceContext();
    o.fileHashes = buildUnnamed48();
  }
  buildCounterSource--;
  return o;
}
...
void checkSource(api.Source o) {
  buildCounterSource++;
  if (buildCounterSource < 3) {
    checkUnnamed47(o.additionalContexts!);
    unittest.expect(
      o.artifactStorageSourceUri!,
      unittest.equals('foo'),
    );
    checkSourceContext(o.context!);
    checkUnnamed48(o.fileHashes!);
  }
  buildCounterSource--;
}
...
core.List<api.RelatedUrl> buildUnnamed55() => [
      buildRelatedUrl(),
      buildRelatedUrl(),
    ];

void checkUnnamed55(core.List<api.RelatedUrl> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRelatedUrl(o[0]);
  checkRelatedUrl(o[1]);
}

core.List<api.Remediation> buildUnnamed56() => [
      buildRemediation(),
      buildRemediation(),
    ];

void checkUnnamed56(core.List<api.Remediation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.VexAssessment buildVexAssessment() {
  ...
  if (buildCounterVexAssessment < 3) {
    o.cve = 'foo';
    o.impacts = buildUnnamed54();
    o.justification = buildJustification();
    o.noteName = 'foo';
    o.relatedUris = buildUnnamed55();
    o.remediations = buildUnnamed56();
    o.state = 'foo';
  }
  buildCounterVexAssessment--;
  return o;
...
void checkVexAssessment(api.VexAssessment o) {
  ...
  if (buildCounterVexAssessment < 3) {
    ...
    checkUnnamed54(o.impacts!);
    checkJustification(o.justification!);
    unittest.expect(
      o.noteName!,
      unittest.equals('foo'),
    );
    checkUnnamed55(o.relatedUris!);
    checkUnnamed56(o.remediations!);
    unittest.expect(
      o.state!,
      unittest.equals('foo'),
    );
...
core.List<api.PackageIssue> buildUnnamed57() => [
      buildPackageIssue(),
      buildPackageIssue(),
    ];

void checkUnnamed57(core.List<api.PackageIssue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPackageIssue(o[0]);
  checkPackageIssue(o[1]);
}

core.List<api.RelatedUrl> buildUnnamed58() => [
      buildRelatedUrl(),
      buildRelatedUrl(),
    ];

void checkUnnamed58(core.List<api.RelatedUrl> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRelatedUrl(o[0]);
  checkRelatedUrl(o[1]);
}
...
api.VulnerabilityOccurrence buildVulnerabilityOccurrence() {
  ...
  if (buildCounterVulnerabilityOccurrence < 3) {
    ...
    o.packageIssue = buildUnnamed57();
    o.relatedUrls = buildUnnamed58();
    o.severity = 'foo';
...
void checkVulnerabilityOccurrence(api.VulnerabilityOccurrence o) {
  ...
  if (buildCounterVulnerabilityOccurrence < 3) {
    ...
    checkUnnamed57(o.packageIssue!);
    checkUnnamed58(o.relatedUrls!);
    unittest.expect(
      o.severity!,
      unittest.equals('foo'),
    );
...
core.List<api.Category> buildUnnamed59() => [
      buildCategory(),
      buildCategory(),
    ];

void checkUnnamed59(core.List<api.Category> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCategory(o[0]);
  checkCategory(o[1]);
}
...
api.WindowsUpdate buildWindowsUpdate() {
  ...
  if (buildCounterWindowsUpdate < 3) {
    o.categories = buildUnnamed59();
    o.description = 'foo';
    o.identity = buildIdentity();
    o.kbArticleIds = buildUnnamed60();
...
void checkWindowsUpdate(api.WindowsUpdate o) {
  buildCounterWindowsUpdate++;
  if (buildCounterWindowsUpdate < 3) {
    checkUnnamed59(o.categories!);
    unittest.expect(
      o.description!,
      unittest.equals('foo'),
    );
    checkIdentity(o.identity!);
    checkUnnamed60(o.kbArticleIds!);
    unittest.expect(
