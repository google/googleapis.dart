...
import 'package:googleapis/cloudtasks/v2beta3.dart' as api;
...
api.AppEngineHttpQueue buildAppEngineHttpQueue() {
  final o = api.AppEngineHttpQueue();
...
void checkAppEngineHttpQueue(api.AppEngineHttpQueue o) {
  buildCounterAppEngineHttpQueue++;
  if (buildCounterAppEngineHttpQueue < 3) {
...
void main() {
  unittest.group('obj-schema-AppEngineHttpQueue', () {
    unittest.test('to-json--from-json', () async {
      final o = buildAppEngineHttpQueue();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.AppEngineHttpQueue.fromJson(
