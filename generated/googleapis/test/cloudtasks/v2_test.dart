...
core.List<api.Location> buildUnnamed3270() => [
      buildLocation(),
      buildLocation(),
    ];

void checkUnnamed3270(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
core.List<api.Queue> buildUnnamed3271() => [
      buildQueue(),
      buildQueue(),
    ];

void checkUnnamed3271(core.List<api.Queue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQueue(o[0]);
  checkQueue(o[1]);
}
...
void checkListQueuesResponse(api.ListQueuesResponse o) {
  ...
  if (buildCounterListQueuesResponse < 3) {
    ...
    checkUnnamed3271(o.queues!);
  }
  buildCounterListQueuesResponse--;
}

core.List<api.Task> buildUnnamed3272() => [
      buildTask(),
      buildTask(),
    ];

void checkUnnamed3272(core.List<api.Task> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTask(o[0]);
  checkTask(o[1]);
}
...
core.Map<core.String, core.Object> buildUnnamed3274() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed3274(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Binding> buildUnnamed3275() => [
      buildBinding(),
      buildBinding(),
    ];

void checkUnnamed3275(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
core.Map<core.String, core.Object> buildUnnamed3276() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed3276(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed3277() => [
      buildUnnamed3276(),
      buildUnnamed3276(),
    ];

void checkUnnamed3277(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed3276(o[0]);
  checkUnnamed3276(o[1]);
}
