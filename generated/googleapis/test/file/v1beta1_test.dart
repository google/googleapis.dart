...
import 'package:googleapis/file/v1beta1.dart' as api;
...
api.DirectoryServicesConfig buildDirectoryServicesConfig() {
  ...
  if (buildCounterDirectoryServicesConfig < 3) {
    ...
    o.managedActiveDirectory = buildManagedActiveDirectoryConfig();
  }
  buildCounterDirectoryServicesConfig--;
  return o;
}
...
void checkDirectoryServicesConfig(api.DirectoryServicesConfig o) {
  ...
  if (buildCounterDirectoryServicesConfig < 3) {
    ...
    checkManagedActiveDirectoryConfig(o.managedActiveDirectory!);
  }
  buildCounterDirectoryServicesConfig--;
}
...
void checkInstance(api.Instance o) {
  ...
  if (buildCounterInstance < 3) {
    ...
    unittest.expect(o.maxShareCount!, unittest.equals('foo'));
    unittest.expect(o.multiShareEnabled!, unittest.isTrue);
    unittest.expect(o.name!, unittest.equals('foo'));
...
core.List<api.Share> buildUnnamed15() => [buildShare(), buildShare()];

void checkUnnamed15(core.List<api.Share> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkShare(o[0]);
  checkShare(o[1]);
}
...
core.int buildCounterListSharesResponse = 0;
api.ListSharesResponse buildListSharesResponse() {
  final o = api.ListSharesResponse();
  buildCounterListSharesResponse++;
  if (buildCounterListSharesResponse < 3) {
    o.nextPageToken = 'foo';
    o.shares = buildUnnamed15();
...
void checkListSharesResponse(api.ListSharesResponse o) {
  buildCounterListSharesResponse++;
  if (buildCounterListSharesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed15(o.shares!);
    checkUnnamed16(o.unreachable!);
  }
  buildCounterListSharesResponse--;
}

core.List<api.Snapshot> buildUnnamed17() => [buildSnapshot(), buildSnapshot()];

void checkUnnamed17(core.List<api.Snapshot> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSnapshot(o[0]);
  checkSnapshot(o[1]);
}
...
core.int buildCounterManagedActiveDirectoryConfig = 0;
api.ManagedActiveDirectoryConfig buildManagedActiveDirectoryConfig() {
  final o = api.ManagedActiveDirectoryConfig();
  buildCounterManagedActiveDirectoryConfig++;
  if (buildCounterManagedActiveDirectoryConfig < 3) {
    o.computer = 'foo';
    o.domain = 'foo';
  }
  buildCounterManagedActiveDirectoryConfig--;
...
void checkManagedActiveDirectoryConfig(api.ManagedActiveDirectoryConfig o) {
  buildCounterManagedActiveDirectoryConfig++;
  if (buildCounterManagedActiveDirectoryConfig < 3) {
    unittest.expect(o.computer!, unittest.equals('foo'));
    unittest.expect(o.domain!, unittest.equals('foo'));
  }
  buildCounterManagedActiveDirectoryConfig--;
}
...
api.NfsExportOptions buildNfsExportOptions() {
  ...
  if (buildCounterNfsExportOptions < 3) {
    ...
    o.anonGid = 'foo';
    o.anonUid = 'foo';
    o.ipRanges = buildUnnamed23();
    o.network = 'foo';
    o.securityFlavors = buildUnnamed24();
    o.squashMode = 'foo';
  }
  buildCounterNfsExportOptions--;
  return o;
...
void checkNfsExportOptions(api.NfsExportOptions o) {
  ...
  if (buildCounterNfsExportOptions < 3) {
    ...
    checkUnnamed23(o.ipRanges!);
    unittest.expect(o.network!, unittest.equals('foo'));
    checkUnnamed24(o.securityFlavors!);
...
void checkReplicaConfig(api.ReplicaConfig o) {
  ...
  if (buildCounterReplicaConfig < 3) {
    ...
    unittest.expect(o.peerInstance!, unittest.equals('foo'));
    unittest.expect(o.state!, unittest.equals('foo'));
    checkUnnamed27(o.stateReasons!);
    unittest.expect(o.stateUpdateTime!, unittest.equals('foo'));
  }
  buildCounterReplicaConfig--;
}

core.List<api.ReplicaConfig> buildUnnamed28() => [
  buildReplicaConfig(),
  buildReplicaConfig(),
];

void checkUnnamed28(core.List<api.ReplicaConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.NfsExportOptions> buildUnnamed30() => [
  buildNfsExportOptions(),
  buildNfsExportOptions(),
];

void checkUnnamed30(core.List<api.NfsExportOptions> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNfsExportOptions(o[0]);
  checkNfsExportOptions(o[1]);
}

core.int buildCounterShare = 0;
api.Share buildShare() {
  final o = api.Share();
  buildCounterShare++;
  if (buildCounterShare < 3) {
    o.backup = 'foo';
    o.capacityGb = 'foo';
    o.createTime = 'foo';
    o.description = 'foo';
    ...
    o.mountName = 'foo';
    o.name = 'foo';
    o.nfsExportOptions = buildUnnamed30();
    o.state = 'foo';
  }
  buildCounterShare--;
  return o;
...
void checkShare(api.Share o) {
  ...
  if (buildCounterShare < 3) {
    ...
    unittest.expect(o.mountName!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed30(o.nfsExportOptions!);
    unittest.expect(o.state!, unittest.equals('foo'));
  }
  buildCounterShare--;
}
...
void main() {
  ...
  unittest.group('obj-schema-ListSharesResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildListSharesResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListSharesResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkListSharesResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-ManagedActiveDirectoryConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildManagedActiveDirectoryConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ManagedActiveDirectoryConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkManagedActiveDirectoryConfig(od);
    });
  });
  ...
  unittest.group('obj-schema-Share', () {
    unittest.test('to-json--from-json', () async {
      final o = buildShare();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Share.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkShare(od);
    });
  ...
  unittest.group('resource-ProjectsLocationsInstancesSharesResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res =
          api.CloudFilestoreApi(mock).projects.locations.instances.shares;
      final arg_request = buildShare();
      final arg_parent = 'foo';
      final arg_shareId = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Share.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkShare(obj);
          ...
          unittest.expect(
            queryMap['shareId']!.first,
            unittest.equals(arg_shareId),
          );
          unittest.expect(
            queryMap['fields']!.first,
            unittest.equals(arg_$fields),
    ...
    unittest.test('method--get', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildShare());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.get(arg_name, $fields: arg_$fields);
      checkShare(response as api.Share);
    });
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildListSharesResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      ...
      checkListSharesResponse(response as api.ListSharesResponse);
    });
