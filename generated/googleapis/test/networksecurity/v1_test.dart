...
core.List<core.int> buildUnnamed25() => [42, 42];
...
core.List<api.UrlList> buildUnnamed59() => [buildUrlList(), buildUrlList()];
...
core.List<api.Source> buildUnnamed67() => [buildSource(), buildSource()];
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildListAddressGroupReferencesResponseAddressGroupReference();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.ListAddressGroupReferencesResponseAddressGroupReference
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
