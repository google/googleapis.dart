...
import 'package:googleapis/networksecurity/v1beta1.dart' as api;
...
buildGoogleCloudNetworksecurityV1beta1CertificateProvider() {
  final o = api.GoogleCloudNetworksecurityV1beta1CertificateProvider();
...
void checkGoogleCloudNetworksecurityV1beta1CertificateProvider(
  ...
  if (buildCounterGoogleCloudNetworksecurityV1beta1CertificateProvider < 3) {
    ...
    checkGoogleCloudNetworksecurityV1beta1GrpcEndpoint(o.grpcEndpoint!);
  }
  buildCounterGoogleCloudNetworksecurityV1beta1CertificateProvider--;
}
...
buildGoogleCloudNetworksecurityV1beta1GrpcEndpoint() {
  final o = api.GoogleCloudNetworksecurityV1beta1GrpcEndpoint();
...
core.List<api.SACAttachment> buildUnnamed83() => [
  buildSACAttachment(),
  buildSACAttachment(),
];

void checkUnnamed83(core.List<api.SACAttachment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListSACAttachmentsResponse buildListSACAttachmentsResponse() {
  ...
  if (buildCounterListSACAttachmentsResponse < 3) {
    o.nextPageToken = 'foo';
    o.sacAttachments = buildUnnamed83();
...
void checkListSACAttachmentsResponse(api.ListSACAttachmentsResponse o) {
  ...
  if (buildCounterListSACAttachmentsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed83(o.sacAttachments!);
    checkUnnamed84(o.unreachable!);
  }
  buildCounterListSACAttachmentsResponse--;
}

core.List<api.SACRealm> buildUnnamed85() => [buildSACRealm(), buildSACRealm()];

void checkUnnamed85(core.List<api.SACRealm> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSACRealm(o[0]);
  checkSACRealm(o[1]);
}
...
void checkListSACRealmsResponse(api.ListSACRealmsResponse o) {
  ...
  if (buildCounterListSACRealmsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed85(o.sacRealms!);
    checkUnnamed86(o.unreachable!);
  }
  buildCounterListSACRealmsResponse--;
}

core.List<api.SecurityProfileGroup> buildUnnamed87() => [
  buildSecurityProfileGroup(),
  buildSecurityProfileGroup(),
];

void checkUnnamed87(core.List<api.SecurityProfileGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListSecurityProfileGroupsResponse buildListSecurityProfileGroupsResponse() {
  ...
  if (buildCounterListSecurityProfileGroupsResponse < 3) {
    o.nextPageToken = 'foo';
    o.securityProfileGroups = buildUnnamed87();
  }
  buildCounterListSecurityProfileGroupsResponse--;
  return o;
}
...
void checkListSecurityProfileGroupsResponse(
  ...
  if (buildCounterListSecurityProfileGroupsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed87(o.securityProfileGroups!);
  }
  buildCounterListSecurityProfileGroupsResponse--;
}

core.List<api.SecurityProfile> buildUnnamed88() => [
  buildSecurityProfile(),
  buildSecurityProfile(),
];

void checkUnnamed88(core.List<api.SecurityProfile> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListSecurityProfilesResponse buildListSecurityProfilesResponse() {
  ...
  if (buildCounterListSecurityProfilesResponse < 3) {
    o.nextPageToken = 'foo';
    o.securityProfiles = buildUnnamed88();
  }
  buildCounterListSecurityProfilesResponse--;
  return o;
}
...
void checkListSecurityProfilesResponse(api.ListSecurityProfilesResponse o) {
  ...
  if (buildCounterListSecurityProfilesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed88(o.securityProfiles!);
  }
  buildCounterListSecurityProfilesResponse--;
}

core.List<api.ServerTlsPolicy> buildUnnamed89() => [
  buildServerTlsPolicy(),
  buildServerTlsPolicy(),
];

void checkUnnamed89(core.List<api.ServerTlsPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListServerTlsPoliciesResponse buildListServerTlsPoliciesResponse() {
  ...
  if (buildCounterListServerTlsPoliciesResponse < 3) {
    o.nextPageToken = 'foo';
    o.serverTlsPolicies = buildUnnamed89();
...
void checkListServerTlsPoliciesResponse(api.ListServerTlsPoliciesResponse o) {
  ...
  if (buildCounterListServerTlsPoliciesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed89(o.serverTlsPolicies!);
    checkUnnamed90(o.unreachable!);
  }
  buildCounterListServerTlsPoliciesResponse--;
}

core.List<api.TlsInspectionPolicy> buildUnnamed91() => [
  buildTlsInspectionPolicy(),
  buildTlsInspectionPolicy(),
];

void checkUnnamed91(core.List<api.TlsInspectionPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListTlsInspectionPoliciesResponse buildListTlsInspectionPoliciesResponse() {
  ...
  if (buildCounterListTlsInspectionPoliciesResponse < 3) {
    o.nextPageToken = 'foo';
    o.tlsInspectionPolicies = buildUnnamed91();
...
void checkListTlsInspectionPoliciesResponse(
  ...
  if (buildCounterListTlsInspectionPoliciesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed91(o.tlsInspectionPolicies!);
...
core.List<api.UrlList> buildUnnamed94() => [buildUrlList(), buildUrlList()];

void checkUnnamed94(core.List<api.UrlList> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUrlList(o[0]);
  checkUrlList(o[1]);
}
...
core.List<api.ValidationCA> buildUnnamed97() => [
  buildValidationCA(),
  buildValidationCA(),
];

void checkUnnamed97(core.List<api.ValidationCA> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValidationCA(o[0]);
  checkValidationCA(o[1]);
}
...
api.MTLSPolicy buildMTLSPolicy() {
  ...
  if (buildCounterMTLSPolicy < 3) {
    o.clientValidationCa = buildUnnamed97();
...
void checkMTLSPolicy(api.MTLSPolicy o) {
  buildCounterMTLSPolicy++;
  if (buildCounterMTLSPolicy < 3) {
    checkUnnamed97(o.clientValidationCa!);
...
core.List<api.MirroringDeploymentGroupDeployment> buildUnnamed102() => [
  buildMirroringDeploymentGroupDeployment(),
  buildMirroringDeploymentGroupDeployment(),
];

void checkUnnamed102(core.List<api.MirroringDeploymentGroupDeployment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MirroringDeploymentGroup buildMirroringDeploymentGroup() {
  ...
  if (buildCounterMirroringDeploymentGroup < 3) {
    o.connectedEndpointGroups = buildUnnamed99();
    o.createTime = 'foo';
    o.description = 'foo';
    o.labels = buildUnnamed100();
    o.locations = buildUnnamed101();
    o.name = 'foo';
    o.nestedDeployments = buildUnnamed102();
    o.network = 'foo';
    o.reconciling = true;
    o.state = 'foo';
    o.updateTime = 'foo';
...
void checkMirroringDeploymentGroup(api.MirroringDeploymentGroup o) {
  buildCounterMirroringDeploymentGroup++;
  if (buildCounterMirroringDeploymentGroup < 3) {
    checkUnnamed99(o.connectedEndpointGroups!);
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    checkUnnamed100(o.labels!);
    checkUnnamed101(o.locations!);
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed102(o.nestedDeployments!);
    unittest.expect(o.network!, unittest.equals('foo'));
    unittest.expect(o.reconciling!, unittest.isTrue);
    unittest.expect(o.state!, unittest.equals('foo'));
    unittest.expect(o.updateTime!, unittest.equals('foo'));
...
core.List<api.MirroringEndpointGroupAssociationDetails> buildUnnamed103() => [
...
api.MirroringEndpointGroup buildMirroringEndpointGroup() {
  ...
  if (buildCounterMirroringEndpointGroup < 3) {
    o.associations = buildUnnamed103();
    o.connectedDeploymentGroups = buildUnnamed104();
    o.createTime = 'foo';
    o.description = 'foo';
...
void checkMirroringEndpointGroup(api.MirroringEndpointGroup o) {
  buildCounterMirroringEndpointGroup++;
  if (buildCounterMirroringEndpointGroup < 3) {
    checkUnnamed103(o.associations!);
    checkUnnamed104(o.connectedDeploymentGroups!);
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
...
core.List<api.MirroringLocation> buildUnnamed107() => [
  buildMirroringLocation(),
  buildMirroringLocation(),
];

void checkUnnamed107(core.List<api.MirroringLocation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMirroringLocation(o[0]);
  checkMirroringLocation(o[1]);
}
...
api.MirroringEndpointGroupAssociation buildMirroringEndpointGroupAssociation() {
  ...
  if (buildCounterMirroringEndpointGroupAssociation < 3) {
    ...
    o.locations = buildUnnamed107();
    o.locationsDetails = buildUnnamed108();
    o.mirroringEndpointGroup = 'foo';
    o.name = 'foo';
    o.network = 'foo';
    o.reconciling = true;
...
void checkMirroringEndpointGroupAssociation(
  ...
  if (buildCounterMirroringEndpointGroupAssociation < 3) {
    ...
    checkUnnamed107(o.locations!);
    checkUnnamed108(o.locationsDetails!);
    unittest.expect(o.mirroringEndpointGroup!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.network!, unittest.equals('foo'));
    unittest.expect(o.reconciling!, unittest.isTrue);
...
core.List<api.MirroringLocation> buildUnnamed109() => [
  buildMirroringLocation(),
  buildMirroringLocation(),
];

void checkUnnamed109(core.List<api.MirroringLocation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMirroringLocation(o[0]);
  checkMirroringLocation(o[1]);
}
...
core.List<api.Destination> buildUnnamed113() => [
  buildDestination(),
  buildDestination(),
];

void checkUnnamed113(core.List<api.Destination> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDestination(o[0]);
  checkDestination(o[1]);
}

core.List<api.Source> buildUnnamed114() => [buildSource(), buildSource()];

void checkUnnamed114(core.List<api.Source> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSource(o[0]);
  checkSource(o[1]);
}
...
api.Rule buildRule() {
  ...
  if (buildCounterRule < 3) {
    o.destinations = buildUnnamed113();
    o.sources = buildUnnamed114();
  }
  buildCounterRule--;
  return o;
}
...
void checkRule(api.Rule o) {
  buildCounterRule++;
  if (buildCounterRule < 3) {
    checkUnnamed113(o.destinations!);
    checkUnnamed114(o.sources!);
  }
  buildCounterRule--;
}
...
api.SACAttachment buildSACAttachment() {
  ...
  if (buildCounterSACAttachment < 3) {
    ...
    o.sacRealm = 'foo';
    o.state = 'foo';
    o.symantecOptions = buildSACAttachmentSACAttachmentSymantecOptions();
    o.timeZone = 'foo';
    o.updateTime = 'foo';
  }
  buildCounterSACAttachment--;
...
void checkSACAttachment(api.SACAttachment o) {
  ...
  if (buildCounterSACAttachment < 3) {
    ...
    unittest.expect(o.state!, unittest.equals('foo'));
    checkSACAttachmentSACAttachmentSymantecOptions(o.symantecOptions!);
...
core.int buildCounterSACAttachmentSACAttachmentSymantecOptions = 0;
api.SACAttachmentSACAttachmentSymantecOptions
buildSACAttachmentSACAttachmentSymantecOptions() {
  final o = api.SACAttachmentSACAttachmentSymantecOptions();
  buildCounterSACAttachmentSACAttachmentSymantecOptions++;
  if (buildCounterSACAttachmentSACAttachmentSymantecOptions < 3) {
    o.symantecLocationName = 'foo';
    o.symantecSite = 'foo';
  }
  buildCounterSACAttachmentSACAttachmentSymantecOptions--;
  return o;
...
void checkSACAttachmentSACAttachmentSymantecOptions(
  api.SACAttachmentSACAttachmentSymantecOptions o,
) {
  buildCounterSACAttachmentSACAttachmentSymantecOptions++;
  if (buildCounterSACAttachmentSACAttachmentSymantecOptions < 3) {
    unittest.expect(o.symantecLocationName!, unittest.equals('foo'));
    unittest.expect(o.symantecSite!, unittest.equals('foo'));
  }
  buildCounterSACAttachmentSACAttachmentSymantecOptions--;
}
...
api.SACRealm buildSACRealm() {
  ...
  if (buildCounterSACRealm < 3) {
    ...
    o.state = 'foo';
    o.symantecOptions = buildSACRealmSACRealmSymantecOptions();
    o.updateTime = 'foo';
  }
  buildCounterSACRealm--;
  return o;
...
void checkSACRealm(api.SACRealm o) {
  ...
  if (buildCounterSACRealm < 3) {
    ...
    unittest.expect(o.state!, unittest.equals('foo'));
    checkSACRealmSACRealmSymantecOptions(o.symantecOptions!);
    unittest.expect(o.updateTime!, unittest.equals('foo'));
  }
  buildCounterSACRealm--;
}
...
core.int buildCounterSACRealmSACRealmSymantecOptions = 0;
api.SACRealmSACRealmSymantecOptions buildSACRealmSACRealmSymantecOptions() {
  final o = api.SACRealmSACRealmSymantecOptions();
  buildCounterSACRealmSACRealmSymantecOptions++;
  if (buildCounterSACRealmSACRealmSymantecOptions < 3) {
    o.availableSymantecSites = buildUnnamed117();
    o.secretPath = 'foo';
    o.symantecConnectionState = 'foo';
  }
  buildCounterSACRealmSACRealmSymantecOptions--;
  return o;
}

void checkSACRealmSACRealmSymantecOptions(
  api.SACRealmSACRealmSymantecOptions o,
) {
  buildCounterSACRealmSACRealmSymantecOptions++;
  if (buildCounterSACRealmSACRealmSymantecOptions < 3) {
    checkUnnamed117(o.availableSymantecSites!);
    unittest.expect(o.secretPath!, unittest.equals('foo'));
    unittest.expect(o.symantecConnectionState!, unittest.equals('foo'));
  }
  buildCounterSACRealmSACRealmSymantecOptions--;
}
...
api.Source buildSource() {
  ...
  if (buildCounterSource < 3) {
    o.ipBlocks = buildUnnamed121();
    o.principals = buildUnnamed122();
  }
  buildCounterSource--;
  return o;
}
...
void checkSource(api.Source o) {
  buildCounterSource++;
  if (buildCounterSource < 3) {
    checkUnnamed121(o.ipBlocks!);
    checkUnnamed122(o.principals!);
  }
  buildCounterSource--;
}
...
core.List<api.AntivirusOverride> buildUnnamed125() => [
  buildAntivirusOverride(),
  buildAntivirusOverride(),
];

void checkUnnamed125(core.List<api.AntivirusOverride> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAntivirusOverride(o[0]);
  checkAntivirusOverride(o[1]);
}

core.List<api.SeverityOverride> buildUnnamed126() => [
  buildSeverityOverride(),
  buildSeverityOverride(),
];

void checkUnnamed126(core.List<api.SeverityOverride> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSeverityOverride(o[0]);
  checkSeverityOverride(o[1]);
}

core.List<api.ThreatOverride> buildUnnamed127() => [
  buildThreatOverride(),
  buildThreatOverride(),
];

void checkUnnamed127(core.List<api.ThreatOverride> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ThreatPreventionProfile buildThreatPreventionProfile() {
  ...
  if (buildCounterThreatPreventionProfile < 3) {
    o.antivirusOverrides = buildUnnamed125();
    o.severityOverrides = buildUnnamed126();
    o.threatOverrides = buildUnnamed127();
  }
  buildCounterThreatPreventionProfile--;
  return o;
}
...
void checkThreatPreventionProfile(api.ThreatPreventionProfile o) {
  buildCounterThreatPreventionProfile++;
  if (buildCounterThreatPreventionProfile < 3) {
    checkUnnamed125(o.antivirusOverrides!);
    checkUnnamed126(o.severityOverrides!);
    checkUnnamed127(o.threatOverrides!);
  }
  buildCounterThreatPreventionProfile--;
}
...
api.TlsInspectionPolicy buildTlsInspectionPolicy() {
  ...
  if (buildCounterTlsInspectionPolicy < 3) {
    o.caPool = 'foo';
    o.createTime = 'foo';
    o.customTlsFeatures = buildUnnamed128();
    o.description = 'foo';
...
void checkTlsInspectionPolicy(api.TlsInspectionPolicy o) {
  ...
  if (buildCounterTlsInspectionPolicy < 3) {
    ...
    unittest.expect(o.createTime!, unittest.equals('foo'));
    checkUnnamed128(o.customTlsFeatures!);
    unittest.expect(o.description!, unittest.equals('foo'));
...
void main() {
  ...
  unittest.group(
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o = buildGoogleCloudNetworksecurityV1beta1CertificateProvider();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api
            .GoogleCloudNetworksecurityV1beta1CertificateProvider.fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
        checkGoogleCloudNetworksecurityV1beta1CertificateProvider(od);
      });
    },
  );

  unittest.group(
    'obj-schema-GoogleCloudNetworksecurityV1beta1GrpcEndpoint',
    () {
      unittest.test('to-json--from-json', () async {
        final o = buildGoogleCloudNetworksecurityV1beta1GrpcEndpoint();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudNetworksecurityV1beta1GrpcEndpoint.fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
        checkGoogleCloudNetworksecurityV1beta1GrpcEndpoint(od);
      });
    },
  );
  ...
  unittest.group('obj-schema-SACAttachmentSACAttachmentSymantecOptions', () {
    unittest.test('to-json--from-json', () async {
      final o = buildSACAttachmentSACAttachmentSymantecOptions();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.SACAttachmentSACAttachmentSymantecOptions.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkSACAttachmentSACAttachmentSymantecOptions(od);
    });
  });
  ...
  unittest.group('obj-schema-SACRealmSACRealmSymantecOptions', () {
    unittest.test('to-json--from-json', () async {
      final o = buildSACRealmSACRealmSymantecOptions();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.SACRealmSACRealmSymantecOptions.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkSACRealmSACRealmSymantecOptions(od);
    });
  });
  ...
  unittest.group('resource-ProjectsLocationsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.NetworkSecurityApi(mock).projects.locations;
      final arg_name = 'foo';
      final arg_extraLocationTypes = buildUnnamed130();
      final arg_filter = 'foo';
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_$fields = 'foo';
  ...
  unittest.group('resource-ProjectsLocationsSacAttachmentsResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res =
          api.NetworkSecurityApi(mock).projects.locations.sacAttachments;
