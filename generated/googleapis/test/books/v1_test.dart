...
core.List<api.Annotation> buildUnnamed4600() => [
      buildAnnotation(),
      buildAnnotation(),
    ];

void checkUnnamed4600(core.List<api.Annotation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAnnotation(o[0]);
  checkAnnotation(o[1]);
}
...
core.List<api.AnnotationsSummaryLayers> buildUnnamed4601() => [
      buildAnnotationsSummaryLayers(),
      buildAnnotationsSummaryLayers(),
    ];

void checkUnnamed4601(core.List<api.AnnotationsSummaryLayers> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkAnnotationsSummary(api.AnnotationsSummary o) {
  ...
  if (buildCounterAnnotationsSummary < 3) {
    ...
    checkUnnamed4601(o.layers!);
  }
  buildCounterAnnotationsSummary--;
}

core.List<api.GeoAnnotationdata> buildUnnamed4602() => [
      buildGeoAnnotationdata(),
      buildGeoAnnotationdata(),
    ];

void checkUnnamed4602(core.List<api.GeoAnnotationdata> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Bookshelf> buildUnnamed4603() => [
      buildBookshelf(),
      buildBookshelf(),
    ];

void checkUnnamed4603(core.List<api.Bookshelf> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBookshelf(o[0]);
  checkBookshelf(o[1]);
}
...
core.List<api.CategoryItems> buildUnnamed4604() => [
      buildCategoryItems(),
      buildCategoryItems(),
    ];

void checkUnnamed4604(core.List<api.CategoryItems> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.DictlayerdataDictWordsDerivatives> buildUnnamed4605() => [
      buildDictlayerdataDictWordsDerivatives(),
      buildDictlayerdataDictWordsDerivatives(),
    ];

void checkUnnamed4605(core.List<api.DictlayerdataDictWordsDerivatives> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.DictlayerdataDictWordsExamples> buildUnnamed4606() => [
      buildDictlayerdataDictWordsExamples(),
      buildDictlayerdataDictWordsExamples(),
    ];

void checkUnnamed4606(core.List<api.DictlayerdataDictWordsExamples> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.DictlayerdataDictWordsSensesConjugations> buildUnnamed4607() => [
      buildDictlayerdataDictWordsSensesConjugations(),
      buildDictlayerdataDictWordsSensesConjugations(),
    ];

void checkUnnamed4607(
...
void checkDictlayerdataDictWordsSensesDefinitions(
  ...
  if (buildCounterDictlayerdataDictWordsSensesDefinitions < 3) {
    ...
    checkUnnamed4608(o.examples!);
  }
  buildCounterDictlayerdataDictWordsSensesDefinitions--;
}

core.List<api.DictlayerdataDictWordsSensesDefinitions> buildUnnamed4609() => [
      buildDictlayerdataDictWordsSensesDefinitions(),
      buildDictlayerdataDictWordsSensesDefinitions(),
    ];
...
core.List<api.DictlayerdataDictWordsSensesSynonyms> buildUnnamed4610() => [
      buildDictlayerdataDictWordsSensesSynonyms(),
      buildDictlayerdataDictWordsSensesSynonyms(),
    ];

void checkUnnamed4610(core.List<api.DictlayerdataDictWordsSensesSynonyms> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkDictlayerdataDictWordsSenses(api.DictlayerdataDictWordsSenses o) {
  buildCounterDictlayerdataDictWordsSenses++;
  if (buildCounterDictlayerdataDictWordsSenses < 3) {
    checkUnnamed4607(o.conjugations!);
    checkUnnamed4609(o.definitions!);
    unittest.expect(
      o.partOfSpeech!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed4610(o.synonyms!);
  }
  buildCounterDictlayerdataDictWordsSenses--;
}

core.List<api.DictlayerdataDictWordsSenses> buildUnnamed4611() => [
      buildDictlayerdataDictWordsSenses(),
      buildDictlayerdataDictWordsSenses(),
    ];

void checkUnnamed4611(core.List<api.DictlayerdataDictWordsSenses> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DictlayerdataDictWords buildDictlayerdataDictWords() {
  ...
  if (buildCounterDictlayerdataDictWords < 3) {
    o.derivatives = buildUnnamed4605();
    o.examples = buildUnnamed4606();
    o.senses = buildUnnamed4611();
...
void checkDictlayerdataDictWords(api.DictlayerdataDictWords o) {
  buildCounterDictlayerdataDictWords++;
  if (buildCounterDictlayerdataDictWords < 3) {
    checkUnnamed4605(o.derivatives!);
    checkUnnamed4606(o.examples!);
    checkUnnamed4611(o.senses!);
    checkDictlayerdataDictWordsSource(o.source!);
  }
  buildCounterDictlayerdataDictWords--;
}

core.List<api.DictlayerdataDictWords> buildUnnamed4612() => [
      buildDictlayerdataDictWords(),
      buildDictlayerdataDictWords(),
    ];

void checkUnnamed4612(core.List<api.DictlayerdataDictWords> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Volume> buildUnnamed4613() => [
      buildVolume(),
      buildVolume(),
    ];

void checkUnnamed4613(core.List<api.Volume> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVolume(o[0]);
  checkVolume(o[1]);
}
...
void checkDiscoveryclustersClusters(api.DiscoveryclustersClusters o) {
  ...
  if (buildCounterDiscoveryclustersClusters < 3) {
    ...
    checkUnnamed4613(o.volumes!);
  }
  buildCounterDiscoveryclustersClusters--;
}

core.List<api.DiscoveryclustersClusters> buildUnnamed4614() => [
      buildDiscoveryclustersClusters(),
      buildDiscoveryclustersClusters(),
    ];

void checkUnnamed4614(core.List<api.DiscoveryclustersClusters> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.DownloadAccessRestriction> buildUnnamed4615() => [
      buildDownloadAccessRestriction(),
      buildDownloadAccessRestriction(),
    ];

void checkUnnamed4615(core.List<api.DownloadAccessRestriction> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DownloadAccesses buildDownloadAccesses() {
  ...
  if (buildCounterDownloadAccesses < 3) {
    o.downloadAccessList = buildUnnamed4615();
    o.kind = 'foo';
  }
  buildCounterDownloadAccesses--;
  return o;
...
void checkDownloadAccesses(api.DownloadAccesses o) {
  buildCounterDownloadAccesses++;
  if (buildCounterDownloadAccesses < 3) {
    checkUnnamed4615(o.downloadAccessList!);
    unittest.expect(
      o.kind!,
      unittest.equals('foo'),
    );
...
core.List<core.String> buildUnnamed4616() => [
      'foo',
      'foo',
    ];

void checkUnnamed4616(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.Layersummary> buildUnnamed4617() => [
      buildLayersummary(),
      buildLayersummary(),
    ];

void checkUnnamed4617(core.List<api.Layersummary> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Layersummary buildLayersummary() {
  ...
  if (buildCounterLayersummary < 3) {
    ...
    o.annotationTypes = buildUnnamed4618();
...
void checkLayersummary(api.Layersummary o) {
  ...
  if (buildCounterLayersummary < 3) {
    ...
    checkUnnamed4618(o.annotationTypes!);
    unittest.expect(
...
core.List<api.MetadataItems> buildUnnamed4619() => [
      buildMetadataItems(),
      buildMetadataItems(),
    ];

void checkUnnamed4619(core.List<api.MetadataItems> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Notification buildNotification() {
  ...
  if (buildCounterNotification < 3) {
    o.body = 'foo';
    o.crmExperimentIds = buildUnnamed4620();
    o.docId = 'foo';
    o.docType = 'foo';
...
void checkNotification(api.Notification o) {
  ...
  if (buildCounterNotification < 3) {
    ...
    checkUnnamed4620(o.crmExperimentIds!);
    unittest.expect(
      o.docId!,
      unittest.equals('foo'),
    );
...
core.List<api.OffersItemsItems> buildUnnamed4621() => [
      buildOffersItemsItems(),
      buildOffersItemsItems(),
    ];

void checkUnnamed4621(core.List<api.OffersItemsItems> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.OffersItems> buildUnnamed4622() => [
      buildOffersItems(),
      buildOffersItems(),
    ];

void checkUnnamed4622(core.List<api.OffersItems> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.SeriesSeries> buildUnnamed4623() => [
      buildSeriesSeries(),
      buildSeriesSeries(),
    ];

void checkUnnamed4623(core.List<api.SeriesSeries> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkSeries(api.Series o) {
  ...
  if (buildCounterSeries < 3) {
    ...
    checkUnnamed4623(o.series!);
  }
  buildCounterSeries--;
}

core.List<api.Volume> buildUnnamed4624() => [
      buildVolume(),
      buildVolume(),
    ];

void checkUnnamed4624(core.List<api.Volume> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVolume(o[0]);
  checkVolume(o[1]);
}
...
core.List<api.VolumeLayerInfoLayers> buildUnnamed4625() => [
      buildVolumeLayerInfoLayers(),
      buildVolumeLayerInfoLayers(),
    ];

void checkUnnamed4625(core.List<api.VolumeLayerInfoLayers> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.VolumeSaleInfoOffers> buildUnnamed4626() => [
      buildVolumeSaleInfoOffers(),
      buildVolumeSaleInfoOffers(),
    ];

void checkUnnamed4626(core.List<api.VolumeSaleInfoOffers> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.VolumeVolumeInfoIndustryIdentifiers> buildUnnamed4629() => [
      buildVolumeVolumeInfoIndustryIdentifiers(),
      buildVolumeVolumeInfoIndustryIdentifiers(),
    ];

void checkUnnamed4629(core.List<api.VolumeVolumeInfoIndustryIdentifiers> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkVolumeVolumeInfo(api.VolumeVolumeInfo o) {
  ...
  if (buildCounterVolumeVolumeInfo < 3) {
    ...
    checkUnnamed4629(o.industryIdentifiers!);
    unittest.expect(
      o.infoLink!,
      unittest.equals('foo'),
    );
...
core.List<api.Volume> buildUnnamed4630() => [
      buildVolume(),
      buildVolume(),
    ];

void checkUnnamed4630(core.List<api.Volume> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVolume(o[0]);
  checkVolume(o[1]);
}
...
core.List<api.Volumeannotation> buildUnnamed4632() => [
      buildVolumeannotation(),
      buildVolumeannotation(),
    ];

void checkUnnamed4632(core.List<api.Volumeannotation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Volume> buildUnnamed4633() => [
      buildVolume(),
      buildVolume(),
    ];

void checkUnnamed4633(core.List<api.Volume> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVolume(o[0]);
  checkVolume(o[1]);
}
...
core.List<api.VolumeseriesinfoVolumeSeriesIssue> buildUnnamed4634() => [
      buildVolumeseriesinfoVolumeSeriesIssue(),
      buildVolumeseriesinfoVolumeSeriesIssue(),
    ];

void checkUnnamed4634(core.List<api.VolumeseriesinfoVolumeSeriesIssue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.VolumeseriesinfoVolumeSeries> buildUnnamed4635() => [
      buildVolumeseriesinfoVolumeSeries(),
      buildVolumeseriesinfoVolumeSeries(),
    ];

void checkUnnamed4635(core.List<api.VolumeseriesinfoVolumeSeries> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Volumeseriesinfo buildVolumeseriesinfo() {
  ...
  if (buildCounterVolumeseriesinfo < 3) {
    ...
    o.volumeSeries = buildUnnamed4635();
  }
  buildCounterVolumeseriesinfo--;
  return o;
}
...
void checkVolumeseriesinfo(api.Volumeseriesinfo o) {
  ...
  if (buildCounterVolumeseriesinfo < 3) {
    ...
    checkUnnamed4635(o.volumeSeries!);
  }
  buildCounterVolumeseriesinfo--;
}
...
void main() {
  ...
  unittest.group('resource-LayersAnnotationDataResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final arg_layerId = 'foo';
      final arg_contentVersion = 'foo';
      final arg_annotationDataId = buildUnnamed4636();
      final arg_h = 42;
      final arg_locale = 'foo';
      final arg_maxResults = 42;
      final arg_pageToken = 'foo';
  ...
  unittest.group('resource-MyconfigResource', () {
    ...
    unittest.test('method--releaseDownloadAccess', () async {
      ...
      final res = api.BooksApi(mock).myconfig;
      final arg_cpksver = 'foo';
      final arg_volumeIds = buildUnnamed4637();
      final arg_locale = 'foo';
      final arg_source = 'foo';
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
    ...
    unittest.test('method--syncVolumeLicenses', () async {
      ...
      final arg_nonce = 'foo';
      final arg_source = 'foo';
      final arg_features = buildUnnamed4638();
      final arg_includeNonComicsSeries = true;
      final arg_locale = 'foo';
      final arg_showPreorders = true;
      final arg_volumeIds = buildUnnamed4639();
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group('resource-MylibraryAnnotationsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final arg_contentVersion = 'foo';
      final arg_layerId = 'foo';
      final arg_layerIds = buildUnnamed4640();
      final arg_maxResults = 42;
      final arg_pageToken = 'foo';
      final arg_showDeleted = true;
      final arg_source = 'foo';
    ...
    unittest.test('method--summary', () async {
      final mock = HttpServerMock();
      final res = api.BooksApi(mock).mylibrary.annotations;
      final arg_layerIds = buildUnnamed4641();
      final arg_volumeId = 'foo';
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final path = (req.url).path;
  ...
  unittest.group('resource-OnboardingResource', () {
    ...
    unittest.test('method--listCategoryVolumes', () async {
      final mock = HttpServerMock();
      final res = api.BooksApi(mock).onboarding;
      final arg_categoryId = buildUnnamed4642();
      final arg_locale = 'foo';
  ...
  unittest.group('resource-SeriesResource', () {
    unittest.test('method--get', () async {
      ...
      final arg_seriesId = buildUnnamed4643();
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group('resource-VolumesMybooksResource', () {
    unittest.test('method--list', () async {
      ...
      final arg_acquireMethod = buildUnnamed4644();
      final arg_country = 'foo';
      final arg_locale = 'foo';
      final arg_maxResults = 42;
      final arg_processingState = buildUnnamed4645();
      final arg_source = 'foo';
      final arg_startIndex = 42;
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
  ...
  unittest.group('resource-VolumesUseruploadedResource', () {
    unittest.test('method--list', () async {
      ...
      final arg_locale = 'foo';
      final arg_maxResults = 42;
      final arg_processingState = buildUnnamed4646();
      final arg_source = 'foo';
      final arg_startIndex = 42;
      final arg_volumeId = buildUnnamed4647();
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final path = (req.url).path;
        var pathOffset = 0;
