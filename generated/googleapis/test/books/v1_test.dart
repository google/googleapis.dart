...
checkUnnamed330(core.List<api.Annotation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAnnotation(o[0]);
  checkAnnotation(o[1]);
}
...
checkUnnamed331(core.List<api.AnnotationsSummaryLayers> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed332(core.List<api.Annotationdata> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed333(core.List<api.Bookshelf> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBookshelf(o[0]);
  checkBookshelf(o[1]);
}
...
checkUnnamed334(core.List<api.CategoryItems> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed335(core.List<api.DictlayerdataDictWordsDerivatives> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed336(core.List<api.DictlayerdataDictWordsExamples> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed337(core.List<api.DictlayerdataDictWordsSensesConjugations> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed338(core.List<api.DictlayerdataDictWordsSensesDefinitionsExamples> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed339(core.List<api.DictlayerdataDictWordsSensesDefinitions> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed340(core.List<api.DictlayerdataDictWordsSensesSynonyms> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkDictlayerdataDictWordsSenses(api.DictlayerdataDictWordsSenses o) {
  buildCounterDictlayerdataDictWordsSenses++;
  if (buildCounterDictlayerdataDictWordsSenses < 3) {
    checkUnnamed337(o.conjugations);
    checkUnnamed339(o.definitions);
...
checkUnnamed341(core.List<api.DictlayerdataDictWordsSenses> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildDictlayerdataDictWords() {
  ...
  if (buildCounterDictlayerdataDictWords < 3) {
    o.derivatives = buildUnnamed335();
    o.examples = buildUnnamed336();
    o.senses = buildUnnamed341();
...
checkDictlayerdataDictWords(api.DictlayerdataDictWords o) {
  buildCounterDictlayerdataDictWords++;
  if (buildCounterDictlayerdataDictWords < 3) {
    checkUnnamed335(o.derivatives);
    checkUnnamed336(o.examples);
    checkUnnamed341(o.senses);
...
checkUnnamed342(core.List<api.DictlayerdataDictWords> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed343(core.List<api.DownloadAccessRestriction> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildDownloadAccesses() {
  ...
  if (buildCounterDownloadAccesses < 3) {
    o.downloadAccessList = buildUnnamed343();
    o.kind = "foo";
  }
  buildCounterDownloadAccesses--;
  return o;
...
checkDownloadAccesses(api.DownloadAccesses o) {
  buildCounterDownloadAccesses++;
  if (buildCounterDownloadAccesses < 3) {
    checkUnnamed343(o.downloadAccessList);
    unittest.expect(o.kind, unittest.equals('foo'));
  }
  buildCounterDownloadAccesses--;
}
...
checkUnnamed344(core.List<api.GeolayerdataGeoBoundary> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed345(core.List<core.List<api.GeolayerdataGeoBoundary>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed344(o[0]);
  checkUnnamed344(o[1]);
}
...
checkUnnamed346(core.List<api.Layersummary> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildLayersummary() {
  ...
  if (buildCounterLayersummary < 3) {
    ...
    o.annotationTypes = buildUnnamed347();
...
checkLayersummary(api.Layersummary o) {
  ...
  if (buildCounterLayersummary < 3) {
    ...
    checkUnnamed347(o.annotationTypes);
...
checkUnnamed348(core.List<api.MetadataItems> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed349(core.List<api.OffersItemsItems> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed350(core.List<api.OffersItems> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed351(core.List<api.VolumeLayerInfoLayers> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed352(core.List<api.VolumeSaleInfoOffers> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed355(core.List<api.VolumeVolumeInfoIndustryIdentifiers> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed356(core.List<api.Volume> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVolume(o[0]);
  checkVolume(o[1]);
}
...
checkUnnamed358(core.List<api.Volumeannotation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed359(core.List<api.Volume> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVolume(o[0]);
  checkVolume(o[1]);
}
...
main() {
  ...
  unittest.group("resource-LayersAnnotationDataResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_layerId = "foo";
      var arg_contentVersion = "foo";
      var arg_annotationDataId = buildUnnamed360();
      var arg_h = 42;
      var arg_locale = "foo";
      var arg_maxResults = 42;
      var arg_pageToken = "foo";
  ...
  unittest.group("resource-MyconfigResourceApi", () {
    ...
    unittest.test("method--releaseDownloadAccess", () {
      ...
      var mock = new HttpServerMock();
      api.MyconfigResourceApi res = new api.BooksApi(mock).myconfig;
      var arg_volumeIds = buildUnnamed361();
      var arg_cpksver = "foo";
      var arg_locale = "foo";
      var arg_source = "foo";
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
    ...
    unittest.test("method--syncVolumeLicenses", () {
      ...
      var arg_nonce = "foo";
      var arg_cpksver = "foo";
      var arg_features = buildUnnamed362();
      var arg_locale = "foo";
      var arg_showPreorders = true;
      var arg_volumeIds = buildUnnamed363();
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
        var index;
  ...
  unittest.group("resource-OnboardingResourceApi", () {
    ...
    unittest.test("method--listCategoryVolumes", () {
      ...
      var mock = new HttpServerMock();
      api.OnboardingResourceApi res = new api.BooksApi(mock).onboarding;
      var arg_categoryId = buildUnnamed366();
      var arg_locale = "foo";
  ...
  unittest.group("resource-VolumesMybooksResourceApi", () {
    unittest.test("method--list", () {
      ...
      var arg_acquireMethod = buildUnnamed367();
      var arg_locale = "foo";
      var arg_maxResults = 42;
  ...
  unittest.group("resource-VolumesUseruploadedResourceApi", () {
    unittest.test("method--list", () {
      ...
      var arg_source = "foo";
      var arg_startIndex = 42;
      var arg_volumeId = buildUnnamed370();
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
        var index;
