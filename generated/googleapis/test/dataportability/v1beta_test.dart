...
import 'package:googleapis/dataportability/v1beta.dart' as api;
...
void checkPortabilityArchiveState(api.PortabilityArchiveState o) {
  buildCounterPortabilityArchiveState++;
  if (buildCounterPortabilityArchiveState < 3) {
    unittest.expect(o.exportTime!, unittest.equals('foo'));
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            ...
            unittest.equals('v1beta/accessType:check'),
          );
          pathOffset += 23;
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final resp = convert.json.encode(
            buildCancelPortabilityArchiveResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            ...
            unittest.equals('v1beta/authorization:reset'),
          );
          pathOffset += 26;
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            ...
            unittest.equals('v1beta/portabilityArchive:initiate'),
          );
          pathOffset += 34;
