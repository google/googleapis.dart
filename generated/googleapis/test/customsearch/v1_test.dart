...
checkUnnamed976(core.List<api.ContextFacets> o) {
...
buildUnnamed977() {
  ...
  o.add(buildUnnamed976());
  o.add(buildUnnamed976());
  return o;
}

checkUnnamed977(core.List<core.List<api.ContextFacets>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed976(o[0]);
  checkUnnamed976(o[1]);
}
...
checkUnnamed978(core.List<api.PromotionBodyLines> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed979(core.List<api.ResultLabels> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed980(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed981() {
  ...
  o.add(buildUnnamed980());
  o.add(buildUnnamed980());
  return o;
}

checkUnnamed981(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed980(o[0]);
  checkUnnamed980(o[1]);
}
...
checkUnnamed982(core.Map<core.String, core.List<core.Map<core.String, core.Object>>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed981(o["x"]);
  checkUnnamed981(o["y"]);
}
...
buildResult() {
  ...
  if (buildCounterResult < 3) {
    ...
    o.kind = "foo";
    o.labels = buildUnnamed979();
    o.link = "foo";
    o.mime = "foo";
    o.pagemap = buildUnnamed982();
    o.snippet = "foo";
    o.title = "foo";
  }
  buildCounterResult--;
...
checkResult(api.Result o) {
  ...
  if (buildCounterResult < 3) {
    ...
    checkUnnamed979(o.labels);
    unittest.expect(o.link, unittest.equals('foo'));
    unittest.expect(o.mime, unittest.equals('foo'));
    checkUnnamed982(o.pagemap);
...
checkUnnamed983(core.List<api.Result> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResult(o[0]);
  checkResult(o[1]);
}
...
checkUnnamed984(core.List<api.Promotion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPromotion(o[0]);
  checkPromotion(o[1]);
}
...
checkUnnamed985(core.List<api.Query> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQuery(o[0]);
  checkQuery(o[1]);
}
...
checkUnnamed986(core.Map<core.String, core.List<api.Query>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed985(o["x"]);
  checkUnnamed985(o["y"]);
}
...
buildSearch() {
  ...
  if (buildCounterSearch < 3) {
    ...
    o.kind = "foo";
    o.promotions = buildUnnamed984();
    o.queries = buildUnnamed986();
...
checkSearch(api.Search o) {
  ...
  if (buildCounterSearch < 3) {
    ...
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed984(o.promotions);
    checkUnnamed986(o.queries);
