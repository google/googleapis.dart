...
checkUnnamed2480(core.List<api.ScriptStackTraceElement> o) {
...
buildExecutionError() {
  ...
  if (buildCounterExecutionError < 3) {
    o.errorMessage = "foo";
    o.errorType = "foo";
    o.scriptStackTraceElements = buildUnnamed2480();
  }
  buildCounterExecutionError--;
  return o;
}
...
checkExecutionError(api.ExecutionError o) {
  ...
  if (buildCounterExecutionError < 3) {
    ...
    checkUnnamed2480(o.scriptStackTraceElements);
  }
  buildCounterExecutionError--;
}
...
checkUnnamed2481(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed2485() {
  ...
  o.add(buildUnnamed2484());
  o.add(buildUnnamed2484());
  return o;
}

checkUnnamed2485(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2484(o[0]);
  checkUnnamed2484(o[1]);
}
