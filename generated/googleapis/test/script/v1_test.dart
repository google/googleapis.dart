...
core.List<api.EntryPoint> buildUnnamed1459() {
...
api.Deployment buildDeployment() {
  ...
  if (buildCounterDeployment < 3) {
    ...
    o.deploymentId = 'foo';
    o.entryPoints = buildUnnamed1459();
    o.updateTime = 'foo';
  }
  buildCounterDeployment--;
  return o;
...
core.List<api.ScriptStackTraceElement> buildUnnamed1460() {
...
api.ExecutionError buildExecutionError() {
  ...
  if (buildCounterExecutionError < 3) {
    o.errorMessage = 'foo';
    o.errorType = 'foo';
    o.scriptStackTraceElements = buildUnnamed1460();
  }
  buildCounterExecutionError--;
  return o;
}
...
void checkExecutionError(api.ExecutionError o) {
  ...
  if (buildCounterExecutionError < 3) {
    ...
    checkUnnamed1460(o.scriptStackTraceElements);
  }
  buildCounterExecutionError--;
}

core.List<core.Object> buildUnnamed1461() {
  var o = <core.Object>[];
  o.add({
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed1461(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleAppsScriptTypeFunction> buildUnnamed1462() {
  var o = <api.GoogleAppsScriptTypeFunction>[];
...
core.List<api.Deployment> buildUnnamed1463() {
  var o = <api.Deployment>[];
...
api.ListDeploymentsResponse buildListDeploymentsResponse() {
  ...
  if (buildCounterListDeploymentsResponse < 3) {
    o.deployments = buildUnnamed1463();
    o.nextPageToken = 'foo';
  }
  buildCounterListDeploymentsResponse--;
  return o;
...
void checkListDeploymentsResponse(api.ListDeploymentsResponse o) {
  buildCounterListDeploymentsResponse++;
  if (buildCounterListDeploymentsResponse < 3) {
    checkUnnamed1463(o.deployments);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListDeploymentsResponse--;
}

core.List<api.GoogleAppsScriptTypeProcess> buildUnnamed1464() {
  var o = <api.GoogleAppsScriptTypeProcess>[];
...
void checkListScriptProcessesResponse(api.ListScriptProcessesResponse o) {
  ...
  if (buildCounterListScriptProcessesResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed1464(o.processes);
  }
  buildCounterListScriptProcessesResponse--;
}

core.List<api.GoogleAppsScriptTypeProcess> buildUnnamed1465() {
  var o = <api.GoogleAppsScriptTypeProcess>[];
  o.add(buildGoogleAppsScriptTypeProcess());
  o.add(buildGoogleAppsScriptTypeProcess());
  return o;
...
void checkListUserProcessesResponse(api.ListUserProcessesResponse o) {
  ...
  if (buildCounterListUserProcessesResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed1465(o.processes);
  }
  buildCounterListUserProcessesResponse--;
}

core.List<api.Value> buildUnnamed1466() {
  var o = <api.Value>[];
  o.add(buildValue());
  o.add(buildValue());
  return o;
...
void checkListValue(api.ListValue o) {
  buildCounterListValue++;
  if (buildCounterListValue < 3) {
    checkUnnamed1466(o.values);
  }
  buildCounterListValue--;
}

core.List<api.Version> buildUnnamed1467() {
  var o = <api.Version>[];
  o.add(buildVersion());
  o.add(buildVersion());
  return o;
...
void checkListVersionsResponse(api.ListVersionsResponse o) {
  ...
  if (buildCounterListVersionsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed1467(o.versions);
  }
  buildCounterListVersionsResponse--;
}

core.List<api.MetricsValue> buildUnnamed1468() {
...
api.Metrics buildMetrics() {
  ...
  if (buildCounterMetrics < 3) {
    o.activeUsers = buildUnnamed1468();
    o.failedExecutions = buildUnnamed1469();
    o.totalExecutions = buildUnnamed1470();
  }
  buildCounterMetrics--;
  return o;
}
...
void checkMetrics(api.Metrics o) {
  buildCounterMetrics++;
  if (buildCounterMetrics < 3) {
    checkUnnamed1468(o.activeUsers);
    checkUnnamed1469(o.failedExecutions);
    checkUnnamed1470(o.totalExecutions);
  }
  buildCounterMetrics--;
}
...
core.Map<core.String, core.Object> buildUnnamed1471() {
...
void checkUnnamed1471(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed1472() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed1472(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed1473() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed1472());
  o.add(buildUnnamed1472());
  return o;
}

void checkUnnamed1473(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1472(o[0]);
  checkUnnamed1472(o[1]);
}
...
void checkStatus(api.Status o) {
  ...
  if (buildCounterStatus < 3) {
    ...
    checkUnnamed1473(o.details);
    unittest.expect(o.message, unittest.equals('foo'));
  }
  buildCounterStatus--;
}

core.Map<core.String, api.Value> buildUnnamed1474() {
