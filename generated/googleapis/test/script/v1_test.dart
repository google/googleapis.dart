...
core.List<api.File> buildUnnamed0() => [buildFile(), buildFile()];
...
void main() {
  ...
  unittest.group('resource-ProcessesResource', () {
    ...
    unittest.test('method--listScriptProcesses', () async {
      ...
      final response = await res.listScriptProcesses(
        ...
        scriptProcessFilter_deploymentId: arg_scriptProcessFilter_deploymentId,
        scriptProcessFilter_endTime: arg_scriptProcessFilter_endTime,
        scriptProcessFilter_functionName: arg_scriptProcessFilter_functionName,
  ...
  unittest.group('resource-ProjectsResource', () {
    ...
    unittest.test('method--getContent', () async {
      ...
      final response = await res.getContent(
        arg_scriptId,
        versionNumber: arg_versionNumber,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--updateContent', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Content.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkContent(obj);
      ...
      final response = await res.updateContent(
        arg_request,
        arg_scriptId,
        $fields: arg_$fields,
      );
