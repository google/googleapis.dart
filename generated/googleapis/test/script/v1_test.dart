...
checkUnnamed2719(core.List<api.ScriptStackTraceElement> o) {
...
buildExecutionError() {
  ...
  if (buildCounterExecutionError < 3) {
    o.errorMessage = "foo";
    o.errorType = "foo";
    o.scriptStackTraceElements = buildUnnamed2719();
  }
  buildCounterExecutionError--;
  return o;
}
...
checkExecutionError(api.ExecutionError o) {
  ...
  if (buildCounterExecutionError < 3) {
    ...
    checkUnnamed2719(o.scriptStackTraceElements);
  }
  buildCounterExecutionError--;
}
...
checkUnnamed2720(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed2724() {
  ...
  o.add(buildUnnamed2723());
  o.add(buildUnnamed2723());
  return o;
}

checkUnnamed2724(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2723(o[0]);
  checkUnnamed2723(o[1]);
}
