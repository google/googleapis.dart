...
checkUnnamed2510(core.List<api.ScriptStackTraceElement> o) {
...
buildExecutionError() {
  ...
  if (buildCounterExecutionError < 3) {
    o.errorMessage = "foo";
    o.errorType = "foo";
    o.scriptStackTraceElements = buildUnnamed2510();
  }
  buildCounterExecutionError--;
  return o;
}
...
checkExecutionError(api.ExecutionError o) {
  ...
  if (buildCounterExecutionError < 3) {
    ...
    checkUnnamed2510(o.scriptStackTraceElements);
  }
  buildCounterExecutionError--;
}
...
checkUnnamed2511(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed2515() {
  ...
  o.add(buildUnnamed2514());
  o.add(buildUnnamed2514());
  return o;
}

checkUnnamed2515(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2514(o[0]);
  checkUnnamed2514(o[1]);
}
