...
core.List<api.Bin> buildUnnamed6810() {
  var o = <api.Bin>[];
  o.add(buildBin());
  o.add(buildBin());
  return o;
...
void checkUnnamed6810(core.List<api.Bin> o) {
...
core.Map<core.String, api.Metric> buildUnnamed6812() {
...
void checkUnnamed6812(core.Map<core.String, api.Metric> o) {
  unittest.expect(o, unittest.hasLength(2));
