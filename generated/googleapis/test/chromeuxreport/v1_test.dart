...
void checkBin(api.Bin o) {
  buildCounterBin++;
  if (buildCounterBin < 3) {
    unittest.expect(o.density, unittest.equals(42.0));
...
core.List<api.Bin> buildUnnamed6319() {
  var o = <api.Bin>[];
  o.add(buildBin());
  o.add(buildBin());
  return o;
...
void checkUnnamed6319(core.List<api.Bin> o) {
...
core.Map<core.String, api.Metric> buildUnnamed6321() {
...
void checkUnnamed6321(core.Map<core.String, api.Metric> o) {
  unittest.expect(o, unittest.hasLength(2));
