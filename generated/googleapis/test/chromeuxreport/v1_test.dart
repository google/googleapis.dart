...
core.List<api.Bin> buildUnnamed4397() => [
      buildBin(),
      buildBin(),
    ];

void checkUnnamed4397(core.List<api.Bin> o) {
...
core.List<core.String> buildUnnamed4398() => [
      'foo',
      'foo',
    ];

void checkUnnamed4398(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.Map<core.String, api.Metric> buildUnnamed4399() => {
      'x': buildMetric(),
      'y': buildMetric(),
    };

void checkUnnamed4399(core.Map<core.String, api.Metric> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetric(o['x']!);
  checkMetric(o['y']!);
}
