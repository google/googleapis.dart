...
checkUnnamed1441(core.List<api.AuthToken> o) {
...
checkUnnamed1443(core.List<api.UserData> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUserData(o[0]);
  checkUserData(o[1]);
}
...
buildAccount() {
  ...
  if (buildCounterAccount < 3) {
    o.authTokens = buildUnnamed1441();
    o.features = buildUnnamed1442();
    o.password = "foo";
    o.userData = buildUnnamed1443();
  }
  buildCounterAccount--;
  return o;
}
...
checkAccount(api.Account o) {
  buildCounterAccount++;
  if (buildCounterAccount < 3) {
    checkUnnamed1441(o.authTokens);
    checkUnnamed1442(o.features);
    unittest.expect(o.password, unittest.equals('foo'));
    checkUnnamed1443(o.userData);
  }
  buildCounterAccount--;
}
...
checkUnnamed1444(core.List<api.Attachment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachment(o[0]);
  checkAttachment(o[1]);
}
...
checkUnnamed1445(core.List<api.Command> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCommand(o[0]);
  checkCommand(o[1]);
}
...
buildContact() {
  ...
  if (buildCounterContact < 3) {
    o.acceptCommands = buildUnnamed1445();
    o.acceptTypes = buildUnnamed1446();
    o.displayName = "foo";
    o.id = "foo";
    o.imageUrls = buildUnnamed1447();
    o.kind = "foo";
    o.phoneNumber = "foo";
    o.priority = 42;
    o.sharingFeatures = buildUnnamed1448();
    o.source = "foo";
    o.speakableName = "foo";
    o.type = "foo";
  }
...
checkContact(api.Contact o) {
  buildCounterContact++;
  if (buildCounterContact < 3) {
    checkUnnamed1445(o.acceptCommands);
    checkUnnamed1446(o.acceptTypes);
    unittest.expect(o.displayName, unittest.equals('foo'));
    unittest.expect(o.id, unittest.equals('foo'));
    checkUnnamed1447(o.imageUrls);
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.phoneNumber, unittest.equals('foo'));
    unittest.expect(o.priority, unittest.equals(42));
    checkUnnamed1448(o.sharingFeatures);
...
checkUnnamed1449(core.List<api.Contact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContact(o[0]);
  checkContact(o[1]);
}
...
checkUnnamed1450(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
checkUnnamed1451(core.List<api.MenuValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMenuValue(o[0]);
  checkMenuValue(o[1]);
}
...
checkUnnamed1452(core.List<api.UserAction> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUserAction(o[0]);
  checkUserAction(o[1]);
}
...
buildNotification() {
  ...
  if (buildCounterNotification < 3) {
    ...
    o.itemId = "foo";
    o.operation = "foo";
    o.userActions = buildUnnamed1452();
    o.userToken = "foo";
    o.verifyToken = "foo";
  }
  buildCounterNotification--;
...
checkNotification(api.Notification o) {
  ...
  if (buildCounterNotification < 3) {
    ...
    checkUnnamed1452(o.userActions);
...
checkUnnamed1454(core.List<api.Subscription> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1455(core.List<api.Attachment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachment(o[0]);
  checkAttachment(o[1]);
}
...
checkUnnamed1456(core.List<api.MenuItem> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMenuItem(o[0]);
  checkMenuItem(o[1]);
}
...
checkUnnamed1457(core.List<api.Contact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContact(o[0]);
  checkContact(o[1]);
}
...
buildTimelineItem() {
  ...
  if (buildCounterTimelineItem < 3) {
    o.attachments = buildUnnamed1455();
    o.bundleId = "foo";
    o.canonicalUrl = "foo";
    ...
    o.menuItems = buildUnnamed1456();
    o.notification = buildNotificationConfig();
    o.pinScore = 42;
    o.recipients = buildUnnamed1457();
    o.selfLink = "foo";
    o.sourceItemId = "foo";
    o.speakableText = "foo";
    o.speakableType = "foo";
...
checkTimelineItem(api.TimelineItem o) {
  buildCounterTimelineItem++;
  if (buildCounterTimelineItem < 3) {
    checkUnnamed1455(o.attachments);
...
checkUnnamed1458(core.List<api.TimelineItem> o) {
  unittest.expect(o, unittest.hasLength(2));
