...
core.List<api.EnrolledService> buildUnnamed5254() {
...
void checkUnnamed5254(core.List<api.EnrolledService> o) {
...
api.AccessApprovalSettings buildAccessApprovalSettings() {
  ...
  if (buildCounterAccessApprovalSettings < 3) {
    ...
    o.enrolledServices = buildUnnamed5254();
    o.name = 'foo';
    o.notificationEmails = buildUnnamed5255();
  }
  buildCounterAccessApprovalSettings--;
  return o;
}
...
void checkAccessApprovalSettings(api.AccessApprovalSettings o) {
  ...
  if (buildCounterAccessApprovalSettings < 3) {
    ...
    checkUnnamed5254(o.enrolledServices!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed5255(o.notificationEmails!);
  }
  buildCounterAccessApprovalSettings--;
}
...
core.List<api.ApprovalRequest> buildUnnamed5256() {
  var o = <api.ApprovalRequest>[];
...
void checkUnnamed5256(core.List<api.ApprovalRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListApprovalRequestsResponse buildListApprovalRequestsResponse() {
  ...
  if (buildCounterListApprovalRequestsResponse < 3) {
    o.approvalRequests = buildUnnamed5256();
    o.nextPageToken = 'foo';
  }
  buildCounterListApprovalRequestsResponse--;
  return o;
...
void checkListApprovalRequestsResponse(api.ListApprovalRequestsResponse o) {
  buildCounterListApprovalRequestsResponse++;
  if (buildCounterListApprovalRequestsResponse < 3) {
    checkUnnamed5256(o.approvalRequests!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
