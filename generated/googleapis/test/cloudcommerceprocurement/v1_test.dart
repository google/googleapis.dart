...
core.List<api.Approval> buildUnnamed0() => [buildApproval(), buildApproval()];
...
api.Account buildAccount() {
  ...
  if (buildCounterAccount < 3) {
    ...
    o.name = 'foo';
    o.provider = 'foo';
    o.resellerParentBillingAccount = 'foo';
    o.state = 'foo';
    o.updateTime = 'foo';
  }
  buildCounterAccount--;
...
void checkAccount(api.Account o) {
  ...
  if (buildCounterAccount < 3) {
    ...
    unittest.expect(o.resellerParentBillingAccount!, unittest.equals('foo'));
...
void checkApproveAccountRequest(api.ApproveAccountRequest o) {
  buildCounterApproveAccountRequest++;
  if (buildCounterApproveAccountRequest < 3) {
    unittest.expect(o.approvalName!, unittest.equals('foo'));
...
void checkApproveEntitlementPlanChangeRequest(
  ...
  buildCounterApproveEntitlementPlanChangeRequest++;
  if (buildCounterApproveEntitlementPlanChangeRequest < 3) {
    unittest.expect(o.pendingPlanName!, unittest.equals('foo'));
  }
  buildCounterApproveEntitlementPlanChangeRequest--;
}
...
void checkApproveEntitlementRequest(api.ApproveEntitlementRequest o) {
  buildCounterApproveEntitlementRequest++;
  if (buildCounterApproveEntitlementRequest < 3) {
    unittest.expect(o.entitlementMigrated!, unittest.equals('foo'));
...
core.List<api.Consumer> buildUnnamed4() => [buildConsumer(), buildConsumer()];
...
void checkEntitlement(api.Entitlement o) {
  ...
  if (buildCounterEntitlement < 3) {
    ...
    unittest.expect(o.messageToUser!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.newOfferEndTime!, unittest.equals('foo'));
    unittest.expect(o.newOfferStartTime!, unittest.equals('foo'));
    unittest.expect(o.newPendingOffer!, unittest.equals('foo'));
    unittest.expect(o.newPendingOfferDuration!, unittest.equals('foo'));
    unittest.expect(o.newPendingPlan!, unittest.equals('foo'));
    unittest.expect(o.offer!, unittest.equals('foo'));
    unittest.expect(o.offerDuration!, unittest.equals('foo'));
    unittest.expect(o.offerEndTime!, unittest.equals('foo'));
    unittest.expect(o.orderId!, unittest.equals('foo'));
    unittest.expect(o.plan!, unittest.equals('foo'));
    unittest.expect(o.product!, unittest.equals('foo'));
    unittest.expect(o.productExternalName!, unittest.equals('foo'));
    unittest.expect(o.provider!, unittest.equals('foo'));
    unittest.expect(o.quoteExternalName!, unittest.equals('foo'));
    unittest.expect(o.state!, unittest.equals('foo'));
    unittest.expect(o.subscriptionEndTime!, unittest.equals('foo'));
    unittest.expect(o.updateTime!, unittest.equals('foo'));
    unittest.expect(o.usageReportingId!, unittest.equals('foo'));
  }
  buildCounterEntitlement--;
}
...
void main() {
  ...
  unittest.group('resource-ProvidersEntitlementsResource', () {
    ...
    unittest.test('method--approvePlanChange', () async {
      ...
      final response = await res.approvePlanChange(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--rejectPlanChange', () async {
      ...
      final response = await res.rejectPlanChange(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
