...
core.List<api.Rule> buildUnnamed6378() => [
      buildRule(),
      buildRule(),
    ];

void checkUnnamed6378(core.List<api.Rule> o) {
...
void checkChannelGrouping(api.ChannelGrouping o) {
  ...
  if (buildCounterChannelGrouping < 3) {
    ...
    checkUnnamed6378(o.rules!);
  }
  buildCounterChannelGrouping--;
}

core.List<api.EventFilter> buildUnnamed6379() => [
      buildEventFilter(),
      buildEventFilter(),
    ];

void checkUnnamed6379(core.List<api.EventFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DisjunctiveMatchStatement buildDisjunctiveMatchStatement() {
  ...
  if (buildCounterDisjunctiveMatchStatement < 3) {
    o.eventFilters = buildUnnamed6379();
  }
  buildCounterDisjunctiveMatchStatement--;
  return o;
}
...
void checkDisjunctiveMatchStatement(api.DisjunctiveMatchStatement o) {
  buildCounterDisjunctiveMatchStatement++;
  if (buildCounterDisjunctiveMatchStatement < 3) {
    checkUnnamed6379(o.eventFilters!);
  }
  buildCounterDisjunctiveMatchStatement--;
}
...
core.List<api.Query> buildUnnamed6380() => [
      buildQuery(),
      buildQuery(),
    ];

void checkUnnamed6380(core.List<api.Query> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQuery(o[0]);
  checkQuery(o[1]);
}
...
void checkListQueriesResponse(api.ListQueriesResponse o) {
  ...
  if (buildCounterListQueriesResponse < 3) {
    ...
    checkUnnamed6380(o.queries!);
  }
  buildCounterListQueriesResponse--;
}

core.List<api.Report> buildUnnamed6381() => [
      buildReport(),
      buildReport(),
    ];

void checkUnnamed6381(core.List<api.Report> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReport(o[0]);
  checkReport(o[1]);
}
...
core.List<api.FilterPair> buildUnnamed6382() => [
      buildFilterPair(),
      buildFilterPair(),
    ];

void checkUnnamed6382(core.List<api.FilterPair> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFilterPair(o[0]);
  checkFilterPair(o[1]);
}
...
api.Parameters buildParameters() {
  ...
  if (buildCounterParameters < 3) {
    o.filters = buildUnnamed6382();
    o.groupBys = buildUnnamed6383();
    o.includeInviteData = true;
    o.metrics = buildUnnamed6384();
...
void checkParameters(api.Parameters o) {
  buildCounterParameters++;
  if (buildCounterParameters < 3) {
    checkUnnamed6382(o.filters!);
    checkUnnamed6383(o.groupBys!);
    unittest.expect(o.includeInviteData!, unittest.isTrue);
    checkUnnamed6384(o.metrics!);
...
core.List<api.EventFilter> buildUnnamed6385() => [
      buildEventFilter(),
      buildEventFilter(),
    ];

void checkUnnamed6385(core.List<api.EventFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEventFilter(o[0]);
  checkEventFilter(o[1]);
}
...
api.PathFilter buildPathFilter() {
  ...
  if (buildCounterPathFilter < 3) {
    o.eventFilters = buildUnnamed6385();
...
void checkPathFilter(api.PathFilter o) {
  buildCounterPathFilter++;
  if (buildCounterPathFilter < 3) {
    checkUnnamed6385(o.eventFilters!);
    unittest.expect(
      o.pathMatchPosition!,
      unittest.equals('foo'),
    );
...
core.List<api.PathFilter> buildUnnamed6386() => [
      buildPathFilter(),
      buildPathFilter(),
    ];

void checkUnnamed6386(core.List<api.PathFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPathFilter(o[0]);
  checkPathFilter(o[1]);
}
...
api.PathQueryOptions buildPathQueryOptions() {
  ...
  if (buildCounterPathQueryOptions < 3) {
    ...
    o.pathFilters = buildUnnamed6386();
  }
  buildCounterPathQueryOptions--;
  return o;
}
...
void checkPathQueryOptions(api.PathQueryOptions o) {
  ...
  if (buildCounterPathQueryOptions < 3) {
    ...
    checkUnnamed6386(o.pathFilters!);
  }
  buildCounterPathQueryOptions--;
}
...
api.QueryMetadata buildQueryMetadata() {
  ...
  if (buildCounterQueryMetadata < 3) {
    ...
    o.shareEmailAddress = buildUnnamed6388();
    o.title = 'foo';
  }
  buildCounterQueryMetadata--;
  return o;
...
void checkQueryMetadata(api.QueryMetadata o) {
  ...
  if (buildCounterQueryMetadata < 3) {
    ...
    checkUnnamed6388(o.shareEmailAddress!);
    unittest.expect(
      o.title!,
      unittest.equals('foo'),
    );
...
core.List<api.DisjunctiveMatchStatement> buildUnnamed6389() => [
      buildDisjunctiveMatchStatement(),
      buildDisjunctiveMatchStatement(),
    ];

void checkUnnamed6389(core.List<api.DisjunctiveMatchStatement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Rule buildRule() {
  ...
  if (buildCounterRule < 3) {
    o.disjunctiveMatchStatements = buildUnnamed6389();
    o.name = 'foo';
  }
  buildCounterRule--;
  return o;
...
void checkRule(api.Rule o) {
  buildCounterRule++;
  if (buildCounterRule < 3) {
    checkUnnamed6389(o.disjunctiveMatchStatements!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
