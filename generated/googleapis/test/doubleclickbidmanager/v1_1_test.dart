...
buildDownloadRequest() {
  ...
  if (buildCounterDownloadRequest < 3) {
    o.fileTypes = buildUnnamed3633();
    o.filterIds = buildUnnamed3634();
    o.filterType = "foo";
    o.version = "foo";
  }
  buildCounterDownloadRequest--;
...
checkDownloadRequest(api.DownloadRequest o) {
  buildCounterDownloadRequest++;
  if (buildCounterDownloadRequest < 3) {
    checkUnnamed3633(o.fileTypes);
    checkUnnamed3634(o.filterIds);
    unittest.expect(o.filterType, unittest.equals('foo'));
...
checkUnnamed3635(core.List<api.Query> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQuery(o[0]);
  checkQuery(o[1]);
}
...
checkUnnamed3636(core.List<api.Report> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReport(o[0]);
  checkReport(o[1]);
}
...
checkUnnamed3637(core.List<api.FilterPair> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFilterPair(o[0]);
  checkFilterPair(o[1]);
}
...
buildParameters() {
  ...
  if (buildCounterParameters < 3) {
    o.filters = buildUnnamed3637();
    o.groupBys = buildUnnamed3638();
    o.includeInviteData = true;
    o.metrics = buildUnnamed3639();
...
checkParameters(api.Parameters o) {
  buildCounterParameters++;
  if (buildCounterParameters < 3) {
    checkUnnamed3637(o.filters);
    checkUnnamed3638(o.groupBys);
    unittest.expect(o.includeInviteData, unittest.isTrue);
    checkUnnamed3639(o.metrics);
...
buildQueryMetadata() {
  ...
  if (buildCounterQueryMetadata < 3) {
    ...
    o.shareEmailAddress = buildUnnamed3640();
    o.title = "foo";
  }
  buildCounterQueryMetadata--;
  return o;
...
checkQueryMetadata(api.QueryMetadata o) {
  ...
  if (buildCounterQueryMetadata < 3) {
    ...
    checkUnnamed3640(o.shareEmailAddress);
...
checkUnnamed3643(core.List<api.RowStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRowStatus(o[0]);
  checkRowStatus(o[1]);
}
...
buildUploadStatus() {
  ...
  if (buildCounterUploadStatus < 3) {
    o.errors = buildUnnamed3642();
    o.rowStatus = buildUnnamed3643();
  }
  buildCounterUploadStatus--;
  return o;
}
...
checkUploadStatus(api.UploadStatus o) {
  buildCounterUploadStatus++;
  if (buildCounterUploadStatus < 3) {
    checkUnnamed3642(o.errors);
    checkUnnamed3643(o.rowStatus);
  }
  buildCounterUploadStatus--;
}
