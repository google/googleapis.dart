...
core.List<api.TaskLinks> buildUnnamed6803() {
  var o = <api.TaskLinks>[];
...
void checkUnnamed6803(core.List<api.TaskLinks> o) {
...
core.List<api.TaskList> buildUnnamed6804() {
  var o = <api.TaskList>[];
  o.add(buildTaskList());
  o.add(buildTaskList());
  return o;
...
void checkUnnamed6804(core.List<api.TaskList> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Task> buildUnnamed6805() {
  var o = <api.Task>[];
  o.add(buildTask());
  o.add(buildTask());
  return o;
...
void checkUnnamed6805(core.List<api.Task> o) {
  unittest.expect(o, unittest.hasLength(2));
