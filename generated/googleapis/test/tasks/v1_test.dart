...
core.List<api.TaskLinks> buildUnnamed7889() => [
      buildTaskLinks(),
      buildTaskLinks(),
    ];

void checkUnnamed7889(core.List<api.TaskLinks> o) {
...
core.List<api.TaskList> buildUnnamed7890() => [
      buildTaskList(),
      buildTaskList(),
    ];

void checkUnnamed7890(core.List<api.TaskList> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTaskList(o[0]);
  checkTaskList(o[1]);
}
...
core.List<api.Task> buildUnnamed7891() => [
      buildTask(),
      buildTask(),
    ];

void checkUnnamed7891(core.List<api.Task> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTask(o[0]);
  checkTask(o[1]);
}
