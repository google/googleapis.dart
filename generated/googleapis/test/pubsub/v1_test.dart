...
checkUnnamed1349(core.List<api.Subscription> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListSubscriptionsResponse() {
  ...
  if (buildCounterListSubscriptionsResponse < 3) {
    o.nextPageToken = "foo";
    o.subscriptions = buildUnnamed1349();
  }
  buildCounterListSubscriptionsResponse--;
  return o;
}
...
checkListSubscriptionsResponse(api.ListSubscriptionsResponse o) {
  ...
  if (buildCounterListSubscriptionsResponse < 3) {
    ...
    checkUnnamed1349(o.subscriptions);
  }
  buildCounterListSubscriptionsResponse--;
}
...
buildListTopicSubscriptionsResponse() {
  ...
  if (buildCounterListTopicSubscriptionsResponse < 3) {
    o.nextPageToken = "foo";
    o.subscriptions = buildUnnamed1350();
  }
  buildCounterListTopicSubscriptionsResponse--;
  return o;
}
...
checkListTopicSubscriptionsResponse(api.ListTopicSubscriptionsResponse o) {
  ...
  if (buildCounterListTopicSubscriptionsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed1350(o.subscriptions);
  }
  buildCounterListTopicSubscriptionsResponse--;
}
...
checkUnnamed1351(core.List<api.Topic> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTopic(o[0]);
  checkTopic(o[1]);
}
...
checkUnnamed1353(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
checkUnnamed1354(core.List<api.PubsubMessage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1357(core.List<api.ReceivedMessage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPullResponse() {
  ...
  if (buildCounterPullResponse < 3) {
    o.receivedMessages = buildUnnamed1357();
  }
  buildCounterPullResponse--;
  return o;
}
...
checkPullResponse(api.PullResponse o) {
  buildCounterPullResponse++;
  if (buildCounterPullResponse < 3) {
    checkUnnamed1357(o.receivedMessages);
  }
  buildCounterPullResponse--;
}
...
checkUnnamed1358(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
