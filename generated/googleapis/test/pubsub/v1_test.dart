...
core.List<api.Schema> buildUnnamed3() => [buildSchema(), buildSchema()];
...
core.List<api.Snapshot> buildUnnamed5() => [buildSnapshot(), buildSnapshot()];
...
core.List<api.Topic> buildUnnamed9() => [buildTopic(), buildTopic()];
