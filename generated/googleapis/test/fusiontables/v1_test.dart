...
checkUnnamed2626(core.List<api.Column> o) {
...
checkUnnamed2627(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2628(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed2629() {
  ...
  o.add(buildUnnamed2628());
  o.add(buildUnnamed2628());
  return o;
}

checkUnnamed2629(core.List<core.List<core.double>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2628(o[0]);
  checkUnnamed2628(o[1]);
}
...
buildLine() {
  ...
  if (buildCounterLine < 3) {
    o.coordinates = buildUnnamed2629();
    o.type = "foo";
  }
  buildCounterLine--;
  return o;
...
checkLine(api.Line o) {
  buildCounterLine++;
  if (buildCounterLine < 3) {
    checkUnnamed2629(o.coordinates);
    unittest.expect(o.type, unittest.equals('foo'));
  }
  buildCounterLine--;
}
...
checkUnnamed2630(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}
...
buildPoint() {
  ...
  if (buildCounterPoint < 3) {
    o.coordinates = buildUnnamed2630();
    o.type = "foo";
  }
  buildCounterPoint--;
  return o;
...
checkPoint(api.Point o) {
  buildCounterPoint++;
  if (buildCounterPoint < 3) {
    checkUnnamed2630(o.coordinates);
    unittest.expect(o.type, unittest.equals('foo'));
  }
  buildCounterPoint--;
}
...
checkUnnamed2632(core.List<core.List<core.double>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed2633() {
  ...
  o.add(buildUnnamed2632());
  o.add(buildUnnamed2632());
  return o;
}

checkUnnamed2633(core.List<core.List<core.List<core.double>>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2632(o[0]);
  checkUnnamed2632(o[1]);
}
...
buildPolygon() {
  ...
  if (buildCounterPolygon < 3) {
    o.coordinates = buildUnnamed2633();
    o.type = "foo";
  }
  buildCounterPolygon--;
  return o;
...
checkPolygon(api.Polygon o) {
  buildCounterPolygon++;
  if (buildCounterPolygon < 3) {
    checkUnnamed2633(o.coordinates);
    unittest.expect(o.type, unittest.equals('foo'));
  }
  buildCounterPolygon--;
}
...
checkUnnamed2635(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed2636() {
  ...
  o.add(buildUnnamed2635());
  o.add(buildUnnamed2635());
  return o;
}

checkUnnamed2636(core.List<core.List<core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2635(o[0]);
  checkUnnamed2635(o[1]);
}
...
buildSqlresponse() {
  ...
  if (buildCounterSqlresponse < 3) {
    o.columns = buildUnnamed2634();
    o.kind = "foo";
    o.rows = buildUnnamed2636();
  }
  buildCounterSqlresponse--;
  return o;
}
...
checkSqlresponse(api.Sqlresponse o) {
  buildCounterSqlresponse++;
  if (buildCounterSqlresponse < 3) {
    checkUnnamed2634(o.columns);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed2636(o.rows);
  }
  buildCounterSqlresponse--;
}
...
checkUnnamed2637(core.List<api.Bucket> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBucket(o[0]);
  checkBucket(o[1]);
}
...
checkUnnamed2638(core.List<api.StyleFunctionGradientColors> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2639(core.List<api.StyleSetting> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2641(core.List<api.Column> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkColumn(o[0]);
  checkColumn(o[1]);
}
...
buildTable() {
  ...
  if (buildCounterTable < 3) {
    ...
    o.baseTableIds = buildUnnamed2640();
    o.columns = buildUnnamed2641();
    o.description = "foo";
    o.isExportable = true;
    o.kind = "foo";
    o.name = "foo";
...
checkTable(api.Table o) {
  ...
  if (buildCounterTable < 3) {
    ...
    checkUnnamed2640(o.baseTableIds);
    checkUnnamed2641(o.columns);
    unittest.expect(o.description, unittest.equals('foo'));
...
checkUnnamed2642(core.List<api.Table> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTable(o[0]);
  checkTable(o[1]);
}
...
checkUnnamed2643(core.List<api.Task> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTask(o[0]);
  checkTask(o[1]);
}
...
buildTemplate() {
  ...
  if (buildCounterTemplate < 3) {
    o.automaticColumnNames = buildUnnamed2644();
    o.body = "foo";
    o.kind = "foo";
    o.name = "foo";
    o.tableId = "foo";
...
checkTemplate(api.Template o) {
  buildCounterTemplate++;
  if (buildCounterTemplate < 3) {
    checkUnnamed2644(o.automaticColumnNames);
...
checkUnnamed2645(core.List<api.Template> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTemplate(o[0]);
  checkTemplate(o[1]);
}
