...
checkUnnamed1838(core.List<api.Column> o) {
...
checkUnnamed1839(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1840(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed1841() {
  ...
  o.add(buildUnnamed1840());
  o.add(buildUnnamed1840());
  return o;
}

checkUnnamed1841(core.List<core.List<core.double>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildLine() {
  ...
  if (buildCounterLine < 3) {
    o.coordinates = buildUnnamed1841();
    o.type = "foo";
  }
  buildCounterLine--;
  return o;
...
checkLine(api.Line o) {
  buildCounterLine++;
  if (buildCounterLine < 3) {
    checkUnnamed1841(o.coordinates);
    unittest.expect(o.type, unittest.equals('foo'));
  }
  buildCounterLine--;
}
...
checkUnnamed1842(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}
...
buildPoint() {
  ...
  if (buildCounterPoint < 3) {
    o.coordinates = buildUnnamed1842();
    o.type = "foo";
  }
  buildCounterPoint--;
  return o;
...
checkPoint(api.Point o) {
  buildCounterPoint++;
  if (buildCounterPoint < 3) {
    checkUnnamed1842(o.coordinates);
    unittest.expect(o.type, unittest.equals('foo'));
  }
  buildCounterPoint--;
}
...
checkUnnamed1843(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}
...
buildUnnamed1844() {
  var o = new core.List<core.List<core.double>>();
  o.add(buildUnnamed1843());
  o.add(buildUnnamed1843());
  return o;
}

checkUnnamed1844(core.List<core.List<core.double>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1843(o[0]);
  checkUnnamed1843(o[1]);
}

buildUnnamed1845() {
  var o = new core.List<core.List<core.List<core.double>>>();
  o.add(buildUnnamed1844());
  o.add(buildUnnamed1844());
  return o;
}

checkUnnamed1845(core.List<core.List<core.List<core.double>>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1844(o[0]);
  checkUnnamed1844(o[1]);
}
...
buildPolygon() {
  ...
  if (buildCounterPolygon < 3) {
    o.coordinates = buildUnnamed1845();
    o.type = "foo";
  }
  buildCounterPolygon--;
  return o;
...
checkPolygon(api.Polygon o) {
  buildCounterPolygon++;
  if (buildCounterPolygon < 3) {
    checkUnnamed1845(o.coordinates);
    unittest.expect(o.type, unittest.equals('foo'));
  }
  buildCounterPolygon--;
}
...
checkUnnamed1847(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed1848() {
  ...
  o.add(buildUnnamed1847());
  o.add(buildUnnamed1847());
  return o;
}

checkUnnamed1848(core.List<core.List<core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1847(o[0]);
  checkUnnamed1847(o[1]);
}
...
buildSqlresponse() {
  ...
  if (buildCounterSqlresponse < 3) {
    o.columns = buildUnnamed1846();
    o.kind = "foo";
    o.rows = buildUnnamed1848();
  }
  buildCounterSqlresponse--;
  return o;
}
...
checkSqlresponse(api.Sqlresponse o) {
  buildCounterSqlresponse++;
  if (buildCounterSqlresponse < 3) {
    checkUnnamed1846(o.columns);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1848(o.rows);
  }
  buildCounterSqlresponse--;
}
...
checkUnnamed1849(core.List<api.Bucket> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBucket(o[0]);
  checkBucket(o[1]);
}
...
checkUnnamed1850(core.List<api.StyleFunctionGradientColors> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1851(core.List<api.StyleSetting> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1853(core.List<api.Column> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkColumn(o[0]);
  checkColumn(o[1]);
}
...
buildTable() {
  ...
  if (buildCounterTable < 3) {
    ...
    o.baseTableIds = buildUnnamed1852();
    o.columns = buildUnnamed1853();
    o.description = "foo";
    o.isExportable = true;
    o.kind = "foo";
    o.name = "foo";
...
checkTable(api.Table o) {
  ...
  if (buildCounterTable < 3) {
    ...
    checkUnnamed1852(o.baseTableIds);
    checkUnnamed1853(o.columns);
    unittest.expect(o.description, unittest.equals('foo'));
...
checkUnnamed1854(core.List<api.Table> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTable(o[0]);
  checkTable(o[1]);
}
...
checkUnnamed1855(core.List<api.Task> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTask(o[0]);
  checkTask(o[1]);
}
...
buildTemplate() {
  ...
  if (buildCounterTemplate < 3) {
    o.automaticColumnNames = buildUnnamed1856();
    o.body = "foo";
    o.kind = "foo";
    o.name = "foo";
    o.tableId = "foo";
...
checkTemplate(api.Template o) {
  buildCounterTemplate++;
  if (buildCounterTemplate < 3) {
    checkUnnamed1856(o.automaticColumnNames);
...
checkUnnamed1857(core.List<api.Template> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTemplate(o[0]);
  checkTemplate(o[1]);
}
