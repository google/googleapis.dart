...
core.List<api.ApigatewayApiConfigGrpcServiceDefinition> buildUnnamed6852() => [
...
core.List<api.ApigatewayApiConfigFile> buildUnnamed6854() => [
      buildApigatewayApiConfigFile(),
      buildApigatewayApiConfigFile(),
    ];

void checkUnnamed6854(core.List<api.ApigatewayApiConfigFile> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApigatewayApiConfigFile(o[0]);
  checkApigatewayApiConfigFile(o[1]);
}

core.List<api.ApigatewayApiConfigOpenApiDocument> buildUnnamed6855() => [
      buildApigatewayApiConfigOpenApiDocument(),
      buildApigatewayApiConfigOpenApiDocument(),
    ];

void checkUnnamed6855(core.List<api.ApigatewayApiConfigOpenApiDocument> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ApigatewayApiConfig buildApigatewayApiConfig() {
  ...
  if (buildCounterApigatewayApiConfig < 3) {
    ...
    o.grpcServices = buildUnnamed6852();
    o.labels = buildUnnamed6853();
    o.managedServiceConfigs = buildUnnamed6854();
    o.name = 'foo';
    o.openapiDocuments = buildUnnamed6855();
...
void checkApigatewayApiConfig(api.ApigatewayApiConfig o) {
  ...
  if (buildCounterApigatewayApiConfig < 3) {
    ...
    checkUnnamed6852(o.grpcServices!);
    checkUnnamed6853(o.labels!);
    checkUnnamed6854(o.managedServiceConfigs!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed6855(o.openapiDocuments!);
    unittest.expect(
      o.serviceConfigId!,
      unittest.equals('foo'),
    );
...
core.List<api.ApigatewayApiConfigFile> buildUnnamed6856() => [
      buildApigatewayApiConfigFile(),
      buildApigatewayApiConfigFile(),
    ];

void checkUnnamed6856(core.List<api.ApigatewayApiConfigFile> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApigatewayApiConfigFile(o[0]);
  checkApigatewayApiConfigFile(o[1]);
}
...
core.List<api.ApigatewayAuditLogConfig> buildUnnamed6857() => [
      buildApigatewayAuditLogConfig(),
      buildApigatewayAuditLogConfig(),
    ];

void checkUnnamed6857(core.List<api.ApigatewayAuditLogConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ApigatewayAuditConfig buildApigatewayAuditConfig() {
  ...
  if (buildCounterApigatewayAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed6857();
    o.service = 'foo';
  }
  buildCounterApigatewayAuditConfig--;
  return o;
...
void checkApigatewayAuditConfig(api.ApigatewayAuditConfig o) {
  buildCounterApigatewayAuditConfig++;
  if (buildCounterApigatewayAuditConfig < 3) {
    checkUnnamed6857(o.auditLogConfigs!);
    unittest.expect(
      o.service!,
      unittest.equals('foo'),
    );
...
api.ApigatewayAuditLogConfig buildApigatewayAuditLogConfig() {
  ...
  if (buildCounterApigatewayAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed6858();
    o.logType = 'foo';
  }
  buildCounterApigatewayAuditLogConfig--;
  return o;
...
void checkApigatewayAuditLogConfig(api.ApigatewayAuditLogConfig o) {
  buildCounterApigatewayAuditLogConfig++;
  if (buildCounterApigatewayAuditLogConfig < 3) {
    checkUnnamed6858(o.exemptedMembers!);
    unittest.expect(
      o.logType!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.String> buildUnnamed6860() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed6860(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.ApigatewayApiConfig> buildUnnamed6861() => [
      buildApigatewayApiConfig(),
      buildApigatewayApiConfig(),
    ];

void checkUnnamed6861(core.List<api.ApigatewayApiConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ApigatewayListApiConfigsResponse buildApigatewayListApiConfigsResponse() {
  ...
  if (buildCounterApigatewayListApiConfigsResponse < 3) {
    o.apiConfigs = buildUnnamed6861();
    o.nextPageToken = 'foo';
    o.unreachableLocations = buildUnnamed6862();
  }
  buildCounterApigatewayListApiConfigsResponse--;
  return o;
}
...
void checkApigatewayListApiConfigsResponse(
  ...
  buildCounterApigatewayListApiConfigsResponse++;
  if (buildCounterApigatewayListApiConfigsResponse < 3) {
    checkUnnamed6861(o.apiConfigs!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
    checkUnnamed6862(o.unreachableLocations!);
  }
  buildCounterApigatewayListApiConfigsResponse--;
}

core.List<api.ApigatewayApi> buildUnnamed6863() => [
      buildApigatewayApi(),
      buildApigatewayApi(),
    ];

void checkUnnamed6863(core.List<api.ApigatewayApi> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ApigatewayListApisResponse buildApigatewayListApisResponse() {
  ...
  if (buildCounterApigatewayListApisResponse < 3) {
    o.apis = buildUnnamed6863();
    o.nextPageToken = 'foo';
    o.unreachableLocations = buildUnnamed6864();
  }
  buildCounterApigatewayListApisResponse--;
  return o;
}
...
void checkApigatewayListApisResponse(api.ApigatewayListApisResponse o) {
  buildCounterApigatewayListApisResponse++;
  if (buildCounterApigatewayListApisResponse < 3) {
    checkUnnamed6863(o.apis!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
    checkUnnamed6864(o.unreachableLocations!);
  }
  buildCounterApigatewayListApisResponse--;
}

core.List<api.ApigatewayGateway> buildUnnamed6865() => [
      buildApigatewayGateway(),
      buildApigatewayGateway(),
    ];

void checkUnnamed6865(core.List<api.ApigatewayGateway> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ApigatewayListGatewaysResponse buildApigatewayListGatewaysResponse() {
  ...
  if (buildCounterApigatewayListGatewaysResponse < 3) {
    o.gateways = buildUnnamed6865();
    o.nextPageToken = 'foo';
    o.unreachableLocations = buildUnnamed6866();
  }
  buildCounterApigatewayListGatewaysResponse--;
  return o;
}
...
void checkApigatewayListGatewaysResponse(api.ApigatewayListGatewaysResponse o) {
  buildCounterApigatewayListGatewaysResponse++;
  if (buildCounterApigatewayListGatewaysResponse < 3) {
    checkUnnamed6865(o.gateways!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
    checkUnnamed6866(o.unreachableLocations!);
  }
  buildCounterApigatewayListGatewaysResponse--;
}

core.List<api.ApigatewayLocation> buildUnnamed6867() => [
      buildApigatewayLocation(),
      buildApigatewayLocation(),
    ];

void checkUnnamed6867(core.List<api.ApigatewayLocation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ApigatewayOperation> buildUnnamed6868() => [
      buildApigatewayOperation(),
      buildApigatewayOperation(),
    ];

void checkUnnamed6868(core.List<api.ApigatewayOperation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ApigatewayOperation buildApigatewayOperation() {
  ...
  if (buildCounterApigatewayOperation < 3) {
    ...
    o.metadata = buildUnnamed6871();
    o.name = 'foo';
    o.response = buildUnnamed6872();
  }
  buildCounterApigatewayOperation--;
  return o;
}
...
void checkApigatewayOperation(api.ApigatewayOperation o) {
  ...
  if (buildCounterApigatewayOperation < 3) {
    ...
    checkUnnamed6871(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed6872(o.response!);
  }
  buildCounterApigatewayOperation--;
}

core.List<api.ApigatewayOperationMetadataDiagnostic> buildUnnamed6873() => [
      buildApigatewayOperationMetadataDiagnostic(),
      buildApigatewayOperationMetadataDiagnostic(),
    ];

void checkUnnamed6873(core.List<api.ApigatewayOperationMetadataDiagnostic> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ApigatewayOperationMetadata buildApigatewayOperationMetadata() {
  ...
  if (buildCounterApigatewayOperationMetadata < 3) {
    o.apiVersion = 'foo';
    o.createTime = 'foo';
    o.diagnostics = buildUnnamed6873();
    o.endTime = 'foo';
...
void checkApigatewayOperationMetadata(api.ApigatewayOperationMetadata o) {
  ...
  if (buildCounterApigatewayOperationMetadata < 3) {
    ...
    checkUnnamed6873(o.diagnostics!);
    unittest.expect(
      o.endTime!,
      unittest.equals('foo'),
    );
...
core.List<api.ApigatewayAuditConfig> buildUnnamed6874() => [
      buildApigatewayAuditConfig(),
      buildApigatewayAuditConfig(),
    ];

void checkUnnamed6874(core.List<api.ApigatewayAuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApigatewayAuditConfig(o[0]);
  checkApigatewayAuditConfig(o[1]);
}

core.List<api.ApigatewayBinding> buildUnnamed6875() => [
      buildApigatewayBinding(),
      buildApigatewayBinding(),
    ];

void checkUnnamed6875(core.List<api.ApigatewayBinding> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ApigatewayPolicy buildApigatewayPolicy() {
  ...
  if (buildCounterApigatewayPolicy < 3) {
    o.auditConfigs = buildUnnamed6874();
    o.bindings = buildUnnamed6875();
    o.etag = 'foo';
    o.version = 42;
  }
  buildCounterApigatewayPolicy--;
...
void checkApigatewayPolicy(api.ApigatewayPolicy o) {
  buildCounterApigatewayPolicy++;
  if (buildCounterApigatewayPolicy < 3) {
    checkUnnamed6874(o.auditConfigs!);
    checkUnnamed6875(o.bindings!);
    unittest.expect(
      o.etag!,
      unittest.equals('foo'),
    );
...
core.List<core.Map<core.String, core.Object>> buildUnnamed6877() => [
      buildUnnamed6876(),
      buildUnnamed6876(),
    ];

void checkUnnamed6877(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed6876(o[0]);
  checkUnnamed6876(o[1]);
}
...
api.ApigatewayTestIamPermissionsRequest
  ...
  if (buildCounterApigatewayTestIamPermissionsRequest < 3) {
    o.permissions = buildUnnamed6878();
  }
  buildCounterApigatewayTestIamPermissionsRequest--;
  return o;
}
...
void checkApigatewayTestIamPermissionsRequest(
  ...
  buildCounterApigatewayTestIamPermissionsRequest++;
  if (buildCounterApigatewayTestIamPermissionsRequest < 3) {
    checkUnnamed6878(o.permissions!);
  }
  buildCounterApigatewayTestIamPermissionsRequest--;
}
...
api.ApigatewayTestIamPermissionsResponse
  ...
  if (buildCounterApigatewayTestIamPermissionsResponse < 3) {
    o.permissions = buildUnnamed6879();
  }
  buildCounterApigatewayTestIamPermissionsResponse--;
  return o;
}
...
void checkApigatewayTestIamPermissionsResponse(
  ...
  buildCounterApigatewayTestIamPermissionsResponse++;
  if (buildCounterApigatewayTestIamPermissionsResponse < 3) {
    checkUnnamed6879(o.permissions!);
  }
  buildCounterApigatewayTestIamPermissionsResponse--;
}
