...
core.List<api.ApigatewayApiConfigGrpcServiceDefinition> buildUnnamed4911() {
...
core.Map<core.String, core.String> buildUnnamed4912() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed4912(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o['x'], unittest.equals('foo'));
  unittest.expect(o['y'], unittest.equals('foo'));
}

core.List<api.ApigatewayApiConfigFile> buildUnnamed4913() {
...
void checkUnnamed4913(core.List<api.ApigatewayApiConfigFile> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ApigatewayApiConfigOpenApiDocument> buildUnnamed4914() {
...
void checkUnnamed4914(core.List<api.ApigatewayApiConfigOpenApiDocument> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ApigatewayApiConfig buildApigatewayApiConfig() {
  ...
  if (buildCounterApigatewayApiConfig < 3) {
    ...
    o.grpcServices = buildUnnamed4911();
    o.labels = buildUnnamed4912();
    o.managedServiceConfigs = buildUnnamed4913();
    o.name = 'foo';
    o.openapiDocuments = buildUnnamed4914();
...
void checkApigatewayApiConfig(api.ApigatewayApiConfig o) {
  ...
  if (buildCounterApigatewayApiConfig < 3) {
    ...
    checkUnnamed4911(o.grpcServices);
    checkUnnamed4912(o.labels);
    checkUnnamed4913(o.managedServiceConfigs);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed4914(o.openapiDocuments);
...
core.List<api.ApigatewayApiConfigFile> buildUnnamed4915() {
  var o = <api.ApigatewayApiConfigFile>[];
  o.add(buildApigatewayApiConfigFile());
  o.add(buildApigatewayApiConfigFile());
  return o;
...
void checkUnnamed4915(core.List<api.ApigatewayApiConfigFile> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApigatewayApiConfigFile(o[0] as api.ApigatewayApiConfigFile);
  checkApigatewayApiConfigFile(o[1] as api.ApigatewayApiConfigFile);
}
...
core.List<api.ApigatewayAuditLogConfig> buildUnnamed4916() {
...
void checkUnnamed4916(core.List<api.ApigatewayAuditLogConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ApigatewayAuditConfig buildApigatewayAuditConfig() {
  ...
  if (buildCounterApigatewayAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed4916();
    o.service = 'foo';
  }
  buildCounterApigatewayAuditConfig--;
  return o;
...
void checkApigatewayAuditConfig(api.ApigatewayAuditConfig o) {
  buildCounterApigatewayAuditConfig++;
  if (buildCounterApigatewayAuditConfig < 3) {
    checkUnnamed4916(o.auditLogConfigs);
...
api.ApigatewayAuditLogConfig buildApigatewayAuditLogConfig() {
  ...
  if (buildCounterApigatewayAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed4917();
    o.logType = 'foo';
  }
  buildCounterApigatewayAuditLogConfig--;
  return o;
...
void checkApigatewayAuditLogConfig(api.ApigatewayAuditLogConfig o) {
  buildCounterApigatewayAuditLogConfig++;
  if (buildCounterApigatewayAuditLogConfig < 3) {
    checkUnnamed4917(o.exemptedMembers);
...
core.Map<core.String, core.String> buildUnnamed4919() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed4919(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o['x'], unittest.equals('foo'));
  unittest.expect(o['y'], unittest.equals('foo'));
}
...
core.List<api.ApigatewayApiConfig> buildUnnamed4920() {
  var o = <api.ApigatewayApiConfig>[];
...
void checkUnnamed4920(core.List<api.ApigatewayApiConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ApigatewayListApiConfigsResponse buildApigatewayListApiConfigsResponse() {
  ...
  if (buildCounterApigatewayListApiConfigsResponse < 3) {
    o.apiConfigs = buildUnnamed4920();
    o.nextPageToken = 'foo';
    o.unreachableLocations = buildUnnamed4921();
  }
  buildCounterApigatewayListApiConfigsResponse--;
  return o;
}
...
void checkApigatewayListApiConfigsResponse(
  ...
  buildCounterApigatewayListApiConfigsResponse++;
  if (buildCounterApigatewayListApiConfigsResponse < 3) {
    checkUnnamed4920(o.apiConfigs);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4921(o.unreachableLocations);
  }
  buildCounterApigatewayListApiConfigsResponse--;
}

core.List<api.ApigatewayApi> buildUnnamed4922() {
  var o = <api.ApigatewayApi>[];
...
void checkUnnamed4922(core.List<api.ApigatewayApi> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ApigatewayListApisResponse buildApigatewayListApisResponse() {
  ...
  if (buildCounterApigatewayListApisResponse < 3) {
    o.apis = buildUnnamed4922();
    o.nextPageToken = 'foo';
    o.unreachableLocations = buildUnnamed4923();
  }
  buildCounterApigatewayListApisResponse--;
  return o;
}
...
void checkApigatewayListApisResponse(api.ApigatewayListApisResponse o) {
  buildCounterApigatewayListApisResponse++;
  if (buildCounterApigatewayListApisResponse < 3) {
    checkUnnamed4922(o.apis);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4923(o.unreachableLocations);
  }
  buildCounterApigatewayListApisResponse--;
}

core.List<api.ApigatewayGateway> buildUnnamed4924() {
  var o = <api.ApigatewayGateway>[];
...
void checkUnnamed4924(core.List<api.ApigatewayGateway> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ApigatewayListGatewaysResponse buildApigatewayListGatewaysResponse() {
  ...
  if (buildCounterApigatewayListGatewaysResponse < 3) {
    o.gateways = buildUnnamed4924();
    o.nextPageToken = 'foo';
    o.unreachableLocations = buildUnnamed4925();
  }
  buildCounterApigatewayListGatewaysResponse--;
  return o;
}
...
void checkApigatewayListGatewaysResponse(api.ApigatewayListGatewaysResponse o) {
  buildCounterApigatewayListGatewaysResponse++;
  if (buildCounterApigatewayListGatewaysResponse < 3) {
    checkUnnamed4924(o.gateways);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4925(o.unreachableLocations);
  }
  buildCounterApigatewayListGatewaysResponse--;
}

core.List<api.ApigatewayLocation> buildUnnamed4926() {
...
void checkUnnamed4926(core.List<api.ApigatewayLocation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkApigatewayListLocationsResponse(
  ...
  buildCounterApigatewayListLocationsResponse++;
  if (buildCounterApigatewayListLocationsResponse < 3) {
    checkUnnamed4926(o.locations);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterApigatewayListLocationsResponse--;
}

core.List<api.ApigatewayOperation> buildUnnamed4927() {
...
void checkUnnamed4927(core.List<api.ApigatewayOperation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkApigatewayListOperationsResponse(
  ...
  if (buildCounterApigatewayListOperationsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4927(o.operations);
  }
  buildCounterApigatewayListOperationsResponse--;
}

core.Map<core.String, core.String> buildUnnamed4928() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed4928(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o['x'], unittest.equals('foo'));
  unittest.expect(o['y'], unittest.equals('foo'));
}
...
api.ApigatewayLocation buildApigatewayLocation() {
  ...
  if (buildCounterApigatewayLocation < 3) {
    o.displayName = 'foo';
    o.labels = buildUnnamed4928();
    o.locationId = 'foo';
    o.metadata = buildUnnamed4929();
    o.name = 'foo';
  }
  buildCounterApigatewayLocation--;
  return o;
...
void checkApigatewayLocation(api.ApigatewayLocation o) {
  ...
  if (buildCounterApigatewayLocation < 3) {
    unittest.expect(o.displayName, unittest.equals('foo'));
    checkUnnamed4928(o.labels);
    unittest.expect(o.locationId, unittest.equals('foo'));
    checkUnnamed4929(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
  }
  buildCounterApigatewayLocation--;
}
...
api.ApigatewayOperation buildApigatewayOperation() {
  ...
  if (buildCounterApigatewayOperation < 3) {
    ...
    o.metadata = buildUnnamed4930();
    o.name = 'foo';
    o.response = buildUnnamed4931();
  }
  buildCounterApigatewayOperation--;
  return o;
}
...
void checkApigatewayOperation(api.ApigatewayOperation o) {
  ...
  if (buildCounterApigatewayOperation < 3) {
    ...
    checkUnnamed4930(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed4931(o.response);
  }
  buildCounterApigatewayOperation--;
}

core.List<api.ApigatewayOperationMetadataDiagnostic> buildUnnamed4932() {
...
void checkUnnamed4932(core.List<api.ApigatewayOperationMetadataDiagnostic> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ApigatewayOperationMetadata buildApigatewayOperationMetadata() {
  ...
  if (buildCounterApigatewayOperationMetadata < 3) {
    o.apiVersion = 'foo';
    o.createTime = 'foo';
    o.diagnostics = buildUnnamed4932();
    o.endTime = 'foo';
...
void checkApigatewayOperationMetadata(api.ApigatewayOperationMetadata o) {
  ...
  if (buildCounterApigatewayOperationMetadata < 3) {
    ...
    unittest.expect(o.createTime, unittest.equals('foo'));
    checkUnnamed4932(o.diagnostics);
...
core.List<api.ApigatewayAuditConfig> buildUnnamed4933() {
  var o = <api.ApigatewayAuditConfig>[];
...
void checkUnnamed4934(core.List<api.ApigatewayBinding> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ApigatewayPolicy buildApigatewayPolicy() {
  ...
  if (buildCounterApigatewayPolicy < 3) {
    o.auditConfigs = buildUnnamed4933();
    o.bindings = buildUnnamed4934();
    o.etag = 'foo';
    o.version = 42;
  }
  buildCounterApigatewayPolicy--;
...
void checkApigatewayPolicy(api.ApigatewayPolicy o) {
  buildCounterApigatewayPolicy++;
  if (buildCounterApigatewayPolicy < 3) {
    checkUnnamed4933(o.auditConfigs);
    checkUnnamed4934(o.bindings);
...
api.ApigatewayTestIamPermissionsRequest
  ...
  if (buildCounterApigatewayTestIamPermissionsRequest < 3) {
    o.permissions = buildUnnamed4937();
  }
  buildCounterApigatewayTestIamPermissionsRequest--;
  return o;
}
...
void checkApigatewayTestIamPermissionsRequest(
  ...
  buildCounterApigatewayTestIamPermissionsRequest++;
  if (buildCounterApigatewayTestIamPermissionsRequest < 3) {
    checkUnnamed4937(o.permissions);
  }
  buildCounterApigatewayTestIamPermissionsRequest--;
}
...
api.ApigatewayTestIamPermissionsResponse
  ...
  if (buildCounterApigatewayTestIamPermissionsResponse < 3) {
    o.permissions = buildUnnamed4938();
  }
  buildCounterApigatewayTestIamPermissionsResponse--;
  return o;
}
...
void checkApigatewayTestIamPermissionsResponse(
  ...
  buildCounterApigatewayTestIamPermissionsResponse++;
  if (buildCounterApigatewayTestIamPermissionsResponse < 3) {
    checkUnnamed4938(o.permissions);
  }
  buildCounterApigatewayTestIamPermissionsResponse--;
}
