...
import 'package:googleapis/apigateway/v1beta.dart' as api;
...
api.ApigatewayApiConfig buildApigatewayApiConfig() {
  ...
  if (buildCounterApigatewayApiConfig < 3) {
    o.createTime = 'foo';
    o.displayName = 'foo';
    o.gatewayConfig = buildApigatewayGatewayConfig();
...
void checkApigatewayApiConfig(api.ApigatewayApiConfig o) {
  ...
  if (buildCounterApigatewayApiConfig < 3) {
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.displayName!, unittest.equals('foo'));
    checkApigatewayGatewayConfig(o.gatewayConfig!);
...
core.int buildCounterApigatewayBackendConfig = 0;
api.ApigatewayBackendConfig buildApigatewayBackendConfig() {
  final o = api.ApigatewayBackendConfig();
  buildCounterApigatewayBackendConfig++;
  if (buildCounterApigatewayBackendConfig < 3) {
    o.googleServiceAccount = 'foo';
  }
  buildCounterApigatewayBackendConfig--;
  return o;
}

void checkApigatewayBackendConfig(api.ApigatewayBackendConfig o) {
  buildCounterApigatewayBackendConfig++;
  if (buildCounterApigatewayBackendConfig < 3) {
    unittest.expect(o.googleServiceAccount!, unittest.equals('foo'));
  }
  buildCounterApigatewayBackendConfig--;
}
...
core.int buildCounterApigatewayGatewayConfig = 0;
api.ApigatewayGatewayConfig buildApigatewayGatewayConfig() {
  final o = api.ApigatewayGatewayConfig();
  buildCounterApigatewayGatewayConfig++;
  if (buildCounterApigatewayGatewayConfig < 3) {
    o.backendConfig = buildApigatewayBackendConfig();
  }
  buildCounterApigatewayGatewayConfig--;
  return o;
}

void checkApigatewayGatewayConfig(api.ApigatewayGatewayConfig o) {
  buildCounterApigatewayGatewayConfig++;
  if (buildCounterApigatewayGatewayConfig < 3) {
    checkApigatewayBackendConfig(o.backendConfig!);
  }
  buildCounterApigatewayGatewayConfig--;
}
...
void main() {
  ...
  unittest.group('obj-schema-ApigatewayBackendConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildApigatewayBackendConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ApigatewayBackendConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkApigatewayBackendConfig(od);
    });
  });
  ...
  unittest.group('obj-schema-ApigatewayGatewayConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildApigatewayGatewayConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ApigatewayGatewayConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkApigatewayGatewayConfig(od);
    });
  });
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final resp = convert.json.encode(
            buildApigatewayListLocationsResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildApigatewayListApiConfigsResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildApigatewayListGatewaysResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildApigatewayListOperationsResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
