...
core.List<api.GoogleCloudOrgpolicyV2Constraint> buildUnnamed5713() => [
      buildGoogleCloudOrgpolicyV2Constraint(),
      buildGoogleCloudOrgpolicyV2Constraint(),
    ];

void checkUnnamed5713(core.List<api.GoogleCloudOrgpolicyV2Constraint> o) {
...
api.GoogleCloudOrgpolicyV2ListConstraintsResponse
  ...
  if (buildCounterGoogleCloudOrgpolicyV2ListConstraintsResponse < 3) {
    o.constraints = buildUnnamed5713();
    o.nextPageToken = 'foo';
  }
  buildCounterGoogleCloudOrgpolicyV2ListConstraintsResponse--;
  return o;
...
void checkGoogleCloudOrgpolicyV2ListConstraintsResponse(
  ...
  buildCounterGoogleCloudOrgpolicyV2ListConstraintsResponse++;
  if (buildCounterGoogleCloudOrgpolicyV2ListConstraintsResponse < 3) {
    checkUnnamed5713(o.constraints!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.GoogleCloudOrgpolicyV2Policy> buildUnnamed5714() => [
      buildGoogleCloudOrgpolicyV2Policy(),
      buildGoogleCloudOrgpolicyV2Policy(),
    ];

void checkUnnamed5714(core.List<api.GoogleCloudOrgpolicyV2Policy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleCloudOrgpolicyV2PolicySpecPolicyRule> buildUnnamed5715() =>
    [
...
api.GoogleCloudOrgpolicyV2PolicySpecPolicyRuleStringValues
  ...
  if (buildCounterGoogleCloudOrgpolicyV2PolicySpecPolicyRuleStringValues < 3) {
    o.allowedValues = buildUnnamed5716();
    o.deniedValues = buildUnnamed5717();
  }
  buildCounterGoogleCloudOrgpolicyV2PolicySpecPolicyRuleStringValues--;
  return o;
}
...
void checkGoogleCloudOrgpolicyV2PolicySpecPolicyRuleStringValues(
  ...
  buildCounterGoogleCloudOrgpolicyV2PolicySpecPolicyRuleStringValues++;
  if (buildCounterGoogleCloudOrgpolicyV2PolicySpecPolicyRuleStringValues < 3) {
    checkUnnamed5716(o.allowedValues!);
    checkUnnamed5717(o.deniedValues!);
  }
  buildCounterGoogleCloudOrgpolicyV2PolicySpecPolicyRuleStringValues--;
}
