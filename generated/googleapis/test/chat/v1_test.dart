...
core.List<api.Reaction> buildUnnamed20() => [
      buildReaction(),
      buildReaction(),
    ];
...
core.List<api.Space> buildUnnamed22() => [
      buildSpace(),
      buildSpace(),
    ];
...
core.List<api.Card> buildUnnamed30() => [
      buildCard(),
      buildCard(),
    ];
...
core.List<api.Space> buildUnnamed38() => [
      buildSpace(),
      buildSpace(),
    ];
...
core.List<api.Button> buildUnnamed43() => [
      buildButton(),
      buildButton(),
    ];
