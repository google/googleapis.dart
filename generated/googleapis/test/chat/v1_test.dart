...
checkUnnamed1933(core.List<api.CardAction> o) {
...
checkUnnamed1934(core.List<api.Section> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSection(o[0]);
  checkSection(o[1]);
}
...
buildCard() {
  ...
  if (buildCounterCard < 3) {
    o.cardActions = buildUnnamed1933();
    o.header = buildCardHeader();
    o.name = "foo";
    o.sections = buildUnnamed1934();
  }
  buildCounterCard--;
  return o;
}
...
checkCard(api.Card o) {
  buildCounterCard++;
  if (buildCounterCard < 3) {
    checkUnnamed1933(o.cardActions);
    checkCardHeader(o.header);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed1934(o.sections);
  }
  buildCounterCard--;
}
...
checkUnnamed1935(core.List<api.ActionParameter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1936(core.List<api.Membership> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMembership(o[0]);
  checkMembership(o[1]);
}
...
buildListMembershipsResponse() {
  ...
  if (buildCounterListMembershipsResponse < 3) {
    o.memberships = buildUnnamed1936();
    o.nextPageToken = "foo";
  }
  buildCounterListMembershipsResponse--;
  return o;
...
checkListMembershipsResponse(api.ListMembershipsResponse o) {
  buildCounterListMembershipsResponse++;
  if (buildCounterListMembershipsResponse < 3) {
    checkUnnamed1936(o.memberships);
...
checkUnnamed1937(core.List<api.Space> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSpace(o[0]);
  checkSpace(o[1]);
}
...
checkUnnamed1938(core.List<api.Annotation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAnnotation(o[0]);
  checkAnnotation(o[1]);
}
...
checkUnnamed1939(core.List<api.Card> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCard(o[0]);
  checkCard(o[1]);
}
...
buildMessage() {
  ...
  if (buildCounterMessage < 3) {
    ...
    o.annotations = buildUnnamed1938();
    o.argumentText = "foo";
    o.cards = buildUnnamed1939();
    o.createTime = "foo";
    o.fallbackText = "foo";
    o.name = "foo";
    o.previewText = "foo";
...
checkMessage(api.Message o) {
  ...
  if (buildCounterMessage < 3) {
    ...
    checkUnnamed1938(o.annotations);
    unittest.expect(o.argumentText, unittest.equals('foo'));
    checkUnnamed1939(o.cards);
    unittest.expect(o.createTime, unittest.equals('foo'));
...
checkUnnamed1940(core.List<api.WidgetMarkup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1941(core.List<api.Button> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkButton(o[0]);
  checkButton(o[1]);
}
