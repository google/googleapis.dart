...
void checkActionStatus(api.ActionStatus o) {
  ...
  if (buildCounterActionStatus < 3) {
    ...
    unittest.expect(o.userFacingMessage!, unittest.equals('foo'));
  }
  buildCounterActionStatus--;
}
...
void checkAttachmentDataRef(api.AttachmentDataRef o) {
  buildCounterAttachmentDataRef++;
  if (buildCounterAttachmentDataRef < 3) {
    unittest.expect(o.attachmentUploadToken!, unittest.equals('foo'));
...
core.int buildCounterCalendarEventLinkData = 0;
api.CalendarEventLinkData buildCalendarEventLinkData() {
  final o = api.CalendarEventLinkData();
  buildCounterCalendarEventLinkData++;
  if (buildCounterCalendarEventLinkData < 3) {
    o.calendarId = 'foo';
    o.eventId = 'foo';
  }
  buildCounterCalendarEventLinkData--;
...
void checkCalendarEventLinkData(api.CalendarEventLinkData o) {
  buildCounterCalendarEventLinkData++;
  if (buildCounterCalendarEventLinkData < 3) {
...
void checkCardWithId(api.CardWithId o) {
  ...
  if (buildCounterCardWithId < 3) {
    ...
    unittest.expect(o.cardId!, unittest.equals('foo'));
  }
  buildCounterCardWithId--;
}
...
void checkChatSpaceLinkData(api.ChatSpaceLinkData o) {
  ...
  if (buildCounterChatSpaceLinkData < 3) {
    ...
    unittest.expect(o.thread!, unittest.equals('foo'));
  }
  buildCounterChatSpaceLinkData--;
}
...
api.CustomEmoji buildCustomEmoji() {
  ...
  if (buildCounterCustomEmoji < 3) {
    o.emojiName = 'foo';
    o.name = 'foo';
    o.payload = buildCustomEmojiPayload();
    o.temporaryImageUri = 'foo';
    o.uid = 'foo';
  }
  buildCounterCustomEmoji--;
  return o;
...
void checkCustomEmoji(api.CustomEmoji o) {
  buildCounterCustomEmoji++;
  if (buildCounterCustomEmoji < 3) {
    unittest.expect(o.emojiName!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    checkCustomEmojiPayload(o.payload!);
    unittest.expect(o.temporaryImageUri!, unittest.equals('foo'));
...
core.int buildCounterCustomEmojiPayload = 0;
api.CustomEmojiPayload buildCustomEmojiPayload() {
  final o = api.CustomEmojiPayload();
  buildCounterCustomEmojiPayload++;
  if (buildCounterCustomEmojiPayload < 3) {
    o.fileContent = 'foo';
    o.filename = 'foo';
  }
  buildCounterCustomEmojiPayload--;
...
void checkCustomEmojiPayload(api.CustomEmojiPayload o) {
  buildCounterCustomEmojiPayload++;
  if (buildCounterCustomEmojiPayload < 3) {
    unittest.expect(o.fileContent!, unittest.equals('foo'));
...
void checkDeletionMetadata(api.DeletionMetadata o) {
  buildCounterDeletionMetadata++;
  if (buildCounterDeletionMetadata < 3) {
    unittest.expect(o.deletionType!, unittest.equals('foo'));
  }
  buildCounterDeletionMetadata--;
}
...
void checkEmoji(api.Emoji o) {
  ...
  if (buildCounterEmoji < 3) {
    checkCustomEmoji(o.customEmoji!);
    unittest.expect(o.unicode!, unittest.equals('foo'));
  }
  buildCounterEmoji--;
}
...
void checkEmojiReactionSummary(api.EmojiReactionSummary o) {
  ...
  if (buildCounterEmojiReactionSummary < 3) {
    checkEmoji(o.emoji!);
    unittest.expect(o.reactionCount!, unittest.equals(42));
  }
  buildCounterEmojiReactionSummary--;
}
...
core.int buildCounterFindGroupChatsResponse = 0;
api.FindGroupChatsResponse buildFindGroupChatsResponse() {
  final o = api.FindGroupChatsResponse();
...
void checkFindGroupChatsResponse(api.FindGroupChatsResponse o) {
  buildCounterFindGroupChatsResponse++;
  if (buildCounterFindGroupChatsResponse < 3) {
...
void checkGoogleAppsCardV1BorderStyle(api.GoogleAppsCardV1BorderStyle o) {
  buildCounterGoogleAppsCardV1BorderStyle++;
  if (buildCounterGoogleAppsCardV1BorderStyle < 3) {
    unittest.expect(o.cornerRadius!, unittest.equals(42));
...
void checkGoogleAppsCardV1CardHeader(api.GoogleAppsCardV1CardHeader o) {
  buildCounterGoogleAppsCardV1CardHeader++;
  if (buildCounterGoogleAppsCardV1CardHeader < 3) {
    unittest.expect(o.imageAltText!, unittest.equals('foo'));
...
void checkUnnamed12(core.List<api.GoogleAppsCardV1NestedWidget> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.int buildCounterGoogleAppsCardV1CommonWidgetAction = 0;
api.GoogleAppsCardV1CommonWidgetAction
buildGoogleAppsCardV1CommonWidgetAction() {
  final o = api.GoogleAppsCardV1CommonWidgetAction();
  buildCounterGoogleAppsCardV1CommonWidgetAction++;
  if (buildCounterGoogleAppsCardV1CommonWidgetAction < 3) {
    o.updateVisibilityAction = buildGoogleAppsCardV1UpdateVisibilityAction();
  }
  buildCounterGoogleAppsCardV1CommonWidgetAction--;
  return o;
}

void checkGoogleAppsCardV1CommonWidgetAction(
  api.GoogleAppsCardV1CommonWidgetAction o,
) {
  buildCounterGoogleAppsCardV1CommonWidgetAction++;
  if (buildCounterGoogleAppsCardV1CommonWidgetAction < 3) {
    checkGoogleAppsCardV1UpdateVisibilityAction(o.updateVisibilityAction!);
  }
  buildCounterGoogleAppsCardV1CommonWidgetAction--;
}

core.int buildCounterGoogleAppsCardV1Condition = 0;
api.GoogleAppsCardV1Condition buildGoogleAppsCardV1Condition() {
  final o = api.GoogleAppsCardV1Condition();
  buildCounterGoogleAppsCardV1Condition++;
  if (buildCounterGoogleAppsCardV1Condition < 3) {
    o.actionRuleId = 'foo';
    o.expressionDataCondition = buildGoogleAppsCardV1ExpressionDataCondition();
  }
  buildCounterGoogleAppsCardV1Condition--;
  return o;
}

void checkGoogleAppsCardV1Condition(api.GoogleAppsCardV1Condition o) {
  buildCounterGoogleAppsCardV1Condition++;
  if (buildCounterGoogleAppsCardV1Condition < 3) {
    unittest.expect(o.actionRuleId!, unittest.equals('foo'));
    checkGoogleAppsCardV1ExpressionDataCondition(o.expressionDataCondition!);
  }
  buildCounterGoogleAppsCardV1Condition--;
}

core.int buildCounterGoogleAppsCardV1DataSourceConfig = 0;
api.GoogleAppsCardV1DataSourceConfig buildGoogleAppsCardV1DataSourceConfig() {
  final o = api.GoogleAppsCardV1DataSourceConfig();
  buildCounterGoogleAppsCardV1DataSourceConfig++;
  if (buildCounterGoogleAppsCardV1DataSourceConfig < 3) {
    o.minCharactersTrigger = 42;
    o.platformDataSource = buildGoogleAppsCardV1PlatformDataSource();
    o.remoteDataSource = buildGoogleAppsCardV1Action();
  }
  buildCounterGoogleAppsCardV1DataSourceConfig--;
  return o;
}

void checkGoogleAppsCardV1DataSourceConfig(
  api.GoogleAppsCardV1DataSourceConfig o,
) {
  buildCounterGoogleAppsCardV1DataSourceConfig++;
  if (buildCounterGoogleAppsCardV1DataSourceConfig < 3) {
    unittest.expect(o.minCharactersTrigger!, unittest.equals(42));
    checkGoogleAppsCardV1PlatformDataSource(o.platformDataSource!);
    checkGoogleAppsCardV1Action(o.remoteDataSource!);
  }
  buildCounterGoogleAppsCardV1DataSourceConfig--;
}
...
void checkGoogleAppsCardV1DateTimePicker(api.GoogleAppsCardV1DateTimePicker o) {
  ...
  if (buildCounterGoogleAppsCardV1DateTimePicker < 3) {
    ...
    unittest.expect(o.timezoneOffsetDate!, unittest.equals(42));
    unittest.expect(o.type!, unittest.equals('foo'));
    unittest.expect(o.valueMsEpoch!, unittest.equals('foo'));
  }
  buildCounterGoogleAppsCardV1DateTimePicker--;
}
...
api.GoogleAppsCardV1DecoratedText buildGoogleAppsCardV1DecoratedText() {
  ...
  if (buildCounterGoogleAppsCardV1DecoratedText < 3) {
    o.bottomLabel = 'foo';
    o.bottomLabelText = buildGoogleAppsCardV1TextParagraph();
    o.button = buildGoogleAppsCardV1Button();
    o.contentText = buildGoogleAppsCardV1TextParagraph();
    o.endIcon = buildGoogleAppsCardV1Icon();
    o.icon = buildGoogleAppsCardV1Icon();
    o.onClick = buildGoogleAppsCardV1OnClick();
    o.startIcon = buildGoogleAppsCardV1Icon();
    o.startIconVerticalAlignment = 'foo';
    o.switchControl = buildGoogleAppsCardV1SwitchControl();
    o.text = 'foo';
    o.topLabel = 'foo';
    o.topLabelText = buildGoogleAppsCardV1TextParagraph();
    o.wrapText = true;
  }
  buildCounterGoogleAppsCardV1DecoratedText--;
  return o;
...
void checkGoogleAppsCardV1DecoratedText(api.GoogleAppsCardV1DecoratedText o) {
  ...
  if (buildCounterGoogleAppsCardV1DecoratedText < 3) {
    ...
    checkGoogleAppsCardV1TextParagraph(o.bottomLabelText!);
    checkGoogleAppsCardV1Button(o.button!);
    checkGoogleAppsCardV1TextParagraph(o.contentText!);
    checkGoogleAppsCardV1Icon(o.endIcon!);
    checkGoogleAppsCardV1Icon(o.icon!);
    checkGoogleAppsCardV1OnClick(o.onClick!);
    checkGoogleAppsCardV1Icon(o.startIcon!);
    unittest.expect(o.startIconVerticalAlignment!, unittest.equals('foo'));
    checkGoogleAppsCardV1SwitchControl(o.switchControl!);
    unittest.expect(o.text!, unittest.equals('foo'));
    unittest.expect(o.topLabel!, unittest.equals('foo'));
    checkGoogleAppsCardV1TextParagraph(o.topLabelText!);
...
core.int buildCounterGoogleAppsCardV1EventAction = 0;
api.GoogleAppsCardV1EventAction buildGoogleAppsCardV1EventAction() {
  final o = api.GoogleAppsCardV1EventAction();
...
void checkGoogleAppsCardV1EventAction(api.GoogleAppsCardV1EventAction o) {
  buildCounterGoogleAppsCardV1EventAction++;
  if (buildCounterGoogleAppsCardV1EventAction < 3) {
    unittest.expect(o.actionRuleId!, unittest.equals('foo'));
...
core.int buildCounterGoogleAppsCardV1ExpressionData = 0;
api.GoogleAppsCardV1ExpressionData buildGoogleAppsCardV1ExpressionData() {
...
core.int buildCounterGoogleAppsCardV1ExpressionDataCondition = 0;
api.GoogleAppsCardV1ExpressionDataCondition
buildGoogleAppsCardV1ExpressionDataCondition() {
  final o = api.GoogleAppsCardV1ExpressionDataCondition();
  buildCounterGoogleAppsCardV1ExpressionDataCondition++;
  if (buildCounterGoogleAppsCardV1ExpressionDataCondition < 3) {
    o.conditionType = 'foo';
  }
  buildCounterGoogleAppsCardV1ExpressionDataCondition--;
  return o;
...
void checkGoogleAppsCardV1ExpressionDataCondition(
  api.GoogleAppsCardV1ExpressionDataCondition o,
) {
  buildCounterGoogleAppsCardV1ExpressionDataCondition++;
  if (buildCounterGoogleAppsCardV1ExpressionDataCondition < 3) {
    unittest.expect(o.conditionType!, unittest.equals('foo'));
  }
  buildCounterGoogleAppsCardV1ExpressionDataCondition--;
}
...
void checkGoogleAppsCardV1Icon(api.GoogleAppsCardV1Icon o) {
  ...
  if (buildCounterGoogleAppsCardV1Icon < 3) {
    ...
    unittest.expect(o.imageType!, unittest.equals('foo'));
    unittest.expect(o.knownIcon!, unittest.equals('foo'));
...
void checkGoogleAppsCardV1MaterialIcon(api.GoogleAppsCardV1MaterialIcon o) {
  ...
  if (buildCounterGoogleAppsCardV1MaterialIcon < 3) {
    ...
    unittest.expect(o.grade!, unittest.equals(42));
    unittest.expect(o.name!, unittest.equals('foo'));
...
void checkGoogleAppsCardV1OpenLink(api.GoogleAppsCardV1OpenLink o) {
  buildCounterGoogleAppsCardV1OpenLink++;
  if (buildCounterGoogleAppsCardV1OpenLink < 3) {
    unittest.expect(o.onClose!, unittest.equals('foo'));
    unittest.expect(o.openAs!, unittest.equals('foo'));
    unittest.expect(o.url!, unittest.equals('foo'));
  }
  buildCounterGoogleAppsCardV1OpenLink--;
}
...
void checkGoogleAppsCardV1PlatformDataSource(
  ...
  buildCounterGoogleAppsCardV1PlatformDataSource++;
  if (buildCounterGoogleAppsCardV1PlatformDataSource < 3) {
    unittest.expect(o.commonDataSource!, unittest.equals('foo'));
    checkHostAppDataSourceMarkup(o.hostAppDataSource!);
  }
  buildCounterGoogleAppsCardV1PlatformDataSource--;
}
...
void checkGoogleAppsCardV1SelectionItem(api.GoogleAppsCardV1SelectionItem o) {
  buildCounterGoogleAppsCardV1SelectionItem++;
  if (buildCounterGoogleAppsCardV1SelectionItem < 3) {
    unittest.expect(o.bottomText!, unittest.equals('foo'));
    unittest.expect(o.selected!, unittest.isTrue);
    unittest.expect(o.startIconUri!, unittest.equals('foo'));
    unittest.expect(o.text!, unittest.equals('foo'));
    unittest.expect(o.value!, unittest.equals('foo'));
  }
  buildCounterGoogleAppsCardV1SelectionItem--;
...
void checkGoogleAppsCardV1SwitchControl(api.GoogleAppsCardV1SwitchControl o) {
  buildCounterGoogleAppsCardV1SwitchControl++;
  if (buildCounterGoogleAppsCardV1SwitchControl < 3) {
    unittest.expect(o.controlType!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    checkGoogleAppsCardV1Action(o.onChangeAction!);
    unittest.expect(o.selected!, unittest.isTrue);
    unittest.expect(o.value!, unittest.equals('foo'));
...
void checkGoogleAppsCardV1TextInput(api.GoogleAppsCardV1TextInput o) {
  ...
  if (buildCounterGoogleAppsCardV1TextInput < 3) {
    ...
    unittest.expect(o.name!, unittest.equals('foo'));
    checkGoogleAppsCardV1Action(o.onChangeAction!);
    unittest.expect(o.placeholderText!, unittest.equals('foo'));
    unittest.expect(o.type!, unittest.equals('foo'));
...
void checkGoogleAppsCardV1TextParagraph(api.GoogleAppsCardV1TextParagraph o) {
  buildCounterGoogleAppsCardV1TextParagraph++;
  if (buildCounterGoogleAppsCardV1TextParagraph < 3) {
    unittest.expect(o.maxLines!, unittest.equals(42));
    unittest.expect(o.text!, unittest.equals('foo'));
    unittest.expect(o.textSyntax!, unittest.equals('foo'));
  }
  buildCounterGoogleAppsCardV1TextParagraph--;
}

core.int buildCounterGoogleAppsCardV1Trigger = 0;
api.GoogleAppsCardV1Trigger buildGoogleAppsCardV1Trigger() {
  final o = api.GoogleAppsCardV1Trigger();
  buildCounterGoogleAppsCardV1Trigger++;
  if (buildCounterGoogleAppsCardV1Trigger < 3) {
    o.actionRuleId = 'foo';
  }
  buildCounterGoogleAppsCardV1Trigger--;
  return o;
...
void checkGoogleAppsCardV1Trigger(api.GoogleAppsCardV1Trigger o) {
  buildCounterGoogleAppsCardV1Trigger++;
  if (buildCounterGoogleAppsCardV1Trigger < 3) {
    unittest.expect(o.actionRuleId!, unittest.equals('foo'));
  }
...
core.int buildCounterGoogleAppsCardV1UpdateVisibilityAction = 0;
api.GoogleAppsCardV1UpdateVisibilityAction
buildGoogleAppsCardV1UpdateVisibilityAction() {
  final o = api.GoogleAppsCardV1UpdateVisibilityAction();
  buildCounterGoogleAppsCardV1UpdateVisibilityAction++;
  if (buildCounterGoogleAppsCardV1UpdateVisibilityAction < 3) {
    o.visibility = 'foo';
  }
  buildCounterGoogleAppsCardV1UpdateVisibilityAction--;
  return o;
...
void checkGoogleAppsCardV1UpdateVisibilityAction(
  api.GoogleAppsCardV1UpdateVisibilityAction o,
) {
  buildCounterGoogleAppsCardV1UpdateVisibilityAction++;
  if (buildCounterGoogleAppsCardV1UpdateVisibilityAction < 3) {
...
void checkGoogleAppsCardV1Validation(api.GoogleAppsCardV1Validation o) {
  buildCounterGoogleAppsCardV1Validation++;
  if (buildCounterGoogleAppsCardV1Validation < 3) {
    unittest.expect(o.characterLimit!, unittest.equals(42));
    unittest.expect(o.inputType!, unittest.equals('foo'));
  }
  buildCounterGoogleAppsCardV1Validation--;
}
...
core.int buildCounterGoogleChatV1Section = 0;
api.GoogleChatV1Section buildGoogleChatV1Section() {
  final o = api.GoogleChatV1Section();
  buildCounterGoogleChatV1Section++;
  if (buildCounterGoogleChatV1Section < 3) {
    o.displayName = 'foo';
    o.name = 'foo';
    o.sortOrder = 42;
    o.type = 'foo';
...
void checkGoogleChatV1Section(api.GoogleChatV1Section o) {
  buildCounterGoogleChatV1Section++;
  if (buildCounterGoogleChatV1Section < 3) {
    unittest.expect(o.displayName!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.sortOrder!, unittest.equals(42));
    unittest.expect(o.type!, unittest.equals('foo'));
  }
  buildCounterGoogleChatV1Section--;
}
...
api.HostAppDataSourceMarkup buildHostAppDataSourceMarkup() {
  ...
  if (buildCounterHostAppDataSourceMarkup < 3) {
    ...
    o.workflowDataSource = buildWorkflowDataSourceMarkup();
  }
  buildCounterHostAppDataSourceMarkup--;
  return o;
}
...
void checkHostAppDataSourceMarkup(api.HostAppDataSourceMarkup o) {
  ...
  if (buildCounterHostAppDataSourceMarkup < 3) {
    ...
    checkWorkflowDataSourceMarkup(o.workflowDataSource!);
  }
  buildCounterHostAppDataSourceMarkup--;
}
...
core.int buildCounterListCustomEmojisResponse = 0;
api.ListCustomEmojisResponse buildListCustomEmojisResponse() {
...
core.List<api.MessagePin> buildUnnamed29() => [
  buildMessagePin(),
  buildMessagePin(),
];

void checkUnnamed29(core.List<api.MessagePin> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMessagePin(o[0]);
  checkMessagePin(o[1]);
}

core.int buildCounterListMessagePinsResponse = 0;
api.ListMessagePinsResponse buildListMessagePinsResponse() {
  final o = api.ListMessagePinsResponse();
  buildCounterListMessagePinsResponse++;
  if (buildCounterListMessagePinsResponse < 3) {
    o.messagePins = buildUnnamed29();
    o.nextPageToken = 'foo';
  }
  buildCounterListMessagePinsResponse--;
  return o;
...
void checkListMessagePinsResponse(api.ListMessagePinsResponse o) {
  buildCounterListMessagePinsResponse++;
  if (buildCounterListMessagePinsResponse < 3) {
    checkUnnamed29(o.messagePins!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListMessagePinsResponse--;
}

core.List<api.Message> buildUnnamed30() => [buildMessage(), buildMessage()];
...
core.List<api.Reaction> buildUnnamed31() => [buildReaction(), buildReaction()];

void checkUnnamed31(core.List<api.Reaction> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReaction(o[0]);
  checkReaction(o[1]);
}
...
void checkListReactionsResponse(api.ListReactionsResponse o) {
  ...
  if (buildCounterListReactionsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed31(o.reactions!);
  }
  buildCounterListReactionsResponse--;
}

core.List<api.SectionItem> buildUnnamed32() => [
  buildSectionItem(),
  buildSectionItem(),
];

void checkUnnamed32(core.List<api.SectionItem> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSectionItem(o[0]);
  checkSectionItem(o[1]);
}

core.int buildCounterListSectionItemsResponse = 0;
api.ListSectionItemsResponse buildListSectionItemsResponse() {
  final o = api.ListSectionItemsResponse();
  buildCounterListSectionItemsResponse++;
  if (buildCounterListSectionItemsResponse < 3) {
    o.nextPageToken = 'foo';
    o.sectionItems = buildUnnamed32();
  }
  buildCounterListSectionItemsResponse--;
  return o;
}

void checkListSectionItemsResponse(api.ListSectionItemsResponse o) {
  buildCounterListSectionItemsResponse++;
  if (buildCounterListSectionItemsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed32(o.sectionItems!);
  }
  buildCounterListSectionItemsResponse--;
}

core.List<api.GoogleChatV1Section> buildUnnamed33() => [
  buildGoogleChatV1Section(),
  buildGoogleChatV1Section(),
];

void checkUnnamed33(core.List<api.GoogleChatV1Section> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleChatV1Section(o[0]);
  checkGoogleChatV1Section(o[1]);
}

core.int buildCounterListSectionsResponse = 0;
api.ListSectionsResponse buildListSectionsResponse() {
  final o = api.ListSectionsResponse();
  buildCounterListSectionsResponse++;
  if (buildCounterListSectionsResponse < 3) {
    o.nextPageToken = 'foo';
    o.sections = buildUnnamed33();
  }
  buildCounterListSectionsResponse--;
  return o;
}

void checkListSectionsResponse(api.ListSectionsResponse o) {
  buildCounterListSectionsResponse++;
  if (buildCounterListSectionsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed33(o.sections!);
  }
  buildCounterListSectionsResponse--;
}

core.List<api.SpaceEvent> buildUnnamed34() => [
  buildSpaceEvent(),
  buildSpaceEvent(),
];

void checkUnnamed34(core.List<api.SpaceEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSpaceEvent(o[0]);
  checkSpaceEvent(o[1]);
}
...
void checkListSpaceEventsResponse(api.ListSpaceEventsResponse o) {
  ...
  if (buildCounterListSpaceEventsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed34(o.spaceEvents!);
  }
  buildCounterListSpaceEventsResponse--;
}

core.List<api.Space> buildUnnamed35() => [buildSpace(), buildSpace()];

void checkUnnamed35(core.List<api.Space> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSpace(o[0]);
  checkSpace(o[1]);
}
...
core.int buildCounterMeetSpaceLinkData = 0;
api.MeetSpaceLinkData buildMeetSpaceLinkData() {
  final o = api.MeetSpaceLinkData();
  buildCounterMeetSpaceLinkData++;
  if (buildCounterMeetSpaceLinkData < 3) {
    o.huddleStatus = 'foo';
    o.meetingCode = 'foo';
    o.type = 'foo';
  }
...
void checkMeetSpaceLinkData(api.MeetSpaceLinkData o) {
  buildCounterMeetSpaceLinkData++;
  if (buildCounterMeetSpaceLinkData < 3) {
    unittest.expect(o.huddleStatus!, unittest.equals('foo'));
...
core.List<api.MembershipCreatedEventData> buildUnnamed36() => [
  buildMembershipCreatedEventData(),
  buildMembershipCreatedEventData(),
];

void checkUnnamed36(core.List<api.MembershipCreatedEventData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.MembershipDeletedEventData> buildUnnamed37() => [
  buildMembershipDeletedEventData(),
  buildMembershipDeletedEventData(),
];

void checkUnnamed37(core.List<api.MembershipDeletedEventData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.MembershipUpdatedEventData> buildUnnamed38() => [
  buildMembershipUpdatedEventData(),
  buildMembershipUpdatedEventData(),
];

void checkUnnamed38(core.List<api.MembershipUpdatedEventData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkMembershipCount(api.MembershipCount o) {
  buildCounterMembershipCount++;
  if (buildCounterMembershipCount < 3) {
    unittest.expect(o.joinedDirectHumanUserCount!, unittest.equals(42));
    unittest.expect(o.joinedGroupCount!, unittest.equals(42));
  }
  buildCounterMembershipCount--;
}
...
core.List<api.AccessoryWidget> buildUnnamed39() => [
  buildAccessoryWidget(),
  buildAccessoryWidget(),
];

void checkUnnamed39(core.List<api.AccessoryWidget> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAccessoryWidget(o[0]);
  checkAccessoryWidget(o[1]);
}

core.List<api.Annotation> buildUnnamed40() => [
  buildAnnotation(),
  buildAnnotation(),
];

void checkUnnamed40(core.List<api.Annotation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAnnotation(o[0]);
  checkAnnotation(o[1]);
}

core.List<api.AttachedGif> buildUnnamed41() => [
  buildAttachedGif(),
  buildAttachedGif(),
];

void checkUnnamed41(core.List<api.AttachedGif> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachedGif(o[0]);
  checkAttachedGif(o[1]);
}

core.List<api.Attachment> buildUnnamed42() => [
  buildAttachment(),
  buildAttachment(),
];

void checkUnnamed42(core.List<api.Attachment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachment(o[0]);
  checkAttachment(o[1]);
}

core.List<api.Card> buildUnnamed43() => [buildCard(), buildCard()];

void checkUnnamed43(core.List<api.Card> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCard(o[0]);
  checkCard(o[1]);
}

core.List<api.CardWithId> buildUnnamed44() => [
  buildCardWithId(),
  buildCardWithId(),
];

void checkUnnamed44(core.List<api.CardWithId> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCardWithId(o[0]);
  checkCardWithId(o[1]);
}

core.List<api.EmojiReactionSummary> buildUnnamed45() => [
  buildEmojiReactionSummary(),
  buildEmojiReactionSummary(),
];

void checkUnnamed45(core.List<api.EmojiReactionSummary> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Message buildMessage() {
  ...
  if (buildCounterMessage < 3) {
    o.accessoryWidgets = buildUnnamed39();
    o.actionResponse = buildActionResponse();
    o.annotations = buildUnnamed40();
    o.argumentText = 'foo';
    o.attachedGifs = buildUnnamed41();
    o.attachment = buildUnnamed42();
    o.cards = buildUnnamed43();
    o.cardsV2 = buildUnnamed44();
    o.clientAssignedMessageId = 'foo';
    o.createTime = 'foo';
    o.deleteTime = 'foo';
    o.deletionMetadata = buildDeletionMetadata();
    o.emojiReactionSummaries = buildUnnamed45();
    o.fallbackText = 'foo';
    o.formattedText = 'foo';
...
core.List<api.MessageCreatedEventData> buildUnnamed46() => [
  buildMessageCreatedEventData(),
  buildMessageCreatedEventData(),
];

void checkUnnamed46(core.List<api.MessageCreatedEventData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.MessageDeletedEventData> buildUnnamed47() => [
  buildMessageDeletedEventData(),
  buildMessageDeletedEventData(),
];

void checkUnnamed47(core.List<api.MessageDeletedEventData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.MessageUpdatedEventData> buildUnnamed48() => [
  buildMessageUpdatedEventData(),
  buildMessageUpdatedEventData(),
];

void checkUnnamed48(core.List<api.MessageUpdatedEventData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.int buildCounterMessagePin = 0;
api.MessagePin buildMessagePin() {
  final o = api.MessagePin();
  buildCounterMessagePin++;
  if (buildCounterMessagePin < 3) {
    o.message = 'foo';
    o.name = 'foo';
  }
  buildCounterMessagePin--;
...
void checkMessagePin(api.MessagePin o) {
  buildCounterMessagePin++;
  if (buildCounterMessagePin < 3) {
    unittest.expect(o.message!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
...
core.int buildCounterMoveSectionItemRequest = 0;
api.MoveSectionItemRequest buildMoveSectionItemRequest() {
  final o = api.MoveSectionItemRequest();
  buildCounterMoveSectionItemRequest++;
  if (buildCounterMoveSectionItemRequest < 3) {
    o.targetSection = 'foo';
  }
  buildCounterMoveSectionItemRequest--;
  return o;
...
void checkMoveSectionItemRequest(api.MoveSectionItemRequest o) {
  buildCounterMoveSectionItemRequest++;
  if (buildCounterMoveSectionItemRequest < 3) {
    unittest.expect(o.targetSection!, unittest.equals('foo'));
  }
  buildCounterMoveSectionItemRequest--;
}

core.int buildCounterMoveSectionItemResponse = 0;
api.MoveSectionItemResponse buildMoveSectionItemResponse() {
  final o = api.MoveSectionItemResponse();
  buildCounterMoveSectionItemResponse++;
  if (buildCounterMoveSectionItemResponse < 3) {
    o.sectionItem = buildSectionItem();
  }
  buildCounterMoveSectionItemResponse--;
  return o;
}

void checkMoveSectionItemResponse(api.MoveSectionItemResponse o) {
  buildCounterMoveSectionItemResponse++;
  if (buildCounterMoveSectionItemResponse < 3) {
    checkSectionItem(o.sectionItem!);
  }
  buildCounterMoveSectionItemResponse--;
}
...
core.int buildCounterPositionSectionRequest = 0;
api.PositionSectionRequest buildPositionSectionRequest() {
  final o = api.PositionSectionRequest();
  buildCounterPositionSectionRequest++;
  if (buildCounterPositionSectionRequest < 3) {
    o.relativePosition = 'foo';
    o.sortOrder = 42;
  }
  buildCounterPositionSectionRequest--;
  return o;
...
void checkPositionSectionRequest(api.PositionSectionRequest o) {
  buildCounterPositionSectionRequest++;
  if (buildCounterPositionSectionRequest < 3) {
    unittest.expect(o.relativePosition!, unittest.equals('foo'));
    unittest.expect(o.sortOrder!, unittest.equals(42));
  }
  buildCounterPositionSectionRequest--;
}

core.int buildCounterPositionSectionResponse = 0;
api.PositionSectionResponse buildPositionSectionResponse() {
  final o = api.PositionSectionResponse();
  buildCounterPositionSectionResponse++;
  if (buildCounterPositionSectionResponse < 3) {
    o.section = buildGoogleChatV1Section();
  }
  buildCounterPositionSectionResponse--;
  return o;
}

void checkPositionSectionResponse(api.PositionSectionResponse o) {
  buildCounterPositionSectionResponse++;
  if (buildCounterPositionSectionResponse < 3) {
    checkGoogleChatV1Section(o.section!);
  }
  buildCounterPositionSectionResponse--;
}
...
core.List<api.Annotation> buildUnnamed49() => [
  buildAnnotation(),
  buildAnnotation(),
];

void checkUnnamed49(core.List<api.Annotation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAnnotation(o[0]);
  checkAnnotation(o[1]);
}

core.List<api.Attachment> buildUnnamed50() => [
  buildAttachment(),
  buildAttachment(),
];

void checkUnnamed50(core.List<api.Attachment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachment(o[0]);
  checkAttachment(o[1]);
}
...
core.List<api.ReactionCreatedEventData> buildUnnamed51() => [
  buildReactionCreatedEventData(),
  buildReactionCreatedEventData(),
];

void checkUnnamed51(core.List<api.ReactionCreatedEventData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ReactionDeletedEventData> buildUnnamed52() => [
  buildReactionDeletedEventData(),
  buildReactionDeletedEventData(),
];

void checkUnnamed52(core.List<api.ReactionDeletedEventData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.RichLinkMetadata buildRichLinkMetadata() {
  ...
  if (buildCounterRichLinkMetadata < 3) {
    o.calendarEventLinkData = buildCalendarEventLinkData();
    o.chatSpaceLinkData = buildChatSpaceLinkData();
    o.driveLinkData = buildDriveLinkData();
    o.meetSpaceLinkData = buildMeetSpaceLinkData();
    o.richLinkType = 'foo';
    o.uri = 'foo';
  }
  buildCounterRichLinkMetadata--;
...
void checkRichLinkMetadata(api.RichLinkMetadata o) {
  buildCounterRichLinkMetadata++;
  if (buildCounterRichLinkMetadata < 3) {
    checkCalendarEventLinkData(o.calendarEventLinkData!);
    checkChatSpaceLinkData(o.chatSpaceLinkData!);
    checkDriveLinkData(o.driveLinkData!);
    checkMeetSpaceLinkData(o.meetSpaceLinkData!);
    unittest.expect(o.richLinkType!, unittest.equals('foo'));
    unittest.expect(o.uri!, unittest.equals('foo'));
  }
  buildCounterRichLinkMetadata--;
}
...
core.List<api.SearchMessageResult> buildUnnamed53() => [
  buildSearchMessageResult(),
  buildSearchMessageResult(),
];

void checkUnnamed53(core.List<api.SearchMessageResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.SearchSpaceResult> buildUnnamed54() => [
  buildSearchSpaceResult(),
  buildSearchSpaceResult(),
];

void checkUnnamed54(core.List<api.SearchSpaceResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSearchSpaceResult(o[0]);
  checkSearchSpaceResult(o[1]);
}

core.List<api.Space> buildUnnamed55() => [buildSpace(), buildSpace()];

void checkUnnamed55(core.List<api.Space> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSpace(o[0]);
  checkSpace(o[1]);
}
...
core.List<api.WidgetMarkup> buildUnnamed56() => [
  buildWidgetMarkup(),
  buildWidgetMarkup(),
];

void checkUnnamed56(core.List<api.WidgetMarkup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkSection(api.Section o) {
  ...
  if (buildCounterSection < 3) {
    unittest.expect(o.header!, unittest.equals('foo'));
    checkUnnamed56(o.widgets!);
  }
  buildCounterSection--;
}

core.int buildCounterSectionItem = 0;
api.SectionItem buildSectionItem() {
  final o = api.SectionItem();
  buildCounterSectionItem++;
  if (buildCounterSectionItem < 3) {
    o.name = 'foo';
    o.space = 'foo';
  }
  buildCounterSectionItem--;
...
void checkSectionItem(api.SectionItem o) {
  buildCounterSectionItem++;
  if (buildCounterSectionItem < 3) {
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.space!, unittest.equals('foo'));
...
core.List<api.GoogleAppsCardV1SelectionItem> buildUnnamed57() => [
  buildGoogleAppsCardV1SelectionItem(),
  buildGoogleAppsCardV1SelectionItem(),
];

void checkUnnamed57(core.List<api.GoogleAppsCardV1SelectionItem> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleAppsCardV1SelectionItem(o[0]);
  checkGoogleAppsCardV1SelectionItem(o[1]);
}
...
core.List<api.Membership> buildUnnamed58() => [
  buildMembership(),
  buildMembership(),
];

void checkUnnamed58(core.List<api.Membership> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMembership(o[0]);
  checkMembership(o[1]);
}
...
void checkSpace(api.Space o) {
  ...
  if (buildCounterSpace < 3) {
    ...
    unittest.expect(o.importModeExpireTime!, unittest.equals('foo'));
    unittest.expect(o.lastActiveTime!, unittest.equals('foo'));
    checkMembershipCount(o.membershipCount!);
    unittest.expect(o.name!, unittest.equals('foo'));
    checkPermissionSettings(o.permissionSettings!);
    unittest.expect(o.predefinedPermissionSettings!, unittest.equals('foo'));
    unittest.expect(o.singleUserBotDm!, unittest.isTrue);
    checkSpaceDetails(o.spaceDetails!);
    unittest.expect(o.spaceHistoryState!, unittest.equals('foo'));
    unittest.expect(o.spaceThreadingState!, unittest.equals('foo'));
    unittest.expect(o.spaceType!, unittest.equals('foo'));
    unittest.expect(o.spaceUri!, unittest.equals('foo'));
...
core.List<api.SpaceUpdatedEventData> buildUnnamed59() => [
  buildSpaceUpdatedEventData(),
  buildSpaceUpdatedEventData(),
];

void checkUnnamed59(core.List<api.SpaceUpdatedEventData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkSpaceNotificationSetting(api.SpaceNotificationSetting o) {
  buildCounterSpaceNotificationSetting++;
  if (buildCounterSpaceNotificationSetting < 3) {
    unittest.expect(o.muteSetting!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.notificationSetting!, unittest.equals('foo'));
  }
  buildCounterSpaceNotificationSetting--;
}
...
void checkSpaceReadState(api.SpaceReadState o) {
  buildCounterSpaceReadState++;
  if (buildCounterSpaceReadState < 3) {
    unittest.expect(o.lastReadTime!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
  }
  buildCounterSpaceReadState--;
}
...
void checkUpdatedWidget(api.UpdatedWidget o) {
  ...
  if (buildCounterUpdatedWidget < 3) {
    ...
    unittest.expect(o.widget!, unittest.equals('foo'));
  }
  buildCounterUpdatedWidget--;
}
...
core.List<api.Button> buildUnnamed60() => [buildButton(), buildButton()];

void checkUnnamed60(core.List<api.Button> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkButton(o[0]);
  checkButton(o[1]);
}
...
core.int buildCounterWorkflowDataSourceMarkup = 0;
api.WorkflowDataSourceMarkup buildWorkflowDataSourceMarkup() {
  final o = api.WorkflowDataSourceMarkup();
  buildCounterWorkflowDataSourceMarkup++;
  if (buildCounterWorkflowDataSourceMarkup < 3) {
    o.includeVariables = true;
    o.type = 'foo';
  }
  buildCounterWorkflowDataSourceMarkup--;
  return o;
...
void checkWorkflowDataSourceMarkup(api.WorkflowDataSourceMarkup o) {
  buildCounterWorkflowDataSourceMarkup++;
  if (buildCounterWorkflowDataSourceMarkup < 3) {
    unittest.expect(o.includeVariables!, unittest.isTrue);
    unittest.expect(o.type!, unittest.equals('foo'));
  }
  buildCounterWorkflowDataSourceMarkup--;
}
...
void main() {
  ...
  unittest.group('obj-schema-CalendarEventLinkData', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCalendarEventLinkData();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CalendarEventLinkData.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCalendarEventLinkData(od);
    });
  });
  ...
  unittest.group('obj-schema-CardAction', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CardAction.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCardAction(od);
    });
  ...
  unittest.group('obj-schema-CardHeader', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CardHeader.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCardHeader(od);
    });
  ...
  unittest.group('obj-schema-CardWithId', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CardWithId.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCardWithId(od);
    });
  ...
  unittest.group('obj-schema-CustomEmojiPayload', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCustomEmojiPayload();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CustomEmojiPayload.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCustomEmojiPayload(od);
    });
  });
  ...
  unittest.group('obj-schema-FindGroupChatsResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildFindGroupChatsResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.FindGroupChatsResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkFindGroupChatsResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-FormAction', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.FormAction.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkFormAction(od);
    });
  ...
  unittest.group('obj-schema-GoogleAppsCardV1CommonWidgetAction', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleAppsCardV1CommonWidgetAction();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleAppsCardV1CommonWidgetAction.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleAppsCardV1CommonWidgetAction(od);
    });
  });

  unittest.group('obj-schema-GoogleAppsCardV1Condition', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleAppsCardV1Condition();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleAppsCardV1Condition.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleAppsCardV1Condition(od);
    });
  });

  unittest.group('obj-schema-GoogleAppsCardV1DataSourceConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleAppsCardV1DataSourceConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleAppsCardV1DataSourceConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleAppsCardV1DataSourceConfig(od);
    });
  });
  ...
  unittest.group('obj-schema-GoogleAppsCardV1EventAction', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleAppsCardV1EventAction();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleAppsCardV1EventAction.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleAppsCardV1EventAction(od);
    });
  });

  unittest.group('obj-schema-GoogleAppsCardV1ExpressionData', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleAppsCardV1ExpressionData();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleAppsCardV1ExpressionData.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleAppsCardV1ExpressionData(od);
    });
  });

  unittest.group('obj-schema-GoogleAppsCardV1ExpressionDataCondition', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleAppsCardV1ExpressionDataCondition();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleAppsCardV1ExpressionDataCondition.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleAppsCardV1ExpressionDataCondition(od);
    });
  });
  ...
  unittest.group('obj-schema-GoogleAppsCardV1Trigger', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleAppsCardV1Trigger();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleAppsCardV1Trigger.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleAppsCardV1Trigger(od);
    });
  });

  unittest.group('obj-schema-GoogleAppsCardV1UpdateVisibilityAction', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleAppsCardV1UpdateVisibilityAction();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleAppsCardV1UpdateVisibilityAction.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleAppsCardV1UpdateVisibilityAction(od);
    });
  });
  ...
  unittest.group('obj-schema-GoogleChatV1Section', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleChatV1Section();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleChatV1Section.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleChatV1Section(od);
    });
  });
  ...
  unittest.group('obj-schema-ListCustomEmojisResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildListCustomEmojisResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListCustomEmojisResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkListCustomEmojisResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-ListMessagePinsResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildListMessagePinsResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListMessagePinsResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkListMessagePinsResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-ListSectionItemsResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildListSectionItemsResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListSectionItemsResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkListSectionItemsResponse(od);
    });
  });

  unittest.group('obj-schema-ListSectionsResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildListSectionsResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListSectionsResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkListSectionsResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-MatchedUrl', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.MatchedUrl.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkMatchedUrl(od);
    });
  ...
  unittest.group('obj-schema-MeetSpaceLinkData', () {
    unittest.test('to-json--from-json', () async {
      final o = buildMeetSpaceLinkData();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.MeetSpaceLinkData.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkMeetSpaceLinkData(od);
    });
  });
  ...
  unittest.group('obj-schema-MessagePin', () {
    unittest.test('to-json--from-json', () async {
      final o = buildMessagePin();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.MessagePin.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkMessagePin(od);
    });
  ...
  unittest.group('obj-schema-MoveSectionItemRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildMoveSectionItemRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.MoveSectionItemRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkMoveSectionItemRequest(od);
    });
  });

  unittest.group('obj-schema-MoveSectionItemResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildMoveSectionItemResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.MoveSectionItemResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkMoveSectionItemResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-OpenLink', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.OpenLink.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkOpenLink(od);
    });
  ...
  unittest.group('obj-schema-PositionSectionRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildPositionSectionRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.PositionSectionRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPositionSectionRequest(od);
    });
  });

  unittest.group('obj-schema-PositionSectionResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildPositionSectionResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.PositionSectionResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPositionSectionResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-Reaction', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Reaction.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkReaction(od);
    });
  ...
  unittest.group('obj-schema-SectionItem', () {
    unittest.test('to-json--from-json', () async {
      final o = buildSectionItem();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.SectionItem.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkSectionItem(od);
    });
  ...
  unittest.group('obj-schema-SpaceEvent', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.SpaceEvent.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkSpaceEvent(od);
    });
  ...
  unittest.group('obj-schema-TextButton', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.TextButton.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkTextButton(od);
    });
  ...
  unittest.group('obj-schema-WorkflowDataSourceMarkup', () {
    unittest.test('to-json--from-json', () async {
      final o = buildWorkflowDataSourceMarkup();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.WorkflowDataSourceMarkup.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkWorkflowDataSourceMarkup(od);
    });
  });

  unittest.group('resource-CustomEmojisResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.HangoutsChatApi(mock).customEmojis;
      final arg_request = buildCustomEmoji();
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.CustomEmoji.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkCustomEmoji(obj);
          ...
          unittest.expect(
            ...
            unittest.equals('v1/customEmojis'),
          );
          pathOffset += 15;
          ...
          final resp = convert.json.encode(buildCustomEmoji());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.create(arg_request, $fields: arg_$fields);
      checkCustomEmoji(response as api.CustomEmoji);
    });
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildListCustomEmojisResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      ...
      checkListCustomEmojisResponse(response as api.ListCustomEmojisResponse);
    });
  });
  ...
  unittest.group('resource-SpacesResource', () {
    unittest.test('method--completeImport', () async {
      ...
      final response = await res.completeImport(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--findDirectMessage', () async {
      ...
      final response = await res.findDirectMessage(
        name: arg_name,
        $fields: arg_$fields,
      );
      checkSpace(response as api.Space);
    ...
    unittest.test('method--findGroupChats', () async {
      final mock = HttpServerMock();
      final res = api.HangoutsChatApi(mock).spaces;
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_spaceView = 'foo';
      final arg_users = buildUnnamed61();
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final path = req.url.path;
          ...
          unittest.expect(
            ...
            unittest.equals('v1/spaces:findGroupChats'),
          );
          pathOffset += 24;
          ...
          unittest.expect(
            queryMap['spaceView']!.first,
            unittest.equals(arg_spaceView),
          );
          unittest.expect(queryMap['users']!, unittest.equals(arg_users));
          unittest.expect(
            queryMap['fields']!.first,
            unittest.equals(arg_$fields),
          );
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildFindGroupChatsResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.findGroupChats(
        pageSize: arg_pageSize,
        pageToken: arg_pageToken,
        spaceView: arg_spaceView,
        users: arg_users,
        $fields: arg_$fields,
      );
      checkFindGroupChatsResponse(response as api.FindGroupChatsResponse);
    });
  ...
  unittest.group('resource-SpacesMessagePinsResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.HangoutsChatApi(mock).spaces.messagePins;
      final arg_request = buildMessagePin();
      final arg_parent = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.MessagePin.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkMessagePin(obj);
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildMessagePin());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      ...
      checkMessagePin(response as api.MessagePin);
    });
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildListMessagePinsResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      ...
      checkListMessagePinsResponse(response as api.ListMessagePinsResponse);
    });
  });
  ...
  unittest.group('resource-SpacesMessagesReactionsResource', () {
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Reaction.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkReaction(obj);
  ...
  unittest.group('resource-UsersSectionsResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.HangoutsChatApi(mock).users.sections;
      final arg_request = buildGoogleChatV1Section();
      final arg_parent = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.GoogleChatV1Section.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkGoogleChatV1Section(obj);
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildGoogleChatV1Section());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      ...
      checkGoogleChatV1Section(response as api.GoogleChatV1Section);
    });
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildListSectionsResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      ...
      checkListSectionsResponse(response as api.ListSectionsResponse);
    });
    ...
    unittest.test('method--position', () async {
      final mock = HttpServerMock();
      final res = api.HangoutsChatApi(mock).users.sections;
      final arg_request = buildPositionSectionRequest();
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.PositionSectionRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkPositionSectionRequest(obj);
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildPositionSectionResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.position(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
      checkPositionSectionResponse(response as api.PositionSectionResponse);
    });
  });

  unittest.group('resource-UsersSectionsItemsResource', () {
    unittest.test('method--list', () async {
      final mock = HttpServerMock();
      final res = api.HangoutsChatApi(mock).users.sections.items;
      final arg_parent = 'foo';
      final arg_filter = 'foo';
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildListSectionItemsResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      ...
      checkListSectionItemsResponse(response as api.ListSectionItemsResponse);
    });

    unittest.test('method--move', () async {
      final mock = HttpServerMock();
      final res = api.HangoutsChatApi(mock).users.sections.items;
      final arg_request = buildMoveSectionItemRequest();
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.MoveSectionItemRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkMoveSectionItemRequest(obj);
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildMoveSectionItemResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      ...
      checkMoveSectionItemResponse(response as api.MoveSectionItemResponse);
    });
  });
  ...
  unittest.group('resource-UsersSpacesResource', () {
    unittest.test('method--getSpaceReadState', () async {
      ...
      final response = await res.getSpaceReadState(
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--updateSpaceReadState', () async {
      ...
      final response = await res.updateSpaceReadState(
        arg_request,
        arg_name,
        updateMask: arg_updateMask,
        $fields: arg_$fields,
  ...
  unittest.group('resource-UsersSpacesThreadsResource', () {
    unittest.test('method--getThreadReadState', () async {
      ...
      final response = await res.getThreadReadState(
        arg_name,
        $fields: arg_$fields,
      );
