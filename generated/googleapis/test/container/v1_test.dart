...
buildCluster() {
  ...
  if (buildCounterCluster < 3) {
    ...
    o.instanceGroupUrls = buildUnnamed741();
...
checkCluster(api.Cluster o) {
  ...
  if (buildCounterCluster < 3) {
    ...
    checkUnnamed741(o.instanceGroupUrls);
...
checkUnnamed742(core.List<api.Cluster> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCluster(o[0]);
  checkCluster(o[1]);
}
...
checkUnnamed743(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
buildServerConfig() {
  ...
  if (buildCounterServerConfig < 3) {
    ...
    o.validNodeVersions = buildUnnamed745();
  }
  buildCounterServerConfig--;
  return o;
}
...
checkServerConfig(api.ServerConfig o) {
  ...
  if (buildCounterServerConfig < 3) {
    ...
    checkUnnamed745(o.validNodeVersions);
  }
  buildCounterServerConfig--;
}
