...
import 'package:googleapis/container/v1beta1.dart' as api;
...
api.AcceleratorConfig buildAcceleratorConfig() {
  ...
  if (buildCounterAcceleratorConfig < 3) {
    ...
    o.maxTimeSharedClientsPerGpu = 'foo';
  }
  buildCounterAcceleratorConfig--;
  return o;
}
...
void checkAcceleratorConfig(api.AcceleratorConfig o) {
  ...
  if (buildCounterAcceleratorConfig < 3) {
    ...
    unittest.expect(o.maxTimeSharedClientsPerGpu!, unittest.equals('foo'));
  }
  buildCounterAcceleratorConfig--;
}
...
api.AddonsConfig buildAddonsConfig() {
  ...
  if (buildCounterAddonsConfig < 3) {
    ...
    o.istioConfig = buildIstioConfig();
    o.kalmConfig = buildKalmConfig();
...
void checkAddonsConfig(api.AddonsConfig o) {
  ...
  if (buildCounterAddonsConfig < 3) {
    ...
    checkIstioConfig(o.istioConfig!);
    checkKalmConfig(o.kalmConfig!);
...
api.Autopilot buildAutopilot() {
  ...
  if (buildCounterAutopilot < 3) {
    o.conversionStatus = buildAutopilotConversionStatus();
    o.enabled = true;
...
void checkAutopilot(api.Autopilot o) {
  buildCounterAutopilot++;
  if (buildCounterAutopilot < 3) {
    checkAutopilotConversionStatus(o.conversionStatus!);
    unittest.expect(o.enabled!, unittest.isTrue);
...
core.int buildCounterAutopilotConversionStatus = 0;
api.AutopilotConversionStatus buildAutopilotConversionStatus() {
  final o = api.AutopilotConversionStatus();
  buildCounterAutopilotConversionStatus++;
  if (buildCounterAutopilotConversionStatus < 3) {
    o.state = 'foo';
  }
  buildCounterAutopilotConversionStatus--;
  return o;
...
void checkAutopilotConversionStatus(api.AutopilotConversionStatus o) {
  buildCounterAutopilotConversionStatus++;
  if (buildCounterAutopilotConversionStatus < 3) {
...
core.int buildCounterAvailableVersion = 0;
api.AvailableVersion buildAvailableVersion() {
  final o = api.AvailableVersion();
  buildCounterAvailableVersion++;
  if (buildCounterAvailableVersion < 3) {
    o.reason = 'foo';
    o.version = 'foo';
  }
  buildCounterAvailableVersion--;
...
void checkAvailableVersion(api.AvailableVersion o) {
  buildCounterAvailableVersion++;
  if (buildCounterAvailableVersion < 3) {
...
core.List<api.PolicyBinding> buildUnnamed5() => [
  buildPolicyBinding(),
  buildPolicyBinding(),
];

void checkUnnamed5(core.List<api.PolicyBinding> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BinaryAuthorization buildBinaryAuthorization() {
  ...
  if (buildCounterBinaryAuthorization < 3) {
    ...
    o.policyBindings = buildUnnamed5();
  }
  buildCounterBinaryAuthorization--;
  return o;
}
...
void checkBinaryAuthorization(api.BinaryAuthorization o) {
  ...
  if (buildCounterBinaryAuthorization < 3) {
    ...
    checkUnnamed5(o.policyBindings!);
  }
  buildCounterBinaryAuthorization--;
}
...
api.BlueGreenInfo buildBlueGreenInfo() {
  ...
  if (buildCounterBlueGreenInfo < 3) {
    o.blueInstanceGroupUrls = buildUnnamed6();
    o.bluePoolDeletionStartTime = 'foo';
    o.greenInstanceGroupUrls = buildUnnamed7();
...
void checkBlueGreenInfo(api.BlueGreenInfo o) {
  buildCounterBlueGreenInfo++;
  if (buildCounterBlueGreenInfo < 3) {
    checkUnnamed6(o.blueInstanceGroupUrls!);
    unittest.expect(o.bluePoolDeletionStartTime!, unittest.equals('foo'));
    checkUnnamed7(o.greenInstanceGroupUrls!);
...
core.List<api.AutopilotCompatibilityIssue> buildUnnamed9() => [
  buildAutopilotCompatibilityIssue(),
  buildAutopilotCompatibilityIssue(),
];

void checkUnnamed9(core.List<api.AutopilotCompatibilityIssue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.StatusCondition> buildUnnamed11() => [
  buildStatusCondition(),
  buildStatusCondition(),
];

void checkUnnamed11(core.List<api.StatusCondition> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.NodePool> buildUnnamed14() => [buildNodePool(), buildNodePool()];

void checkUnnamed14(core.List<api.NodePool> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNodePool(o[0]);
  checkNodePool(o[1]);
}
...
api.Cluster buildCluster() {
  ...
  if (buildCounterCluster < 3) {
    ...
    o.alphaClusterFeatureGates = buildUnnamed10();
    ...
    o.clusterTelemetry = buildClusterTelemetry();
    ...
    o.instanceGroupUrls = buildUnnamed12();
    ...
    o.podSecurityPolicyConfig = buildPodSecurityPolicyConfig();
    o.privateCluster = true;
    o.privateClusterConfig = buildPrivateClusterConfig();
    o.protectConfig = buildProtectConfig();
    o.rbacBindingConfig = buildRBACBindingConfig();
    o.releaseChannel = buildReleaseChannel();
    o.resourceLabels = buildUnnamed15();
    ...
    o.workloadAltsConfig = buildWorkloadALTSConfig();
    o.workloadCertificates = buildWorkloadCertificates();
...
void checkCluster(api.Cluster o) {
  ...
  if (buildCounterCluster < 3) {
    ...
    checkUnnamed10(o.alphaClusterFeatureGates!);
    ...
    checkClusterTelemetry(o.clusterTelemetry!);
    ...
    checkUnnamed12(o.instanceGroupUrls!);
    ...
    checkPodSecurityPolicyConfig(o.podSecurityPolicyConfig!);
    unittest.expect(o.privateCluster!, unittest.isTrue);
    checkPrivateClusterConfig(o.privateClusterConfig!);
    checkProtectConfig(o.protectConfig!);
    checkRBACBindingConfig(o.rbacBindingConfig!);
    checkReleaseChannel(o.releaseChannel!);
    checkUnnamed15(o.resourceLabels!);
    ...
    checkWorkloadALTSConfig(o.workloadAltsConfig!);
    checkWorkloadCertificates(o.workloadCertificates!);
...
core.List<api.ResourceLimit> buildUnnamed17() => [
  buildResourceLimit(),
  buildResourceLimit(),
];

void checkUnnamed17(core.List<api.ResourceLimit> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ClusterAutoscaling buildClusterAutoscaling() {
  ...
  if (buildCounterClusterAutoscaling < 3) {
    o.autoprovisioningLocations = buildUnnamed16();
    ...
    o.resourceLimits = buildUnnamed17();
  }
  buildCounterClusterAutoscaling--;
  return o;
}
...
void checkClusterAutoscaling(api.ClusterAutoscaling o) {
  buildCounterClusterAutoscaling++;
  if (buildCounterClusterAutoscaling < 3) {
    checkUnnamed16(o.autoprovisioningLocations!);
    ...
    checkUnnamed17(o.resourceLimits!);
  }
  buildCounterClusterAutoscaling--;
}
...
core.int buildCounterClusterTelemetry = 0;
api.ClusterTelemetry buildClusterTelemetry() {
  final o = api.ClusterTelemetry();
  buildCounterClusterTelemetry++;
  if (buildCounterClusterTelemetry < 3) {
    o.type = 'foo';
  }
  buildCounterClusterTelemetry--;
  return o;
...
void checkClusterTelemetry(api.ClusterTelemetry o) {
  buildCounterClusterTelemetry++;
  if (buildCounterClusterTelemetry < 3) {
...
api.ClusterUpdate buildClusterUpdate() {
  ...
  if (buildCounterClusterUpdate < 3) {
    ...
    o.desiredClusterTelemetry = buildClusterTelemetry();
    ...
    o.desiredHostMaintenancePolicy = buildHostMaintenancePolicy();
    ...
    o.desiredPodSecurityPolicyConfig = buildPodSecurityPolicyConfig();
    o.desiredPrivateClusterConfig = buildPrivateClusterConfig();
    o.desiredPrivateIpv6GoogleAccess = 'foo';
    o.desiredProtectConfig = buildProtectConfig();
    ...
    o.desiredTpuConfig = buildTpuConfig();
    o.desiredUserManagedKeysConfig = buildUserManagedKeysConfig();
    o.desiredVerticalPodAutoscaling = buildVerticalPodAutoscaling();
    o.desiredWorkloadAltsConfig = buildWorkloadALTSConfig();
    o.desiredWorkloadCertificates = buildWorkloadCertificates();
...
void checkClusterUpdate(api.ClusterUpdate o) {
  ...
  if (buildCounterClusterUpdate < 3) {
    ...
    checkClusterTelemetry(o.desiredClusterTelemetry!);
    ...
    checkHostMaintenancePolicy(o.desiredHostMaintenancePolicy!);
    ...
    checkPodSecurityPolicyConfig(o.desiredPodSecurityPolicyConfig!);
    ...
    checkProtectConfig(o.desiredProtectConfig!);
    ...
    checkTpuConfig(o.desiredTpuConfig!);
    checkUserManagedKeysConfig(o.desiredUserManagedKeysConfig!);
    checkVerticalPodAutoscaling(o.desiredVerticalPodAutoscaling!);
    checkWorkloadALTSConfig(o.desiredWorkloadAltsConfig!);
    checkWorkloadCertificates(o.desiredWorkloadCertificates!);
...
core.List<api.UpgradeDetails> buildUnnamed21() => [
  buildUpgradeDetails(),
  buildUpgradeDetails(),
];

void checkUnnamed21(core.List<api.UpgradeDetails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkClusterUpgradeInfo(api.ClusterUpgradeInfo o) {
  buildCounterClusterUpgradeInfo++;
  if (buildCounterClusterUpgradeInfo < 3) {
    checkUnnamed19(o.autoUpgradeStatus!);
    ...
    checkUnnamed20(o.pausedReason!);
    checkUnnamed21(o.upgradeDetails!);
  }
  buildCounterClusterUpgradeInfo--;
}
...
core.List<api.ComplianceStandard> buildUnnamed22() => [
  buildComplianceStandard(),
  buildComplianceStandard(),
];

void checkUnnamed22(core.List<api.ComplianceStandard> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.CompliancePostureConfig buildCompliancePostureConfig() {
  ...
  if (buildCounterCompliancePostureConfig < 3) {
    o.complianceStandards = buildUnnamed22();
    o.mode = 'foo';
  }
  buildCounterCompliancePostureConfig--;
  return o;
...
void checkCompliancePostureConfig(api.CompliancePostureConfig o) {
  buildCounterCompliancePostureConfig++;
  if (buildCounterCompliancePostureConfig < 3) {
    checkUnnamed22(o.complianceStandards!);
    unittest.expect(o.mode!, unittest.equals('foo'));
  }
  buildCounterCompliancePostureConfig--;
}
...
core.int buildCounterEphemeralStorageConfig = 0;
api.EphemeralStorageConfig buildEphemeralStorageConfig() {
  final o = api.EphemeralStorageConfig();
  buildCounterEphemeralStorageConfig++;
  if (buildCounterEphemeralStorageConfig < 3) {
    o.localSsdCount = 42;
  }
  buildCounterEphemeralStorageConfig--;
  return o;
...
void checkEphemeralStorageConfig(api.EphemeralStorageConfig o) {
  buildCounterEphemeralStorageConfig++;
  if (buildCounterEphemeralStorageConfig < 3) {
...
core.int buildCounterHostMaintenancePolicy = 0;
api.HostMaintenancePolicy buildHostMaintenancePolicy() {
  final o = api.HostMaintenancePolicy();
  buildCounterHostMaintenancePolicy++;
  if (buildCounterHostMaintenancePolicy < 3) {
    o.maintenanceInterval = 'foo';
    o.opportunisticMaintenanceStrategy =
        buildOpportunisticMaintenanceStrategy();
  }
  buildCounterHostMaintenancePolicy--;
  return o;
}

void checkHostMaintenancePolicy(api.HostMaintenancePolicy o) {
  buildCounterHostMaintenancePolicy++;
  if (buildCounterHostMaintenancePolicy < 3) {
    unittest.expect(o.maintenanceInterval!, unittest.equals('foo'));
    checkOpportunisticMaintenanceStrategy(o.opportunisticMaintenanceStrategy!);
  }
  buildCounterHostMaintenancePolicy--;
}
...
core.List<api.AdditionalIPRangesConfig> buildUnnamed33() => [
  buildAdditionalIPRangesConfig(),
  buildAdditionalIPRangesConfig(),
];

void checkUnnamed33(core.List<api.AdditionalIPRangesConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdditionalIPRangesConfig(o[0]);
  checkAdditionalIPRangesConfig(o[1]);
}
...
api.IPAllocationPolicy buildIPAllocationPolicy() {
  ...
  if (buildCounterIPAllocationPolicy < 3) {
    o.additionalIpRangesConfigs = buildUnnamed33();
    o.additionalPodRangesConfig = buildAdditionalPodRangesConfig();
    o.allowRouteOverlap = true;
...
void checkIPAllocationPolicy(api.IPAllocationPolicy o) {
  buildCounterIPAllocationPolicy++;
  if (buildCounterIPAllocationPolicy < 3) {
    checkUnnamed33(o.additionalIpRangesConfigs!);
    checkAdditionalPodRangesConfig(o.additionalPodRangesConfig!);
    unittest.expect(o.allowRouteOverlap!, unittest.isTrue);
...
core.int buildCounterIstioConfig = 0;
api.IstioConfig buildIstioConfig() {
  final o = api.IstioConfig();
  buildCounterIstioConfig++;
  if (buildCounterIstioConfig < 3) {
    o.auth = 'foo';
    o.disabled = true;
  }
  buildCounterIstioConfig--;
...
void checkIstioConfig(api.IstioConfig o) {
  buildCounterIstioConfig++;
  if (buildCounterIstioConfig < 3) {
    unittest.expect(o.auth!, unittest.equals('foo'));
    unittest.expect(o.disabled!, unittest.isTrue);
  }
  buildCounterIstioConfig--;
}
...
void checkK8sBetaAPIConfig(api.K8sBetaAPIConfig o) {
  buildCounterK8sBetaAPIConfig++;
  if (buildCounterK8sBetaAPIConfig < 3) {
    checkUnnamed34(o.enabledApis!);
  }
  buildCounterK8sBetaAPIConfig--;
}

core.int buildCounterKalmConfig = 0;
api.KalmConfig buildKalmConfig() {
  final o = api.KalmConfig();
  buildCounterKalmConfig++;
  if (buildCounterKalmConfig < 3) {
    o.enabled = true;
  }
  buildCounterKalmConfig--;
  return o;
...
void checkKalmConfig(api.KalmConfig o) {
  buildCounterKalmConfig++;
  if (buildCounterKalmConfig < 3) {
    unittest.expect(o.enabled!, unittest.isTrue);
  }
...
core.List<api.Cluster> buildUnnamed36() => [buildCluster(), buildCluster()];

void checkUnnamed36(core.List<api.Cluster> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCluster(o[0]);
  checkCluster(o[1]);
}
...
api.ListClustersResponse buildListClustersResponse() {
  ...
  if (buildCounterListClustersResponse < 3) {
    o.clusters = buildUnnamed36();
    o.missingZones = buildUnnamed37();
  }
  buildCounterListClustersResponse--;
  return o;
}
...
void checkListClustersResponse(api.ListClustersResponse o) {
  buildCounterListClustersResponse++;
  if (buildCounterListClustersResponse < 3) {
    checkUnnamed36(o.clusters!);
    checkUnnamed37(o.missingZones!);
  }
  buildCounterListClustersResponse--;
}
...
core.List<api.NodePool> buildUnnamed39() => [buildNodePool(), buildNodePool()];

void checkUnnamed39(core.List<api.NodePool> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNodePool(o[0]);
  checkNodePool(o[1]);
}
...
void checkListOperationsResponse(api.ListOperationsResponse o) {
  buildCounterListOperationsResponse++;
  if (buildCounterListOperationsResponse < 3) {
    checkUnnamed40(o.missingZones!);
    checkUnnamed41(o.operations!);
  }
  buildCounterListOperationsResponse--;
}

core.List<api.UsableSubnetwork> buildUnnamed42() => [
  buildUsableSubnetwork(),
  buildUsableSubnetwork(),
];

void checkUnnamed42(core.List<api.UsableSubnetwork> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkLocation(api.Location o) {
  ...
  if (buildCounterLocation < 3) {
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.recommended!, unittest.isTrue);
    unittest.expect(o.type!, unittest.equals('foo'));
  }
  buildCounterLocation--;
}
...
api.LoggingComponentConfig buildLoggingComponentConfig() {
  ...
  if (buildCounterLoggingComponentConfig < 3) {
    o.enableComponents = buildUnnamed43();
  }
  buildCounterLoggingComponentConfig--;
  return o;
}
...
void checkLoggingComponentConfig(api.LoggingComponentConfig o) {
  buildCounterLoggingComponentConfig++;
  if (buildCounterLoggingComponentConfig < 3) {
    checkUnnamed43(o.enableComponents!);
  }
  buildCounterLoggingComponentConfig--;
}
...
core.Map<core.String, api.TimeWindow> buildUnnamed44() => {
  'x': buildTimeWindow(),
  'y': buildTimeWindow(),
};

void checkUnnamed44(core.Map<core.String, api.TimeWindow> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTimeWindow(o['x']!);
  checkTimeWindow(o['y']!);
}
...
api.MaintenanceWindow buildMaintenanceWindow() {
  ...
  if (buildCounterMaintenanceWindow < 3) {
    ...
    o.maintenanceExclusions = buildUnnamed44();
...
void checkMaintenanceWindow(api.MaintenanceWindow o) {
  ...
  if (buildCounterMaintenanceWindow < 3) {
    ...
    checkUnnamed44(o.maintenanceExclusions!);
...
core.int buildCounterMaster = 0;
api.Master buildMaster() {
  final o = api.Master();
  buildCounterMaster++;
  if (buildCounterMaster < 3) {}
  buildCounterMaster--;
  return o;
}

void checkMaster(api.Master o) {
  buildCounterMaster++;
  if (buildCounterMaster < 3) {}
  buildCounterMaster--;
}
...
core.List<api.CidrBlock> buildUnnamed45() => [
  buildCidrBlock(),
  buildCidrBlock(),
];

void checkUnnamed45(core.List<api.CidrBlock> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCidrBlock(o[0]);
  checkCidrBlock(o[1]);
}
...
api.NetworkPerformanceConfig buildNetworkPerformanceConfig() {
  ...
  if (buildCounterNetworkPerformanceConfig < 3) {
    o.externalIpEgressBandwidthTier = 'foo';
    o.totalEgressBandwidthTier = 'foo';
  }
  buildCounterNetworkPerformanceConfig--;
  return o;
...
void checkNetworkPerformanceConfig(api.NetworkPerformanceConfig o) {
  buildCounterNetworkPerformanceConfig++;
  if (buildCounterNetworkPerformanceConfig < 3) {
    unittest.expect(o.externalIpEgressBandwidthTier!, unittest.equals('foo'));
    unittest.expect(o.totalEgressBandwidthTier!, unittest.equals('foo'));
  }
  buildCounterNetworkPerformanceConfig--;
}
...
core.List<api.AcceleratorConfig> buildUnnamed49() => [
  buildAcceleratorConfig(),
  buildAcceleratorConfig(),
];

void checkUnnamed49(core.List<api.AcceleratorConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.SecondaryBootDisk> buildUnnamed54() => [
  buildSecondaryBootDisk(),
  buildSecondaryBootDisk(),
];

void checkUnnamed54(core.List<api.SecondaryBootDisk> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.NodeTaint> buildUnnamed57() => [
  buildNodeTaint(),
  buildNodeTaint(),
];

void checkUnnamed57(core.List<api.NodeTaint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNodeTaint(o[0]);
  checkNodeTaint(o[1]);
}
...
api.NodeConfig buildNodeConfig() {
  ...
  if (buildCounterNodeConfig < 3) {
    ...
    o.ephemeralStorageConfig = buildEphemeralStorageConfig();
    ...
    o.hostMaintenancePolicy = buildHostMaintenancePolicy();
    o.imageType = 'foo';
    ...
    o.secondaryBootDisks = buildUnnamed54();
    o.serviceAccount = 'foo';
    o.shieldedInstanceConfig = buildShieldedInstanceConfig();
    o.soleTenantConfig = buildSoleTenantConfig();
    o.spot = true;
    o.storagePools = buildUnnamed55();
    o.tags = buildUnnamed56();
    o.taints = buildUnnamed57();
...
void checkNodeConfig(api.NodeConfig o) {
  ...
  if (buildCounterNodeConfig < 3) {
    ...
    checkEphemeralStorageConfig(o.ephemeralStorageConfig!);
    ...
    checkHostMaintenancePolicy(o.hostMaintenancePolicy!);
    unittest.expect(o.imageType!, unittest.equals('foo'));
...
api.NodeKubeletConfig buildNodeKubeletConfig() {
  ...
  if (buildCounterNodeKubeletConfig < 3) {
    o.allowedUnsafeSysctls = buildUnnamed58();
...
void checkNodeKubeletConfig(api.NodeKubeletConfig o) {
  buildCounterNodeKubeletConfig++;
  if (buildCounterNodeKubeletConfig < 3) {
    checkUnnamed58(o.allowedUnsafeSysctls!);
...
core.List<api.AdditionalNodeNetworkConfig> buildUnnamed60() => [
  buildAdditionalNodeNetworkConfig(),
  buildAdditionalNodeNetworkConfig(),
];

void checkUnnamed60(core.List<api.AdditionalNodeNetworkConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdditionalNodeNetworkConfig(o[0]);
  checkAdditionalNodeNetworkConfig(o[1]);
}

core.List<api.AdditionalPodNetworkConfig> buildUnnamed61() => [
  buildAdditionalPodNetworkConfig(),
  buildAdditionalPodNetworkConfig(),
];

void checkUnnamed61(core.List<api.AdditionalPodNetworkConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.NodeNetworkConfig buildNodeNetworkConfig() {
  ...
  if (buildCounterNodeNetworkConfig < 3) {
    o.additionalNodeNetworkConfigs = buildUnnamed60();
    o.additionalPodNetworkConfigs = buildUnnamed61();
...
void checkNodeNetworkConfig(api.NodeNetworkConfig o) {
  buildCounterNodeNetworkConfig++;
  if (buildCounterNodeNetworkConfig < 3) {
    checkUnnamed60(o.additionalNodeNetworkConfigs!);
    checkUnnamed61(o.additionalPodNetworkConfigs!);
...
core.List<api.StatusCondition> buildUnnamed62() => [
  buildStatusCondition(),
  buildStatusCondition(),
];

void checkUnnamed62(core.List<api.StatusCondition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatusCondition(o[0]);
  checkStatusCondition(o[1]);
}
...
api.NodePool buildNodePool() {
  ...
  if (buildCounterNodePool < 3) {
    ...
    o.etag = 'foo';
    o.initialNodeCount = 42;
    o.instanceGroupUrls = buildUnnamed63();
...
void checkNodePool(api.NodePool o) {
  ...
  if (buildCounterNodePool < 3) {
    ...
    unittest.expect(o.etag!, unittest.equals('foo'));
    unittest.expect(o.initialNodeCount!, unittest.equals(42));
    checkUnnamed63(o.instanceGroupUrls!);
...
core.List<api.UpgradeDetails> buildUnnamed67() => [
  buildUpgradeDetails(),
  buildUpgradeDetails(),
];

void checkUnnamed67(core.List<api.UpgradeDetails> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUpgradeDetails(o[0]);
  checkUpgradeDetails(o[1]);
}
...
api.NodePoolUpgradeInfo buildNodePoolUpgradeInfo() {
  ...
  if (buildCounterNodePoolUpgradeInfo < 3) {
    o.autoUpgradeStatus = buildUnnamed65();
    o.endOfExtendedSupportTimestamp = 'foo';
    o.endOfStandardSupportTimestamp = 'foo';
    o.minorTargetVersion = 'foo';
    o.patchTargetVersion = 'foo';
    o.pausedReason = buildUnnamed66();
    o.upgradeDetails = buildUnnamed67();
  }
  buildCounterNodePoolUpgradeInfo--;
  return o;
}
...
void checkNodePoolUpgradeInfo(api.NodePoolUpgradeInfo o) {
  buildCounterNodePoolUpgradeInfo++;
  if (buildCounterNodePoolUpgradeInfo < 3) {
    checkUnnamed65(o.autoUpgradeStatus!);
    unittest.expect(o.endOfExtendedSupportTimestamp!, unittest.equals('foo'));
    unittest.expect(o.endOfStandardSupportTimestamp!, unittest.equals('foo'));
    unittest.expect(o.minorTargetVersion!, unittest.equals('foo'));
    unittest.expect(o.patchTargetVersion!, unittest.equals('foo'));
    checkUnnamed66(o.pausedReason!);
    checkUnnamed67(o.upgradeDetails!);
  }
  buildCounterNodePoolUpgradeInfo--;
}
...
core.List<api.NodeTaint> buildUnnamed68() => [
  buildNodeTaint(),
  buildNodeTaint(),
];

void checkUnnamed68(core.List<api.NodeTaint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNodeTaint(o[0]);
  checkNodeTaint(o[1]);
}
...
core.List<api.StatusCondition> buildUnnamed69() => [
  buildStatusCondition(),
  buildStatusCondition(),
];

void checkUnnamed69(core.List<api.StatusCondition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatusCondition(o[0]);
  checkStatusCondition(o[1]);
}

core.List<api.StatusCondition> buildUnnamed70() => [
  buildStatusCondition(),
  buildStatusCondition(),
];

void checkUnnamed70(core.List<api.StatusCondition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatusCondition(o[0]);
  checkStatusCondition(o[1]);
}
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.clusterConditions = buildUnnamed69();
    o.detail = 'foo';
    o.endTime = 'foo';
    o.error = buildStatus();
    o.location = 'foo';
    o.name = 'foo';
    o.nodepoolConditions = buildUnnamed70();
    o.operationType = 'foo';
...
void checkOperation(api.Operation o) {
  buildCounterOperation++;
  if (buildCounterOperation < 3) {
    checkUnnamed69(o.clusterConditions!);
    unittest.expect(o.detail!, unittest.equals('foo'));
    unittest.expect(o.endTime!, unittest.equals('foo'));
    checkStatus(o.error!);
    unittest.expect(o.location!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed70(o.nodepoolConditions!);
...
core.List<api.Metric> buildUnnamed71() => [buildMetric(), buildMetric()];
...
core.List<api.OperationProgress> buildUnnamed72() => [
  buildOperationProgress(),
  buildOperationProgress(),
];

void checkUnnamed72(core.List<api.OperationProgress> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkOperationProgress(api.OperationProgress o) {
  ...
  if (buildCounterOperationProgress < 3) {
    ...
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed72(o.stages!);
    unittest.expect(o.status!, unittest.equals('foo'));
  }
  buildCounterOperationProgress--;
}

core.int buildCounterOpportunisticMaintenanceStrategy = 0;
api.OpportunisticMaintenanceStrategy buildOpportunisticMaintenanceStrategy() {
  final o = api.OpportunisticMaintenanceStrategy();
  buildCounterOpportunisticMaintenanceStrategy++;
  if (buildCounterOpportunisticMaintenanceStrategy < 3) {
    o.maintenanceAvailabilityWindow = 'foo';
    o.minNodesPerPool = 'foo';
    o.nodeIdleTimeWindow = 'foo';
  }
  buildCounterOpportunisticMaintenanceStrategy--;
  return o;
}

void checkOpportunisticMaintenanceStrategy(
  api.OpportunisticMaintenanceStrategy o,
) {
  buildCounterOpportunisticMaintenanceStrategy++;
  if (buildCounterOpportunisticMaintenanceStrategy < 3) {
    unittest.expect(o.maintenanceAvailabilityWindow!, unittest.equals('foo'));
    unittest.expect(o.minNodesPerPool!, unittest.equals('foo'));
    unittest.expect(o.nodeIdleTimeWindow!, unittest.equals('foo'));
  }
  buildCounterOpportunisticMaintenanceStrategy--;
}
...
core.int buildCounterPodSecurityPolicyConfig = 0;
api.PodSecurityPolicyConfig buildPodSecurityPolicyConfig() {
  final o = api.PodSecurityPolicyConfig();
  buildCounterPodSecurityPolicyConfig++;
  if (buildCounterPodSecurityPolicyConfig < 3) {
    o.enabled = true;
  }
  buildCounterPodSecurityPolicyConfig--;
  return o;
...
void checkPodSecurityPolicyConfig(api.PodSecurityPolicyConfig o) {
  buildCounterPodSecurityPolicyConfig++;
  if (buildCounterPodSecurityPolicyConfig < 3) {
    unittest.expect(o.enabled!, unittest.isTrue);
  }
...
core.List<api.CertificateAuthorityDomainConfig> buildUnnamed74() => [
  buildCertificateAuthorityDomainConfig(),
  buildCertificateAuthorityDomainConfig(),
];

void checkUnnamed74(core.List<api.CertificateAuthorityDomainConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PrivateRegistryAccessConfig buildPrivateRegistryAccessConfig() {
  ...
  if (buildCounterPrivateRegistryAccessConfig < 3) {
    o.certificateAuthorityDomainConfig = buildUnnamed74();
    o.enabled = true;
  }
  buildCounterPrivateRegistryAccessConfig--;
  return o;
...
void checkPrivateRegistryAccessConfig(api.PrivateRegistryAccessConfig o) {
  buildCounterPrivateRegistryAccessConfig++;
  if (buildCounterPrivateRegistryAccessConfig < 3) {
    checkUnnamed74(o.certificateAuthorityDomainConfig!);
    unittest.expect(o.enabled!, unittest.isTrue);
  }
  buildCounterPrivateRegistryAccessConfig--;
}
...
api.PrivilegedAdmissionConfig buildPrivilegedAdmissionConfig() {
  ...
  if (buildCounterPrivilegedAdmissionConfig < 3) {
    o.allowlistPaths = buildUnnamed75();
  }
  buildCounterPrivilegedAdmissionConfig--;
  return o;
}
...
void checkPrivilegedAdmissionConfig(api.PrivilegedAdmissionConfig o) {
  buildCounterPrivilegedAdmissionConfig++;
  if (buildCounterPrivilegedAdmissionConfig < 3) {
    checkUnnamed75(o.allowlistPaths!);
  }
  buildCounterPrivilegedAdmissionConfig--;
}

core.int buildCounterProtectConfig = 0;
api.ProtectConfig buildProtectConfig() {
  final o = api.ProtectConfig();
  buildCounterProtectConfig++;
  if (buildCounterProtectConfig < 3) {
    o.workloadConfig = buildWorkloadConfig();
    o.workloadVulnerabilityMode = 'foo';
  }
  buildCounterProtectConfig--;
  return o;
}

void checkProtectConfig(api.ProtectConfig o) {
  buildCounterProtectConfig++;
  if (buildCounterProtectConfig < 3) {
    checkWorkloadConfig(o.workloadConfig!);
    unittest.expect(o.workloadVulnerabilityMode!, unittest.equals('foo'));
  }
  buildCounterProtectConfig--;
}
...
core.List<api.AvailableVersion> buildUnnamed76() => [
  buildAvailableVersion(),
  buildAvailableVersion(),
];

void checkUnnamed76(core.List<api.AvailableVersion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAvailableVersion(o[0]);
  checkAvailableVersion(o[1]);
}
...
api.ReleaseChannelConfig buildReleaseChannelConfig() {
  ...
  if (buildCounterReleaseChannelConfig < 3) {
    o.availableVersions = buildUnnamed76();
    o.channel = 'foo';
    o.defaultVersion = 'foo';
    o.upgradeTargetVersion = 'foo';
    o.validVersions = buildUnnamed77();
  }
  buildCounterReleaseChannelConfig--;
  return o;
}
...
void checkSandboxConfig(api.SandboxConfig o) {
  buildCounterSandboxConfig++;
  if (buildCounterSandboxConfig < 3) {
    unittest.expect(o.sandboxType!, unittest.equals('foo'));
    unittest.expect(o.type!, unittest.equals('foo'));
  }
  buildCounterSandboxConfig--;
}
...
core.List<api.ReleaseChannelConfig> buildUnnamed81() => [
  buildReleaseChannelConfig(),
  buildReleaseChannelConfig(),
];

void checkUnnamed81(core.List<api.ReleaseChannelConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, api.WindowsVersions> buildUnnamed85() => {
  'x': buildWindowsVersions(),
  'y': buildWindowsVersions(),
};

void checkUnnamed85(core.Map<core.String, api.WindowsVersions> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWindowsVersions(o['x']!);
  checkWindowsVersions(o['y']!);
}
...
api.ServerConfig buildServerConfig() {
  ...
  if (buildCounterServerConfig < 3) {
    o.channels = buildUnnamed81();
    o.defaultClusterVersion = 'foo';
    o.defaultImageType = 'foo';
    o.validImageTypes = buildUnnamed82();
    o.validMasterVersions = buildUnnamed83();
    o.validNodeVersions = buildUnnamed84();
    o.windowsVersionMaps = buildUnnamed85();
  }
  buildCounterServerConfig--;
  return o;
}
...
void checkServerConfig(api.ServerConfig o) {
  buildCounterServerConfig++;
  if (buildCounterServerConfig < 3) {
    checkUnnamed81(o.channels!);
    unittest.expect(o.defaultClusterVersion!, unittest.equals('foo'));
    unittest.expect(o.defaultImageType!, unittest.equals('foo'));
    checkUnnamed82(o.validImageTypes!);
    checkUnnamed83(o.validMasterVersions!);
    checkUnnamed84(o.validNodeVersions!);
    checkUnnamed85(o.windowsVersionMaps!);
  }
  buildCounterServerConfig--;
}
...
api.SetLabelsRequest buildSetLabelsRequest() {
  ...
  if (buildCounterSetLabelsRequest < 3) {
    ...
    o.name = 'foo';
    o.projectId = 'foo';
    o.resourceLabels = buildUnnamed86();
    o.zone = 'foo';
  }
  buildCounterSetLabelsRequest--;
  return o;
...
void checkSetLabelsRequest(api.SetLabelsRequest o) {
  ...
  if (buildCounterSetLabelsRequest < 3) {
    ...
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.projectId!, unittest.equals('foo'));
    checkUnnamed86(o.resourceLabels!);
    unittest.expect(o.zone!, unittest.equals('foo'));
  }
  buildCounterSetLabelsRequest--;
}
...
core.List<api.NodeAffinity> buildUnnamed88() => [
  buildNodeAffinity(),
  buildNodeAffinity(),
];

void checkUnnamed88(core.List<api.NodeAffinity> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SoleTenantConfig buildSoleTenantConfig() {
  ...
  if (buildCounterSoleTenantConfig < 3) {
    o.minNodeCpus = 42;
    o.nodeAffinities = buildUnnamed88();
  }
  buildCounterSoleTenantConfig--;
  return o;
}
...
void checkSoleTenantConfig(api.SoleTenantConfig o) {
  ...
  if (buildCounterSoleTenantConfig < 3) {
    ...
    checkUnnamed88(o.nodeAffinities!);
  }
  buildCounterSoleTenantConfig--;
}
...
core.int buildCounterTpuConfig = 0;
api.TpuConfig buildTpuConfig() {
  final o = api.TpuConfig();
  buildCounterTpuConfig++;
  if (buildCounterTpuConfig < 3) {
    o.enabled = true;
    o.ipv4CidrBlock = 'foo';
...
void checkTpuConfig(api.TpuConfig o) {
  buildCounterTpuConfig++;
  if (buildCounterTpuConfig < 3) {
    unittest.expect(o.enabled!, unittest.isTrue);
    unittest.expect(o.ipv4CidrBlock!, unittest.equals('foo'));
...
core.List<api.AcceleratorConfig> buildUnnamed91() => [
  buildAcceleratorConfig(),
  buildAcceleratorConfig(),
];

void checkUnnamed91(core.List<api.AcceleratorConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAcceleratorConfig(o[0]);
  checkAcceleratorConfig(o[1]);
}
...
core.List<api.UsableSubnetworkSecondaryRange> buildUnnamed94() => [
  buildUsableSubnetworkSecondaryRange(),
  buildUsableSubnetworkSecondaryRange(),
];

void checkUnnamed94(core.List<api.UsableSubnetworkSecondaryRange> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.UsableSubnetwork buildUsableSubnetwork() {
  ...
  if (buildCounterUsableSubnetwork < 3) {
    o.ipCidrRange = 'foo';
    o.network = 'foo';
    o.secondaryIpRanges = buildUnnamed94();
    o.statusMessage = 'foo';
    o.subnetwork = 'foo';
  }
  buildCounterUsableSubnetwork--;
...
void checkUsableSubnetwork(api.UsableSubnetwork o) {
  ...
  if (buildCounterUsableSubnetwork < 3) {
    ...
    unittest.expect(o.network!, unittest.equals('foo'));
    checkUnnamed94(o.secondaryIpRanges!);
    unittest.expect(o.statusMessage!, unittest.equals('foo'));
    unittest.expect(o.subnetwork!, unittest.equals('foo'));
  }
  buildCounterUsableSubnetwork--;
...
api.UserManagedKeysConfig buildUserManagedKeysConfig() {
  ...
  if (buildCounterUserManagedKeysConfig < 3) {
    ...
    o.serviceAccountSigningKeys = buildUnnamed95();
    o.serviceAccountVerificationKeys = buildUnnamed96();
  }
  buildCounterUserManagedKeysConfig--;
  return o;
}
...
void checkUserManagedKeysConfig(api.UserManagedKeysConfig o) {
  ...
  if (buildCounterUserManagedKeysConfig < 3) {
    ...
    checkUnnamed95(o.serviceAccountSigningKeys!);
    checkUnnamed96(o.serviceAccountVerificationKeys!);
  }
  buildCounterUserManagedKeysConfig--;
}
...
core.int buildCounterWindowsVersion = 0;
api.WindowsVersion buildWindowsVersion() {
  final o = api.WindowsVersion();
  buildCounterWindowsVersion++;
  if (buildCounterWindowsVersion < 3) {
    o.imageType = 'foo';
    o.osVersion = 'foo';
...
void checkWindowsVersion(api.WindowsVersion o) {
  buildCounterWindowsVersion++;
  if (buildCounterWindowsVersion < 3) {
    unittest.expect(o.imageType!, unittest.equals('foo'));
    unittest.expect(o.osVersion!, unittest.equals('foo'));
...
core.List<api.WindowsVersion> buildUnnamed97() => [
  buildWindowsVersion(),
  buildWindowsVersion(),
];

void checkUnnamed97(core.List<api.WindowsVersion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWindowsVersion(o[0]);
  checkWindowsVersion(o[1]);
}

core.int buildCounterWindowsVersions = 0;
api.WindowsVersions buildWindowsVersions() {
  final o = api.WindowsVersions();
  buildCounterWindowsVersions++;
  if (buildCounterWindowsVersions < 3) {
    o.windowsVersions = buildUnnamed97();
  }
  buildCounterWindowsVersions--;
  return o;
}

void checkWindowsVersions(api.WindowsVersions o) {
  buildCounterWindowsVersions++;
  if (buildCounterWindowsVersions < 3) {
    checkUnnamed97(o.windowsVersions!);
  }
  buildCounterWindowsVersions--;
}

core.int buildCounterWorkloadALTSConfig = 0;
api.WorkloadALTSConfig buildWorkloadALTSConfig() {
  final o = api.WorkloadALTSConfig();
  buildCounterWorkloadALTSConfig++;
  if (buildCounterWorkloadALTSConfig < 3) {
    o.enableAlts = true;
  }
  buildCounterWorkloadALTSConfig--;
  return o;
...
void checkWorkloadALTSConfig(api.WorkloadALTSConfig o) {
  buildCounterWorkloadALTSConfig++;
  if (buildCounterWorkloadALTSConfig < 3) {
    unittest.expect(o.enableAlts!, unittest.isTrue);
  }
  buildCounterWorkloadALTSConfig--;
}

core.int buildCounterWorkloadCertificates = 0;
api.WorkloadCertificates buildWorkloadCertificates() {
  final o = api.WorkloadCertificates();
  buildCounterWorkloadCertificates++;
  if (buildCounterWorkloadCertificates < 3) {
    o.enableCertificates = true;
  }
  buildCounterWorkloadCertificates--;
  return o;
...
void checkWorkloadCertificates(api.WorkloadCertificates o) {
  buildCounterWorkloadCertificates++;
  if (buildCounterWorkloadCertificates < 3) {
    unittest.expect(o.enableCertificates!, unittest.isTrue);
  }
...
core.int buildCounterWorkloadConfig = 0;
api.WorkloadConfig buildWorkloadConfig() {
  final o = api.WorkloadConfig();
  buildCounterWorkloadConfig++;
  if (buildCounterWorkloadConfig < 3) {
    o.auditMode = 'foo';
  }
  buildCounterWorkloadConfig--;
  return o;
...
void checkWorkloadConfig(api.WorkloadConfig o) {
  buildCounterWorkloadConfig++;
  if (buildCounterWorkloadConfig < 3) {
    unittest.expect(o.auditMode!, unittest.equals('foo'));
  }
  buildCounterWorkloadConfig--;
}
...
void checkWorkloadIdentityConfig(api.WorkloadIdentityConfig o) {
  buildCounterWorkloadIdentityConfig++;
  if (buildCounterWorkloadIdentityConfig < 3) {
    unittest.expect(o.identityNamespace!, unittest.equals('foo'));
...
void checkWorkloadMetadataConfig(api.WorkloadMetadataConfig o) {
  ...
  if (buildCounterWorkloadMetadataConfig < 3) {
    unittest.expect(o.mode!, unittest.equals('foo'));
    unittest.expect(o.nodeMetadata!, unittest.equals('foo'));
  }
  buildCounterWorkloadMetadataConfig--;
}
...
void main() {
  ...
  unittest.group('obj-schema-AutopilotConversionStatus', () {
    unittest.test('to-json--from-json', () async {
      final o = buildAutopilotConversionStatus();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.AutopilotConversionStatus.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkAutopilotConversionStatus(od);
    });
  });
  ...
  unittest.group('obj-schema-AvailableVersion', () {
    unittest.test('to-json--from-json', () async {
      final o = buildAvailableVersion();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.AvailableVersion.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkAvailableVersion(od);
    });
  });
  ...
  unittest.group('obj-schema-ClusterTelemetry', () {
    unittest.test('to-json--from-json', () async {
      final o = buildClusterTelemetry();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ClusterTelemetry.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkClusterTelemetry(od);
    });
  });
  ...
  unittest.group('obj-schema-EphemeralStorageConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildEphemeralStorageConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.EphemeralStorageConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkEphemeralStorageConfig(od);
    });
  });
  ...
  unittest.group('obj-schema-HostMaintenancePolicy', () {
    unittest.test('to-json--from-json', () async {
      final o = buildHostMaintenancePolicy();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.HostMaintenancePolicy.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkHostMaintenancePolicy(od);
    });
  });
  ...
  unittest.group('obj-schema-IstioConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildIstioConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.IstioConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkIstioConfig(od);
    });
  ...
  unittest.group('obj-schema-KalmConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildKalmConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.KalmConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkKalmConfig(od);
    });
  ...
  unittest.group('obj-schema-Master', () {
    unittest.test('to-json--from-json', () async {
      final o = buildMaster();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Master.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkMaster(od);
    });
  ...
  unittest.group('obj-schema-OpportunisticMaintenanceStrategy', () {
    unittest.test('to-json--from-json', () async {
      final o = buildOpportunisticMaintenanceStrategy();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.OpportunisticMaintenanceStrategy.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkOpportunisticMaintenanceStrategy(od);
    });
  });
  ...
  unittest.group('obj-schema-PodSecurityPolicyConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildPodSecurityPolicyConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.PodSecurityPolicyConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPodSecurityPolicyConfig(od);
    });
  });
  ...
  unittest.group('obj-schema-ProtectConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildProtectConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ProtectConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkProtectConfig(od);
    });
  });
  ...
  unittest.group('obj-schema-TpuConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildTpuConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.TpuConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkTpuConfig(od);
    });
  ...
  unittest.group('obj-schema-WindowsVersion', () {
    unittest.test('to-json--from-json', () async {
      final o = buildWindowsVersion();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.WindowsVersion.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkWindowsVersion(od);
    });
  });

  unittest.group('obj-schema-WindowsVersions', () {
    unittest.test('to-json--from-json', () async {
      final o = buildWindowsVersions();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.WindowsVersions.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkWindowsVersions(od);
    });
  });

  unittest.group('obj-schema-WorkloadALTSConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildWorkloadALTSConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.WorkloadALTSConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkWorkloadALTSConfig(od);
    });
  });

  unittest.group('obj-schema-WorkloadCertificates', () {
    unittest.test('to-json--from-json', () async {
      final o = buildWorkloadCertificates();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.WorkloadCertificates.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkWorkloadCertificates(od);
    });
  });

  unittest.group('obj-schema-WorkloadConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildWorkloadConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.WorkloadConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkWorkloadConfig(od);
    });
  });
