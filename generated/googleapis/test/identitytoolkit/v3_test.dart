...
buildCreateAuthUriResponse() {
  ...
  if (buildCounterCreateAuthUriResponse < 3) {
    o.allProviders = buildUnnamed2629();
    o.authUri = "foo";
...
checkCreateAuthUriResponse(api.CreateAuthUriResponse o) {
  buildCounterCreateAuthUriResponse++;
  if (buildCounterCreateAuthUriResponse < 3) {
    checkUnnamed2629(o.allProviders);
...
checkUnnamed2630(core.List<api.UserInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUserInfo(o[0]);
  checkUserInfo(o[1]);
}
...
checkUnnamed2631(core.List<api.UserInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUserInfo(o[0]);
  checkUserInfo(o[1]);
}
...
buildIdentitytoolkitRelyingpartyGetAccountInfoRequest() {
  ...
  if (buildCounterIdentitytoolkitRelyingpartyGetAccountInfoRequest < 3) {
    o.delegatedProjectNumber = "foo";
    o.email = buildUnnamed2632();
    o.idToken = "foo";
    o.localId = buildUnnamed2633();
  }
  buildCounterIdentitytoolkitRelyingpartyGetAccountInfoRequest--;
  return o;
}
...
checkIdentitytoolkitRelyingpartyGetAccountInfoRequest(api.IdentitytoolkitRelyingpartyGetAccountInfoRequest o) {
  ...
  if (buildCounterIdentitytoolkitRelyingpartyGetAccountInfoRequest < 3) {
    unittest.expect(o.delegatedProjectNumber, unittest.equals('foo'));
    checkUnnamed2632(o.email);
    unittest.expect(o.idToken, unittest.equals('foo'));
    checkUnnamed2633(o.localId);
  }
  buildCounterIdentitytoolkitRelyingpartyGetAccountInfoRequest--;
}
...
checkUnnamed2635(core.List<api.IdpConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIdpConfig(o[0]);
  checkIdpConfig(o[1]);
}
...
buildIdentitytoolkitRelyingpartySetAccountInfoRequest() {
  ...
  if (buildCounterIdentitytoolkitRelyingpartySetAccountInfoRequest < 3) {
    ...
    o.delegatedProjectNumber = "foo";
    o.deleteAttribute = buildUnnamed2636();
    o.deleteProvider = buildUnnamed2637();
    o.disableUser = true;
    o.displayName = "foo";
    o.email = "foo";
...
checkIdentitytoolkitRelyingpartySetAccountInfoRequest(api.IdentitytoolkitRelyingpartySetAccountInfoRequest o) {
  ...
  if (buildCounterIdentitytoolkitRelyingpartySetAccountInfoRequest < 3) {
    ...
    unittest.expect(o.delegatedProjectNumber, unittest.equals('foo'));
    checkUnnamed2636(o.deleteAttribute);
    checkUnnamed2637(o.deleteProvider);
...
checkUnnamed2640(core.List<api.UserInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUserInfo(o[0]);
  checkUserInfo(o[1]);
}
...
checkUnnamed2641(core.List<api.SetAccountInfoResponseProviderUserInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSetAccountInfoResponse() {
  ...
  if (buildCounterSetAccountInfoResponse < 3) {
    ...
    o.newEmail = "foo";
    o.photoUrl = "foo";
    o.providerUserInfo = buildUnnamed2641();
    o.refreshToken = "foo";
  }
  buildCounterSetAccountInfoResponse--;
  return o;
...
checkSetAccountInfoResponse(api.SetAccountInfoResponse o) {
  ...
  if (buildCounterSetAccountInfoResponse < 3) {
    ...
    unittest.expect(o.newEmail, unittest.equals('foo'));
    unittest.expect(o.photoUrl, unittest.equals('foo'));
    checkUnnamed2641(o.providerUserInfo);
...
checkUnnamed2642(core.List<api.UploadAccountResponseError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2643(core.List<api.UserInfoProviderUserInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUserInfo() {
  ...
  if (buildCounterUserInfo < 3) {
    ...
    o.photoUrl = "foo";
    o.providerUserInfo = buildUnnamed2643();
    o.salt = "foo";
    o.validSince = "foo";
    o.version = 42;
  }
...
checkUserInfo(api.UserInfo o) {
  ...
  if (buildCounterUserInfo < 3) {
    ...
    unittest.expect(o.photoUrl, unittest.equals('foo'));
    checkUnnamed2643(o.providerUserInfo);
...
buildVerifyAssertionResponse() {
  ...
  if (buildCounterVerifyAssertionResponse < 3) {
    ...
    o.refreshToken = "foo";
    o.timeZone = "foo";
    o.verifiedProvider = buildUnnamed2644();
  }
  buildCounterVerifyAssertionResponse--;
  return o;
}
...
checkVerifyAssertionResponse(api.VerifyAssertionResponse o) {
  ...
  if (buildCounterVerifyAssertionResponse < 3) {
    ...
    checkUnnamed2644(o.verifiedProvider);
  }
  buildCounterVerifyAssertionResponse--;
}
