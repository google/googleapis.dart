...
core.List<api.Exemplar> buildUnnamed7() => [buildExemplar(), buildExemplar()];
...
core.List<api.LogEntry> buildUnnamed17() => [buildLogEntry(), buildLogEntry()];

void checkUnnamed17(core.List<api.LogEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogEntry(o[0]);
  checkLogEntry(o[1]);
}

core.List<api.MetricValueSet> buildUnnamed18() => [
  buildMetricValueSet(),
  buildMetricValueSet(),
];

void checkUnnamed18(core.List<api.MetricValueSet> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetricValueSet(o[0]);
  checkMetricValueSet(o[1]);
}

core.List<api.ResourceInfo> buildUnnamed19() => [
  buildResourceInfo(),
  buildResourceInfo(),
];

void checkUnnamed19(core.List<api.ResourceInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResourceInfo(o[0]);
  checkResourceInfo(o[1]);
}

core.List<api.TraceSpan> buildUnnamed20() => [
  buildTraceSpan(),
  buildTraceSpan(),
];

void checkUnnamed20(core.List<api.TraceSpan> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTraceSpan(o[0]);
  checkTraceSpan(o[1]);
}
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    ...
    o.logEntries = buildUnnamed17();
    o.metricValueSets = buildUnnamed18();
    o.operationId = 'foo';
    o.operationName = 'foo';
    o.quotaProperties = buildQuotaProperties();
    o.resources = buildUnnamed19();
    o.startTime = 'foo';
    o.traceSpans = buildUnnamed20();
    o.userLabels = buildUnnamed21();
  }
  buildCounterOperation--;
  return o;
}
...
core.List<api.MetricValueSet> buildUnnamed24() => [
  buildMetricValueSet(),
  buildMetricValueSet(),
];

void checkUnnamed24(core.List<api.MetricValueSet> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetricValueSet(o[0]);
  checkMetricValueSet(o[1]);
}
...
core.List<api.ReportError> buildUnnamed28() => [
  buildReportError(),
  buildReportError(),
];

void checkUnnamed28(core.List<api.ReportError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void main() {
  ...
  unittest.group('obj-schema-CheckError', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CheckError.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCheckError(od);
    });
  ...
  unittest.group('obj-schema-CheckInfo', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CheckInfo.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCheckInfo(od);
    });
  ...
  unittest.group('obj-schema-QuotaError', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.QuotaError.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkQuotaError(od);
    });
  ...
  unittest.group('obj-schema-QuotaInfo', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.QuotaInfo.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkQuotaInfo(od);
    });
  ...
  unittest.group('resource-ServicesResource', () {
    unittest.test('method--allocateQuota', () async {
      ...
      final response = await res.allocateQuota(
        arg_request,
        arg_serviceName,
        $fields: arg_$fields,
      );
