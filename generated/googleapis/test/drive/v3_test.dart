...
core.List<api.Label> buildUnnamed48() => [buildLabel(), buildLabel()];
...
core.List<api.Reply> buildUnnamed54() => [buildReply(), buildReply()];
...
core.List<api.Revision> buildUnnamed57() => [buildRevision(), buildRevision()];
