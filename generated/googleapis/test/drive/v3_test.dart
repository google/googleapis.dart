...
core.List<api.AboutDriveThemes> buildUnnamed5967() => [
      buildAboutDriveThemes(),
      buildAboutDriveThemes(),
    ];

void checkUnnamed5967(core.List<api.AboutDriveThemes> o) {
...
core.Map<core.String, core.List<core.String>> buildUnnamed5969() => {
      'x': buildUnnamed5968(),
      'y': buildUnnamed5968(),
    };

void checkUnnamed5969(core.Map<core.String, core.List<core.String>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed5968(o['x']!);
  checkUnnamed5968(o['y']!);
}
...
core.Map<core.String, core.List<core.String>> buildUnnamed5972() => {
      'x': buildUnnamed5971(),
      'y': buildUnnamed5971(),
    };

void checkUnnamed5972(core.Map<core.String, core.List<core.String>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed5971(o['x']!);
  checkUnnamed5971(o['y']!);
}

core.Map<core.String, core.String> buildUnnamed5973() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed5973(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.AboutTeamDriveThemes> buildUnnamed5974() => [
      buildAboutTeamDriveThemes(),
      buildAboutTeamDriveThemes(),
    ];

void checkUnnamed5974(core.List<api.AboutTeamDriveThemes> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.About buildAbout() {
  ...
  if (buildCounterAbout < 3) {
    ...
    o.driveThemes = buildUnnamed5967();
    o.exportFormats = buildUnnamed5969();
    o.folderColorPalette = buildUnnamed5970();
    o.importFormats = buildUnnamed5972();
    o.kind = 'foo';
    o.maxImportSizes = buildUnnamed5973();
    o.maxUploadSize = 'foo';
    o.storageQuota = buildAboutStorageQuota();
    o.teamDriveThemes = buildUnnamed5974();
    o.user = buildUser();
  }
  buildCounterAbout--;
  return o;
...
void checkAbout(api.About o) {
  ...
  if (buildCounterAbout < 3) {
    ...
    checkUnnamed5967(o.driveThemes!);
    checkUnnamed5969(o.exportFormats!);
    checkUnnamed5970(o.folderColorPalette!);
    checkUnnamed5972(o.importFormats!);
    unittest.expect(
      o.kind!,
      unittest.equals('foo'),
    );
    checkUnnamed5973(o.maxImportSizes!);
    unittest.expect(
      o.maxUploadSize!,
      unittest.equals('foo'),
    );
    checkAboutStorageQuota(o.storageQuota!);
    checkUnnamed5974(o.teamDriveThemes!);
    checkUser(o.user!);
  }
  buildCounterAbout--;
}
...
core.List<api.Change> buildUnnamed5975() => [
      buildChange(),
      buildChange(),
    ];

void checkUnnamed5975(core.List<api.Change> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkChange(o[0]);
  checkChange(o[1]);
}
...
core.Map<core.String, core.String> buildUnnamed5976() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed5976(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.Reply> buildUnnamed5977() => [
      buildReply(),
      buildReply(),
    ];

void checkUnnamed5977(core.List<api.Reply> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReply(o[0]);
  checkReply(o[1]);
}
...
void checkComment(api.Comment o) {
  ...
  if (buildCounterComment < 3) {
    ...
    checkUnnamed5977(o.replies!);
    unittest.expect(o.resolved!, unittest.isTrue);
  }
  buildCounterComment--;
}

core.List<api.Comment> buildUnnamed5978() => [
      buildComment(),
      buildComment(),
    ];

void checkUnnamed5978(core.List<api.Comment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkComment(o[0]);
  checkComment(o[1]);
}
...
core.List<api.Drive> buildUnnamed5979() => [
      buildDrive(),
      buildDrive(),
    ];

void checkUnnamed5979(core.List<api.Drive> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDrive(o[0]);
  checkDrive(o[1]);
}
...
core.Map<core.String, core.String?> buildUnnamed5980() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed5980(core.Map<core.String, core.String?> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.ContentRestriction> buildUnnamed5981() => [
      buildContentRestriction(),
      buildContentRestriction(),
    ];

void checkUnnamed5981(core.List<api.ContentRestriction> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContentRestriction(o[0]);
  checkContentRestriction(o[1]);
}

core.Map<core.String, core.String> buildUnnamed5982() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed5982(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.User> buildUnnamed5983() => [
      buildUser(),
      buildUser(),
    ];

void checkUnnamed5983(core.List<api.User> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUser(o[0]);
  checkUser(o[1]);
}
...
core.List<api.Permission> buildUnnamed5986() => [
      buildPermission(),
      buildPermission(),
    ];

void checkUnnamed5986(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0]);
  checkPermission(o[1]);
}

core.Map<core.String, core.String?> buildUnnamed5987() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed5987(core.Map<core.String, core.String?> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.File buildFile() {
  ...
  if (buildCounterFile < 3) {
    o.appProperties = buildUnnamed5980();
    o.capabilities = buildFileCapabilities();
    o.contentHints = buildFileContentHints();
    o.contentRestrictions = buildUnnamed5981();
    o.copyRequiresWriterPermission = true;
    o.createdTime = core.DateTime.parse('2002-02-27T14:01:02');
    o.description = 'foo';
    o.driveId = 'foo';
    o.explicitlyTrashed = true;
    o.exportLinks = buildUnnamed5982();
    o.fileExtension = 'foo';
    ...
    o.ownedByMe = true;
    o.owners = buildUnnamed5983();
    o.parents = buildUnnamed5984();
    o.permissionIds = buildUnnamed5985();
    o.permissions = buildUnnamed5986();
    o.properties = buildUnnamed5987();
...
void checkFile(api.File o) {
  ...
  if (buildCounterFile < 3) {
    ...
    checkUnnamed5982(o.exportLinks!);
    unittest.expect(
      o.fileExtension!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed5983(o.owners!);
    checkUnnamed5984(o.parents!);
    checkUnnamed5985(o.permissionIds!);
    checkUnnamed5986(o.permissions!);
    checkUnnamed5987(o.properties!);
    unittest.expect(
      o.quotaBytesUsed!,
      unittest.equals('foo'),
    );
...
core.List<api.File> buildUnnamed5989() => [
      buildFile(),
      buildFile(),
    ];

void checkUnnamed5989(core.List<api.File> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFile(o[0]);
  checkFile(o[1]);
}
...
core.List<api.PermissionPermissionDetails> buildUnnamed5991() => [
      buildPermissionPermissionDetails(),
      buildPermissionPermissionDetails(),
    ];

void checkUnnamed5991(core.List<api.PermissionPermissionDetails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.PermissionTeamDrivePermissionDetails> buildUnnamed5992() => [
      buildPermissionTeamDrivePermissionDetails(),
      buildPermissionTeamDrivePermissionDetails(),
    ];

void checkUnnamed5992(core.List<api.PermissionTeamDrivePermissionDetails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Permission buildPermission() {
  ...
  if (buildCounterPermission < 3) {
    ...
    o.id = 'foo';
    o.kind = 'foo';
    o.permissionDetails = buildUnnamed5991();
    o.photoLink = 'foo';
    o.role = 'foo';
    o.teamDrivePermissionDetails = buildUnnamed5992();
    o.type = 'foo';
    o.view = 'foo';
  }
  buildCounterPermission--;
...
void checkPermission(api.Permission o) {
  ...
  if (buildCounterPermission < 3) {
    ...
    checkUnnamed5991(o.permissionDetails!);
    unittest.expect(
      o.photoLink!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed5992(o.teamDrivePermissionDetails!);
    unittest.expect(
      o.type!,
      unittest.equals('foo'),
    );
...
core.List<api.Permission> buildUnnamed5993() => [
      buildPermission(),
      buildPermission(),
    ];

void checkUnnamed5993(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0]);
  checkPermission(o[1]);
}
...
core.List<api.Reply> buildUnnamed5994() => [
      buildReply(),
      buildReply(),
    ];

void checkUnnamed5994(core.List<api.Reply> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReply(o[0]);
  checkReply(o[1]);
}
...
void checkReplyList(api.ReplyList o) {
  ...
  if (buildCounterReplyList < 3) {
    ...
    checkUnnamed5994(o.replies!);
  }
  buildCounterReplyList--;
}

core.Map<core.String, core.String> buildUnnamed5995() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed5995(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.Revision buildRevision() {
  ...
  if (buildCounterRevision < 3) {
    o.exportLinks = buildUnnamed5995();
    o.id = 'foo';
    o.keepForever = true;
    o.kind = 'foo';
    o.lastModifyingUser = buildUser();
...
void checkRevision(api.Revision o) {
  buildCounterRevision++;
  if (buildCounterRevision < 3) {
    checkUnnamed5995(o.exportLinks!);
    unittest.expect(
      o.id!,
      unittest.equals('foo'),
    );
...
core.List<api.Revision> buildUnnamed5996() => [
      buildRevision(),
      buildRevision(),
    ];

void checkUnnamed5996(core.List<api.Revision> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRevision(o[0]);
  checkRevision(o[1]);
}
...
core.List<api.TeamDrive> buildUnnamed5997() => [
      buildTeamDrive(),
      buildTeamDrive(),
    ];

void checkUnnamed5997(core.List<api.TeamDrive> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTeamDrive(o[0]);
  checkTeamDrive(o[1]);
}
