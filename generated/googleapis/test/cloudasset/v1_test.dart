...
void checkAnalyzeIamPolicyLongrunningRequest(
  ...
  if (buildCounterAnalyzeIamPolicyLongrunningRequest < 3) {
    ...
    unittest.expect(o.savedAnalysisQuery!, unittest.equals('foo'));
  }
  buildCounterAnalyzeIamPolicyLongrunningRequest--;
}
...
void checkAnalyzerOrgPolicy(api.AnalyzerOrgPolicy o) {
  buildCounterAnalyzerOrgPolicy++;
  if (buildCounterAnalyzerOrgPolicy < 3) {
    unittest.expect(o.appliedResource!, unittest.equals('foo'));
    unittest.expect(o.attachedResource!, unittest.equals('foo'));
...
core.List<api.AssetException> buildUnnamed9() => [
  buildAssetException(),
  buildAssetException(),
];

void checkUnnamed9(core.List<api.AssetException> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAssetException(o[0]);
  checkAssetException(o[1]);
}

core.List<api.GoogleCloudOrgpolicyV1Policy> buildUnnamed10() => [
  buildGoogleCloudOrgpolicyV1Policy(),
  buildGoogleCloudOrgpolicyV1Policy(),
];

void checkUnnamed10(core.List<api.GoogleCloudOrgpolicyV1Policy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Asset buildAsset() {
  ...
  if (buildCounterAsset < 3) {
    ...
    o.assetExceptions = buildUnnamed9();
    o.assetType = 'foo';
    o.iamPolicy = buildPolicy();
    o.name = 'foo';
    o.orgPolicy = buildUnnamed10();
...
core.int buildCounterAssetEnrichment = 0;
api.AssetEnrichment buildAssetEnrichment() {
  final o = api.AssetEnrichment();
  buildCounterAssetEnrichment++;
  if (buildCounterAssetEnrichment < 3) {
    o.resourceOwners = buildResourceOwners();
  }
  buildCounterAssetEnrichment--;
  return o;
}

void checkAssetEnrichment(api.AssetEnrichment o) {
  buildCounterAssetEnrichment++;
  if (buildCounterAssetEnrichment < 3) {
    checkResourceOwners(o.resourceOwners!);
  }
  buildCounterAssetEnrichment--;
}

core.int buildCounterAssetException = 0;
api.AssetException buildAssetException() {
  final o = api.AssetException();
  buildCounterAssetException++;
  if (buildCounterAssetException < 3) {
    o.details = 'foo';
    o.exceptionType = 'foo';
  }
  buildCounterAssetException--;
...
void checkAssetException(api.AssetException o) {
  buildCounterAssetException++;
  if (buildCounterAssetException < 3) {
...
core.List<api.VersionedResource> buildUnnamed11() => [
  buildVersionedResource(),
  buildVersionedResource(),
];

void checkUnnamed11(core.List<api.VersionedResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AttachedResource buildAttachedResource() {
  ...
  if (buildCounterAttachedResource < 3) {
    o.assetType = 'foo';
    o.versionedResources = buildUnnamed11();
  }
  buildCounterAttachedResource--;
  return o;
}
...
void checkAttachedResource(api.AttachedResource o) {
  ...
  if (buildCounterAttachedResource < 3) {
    unittest.expect(o.assetType!, unittest.equals('foo'));
    checkUnnamed11(o.versionedResources!);
  }
  buildCounterAttachedResource--;
}

core.List<api.AuditLogConfig> buildUnnamed12() => [
  buildAuditLogConfig(),
  buildAuditLogConfig(),
];

void checkUnnamed12(core.List<api.AuditLogConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AuditConfig buildAuditConfig() {
  ...
  if (buildCounterAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed12();
    o.service = 'foo';
  }
  buildCounterAuditConfig--;
  return o;
...
void checkAuditConfig(api.AuditConfig o) {
  buildCounterAuditConfig++;
  if (buildCounterAuditConfig < 3) {
    checkUnnamed12(o.auditLogConfigs!);
...
api.AuditLogConfig buildAuditLogConfig() {
  ...
  if (buildCounterAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed13();
    o.logType = 'foo';
  }
  buildCounterAuditLogConfig--;
  return o;
...
void checkAuditLogConfig(api.AuditLogConfig o) {
  buildCounterAuditLogConfig++;
  if (buildCounterAuditLogConfig < 3) {
    checkUnnamed13(o.exemptedMembers!);
    unittest.expect(o.logType!, unittest.equals('foo'));
  }
  buildCounterAuditLogConfig--;
}

core.List<api.TemporalAsset> buildUnnamed14() => [
  buildTemporalAsset(),
  buildTemporalAsset(),
];

void checkUnnamed14(core.List<api.TemporalAsset> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkBatchGetAssetsHistoryResponse(api.BatchGetAssetsHistoryResponse o) {
  buildCounterBatchGetAssetsHistoryResponse++;
  if (buildCounterBatchGetAssetsHistoryResponse < 3) {
    checkUnnamed14(o.assets!);
  }
  buildCounterBatchGetAssetsHistoryResponse--;
}

core.List<api.EffectiveIamPolicy> buildUnnamed15() => [
  buildEffectiveIamPolicy(),
  buildEffectiveIamPolicy(),
];

void checkUnnamed15(core.List<api.EffectiveIamPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildBatchGetEffectiveIamPoliciesResponse() {
  ...
  if (buildCounterBatchGetEffectiveIamPoliciesResponse < 3) {
    o.policyResults = buildUnnamed15();
  }
  buildCounterBatchGetEffectiveIamPoliciesResponse--;
  return o;
}
...
void checkBatchGetEffectiveIamPoliciesResponse(
  ...
  buildCounterBatchGetEffectiveIamPoliciesResponse++;
  if (buildCounterBatchGetEffectiveIamPoliciesResponse < 3) {
    checkUnnamed15(o.policyResults!);
  }
  buildCounterBatchGetEffectiveIamPoliciesResponse--;
}
...
void checkConditionContext(api.ConditionContext o) {
  buildCounterConditionContext++;
  if (buildCounterConditionContext < 3) {
    unittest.expect(o.accessTime!, unittest.equals('foo'));
  }
  buildCounterConditionContext--;
}
...
void checkConditionEvaluation(api.ConditionEvaluation o) {
  buildCounterConditionEvaluation++;
  if (buildCounterConditionEvaluation < 3) {
    unittest.expect(o.evaluationValue!, unittest.equals('foo'));
  }
  buildCounterConditionEvaluation--;
}
...
core.List<api.PolicyInfo> buildUnnamed17() => [
  buildPolicyInfo(),
  buildPolicyInfo(),
];

void checkUnnamed17(core.List<api.PolicyInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPolicyInfo(o[0]);
  checkPolicyInfo(o[1]);
}
...
api.EffectiveTagDetails buildEffectiveTagDetails() {
  ...
  if (buildCounterEffectiveTagDetails < 3) {
    o.attachedResource = 'foo';
    o.effectiveTags = buildUnnamed18();
  }
  buildCounterEffectiveTagDetails--;
  return o;
}
...
void checkEffectiveTagDetails(api.EffectiveTagDetails o) {
  ...
  if (buildCounterEffectiveTagDetails < 3) {
    unittest.expect(o.attachedResource!, unittest.equals('foo'));
    checkUnnamed18(o.effectiveTags!);
  }
  buildCounterEffectiveTagDetails--;
}
...
core.Map<core.String, api.Permissions> buildUnnamed19() => {
  'x': buildPermissions(),
  'y': buildPermissions(),
};

void checkUnnamed19(core.Map<core.String, api.Permissions> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Explanation buildExplanation() {
  ...
  if (buildCounterExplanation < 3) {
    o.matchedPermissions = buildUnnamed19();
  }
  buildCounterExplanation--;
  return o;
}
...
void checkExplanation(api.Explanation o) {
  buildCounterExplanation++;
  if (buildCounterExplanation < 3) {
    checkUnnamed19(o.matchedPermissions!);
  }
  buildCounterExplanation--;
}
...
api.ExportAssetsRequest buildExportAssetsRequest() {
  ...
  if (buildCounterExportAssetsRequest < 3) {
    o.assetTypes = buildUnnamed20();
    o.contentType = 'foo';
    o.outputConfig = buildOutputConfig();
    o.readTime = 'foo';
    o.relationshipTypes = buildUnnamed21();
  }
  buildCounterExportAssetsRequest--;
  return o;
}
...
api.Feed buildFeed() {
  ...
  if (buildCounterFeed < 3) {
    o.assetNames = buildUnnamed22();
    o.assetTypes = buildUnnamed23();
    o.condition = buildExpr();
    o.contentType = 'foo';
    o.feedOutputConfig = buildFeedOutputConfig();
    o.name = 'foo';
    o.relationshipTypes = buildUnnamed24();
  }
  buildCounterFeed--;
  return o;
}
...
void checkFeed(api.Feed o) {
  buildCounterFeed++;
  if (buildCounterFeed < 3) {
    checkUnnamed22(o.assetNames!);
    checkUnnamed23(o.assetTypes!);
    checkExpr(o.condition!);
    unittest.expect(o.contentType!, unittest.equals('foo'));
    checkFeedOutputConfig(o.feedOutputConfig!);
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed24(o.relationshipTypes!);
  }
  buildCounterFeed--;
}
...
core.List<api.GoogleCloudAssetV1Access> buildUnnamed25() => [
  buildGoogleCloudAssetV1Access(),
  buildGoogleCloudAssetV1Access(),
];

void checkUnnamed25(core.List<api.GoogleCloudAssetV1Access> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudAssetV1Access(o[0]);
  checkGoogleCloudAssetV1Access(o[1]);
}

core.List<api.GoogleCloudAssetV1Edge> buildUnnamed26() => [
  buildGoogleCloudAssetV1Edge(),
  buildGoogleCloudAssetV1Edge(),
];

void checkUnnamed26(core.List<api.GoogleCloudAssetV1Edge> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudAssetV1Edge(o[0]);
  checkGoogleCloudAssetV1Edge(o[1]);
}

core.List<api.GoogleCloudAssetV1Resource> buildUnnamed27() => [
  buildGoogleCloudAssetV1Resource(),
  buildGoogleCloudAssetV1Resource(),
];

void checkUnnamed27(core.List<api.GoogleCloudAssetV1Resource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildGoogleCloudAssetV1AccessControlList() {
  ...
  if (buildCounterGoogleCloudAssetV1AccessControlList < 3) {
    o.accesses = buildUnnamed25();
    o.conditionEvaluation = buildConditionEvaluation();
    o.resourceEdges = buildUnnamed26();
...
void checkGoogleCloudAssetV1AccessControlList(
  ...
  buildCounterGoogleCloudAssetV1AccessControlList++;
  if (buildCounterGoogleCloudAssetV1AccessControlList < 3) {
    checkUnnamed25(o.accesses!);
    checkConditionEvaluation(o.conditionEvaluation!);
    checkUnnamed26(o.resourceEdges!);
    checkUnnamed27(o.resources!);
  }
  buildCounterGoogleCloudAssetV1AccessControlList--;
}

core.List<api.AnalyzerOrgPolicy> buildUnnamed28() => [
  buildAnalyzerOrgPolicy(),
  buildAnalyzerOrgPolicy(),
];

void checkUnnamed28(core.List<api.AnalyzerOrgPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkGoogleCloudAssetV1AnalyzeOrgPolicyGovernedAssetsResponseGovernedAsset(
  api.GoogleCloudAssetV1AnalyzeOrgPolicyGovernedAssetsResponseGovernedAsset o,
) {
  buildCounterGoogleCloudAssetV1AnalyzeOrgPolicyGovernedAssetsResponseGovernedAsset++;
  if (buildCounterGoogleCloudAssetV1AnalyzeOrgPolicyGovernedAssetsResponseGovernedAsset <
      3) {
...
core.List<api.EffectiveTagDetails> buildUnnamed30() => [
  buildEffectiveTagDetails(),
  buildEffectiveTagDetails(),
];

void checkUnnamed30(core.List<api.EffectiveTagDetails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildGoogleCloudAssetV1AnalyzeOrgPolicyGovernedAssetsResponseGovernedResource() {
  ...
  if (buildCounterGoogleCloudAssetV1AnalyzeOrgPolicyGovernedAssetsResponseGovernedResource <
      3) {
    o.assetType = 'foo';
    o.effectiveTags = buildUnnamed30();
...
checkGoogleCloudAssetV1AnalyzeOrgPolicyGovernedAssetsResponseGovernedResource(
  ...
  if (buildCounterGoogleCloudAssetV1AnalyzeOrgPolicyGovernedAssetsResponseGovernedResource <
      3) {
    unittest.expect(o.assetType!, unittest.equals('foo'));
    checkUnnamed30(o.effectiveTags!);
...
core.List<api.EffectiveTagDetails> buildUnnamed34() => [
  buildEffectiveTagDetails(),
  buildEffectiveTagDetails(),
];

void checkUnnamed34(core.List<api.EffectiveTagDetails> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEffectiveTagDetails(o[0]);
  checkEffectiveTagDetails(o[1]);
}
...
core.List<api.AnalyzerOrgPolicy> buildUnnamed36() => [
  buildAnalyzerOrgPolicy(),
  buildAnalyzerOrgPolicy(),
];

void checkUnnamed36(core.List<api.AnalyzerOrgPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAnalyzerOrgPolicy(o[0]);
  checkAnalyzerOrgPolicy(o[1]);
}
...
buildGoogleCloudAssetV1GovernedContainer() {
  ...
  if (buildCounterGoogleCloudAssetV1GovernedContainer < 3) {
    o.consolidatedPolicy = buildAnalyzerOrgPolicy();
    o.effectiveTags = buildUnnamed34();
    o.folders = buildUnnamed35();
    o.fullResourceName = 'foo';
    o.organization = 'foo';
    o.parent = 'foo';
    o.policyBundle = buildUnnamed36();
    o.project = 'foo';
  }
  buildCounterGoogleCloudAssetV1GovernedContainer--;
  return o;
...
void checkGoogleCloudAssetV1GovernedContainer(
  ...
  if (buildCounterGoogleCloudAssetV1GovernedContainer < 3) {
    checkAnalyzerOrgPolicy(o.consolidatedPolicy!);
    checkUnnamed34(o.effectiveTags!);
    checkUnnamed35(o.folders!);
    unittest.expect(o.fullResourceName!, unittest.equals('foo'));
    unittest.expect(o.organization!, unittest.equals('foo'));
    unittest.expect(o.parent!, unittest.equals('foo'));
    checkUnnamed36(o.policyBundle!);
    unittest.expect(o.project!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudAssetV1GovernedContainer--;
}
...
core.List<api.GoogleCloudAssetV1Edge> buildUnnamed37() => [
  buildGoogleCloudAssetV1Edge(),
  buildGoogleCloudAssetV1Edge(),
];

void checkUnnamed37(core.List<api.GoogleCloudAssetV1Edge> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudAssetV1Edge(o[0]);
  checkGoogleCloudAssetV1Edge(o[1]);
}

core.List<api.GoogleCloudAssetV1Identity> buildUnnamed38() => [
  buildGoogleCloudAssetV1Identity(),
  buildGoogleCloudAssetV1Identity(),
];

void checkUnnamed38(core.List<api.GoogleCloudAssetV1Identity> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleCloudAssetV1IdentityList buildGoogleCloudAssetV1IdentityList() {
  ...
  if (buildCounterGoogleCloudAssetV1IdentityList < 3) {
    o.groupEdges = buildUnnamed37();
    o.identities = buildUnnamed38();
  }
  buildCounterGoogleCloudAssetV1IdentityList--;
  return o;
}
...
void checkGoogleCloudAssetV1IdentityList(api.GoogleCloudAssetV1IdentityList o) {
  buildCounterGoogleCloudAssetV1IdentityList++;
  if (buildCounterGoogleCloudAssetV1IdentityList < 3) {
    checkUnnamed37(o.groupEdges!);
    checkUnnamed38(o.identities!);
  }
  buildCounterGoogleCloudAssetV1IdentityList--;
}
...
core.int
buildCounterGoogleCloudAssetV1QueryAssetsOutputConfigBigQueryDestination = 0;
...
api.GoogleCloudAssetV1StringValues buildGoogleCloudAssetV1StringValues() {
  ...
  if (buildCounterGoogleCloudAssetV1StringValues < 3) {
    o.allowedValues = buildUnnamed39();
    o.deniedValues = buildUnnamed40();
  }
  buildCounterGoogleCloudAssetV1StringValues--;
  return o;
}
...
void checkGoogleCloudAssetV1StringValues(api.GoogleCloudAssetV1StringValues o) {
  buildCounterGoogleCloudAssetV1StringValues++;
  if (buildCounterGoogleCloudAssetV1StringValues < 3) {
    checkUnnamed39(o.allowedValues!);
    checkUnnamed40(o.deniedValues!);
  }
  buildCounterGoogleCloudAssetV1StringValues--;
}
...
api.GoogleCloudOrgpolicyV1ListPolicy buildGoogleCloudOrgpolicyV1ListPolicy() {
  ...
  if (buildCounterGoogleCloudOrgpolicyV1ListPolicy < 3) {
    o.allValues = 'foo';
    o.allowedValues = buildUnnamed41();
    o.deniedValues = buildUnnamed42();
    o.inheritFromParent = true;
...
void checkGoogleCloudOrgpolicyV1ListPolicy(
  ...
  if (buildCounterGoogleCloudOrgpolicyV1ListPolicy < 3) {
    ...
    checkUnnamed41(o.allowedValues!);
    checkUnnamed42(o.deniedValues!);
    unittest.expect(o.inheritFromParent!, unittest.isTrue);
...
core.int buildCounterGoogleIdentityAccesscontextmanagerV1AddRequestHeader = 0;
api.GoogleIdentityAccesscontextmanagerV1AddRequestHeader
buildGoogleIdentityAccesscontextmanagerV1AddRequestHeader() {
  final o = api.GoogleIdentityAccesscontextmanagerV1AddRequestHeader();
  buildCounterGoogleIdentityAccesscontextmanagerV1AddRequestHeader++;
  if (buildCounterGoogleIdentityAccesscontextmanagerV1AddRequestHeader < 3) {
    o.key = 'foo';
    o.value = 'foo';
  }
  buildCounterGoogleIdentityAccesscontextmanagerV1AddRequestHeader--;
...
void checkGoogleIdentityAccesscontextmanagerV1AddRequestHeader(
  api.GoogleIdentityAccesscontextmanagerV1AddRequestHeader o,
) {
  buildCounterGoogleIdentityAccesscontextmanagerV1AddRequestHeader++;
  if (buildCounterGoogleIdentityAccesscontextmanagerV1AddRequestHeader < 3) {
...
buildGoogleIdentityAccesscontextmanagerV1ApiOperation() {
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1ApiOperation < 3) {
    o.methodSelectors = buildUnnamed44();
    o.serviceName = 'foo';
  }
  buildCounterGoogleIdentityAccesscontextmanagerV1ApiOperation--;
  return o;
...
void checkGoogleIdentityAccesscontextmanagerV1ApiOperation(
  ...
  buildCounterGoogleIdentityAccesscontextmanagerV1ApiOperation++;
  if (buildCounterGoogleIdentityAccesscontextmanagerV1ApiOperation < 3) {
    checkUnnamed44(o.methodSelectors!);
    unittest.expect(o.serviceName!, unittest.equals('foo'));
  }
  buildCounterGoogleIdentityAccesscontextmanagerV1ApiOperation--;
}

core.List<api.GoogleIdentityAccesscontextmanagerV1Condition> buildUnnamed45() =>
    [
...
buildGoogleIdentityAccesscontextmanagerV1Condition() {
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1Condition < 3) {
    ...
    o.ipSubnetworks = buildUnnamed46();
    o.members = buildUnnamed47();
    o.negate = true;
    o.regions = buildUnnamed48();
    o.requiredAccessLevels = buildUnnamed49();
    o.vpcNetworkSources = buildUnnamed50();
  }
  buildCounterGoogleIdentityAccesscontextmanagerV1Condition--;
  return o;
}
...
void checkGoogleIdentityAccesscontextmanagerV1Condition(
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1Condition < 3) {
    ...
    checkUnnamed46(o.ipSubnetworks!);
    checkUnnamed47(o.members!);
    unittest.expect(o.negate!, unittest.isTrue);
    checkUnnamed48(o.regions!);
    checkUnnamed49(o.requiredAccessLevels!);
    checkUnnamed50(o.vpcNetworkSources!);
  }
  buildCounterGoogleIdentityAccesscontextmanagerV1Condition--;
}
...
buildGoogleIdentityAccesscontextmanagerV1DevicePolicy() {
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1DevicePolicy < 3) {
    o.allowedDeviceManagementLevels = buildUnnamed51();
    o.allowedEncryptionStatuses = buildUnnamed52();
    o.osConstraints = buildUnnamed53();
...
void checkGoogleIdentityAccesscontextmanagerV1DevicePolicy(
  ...
  buildCounterGoogleIdentityAccesscontextmanagerV1DevicePolicy++;
  if (buildCounterGoogleIdentityAccesscontextmanagerV1DevicePolicy < 3) {
    checkUnnamed51(o.allowedDeviceManagementLevels!);
    checkUnnamed52(o.allowedEncryptionStatuses!);
    checkUnnamed53(o.osConstraints!);
...
buildGoogleIdentityAccesscontextmanagerV1EgressFrom() {
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1EgressFrom < 3) {
    o.identities = buildUnnamed54();
    o.identityType = 'foo';
    o.sourceRestriction = 'foo';
    o.sources = buildUnnamed55();
  }
  buildCounterGoogleIdentityAccesscontextmanagerV1EgressFrom--;
  return o;
}
...
buildGoogleIdentityAccesscontextmanagerV1EgressSource() {
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1EgressSource < 3) {
    o.accessLevel = 'foo';
    o.pscEndpoint =
        buildGoogleIdentityAccesscontextmanagerV1PrivateServiceConnectEndpoint();
    o.resource = 'foo';
  }
  buildCounterGoogleIdentityAccesscontextmanagerV1EgressSource--;
  return o;
...
void checkGoogleIdentityAccesscontextmanagerV1EgressSource(
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1EgressSource < 3) {
    ...
    checkGoogleIdentityAccesscontextmanagerV1PrivateServiceConnectEndpoint(
      o.pscEndpoint!,
    );
...
buildGoogleIdentityAccesscontextmanagerV1EgressTo() {
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1EgressTo < 3) {
    o.externalResources = buildUnnamed56();
...
void checkGoogleIdentityAccesscontextmanagerV1EgressTo(
  ...
  buildCounterGoogleIdentityAccesscontextmanagerV1EgressTo++;
  if (buildCounterGoogleIdentityAccesscontextmanagerV1EgressTo < 3) {
    checkUnnamed56(o.externalResources!);
...
core.int buildCounterGoogleIdentityAccesscontextmanagerV1Modifier = 0;
api.GoogleIdentityAccesscontextmanagerV1Modifier
buildGoogleIdentityAccesscontextmanagerV1Modifier() {
  final o = api.GoogleIdentityAccesscontextmanagerV1Modifier();
  buildCounterGoogleIdentityAccesscontextmanagerV1Modifier++;
  if (buildCounterGoogleIdentityAccesscontextmanagerV1Modifier < 3) {
    o.addRequestHeader =
        buildGoogleIdentityAccesscontextmanagerV1AddRequestHeader();
  }
  buildCounterGoogleIdentityAccesscontextmanagerV1Modifier--;
...
void checkGoogleIdentityAccesscontextmanagerV1Modifier(
  api.GoogleIdentityAccesscontextmanagerV1Modifier o,
) {
  buildCounterGoogleIdentityAccesscontextmanagerV1Modifier++;
  if (buildCounterGoogleIdentityAccesscontextmanagerV1Modifier < 3) {
    checkGoogleIdentityAccesscontextmanagerV1AddRequestHeader(
      o.addRequestHeader!,
    );
  }
  buildCounterGoogleIdentityAccesscontextmanagerV1Modifier--;
...
core.int
buildCounterGoogleIdentityAccesscontextmanagerV1PrivateServiceConnectEndpoint =
    0;
api.GoogleIdentityAccesscontextmanagerV1PrivateServiceConnectEndpoint
buildGoogleIdentityAccesscontextmanagerV1PrivateServiceConnectEndpoint() {
  final o =
      api.GoogleIdentityAccesscontextmanagerV1PrivateServiceConnectEndpoint();
  buildCounterGoogleIdentityAccesscontextmanagerV1PrivateServiceConnectEndpoint++;
  if (buildCounterGoogleIdentityAccesscontextmanagerV1PrivateServiceConnectEndpoint <
      3) {
...
void checkGoogleIdentityAccesscontextmanagerV1PrivateServiceConnectEndpoint(
  api.GoogleIdentityAccesscontextmanagerV1PrivateServiceConnectEndpoint o,
) {
  buildCounterGoogleIdentityAccesscontextmanagerV1PrivateServiceConnectEndpoint++;
  if (buildCounterGoogleIdentityAccesscontextmanagerV1PrivateServiceConnectEndpoint <
      3) {
...
core.List<api.GoogleIdentityAccesscontextmanagerV1Modifier> buildUnnamed65() =>
    [
      buildGoogleIdentityAccesscontextmanagerV1Modifier(),
      buildGoogleIdentityAccesscontextmanagerV1Modifier(),
    ];
...
void checkUnnamed65(
  core.List<api.GoogleIdentityAccesscontextmanagerV1Modifier> o,
) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleIdentityAccesscontextmanagerV1Modifier(o[0]);
  checkGoogleIdentityAccesscontextmanagerV1Modifier(o[1]);
}

core.int buildCounterGoogleIdentityAccesscontextmanagerV1ServicePattern = 0;
api.GoogleIdentityAccesscontextmanagerV1ServicePattern
buildGoogleIdentityAccesscontextmanagerV1ServicePattern() {
  final o = api.GoogleIdentityAccesscontextmanagerV1ServicePattern();
  buildCounterGoogleIdentityAccesscontextmanagerV1ServicePattern++;
  if (buildCounterGoogleIdentityAccesscontextmanagerV1ServicePattern < 3) {
    o.modifiers = buildUnnamed65();
    o.pattern = 'foo';
    o.service = 'foo';
  }
  buildCounterGoogleIdentityAccesscontextmanagerV1ServicePattern--;
...
void checkGoogleIdentityAccesscontextmanagerV1ServicePattern(
  api.GoogleIdentityAccesscontextmanagerV1ServicePattern o,
) {
  buildCounterGoogleIdentityAccesscontextmanagerV1ServicePattern++;
  if (buildCounterGoogleIdentityAccesscontextmanagerV1ServicePattern < 3) {
    checkUnnamed65(o.modifiers!);
...
buildGoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig() {
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig <
      3) {
    o.accessLevels = buildUnnamed66();
    o.egressPolicies = buildUnnamed67();
    o.ingressPolicies = buildUnnamed68();
    o.resources = buildUnnamed69();
    o.restrictedServices = buildUnnamed70();
...
void checkGoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig(
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig <
      3) {
    checkUnnamed66(o.accessLevels!);
    checkUnnamed67(o.egressPolicies!);
    checkUnnamed68(o.ingressPolicies!);
    checkUnnamed69(o.resources!);
    checkUnnamed70(o.restrictedServices!);
...
core.List<api.GoogleIdentityAccesscontextmanagerV1ServicePattern>
buildUnnamed71() => [
  buildGoogleIdentityAccesscontextmanagerV1ServicePattern(),
  buildGoogleIdentityAccesscontextmanagerV1ServicePattern(),
];
...
void checkUnnamed71(
  core.List<api.GoogleIdentityAccesscontextmanagerV1ServicePattern> o,
) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleIdentityAccesscontextmanagerV1ServicePattern(o[0]);
  checkGoogleIdentityAccesscontextmanagerV1ServicePattern(o[1]);
}
...
buildGoogleIdentityAccesscontextmanagerV1VpcAccessibleServices() {
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1VpcAccessibleServices <
      3) {
    o.allowedServicePatterns = buildUnnamed71();
    o.allowedServices = buildUnnamed72();
    o.enableRestriction = true;
    o.servicePatternsEnforcementScopes = buildUnnamed73();
  }
  buildCounterGoogleIdentityAccesscontextmanagerV1VpcAccessibleServices--;
  return o;
}
...
void checkGoogleIdentityAccesscontextmanagerV1VpcAccessibleServices(
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1VpcAccessibleServices <
      3) {
    checkUnnamed71(o.allowedServicePatterns!);
    checkUnnamed72(o.allowedServices!);
    unittest.expect(o.enableRestriction!, unittest.isTrue);
    checkUnnamed73(o.servicePatternsEnforcementScopes!);
  }
  buildCounterGoogleIdentityAccesscontextmanagerV1VpcAccessibleServices--;
}
...
buildGoogleIdentityAccesscontextmanagerV1VpcSubNetwork() {
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1VpcSubNetwork < 3) {
    o.network = 'foo';
    o.vpcIpSubnetworks = buildUnnamed74();
  }
  buildCounterGoogleIdentityAccesscontextmanagerV1VpcSubNetwork--;
  return o;
}
...
void checkGoogleIdentityAccesscontextmanagerV1VpcSubNetwork(
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1VpcSubNetwork < 3) {
    ...
    checkUnnamed74(o.vpcIpSubnetworks!);
  }
  buildCounterGoogleIdentityAccesscontextmanagerV1VpcSubNetwork--;
}

core.List<api.IamPolicyAnalysisResult> buildUnnamed75() => [
  buildIamPolicyAnalysisResult(),
  buildIamPolicyAnalysisResult(),
];

void checkUnnamed75(core.List<api.IamPolicyAnalysisResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIamPolicyAnalysisResult(o[0]);
  checkIamPolicyAnalysisResult(o[1]);
}

core.List<api.IamPolicyAnalysisState> buildUnnamed76() => [
  buildIamPolicyAnalysisState(),
  buildIamPolicyAnalysisState(),
];

void checkUnnamed76(core.List<api.IamPolicyAnalysisState> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.IamPolicyAnalysis buildIamPolicyAnalysis() {
  ...
  if (buildCounterIamPolicyAnalysis < 3) {
    o.analysisQuery = buildIamPolicyAnalysisQuery();
    o.analysisResults = buildUnnamed75();
    o.fullyExplored = true;
    o.nonCriticalErrors = buildUnnamed76();
  }
  buildCounterIamPolicyAnalysis--;
  return o;
}
...
void checkIamPolicyAnalysis(api.IamPolicyAnalysis o) {
  ...
  if (buildCounterIamPolicyAnalysis < 3) {
    checkIamPolicyAnalysisQuery(o.analysisQuery!);
    checkUnnamed75(o.analysisResults!);
    unittest.expect(o.fullyExplored!, unittest.isTrue);
    checkUnnamed76(o.nonCriticalErrors!);
  }
  buildCounterIamPolicyAnalysis--;
}
...
core.List<api.GoogleCloudAssetV1AccessControlList> buildUnnamed77() => [
  buildGoogleCloudAssetV1AccessControlList(),
  buildGoogleCloudAssetV1AccessControlList(),
];

void checkUnnamed77(core.List<api.GoogleCloudAssetV1AccessControlList> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.IamPolicyAnalysisResult buildIamPolicyAnalysisResult() {
  ...
  if (buildCounterIamPolicyAnalysisResult < 3) {
    o.accessControlLists = buildUnnamed77();
...
void checkIamPolicyAnalysisResult(api.IamPolicyAnalysisResult o) {
  buildCounterIamPolicyAnalysisResult++;
  if (buildCounterIamPolicyAnalysisResult < 3) {
    checkUnnamed77(o.accessControlLists!);
...
core.Map<core.String, api.Item> buildUnnamed79() => {
  'x': buildItem(),
  'y': buildItem(),
};

void checkUnnamed79(core.Map<core.String, api.Item> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkItem(o['x']!);
  checkItem(o['y']!);
}
...
core.List<api.Asset> buildUnnamed80() => [buildAsset(), buildAsset()];

void checkUnnamed80(core.List<api.Asset> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAsset(o[0]);
  checkAsset(o[1]);
}
...
core.List<api.Feed> buildUnnamed81() => [buildFeed(), buildFeed()];

void checkUnnamed81(core.List<api.Feed> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFeed(o[0]);
  checkFeed(o[1]);
}
...
void checkListFeedsResponse(api.ListFeedsResponse o) {
  buildCounterListFeedsResponse++;
  if (buildCounterListFeedsResponse < 3) {
    checkUnnamed81(o.feeds!);
  }
  buildCounterListFeedsResponse--;
}

core.List<api.SavedQuery> buildUnnamed82() => [
  buildSavedQuery(),
  buildSavedQuery(),
];

void checkUnnamed82(core.List<api.SavedQuery> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSavedQuery(o[0]);
  checkSavedQuery(o[1]);
}
...
core.List<api.MoveImpact> buildUnnamed83() => [
  buildMoveImpact(),
  buildMoveImpact(),
];

void checkUnnamed83(core.List<api.MoveImpact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMoveImpact(o[0]);
  checkMoveImpact(o[1]);
}

core.List<api.MoveImpact> buildUnnamed84() => [
  buildMoveImpact(),
  buildMoveImpact(),
];

void checkUnnamed84(core.List<api.MoveImpact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMoveImpact(o[0]);
  checkMoveImpact(o[1]);
}
...
api.MoveAnalysisResult buildMoveAnalysisResult() {
  ...
  if (buildCounterMoveAnalysisResult < 3) {
    o.blockers = buildUnnamed83();
    o.warnings = buildUnnamed84();
  }
  buildCounterMoveAnalysisResult--;
  return o;
}
...
void checkMoveAnalysisResult(api.MoveAnalysisResult o) {
  buildCounterMoveAnalysisResult++;
  if (buildCounterMoveAnalysisResult < 3) {
    checkUnnamed83(o.blockers!);
    checkUnnamed84(o.warnings!);
  }
  buildCounterMoveAnalysisResult--;
}
...
core.List<api.AnalyzerOrgPolicy> buildUnnamed88() => [
  buildAnalyzerOrgPolicy(),
  buildAnalyzerOrgPolicy(),
];

void checkUnnamed88(core.List<api.AnalyzerOrgPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAnalyzerOrgPolicy(o[0]);
  checkAnalyzerOrgPolicy(o[1]);
}
...
api.OrgPolicyResult buildOrgPolicyResult() {
  ...
  if (buildCounterOrgPolicyResult < 3) {
    o.consolidatedPolicy = buildAnalyzerOrgPolicy();
    o.folders = buildUnnamed87();
    o.organization = 'foo';
    o.policyBundle = buildUnnamed88();
    o.project = 'foo';
  }
  buildCounterOrgPolicyResult--;
  return o;
...
void checkOrgPolicyResult(api.OrgPolicyResult o) {
  ...
  if (buildCounterOrgPolicyResult < 3) {
    checkAnalyzerOrgPolicy(o.consolidatedPolicy!);
    checkUnnamed87(o.folders!);
    unittest.expect(o.organization!, unittest.equals('foo'));
    checkUnnamed88(o.policyBundle!);
    unittest.expect(o.project!, unittest.equals('foo'));
  }
  buildCounterOrgPolicyResult--;
}
...
void checkQueryAssetsRequest(api.QueryAssetsRequest o) {
  buildCounterQueryAssetsRequest++;
  if (buildCounterQueryAssetsRequest < 3) {
    unittest.expect(o.jobReference!, unittest.equals('foo'));
    checkQueryAssetsOutputConfig(o.outputConfig!);
    unittest.expect(o.pageSize!, unittest.equals(42));
    unittest.expect(o.pageToken!, unittest.equals('foo'));
    unittest.expect(o.readTime!, unittest.equals('foo'));
    checkTimeWindow(o.readTimeWindow!);
    unittest.expect(o.statement!, unittest.equals('foo'));
...
core.List<api.RelatedAsset> buildUnnamed95() => [
  buildRelatedAsset(),
  buildRelatedAsset(),
];

void checkUnnamed95(core.List<api.RelatedAsset> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.RelatedResource> buildUnnamed96() => [
  buildRelatedResource(),
  buildRelatedResource(),
];

void checkUnnamed96(core.List<api.RelatedResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.RelatedResources buildRelatedResources() {
  ...
  if (buildCounterRelatedResources < 3) {
    o.relatedResources = buildUnnamed96();
  }
  buildCounterRelatedResources--;
  return o;
}
...
void checkRelatedResources(api.RelatedResources o) {
  buildCounterRelatedResources++;
  if (buildCounterRelatedResources < 3) {
    checkUnnamed96(o.relatedResources!);
  }
  buildCounterRelatedResources--;
}
...
void checkRelationshipAttributes(api.RelationshipAttributes o) {
  ...
  if (buildCounterRelationshipAttributes < 3) {
    ...
    unittest.expect(o.sourceResourceType!, unittest.equals('foo'));
...
core.int buildCounterResourceOwners = 0;
api.ResourceOwners buildResourceOwners() {
  final o = api.ResourceOwners();
  buildCounterResourceOwners++;
  if (buildCounterResourceOwners < 3) {
    o.resourceOwners = buildUnnamed98();
  }
  buildCounterResourceOwners--;
  return o;
}

void checkResourceOwners(api.ResourceOwners o) {
  buildCounterResourceOwners++;
  if (buildCounterResourceOwners < 3) {
    checkUnnamed98(o.resourceOwners!);
  }
  buildCounterResourceOwners--;
}
...
core.List<api.AttachedResource> buildUnnamed100() => [
  buildAttachedResource(),
  buildAttachedResource(),
];

void checkUnnamed100(core.List<api.AttachedResource> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachedResource(o[0]);
  checkAttachedResource(o[1]);
}

core.List<api.EffectiveTagDetails> buildUnnamed101() => [
  buildEffectiveTagDetails(),
  buildEffectiveTagDetails(),
];

void checkUnnamed101(core.List<api.EffectiveTagDetails> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEffectiveTagDetails(o[0]);
  checkEffectiveTagDetails(o[1]);
}

core.List<api.AssetEnrichment> buildUnnamed102() => [
  buildAssetEnrichment(),
  buildAssetEnrichment(),
];

void checkUnnamed102(core.List<api.AssetEnrichment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAssetEnrichment(o[0]);
  checkAssetEnrichment(o[1]);
}
...
core.Map<core.String, api.RelatedResources> buildUnnamed107() => {
  'x': buildRelatedResources(),
  'y': buildRelatedResources(),
};

void checkUnnamed107(core.Map<core.String, api.RelatedResources> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Tag> buildUnnamed112() => [buildTag(), buildTag()];

void checkUnnamed112(core.List<api.Tag> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTag(o[0]);
  checkTag(o[1]);
}

core.List<api.VersionedResource> buildUnnamed113() => [
  buildVersionedResource(),
  buildVersionedResource(),
];

void checkUnnamed113(core.List<api.VersionedResource> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVersionedResource(o[0]);
  checkVersionedResource(o[1]);
}
...
api.ResourceSearchResult buildResourceSearchResult() {
  ...
  if (buildCounterResourceSearchResult < 3) {
    o.additionalAttributes = buildUnnamed99();
    o.assetType = 'foo';
    o.attachedResources = buildUnnamed100();
    o.createTime = 'foo';
    o.description = 'foo';
    o.displayName = 'foo';
    o.effectiveTags = buildUnnamed101();
    o.enrichments = buildUnnamed102();
    o.folders = buildUnnamed103();
    o.kmsKey = 'foo';
    o.kmsKeys = buildUnnamed104();
    o.labels = buildUnnamed105();
    o.location = 'foo';
    o.name = 'foo';
    o.networkTags = buildUnnamed106();
    o.organization = 'foo';
    o.parentAssetType = 'foo';
    o.parentFullResourceName = 'foo';
    o.project = 'foo';
    o.relationships = buildUnnamed107();
    o.sccSecurityMarks = buildUnnamed108();
    o.state = 'foo';
    o.tagKeys = buildUnnamed109();
    o.tagValueIds = buildUnnamed110();
    o.tagValues = buildUnnamed111();
    o.tags = buildUnnamed112();
    o.updateTime = 'foo';
    o.versionedResources = buildUnnamed113();
  }
  buildCounterResourceSearchResult--;
  return o;
}
...
void checkResourceSearchResult(api.ResourceSearchResult o) {
  buildCounterResourceSearchResult++;
  if (buildCounterResourceSearchResult < 3) {
    checkUnnamed99(o.additionalAttributes!);
    unittest.expect(o.assetType!, unittest.equals('foo'));
    checkUnnamed100(o.attachedResources!);
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.displayName!, unittest.equals('foo'));
    checkUnnamed101(o.effectiveTags!);
    checkUnnamed102(o.enrichments!);
    checkUnnamed103(o.folders!);
    unittest.expect(o.kmsKey!, unittest.equals('foo'));
    checkUnnamed104(o.kmsKeys!);
    checkUnnamed105(o.labels!);
    unittest.expect(o.location!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed106(o.networkTags!);
    unittest.expect(o.organization!, unittest.equals('foo'));
    unittest.expect(o.parentAssetType!, unittest.equals('foo'));
    unittest.expect(o.parentFullResourceName!, unittest.equals('foo'));
    unittest.expect(o.project!, unittest.equals('foo'));
    checkUnnamed107(o.relationships!);
    checkUnnamed108(o.sccSecurityMarks!);
    unittest.expect(o.state!, unittest.equals('foo'));
    checkUnnamed109(o.tagKeys!);
    checkUnnamed110(o.tagValueIds!);
    checkUnnamed111(o.tagValues!);
    checkUnnamed112(o.tags!);
    unittest.expect(o.updateTime!, unittest.equals('foo'));
    checkUnnamed113(o.versionedResources!);
  }
  buildCounterResourceSearchResult--;
}
...
void checkSavedQuery(api.SavedQuery o) {
  ...
  if (buildCounterSavedQuery < 3) {
    ...
    unittest.expect(o.lastUpdater!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
  }
  buildCounterSavedQuery--;
}

core.List<api.IamPolicySearchResult> buildUnnamed115() => [
  buildIamPolicySearchResult(),
  buildIamPolicySearchResult(),
];

void checkUnnamed115(core.List<api.IamPolicySearchResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ResourceSearchResult> buildUnnamed116() => [
  buildResourceSearchResult(),
  buildResourceSearchResult(),
];

void checkUnnamed116(core.List<api.ResourceSearchResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkTag(api.Tag o) {
  ...
  if (buildCounterTag < 3) {
    ...
    unittest.expect(o.tagKeyId!, unittest.equals('foo'));
    unittest.expect(o.tagValue!, unittest.equals('foo'));
    unittest.expect(o.tagValueId!, unittest.equals('foo'));
  }
  buildCounterTag--;
}
...
core.List<api.AssetException> buildUnnamed121() => [
  buildAssetException(),
  buildAssetException(),
];

void checkUnnamed121(core.List<api.AssetException> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAssetException(o[0]);
  checkAssetException(o[1]);
}
...
api.VersionedResource buildVersionedResource() {
  ...
  if (buildCounterVersionedResource < 3) {
    o.assetExceptions = buildUnnamed121();
    o.resource = buildUnnamed122();
    o.version = 'foo';
  }
  buildCounterVersionedResource--;
  return o;
...
void checkVersionedResource(api.VersionedResource o) {
  buildCounterVersionedResource++;
  if (buildCounterVersionedResource < 3) {
    checkUnnamed121(o.assetExceptions!);
    checkUnnamed122(o.resource!);
    unittest.expect(o.version!, unittest.equals('foo'));
  }
  buildCounterVersionedResource--;
}
...
core.List<api.WindowsUpdateCategory> buildUnnamed123() => [
  buildWindowsUpdateCategory(),
  buildWindowsUpdateCategory(),
];

void checkUnnamed123(core.List<api.WindowsUpdateCategory> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.WindowsUpdatePackage buildWindowsUpdatePackage() {
  ...
  if (buildCounterWindowsUpdatePackage < 3) {
    o.categories = buildUnnamed123();
    o.description = 'foo';
    o.kbArticleIds = buildUnnamed124();
    o.lastDeploymentChangeTime = 'foo';
    o.moreInfoUrls = buildUnnamed125();
    o.revisionNumber = 42;
    o.supportUrl = 'foo';
    o.title = 'foo';
    o.updateId = 'foo';
...
void checkWindowsUpdatePackage(api.WindowsUpdatePackage o) {
  buildCounterWindowsUpdatePackage++;
  if (buildCounterWindowsUpdatePackage < 3) {
    checkUnnamed123(o.categories!);
    unittest.expect(o.description!, unittest.equals('foo'));
    checkUnnamed124(o.kbArticleIds!);
    unittest.expect(o.lastDeploymentChangeTime!, unittest.equals('foo'));
    checkUnnamed125(o.moreInfoUrls!);
...
void main() {
  ...
  unittest.group('obj-schema-AssetEnrichment', () {
    unittest.test('to-json--from-json', () async {
      final o = buildAssetEnrichment();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.AssetEnrichment.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkAssetEnrichment(od);
    });
  });

  unittest.group('obj-schema-AssetException', () {
    unittest.test('to-json--from-json', () async {
      final o = buildAssetException();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.AssetException.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkAssetException(od);
    });
  });
  ...
  unittest.group(
    'obj-schema-GoogleIdentityAccesscontextmanagerV1AddRequestHeader',
    () {
      unittest.test('to-json--from-json', () async {
        final o = buildGoogleIdentityAccesscontextmanagerV1AddRequestHeader();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od =
            api.GoogleIdentityAccesscontextmanagerV1AddRequestHeader.fromJson(
              oJson as core.Map<core.String, core.dynamic>,
            );
        checkGoogleIdentityAccesscontextmanagerV1AddRequestHeader(od);
      });
    },
  );
  ...
  unittest.group('obj-schema-GoogleIdentityAccesscontextmanagerV1Modifier', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleIdentityAccesscontextmanagerV1Modifier();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleIdentityAccesscontextmanagerV1Modifier.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleIdentityAccesscontextmanagerV1Modifier(od);
    });
  });
  ...
  unittest.group(
    'obj-schema-GoogleIdentityAccesscontextmanagerV1PrivateServiceConnectEndpoint',
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleIdentityAccesscontextmanagerV1PrivateServiceConnectEndpoint();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od =
            api.GoogleIdentityAccesscontextmanagerV1PrivateServiceConnectEndpoint.fromJson(
              oJson as core.Map<core.String, core.dynamic>,
            );
        checkGoogleIdentityAccesscontextmanagerV1PrivateServiceConnectEndpoint(
          od,
  ...
  unittest.group(
    'obj-schema-GoogleIdentityAccesscontextmanagerV1ServicePattern',
    () {
      unittest.test('to-json--from-json', () async {
        final o = buildGoogleIdentityAccesscontextmanagerV1ServicePattern();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od =
            api.GoogleIdentityAccesscontextmanagerV1ServicePattern.fromJson(
              oJson as core.Map<core.String, core.dynamic>,
            );
        checkGoogleIdentityAccesscontextmanagerV1ServicePattern(od);
      });
    },
  );
  ...
  unittest.group('obj-schema-MoveImpact', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.MoveImpact.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkMoveImpact(od);
    });
  ...
  unittest.group('obj-schema-PolicyInfo', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.PolicyInfo.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPolicyInfo(od);
    });
  ...
  unittest.group('obj-schema-ResourceOwners', () {
    unittest.test('to-json--from-json', () async {
      final o = buildResourceOwners();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ResourceOwners.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkResourceOwners(od);
    });
  });
  ...
  unittest.group('resource-AssetsResource', () {
    unittest.test('method--list', () async {
      ...
      final arg_assetTypes = buildUnnamed126();
      final arg_contentType = 'foo';
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_readTime = 'foo';
      final arg_relationshipTypes = buildUnnamed127();
  ...
  unittest.group('resource-EffectiveIamPoliciesResource', () {
    unittest.test('method--batchGet', () async {
      ...
      final arg_scope = 'foo';
      final arg_names = buildUnnamed128();
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final path = req.url.path;
  ...
  unittest.group('resource-V1Resource', () {
    unittest.test('method--analyzeIamPolicy', () async {
      ...
      final arg_scope = 'foo';
      final arg_analysisQuery_accessSelector_permissions = buildUnnamed129();
      final arg_analysisQuery_accessSelector_roles = buildUnnamed130();
      ...
      final response = await res.analyzeIamPolicy(
        arg_scope,
    ...
    unittest.test('method--analyzeMove', () async {
      ...
      final response = await res.analyzeMove(
        arg_resource,
    ...
    unittest.test('method--analyzeOrgPolicies', () async {
      ...
      final response = await res.analyzeOrgPolicies(
        arg_scope,
    ...
    unittest.test('method--analyzeOrgPolicyGovernedAssets', () async {
      ...
      final response = await res.analyzeOrgPolicyGovernedAssets(
        arg_scope,
        constraint: arg_constraint,
        filter: arg_filter,
        pageSize: arg_pageSize,
    ...
    unittest.test('method--analyzeOrgPolicyGovernedContainers', () async {
      ...
      final response = await res.analyzeOrgPolicyGovernedContainers(
        arg_scope,
        constraint: arg_constraint,
        filter: arg_filter,
        pageSize: arg_pageSize,
    ...
    unittest.test('method--batchGetAssetsHistory', () async {
      ...
      final res = api.CloudAssetApi(mock).v1;
      final arg_parent = 'foo';
      final arg_assetNames = buildUnnamed131();
      final arg_contentType = 'foo';
      final arg_readTimeWindow_endTime = 'foo';
      final arg_readTimeWindow_startTime = 'foo';
      final arg_relationshipTypes = buildUnnamed132();
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final path = req.url.path;
    ...
    unittest.test('method--queryAssets', () async {
      ...
      final response = await res.queryAssets(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--searchAllIamPolicies', () async {
      ...
      final res = api.CloudAssetApi(mock).v1;
      final arg_scope = 'foo';
      final arg_assetTypes = buildUnnamed133();
      ...
      final response = await res.searchAllIamPolicies(
        arg_scope,
        assetTypes: arg_assetTypes,
        orderBy: arg_orderBy,
        pageSize: arg_pageSize,
    ...
    unittest.test('method--searchAllResources', () async {
      ...
      final res = api.CloudAssetApi(mock).v1;
      final arg_scope = 'foo';
      final arg_assetTypes = buildUnnamed134();
      final arg_orderBy = 'foo';
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_query = 'foo';
      ...
      final response = await res.searchAllResources(
        arg_scope,
        assetTypes: arg_assetTypes,
        orderBy: arg_orderBy,
        pageSize: arg_pageSize,
