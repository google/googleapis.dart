...
core.List<api.AnalyzerOrgPolicy> buildUnnamed32() => [
      buildAnalyzerOrgPolicy(),
      buildAnalyzerOrgPolicy(),
    ];

void checkUnnamed32(core.List<api.AnalyzerOrgPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAnalyzerOrgPolicy(o[0]);
  checkAnalyzerOrgPolicy(o[1]);
}
...
core.List<api.GoogleCloudAssetV1Edge> buildUnnamed33() => [
      buildGoogleCloudAssetV1Edge(),
      buildGoogleCloudAssetV1Edge(),
    ];

void checkUnnamed33(core.List<api.GoogleCloudAssetV1Edge> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudAssetV1Edge(o[0]);
  checkGoogleCloudAssetV1Edge(o[1]);
}

core.List<api.GoogleCloudAssetV1Identity> buildUnnamed34() => [
      buildGoogleCloudAssetV1Identity(),
      buildGoogleCloudAssetV1Identity(),
    ];

void checkUnnamed34(core.List<api.GoogleCloudAssetV1Identity> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleCloudAssetV1StringValues buildGoogleCloudAssetV1StringValues() {
  ...
  if (buildCounterGoogleCloudAssetV1StringValues < 3) {
    o.allowedValues = buildUnnamed35();
    o.deniedValues = buildUnnamed36();
  }
  buildCounterGoogleCloudAssetV1StringValues--;
  return o;
}
...
void checkGoogleCloudAssetV1StringValues(api.GoogleCloudAssetV1StringValues o) {
  buildCounterGoogleCloudAssetV1StringValues++;
  if (buildCounterGoogleCloudAssetV1StringValues < 3) {
    checkUnnamed35(o.allowedValues!);
    checkUnnamed36(o.deniedValues!);
  }
  buildCounterGoogleCloudAssetV1StringValues--;
}
...
api.GoogleCloudOrgpolicyV1ListPolicy buildGoogleCloudOrgpolicyV1ListPolicy() {
  ...
  if (buildCounterGoogleCloudOrgpolicyV1ListPolicy < 3) {
    o.allValues = 'foo';
    o.allowedValues = buildUnnamed37();
    o.deniedValues = buildUnnamed38();
    o.inheritFromParent = true;
...
void checkGoogleCloudOrgpolicyV1ListPolicy(
  ...
  if (buildCounterGoogleCloudOrgpolicyV1ListPolicy < 3) {
    ...
    checkUnnamed37(o.allowedValues!);
    checkUnnamed38(o.deniedValues!);
    unittest.expect(o.inheritFromParent!, unittest.isTrue);
    unittest.expect(
      o.suggestedValue!,
      unittest.equals('foo'),
...
api.GoogleIdentityAccesscontextmanagerV1ApiOperation
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1ApiOperation < 3) {
    o.methodSelectors = buildUnnamed40();
    o.serviceName = 'foo';
  }
  buildCounterGoogleIdentityAccesscontextmanagerV1ApiOperation--;
  return o;
...
void checkGoogleIdentityAccesscontextmanagerV1ApiOperation(
  ...
  buildCounterGoogleIdentityAccesscontextmanagerV1ApiOperation++;
  if (buildCounterGoogleIdentityAccesscontextmanagerV1ApiOperation < 3) {
    checkUnnamed40(o.methodSelectors!);
    unittest.expect(
      o.serviceName!,
      unittest.equals('foo'),
    );
...
core.List<api.GoogleIdentityAccesscontextmanagerV1Condition> buildUnnamed41() =>
    [
...
api.GoogleIdentityAccesscontextmanagerV1Condition
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1Condition < 3) {
    ...
    o.ipSubnetworks = buildUnnamed42();
    o.members = buildUnnamed43();
    o.negate = true;
    o.regions = buildUnnamed44();
    o.requiredAccessLevels = buildUnnamed45();
    o.vpcNetworkSources = buildUnnamed46();
  }
  buildCounterGoogleIdentityAccesscontextmanagerV1Condition--;
  return o;
}
...
void checkGoogleIdentityAccesscontextmanagerV1Condition(
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1Condition < 3) {
    ...
    checkUnnamed42(o.ipSubnetworks!);
    checkUnnamed43(o.members!);
    unittest.expect(o.negate!, unittest.isTrue);
    checkUnnamed44(o.regions!);
    checkUnnamed45(o.requiredAccessLevels!);
    checkUnnamed46(o.vpcNetworkSources!);
  }
  buildCounterGoogleIdentityAccesscontextmanagerV1Condition--;
}
...
api.GoogleIdentityAccesscontextmanagerV1DevicePolicy
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1DevicePolicy < 3) {
    o.allowedDeviceManagementLevels = buildUnnamed47();
    o.allowedEncryptionStatuses = buildUnnamed48();
    o.osConstraints = buildUnnamed49();
...
void checkGoogleIdentityAccesscontextmanagerV1DevicePolicy(
  ...
  buildCounterGoogleIdentityAccesscontextmanagerV1DevicePolicy++;
  if (buildCounterGoogleIdentityAccesscontextmanagerV1DevicePolicy < 3) {
    checkUnnamed47(o.allowedDeviceManagementLevels!);
    checkUnnamed48(o.allowedEncryptionStatuses!);
    checkUnnamed49(o.osConstraints!);
...
api.GoogleIdentityAccesscontextmanagerV1EgressTo
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1EgressTo < 3) {
    o.externalResources = buildUnnamed52();
...
void checkGoogleIdentityAccesscontextmanagerV1EgressTo(
  ...
  buildCounterGoogleIdentityAccesscontextmanagerV1EgressTo++;
  if (buildCounterGoogleIdentityAccesscontextmanagerV1EgressTo < 3) {
    checkUnnamed52(o.externalResources!);
...
api.GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig <
      3) {
    o.accessLevels = buildUnnamed59();
    o.egressPolicies = buildUnnamed60();
    o.ingressPolicies = buildUnnamed61();
    o.resources = buildUnnamed62();
    o.restrictedServices = buildUnnamed63();
...
void checkGoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig(
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig <
      3) {
    checkUnnamed59(o.accessLevels!);
    checkUnnamed60(o.egressPolicies!);
    checkUnnamed61(o.ingressPolicies!);
    checkUnnamed62(o.resources!);
    checkUnnamed63(o.restrictedServices!);
...
api.GoogleIdentityAccesscontextmanagerV1VpcAccessibleServices
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1VpcAccessibleServices <
      3) {
    o.allowedServices = buildUnnamed64();
...
void checkGoogleIdentityAccesscontextmanagerV1VpcAccessibleServices(
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1VpcAccessibleServices <
      3) {
    checkUnnamed64(o.allowedServices!);
...
api.GoogleIdentityAccesscontextmanagerV1VpcSubNetwork
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1VpcSubNetwork < 3) {
    o.network = 'foo';
    o.vpcIpSubnetworks = buildUnnamed65();
  }
  buildCounterGoogleIdentityAccesscontextmanagerV1VpcSubNetwork--;
  return o;
}
...
void checkGoogleIdentityAccesscontextmanagerV1VpcSubNetwork(
  ...
  if (buildCounterGoogleIdentityAccesscontextmanagerV1VpcSubNetwork < 3) {
    ...
    checkUnnamed65(o.vpcIpSubnetworks!);
  }
  buildCounterGoogleIdentityAccesscontextmanagerV1VpcSubNetwork--;
}

core.List<api.IamPolicyAnalysisResult> buildUnnamed66() => [
      buildIamPolicyAnalysisResult(),
      buildIamPolicyAnalysisResult(),
    ];

void checkUnnamed66(core.List<api.IamPolicyAnalysisResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIamPolicyAnalysisResult(o[0]);
  checkIamPolicyAnalysisResult(o[1]);
}

core.List<api.IamPolicyAnalysisState> buildUnnamed67() => [
      buildIamPolicyAnalysisState(),
      buildIamPolicyAnalysisState(),
    ];

void checkUnnamed67(core.List<api.IamPolicyAnalysisState> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.IamPolicyAnalysis buildIamPolicyAnalysis() {
  ...
  if (buildCounterIamPolicyAnalysis < 3) {
    o.analysisQuery = buildIamPolicyAnalysisQuery();
    o.analysisResults = buildUnnamed66();
    o.fullyExplored = true;
    o.nonCriticalErrors = buildUnnamed67();
  }
  buildCounterIamPolicyAnalysis--;
  return o;
}
...
void checkIamPolicyAnalysis(api.IamPolicyAnalysis o) {
  ...
  if (buildCounterIamPolicyAnalysis < 3) {
    checkIamPolicyAnalysisQuery(o.analysisQuery!);
    checkUnnamed66(o.analysisResults!);
    unittest.expect(o.fullyExplored!, unittest.isTrue);
    checkUnnamed67(o.nonCriticalErrors!);
  }
  buildCounterIamPolicyAnalysis--;
}
...
core.List<api.GoogleCloudAssetV1AccessControlList> buildUnnamed68() => [
      buildGoogleCloudAssetV1AccessControlList(),
      buildGoogleCloudAssetV1AccessControlList(),
    ];

void checkUnnamed68(core.List<api.GoogleCloudAssetV1AccessControlList> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.IamPolicyAnalysisResult buildIamPolicyAnalysisResult() {
  ...
  if (buildCounterIamPolicyAnalysisResult < 3) {
    o.accessControlLists = buildUnnamed68();
...
void checkIamPolicyAnalysisResult(api.IamPolicyAnalysisResult o) {
  buildCounterIamPolicyAnalysisResult++;
  if (buildCounterIamPolicyAnalysisResult < 3) {
    checkUnnamed68(o.accessControlLists!);
    unittest.expect(
...
core.Map<core.String, api.Item> buildUnnamed70() => {
      'x': buildItem(),
      'y': buildItem(),
    };

void checkUnnamed70(core.Map<core.String, api.Item> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkItem(o['x']!);
  checkItem(o['y']!);
}
...
core.List<api.Asset> buildUnnamed71() => [
      buildAsset(),
      buildAsset(),
    ];

void checkUnnamed71(core.List<api.Asset> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAsset(o[0]);
  checkAsset(o[1]);
}
...
core.List<api.Feed> buildUnnamed72() => [
      buildFeed(),
      buildFeed(),
    ];

void checkUnnamed72(core.List<api.Feed> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFeed(o[0]);
  checkFeed(o[1]);
}
...
void checkListFeedsResponse(api.ListFeedsResponse o) {
  buildCounterListFeedsResponse++;
  if (buildCounterListFeedsResponse < 3) {
    checkUnnamed72(o.feeds!);
  }
  buildCounterListFeedsResponse--;
}

core.List<api.SavedQuery> buildUnnamed73() => [
      buildSavedQuery(),
      buildSavedQuery(),
    ];

void checkUnnamed73(core.List<api.SavedQuery> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSavedQuery(o[0]);
  checkSavedQuery(o[1]);
}
...
core.List<api.MoveImpact> buildUnnamed74() => [
      buildMoveImpact(),
      buildMoveImpact(),
    ];

void checkUnnamed74(core.List<api.MoveImpact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMoveImpact(o[0]);
  checkMoveImpact(o[1]);
}

core.List<api.MoveImpact> buildUnnamed75() => [
      buildMoveImpact(),
      buildMoveImpact(),
    ];

void checkUnnamed75(core.List<api.MoveImpact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMoveImpact(o[0]);
  checkMoveImpact(o[1]);
}
...
api.MoveAnalysisResult buildMoveAnalysisResult() {
  ...
  if (buildCounterMoveAnalysisResult < 3) {
    o.blockers = buildUnnamed74();
    o.warnings = buildUnnamed75();
  }
  buildCounterMoveAnalysisResult--;
  return o;
}
...
void checkMoveAnalysisResult(api.MoveAnalysisResult o) {
  buildCounterMoveAnalysisResult++;
  if (buildCounterMoveAnalysisResult < 3) {
    checkUnnamed74(o.blockers!);
    checkUnnamed75(o.warnings!);
  }
  buildCounterMoveAnalysisResult--;
}
...
core.List<api.AnalyzerOrgPolicy> buildUnnamed78() => [
      buildAnalyzerOrgPolicy(),
      buildAnalyzerOrgPolicy(),
    ];

void checkUnnamed78(core.List<api.AnalyzerOrgPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAnalyzerOrgPolicy(o[0]);
  checkAnalyzerOrgPolicy(o[1]);
}
...
core.List<api.RelatedAsset> buildUnnamed85() => [
      buildRelatedAsset(),
      buildRelatedAsset(),
    ];

void checkUnnamed85(core.List<api.RelatedAsset> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.RelatedResource> buildUnnamed86() => [
      buildRelatedResource(),
      buildRelatedResource(),
    ];

void checkUnnamed86(core.List<api.RelatedResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.RelatedResources buildRelatedResources() {
  ...
  if (buildCounterRelatedResources < 3) {
    o.relatedResources = buildUnnamed86();
  }
  buildCounterRelatedResources--;
  return o;
}
...
void checkRelatedResources(api.RelatedResources o) {
  buildCounterRelatedResources++;
  if (buildCounterRelatedResources < 3) {
    checkUnnamed86(o.relatedResources!);
  }
  buildCounterRelatedResources--;
}
...
core.List<api.AttachedResource> buildUnnamed89() => [
      buildAttachedResource(),
      buildAttachedResource(),
    ];

void checkUnnamed89(core.List<api.AttachedResource> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachedResource(o[0]);
  checkAttachedResource(o[1]);
}

core.List<api.EffectiveTagDetails> buildUnnamed90() => [
      buildEffectiveTagDetails(),
      buildEffectiveTagDetails(),
    ];

void checkUnnamed90(core.List<api.EffectiveTagDetails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, api.RelatedResources> buildUnnamed95() => {
      'x': buildRelatedResources(),
      'y': buildRelatedResources(),
    };

void checkUnnamed95(core.Map<core.String, api.RelatedResources> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Tag> buildUnnamed100() => [
      buildTag(),
      buildTag(),
    ];

void checkUnnamed100(core.List<api.Tag> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTag(o[0]);
  checkTag(o[1]);
}

core.List<api.VersionedResource> buildUnnamed101() => [
      buildVersionedResource(),
      buildVersionedResource(),
    ];

void checkUnnamed101(core.List<api.VersionedResource> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVersionedResource(o[0]);
  checkVersionedResource(o[1]);
}
...
api.ResourceSearchResult buildResourceSearchResult() {
  ...
  if (buildCounterResourceSearchResult < 3) {
    o.additionalAttributes = buildUnnamed88();
    o.assetType = 'foo';
    o.attachedResources = buildUnnamed89();
    o.createTime = 'foo';
    o.description = 'foo';
    o.displayName = 'foo';
    o.effectiveTags = buildUnnamed90();
    o.folders = buildUnnamed91();
    o.kmsKey = 'foo';
    o.kmsKeys = buildUnnamed92();
    o.labels = buildUnnamed93();
    o.location = 'foo';
    o.name = 'foo';
    o.networkTags = buildUnnamed94();
    o.organization = 'foo';
    o.parentAssetType = 'foo';
    o.parentFullResourceName = 'foo';
    o.project = 'foo';
    o.relationships = buildUnnamed95();
    o.sccSecurityMarks = buildUnnamed96();
    o.state = 'foo';
    o.tagKeys = buildUnnamed97();
    o.tagValueIds = buildUnnamed98();
    o.tagValues = buildUnnamed99();
    o.tags = buildUnnamed100();
    o.updateTime = 'foo';
    o.versionedResources = buildUnnamed101();
  }
  buildCounterResourceSearchResult--;
  return o;
}
...
void checkResourceSearchResult(api.ResourceSearchResult o) {
  buildCounterResourceSearchResult++;
  if (buildCounterResourceSearchResult < 3) {
    checkUnnamed88(o.additionalAttributes!);
    unittest.expect(
      o.assetType!,
      unittest.equals('foo'),
    );
    checkUnnamed89(o.attachedResources!);
    unittest.expect(
      o.createTime!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed90(o.effectiveTags!);
    checkUnnamed91(o.folders!);
    unittest.expect(
      o.kmsKey!,
      unittest.equals('foo'),
    );
    checkUnnamed92(o.kmsKeys!);
    ...
    checkUnnamed95(o.relationships!);
    checkUnnamed96(o.sccSecurityMarks!);
    unittest.expect(
      o.state!,
      unittest.equals('foo'),
    );
    checkUnnamed97(o.tagKeys!);
    checkUnnamed98(o.tagValueIds!);
    checkUnnamed99(o.tagValues!);
    checkUnnamed100(o.tags!);
    unittest.expect(
      o.updateTime!,
      unittest.equals('foo'),
    );
    checkUnnamed101(o.versionedResources!);
  }
  buildCounterResourceSearchResult--;
}
...
core.List<api.IamPolicySearchResult> buildUnnamed103() => [
      buildIamPolicySearchResult(),
      buildIamPolicySearchResult(),
    ];

void checkUnnamed103(core.List<api.IamPolicySearchResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ResourceSearchResult> buildUnnamed104() => [
      buildResourceSearchResult(),
      buildResourceSearchResult(),
    ];

void checkUnnamed104(core.List<api.ResourceSearchResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.WindowsUpdateCategory> buildUnnamed110() => [
      buildWindowsUpdateCategory(),
      buildWindowsUpdateCategory(),
    ];

void checkUnnamed110(core.List<api.WindowsUpdateCategory> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.WindowsUpdatePackage buildWindowsUpdatePackage() {
  ...
  if (buildCounterWindowsUpdatePackage < 3) {
    o.categories = buildUnnamed110();
    o.description = 'foo';
    o.kbArticleIds = buildUnnamed111();
    o.lastDeploymentChangeTime = 'foo';
    o.moreInfoUrls = buildUnnamed112();
    o.revisionNumber = 42;
    o.supportUrl = 'foo';
    o.title = 'foo';
    o.updateId = 'foo';
...
void checkWindowsUpdatePackage(api.WindowsUpdatePackage o) {
  buildCounterWindowsUpdatePackage++;
  if (buildCounterWindowsUpdatePackage < 3) {
    checkUnnamed110(o.categories!);
    unittest.expect(
      o.description!,
      unittest.equals('foo'),
    );
    checkUnnamed111(o.kbArticleIds!);
    unittest.expect(
      o.lastDeploymentChangeTime!,
      unittest.equals('foo'),
    );
    checkUnnamed112(o.moreInfoUrls!);
    unittest.expect(
      o.revisionNumber!,
      unittest.equals(42),
    );
...
void main() {
  ...
  unittest.group('resource-AssetsResource', () {
    unittest.test('method--list', () async {
      ...
      final arg_relationshipTypes = buildUnnamed114();
  ...
  unittest.group('resource-EffectiveIamPoliciesResource', () {
    unittest.test('method--batchGet', () async {
      ...
      final arg_scope = 'foo';
      final arg_names = buildUnnamed115();
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final path = req.url.path;
        var pathOffset = 0;
  ...
  unittest.group('resource-V1Resource', () {
    unittest.test('method--analyzeIamPolicy', () async {
      ...
      final arg_scope = 'foo';
      final arg_analysisQuery_accessSelector_permissions = buildUnnamed116();
      final arg_analysisQuery_accessSelector_roles = buildUnnamed117();
    ...
    unittest.test('method--batchGetAssetsHistory', () async {
      ...
      final res = api.CloudAssetApi(mock).v1;
      final arg_parent = 'foo';
      final arg_assetNames = buildUnnamed118();
      final arg_contentType = 'foo';
      final arg_readTimeWindow_endTime = 'foo';
      final arg_readTimeWindow_startTime = 'foo';
      final arg_relationshipTypes = buildUnnamed119();
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final path = req.url.path;
        var pathOffset = 0;
    ...
    unittest.test('method--searchAllIamPolicies', () async {
      ...
      final res = api.CloudAssetApi(mock).v1;
      final arg_scope = 'foo';
      final arg_assetTypes = buildUnnamed120();
    ...
    unittest.test('method--searchAllResources', () async {
      ...
      final res = api.CloudAssetApi(mock).v1;
      final arg_scope = 'foo';
      final arg_assetTypes = buildUnnamed121();
      final arg_orderBy = 'foo';
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_query = 'foo';
