...
core.List<api.BuildBazelRemoteExecutionV2OutputDirectory> buildUnnamed6417() {
...
core.List<api.BuildBazelRemoteExecutionV2OutputSymlink> buildUnnamed6418() {
...
core.List<api.BuildBazelRemoteExecutionV2OutputSymlink> buildUnnamed6419() {
  var o = <api.BuildBazelRemoteExecutionV2OutputSymlink>[];
  o.add(buildBuildBazelRemoteExecutionV2OutputSymlink());
  o.add(buildBuildBazelRemoteExecutionV2OutputSymlink());
  return o;
...
core.List<api.BuildBazelRemoteExecutionV2OutputFile> buildUnnamed6420() {
...
void checkUnnamed6420(core.List<api.BuildBazelRemoteExecutionV2OutputFile> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.BuildBazelRemoteExecutionV2OutputSymlink> buildUnnamed6421() {
  var o = <api.BuildBazelRemoteExecutionV2OutputSymlink>[];
  o.add(buildBuildBazelRemoteExecutionV2OutputSymlink());
  o.add(buildBuildBazelRemoteExecutionV2OutputSymlink());
  return o;
...
api.BuildBazelRemoteExecutionV2ActionResult
  ...
  if (buildCounterBuildBazelRemoteExecutionV2ActionResult < 3) {
    ...
    o.exitCode = 42;
    o.outputDirectories = buildUnnamed6417();
    o.outputDirectorySymlinks = buildUnnamed6418();
    o.outputFileSymlinks = buildUnnamed6419();
    o.outputFiles = buildUnnamed6420();
    o.outputSymlinks = buildUnnamed6421();
...
void checkBuildBazelRemoteExecutionV2ActionResult(
  ...
  if (buildCounterBuildBazelRemoteExecutionV2ActionResult < 3) {
    ...
    checkUnnamed6417(o.outputDirectories!);
    checkUnnamed6418(o.outputDirectorySymlinks!);
    checkUnnamed6419(o.outputFileSymlinks!);
    checkUnnamed6420(o.outputFiles!);
    checkUnnamed6421(o.outputSymlinks!);
    checkBuildBazelRemoteExecutionV2Digest(
...
core.List<api.BuildBazelRemoteExecutionV2Digest> buildUnnamed6422() {
...
void checkUnnamed6422(core.List<api.BuildBazelRemoteExecutionV2Digest> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuildBazelRemoteExecutionV2Digest(
...
api.BuildBazelRemoteExecutionV2CacheCapabilities
  ...
  if (buildCounterBuildBazelRemoteExecutionV2CacheCapabilities < 3) {
    ...
    o.digestFunction = buildUnnamed6426();
    o.maxBatchTotalSizeBytes = 'foo';
    o.supportedCompressor = buildUnnamed6427();
...
void checkBuildBazelRemoteExecutionV2CacheCapabilities(
  ...
  if (buildCounterBuildBazelRemoteExecutionV2CacheCapabilities < 3) {
    ...
    checkUnnamed6426(o.digestFunction!);
    unittest.expect(
      o.maxBatchTotalSizeBytes!,
      unittest.equals('foo'),
    );
    checkUnnamed6427(o.supportedCompressor!);
    unittest.expect(
...
api.BuildBazelRemoteExecutionV2Command
  ...
  if (buildCounterBuildBazelRemoteExecutionV2Command < 3) {
    o.arguments = buildUnnamed6428();
    o.environmentVariables = buildUnnamed6429();
    o.outputDirectories = buildUnnamed6430();
    o.outputFiles = buildUnnamed6431();
    o.outputNodeProperties = buildUnnamed6432();
    o.outputPaths = buildUnnamed6433();
    o.platform = buildBuildBazelRemoteExecutionV2Platform();
...
void checkBuildBazelRemoteExecutionV2Command(
  ...
  buildCounterBuildBazelRemoteExecutionV2Command++;
  if (buildCounterBuildBazelRemoteExecutionV2Command < 3) {
    checkUnnamed6428(o.arguments!);
    checkUnnamed6429(o.environmentVariables!);
    checkUnnamed6430(o.outputDirectories!);
    checkUnnamed6431(o.outputFiles!);
    checkUnnamed6432(o.outputNodeProperties!);
    checkUnnamed6433(o.outputPaths!);
    checkBuildBazelRemoteExecutionV2Platform(
        o.platform! as api.BuildBazelRemoteExecutionV2Platform);
    unittest.expect(
      o.workingDirectory!,
...
core.List<api.BuildBazelRemoteExecutionV2DirectoryNode> buildUnnamed6434() {
...
core.List<api.BuildBazelRemoteExecutionV2FileNode> buildUnnamed6435() {
...
void checkUnnamed6435(core.List<api.BuildBazelRemoteExecutionV2FileNode> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.BuildBazelRemoteExecutionV2SymlinkNode> buildUnnamed6436() {
...
void checkUnnamed6436(core.List<api.BuildBazelRemoteExecutionV2SymlinkNode> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BuildBazelRemoteExecutionV2Directory
  ...
  if (buildCounterBuildBazelRemoteExecutionV2Directory < 3) {
    o.directories = buildUnnamed6434();
    o.files = buildUnnamed6435();
    o.nodeProperties = buildBuildBazelRemoteExecutionV2NodeProperties();
    o.symlinks = buildUnnamed6436();
  }
  buildCounterBuildBazelRemoteExecutionV2Directory--;
  return o;
}
...
void checkBuildBazelRemoteExecutionV2ExecuteResponse(
  ...
  if (buildCounterBuildBazelRemoteExecutionV2ExecuteResponse < 3) {
    ...
    checkUnnamed6437(o.serverLogs!);
    checkGoogleRpcStatus(o.status! as api.GoogleRpcStatus);
  }
  buildCounterBuildBazelRemoteExecutionV2ExecuteResponse--;
}

core.Map<core.String, core.Object> buildUnnamed6438() {
...
void checkUnnamed6438(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed6439() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed6438());
  o.add(buildUnnamed6438());
  return o;
}

void checkUnnamed6439(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed6438(o[0]);
  checkUnnamed6438(o[1]);
}
...
api.BuildBazelRemoteExecutionV2ExecutedActionMetadata
  ...
  if (buildCounterBuildBazelRemoteExecutionV2ExecutedActionMetadata < 3) {
    o.auxiliaryMetadata = buildUnnamed6439();
...
void checkBuildBazelRemoteExecutionV2ExecutedActionMetadata(
  ...
  buildCounterBuildBazelRemoteExecutionV2ExecutedActionMetadata++;
  if (buildCounterBuildBazelRemoteExecutionV2ExecutedActionMetadata < 3) {
    checkUnnamed6439(o.auxiliaryMetadata!);
    unittest.expect(
...
api.BuildBazelRemoteExecutionV2ExecutionCapabilities
  ...
  if (buildCounterBuildBazelRemoteExecutionV2ExecutionCapabilities < 3) {
    ...
    o.executionPriorityCapabilities =
        buildBuildBazelRemoteExecutionV2PriorityCapabilities();
    o.supportedNodeProperties = buildUnnamed6440();
  }
  buildCounterBuildBazelRemoteExecutionV2ExecutionCapabilities--;
  return o;
}
...
void checkBuildBazelRemoteExecutionV2ExecutionCapabilities(
  ...
  if (buildCounterBuildBazelRemoteExecutionV2ExecutionCapabilities < 3) {
    ...
    checkBuildBazelRemoteExecutionV2PriorityCapabilities(
        o.executionPriorityCapabilities!
            as api.BuildBazelRemoteExecutionV2PriorityCapabilities);
    checkUnnamed6440(o.supportedNodeProperties!);
  }
  buildCounterBuildBazelRemoteExecutionV2ExecutionCapabilities--;
}
...
core.List<api.BuildBazelRemoteExecutionV2Digest> buildUnnamed6441() {
  var o = <api.BuildBazelRemoteExecutionV2Digest>[];
  o.add(buildBuildBazelRemoteExecutionV2Digest());
  o.add(buildBuildBazelRemoteExecutionV2Digest());
  return o;
...
void checkUnnamed6441(core.List<api.BuildBazelRemoteExecutionV2Digest> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuildBazelRemoteExecutionV2Digest(
      o[0] as api.BuildBazelRemoteExecutionV2Digest);
  checkBuildBazelRemoteExecutionV2Digest(
...
api.BuildBazelRemoteExecutionV2FindMissingBlobsRequest
  ...
  if (buildCounterBuildBazelRemoteExecutionV2FindMissingBlobsRequest < 3) {
    o.blobDigests = buildUnnamed6441();
  }
  buildCounterBuildBazelRemoteExecutionV2FindMissingBlobsRequest--;
  return o;
}
...
void checkBuildBazelRemoteExecutionV2FindMissingBlobsRequest(
  ...
  buildCounterBuildBazelRemoteExecutionV2FindMissingBlobsRequest++;
  if (buildCounterBuildBazelRemoteExecutionV2FindMissingBlobsRequest < 3) {
    checkUnnamed6441(o.blobDigests!);
  }
  buildCounterBuildBazelRemoteExecutionV2FindMissingBlobsRequest--;
}

core.List<api.BuildBazelRemoteExecutionV2Digest> buildUnnamed6442() {
  var o = <api.BuildBazelRemoteExecutionV2Digest>[];
  o.add(buildBuildBazelRemoteExecutionV2Digest());
  o.add(buildBuildBazelRemoteExecutionV2Digest());
  return o;
...
void checkUnnamed6442(core.List<api.BuildBazelRemoteExecutionV2Digest> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuildBazelRemoteExecutionV2Digest(
      o[0] as api.BuildBazelRemoteExecutionV2Digest);
  checkBuildBazelRemoteExecutionV2Digest(
...
api.BuildBazelRemoteExecutionV2FindMissingBlobsResponse
  ...
  if (buildCounterBuildBazelRemoteExecutionV2FindMissingBlobsResponse < 3) {
    o.missingBlobDigests = buildUnnamed6442();
  }
  buildCounterBuildBazelRemoteExecutionV2FindMissingBlobsResponse--;
  return o;
}
...
void checkBuildBazelRemoteExecutionV2FindMissingBlobsResponse(
  ...
  buildCounterBuildBazelRemoteExecutionV2FindMissingBlobsResponse++;
  if (buildCounterBuildBazelRemoteExecutionV2FindMissingBlobsResponse < 3) {
    checkUnnamed6442(o.missingBlobDigests!);
  }
  buildCounterBuildBazelRemoteExecutionV2FindMissingBlobsResponse--;
}

core.List<api.BuildBazelRemoteExecutionV2Directory> buildUnnamed6443() {
  var o = <api.BuildBazelRemoteExecutionV2Directory>[];
...
void checkUnnamed6443(core.List<api.BuildBazelRemoteExecutionV2Directory> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BuildBazelRemoteExecutionV2GetTreeResponse
  ...
  if (buildCounterBuildBazelRemoteExecutionV2GetTreeResponse < 3) {
    o.directories = buildUnnamed6443();
    o.nextPageToken = 'foo';
  }
  buildCounterBuildBazelRemoteExecutionV2GetTreeResponse--;
  return o;
...
void checkBuildBazelRemoteExecutionV2GetTreeResponse(
  ...
  buildCounterBuildBazelRemoteExecutionV2GetTreeResponse++;
  if (buildCounterBuildBazelRemoteExecutionV2GetTreeResponse < 3) {
    checkUnnamed6443(o.directories!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.BuildBazelRemoteExecutionV2NodeProperty> buildUnnamed6444() {
...
core.List<api.BuildBazelRemoteExecutionV2PlatformProperty> buildUnnamed6445() {
...
core.List<api.BuildBazelRemoteExecutionV2Directory> buildUnnamed6447() {
  var o = <api.BuildBazelRemoteExecutionV2Directory>[];
  o.add(buildBuildBazelRemoteExecutionV2Directory());
  o.add(buildBuildBazelRemoteExecutionV2Directory());
  return o;
...
void checkUnnamed6447(core.List<api.BuildBazelRemoteExecutionV2Directory> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuildBazelRemoteExecutionV2Directory(
      o[0] as api.BuildBazelRemoteExecutionV2Directory);
  checkBuildBazelRemoteExecutionV2Directory(
...
api.GoogleDevtoolsRemotebuildbotResourceUsage
  ...
  if (buildCounterGoogleDevtoolsRemotebuildbotResourceUsage < 3) {
    ...
    o.totalDiskIoStats =
        buildGoogleDevtoolsRemotebuildbotResourceUsageIOStats();
  }
  buildCounterGoogleDevtoolsRemotebuildbotResourceUsage--;
  return o;
}
...
void checkGoogleDevtoolsRemotebuildbotResourceUsage(
  ...
  if (buildCounterGoogleDevtoolsRemotebuildbotResourceUsage < 3) {
    ...
    checkGoogleDevtoolsRemotebuildbotResourceUsageIOStats(o.totalDiskIoStats!
        as api.GoogleDevtoolsRemotebuildbotResourceUsageIOStats);
  }
  buildCounterGoogleDevtoolsRemotebuildbotResourceUsage--;
}

core.int buildCounterGoogleDevtoolsRemotebuildbotResourceUsageIOStats = 0;
api.GoogleDevtoolsRemotebuildbotResourceUsageIOStats
    buildGoogleDevtoolsRemotebuildbotResourceUsageIOStats() {
  var o = api.GoogleDevtoolsRemotebuildbotResourceUsageIOStats();
  buildCounterGoogleDevtoolsRemotebuildbotResourceUsageIOStats++;
  if (buildCounterGoogleDevtoolsRemotebuildbotResourceUsageIOStats < 3) {
    o.readBytesCount = 'foo';
    o.readCount = 'foo';
    o.readTimeMs = 'foo';
    o.writeBytesCount = 'foo';
    o.writeCount = 'foo';
    o.writeTimeMs = 'foo';
  }
  buildCounterGoogleDevtoolsRemotebuildbotResourceUsageIOStats--;
...
void checkGoogleDevtoolsRemotebuildbotResourceUsageIOStats(
    api.GoogleDevtoolsRemotebuildbotResourceUsageIOStats o) {
  buildCounterGoogleDevtoolsRemotebuildbotResourceUsageIOStats++;
  if (buildCounterGoogleDevtoolsRemotebuildbotResourceUsageIOStats < 3) {
    unittest.expect(
      o.readBytesCount!,
...
api.GoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyFeature
  ...
  if (buildCounterGoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyFeature <
      3) {
    o.allowedValues = buildUnnamed6448();
    o.policy = 'foo';
  }
  buildCounterGoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyFeature--;
  return o;
...
void checkGoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyFeature(
  ...
  if (buildCounterGoogleDevtoolsRemotebuildexecutionAdminV1alphaFeaturePolicyFeature <
      3) {
    checkUnnamed6448(o.allowedValues!);
    unittest.expect(
      o.policy!,
      unittest.equals('foo'),
    );
...
api.GoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse
  ...
  if (buildCounterGoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse <
      3) {
    o.workerPools = buildUnnamed6450();
  }
  buildCounterGoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse--;
  return o;
}
...
void checkGoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse(
  ...
  if (buildCounterGoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse <
      3) {
    checkUnnamed6450(o.workerPools!);
  }
  buildCounterGoogleDevtoolsRemotebuildexecutionAdminV1alphaListWorkerPoolsResponse--;
}
...
core.Map<core.String, core.String> buildUnnamed6451() {
...
void checkUnnamed6451(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.Map<core.String, core.Object> buildUnnamed6452() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed6452(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed6453() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed6452());
  o.add(buildUnnamed6452());
  return o;
}

void checkUnnamed6453(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed6452(o[0]);
  checkUnnamed6452(o[1]);
}
...
core.List<api.GoogleDevtoolsRemoteworkersV1test2Digest> buildUnnamed6456() {
...
core.List<api.GoogleDevtoolsRemoteworkersV1test2Blob> buildUnnamed6457() {
  var o = <api.GoogleDevtoolsRemoteworkersV1test2Blob>[];
...
void checkUnnamed6457(core.List<api.GoogleDevtoolsRemoteworkersV1test2Blob> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleDevtoolsRemoteworkersV1test2CommandTaskInputs
  ...
  if (buildCounterGoogleDevtoolsRemoteworkersV1test2CommandTaskInputs < 3) {
    o.arguments = buildUnnamed6454();
    o.environmentVariables = buildUnnamed6455();
    o.files = buildUnnamed6456();
    o.inlineBlobs = buildUnnamed6457();
    o.workingDirectory = 'foo';
  }
  buildCounterGoogleDevtoolsRemoteworkersV1test2CommandTaskInputs--;
  return o;
...
void checkGoogleDevtoolsRemoteworkersV1test2CommandTaskInputs(
  ...
  buildCounterGoogleDevtoolsRemoteworkersV1test2CommandTaskInputs++;
  if (buildCounterGoogleDevtoolsRemoteworkersV1test2CommandTaskInputs < 3) {
    checkUnnamed6454(o.arguments!);
    checkUnnamed6455(o.environmentVariables!);
    checkUnnamed6456(o.files!);
    checkUnnamed6457(o.inlineBlobs!);
    unittest.expect(
      o.workingDirectory!,
      unittest.equals('foo'),
    );
...
api.GoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs
  ...
  if (buildCounterGoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs < 3) {
    o.directories = buildUnnamed6458();
    o.files = buildUnnamed6459();
...
void checkGoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs(
  ...
  buildCounterGoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs++;
  if (buildCounterGoogleDevtoolsRemoteworkersV1test2CommandTaskOutputs < 3) {
    checkUnnamed6458(o.directories!);
    checkUnnamed6459(o.files!);
    unittest.expect(
      o.stderrDestination!,
      unittest.equals('foo'),
    );
...
api.GoogleDevtoolsRemoteworkersV1test2Directory
  ...
  if (buildCounterGoogleDevtoolsRemoteworkersV1test2Directory < 3) {
    o.directories = buildUnnamed6460();
    o.files = buildUnnamed6461();
  }
  buildCounterGoogleDevtoolsRemoteworkersV1test2Directory--;
  return o;
}
...
void checkGoogleDevtoolsRemoteworkersV1test2Directory(
  ...
  buildCounterGoogleDevtoolsRemoteworkersV1test2Directory++;
  if (buildCounterGoogleDevtoolsRemoteworkersV1test2Directory < 3) {
    checkUnnamed6460(o.directories!);
    checkUnnamed6461(o.files!);
  }
  buildCounterGoogleDevtoolsRemoteworkersV1test2Directory--;
}
...
core.Map<core.String, core.Object> buildUnnamed6462() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed6462(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed6463() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed6463(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleLongrunningOperation buildGoogleLongrunningOperation() {
  ...
  if (buildCounterGoogleLongrunningOperation < 3) {
    ...
    o.metadata = buildUnnamed6462();
    o.name = 'foo';
    o.response = buildUnnamed6463();
  }
  buildCounterGoogleLongrunningOperation--;
  return o;
}
...
void checkGoogleLongrunningOperation(api.GoogleLongrunningOperation o) {
  ...
  if (buildCounterGoogleLongrunningOperation < 3) {
    ...
    checkUnnamed6462(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed6463(o.response!);
  }
  buildCounterGoogleLongrunningOperation--;
}

core.Map<core.String, core.Object> buildUnnamed6464() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed6464(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed6465() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed6464());
  o.add(buildUnnamed6464());
  return o;
}

void checkUnnamed6465(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed6464(o[0]);
  checkUnnamed6464(o[1]);
}
...
void main() {
  ...
  unittest.group('obj-schema-GoogleDevtoolsRemotebuildbotResourceUsageIOStats',
      () {
    unittest.test('to-json--from-json', () async {
      var o = buildGoogleDevtoolsRemotebuildbotResourceUsageIOStats();
      var oJson = convert.jsonDecode(convert.jsonEncode(o));
      var od = api.GoogleDevtoolsRemotebuildbotResourceUsageIOStats.fromJson(
          oJson as core.Map<core.String, core.dynamic>);
      checkGoogleDevtoolsRemotebuildbotResourceUsageIOStats(
          od as api.GoogleDevtoolsRemotebuildbotResourceUsageIOStats);
    });
  });
  ...
  unittest.group('resource-ActionResultsResource', () {
    unittest.test('method--get', () async {
      ...
      var arg_inlineOutputFiles = buildUnnamed6466();
