...
core.List<api.Property> buildUnnamed0() => [
      buildProperty(),
      buildProperty(),
    ];
...
core.List<api.Posture> buildUnnamed11() => [
      buildPosture(),
      buildPosture(),
    ];
...
core.List<api.Posture> buildUnnamed13() => [
      buildPosture(),
      buildPosture(),
    ];
...
core.List<api.Report> buildUnnamed15() => [
      buildReport(),
      buildReport(),
    ];
...
core.List<api.Policy> buildUnnamed25() => [
      buildPolicy(),
      buildPolicy(),
    ];
...
void checkPostureDetails(api.PostureDetails o) {
  ...
  if (buildCounterPostureDetails < 3) {
    ...
    unittest.expect(
      o.postureDeploymentTargetResource!,
      unittest.equals('foo'),
    );
    unittest.expect(
      o.postureRevisionId!,
...
void main() {
  ...
  unittest.group('obj-schema-PolicySet', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od =
          api.PolicySet.fromJson(oJson as core.Map<core.String, core.dynamic>);
      checkPolicySet(od);
    });
  });
  ...
  unittest.group('obj-schema-Posture', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od =
          api.Posture.fromJson(oJson as core.Map<core.String, core.dynamic>);
      checkPosture(od);
    });
  });
  ...
  unittest.group('resource-OrganizationsLocationsPostureDeploymentsResource',
    ...
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.SecurityPostureApi(mock)
          .organizations
          .locations
          .postureDeployments;
      ...
      final response = await res.create(arg_request, arg_parent,
          postureDeploymentId: arg_postureDeploymentId, $fields: arg_$fields);
      checkOperation(response as api.Operation);
    });
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        final resp = convert.json.encode(buildListPostureDeploymentsResponse());
        return async.Future.value(stringResponse(200, h, resp));
      }), true);
  ...
  unittest.group('resource-OrganizationsLocationsPosturesResource', () {
    unittest.test('method--create', () async {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final obj =
            api.Posture.fromJson(json as core.Map<core.String, core.dynamic>);
        checkPosture(obj);
      ...
      final response = await res.create(arg_request, arg_parent,
          postureId: arg_postureId, $fields: arg_$fields);
      checkOperation(response as api.Operation);
    });
    ...
    unittest.test('method--extract', () async {
      ...
      final response =
          await res.extract(arg_request, arg_parent, $fields: arg_$fields);
      checkOperation(response as api.Operation);
    });
