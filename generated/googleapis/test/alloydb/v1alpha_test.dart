...
import 'package:googleapis/alloydb/v1alpha.dart' as api;
...
api.Cluster buildCluster() {
  ...
  if (buildCounterCluster < 3) {
    ...
    o.encryptionInfo = buildEncryptionInfo();
    o.etag = 'foo';
    o.geminiConfig = buildGeminiClusterConfig();
...
void checkCluster(api.Cluster o) {
  ...
  if (buildCounterCluster < 3) {
    ...
    checkEncryptionInfo(o.encryptionInfo!);
    unittest.expect(o.etag!, unittest.equals('foo'));
    checkGeminiClusterConfig(o.geminiConfig!);
...
api.ConnectionPoolConfig buildConnectionPoolConfig() {
  ...
  if (buildCounterConnectionPoolConfig < 3) {
    o.defaultPoolSize = 'foo';
    o.enable = true;
    o.enabled = true;
    o.flags = buildUnnamed8();
    o.ignoreStartupParameters = buildUnnamed9();
    o.maxClientConn = 'foo';
    o.maxPreparedStatements = 'foo';
    o.minPoolSize = 'foo';
    o.poolMode = 'foo';
    o.poolerCount = 42;
    o.queryWaitTimeout = 'foo';
    o.serverIdleTimeout = 'foo';
    o.statsUsers = buildUnnamed10();
  }
  buildCounterConnectionPoolConfig--;
  return o;
}
...
void checkConnectionPoolConfig(api.ConnectionPoolConfig o) {
  buildCounterConnectionPoolConfig++;
  if (buildCounterConnectionPoolConfig < 3) {
    unittest.expect(o.defaultPoolSize!, unittest.equals('foo'));
    unittest.expect(o.enable!, unittest.isTrue);
    unittest.expect(o.enabled!, unittest.isTrue);
    checkUnnamed8(o.flags!);
    checkUnnamed9(o.ignoreStartupParameters!);
    unittest.expect(o.maxClientConn!, unittest.equals('foo'));
    unittest.expect(o.maxPreparedStatements!, unittest.equals('foo'));
    unittest.expect(o.minPoolSize!, unittest.equals('foo'));
    unittest.expect(o.poolMode!, unittest.equals('foo'));
    unittest.expect(o.poolerCount!, unittest.equals(42));
    unittest.expect(o.queryWaitTimeout!, unittest.equals('foo'));
    unittest.expect(o.serverIdleTimeout!, unittest.equals('foo'));
    checkUnnamed10(o.statsUsers!);
  }
  buildCounterConnectionPoolConfig--;
}
...
api.EncryptionInfo buildEncryptionInfo() {
  ...
  if (buildCounterEncryptionInfo < 3) {
    ...
    o.kmsKeyVersions = buildUnnamed13();
  }
  buildCounterEncryptionInfo--;
  return o;
}
...
void checkEncryptionInfo(api.EncryptionInfo o) {
  ...
  if (buildCounterEncryptionInfo < 3) {
    ...
    checkUnnamed13(o.kmsKeyVersions!);
  }
  buildCounterEncryptionInfo--;
}
...
core.int buildCounterGCAInstanceConfig = 0;
api.GCAInstanceConfig buildGCAInstanceConfig() {
  final o = api.GCAInstanceConfig();
  buildCounterGCAInstanceConfig++;
  if (buildCounterGCAInstanceConfig < 3) {
    o.gcaEntitlement = 'foo';
  }
  buildCounterGCAInstanceConfig--;
  return o;
}

void checkGCAInstanceConfig(api.GCAInstanceConfig o) {
  buildCounterGCAInstanceConfig++;
  if (buildCounterGCAInstanceConfig < 3) {
    unittest.expect(o.gcaEntitlement!, unittest.equals('foo'));
  }
  buildCounterGCAInstanceConfig--;
}
...
core.int buildCounterGeminiClusterConfig = 0;
api.GeminiClusterConfig buildGeminiClusterConfig() {
  final o = api.GeminiClusterConfig();
  buildCounterGeminiClusterConfig++;
  if (buildCounterGeminiClusterConfig < 3) {
    o.entitled = true;
  }
  buildCounterGeminiClusterConfig--;
  return o;
...
void checkGeminiClusterConfig(api.GeminiClusterConfig o) {
  buildCounterGeminiClusterConfig++;
  if (buildCounterGeminiClusterConfig < 3) {
...
core.List<api.GoogleCloudLocationLocation> buildUnnamed14() => [
  buildGoogleCloudLocationLocation(),
  buildGoogleCloudLocationLocation(),
];

void checkUnnamed14(core.List<api.GoogleCloudLocationLocation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Node> buildUnnamed20() => [buildNode(), buildNode()];

void checkUnnamed20(core.List<api.Node> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNode(o[0]);
  checkNode(o[1]);
}
...
api.Instance buildInstance() {
  ...
  if (buildCounterInstance < 3) {
    ...
    o.createTime = 'foo';
    o.databaseFlags = buildUnnamed18();
    o.deleteTime = 'foo';
    o.displayName = 'foo';
    o.etag = 'foo';
    o.gcaConfig = buildGCAInstanceConfig();
    o.gceZone = 'foo';
    ...
    o.nodes = buildUnnamed20();
    o.observabilityConfig = buildObservabilityInstanceConfig();
    o.outboundPublicIpAddresses = buildUnnamed21();
...
void checkInstance(api.Instance o) {
  ...
  if (buildCounterInstance < 3) {
    ...
    unittest.expect(o.createTime!, unittest.equals('foo'));
    checkUnnamed18(o.databaseFlags!);
    unittest.expect(o.deleteTime!, unittest.equals('foo'));
    unittest.expect(o.displayName!, unittest.equals('foo'));
    unittest.expect(o.etag!, unittest.equals('foo'));
    checkGCAInstanceConfig(o.gcaConfig!);
    ...
    checkUnnamed20(o.nodes!);
    checkObservabilityInstanceConfig(o.observabilityConfig!);
    checkUnnamed21(o.outboundPublicIpAddresses!);
...
core.List<api.AuthorizedNetwork> buildUnnamed22() => [
  buildAuthorizedNetwork(),
  buildAuthorizedNetwork(),
];

void checkUnnamed22(core.List<api.AuthorizedNetwork> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.InstanceNetworkConfig buildInstanceNetworkConfig() {
  ...
  if (buildCounterInstanceNetworkConfig < 3) {
    ...
    o.authorizedExternalNetworks = buildUnnamed22();
...
void checkInstanceNetworkConfig(api.InstanceNetworkConfig o) {
  ...
  if (buildCounterInstanceNetworkConfig < 3) {
    ...
    checkUnnamed22(o.authorizedExternalNetworks!);
...
core.List<api.Backup> buildUnnamed23() => [buildBackup(), buildBackup()];

void checkUnnamed23(core.List<api.Backup> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBackup(o[0]);
  checkBackup(o[1]);
}
...
core.List<api.Cluster> buildUnnamed25() => [buildCluster(), buildCluster()];
...
core.List<api.Instance> buildUnnamed27() => [buildInstance(), buildInstance()];

void checkUnnamed27(core.List<api.Instance> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInstance(o[0]);
  checkInstance(o[1]);
}
...
core.List<api.SupportedDatabaseFlag> buildUnnamed30() => [
  buildSupportedDatabaseFlag(),
  buildSupportedDatabaseFlag(),
];

void checkUnnamed30(core.List<api.SupportedDatabaseFlag> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListSupportedDatabaseFlagsResponse() {
  ...
  if (buildCounterListSupportedDatabaseFlagsResponse < 3) {
    o.nextPageToken = 'foo';
    o.supportedDatabaseFlags = buildUnnamed30();
  }
  buildCounterListSupportedDatabaseFlagsResponse--;
  return o;
}
...
void checkListSupportedDatabaseFlagsResponse(
  ...
  if (buildCounterListSupportedDatabaseFlagsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed30(o.supportedDatabaseFlags!);
  }
  buildCounterListSupportedDatabaseFlagsResponse--;
}
...
core.List<api.User> buildUnnamed32() => [buildUser(), buildUser()];
...
core.List<api.DenyMaintenancePeriod> buildUnnamed33() => [
  buildDenyMaintenancePeriod(),
  buildDenyMaintenancePeriod(),
];

void checkUnnamed33(core.List<api.DenyMaintenancePeriod> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDenyMaintenancePeriod(o[0]);
  checkDenyMaintenancePeriod(o[1]);
}

core.List<api.MaintenanceWindow> buildUnnamed34() => [
  buildMaintenanceWindow(),
  buildMaintenanceWindow(),
];

void checkUnnamed34(core.List<api.MaintenanceWindow> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MaintenanceUpdatePolicy buildMaintenanceUpdatePolicy() {
  ...
  if (buildCounterMaintenanceUpdatePolicy < 3) {
    o.denyMaintenancePeriods = buildUnnamed33();
    o.maintenanceWindows = buildUnnamed34();
  }
  buildCounterMaintenanceUpdatePolicy--;
  return o;
}
...
void checkMaintenanceUpdatePolicy(api.MaintenanceUpdatePolicy o) {
  buildCounterMaintenanceUpdatePolicy++;
  if (buildCounterMaintenanceUpdatePolicy < 3) {
    checkUnnamed33(o.denyMaintenancePeriods!);
    checkUnnamed34(o.maintenanceWindows!);
  }
  buildCounterMaintenanceUpdatePolicy--;
}
...
api.ObservabilityInstanceConfig buildObservabilityInstanceConfig() {
  ...
  if (buildCounterObservabilityInstanceConfig < 3) {
    o.assistiveExperiencesEnabled = true;
    o.enabled = true;
...
void checkObservabilityInstanceConfig(api.ObservabilityInstanceConfig o) {
  buildCounterObservabilityInstanceConfig++;
  if (buildCounterObservabilityInstanceConfig < 3) {
    unittest.expect(o.assistiveExperiencesEnabled!, unittest.isTrue);
    unittest.expect(o.enabled!, unittest.isTrue);
    ...
    unittest.expect(o.trackClientAddress!, unittest.isTrue);
...
api.PrimaryConfig buildPrimaryConfig() {
  ...
  if (buildCounterPrimaryConfig < 3) {
    o.secondaryClusterNames = buildUnnamed37();
  }
  buildCounterPrimaryConfig--;
  return o;
}
...
void checkPrimaryConfig(api.PrimaryConfig o) {
  buildCounterPrimaryConfig++;
  if (buildCounterPrimaryConfig < 3) {
    checkUnnamed37(o.secondaryClusterNames!);
  }
  buildCounterPrimaryConfig--;
}
...
core.List<api.PscAutoConnectionConfig> buildUnnamed39() => [
  buildPscAutoConnectionConfig(),
  buildPscAutoConnectionConfig(),
];

void checkUnnamed39(core.List<api.PscAutoConnectionConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPscAutoConnectionConfig(o[0]);
  checkPscAutoConnectionConfig(o[1]);
}

core.List<api.PscInterfaceConfig> buildUnnamed40() => [
  buildPscInterfaceConfig(),
  buildPscInterfaceConfig(),
];

void checkUnnamed40(core.List<api.PscInterfaceConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PscInstanceConfig buildPscInstanceConfig() {
  ...
  if (buildCounterPscInstanceConfig < 3) {
    o.allowedConsumerProjects = buildUnnamed38();
    o.pscAutoConnections = buildUnnamed39();
    o.pscDnsName = 'foo';
    o.pscInterfaceConfigs = buildUnnamed40();
...
void checkPscInstanceConfig(api.PscInstanceConfig o) {
  buildCounterPscInstanceConfig++;
  if (buildCounterPscInstanceConfig < 3) {
    checkUnnamed38(o.allowedConsumerProjects!);
    checkUnnamed39(o.pscAutoConnections!);
    unittest.expect(o.pscDnsName!, unittest.equals('foo'));
    checkUnnamed40(o.pscInterfaceConfigs!);
...
api.StringRestrictions buildStringRestrictions() {
  ...
  if (buildCounterStringRestrictions < 3) {
    o.allowedValues = buildUnnamed45();
  }
  buildCounterStringRestrictions--;
  return o;
}
...
void checkStringRestrictions(api.StringRestrictions o) {
  buildCounterStringRestrictions++;
  if (buildCounterStringRestrictions < 3) {
    checkUnnamed45(o.allowedValues!);
  }
  buildCounterStringRestrictions--;
}
...
api.SupportedDatabaseFlag buildSupportedDatabaseFlag() {
  ...
  if (buildCounterSupportedDatabaseFlag < 3) {
    ...
    o.supportedDbVersions = buildUnnamed46();
    o.valueType = 'foo';
  }
  buildCounterSupportedDatabaseFlag--;
  return o;
...
void checkSupportedDatabaseFlag(api.SupportedDatabaseFlag o) {
  ...
  if (buildCounterSupportedDatabaseFlag < 3) {
    ...
    checkUnnamed46(o.supportedDbVersions!);
...
api.User buildUser() {
  ...
  if (buildCounterUser < 3) {
    o.databaseRoles = buildUnnamed47();
...
void checkUser(api.User o) {
  buildCounterUser++;
  if (buildCounterUser < 3) {
    checkUnnamed47(o.databaseRoles!);
...
core.List<api.GoogleTypeTimeOfDay> buildUnnamed49() => [
  buildGoogleTypeTimeOfDay(),
  buildGoogleTypeTimeOfDay(),
];

void checkUnnamed49(core.List<api.GoogleTypeTimeOfDay> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.WeeklySchedule buildWeeklySchedule() {
  ...
  if (buildCounterWeeklySchedule < 3) {
    o.daysOfWeek = buildUnnamed48();
    o.startTimes = buildUnnamed49();
  }
  buildCounterWeeklySchedule--;
  return o;
}
...
void checkWeeklySchedule(api.WeeklySchedule o) {
  buildCounterWeeklySchedule++;
  if (buildCounterWeeklySchedule < 3) {
    checkUnnamed48(o.daysOfWeek!);
    checkUnnamed49(o.startTimes!);
  }
  buildCounterWeeklySchedule--;
}
...
void main() {
  ...
  unittest.group('obj-schema-GCAInstanceConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGCAInstanceConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GCAInstanceConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGCAInstanceConfig(od);
    });
  });
  ...
  unittest.group('obj-schema-GeminiClusterConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGeminiClusterConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GeminiClusterConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGeminiClusterConfig(od);
    });
  });
