...
core.List<api.Account> buildUnnamed5213() {
  var o = <api.Account>[];
  o.add(buildAccount());
  o.add(buildAccount());
  return o;
...
void checkUnnamed5213(core.List<api.Account> o) {
...
core.List<api.AdClient> buildUnnamed5214() {
  var o = <api.AdClient>[];
  o.add(buildAdClient());
  o.add(buildAdClient());
  return o;
...
void checkUnnamed5214(core.List<api.AdClient> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.AdUnit> buildUnnamed5215() {
  var o = <api.AdUnit>[];
  o.add(buildAdUnit());
  o.add(buildAdUnit());
  return o;
...
void checkUnnamed5215(core.List<api.AdUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AssociationSession buildAssociationSession() {
  ...
  if (buildCounterAssociationSession < 3) {
    ...
    o.id = 'foo';
    o.kind = 'foo';
    o.productCodes = buildUnnamed5216();
    o.redirectUrl = 'foo';
    o.status = 'foo';
    o.userLocale = 'foo';
    o.websiteLocale = 'foo';
...
void checkAssociationSession(api.AssociationSession o) {
  ...
  if (buildCounterAssociationSession < 3) {
    ...
    checkUnnamed5216(o.productCodes!);
    unittest.expect(
      o.redirectUrl!,
      unittest.equals('foo'),
    );
...
core.List<api.CustomChannel> buildUnnamed5217() {
  var o = <api.CustomChannel>[];
...
void checkUnnamed5217(core.List<api.CustomChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ReportHeaders> buildUnnamed5219() {
  var o = <api.ReportHeaders>[];
...
void checkUnnamed5219(core.List<api.ReportHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.List<core.String>> buildUnnamed5221() {
...
void checkUnnamed5221(core.List<core.List<core.String>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Report buildReport() {
  ...
  if (buildCounterReport < 3) {
    o.averages = buildUnnamed5218();
    o.headers = buildUnnamed5219();
    o.kind = 'foo';
    o.rows = buildUnnamed5221();
    o.totalMatchedRows = 'foo';
    o.totals = buildUnnamed5222();
    o.warnings = buildUnnamed5223();
  }
  buildCounterReport--;
  return o;
}
...
void checkReport(api.Report o) {
  buildCounterReport++;
  if (buildCounterReport < 3) {
    checkUnnamed5218(o.averages!);
    checkUnnamed5219(o.headers!);
    unittest.expect(
      o.kind!,
      unittest.equals('foo'),
    );
    checkUnnamed5221(o.rows!);
    unittest.expect(
      o.totalMatchedRows!,
      unittest.equals('foo'),
    );
    checkUnnamed5222(o.totals!);
    checkUnnamed5223(o.warnings!);
  }
  buildCounterReport--;
}
...
core.List<api.UrlChannel> buildUnnamed5224() {
  var o = <api.UrlChannel>[];
...
void checkUnnamed5224(core.List<api.UrlChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void main() {
  ...
  unittest.group('resource-AccountsResource', () {
    ...
    unittest.test('method--list', () async {
      var mock = HttpServerMock();
      var res = api.AdSenseHostApi(mock).accounts;
      var arg_filterAdClientId = buildUnnamed5225();
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group('resource-AccountsAdunitsResource', () {
    ...
    unittest.test('method--getAdCode', () async {
      ...
      var arg_adClientId = 'foo';
      var arg_adUnitId = 'foo';
      var arg_hostCustomChannelId = buildUnnamed5226();
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group('resource-AccountsReportsResource', () {
    unittest.test('method--generate', () async {
      ...
      var arg_endDate = 'foo';
      var arg_dimension = buildUnnamed5227();
      var arg_filter = buildUnnamed5228();
      var arg_locale = 'foo';
      var arg_maxResults = 42;
      var arg_metric = buildUnnamed5229();
      var arg_sort = buildUnnamed5230();
  ...
  unittest.group('resource-AssociationsessionsResource', () {
    unittest.test('method--start', () async {
      ...
      var arg_productCode = buildUnnamed5231();
  ...
  unittest.group('resource-ReportsResource', () {
    unittest.test('method--generate', () async {
      ...
      var arg_startDate = 'foo';
      var arg_endDate = 'foo';
      var arg_dimension = buildUnnamed5232();
      var arg_filter = buildUnnamed5233();
      var arg_locale = 'foo';
      var arg_maxResults = 42;
      var arg_metric = buildUnnamed5234();
      var arg_sort = buildUnnamed5235();
      var arg_startIndex = 42;
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
