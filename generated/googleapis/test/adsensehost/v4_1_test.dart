...
core.List<api.Account> buildUnnamed5758() => [
      buildAccount(),
      buildAccount(),
    ];

void checkUnnamed5758(core.List<api.Account> o) {
...
core.List<api.AdClient> buildUnnamed5759() => [
      buildAdClient(),
      buildAdClient(),
    ];

void checkUnnamed5759(core.List<api.AdClient> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdClient(o[0]);
  checkAdClient(o[1]);
}
...
core.List<api.AdUnit> buildUnnamed5760() => [
      buildAdUnit(),
      buildAdUnit(),
    ];

void checkUnnamed5760(core.List<api.AdUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdUnit(o[0]);
  checkAdUnit(o[1]);
}
...
api.AssociationSession buildAssociationSession() {
  ...
  if (buildCounterAssociationSession < 3) {
    ...
    o.id = 'foo';
    o.kind = 'foo';
    o.productCodes = buildUnnamed5761();
    o.redirectUrl = 'foo';
    o.status = 'foo';
    o.userLocale = 'foo';
    o.websiteLocale = 'foo';
...
void checkAssociationSession(api.AssociationSession o) {
  ...
  if (buildCounterAssociationSession < 3) {
    ...
    checkUnnamed5761(o.productCodes!);
    unittest.expect(
      o.redirectUrl!,
      unittest.equals('foo'),
    );
...
core.List<api.CustomChannel> buildUnnamed5762() => [
      buildCustomChannel(),
      buildCustomChannel(),
    ];

void checkUnnamed5762(core.List<api.CustomChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.String> buildUnnamed5763() => [
      'foo',
      'foo',
    ];

void checkUnnamed5763(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.ReportHeaders> buildUnnamed5764() => [
      buildReportHeaders(),
      buildReportHeaders(),
    ];

void checkUnnamed5764(core.List<api.ReportHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.List<core.String>> buildUnnamed5766() => [
      buildUnnamed5765(),
      buildUnnamed5765(),
    ];

void checkUnnamed5766(core.List<core.List<core.String>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed5765(o[0]);
  checkUnnamed5765(o[1]);
}
...
api.Report buildReport() {
  ...
  if (buildCounterReport < 3) {
    o.averages = buildUnnamed5763();
    o.headers = buildUnnamed5764();
    o.kind = 'foo';
    o.rows = buildUnnamed5766();
    o.totalMatchedRows = 'foo';
    o.totals = buildUnnamed5767();
    o.warnings = buildUnnamed5768();
  }
  buildCounterReport--;
  return o;
}
...
void checkReport(api.Report o) {
  buildCounterReport++;
  if (buildCounterReport < 3) {
    checkUnnamed5763(o.averages!);
    checkUnnamed5764(o.headers!);
    unittest.expect(
      o.kind!,
      unittest.equals('foo'),
    );
    checkUnnamed5766(o.rows!);
    unittest.expect(
      o.totalMatchedRows!,
      unittest.equals('foo'),
    );
    checkUnnamed5767(o.totals!);
    checkUnnamed5768(o.warnings!);
  }
  buildCounterReport--;
}
...
core.List<api.UrlChannel> buildUnnamed5769() => [
      buildUrlChannel(),
      buildUrlChannel(),
    ];

void checkUnnamed5769(core.List<api.UrlChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUrlChannel(o[0]);
  checkUrlChannel(o[1]);
}
...
void main() {
  ...
  unittest.group('resource-AccountsResource', () {
    ...
    unittest.test('method--list', () async {
      final mock = HttpServerMock();
      final res = api.AdSenseHostApi(mock).accounts;
      final arg_filterAdClientId = buildUnnamed5770();
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group('resource-AccountsAdunitsResource', () {
    ...
    unittest.test('method--getAdCode', () async {
      ...
      final arg_adClientId = 'foo';
      final arg_adUnitId = 'foo';
      final arg_hostCustomChannelId = buildUnnamed5771();
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group('resource-AccountsReportsResource', () {
    unittest.test('method--generate', () async {
      ...
      final arg_dimension = buildUnnamed5772();
      final arg_filter = buildUnnamed5773();
      final arg_locale = 'foo';
      final arg_maxResults = 42;
      final arg_metric = buildUnnamed5774();
      final arg_sort = buildUnnamed5775();
  ...
  unittest.group('resource-AssociationsessionsResource', () {
    unittest.test('method--start', () async {
      ...
      final arg_productCode = buildUnnamed5776();
  ...
  unittest.group('resource-ReportsResource', () {
    unittest.test('method--generate', () async {
      ...
      final arg_startDate = 'foo';
      final arg_endDate = 'foo';
      final arg_dimension = buildUnnamed5777();
      final arg_filter = buildUnnamed5778();
      final arg_locale = 'foo';
      final arg_maxResults = 42;
      final arg_metric = buildUnnamed5779();
      final arg_sort = buildUnnamed5780();
      final arg_startIndex = 42;
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final path = (req.url).path;
