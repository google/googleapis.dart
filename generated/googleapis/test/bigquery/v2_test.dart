...
core.List<core.double> buildUnnamed1350() {
  var o = <core.double>[];
  o.add(42.0);
  o.add(42.0);
  return o;
...
void checkUnnamed1350(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}

core.List<core.double> buildUnnamed1351() {
  var o = <core.double>[];
  o.add(42.0);
  o.add(42.0);
  return o;
...
void checkUnnamed1351(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}
...
api.ArimaCoefficients buildArimaCoefficients() {
  ...
  if (buildCounterArimaCoefficients < 3) {
    o.autoRegressiveCoefficients = buildUnnamed1350();
    o.interceptCoefficient = 42.0;
    o.movingAverageCoefficients = buildUnnamed1351();
  }
  buildCounterArimaCoefficients--;
  return o;
}
...
void checkArimaCoefficients(api.ArimaCoefficients o) {
  buildCounterArimaCoefficients++;
  if (buildCounterArimaCoefficients < 3) {
    checkUnnamed1350(o.autoRegressiveCoefficients);
    unittest.expect(o.interceptCoefficient, unittest.equals(42.0));
    checkUnnamed1351(o.movingAverageCoefficients);
  }
  buildCounterArimaCoefficients--;
}
...
core.List<api.ArimaFittingMetrics> buildUnnamed1352() {
  var o = <api.ArimaFittingMetrics>[];
...
void checkUnnamed1352(core.List<api.ArimaFittingMetrics> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkArimaFittingMetrics(o[0] as api.ArimaFittingMetrics);
  checkArimaFittingMetrics(o[1] as api.ArimaFittingMetrics);
}

core.List<api.ArimaSingleModelForecastingMetrics> buildUnnamed1353() {
...
void checkUnnamed1353(core.List<api.ArimaSingleModelForecastingMetrics> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.bool> buildUnnamed1354() {
  var o = <core.bool>[];
  o.add(true);
  o.add(true);
  return o;
...
void checkUnnamed1354(core.List<core.bool> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.isTrue);
  unittest.expect(o[1], unittest.isTrue);
}

core.List<api.ArimaOrder> buildUnnamed1355() {
...
void checkUnnamed1355(core.List<api.ArimaOrder> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkArimaOrder(o[0] as api.ArimaOrder);
  checkArimaOrder(o[1] as api.ArimaOrder);
}

core.List<core.String> buildUnnamed1356() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed1356(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ArimaForecastingMetrics buildArimaForecastingMetrics() {
  ...
  if (buildCounterArimaForecastingMetrics < 3) {
    o.arimaFittingMetrics = buildUnnamed1352();
    o.arimaSingleModelForecastingMetrics = buildUnnamed1353();
    o.hasDrift = buildUnnamed1354();
    o.nonSeasonalOrder = buildUnnamed1355();
    o.seasonalPeriods = buildUnnamed1356();
    o.timeSeriesId = buildUnnamed1357();
  }
  buildCounterArimaForecastingMetrics--;
  return o;
}
...
void checkArimaForecastingMetrics(api.ArimaForecastingMetrics o) {
  buildCounterArimaForecastingMetrics++;
  if (buildCounterArimaForecastingMetrics < 3) {
    checkUnnamed1352(o.arimaFittingMetrics);
    checkUnnamed1353(o.arimaSingleModelForecastingMetrics);
    checkUnnamed1354(o.hasDrift);
    checkUnnamed1355(o.nonSeasonalOrder);
    checkUnnamed1356(o.seasonalPeriods);
    checkUnnamed1357(o.timeSeriesId);
  }
  buildCounterArimaForecastingMetrics--;
}
...
api.ArimaModelInfo buildArimaModelInfo() {
  ...
  if (buildCounterArimaModelInfo < 3) {
    ...
    o.seasonalPeriods = buildUnnamed1358();
    o.timeSeriesId = 'foo';
  }
  buildCounterArimaModelInfo--;
  return o;
...
void checkArimaModelInfo(api.ArimaModelInfo o) {
  ...
  if (buildCounterArimaModelInfo < 3) {
    ...
    checkUnnamed1358(o.seasonalPeriods);
...
core.List<api.ArimaModelInfo> buildUnnamed1359() {
  var o = <api.ArimaModelInfo>[];
...
void checkUnnamed1359(core.List<api.ArimaModelInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkArimaModelInfo(o[0] as api.ArimaModelInfo);
  checkArimaModelInfo(o[1] as api.ArimaModelInfo);
}

core.List<core.String> buildUnnamed1360() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed1360(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
api.ArimaResult buildArimaResult() {
  ...
  if (buildCounterArimaResult < 3) {
    o.arimaModelInfo = buildUnnamed1359();
    o.seasonalPeriods = buildUnnamed1360();
  }
  buildCounterArimaResult--;
  return o;
}
...
void checkArimaResult(api.ArimaResult o) {
  buildCounterArimaResult++;
  if (buildCounterArimaResult < 3) {
    checkUnnamed1359(o.arimaModelInfo);
    checkUnnamed1360(o.seasonalPeriods);
  }
  buildCounterArimaResult--;
}

core.List<core.String> buildUnnamed1361() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed1361(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
api.ArimaSingleModelForecastingMetrics
  ...
  if (buildCounterArimaSingleModelForecastingMetrics < 3) {
    ...
    o.hasDrift = true;
    o.nonSeasonalOrder = buildArimaOrder();
    o.seasonalPeriods = buildUnnamed1361();
    o.timeSeriesId = 'foo';
  }
  buildCounterArimaSingleModelForecastingMetrics--;
  return o;
...
void checkArimaSingleModelForecastingMetrics(
  ...
  if (buildCounterArimaSingleModelForecastingMetrics < 3) {
    ...
    unittest.expect(o.hasDrift, unittest.isTrue);
    checkArimaOrder(o.nonSeasonalOrder as api.ArimaOrder);
    checkUnnamed1361(o.seasonalPeriods);
    unittest.expect(o.timeSeriesId, unittest.equals('foo'));
  }
  buildCounterArimaSingleModelForecastingMetrics--;
}

core.List<api.AuditLogConfig> buildUnnamed1362() {
...
void checkUnnamed1362(core.List<api.AuditLogConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AuditConfig buildAuditConfig() {
  ...
  if (buildCounterAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed1362();
    o.service = 'foo';
  }
  buildCounterAuditConfig--;
  return o;
...
void checkAuditConfig(api.AuditConfig o) {
  buildCounterAuditConfig++;
  if (buildCounterAuditConfig < 3) {
    checkUnnamed1362(o.auditLogConfigs);
...
api.AuditLogConfig buildAuditLogConfig() {
  ...
  if (buildCounterAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed1363();
    o.logType = 'foo';
  }
  buildCounterAuditLogConfig--;
  return o;
...
void checkAuditLogConfig(api.AuditLogConfig o) {
  buildCounterAuditLogConfig++;
  if (buildCounterAuditLogConfig < 3) {
    checkUnnamed1363(o.exemptedMembers);
...
core.List<api.BigtableColumn> buildUnnamed1364() {
  var o = <api.BigtableColumn>[];
...
void checkUnnamed1364(core.List<api.BigtableColumn> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.BigtableColumnFamily> buildUnnamed1365() {
  var o = <api.BigtableColumnFamily>[];
...
void checkUnnamed1365(core.List<api.BigtableColumnFamily> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BigtableOptions buildBigtableOptions() {
  ...
  if (buildCounterBigtableOptions < 3) {
    o.columnFamilies = buildUnnamed1365();
...
void checkBigtableOptions(api.BigtableOptions o) {
  buildCounterBigtableOptions++;
  if (buildCounterBigtableOptions < 3) {
    checkUnnamed1365(o.columnFamilies);
...
core.List<api.BinaryConfusionMatrix> buildUnnamed1366() {
...
void checkUnnamed1366(core.List<api.BinaryConfusionMatrix> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BinaryClassificationMetrics buildBinaryClassificationMetrics() {
  ...
  if (buildCounterBinaryClassificationMetrics < 3) {
    ...
    o.binaryConfusionMatrixList = buildUnnamed1366();
    o.negativeLabel = 'foo';
    o.positiveLabel = 'foo';
  }
  buildCounterBinaryClassificationMetrics--;
...
void checkBinaryClassificationMetrics(api.BinaryClassificationMetrics o) {
  ...
  if (buildCounterBinaryClassificationMetrics < 3) {
    ...
    checkUnnamed1366(o.binaryConfusionMatrixList);
...
core.List<api.BqmlIterationResult> buildUnnamed1368() {
  var o = <api.BqmlIterationResult>[];
...
void checkUnnamed1368(core.List<api.BqmlIterationResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BqmlTrainingRun buildBqmlTrainingRun() {
  ...
  if (buildCounterBqmlTrainingRun < 3) {
    o.iterationResults = buildUnnamed1368();
...
void checkBqmlTrainingRun(api.BqmlTrainingRun o) {
  buildCounterBqmlTrainingRun++;
  if (buildCounterBqmlTrainingRun < 3) {
    checkUnnamed1368(o.iterationResults);
...
core.List<api.CategoryCount> buildUnnamed1369() {
...
void checkUnnamed1369(core.List<api.CategoryCount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.CategoricalValue buildCategoricalValue() {
  ...
  if (buildCounterCategoricalValue < 3) {
    o.categoryCounts = buildUnnamed1369();
  }
  buildCounterCategoricalValue--;
  return o;
}
...
void checkCategoricalValue(api.CategoricalValue o) {
  buildCounterCategoricalValue++;
  if (buildCounterCategoricalValue < 3) {
    checkUnnamed1369(o.categoryCounts);
  }
  buildCounterCategoricalValue--;
}
...
core.List<api.FeatureValue> buildUnnamed1370() {
...
void checkUnnamed1370(core.List<api.FeatureValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Cluster buildCluster() {
  ...
  if (buildCounterCluster < 3) {
    o.centroidId = 'foo';
    o.count = 'foo';
    o.featureValues = buildUnnamed1370();
  }
  buildCounterCluster--;
  return o;
}
...
void checkCluster(api.Cluster o) {
  ...
  if (buildCounterCluster < 3) {
    ...
    unittest.expect(o.count, unittest.equals('foo'));
    checkUnnamed1370(o.featureValues);
  }
  buildCounterCluster--;
}
...
void checkClustering(api.Clustering o) {
  buildCounterClustering++;
  if (buildCounterClustering < 3) {
    checkUnnamed1371(o.fields);
  }
  buildCounterClustering--;
}

core.List<api.Cluster> buildUnnamed1372() {
  var o = <api.Cluster>[];
  o.add(buildCluster());
  o.add(buildCluster());
  return o;
...
void checkUnnamed1372(core.List<api.Cluster> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Row> buildUnnamed1373() {
  var o = <api.Row>[];
  o.add(buildRow());
  o.add(buildRow());
  return o;
...
void checkUnnamed1373(core.List<api.Row> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.DatasetAccess> buildUnnamed1374() {
  var o = <api.DatasetAccess>[];
...
void checkUnnamed1374(core.List<api.DatasetAccess> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDatasetAccess(o[0] as api.DatasetAccess);
  checkDatasetAccess(o[1] as api.DatasetAccess);
}

core.Map<core.String, core.String> buildUnnamed1375() {
...
void checkUnnamed1375(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.DatasetAccessEntryTargetTypes> buildUnnamed1376() {
  var o = <api.DatasetAccessEntryTargetTypes>[];
...
void checkUnnamed1376(core.List<api.DatasetAccessEntryTargetTypes> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DatasetAccessEntry buildDatasetAccessEntry() {
  ...
  if (buildCounterDatasetAccessEntry < 3) {
    ...
    o.targetTypes = buildUnnamed1376();
  }
  buildCounterDatasetAccessEntry--;
  return o;
}
...
void checkDatasetAccessEntry(api.DatasetAccessEntry o) {
  ...
  if (buildCounterDatasetAccessEntry < 3) {
    ...
    checkUnnamed1376(o.targetTypes);
  }
  buildCounterDatasetAccessEntry--;
}

core.Map<core.String, core.String> buildUnnamed1377() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed1377(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o['x'], unittest.equals('foo'));
  unittest.expect(o['y'], unittest.equals('foo'));
}
...
core.List<api.DatasetListDatasets> buildUnnamed1378() {
  var o = <api.DatasetListDatasets>[];
...
void checkUnnamed1378(core.List<api.DatasetListDatasets> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.String> buildUnnamed1379() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed1379(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o['x'], unittest.equals('foo'));
  unittest.expect(o['y'], unittest.equals('foo'));
}
...
api.DimensionalityReductionMetrics buildDimensionalityReductionMetrics() {
  var o = api.DimensionalityReductionMetrics();
...
void checkEvaluationMetrics(api.EvaluationMetrics o) {
  ...
  if (buildCounterEvaluationMetrics < 3) {
    ...
    checkDimensionalityReductionMetrics(
        o.dimensionalityReductionMetrics as api.DimensionalityReductionMetrics);
...
core.List<api.ExplainQueryStep> buildUnnamed1381() {
...
void checkUnnamed1381(core.List<api.ExplainQueryStep> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ExplainQueryStage buildExplainQueryStage() {
  ...
  if (buildCounterExplainQueryStage < 3) {
    ...
    o.endMs = 'foo';
    o.id = 'foo';
    o.inputStages = buildUnnamed1380();
    o.name = 'foo';
...
void checkExplainQueryStage(api.ExplainQueryStage o) {
  ...
  if (buildCounterExplainQueryStage < 3) {
    ...
    unittest.expect(o.id, unittest.equals('foo'));
    checkUnnamed1380(o.inputStages);
    unittest.expect(o.name, unittest.equals('foo'));
...
core.List<api.ErrorProto> buildUnnamed1384() {
  var o = <api.ErrorProto>[];
...
void checkUnnamed1384(core.List<api.ErrorProto> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkErrorProto(o[0] as api.ErrorProto);
  checkErrorProto(o[1] as api.ErrorProto);
}

core.List<api.TableRow> buildUnnamed1385() {
  var o = <api.TableRow>[];
  o.add(buildTableRow());
  o.add(buildTableRow());
  return o;
...
void checkUnnamed1385(core.List<api.TableRow> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Explanation> buildUnnamed1386() {
  var o = <api.Explanation>[];
...
void checkUnnamed1386(core.List<api.Explanation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GlobalExplanation buildGlobalExplanation() {
  ...
  if (buildCounterGlobalExplanation < 3) {
    o.classLabel = 'foo';
    o.explanations = buildUnnamed1386();
  }
  buildCounterGlobalExplanation--;
  return o;
}
...
void checkGlobalExplanation(api.GlobalExplanation o) {
  ...
  if (buildCounterGlobalExplanation < 3) {
    ...
    checkUnnamed1386(o.explanations);
  }
  buildCounterGlobalExplanation--;
}
...
core.List<api.ClusterInfo> buildUnnamed1387() {
  var o = <api.ClusterInfo>[];
...
void checkUnnamed1387(core.List<api.ClusterInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkClusterInfo(o[0] as api.ClusterInfo);
  checkClusterInfo(o[1] as api.ClusterInfo);
}

core.List<api.PrincipalComponentInfo> buildUnnamed1388() {
  var o = <api.PrincipalComponentInfo>[];
  o.add(buildPrincipalComponentInfo());
  o.add(buildPrincipalComponentInfo());
  return o;
}

void checkUnnamed1388(core.List<api.PrincipalComponentInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPrincipalComponentInfo(o[0] as api.PrincipalComponentInfo);
  checkPrincipalComponentInfo(o[1] as api.PrincipalComponentInfo);
}
...
api.IterationResult buildIterationResult() {
  ...
  if (buildCounterIterationResult < 3) {
    ...
    o.clusterInfos = buildUnnamed1387();
    o.durationMs = 'foo';
    o.evalLoss = 42.0;
    o.index = 42;
    o.learnRate = 42.0;
    o.principalComponentInfos = buildUnnamed1388();
    o.trainingLoss = 42.0;
  }
  buildCounterIterationResult--;
  return o;
...
void checkIterationResult(api.IterationResult o) {
  ...
  if (buildCounterIterationResult < 3) {
    ...
    checkUnnamed1387(o.clusterInfos);
    unittest.expect(o.durationMs, unittest.equals('foo'));
    unittest.expect(o.evalLoss, unittest.equals(42.0));
    unittest.expect(o.index, unittest.equals(42));
    unittest.expect(o.learnRate, unittest.equals(42.0));
    checkUnnamed1388(o.principalComponentInfos);
    unittest.expect(o.trainingLoss, unittest.equals(42.0));
  }
  buildCounterIterationResult--;
}
...
core.Map<core.String, core.String> buildUnnamed1389() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed1389(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o['x'], unittest.equals('foo'));
  unittest.expect(o['y'], unittest.equals('foo'));
}
...
core.List<core.String> buildUnnamed1390() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed1390(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
api.JobConfigurationExtract buildJobConfigurationExtract() {
  ...
  if (buildCounterJobConfigurationExtract < 3) {
    ...
    o.destinationUris = buildUnnamed1390();
    o.fieldDelimiter = 'foo';
    o.printHeader = true;
...
void checkJobConfigurationExtract(api.JobConfigurationExtract o) {
  ...
  if (buildCounterJobConfigurationExtract < 3) {
    ...
    checkUnnamed1390(o.destinationUris);
    unittest.expect(o.fieldDelimiter, unittest.equals('foo'));
...
core.List<core.String> buildUnnamed1391() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed1391(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}

core.List<core.String> buildUnnamed1392() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed1392(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
api.JobConfigurationLoad buildJobConfigurationLoad() {
  ...
  if (buildCounterJobConfigurationLoad < 3) {
    ...
    o.decimalTargetTypes = buildUnnamed1391();
    ...
    o.maxBadRecords = 42;
    o.nullMarker = 'foo';
    o.projectionFields = buildUnnamed1392();
    o.quote = 'foo';
    o.rangePartitioning = buildRangePartitioning();
    o.schema = buildTableSchema();
    o.schemaInline = 'foo';
    o.schemaInlineFormat = 'foo';
    o.schemaUpdateOptions = buildUnnamed1393();
    o.skipLeadingRows = 42;
    o.sourceFormat = 'foo';
    o.sourceUris = buildUnnamed1394();
...
void checkJobConfigurationLoad(api.JobConfigurationLoad o) {
  ...
  if (buildCounterJobConfigurationLoad < 3) {
    ...
    checkUnnamed1391(o.decimalTargetTypes);
    checkEncryptionConfiguration(
    ...
    checkUnnamed1392(o.projectionFields);
    unittest.expect(o.quote, unittest.equals('foo'));
    ...
    checkUnnamed1393(o.schemaUpdateOptions);
    unittest.expect(o.skipLeadingRows, unittest.equals(42));
    unittest.expect(o.sourceFormat, unittest.equals('foo'));
    checkUnnamed1394(o.sourceUris);
...
core.List<api.ConnectionProperty> buildUnnamed1395() {
  var o = <api.ConnectionProperty>[];
...
void checkUnnamed1396(core.List<api.QueryParameter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, api.ExternalDataConfiguration> buildUnnamed1398() {
...
void checkUnnamed1398(core.Map<core.String, api.ExternalDataConfiguration> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.UserDefinedFunctionResource> buildUnnamed1399() {
...
void checkUnnamed1399(core.List<api.UserDefinedFunctionResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.JobConfigurationQuery buildJobConfigurationQuery() {
  ...
  if (buildCounterJobConfigurationQuery < 3) {
    ...
    o.clustering = buildClustering();
    o.connectionProperties = buildUnnamed1395();
    o.createDisposition = 'foo';
    ...
    o.priority = 'foo';
    o.query = 'foo';
    o.queryParameters = buildUnnamed1396();
    o.rangePartitioning = buildRangePartitioning();
    o.schemaUpdateOptions = buildUnnamed1397();
    o.tableDefinitions = buildUnnamed1398();
    o.timePartitioning = buildTimePartitioning();
    o.useLegacySql = true;
    o.useQueryCache = true;
    o.userDefinedFunctionResources = buildUnnamed1399();
    o.writeDisposition = 'foo';
  }
  buildCounterJobConfigurationQuery--;
  return o;
...
void checkJobConfigurationQuery(api.JobConfigurationQuery o) {
  ...
  if (buildCounterJobConfigurationQuery < 3) {
    ...
    checkClustering(o.clustering as api.Clustering);
    checkUnnamed1395(o.connectionProperties);
    unittest.expect(o.createDisposition, unittest.equals('foo'));
    ...
    checkUnnamed1396(o.queryParameters);
    checkRangePartitioning(o.rangePartitioning as api.RangePartitioning);
    checkUnnamed1397(o.schemaUpdateOptions);
    checkUnnamed1398(o.tableDefinitions);
    checkTimePartitioning(o.timePartitioning as api.TimePartitioning);
    unittest.expect(o.useLegacySql, unittest.isTrue);
    unittest.expect(o.useQueryCache, unittest.isTrue);
    checkUnnamed1399(o.userDefinedFunctionResources);
    unittest.expect(o.writeDisposition, unittest.equals('foo'));
  }
  buildCounterJobConfigurationQuery--;
}

core.List<api.TableReference> buildUnnamed1400() {
...
void checkUnnamed1400(core.List<api.TableReference> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.JobConfigurationTableCopy buildJobConfigurationTableCopy() {
  ...
  if (buildCounterJobConfigurationTableCopy < 3) {
    ...
    o.operationType = 'foo';
    o.sourceTable = buildTableReference();
    o.sourceTables = buildUnnamed1400();
    o.writeDisposition = 'foo';
  }
  buildCounterJobConfigurationTableCopy--;
  return o;
...
void checkJobConfigurationTableCopy(api.JobConfigurationTableCopy o) {
  ...
  if (buildCounterJobConfigurationTableCopy < 3) {
    ...
    checkTableReference(o.sourceTable as api.TableReference);
    checkUnnamed1400(o.sourceTables);
    unittest.expect(o.writeDisposition, unittest.equals('foo'));
  }
  buildCounterJobConfigurationTableCopy--;
}
...
core.List<api.JobListJobs> buildUnnamed1401() {
  var o = <api.JobListJobs>[];
...
void checkUnnamed1401(core.List<api.JobListJobs> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.JobStatisticsReservationUsage> buildUnnamed1403() {
  var o = <api.JobStatisticsReservationUsage>[];
...
void checkUnnamed1403(core.List<api.JobStatisticsReservationUsage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.JobStatistics buildJobStatistics() {
  ...
  if (buildCounterJobStatistics < 3) {
    ...
    o.quotaDeferments = buildUnnamed1402();
    o.reservationUsage = buildUnnamed1403();
    o.reservationId = 'foo';
...
void checkJobStatistics(api.JobStatistics o) {
  ...
  if (buildCounterJobStatistics < 3) {
    ...
    checkUnnamed1402(o.quotaDeferments);
    checkUnnamed1403(o.reservationUsage);
...
core.List<api.ExplainQueryStage> buildUnnamed1404() {
  var o = <api.ExplainQueryStage>[];
...
void checkUnnamed1404(core.List<api.ExplainQueryStage> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkExplainQueryStage(o[0] as api.ExplainQueryStage);
  checkExplainQueryStage(o[1] as api.ExplainQueryStage);
}

core.List<api.RoutineReference> buildUnnamed1405() {
...
void checkUnnamed1405(core.List<api.RoutineReference> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRoutineReference(o[0] as api.RoutineReference);
  checkRoutineReference(o[1] as api.RoutineReference);
}

core.List<api.TableReference> buildUnnamed1406() {
  var o = <api.TableReference>[];
  o.add(buildTableReference());
  o.add(buildTableReference());
  return o;
...
void checkUnnamed1406(core.List<api.TableReference> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTableReference(o[0] as api.TableReference);
  checkTableReference(o[1] as api.TableReference);
}
...
core.List<api.JobStatistics2ReservationUsage> buildUnnamed1407() {
  var o = <api.JobStatistics2ReservationUsage>[];
...
void checkUnnamed1407(core.List<api.JobStatistics2ReservationUsage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.QueryTimelineSample> buildUnnamed1408() {
...
void checkUnnamed1409(core.List<api.QueryParameter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQueryParameter(o[0] as api.QueryParameter);
  checkQueryParameter(o[1] as api.QueryParameter);
}
...
api.JobStatistics2 buildJobStatistics2() {
  ...
  if (buildCounterJobStatistics2 < 3) {
    ...
    o.numDmlAffectedRows = 'foo';
    o.queryPlan = buildUnnamed1404();
    o.referencedRoutines = buildUnnamed1405();
    o.referencedTables = buildUnnamed1406();
    o.reservationUsage = buildUnnamed1407();
    o.schema = buildTableSchema();
    o.statementType = 'foo';
    o.timeline = buildUnnamed1408();
    o.totalBytesBilled = 'foo';
    o.totalBytesProcessed = 'foo';
    o.totalBytesProcessedAccuracy = 'foo';
    o.totalPartitionsProcessed = 'foo';
    o.totalSlotMs = 'foo';
    o.undeclaredQueryParameters = buildUnnamed1409();
  }
  buildCounterJobStatistics2--;
  return o;
}
...
void checkJobStatistics2(api.JobStatistics2 o) {
  ...
  if (buildCounterJobStatistics2 < 3) {
    ...
    unittest.expect(o.numDmlAffectedRows, unittest.equals('foo'));
    checkUnnamed1404(o.queryPlan);
    checkUnnamed1405(o.referencedRoutines);
    checkUnnamed1406(o.referencedTables);
    checkUnnamed1407(o.reservationUsage);
    checkTableSchema(o.schema as api.TableSchema);
    unittest.expect(o.statementType, unittest.equals('foo'));
    checkUnnamed1408(o.timeline);
    ...
    unittest.expect(o.totalSlotMs, unittest.equals('foo'));
    checkUnnamed1409(o.undeclaredQueryParameters);
  }
  buildCounterJobStatistics2--;
}
...
api.JobStatistics4 buildJobStatistics4() {
  ...
  if (buildCounterJobStatistics4 < 3) {
    o.destinationUriFileCounts = buildUnnamed1410();
    o.inputBytes = 'foo';
  }
  buildCounterJobStatistics4--;
  return o;
...
void checkJobStatistics4(api.JobStatistics4 o) {
  buildCounterJobStatistics4++;
  if (buildCounterJobStatistics4 < 3) {
    checkUnnamed1410(o.destinationUriFileCounts);
    unittest.expect(o.inputBytes, unittest.equals('foo'));
  }
  buildCounterJobStatistics4--;
}

core.List<api.ErrorProto> buildUnnamed1411() {
  var o = <api.ErrorProto>[];
  o.add(buildErrorProto());
  o.add(buildErrorProto());
  return o;
...
void checkUnnamed1411(core.List<api.ErrorProto> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkErrorProto(o[0] as api.ErrorProto);
  checkErrorProto(o[1] as api.ErrorProto);
}
...
core.List<api.Model> buildUnnamed1412() {
  var o = <api.Model>[];
  o.add(buildModel());
  o.add(buildModel());
  return o;
...
void checkUnnamed1412(core.List<api.Model> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListModelsResponse(api.ListModelsResponse o) {
  buildCounterListModelsResponse++;
  if (buildCounterListModelsResponse < 3) {
    checkUnnamed1412(o.models);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListModelsResponse--;
}

core.List<api.Routine> buildUnnamed1413() {
  var o = <api.Routine>[];
  o.add(buildRoutine());
  o.add(buildRoutine());
  return o;
...
void checkUnnamed1413(core.List<api.Routine> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListRoutinesResponse(api.ListRoutinesResponse o) {
  ...
  if (buildCounterListRoutinesResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed1413(o.routines);
  }
  buildCounterListRoutinesResponse--;
}

core.List<api.RowAccessPolicy> buildUnnamed1414() {
...
void checkUnnamed1414(core.List<api.RowAccessPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListRowAccessPoliciesResponse buildListRowAccessPoliciesResponse() {
  ...
  if (buildCounterListRowAccessPoliciesResponse < 3) {
    o.nextPageToken = 'foo';
    o.rowAccessPolicies = buildUnnamed1414();
  }
  buildCounterListRowAccessPoliciesResponse--;
  return o;
}
...
void checkListRowAccessPoliciesResponse(api.ListRowAccessPoliciesResponse o) {
  ...
  if (buildCounterListRowAccessPoliciesResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed1414(o.rowAccessPolicies);
  }
  buildCounterListRowAccessPoliciesResponse--;
}
...
core.List<api.StandardSqlField> buildUnnamed1415() {
...
void checkUnnamed1415(core.List<api.StandardSqlField> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStandardSqlField(o[0] as api.StandardSqlField);
  checkStandardSqlField(o[1] as api.StandardSqlField);
}

core.List<api.StandardSqlField> buildUnnamed1416() {
  var o = <api.StandardSqlField>[];
  o.add(buildStandardSqlField());
  o.add(buildStandardSqlField());
  return o;
...
void checkUnnamed1416(core.List<api.StandardSqlField> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStandardSqlField(o[0] as api.StandardSqlField);
  checkStandardSqlField(o[1] as api.StandardSqlField);
}

core.Map<core.String, core.String> buildUnnamed1417() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed1417(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o['x'], unittest.equals('foo'));
  unittest.expect(o['y'], unittest.equals('foo'));
}

core.List<api.TrainingRun> buildUnnamed1418() {
...
void checkUnnamed1418(core.List<api.TrainingRun> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Model buildModel() {
  ...
  if (buildCounterModel < 3) {
    ...
    o.featureColumns = buildUnnamed1415();
    o.friendlyName = 'foo';
    o.labelColumns = buildUnnamed1416();
    o.labels = buildUnnamed1417();
    o.lastModifiedTime = 'foo';
    o.location = 'foo';
    o.modelReference = buildModelReference();
    o.modelType = 'foo';
    o.trainingRuns = buildUnnamed1418();
  }
  buildCounterModel--;
  return o;
}
...
void checkModel(api.Model o) {
  ...
  if (buildCounterModel < 3) {
    ...
    checkUnnamed1415(o.featureColumns);
    unittest.expect(o.friendlyName, unittest.equals('foo'));
    checkUnnamed1416(o.labelColumns);
    checkUnnamed1417(o.labels);
    unittest.expect(o.lastModifiedTime, unittest.equals('foo'));
    unittest.expect(o.location, unittest.equals('foo'));
    checkModelReference(o.modelReference as api.ModelReference);
    unittest.expect(o.modelType, unittest.equals('foo'));
    checkUnnamed1418(o.trainingRuns);
  }
  buildCounterModel--;
}
...
core.List<api.BqmlTrainingRun> buildUnnamed1420() {
  var o = <api.BqmlTrainingRun>[];
...
void checkUnnamed1420(core.List<api.BqmlTrainingRun> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ModelDefinition buildModelDefinition() {
  ...
  if (buildCounterModelDefinition < 3) {
    ...
    o.trainingRuns = buildUnnamed1420();
  }
  buildCounterModelDefinition--;
  return o;
}
...
void checkModelDefinition(api.ModelDefinition o) {
  ...
  if (buildCounterModelDefinition < 3) {
    ...
    checkUnnamed1420(o.trainingRuns);
  }
  buildCounterModelDefinition--;
}
...
core.List<api.ConfusionMatrix> buildUnnamed1421() {
  var o = <api.ConfusionMatrix>[];
...
void checkUnnamed1421(core.List<api.ConfusionMatrix> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MultiClassClassificationMetrics buildMultiClassClassificationMetrics() {
  ...
  if (buildCounterMultiClassClassificationMetrics < 3) {
    o.aggregateClassificationMetrics = buildAggregateClassificationMetrics();
    o.confusionMatrixList = buildUnnamed1421();
  }
  buildCounterMultiClassClassificationMetrics--;
  return o;
}
...
void checkMultiClassClassificationMetrics(
  ...
  if (buildCounterMultiClassClassificationMetrics < 3) {
    checkAggregateClassificationMetrics(
        o.aggregateClassificationMetrics as api.AggregateClassificationMetrics);
    checkUnnamed1421(o.confusionMatrixList);
  }
  buildCounterMultiClassClassificationMetrics--;
}

core.List<api.AuditConfig> buildUnnamed1422() {
  var o = <api.AuditConfig>[];
...
void checkUnnamed1422(core.List<api.AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAuditConfig(o[0] as api.AuditConfig);
  checkAuditConfig(o[1] as api.AuditConfig);
}

core.List<api.Binding> buildUnnamed1423() {
  var o = <api.Binding>[];
  o.add(buildBinding());
  o.add(buildBinding());
  return o;
...
void checkUnnamed1423(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Policy buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.auditConfigs = buildUnnamed1422();
    o.bindings = buildUnnamed1423();
    o.etag = 'foo';
    o.version = 42;
  }
  buildCounterPolicy--;
...
void checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed1422(o.auditConfigs);
    checkUnnamed1423(o.bindings);
    unittest.expect(o.etag, unittest.equals('foo'));
...
core.List<api.ProjectListProjects> buildUnnamed1424() {
  var o = <api.ProjectListProjects>[];
...
void checkUnnamed1424(core.List<api.ProjectListProjects> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.QueryParameterTypeStructTypes> buildUnnamed1425() {
  var o = <api.QueryParameterTypeStructTypes>[];
...
void checkUnnamed1425(core.List<api.QueryParameterTypeStructTypes> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.QueryParameterType buildQueryParameterType() {
  ...
  if (buildCounterQueryParameterType < 3) {
    ...
    o.structTypes = buildUnnamed1425();
    o.type = 'foo';
  }
  buildCounterQueryParameterType--;
  return o;
...
void checkQueryParameterType(api.QueryParameterType o) {
  ...
  if (buildCounterQueryParameterType < 3) {
    ...
    checkUnnamed1425(o.structTypes);
    unittest.expect(o.type, unittest.equals('foo'));
  }
  buildCounterQueryParameterType--;
}

core.List<api.QueryParameterValue> buildUnnamed1426() {
...
void checkUnnamed1426(core.List<api.QueryParameterValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQueryParameterValue(o[0] as api.QueryParameterValue);
  checkQueryParameterValue(o[1] as api.QueryParameterValue);
}

core.Map<core.String, api.QueryParameterValue> buildUnnamed1427() {
...
void checkUnnamed1427(core.Map<core.String, api.QueryParameterValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.QueryParameterValue buildQueryParameterValue() {
  ...
  if (buildCounterQueryParameterValue < 3) {
    o.arrayValues = buildUnnamed1426();
    o.structValues = buildUnnamed1427();
    o.value = 'foo';
  }
  buildCounterQueryParameterValue--;
  return o;
...
void checkQueryParameterValue(api.QueryParameterValue o) {
  buildCounterQueryParameterValue++;
  if (buildCounterQueryParameterValue < 3) {
    checkUnnamed1426(o.arrayValues);
    checkUnnamed1427(o.structValues);
    unittest.expect(o.value, unittest.equals('foo'));
  }
  buildCounterQueryParameterValue--;
}

core.List<api.ConnectionProperty> buildUnnamed1428() {
  var o = <api.ConnectionProperty>[];
  o.add(buildConnectionProperty());
  o.add(buildConnectionProperty());
  return o;
...
void checkUnnamed1428(core.List<api.ConnectionProperty> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkConnectionProperty(o[0] as api.ConnectionProperty);
  checkConnectionProperty(o[1] as api.ConnectionProperty);
}

core.Map<core.String, core.String> buildUnnamed1429() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed1429(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o['x'], unittest.equals('foo'));
  unittest.expect(o['y'], unittest.equals('foo'));
}

core.List<api.QueryParameter> buildUnnamed1430() {
  var o = <api.QueryParameter>[];
  o.add(buildQueryParameter());
  o.add(buildQueryParameter());
  return o;
...
void checkUnnamed1430(core.List<api.QueryParameter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQueryParameter(o[0] as api.QueryParameter);
  checkQueryParameter(o[1] as api.QueryParameter);
}
...
api.QueryRequest buildQueryRequest() {
  ...
  if (buildCounterQueryRequest < 3) {
    o.connectionProperties = buildUnnamed1428();
    o.defaultDataset = buildDatasetReference();
    o.dryRun = true;
    o.kind = 'foo';
    ...
    o.preserveNulls = true;
    o.query = 'foo';
    o.queryParameters = buildUnnamed1430();
    o.requestId = 'foo';
    o.timeoutMs = 42;
    o.useLegacySql = true;
    o.useQueryCache = true;
...
void checkQueryRequest(api.QueryRequest o) {
  buildCounterQueryRequest++;
  if (buildCounterQueryRequest < 3) {
    checkUnnamed1428(o.connectionProperties);
    checkDatasetReference(o.defaultDataset as api.DatasetReference);
    unittest.expect(o.dryRun, unittest.isTrue);
    unittest.expect(o.kind, unittest.equals('foo'));
    ...
    unittest.expect(o.preserveNulls, unittest.isTrue);
    unittest.expect(o.query, unittest.equals('foo'));
    checkUnnamed1430(o.queryParameters);
...
core.List<api.ErrorProto> buildUnnamed1431() {
  var o = <api.ErrorProto>[];
  o.add(buildErrorProto());
  o.add(buildErrorProto());
  return o;
...
void checkUnnamed1431(core.List<api.ErrorProto> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkErrorProto(o[0] as api.ErrorProto);
  checkErrorProto(o[1] as api.ErrorProto);
}

core.List<api.TableRow> buildUnnamed1432() {
  var o = <api.TableRow>[];
  o.add(buildTableRow());
  o.add(buildTableRow());
  return o;
...
void checkUnnamed1432(core.List<api.TableRow> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTableRow(o[0] as api.TableRow);
  checkTableRow(o[1] as api.TableRow);
}
...
api.QueryResponse buildQueryResponse() {
  ...
  if (buildCounterQueryResponse < 3) {
    o.cacheHit = true;
    o.errors = buildUnnamed1431();
    o.jobComplete = true;
    o.jobReference = buildJobReference();
    o.kind = 'foo';
    o.numDmlAffectedRows = 'foo';
    o.pageToken = 'foo';
    o.rows = buildUnnamed1432();
    o.schema = buildTableSchema();
    o.totalBytesProcessed = 'foo';
    o.totalRows = 'foo';
  }
...
void checkQueryResponse(api.QueryResponse o) {
  ...
  if (buildCounterQueryResponse < 3) {
    unittest.expect(o.cacheHit, unittest.isTrue);
    checkUnnamed1431(o.errors);
    unittest.expect(o.jobComplete, unittest.isTrue);
    checkJobReference(o.jobReference as api.JobReference);
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.numDmlAffectedRows, unittest.equals('foo'));
    unittest.expect(o.pageToken, unittest.equals('foo'));
    checkUnnamed1432(o.rows);
    checkTableSchema(o.schema as api.TableSchema);
    unittest.expect(o.totalBytesProcessed, unittest.equals('foo'));
    unittest.expect(o.totalRows, unittest.equals('foo'));
  }
...
core.List<api.Argument> buildUnnamed1433() {
  var o = <api.Argument>[];
  o.add(buildArgument());
  o.add(buildArgument());
  return o;
...
void checkUnnamed1433(core.List<api.Argument> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Routine buildRoutine() {
  ...
  if (buildCounterRoutine < 3) {
    o.arguments = buildUnnamed1433();
    o.creationTime = 'foo';
    o.definitionBody = 'foo';
    o.description = 'foo';
    o.determinismLevel = 'foo';
    o.etag = 'foo';
    o.importedLibraries = buildUnnamed1434();
    o.language = 'foo';
    o.lastModifiedTime = 'foo';
...
core.List<api.Entry> buildUnnamed1435() {
  var o = <api.Entry>[];
  o.add(buildEntry());
  o.add(buildEntry());
  return o;
...
void checkUnnamed1435(core.List<api.Entry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ScriptStackFrame> buildUnnamed1436() {
  var o = <api.ScriptStackFrame>[];
...
void checkUnnamed1436(core.List<api.ScriptStackFrame> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ScriptStatistics buildScriptStatistics() {
  ...
  if (buildCounterScriptStatistics < 3) {
    ...
    o.stackFrames = buildUnnamed1436();
  }
  buildCounterScriptStatistics--;
  return o;
}
...
void checkScriptStatistics(api.ScriptStatistics o) {
  ...
  if (buildCounterScriptStatistics < 3) {
    ...
    checkUnnamed1436(o.stackFrames);
  }
  buildCounterScriptStatistics--;
}
...
core.List<api.StandardSqlField> buildUnnamed1437() {
  var o = <api.StandardSqlField>[];
  o.add(buildStandardSqlField());
  o.add(buildStandardSqlField());
  return o;
...
void checkUnnamed1437(core.List<api.StandardSqlField> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStandardSqlField(o[0] as api.StandardSqlField);
  checkStandardSqlField(o[1] as api.StandardSqlField);
}
...
core.Map<core.String, core.String> buildUnnamed1438() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed1438(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o['x'], unittest.equals('foo'));
  unittest.expect(o['y'], unittest.equals('foo'));
}
...
core.List<api.TableDataInsertAllRequestRows> buildUnnamed1439() {
  var o = <api.TableDataInsertAllRequestRows>[];
...
void checkUnnamed1439(core.List<api.TableDataInsertAllRequestRows> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ErrorProto> buildUnnamed1440() {
  var o = <api.ErrorProto>[];
  o.add(buildErrorProto());
  o.add(buildErrorProto());
  return o;
...
void checkUnnamed1440(core.List<api.ErrorProto> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkErrorProto(o[0] as api.ErrorProto);
  checkErrorProto(o[1] as api.ErrorProto);
}
...
void checkTableDataInsertAllResponseInsertErrors(
  ...
  buildCounterTableDataInsertAllResponseInsertErrors++;
  if (buildCounterTableDataInsertAllResponseInsertErrors < 3) {
    checkUnnamed1440(o.errors);
    unittest.expect(o.index, unittest.equals(42));
  }
  buildCounterTableDataInsertAllResponseInsertErrors--;
}

core.List<api.TableDataInsertAllResponseInsertErrors> buildUnnamed1441() {
  var o = <api.TableDataInsertAllResponseInsertErrors>[];
...
void checkUnnamed1441(core.List<api.TableDataInsertAllResponseInsertErrors> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TableDataInsertAllResponse buildTableDataInsertAllResponse() {
  ...
  if (buildCounterTableDataInsertAllResponse < 3) {
    o.insertErrors = buildUnnamed1441();
    o.kind = 'foo';
  }
  buildCounterTableDataInsertAllResponse--;
  return o;
...
void checkTableDataInsertAllResponse(api.TableDataInsertAllResponse o) {
  buildCounterTableDataInsertAllResponse++;
  if (buildCounterTableDataInsertAllResponse < 3) {
    checkUnnamed1441(o.insertErrors);
    unittest.expect(o.kind, unittest.equals('foo'));
  }
  buildCounterTableDataInsertAllResponse--;
}

core.List<api.TableRow> buildUnnamed1442() {
  var o = <api.TableRow>[];
  o.add(buildTableRow());
  o.add(buildTableRow());
  return o;
...
void checkUnnamed1442(core.List<api.TableRow> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTableRow(o[0] as api.TableRow);
  checkTableRow(o[1] as api.TableRow);
}
...
void checkTableDataList(api.TableDataList o) {
  ...
  if (buildCounterTableDataList < 3) {
    ...
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.pageToken, unittest.equals('foo'));
    checkUnnamed1442(o.rows);
    unittest.expect(o.totalRows, unittest.equals('foo'));
  }
  buildCounterTableDataList--;
}

core.List<core.String> buildUnnamed1443() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed1443(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
void checkTableFieldSchemaCategories(api.TableFieldSchemaCategories o) {
  buildCounterTableFieldSchemaCategories++;
  if (buildCounterTableFieldSchemaCategories < 3) {
    checkUnnamed1443(o.names);
  }
  buildCounterTableFieldSchemaCategories--;
}

core.List<api.TableFieldSchema> buildUnnamed1444() {
...
void checkUnnamed1444(core.List<api.TableFieldSchema> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.String> buildUnnamed1446() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed1446(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o['x'], unittest.equals('foo'));
  unittest.expect(o['y'], unittest.equals('foo'));
}
...
core.List<api.TableListTables> buildUnnamed1447() {
  var o = <api.TableListTables>[];
...
void checkUnnamed1447(core.List<api.TableListTables> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.TableCell> buildUnnamed1448() {
  var o = <api.TableCell>[];
...
void checkUnnamed1448(core.List<api.TableCell> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkTableRow(api.TableRow o) {
  buildCounterTableRow++;
  if (buildCounterTableRow < 3) {
    checkUnnamed1448(o.f);
  }
  buildCounterTableRow--;
}

core.List<api.TableFieldSchema> buildUnnamed1449() {
  var o = <api.TableFieldSchema>[];
  o.add(buildTableFieldSchema());
  o.add(buildTableFieldSchema());
  return o;
...
void checkUnnamed1449(core.List<api.TableFieldSchema> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTableFieldSchema(o[0] as api.TableFieldSchema);
  checkTableFieldSchema(o[1] as api.TableFieldSchema);
}
...
api.TestIamPermissionsRequest buildTestIamPermissionsRequest() {
  ...
  if (buildCounterTestIamPermissionsRequest < 3) {
    o.permissions = buildUnnamed1450();
  }
  buildCounterTestIamPermissionsRequest--;
  return o;
}
...
void checkTestIamPermissionsRequest(api.TestIamPermissionsRequest o) {
  buildCounterTestIamPermissionsRequest++;
  if (buildCounterTestIamPermissionsRequest < 3) {
    checkUnnamed1450(o.permissions);
  }
  buildCounterTestIamPermissionsRequest--;
}

core.List<core.String> buildUnnamed1451() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed1451(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
api.TestIamPermissionsResponse buildTestIamPermissionsResponse() {
  ...
  if (buildCounterTestIamPermissionsResponse < 3) {
    o.permissions = buildUnnamed1451();
  }
  buildCounterTestIamPermissionsResponse--;
  return o;
}
...
void checkTestIamPermissionsResponse(api.TestIamPermissionsResponse o) {
  buildCounterTestIamPermissionsResponse++;
  if (buildCounterTestIamPermissionsResponse < 3) {
    checkUnnamed1451(o.permissions);
  }
  buildCounterTestIamPermissionsResponse--;
}
...
core.Map<core.String, core.double> buildUnnamed1454() {
...
void checkUnnamed1454(core.Map<core.String, core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkTrainingOptions(api.TrainingOptions o) {
  ...
  if (buildCounterTrainingOptions < 3) {
    ...
    checkUnnamed1452(o.hiddenUnits);
    ...
    checkUnnamed1453(o.inputLabelColumns);
    ...
    checkUnnamed1454(o.labelClassWeights);
    unittest.expect(o.learnRate, unittest.equals(42.0));
    unittest.expect(o.learnRateStrategy, unittest.equals('foo'));
    unittest.expect(o.lossType, unittest.equals('foo'));
...
core.List<api.GlobalExplanation> buildUnnamed1455() {
  var o = <api.GlobalExplanation>[];
...
void checkUnnamed1456(core.List<api.IterationResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TrainingRun buildTrainingRun() {
  ...
  if (buildCounterTrainingRun < 3) {
    ...
    o.globalExplanations = buildUnnamed1455();
    o.results = buildUnnamed1456();
    o.startTime = 'foo';
...
void checkTrainingRun(api.TrainingRun o) {
  ...
  if (buildCounterTrainingRun < 3) {
    ...
    checkUnnamed1455(o.globalExplanations);
    checkUnnamed1456(o.results);
    unittest.expect(o.startTime, unittest.equals('foo'));
...
core.List<api.UserDefinedFunctionResource> buildUnnamed1457() {
  var o = <api.UserDefinedFunctionResource>[];
  o.add(buildUserDefinedFunctionResource());
  o.add(buildUserDefinedFunctionResource());
  return o;
...
void checkUnnamed1457(core.List<api.UserDefinedFunctionResource> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUserDefinedFunctionResource(o[0] as api.UserDefinedFunctionResource);
  checkUserDefinedFunctionResource(o[1] as api.UserDefinedFunctionResource);
}
...
api.ViewDefinition buildViewDefinition() {
  ...
  if (buildCounterViewDefinition < 3) {
    o.query = 'foo';
    o.useLegacySql = true;
    o.userDefinedFunctionResources = buildUnnamed1457();
  }
  buildCounterViewDefinition--;
  return o;
}
...
void checkViewDefinition(api.ViewDefinition o) {
  ...
  if (buildCounterViewDefinition < 3) {
    unittest.expect(o.query, unittest.equals('foo'));
    unittest.expect(o.useLegacySql, unittest.isTrue);
    checkUnnamed1457(o.userDefinedFunctionResources);
  }
  buildCounterViewDefinition--;
}
...
void main() {
  ...
  unittest.group('resource-JobsResource', () {
    ...
    unittest.test('method--list', () {
      ...
      var arg_stateFilter = buildUnnamed1458();
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
