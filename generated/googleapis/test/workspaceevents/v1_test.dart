...
core.List<api.Subscription> buildUnnamed0() => [
      buildSubscription(),
      buildSubscription(),
    ];

void checkUnnamed0(core.List<api.Subscription> o) {
...
void main() {
  ...
  unittest.group('resource-SubscriptionsResource', () {
    ...
    unittest.test('method--reactivate', () async {
      ...
      final response =
          await res.reactivate(arg_request, arg_name, $fields: arg_$fields);
      checkOperation(response as api.Operation);
    });
  });
}
