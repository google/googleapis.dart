...
import 'package:googleapis/dataform/v1beta1.dart' as api;
...
core.List<api.ReleaseConfig> buildUnnamed22() => [
  buildReleaseConfig(),
  buildReleaseConfig(),
];

void checkUnnamed22(core.List<api.ReleaseConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListReleaseConfigsResponse buildListReleaseConfigsResponse() {
  ...
  if (buildCounterListReleaseConfigsResponse < 3) {
    o.nextPageToken = 'foo';
    o.releaseConfigs = buildUnnamed22();
...
void checkListReleaseConfigsResponse(api.ListReleaseConfigsResponse o) {
  ...
  if (buildCounterListReleaseConfigsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed22(o.releaseConfigs!);
...
core.List<api.WorkflowConfig> buildUnnamed27() => [
  buildWorkflowConfig(),
  buildWorkflowConfig(),
];

void checkUnnamed27(core.List<api.WorkflowConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListWorkflowConfigsResponse buildListWorkflowConfigsResponse() {
  ...
  if (buildCounterListWorkflowConfigsResponse < 3) {
    ...
    o.workflowConfigs = buildUnnamed27();
  }
  buildCounterListWorkflowConfigsResponse--;
  return o;
}
...
void checkListWorkflowConfigsResponse(api.ListWorkflowConfigsResponse o) {
  ...
  if (buildCounterListWorkflowConfigsResponse < 3) {
    ...
    checkUnnamed27(o.workflowConfigs!);
  }
  buildCounterListWorkflowConfigsResponse--;
}
...
core.List<api.WorkflowInvocation> buildUnnamed29() => [
  buildWorkflowInvocation(),
  buildWorkflowInvocation(),
];

void checkUnnamed29(core.List<api.WorkflowInvocation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListWorkflowInvocationsResponse buildListWorkflowInvocationsResponse() {
  ...
  if (buildCounterListWorkflowInvocationsResponse < 3) {
    ...
    o.workflowInvocations = buildUnnamed29();
  }
  buildCounterListWorkflowInvocationsResponse--;
  return o;
}
...
void checkListWorkflowInvocationsResponse(
  ...
  if (buildCounterListWorkflowInvocationsResponse < 3) {
    ...
    checkUnnamed29(o.workflowInvocations!);
  }
  buildCounterListWorkflowInvocationsResponse--;
}
...
core.List<api.Workspace> buildUnnamed31() => [
  buildWorkspace(),
  buildWorkspace(),
];

void checkUnnamed31(core.List<api.Workspace> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWorkspace(o[0]);
  checkWorkspace(o[1]);
}
...
core.List<api.Target> buildUnnamed34() => [buildTarget(), buildTarget()];
...
api.Notebook buildNotebook() {
  ...
  if (buildCounterNotebook < 3) {
    o.contents = 'foo';
    o.dependencyTargets = buildUnnamed34();
    o.disabled = true;
...
void checkNotebook(api.Notebook o) {
  ...
  if (buildCounterNotebook < 3) {
    ...
    checkUnnamed34(o.dependencyTargets!);
    unittest.expect(o.disabled!, unittest.isTrue);
...
core.List<api.CompilationResultAction> buildUnnamed40() => [
  buildCompilationResultAction(),
  buildCompilationResultAction(),
];

void checkUnnamed40(core.List<api.CompilationResultAction> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildQueryCompilationResultActionsResponse() {
  ...
  if (buildCounterQueryCompilationResultActionsResponse < 3) {
    o.compilationResultActions = buildUnnamed40();
    o.nextPageToken = 'foo';
  }
  buildCounterQueryCompilationResultActionsResponse--;
  return o;
...
void checkQueryCompilationResultActionsResponse(
  ...
  buildCounterQueryCompilationResultActionsResponse++;
  if (buildCounterQueryCompilationResultActionsResponse < 3) {
    checkUnnamed40(o.compilationResultActions!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterQueryCompilationResultActionsResponse--;
}

core.List<api.DirectoryEntry> buildUnnamed41() => [
  buildDirectoryEntry(),
  buildDirectoryEntry(),
];

void checkUnnamed41(core.List<api.DirectoryEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.QueryDirectoryContentsResponse buildQueryDirectoryContentsResponse() {
  ...
  if (buildCounterQueryDirectoryContentsResponse < 3) {
    o.directoryEntries = buildUnnamed41();
    o.nextPageToken = 'foo';
  }
  buildCounterQueryDirectoryContentsResponse--;
  return o;
...
void checkQueryDirectoryContentsResponse(api.QueryDirectoryContentsResponse o) {
  buildCounterQueryDirectoryContentsResponse++;
  if (buildCounterQueryDirectoryContentsResponse < 3) {
    checkUnnamed41(o.directoryEntries!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterQueryDirectoryContentsResponse--;
}

core.List<api.DirectoryEntry> buildUnnamed42() => [
  buildDirectoryEntry(),
  buildDirectoryEntry(),
];

void checkUnnamed42(core.List<api.DirectoryEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDirectoryEntry(o[0]);
  checkDirectoryEntry(o[1]);
}
...
buildQueryRepositoryDirectoryContentsResponse() {
  ...
  if (buildCounterQueryRepositoryDirectoryContentsResponse < 3) {
    o.directoryEntries = buildUnnamed42();
    o.nextPageToken = 'foo';
  }
  buildCounterQueryRepositoryDirectoryContentsResponse--;
  return o;
...
void checkQueryRepositoryDirectoryContentsResponse(
  ...
  buildCounterQueryRepositoryDirectoryContentsResponse++;
  if (buildCounterQueryRepositoryDirectoryContentsResponse < 3) {
    checkUnnamed42(o.directoryEntries!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterQueryRepositoryDirectoryContentsResponse--;
}

core.List<api.WorkflowInvocationAction> buildUnnamed43() => [
  buildWorkflowInvocationAction(),
  buildWorkflowInvocationAction(),
];

void checkUnnamed43(core.List<api.WorkflowInvocationAction> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildQueryWorkflowInvocationActionsResponse() {
  ...
  if (buildCounterQueryWorkflowInvocationActionsResponse < 3) {
    o.nextPageToken = 'foo';
    o.workflowInvocationActions = buildUnnamed43();
  }
  buildCounterQueryWorkflowInvocationActionsResponse--;
  return o;
}
...
void checkQueryWorkflowInvocationActionsResponse(
  ...
  if (buildCounterQueryWorkflowInvocationActionsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed43(o.workflowInvocationActions!);
  }
  buildCounterQueryWorkflowInvocationActionsResponse--;
}
...
core.List<api.Target> buildUnnamed46() => [buildTarget(), buildTarget()];

void checkUnnamed46(core.List<api.Target> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTarget(o[0]);
  checkTarget(o[1]);
}
...
api.Relation buildRelation() {
  ...
  if (buildCounterRelation < 3) {
    o.additionalOptions = buildUnnamed44();
    o.clusterExpressions = buildUnnamed45();
    o.dependencyTargets = buildUnnamed46();
    o.disabled = true;
    o.incrementalTableConfig = buildIncrementalTableConfig();
    o.partitionExpirationDays = 42;
    o.partitionExpression = 'foo';
    o.postOperations = buildUnnamed47();
    o.preOperations = buildUnnamed48();
    o.relationDescriptor = buildRelationDescriptor();
    o.relationType = 'foo';
...
void checkRelation(api.Relation o) {
  buildCounterRelation++;
  if (buildCounterRelation < 3) {
    checkUnnamed44(o.additionalOptions!);
    checkUnnamed45(o.clusterExpressions!);
    checkUnnamed46(o.dependencyTargets!);
    unittest.expect(o.disabled!, unittest.isTrue);
    ...
    checkUnnamed47(o.postOperations!);
    checkUnnamed48(o.preOperations!);
    checkRelationDescriptor(o.relationDescriptor!);
...
core.List<api.ColumnDescriptor> buildUnnamed51() => [
  buildColumnDescriptor(),
  buildColumnDescriptor(),
];

void checkUnnamed51(core.List<api.ColumnDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.RelationDescriptor buildRelationDescriptor() {
  ...
  if (buildCounterRelationDescriptor < 3) {
    o.bigqueryLabels = buildUnnamed50();
...
void checkRelationDescriptor(api.RelationDescriptor o) {
  buildCounterRelationDescriptor++;
  if (buildCounterRelationDescriptor < 3) {
    checkUnnamed50(o.bigqueryLabels!);
...
core.List<api.ScheduledReleaseRecord> buildUnnamed52() => [
  buildScheduledReleaseRecord(),
  buildScheduledReleaseRecord(),
];

void checkUnnamed52(core.List<api.ScheduledReleaseRecord> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ReleaseConfig buildReleaseConfig() {
  ...
  if (buildCounterReleaseConfig < 3) {
    ...
    o.internalMetadata = 'foo';
    o.name = 'foo';
    o.recentScheduledReleaseRecords = buildUnnamed52();
...
void checkReleaseConfig(api.ReleaseConfig o) {
  ...
  if (buildCounterReleaseConfig < 3) {
    ...
    unittest.expect(o.internalMetadata!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed52(o.recentScheduledReleaseRecords!);
...
core.List<api.SearchResult> buildUnnamed55() => [
  buildSearchResult(),
  buildSearchResult(),
];

void checkUnnamed55(core.List<api.SearchResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SearchFilesResponse buildSearchFilesResponse() {
  ...
  if (buildCounterSearchFilesResponse < 3) {
    o.nextPageToken = 'foo';
    o.searchResults = buildUnnamed55();
  }
  buildCounterSearchFilesResponse--;
  return o;
}
...
void checkSearchFilesResponse(api.SearchFilesResponse o) {
  ...
  if (buildCounterSearchFilesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed55(o.searchResults!);
  }
  buildCounterSearchFilesResponse--;
}
...
core.List<api.ScheduledExecutionRecord> buildUnnamed60() => [
  buildScheduledExecutionRecord(),
  buildScheduledExecutionRecord(),
];

void checkUnnamed60(core.List<api.ScheduledExecutionRecord> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.WorkflowConfig buildWorkflowConfig() {
  ...
  if (buildCounterWorkflowConfig < 3) {
    ...
    o.name = 'foo';
    o.recentScheduledExecutionRecords = buildUnnamed60();
    o.releaseConfig = 'foo';
    o.timeZone = 'foo';
    o.updateTime = 'foo';
  }
...
void checkWorkflowConfig(api.WorkflowConfig o) {
  ...
  if (buildCounterWorkflowConfig < 3) {
    ...
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed60(o.recentScheduledExecutionRecords!);
    unittest.expect(o.releaseConfig!, unittest.equals('foo'));
    unittest.expect(o.timeZone!, unittest.equals('foo'));
