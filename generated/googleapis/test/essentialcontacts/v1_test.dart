...
core.List<api.GoogleCloudEssentialcontactsV1Contact> buildUnnamed5784() => [
      buildGoogleCloudEssentialcontactsV1Contact(),
      buildGoogleCloudEssentialcontactsV1Contact(),
    ];

void checkUnnamed5784(core.List<api.GoogleCloudEssentialcontactsV1Contact> o) {
...
api.GoogleCloudEssentialcontactsV1Contact
  ...
  if (buildCounterGoogleCloudEssentialcontactsV1Contact < 3) {
    ...
    o.languageTag = 'foo';
    o.name = 'foo';
    o.notificationCategorySubscriptions = buildUnnamed5785();
    o.validateTime = 'foo';
...
void checkGoogleCloudEssentialcontactsV1Contact(
  ...
  if (buildCounterGoogleCloudEssentialcontactsV1Contact < 3) {
    ...
    checkUnnamed5785(o.notificationCategorySubscriptions!);
    unittest.expect(
      o.validateTime!,
      unittest.equals('foo'),
    );
...
core.List<api.GoogleCloudEssentialcontactsV1Contact> buildUnnamed5786() => [
      buildGoogleCloudEssentialcontactsV1Contact(),
      buildGoogleCloudEssentialcontactsV1Contact(),
    ];

void checkUnnamed5786(core.List<api.GoogleCloudEssentialcontactsV1Contact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudEssentialcontactsV1Contact(o[0]);
  checkGoogleCloudEssentialcontactsV1Contact(o[1]);
}
...
core.List<core.String> buildUnnamed5787() => [
      'foo',
      'foo',
    ];

void checkUnnamed5787(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
void main() {
  ...
  unittest.group('resource-FoldersContactsResource', () {
    unittest.test('method--compute', () async {
      ...
      final arg_notificationCategories = buildUnnamed5788();
  ...
  unittest.group('resource-OrganizationsContactsResource', () {
    unittest.test('method--compute', () async {
      ...
      final arg_parent = 'foo';
      final arg_notificationCategories = buildUnnamed5789();
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
  ...
  unittest.group('resource-ProjectsContactsResource', () {
    unittest.test('method--compute', () async {
      ...
      final arg_parent = 'foo';
      final arg_notificationCategories = buildUnnamed5790();
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
