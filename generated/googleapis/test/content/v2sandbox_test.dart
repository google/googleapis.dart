...
checkUnnamed815(core.List<api.Error> o) {
...
checkUnnamed816(core.List<api.OrderLineItem> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed817(core.List<api.OrderRefund> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed818(core.List<api.OrderShipment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOrder() {
  ...
  if (buildCounterOrder < 3) {
    ...
    o.paymentStatus = "foo";
    o.placedDate = "foo";
    o.refunds = buildUnnamed817();
    o.shipments = buildUnnamed818();
...
checkOrder(api.Order o) {
  ...
  if (buildCounterOrder < 3) {
    ...
    checkUnnamed817(o.refunds);
    checkUnnamed818(o.shipments);
...
buildOrderAddress() {
  ...
  if (buildCounterOrderAddress < 3) {
    o.country = "foo";
    o.fullAddress = buildUnnamed819();
    o.isPostOfficeBox = true;
    o.locality = "foo";
    o.postalCode = "foo";
    o.recipientName = "foo";
    o.region = "foo";
    o.streetAddress = buildUnnamed820();
  }
  buildCounterOrderAddress--;
  return o;
}
...
checkOrderAddress(api.OrderAddress o) {
  ...
  if (buildCounterOrderAddress < 3) {
    ...
    checkUnnamed820(o.streetAddress);
  }
  buildCounterOrderAddress--;
}
...
checkUnnamed821(core.List<api.OrderCancellation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed822(core.List<api.OrderReturn> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOrderLineItem() {
  ...
  if (buildCounterOrderLineItem < 3) {
    o.cancellations = buildUnnamed821();
    o.id = "foo";
    o.price = buildPrice();
...
checkOrderLineItem(api.OrderLineItem o) {
  buildCounterOrderLineItem++;
  if (buildCounterOrderLineItem < 3) {
    checkUnnamed821(o.cancellations);
    unittest.expect(o.id, unittest.equals('foo'));
    checkPrice(o.price);
...
checkUnnamed823(core.List<api.OrderLineItemProductVariantAttribute> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOrderLineItemProduct() {
  ...
  if (buildCounterOrderLineItemProduct < 3) {
    ...
    o.targetCountry = "foo";
    o.title = "foo";
    o.variantAttributes = buildUnnamed823();
  }
  buildCounterOrderLineItemProduct--;
  return o;
}
...
checkOrderLineItemProduct(api.OrderLineItemProduct o) {
  ...
  if (buildCounterOrderLineItemProduct < 3) {
    ...
    checkUnnamed823(o.variantAttributes);
  }
  buildCounterOrderLineItemProduct--;
}
...
checkUnnamed824(core.List<api.OrderShipmentLineItemShipment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed825(core.List<api.OrdersCustomBatchRequestEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed826(core.List<api.OrderShipmentLineItemShipment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrderShipmentLineItemShipment(o[0]);
  checkOrderShipmentLineItemShipment(o[1]);
}
...
checkUnnamed827(core.List<api.OrdersCustomBatchResponseEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed828(core.List<api.Order> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrder(o[0]);
  checkOrder(o[1]);
}
...
checkUnnamed829(core.List<api.OrderShipmentLineItemShipment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrderShipmentLineItemShipment(o[0]);
  checkOrderShipmentLineItemShipment(o[1]);
}
...
checkUnnamed830(core.List<api.TestOrderLineItem> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed831(core.List<api.OrderLineItemProductVariantAttribute> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrderLineItemProductVariantAttribute(o[0]);
  checkOrderLineItemProductVariantAttribute(o[1]);
}
...
buildTestOrderLineItemProduct() {
  ...
  if (buildCounterTestOrderLineItemProduct < 3) {
    ...
    o.targetCountry = "foo";
    o.title = "foo";
    o.variantAttributes = buildUnnamed831();
  }
  buildCounterTestOrderLineItemProduct--;
  return o;
}
...
checkTestOrderLineItemProduct(api.TestOrderLineItemProduct o) {
  ...
  if (buildCounterTestOrderLineItemProduct < 3) {
    ...
    unittest.expect(o.targetCountry, unittest.equals('foo'));
    unittest.expect(o.title, unittest.equals('foo'));
    checkUnnamed831(o.variantAttributes);
  }
  buildCounterTestOrderLineItemProduct--;
}
...
main() {
  ...
  unittest.group("resource-OrdersResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_statuses = buildUnnamed832();
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
        var index;
