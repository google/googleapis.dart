...
void checkAccount(api.Account o) {
  ...
  if (buildCounterAccount < 3) {
    ...
    unittest.expect(o.accountNumber, unittest.equals('foo'));
    ...
    unittest.expect(o.primaryOwner, unittest.equals('foo'));
    unittest.expect(o.role, unittest.equals('foo'));
    unittest.expect(o.type, unittest.equals('foo'));
    unittest.expect(o.verificationState, unittest.equals('foo'));
    unittest.expect(o.vettedState, unittest.equals('foo'));
  }
  buildCounterAccount--;
}
...
core.List<api.Admin> buildUnnamed5043() {
  var o = <api.Admin>[];
  o.add(buildAdmin());
  o.add(buildAdmin());
  return o;
...
void checkUnnamed5043(core.List<api.Admin> o) {
...
api.ListAccountAdminsResponse buildListAccountAdminsResponse() {
  ...
  if (buildCounterListAccountAdminsResponse < 3) {
    o.accountAdmins = buildUnnamed5043();
  }
  buildCounterListAccountAdminsResponse--;
  return o;
}
...
void checkListAccountAdminsResponse(api.ListAccountAdminsResponse o) {
  buildCounterListAccountAdminsResponse++;
  if (buildCounterListAccountAdminsResponse < 3) {
    checkUnnamed5043(o.accountAdmins);
  }
  buildCounterListAccountAdminsResponse--;
}

core.List<api.Account> buildUnnamed5044() {
  var o = <api.Account>[];
  o.add(buildAccount());
  o.add(buildAccount());
  return o;
...
void checkUnnamed5044(core.List<api.Account> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListAccountsResponse(api.ListAccountsResponse o) {
  buildCounterListAccountsResponse++;
  if (buildCounterListAccountsResponse < 3) {
    checkUnnamed5044(o.accounts);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListAccountsResponse--;
}

core.List<api.Invitation> buildUnnamed5045() {
  var o = <api.Invitation>[];
...
void checkUnnamed5045(core.List<api.Invitation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListInvitationsResponse buildListInvitationsResponse() {
  ...
  if (buildCounterListInvitationsResponse < 3) {
    o.invitations = buildUnnamed5045();
  }
  buildCounterListInvitationsResponse--;
  return o;
}
...
void checkListInvitationsResponse(api.ListInvitationsResponse o) {
  buildCounterListInvitationsResponse++;
  if (buildCounterListInvitationsResponse < 3) {
    checkUnnamed5045(o.invitations);
  }
  buildCounterListInvitationsResponse--;
}

core.List<api.Admin> buildUnnamed5046() {
  var o = <api.Admin>[];
  o.add(buildAdmin());
  o.add(buildAdmin());
  return o;
...
void checkUnnamed5046(core.List<api.Admin> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdmin(o[0] as api.Admin);
  checkAdmin(o[1] as api.Admin);
}
...
void checkOrganizationInfo(api.OrganizationInfo o) {
  ...
  if (buildCounterOrganizationInfo < 3) {
    ...
    unittest.expect(o.registeredDomain, unittest.equals('foo'));
  }
  buildCounterOrganizationInfo--;
}
...
api.PostalAddress buildPostalAddress() {
  ...
  if (buildCounterPostalAddress < 3) {
    o.addressLines = buildUnnamed5047();
    o.administrativeArea = 'foo';
    o.languageCode = 'foo';
    o.locality = 'foo';
    o.organization = 'foo';
    o.postalCode = 'foo';
    o.recipients = buildUnnamed5048();
    o.regionCode = 'foo';
    o.revision = 42;
    o.sortingCode = 'foo';
    o.sublocality = 'foo';
...
void checkPostalAddress(api.PostalAddress o) {
  buildCounterPostalAddress++;
  if (buildCounterPostalAddress < 3) {
    checkUnnamed5047(o.addressLines);
  ...
  unittest.group('resource-AccountsResource', () {
    ...
    unittest.test('method--list', () {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        unittest.expect(queryMap["parentAccount"].first,
