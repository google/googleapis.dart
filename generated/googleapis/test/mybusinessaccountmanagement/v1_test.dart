...
core.List<api.Admin> buildUnnamed6250() => [
      buildAdmin(),
      buildAdmin(),
    ];

void checkUnnamed6250(core.List<api.Admin> o) {
...
api.ListAccountAdminsResponse buildListAccountAdminsResponse() {
  ...
  if (buildCounterListAccountAdminsResponse < 3) {
    o.accountAdmins = buildUnnamed6250();
  }
  buildCounterListAccountAdminsResponse--;
  return o;
}
...
void checkListAccountAdminsResponse(api.ListAccountAdminsResponse o) {
  buildCounterListAccountAdminsResponse++;
  if (buildCounterListAccountAdminsResponse < 3) {
    checkUnnamed6250(o.accountAdmins!);
  }
  buildCounterListAccountAdminsResponse--;
}

core.List<api.Account> buildUnnamed6251() => [
      buildAccount(),
      buildAccount(),
    ];

void checkUnnamed6251(core.List<api.Account> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAccount(o[0]);
  checkAccount(o[1]);
}
...
core.List<api.Invitation> buildUnnamed6252() => [
      buildInvitation(),
      buildInvitation(),
    ];

void checkUnnamed6252(core.List<api.Invitation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInvitation(o[0]);
  checkInvitation(o[1]);
}
...
api.ListInvitationsResponse buildListInvitationsResponse() {
  ...
  if (buildCounterListInvitationsResponse < 3) {
    o.invitations = buildUnnamed6252();
  }
  buildCounterListInvitationsResponse--;
  return o;
}
...
void checkListInvitationsResponse(api.ListInvitationsResponse o) {
  buildCounterListInvitationsResponse++;
  if (buildCounterListInvitationsResponse < 3) {
    checkUnnamed6252(o.invitations!);
  }
  buildCounterListInvitationsResponse--;
}

core.List<api.Admin> buildUnnamed6253() => [
      buildAdmin(),
      buildAdmin(),
    ];

void checkUnnamed6253(core.List<api.Admin> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdmin(o[0]);
  checkAdmin(o[1]);
}
...
api.PostalAddress buildPostalAddress() {
  ...
  if (buildCounterPostalAddress < 3) {
    o.addressLines = buildUnnamed6254();
    o.administrativeArea = 'foo';
    o.languageCode = 'foo';
    o.locality = 'foo';
    o.organization = 'foo';
    o.postalCode = 'foo';
    o.recipients = buildUnnamed6255();
    o.regionCode = 'foo';
    o.revision = 42;
    o.sortingCode = 'foo';
    o.sublocality = 'foo';
...
void checkPostalAddress(api.PostalAddress o) {
  buildCounterPostalAddress++;
  if (buildCounterPostalAddress < 3) {
    checkUnnamed6254(o.addressLines!);
    unittest.expect(
