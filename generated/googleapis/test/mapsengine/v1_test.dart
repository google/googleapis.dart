...
checkUnnamed66(core.List<core.double> o) {
...
checkUnnamed68(core.List<api.Asset> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAsset(o[0]);
  checkAsset(o[1]);
}
...
checkUnnamed69(core.List<api.Filter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFilter(o[0]);
  checkFilter(o[1]);
}
...
buildFeaturesBatchDeleteRequest() {
  ...
  if (buildCounterFeaturesBatchDeleteRequest < 3) {
    o.gxIds = buildUnnamed70();
    o.primaryKeys = buildUnnamed71();
  }
  buildCounterFeaturesBatchDeleteRequest--;
  return o;
}
...
checkFeaturesBatchDeleteRequest(api.FeaturesBatchDeleteRequest o) {
  buildCounterFeaturesBatchDeleteRequest++;
  if (buildCounterFeaturesBatchDeleteRequest < 3) {
    checkUnnamed70(o.gxIds);
    checkUnnamed71(o.primaryKeys);
  }
  buildCounterFeaturesBatchDeleteRequest--;
}
...
checkUnnamed75(core.List<api.GeoJsonGeometry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed78(core.List<core.List<api.GeoJsonPosition>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed77(o[0]);
  checkUnnamed77(o[1]);
}
...
checkUnnamed81(core.List<core.List<api.GeoJsonPosition>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed80(o[0]);
  checkUnnamed80(o[1]);
}
...
checkUnnamed82(core.List<core.List<core.List<api.GeoJsonPosition>>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed81(o[0]);
  checkUnnamed81(o[1]);
}
...
checkUnnamed83(core.List<api.GeoJsonPosition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGeoJsonPosition(o[0]);
  checkGeoJsonPosition(o[1]);
}
...
checkUnnamed84(core.List<core.List<api.GeoJsonPosition>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed83(o[0]);
  checkUnnamed83(o[1]);
}
...
checkUnnamed85(core.List<api.Icon> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIcon(o[0]);
  checkIcon(o[1]);
}
...
checkUnnamed86(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}
...
checkUnnamed87(core.List<api.Layer> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLayer(o[0]);
  checkLayer(o[1]);
}
...
checkUnnamed91(core.List<api.MapItem> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMapItem(o[0]);
  checkMapItem(o[1]);
}
...
checkUnnamed95(core.List<api.Map> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMap(o[0]);
  checkMap(o[1]);
}
...
checkUnnamed96(core.List<api.Parent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkParent(o[0]);
  checkParent(o[1]);
}
...
checkUnnamed100(core.List<api.Project> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProject(o[0]);
  checkProject(o[1]);
}
...
checkUnnamed101(core.List<api.PublishedLayer> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed102(core.List<api.PublishedMap> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed103(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}
...
checkUnnamed104(core.List<api.File> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFile(o[0]);
  checkFile(o[1]);
}
...
buildRaster() {
  ...
  if (buildCounterRaster < 3) {
    ...
    o.attribution = "foo";
    o.bbox = buildUnnamed103();
    o.creationTime = core.DateTime.parse("2002-02-27T14:01:02");
    o.creatorEmail = "foo";
    o.description = "foo";
    o.draftAccessList = "foo";
    o.etag = "foo";
    o.files = buildUnnamed104();
    o.id = "foo";
    o.lastModifiedTime = core.DateTime.parse("2002-02-27T14:01:02");
    o.lastModifierEmail = "foo";
    o.maskType = "foo";
...
checkRaster(api.Raster o) {
  ...
  if (buildCounterRaster < 3) {
    ...
    checkUnnamed103(o.bbox);
    unittest.expect(o.creationTime, unittest.equals(core.DateTime.parse("2002-02-27T14:01:02")));
    unittest.expect(o.creatorEmail, unittest.equals('foo'));
    unittest.expect(o.description, unittest.equals('foo'));
    unittest.expect(o.draftAccessList, unittest.equals('foo'));
    unittest.expect(o.etag, unittest.equals('foo'));
    checkUnnamed104(o.files);
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.lastModifiedTime, unittest.equals(core.DateTime.parse("2002-02-27T14:01:02")));
    unittest.expect(o.lastModifierEmail, unittest.equals('foo'));
...
checkUnnamed105(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}
...
checkUnnamed106(core.List<api.RasterCollection> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildRasterCollectionsListResponse() {
  ...
  if (buildCounterRasterCollectionsListResponse < 3) {
    o.nextPageToken = "foo";
    o.rasterCollections = buildUnnamed106();
  }
  buildCounterRasterCollectionsListResponse--;
  return o;
}
...
checkRasterCollectionsListResponse(api.RasterCollectionsListResponse o) {
  ...
  if (buildCounterRasterCollectionsListResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed106(o.rasterCollections);
  }
  buildCounterRasterCollectionsListResponse--;
}
...
checkUnnamed107(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}
...
checkUnnamed111(core.List<api.RasterCollectionsRaster> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed112(core.List<api.Raster> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRaster(o[0]);
  checkRaster(o[1]);
}
...
checkUnnamed113(core.List<api.TableColumn> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed115(core.List<api.File> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFile(o[0]);
  checkFile(o[1]);
}
...
checkUnnamed116(core.List<api.Table> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTable(o[0]);
  checkTable(o[1]);
}
...
checkUnnamed117(core.List<api.DisplayRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildVectorStyle() {
  ...
  if (buildCounterVectorStyle < 3) {
    o.displayRules = buildUnnamed117();
...
checkVectorStyle(api.VectorStyle o) {
  buildCounterVectorStyle++;
  if (buildCounterVectorStyle < 3) {
    checkUnnamed117(o.displayRules);
