...
checkUnnamed1152(core.List<api.Asset> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAsset(o[0]);
  checkAsset(o[1]);
}
...
checkUnnamed1153(core.List<api.Filter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFilter(o[0]);
  checkFilter(o[1]);
}
...
buildFeaturesBatchDeleteRequest() {
  ...
  if (buildCounterFeaturesBatchDeleteRequest < 3) {
    o.gxIds = buildUnnamed1154();
    o.primaryKeys = buildUnnamed1155();
  }
  buildCounterFeaturesBatchDeleteRequest--;
  return o;
}
...
checkFeaturesBatchDeleteRequest(api.FeaturesBatchDeleteRequest o) {
  buildCounterFeaturesBatchDeleteRequest++;
  if (buildCounterFeaturesBatchDeleteRequest < 3) {
    checkUnnamed1154(o.gxIds);
    checkUnnamed1155(o.primaryKeys);
  }
  buildCounterFeaturesBatchDeleteRequest--;
}
...
checkUnnamed1156(core.List<api.Feature> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFeature(o[0]);
  checkFeature(o[1]);
}
...
checkUnnamed1158(core.List<api.Feature> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFeature(o[0]);
  checkFeature(o[1]);
}
...
checkUnnamed1159(core.List<api.GeoJsonGeometry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1160(core.List<api.GeoJsonPosition> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildGeoJsonLineString() {
  ...
  if (buildCounterGeoJsonLineString < 3) {
    o.coordinates = buildUnnamed1160();
  }
  buildCounterGeoJsonLineString--;
  return o;
}
...
checkGeoJsonLineString(api.GeoJsonLineString o) {
  buildCounterGeoJsonLineString++;
  if (buildCounterGeoJsonLineString < 3) {
    checkUnnamed1160(o.coordinates);
  }
  buildCounterGeoJsonLineString--;
}
...
checkUnnamed1161(core.List<api.GeoJsonPosition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGeoJsonPosition(o[0]);
  checkGeoJsonPosition(o[1]);
}
...
checkUnnamed1162(core.List<core.List<api.GeoJsonPosition>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildGeoJsonMultiLineString() {
  ...
  if (buildCounterGeoJsonMultiLineString < 3) {
    o.coordinates = buildUnnamed1162();
  }
  buildCounterGeoJsonMultiLineString--;
  return o;
}
...
checkGeoJsonMultiLineString(api.GeoJsonMultiLineString o) {
  buildCounterGeoJsonMultiLineString++;
  if (buildCounterGeoJsonMultiLineString < 3) {
    checkUnnamed1162(o.coordinates);
  }
  buildCounterGeoJsonMultiLineString--;
}
...
checkUnnamed1163(core.List<api.GeoJsonPosition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGeoJsonPosition(o[0]);
  checkGeoJsonPosition(o[1]);
}
...
buildGeoJsonMultiPoint() {
  ...
  if (buildCounterGeoJsonMultiPoint < 3) {
    o.coordinates = buildUnnamed1163();
  }
  buildCounterGeoJsonMultiPoint--;
  return o;
}
...
checkGeoJsonMultiPoint(api.GeoJsonMultiPoint o) {
  buildCounterGeoJsonMultiPoint++;
  if (buildCounterGeoJsonMultiPoint < 3) {
    checkUnnamed1163(o.coordinates);
  }
  buildCounterGeoJsonMultiPoint--;
}
...
checkUnnamed1164(core.List<api.GeoJsonPosition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGeoJsonPosition(o[0]);
  checkGeoJsonPosition(o[1]);
}
...
checkUnnamed1165(core.List<core.List<api.GeoJsonPosition>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed1166() {
  ...
  o.add(buildUnnamed1165());
  o.add(buildUnnamed1165());
  return o;
}

checkUnnamed1166(core.List<core.List<core.List<api.GeoJsonPosition>>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1165(o[0]);
  checkUnnamed1165(o[1]);
}
...
checkUnnamed1168(core.List<core.List<api.GeoJsonPosition>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildGeoJsonPolygon() {
  ...
  if (buildCounterGeoJsonPolygon < 3) {
    o.coordinates = buildUnnamed1168();
  }
  buildCounterGeoJsonPolygon--;
  return o;
}
...
checkGeoJsonPolygon(api.GeoJsonPolygon o) {
  buildCounterGeoJsonPolygon++;
  if (buildCounterGeoJsonPolygon < 3) {
    checkUnnamed1168(o.coordinates);
  }
  buildCounterGeoJsonPolygon--;
}
...
checkUnnamed1169(core.List<api.Icon> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIcon(o[0]);
  checkIcon(o[1]);
}
...
checkUnnamed1171(core.List<api.Layer> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLayer(o[0]);
  checkLayer(o[1]);
}
...
checkUnnamed1175(core.List<api.MapItem> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMapItem(o[0]);
  checkMapItem(o[1]);
}
...
buildMapFolder() {
  ...
  if (buildCounterMapFolder < 3) {
    o.contents = buildUnnamed1175();
    o.defaultViewport = buildUnnamed1176();
    o.expandable = true;
    o.key = "foo";
    o.name = "foo";
    o.visibility = "foo";
...
checkMapFolder(api.MapFolder o) {
  buildCounterMapFolder++;
  if (buildCounterMapFolder < 3) {
    checkUnnamed1175(o.contents);
    checkUnnamed1176(o.defaultViewport);
...
buildMapKmlLink() {
  ...
  if (buildCounterMapKmlLink < 3) {
    o.defaultViewport = buildUnnamed1177();
    o.kmlUrl = "foo";
    o.name = "foo";
    o.visibility = "foo";
  }
...
checkMapKmlLink(api.MapKmlLink o) {
  buildCounterMapKmlLink++;
  if (buildCounterMapKmlLink < 3) {
    checkUnnamed1177(o.defaultViewport);
...
buildMapLayer() {
  ...
  if (buildCounterMapLayer < 3) {
    o.defaultViewport = buildUnnamed1178();
    o.id = "foo";
    o.key = "foo";
    o.name = "foo";
    o.visibility = "foo";
...
checkMapLayer(api.MapLayer o) {
  buildCounterMapLayer++;
  if (buildCounterMapLayer < 3) {
    checkUnnamed1178(o.defaultViewport);
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.key, unittest.equals('foo'));
    unittest.expect(o.name, unittest.equals('foo'));
    unittest.expect(o.visibility, unittest.equals('foo'));
...
checkUnnamed1179(core.List<api.Map> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMap(o[0]);
  checkMap(o[1]);
}
...
checkUnnamed1180(core.List<api.Parent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkParent(o[0]);
  checkParent(o[1]);
}
...
checkUnnamed1182(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0]);
  checkPermission(o[1]);
}
...
checkUnnamed1183(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0]);
  checkPermission(o[1]);
}
...
checkUnnamed1184(core.List<api.Project> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProject(o[0]);
  checkProject(o[1]);
}
...
checkUnnamed1185(core.List<api.PublishedLayer> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1186(core.List<api.PublishedMap> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1188(core.List<api.File> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFile(o[0]);
  checkFile(o[1]);
}
...
checkUnnamed1190(core.List<api.RasterCollection> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildRasterCollectionsListResponse() {
  ...
  if (buildCounterRasterCollectionsListResponse < 3) {
    o.nextPageToken = "foo";
    o.rasterCollections = buildUnnamed1190();
  }
  buildCounterRasterCollectionsListResponse--;
  return o;
}
...
checkRasterCollectionsListResponse(api.RasterCollectionsListResponse o) {
  ...
  if (buildCounterRasterCollectionsListResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed1190(o.rasterCollections);
  }
  buildCounterRasterCollectionsListResponse--;
}
...
checkUnnamed1195(core.List<api.RasterCollectionsRaster> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1196(core.List<api.Raster> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRaster(o[0]);
  checkRaster(o[1]);
}
...
checkUnnamed1197(core.List<api.TableColumn> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1200(core.List<api.Table> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTable(o[0]);
  checkTable(o[1]);
}
...
checkUnnamed1201(core.List<api.DisplayRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildVectorStyle() {
  ...
  if (buildCounterVectorStyle < 3) {
    o.displayRules = buildUnnamed1201();
...
checkVectorStyle(api.VectorStyle o) {
  buildCounterVectorStyle++;
  if (buildCounterVectorStyle < 3) {
    checkUnnamed1201(o.displayRules);
