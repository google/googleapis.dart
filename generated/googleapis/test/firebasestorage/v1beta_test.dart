...
import 'package:googleapis/firebasestorage/v1beta.dart' as api;
...
void main() {
  ...
  unittest.group('resource-ProjectsResource', () {
    unittest.test('method--deleteDefaultBucket', () async {
      ...
      final response = await res.deleteDefaultBucket(
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--getDefaultBucket', () async {
      ...
      final response = await res.getDefaultBucket(
        arg_name,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-ProjectsBucketsResource', () {
    unittest.test('method--addFirebase', () async {
      ...
      final response = await res.addFirebase(
        arg_request,
        arg_bucket,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--removeFirebase', () async {
      ...
      final response = await res.removeFirebase(
        arg_request,
        arg_bucket,
        $fields: arg_$fields,
      );
