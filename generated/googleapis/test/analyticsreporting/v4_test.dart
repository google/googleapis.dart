...
checkUnnamed2226(core.List<api.CustomDimension> o) {
...
buildActivity() {
  ...
  if (buildCounterActivity < 3) {
    ...
    o.customDimension = buildUnnamed2226();
...
checkActivity(api.Activity o) {
  ...
  if (buildCounterActivity < 3) {
    ...
    checkUnnamed2226(o.customDimension);
...
checkUnnamed2227(core.List<api.Cohort> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCohort(o[0]);
  checkCohort(o[1]);
}
...
checkUnnamed2229(core.List<api.PivotValueRegion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildDateRangeValues() {
  ...
  if (buildCounterDateRangeValues < 3) {
    o.pivotValueRegions = buildUnnamed2229();
    o.values = buildUnnamed2230();
  }
  buildCounterDateRangeValues--;
  return o;
}
...
checkDateRangeValues(api.DateRangeValues o) {
  buildCounterDateRangeValues++;
  if (buildCounterDateRangeValues < 3) {
    checkUnnamed2229(o.pivotValueRegions);
    checkUnnamed2230(o.values);
  }
  buildCounterDateRangeValues--;
}
...
buildDimension() {
  ...
  if (buildCounterDimension < 3) {
    o.histogramBuckets = buildUnnamed2231();
    o.name = "foo";
  }
  buildCounterDimension--;
  return o;
...
checkDimension(api.Dimension o) {
  buildCounterDimension++;
  if (buildCounterDimension < 3) {
    checkUnnamed2231(o.histogramBuckets);
    unittest.expect(o.name, unittest.equals('foo'));
  }
  buildCounterDimension--;
}
...
buildDimensionFilter() {
  ...
  if (buildCounterDimensionFilter < 3) {
    ...
    o.dimensionName = "foo";
    o.expressions = buildUnnamed2232();
    o.not = true;
    o.operator = "foo";
  }
  buildCounterDimensionFilter--;
...
checkDimensionFilter(api.DimensionFilter o) {
  ...
  if (buildCounterDimensionFilter < 3) {
    ...
    checkUnnamed2232(o.expressions);
...
checkUnnamed2233(core.List<api.DimensionFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2234(core.List<api.ProductData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2235(core.List<api.ReportRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildGetReportsRequest() {
  ...
  if (buildCounterGetReportsRequest < 3) {
    o.reportRequests = buildUnnamed2235();
...
checkGetReportsRequest(api.GetReportsRequest o) {
  buildCounterGetReportsRequest++;
  if (buildCounterGetReportsRequest < 3) {
    checkUnnamed2235(o.reportRequests);
...
checkUnnamed2236(core.List<api.Report> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReport(o[0]);
  checkReport(o[1]);
}
...
checkUnnamed2237(core.List<api.GoalData> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoalData(o[0]);
  checkGoalData(o[1]);
}
...
checkUnnamed2238(core.List<api.MetricFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2239(core.List<api.MetricHeaderEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2240(core.List<api.PivotHeader> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildMetricHeader() {
  ...
  if (buildCounterMetricHeader < 3) {
    o.metricHeaderEntries = buildUnnamed2239();
    o.pivotHeaders = buildUnnamed2240();
  }
  buildCounterMetricHeader--;
  return o;
}
...
checkMetricHeader(api.MetricHeader o) {
  buildCounterMetricHeader++;
  if (buildCounterMetricHeader < 3) {
    checkUnnamed2239(o.metricHeaderEntries);
    checkUnnamed2240(o.pivotHeaders);
  }
  buildCounterMetricHeader--;
}
...
checkUnnamed2241(core.List<api.SegmentFilterClause> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOrFiltersForSegment() {
  ...
  if (buildCounterOrFiltersForSegment < 3) {
    o.segmentFilterClauses = buildUnnamed2241();
  }
  buildCounterOrFiltersForSegment--;
  return o;
}
...
checkOrFiltersForSegment(api.OrFiltersForSegment o) {
  buildCounterOrFiltersForSegment++;
  if (buildCounterOrFiltersForSegment < 3) {
    checkUnnamed2241(o.segmentFilterClauses);
  }
  buildCounterOrFiltersForSegment--;
}
...
checkUnnamed2242(core.List<api.DimensionFilterClause> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2243(core.List<api.Dimension> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimension(o[0]);
  checkDimension(o[1]);
}
...
checkUnnamed2244(core.List<api.Metric> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetric(o[0]);
  checkMetric(o[1]);
}
...
buildPivot() {
  ...
  if (buildCounterPivot < 3) {
    o.dimensionFilterClauses = buildUnnamed2242();
    o.dimensions = buildUnnamed2243();
    o.maxGroupCount = 42;
    o.metrics = buildUnnamed2244();
    o.startGroup = 42;
  }
  buildCounterPivot--;
  return o;
...
checkPivot(api.Pivot o) {
  buildCounterPivot++;
  if (buildCounterPivot < 3) {
    checkUnnamed2242(o.dimensionFilterClauses);
    checkUnnamed2243(o.dimensions);
    unittest.expect(o.maxGroupCount, unittest.equals(42));
    checkUnnamed2244(o.metrics);
...
checkUnnamed2245(core.List<api.PivotHeaderEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPivotHeader() {
  ...
  if (buildCounterPivotHeader < 3) {
    o.pivotHeaderEntries = buildUnnamed2245();
...
checkPivotHeader(api.PivotHeader o) {
  buildCounterPivotHeader++;
  if (buildCounterPivotHeader < 3) {
    checkUnnamed2245(o.pivotHeaderEntries);
...
buildPivotHeaderEntry() {
  ...
  if (buildCounterPivotHeaderEntry < 3) {
    o.dimensionNames = buildUnnamed2246();
    o.dimensionValues = buildUnnamed2247();
...
checkPivotHeaderEntry(api.PivotHeaderEntry o) {
  buildCounterPivotHeaderEntry++;
  if (buildCounterPivotHeaderEntry < 3) {
    checkUnnamed2246(o.dimensionNames);
    checkUnnamed2247(o.dimensionValues);
...
checkUnnamed2249(core.List<api.DateRangeValues> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2250(core.List<api.DateRangeValues> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDateRangeValues(o[0]);
  checkDateRangeValues(o[1]);
}
...
checkUnnamed2251(core.List<api.ReportRow> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReportRow(o[0]);
  checkReportRow(o[1]);
}
...
checkUnnamed2254(core.List<api.DateRangeValues> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDateRangeValues(o[0]);
  checkDateRangeValues(o[1]);
}
...
buildReportData() {
  ...
  if (buildCounterReportData < 3) {
    ...
    o.isDataGolden = true;
    o.maximums = buildUnnamed2249();
    o.minimums = buildUnnamed2250();
    o.rowCount = 42;
    o.rows = buildUnnamed2251();
    o.samplesReadCounts = buildUnnamed2252();
    o.samplingSpaceSizes = buildUnnamed2253();
    o.totals = buildUnnamed2254();
  }
  buildCounterReportData--;
  return o;
}
...
checkReportData(api.ReportData o) {
  ...
  if (buildCounterReportData < 3) {
    ...
    checkUnnamed2249(o.maximums);
    checkUnnamed2250(o.minimums);
    unittest.expect(o.rowCount, unittest.equals(42));
    checkUnnamed2251(o.rows);
    checkUnnamed2252(o.samplesReadCounts);
    checkUnnamed2253(o.samplingSpaceSizes);
    checkUnnamed2254(o.totals);
  }
  buildCounterReportData--;
}
...
checkUnnamed2255(core.List<api.DateRange> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDateRange(o[0]);
  checkDateRange(o[1]);
}
...
checkUnnamed2256(core.List<api.DimensionFilterClause> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimensionFilterClause(o[0]);
  checkDimensionFilterClause(o[1]);
}
...
checkUnnamed2257(core.List<api.Dimension> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimension(o[0]);
  checkDimension(o[1]);
}
...
checkUnnamed2258(core.List<api.MetricFilterClause> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2259(core.List<api.Metric> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetric(o[0]);
  checkMetric(o[1]);
}
...
checkUnnamed2260(core.List<api.OrderBy> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrderBy(o[0]);
  checkOrderBy(o[1]);
}
...
checkUnnamed2261(core.List<api.Pivot> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPivot(o[0]);
  checkPivot(o[1]);
}
...
checkUnnamed2262(core.List<api.Segment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSegment(o[0]);
  checkSegment(o[1]);
}
...
buildReportRequest() {
  ...
  if (buildCounterReportRequest < 3) {
    ...
    o.dateRanges = buildUnnamed2255();
    o.dimensionFilterClauses = buildUnnamed2256();
    o.dimensions = buildUnnamed2257();
    o.filtersExpression = "foo";
    o.hideTotals = true;
    o.hideValueRanges = true;
    o.includeEmptyRows = true;
    o.metricFilterClauses = buildUnnamed2258();
    o.metrics = buildUnnamed2259();
    o.orderBys = buildUnnamed2260();
    o.pageSize = 42;
    o.pageToken = "foo";
    o.pivots = buildUnnamed2261();
    o.samplingLevel = "foo";
    o.segments = buildUnnamed2262();
    o.viewId = "foo";
  }
  buildCounterReportRequest--;
  return o;
...
checkReportRequest(api.ReportRequest o) {
  ...
  if (buildCounterReportRequest < 3) {
    ...
    checkUnnamed2255(o.dateRanges);
    checkUnnamed2256(o.dimensionFilterClauses);
    checkUnnamed2257(o.dimensions);
    ...
    checkUnnamed2258(o.metricFilterClauses);
    checkUnnamed2259(o.metrics);
    checkUnnamed2260(o.orderBys);
    unittest.expect(o.pageSize, unittest.equals(42));
    unittest.expect(o.pageToken, unittest.equals('foo'));
    checkUnnamed2261(o.pivots);
    unittest.expect(o.samplingLevel, unittest.equals('foo'));
    checkUnnamed2262(o.segments);
...
checkUnnamed2264(core.List<api.DateRangeValues> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDateRangeValues(o[0]);
  checkDateRangeValues(o[1]);
}
...
buildReportRow() {
  ...
  if (buildCounterReportRow < 3) {
    o.dimensions = buildUnnamed2263();
    o.metrics = buildUnnamed2264();
  }
  buildCounterReportRow--;
  return o;
}
...
checkReportRow(api.ReportRow o) {
  buildCounterReportRow++;
  if (buildCounterReportRow < 3) {
    checkUnnamed2263(o.dimensions);
    checkUnnamed2264(o.metrics);
  }
  buildCounterReportRow--;
}
...
buildSearchUserActivityRequest() {
  ...
  if (buildCounterSearchUserActivityRequest < 3) {
    o.activityTypes = buildUnnamed2265();
    o.dateRange = buildDateRange();
    o.pageSize = 42;
    o.pageToken = "foo";
    o.user = buildUser();
...
checkSearchUserActivityRequest(api.SearchUserActivityRequest o) {
  buildCounterSearchUserActivityRequest++;
  if (buildCounterSearchUserActivityRequest < 3) {
    checkUnnamed2265(o.activityTypes);
    checkDateRange(o.dateRange);
    unittest.expect(o.pageSize, unittest.equals(42));
    unittest.expect(o.pageToken, unittest.equals('foo'));
    checkUser(o.user);
...
checkUnnamed2266(core.List<api.UserActivitySession> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2267(core.List<api.SegmentFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSegmentDefinition() {
  ...
  if (buildCounterSegmentDefinition < 3) {
    o.segmentFilters = buildUnnamed2267();
  }
  buildCounterSegmentDefinition--;
  return o;
}
...
checkSegmentDefinition(api.SegmentDefinition o) {
  buildCounterSegmentDefinition++;
  if (buildCounterSegmentDefinition < 3) {
    checkUnnamed2267(o.segmentFilters);
  }
  buildCounterSegmentDefinition--;
}
...
buildSegmentDimensionFilter() {
  ...
  if (buildCounterSegmentDimensionFilter < 3) {
    o.caseSensitive = true;
    o.dimensionName = "foo";
    o.expressions = buildUnnamed2268();
...
checkSegmentDimensionFilter(api.SegmentDimensionFilter o) {
  ...
  if (buildCounterSegmentDimensionFilter < 3) {
    unittest.expect(o.caseSensitive, unittest.isTrue);
    unittest.expect(o.dimensionName, unittest.equals('foo'));
    checkUnnamed2268(o.expressions);
...
checkUnnamed2269(core.List<api.OrFiltersForSegment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSegmentSequenceStep() {
  ...
  if (buildCounterSegmentSequenceStep < 3) {
    o.matchType = "foo";
    o.orFiltersForSegment = buildUnnamed2269();
  }
  buildCounterSegmentSequenceStep--;
  return o;
}
...
checkSegmentSequenceStep(api.SegmentSequenceStep o) {
  ...
  if (buildCounterSegmentSequenceStep < 3) {
    ...
    checkUnnamed2269(o.orFiltersForSegment);
  }
  buildCounterSegmentSequenceStep--;
}
...
checkUnnamed2270(core.List<api.SegmentSequenceStep> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSequenceSegment() {
  ...
  if (buildCounterSequenceSegment < 3) {
    ...
    o.segmentSequenceSteps = buildUnnamed2270();
  }
  buildCounterSequenceSegment--;
  return o;
}
...
checkSequenceSegment(api.SequenceSegment o) {
  ...
  if (buildCounterSequenceSegment < 3) {
    ...
    checkUnnamed2270(o.segmentSequenceSteps);
  }
  buildCounterSequenceSegment--;
}
...
checkUnnamed2271(core.List<api.OrFiltersForSegment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrFiltersForSegment(o[0]);
  checkOrFiltersForSegment(o[1]);
}
...
buildSimpleSegment() {
  ...
  if (buildCounterSimpleSegment < 3) {
    o.orFiltersForSegment = buildUnnamed2271();
  }
  buildCounterSimpleSegment--;
  return o;
}
...
checkSimpleSegment(api.SimpleSegment o) {
  buildCounterSimpleSegment++;
  if (buildCounterSimpleSegment < 3) {
    checkUnnamed2271(o.orFiltersForSegment);
  }
  buildCounterSimpleSegment--;
}
...
checkUnnamed2272(core.List<api.Activity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkActivity(o[0]);
  checkActivity(o[1]);
}
