...
core.List<api.Account> buildUnnamed20() => [
      buildAccount(),
      buildAccount(),
    ];
...
core.List<api.QuotaGroup> buildUnnamed22() => [
      buildQuotaGroup(),
      buildQuotaGroup(),
    ];

void checkUnnamed22(core.List<api.QuotaGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQuotaGroup(o[0]);
  checkQuotaGroup(o[1]);
}
...
core.List<api.MethodDetails> buildUnnamed23() => [
      buildMethodDetails(),
      buildMethodDetails(),
    ];

void checkUnnamed23(core.List<api.MethodDetails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.QuotaGroup buildQuotaGroup() {
  ...
  if (buildCounterQuotaGroup < 3) {
    o.methodDetails = buildUnnamed23();
    o.name = 'foo';
    o.quotaLimit = 'foo';
...
void checkQuotaGroup(api.QuotaGroup o) {
  buildCounterQuotaGroup++;
  if (buildCounterQuotaGroup < 3) {
    checkUnnamed23(o.methodDetails!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
void main() {
  ...
  unittest.group('obj-schema-CssProduct', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od =
          api.CssProduct.fromJson(oJson as core.Map<core.String, core.dynamic>);
      checkCssProduct(od);
    });
  });
  ...
  unittest.group('obj-schema-QuotaGroup', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od =
          api.QuotaGroup.fromJson(oJson as core.Map<core.String, core.dynamic>);
      checkQuotaGroup(od);
    });
  });
  ...
  unittest.group('resource-AccountsResource', () {
    unittest.test('method--get', () async {
      ...
      final response =
          await res.get(arg_name, parent: arg_parent, $fields: arg_$fields);
    ...
    unittest.test('method--updateLabels', () async {
      ...
      final response =
          await res.updateLabels(arg_request, arg_name, $fields: arg_$fields);
      checkAccount(response as api.Account);
    });
  });
  ...
  unittest.group('resource-AccountsCssProductInputsResource', () {
    unittest.test('method--delete', () async {
      ...
      final response = await res.delete(arg_name,
          supplementalFeedId: arg_supplementalFeedId, $fields: arg_$fields);
    ...
    unittest.test('method--insert', () async {
      ...
      final response = await res.insert(arg_request, arg_parent,
  ...
  unittest.group('resource-AccountsQuotasResource', () {
    unittest.test('method--list', () async {
      final mock = HttpServerMock();
      final res = api.CssApi(mock).accounts.quotas;
      final arg_parent = 'foo';
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_$fields = 'foo';
