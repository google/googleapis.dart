...
core.List<api.ErrorProto> buildUnnamed1() => [
  buildErrorProto(),
  buildErrorProto(),
];

void checkUnnamed1(core.List<api.ErrorProto> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkErrorProto(o[0]);
  checkErrorProto(o[1]);
}
...
core.List<api.GroupItem> buildUnnamed2() => [
  buildGroupItem(),
  buildGroupItem(),
];

void checkUnnamed2(core.List<api.GroupItem> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGroupItem(o[0]);
  checkGroupItem(o[1]);
}
...
core.List<api.Group> buildUnnamed3() => [buildGroup(), buildGroup()];

void checkUnnamed3(core.List<api.Group> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGroup(o[0]);
  checkGroup(o[1]);
}
...
core.List<api.ResultTableColumnHeader> buildUnnamed4() => [
  buildResultTableColumnHeader(),
  buildResultTableColumnHeader(),
];

void checkUnnamed4(core.List<api.ResultTableColumnHeader> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void main() {
  ...
  unittest.group('obj-schema-ErrorProto', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ErrorProto.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkErrorProto(od);
    });
  ...
  unittest.group('obj-schema-GroupItem', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GroupItem.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGroupItem(od);
    });
  ...
  unittest.group('resource-GroupItemsResource', () {
    ...
    unittest.test('method--insert', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.GroupItem.fromJson(
