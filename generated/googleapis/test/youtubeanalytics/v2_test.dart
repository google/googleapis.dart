...
checkUnnamed3506(core.List<api.ErrorProto> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkErrorProto(o[0]);
  checkErrorProto(o[1]);
}
...
checkUnnamed3507(core.List<api.GroupItem> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGroupItem(o[0]);
  checkGroupItem(o[1]);
}
...
checkUnnamed3508(core.List<api.Group> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGroup(o[0]);
  checkGroup(o[1]);
}
...
checkUnnamed3509(core.List<api.ResultTableColumnHeader> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3510(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed3511() {
  ...
  o.add(buildUnnamed3510());
  o.add(buildUnnamed3510());
  return o;
}

checkUnnamed3511(core.List<core.List<core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed3510(o[0]);
  checkUnnamed3510(o[1]);
}
...
buildQueryResponse() {
  ...
  if (buildCounterQueryResponse < 3) {
    o.columnHeaders = buildUnnamed3509();
    o.errors = buildErrors();
    o.kind = "foo";
    o.rows = buildUnnamed3511();
  }
  buildCounterQueryResponse--;
  return o;
}
...
checkQueryResponse(api.QueryResponse o) {
  buildCounterQueryResponse++;
  if (buildCounterQueryResponse < 3) {
    checkUnnamed3509(o.columnHeaders);
    checkErrors(o.errors);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed3511(o.rows);
  }
  buildCounterQueryResponse--;
}
