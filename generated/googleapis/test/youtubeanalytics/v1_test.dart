...
checkUnnamed174(core.List<api.BatchReportOutputs> o) {
...
checkUnnamed175(core.List<api.BatchReportDefinition> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed176(core.List<api.BatchReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed177(core.List<api.GroupItem> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGroupItem(o[0]);
  checkGroupItem(o[1]);
}
...
checkUnnamed178(core.List<api.Group> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGroup(o[0]);
  checkGroup(o[1]);
}
...
checkUnnamed179(core.List<api.ResultTableColumnHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed180(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed181(core.List<core.List<core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed180(o[0]);
  checkUnnamed180(o[1]);
}
...
buildResultTable() {
  ...
  if (buildCounterResultTable < 3) {
    o.columnHeaders = buildUnnamed179();
    o.kind = "foo";
...
checkResultTable(api.ResultTable o) {
  buildCounterResultTable++;
  if (buildCounterResultTable < 3) {
    checkUnnamed179(o.columnHeaders);
    unittest.expect(o.kind, unittest.equals('foo'));
