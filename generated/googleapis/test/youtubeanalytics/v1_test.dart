...
checkUnnamed2981(core.List<api.BatchReportOutputs> o) {
...
checkUnnamed2982(core.List<api.BatchReportDefinition> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2983(core.List<api.BatchReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2984(core.List<api.GroupItem> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGroupItem(o[0]);
  checkGroupItem(o[1]);
}
...
checkUnnamed2985(core.List<api.Group> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGroup(o[0]);
  checkGroup(o[1]);
}
...
checkUnnamed2986(core.List<api.ResultTableColumnHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2987(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed2988() {
  ...
  o.add(buildUnnamed2987());
  o.add(buildUnnamed2987());
  return o;
}

checkUnnamed2988(core.List<core.List<core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2987(o[0]);
  checkUnnamed2987(o[1]);
}
...
buildResultTable() {
  ...
  if (buildCounterResultTable < 3) {
    o.columnHeaders = buildUnnamed2986();
    o.kind = "foo";
    o.rows = buildUnnamed2988();
  }
  buildCounterResultTable--;
  return o;
}
...
checkResultTable(api.ResultTable o) {
  buildCounterResultTable++;
  if (buildCounterResultTable < 3) {
    checkUnnamed2986(o.columnHeaders);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed2988(o.rows);
  }
  buildCounterResultTable--;
}
