...
checkUnnamed1454(core.List<api.BatchReportOutputs> o) {
...
checkUnnamed1455(core.List<api.BatchReportDefinition> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1456(core.List<api.BatchReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1457(core.List<api.GroupItem> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGroupItem(o[0]);
  checkGroupItem(o[1]);
}
...
checkUnnamed1458(core.List<api.Group> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGroup(o[0]);
  checkGroup(o[1]);
}
...
checkUnnamed1459(core.List<api.ResultTableColumnHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1461(core.List<core.List<core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildResultTable() {
  ...
  if (buildCounterResultTable < 3) {
    o.columnHeaders = buildUnnamed1459();
    o.kind = "foo";
    o.rows = buildUnnamed1461();
  }
  buildCounterResultTable--;
  return o;
}
...
checkResultTable(api.ResultTable o) {
  buildCounterResultTable++;
  if (buildCounterResultTable < 3) {
    checkUnnamed1459(o.columnHeaders);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1461(o.rows);
  }
  buildCounterResultTable--;
}
