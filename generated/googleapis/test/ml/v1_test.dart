...
void
  ...
  api.GoogleCloudMlV1AutomatedStoppingConfigDecayCurveAutomatedStoppingConfig o,
) {
  buildCounterGoogleCloudMlV1AutomatedStoppingConfigDecayCurveAutomatedStoppingConfig++;
  if (buildCounterGoogleCloudMlV1AutomatedStoppingConfigDecayCurveAutomatedStoppingConfig <
      3) {
...
core.List<core.double> buildUnnamed5() => [42.0, 42.0];
...
void
  ...
  api.GoogleCloudMlV1StudyConfigParameterSpecMatchingParentDiscreteValueSpec o,
) {
  buildCounterGoogleCloudMlV1StudyConfigParameterSpecMatchingParentDiscreteValueSpec++;
  if (buildCounterGoogleCloudMlV1StudyConfigParameterSpecMatchingParentDiscreteValueSpec <
      3) {
...
void checkGoogleCloudMlV1Job(api.GoogleCloudMlV1Job o) {
  ...
  if (buildCounterGoogleCloudMlV1Job < 3) {
    ...
    unittest.expect(o.jobPosition!, unittest.equals('foo'));
...
void main() {
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudMlV1HyperparameterOutputHyperparameterMetric();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudMlV1HyperparameterOutputHyperparameterMetric
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudMlV1StudyConfigParameterSpecDiscreteValueSpec();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudMlV1StudyConfigParameterSpecDiscreteValueSpec
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudMlV1StudyConfigParameterSpecIntegerValueSpec();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudMlV1StudyConfigParameterSpecIntegerValueSpec
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
  ...
  unittest.group(
    'obj-schema-GoogleCloudMlV1IntegratedGradientsAttribution',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group('resource-ProjectsResource', () {
    unittest.test('method--explain', () async {
      ...
      final response = await res.explain(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-ProjectsLocationsStudiesTrialsResource', () {
    unittest.test('method--addMeasurement', () async {
      ...
      final response = await res.addMeasurement(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--checkEarlyStoppingState', () async {
      ...
      final response = await res.checkEarlyStoppingState(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--listOptimalTrials', () async {
      ...
      final response = await res.listOptimalTrials(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--suggest', () async {
      ...
      final response = await res.suggest(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-ProjectsModelsVersionsResource', () {
    ...
    unittest.test('method--setDefault', () async {
      ...
      final response = await res.setDefault(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
