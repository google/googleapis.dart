...
checkUnnamed178(core.List<api.ApplicationTransferParam> o) {
...
buildApplication() {
  ...
  if (buildCounterApplication < 3) {
    ...
    o.kind = "foo";
    o.name = "foo";
    o.transferParams = buildUnnamed178();
  }
  buildCounterApplication--;
  return o;
}
...
checkApplication(api.Application o) {
  ...
  if (buildCounterApplication < 3) {
    ...
    checkUnnamed178(o.transferParams);
  }
  buildCounterApplication--;
}
...
checkUnnamed179(core.List<api.ApplicationTransferParam> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApplicationTransferParam(o[0]);
  checkApplicationTransferParam(o[1]);
}
...
buildApplicationDataTransfer() {
  ...
  if (buildCounterApplicationDataTransfer < 3) {
    o.applicationId = "foo";
    o.applicationTransferParams = buildUnnamed179();
...
checkApplicationDataTransfer(api.ApplicationDataTransfer o) {
  ...
  if (buildCounterApplicationDataTransfer < 3) {
    ...
    checkUnnamed179(o.applicationTransferParams);
...
checkUnnamed181(core.List<api.Application> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildApplicationsListResponse() {
  ...
  if (buildCounterApplicationsListResponse < 3) {
    o.applications = buildUnnamed181();
    o.etag = "foo";
    o.kind = "foo";
    o.nextPageToken = "foo";
  }
...
checkApplicationsListResponse(api.ApplicationsListResponse o) {
  buildCounterApplicationsListResponse++;
  if (buildCounterApplicationsListResponse < 3) {
    checkUnnamed181(o.applications);
    unittest.expect(o.etag, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed182(core.List<api.ApplicationDataTransfer> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildDataTransfer() {
  ...
  if (buildCounterDataTransfer < 3) {
    o.applicationDataTransfers = buildUnnamed182();
    o.etag = "foo";
    o.id = "foo";
    o.kind = "foo";
...
checkDataTransfer(api.DataTransfer o) {
  buildCounterDataTransfer++;
  if (buildCounterDataTransfer < 3) {
    checkUnnamed182(o.applicationDataTransfers);
    unittest.expect(o.etag, unittest.equals('foo'));
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed183(core.List<api.DataTransfer> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildDataTransfersListResponse() {
  ...
  if (buildCounterDataTransfersListResponse < 3) {
    o.dataTransfers = buildUnnamed183();
    o.etag = "foo";
    o.kind = "foo";
    o.nextPageToken = "foo";
  }
...
checkDataTransfersListResponse(api.DataTransfersListResponse o) {
  buildCounterDataTransfersListResponse++;
  if (buildCounterDataTransfersListResponse < 3) {
    checkUnnamed183(o.dataTransfers);
    unittest.expect(o.etag, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
