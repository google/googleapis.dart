...
core.List<api.Asp> buildUnnamed1() => [buildAsp(), buildAsp()];
...
void checkAuxiliaryMessage(api.AuxiliaryMessage o) {
  buildCounterAuxiliaryMessage++;
  if (buildCounterAuxiliaryMessage < 3) {
    unittest.expect(o.auxiliaryMessage!, unittest.equals('foo'));
...
core.int buildCounterBacklightInfo = 0;
api.BacklightInfo buildBacklightInfo() {
  final o = api.BacklightInfo();
  buildCounterBacklightInfo++;
  if (buildCounterBacklightInfo < 3) {
    o.brightness = 42;
    o.maxBrightness = 42;
    o.path = 'foo';
  }
...
void checkBacklightInfo(api.BacklightInfo o) {
  buildCounterBacklightInfo++;
  if (buildCounterBacklightInfo < 3) {
    unittest.expect(o.brightness!, unittest.equals(42));
    unittest.expect(o.maxBrightness!, unittest.equals(42));
...
core.int buildCounterBatchChangeChromeOsDeviceStatusRequest = 0;
api.BatchChangeChromeOsDeviceStatusRequest
buildBatchChangeChromeOsDeviceStatusRequest() {
  final o = api.BatchChangeChromeOsDeviceStatusRequest();
  buildCounterBatchChangeChromeOsDeviceStatusRequest++;
  if (buildCounterBatchChangeChromeOsDeviceStatusRequest < 3) {
    o.changeChromeOsDeviceStatusAction = 'foo';
    o.deprovisionReason = 'foo';
    o.deviceIds = buildUnnamed2();
  }
  buildCounterBatchChangeChromeOsDeviceStatusRequest--;
  return o;
}

void checkBatchChangeChromeOsDeviceStatusRequest(
  api.BatchChangeChromeOsDeviceStatusRequest o,
) {
  buildCounterBatchChangeChromeOsDeviceStatusRequest++;
  if (buildCounterBatchChangeChromeOsDeviceStatusRequest < 3) {
    unittest.expect(
      o.changeChromeOsDeviceStatusAction!,
      unittest.equals('foo'),
    );
    unittest.expect(o.deprovisionReason!, unittest.equals('foo'));
    checkUnnamed2(o.deviceIds!);
  }
  buildCounterBatchChangeChromeOsDeviceStatusRequest--;
}

core.List<api.ChangeChromeOsDeviceStatusResult> buildUnnamed3() => [
  buildChangeChromeOsDeviceStatusResult(),
  buildChangeChromeOsDeviceStatusResult(),
];

void checkUnnamed3(core.List<api.ChangeChromeOsDeviceStatusResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkChangeChromeOsDeviceStatusResult(o[0]);
  checkChangeChromeOsDeviceStatusResult(o[1]);
}

core.int buildCounterBatchChangeChromeOsDeviceStatusResponse = 0;
api.BatchChangeChromeOsDeviceStatusResponse
buildBatchChangeChromeOsDeviceStatusResponse() {
  final o = api.BatchChangeChromeOsDeviceStatusResponse();
  buildCounterBatchChangeChromeOsDeviceStatusResponse++;
  if (buildCounterBatchChangeChromeOsDeviceStatusResponse < 3) {
    o.changeChromeOsDeviceStatusResults = buildUnnamed3();
  }
  buildCounterBatchChangeChromeOsDeviceStatusResponse--;
  return o;
}

void checkBatchChangeChromeOsDeviceStatusResponse(
  api.BatchChangeChromeOsDeviceStatusResponse o,
) {
  buildCounterBatchChangeChromeOsDeviceStatusResponse++;
  if (buildCounterBatchChangeChromeOsDeviceStatusResponse < 3) {
    checkUnnamed3(o.changeChromeOsDeviceStatusResults!);
  }
  buildCounterBatchChangeChromeOsDeviceStatusResponse--;
}

core.List<api.CreatePrintServerRequest> buildUnnamed4() => [
  buildCreatePrintServerRequest(),
  buildCreatePrintServerRequest(),
];

void checkUnnamed4(core.List<api.CreatePrintServerRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.PrintServerFailureInfo> buildUnnamed5() => [
  buildPrintServerFailureInfo(),
  buildPrintServerFailureInfo(),
];

void checkUnnamed5(core.List<api.PrintServerFailureInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPrintServerFailureInfo(o[0]);
  checkPrintServerFailureInfo(o[1]);
}

core.List<api.PrintServer> buildUnnamed6() => [
  buildPrintServer(),
  buildPrintServer(),
];

void checkUnnamed6(core.List<api.PrintServer> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BatchCreatePrintServersResponse buildBatchCreatePrintServersResponse() {
  ...
  if (buildCounterBatchCreatePrintServersResponse < 3) {
    o.failures = buildUnnamed5();
    o.printServers = buildUnnamed6();
  }
  buildCounterBatchCreatePrintServersResponse--;
  return o;
}
...
void checkBatchCreatePrintServersResponse(
  ...
  buildCounterBatchCreatePrintServersResponse++;
  if (buildCounterBatchCreatePrintServersResponse < 3) {
    checkUnnamed5(o.failures!);
    checkUnnamed6(o.printServers!);
  }
  buildCounterBatchCreatePrintServersResponse--;
}

core.List<api.CreatePrinterRequest> buildUnnamed7() => [
  buildCreatePrinterRequest(),
  buildCreatePrinterRequest(),
];

void checkUnnamed7(core.List<api.CreatePrinterRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.FailureInfo> buildUnnamed8() => [
  buildFailureInfo(),
  buildFailureInfo(),
];

void checkUnnamed8(core.List<api.FailureInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFailureInfo(o[0]);
  checkFailureInfo(o[1]);
}

core.List<api.Printer> buildUnnamed9() => [buildPrinter(), buildPrinter()];

void checkUnnamed9(core.List<api.Printer> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPrinter(o[0]);
  checkPrinter(o[1]);
}
...
api.BatchCreatePrintersResponse buildBatchCreatePrintersResponse() {
  ...
  if (buildCounterBatchCreatePrintersResponse < 3) {
    o.failures = buildUnnamed8();
    o.printers = buildUnnamed9();
  }
  buildCounterBatchCreatePrintersResponse--;
  return o;
}
...
void checkBatchCreatePrintersResponse(api.BatchCreatePrintersResponse o) {
  buildCounterBatchCreatePrintersResponse++;
  if (buildCounterBatchCreatePrintersResponse < 3) {
    checkUnnamed8(o.failures!);
    checkUnnamed9(o.printers!);
  }
  buildCounterBatchCreatePrintersResponse--;
}
...
core.List<api.PrintServerFailureInfo> buildUnnamed11() => [
  buildPrintServerFailureInfo(),
  buildPrintServerFailureInfo(),
];

void checkUnnamed11(core.List<api.PrintServerFailureInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPrintServerFailureInfo(o[0]);
  checkPrintServerFailureInfo(o[1]);
}
...
api.BatchDeletePrintServersResponse buildBatchDeletePrintServersResponse() {
  ...
  if (buildCounterBatchDeletePrintServersResponse < 3) {
    o.failedPrintServers = buildUnnamed11();
    o.printServerIds = buildUnnamed12();
  }
  buildCounterBatchDeletePrintServersResponse--;
  return o;
}
...
void checkBatchDeletePrintServersResponse(
  ...
  buildCounterBatchDeletePrintServersResponse++;
  if (buildCounterBatchDeletePrintServersResponse < 3) {
    checkUnnamed11(o.failedPrintServers!);
    checkUnnamed12(o.printServerIds!);
  }
  buildCounterBatchDeletePrintServersResponse--;
}
...
core.List<api.FailureInfo> buildUnnamed14() => [
  buildFailureInfo(),
  buildFailureInfo(),
];

void checkUnnamed14(core.List<api.FailureInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFailureInfo(o[0]);
  checkFailureInfo(o[1]);
}
...
api.BatchDeletePrintersResponse buildBatchDeletePrintersResponse() {
  ...
  if (buildCounterBatchDeletePrintersResponse < 3) {
    o.failedPrinters = buildUnnamed14();
    o.printerIds = buildUnnamed15();
  }
  buildCounterBatchDeletePrintersResponse--;
  return o;
}
...
void checkBatchDeletePrintersResponse(api.BatchDeletePrintersResponse o) {
  buildCounterBatchDeletePrintersResponse++;
  if (buildCounterBatchDeletePrintersResponse < 3) {
    checkUnnamed14(o.failedPrinters!);
    checkUnnamed15(o.printerIds!);
  }
  buildCounterBatchDeletePrintersResponse--;
}

core.int buildCounterBluetoothAdapterInfo = 0;
api.BluetoothAdapterInfo buildBluetoothAdapterInfo() {
  final o = api.BluetoothAdapterInfo();
  buildCounterBluetoothAdapterInfo++;
  if (buildCounterBluetoothAdapterInfo < 3) {
    o.address = 'foo';
    o.numConnectedDevices = 42;
  }
  buildCounterBluetoothAdapterInfo--;
  return o;
}

void checkBluetoothAdapterInfo(api.BluetoothAdapterInfo o) {
  buildCounterBluetoothAdapterInfo++;
  if (buildCounterBluetoothAdapterInfo < 3) {
    unittest.expect(o.address!, unittest.equals('foo'));
    unittest.expect(o.numConnectedDevices!, unittest.equals(42));
  }
  buildCounterBluetoothAdapterInfo--;
}
...
core.List<api.Building> buildUnnamed18() => [buildBuilding(), buildBuilding()];

void checkUnnamed18(core.List<api.Building> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuilding(o[0]);
  checkBuilding(o[1]);
}
...
void checkByteUsage(api.ByteUsage o) {
  ...
  if (buildCounterByteUsage < 3) {
    ...
    unittest.expect(o.usedBytes!, unittest.equals('foo'));
  }
  buildCounterByteUsage--;
}
...
core.List<api.CalendarResource> buildUnnamed19() => [
  buildCalendarResource(),
  buildCalendarResource(),
];

void checkUnnamed19(core.List<api.CalendarResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.int buildCounterChangeChromeOsDeviceStatusResult = 0;
api.ChangeChromeOsDeviceStatusResult buildChangeChromeOsDeviceStatusResult() {
  final o = api.ChangeChromeOsDeviceStatusResult();
  buildCounterChangeChromeOsDeviceStatusResult++;
  if (buildCounterChangeChromeOsDeviceStatusResult < 3) {
    o.deviceId = 'foo';
    o.error = buildStatus();
    o.response = buildChangeChromeOsDeviceStatusSucceeded();
  }
  buildCounterChangeChromeOsDeviceStatusResult--;
  return o;
}

void checkChangeChromeOsDeviceStatusResult(
  api.ChangeChromeOsDeviceStatusResult o,
) {
  buildCounterChangeChromeOsDeviceStatusResult++;
  if (buildCounterChangeChromeOsDeviceStatusResult < 3) {
    unittest.expect(o.deviceId!, unittest.equals('foo'));
    checkStatus(o.error!);
    checkChangeChromeOsDeviceStatusSucceeded(o.response!);
  }
  buildCounterChangeChromeOsDeviceStatusResult--;
}

core.int buildCounterChangeChromeOsDeviceStatusSucceeded = 0;
api.ChangeChromeOsDeviceStatusSucceeded
buildChangeChromeOsDeviceStatusSucceeded() {
  final o = api.ChangeChromeOsDeviceStatusSucceeded();
  buildCounterChangeChromeOsDeviceStatusSucceeded++;
  if (buildCounterChangeChromeOsDeviceStatusSucceeded < 3) {}
  buildCounterChangeChromeOsDeviceStatusSucceeded--;
  return o;
}

void checkChangeChromeOsDeviceStatusSucceeded(
  api.ChangeChromeOsDeviceStatusSucceeded o,
) {
  buildCounterChangeChromeOsDeviceStatusSucceeded++;
  if (buildCounterChangeChromeOsDeviceStatusSucceeded < 3) {}
  buildCounterChangeChromeOsDeviceStatusSucceeded--;
...
core.List<api.ChromeOsDeviceActiveTimeRanges> buildUnnamed21() => [
  buildChromeOsDeviceActiveTimeRanges(),
  buildChromeOsDeviceActiveTimeRanges(),
];

void checkUnnamed21(core.List<api.ChromeOsDeviceActiveTimeRanges> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkChromeOsDeviceActiveTimeRanges(o[0]);
  checkChromeOsDeviceActiveTimeRanges(o[1]);
}

core.List<api.BacklightInfo> buildUnnamed22() => [
  buildBacklightInfo(),
  buildBacklightInfo(),
];

void checkUnnamed22(core.List<api.BacklightInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBacklightInfo(o[0]);
  checkBacklightInfo(o[1]);
}

core.List<api.BluetoothAdapterInfo> buildUnnamed23() => [
  buildBluetoothAdapterInfo(),
  buildBluetoothAdapterInfo(),
];

void checkUnnamed23(core.List<api.BluetoothAdapterInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBluetoothAdapterInfo(o[0]);
  checkBluetoothAdapterInfo(o[1]);
}
...
core.List<api.ChromeOsDeviceCpuInfoLogicalCpusCStates> buildUnnamed24() => [
  buildChromeOsDeviceCpuInfoLogicalCpusCStates(),
  buildChromeOsDeviceCpuInfoLogicalCpusCStates(),
];

void checkUnnamed24(core.List<api.ChromeOsDeviceCpuInfoLogicalCpusCStates> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkChromeOsDeviceCpuInfoLogicalCpus(
  ...
  buildCounterChromeOsDeviceCpuInfoLogicalCpus++;
  if (buildCounterChromeOsDeviceCpuInfoLogicalCpus < 3) {
    checkUnnamed24(o.cStates!);
    unittest.expect(o.currentScalingFrequencyKhz!, unittest.equals(42));
    unittest.expect(o.idleDuration!, unittest.equals('foo'));
    unittest.expect(o.maxScalingFrequencyKhz!, unittest.equals(42));
  }
  buildCounterChromeOsDeviceCpuInfoLogicalCpus--;
}

core.List<api.ChromeOsDeviceCpuInfoLogicalCpus> buildUnnamed25() => [
  buildChromeOsDeviceCpuInfoLogicalCpus(),
  buildChromeOsDeviceCpuInfoLogicalCpus(),
];

void checkUnnamed25(core.List<api.ChromeOsDeviceCpuInfoLogicalCpus> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkChromeOsDeviceCpuInfo(api.ChromeOsDeviceCpuInfo o) {
  ...
  if (buildCounterChromeOsDeviceCpuInfo < 3) {
    ...
    checkUnnamed25(o.logicalCpus!);
    unittest.expect(o.maxClockSpeedKhz!, unittest.equals(42));
    unittest.expect(o.model!, unittest.equals('foo'));
  }
  buildCounterChromeOsDeviceCpuInfo--;
}

core.List<api.ChromeOsDeviceCpuInfo> buildUnnamed26() => [
  buildChromeOsDeviceCpuInfo(),
  buildChromeOsDeviceCpuInfo(),
];

void checkUnnamed26(core.List<api.ChromeOsDeviceCpuInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ChromeOsDeviceCpuStatusReports buildChromeOsDeviceCpuStatusReports() {
  ...
  if (buildCounterChromeOsDeviceCpuStatusReports < 3) {
    o.cpuTemperatureInfo = buildUnnamed27();
    o.cpuUtilizationPercentageInfo = buildUnnamed28();
...
void checkChromeOsDeviceCpuStatusReports(api.ChromeOsDeviceCpuStatusReports o) {
  buildCounterChromeOsDeviceCpuStatusReports++;
  if (buildCounterChromeOsDeviceCpuStatusReports < 3) {
    checkUnnamed27(o.cpuTemperatureInfo!);
    checkUnnamed28(o.cpuUtilizationPercentageInfo!);
    unittest.expect(
      o.reportTime!,
...
core.List<api.ChromeOsDeviceCpuStatusReports> buildUnnamed29() => [
  buildChromeOsDeviceCpuStatusReports(),
  buildChromeOsDeviceCpuStatusReports(),
];

void checkUnnamed29(core.List<api.ChromeOsDeviceCpuStatusReports> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ChromeOsDeviceDeviceFiles> buildUnnamed30() => [
  buildChromeOsDeviceDeviceFiles(),
  buildChromeOsDeviceDeviceFiles(),
];

void checkUnnamed30(core.List<api.ChromeOsDeviceDeviceFiles> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ChromeOsDeviceDiskVolumeReportsVolumeInfo> buildUnnamed31() => [
  buildChromeOsDeviceDiskVolumeReportsVolumeInfo(),
  buildChromeOsDeviceDiskVolumeReportsVolumeInfo(),
];
...
void checkChromeOsDeviceDiskVolumeReports(
  ...
  buildCounterChromeOsDeviceDiskVolumeReports++;
  if (buildCounterChromeOsDeviceDiskVolumeReports < 3) {
    checkUnnamed31(o.volumeInfo!);
  }
  buildCounterChromeOsDeviceDiskVolumeReports--;
}

core.List<api.ChromeOsDeviceDiskVolumeReports> buildUnnamed32() => [
  buildChromeOsDeviceDiskVolumeReports(),
  buildChromeOsDeviceDiskVolumeReports(),
];

void checkUnnamed32(core.List<api.ChromeOsDeviceDiskVolumeReports> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkChromeOsDeviceDiskVolumeReports(o[0]);
  checkChromeOsDeviceDiskVolumeReports(o[1]);
}

core.List<api.FanInfo> buildUnnamed33() => [buildFanInfo(), buildFanInfo()];

void checkUnnamed33(core.List<api.FanInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFanInfo(o[0]);
  checkFanInfo(o[1]);
}
...
core.List<api.ChromeOsDeviceLastKnownNetwork> buildUnnamed34() => [
  buildChromeOsDeviceLastKnownNetwork(),
  buildChromeOsDeviceLastKnownNetwork(),
];

void checkUnnamed34(core.List<api.ChromeOsDeviceLastKnownNetwork> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ChromeOsDeviceRecentUsers> buildUnnamed35() => [
  buildChromeOsDeviceRecentUsers(),
  buildChromeOsDeviceRecentUsers(),
];

void checkUnnamed35(core.List<api.ChromeOsDeviceRecentUsers> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ChromeOsDeviceScreenshotFiles> buildUnnamed36() => [
  buildChromeOsDeviceScreenshotFiles(),
  buildChromeOsDeviceScreenshotFiles(),
];

void checkUnnamed36(core.List<api.ChromeOsDeviceScreenshotFiles> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildChromeOsDeviceSystemRamFreeReports() {
  ...
  if (buildCounterChromeOsDeviceSystemRamFreeReports < 3) {
    o.reportTime = core.DateTime.parse('2002-02-27T14:01:02Z');
    o.systemRamFreeInfo = buildUnnamed37();
  }
  buildCounterChromeOsDeviceSystemRamFreeReports--;
  return o;
}
...
void checkChromeOsDeviceSystemRamFreeReports(
  ...
  if (buildCounterChromeOsDeviceSystemRamFreeReports < 3) {
    ...
    checkUnnamed37(o.systemRamFreeInfo!);
  }
  buildCounterChromeOsDeviceSystemRamFreeReports--;
}

core.List<api.ChromeOsDeviceSystemRamFreeReports> buildUnnamed38() => [
  buildChromeOsDeviceSystemRamFreeReports(),
  buildChromeOsDeviceSystemRamFreeReports(),
];

void checkUnnamed38(core.List<api.ChromeOsDeviceSystemRamFreeReports> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ChromeOsDevice buildChromeOsDevice() {
  ...
  if (buildCounterChromeOsDevice < 3) {
    o.activeTimeRanges = buildUnnamed21();
    ...
    o.bluetoothAdapterInfo = buildUnnamed23();
    o.bootMode = 'foo';
    o.chromeOsType = 'foo';
    o.cpuInfo = buildUnnamed26();
    o.cpuStatusReports = buildUnnamed29();
    o.deprovisionReason = 'foo';
    o.deviceFiles = buildUnnamed30();
    o.deviceId = 'foo';
    o.deviceLicenseType = 'foo';
    o.diskSpaceUsage = buildByteUsage();
    o.diskVolumeReports = buildUnnamed32();
    ...
    o.recentUsers = buildUnnamed35();
    o.screenshotFiles = buildUnnamed36();
    o.serialNumber = 'foo';
    o.status = 'foo';
    o.supportEndDate = core.DateTime.parse('2002-02-27T14:01:02Z');
    o.systemRamFreeReports = buildUnnamed38();
...
void checkChromeOsDevice(api.ChromeOsDevice o) {
  buildCounterChromeOsDevice++;
  if (buildCounterChromeOsDevice < 3) {
    checkUnnamed21(o.activeTimeRanges!);
    ...
    unittest.expect(o.autoUpdateThrough!, unittest.equals('foo'));
    checkUnnamed22(o.backlightInfo!);
    checkUnnamed23(o.bluetoothAdapterInfo!);
    unittest.expect(o.bootMode!, unittest.equals('foo'));
    unittest.expect(o.chromeOsType!, unittest.equals('foo'));
    checkUnnamed26(o.cpuInfo!);
    checkUnnamed29(o.cpuStatusReports!);
    unittest.expect(o.deprovisionReason!, unittest.equals('foo'));
    checkUnnamed30(o.deviceFiles!);
    unittest.expect(o.deviceId!, unittest.equals('foo'));
    unittest.expect(o.deviceLicenseType!, unittest.equals('foo'));
    checkByteUsage(o.diskSpaceUsage!);
    checkUnnamed32(o.diskVolumeReports!);
    ...
    unittest.expect(o.extendedSupportStart!, unittest.equals('foo'));
    checkUnnamed33(o.fanInfo!);
    unittest.expect(o.firmwareVersion!, unittest.equals('foo'));
    unittest.expect(o.firstEnrollmentTime!, unittest.equals('foo'));
    unittest.expect(o.kind!, unittest.equals('foo'));
    unittest.expect(o.lastDeprovisionTimestamp!, unittest.equals('foo'));
    unittest.expect(
      o.lastEnrollmentTime!,
      unittest.equals(core.DateTime.parse('2002-02-27T14:01:02Z')),
    );
    checkUnnamed34(o.lastKnownNetwork!);
    unittest.expect(
      o.lastSync!,
      unittest.equals(core.DateTime.parse('2002-02-27T14:01:02Z')),
    );
    ...
    checkUnnamed35(o.recentUsers!);
    checkUnnamed36(o.screenshotFiles!);
    ...
    checkUnnamed38(o.systemRamFreeReports!);
...
core.List<api.ChromeOsDevice> buildUnnamed39() => [
  buildChromeOsDevice(),
  buildChromeOsDevice(),
];

void checkUnnamed39(core.List<api.ChromeOsDevice> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ChromeOsDevices buildChromeOsDevices() {
  ...
  if (buildCounterChromeOsDevices < 3) {
    o.chromeosdevices = buildUnnamed39();
    o.etag = 'foo';
    o.kind = 'foo';
    o.nextPageToken = 'foo';
  }
...
void checkChromeOsDevices(api.ChromeOsDevices o) {
  buildCounterChromeOsDevices++;
  if (buildCounterChromeOsDevices < 3) {
    checkUnnamed39(o.chromeosdevices!);
    unittest.expect(o.etag!, unittest.equals('foo'));
    unittest.expect(o.kind!, unittest.equals('foo'));
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
...
void checkDirectoryChromeosdevicesCommand(
  ...
  buildCounterDirectoryChromeosdevicesCommand++;
  if (buildCounterDirectoryChromeosdevicesCommand < 3) {
    unittest.expect(o.commandExpireTime!, unittest.equals('foo'));
...
void checkDirectoryChromeosdevicesCommandResult(
  ...
  buildCounterDirectoryChromeosdevicesCommandResult++;
  if (buildCounterDirectoryChromeosdevicesCommandResult < 3) {
    unittest.expect(o.commandResultPayload!, unittest.equals('foo'));
...
core.int buildCounterDirectoryUsersCreateGuestRequest = 0;
api.DirectoryUsersCreateGuestRequest buildDirectoryUsersCreateGuestRequest() {
  final o = api.DirectoryUsersCreateGuestRequest();
  buildCounterDirectoryUsersCreateGuestRequest++;
  if (buildCounterDirectoryUsersCreateGuestRequest < 3) {
    o.customer = 'foo';
    o.primaryGuestEmail = 'foo';
  }
  buildCounterDirectoryUsersCreateGuestRequest--;
  return o;
}

void checkDirectoryUsersCreateGuestRequest(
  api.DirectoryUsersCreateGuestRequest o,
) {
  buildCounterDirectoryUsersCreateGuestRequest++;
  if (buildCounterDirectoryUsersCreateGuestRequest < 3) {
    unittest.expect(o.customer!, unittest.equals('foo'));
    unittest.expect(o.primaryGuestEmail!, unittest.equals('foo'));
  }
  buildCounterDirectoryUsersCreateGuestRequest--;
}
...
core.List<api.DomainAlias> buildUnnamed41() => [
  buildDomainAlias(),
  buildDomainAlias(),
];

void checkUnnamed41(core.List<api.DomainAlias> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DomainAliases buildDomainAliases() {
  ...
  if (buildCounterDomainAliases < 3) {
    o.domainAliases = buildUnnamed41();
    o.etag = 'foo';
    o.kind = 'foo';
  }
  buildCounterDomainAliases--;
...
void checkDomainAliases(api.DomainAliases o) {
  buildCounterDomainAliases++;
  if (buildCounterDomainAliases < 3) {
    checkUnnamed41(o.domainAliases!);
    unittest.expect(o.etag!, unittest.equals('foo'));
    unittest.expect(o.kind!, unittest.equals('foo'));
  }
  buildCounterDomainAliases--;
...
core.List<api.DomainAlias> buildUnnamed42() => [
  buildDomainAlias(),
  buildDomainAlias(),
];

void checkUnnamed42(core.List<api.DomainAlias> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDomainAlias(o[0]);
  checkDomainAlias(o[1]);
}
...
api.Domains buildDomains() {
  ...
  if (buildCounterDomains < 3) {
    o.creationTime = 'foo';
    o.domainAliases = buildUnnamed42();
    o.domainName = 'foo';
    o.etag = 'foo';
    o.isPrimary = true;
    o.kind = 'foo';
...
void checkDomains(api.Domains o) {
  ...
  if (buildCounterDomains < 3) {
    unittest.expect(o.creationTime!, unittest.equals('foo'));
    checkUnnamed42(o.domainAliases!);
...
core.List<api.Domains> buildUnnamed43() => [buildDomains(), buildDomains()];

void checkUnnamed43(core.List<api.Domains> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDomains(o[0]);
  checkDomains(o[1]);
}
...
core.int buildCounterFanInfo = 0;
api.FanInfo buildFanInfo() {
  final o = api.FanInfo();
  buildCounterFanInfo++;
  if (buildCounterFanInfo < 3) {
    o.speedRpm = 42;
  }
  buildCounterFanInfo--;
  return o;
...
void checkFanInfo(api.FanInfo o) {
  buildCounterFanInfo++;
  if (buildCounterFanInfo < 3) {
    unittest.expect(o.speedRpm!, unittest.equals(42));
  }
  buildCounterFanInfo--;
}
...
core.List<api.Feature> buildUnnamed44() => [buildFeature(), buildFeature()];

void checkUnnamed44(core.List<api.Feature> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFeature(o[0]);
  checkFeature(o[1]);
}
...
core.List<api.ExternalId> buildUnnamed46() => [
  buildExternalId(),
  buildExternalId(),
];

void checkUnnamed46(core.List<api.ExternalId> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkExternalId(o[0]);
  checkExternalId(o[1]);
}
...
api.Group buildGroup() {
  ...
  if (buildCounterGroup < 3) {
    o.adminCreated = true;
    o.aliases = buildUnnamed45();
    o.description = 'foo';
    o.directMembersCount = 'foo';
    o.email = 'foo';
    o.etag = 'foo';
    o.externalIds = buildUnnamed46();
    o.id = 'foo';
    o.kind = 'foo';
    o.name = 'foo';
    o.nonEditableAliases = buildUnnamed47();
  }
  buildCounterGroup--;
  return o;
}
...
void checkGroup(api.Group o) {
  ...
  if (buildCounterGroup < 3) {
    ...
    checkUnnamed45(o.aliases!);
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.directMembersCount!, unittest.equals('foo'));
    unittest.expect(o.email!, unittest.equals('foo'));
    unittest.expect(o.etag!, unittest.equals('foo'));
    checkUnnamed46(o.externalIds!);
    unittest.expect(o.id!, unittest.equals('foo'));
    unittest.expect(o.kind!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed47(o.nonEditableAliases!);
  }
  buildCounterGroup--;
}

core.List<api.Group> buildUnnamed48() => [buildGroup(), buildGroup()];

void checkUnnamed48(core.List<api.Group> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGroup(o[0]);
  checkGroup(o[1]);
}
...
core.int buildCounterGuestAccountInfo = 0;
api.GuestAccountInfo buildGuestAccountInfo() {
  final o = api.GuestAccountInfo();
  buildCounterGuestAccountInfo++;
  if (buildCounterGuestAccountInfo < 3) {
    o.primaryGuestEmail = 'foo';
  }
  buildCounterGuestAccountInfo--;
  return o;
...
void checkGuestAccountInfo(api.GuestAccountInfo o) {
  buildCounterGuestAccountInfo++;
  if (buildCounterGuestAccountInfo < 3) {
    unittest.expect(o.primaryGuestEmail!, unittest.equals('foo'));
  }
...
core.List<api.PrintServer> buildUnnamed49() => [
  buildPrintServer(),
  buildPrintServer(),
];

void checkUnnamed49(core.List<api.PrintServer> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPrintServer(o[0]);
  checkPrintServer(o[1]);
}
...
void checkListPrintServersResponse(api.ListPrintServersResponse o) {
  ...
  if (buildCounterListPrintServersResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed49(o.printServers!);
  }
  buildCounterListPrintServersResponse--;
}

core.List<api.PrinterModel> buildUnnamed50() => [
  buildPrinterModel(),
  buildPrinterModel(),
];

void checkUnnamed50(core.List<api.PrinterModel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListPrinterModelsResponse buildListPrinterModelsResponse() {
  ...
  if (buildCounterListPrinterModelsResponse < 3) {
    o.nextPageToken = 'foo';
    o.printerModels = buildUnnamed50();
  }
  buildCounterListPrinterModelsResponse--;
  return o;
}
...
void checkListPrinterModelsResponse(api.ListPrinterModelsResponse o) {
  ...
  if (buildCounterListPrinterModelsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed50(o.printerModels!);
  }
  buildCounterListPrinterModelsResponse--;
}

core.List<api.Printer> buildUnnamed51() => [buildPrinter(), buildPrinter()];

void checkUnnamed51(core.List<api.Printer> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPrinter(o[0]);
  checkPrinter(o[1]);
}
...
core.List<api.Member> buildUnnamed52() => [buildMember(), buildMember()];

void checkUnnamed52(core.List<api.Member> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMember(o[0]);
  checkMember(o[1]);
}
...
core.List<api.MobileDeviceApplications> buildUnnamed54() => [
  buildMobileDeviceApplications(),
  buildMobileDeviceApplications(),
];

void checkUnnamed54(core.List<api.MobileDeviceApplications> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MobileDevice buildMobileDevice() {
  ...
  if (buildCounterMobileDevice < 3) {
    ...
    o.meid = 'foo';
    o.model = 'foo';
    o.name = buildUnnamed56();
    o.networkOperator = 'foo';
    o.os = 'foo';
    o.otherAccountsInfo = buildUnnamed57();
    o.privilege = 'foo';
...
core.List<api.MobileDevice> buildUnnamed58() => [
  buildMobileDevice(),
  buildMobileDevice(),
];

void checkUnnamed58(core.List<api.MobileDevice> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MobileDevices buildMobileDevices() {
  ...
  if (buildCounterMobileDevices < 3) {
    o.etag = 'foo';
    o.kind = 'foo';
    o.mobiledevices = buildUnnamed58();
    o.nextPageToken = 'foo';
  }
  buildCounterMobileDevices--;
  return o;
...
void checkMobileDevices(api.MobileDevices o) {
  ...
  if (buildCounterMobileDevices < 3) {
    unittest.expect(o.etag!, unittest.equals('foo'));
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed58(o.mobiledevices!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterMobileDevices--;
}
...
core.List<api.OrgUnit> buildUnnamed59() => [buildOrgUnit(), buildOrgUnit()];

void checkUnnamed59(core.List<api.OrgUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrgUnit(o[0]);
  checkOrgUnit(o[1]);
}
...
api.OrgUnits buildOrgUnits() {
  ...
  if (buildCounterOrgUnits < 3) {
    o.etag = 'foo';
    o.kind = 'foo';
    o.organizationUnits = buildUnnamed59();
  }
  buildCounterOrgUnits--;
  return o;
}
...
void checkOrgUnits(api.OrgUnits o) {
  ...
  if (buildCounterOrgUnits < 3) {
    unittest.expect(o.etag!, unittest.equals('foo'));
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed59(o.organizationUnits!);
  }
  buildCounterOrgUnits--;
}
...
void checkOsUpdateStatus(api.OsUpdateStatus o) {
  buildCounterOsUpdateStatus++;
  if (buildCounterOsUpdateStatus < 3) {
    unittest.expect(o.rebootTime!, unittest.equals('foo'));
    unittest.expect(o.state!, unittest.equals('foo'));
    unittest.expect(o.targetKioskAppVersion!, unittest.equals('foo'));
    unittest.expect(o.targetOsVersion!, unittest.equals('foo'));
    unittest.expect(o.updateCheckTime!, unittest.equals('foo'));
...
void checkPrintServerFailureInfo(api.PrintServerFailureInfo o) {
  ...
  if (buildCounterPrintServerFailureInfo < 3) {
    ...
    unittest.expect(o.errorMessage!, unittest.equals('foo'));
    checkPrintServer(o.printServer!);
    unittest.expect(o.printServerId!, unittest.equals('foo'));
  }
  buildCounterPrintServerFailureInfo--;
}

core.List<api.AuxiliaryMessage> buildUnnamed60() => [
  buildAuxiliaryMessage(),
  buildAuxiliaryMessage(),
];

void checkUnnamed60(core.List<api.AuxiliaryMessage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Printer buildPrinter() {
  ...
  if (buildCounterPrinter < 3) {
    o.auxiliaryMessages = buildUnnamed60();
    o.createTime = 'foo';
    o.description = 'foo';
    o.displayName = 'foo';
    o.id = 'foo';
...
void checkPrinter(api.Printer o) {
  buildCounterPrinter++;
  if (buildCounterPrinter < 3) {
    checkUnnamed60(o.auxiliaryMessages!);
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.displayName!, unittest.equals('foo'));
    unittest.expect(o.id!, unittest.equals('foo'));
    unittest.expect(o.makeAndModel!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.orgUnitId!, unittest.equals('foo'));
    unittest.expect(o.uri!, unittest.equals('foo'));
...
core.List<api.Privilege> buildUnnamed61() => [
  buildPrivilege(),
  buildPrivilege(),
];

void checkUnnamed61(core.List<api.Privilege> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPrivilege(o[0]);
  checkPrivilege(o[1]);
}
...
api.Privilege buildPrivilege() {
  ...
  if (buildCounterPrivilege < 3) {
    o.childPrivileges = buildUnnamed61();
    o.etag = 'foo';
    o.isOuScopable = true;
    o.kind = 'foo';
    o.privilegeName = 'foo';
...
void checkPrivilege(api.Privilege o) {
  buildCounterPrivilege++;
  if (buildCounterPrivilege < 3) {
    checkUnnamed61(o.childPrivileges!);
    unittest.expect(o.etag!, unittest.equals('foo'));
...
core.List<api.Privilege> buildUnnamed62() => [
  buildPrivilege(),
  buildPrivilege(),
];

void checkUnnamed62(core.List<api.Privilege> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPrivilege(o[0]);
  checkPrivilege(o[1]);
}
...
core.List<api.RoleRolePrivileges> buildUnnamed63() => [
  buildRoleRolePrivileges(),
  buildRoleRolePrivileges(),
];

void checkUnnamed63(core.List<api.RoleRolePrivileges> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Role buildRole() {
  ...
  if (buildCounterRole < 3) {
    ...
    o.roleId = 'foo';
    o.roleName = 'foo';
    o.rolePrivileges = buildUnnamed63();
  }
  buildCounterRole--;
  return o;
}
...
void checkRole(api.Role o) {
  ...
  if (buildCounterRole < 3) {
    ...
    checkUnnamed63(o.rolePrivileges!);
  }
  buildCounterRole--;
}
...
core.List<api.RoleAssignment> buildUnnamed64() => [
  buildRoleAssignment(),
  buildRoleAssignment(),
];

void checkUnnamed64(core.List<api.RoleAssignment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Role> buildUnnamed65() => [buildRole(), buildRole()];

void checkUnnamed65(core.List<api.Role> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRole(o[0]);
  checkRole(o[1]);
}
...
core.List<api.SchemaFieldSpec> buildUnnamed66() => [
  buildSchemaFieldSpec(),
  buildSchemaFieldSpec(),
];

void checkUnnamed66(core.List<api.SchemaFieldSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Schema> buildUnnamed67() => [buildSchema(), buildSchema()];

void checkUnnamed67(core.List<api.Schema> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSchema(o[0]);
  checkSchema(o[1]);
}
...
void checkToken(api.Token o) {
  ...
  if (buildCounterToken < 3) {
    ...
    checkUnnamed70(o.scopes!);
    unittest.expect(o.userKey!, unittest.equals('foo'));
  }
  buildCounterToken--;
}

core.List<api.Token> buildUnnamed71() => [buildToken(), buildToken()];

void checkUnnamed71(core.List<api.Token> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkToken(o[0]);
  checkToken(o[1]);
}
...
core.Map<core.String, api.UserCustomProperties> buildUnnamed73() => {
  'x': buildUserCustomProperties(),
  'y': buildUserCustomProperties(),
};

void checkUnnamed73(core.Map<core.String, api.UserCustomProperties> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.User buildUser() {
  ...
  if (buildCounterUser < 3) {
    ...
    o.customSchemas = buildUnnamed73();
    o.customerId = 'foo';
    ...
    o.guestAccountInfo = buildGuestAccountInfo();
    o.hashFunction = 'foo';
    o.id = 'foo';
    o.ims = {
      'list': [1, 2, 3],
    ...
    o.nonEditableAliases = buildUnnamed74();
    o.notes = {
      'list': [1, 2, 3],
      'bool': true,
      'string': 'foo',
...
void checkUser(api.User o) {
  buildCounterUser++;
  if (buildCounterUser < 3) {
    var casted6 = (o.addresses!) as core.Map;
    ...
    unittest.expect(o.archivalTime!, unittest.equals('foo'));
    ...
    checkUnnamed73(o.customSchemas!);
    unittest.expect(o.customerId!, unittest.equals('foo'));
    unittest.expect(
      o.deletionTime!,
      unittest.equals(core.DateTime.parse('2002-02-27T14:01:02Z')),
    );
    var casted7 = (o.emails!) as core.Map;
    unittest.expect(casted7, unittest.hasLength(3));
    unittest.expect(casted7['list'], unittest.equals([1, 2, 3]));
    unittest.expect(casted7['bool'], unittest.equals(true));
    unittest.expect(casted7['string'], unittest.equals('foo'));
    unittest.expect(o.etag!, unittest.equals('foo'));
    var casted8 = (o.externalIds!) as core.Map;
    unittest.expect(casted8, unittest.hasLength(3));
    unittest.expect(casted8['list'], unittest.equals([1, 2, 3]));
    unittest.expect(casted8['bool'], unittest.equals(true));
    unittest.expect(casted8['string'], unittest.equals('foo'));
    var casted9 = (o.gender!) as core.Map;
    unittest.expect(casted9, unittest.hasLength(3));
    unittest.expect(casted9['list'], unittest.equals([1, 2, 3]));
    unittest.expect(casted9['bool'], unittest.equals(true));
    unittest.expect(casted9['string'], unittest.equals('foo'));
    checkGuestAccountInfo(o.guestAccountInfo!);
    unittest.expect(o.hashFunction!, unittest.equals('foo'));
    unittest.expect(o.id!, unittest.equals('foo'));
    var casted10 = (o.ims!) as core.Map;
    ...
    unittest.expect(o.isGuestUser!, unittest.isTrue);
    unittest.expect(o.isMailboxSetup!, unittest.isTrue);
    var casted11 = (o.keywords!) as core.Map;
    unittest.expect(casted11, unittest.hasLength(3));
    unittest.expect(casted11['list'], unittest.equals([1, 2, 3]));
    unittest.expect(casted11['bool'], unittest.equals(true));
    unittest.expect(casted11['string'], unittest.equals('foo'));
    unittest.expect(o.kind!, unittest.equals('foo'));
    var casted12 = (o.languages!) as core.Map;
    ...
    var casted13 = (o.locations!) as core.Map;
    unittest.expect(casted13, unittest.hasLength(3));
    unittest.expect(casted13['list'], unittest.equals([1, 2, 3]));
    unittest.expect(casted13['bool'], unittest.equals(true));
    unittest.expect(casted13['string'], unittest.equals('foo'));
    checkUserName(o.name!);
    checkUnnamed74(o.nonEditableAliases!);
    var casted14 = (o.notes!) as core.Map;
    unittest.expect(casted14, unittest.hasLength(3));
    unittest.expect(casted14['list'], unittest.equals([1, 2, 3]));
    unittest.expect(casted14['bool'], unittest.equals(true));
    unittest.expect(casted14['string'], unittest.equals('foo'));
    unittest.expect(o.orgUnitPath!, unittest.equals('foo'));
    var casted15 = (o.organizations!) as core.Map;
    unittest.expect(casted15, unittest.hasLength(3));
    unittest.expect(casted15['list'], unittest.equals([1, 2, 3]));
    unittest.expect(casted15['bool'], unittest.equals(true));
    unittest.expect(casted15['string'], unittest.equals('foo'));
    unittest.expect(o.password!, unittest.equals('foo'));
    var casted16 = (o.phones!) as core.Map;
    unittest.expect(casted16, unittest.hasLength(3));
    unittest.expect(casted16['list'], unittest.equals([1, 2, 3]));
    unittest.expect(casted16['bool'], unittest.equals(true));
    unittest.expect(casted16['string'], unittest.equals('foo'));
    var casted17 = (o.posixAccounts!) as core.Map;
    ...
    var casted18 = (o.relations!) as core.Map;
    unittest.expect(casted18, unittest.hasLength(3));
    unittest.expect(casted18['list'], unittest.equals([1, 2, 3]));
    unittest.expect(casted18['bool'], unittest.equals(true));
    unittest.expect(casted18['string'], unittest.equals('foo'));
    var casted19 = (o.sshPublicKeys!) as core.Map;
...
core.List<api.User> buildUnnamed75() => [buildUser(), buildUser()];

void checkUnnamed75(core.List<api.User> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUser(o[0]);
  checkUser(o[1]);
}
...
core.List<api.VerificationCode> buildUnnamed76() => [
  buildVerificationCode(),
  buildVerificationCode(),
];

void checkUnnamed76(core.List<api.VerificationCode> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void main() {
  ...
  unittest.group('obj-schema-BacklightInfo', () {
    unittest.test('to-json--from-json', () async {
      final o = buildBacklightInfo();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.BacklightInfo.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkBacklightInfo(od);
    });
  });

  unittest.group('obj-schema-BatchChangeChromeOsDeviceStatusRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildBatchChangeChromeOsDeviceStatusRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.BatchChangeChromeOsDeviceStatusRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkBatchChangeChromeOsDeviceStatusRequest(od);
    });
  });

  unittest.group('obj-schema-BatchChangeChromeOsDeviceStatusResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildBatchChangeChromeOsDeviceStatusResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.BatchChangeChromeOsDeviceStatusResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkBatchChangeChromeOsDeviceStatusResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-BluetoothAdapterInfo', () {
    unittest.test('to-json--from-json', () async {
      final o = buildBluetoothAdapterInfo();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.BluetoothAdapterInfo.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkBluetoothAdapterInfo(od);
    });
  });
  ...
  unittest.group('obj-schema-Building', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Building.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkBuilding(od);
    });
  ...
  unittest.group('obj-schema-Buildings', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Buildings.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkBuildings(od);
    });
  ...
  unittest.group('obj-schema-ByteUsage', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ByteUsage.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkByteUsage(od);
    });
  ...
  unittest.group('obj-schema-ChangeChromeOsDeviceStatusResult', () {
    unittest.test('to-json--from-json', () async {
      final o = buildChangeChromeOsDeviceStatusResult();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ChangeChromeOsDeviceStatusResult.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkChangeChromeOsDeviceStatusResult(od);
    });
  });

  unittest.group('obj-schema-ChangeChromeOsDeviceStatusSucceeded', () {
    unittest.test('to-json--from-json', () async {
      final o = buildChangeChromeOsDeviceStatusSucceeded();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ChangeChromeOsDeviceStatusSucceeded.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkChangeChromeOsDeviceStatusSucceeded(od);
    });
  });
  ...
  unittest.group(
    'obj-schema-ChromeOsDeviceCpuStatusReportsCpuTemperatureInfo',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group('obj-schema-DirectoryUsersCreateGuestRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildDirectoryUsersCreateGuestRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.DirectoryUsersCreateGuestRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkDirectoryUsersCreateGuestRequest(od);
    });
  });
  ...
  unittest.group('obj-schema-Domains2', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Domains2.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkDomains2(od);
    });
  ...
  unittest.group('obj-schema-ExternalId', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ExternalId.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkExternalId(od);
    });
  ...
  unittest.group('obj-schema-FanInfo', () {
    unittest.test('to-json--from-json', () async {
      final o = buildFanInfo();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.FanInfo.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkFanInfo(od);
    });
  ...
  unittest.group('obj-schema-Features', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Features.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkFeatures(od);
    });
  ...
  unittest.group('obj-schema-GuestAccountInfo', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGuestAccountInfo();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GuestAccountInfo.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGuestAccountInfo(od);
    });
  });
  ...
  unittest.group('obj-schema-OrgUnits', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.OrgUnits.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkOrgUnits(od);
    });
  ...
  unittest.group('obj-schema-Privilege', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Privilege.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPrivilege(od);
    });
  ...
  unittest.group('obj-schema-Privileges', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Privileges.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPrivileges(od);
    });
  ...
  unittest.group('obj-schema-UserName', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.UserName.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkUserName(od);
    });
  ...
  unittest.group('obj-schema-UserPhoto', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.UserPhoto.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkUserPhoto(od);
    });
  ...
  unittest.group('resource-CustomerDevicesChromeosResource', () {
    unittest.test('method--batchChangeStatus', () async {
      final mock = HttpServerMock();
      final res = api.DirectoryApi(mock).customer.devices.chromeos;
      final arg_request = buildBatchChangeChromeOsDeviceStatusRequest();
      final arg_customerId = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.BatchChangeChromeOsDeviceStatusRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkBatchChangeChromeOsDeviceStatusRequest(obj);
          ...
          unittest.expect(
            ...
            unittest.equals('/devices/chromeos:batchChangeStatus'),
          );
          pathOffset += 35;
      ...
      final response = await res.batchChangeStatus(
        arg_request,
        arg_customerId,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--get', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          subPart = core.Uri.decodeQueryComponent(path.substring(pathOffset));
          pathOffset = path.length;
          unittest.expect(subPart, unittest.equals('$arg_commandId'));
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildDirectoryChromeosdevicesCommand(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
    ...
    unittest.test('method--batchCreatePrintServers', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildBatchCreatePrintServersResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
    ...
    unittest.test('method--batchDeletePrintServers', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildBatchDeletePrintServersResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
  ...
  unittest.group('resource-CustomersChromePrintersResource', () {
    unittest.test('method--batchCreatePrinters', () async {
      ...
      final response = await res.batchCreatePrinters(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--batchDeletePrinters', () async {
      ...
      final response = await res.batchDeletePrinters(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Printer.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkPrinter(obj);
    ...
    unittest.test('method--listPrinterModels', () async {
      ...
      final response = await res.listPrinterModels(
        arg_parent,
        filter: arg_filter,
        pageSize: arg_pageSize,
        pageToken: arg_pageToken,
  ...
  unittest.group('resource-DomainAliasesResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final response = await res.list(
        arg_customer,
        parentDomainName: arg_parentDomainName,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-DomainsResource', () {
    ...
    unittest.test('method--insert', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Domains.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkDomains(obj);
  ...
  unittest.group('resource-MembersResource', () {
    ...
    unittest.test('method--hasMember', () async {
      ...
      final response = await res.hasMember(
        arg_groupKey,
        arg_memberKey,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-OrgunitsResource', () {
    ...
    unittest.test('method--insert', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.OrgUnit.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkOrgUnit(obj);
  ...
  unittest.group('resource-ResourcesBuildingsResource', () {
    ...
    unittest.test('method--insert', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Building.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkBuilding(obj);
      ...
      final response = await res.insert(
        arg_request,
        arg_customer,
        coordinatesSource: arg_coordinatesSource,
        $fields: arg_$fields,
      );
      checkBuilding(response as api.Building);
    });
  ...
  unittest.group('resource-UsersResource', () {
    unittest.test('method--createGuest', () async {
      final mock = HttpServerMock();
      final res = api.DirectoryApi(mock).users;
      final arg_request = buildDirectoryUsersCreateGuestRequest();
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.DirectoryUsersCreateGuestRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkDirectoryUsersCreateGuestRequest(obj);
          ...
          unittest.expect(
            ...
            unittest.equals('admin/directory/v1/users:createGuest'),
          );
          pathOffset += 36;
      ...
      final response = await res.createGuest(arg_request, $fields: arg_$fields);
  ...
  unittest.group('resource-UsersPhotosResource', () {
    ...
    unittest.test('method--patch', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.UserPhoto.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkUserPhoto(obj);
