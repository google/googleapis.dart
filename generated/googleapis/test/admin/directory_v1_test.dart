...
core.List<api.ChromeOsDeviceCpuInfoLogicalCpusCStates> buildUnnamed23() => [
  buildChromeOsDeviceCpuInfoLogicalCpusCStates(),
  buildChromeOsDeviceCpuInfoLogicalCpusCStates(),
];

void checkUnnamed23(core.List<api.ChromeOsDeviceCpuInfoLogicalCpusCStates> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ChromeOsDeviceCpuInfoLogicalCpus> buildUnnamed24() => [
  buildChromeOsDeviceCpuInfoLogicalCpus(),
  buildChromeOsDeviceCpuInfoLogicalCpus(),
];

void checkUnnamed24(core.List<api.ChromeOsDeviceCpuInfoLogicalCpus> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ChromeOsDeviceCpuInfo> buildUnnamed25() => [
  buildChromeOsDeviceCpuInfo(),
  buildChromeOsDeviceCpuInfo(),
];

void checkUnnamed25(core.List<api.ChromeOsDeviceCpuInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ChromeOsDeviceCpuStatusReports buildChromeOsDeviceCpuStatusReports() {
  ...
  if (buildCounterChromeOsDeviceCpuStatusReports < 3) {
    o.cpuTemperatureInfo = buildUnnamed26();
    o.cpuUtilizationPercentageInfo = buildUnnamed27();
...
void checkChromeOsDeviceCpuStatusReports(api.ChromeOsDeviceCpuStatusReports o) {
  buildCounterChromeOsDeviceCpuStatusReports++;
  if (buildCounterChromeOsDeviceCpuStatusReports < 3) {
    checkUnnamed26(o.cpuTemperatureInfo!);
    checkUnnamed27(o.cpuUtilizationPercentageInfo!);
    unittest.expect(
      o.reportTime!,
...
core.List<api.ChromeOsDeviceCpuStatusReports> buildUnnamed28() => [
  buildChromeOsDeviceCpuStatusReports(),
  buildChromeOsDeviceCpuStatusReports(),
];

void checkUnnamed28(core.List<api.ChromeOsDeviceCpuStatusReports> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ChromeOsDeviceDeviceFiles> buildUnnamed29() => [
  buildChromeOsDeviceDeviceFiles(),
  buildChromeOsDeviceDeviceFiles(),
];

void checkUnnamed29(core.List<api.ChromeOsDeviceDeviceFiles> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ChromeOsDeviceDiskVolumeReportsVolumeInfo> buildUnnamed30() => [
  buildChromeOsDeviceDiskVolumeReportsVolumeInfo(),
  buildChromeOsDeviceDiskVolumeReportsVolumeInfo(),
];
...
void checkChromeOsDeviceDiskVolumeReports(
  ...
  buildCounterChromeOsDeviceDiskVolumeReports++;
  if (buildCounterChromeOsDeviceDiskVolumeReports < 3) {
    checkUnnamed30(o.volumeInfo!);
  }
  buildCounterChromeOsDeviceDiskVolumeReports--;
}

core.List<api.ChromeOsDeviceDiskVolumeReports> buildUnnamed31() => [
  buildChromeOsDeviceDiskVolumeReports(),
  buildChromeOsDeviceDiskVolumeReports(),
];

void checkUnnamed31(core.List<api.ChromeOsDeviceDiskVolumeReports> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkChromeOsDeviceDiskVolumeReports(o[0]);
  checkChromeOsDeviceDiskVolumeReports(o[1]);
}

core.List<api.FanInfo> buildUnnamed32() => [buildFanInfo(), buildFanInfo()];

void checkUnnamed32(core.List<api.FanInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFanInfo(o[0]);
  checkFanInfo(o[1]);
}
...
core.List<api.ChromeOsDeviceLastKnownNetwork> buildUnnamed33() => [
  buildChromeOsDeviceLastKnownNetwork(),
  buildChromeOsDeviceLastKnownNetwork(),
];

void checkUnnamed33(core.List<api.ChromeOsDeviceLastKnownNetwork> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ChromeOsDeviceRecentUsers> buildUnnamed34() => [
  buildChromeOsDeviceRecentUsers(),
  buildChromeOsDeviceRecentUsers(),
];

void checkUnnamed34(core.List<api.ChromeOsDeviceRecentUsers> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ChromeOsDeviceScreenshotFiles> buildUnnamed35() => [
  buildChromeOsDeviceScreenshotFiles(),
  buildChromeOsDeviceScreenshotFiles(),
];

void checkUnnamed35(core.List<api.ChromeOsDeviceScreenshotFiles> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildChromeOsDeviceSystemRamFreeReports() {
  ...
  if (buildCounterChromeOsDeviceSystemRamFreeReports < 3) {
    o.reportTime = core.DateTime.parse('2002-02-27T14:01:02Z');
    o.systemRamFreeInfo = buildUnnamed36();
  }
  buildCounterChromeOsDeviceSystemRamFreeReports--;
  return o;
}
...
void checkChromeOsDeviceSystemRamFreeReports(
  ...
  if (buildCounterChromeOsDeviceSystemRamFreeReports < 3) {
    ...
    checkUnnamed36(o.systemRamFreeInfo!);
  }
  buildCounterChromeOsDeviceSystemRamFreeReports--;
}

core.List<api.ChromeOsDeviceSystemRamFreeReports> buildUnnamed37() => [
  buildChromeOsDeviceSystemRamFreeReports(),
  buildChromeOsDeviceSystemRamFreeReports(),
];

void checkUnnamed37(core.List<api.ChromeOsDeviceSystemRamFreeReports> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ChromeOsDevice buildChromeOsDevice() {
  ...
  if (buildCounterChromeOsDevice < 3) {
    ...
    o.systemRamFreeReports = buildUnnamed37();
...
void checkChromeOsDevice(api.ChromeOsDevice o) {
  ...
  if (buildCounterChromeOsDevice < 3) {
    ...
    checkUnnamed28(o.cpuStatusReports!);
    unittest.expect(o.deprovisionReason!, unittest.equals('foo'));
    checkUnnamed29(o.deviceFiles!);
    unittest.expect(o.deviceId!, unittest.equals('foo'));
    ...
    checkUnnamed33(o.lastKnownNetwork!);
    unittest.expect(
      o.lastSync!,
      unittest.equals(core.DateTime.parse('2002-02-27T14:01:02Z')),
    );
    ...
    checkUnnamed37(o.systemRamFreeReports!);
...
core.List<api.ChromeOsDevice> buildUnnamed38() => [
  buildChromeOsDevice(),
  buildChromeOsDevice(),
];

void checkUnnamed38(core.List<api.ChromeOsDevice> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ChromeOsDevices buildChromeOsDevices() {
  ...
  if (buildCounterChromeOsDevices < 3) {
    o.chromeosdevices = buildUnnamed38();
    o.etag = 'foo';
    o.kind = 'foo';
    o.nextPageToken = 'foo';
  }
...
void checkChromeOsDevices(api.ChromeOsDevices o) {
  buildCounterChromeOsDevices++;
  if (buildCounterChromeOsDevices < 3) {
    checkUnnamed38(o.chromeosdevices!);
    unittest.expect(o.etag!, unittest.equals('foo'));
    unittest.expect(o.kind!, unittest.equals('foo'));
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
...
core.List<api.DomainAlias> buildUnnamed40() => [
  buildDomainAlias(),
  buildDomainAlias(),
];

void checkUnnamed40(core.List<api.DomainAlias> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DomainAliases buildDomainAliases() {
  ...
  if (buildCounterDomainAliases < 3) {
    o.domainAliases = buildUnnamed40();
    o.etag = 'foo';
    o.kind = 'foo';
  }
  buildCounterDomainAliases--;
...
void checkDomainAliases(api.DomainAliases o) {
  buildCounterDomainAliases++;
  if (buildCounterDomainAliases < 3) {
    checkUnnamed40(o.domainAliases!);
    unittest.expect(o.etag!, unittest.equals('foo'));
    unittest.expect(o.kind!, unittest.equals('foo'));
  }
  buildCounterDomainAliases--;
...
core.List<api.Domains> buildUnnamed42() => [buildDomains(), buildDomains()];

void checkUnnamed42(core.List<api.Domains> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDomains(o[0]);
  checkDomains(o[1]);
}
...
core.List<api.Feature> buildUnnamed43() => [buildFeature(), buildFeature()];

void checkUnnamed43(core.List<api.Feature> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFeature(o[0]);
  checkFeature(o[1]);
}
...
api.Group buildGroup() {
  ...
  if (buildCounterGroup < 3) {
    ...
    o.kind = 'foo';
    o.name = 'foo';
    o.nonEditableAliases = buildUnnamed45();
  }
  buildCounterGroup--;
  return o;
}
...
void checkGroup(api.Group o) {
  ...
  if (buildCounterGroup < 3) {
    ...
    unittest.expect(o.kind!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed45(o.nonEditableAliases!);
  }
  buildCounterGroup--;
}

core.List<api.Group> buildUnnamed46() => [buildGroup(), buildGroup()];

void checkUnnamed46(core.List<api.Group> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGroup(o[0]);
  checkGroup(o[1]);
}
...
core.List<api.PrintServer> buildUnnamed47() => [
  buildPrintServer(),
  buildPrintServer(),
];

void checkUnnamed47(core.List<api.PrintServer> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPrintServer(o[0]);
  checkPrintServer(o[1]);
}
...
void checkListPrintServersResponse(api.ListPrintServersResponse o) {
  ...
  if (buildCounterListPrintServersResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed47(o.printServers!);
  }
  buildCounterListPrintServersResponse--;
}

core.List<api.PrinterModel> buildUnnamed48() => [
  buildPrinterModel(),
  buildPrinterModel(),
];

void checkUnnamed48(core.List<api.PrinterModel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListPrinterModelsResponse buildListPrinterModelsResponse() {
  ...
  if (buildCounterListPrinterModelsResponse < 3) {
    o.nextPageToken = 'foo';
    o.printerModels = buildUnnamed48();
  }
  buildCounterListPrinterModelsResponse--;
  return o;
}
...
void checkListPrinterModelsResponse(api.ListPrinterModelsResponse o) {
  ...
  if (buildCounterListPrinterModelsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed48(o.printerModels!);
  }
  buildCounterListPrinterModelsResponse--;
}

core.List<api.Printer> buildUnnamed49() => [buildPrinter(), buildPrinter()];

void checkUnnamed49(core.List<api.Printer> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPrinter(o[0]);
  checkPrinter(o[1]);
}
...
core.List<api.Member> buildUnnamed50() => [buildMember(), buildMember()];

void checkUnnamed50(core.List<api.Member> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMember(o[0]);
  checkMember(o[1]);
}
...
core.List<api.MobileDeviceApplications> buildUnnamed52() => [
  buildMobileDeviceApplications(),
  buildMobileDeviceApplications(),
];

void checkUnnamed52(core.List<api.MobileDeviceApplications> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MobileDevice buildMobileDevice() {
  ...
  if (buildCounterMobileDevice < 3) {
    ...
    o.meid = 'foo';
    o.model = 'foo';
    o.name = buildUnnamed54();
    o.networkOperator = 'foo';
    o.os = 'foo';
    o.otherAccountsInfo = buildUnnamed55();
    o.privilege = 'foo';
...
core.List<api.MobileDevice> buildUnnamed56() => [
  buildMobileDevice(),
  buildMobileDevice(),
];

void checkUnnamed56(core.List<api.MobileDevice> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MobileDevices buildMobileDevices() {
  ...
  if (buildCounterMobileDevices < 3) {
    o.etag = 'foo';
    o.kind = 'foo';
    o.mobiledevices = buildUnnamed56();
    o.nextPageToken = 'foo';
  }
  buildCounterMobileDevices--;
  return o;
...
void checkMobileDevices(api.MobileDevices o) {
  ...
  if (buildCounterMobileDevices < 3) {
    unittest.expect(o.etag!, unittest.equals('foo'));
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed56(o.mobiledevices!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterMobileDevices--;
}
...
core.List<api.OrgUnit> buildUnnamed57() => [buildOrgUnit(), buildOrgUnit()];

void checkUnnamed57(core.List<api.OrgUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrgUnit(o[0]);
  checkOrgUnit(o[1]);
}
...
api.OrgUnits buildOrgUnits() {
  ...
  if (buildCounterOrgUnits < 3) {
    o.etag = 'foo';
    o.kind = 'foo';
    o.organizationUnits = buildUnnamed57();
  }
  buildCounterOrgUnits--;
  return o;
}
...
void checkOrgUnits(api.OrgUnits o) {
  ...
  if (buildCounterOrgUnits < 3) {
    unittest.expect(o.etag!, unittest.equals('foo'));
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed57(o.organizationUnits!);
  }
  buildCounterOrgUnits--;
}
...
core.List<api.AuxiliaryMessage> buildUnnamed58() => [
  buildAuxiliaryMessage(),
  buildAuxiliaryMessage(),
];

void checkUnnamed58(core.List<api.AuxiliaryMessage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Printer buildPrinter() {
  ...
  if (buildCounterPrinter < 3) {
    o.auxiliaryMessages = buildUnnamed58();
    o.createTime = 'foo';
    o.description = 'foo';
    o.displayName = 'foo';
    o.id = 'foo';
...
void checkPrinter(api.Printer o) {
  buildCounterPrinter++;
  if (buildCounterPrinter < 3) {
    checkUnnamed58(o.auxiliaryMessages!);
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.displayName!, unittest.equals('foo'));
    unittest.expect(o.id!, unittest.equals('foo'));
...
core.List<api.Privilege> buildUnnamed59() => [
  buildPrivilege(),
  buildPrivilege(),
];

void checkUnnamed59(core.List<api.Privilege> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPrivilege(o[0]);
  checkPrivilege(o[1]);
}
...
api.Privilege buildPrivilege() {
  ...
  if (buildCounterPrivilege < 3) {
    o.childPrivileges = buildUnnamed59();
    o.etag = 'foo';
    o.isOuScopable = true;
    o.kind = 'foo';
    o.privilegeName = 'foo';
...
void checkPrivilege(api.Privilege o) {
  buildCounterPrivilege++;
  if (buildCounterPrivilege < 3) {
    checkUnnamed59(o.childPrivileges!);
    unittest.expect(o.etag!, unittest.equals('foo'));
...
core.List<api.RoleRolePrivileges> buildUnnamed61() => [
  buildRoleRolePrivileges(),
  buildRoleRolePrivileges(),
];

void checkUnnamed61(core.List<api.RoleRolePrivileges> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Role buildRole() {
  ...
  if (buildCounterRole < 3) {
    ...
    o.roleId = 'foo';
    o.roleName = 'foo';
    o.rolePrivileges = buildUnnamed61();
  }
  buildCounterRole--;
  return o;
}
...
void checkRole(api.Role o) {
  ...
  if (buildCounterRole < 3) {
    ...
    checkUnnamed61(o.rolePrivileges!);
  }
  buildCounterRole--;
}
...
core.List<api.RoleAssignment> buildUnnamed62() => [
  buildRoleAssignment(),
  buildRoleAssignment(),
];

void checkUnnamed62(core.List<api.RoleAssignment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Role> buildUnnamed63() => [buildRole(), buildRole()];

void checkUnnamed63(core.List<api.Role> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRole(o[0]);
  checkRole(o[1]);
}
...
core.List<api.SchemaFieldSpec> buildUnnamed64() => [
  buildSchemaFieldSpec(),
  buildSchemaFieldSpec(),
];

void checkUnnamed64(core.List<api.SchemaFieldSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Schema> buildUnnamed65() => [buildSchema(), buildSchema()];

void checkUnnamed65(core.List<api.Schema> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSchema(o[0]);
  checkSchema(o[1]);
}
...
void checkToken(api.Token o) {
  ...
  if (buildCounterToken < 3) {
    ...
    checkUnnamed68(o.scopes!);
    unittest.expect(o.userKey!, unittest.equals('foo'));
  }
  buildCounterToken--;
}

core.List<api.Token> buildUnnamed69() => [buildToken(), buildToken()];

void checkUnnamed69(core.List<api.Token> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkToken(o[0]);
  checkToken(o[1]);
}
...
core.Map<core.String, api.UserCustomProperties> buildUnnamed71() => {
  'x': buildUserCustomProperties(),
  'y': buildUserCustomProperties(),
};

void checkUnnamed71(core.Map<core.String, api.UserCustomProperties> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.User buildUser() {
  ...
  if (buildCounterUser < 3) {
    ...
    o.nonEditableAliases = buildUnnamed72();
    o.notes = {
      'list': [1, 2, 3],
      'bool': true,
      'string': 'foo',
...
void checkUser(api.User o) {
  ...
  if (buildCounterUser < 3) {
    ...
    checkUnnamed71(o.customSchemas!);
    ...
    checkUnnamed72(o.nonEditableAliases!);
...
core.List<api.User> buildUnnamed73() => [buildUser(), buildUser()];

void checkUnnamed73(core.List<api.User> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUser(o[0]);
  checkUser(o[1]);
}
...
core.List<api.VerificationCode> buildUnnamed74() => [
  buildVerificationCode(),
  buildVerificationCode(),
];

void checkUnnamed74(core.List<api.VerificationCode> o) {
  unittest.expect(o, unittest.hasLength(2));
