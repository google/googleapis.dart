...
checkUnnamed3982(core.List<api.Activity> o) {
...
checkUnnamed3983(core.List<api.NestedParameter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3985(core.List<api.NestedParameter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNestedParameter(o[0]);
  checkNestedParameter(o[1]);
}
...
checkUnnamed3986(core.List<api.ActivityEventsParametersMultiMessageValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildActivityEventsParameters() {
  ...
  if (buildCounterActivityEventsParameters < 3) {
    ...
    o.multiIntValue = buildUnnamed3984();
    o.multiMessageValue = buildUnnamed3986();
    o.multiValue = buildUnnamed3987();
    o.name = "foo";
    o.value = "foo";
  }
  buildCounterActivityEventsParameters--;
...
checkActivityEventsParameters(api.ActivityEventsParameters o) {
  ...
  if (buildCounterActivityEventsParameters < 3) {
    ...
    checkUnnamed3984(o.multiIntValue);
    checkUnnamed3986(o.multiMessageValue);
    checkUnnamed3987(o.multiValue);
...
checkUnnamed3988(core.List<api.ActivityEventsParameters> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3989(core.List<api.ActivityEvents> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3990(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3991(core.List<core.bool> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildNestedParameter() {
  ...
  if (buildCounterNestedParameter < 3) {
    o.boolValue = true;
    o.intValue = "foo";
    o.multiBoolValue = buildUnnamed3991();
    o.multiIntValue = buildUnnamed3992();
    o.multiValue = buildUnnamed3993();
    o.name = "foo";
    o.value = "foo";
  }
  buildCounterNestedParameter--;
...
checkNestedParameter(api.NestedParameter o) {
  ...
  if (buildCounterNestedParameter < 3) {
    unittest.expect(o.boolValue, unittest.isTrue);
    unittest.expect(o.intValue, unittest.equals('foo'));
    checkUnnamed3991(o.multiBoolValue);
    checkUnnamed3992(o.multiIntValue);
    checkUnnamed3993(o.multiValue);
    unittest.expect(o.name, unittest.equals('foo'));
    unittest.expect(o.value, unittest.equals('foo'));
  }
  buildCounterNestedParameter--;
...
buildUnnamed3995() {
  ...
  o.add(buildUnnamed3994());
  o.add(buildUnnamed3994());
  return o;
}

checkUnnamed3995(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed3994(o[0]);
  checkUnnamed3994(o[1]);
}
...
checkUnnamed3996(core.List<api.UsageReportParameters> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3997(core.List<api.UsageReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3998(core.List<api.UsageReportsWarningsData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3999(core.List<api.UsageReportsWarnings> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUsageReports() {
  ...
  if (buildCounterUsageReports < 3) {
    ...
    o.kind = "foo";
    o.nextPageToken = "foo";
    o.usageReports = buildUnnamed3997();
    o.warnings = buildUnnamed3999();
  }
  buildCounterUsageReports--;
  return o;
}
...
checkUsageReports(api.UsageReports o) {
  ...
  if (buildCounterUsageReports < 3) {
    ...
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed3997(o.usageReports);
    checkUnnamed3999(o.warnings);
  }
  buildCounterUsageReports--;
}
