...
checkUnnamed3288(core.List<api.Activity> o) {
...
buildActivityEventsParameters() {
  ...
  if (buildCounterActivityEventsParameters < 3) {
    o.boolValue = true;
    o.intValue = "foo";
    o.multiIntValue = buildUnnamed3289();
    o.multiValue = buildUnnamed3290();
    o.name = "foo";
    o.value = "foo";
  }
  buildCounterActivityEventsParameters--;
...
checkActivityEventsParameters(api.ActivityEventsParameters o) {
  ...
  if (buildCounterActivityEventsParameters < 3) {
    ...
    checkUnnamed3289(o.multiIntValue);
    checkUnnamed3290(o.multiValue);
...
checkUnnamed3291(core.List<api.ActivityEventsParameters> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3292(core.List<api.ActivityEvents> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed3295() {
  ...
  o.add(buildUnnamed3294());
  o.add(buildUnnamed3294());
  return o;
}

checkUnnamed3295(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed3294(o[0]);
  checkUnnamed3294(o[1]);
}
...
checkUnnamed3296(core.List<api.UsageReportParameters> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3297(core.List<api.UsageReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3298(core.List<api.UsageReportsWarningsData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3299(core.List<api.UsageReportsWarnings> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUsageReports() {
  ...
  if (buildCounterUsageReports < 3) {
    ...
    o.kind = "foo";
    o.nextPageToken = "foo";
    o.usageReports = buildUnnamed3297();
    o.warnings = buildUnnamed3299();
  }
  buildCounterUsageReports--;
  return o;
}
...
checkUsageReports(api.UsageReports o) {
  ...
  if (buildCounterUsageReports < 3) {
    ...
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed3297(o.usageReports);
    checkUnnamed3299(o.warnings);
  }
  buildCounterUsageReports--;
}
