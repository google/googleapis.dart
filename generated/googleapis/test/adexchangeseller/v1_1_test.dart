...
checkUnnamed130(core.List<api.AdClient> o) {
...
checkUnnamed131(core.List<api.AdUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdUnit(o[0]);
  checkAdUnit(o[1]);
}
...
checkUnnamed132(core.List<api.Alert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAlert(o[0]);
  checkAlert(o[1]);
}
...
checkUnnamed133(core.List<api.CustomChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed134(core.List<api.ReportingMetadataEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed135(core.List<api.PreferredDeal> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed137(core.List<api.ReportHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed139() {
  ...
  o.add(buildUnnamed138());
  o.add(buildUnnamed138());
  return o;
}

checkUnnamed139(core.List<core.List<core.String>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed138(o[0]);
  checkUnnamed138(o[1]);
}
...
buildReport() {
  ...
  if (buildCounterReport < 3) {
    o.averages = buildUnnamed136();
    o.headers = buildUnnamed137();
    o.kind = "foo";
    o.rows = buildUnnamed139();
    o.totalMatchedRows = "foo";
    o.totals = buildUnnamed140();
    o.warnings = buildUnnamed141();
  }
  buildCounterReport--;
  return o;
}
...
checkReport(api.Report o) {
  buildCounterReport++;
  if (buildCounterReport < 3) {
    checkUnnamed136(o.averages);
    checkUnnamed137(o.headers);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed139(o.rows);
    unittest.expect(o.totalMatchedRows, unittest.equals('foo'));
    checkUnnamed140(o.totals);
    checkUnnamed141(o.warnings);
  }
  buildCounterReport--;
}
...
buildReportingMetadataEntry() {
  ...
  if (buildCounterReportingMetadataEntry < 3) {
    o.compatibleDimensions = buildUnnamed142();
    o.compatibleMetrics = buildUnnamed143();
    o.id = "foo";
    o.kind = "foo";
    o.requiredDimensions = buildUnnamed144();
    o.requiredMetrics = buildUnnamed145();
    o.supportedProducts = buildUnnamed146();
  }
  buildCounterReportingMetadataEntry--;
  return o;
}
...
checkReportingMetadataEntry(api.ReportingMetadataEntry o) {
  buildCounterReportingMetadataEntry++;
  if (buildCounterReportingMetadataEntry < 3) {
    checkUnnamed142(o.compatibleDimensions);
    checkUnnamed143(o.compatibleMetrics);
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed144(o.requiredDimensions);
    checkUnnamed145(o.requiredMetrics);
    checkUnnamed146(o.supportedProducts);
  }
  buildCounterReportingMetadataEntry--;
}
...
checkUnnamed147(core.List<api.SavedReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed148(core.List<api.UrlChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUrlChannel(o[0]);
  checkUrlChannel(o[1]);
}
...
main() {
  ...
  unittest.group("resource-ReportsResourceApi", () {
    unittest.test("method--generate", () {
      ...
      var arg_endDate = "foo";
      var arg_dimension = buildUnnamed149();
      var arg_filter = buildUnnamed150();
      var arg_locale = "foo";
      var arg_maxResults = 42;
      var arg_metric = buildUnnamed151();
      var arg_sort = buildUnnamed152();
