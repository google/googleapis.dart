...
checkUnnamed242(core.List<api.AdClient> o) {
...
checkUnnamed243(core.List<api.AdUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdUnit(o[0]);
  checkAdUnit(o[1]);
}
...
checkUnnamed247(core.List<api.PreferredDeal> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed249(core.List<api.ReportHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildReportingMetadataEntry() {
  ...
  if (buildCounterReportingMetadataEntry < 3) {
    o.compatibleDimensions = buildUnnamed254();
    o.compatibleMetrics = buildUnnamed255();
    o.id = "foo";
    o.kind = "foo";
    o.requiredDimensions = buildUnnamed256();
    o.requiredMetrics = buildUnnamed257();
    o.supportedProducts = buildUnnamed258();
  }
  buildCounterReportingMetadataEntry--;
  return o;
}
...
checkReportingMetadataEntry(api.ReportingMetadataEntry o) {
  buildCounterReportingMetadataEntry++;
  if (buildCounterReportingMetadataEntry < 3) {
    checkUnnamed254(o.compatibleDimensions);
    checkUnnamed255(o.compatibleMetrics);
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed256(o.requiredDimensions);
    checkUnnamed257(o.requiredMetrics);
    checkUnnamed258(o.supportedProducts);
  }
  buildCounterReportingMetadataEntry--;
}
...
checkUnnamed259(core.List<api.SavedReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed260(core.List<api.UrlChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUrlChannel(o[0]);
  checkUrlChannel(o[1]);
}
