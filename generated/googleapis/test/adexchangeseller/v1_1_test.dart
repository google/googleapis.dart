...
checkUnnamed140(core.List<api.AdClient> o) {
...
checkUnnamed141(core.List<api.AdUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdUnit(o[0]);
  checkAdUnit(o[1]);
}
...
checkUnnamed142(core.List<api.Alert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAlert(o[0]);
  checkAlert(o[1]);
}
...
checkUnnamed143(core.List<api.CustomChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed144(core.List<api.ReportingMetadataEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed145(core.List<api.PreferredDeal> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed147(core.List<api.ReportHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed149(core.List<core.List<core.String>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed148(o[0]);
  checkUnnamed148(o[1]);
}
...
buildReport() {
  ...
  if (buildCounterReport < 3) {
    o.averages = buildUnnamed146();
    o.headers = buildUnnamed147();
    o.kind = "foo";
    o.rows = buildUnnamed149();
    o.totalMatchedRows = "foo";
    o.totals = buildUnnamed150();
    o.warnings = buildUnnamed151();
  }
  buildCounterReport--;
  return o;
}
...
checkReport(api.Report o) {
  buildCounterReport++;
  if (buildCounterReport < 3) {
    checkUnnamed146(o.averages);
    checkUnnamed147(o.headers);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed149(o.rows);
    unittest.expect(o.totalMatchedRows, unittest.equals('foo'));
    checkUnnamed150(o.totals);
    checkUnnamed151(o.warnings);
  }
  buildCounterReport--;
}
...
buildReportingMetadataEntry() {
  ...
  if (buildCounterReportingMetadataEntry < 3) {
    o.compatibleDimensions = buildUnnamed152();
    o.compatibleMetrics = buildUnnamed153();
    o.id = "foo";
    o.kind = "foo";
    o.requiredDimensions = buildUnnamed154();
    o.requiredMetrics = buildUnnamed155();
    o.supportedProducts = buildUnnamed156();
  }
  buildCounterReportingMetadataEntry--;
  return o;
}
...
checkReportingMetadataEntry(api.ReportingMetadataEntry o) {
  buildCounterReportingMetadataEntry++;
  if (buildCounterReportingMetadataEntry < 3) {
    checkUnnamed152(o.compatibleDimensions);
    checkUnnamed153(o.compatibleMetrics);
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed154(o.requiredDimensions);
    checkUnnamed155(o.requiredMetrics);
    checkUnnamed156(o.supportedProducts);
  }
  buildCounterReportingMetadataEntry--;
}
...
checkUnnamed157(core.List<api.SavedReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed158(core.List<api.UrlChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUrlChannel(o[0]);
  checkUrlChannel(o[1]);
}
...
main() {
  ...
  unittest.group("resource-ReportsResourceApi", () {
    unittest.test("method--generate", () {
      ...
      var arg_endDate = "foo";
      var arg_dimension = buildUnnamed159();
      var arg_filter = buildUnnamed160();
      var arg_locale = "foo";
      var arg_maxResults = 42;
      var arg_metric = buildUnnamed161();
      var arg_sort = buildUnnamed162();
