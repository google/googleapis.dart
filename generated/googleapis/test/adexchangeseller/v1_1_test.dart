...
checkUnnamed594(core.List<api.AdClient> o) {
...
checkUnnamed595(core.List<api.AdUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdUnit(o[0]);
  checkAdUnit(o[1]);
}
...
checkUnnamed596(core.List<api.Alert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAlert(o[0]);
  checkAlert(o[1]);
}
...
checkUnnamed597(core.List<api.CustomChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed598(core.List<api.ReportingMetadataEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed599(core.List<api.PreferredDeal> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed601(core.List<api.ReportHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed603(core.List<core.List<core.String>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed602(o[0]);
  checkUnnamed602(o[1]);
}
...
buildReport() {
  ...
  if (buildCounterReport < 3) {
    o.averages = buildUnnamed600();
    o.headers = buildUnnamed601();
    o.kind = "foo";
    o.rows = buildUnnamed603();
    o.totalMatchedRows = "foo";
    o.totals = buildUnnamed604();
    o.warnings = buildUnnamed605();
  }
  buildCounterReport--;
  return o;
}
...
checkReport(api.Report o) {
  buildCounterReport++;
  if (buildCounterReport < 3) {
    checkUnnamed600(o.averages);
    checkUnnamed601(o.headers);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed603(o.rows);
    unittest.expect(o.totalMatchedRows, unittest.equals('foo'));
    checkUnnamed604(o.totals);
    checkUnnamed605(o.warnings);
  }
  buildCounterReport--;
}
...
buildReportingMetadataEntry() {
  ...
  if (buildCounterReportingMetadataEntry < 3) {
    o.compatibleDimensions = buildUnnamed606();
    o.compatibleMetrics = buildUnnamed607();
    o.id = "foo";
    o.kind = "foo";
    o.requiredDimensions = buildUnnamed608();
    o.requiredMetrics = buildUnnamed609();
    o.supportedProducts = buildUnnamed610();
  }
  buildCounterReportingMetadataEntry--;
  return o;
}
...
checkReportingMetadataEntry(api.ReportingMetadataEntry o) {
  buildCounterReportingMetadataEntry++;
  if (buildCounterReportingMetadataEntry < 3) {
    checkUnnamed606(o.compatibleDimensions);
    checkUnnamed607(o.compatibleMetrics);
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed608(o.requiredDimensions);
    checkUnnamed609(o.requiredMetrics);
    checkUnnamed610(o.supportedProducts);
  }
  buildCounterReportingMetadataEntry--;
}
...
checkUnnamed611(core.List<api.SavedReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed612(core.List<api.UrlChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUrlChannel(o[0]);
  checkUrlChannel(o[1]);
}
...
main() {
  ...
  unittest.group("resource-ReportsResourceApi", () {
    unittest.test("method--generate", () {
      ...
      var arg_endDate = "foo";
      var arg_dimension = buildUnnamed613();
      var arg_filter = buildUnnamed614();
      var arg_locale = "foo";
      var arg_maxResults = 42;
      var arg_metric = buildUnnamed615();
      var arg_sort = buildUnnamed616();
