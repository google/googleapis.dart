...
checkUnnamed346(core.List<api.AdClient> o) {
...
checkUnnamed347(core.List<api.AdUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdUnit(o[0]);
  checkAdUnit(o[1]);
}
...
checkUnnamed348(core.List<api.Alert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAlert(o[0]);
  checkAlert(o[1]);
}
...
checkUnnamed349(core.List<api.CustomChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed350(core.List<api.ReportingMetadataEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed351(core.List<api.PreferredDeal> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed353(core.List<api.ReportHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed355() {
  ...
  o.add(buildUnnamed354());
  o.add(buildUnnamed354());
  return o;
}

checkUnnamed355(core.List<core.List<core.String>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed354(o[0]);
  checkUnnamed354(o[1]);
}
...
buildReport() {
  ...
  if (buildCounterReport < 3) {
    o.averages = buildUnnamed352();
    o.headers = buildUnnamed353();
    o.kind = "foo";
    o.rows = buildUnnamed355();
    o.totalMatchedRows = "foo";
    o.totals = buildUnnamed356();
    o.warnings = buildUnnamed357();
  }
  buildCounterReport--;
  return o;
}
...
checkReport(api.Report o) {
  buildCounterReport++;
  if (buildCounterReport < 3) {
    checkUnnamed352(o.averages);
    checkUnnamed353(o.headers);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed355(o.rows);
    unittest.expect(o.totalMatchedRows, unittest.equals('foo'));
    checkUnnamed356(o.totals);
    checkUnnamed357(o.warnings);
  }
  buildCounterReport--;
}
...
buildReportingMetadataEntry() {
  ...
  if (buildCounterReportingMetadataEntry < 3) {
    o.compatibleDimensions = buildUnnamed358();
    o.compatibleMetrics = buildUnnamed359();
    o.id = "foo";
    o.kind = "foo";
    o.requiredDimensions = buildUnnamed360();
    o.requiredMetrics = buildUnnamed361();
    o.supportedProducts = buildUnnamed362();
  }
  buildCounterReportingMetadataEntry--;
  return o;
}
...
checkReportingMetadataEntry(api.ReportingMetadataEntry o) {
  buildCounterReportingMetadataEntry++;
  if (buildCounterReportingMetadataEntry < 3) {
    checkUnnamed358(o.compatibleDimensions);
    checkUnnamed359(o.compatibleMetrics);
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed360(o.requiredDimensions);
    checkUnnamed361(o.requiredMetrics);
    checkUnnamed362(o.supportedProducts);
  }
  buildCounterReportingMetadataEntry--;
}
...
checkUnnamed363(core.List<api.SavedReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed364(core.List<api.UrlChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUrlChannel(o[0]);
  checkUrlChannel(o[1]);
}
...
main() {
  ...
  unittest.group("resource-ReportsResourceApi", () {
    unittest.test("method--generate", () {
      ...
      var arg_endDate = "foo";
      var arg_dimension = buildUnnamed365();
      var arg_filter = buildUnnamed366();
      var arg_locale = "foo";
      var arg_maxResults = 42;
      var arg_metric = buildUnnamed367();
      var arg_sort = buildUnnamed368();
