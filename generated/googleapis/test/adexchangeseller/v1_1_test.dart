...
checkUnnamed141(core.List<api.AdClient> o) {
...
checkUnnamed142(core.List<api.AdUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdUnit(o[0]);
  checkAdUnit(o[1]);
}
...
checkUnnamed146(core.List<api.PreferredDeal> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed148(core.List<api.ReportHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed150(core.List<core.List<core.String>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed149(o[0]);
  checkUnnamed149(o[1]);
}
...
buildReport() {
  ...
  if (buildCounterReport < 3) {
    o.averages = buildUnnamed147();
    o.headers = buildUnnamed148();
    o.kind = "foo";
    o.rows = buildUnnamed150();
    o.totalMatchedRows = "foo";
    o.totals = buildUnnamed151();
    o.warnings = buildUnnamed152();
  }
  buildCounterReport--;
  return o;
}
...
checkReport(api.Report o) {
  buildCounterReport++;
  if (buildCounterReport < 3) {
    checkUnnamed147(o.averages);
    checkUnnamed148(o.headers);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed150(o.rows);
    unittest.expect(o.totalMatchedRows, unittest.equals('foo'));
    checkUnnamed151(o.totals);
    checkUnnamed152(o.warnings);
  }
  buildCounterReport--;
}
...
buildReportingMetadataEntry() {
  ...
  if (buildCounterReportingMetadataEntry < 3) {
    o.compatibleDimensions = buildUnnamed153();
    o.compatibleMetrics = buildUnnamed154();
    o.id = "foo";
    o.kind = "foo";
    o.requiredDimensions = buildUnnamed155();
    o.requiredMetrics = buildUnnamed156();
    o.supportedProducts = buildUnnamed157();
  }
  buildCounterReportingMetadataEntry--;
  return o;
}
...
checkReportingMetadataEntry(api.ReportingMetadataEntry o) {
  buildCounterReportingMetadataEntry++;
  if (buildCounterReportingMetadataEntry < 3) {
    checkUnnamed153(o.compatibleDimensions);
    checkUnnamed154(o.compatibleMetrics);
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed155(o.requiredDimensions);
    checkUnnamed156(o.requiredMetrics);
    checkUnnamed157(o.supportedProducts);
  }
  buildCounterReportingMetadataEntry--;
}
...
checkUnnamed158(core.List<api.SavedReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed159(core.List<api.UrlChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUrlChannel(o[0]);
  checkUrlChannel(o[1]);
}
