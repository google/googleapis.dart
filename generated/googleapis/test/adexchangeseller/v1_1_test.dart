...
checkUnnamed340(core.List<api.AdClient> o) {
...
checkUnnamed341(core.List<api.AdUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdUnit(o[0]);
  checkAdUnit(o[1]);
}
...
checkUnnamed342(core.List<api.Alert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAlert(o[0]);
  checkAlert(o[1]);
}
...
checkUnnamed343(core.List<api.CustomChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed344(core.List<api.ReportingMetadataEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed345(core.List<api.PreferredDeal> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed347(core.List<api.ReportHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed349(core.List<core.List<core.String>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed348(o[0]);
  checkUnnamed348(o[1]);
}
...
buildReport() {
  ...
  if (buildCounterReport < 3) {
    o.averages = buildUnnamed346();
    o.headers = buildUnnamed347();
    o.kind = "foo";
    o.rows = buildUnnamed349();
    o.totalMatchedRows = "foo";
    o.totals = buildUnnamed350();
    o.warnings = buildUnnamed351();
  }
  buildCounterReport--;
  return o;
}
...
checkReport(api.Report o) {
  buildCounterReport++;
  if (buildCounterReport < 3) {
    checkUnnamed346(o.averages);
    checkUnnamed347(o.headers);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed349(o.rows);
    unittest.expect(o.totalMatchedRows, unittest.equals('foo'));
    checkUnnamed350(o.totals);
    checkUnnamed351(o.warnings);
  }
  buildCounterReport--;
}
...
buildReportingMetadataEntry() {
  ...
  if (buildCounterReportingMetadataEntry < 3) {
    o.compatibleDimensions = buildUnnamed352();
    o.compatibleMetrics = buildUnnamed353();
    o.id = "foo";
    o.kind = "foo";
    o.requiredDimensions = buildUnnamed354();
    o.requiredMetrics = buildUnnamed355();
    o.supportedProducts = buildUnnamed356();
  }
  buildCounterReportingMetadataEntry--;
  return o;
}
...
checkReportingMetadataEntry(api.ReportingMetadataEntry o) {
  buildCounterReportingMetadataEntry++;
  if (buildCounterReportingMetadataEntry < 3) {
    checkUnnamed352(o.compatibleDimensions);
    checkUnnamed353(o.compatibleMetrics);
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed354(o.requiredDimensions);
    checkUnnamed355(o.requiredMetrics);
    checkUnnamed356(o.supportedProducts);
  }
  buildCounterReportingMetadataEntry--;
}
...
checkUnnamed357(core.List<api.SavedReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed358(core.List<api.UrlChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUrlChannel(o[0]);
  checkUrlChannel(o[1]);
}
...
main() {
  ...
  unittest.group("resource-ReportsResourceApi", () {
    unittest.test("method--generate", () {
      ...
      var arg_endDate = "foo";
      var arg_dimension = buildUnnamed359();
      var arg_filter = buildUnnamed360();
      var arg_locale = "foo";
      var arg_maxResults = 42;
      var arg_metric = buildUnnamed361();
      var arg_sort = buildUnnamed362();
