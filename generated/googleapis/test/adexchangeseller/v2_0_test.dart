...
checkUnnamed150(core.List<api.Account> o) {
...
checkUnnamed151(core.List<api.AdClient> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdClient(o[0]);
  checkAdClient(o[1]);
}
...
checkUnnamed152(core.List<api.Alert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAlert(o[0]);
  checkAlert(o[1]);
}
...
checkUnnamed153(core.List<api.CustomChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed154(core.List<api.ReportingMetadataEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed155(core.List<api.PreferredDeal> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed157(core.List<api.ReportHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed159() {
  ...
  o.add(buildUnnamed158());
  o.add(buildUnnamed158());
  return o;
}

checkUnnamed159(core.List<core.List<core.String>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed158(o[0]);
  checkUnnamed158(o[1]);
}
...
buildReport() {
  ...
  if (buildCounterReport < 3) {
    o.averages = buildUnnamed156();
    o.headers = buildUnnamed157();
    o.kind = "foo";
    o.rows = buildUnnamed159();
    o.totalMatchedRows = "foo";
    o.totals = buildUnnamed160();
    o.warnings = buildUnnamed161();
  }
  buildCounterReport--;
  return o;
}
...
checkReport(api.Report o) {
  buildCounterReport++;
  if (buildCounterReport < 3) {
    checkUnnamed156(o.averages);
    checkUnnamed157(o.headers);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed159(o.rows);
    unittest.expect(o.totalMatchedRows, unittest.equals('foo'));
    checkUnnamed160(o.totals);
    checkUnnamed161(o.warnings);
  }
  buildCounterReport--;
}
...
buildReportingMetadataEntry() {
  ...
  if (buildCounterReportingMetadataEntry < 3) {
    o.compatibleDimensions = buildUnnamed162();
    o.compatibleMetrics = buildUnnamed163();
    o.id = "foo";
    o.kind = "foo";
    o.requiredDimensions = buildUnnamed164();
    o.requiredMetrics = buildUnnamed165();
    o.supportedProducts = buildUnnamed166();
  }
  buildCounterReportingMetadataEntry--;
  return o;
}
...
checkReportingMetadataEntry(api.ReportingMetadataEntry o) {
  buildCounterReportingMetadataEntry++;
  if (buildCounterReportingMetadataEntry < 3) {
    checkUnnamed162(o.compatibleDimensions);
    checkUnnamed163(o.compatibleMetrics);
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed164(o.requiredDimensions);
    checkUnnamed165(o.requiredMetrics);
    checkUnnamed166(o.supportedProducts);
  }
  buildCounterReportingMetadataEntry--;
}
...
checkUnnamed167(core.List<api.SavedReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed168(core.List<api.UrlChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUrlChannel(o[0]);
  checkUrlChannel(o[1]);
}
...
main() {
  ...
  unittest.group("resource-AccountsReportsResourceApi", () {
    unittest.test("method--generate", () {
      ...
      var arg_endDate = "foo";
      var arg_dimension = buildUnnamed169();
      var arg_filter = buildUnnamed170();
      var arg_locale = "foo";
      var arg_maxResults = 42;
      var arg_metric = buildUnnamed171();
      var arg_sort = buildUnnamed172();
