...
import 'package:googleapis/dfareporting/v5.dart' as api;
...
core.List<api.Account> buildUnnamed6() => [buildAccount(), buildAccount()];
...
core.List<api.Ad> buildUnnamed12() => [buildAd(), buildAd()];
...
api.Advertiser buildAdvertiser() {
  ...
  if (buildCounterAdvertiser < 3) {
    ...
    o.defaultEmail = 'foo';
    o.euPoliticalAdsDeclaration = 'foo';
...
void checkAdvertiser(api.Advertiser o) {
  ...
  if (buildCounterAdvertiser < 3) {
    ...
    unittest.expect(o.euPoliticalAdsDeclaration!, unittest.equals('foo'));
...
core.List<api.Invoice> buildUnnamed14() => [buildInvoice(), buildInvoice()];
...
void checkBillingProfile(api.BillingProfile o) {
  ...
  if (buildCounterBillingProfile < 3) {
    ...
    unittest.expect(o.id!, unittest.equals('foo'));
    unittest.expect(o.invoiceLevel!, unittest.equals('foo'));
    unittest.expect(o.isDefault!, unittest.isTrue);
    unittest.expect(o.kind!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.paymentsAccountId!, unittest.equals('foo'));
    unittest.expect(o.paymentsCustomerId!, unittest.equals('foo'));
    unittest.expect(o.purchaseOrder!, unittest.equals('foo'));
    unittest.expect(o.secondaryPaymentsCustomerId!, unittest.equals('foo'));
    unittest.expect(o.status!, unittest.equals('foo'));
  }
  buildCounterBillingProfile--;
}
...
void checkBillingRate(api.BillingRate o) {
  ...
  if (buildCounterBillingRate < 3) {
    ...
    unittest.expect(o.id!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.rateInMicros!, unittest.equals('foo'));
    unittest.expect(o.startDate!, unittest.equals('foo'));
    checkUnnamed20(o.tieredRates!);
    unittest.expect(o.type!, unittest.equals('foo'));
    unittest.expect(o.unitOfMeasure!, unittest.equals('foo'));
  }
  buildCounterBillingRate--;
}
...
void checkBillingRateTieredRate(api.BillingRateTieredRate o) {
  buildCounterBillingRateTieredRate++;
  if (buildCounterBillingRateTieredRate < 3) {
    unittest.expect(o.highValue!, unittest.equals('foo'));
    unittest.expect(o.lowValue!, unittest.equals('foo'));
    unittest.expect(o.rateInMicros!, unittest.equals('foo'));
  }
  buildCounterBillingRateTieredRate--;
}
...
core.List<api.Browser> buildUnnamed22() => [buildBrowser(), buildBrowser()];
...
core.List<api.Campaign> buildUnnamed28() => [buildCampaign(), buildCampaign()];
...
void checkCartData(api.CartData o) {
  ...
  if (buildCounterCartData < 3) {
    ...
    unittest.expect(o.merchantFeedLanguage!, unittest.equals('foo'));
...
core.List<api.City> buildUnnamed31() => [buildCity(), buildCity()];
...
core.List<api.Size> buildUnnamed32() => [buildSize(), buildSize()];
...
core.int buildCounterContentSource = 0;
api.ContentSource buildContentSource() {
  final o = api.ContentSource();
  buildCounterContentSource++;
  if (buildCounterContentSource < 3) {
    o.contentSourceName = 'foo';
    o.createInfo = buildLastModifiedInfo();
    o.lastModifiedInfo = buildLastModifiedInfo();
    o.metaData = buildContentSourceMetaData();
    o.resourceLink = 'foo';
    o.resourceType = 'foo';
  }
  buildCounterContentSource--;
...
void checkContentSource(api.ContentSource o) {
  buildCounterContentSource++;
  if (buildCounterContentSource < 3) {
    unittest.expect(o.contentSourceName!, unittest.equals('foo'));
    checkLastModifiedInfo(o.createInfo!);
    checkLastModifiedInfo(o.lastModifiedInfo!);
    checkContentSourceMetaData(o.metaData!);
...
core.int buildCounterContentSourceMetaData = 0;
api.ContentSourceMetaData buildContentSourceMetaData() {
  final o = api.ContentSourceMetaData();
  buildCounterContentSourceMetaData++;
  if (buildCounterContentSourceMetaData < 3) {
    o.charset = 'foo';
    o.fieldNames = buildUnnamed35();
    o.rowNumber = 42;
    o.separator = 'foo';
  }
  buildCounterContentSourceMetaData--;
...
void checkContentSourceMetaData(api.ContentSourceMetaData o) {
  buildCounterContentSourceMetaData++;
  if (buildCounterContentSourceMetaData < 3) {
    unittest.expect(o.charset!, unittest.equals('foo'));
    checkUnnamed35(o.fieldNames!);
    unittest.expect(o.rowNumber!, unittest.equals(42));
    unittest.expect(o.separator!, unittest.equals('foo'));
  }
  buildCounterContentSourceMetaData--;
}
...
api.Conversion buildConversion() {
  ...
  if (buildCounterConversion < 3) {
    ...
    o.ordinal = 'foo';
    o.quantity = 'foo';
    o.sessionAttributesEncoded = 'foo';
...
void checkConversion(api.Conversion o) {
  buildCounterConversion++;
  if (buildCounterConversion < 3) {
    unittest.expect(o.adUserDataConsent!, unittest.equals('foo'));
    ...
    unittest.expect(o.sessionAttributesEncoded!, unittest.equals('foo'));
...
core.List<api.Country> buildUnnamed44() => [buildCountry(), buildCountry()];
...
core.List<api.Size> buildUnnamed46() => [buildSize(), buildSize()];
...
core.List<api.ClickTag> buildUnnamed48() => [buildClickTag(), buildClickTag()];
...
core.List<api.Size> buildUnnamed58() => [buildSize(), buildSize()];
...
core.List<api.ClickTag> buildUnnamed61() => [buildClickTag(), buildClickTag()];
...
core.List<api.Creative> buildUnnamed75() => [buildCreative(), buildCreative()];
...
core.List<api.Metric> buildUnnamed78() => [buildMetric(), buildMetric()];
...
core.List<api.Metric> buildUnnamed79() => [buildMetric(), buildMetric()];
...
core.List<api.Metric> buildUnnamed82() => [buildMetric(), buildMetric()];
...
core.List<api.RuleBlock> buildUnnamed84() => [
  buildRuleBlock(),
  buildRuleBlock(),
];

void checkUnnamed84(core.List<api.RuleBlock> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRuleBlock(o[0]);
  checkRuleBlock(o[1]);
}

core.int buildCounterCustomRule = 0;
api.CustomRule buildCustomRule() {
  final o = api.CustomRule();
  buildCounterCustomRule++;
  if (buildCounterCustomRule < 3) {
    o.name = 'foo';
    o.priority = 42;
    o.ruleBlocks = buildUnnamed84();
  }
  buildCounterCustomRule--;
  return o;
}

void checkCustomRule(api.CustomRule o) {
  buildCounterCustomRule++;
  if (buildCounterCustomRule < 3) {
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.priority!, unittest.equals(42));
    checkUnnamed84(o.ruleBlocks!);
  }
  buildCounterCustomRule--;
}

core.int buildCounterCustomValueField = 0;
api.CustomValueField buildCustomValueField() {
  final o = api.CustomValueField();
  buildCounterCustomValueField++;
  if (buildCounterCustomValueField < 3) {
    o.fieldId = 42;
    o.requestKey = 'foo';
  }
  buildCounterCustomValueField--;
...
void checkCustomValueField(api.CustomValueField o) {
  buildCounterCustomValueField++;
  if (buildCounterCustomValueField < 3) {
    unittest.expect(o.fieldId!, unittest.equals(42));
    unittest.expect(o.requestKey!, unittest.equals('foo'));
  }
  buildCounterCustomValueField--;
}
...
core.List<core.int> buildUnnamed86() => [42, 42];

void checkUnnamed86(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DayPartTargeting buildDayPartTargeting() {
  ...
  if (buildCounterDayPartTargeting < 3) {
    o.daysOfWeek = buildUnnamed85();
    o.hoursOfDay = buildUnnamed86();
...
void checkDayPartTargeting(api.DayPartTargeting o) {
  buildCounterDayPartTargeting++;
  if (buildCounterDayPartTargeting < 3) {
    checkUnnamed85(o.daysOfWeek!);
    checkUnnamed86(o.hoursOfDay!);
...
api.DeepLink buildDeepLink() {
  ...
  if (buildCounterDeepLink < 3) {
    ...
    o.remarketingListIds = buildUnnamed87();
  }
  buildCounterDeepLink--;
  return o;
}
...
void checkDeepLink(api.DeepLink o) {
  ...
  if (buildCounterDeepLink < 3) {
    ...
    checkUnnamed87(o.remarketingListIds!);
  }
  buildCounterDeepLink--;
}
...
core.int buildCounterDependentFieldValue = 0;
api.DependentFieldValue buildDependentFieldValue() {
...
core.List<api.DimensionValue> buildUnnamed88() => [
  buildDimensionValue(),
  buildDimensionValue(),
];

void checkUnnamed88(core.List<api.DimensionValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimensionValue(o[0]);
  checkDimensionValue(o[1]);
}
...
core.List<api.DimensionFilter> buildUnnamed89() => [
  buildDimensionFilter(),
  buildDimensionFilter(),
];

void checkUnnamed89(core.List<api.DimensionFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DirectorySite buildDirectorySite() {
  ...
  if (buildCounterDirectorySite < 3) {
    o.id = 'foo';
    o.idDimensionValue = buildDimensionValue();
    o.inpageTagFormats = buildUnnamed90();
    o.interstitialTagFormats = buildUnnamed91();
    o.kind = 'foo';
    o.name = 'foo';
...
void checkDirectorySite(api.DirectorySite o) {
  ...
  if (buildCounterDirectorySite < 3) {
    unittest.expect(o.id!, unittest.equals('foo'));
    checkDimensionValue(o.idDimensionValue!);
    checkUnnamed90(o.inpageTagFormats!);
    checkUnnamed91(o.interstitialTagFormats!);
    unittest.expect(o.kind!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.publisherSpecificationId!, unittest.equals('foo'));
...
core.List<api.DirectorySite> buildUnnamed92() => [
  buildDirectorySite(),
  buildDirectorySite(),
];

void checkUnnamed92(core.List<api.DirectorySite> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DirectorySitesListResponse buildDirectorySitesListResponse() {
  ...
  if (buildCounterDirectorySitesListResponse < 3) {
    o.directorySites = buildUnnamed92();
    o.kind = 'foo';
    o.nextPageToken = 'foo';
  }
  buildCounterDirectorySitesListResponse--;
...
void checkDirectorySitesListResponse(api.DirectorySitesListResponse o) {
  buildCounterDirectorySitesListResponse++;
  if (buildCounterDirectorySitesListResponse < 3) {
    checkUnnamed92(o.directorySites!);
    unittest.expect(o.kind!, unittest.equals('foo'));
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterDirectorySitesListResponse--;
...
core.int buildCounterDynamicFeed = 0;
api.DynamicFeed buildDynamicFeed() {
  final o = api.DynamicFeed();
  buildCounterDynamicFeed++;
  if (buildCounterDynamicFeed < 3) {
    o.contentSource = buildContentSource();
    o.createInfo = buildLastModifiedInfo();
    o.dynamicFeedId = 'foo';
    o.dynamicFeedName = 'foo';
    o.element = buildElement();
    o.feedIngestionStatus = buildFeedIngestionStatus();
    o.feedSchedule = buildFeedSchedule();
    o.hasPublished = true;
    o.lastModifiedInfo = buildLastModifiedInfo();
    o.status = 'foo';
    o.studioAdvertiserId = 'foo';
...
void checkDynamicFeed(api.DynamicFeed o) {
  buildCounterDynamicFeed++;
  if (buildCounterDynamicFeed < 3) {
    checkContentSource(o.contentSource!);
    checkLastModifiedInfo(o.createInfo!);
    unittest.expect(o.dynamicFeedId!, unittest.equals('foo'));
    unittest.expect(o.dynamicFeedName!, unittest.equals('foo'));
    checkElement(o.element!);
    checkFeedIngestionStatus(o.feedIngestionStatus!);
    checkFeedSchedule(o.feedSchedule!);
    unittest.expect(o.hasPublished!, unittest.isTrue);
    checkLastModifiedInfo(o.lastModifiedInfo!);
    unittest.expect(o.status!, unittest.equals('foo'));
    unittest.expect(o.studioAdvertiserId!, unittest.equals('foo'));
  }
...
core.int buildCounterDynamicFeedsInsertRequest = 0;
api.DynamicFeedsInsertRequest buildDynamicFeedsInsertRequest() {
  final o = api.DynamicFeedsInsertRequest();
  buildCounterDynamicFeedsInsertRequest++;
  if (buildCounterDynamicFeedsInsertRequest < 3) {
    o.dynamicFeed = buildDynamicFeed();
    o.dynamicProfileId = 'foo';
  }
  buildCounterDynamicFeedsInsertRequest--;
  return o;
}

void checkDynamicFeedsInsertRequest(api.DynamicFeedsInsertRequest o) {
  buildCounterDynamicFeedsInsertRequest++;
  if (buildCounterDynamicFeedsInsertRequest < 3) {
    checkDynamicFeed(o.dynamicFeed!);
    unittest.expect(o.dynamicProfileId!, unittest.equals('foo'));
  }
  buildCounterDynamicFeedsInsertRequest--;
}

core.int buildCounterDynamicProfile = 0;
api.DynamicProfile buildDynamicProfile() {
  final o = api.DynamicProfile();
  buildCounterDynamicProfile++;
  if (buildCounterDynamicProfile < 3) {
    o.active = buildDynamicProfileVersion();
    o.archiveStatus = 'foo';
    o.createInfo = buildLastModifiedInfo();
    o.description = 'foo';
    o.draft = buildDynamicProfileVersion();
    o.dynamicProfileId = 'foo';
    o.kind = 'foo';
    o.lastModifiedInfo = buildLastModifiedInfo();
    o.name = 'foo';
...
void checkDynamicProfile(api.DynamicProfile o) {
  buildCounterDynamicProfile++;
  if (buildCounterDynamicProfile < 3) {
    checkDynamicProfileVersion(o.active!);
    unittest.expect(o.archiveStatus!, unittest.equals('foo'));
    checkLastModifiedInfo(o.createInfo!);
    unittest.expect(o.description!, unittest.equals('foo'));
    checkDynamicProfileVersion(o.draft!);
    unittest.expect(o.dynamicProfileId!, unittest.equals('foo'));
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkLastModifiedInfo(o.lastModifiedInfo!);
    unittest.expect(o.name!, unittest.equals('foo'));
...
core.int buildCounterDynamicProfileFeedSettings = 0;
api.DynamicProfileFeedSettings buildDynamicProfileFeedSettings() {
  final o = api.DynamicProfileFeedSettings();
  buildCounterDynamicProfileFeedSettings++;
  if (buildCounterDynamicProfileFeedSettings < 3) {
    o.dynamicFeedId = 'foo';
    o.dynamicRules = buildDynamicRules();
    o.quantity = 42;
  }
  buildCounterDynamicProfileFeedSettings--;
  return o;
...
void checkDynamicProfileFeedSettings(api.DynamicProfileFeedSettings o) {
  buildCounterDynamicProfileFeedSettings++;
  if (buildCounterDynamicProfileFeedSettings < 3) {
    unittest.expect(o.dynamicFeedId!, unittest.equals('foo'));
    checkDynamicRules(o.dynamicRules!);
    unittest.expect(o.quantity!, unittest.equals(42));
  }
  buildCounterDynamicProfileFeedSettings--;
}

core.List<api.DynamicProfileFeedSettings> buildUnnamed93() => [
  buildDynamicProfileFeedSettings(),
  buildDynamicProfileFeedSettings(),
];

void checkUnnamed93(core.List<api.DynamicProfileFeedSettings> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDynamicProfileFeedSettings(o[0]);
  checkDynamicProfileFeedSettings(o[1]);
}

core.int buildCounterDynamicProfileVersion = 0;
api.DynamicProfileVersion buildDynamicProfileVersion() {
  final o = api.DynamicProfileVersion();
  buildCounterDynamicProfileVersion++;
  if (buildCounterDynamicProfileVersion < 3) {
    o.dynamicProfileFeedSettings = buildUnnamed93();
    o.versionId = 'foo';
  }
  buildCounterDynamicProfileVersion--;
  return o;
...
void checkDynamicProfileVersion(api.DynamicProfileVersion o) {
  buildCounterDynamicProfileVersion++;
  if (buildCounterDynamicProfileVersion < 3) {
    checkUnnamed93(o.dynamicProfileFeedSettings!);
...
core.List<api.CustomRule> buildUnnamed95() => [
  buildCustomRule(),
  buildCustomRule(),
];

void checkUnnamed95(core.List<api.CustomRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCustomRule(o[0]);
  checkCustomRule(o[1]);
}

core.List<api.CustomValueField> buildUnnamed96() => [
  buildCustomValueField(),
  buildCustomValueField(),
];

void checkUnnamed96(core.List<api.CustomValueField> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCustomValueField(o[0]);
  checkCustomValueField(o[1]);
}

core.List<api.RemarketingValueAttribute> buildUnnamed97() => [
  buildRemarketingValueAttribute(),
  buildRemarketingValueAttribute(),
];

void checkUnnamed97(core.List<api.RemarketingValueAttribute> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRemarketingValueAttribute(o[0]);
  checkRemarketingValueAttribute(o[1]);
}

core.int buildCounterDynamicRules = 0;
api.DynamicRules buildDynamicRules() {
  final o = api.DynamicRules();
  buildCounterDynamicRules++;
  if (buildCounterDynamicRules < 3) {
    o.autoTargetedFieldIds = buildUnnamed94();
    o.customRules = buildUnnamed95();
    o.customValueFields = buildUnnamed96();
    o.proximityFilter = buildProximityFilter();
    o.remarketingValueAttributes = buildUnnamed97();
    o.rotationType = 'foo';
    o.ruleType = 'foo';
    o.weightFieldId = 42;
  }
...
void checkDynamicRules(api.DynamicRules o) {
  buildCounterDynamicRules++;
  if (buildCounterDynamicRules < 3) {
    checkUnnamed94(o.autoTargetedFieldIds!);
    checkUnnamed95(o.customRules!);
    checkUnnamed96(o.customValueFields!);
    checkProximityFilter(o.proximityFilter!);
    checkUnnamed97(o.remarketingValueAttributes!);
    unittest.expect(o.rotationType!, unittest.equals('foo'));
    unittest.expect(o.ruleType!, unittest.equals('foo'));
    unittest.expect(o.weightFieldId!, unittest.equals(42));
  }
  buildCounterDynamicRules--;
}
...
core.List<api.DynamicTargetingKey> buildUnnamed98() => [
  buildDynamicTargetingKey(),
  buildDynamicTargetingKey(),
];

void checkUnnamed98(core.List<api.DynamicTargetingKey> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DynamicTargetingKeysListResponse buildDynamicTargetingKeysListResponse() {
  ...
  if (buildCounterDynamicTargetingKeysListResponse < 3) {
    o.dynamicTargetingKeys = buildUnnamed98();
    o.kind = 'foo';
  }
  buildCounterDynamicTargetingKeysListResponse--;
  return o;
...
void checkDynamicTargetingKeysListResponse(
  ...
  buildCounterDynamicTargetingKeysListResponse++;
  if (buildCounterDynamicTargetingKeysListResponse < 3) {
    checkUnnamed98(o.dynamicTargetingKeys!);
    unittest.expect(o.kind!, unittest.equals('foo'));
  }
  buildCounterDynamicTargetingKeysListResponse--;
}

core.List<api.FeedField> buildUnnamed99() => [
  buildFeedField(),
  buildFeedField(),
];

void checkUnnamed99(core.List<api.FeedField> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFeedField(o[0]);
  checkFeedField(o[1]);
}

core.int buildCounterElement = 0;
api.Element buildElement() {
  final o = api.Element();
  buildCounterElement++;
  if (buildCounterElement < 3) {
    o.activeFieldId = 42;
    o.createInfo = buildLastModifiedInfo();
    o.defaultFieldId = 42;
    o.elementName = 'foo';
    o.endTimestampFieldId = 42;
    o.externalIdFieldId = 42;
    o.feedFields = buildUnnamed99();
    o.isLocalTimestamp = true;
    o.lastModifiedInfo = buildLastModifiedInfo();
    o.proximityTargetingFieldId = 42;
    o.reportingLabelFieldId = 42;
    o.startTimestampFieldId = 42;
  }
  buildCounterElement--;
  return o;
}

void checkElement(api.Element o) {
  buildCounterElement++;
  if (buildCounterElement < 3) {
    unittest.expect(o.activeFieldId!, unittest.equals(42));
    checkLastModifiedInfo(o.createInfo!);
    unittest.expect(o.defaultFieldId!, unittest.equals(42));
    unittest.expect(o.elementName!, unittest.equals('foo'));
    unittest.expect(o.endTimestampFieldId!, unittest.equals(42));
    unittest.expect(o.externalIdFieldId!, unittest.equals(42));
    checkUnnamed99(o.feedFields!);
    unittest.expect(o.isLocalTimestamp!, unittest.isTrue);
    checkLastModifiedInfo(o.lastModifiedInfo!);
    unittest.expect(o.proximityTargetingFieldId!, unittest.equals(42));
    unittest.expect(o.reportingLabelFieldId!, unittest.equals(42));
    unittest.expect(o.startTimestampFieldId!, unittest.equals(42));
  }
  buildCounterElement--;
}
...
core.List<api.EventTag> buildUnnamed101() => [buildEventTag(), buildEventTag()];

void checkUnnamed101(core.List<api.EventTag> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEventTag(o[0]);
  checkEventTag(o[1]);
}
...
void checkEventTagsListResponse(api.EventTagsListResponse o) {
  buildCounterEventTagsListResponse++;
  if (buildCounterEventTagsListResponse < 3) {
    checkUnnamed101(o.eventTags!);
    unittest.expect(o.kind!, unittest.equals('foo'));
  }
  buildCounterEventTagsListResponse--;
}

core.int buildCounterFeedField = 0;
api.FeedField buildFeedField() {
  final o = api.FeedField();
  buildCounterFeedField++;
  if (buildCounterFeedField < 3) {
    o.defaultValue = 'foo';
    o.filterable = true;
    o.id = 42;
    o.name = 'foo';
...
void checkFeedField(api.FeedField o) {
  buildCounterFeedField++;
  if (buildCounterFeedField < 3) {
    ...
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.renderable!, unittest.isTrue);
...
core.List<api.IngestionErrorRecord> buildUnnamed102() => [
  buildIngestionErrorRecord(),
  buildIngestionErrorRecord(),
];

void checkUnnamed102(core.List<api.IngestionErrorRecord> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIngestionErrorRecord(o[0]);
  checkIngestionErrorRecord(o[1]);
}

core.int buildCounterFeedIngestionStatus = 0;
api.FeedIngestionStatus buildFeedIngestionStatus() {
  final o = api.FeedIngestionStatus();
  buildCounterFeedIngestionStatus++;
  if (buildCounterFeedIngestionStatus < 3) {
    o.ingestionErrorRecords = buildUnnamed102();
    o.ingestionStatus = buildIngestionStatus();
    o.state = 'foo';
  }
  buildCounterFeedIngestionStatus--;
  return o;
...
void checkFeedIngestionStatus(api.FeedIngestionStatus o) {
  buildCounterFeedIngestionStatus++;
  if (buildCounterFeedIngestionStatus < 3) {
    checkUnnamed102(o.ingestionErrorRecords!);
    checkIngestionStatus(o.ingestionStatus!);
    unittest.expect(o.state!, unittest.equals('foo'));
  }
  buildCounterFeedIngestionStatus--;
}

core.int buildCounterFeedSchedule = 0;
api.FeedSchedule buildFeedSchedule() {
  final o = api.FeedSchedule();
  buildCounterFeedSchedule++;
  if (buildCounterFeedSchedule < 3) {
    o.repeatValue = 'foo';
...
void checkFeedSchedule(api.FeedSchedule o) {
  buildCounterFeedSchedule++;
  if (buildCounterFeedSchedule < 3) {
    unittest.expect(o.repeatValue!, unittest.equals('foo'));
    unittest.expect(o.scheduleEnabled!, unittest.isTrue);
    unittest.expect(o.startHour!, unittest.equals('foo'));
...
core.int buildCounterFieldError = 0;
api.FieldError buildFieldError() {
  final o = api.FieldError();
  buildCounterFieldError++;
  if (buildCounterFieldError < 3) {
    o.fieldId = 42;
    o.fieldName = 'foo';
    o.fieldValues = buildUnnamed103();
    o.ingestionError = 'foo';
    o.isError = true;
  }
  buildCounterFieldError--;
  return o;
...
void checkFieldError(api.FieldError o) {
  buildCounterFieldError++;
  if (buildCounterFieldError < 3) {
    unittest.expect(o.fieldId!, unittest.equals(42));
    unittest.expect(o.fieldName!, unittest.equals('foo'));
    checkUnnamed103(o.fieldValues!);
    unittest.expect(o.ingestionError!, unittest.equals('foo'));
...
api.FieldFilter buildFieldFilter() {
  ...
  if (buildCounterFieldFilter < 3) {
    o.boolValue = true;
    o.dependentFieldValue = buildDependentFieldValue();
    o.fieldId = 42;
    o.matchType = 'foo';
    o.requestValue = buildRequestValue();
    o.stringValue = 'foo';
    o.valueType = 'foo';
  }
  buildCounterFieldFilter--;
...
void checkFieldFilter(api.FieldFilter o) {
  ...
  if (buildCounterFieldFilter < 3) {
    ...
    checkDependentFieldValue(o.dependentFieldValue!);
    unittest.expect(o.fieldId!, unittest.equals(42));
    unittest.expect(o.matchType!, unittest.equals('foo'));
    checkRequestValue(o.requestValue!);
...
core.List<api.File> buildUnnamed104() => [buildFile(), buildFile()];

void checkUnnamed104(core.List<api.File> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFile(o[0]);
  checkFile(o[1]);
}
...
core.List<api.FloodlightActivity> buildUnnamed105() => [
  buildFloodlightActivity(),
  buildFloodlightActivity(),
];

void checkUnnamed105(core.List<api.FloodlightActivity> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.FloodlightActivitiesListResponse buildFloodlightActivitiesListResponse() {
  ...
  if (buildCounterFloodlightActivitiesListResponse < 3) {
    o.floodlightActivities = buildUnnamed105();
    o.kind = 'foo';
    o.nextPageToken = 'foo';
  }
  buildCounterFloodlightActivitiesListResponse--;
...
void checkFloodlightActivitiesListResponse(
  ...
  buildCounterFloodlightActivitiesListResponse++;
  if (buildCounterFloodlightActivitiesListResponse < 3) {
    checkUnnamed105(o.floodlightActivities!);
    unittest.expect(o.kind!, unittest.equals('foo'));
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterFloodlightActivitiesListResponse--;
...
core.List<api.FloodlightActivityDynamicTag> buildUnnamed106() => [
  buildFloodlightActivityDynamicTag(),
  buildFloodlightActivityDynamicTag(),
];

void checkUnnamed106(core.List<api.FloodlightActivityDynamicTag> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFloodlightActivityDynamicTag(o[0]);
  checkFloodlightActivityDynamicTag(o[1]);
}

core.List<api.FloodlightActivityPublisherDynamicTag> buildUnnamed107() => [
  buildFloodlightActivityPublisherDynamicTag(),
  buildFloodlightActivityPublisherDynamicTag(),
];

void checkUnnamed107(core.List<api.FloodlightActivityPublisherDynamicTag> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.FloodlightActivity buildFloodlightActivity() {
  ...
  if (buildCounterFloodlightActivity < 3) {
    ...
    o.conversionCategory = 'foo';
    o.countingMethod = 'foo';
    o.defaultTags = buildUnnamed106();
    o.expectedUrl = 'foo';
    ...
    o.name = 'foo';
    o.notes = 'foo';
    o.publisherTags = buildUnnamed107();
    o.secure = true;
    o.sslCompliant = true;
    o.sslRequired = true;
    o.status = 'foo';
    ...
    o.tagFormat = 'foo';
    o.tagString = 'foo';
    o.userDefinedVariableTypes = buildUnnamed108();
  }
  buildCounterFloodlightActivity--;
  return o;
}
...
void checkFloodlightActivity(api.FloodlightActivity o) {
  ...
  if (buildCounterFloodlightActivity < 3) {
    ...
    unittest.expect(o.conversionCategory!, unittest.equals('foo'));
    unittest.expect(o.countingMethod!, unittest.equals('foo'));
    checkUnnamed106(o.defaultTags!);
    ...
    checkUnnamed107(o.publisherTags!);
    ...
    checkUnnamed108(o.userDefinedVariableTypes!);
  }
  buildCounterFloodlightActivity--;
}
...
core.List<api.FloodlightActivityGroup> buildUnnamed109() => [
  buildFloodlightActivityGroup(),
  buildFloodlightActivityGroup(),
];

void checkUnnamed109(core.List<api.FloodlightActivityGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildFloodlightActivityGroupsListResponse() {
  ...
  if (buildCounterFloodlightActivityGroupsListResponse < 3) {
    o.floodlightActivityGroups = buildUnnamed109();
    o.kind = 'foo';
    o.nextPageToken = 'foo';
  }
  buildCounterFloodlightActivityGroupsListResponse--;
...
void checkFloodlightActivityGroupsListResponse(
  ...
  buildCounterFloodlightActivityGroupsListResponse++;
  if (buildCounterFloodlightActivityGroupsListResponse < 3) {
    checkUnnamed109(o.floodlightActivityGroups!);
    unittest.expect(o.kind!, unittest.equals('foo'));
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterFloodlightActivityGroupsListResponse--;
...
core.List<api.ThirdPartyAuthenticationToken> buildUnnamed110() => [
  buildThirdPartyAuthenticationToken(),
  buildThirdPartyAuthenticationToken(),
];

void checkUnnamed110(core.List<api.ThirdPartyAuthenticationToken> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkThirdPartyAuthenticationToken(o[0]);
  checkThirdPartyAuthenticationToken(o[1]);
}

core.List<api.UserDefinedVariableConfiguration> buildUnnamed111() => [
  buildUserDefinedVariableConfiguration(),
  buildUserDefinedVariableConfiguration(),
];

void checkUnnamed111(core.List<api.UserDefinedVariableConfiguration> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.FloodlightConfiguration buildFloodlightConfiguration() {
  ...
  if (buildCounterFloodlightConfiguration < 3) {
    ...
    o.thirdPartyAuthenticationTokens = buildUnnamed110();
    o.userDefinedVariableConfigurations = buildUnnamed111();
  }
  buildCounterFloodlightConfiguration--;
  return o;
}
...
void checkFloodlightConfiguration(api.FloodlightConfiguration o) {
  ...
  if (buildCounterFloodlightConfiguration < 3) {
    ...
    checkUnnamed110(o.thirdPartyAuthenticationTokens!);
    checkUnnamed111(o.userDefinedVariableConfigurations!);
  }
  buildCounterFloodlightConfiguration--;
}

core.List<api.FloodlightConfiguration> buildUnnamed112() => [
  buildFloodlightConfiguration(),
  buildFloodlightConfiguration(),
];

void checkUnnamed112(core.List<api.FloodlightConfiguration> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildFloodlightConfigurationsListResponse() {
  ...
  if (buildCounterFloodlightConfigurationsListResponse < 3) {
    o.floodlightConfigurations = buildUnnamed112();
    o.kind = 'foo';
  }
  buildCounterFloodlightConfigurationsListResponse--;
  return o;
...
void checkFloodlightConfigurationsListResponse(
  ...
  buildCounterFloodlightConfigurationsListResponse++;
  if (buildCounterFloodlightConfigurationsListResponse < 3) {
    checkUnnamed112(o.floodlightConfigurations!);
    unittest.expect(o.kind!, unittest.equals('foo'));
  }
  buildCounterFloodlightConfigurationsListResponse--;
}

core.List<api.Dimension> buildUnnamed113() => [
  buildDimension(),
  buildDimension(),
];

void checkUnnamed113(core.List<api.Dimension> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimension(o[0]);
  checkDimension(o[1]);
}

core.List<api.Dimension> buildUnnamed114() => [
  buildDimension(),
  buildDimension(),
];

void checkUnnamed114(core.List<api.Dimension> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimension(o[0]);
  checkDimension(o[1]);
}

core.List<api.Metric> buildUnnamed115() => [buildMetric(), buildMetric()];

void checkUnnamed115(core.List<api.Metric> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetric(o[0]);
  checkMetric(o[1]);
}
...
api.FloodlightReportCompatibleFields buildFloodlightReportCompatibleFields() {
  ...
  if (buildCounterFloodlightReportCompatibleFields < 3) {
    o.dimensionFilters = buildUnnamed113();
    o.dimensions = buildUnnamed114();
    o.kind = 'foo';
    o.metrics = buildUnnamed115();
  }
  buildCounterFloodlightReportCompatibleFields--;
  return o;
}
...
void checkFloodlightReportCompatibleFields(
  ...
  buildCounterFloodlightReportCompatibleFields++;
  if (buildCounterFloodlightReportCompatibleFields < 3) {
    checkUnnamed113(o.dimensionFilters!);
    checkUnnamed114(o.dimensions!);
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed115(o.metrics!);
  }
  buildCounterFloodlightReportCompatibleFields--;
}
...
core.List<api.City> buildUnnamed116() => [buildCity(), buildCity()];

void checkUnnamed116(core.List<api.City> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCity(o[0]);
  checkCity(o[1]);
}

core.List<api.Country> buildUnnamed117() => [buildCountry(), buildCountry()];

void checkUnnamed117(core.List<api.Country> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCountry(o[0]);
  checkCountry(o[1]);
}

core.List<api.Metro> buildUnnamed118() => [buildMetro(), buildMetro()];

void checkUnnamed118(core.List<api.Metro> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetro(o[0]);
  checkMetro(o[1]);
}

core.List<api.PostalCode> buildUnnamed119() => [
  buildPostalCode(),
  buildPostalCode(),
];

void checkUnnamed119(core.List<api.PostalCode> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPostalCode(o[0]);
  checkPostalCode(o[1]);
}

core.List<api.Region> buildUnnamed120() => [buildRegion(), buildRegion()];

void checkUnnamed120(core.List<api.Region> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRegion(o[0]);
  checkRegion(o[1]);
}
...
api.GeoTargeting buildGeoTargeting() {
  ...
  if (buildCounterGeoTargeting < 3) {
    o.cities = buildUnnamed116();
    o.countries = buildUnnamed117();
    o.excludeCountries = true;
    o.metros = buildUnnamed118();
    o.postalCodes = buildUnnamed119();
    o.regions = buildUnnamed120();
  }
  buildCounterGeoTargeting--;
  return o;
}
...
void checkGeoTargeting(api.GeoTargeting o) {
  buildCounterGeoTargeting++;
  if (buildCounterGeoTargeting < 3) {
    checkUnnamed116(o.cities!);
    checkUnnamed117(o.countries!);
    unittest.expect(o.excludeCountries!, unittest.isTrue);
    checkUnnamed118(o.metros!);
    checkUnnamed119(o.postalCodes!);
    checkUnnamed120(o.regions!);
  }
  buildCounterGeoTargeting--;
}

core.List<api.FieldError> buildUnnamed121() => [
  buildFieldError(),
  buildFieldError(),
];

void checkUnnamed121(core.List<api.FieldError> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFieldError(o[0]);
  checkFieldError(o[1]);
}

core.int buildCounterIngestionErrorRecord = 0;
api.IngestionErrorRecord buildIngestionErrorRecord() {
  final o = api.IngestionErrorRecord();
  buildCounterIngestionErrorRecord++;
  if (buildCounterIngestionErrorRecord < 3) {
...
void checkIngestionErrorRecord(api.IngestionErrorRecord o) {
  buildCounterIngestionErrorRecord++;
  if (buildCounterIngestionErrorRecord < 3) {
...
core.int buildCounterIngestionStatus = 0;
api.IngestionStatus buildIngestionStatus() {
  final o = api.IngestionStatus();
  buildCounterIngestionStatus++;
  if (buildCounterIngestionStatus < 3) {
    o.numActiveRows = 'foo';
    o.numRowsProcessed = 'foo';
    o.numRowsTotal = 'foo';
    o.numRowsWithErrors = 'foo';
    o.numWarningsTotal = 'foo';
  }
  buildCounterIngestionStatus--;
  return o;
}

void checkIngestionStatus(api.IngestionStatus o) {
  buildCounterIngestionStatus++;
  if (buildCounterIngestionStatus < 3) {
    unittest.expect(o.numActiveRows!, unittest.equals('foo'));
    unittest.expect(o.numRowsProcessed!, unittest.equals('foo'));
    unittest.expect(o.numRowsTotal!, unittest.equals('foo'));
    unittest.expect(o.numRowsWithErrors!, unittest.equals('foo'));
    unittest.expect(o.numWarningsTotal!, unittest.equals('foo'));
  }
  buildCounterIngestionStatus--;
}

core.List<api.CampaignSummary> buildUnnamed122() => [
  buildCampaignSummary(),
  buildCampaignSummary(),
];

void checkUnnamed122(core.List<api.CampaignSummary> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Invoice buildInvoice() {
  ...
  if (buildCounterInvoice < 3) {
    o.campaignSummaries = buildUnnamed122();
    ...
    o.replacedInvoiceIds = buildUnnamed123();
...
void checkInvoice(api.Invoice o) {
  buildCounterInvoice++;
  if (buildCounterInvoice < 3) {
    checkUnnamed122(o.campaignSummaries!);
    unittest.expect(o.correctedInvoiceId!, unittest.equals('foo'));
    unittest.expect(o.currencyCode!, unittest.equals('foo'));
    unittest.expect(o.dueDate!, unittest.equals('foo'));
    unittest.expect(o.id!, unittest.equals('foo'));
    unittest.expect(o.invoiceType!, unittest.equals('foo'));
    unittest.expect(o.issueDate!, unittest.equals('foo'));
    unittest.expect(o.kind!, unittest.equals('foo'));
    unittest.expect(o.paymentsAccountId!, unittest.equals('foo'));
    ...
    checkUnnamed123(o.replacedInvoiceIds!);
    unittest.expect(o.serviceEndDate!, unittest.equals('foo'));
    unittest.expect(o.serviceStartDate!, unittest.equals('foo'));
...
core.List<api.DeepLink> buildUnnamed124() => [buildDeepLink(), buildDeepLink()];

void checkUnnamed124(core.List<api.DeepLink> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDeepLink(o[0]);
  checkDeepLink(o[1]);
}
...
core.List<api.Language> buildUnnamed125() => [buildLanguage(), buildLanguage()];

void checkUnnamed125(core.List<api.Language> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLanguage(o[0]);
  checkLanguage(o[1]);
}
...
void checkLanguageTargeting(api.LanguageTargeting o) {
  buildCounterLanguageTargeting++;
  if (buildCounterLanguageTargeting < 3) {
    checkUnnamed125(o.languages!);
  }
  buildCounterLanguageTargeting--;
}

core.List<api.Language> buildUnnamed126() => [buildLanguage(), buildLanguage()];

void checkUnnamed126(core.List<api.Language> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLanguage(o[0]);
  checkLanguage(o[1]);
}
...
core.List<api.ListPopulationTerm> buildUnnamed127() => [
  buildListPopulationTerm(),
  buildListPopulationTerm(),
];

void checkUnnamed127(core.List<api.ListPopulationTerm> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListPopulationClause(api.ListPopulationClause o) {
  buildCounterListPopulationClause++;
  if (buildCounterListPopulationClause < 3) {
    checkUnnamed127(o.terms!);
  }
  buildCounterListPopulationClause--;
}

core.List<api.ListPopulationClause> buildUnnamed128() => [
  buildListPopulationClause(),
  buildListPopulationClause(),
];

void checkUnnamed128(core.List<api.ListPopulationClause> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListPopulationRule buildListPopulationRule() {
  ...
  if (buildCounterListPopulationRule < 3) {
    ...
    o.listPopulationClauses = buildUnnamed128();
  }
  buildCounterListPopulationRule--;
  return o;
}
...
void checkListPopulationRule(api.ListPopulationRule o) {
  ...
  if (buildCounterListPopulationRule < 3) {
    ...
    checkUnnamed128(o.listPopulationClauses!);
  }
  buildCounterListPopulationRule--;
}
...
void checkMeasurementPartnerAdvertiserLink(
  ...
  if (buildCounterMeasurementPartnerAdvertiserLink < 3) {
    ...
    unittest.expect(o.measurementPartner!, unittest.equals('foo'));
    unittest.expect(o.partnerAdvertiserId!, unittest.equals('foo'));
  }
  buildCounterMeasurementPartnerAdvertiserLink--;
}
...
void checkMeasurementPartnerCampaignLink(api.MeasurementPartnerCampaignLink o) {
  ...
  if (buildCounterMeasurementPartnerCampaignLink < 3) {
    unittest.expect(o.linkStatus!, unittest.equals('foo'));
    unittest.expect(o.measurementPartner!, unittest.equals('foo'));
    unittest.expect(o.partnerCampaignId!, unittest.equals('foo'));
  }
  buildCounterMeasurementPartnerCampaignLink--;
}
...
void checkMeasurementPartnerWrappingData(api.MeasurementPartnerWrappingData o) {
  ...
  if (buildCounterMeasurementPartnerWrappingData < 3) {
    unittest.expect(o.linkStatus!, unittest.equals('foo'));
    unittest.expect(o.measurementPartner!, unittest.equals('foo'));
    unittest.expect(o.tagWrappingMode!, unittest.equals('foo'));
    unittest.expect(o.wrappedTag!, unittest.equals('foo'));
  }
  buildCounterMeasurementPartnerWrappingData--;
}
...
core.List<api.Metro> buildUnnamed129() => [buildMetro(), buildMetro()];

void checkUnnamed129(core.List<api.Metro> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetro(o[0]);
  checkMetro(o[1]);
}
...
core.List<api.MobileApp> buildUnnamed130() => [
  buildMobileApp(),
  buildMobileApp(),
];

void checkUnnamed130(core.List<api.MobileApp> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMobileApp(o[0]);
  checkMobileApp(o[1]);
}
...
core.List<api.MobileCarrier> buildUnnamed131() => [
  buildMobileCarrier(),
  buildMobileCarrier(),
];

void checkUnnamed131(core.List<api.MobileCarrier> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MobileCarriersListResponse buildMobileCarriersListResponse() {
  ...
  if (buildCounterMobileCarriersListResponse < 3) {
    o.kind = 'foo';
    o.mobileCarriers = buildUnnamed131();
  }
  buildCounterMobileCarriersListResponse--;
  return o;
}
...
void checkMobileCarriersListResponse(api.MobileCarriersListResponse o) {
  ...
  if (buildCounterMobileCarriersListResponse < 3) {
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed131(o.mobileCarriers!);
  }
  buildCounterMobileCarriersListResponse--;
}
...
void checkOfflineUserAddressInfo(api.OfflineUserAddressInfo o) {
  ...
  if (buildCounterOfflineUserAddressInfo < 3) {
    ...
    unittest.expect(o.hashedStreetAddress!, unittest.equals('foo'));
...
core.List<api.OperatingSystemVersion> buildUnnamed133() => [
  buildOperatingSystemVersion(),
  buildOperatingSystemVersion(),
];

void checkUnnamed133(core.List<api.OperatingSystemVersion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOperatingSystemVersionsListResponse() {
  ...
  if (buildCounterOperatingSystemVersionsListResponse < 3) {
    o.kind = 'foo';
    o.operatingSystemVersions = buildUnnamed133();
  }
  buildCounterOperatingSystemVersionsListResponse--;
  return o;
}
...
void checkOperatingSystemVersionsListResponse(
  ...
  if (buildCounterOperatingSystemVersionsListResponse < 3) {
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed133(o.operatingSystemVersions!);
  }
  buildCounterOperatingSystemVersionsListResponse--;
}

core.List<api.OperatingSystem> buildUnnamed134() => [
  buildOperatingSystem(),
  buildOperatingSystem(),
];

void checkUnnamed134(core.List<api.OperatingSystem> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.OperatingSystemsListResponse buildOperatingSystemsListResponse() {
  ...
  if (buildCounterOperatingSystemsListResponse < 3) {
    o.kind = 'foo';
    o.operatingSystems = buildUnnamed134();
  }
  buildCounterOperatingSystemsListResponse--;
  return o;
}
...
void checkOperatingSystemsListResponse(api.OperatingSystemsListResponse o) {
  ...
  if (buildCounterOperatingSystemsListResponse < 3) {
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed134(o.operatingSystems!);
  }
  buildCounterOperatingSystemsListResponse--;
}
...
core.List<api.Metric> buildUnnamed137() => [buildMetric(), buildMetric()];
...
buildPathToConversionReportCompatibleFields() {
  ...
  if (buildCounterPathToConversionReportCompatibleFields < 3) {
    o.conversionDimensions = buildUnnamed135();
    o.customFloodlightVariables = buildUnnamed136();
    o.kind = 'foo';
    o.metrics = buildUnnamed137();
    o.perInteractionDimensions = buildUnnamed138();
  }
  buildCounterPathToConversionReportCompatibleFields--;
  return o;
}
...
void checkPathToConversionReportCompatibleFields(
  ...
  buildCounterPathToConversionReportCompatibleFields++;
  if (buildCounterPathToConversionReportCompatibleFields < 3) {
    checkUnnamed135(o.conversionDimensions!);
    checkUnnamed136(o.customFloodlightVariables!);
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed137(o.metrics!);
    checkUnnamed138(o.perInteractionDimensions!);
  }
  buildCounterPathToConversionReportCompatibleFields--;
}

core.List<api.Size> buildUnnamed139() => [buildSize(), buildSize()];

void checkUnnamed139(core.List<api.Size> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSize(o[0]);
  checkSize(o[1]);
}
...
api.Placement buildPlacement() {
  ...
  if (buildCounterPlacement < 3) {
    ...
    o.additionalSizes = buildUnnamed139();
    o.advertiserId = 'foo';
    o.advertiserIdDimensionValue = buildDimensionValue();
    o.allowOnYoutube = true;
    o.campaignId = 'foo';
    o.campaignIdDimensionValue = buildDimensionValue();
    o.comment = 'foo';
    o.compatibility = 'foo';
    ...
    o.youtubeSettings = buildYoutubeSettings();
  }
  buildCounterPlacement--;
  return o;
}
...
void checkPlacement(api.Placement o) {
  ...
  if (buildCounterPlacement < 3) {
    unittest.expect(o.accountId!, unittest.equals('foo'));
    unittest.expect(o.activeStatus!, unittest.equals('foo'));
    unittest.expect(o.adBlockingOptOut!, unittest.isTrue);
    unittest.expect(o.adServingPlatformId!, unittest.equals('foo'));
    checkUnnamed139(o.additionalSizes!);
    unittest.expect(o.advertiserId!, unittest.equals('foo'));
    checkDimensionValue(o.advertiserIdDimensionValue!);
    unittest.expect(o.allowOnYoutube!, unittest.isTrue);
    unittest.expect(o.campaignId!, unittest.equals('foo'));
    checkDimensionValue(o.campaignIdDimensionValue!);
    unittest.expect(o.comment!, unittest.equals('foo'));
    unittest.expect(o.compatibility!, unittest.equals('foo'));
    ...
    checkYoutubeSettings(o.youtubeSettings!);
  }
  buildCounterPlacement--;
}
...
core.List<api.PlacementSingleConversionDomain> buildUnnamed141() => [
  buildPlacementSingleConversionDomain(),
  buildPlacementSingleConversionDomain(),
];

void checkUnnamed141(core.List<api.PlacementSingleConversionDomain> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PlacementConversionDomainOverride buildPlacementConversionDomainOverride() {
  ...
  if (buildCounterPlacementConversionDomainOverride < 3) {
    o.conversionDomains = buildUnnamed141();
  }
  buildCounterPlacementConversionDomainOverride--;
  return o;
}
...
void checkPlacementConversionDomainOverride(
  ...
  buildCounterPlacementConversionDomainOverride++;
  if (buildCounterPlacementConversionDomainOverride < 3) {
    checkUnnamed141(o.conversionDomains!);
  }
  buildCounterPlacementConversionDomainOverride--;
}
...
api.PlacementGroup buildPlacementGroup() {
  ...
  if (buildCounterPlacementGroup < 3) {
    ...
    o.campaignId = 'foo';
    o.campaignIdDimensionValue = buildDimensionValue();
    o.childPlacementIds = buildUnnamed142();
    o.comment = 'foo';
    o.contentCategoryId = 'foo';
    o.createInfo = buildLastModifiedInfo();
    o.directorySiteId = 'foo';
...
void checkPlacementGroup(api.PlacementGroup o) {
  ...
  if (buildCounterPlacementGroup < 3) {
    ...
    unittest.expect(o.campaignId!, unittest.equals('foo'));
    checkDimensionValue(o.campaignIdDimensionValue!);
    checkUnnamed142(o.childPlacementIds!);
    unittest.expect(o.comment!, unittest.equals('foo'));
    unittest.expect(o.contentCategoryId!, unittest.equals('foo'));
    checkLastModifiedInfo(o.createInfo!);
    unittest.expect(o.directorySiteId!, unittest.equals('foo'));
...
core.List<api.PlacementGroup> buildUnnamed143() => [
  buildPlacementGroup(),
  buildPlacementGroup(),
];

void checkUnnamed143(core.List<api.PlacementGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PlacementGroupsListResponse buildPlacementGroupsListResponse() {
  ...
  if (buildCounterPlacementGroupsListResponse < 3) {
    o.kind = 'foo';
    o.nextPageToken = 'foo';
    o.placementGroups = buildUnnamed143();
  }
  buildCounterPlacementGroupsListResponse--;
  return o;
}
...
void checkPlacementGroupsListResponse(api.PlacementGroupsListResponse o) {
  ...
  if (buildCounterPlacementGroupsListResponse < 3) {
    unittest.expect(o.kind!, unittest.equals('foo'));
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed143(o.placementGroups!);
  }
  buildCounterPlacementGroupsListResponse--;
}
...
void checkPlacementSingleConversionDomain(
  ...
  buildCounterPlacementSingleConversionDomain++;
  if (buildCounterPlacementSingleConversionDomain < 3) {
    unittest.expect(o.conversionDomainId!, unittest.equals('foo'));
    unittest.expect(o.conversionDomainValue!, unittest.equals('foo'));
  }
  buildCounterPlacementSingleConversionDomain--;
}

core.List<api.PlacementStrategy> buildUnnamed144() => [
  buildPlacementStrategy(),
  buildPlacementStrategy(),
];

void checkUnnamed144(core.List<api.PlacementStrategy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PlacementStrategiesListResponse buildPlacementStrategiesListResponse() {
  ...
  if (buildCounterPlacementStrategiesListResponse < 3) {
    o.kind = 'foo';
    o.nextPageToken = 'foo';
    o.placementStrategies = buildUnnamed144();
  }
  buildCounterPlacementStrategiesListResponse--;
  return o;
}
...
void checkPlacementStrategiesListResponse(
  ...
  if (buildCounterPlacementStrategiesListResponse < 3) {
    unittest.expect(o.kind!, unittest.equals('foo'));
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed144(o.placementStrategies!);
  }
  buildCounterPlacementStrategiesListResponse--;
}
...
core.List<api.TagData> buildUnnamed145() => [buildTagData(), buildTagData()];

void checkUnnamed145(core.List<api.TagData> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTagData(o[0]);
  checkTagData(o[1]);
}
...
void checkPlacementTag(api.PlacementTag o) {
  ...
  if (buildCounterPlacementTag < 3) {
    unittest.expect(o.placementId!, unittest.equals('foo'));
    checkUnnamed145(o.tagDatas!);
  }
  buildCounterPlacementTag--;
}

core.List<api.PlacementTag> buildUnnamed146() => [
  buildPlacementTag(),
  buildPlacementTag(),
];

void checkUnnamed146(core.List<api.PlacementTag> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PlacementsGenerateTagsResponse buildPlacementsGenerateTagsResponse() {
  ...
  if (buildCounterPlacementsGenerateTagsResponse < 3) {
    o.kind = 'foo';
    o.placementTags = buildUnnamed146();
  }
  buildCounterPlacementsGenerateTagsResponse--;
  return o;
}
...
void checkPlacementsGenerateTagsResponse(api.PlacementsGenerateTagsResponse o) {
  ...
  if (buildCounterPlacementsGenerateTagsResponse < 3) {
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed146(o.placementTags!);
  }
  buildCounterPlacementsGenerateTagsResponse--;
}

core.List<api.Placement> buildUnnamed147() => [
  buildPlacement(),
  buildPlacement(),
];

void checkUnnamed147(core.List<api.Placement> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPlacement(o[0]);
  checkPlacement(o[1]);
}
...
core.List<api.PlatformType> buildUnnamed148() => [
  buildPlatformType(),
  buildPlatformType(),
];

void checkUnnamed148(core.List<api.PlatformType> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PlatformTypesListResponse buildPlatformTypesListResponse() {
  ...
  if (buildCounterPlatformTypesListResponse < 3) {
    o.kind = 'foo';
    o.platformTypes = buildUnnamed148();
  }
  buildCounterPlatformTypesListResponse--;
  return o;
}
...
void checkPlatformTypesListResponse(api.PlatformTypesListResponse o) {
  ...
  if (buildCounterPlatformTypesListResponse < 3) {
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed148(o.platformTypes!);
  }
  buildCounterPlatformTypesListResponse--;
}
...
core.List<api.PostalCode> buildUnnamed149() => [
  buildPostalCode(),
  buildPostalCode(),
];

void checkUnnamed149(core.List<api.PostalCode> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPostalCode(o[0]);
  checkPostalCode(o[1]);
}
...
void checkPostalCodesListResponse(api.PostalCodesListResponse o) {
  ...
  if (buildCounterPostalCodesListResponse < 3) {
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed149(o.postalCodes!);
  }
  buildCounterPostalCodesListResponse--;
}

core.List<api.PricingSchedulePricingPeriod> buildUnnamed150() => [
  buildPricingSchedulePricingPeriod(),
  buildPricingSchedulePricingPeriod(),
];

void checkUnnamed150(core.List<api.PricingSchedulePricingPeriod> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PricingSchedule buildPricingSchedule() {
  ...
  if (buildCounterPricingSchedule < 3) {
    ...
    o.flighted = true;
    o.floodlightActivityId = 'foo';
    o.pricingPeriods = buildUnnamed150();
    o.pricingType = 'foo';
    o.startDate = core.DateTime.parse('2002-02-27T14:01:02Z');
...
void checkPricingSchedule(api.PricingSchedule o) {
  ...
  if (buildCounterPricingSchedule < 3) {
    ...
    unittest.expect(o.floodlightActivityId!, unittest.equals('foo'));
    checkUnnamed150(o.pricingPeriods!);
...
core.int buildCounterProximityFilter = 0;
api.ProximityFilter buildProximityFilter() {
  final o = api.ProximityFilter();
  buildCounterProximityFilter++;
  if (buildCounterProximityFilter < 3) {
    o.fieldId = 42;
    o.radiusBucketType = 'foo';
    o.radiusUnitType = 'foo';
    o.radiusValue = 42;
  }
  buildCounterProximityFilter--;
  return o;
...
void checkProximityFilter(api.ProximityFilter o) {
  buildCounterProximityFilter++;
  if (buildCounterProximityFilter < 3) {
    unittest.expect(o.fieldId!, unittest.equals(42));
    unittest.expect(o.radiusBucketType!, unittest.equals('foo'));
    unittest.expect(o.radiusUnitType!, unittest.equals('foo'));
    unittest.expect(o.radiusValue!, unittest.equals(42));
  }
  buildCounterProximityFilter--;
}
...
core.List<api.Dimension> buildUnnamed152() => [
  buildDimension(),
  buildDimension(),
];

void checkUnnamed152(core.List<api.Dimension> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimension(o[0]);
  checkDimension(o[1]);
}

core.List<api.Metric> buildUnnamed153() => [buildMetric(), buildMetric()];
...
core.List<api.Metric> buildUnnamed154() => [buildMetric(), buildMetric()];
...
core.List<api.Metric> buildUnnamed155() => [buildMetric(), buildMetric()];

void checkUnnamed155(core.List<api.Metric> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetric(o[0]);
  checkMetric(o[1]);
}
...
api.ReachReportCompatibleFields buildReachReportCompatibleFields() {
  ...
  if (buildCounterReachReportCompatibleFields < 3) {
    o.dimensionFilters = buildUnnamed151();
    o.dimensions = buildUnnamed152();
    o.kind = 'foo';
    o.metrics = buildUnnamed153();
    o.pivotedActivityMetrics = buildUnnamed154();
    o.reachByFrequencyMetrics = buildUnnamed155();
  }
  buildCounterReachReportCompatibleFields--;
  return o;
}
...
void checkReachReportCompatibleFields(api.ReachReportCompatibleFields o) {
  buildCounterReachReportCompatibleFields++;
  if (buildCounterReachReportCompatibleFields < 3) {
    checkUnnamed151(o.dimensionFilters!);
    checkUnnamed152(o.dimensions!);
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed153(o.metrics!);
    checkUnnamed154(o.pivotedActivityMetrics!);
    checkUnnamed155(o.reachByFrequencyMetrics!);
  }
  buildCounterReachReportCompatibleFields--;
}
...
core.List<api.Region> buildUnnamed156() => [buildRegion(), buildRegion()];

void checkUnnamed156(core.List<api.Region> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRegion(o[0]);
  checkRegion(o[1]);
}
...
api.RemarketingListShare buildRemarketingListShare() {
  ...
  if (buildCounterRemarketingListShare < 3) {
    o.kind = 'foo';
    o.remarketingListId = 'foo';
    o.sharedAccountIds = buildUnnamed157();
    o.sharedAdvertiserIds = buildUnnamed158();
  }
  buildCounterRemarketingListShare--;
  return o;
}
...
void checkRemarketingListShare(api.RemarketingListShare o) {
  ...
  if (buildCounterRemarketingListShare < 3) {
    unittest.expect(o.kind!, unittest.equals('foo'));
    unittest.expect(o.remarketingListId!, unittest.equals('foo'));
    checkUnnamed157(o.sharedAccountIds!);
    checkUnnamed158(o.sharedAdvertiserIds!);
  }
  buildCounterRemarketingListShare--;
}

core.List<api.RemarketingList> buildUnnamed159() => [
  buildRemarketingList(),
  buildRemarketingList(),
];

void checkUnnamed159(core.List<api.RemarketingList> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.RemarketingListsListResponse buildRemarketingListsListResponse() {
  ...
  if (buildCounterRemarketingListsListResponse < 3) {
    o.kind = 'foo';
    o.nextPageToken = 'foo';
    o.remarketingLists = buildUnnamed159();
  }
  buildCounterRemarketingListsListResponse--;
  return o;
}
...
void checkRemarketingListsListResponse(api.RemarketingListsListResponse o) {
  ...
  if (buildCounterRemarketingListsListResponse < 3) {
    unittest.expect(o.kind!, unittest.equals('foo'));
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed159(o.remarketingLists!);
  }
  buildCounterRemarketingListsListResponse--;
}
...
core.int buildCounterRemarketingValueAttribute = 0;
api.RemarketingValueAttribute buildRemarketingValueAttribute() {
  final o = api.RemarketingValueAttribute();
  buildCounterRemarketingValueAttribute++;
  if (buildCounterRemarketingValueAttribute < 3) {
    o.fieldId = 42;
    o.userAttributeIds = buildUnnamed160();
  }
  buildCounterRemarketingValueAttribute--;
  return o;
}

void checkRemarketingValueAttribute(api.RemarketingValueAttribute o) {
  buildCounterRemarketingValueAttribute++;
  if (buildCounterRemarketingValueAttribute < 3) {
    unittest.expect(o.fieldId!, unittest.equals(42));
    checkUnnamed160(o.userAttributeIds!);
  }
  buildCounterRemarketingValueAttribute--;
}

core.List<api.DimensionValue> buildUnnamed161() => [
  buildDimensionValue(),
  buildDimensionValue(),
];

void checkUnnamed161(core.List<api.DimensionValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimensionValue(o[0]);
  checkDimensionValue(o[1]);
}
...
api.ReportCriteria buildReportCriteria() {
  ...
  if (buildCounterReportCriteria < 3) {
    ...
    o.dateRange = buildDateRange();
    o.dimensionFilters = buildUnnamed161();
    o.dimensions = buildUnnamed162();
    o.metricNames = buildUnnamed163();
  }
  buildCounterReportCriteria--;
  return o;
}
...
void checkReportCriteria(api.ReportCriteria o) {
  ...
  if (buildCounterReportCriteria < 3) {
    ...
    checkDateRange(o.dateRange!);
    checkUnnamed161(o.dimensionFilters!);
    checkUnnamed162(o.dimensions!);
    checkUnnamed163(o.metricNames!);
  }
  buildCounterReportCriteria--;
}
...
core.List<api.Recipient> buildUnnamed167() => [
  buildRecipient(),
  buildRecipient(),
];

void checkUnnamed167(core.List<api.Recipient> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRecipient(o[0]);
  checkRecipient(o[1]);
}
...
core.List<api.DimensionValue> buildUnnamed169() => [
  buildDimensionValue(),
  buildDimensionValue(),
];

void checkUnnamed169(core.List<api.DimensionValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimensionValue(o[0]);
  checkDimensionValue(o[1]);
}
...
api.ReportFloodlightCriteria buildReportFloodlightCriteria() {
  ...
  if (buildCounterReportFloodlightCriteria < 3) {
    o.customRichMediaEvents = buildUnnamed168();
    o.dateRange = buildDateRange();
    o.dimensionFilters = buildUnnamed169();
...
void checkReportFloodlightCriteria(api.ReportFloodlightCriteria o) {
  buildCounterReportFloodlightCriteria++;
  if (buildCounterReportFloodlightCriteria < 3) {
    checkUnnamed168(o.customRichMediaEvents!);
    checkDateRange(o.dateRange!);
    checkUnnamed169(o.dimensionFilters!);
...
core.List<api.SortedDimension> buildUnnamed173() => [
  buildSortedDimension(),
  buildSortedDimension(),
];

void checkUnnamed173(core.List<api.SortedDimension> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSortedDimension(o[0]);
  checkSortedDimension(o[1]);
}
...
api.ReportPathToConversionCriteria buildReportPathToConversionCriteria() {
  ...
  if (buildCounterReportPathToConversionCriteria < 3) {
    o.activityFilters = buildUnnamed172();
    o.conversionDimensions = buildUnnamed173();
    o.customFloodlightVariables = buildUnnamed174();
    o.customRichMediaEvents = buildUnnamed175();
    o.dateRange = buildDateRange();
    o.floodlightConfigId = buildDimensionValue();
    o.metricNames = buildUnnamed176();
    o.perInteractionDimensions = buildUnnamed177();
...
void checkReportPathToConversionCriteria(api.ReportPathToConversionCriteria o) {
  buildCounterReportPathToConversionCriteria++;
  if (buildCounterReportPathToConversionCriteria < 3) {
    checkUnnamed172(o.activityFilters!);
    checkUnnamed173(o.conversionDimensions!);
    checkUnnamed174(o.customFloodlightVariables!);
    checkUnnamed175(o.customRichMediaEvents!);
    checkDateRange(o.dateRange!);
    checkDimensionValue(o.floodlightConfigId!);
    checkUnnamed176(o.metricNames!);
    checkUnnamed177(o.perInteractionDimensions!);
    checkReportPathToConversionCriteriaReportProperties(o.reportProperties!);
  }
  buildCounterReportPathToConversionCriteria--;
}

core.List<api.DimensionValue> buildUnnamed178() => [
  buildDimensionValue(),
  buildDimensionValue(),
];

void checkUnnamed178(core.List<api.DimensionValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimensionValue(o[0]);
  checkDimensionValue(o[1]);
}
...
api.ReportReachCriteria buildReportReachCriteria() {
  ...
  if (buildCounterReportReachCriteria < 3) {
    ...
    o.customRichMediaEvents = buildCustomRichMediaEvents();
    o.dateRange = buildDateRange();
    o.dimensionFilters = buildUnnamed178();
    o.dimensions = buildUnnamed179();
    o.metricNames = buildUnnamed180();
    o.reachByFrequencyMetricNames = buildUnnamed181();
  }
  buildCounterReportReachCriteria--;
  return o;
}
...
void checkReportReachCriteria(api.ReportReachCriteria o) {
  ...
  if (buildCounterReportReachCriteria < 3) {
    ...
    checkCustomRichMediaEvents(o.customRichMediaEvents!);
    checkDateRange(o.dateRange!);
    checkUnnamed178(o.dimensionFilters!);
    checkUnnamed179(o.dimensions!);
    checkUnnamed180(o.metricNames!);
    checkUnnamed181(o.reachByFrequencyMetricNames!);
  }
  buildCounterReportReachCriteria--;
}
...
api.ReportSchedule buildReportSchedule() {
  ...
  if (buildCounterReportSchedule < 3) {
    ...
    o.repeats = 'foo';
    o.repeatsOnWeekDays = buildUnnamed182();
...
void checkReportSchedule(api.ReportSchedule o) {
  ...
  if (buildCounterReportSchedule < 3) {
    ...
    checkUnnamed182(o.repeatsOnWeekDays!);
...
core.List<api.Dimension> buildUnnamed183() => [
  buildDimension(),
  buildDimension(),
];

void checkUnnamed183(core.List<api.Dimension> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimension(o[0]);
  checkDimension(o[1]);
}

core.List<api.Dimension> buildUnnamed184() => [
  buildDimension(),
  buildDimension(),
];

void checkUnnamed184(core.List<api.Dimension> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDimension(o[0]);
  checkDimension(o[1]);
}

core.List<api.Metric> buildUnnamed185() => [buildMetric(), buildMetric()];

void checkUnnamed185(core.List<api.Metric> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetric(o[0]);
  checkMetric(o[1]);
}

core.List<api.Metric> buildUnnamed186() => [buildMetric(), buildMetric()];

void checkUnnamed186(core.List<api.Metric> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetric(o[0]);
  checkMetric(o[1]);
}
...
api.ReportCompatibleFields buildReportCompatibleFields() {
  ...
  if (buildCounterReportCompatibleFields < 3) {
    o.dimensionFilters = buildUnnamed183();
    o.dimensions = buildUnnamed184();
    o.kind = 'foo';
    o.metrics = buildUnnamed185();
    o.pivotedActivityMetrics = buildUnnamed186();
  }
  buildCounterReportCompatibleFields--;
  return o;
}
...
void checkReportCompatibleFields(api.ReportCompatibleFields o) {
  buildCounterReportCompatibleFields++;
  if (buildCounterReportCompatibleFields < 3) {
    checkUnnamed183(o.dimensionFilters!);
    checkUnnamed184(o.dimensions!);
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed185(o.metrics!);
    checkUnnamed186(o.pivotedActivityMetrics!);
  }
  buildCounterReportCompatibleFields--;
}

core.List<api.Report> buildUnnamed187() => [buildReport(), buildReport()];

void checkUnnamed187(core.List<api.Report> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReport(o[0]);
  checkReport(o[1]);
}
...
core.int buildCounterRequestValue = 0;
api.RequestValue buildRequestValue() {
  final o = api.RequestValue();
  buildCounterRequestValue++;
  if (buildCounterRequestValue < 3) {
    o.excludeFromUserAttributeIds = buildUnnamed188();
    o.key = 'foo';
    o.userAttributeIds = buildUnnamed189();
  }
  buildCounterRequestValue--;
  return o;
}
...
void checkRequestValue(api.RequestValue o) {
  buildCounterRequestValue++;
  if (buildCounterRequestValue < 3) {
    checkUnnamed188(o.excludeFromUserAttributeIds!);
    unittest.expect(o.key!, unittest.equals('foo'));
    checkUnnamed189(o.userAttributeIds!);
  }
  buildCounterRequestValue--;
}
...
core.List<api.FieldFilter> buildUnnamed190() => [
  buildFieldFilter(),
  buildFieldFilter(),
];

void checkUnnamed190(core.List<api.FieldFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFieldFilter(o[0]);
  checkFieldFilter(o[1]);
}

core.int buildCounterRuleBlock = 0;
api.RuleBlock buildRuleBlock() {
  final o = api.RuleBlock();
  buildCounterRuleBlock++;
  if (buildCounterRuleBlock < 3) {
    o.fieldFilter = buildUnnamed190();
  }
  buildCounterRuleBlock--;
  return o;
}
...
void checkRuleBlock(api.RuleBlock o) {
  buildCounterRuleBlock++;
  if (buildCounterRuleBlock < 3) {
    checkUnnamed190(o.fieldFilter!);
  }
  buildCounterRuleBlock--;
}

core.List<api.SiteContact> buildUnnamed191() => [
  buildSiteContact(),
  buildSiteContact(),
];

void checkUnnamed191(core.List<api.SiteContact> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Site buildSite() {
  ...
  if (buildCounterSite < 3) {
    ...
    o.kind = 'foo';
    o.name = 'foo';
    o.siteContacts = buildUnnamed191();
...
void checkSite(api.Site o) {
  ...
  if (buildCounterSite < 3) {
    ...
    unittest.expect(o.kind!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed191(o.siteContacts!);
...
core.List<api.Size> buildUnnamed192() => [buildSize(), buildSize()];

void checkUnnamed192(core.List<api.Size> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSize(o[0]);
  checkSize(o[1]);
}
...
api.SiteCompanionSetting buildSiteCompanionSetting() {
  ...
  if (buildCounterSiteCompanionSetting < 3) {
    o.companionsDisabled = true;
    o.enabledSizes = buildUnnamed192();
    o.imageOnly = true;
    o.kind = 'foo';
  }
  buildCounterSiteCompanionSetting--;
...
void checkSiteCompanionSetting(api.SiteCompanionSetting o) {
  ...
  if (buildCounterSiteCompanionSetting < 3) {
    unittest.expect(o.companionsDisabled!, unittest.isTrue);
    checkUnnamed192(o.enabledSizes!);
    unittest.expect(o.imageOnly!, unittest.isTrue);
    unittest.expect(o.kind!, unittest.equals('foo'));
  }
  buildCounterSiteCompanionSetting--;
...
core.List<core.int> buildUnnamed193() => [42, 42];

void checkUnnamed193(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42));
  unittest.expect(o[1], unittest.equals(42));
}
...
api.SiteTranscodeSetting buildSiteTranscodeSetting() {
  ...
  if (buildCounterSiteTranscodeSetting < 3) {
    o.enabledVideoFormats = buildUnnamed193();
    o.kind = 'foo';
  }
  buildCounterSiteTranscodeSetting--;
  return o;
...
void checkSiteTranscodeSetting(api.SiteTranscodeSetting o) {
  buildCounterSiteTranscodeSetting++;
  if (buildCounterSiteTranscodeSetting < 3) {
    checkUnnamed193(o.enabledVideoFormats!);
    unittest.expect(o.kind!, unittest.equals('foo'));
  }
  buildCounterSiteTranscodeSetting--;
}
...
core.List<api.Site> buildUnnamed194() => [buildSite(), buildSite()];

void checkUnnamed194(core.List<api.Site> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSite(o[0]);
  checkSite(o[1]);
}
...
core.List<api.Size> buildUnnamed195() => [buildSize(), buildSize()];

void checkUnnamed195(core.List<api.Size> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSize(o[0]);
  checkSize(o[1]);
}
...
api.Subaccount buildSubaccount() {
  ...
  if (buildCounterSubaccount < 3) {
    o.accountId = 'foo';
    o.availablePermissionIds = buildUnnamed196();
    o.id = 'foo';
    o.kind = 'foo';
    o.name = 'foo';
  }
...
void checkSubaccount(api.Subaccount o) {
  ...
  if (buildCounterSubaccount < 3) {
    unittest.expect(o.accountId!, unittest.equals('foo'));
    checkUnnamed196(o.availablePermissionIds!);
    unittest.expect(o.id!, unittest.equals('foo'));
    unittest.expect(o.kind!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
  }
...
core.List<api.Subaccount> buildUnnamed197() => [
  buildSubaccount(),
  buildSubaccount(),
];

void checkUnnamed197(core.List<api.Subaccount> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSubaccount(o[0]);
  checkSubaccount(o[1]);
}
...
core.List<api.TargetableRemarketingList> buildUnnamed198() => [
  buildTargetableRemarketingList(),
  buildTargetableRemarketingList(),
];

void checkUnnamed198(core.List<api.TargetableRemarketingList> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildTargetableRemarketingListsListResponse() {
  ...
  if (buildCounterTargetableRemarketingListsListResponse < 3) {
    o.kind = 'foo';
    o.nextPageToken = 'foo';
    o.targetableRemarketingLists = buildUnnamed198();
  }
  buildCounterTargetableRemarketingListsListResponse--;
  return o;
}
...
void checkTargetableRemarketingListsListResponse(
  ...
  if (buildCounterTargetableRemarketingListsListResponse < 3) {
    unittest.expect(o.kind!, unittest.equals('foo'));
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed198(o.targetableRemarketingLists!);
  }
  buildCounterTargetableRemarketingListsListResponse--;
}
...
core.List<api.TargetingTemplate> buildUnnamed199() => [
  buildTargetingTemplate(),
  buildTargetingTemplate(),
];

void checkUnnamed199(core.List<api.TargetingTemplate> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TargetingTemplatesListResponse buildTargetingTemplatesListResponse() {
  ...
  if (buildCounterTargetingTemplatesListResponse < 3) {
    o.kind = 'foo';
    o.nextPageToken = 'foo';
    o.targetingTemplates = buildUnnamed199();
  }
  buildCounterTargetingTemplatesListResponse--;
  return o;
}
...
void checkTargetingTemplatesListResponse(api.TargetingTemplatesListResponse o) {
  ...
  if (buildCounterTargetingTemplatesListResponse < 3) {
    unittest.expect(o.kind!, unittest.equals('foo'));
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed199(o.targetingTemplates!);
  }
  buildCounterTargetingTemplatesListResponse--;
}

core.List<api.Browser> buildUnnamed200() => [buildBrowser(), buildBrowser()];

void checkUnnamed200(core.List<api.Browser> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBrowser(o[0]);
  checkBrowser(o[1]);
}

core.List<api.ConnectionType> buildUnnamed201() => [
  buildConnectionType(),
  buildConnectionType(),
];

void checkUnnamed201(core.List<api.ConnectionType> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkConnectionType(o[0]);
  checkConnectionType(o[1]);
}

core.List<api.MobileCarrier> buildUnnamed202() => [
  buildMobileCarrier(),
  buildMobileCarrier(),
];

void checkUnnamed202(core.List<api.MobileCarrier> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMobileCarrier(o[0]);
  checkMobileCarrier(o[1]);
}

core.List<api.OperatingSystemVersion> buildUnnamed203() => [
  buildOperatingSystemVersion(),
  buildOperatingSystemVersion(),
];

void checkUnnamed203(core.List<api.OperatingSystemVersion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperatingSystemVersion(o[0]);
  checkOperatingSystemVersion(o[1]);
}

core.List<api.OperatingSystem> buildUnnamed204() => [
  buildOperatingSystem(),
  buildOperatingSystem(),
];

void checkUnnamed204(core.List<api.OperatingSystem> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperatingSystem(o[0]);
  checkOperatingSystem(o[1]);
}

core.List<api.PlatformType> buildUnnamed205() => [
  buildPlatformType(),
  buildPlatformType(),
];

void checkUnnamed205(core.List<api.PlatformType> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPlatformType(o[0]);
  checkPlatformType(o[1]);
}
...
api.TechnologyTargeting buildTechnologyTargeting() {
  ...
  if (buildCounterTechnologyTargeting < 3) {
    o.browsers = buildUnnamed200();
    o.connectionTypes = buildUnnamed201();
    o.mobileCarriers = buildUnnamed202();
    o.operatingSystemVersions = buildUnnamed203();
    o.operatingSystems = buildUnnamed204();
    o.platformTypes = buildUnnamed205();
  }
  buildCounterTechnologyTargeting--;
  return o;
}
...
void checkTechnologyTargeting(api.TechnologyTargeting o) {
  buildCounterTechnologyTargeting++;
  if (buildCounterTechnologyTargeting < 3) {
    checkUnnamed200(o.browsers!);
    checkUnnamed201(o.connectionTypes!);
    checkUnnamed202(o.mobileCarriers!);
    checkUnnamed203(o.operatingSystemVersions!);
    checkUnnamed204(o.operatingSystems!);
    checkUnnamed205(o.platformTypes!);
  }
  buildCounterTechnologyTargeting--;
}
...
core.List<core.int> buildUnnamed206() => [42, 42];

void checkUnnamed206(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42));
  unittest.expect(o[1], unittest.equals(42));
}
...
api.TranscodeSetting buildTranscodeSetting() {
  ...
  if (buildCounterTranscodeSetting < 3) {
    o.enabledVideoFormats = buildUnnamed206();
    o.kind = 'foo';
  }
  buildCounterTranscodeSetting--;
  return o;
...
void checkTranscodeSetting(api.TranscodeSetting o) {
  buildCounterTranscodeSetting++;
  if (buildCounterTranscodeSetting < 3) {
    checkUnnamed206(o.enabledVideoFormats!);
    unittest.expect(o.kind!, unittest.equals('foo'));
  }
  buildCounterTranscodeSetting--;
}

core.List<api.TvCampaignTimepoint> buildUnnamed207() => [
  buildTvCampaignTimepoint(),
  buildTvCampaignTimepoint(),
];

void checkUnnamed207(core.List<api.TvCampaignTimepoint> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkTvCampaignDetail(api.TvCampaignDetail o) {
  ...
  if (buildCounterTvCampaignDetail < 3) {
    unittest.expect(o.id!, unittest.equals('foo'));
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed207(o.timepoints!);
  }
  buildCounterTvCampaignDetail--;
}

core.List<api.TvCampaignSummary> buildUnnamed208() => [
  buildTvCampaignSummary(),
  buildTvCampaignSummary(),
];

void checkUnnamed208(core.List<api.TvCampaignSummary> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TvCampaignSummariesListResponse buildTvCampaignSummariesListResponse() {
  ...
  if (buildCounterTvCampaignSummariesListResponse < 3) {
    o.kind = 'foo';
    o.tvCampaignSummaries = buildUnnamed208();
  }
  buildCounterTvCampaignSummariesListResponse--;
  return o;
}
...
void checkTvCampaignSummariesListResponse(
  ...
  if (buildCounterTvCampaignSummariesListResponse < 3) {
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed208(o.tvCampaignSummaries!);
  }
  buildCounterTvCampaignSummariesListResponse--;
}
...
void checkTvCampaignSummary(api.TvCampaignSummary o) {
  ...
  if (buildCounterTvCampaignSummary < 3) {
    unittest.expect(o.endDate!, unittest.equals('foo'));
    unittest.expect(o.grp!, unittest.equals('foo'));
    unittest.expect(o.id!, unittest.equals('foo'));
    unittest.expect(o.impressions!, unittest.equals('foo'));
    unittest.expect(o.kind!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.spend!, unittest.equals(42.0));
    unittest.expect(o.startDate!, unittest.equals('foo'));
    unittest.expect(o.type!, unittest.equals('foo'));
  }
  buildCounterTvCampaignSummary--;
...
void checkTvCampaignTimepoint(api.TvCampaignTimepoint o) {
  buildCounterTvCampaignTimepoint++;
  if (buildCounterTvCampaignTimepoint < 3) {
    unittest.expect(o.dateWindow!, unittest.equals('foo'));
    unittest.expect(o.spend!, unittest.equals(42.0));
    unittest.expect(o.startDate!, unittest.equals('foo'));
  }
  buildCounterTvCampaignTimepoint--;
...
void checkUserIdentifier(api.UserIdentifier o) {
  ...
  if (buildCounterUserIdentifier < 3) {
    ...
    unittest.expect(o.hashedEmail!, unittest.equals('foo'));
    unittest.expect(o.hashedPhoneNumber!, unittest.equals('foo'));
  }
  buildCounterUserIdentifier--;
}
...
core.List<api.UserProfile> buildUnnamed209() => [
  buildUserProfile(),
  buildUserProfile(),
];

void checkUnnamed209(core.List<api.UserProfile> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.UserRolePermission> buildUnnamed210() => [
  buildUserRolePermission(),
  buildUserRolePermission(),
];

void checkUnnamed210(core.List<api.UserRolePermission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.UserRolePermissionGroup> buildUnnamed211() => [
  buildUserRolePermissionGroup(),
  buildUserRolePermissionGroup(),
];

void checkUnnamed211(core.List<api.UserRolePermissionGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUserRolePermissionGroupsListResponse() {
  ...
  if (buildCounterUserRolePermissionGroupsListResponse < 3) {
    o.kind = 'foo';
    o.userRolePermissionGroups = buildUnnamed211();
  }
  buildCounterUserRolePermissionGroupsListResponse--;
  return o;
}
...
void checkUserRolePermissionGroupsListResponse(
  ...
  if (buildCounterUserRolePermissionGroupsListResponse < 3) {
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed211(o.userRolePermissionGroups!);
  }
  buildCounterUserRolePermissionGroupsListResponse--;
}

core.List<api.UserRolePermission> buildUnnamed212() => [
  buildUserRolePermission(),
  buildUserRolePermission(),
];

void checkUnnamed212(core.List<api.UserRolePermission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUserRolePermission(o[0]);
  checkUserRolePermission(o[1]);
}
...
api.UserRolePermissionsListResponse buildUserRolePermissionsListResponse() {
  ...
  if (buildCounterUserRolePermissionsListResponse < 3) {
    o.kind = 'foo';
    o.userRolePermissions = buildUnnamed212();
  }
  buildCounterUserRolePermissionsListResponse--;
  return o;
}
...
void checkUserRolePermissionsListResponse(
  ...
  if (buildCounterUserRolePermissionsListResponse < 3) {
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed212(o.userRolePermissions!);
  }
  buildCounterUserRolePermissionsListResponse--;
}

core.List<api.UserRole> buildUnnamed213() => [buildUserRole(), buildUserRole()];

void checkUnnamed213(core.List<api.UserRole> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUserRole(o[0]);
  checkUserRole(o[1]);
}
...
core.List<api.VideoFormat> buildUnnamed214() => [
  buildVideoFormat(),
  buildVideoFormat(),
];

void checkUnnamed214(core.List<api.VideoFormat> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.VideoFormatsListResponse buildVideoFormatsListResponse() {
  ...
  if (buildCounterVideoFormatsListResponse < 3) {
    o.kind = 'foo';
    o.videoFormats = buildUnnamed214();
  }
  buildCounterVideoFormatsListResponse--;
  return o;
}
...
void checkVideoFormatsListResponse(api.VideoFormatsListResponse o) {
  ...
  if (buildCounterVideoFormatsListResponse < 3) {
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkUnnamed214(o.videoFormats!);
  }
  buildCounterVideoFormatsListResponse--;
}
...
api.YoutubeSettings buildYoutubeSettings() {
  ...
  if (buildCounterYoutubeSettings < 3) {
    o.businessLogoCreativeIds = buildUnnamed215();
    o.businessName = 'foo';
    o.callToActions = buildUnnamed216();
    o.descriptions = buildUnnamed217();
    o.headlines = buildUnnamed218();
    o.longHeadlines = buildUnnamed219();
  }
  buildCounterYoutubeSettings--;
  return o;
}
...
void checkYoutubeSettings(api.YoutubeSettings o) {
  buildCounterYoutubeSettings++;
  if (buildCounterYoutubeSettings < 3) {
    checkUnnamed215(o.businessLogoCreativeIds!);
    unittest.expect(o.businessName!, unittest.equals('foo'));
    checkUnnamed216(o.callToActions!);
    checkUnnamed217(o.descriptions!);
    checkUnnamed218(o.headlines!);
    checkUnnamed219(o.longHeadlines!);
  }
  buildCounterYoutubeSettings--;
}
...
core.List<core.String> buildUnnamed233() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed236() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed240() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed241() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed242() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed255() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed256() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed259() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed260() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed267() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed270() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed271() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed274() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed276() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed277() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed278() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed279() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed280() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed281() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed282() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed283() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed284() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed285() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed286() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed287() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed288() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed289() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed290() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed291() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed292() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed293() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed294() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed295() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed296() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed297() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed298() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed299() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed300() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed301() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed302() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed303() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed304() => ['foo', 'foo'];
...
core.List<core.String> buildUnnamed305() => ['foo', 'foo'];
...
void main() {
  ...
  unittest.group('obj-schema-ContentSource', () {
    unittest.test('to-json--from-json', () async {
      final o = buildContentSource();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ContentSource.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkContentSource(od);
    });
  });

  unittest.group('obj-schema-ContentSourceMetaData', () {
    unittest.test('to-json--from-json', () async {
      final o = buildContentSourceMetaData();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ContentSourceMetaData.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkContentSourceMetaData(od);
    });
  });
  ...
  unittest.group('obj-schema-Conversion', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Conversion.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkConversion(od);
    });
  ...
  unittest.group('obj-schema-CustomRule', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCustomRule();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CustomRule.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCustomRule(od);
    });
  ...
  unittest.group('obj-schema-CustomValueField', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCustomValueField();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CustomValueField.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCustomValueField(od);
    });
  });
  ...
  unittest.group('obj-schema-DeepLink', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.DeepLink.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkDeepLink(od);
    });
  ...
  unittest.group('obj-schema-DependentFieldValue', () {
    unittest.test('to-json--from-json', () async {
      final o = buildDependentFieldValue();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.DependentFieldValue.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkDependentFieldValue(od);
    });
  });
  ...
  unittest.group('obj-schema-DynamicFeed', () {
    unittest.test('to-json--from-json', () async {
      final o = buildDynamicFeed();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.DynamicFeed.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkDynamicFeed(od);
    });
  ...
  unittest.group('obj-schema-DynamicFeedsInsertRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildDynamicFeedsInsertRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.DynamicFeedsInsertRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkDynamicFeedsInsertRequest(od);
    });
  });

  unittest.group('obj-schema-DynamicProfile', () {
    unittest.test('to-json--from-json', () async {
      final o = buildDynamicProfile();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.DynamicProfile.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkDynamicProfile(od);
    });
  });

  unittest.group('obj-schema-DynamicProfileFeedSettings', () {
    unittest.test('to-json--from-json', () async {
      final o = buildDynamicProfileFeedSettings();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.DynamicProfileFeedSettings.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkDynamicProfileFeedSettings(od);
    });
  });

  unittest.group('obj-schema-DynamicProfileVersion', () {
    unittest.test('to-json--from-json', () async {
      final o = buildDynamicProfileVersion();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.DynamicProfileVersion.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkDynamicProfileVersion(od);
    });
  });

  unittest.group('obj-schema-DynamicRules', () {
    unittest.test('to-json--from-json', () async {
      final o = buildDynamicRules();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.DynamicRules.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkDynamicRules(od);
    });
  });
  ...
  unittest.group('obj-schema-Element', () {
    unittest.test('to-json--from-json', () async {
      final o = buildElement();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Element.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkElement(od);
    });
  ...
  unittest.group('obj-schema-EventTag', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.EventTag.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkEventTag(od);
    });
  ...
  unittest.group('obj-schema-FeedField', () {
    unittest.test('to-json--from-json', () async {
      final o = buildFeedField();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.FeedField.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkFeedField(od);
    });
  ...
  unittest.group('obj-schema-FeedIngestionStatus', () {
    unittest.test('to-json--from-json', () async {
      final o = buildFeedIngestionStatus();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.FeedIngestionStatus.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkFeedIngestionStatus(od);
    });
  });

  unittest.group('obj-schema-FeedSchedule', () {
    unittest.test('to-json--from-json', () async {
      final o = buildFeedSchedule();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.FeedSchedule.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkFeedSchedule(od);
    });
  });

  unittest.group('obj-schema-FieldError', () {
    unittest.test('to-json--from-json', () async {
      final o = buildFieldError();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.FieldError.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkFieldError(od);
    });
  ...
  unittest.group('obj-schema-FileUrls', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.FileUrls.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkFileUrls(od);
    });
  ...
  unittest.group('obj-schema-FsCommand', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.FsCommand.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkFsCommand(od);
    });
  ...
  unittest.group('obj-schema-IngestionErrorRecord', () {
    unittest.test('to-json--from-json', () async {
      final o = buildIngestionErrorRecord();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.IngestionErrorRecord.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkIngestionErrorRecord(od);
    });
  });

  unittest.group('obj-schema-IngestionStatus', () {
    unittest.test('to-json--from-json', () async {
      final o = buildIngestionStatus();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.IngestionStatus.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkIngestionStatus(od);
    });
  });
  ...
  unittest.group('obj-schema-Language', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Language.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkLanguage(od);
    });
  ...
  unittest.group('obj-schema-Placement', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Placement.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPlacement(od);
    });
  ...
  unittest.group('obj-schema-PostalCode', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.PostalCode.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPostalCode(od);
    });
  ...
  unittest.group('obj-schema-ProximityFilter', () {
    unittest.test('to-json--from-json', () async {
      final o = buildProximityFilter();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ProximityFilter.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkProximityFilter(od);
    });
  });
  ...
  unittest.group('obj-schema-Recipient', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Recipient.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkRecipient(od);
    });
  ...
  unittest.group('obj-schema-RemarketingValueAttribute', () {
    unittest.test('to-json--from-json', () async {
      final o = buildRemarketingValueAttribute();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.RemarketingValueAttribute.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkRemarketingValueAttribute(od);
    });
  });
  ...
  unittest.group(
    'obj-schema-ReportPathToConversionCriteriaReportProperties',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group('obj-schema-ReportList', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ReportList.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkReportList(od);
    });
  ...
  unittest.group('obj-schema-RequestValue', () {
    unittest.test('to-json--from-json', () async {
      final o = buildRequestValue();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.RequestValue.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkRequestValue(od);
    });
  });
  ...
  unittest.group('obj-schema-RuleBlock', () {
    unittest.test('to-json--from-json', () async {
      final o = buildRuleBlock();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.RuleBlock.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkRuleBlock(od);
    });
  ...
  unittest.group('obj-schema-Subaccount', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Subaccount.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkSubaccount(od);
    });
  ...
  unittest.group('obj-schema-TagSetting', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.TagSetting.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkTagSetting(od);
    });
  ...
  unittest.group('obj-schema-UserRole', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.UserRole.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkUserRole(od);
    });
  ...
  unittest.group('obj-schema-YoutubeSettings', () {
    unittest.test('to-json--from-json', () async {
      final o = buildYoutubeSettings();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.YoutubeSettings.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkYoutubeSettings(od);
    });
  });
  ...
  unittest.group('resource-AdsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final arg_audienceSegmentIds = buildUnnamed222();
      final arg_campaignIds = buildUnnamed223();
      final arg_compatibility = 'foo';
      final arg_creativeIds = buildUnnamed224();
      final arg_creativeOptimizationConfigurationIds = buildUnnamed225();
      final arg_dynamicClickTracker = true;
      final arg_ids = buildUnnamed226();
      final arg_landingPageIds = buildUnnamed227();
      final arg_maxResults = 42;
      final arg_overriddenEventTagId = 'foo';
      final arg_pageToken = 'foo';
      final arg_placementIds = buildUnnamed228();
      final arg_remarketingListIds = buildUnnamed229();
      final arg_searchString = 'foo';
      final arg_sizeIds = buildUnnamed230();
      final arg_sortField = 'foo';
      final arg_sortOrder = 'foo';
      final arg_sslCompliant = true;
      final arg_sslRequired = true;
      final arg_type = buildUnnamed231();
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final path = req.url.path;
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildAdvertiserInvoicesListResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
  ...
  unittest.group('resource-AdvertiserLandingPagesResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.DfareportingApi(mock).advertiserLandingPages;
      final arg_profileId = 'foo';
      final arg_advertiserIds = buildUnnamed233();
      final arg_archived = true;
  ...
  unittest.group('resource-AdvertisersResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final arg_floodlightConfigurationIds = buildUnnamed237();
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildBillingAssignmentsListResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
  ...
  unittest.group('resource-BillingProfilesResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final arg_sortField = 'foo';
      final arg_sortOrder = 'foo';
      final arg_status = buildUnnamed240();
      final arg_subaccountIds = buildUnnamed241();
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final path = req.url.path;
  ...
  unittest.group('resource-CampaignsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final arg_advertiserIds = buildUnnamed243();
      final arg_archived = true;
      final arg_atLeastOneOptimizationActivity = true;
      final arg_excludedIds = buildUnnamed244();
  ...
  unittest.group('resource-ChangeLogsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final arg_objectIds = buildUnnamed247();
      final arg_objectType = 'foo';
      final arg_pageToken = 'foo';
      final arg_searchString = 'foo';
      final arg_userProfileIds = buildUnnamed248();
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final path = req.url.path;
  ...
  unittest.group('resource-CitiesResource', () {
    unittest.test('method--list', () async {
      ...
      final arg_profileId = 'foo';
      final arg_countryDartIds = buildUnnamed249();
      final arg_dartIds = buildUnnamed250();
      final arg_namePrefix = 'foo';
      final arg_regionDartIds = buildUnnamed251();
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final path = req.url.path;
  ...
  unittest.group('resource-ConversionsResource', () {
    unittest.test('method--batchinsert', () async {
      ...
      final response = await res.batchinsert(
        arg_request,
        arg_profileId,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-CreativeGroupsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.DfareportingApi(mock).creativeGroups;
      final arg_profileId = 'foo';
      final arg_advertiserIds = buildUnnamed256();
  ...
  unittest.group('resource-CreativesResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final arg_archived = true;
      final arg_campaignId = 'foo';
      final arg_companionCreativeIds = buildUnnamed258();
      final arg_creativeFieldIds = buildUnnamed259();
      final arg_ids = buildUnnamed260();
      final arg_maxResults = 42;
      final arg_pageToken = 'foo';
      final arg_renderingIds = buildUnnamed261();
      final arg_searchString = 'foo';
      final arg_sizeIds = buildUnnamed262();
      final arg_sortField = 'foo';
      final arg_sortOrder = 'foo';
      final arg_studioCreativeId = 'foo';
      final arg_types = buildUnnamed263();
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final path = req.url.path;
  ...
  unittest.group('resource-DynamicFeedsResource', () {
    unittest.test('method--get', () async {
      final mock = HttpServerMock();
      final res = api.DfareportingApi(mock).dynamicFeeds;
      final arg_dynamicFeedId = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final path = req.url.path;
          ...
          unittest.expect(
            ...
            unittest.equals('studio/dynamicFeeds/'),
          );
          pathOffset += 20;
          // NOTE: We cannot test reserved expansions due to the inability to reverse the operation;
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildDynamicFeed());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.get(arg_dynamicFeedId, $fields: arg_$fields);
      checkDynamicFeed(response as api.DynamicFeed);
    });

    unittest.test('method--insert', () async {
      final mock = HttpServerMock();
      final res = api.DfareportingApi(mock).dynamicFeeds;
      final arg_request = buildDynamicFeedsInsertRequest();
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.DynamicFeedsInsertRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkDynamicFeedsInsertRequest(obj);
  ...
  unittest.group('resource-DynamicProfilesResource', () {
    unittest.test('method--get', () async {
      final mock = HttpServerMock();
      final res = api.DfareportingApi(mock).dynamicProfiles;
      final arg_dynamicProfileId = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final path = req.url.path;
          ...
          unittest.expect(
            ...
            unittest.equals('studio/dynamicProfiles/'),
          );
          pathOffset += 23;
          // NOTE: We cannot test reserved expansions due to the inability to reverse the operation;
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildDynamicProfile());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.get(
        arg_dynamicProfileId,
        $fields: arg_$fields,
      );
      checkDynamicProfile(response as api.DynamicProfile);
    });

    unittest.test('method--insert', () async {
      final mock = HttpServerMock();
      final res = api.DfareportingApi(mock).dynamicProfiles;
      final arg_request = buildDynamicProfile();
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.DynamicProfile.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkDynamicProfile(obj);
  ...
  unittest.group('resource-DynamicTargetingKeysResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final arg_profileId = 'foo';
      final arg_advertiserId = 'foo';
      final arg_names = buildUnnamed265();
      final arg_objectId = 'foo';
      final arg_objectType = 'foo';
      final arg_$fields = 'foo';
      mock.register(
  ...
  unittest.group('resource-EventTagsResource', () {
    ...
    unittest.test('method--insert', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.EventTag.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkEventTag(obj);
    ...
    unittest.test('method--list', () async {
      ...
      final arg_eventTagTypes = buildUnnamed266();
  ...
  unittest.group('resource-FloodlightActivitiesResource', () {
    ...
    unittest.test('method--generatetag', () async {
      ...
      final response = await res.generatetag(
        arg_profileId,
    ...
    unittest.test('method--list', () async {
      ...
      final arg_profileId = 'foo';
      final arg_advertiserId = 'foo';
      final arg_floodlightActivityGroupIds = buildUnnamed268();
      ...
      final response = await res.list(
        ...
        floodlightActivityGroupTagString: arg_floodlightActivityGroupTagString,
  ...
  unittest.group('resource-MobileAppsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.DfareportingApi(mock).mobileApps;
      final arg_profileId = 'foo';
      final arg_directories = buildUnnamed272();
  ...
  unittest.group('resource-PlacementGroupsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.DfareportingApi(mock).placementGroups;
      final arg_profileId = 'foo';
      final arg_activeStatus = buildUnnamed274();
      final arg_advertiserIds = buildUnnamed275();
      final arg_campaignIds = buildUnnamed276();
      final arg_contentCategoryIds = buildUnnamed277();
      final arg_directorySiteIds = buildUnnamed278();
      ...
      final arg_placementStrategyIds = buildUnnamed280();
      final arg_pricingTypes = buildUnnamed281();
      final arg_searchString = 'foo';
      final arg_siteIds = buildUnnamed282();
      final arg_sortField = 'foo';
      final arg_sortOrder = 'foo';
      final arg_$fields = 'foo';
      mock.register(
  ...
  unittest.group('resource-PlacementsResource', () {
    unittest.test('method--generatetags', () async {
      ...
      final arg_profileId = 'foo';
      final arg_campaignId = 'foo';
      final arg_placementIds = buildUnnamed284();
      final arg_tagFormats = buildUnnamed285();
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final path = req.url.path;
      ...
      final response = await res.generatetags(
        arg_profileId,
        campaignId: arg_campaignId,
        placementIds: arg_placementIds,
    ...
    unittest.test('method--insert', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Placement.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkPlacement(obj);
    ...
    unittest.test('method--list', () async {
      ...
      final arg_sizeIds = buildUnnamed297();
      final arg_sortField = 'foo';
      final arg_sortOrder = 'foo';
      final arg_$fields = 'foo';
      mock.register(
  ...
  unittest.group('resource-SitesResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final arg_campaignIds = buildUnnamed298();
      final arg_directorySiteIds = buildUnnamed299();
      final arg_ids = buildUnnamed300();
      final arg_maxResults = 42;
      final arg_pageToken = 'foo';
      final arg_searchString = 'foo';
      final arg_sortField = 'foo';
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildTvCampaignSummariesListResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
  ...
  unittest.group('resource-UserRolesResource', () {
    ...
    unittest.test('method--insert', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.UserRole.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkUserRole(obj);
