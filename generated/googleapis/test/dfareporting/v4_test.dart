...
core.List<api.Country> buildUnnamed43() => [buildCountry(), buildCountry()];
...
core.List<api.Size> buildUnnamed45() => [buildSize(), buildSize()];
...
core.List<api.ClickTag> buildUnnamed47() => [buildClickTag(), buildClickTag()];
...
core.List<api.Size> buildUnnamed57() => [buildSize(), buildSize()];
...
core.List<api.ClickTag> buildUnnamed60() => [buildClickTag(), buildClickTag()];
...
core.List<api.Rule> buildUnnamed66() => [buildRule(), buildRule()];
...
core.List<core.int> buildUnnamed85() => [42, 42];
...
core.List<api.EventTag> buildUnnamed94() => [buildEventTag(), buildEventTag()];
...
core.List<api.File> buildUnnamed95() => [buildFile(), buildFile()];
...
core.List<api.City> buildUnnamed107() => [buildCity(), buildCity()];
...
core.List<api.Country> buildUnnamed108() => [buildCountry(), buildCountry()];
...
core.List<api.Metro> buildUnnamed109() => [buildMetro(), buildMetro()];
...
core.List<api.Region> buildUnnamed111() => [buildRegion(), buildRegion()];
...
core.List<api.AdSlot> buildUnnamed112() => [buildAdSlot(), buildAdSlot()];
...
core.List<api.DeepLink> buildUnnamed116() => [buildDeepLink(), buildDeepLink()];
...
core.List<api.Language> buildUnnamed117() => [buildLanguage(), buildLanguage()];
...
core.List<api.Language> buildUnnamed118() => [buildLanguage(), buildLanguage()];
...
core.List<api.Metro> buildUnnamed121() => [buildMetro(), buildMetro()];
...
core.List<api.Order> buildUnnamed131() => [buildOrder(), buildOrder()];
...
core.List<api.Metric> buildUnnamed134() => [buildMetric(), buildMetric()];
...
core.List<api.Size> buildUnnamed136() => [buildSize(), buildSize()];
...
core.List<api.TagData> buildUnnamed142() => [buildTagData(), buildTagData()];
...
core.List<api.Flight> buildUnnamed147() => [buildFlight(), buildFlight()];
...
core.List<api.Project> buildUnnamed149() => [buildProject(), buildProject()];
...
core.List<api.Metric> buildUnnamed152() => [buildMetric(), buildMetric()];
...
core.List<api.Region> buildUnnamed155() => [buildRegion(), buildRegion()];
...
core.List<api.Metric> buildUnnamed187() => [buildMetric(), buildMetric()];
...
core.List<api.Metric> buildUnnamed188() => [buildMetric(), buildMetric()];
...
core.List<api.Size> buildUnnamed191() => [buildSize(), buildSize()];
...
core.List<core.int> buildUnnamed192() => [42, 42];
...
core.List<api.Site> buildUnnamed193() => [buildSite(), buildSite()];
...
core.List<api.Browser> buildUnnamed199() => [buildBrowser(), buildBrowser()];
...
core.List<core.int> buildUnnamed205() => [42, 42];
...
core.List<api.UserRole> buildUnnamed212() => [buildUserRole(), buildUserRole()];
...
core.List<core.String> buildUnnamed306() => ['foo', 'foo'];
