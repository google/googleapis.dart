...
import 'package:googleapis/binaryauthorization/v1beta1.dart' as api;
...
core.List<api.Binding> buildUnnamed4() => [buildBinding(), buildBinding()];
...
core.List<api.Attestor> buildUnnamed5() => [buildAttestor(), buildAttestor()];
...
api.UserOwnedDrydockNote buildUserOwnedDrydockNote() {
  final o = api.UserOwnedDrydockNote();
...
void checkUserOwnedDrydockNote(api.UserOwnedDrydockNote o) {
  buildCounterUserOwnedDrydockNote++;
  if (buildCounterUserOwnedDrydockNote < 3) {
...
void main() {
  ...
  unittest.group('obj-schema-UserOwnedDrydockNote', () {
    unittest.test('to-json--from-json', () async {
      final o = buildUserOwnedDrydockNote();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.UserOwnedDrydockNote.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
