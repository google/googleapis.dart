...
core.List<api.Check> buildUnnamed6() => [
      buildCheck(),
      buildCheck(),
    ];
...
core.List<api.CheckSet> buildUnnamed9() => [
      buildCheckSet(),
      buildCheckSet(),
    ];
...
core.List<api.Attestor> buildUnnamed12() => [
      buildAttestor(),
      buildAttestor(),
    ];
...
void main() {
  ...
  unittest.group('obj-schema-PodResult', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od =
          api.PodResult.fromJson(oJson as core.Map<core.String, core.dynamic>);
      checkPodResult(od);
    });
  });
  ...
  unittest.group('resource-ProjectsPlatformsGkePoliciesResource', () {
    unittest.test('method--evaluate', () async {
      ...
      final response =
          await res.evaluate(arg_request, arg_name, $fields: arg_$fields);
