...
core.List<api.Catalog> buildUnnamed2() => [buildCatalog(), buildCatalog()];
...
core.List<api.Database> buildUnnamed3() => [buildDatabase(), buildDatabase()];
...
core.List<api.Table> buildUnnamed4() => [buildTable(), buildTable()];
