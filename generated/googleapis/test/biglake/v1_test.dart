...
core.List<api.Catalog> buildUnnamed5() => [buildCatalog(), buildCatalog()];

void checkUnnamed5(core.List<api.Catalog> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCatalog(o[0]);
  checkCatalog(o[1]);
}
...
void checkListCatalogsResponse(api.ListCatalogsResponse o) {
  buildCounterListCatalogsResponse++;
  if (buildCounterListCatalogsResponse < 3) {
    checkUnnamed5(o.catalogs!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListCatalogsResponse--;
}

core.List<api.Database> buildUnnamed6() => [buildDatabase(), buildDatabase()];
...
core.List<api.Table> buildUnnamed7() => [buildTable(), buildTable()];
...
void checkSerDeInfo(api.SerDeInfo o) {
  buildCounterSerDeInfo++;
  if (buildCounterSerDeInfo < 3) {
    unittest.expect(o.serializationLib!, unittest.equals('foo'));
  }
  buildCounterSerDeInfo--;
}
...
void main() {
  ...
  unittest.group('resource-ProjectsCatalogsResource', () {
    unittest.test('method--getIamPolicy', () async {
      final mock = HttpServerMock();
      final res = api.BigLakeServiceApi(mock).projects.catalogs;
  ...
  unittest.group('resource-ProjectsCatalogsNamespacesResource', () {
    unittest.test('method--getIamPolicy', () async {
      final mock = HttpServerMock();
      final res = api.BigLakeServiceApi(mock).projects.catalogs.namespaces;
      final arg_resource = 'foo';
      final arg_options_requestedPolicyVersion = 42;
      final arg_$fields = 'foo';
      mock.register(
  ...
  unittest.group('resource-ProjectsCatalogsNamespacesTablesResource', () {
    unittest.test('method--getIamPolicy', () async {
      final mock = HttpServerMock();
  ...
  unittest.group('resource-ProjectsLocationsCatalogsResource', () {
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Catalog.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkCatalog(obj);
