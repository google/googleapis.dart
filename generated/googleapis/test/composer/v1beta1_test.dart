...
import 'package:googleapis/composer/v1beta1.dart' as api;
...
api.DataRetentionConfig buildDataRetentionConfig() {
  ...
  if (buildCounterDataRetentionConfig < 3) {
    o.airflowDatabaseRetentionDays = 42;
...
void checkDataRetentionConfig(api.DataRetentionConfig o) {
  buildCounterDataRetentionConfig++;
  if (buildCounterDataRetentionConfig < 3) {
    unittest.expect(o.airflowDatabaseRetentionDays!, unittest.equals(42));
...
void checkNodeConfig(api.NodeConfig o) {
  ...
  if (buildCounterNodeConfig < 3) {
    ...
    unittest.expect(o.machineType!, unittest.equals('foo'));
    unittest.expect(o.maxPodsPerNode!, unittest.equals(42));
...
core.List<api.Line> buildUnnamed14() => [buildLine(), buildLine()];
