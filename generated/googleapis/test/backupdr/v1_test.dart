...
core.List<api.Backup> buildUnnamed37() => [buildBackup(), buildBackup()];
...
core.List<api.Entry> buildUnnamed50() => [buildEntry(), buildEntry()];
...
core.List<api.Binding> buildUnnamed58() => [buildBinding(), buildBinding()];
