...
core.int buildCounterAlloyDBClusterBackupPlanAssociationProperties = 0;
api.AlloyDBClusterBackupPlanAssociationProperties
buildAlloyDBClusterBackupPlanAssociationProperties() {
  final o = api.AlloyDBClusterBackupPlanAssociationProperties();
  buildCounterAlloyDBClusterBackupPlanAssociationProperties++;
  if (buildCounterAlloyDBClusterBackupPlanAssociationProperties < 3) {
    o.clusterUid = 'foo';
  }
  buildCounterAlloyDBClusterBackupPlanAssociationProperties--;
  return o;
...
void checkAlloyDBClusterBackupPlanAssociationProperties(
  api.AlloyDBClusterBackupPlanAssociationProperties o,
) {
  buildCounterAlloyDBClusterBackupPlanAssociationProperties++;
  if (buildCounterAlloyDBClusterBackupPlanAssociationProperties < 3) {
...
core.List<api.AlloyDbPitrWindow> buildUnnamed1() => [
  buildAlloyDbPitrWindow(),
  buildAlloyDbPitrWindow(),
];

void checkUnnamed1(core.List<api.AlloyDbPitrWindow> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAlloyDbPitrWindow(o[0]);
  checkAlloyDbPitrWindow(o[1]);
}

core.int buildCounterAlloyDBClusterDataSourceProperties = 0;
api.AlloyDBClusterDataSourceProperties
buildAlloyDBClusterDataSourceProperties() {
  final o = api.AlloyDBClusterDataSourceProperties();
  buildCounterAlloyDBClusterDataSourceProperties++;
  if (buildCounterAlloyDBClusterDataSourceProperties < 3) {
    o.clusterUid = 'foo';
    o.name = 'foo';
    o.pitrWindows = buildUnnamed1();
  }
  buildCounterAlloyDBClusterDataSourceProperties--;
  return o;
}

void checkAlloyDBClusterDataSourceProperties(
  api.AlloyDBClusterDataSourceProperties o,
) {
  buildCounterAlloyDBClusterDataSourceProperties++;
  if (buildCounterAlloyDBClusterDataSourceProperties < 3) {
    unittest.expect(o.clusterUid!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed1(o.pitrWindows!);
  }
  buildCounterAlloyDBClusterDataSourceProperties--;
}

core.int buildCounterAlloyDBClusterDataSourceReferenceProperties = 0;
api.AlloyDBClusterDataSourceReferenceProperties
buildAlloyDBClusterDataSourceReferenceProperties() {
  final o = api.AlloyDBClusterDataSourceReferenceProperties();
  buildCounterAlloyDBClusterDataSourceReferenceProperties++;
  if (buildCounterAlloyDBClusterDataSourceReferenceProperties < 3) {
    o.name = 'foo';
  }
  buildCounterAlloyDBClusterDataSourceReferenceProperties--;
  return o;
...
void checkAlloyDBClusterDataSourceReferenceProperties(
  api.AlloyDBClusterDataSourceReferenceProperties o,
) {
  buildCounterAlloyDBClusterDataSourceReferenceProperties++;
  if (buildCounterAlloyDBClusterDataSourceReferenceProperties < 3) {
    unittest.expect(o.name!, unittest.equals('foo'));
...
core.int buildCounterAlloyDbClusterBackupProperties = 0;
api.AlloyDbClusterBackupProperties buildAlloyDbClusterBackupProperties() {
  final o = api.AlloyDbClusterBackupProperties();
  buildCounterAlloyDbClusterBackupProperties++;
  if (buildCounterAlloyDbClusterBackupProperties < 3) {
    o.chainId = 'foo';
...
void checkAlloyDbClusterBackupProperties(api.AlloyDbClusterBackupProperties o) {
  buildCounterAlloyDbClusterBackupProperties++;
  if (buildCounterAlloyDbClusterBackupProperties < 3) {
    unittest.expect(o.chainId!, unittest.equals('foo'));
    unittest.expect(o.databaseVersion!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.storedBytes!, unittest.equals('foo'));
  }
  buildCounterAlloyDbClusterBackupProperties--;
}

core.int buildCounterAlloyDbPitrWindow = 0;
api.AlloyDbPitrWindow buildAlloyDbPitrWindow() {
  final o = api.AlloyDbPitrWindow();
  buildCounterAlloyDbPitrWindow++;
  if (buildCounterAlloyDbPitrWindow < 3) {
    o.endTime = 'foo';
...
void checkAlloyDbPitrWindow(api.AlloyDbPitrWindow o) {
  buildCounterAlloyDbPitrWindow++;
  if (buildCounterAlloyDbPitrWindow < 3) {
...
core.List<api.GuestOsFeature> buildUnnamed2() => [
  buildGuestOsFeature(),
  buildGuestOsFeature(),
];

void checkUnnamed2(core.List<api.GuestOsFeature> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AttachedDisk buildAttachedDisk() {
  ...
  if (buildCounterAttachedDisk < 3) {
    ...
    o.guestOsFeature = buildUnnamed2();
    o.index = 'foo';
    o.initializeParams = buildInitializeParams();
    o.kind = 'foo';
    o.license = buildUnnamed3();
    o.mode = 'foo';
    o.savedState = 'foo';
    o.source = 'foo';
    o.type = 'foo';
...
core.List<api.BackupLock> buildUnnamed6() => [
  buildBackupLock(),
  buildBackupLock(),
];

void checkUnnamed6(core.List<api.BackupLock> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBackupLock(o[0]);
  checkBackupLock(o[1]);
}
...
core.List<api.BackupLock> buildUnnamed9() => [
  buildBackupLock(),
  buildBackupLock(),
];

void checkUnnamed9(core.List<api.BackupLock> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBackupLock(o[0]);
  checkBackupLock(o[1]);
}
...
api.Backup buildBackup() {
  ...
  if (buildCounterBackup < 3) {
    o.alloyDbBackupProperties = buildAlloyDbClusterBackupProperties();
    o.backupApplianceBackupProperties = buildBackupApplianceBackupProperties();
    o.backupApplianceLocks = buildUnnamed6();
    o.backupRetentionInheritance = 'foo';
    o.backupType = 'foo';
...
void checkBackup(api.Backup o) {
  buildCounterBackup++;
  if (buildCounterBackup < 3) {
    checkAlloyDbClusterBackupProperties(o.alloyDbBackupProperties!);
    checkBackupApplianceBackupProperties(o.backupApplianceBackupProperties!);
    checkUnnamed6(o.backupApplianceLocks!);
    unittest.expect(o.backupRetentionInheritance!, unittest.equals('foo'));
...
core.List<api.BackupLocation> buildUnnamed10() => [
  buildBackupLocation(),
  buildBackupLocation(),
];

void checkUnnamed10(core.List<api.BackupLocation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BackupConfigDetails buildBackupConfigDetails() {
  ...
  if (buildCounterBackupConfigDetails < 3) {
    ...
    o.backupLocations = buildUnnamed10();
    o.backupVault = 'foo';
...
void checkBackupConfigDetails(api.BackupConfigDetails o) {
  ...
  if (buildCounterBackupConfigDetails < 3) {
    ...
    checkUnnamed10(o.backupLocations!);
...
core.List<api.BackupDrPlanRule> buildUnnamed11() => [
  buildBackupDrPlanRule(),
  buildBackupDrPlanRule(),
];

void checkUnnamed11(core.List<api.BackupDrPlanRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BackupDrPlanConfig buildBackupDrPlanConfig() {
  ...
  if (buildCounterBackupDrPlanConfig < 3) {
    o.backupDrPlanRules = buildUnnamed11();
  }
  buildCounterBackupDrPlanConfig--;
  return o;
}
...
void checkBackupDrPlanConfig(api.BackupDrPlanConfig o) {
  buildCounterBackupDrPlanConfig++;
  if (buildCounterBackupDrPlanConfig < 3) {
    checkUnnamed11(o.backupDrPlanRules!);
  }
  buildCounterBackupDrPlanConfig--;
}
...
core.int buildCounterBackupGcpResource = 0;
api.BackupGcpResource buildBackupGcpResource() {
  final o = api.BackupGcpResource();
  buildCounterBackupGcpResource++;
  if (buildCounterBackupGcpResource < 3) {
...
void checkBackupGcpResource(api.BackupGcpResource o) {
  buildCounterBackupGcpResource++;
  if (buildCounterBackupGcpResource < 3) {
...
core.List<api.BackupRule> buildUnnamed12() => [
  buildBackupRule(),
  buildBackupRule(),
];

void checkUnnamed12(core.List<api.BackupRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBackupRule(o[0]);
  checkBackupRule(o[1]);
}
...
api.BackupPlan buildBackupPlan() {
  ...
  if (buildCounterBackupPlan < 3) {
    ...
    o.logRetentionDays = 'foo';
    o.maxCustomOnDemandRetentionDays = 42;
    o.name = 'foo';
    o.resourceType = 'foo';
    o.revisionId = 'foo';
    o.revisionName = 'foo';
    o.state = 'foo';
    o.supportedResourceTypes = buildUnnamed14();
    o.updateTime = 'foo';
  }
  buildCounterBackupPlan--;
  return o;
...
void checkBackupPlan(api.BackupPlan o) {
  ...
  if (buildCounterBackupPlan < 3) {
    ...
    unittest.expect(o.logRetentionDays!, unittest.equals('foo'));
    unittest.expect(o.maxCustomOnDemandRetentionDays!, unittest.equals(42));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.resourceType!, unittest.equals('foo'));
    unittest.expect(o.revisionId!, unittest.equals('foo'));
    unittest.expect(o.revisionName!, unittest.equals('foo'));
    unittest.expect(o.state!, unittest.equals('foo'));
    checkUnnamed14(o.supportedResourceTypes!);
    unittest.expect(o.updateTime!, unittest.equals('foo'));
  }
  buildCounterBackupPlan--;
}

core.List<api.RuleConfigInfo> buildUnnamed15() => [
  buildRuleConfigInfo(),
  buildRuleConfigInfo(),
];

void checkUnnamed15(core.List<api.RuleConfigInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BackupPlanAssociation buildBackupPlanAssociation() {
  ...
  if (buildCounterBackupPlanAssociation < 3) {
    o.alloydbClusterBackupPlanAssociationProperties =
        buildAlloyDBClusterBackupPlanAssociationProperties();
    o.backupPlan = 'foo';
    ...
    o.createTime = 'foo';
    o.dataSource = 'foo';
    o.filestoreInstanceBackupPlanAssociationProperties =
        buildFilestoreInstanceBackupPlanAssociationProperties();
    o.name = 'foo';
    o.resource = 'foo';
    o.resourceType = 'foo';
    o.rulesConfigInfo = buildUnnamed15();
    o.state = 'foo';
    o.updateTime = 'foo';
  }
  buildCounterBackupPlanAssociation--;
...
void checkBackupPlanAssociation(api.BackupPlanAssociation o) {
  buildCounterBackupPlanAssociation++;
  if (buildCounterBackupPlanAssociation < 3) {
    checkAlloyDBClusterBackupPlanAssociationProperties(
      o.alloydbClusterBackupPlanAssociationProperties!,
    );
    ...
    checkFilestoreInstanceBackupPlanAssociationProperties(
      o.filestoreInstanceBackupPlanAssociationProperties!,
    );
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.resource!, unittest.equals('foo'));
    unittest.expect(o.resourceType!, unittest.equals('foo'));
    checkUnnamed15(o.rulesConfigInfo!);
    unittest.expect(o.state!, unittest.equals('foo'));
    unittest.expect(o.updateTime!, unittest.equals('foo'));
  }
  buildCounterBackupPlanAssociation--;
...
void checkCloudSqlInstanceBackupProperties(
  ...
  if (buildCounterCloudSqlInstanceBackupProperties < 3) {
    ...
    unittest.expect(o.instanceCreateTime!, unittest.equals('foo'));
    unittest.expect(o.instanceDeleteTime!, unittest.equals('foo'));
...
buildComputeInstanceBackupPlanProperties() {
  ...
  if (buildCounterComputeInstanceBackupPlanProperties < 3) {
    o.bootDiskOnly = true;
    o.diskExclusionLabels = buildDiskExclusionLabels();
    o.guestFlush = true;
  }
  buildCounterComputeInstanceBackupPlanProperties--;
  return o;
...
void checkComputeInstanceBackupPlanProperties(
  ...
  buildCounterComputeInstanceBackupPlanProperties++;
  if (buildCounterComputeInstanceBackupPlanProperties < 3) {
    unittest.expect(o.bootDiskOnly!, unittest.isTrue);
    checkDiskExclusionLabels(o.diskExclusionLabels!);
...
core.List<api.AcceleratorConfig> buildUnnamed21() => [
  buildAcceleratorConfig(),
  buildAcceleratorConfig(),
];

void checkUnnamed21(core.List<api.AcceleratorConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.NetworkInterface> buildUnnamed24() => [
  buildNetworkInterface(),
  buildNetworkInterface(),
];

void checkUnnamed24(core.List<api.NetworkInterface> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNetworkInterface(o[0]);
  checkNetworkInterface(o[1]);
}

core.List<api.ServiceAccount> buildUnnamed25() => [
  buildServiceAccount(),
  buildServiceAccount(),
];

void checkUnnamed25(core.List<api.ServiceAccount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ComputeInstanceBackupProperties buildComputeInstanceBackupProperties() {
  ...
  if (buildCounterComputeInstanceBackupProperties < 3) {
    ...
    o.excludedDisks = buildUnnamed20();
    o.guestAccelerator = buildUnnamed21();
    o.guestFlush = true;
    o.includedDisks = buildUnnamed22();
    o.keyRevocationActionType = 'foo';
    o.labels = buildUnnamed23();
    o.machineType = 'foo';
    o.metadata = buildMetadata();
    o.minCpuPlatform = 'foo';
    o.networkInterface = buildUnnamed24();
    o.scheduling = buildScheduling();
    o.serviceAccount = buildUnnamed25();
    o.sourceInstance = 'foo';
    o.tags = buildTags();
  }
  buildCounterComputeInstanceBackupProperties--;
...
void checkComputeInstanceBackupProperties(
  ...
  if (buildCounterComputeInstanceBackupProperties < 3) {
    ...
    checkUnnamed20(o.excludedDisks!);
    checkUnnamed21(o.guestAccelerator!);
    unittest.expect(o.guestFlush!, unittest.isTrue);
    checkUnnamed22(o.includedDisks!);
    ...
    checkUnnamed24(o.networkInterface!);
    checkScheduling(o.scheduling!);
    checkUnnamed25(o.serviceAccount!);
    unittest.expect(o.sourceInstance!, unittest.equals('foo'));
    checkTags(o.tags!);
  }
  buildCounterComputeInstanceBackupProperties--;
...
core.List<api.AttachedDisk> buildUnnamed26() => [
  buildAttachedDisk(),
  buildAttachedDisk(),
];

void checkUnnamed26(core.List<api.AttachedDisk> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachedDisk(o[0]);
  checkAttachedDisk(o[1]);
}
...
core.List<api.ServiceAccount> buildUnnamed31() => [
  buildServiceAccount(),
  buildServiceAccount(),
];

void checkUnnamed31(core.List<api.ServiceAccount> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkServiceAccount(o[0]);
  checkServiceAccount(o[1]);
}
...
api.ComputeInstanceRestoreProperties buildComputeInstanceRestoreProperties() {
  ...
  if (buildCounterComputeInstanceRestoreProperties < 3) {
    ...
    o.description = 'foo';
    o.disks = buildUnnamed26();
    o.displayDevice = buildDisplayDevice();
    o.guestAccelerators = buildUnnamed27();
    o.hostname = 'foo';
    ...
    o.resourcePolicies = buildUnnamed30();
    o.scheduling = buildScheduling();
    o.serviceAccounts = buildUnnamed31();
    o.tags = buildTags();
  }
  buildCounterComputeInstanceRestoreProperties--;
  return o;
...
void checkComputeInstanceRestoreProperties(
  ...
  if (buildCounterComputeInstanceRestoreProperties < 3) {
    ...
    unittest.expect(o.description!, unittest.equals('foo'));
    checkUnnamed26(o.disks!);
    checkDisplayDevice(o.displayDevice!);
    checkUnnamed27(o.guestAccelerators!);
    unittest.expect(o.hostname!, unittest.equals('foo'));
    ...
    checkUnnamed30(o.resourcePolicies!);
    checkScheduling(o.scheduling!);
    checkUnnamed31(o.serviceAccounts!);
    checkTags(o.tags!);
  }
  buildCounterComputeInstanceRestoreProperties--;
}
...
api.ComputeInstanceTargetEnvironment buildComputeInstanceTargetEnvironment() {
  ...
  if (buildCounterComputeInstanceTargetEnvironment < 3) {
    o.project = 'foo';
    o.useProjectServiceAccount = true;
    o.zone = 'foo';
  }
  buildCounterComputeInstanceTargetEnvironment--;
  return o;
...
void checkComputeInstanceTargetEnvironment(
  ...
  if (buildCounterComputeInstanceTargetEnvironment < 3) {
    ...
    unittest.expect(o.useProjectServiceAccount!, unittest.isTrue);
...
api.DataSourceGcpResource buildDataSourceGcpResource() {
  ...
  if (buildCounterDataSourceGcpResource < 3) {
    o.alloyDbClusterDatasourceProperties =
        buildAlloyDBClusterDataSourceProperties();
...
void checkDataSourceGcpResource(api.DataSourceGcpResource o) {
  buildCounterDataSourceGcpResource++;
  if (buildCounterDataSourceGcpResource < 3) {
    checkAlloyDBClusterDataSourceProperties(
      o.alloyDbClusterDatasourceProperties!,
    );
...
void checkDataSourceGcpResourceInfo(api.DataSourceGcpResourceInfo o) {
  buildCounterDataSourceGcpResourceInfo++;
  if (buildCounterDataSourceGcpResourceInfo < 3) {
    checkAlloyDBClusterDataSourceReferenceProperties(
      o.alloyDbClusterProperties!,
    );
...
core.List<api.LabelKeyValPair> buildUnnamed37() => [
  buildLabelKeyValPair(),
  buildLabelKeyValPair(),
];

void checkUnnamed37(core.List<api.LabelKeyValPair> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelKeyValPair(o[0]);
  checkLabelKeyValPair(o[1]);
}

core.int buildCounterDiskExclusionLabels = 0;
api.DiskExclusionLabels buildDiskExclusionLabels() {
  final o = api.DiskExclusionLabels();
  buildCounterDiskExclusionLabels++;
  if (buildCounterDiskExclusionLabels < 3) {
...
void checkDiskExclusionLabels(api.DiskExclusionLabels o) {
  buildCounterDiskExclusionLabels++;
  if (buildCounterDiskExclusionLabels < 3) {
...
core.List<api.GuestOsFeature> buildUnnamed38() => [
  buildGuestOsFeature(),
  buildGuestOsFeature(),
];

void checkUnnamed38(core.List<api.GuestOsFeature> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGuestOsFeature(o[0]);
  checkGuestOsFeature(o[1]);
}
...
api.DiskRestoreProperties buildDiskRestoreProperties() {
  ...
  if (buildCounterDiskRestoreProperties < 3) {
    ...
    o.diskEncryptionKey = buildCustomerEncryptionKey();
    o.enableConfidentialCompute = true;
    o.guestOsFeature = buildUnnamed38();
    o.instanceBackupSource = buildRestoreDiskFromInstanceOptions();
    ...
    o.provisionedIops = 'foo';
    o.provisionedThroughput = 'foo';
    o.resourceManagerTags = buildUnnamed41();
    o.resourcePolicy = buildUnnamed42();
    o.sizeGb = 'foo';
    o.storagePool = 'foo';
    o.type = 'foo';
  }
...
void checkDiskRestoreProperties(api.DiskRestoreProperties o) {
  ...
  if (buildCounterDiskRestoreProperties < 3) {
    ...
    checkCustomerEncryptionKey(o.diskEncryptionKey!);
    unittest.expect(o.enableConfidentialCompute!, unittest.isTrue);
    checkUnnamed38(o.guestOsFeature!);
    checkRestoreDiskFromInstanceOptions(o.instanceBackupSource!);
    ...
    unittest.expect(o.provisionedIops!, unittest.equals('foo'));
    unittest.expect(o.provisionedThroughput!, unittest.equals('foo'));
    checkUnnamed41(o.resourceManagerTags!);
    checkUnnamed42(o.resourcePolicy!);
    unittest.expect(o.sizeGb!, unittest.equals('foo'));
    unittest.expect(o.storagePool!, unittest.equals('foo'));
    unittest.expect(o.type!, unittest.equals('foo'));
  }
...
core.int buildCounterEndTrialRequest = 0;
api.EndTrialRequest buildEndTrialRequest() {
  final o = api.EndTrialRequest();
  buildCounterEndTrialRequest++;
  if (buildCounterEndTrialRequest < 3) {
    o.endReason = 'foo';
  }
  buildCounterEndTrialRequest--;
  return o;
...
void checkEndTrialRequest(api.EndTrialRequest o) {
  buildCounterEndTrialRequest++;
  if (buildCounterEndTrialRequest < 3) {
...
core.List<api.BackupPlanAssociation> buildUnnamed43() => [
  buildBackupPlanAssociation(),
  buildBackupPlanAssociation(),
];

void checkUnnamed43(core.List<api.BackupPlanAssociation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildFetchBackupPlanAssociationsForResourceTypeResponse() {
  ...
  if (buildCounterFetchBackupPlanAssociationsForResourceTypeResponse < 3) {
    o.backupPlanAssociations = buildUnnamed43();
    o.nextPageToken = 'foo';
  }
  buildCounterFetchBackupPlanAssociationsForResourceTypeResponse--;
  return o;
...
void checkFetchBackupPlanAssociationsForResourceTypeResponse(
  ...
  buildCounterFetchBackupPlanAssociationsForResourceTypeResponse++;
  if (buildCounterFetchBackupPlanAssociationsForResourceTypeResponse < 3) {
    checkUnnamed43(o.backupPlanAssociations!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterFetchBackupPlanAssociationsForResourceTypeResponse--;
}

core.List<api.Backup> buildUnnamed44() => [buildBackup(), buildBackup()];

void checkUnnamed44(core.List<api.Backup> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBackup(o[0]);
  checkBackup(o[1]);
}

core.int buildCounterFetchBackupsForResourceTypeResponse = 0;
api.FetchBackupsForResourceTypeResponse
buildFetchBackupsForResourceTypeResponse() {
  final o = api.FetchBackupsForResourceTypeResponse();
  buildCounterFetchBackupsForResourceTypeResponse++;
  if (buildCounterFetchBackupsForResourceTypeResponse < 3) {
    o.backups = buildUnnamed44();
    o.nextPageToken = 'foo';
  }
  buildCounterFetchBackupsForResourceTypeResponse--;
  return o;
...
void checkFetchBackupsForResourceTypeResponse(
  api.FetchBackupsForResourceTypeResponse o,
) {
  buildCounterFetchBackupsForResourceTypeResponse++;
  if (buildCounterFetchBackupsForResourceTypeResponse < 3) {
    checkUnnamed44(o.backups!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterFetchBackupsForResourceTypeResponse--;
}

core.List<api.DataSourceReference> buildUnnamed45() => [
  buildDataSourceReference(),
  buildDataSourceReference(),
];

void checkUnnamed45(core.List<api.DataSourceReference> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildFetchDataSourceReferencesForResourceTypeResponse() {
  ...
  if (buildCounterFetchDataSourceReferencesForResourceTypeResponse < 3) {
    o.dataSourceReferences = buildUnnamed45();
    o.nextPageToken = 'foo';
  }
  buildCounterFetchDataSourceReferencesForResourceTypeResponse--;
  return o;
...
void checkFetchDataSourceReferencesForResourceTypeResponse(
  ...
  buildCounterFetchDataSourceReferencesForResourceTypeResponse++;
  if (buildCounterFetchDataSourceReferencesForResourceTypeResponse < 3) {
    checkUnnamed45(o.dataSourceReferences!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterFetchDataSourceReferencesForResourceTypeResponse--;
}
...
core.List<api.ResourceBackupConfig> buildUnnamed46() => [
  buildResourceBackupConfig(),
  buildResourceBackupConfig(),
];

void checkUnnamed46(core.List<api.ResourceBackupConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResourceBackupConfig(o[0]);
  checkResourceBackupConfig(o[1]);
}

core.int buildCounterFetchResourceBackupConfigsResponse = 0;
api.FetchResourceBackupConfigsResponse
buildFetchResourceBackupConfigsResponse() {
  final o = api.FetchResourceBackupConfigsResponse();
  buildCounterFetchResourceBackupConfigsResponse++;
  if (buildCounterFetchResourceBackupConfigsResponse < 3) {
    o.nextPageToken = 'foo';
    o.resourceBackupConfigs = buildUnnamed46();
  }
  buildCounterFetchResourceBackupConfigsResponse--;
  return o;
}

void checkFetchResourceBackupConfigsResponse(
  api.FetchResourceBackupConfigsResponse o,
) {
  buildCounterFetchResourceBackupConfigsResponse++;
  if (buildCounterFetchResourceBackupConfigsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed46(o.resourceBackupConfigs!);
  }
  buildCounterFetchResourceBackupConfigsResponse--;
}

core.List<api.BackupVault> buildUnnamed47() => [
  buildBackupVault(),
  buildBackupVault(),
];

void checkUnnamed47(core.List<api.BackupVault> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.int buildCounterFilestoreInstanceBackupPlanAssociationProperties = 0;
api.FilestoreInstanceBackupPlanAssociationProperties
buildFilestoreInstanceBackupPlanAssociationProperties() {
  final o = api.FilestoreInstanceBackupPlanAssociationProperties();
  buildCounterFilestoreInstanceBackupPlanAssociationProperties++;
  if (buildCounterFilestoreInstanceBackupPlanAssociationProperties < 3) {
    o.instanceCreateTime = 'foo';
  }
  buildCounterFilestoreInstanceBackupPlanAssociationProperties--;
  return o;
...
void checkFilestoreInstanceBackupPlanAssociationProperties(
  api.FilestoreInstanceBackupPlanAssociationProperties o,
) {
  buildCounterFilestoreInstanceBackupPlanAssociationProperties++;
  if (buildCounterFilestoreInstanceBackupPlanAssociationProperties < 3) {
    unittest.expect(o.instanceCreateTime!, unittest.equals('foo'));
...
api.GcpBackupConfig buildGcpBackupConfig() {
  ...
  if (buildCounterGcpBackupConfig < 3) {
    ...
    o.backupPlanRevisionId = 'foo';
    o.backupPlanRevisionName = 'foo';
    o.backupPlanRules = buildUnnamed49();
  }
  buildCounterGcpBackupConfig--;
  return o;
}
...
void checkGcpBackupConfig(api.GcpBackupConfig o) {
  ...
  if (buildCounterGcpBackupConfig < 3) {
    ...
    unittest.expect(o.backupPlanRevisionId!, unittest.equals('foo'));
    unittest.expect(o.backupPlanRevisionName!, unittest.equals('foo'));
    checkUnnamed49(o.backupPlanRules!);
  }
  buildCounterGcpBackupConfig--;
}
...
api.InstanceParams buildInstanceParams() {
  ...
  if (buildCounterInstanceParams < 3) {
    o.resourceManagerTags = buildUnnamed51();
  }
  buildCounterInstanceParams--;
  return o;
}
...
void checkInstanceParams(api.InstanceParams o) {
  buildCounterInstanceParams++;
  if (buildCounterInstanceParams < 3) {
    checkUnnamed51(o.resourceManagerTags!);
  }
  buildCounterInstanceParams--;
}

core.int buildCounterLabelKeyValPair = 0;
api.LabelKeyValPair buildLabelKeyValPair() {
  final o = api.LabelKeyValPair();
  buildCounterLabelKeyValPair++;
  if (buildCounterLabelKeyValPair < 3) {
    o.key = 'foo';
    o.value = 'foo';
  }
  buildCounterLabelKeyValPair--;
...
void checkLabelKeyValPair(api.LabelKeyValPair o) {
  buildCounterLabelKeyValPair++;
  if (buildCounterLabelKeyValPair < 3) {
    unittest.expect(o.key!, unittest.equals('foo'));
    unittest.expect(o.value!, unittest.equals('foo'));
...
core.List<api.BackupPlanAssociation> buildUnnamed52() => [
  buildBackupPlanAssociation(),
  buildBackupPlanAssociation(),
];

void checkUnnamed52(core.List<api.BackupPlanAssociation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBackupPlanAssociation(o[0]);
  checkBackupPlanAssociation(o[1]);
}
...
buildListBackupPlanAssociationsResponse() {
  ...
  if (buildCounterListBackupPlanAssociationsResponse < 3) {
    o.backupPlanAssociations = buildUnnamed52();
    o.nextPageToken = 'foo';
...
void checkListBackupPlanAssociationsResponse(
  ...
  buildCounterListBackupPlanAssociationsResponse++;
  if (buildCounterListBackupPlanAssociationsResponse < 3) {
    checkUnnamed52(o.backupPlanAssociations!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
...
core.List<api.BackupPlanRevision> buildUnnamed54() => [
  buildBackupPlanRevision(),
  buildBackupPlanRevision(),
];

void checkUnnamed54(core.List<api.BackupPlanRevision> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListBackupPlanRevisionsResponse buildListBackupPlanRevisionsResponse() {
  ...
  if (buildCounterListBackupPlanRevisionsResponse < 3) {
    o.backupPlanRevisions = buildUnnamed54();
    o.nextPageToken = 'foo';
...
void checkListBackupPlanRevisionsResponse(
  ...
  buildCounterListBackupPlanRevisionsResponse++;
  if (buildCounterListBackupPlanRevisionsResponse < 3) {
    checkUnnamed54(o.backupPlanRevisions!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
...
core.List<api.BackupPlan> buildUnnamed56() => [
  buildBackupPlan(),
  buildBackupPlan(),
];

void checkUnnamed56(core.List<api.BackupPlan> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBackupPlan(o[0]);
  checkBackupPlan(o[1]);
}
...
core.List<api.BackupVault> buildUnnamed58() => [
  buildBackupVault(),
  buildBackupVault(),
];

void checkUnnamed58(core.List<api.BackupVault> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBackupVault(o[0]);
  checkBackupVault(o[1]);
}
...
core.List<api.Backup> buildUnnamed60() => [buildBackup(), buildBackup()];

void checkUnnamed60(core.List<api.Backup> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBackup(o[0]);
  checkBackup(o[1]);
}
...
core.List<api.DataSourceReference> buildUnnamed62() => [
  buildDataSourceReference(),
  buildDataSourceReference(),
];

void checkUnnamed62(core.List<api.DataSourceReference> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataSourceReference(o[0]);
  checkDataSourceReference(o[1]);
}
...
core.int buildCounterListDataSourceReferencesResponse = 0;
api.ListDataSourceReferencesResponse buildListDataSourceReferencesResponse() {
  final o = api.ListDataSourceReferencesResponse();
  buildCounterListDataSourceReferencesResponse++;
  if (buildCounterListDataSourceReferencesResponse < 3) {
    o.dataSourceReferences = buildUnnamed62();
    o.nextPageToken = 'foo';
...
void checkListDataSourceReferencesResponse(
  api.ListDataSourceReferencesResponse o,
) {
  buildCounterListDataSourceReferencesResponse++;
  if (buildCounterListDataSourceReferencesResponse < 3) {
    checkUnnamed62(o.dataSourceReferences!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
...
core.List<api.DataSource> buildUnnamed64() => [
  buildDataSource(),
  buildDataSource(),
];

void checkUnnamed64(core.List<api.DataSource> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataSource(o[0]);
  checkDataSource(o[1]);
}
...
core.List<api.ManagementServer> buildUnnamed67() => [
  buildManagementServer(),
  buildManagementServer(),
];

void checkUnnamed67(core.List<api.ManagementServer> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListManagementServersResponse buildListManagementServersResponse() {
  ...
  if (buildCounterListManagementServersResponse < 3) {
    o.managementServers = buildUnnamed67();
    o.nextPageToken = 'foo';
...
void checkListManagementServersResponse(api.ListManagementServersResponse o) {
  buildCounterListManagementServersResponse++;
  if (buildCounterListManagementServersResponse < 3) {
    checkUnnamed67(o.managementServers!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
...
core.List<api.ResourceBackupConfig> buildUnnamed71() => [
  buildResourceBackupConfig(),
  buildResourceBackupConfig(),
];

void checkUnnamed71(core.List<api.ResourceBackupConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResourceBackupConfig(o[0]);
  checkResourceBackupConfig(o[1]);
}
...
api.ListResourceBackupConfigsResponse buildListResourceBackupConfigsResponse() {
  ...
  if (buildCounterListResourceBackupConfigsResponse < 3) {
    o.nextPageToken = 'foo';
    o.resourceBackupConfigs = buildUnnamed71();
  }
  buildCounterListResourceBackupConfigsResponse--;
  return o;
}
...
void checkListResourceBackupConfigsResponse(
  ...
  if (buildCounterListResourceBackupConfigsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed71(o.resourceBackupConfigs!);
  }
  buildCounterListResourceBackupConfigsResponse--;
}
...
core.List<api.NetworkConfig> buildUnnamed76() => [
  buildNetworkConfig(),
  buildNetworkConfig(),
];

void checkUnnamed76(core.List<api.NetworkConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Entry> buildUnnamed77() => [buildEntry(), buildEntry()];

void checkUnnamed77(core.List<api.Entry> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEntry(o[0]);
  checkEntry(o[1]);
}
...
core.List<api.AccessConfig> buildUnnamed78() => [
  buildAccessConfig(),
  buildAccessConfig(),
];

void checkUnnamed78(core.List<api.AccessConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAccessConfig(o[0]);
  checkAccessConfig(o[1]);
}

core.List<api.AliasIpRange> buildUnnamed79() => [
  buildAliasIpRange(),
  buildAliasIpRange(),
];

void checkUnnamed79(core.List<api.AliasIpRange> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAliasIpRange(o[0]);
  checkAliasIpRange(o[1]);
}

core.List<api.AccessConfig> buildUnnamed80() => [
  buildAccessConfig(),
  buildAccessConfig(),
];

void checkUnnamed80(core.List<api.AccessConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAccessConfig(o[0]);
  checkAccessConfig(o[1]);
}
...
api.NetworkInterface buildNetworkInterface() {
  ...
  if (buildCounterNetworkInterface < 3) {
    o.accessConfigs = buildUnnamed78();
    o.aliasIpRanges = buildUnnamed79();
    o.internalIpv6PrefixLength = 42;
    o.ipv6AccessConfigs = buildUnnamed80();
...
void checkNetworkInterface(api.NetworkInterface o) {
  buildCounterNetworkInterface++;
  if (buildCounterNetworkInterface < 3) {
    checkUnnamed78(o.accessConfigs!);
    checkUnnamed79(o.aliasIpRanges!);
    unittest.expect(o.internalIpv6PrefixLength!, unittest.equals(42));
    checkUnnamed80(o.ipv6AccessConfigs!);
...
core.List<api.Binding> buildUnnamed85() => [buildBinding(), buildBinding()];
...
core.List<api.BackupConfigDetails> buildUnnamed87() => [
  buildBackupConfigDetails(),
  buildBackupConfigDetails(),
];

void checkUnnamed87(core.List<api.BackupConfigDetails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ResourceBackupConfig buildResourceBackupConfig() {
  ...
  if (buildCounterResourceBackupConfig < 3) {
    o.backupConfigsDetails = buildUnnamed87();
    o.backupConfigured = true;
    o.name = 'foo';
    o.targetResource = 'foo';
    o.targetResourceDisplayName = 'foo';
    o.targetResourceLabels = buildUnnamed88();
...
void checkResourceBackupConfig(api.ResourceBackupConfig o) {
  buildCounterResourceBackupConfig++;
  if (buildCounterResourceBackupConfig < 3) {
    checkUnnamed87(o.backupConfigsDetails!);
    ...
    checkUnnamed88(o.targetResourceLabels!);
...
void checkRestoreBackupRequest(api.RestoreBackupRequest o) {
  buildCounterRestoreBackupRequest++;
  if (buildCounterRestoreBackupRequest < 3) {
    unittest.expect(o.clearOverridesFieldMask!, unittest.equals('foo'));
...
core.int buildCounterRestoreDiskFromInstanceOptions = 0;
api.RestoreDiskFromInstanceOptions buildRestoreDiskFromInstanceOptions() {
  final o = api.RestoreDiskFromInstanceOptions();
  buildCounterRestoreDiskFromInstanceOptions++;
  if (buildCounterRestoreDiskFromInstanceOptions < 3) {
    o.bootDisk = true;
    o.sourceDeviceName = 'foo';
  }
  buildCounterRestoreDiskFromInstanceOptions--;
  return o;
}

void checkRestoreDiskFromInstanceOptions(api.RestoreDiskFromInstanceOptions o) {
  buildCounterRestoreDiskFromInstanceOptions++;
  if (buildCounterRestoreDiskFromInstanceOptions < 3) {
    unittest.expect(o.bootDisk!, unittest.isTrue);
    unittest.expect(o.sourceDeviceName!, unittest.equals('foo'));
  }
  buildCounterRestoreDiskFromInstanceOptions--;
}
...
core.List<api.NodeAffinity> buildUnnamed89() => [
  buildNodeAffinity(),
  buildNodeAffinity(),
];

void checkUnnamed89(core.List<api.NodeAffinity> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Scheduling buildScheduling() {
  ...
  if (buildCounterScheduling < 3) {
    ...
    o.minNodeCpus = 42;
    o.nodeAffinities = buildUnnamed89();
...
void checkScheduling(api.Scheduling o) {
  ...
  if (buildCounterScheduling < 3) {
    ...
    checkUnnamed89(o.nodeAffinities!);
...
core.List<core.int> buildUnnamed91() => [42, 42];

void checkUnnamed91(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.StandardSchedule buildStandardSchedule() {
  ...
  if (buildCounterStandardSchedule < 3) {
    ...
    o.daysOfMonth = buildUnnamed91();
    o.daysOfWeek = buildUnnamed92();
    o.hourlyFrequency = 42;
    o.months = buildUnnamed93();
...
void checkTriggerBackupRequest(api.TriggerBackupRequest o) {
  buildCounterTriggerBackupRequest++;
  if (buildCounterTriggerBackupRequest < 3) {
    unittest.expect(o.customRetentionDays!, unittest.equals(42));
...
void main() {
  ...
  unittest.group(
    'obj-schema-AlloyDBClusterBackupPlanAssociationProperties',
    () {
      unittest.test('to-json--from-json', () async {
        final o = buildAlloyDBClusterBackupPlanAssociationProperties();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.AlloyDBClusterBackupPlanAssociationProperties.fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
        checkAlloyDBClusterBackupPlanAssociationProperties(od);
      });
    },
  );

  unittest.group('obj-schema-AlloyDBClusterDataSourceProperties', () {
    unittest.test('to-json--from-json', () async {
      final o = buildAlloyDBClusterDataSourceProperties();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.AlloyDBClusterDataSourceProperties.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkAlloyDBClusterDataSourceProperties(od);
    });
  });

  unittest.group('obj-schema-AlloyDBClusterDataSourceReferenceProperties', () {
    unittest.test('to-json--from-json', () async {
      final o = buildAlloyDBClusterDataSourceReferenceProperties();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.AlloyDBClusterDataSourceReferenceProperties.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkAlloyDBClusterDataSourceReferenceProperties(od);
    });
  });

  unittest.group('obj-schema-AlloyDbClusterBackupProperties', () {
    unittest.test('to-json--from-json', () async {
      final o = buildAlloyDbClusterBackupProperties();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.AlloyDbClusterBackupProperties.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkAlloyDbClusterBackupProperties(od);
    });
  });

  unittest.group('obj-schema-AlloyDbPitrWindow', () {
    unittest.test('to-json--from-json', () async {
      final o = buildAlloyDbPitrWindow();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.AlloyDbPitrWindow.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkAlloyDbPitrWindow(od);
    });
  });
  ...
  unittest.group('obj-schema-BackupGcpResource', () {
    unittest.test('to-json--from-json', () async {
      final o = buildBackupGcpResource();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.BackupGcpResource.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkBackupGcpResource(od);
    });
  });
  ...
  unittest.group('obj-schema-DiskExclusionLabels', () {
    unittest.test('to-json--from-json', () async {
      final o = buildDiskExclusionLabels();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.DiskExclusionLabels.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkDiskExclusionLabels(od);
    });
  });
  ...
  unittest.group('obj-schema-EndTrialRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildEndTrialRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.EndTrialRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkEndTrialRequest(od);
    });
  });
  ...
  unittest.group('obj-schema-FetchBackupsForResourceTypeResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildFetchBackupsForResourceTypeResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.FetchBackupsForResourceTypeResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkFetchBackupsForResourceTypeResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-FetchResourceBackupConfigsResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildFetchResourceBackupConfigsResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.FetchResourceBackupConfigsResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkFetchResourceBackupConfigsResponse(od);
    });
  });
  ...
  unittest.group(
    'obj-schema-FilestoreInstanceBackupPlanAssociationProperties',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group('obj-schema-LabelKeyValPair', () {
    unittest.test('to-json--from-json', () async {
      final o = buildLabelKeyValPair();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.LabelKeyValPair.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkLabelKeyValPair(od);
    });
  });
  ...
  unittest.group('obj-schema-ListDataSourceReferencesResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildListDataSourceReferencesResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListDataSourceReferencesResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkListDataSourceReferencesResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-RestoreDiskFromInstanceOptions', () {
    unittest.test('to-json--from-json', () async {
      final o = buildRestoreDiskFromInstanceOptions();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.RestoreDiskFromInstanceOptions.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkRestoreDiskFromInstanceOptions(od);
    });
  });
  ...
  unittest.group('resource-FoldersLocationsResourceBackupConfigsResource', () {
    unittest.test('method--fetch', () async {
      final mock = HttpServerMock();
      final res = api.BackupdrApi(mock).folders.locations.resourceBackupConfigs;
      ...
      checkFetchResourceBackupConfigsResponse(
        response as api.FetchResourceBackupConfigsResponse,
      );
    });
  });

  unittest.group(
    'resource-OrganizationsLocationsResourceBackupConfigsResource',
    () {
      unittest.test('method--fetch', () async {
        final mock = HttpServerMock();
        final res = api.BackupdrApi(
          mock,
        ).organizations.locations.resourceBackupConfigs;
        final arg_parent = 'foo';
        final arg_filter = 'foo';
        final arg_orderBy = 'foo';
        final arg_pageSize = 42;
  ...
  unittest.group('resource-ProjectsLocationsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.BackupdrApi(mock).projects.locations;
      final arg_name = 'foo';
      final arg_extraLocationTypes = buildUnnamed100();
      final arg_filter = 'foo';
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_$fields = 'foo';
  ...
  unittest.group('resource-ProjectsLocationsBackupVaultsDataSourcesBackupsResource', () {
    ...
    unittest.test('method--fetchForResourceType', () async {
      ...
      checkFetchBackupsForResourceTypeResponse(
        response as api.FetchBackupsForResourceTypeResponse,
      );
    });
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildListDataSourceReferencesResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      ...
      checkListDataSourceReferencesResponse(
        response as api.ListDataSourceReferencesResponse,
      );
    });
  });
  ...
  unittest.group('resource-ProjectsLocationsTrialResource', () {
    unittest.test('method--end', () async {
      final mock = HttpServerMock();
      final res = api.BackupdrApi(mock).projects.locations.trial;
      final arg_request = buildEndTrialRequest();
      final arg_parent = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.EndTrialRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkEndTrialRequest(obj);
