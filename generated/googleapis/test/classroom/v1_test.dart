...
core.List<api.Attachment> buildUnnamed6021() => [
      buildAttachment(),
      buildAttachment(),
    ];

void checkUnnamed6021(core.List<api.Attachment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachment(o[0]);
  checkAttachment(o[1]);
}
...
api.AssignmentSubmission buildAssignmentSubmission() {
  ...
  if (buildCounterAssignmentSubmission < 3) {
    o.attachments = buildUnnamed6021();
  }
  buildCounterAssignmentSubmission--;
  return o;
}
...
void checkAssignmentSubmission(api.AssignmentSubmission o) {
  buildCounterAssignmentSubmission++;
  if (buildCounterAssignmentSubmission < 3) {
    checkUnnamed6021(o.attachments!);
  }
  buildCounterAssignmentSubmission--;
}
...
core.List<api.CourseMaterialSet> buildUnnamed6022() => [
      buildCourseMaterialSet(),
      buildCourseMaterialSet(),
    ];

void checkUnnamed6022(core.List<api.CourseMaterialSet> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Course buildCourse() {
  ...
  if (buildCounterCourse < 3) {
    ...
    o.courseMaterialSets = buildUnnamed6022();
    o.courseState = 'foo';
    o.creationTime = 'foo';
    o.description = 'foo';
...
void checkCourse(api.Course o) {
  ...
  if (buildCounterCourse < 3) {
    ...
    checkUnnamed6022(o.courseMaterialSets!);
    unittest.expect(
      o.courseState!,
      unittest.equals('foo'),
    );
...
core.List<api.CourseMaterial> buildUnnamed6023() => [
      buildCourseMaterial(),
      buildCourseMaterial(),
    ];

void checkUnnamed6023(core.List<api.CourseMaterial> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Material> buildUnnamed6024() => [
      buildMaterial(),
      buildMaterial(),
    ];

void checkUnnamed6024(core.List<api.Material> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMaterial(o[0]);
  checkMaterial(o[1]);
}
...
core.List<api.Material> buildUnnamed6025() => [
      buildMaterial(),
      buildMaterial(),
    ];

void checkUnnamed6025(core.List<api.Material> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMaterial(o[0]);
  checkMaterial(o[1]);
}
...
core.List<api.Announcement> buildUnnamed6027() => [
      buildAnnouncement(),
      buildAnnouncement(),
    ];

void checkUnnamed6027(core.List<api.Announcement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListAnnouncementsResponse buildListAnnouncementsResponse() {
  ...
  if (buildCounterListAnnouncementsResponse < 3) {
    o.announcements = buildUnnamed6027();
    o.nextPageToken = 'foo';
  }
  buildCounterListAnnouncementsResponse--;
  return o;
...
void checkListAnnouncementsResponse(api.ListAnnouncementsResponse o) {
  buildCounterListAnnouncementsResponse++;
  if (buildCounterListAnnouncementsResponse < 3) {
    checkUnnamed6027(o.announcements!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.CourseAlias> buildUnnamed6028() => [
      buildCourseAlias(),
      buildCourseAlias(),
    ];

void checkUnnamed6028(core.List<api.CourseAlias> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.CourseWorkMaterial> buildUnnamed6029() => [
      buildCourseWorkMaterial(),
      buildCourseWorkMaterial(),
    ];

void checkUnnamed6029(core.List<api.CourseWorkMaterial> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListCourseWorkMaterialResponse buildListCourseWorkMaterialResponse() {
  ...
  if (buildCounterListCourseWorkMaterialResponse < 3) {
    o.courseWorkMaterial = buildUnnamed6029();
    o.nextPageToken = 'foo';
  }
  buildCounterListCourseWorkMaterialResponse--;
  return o;
...
void checkListCourseWorkMaterialResponse(api.ListCourseWorkMaterialResponse o) {
  buildCounterListCourseWorkMaterialResponse++;
  if (buildCounterListCourseWorkMaterialResponse < 3) {
    checkUnnamed6029(o.courseWorkMaterial!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.CourseWork> buildUnnamed6030() => [
      buildCourseWork(),
      buildCourseWork(),
    ];

void checkUnnamed6030(core.List<api.CourseWork> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCourseWork(o[0]);
  checkCourseWork(o[1]);
}
...
core.List<api.Course> buildUnnamed6031() => [
      buildCourse(),
      buildCourse(),
    ];

void checkUnnamed6031(core.List<api.Course> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCourse(o[0]);
  checkCourse(o[1]);
}
...
core.List<api.GuardianInvitation> buildUnnamed6032() => [
      buildGuardianInvitation(),
      buildGuardianInvitation(),
    ];

void checkUnnamed6032(core.List<api.GuardianInvitation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListGuardianInvitationsResponse buildListGuardianInvitationsResponse() {
  ...
  if (buildCounterListGuardianInvitationsResponse < 3) {
    o.guardianInvitations = buildUnnamed6032();
    o.nextPageToken = 'foo';
  }
  buildCounterListGuardianInvitationsResponse--;
  return o;
...
void checkListGuardianInvitationsResponse(
  ...
  buildCounterListGuardianInvitationsResponse++;
  if (buildCounterListGuardianInvitationsResponse < 3) {
    checkUnnamed6032(o.guardianInvitations!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Guardian> buildUnnamed6033() => [
      buildGuardian(),
      buildGuardian(),
    ];

void checkUnnamed6033(core.List<api.Guardian> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGuardian(o[0]);
  checkGuardian(o[1]);
}
...
core.List<api.Invitation> buildUnnamed6034() => [
      buildInvitation(),
      buildInvitation(),
    ];

void checkUnnamed6034(core.List<api.Invitation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInvitation(o[0]);
  checkInvitation(o[1]);
}
...
api.ListInvitationsResponse buildListInvitationsResponse() {
  ...
  if (buildCounterListInvitationsResponse < 3) {
    o.invitations = buildUnnamed6034();
    o.nextPageToken = 'foo';
  }
  buildCounterListInvitationsResponse--;
  return o;
...
void checkListInvitationsResponse(api.ListInvitationsResponse o) {
  buildCounterListInvitationsResponse++;
  if (buildCounterListInvitationsResponse < 3) {
    checkUnnamed6034(o.invitations!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.StudentSubmission> buildUnnamed6035() => [
      buildStudentSubmission(),
      buildStudentSubmission(),
    ];

void checkUnnamed6035(core.List<api.StudentSubmission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListStudentSubmissionsResponse buildListStudentSubmissionsResponse() {
  ...
  if (buildCounterListStudentSubmissionsResponse < 3) {
    o.nextPageToken = 'foo';
    o.studentSubmissions = buildUnnamed6035();
  }
  buildCounterListStudentSubmissionsResponse--;
  return o;
}
...
void checkListStudentSubmissionsResponse(api.ListStudentSubmissionsResponse o) {
  ...
  if (buildCounterListStudentSubmissionsResponse < 3) {
    ...
    checkUnnamed6035(o.studentSubmissions!);
  }
  buildCounterListStudentSubmissionsResponse--;
}

core.List<api.Student> buildUnnamed6036() => [
      buildStudent(),
      buildStudent(),
    ];

void checkUnnamed6036(core.List<api.Student> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStudent(o[0]);
  checkStudent(o[1]);
}
...
void checkListStudentsResponse(api.ListStudentsResponse o) {
  ...
  if (buildCounterListStudentsResponse < 3) {
    ...
    checkUnnamed6036(o.students!);
  }
  buildCounterListStudentsResponse--;
}

core.List<api.Teacher> buildUnnamed6037() => [
      buildTeacher(),
      buildTeacher(),
    ];

void checkUnnamed6037(core.List<api.Teacher> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTeacher(o[0]);
  checkTeacher(o[1]);
}
...
void checkListTeachersResponse(api.ListTeachersResponse o) {
  ...
  if (buildCounterListTeachersResponse < 3) {
    ...
    checkUnnamed6037(o.teachers!);
  }
  buildCounterListTeachersResponse--;
}

core.List<api.Topic> buildUnnamed6038() => [
      buildTopic(),
      buildTopic(),
    ];

void checkUnnamed6038(core.List<api.Topic> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTopic(o[0]);
  checkTopic(o[1]);
}
...
core.List<api.Attachment> buildUnnamed6039() => [
      buildAttachment(),
      buildAttachment(),
    ];

void checkUnnamed6039(core.List<api.Attachment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachment(o[0]);
  checkAttachment(o[1]);
}
...
api.ModifyAttachmentsRequest buildModifyAttachmentsRequest() {
  ...
  if (buildCounterModifyAttachmentsRequest < 3) {
    o.addAttachments = buildUnnamed6039();
  }
  buildCounterModifyAttachmentsRequest--;
  return o;
}
...
void checkModifyAttachmentsRequest(api.ModifyAttachmentsRequest o) {
  buildCounterModifyAttachmentsRequest++;
  if (buildCounterModifyAttachmentsRequest < 3) {
    checkUnnamed6039(o.addAttachments!);
  }
  buildCounterModifyAttachmentsRequest--;
}
...
api.ModifyIndividualStudentsOptions buildModifyIndividualStudentsOptions() {
  ...
  if (buildCounterModifyIndividualStudentsOptions < 3) {
    o.addStudentIds = buildUnnamed6040();
    o.removeStudentIds = buildUnnamed6041();
  }
  buildCounterModifyIndividualStudentsOptions--;
  return o;
}
...
void checkModifyIndividualStudentsOptions(
  ...
  buildCounterModifyIndividualStudentsOptions++;
  if (buildCounterModifyIndividualStudentsOptions < 3) {
    checkUnnamed6040(o.addStudentIds!);
    checkUnnamed6041(o.removeStudentIds!);
  }
  buildCounterModifyIndividualStudentsOptions--;
}
...
core.List<api.SubmissionHistory> buildUnnamed6043() => [
      buildSubmissionHistory(),
      buildSubmissionHistory(),
    ];

void checkUnnamed6043(core.List<api.SubmissionHistory> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.StudentSubmission buildStudentSubmission() {
  ...
  if (buildCounterStudentSubmission < 3) {
    ...
    o.state = 'foo';
    o.submissionHistory = buildUnnamed6043();
    o.updateTime = 'foo';
    o.userId = 'foo';
  }
  buildCounterStudentSubmission--;
...
void checkStudentSubmission(api.StudentSubmission o) {
  ...
  if (buildCounterStudentSubmission < 3) {
    ...
    checkUnnamed6043(o.submissionHistory!);
    unittest.expect(
      o.updateTime!,
      unittest.equals('foo'),
    );
...
core.List<api.GlobalPermission> buildUnnamed6044() => [
      buildGlobalPermission(),
      buildGlobalPermission(),
    ];

void checkUnnamed6044(core.List<api.GlobalPermission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void main() {
  ...
  unittest.group('resource-CoursesResource', () {
    ...
    unittest.test('method--list', () async {
      final mock = HttpServerMock();
      final res = api.ClassroomApi(mock).courses;
      final arg_courseStates = buildUnnamed6045();
  ...
  unittest.group('resource-CoursesAnnouncementsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.ClassroomApi(mock).courses.announcements;
      final arg_courseId = 'foo';
      final arg_announcementStates = buildUnnamed6046();
  ...
  unittest.group('resource-CoursesCourseWorkResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.ClassroomApi(mock).courses.courseWork;
      final arg_courseId = 'foo';
      final arg_courseWorkStates = buildUnnamed6047();
      final arg_orderBy = 'foo';
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_$fields = 'foo';
  ...
  unittest.group('resource-CoursesCourseWorkStudentSubmissionsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_states = buildUnnamed6048();
  ...
  unittest.group('resource-CoursesCourseWorkMaterialsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.ClassroomApi(mock).courses.courseWorkMaterials;
      final arg_courseId = 'foo';
      final arg_courseWorkMaterialStates = buildUnnamed6049();
  ...
  unittest.group('resource-UserProfilesGuardianInvitationsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_states = buildUnnamed6050();
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final path = (req.url).path;
        var pathOffset = 0;
