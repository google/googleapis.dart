...
core.List<api.Material> buildUnnamed5549() {
  var o = <api.Material>[];
  o.add(buildMaterial());
  o.add(buildMaterial());
  return o;
...
void checkUnnamed5549(core.List<api.Material> o) {
...
core.List<api.Attachment> buildUnnamed5550() {
...
void checkUnnamed5550(core.List<api.Attachment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AssignmentSubmission buildAssignmentSubmission() {
  ...
  if (buildCounterAssignmentSubmission < 3) {
    o.attachments = buildUnnamed5550();
  }
  buildCounterAssignmentSubmission--;
  return o;
}
...
void checkAssignmentSubmission(api.AssignmentSubmission o) {
  buildCounterAssignmentSubmission++;
  if (buildCounterAssignmentSubmission < 3) {
    checkUnnamed5550(o.attachments!);
  }
  buildCounterAssignmentSubmission--;
}
...
core.List<api.CourseMaterialSet> buildUnnamed5551() {
...
void checkUnnamed5551(core.List<api.CourseMaterialSet> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Course buildCourse() {
  ...
  if (buildCounterCourse < 3) {
    ...
    o.courseMaterialSets = buildUnnamed5551();
    o.courseState = 'foo';
    o.creationTime = 'foo';
    o.description = 'foo';
...
void checkCourse(api.Course o) {
  ...
  if (buildCounterCourse < 3) {
    ...
    checkUnnamed5551(o.courseMaterialSets!);
    unittest.expect(
      o.courseState!,
      unittest.equals('foo'),
    );
...
core.List<api.CourseMaterial> buildUnnamed5552() {
  var o = <api.CourseMaterial>[];
...
void checkUnnamed5552(core.List<api.CourseMaterial> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Material> buildUnnamed5553() {
  var o = <api.Material>[];
  o.add(buildMaterial());
  o.add(buildMaterial());
  return o;
...
void checkUnnamed5553(core.List<api.Material> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMaterial(o[0] as api.Material);
  checkMaterial(o[1] as api.Material);
}
...
core.List<api.Material> buildUnnamed5554() {
  var o = <api.Material>[];
  o.add(buildMaterial());
  o.add(buildMaterial());
  return o;
...
void checkUnnamed5554(core.List<api.Material> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMaterial(o[0] as api.Material);
  checkMaterial(o[1] as api.Material);
}
...
core.List<api.Announcement> buildUnnamed5556() {
  var o = <api.Announcement>[];
...
void checkUnnamed5556(core.List<api.Announcement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListAnnouncementsResponse buildListAnnouncementsResponse() {
  ...
  if (buildCounterListAnnouncementsResponse < 3) {
    o.announcements = buildUnnamed5556();
    o.nextPageToken = 'foo';
  }
  buildCounterListAnnouncementsResponse--;
  return o;
...
void checkListAnnouncementsResponse(api.ListAnnouncementsResponse o) {
  buildCounterListAnnouncementsResponse++;
  if (buildCounterListAnnouncementsResponse < 3) {
    checkUnnamed5556(o.announcements!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.CourseAlias> buildUnnamed5557() {
  var o = <api.CourseAlias>[];
...
void checkUnnamed5557(core.List<api.CourseAlias> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.CourseWorkMaterial> buildUnnamed5558() {
  var o = <api.CourseWorkMaterial>[];
...
void checkUnnamed5558(core.List<api.CourseWorkMaterial> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListCourseWorkMaterialResponse buildListCourseWorkMaterialResponse() {
  ...
  if (buildCounterListCourseWorkMaterialResponse < 3) {
    o.courseWorkMaterial = buildUnnamed5558();
    o.nextPageToken = 'foo';
  }
  buildCounterListCourseWorkMaterialResponse--;
  return o;
...
void checkListCourseWorkMaterialResponse(api.ListCourseWorkMaterialResponse o) {
  buildCounterListCourseWorkMaterialResponse++;
  if (buildCounterListCourseWorkMaterialResponse < 3) {
    checkUnnamed5558(o.courseWorkMaterial!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.CourseWork> buildUnnamed5559() {
  var o = <api.CourseWork>[];
...
void checkUnnamed5559(core.List<api.CourseWork> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Course> buildUnnamed5560() {
  var o = <api.Course>[];
  o.add(buildCourse());
  o.add(buildCourse());
  return o;
...
void checkUnnamed5560(core.List<api.Course> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GuardianInvitation> buildUnnamed5561() {
  var o = <api.GuardianInvitation>[];
...
void checkUnnamed5561(core.List<api.GuardianInvitation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListGuardianInvitationsResponse buildListGuardianInvitationsResponse() {
  ...
  if (buildCounterListGuardianInvitationsResponse < 3) {
    o.guardianInvitations = buildUnnamed5561();
    o.nextPageToken = 'foo';
  }
  buildCounterListGuardianInvitationsResponse--;
  return o;
...
void checkListGuardianInvitationsResponse(
  ...
  buildCounterListGuardianInvitationsResponse++;
  if (buildCounterListGuardianInvitationsResponse < 3) {
    checkUnnamed5561(o.guardianInvitations!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Guardian> buildUnnamed5562() {
  var o = <api.Guardian>[];
  o.add(buildGuardian());
  o.add(buildGuardian());
  return o;
...
void checkUnnamed5562(core.List<api.Guardian> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Invitation> buildUnnamed5563() {
  var o = <api.Invitation>[];
...
void checkUnnamed5563(core.List<api.Invitation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListInvitationsResponse buildListInvitationsResponse() {
  ...
  if (buildCounterListInvitationsResponse < 3) {
    o.invitations = buildUnnamed5563();
    o.nextPageToken = 'foo';
  }
  buildCounterListInvitationsResponse--;
  return o;
...
void checkListInvitationsResponse(api.ListInvitationsResponse o) {
  buildCounterListInvitationsResponse++;
  if (buildCounterListInvitationsResponse < 3) {
    checkUnnamed5563(o.invitations!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.StudentSubmission> buildUnnamed5564() {
...
void checkUnnamed5564(core.List<api.StudentSubmission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListStudentSubmissionsResponse buildListStudentSubmissionsResponse() {
  ...
  if (buildCounterListStudentSubmissionsResponse < 3) {
    o.nextPageToken = 'foo';
    o.studentSubmissions = buildUnnamed5564();
  }
  buildCounterListStudentSubmissionsResponse--;
  return o;
}
...
void checkListStudentSubmissionsResponse(api.ListStudentSubmissionsResponse o) {
  ...
  if (buildCounterListStudentSubmissionsResponse < 3) {
    ...
    checkUnnamed5564(o.studentSubmissions!);
  }
  buildCounterListStudentSubmissionsResponse--;
}

core.List<api.Student> buildUnnamed5565() {
  var o = <api.Student>[];
  o.add(buildStudent());
  o.add(buildStudent());
  return o;
...
void checkUnnamed5565(core.List<api.Student> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListStudentsResponse(api.ListStudentsResponse o) {
  ...
  if (buildCounterListStudentsResponse < 3) {
    ...
    checkUnnamed5565(o.students!);
  }
  buildCounterListStudentsResponse--;
}

core.List<api.Teacher> buildUnnamed5566() {
  var o = <api.Teacher>[];
  o.add(buildTeacher());
  o.add(buildTeacher());
  return o;
...
void checkUnnamed5566(core.List<api.Teacher> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListTeachersResponse(api.ListTeachersResponse o) {
  ...
  if (buildCounterListTeachersResponse < 3) {
    ...
    checkUnnamed5566(o.teachers!);
  }
  buildCounterListTeachersResponse--;
}

core.List<api.Topic> buildUnnamed5567() {
  var o = <api.Topic>[];
  o.add(buildTopic());
  o.add(buildTopic());
  return o;
...
void checkUnnamed5567(core.List<api.Topic> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Attachment> buildUnnamed5568() {
  var o = <api.Attachment>[];
  o.add(buildAttachment());
  o.add(buildAttachment());
  return o;
...
void checkUnnamed5568(core.List<api.Attachment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachment(o[0] as api.Attachment);
  checkAttachment(o[1] as api.Attachment);
}
...
api.ModifyAttachmentsRequest buildModifyAttachmentsRequest() {
  ...
  if (buildCounterModifyAttachmentsRequest < 3) {
    o.addAttachments = buildUnnamed5568();
  }
  buildCounterModifyAttachmentsRequest--;
  return o;
}
...
void checkModifyAttachmentsRequest(api.ModifyAttachmentsRequest o) {
  buildCounterModifyAttachmentsRequest++;
  if (buildCounterModifyAttachmentsRequest < 3) {
    checkUnnamed5568(o.addAttachments!);
  }
  buildCounterModifyAttachmentsRequest--;
}
...
api.ModifyIndividualStudentsOptions buildModifyIndividualStudentsOptions() {
  ...
  if (buildCounterModifyIndividualStudentsOptions < 3) {
    o.addStudentIds = buildUnnamed5569();
    o.removeStudentIds = buildUnnamed5570();
  }
  buildCounterModifyIndividualStudentsOptions--;
  return o;
}
...
void checkModifyIndividualStudentsOptions(
  ...
  buildCounterModifyIndividualStudentsOptions++;
  if (buildCounterModifyIndividualStudentsOptions < 3) {
    checkUnnamed5569(o.addStudentIds!);
    checkUnnamed5570(o.removeStudentIds!);
  }
  buildCounterModifyIndividualStudentsOptions--;
}
...
core.List<api.SubmissionHistory> buildUnnamed5572() {
...
void checkUnnamed5572(core.List<api.SubmissionHistory> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.StudentSubmission buildStudentSubmission() {
  ...
  if (buildCounterStudentSubmission < 3) {
    ...
    o.state = 'foo';
    o.submissionHistory = buildUnnamed5572();
    o.updateTime = 'foo';
    o.userId = 'foo';
  }
  buildCounterStudentSubmission--;
...
void checkStudentSubmission(api.StudentSubmission o) {
  ...
  if (buildCounterStudentSubmission < 3) {
    ...
    checkUnnamed5572(o.submissionHistory!);
    unittest.expect(
      o.updateTime!,
      unittest.equals('foo'),
    );
...
core.List<api.GlobalPermission> buildUnnamed5573() {
  var o = <api.GlobalPermission>[];
...
void checkUnnamed5573(core.List<api.GlobalPermission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.UserProfile buildUserProfile() {
  ...
  if (buildCounterUserProfile < 3) {
    ...
    o.id = 'foo';
    o.name = buildName();
    o.permissions = buildUnnamed5573();
    o.photoUrl = 'foo';
...
void checkUserProfile(api.UserProfile o) {
  ...
  if (buildCounterUserProfile < 3) {
    ...
    checkUnnamed5573(o.permissions!);
    unittest.expect(
      o.photoUrl!,
      unittest.equals('foo'),
    );
...
void main() {
  ...
  unittest.group('resource-CoursesResource', () {
    ...
    unittest.test('method--list', () async {
      var mock = HttpServerMock();
      var res = api.ClassroomApi(mock).courses;
      var arg_courseStates = buildUnnamed5574();
      var arg_pageSize = 42;
  ...
  unittest.group('resource-CoursesAnnouncementsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      var res = api.ClassroomApi(mock).courses.announcements;
      var arg_courseId = 'foo';
      var arg_announcementStates = buildUnnamed5575();
      var arg_orderBy = 'foo';
      var arg_pageSize = 42;
      var arg_pageToken = 'foo';
      var arg_$fields = 'foo';
  ...
  unittest.group('resource-CoursesCourseWorkResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      var res = api.ClassroomApi(mock).courses.courseWork;
      var arg_courseId = 'foo';
      var arg_courseWorkStates = buildUnnamed5576();
      var arg_orderBy = 'foo';
      var arg_pageSize = 42;
      var arg_pageToken = 'foo';
      var arg_$fields = 'foo';
  ...
  unittest.group('resource-CoursesCourseWorkStudentSubmissionsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      var arg_pageSize = 42;
      var arg_pageToken = 'foo';
      var arg_states = buildUnnamed5577();
      var arg_userId = 'foo';
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
  ...
  unittest.group('resource-CoursesCourseWorkMaterialsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      var res = api.ClassroomApi(mock).courses.courseWorkMaterials;
      var arg_courseId = 'foo';
      var arg_courseWorkMaterialStates = buildUnnamed5578();
  ...
  unittest.group('resource-UserProfilesGuardianInvitationsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      var arg_pageSize = 42;
      var arg_pageToken = 'foo';
      var arg_states = buildUnnamed5579();
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
