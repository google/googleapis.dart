...
core.List<api.Material> buildUnnamed3645() => [
      buildMaterial(),
      buildMaterial(),
    ];

void checkUnnamed3645(core.List<api.Material> o) {
...
core.List<api.Attachment> buildUnnamed3646() => [
      buildAttachment(),
      buildAttachment(),
    ];

void checkUnnamed3646(core.List<api.Attachment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachment(o[0]);
  checkAttachment(o[1]);
}
...
api.AssignmentSubmission buildAssignmentSubmission() {
  ...
  if (buildCounterAssignmentSubmission < 3) {
    o.attachments = buildUnnamed3646();
  }
  buildCounterAssignmentSubmission--;
  return o;
}
...
void checkAssignmentSubmission(api.AssignmentSubmission o) {
  buildCounterAssignmentSubmission++;
  if (buildCounterAssignmentSubmission < 3) {
    checkUnnamed3646(o.attachments!);
  }
  buildCounterAssignmentSubmission--;
}
...
core.List<api.CourseMaterialSet> buildUnnamed3647() => [
      buildCourseMaterialSet(),
      buildCourseMaterialSet(),
    ];

void checkUnnamed3647(core.List<api.CourseMaterialSet> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Course buildCourse() {
  ...
  if (buildCounterCourse < 3) {
    ...
    o.courseMaterialSets = buildUnnamed3647();
    o.courseState = 'foo';
    o.creationTime = 'foo';
    o.description = 'foo';
...
void checkCourse(api.Course o) {
  ...
  if (buildCounterCourse < 3) {
    ...
    checkUnnamed3647(o.courseMaterialSets!);
    unittest.expect(
      o.courseState!,
      unittest.equals('foo'),
    );
...
core.List<api.CourseMaterial> buildUnnamed3648() => [
      buildCourseMaterial(),
      buildCourseMaterial(),
    ];

void checkUnnamed3648(core.List<api.CourseMaterial> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Material> buildUnnamed3649() => [
      buildMaterial(),
      buildMaterial(),
    ];

void checkUnnamed3649(core.List<api.Material> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMaterial(o[0]);
  checkMaterial(o[1]);
}
...
core.List<api.Material> buildUnnamed3650() => [
      buildMaterial(),
      buildMaterial(),
    ];

void checkUnnamed3650(core.List<api.Material> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMaterial(o[0]);
  checkMaterial(o[1]);
}
...
core.List<api.Announcement> buildUnnamed3652() => [
      buildAnnouncement(),
      buildAnnouncement(),
    ];

void checkUnnamed3652(core.List<api.Announcement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListAnnouncementsResponse buildListAnnouncementsResponse() {
  ...
  if (buildCounterListAnnouncementsResponse < 3) {
    o.announcements = buildUnnamed3652();
    o.nextPageToken = 'foo';
  }
  buildCounterListAnnouncementsResponse--;
  return o;
...
void checkListAnnouncementsResponse(api.ListAnnouncementsResponse o) {
  buildCounterListAnnouncementsResponse++;
  if (buildCounterListAnnouncementsResponse < 3) {
    checkUnnamed3652(o.announcements!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.CourseAlias> buildUnnamed3653() => [
      buildCourseAlias(),
      buildCourseAlias(),
    ];

void checkUnnamed3653(core.List<api.CourseAlias> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.CourseWorkMaterial> buildUnnamed3654() => [
      buildCourseWorkMaterial(),
      buildCourseWorkMaterial(),
    ];

void checkUnnamed3654(core.List<api.CourseWorkMaterial> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListCourseWorkMaterialResponse buildListCourseWorkMaterialResponse() {
  ...
  if (buildCounterListCourseWorkMaterialResponse < 3) {
    o.courseWorkMaterial = buildUnnamed3654();
    o.nextPageToken = 'foo';
  }
  buildCounterListCourseWorkMaterialResponse--;
  return o;
...
void checkListCourseWorkMaterialResponse(api.ListCourseWorkMaterialResponse o) {
  buildCounterListCourseWorkMaterialResponse++;
  if (buildCounterListCourseWorkMaterialResponse < 3) {
    checkUnnamed3654(o.courseWorkMaterial!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.CourseWork> buildUnnamed3655() => [
      buildCourseWork(),
      buildCourseWork(),
    ];

void checkUnnamed3655(core.List<api.CourseWork> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCourseWork(o[0]);
  checkCourseWork(o[1]);
}
...
core.List<api.Course> buildUnnamed3656() => [
      buildCourse(),
      buildCourse(),
    ];

void checkUnnamed3656(core.List<api.Course> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCourse(o[0]);
  checkCourse(o[1]);
}
...
core.List<api.GuardianInvitation> buildUnnamed3657() => [
      buildGuardianInvitation(),
      buildGuardianInvitation(),
    ];

void checkUnnamed3657(core.List<api.GuardianInvitation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListGuardianInvitationsResponse buildListGuardianInvitationsResponse() {
  ...
  if (buildCounterListGuardianInvitationsResponse < 3) {
    o.guardianInvitations = buildUnnamed3657();
    o.nextPageToken = 'foo';
  }
  buildCounterListGuardianInvitationsResponse--;
  return o;
...
void checkListGuardianInvitationsResponse(
  ...
  buildCounterListGuardianInvitationsResponse++;
  if (buildCounterListGuardianInvitationsResponse < 3) {
    checkUnnamed3657(o.guardianInvitations!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Guardian> buildUnnamed3658() => [
      buildGuardian(),
      buildGuardian(),
    ];

void checkUnnamed3658(core.List<api.Guardian> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGuardian(o[0]);
  checkGuardian(o[1]);
}
...
core.List<api.Invitation> buildUnnamed3659() => [
      buildInvitation(),
      buildInvitation(),
    ];

void checkUnnamed3659(core.List<api.Invitation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInvitation(o[0]);
  checkInvitation(o[1]);
}
...
api.ListInvitationsResponse buildListInvitationsResponse() {
  ...
  if (buildCounterListInvitationsResponse < 3) {
    o.invitations = buildUnnamed3659();
    o.nextPageToken = 'foo';
  }
  buildCounterListInvitationsResponse--;
  return o;
...
void checkListInvitationsResponse(api.ListInvitationsResponse o) {
  buildCounterListInvitationsResponse++;
  if (buildCounterListInvitationsResponse < 3) {
    checkUnnamed3659(o.invitations!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.StudentSubmission> buildUnnamed3660() => [
      buildStudentSubmission(),
      buildStudentSubmission(),
    ];

void checkUnnamed3660(core.List<api.StudentSubmission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListStudentSubmissionsResponse buildListStudentSubmissionsResponse() {
  ...
  if (buildCounterListStudentSubmissionsResponse < 3) {
    o.nextPageToken = 'foo';
    o.studentSubmissions = buildUnnamed3660();
  }
  buildCounterListStudentSubmissionsResponse--;
  return o;
}
...
void checkListStudentSubmissionsResponse(api.ListStudentSubmissionsResponse o) {
  ...
  if (buildCounterListStudentSubmissionsResponse < 3) {
    ...
    checkUnnamed3660(o.studentSubmissions!);
  }
  buildCounterListStudentSubmissionsResponse--;
}

core.List<api.Student> buildUnnamed3661() => [
      buildStudent(),
      buildStudent(),
    ];

void checkUnnamed3661(core.List<api.Student> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStudent(o[0]);
  checkStudent(o[1]);
}
...
void checkListStudentsResponse(api.ListStudentsResponse o) {
  ...
  if (buildCounterListStudentsResponse < 3) {
    ...
    checkUnnamed3661(o.students!);
  }
  buildCounterListStudentsResponse--;
}

core.List<api.Teacher> buildUnnamed3662() => [
      buildTeacher(),
      buildTeacher(),
    ];

void checkUnnamed3662(core.List<api.Teacher> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTeacher(o[0]);
  checkTeacher(o[1]);
}
...
void checkListTeachersResponse(api.ListTeachersResponse o) {
  ...
  if (buildCounterListTeachersResponse < 3) {
    ...
    checkUnnamed3662(o.teachers!);
  }
  buildCounterListTeachersResponse--;
}

core.List<api.Topic> buildUnnamed3663() => [
      buildTopic(),
      buildTopic(),
    ];

void checkUnnamed3663(core.List<api.Topic> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTopic(o[0]);
  checkTopic(o[1]);
}
...
core.List<api.Attachment> buildUnnamed3664() => [
      buildAttachment(),
      buildAttachment(),
    ];

void checkUnnamed3664(core.List<api.Attachment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachment(o[0]);
  checkAttachment(o[1]);
}
...
api.ModifyAttachmentsRequest buildModifyAttachmentsRequest() {
  ...
  if (buildCounterModifyAttachmentsRequest < 3) {
    o.addAttachments = buildUnnamed3664();
  }
  buildCounterModifyAttachmentsRequest--;
  return o;
}
...
void checkModifyAttachmentsRequest(api.ModifyAttachmentsRequest o) {
  buildCounterModifyAttachmentsRequest++;
  if (buildCounterModifyAttachmentsRequest < 3) {
    checkUnnamed3664(o.addAttachments!);
  }
  buildCounterModifyAttachmentsRequest--;
}
...
api.ModifyIndividualStudentsOptions buildModifyIndividualStudentsOptions() {
  ...
  if (buildCounterModifyIndividualStudentsOptions < 3) {
    o.addStudentIds = buildUnnamed3665();
    o.removeStudentIds = buildUnnamed3666();
  }
  buildCounterModifyIndividualStudentsOptions--;
  return o;
}
...
void checkModifyIndividualStudentsOptions(
  ...
  buildCounterModifyIndividualStudentsOptions++;
  if (buildCounterModifyIndividualStudentsOptions < 3) {
    checkUnnamed3665(o.addStudentIds!);
    checkUnnamed3666(o.removeStudentIds!);
  }
  buildCounterModifyIndividualStudentsOptions--;
}
...
core.List<api.SubmissionHistory> buildUnnamed3668() => [
      buildSubmissionHistory(),
      buildSubmissionHistory(),
    ];

void checkUnnamed3668(core.List<api.SubmissionHistory> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.StudentSubmission buildStudentSubmission() {
  ...
  if (buildCounterStudentSubmission < 3) {
    ...
    o.state = 'foo';
    o.submissionHistory = buildUnnamed3668();
    o.updateTime = 'foo';
    o.userId = 'foo';
  }
  buildCounterStudentSubmission--;
...
void checkStudentSubmission(api.StudentSubmission o) {
  ...
  if (buildCounterStudentSubmission < 3) {
    ...
    checkUnnamed3668(o.submissionHistory!);
    unittest.expect(
      o.updateTime!,
      unittest.equals('foo'),
    );
...
core.List<api.GlobalPermission> buildUnnamed3669() => [
      buildGlobalPermission(),
      buildGlobalPermission(),
    ];

void checkUnnamed3669(core.List<api.GlobalPermission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.UserProfile buildUserProfile() {
  ...
  if (buildCounterUserProfile < 3) {
    ...
    o.id = 'foo';
    o.name = buildName();
    o.permissions = buildUnnamed3669();
    o.photoUrl = 'foo';
...
void checkUserProfile(api.UserProfile o) {
  ...
  if (buildCounterUserProfile < 3) {
    ...
    checkName(o.name!);
    checkUnnamed3669(o.permissions!);
    unittest.expect(
      o.photoUrl!,
      unittest.equals('foo'),
    );
...
void main() {
  ...
  unittest.group('resource-CoursesResource', () {
    ...
    unittest.test('method--list', () async {
      final mock = HttpServerMock();
      final res = api.ClassroomApi(mock).courses;
      final arg_courseStates = buildUnnamed3670();
  ...
  unittest.group('resource-CoursesAnnouncementsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.ClassroomApi(mock).courses.announcements;
      final arg_courseId = 'foo';
      final arg_announcementStates = buildUnnamed3671();
  ...
  unittest.group('resource-CoursesCourseWorkResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.ClassroomApi(mock).courses.courseWork;
      final arg_courseId = 'foo';
      final arg_courseWorkStates = buildUnnamed3672();
      final arg_orderBy = 'foo';
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_$fields = 'foo';
  ...
  unittest.group('resource-CoursesCourseWorkStudentSubmissionsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_states = buildUnnamed3673();
  ...
  unittest.group('resource-CoursesCourseWorkMaterialsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.ClassroomApi(mock).courses.courseWorkMaterials;
      final arg_courseId = 'foo';
      final arg_courseWorkMaterialStates = buildUnnamed3674();
  ...
  unittest.group('resource-UserProfilesGuardianInvitationsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_states = buildUnnamed3675();
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final path = (req.url).path;
        var pathOffset = 0;
