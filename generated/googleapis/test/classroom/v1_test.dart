...
core.List<api.Material> buildUnnamed6095() => [
      buildMaterial(),
      buildMaterial(),
    ];

void checkUnnamed6095(core.List<api.Material> o) {
...
core.List<api.Attachment> buildUnnamed6096() => [
      buildAttachment(),
      buildAttachment(),
    ];

void checkUnnamed6096(core.List<api.Attachment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachment(o[0]);
  checkAttachment(o[1]);
}
...
api.AssignmentSubmission buildAssignmentSubmission() {
  ...
  if (buildCounterAssignmentSubmission < 3) {
    o.attachments = buildUnnamed6096();
  }
  buildCounterAssignmentSubmission--;
  return o;
}
...
void checkAssignmentSubmission(api.AssignmentSubmission o) {
  buildCounterAssignmentSubmission++;
  if (buildCounterAssignmentSubmission < 3) {
    checkUnnamed6096(o.attachments!);
  }
  buildCounterAssignmentSubmission--;
}
...
core.List<api.CourseMaterialSet> buildUnnamed6097() => [
      buildCourseMaterialSet(),
      buildCourseMaterialSet(),
    ];

void checkUnnamed6097(core.List<api.CourseMaterialSet> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Course buildCourse() {
  ...
  if (buildCounterCourse < 3) {
    ...
    o.courseMaterialSets = buildUnnamed6097();
    o.courseState = 'foo';
    o.creationTime = 'foo';
    o.description = 'foo';
...
void checkCourse(api.Course o) {
  ...
  if (buildCounterCourse < 3) {
    ...
    checkUnnamed6097(o.courseMaterialSets!);
    unittest.expect(
      o.courseState!,
      unittest.equals('foo'),
    );
...
core.List<api.CourseMaterial> buildUnnamed6098() => [
      buildCourseMaterial(),
      buildCourseMaterial(),
    ];

void checkUnnamed6098(core.List<api.CourseMaterial> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Material> buildUnnamed6099() => [
      buildMaterial(),
      buildMaterial(),
    ];

void checkUnnamed6099(core.List<api.Material> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMaterial(o[0]);
  checkMaterial(o[1]);
}
...
core.List<api.Material> buildUnnamed6100() => [
      buildMaterial(),
      buildMaterial(),
    ];

void checkUnnamed6100(core.List<api.Material> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMaterial(o[0]);
  checkMaterial(o[1]);
}
...
core.List<api.Announcement> buildUnnamed6102() => [
      buildAnnouncement(),
      buildAnnouncement(),
    ];

void checkUnnamed6102(core.List<api.Announcement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListAnnouncementsResponse buildListAnnouncementsResponse() {
  ...
  if (buildCounterListAnnouncementsResponse < 3) {
    o.announcements = buildUnnamed6102();
    o.nextPageToken = 'foo';
  }
  buildCounterListAnnouncementsResponse--;
  return o;
...
void checkListAnnouncementsResponse(api.ListAnnouncementsResponse o) {
  buildCounterListAnnouncementsResponse++;
  if (buildCounterListAnnouncementsResponse < 3) {
    checkUnnamed6102(o.announcements!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.CourseAlias> buildUnnamed6103() => [
      buildCourseAlias(),
      buildCourseAlias(),
    ];

void checkUnnamed6103(core.List<api.CourseAlias> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.CourseWorkMaterial> buildUnnamed6104() => [
      buildCourseWorkMaterial(),
      buildCourseWorkMaterial(),
    ];

void checkUnnamed6104(core.List<api.CourseWorkMaterial> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListCourseWorkMaterialResponse buildListCourseWorkMaterialResponse() {
  ...
  if (buildCounterListCourseWorkMaterialResponse < 3) {
    o.courseWorkMaterial = buildUnnamed6104();
    o.nextPageToken = 'foo';
  }
  buildCounterListCourseWorkMaterialResponse--;
  return o;
...
void checkListCourseWorkMaterialResponse(api.ListCourseWorkMaterialResponse o) {
  buildCounterListCourseWorkMaterialResponse++;
  if (buildCounterListCourseWorkMaterialResponse < 3) {
    checkUnnamed6104(o.courseWorkMaterial!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.CourseWork> buildUnnamed6105() => [
      buildCourseWork(),
      buildCourseWork(),
    ];

void checkUnnamed6105(core.List<api.CourseWork> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCourseWork(o[0]);
  checkCourseWork(o[1]);
}
...
core.List<api.Course> buildUnnamed6106() => [
      buildCourse(),
      buildCourse(),
    ];

void checkUnnamed6106(core.List<api.Course> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCourse(o[0]);
  checkCourse(o[1]);
}
...
core.List<api.GuardianInvitation> buildUnnamed6107() => [
      buildGuardianInvitation(),
      buildGuardianInvitation(),
    ];

void checkUnnamed6107(core.List<api.GuardianInvitation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListGuardianInvitationsResponse buildListGuardianInvitationsResponse() {
  ...
  if (buildCounterListGuardianInvitationsResponse < 3) {
    o.guardianInvitations = buildUnnamed6107();
    o.nextPageToken = 'foo';
  }
  buildCounterListGuardianInvitationsResponse--;
  return o;
...
void checkListGuardianInvitationsResponse(
  ...
  buildCounterListGuardianInvitationsResponse++;
  if (buildCounterListGuardianInvitationsResponse < 3) {
    checkUnnamed6107(o.guardianInvitations!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Guardian> buildUnnamed6108() => [
      buildGuardian(),
      buildGuardian(),
    ];

void checkUnnamed6108(core.List<api.Guardian> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGuardian(o[0]);
  checkGuardian(o[1]);
}
...
core.List<api.Invitation> buildUnnamed6109() => [
      buildInvitation(),
      buildInvitation(),
    ];

void checkUnnamed6109(core.List<api.Invitation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInvitation(o[0]);
  checkInvitation(o[1]);
}
...
api.ListInvitationsResponse buildListInvitationsResponse() {
  ...
  if (buildCounterListInvitationsResponse < 3) {
    o.invitations = buildUnnamed6109();
    o.nextPageToken = 'foo';
  }
  buildCounterListInvitationsResponse--;
  return o;
...
void checkListInvitationsResponse(api.ListInvitationsResponse o) {
  buildCounterListInvitationsResponse++;
  if (buildCounterListInvitationsResponse < 3) {
    checkUnnamed6109(o.invitations!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.StudentSubmission> buildUnnamed6110() => [
      buildStudentSubmission(),
      buildStudentSubmission(),
    ];

void checkUnnamed6110(core.List<api.StudentSubmission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListStudentSubmissionsResponse buildListStudentSubmissionsResponse() {
  ...
  if (buildCounterListStudentSubmissionsResponse < 3) {
    o.nextPageToken = 'foo';
    o.studentSubmissions = buildUnnamed6110();
  }
  buildCounterListStudentSubmissionsResponse--;
  return o;
}
...
void checkListStudentSubmissionsResponse(api.ListStudentSubmissionsResponse o) {
  ...
  if (buildCounterListStudentSubmissionsResponse < 3) {
    ...
    checkUnnamed6110(o.studentSubmissions!);
  }
  buildCounterListStudentSubmissionsResponse--;
}

core.List<api.Student> buildUnnamed6111() => [
      buildStudent(),
      buildStudent(),
    ];

void checkUnnamed6111(core.List<api.Student> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStudent(o[0]);
  checkStudent(o[1]);
}
...
void checkListStudentsResponse(api.ListStudentsResponse o) {
  ...
  if (buildCounterListStudentsResponse < 3) {
    ...
    checkUnnamed6111(o.students!);
  }
  buildCounterListStudentsResponse--;
}

core.List<api.Teacher> buildUnnamed6112() => [
      buildTeacher(),
      buildTeacher(),
    ];

void checkUnnamed6112(core.List<api.Teacher> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTeacher(o[0]);
  checkTeacher(o[1]);
}
...
void checkListTeachersResponse(api.ListTeachersResponse o) {
  ...
  if (buildCounterListTeachersResponse < 3) {
    ...
    checkUnnamed6112(o.teachers!);
  }
  buildCounterListTeachersResponse--;
}

core.List<api.Topic> buildUnnamed6113() => [
      buildTopic(),
      buildTopic(),
    ];

void checkUnnamed6113(core.List<api.Topic> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTopic(o[0]);
  checkTopic(o[1]);
}
...
core.List<api.Attachment> buildUnnamed6114() => [
      buildAttachment(),
      buildAttachment(),
    ];

void checkUnnamed6114(core.List<api.Attachment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachment(o[0]);
  checkAttachment(o[1]);
}
...
api.ModifyAttachmentsRequest buildModifyAttachmentsRequest() {
  ...
  if (buildCounterModifyAttachmentsRequest < 3) {
    o.addAttachments = buildUnnamed6114();
  }
  buildCounterModifyAttachmentsRequest--;
  return o;
}
...
void checkModifyAttachmentsRequest(api.ModifyAttachmentsRequest o) {
  buildCounterModifyAttachmentsRequest++;
  if (buildCounterModifyAttachmentsRequest < 3) {
    checkUnnamed6114(o.addAttachments!);
  }
  buildCounterModifyAttachmentsRequest--;
}
...
api.ModifyIndividualStudentsOptions buildModifyIndividualStudentsOptions() {
  ...
  if (buildCounterModifyIndividualStudentsOptions < 3) {
    o.addStudentIds = buildUnnamed6115();
    o.removeStudentIds = buildUnnamed6116();
  }
  buildCounterModifyIndividualStudentsOptions--;
  return o;
}
...
void checkModifyIndividualStudentsOptions(
  ...
  buildCounterModifyIndividualStudentsOptions++;
  if (buildCounterModifyIndividualStudentsOptions < 3) {
    checkUnnamed6115(o.addStudentIds!);
    checkUnnamed6116(o.removeStudentIds!);
  }
  buildCounterModifyIndividualStudentsOptions--;
}
...
core.List<api.SubmissionHistory> buildUnnamed6118() => [
      buildSubmissionHistory(),
      buildSubmissionHistory(),
    ];

void checkUnnamed6118(core.List<api.SubmissionHistory> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.StudentSubmission buildStudentSubmission() {
  ...
  if (buildCounterStudentSubmission < 3) {
    ...
    o.state = 'foo';
    o.submissionHistory = buildUnnamed6118();
    o.updateTime = 'foo';
    o.userId = 'foo';
  }
  buildCounterStudentSubmission--;
...
void checkStudentSubmission(api.StudentSubmission o) {
  ...
  if (buildCounterStudentSubmission < 3) {
    ...
    checkUnnamed6118(o.submissionHistory!);
    unittest.expect(
      o.updateTime!,
      unittest.equals('foo'),
    );
...
core.List<api.GlobalPermission> buildUnnamed6119() => [
      buildGlobalPermission(),
      buildGlobalPermission(),
    ];

void checkUnnamed6119(core.List<api.GlobalPermission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.UserProfile buildUserProfile() {
  ...
  if (buildCounterUserProfile < 3) {
    ...
    o.id = 'foo';
    o.name = buildName();
    o.permissions = buildUnnamed6119();
    o.photoUrl = 'foo';
...
void checkUserProfile(api.UserProfile o) {
  ...
  if (buildCounterUserProfile < 3) {
    ...
    checkName(o.name!);
    checkUnnamed6119(o.permissions!);
    unittest.expect(
      o.photoUrl!,
      unittest.equals('foo'),
    );
...
void main() {
  ...
  unittest.group('resource-CoursesResource', () {
    ...
    unittest.test('method--list', () async {
      final mock = HttpServerMock();
      final res = api.ClassroomApi(mock).courses;
      final arg_courseStates = buildUnnamed6120();
  ...
  unittest.group('resource-CoursesAnnouncementsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.ClassroomApi(mock).courses.announcements;
      final arg_courseId = 'foo';
      final arg_announcementStates = buildUnnamed6121();
  ...
  unittest.group('resource-CoursesCourseWorkResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.ClassroomApi(mock).courses.courseWork;
      final arg_courseId = 'foo';
      final arg_courseWorkStates = buildUnnamed6122();
      final arg_orderBy = 'foo';
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_$fields = 'foo';
  ...
  unittest.group('resource-CoursesCourseWorkStudentSubmissionsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_states = buildUnnamed6123();
  ...
  unittest.group('resource-CoursesCourseWorkMaterialsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.ClassroomApi(mock).courses.courseWorkMaterials;
      final arg_courseId = 'foo';
      final arg_courseWorkMaterialStates = buildUnnamed6124();
  ...
  unittest.group('resource-UserProfilesGuardianInvitationsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_states = buildUnnamed6125();
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final path = (req.url).path;
        var pathOffset = 0;
