...
core.List<api.Material> buildUnnamed6027() => [
      buildMaterial(),
      buildMaterial(),
    ];

void checkUnnamed6027(core.List<api.Material> o) {
...
core.List<api.Attachment> buildUnnamed6028() => [
      buildAttachment(),
      buildAttachment(),
    ];

void checkUnnamed6028(core.List<api.Attachment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachment(o[0]);
  checkAttachment(o[1]);
}
...
api.AssignmentSubmission buildAssignmentSubmission() {
  ...
  if (buildCounterAssignmentSubmission < 3) {
    o.attachments = buildUnnamed6028();
  }
  buildCounterAssignmentSubmission--;
  return o;
}
...
void checkAssignmentSubmission(api.AssignmentSubmission o) {
  buildCounterAssignmentSubmission++;
  if (buildCounterAssignmentSubmission < 3) {
    checkUnnamed6028(o.attachments!);
  }
  buildCounterAssignmentSubmission--;
}
...
core.List<api.CourseMaterialSet> buildUnnamed6029() => [
      buildCourseMaterialSet(),
      buildCourseMaterialSet(),
    ];

void checkUnnamed6029(core.List<api.CourseMaterialSet> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Course buildCourse() {
  ...
  if (buildCounterCourse < 3) {
    ...
    o.courseMaterialSets = buildUnnamed6029();
    o.courseState = 'foo';
    o.creationTime = 'foo';
    o.description = 'foo';
...
void checkCourse(api.Course o) {
  ...
  if (buildCounterCourse < 3) {
    ...
    checkUnnamed6029(o.courseMaterialSets!);
    unittest.expect(
      o.courseState!,
      unittest.equals('foo'),
    );
...
core.List<api.CourseMaterial> buildUnnamed6030() => [
      buildCourseMaterial(),
      buildCourseMaterial(),
    ];

void checkUnnamed6030(core.List<api.CourseMaterial> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Material> buildUnnamed6031() => [
      buildMaterial(),
      buildMaterial(),
    ];

void checkUnnamed6031(core.List<api.Material> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMaterial(o[0]);
  checkMaterial(o[1]);
}
...
core.List<api.Announcement> buildUnnamed6034() => [
      buildAnnouncement(),
      buildAnnouncement(),
    ];

void checkUnnamed6034(core.List<api.Announcement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListAnnouncementsResponse buildListAnnouncementsResponse() {
  ...
  if (buildCounterListAnnouncementsResponse < 3) {
    o.announcements = buildUnnamed6034();
    o.nextPageToken = 'foo';
  }
  buildCounterListAnnouncementsResponse--;
  return o;
...
void checkListAnnouncementsResponse(api.ListAnnouncementsResponse o) {
  buildCounterListAnnouncementsResponse++;
  if (buildCounterListAnnouncementsResponse < 3) {
    checkUnnamed6034(o.announcements!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.CourseAlias> buildUnnamed6035() => [
      buildCourseAlias(),
      buildCourseAlias(),
    ];

void checkUnnamed6035(core.List<api.CourseAlias> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.CourseWorkMaterial> buildUnnamed6036() => [
      buildCourseWorkMaterial(),
      buildCourseWorkMaterial(),
    ];

void checkUnnamed6036(core.List<api.CourseWorkMaterial> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListCourseWorkMaterialResponse buildListCourseWorkMaterialResponse() {
  ...
  if (buildCounterListCourseWorkMaterialResponse < 3) {
    o.courseWorkMaterial = buildUnnamed6036();
    o.nextPageToken = 'foo';
  }
  buildCounterListCourseWorkMaterialResponse--;
  return o;
...
void checkListCourseWorkMaterialResponse(api.ListCourseWorkMaterialResponse o) {
  buildCounterListCourseWorkMaterialResponse++;
  if (buildCounterListCourseWorkMaterialResponse < 3) {
    checkUnnamed6036(o.courseWorkMaterial!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.CourseWork> buildUnnamed6037() => [
      buildCourseWork(),
      buildCourseWork(),
    ];

void checkUnnamed6037(core.List<api.CourseWork> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCourseWork(o[0]);
  checkCourseWork(o[1]);
}
...
core.List<api.Course> buildUnnamed6038() => [
      buildCourse(),
      buildCourse(),
    ];

void checkUnnamed6038(core.List<api.Course> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCourse(o[0]);
  checkCourse(o[1]);
}
...
core.List<api.GuardianInvitation> buildUnnamed6039() => [
      buildGuardianInvitation(),
      buildGuardianInvitation(),
    ];

void checkUnnamed6039(core.List<api.GuardianInvitation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListGuardianInvitationsResponse buildListGuardianInvitationsResponse() {
  ...
  if (buildCounterListGuardianInvitationsResponse < 3) {
    o.guardianInvitations = buildUnnamed6039();
    o.nextPageToken = 'foo';
  }
  buildCounterListGuardianInvitationsResponse--;
  return o;
...
void checkListGuardianInvitationsResponse(
  ...
  buildCounterListGuardianInvitationsResponse++;
  if (buildCounterListGuardianInvitationsResponse < 3) {
    checkUnnamed6039(o.guardianInvitations!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Guardian> buildUnnamed6040() => [
      buildGuardian(),
      buildGuardian(),
    ];

void checkUnnamed6040(core.List<api.Guardian> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGuardian(o[0]);
  checkGuardian(o[1]);
}
...
core.List<api.Invitation> buildUnnamed6041() => [
      buildInvitation(),
      buildInvitation(),
    ];

void checkUnnamed6041(core.List<api.Invitation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInvitation(o[0]);
  checkInvitation(o[1]);
}
...
api.ListInvitationsResponse buildListInvitationsResponse() {
  ...
  if (buildCounterListInvitationsResponse < 3) {
    o.invitations = buildUnnamed6041();
    o.nextPageToken = 'foo';
  }
  buildCounterListInvitationsResponse--;
  return o;
...
void checkListInvitationsResponse(api.ListInvitationsResponse o) {
  buildCounterListInvitationsResponse++;
  if (buildCounterListInvitationsResponse < 3) {
    checkUnnamed6041(o.invitations!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.StudentSubmission> buildUnnamed6042() => [
      buildStudentSubmission(),
      buildStudentSubmission(),
    ];

void checkUnnamed6042(core.List<api.StudentSubmission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListStudentSubmissionsResponse buildListStudentSubmissionsResponse() {
  ...
  if (buildCounterListStudentSubmissionsResponse < 3) {
    o.nextPageToken = 'foo';
    o.studentSubmissions = buildUnnamed6042();
  }
  buildCounterListStudentSubmissionsResponse--;
  return o;
}
...
void checkListStudentSubmissionsResponse(api.ListStudentSubmissionsResponse o) {
  ...
  if (buildCounterListStudentSubmissionsResponse < 3) {
    ...
    checkUnnamed6042(o.studentSubmissions!);
  }
  buildCounterListStudentSubmissionsResponse--;
}

core.List<api.Student> buildUnnamed6043() => [
      buildStudent(),
      buildStudent(),
    ];

void checkUnnamed6043(core.List<api.Student> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStudent(o[0]);
  checkStudent(o[1]);
}
...
void checkListStudentsResponse(api.ListStudentsResponse o) {
  ...
  if (buildCounterListStudentsResponse < 3) {
    ...
    checkUnnamed6043(o.students!);
  }
  buildCounterListStudentsResponse--;
}

core.List<api.Teacher> buildUnnamed6044() => [
      buildTeacher(),
      buildTeacher(),
    ];

void checkUnnamed6044(core.List<api.Teacher> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTeacher(o[0]);
  checkTeacher(o[1]);
}
...
void checkListTeachersResponse(api.ListTeachersResponse o) {
  ...
  if (buildCounterListTeachersResponse < 3) {
    ...
    checkUnnamed6044(o.teachers!);
  }
  buildCounterListTeachersResponse--;
}

core.List<api.Topic> buildUnnamed6045() => [
      buildTopic(),
      buildTopic(),
    ];

void checkUnnamed6045(core.List<api.Topic> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTopic(o[0]);
  checkTopic(o[1]);
}
...
core.List<api.Attachment> buildUnnamed6046() => [
      buildAttachment(),
      buildAttachment(),
    ];

void checkUnnamed6046(core.List<api.Attachment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachment(o[0]);
  checkAttachment(o[1]);
}
...
api.ModifyAttachmentsRequest buildModifyAttachmentsRequest() {
  ...
  if (buildCounterModifyAttachmentsRequest < 3) {
    o.addAttachments = buildUnnamed6046();
  }
  buildCounterModifyAttachmentsRequest--;
  return o;
}
...
void checkModifyAttachmentsRequest(api.ModifyAttachmentsRequest o) {
  buildCounterModifyAttachmentsRequest++;
  if (buildCounterModifyAttachmentsRequest < 3) {
    checkUnnamed6046(o.addAttachments!);
  }
  buildCounterModifyAttachmentsRequest--;
}
...
api.ModifyIndividualStudentsOptions buildModifyIndividualStudentsOptions() {
  ...
  if (buildCounterModifyIndividualStudentsOptions < 3) {
    o.addStudentIds = buildUnnamed6047();
    o.removeStudentIds = buildUnnamed6048();
  }
  buildCounterModifyIndividualStudentsOptions--;
  return o;
}
...
void checkModifyIndividualStudentsOptions(
  ...
  buildCounterModifyIndividualStudentsOptions++;
  if (buildCounterModifyIndividualStudentsOptions < 3) {
    checkUnnamed6047(o.addStudentIds!);
    checkUnnamed6048(o.removeStudentIds!);
  }
  buildCounterModifyIndividualStudentsOptions--;
}
...
core.List<api.SubmissionHistory> buildUnnamed6050() => [
      buildSubmissionHistory(),
      buildSubmissionHistory(),
    ];

void checkUnnamed6050(core.List<api.SubmissionHistory> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.StudentSubmission buildStudentSubmission() {
  ...
  if (buildCounterStudentSubmission < 3) {
    ...
    o.state = 'foo';
    o.submissionHistory = buildUnnamed6050();
    o.updateTime = 'foo';
    o.userId = 'foo';
  }
  buildCounterStudentSubmission--;
...
void checkStudentSubmission(api.StudentSubmission o) {
  ...
  if (buildCounterStudentSubmission < 3) {
    ...
    checkUnnamed6050(o.submissionHistory!);
    unittest.expect(
      o.updateTime!,
      unittest.equals('foo'),
    );
...
core.List<api.GlobalPermission> buildUnnamed6051() => [
      buildGlobalPermission(),
      buildGlobalPermission(),
    ];

void checkUnnamed6051(core.List<api.GlobalPermission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void main() {
  ...
  unittest.group('resource-CoursesResource', () {
    ...
    unittest.test('method--list', () async {
      final mock = HttpServerMock();
      final res = api.ClassroomApi(mock).courses;
      final arg_courseStates = buildUnnamed6052();
  ...
  unittest.group('resource-CoursesAnnouncementsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.ClassroomApi(mock).courses.announcements;
      final arg_courseId = 'foo';
      final arg_announcementStates = buildUnnamed6053();
  ...
  unittest.group('resource-CoursesCourseWorkResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.ClassroomApi(mock).courses.courseWork;
      final arg_courseId = 'foo';
      final arg_courseWorkStates = buildUnnamed6054();
      final arg_orderBy = 'foo';
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_$fields = 'foo';
  ...
  unittest.group('resource-CoursesCourseWorkStudentSubmissionsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_states = buildUnnamed6055();
  ...
  unittest.group('resource-CoursesCourseWorkMaterialsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.ClassroomApi(mock).courses.courseWorkMaterials;
      final arg_courseId = 'foo';
      final arg_courseWorkMaterialStates = buildUnnamed6056();
  ...
  unittest.group('resource-UserProfilesGuardianInvitationsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_states = buildUnnamed6057();
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final path = (req.url).path;
        var pathOffset = 0;
