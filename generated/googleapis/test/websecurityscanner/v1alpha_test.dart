...
import 'package:googleapis/websecurityscanner/v1alpha.dart' as api;
...
core.List<api.CrawledUrl> buildUnnamed0() => [
  buildCrawledUrl(),
  buildCrawledUrl(),
];

void checkUnnamed0(core.List<api.CrawledUrl> o) {
...
void checkListCrawledUrlsResponse(api.ListCrawledUrlsResponse o) {
  buildCounterListCrawledUrlsResponse++;
  if (buildCounterListCrawledUrlsResponse < 3) {
    checkUnnamed0(o.crawledUrls!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListCrawledUrlsResponse--;
}

core.List<api.FindingTypeStats> buildUnnamed1() => [
  buildFindingTypeStats(),
  buildFindingTypeStats(),
];

void checkUnnamed1(core.List<api.FindingTypeStats> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListFindingTypeStatsResponse buildListFindingTypeStatsResponse() {
  ...
  if (buildCounterListFindingTypeStatsResponse < 3) {
    o.findingTypeStats = buildUnnamed1();
  }
  buildCounterListFindingTypeStatsResponse--;
  return o;
}
...
void checkListFindingTypeStatsResponse(api.ListFindingTypeStatsResponse o) {
  buildCounterListFindingTypeStatsResponse++;
  if (buildCounterListFindingTypeStatsResponse < 3) {
    checkUnnamed1(o.findingTypeStats!);
  }
  buildCounterListFindingTypeStatsResponse--;
}

core.List<api.Finding> buildUnnamed2() => [buildFinding(), buildFinding()];

void checkUnnamed2(core.List<api.Finding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFinding(o[0]);
  checkFinding(o[1]);
}
...
void checkListFindingsResponse(api.ListFindingsResponse o) {
  buildCounterListFindingsResponse++;
  if (buildCounterListFindingsResponse < 3) {
    checkUnnamed2(o.findings!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListFindingsResponse--;
}

core.List<api.ScanConfig> buildUnnamed3() => [
  buildScanConfig(),
  buildScanConfig(),
];

void checkUnnamed3(core.List<api.ScanConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkScanConfig(o[0]);
  checkScanConfig(o[1]);
}
...
void checkListScanConfigsResponse(api.ListScanConfigsResponse o) {
  ...
  if (buildCounterListScanConfigsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed3(o.scanConfigs!);
  }
  buildCounterListScanConfigsResponse--;
}

core.List<api.ScanRun> buildUnnamed4() => [buildScanRun(), buildScanRun()];

void checkUnnamed4(core.List<api.ScanRun> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkScanRun(o[0]);
  checkScanRun(o[1]);
}
...
api.ScanConfig buildScanConfig() {
  ...
  if (buildCounterScanConfig < 3) {
    ...
    o.blacklistPatterns = buildUnnamed6();
    o.displayName = 'foo';
    o.latestRun = buildScanRun();
    o.maxQps = 42;
    o.name = 'foo';
    o.schedule = buildSchedule();
    o.startingUrls = buildUnnamed7();
    o.targetPlatforms = buildUnnamed8();
    o.userAgent = 'foo';
  }
  buildCounterScanConfig--;
  return o;
...
core.List<api.Header> buildUnnamed9() => [buildHeader(), buildHeader()];

void checkUnnamed9(core.List<api.Header> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHeader(o[0]);
  checkHeader(o[1]);
}

core.List<api.Header> buildUnnamed10() => [buildHeader(), buildHeader()];
...
api.VulnerableHeaders buildVulnerableHeaders() {
  ...
  if (buildCounterVulnerableHeaders < 3) {
    ...
    o.missingHeaders = buildUnnamed10();
  }
  buildCounterVulnerableHeaders--;
  return o;
}
...
void checkVulnerableHeaders(api.VulnerableHeaders o) {
  ...
  if (buildCounterVulnerableHeaders < 3) {
    ...
    checkUnnamed10(o.missingHeaders!);
  }
  buildCounterVulnerableHeaders--;
}
...
api.VulnerableParameters buildVulnerableParameters() {
  ...
  if (buildCounterVulnerableParameters < 3) {
    o.parameterNames = buildUnnamed11();
  }
  buildCounterVulnerableParameters--;
  return o;
}
...
void checkVulnerableParameters(api.VulnerableParameters o) {
  buildCounterVulnerableParameters++;
  if (buildCounterVulnerableParameters < 3) {
    checkUnnamed11(o.parameterNames!);
  }
  buildCounterVulnerableParameters--;
}
...
void main() {
  ...
  unittest.group('obj-schema-CrawledUrl', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CrawledUrl.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCrawledUrl(od);
    });
  ...
  unittest.group(
    'resource-ProjectsScanConfigsScanRunsFindingTypeStatsResource',
    () {
      unittest.test('method--list', () async {
        final mock = HttpServerMock();
        final res =
