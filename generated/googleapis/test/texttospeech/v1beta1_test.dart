...
import 'package:googleapis/texttospeech/v1beta1.dart' as api;
...
api.SynthesizeSpeechRequest buildSynthesizeSpeechRequest() {
  ...
  if (buildCounterSynthesizeSpeechRequest < 3) {
    ...
    o.audioConfig = buildAudioConfig();
    o.enableTimePointing = buildUnnamed9();
    o.input = buildSynthesisInput();
    o.voice = buildVoiceSelectionParams();
  }
  buildCounterSynthesizeSpeechRequest--;
...
void checkSynthesizeSpeechRequest(api.SynthesizeSpeechRequest o) {
  ...
  if (buildCounterSynthesizeSpeechRequest < 3) {
    ...
    checkAudioConfig(o.audioConfig!);
    checkUnnamed9(o.enableTimePointing!);
    checkSynthesisInput(o.input!);
    checkVoiceSelectionParams(o.voice!);
  }
  buildCounterSynthesizeSpeechRequest--;
...
core.List<api.Timepoint> buildUnnamed10() => [
  buildTimepoint(),
  buildTimepoint(),
];

void checkUnnamed10(core.List<api.Timepoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTimepoint(o[0]);
  checkTimepoint(o[1]);
}
...
void checkSynthesizeSpeechResponse(api.SynthesizeSpeechResponse o) {
  ...
  if (buildCounterSynthesizeSpeechResponse < 3) {
    ...
    checkUnnamed10(o.timepoints!);
  }
  buildCounterSynthesizeSpeechResponse--;
}

core.int buildCounterTimepoint = 0;
api.Timepoint buildTimepoint() {
  final o = api.Timepoint();
  buildCounterTimepoint++;
  if (buildCounterTimepoint < 3) {
    o.markName = 'foo';
    o.timeSeconds = 42.0;
  }
  buildCounterTimepoint--;
...
void checkTimepoint(api.Timepoint o) {
  buildCounterTimepoint++;
  if (buildCounterTimepoint < 3) {
    unittest.expect(o.markName!, unittest.equals('foo'));
    unittest.expect(o.timeSeconds!, unittest.equals(42.0));
  }
  buildCounterTimepoint--;
}
...
void main() {
  ...
  unittest.group('obj-schema-Timepoint', () {
    unittest.test('to-json--from-json', () async {
      final o = buildTimepoint();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Timepoint.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkTimepoint(od);
    });
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            ...
            unittest.equals('v1beta1/text:synthesize'),
          );
          pathOffset += 23;
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            ...
            unittest.equals('v1beta1/voices'),
          );
          pathOffset += 14;
