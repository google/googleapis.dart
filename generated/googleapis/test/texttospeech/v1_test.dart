...
api.AudioConfig buildAudioConfig() {
  ...
  if (buildCounterAudioConfig < 3) {
    o.audioEncoding = 'foo';
    o.effectsProfileId = buildUnnamed5781();
    o.pitch = 42.0;
...
void checkAudioConfig(api.AudioConfig o) {
  ...
  if (buildCounterAudioConfig < 3) {
    ...
    checkUnnamed5781(o.effectsProfileId!);
    unittest.expect(
      o.pitch!,
...
core.List<api.Voice> buildUnnamed5782() => [
      buildVoice(),
      buildVoice(),
    ];

void checkUnnamed5782(core.List<api.Voice> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVoice(o[0]);
  checkVoice(o[1]);
}
...
api.Voice buildVoice() {
  ...
  if (buildCounterVoice < 3) {
    o.languageCodes = buildUnnamed5783();
    o.name = 'foo';
...
void checkVoice(api.Voice o) {
  buildCounterVoice++;
  if (buildCounterVoice < 3) {
    checkUnnamed5783(o.languageCodes!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
