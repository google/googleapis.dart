...
api.AudioConfig buildAudioConfig() {
  ...
  if (buildCounterAudioConfig < 3) {
    o.audioEncoding = 'foo';
    o.effectsProfileId = buildUnnamed5019();
    o.pitch = 42.0;
...
void checkAudioConfig(api.AudioConfig o) {
  ...
  if (buildCounterAudioConfig < 3) {
    ...
    checkUnnamed5019(o.effectsProfileId);
...
core.List<api.Voice> buildUnnamed5020() {
  var o = <api.Voice>[];
  o.add(buildVoice());
  o.add(buildVoice());
  return o;
...
void checkUnnamed5020(core.List<api.Voice> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Voice buildVoice() {
  ...
  if (buildCounterVoice < 3) {
    o.languageCodes = buildUnnamed5021();
    o.name = 'foo';
...
void checkVoice(api.Voice o) {
  buildCounterVoice++;
  if (buildCounterVoice < 3) {
    checkUnnamed5021(o.languageCodes);
