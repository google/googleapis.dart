...
api.AudioConfig buildAudioConfig() {
  ...
  if (buildCounterAudioConfig < 3) {
    o.audioEncoding = 'foo';
    o.effectsProfileId = buildUnnamed5404();
    o.pitch = 42.0;
...
void checkAudioConfig(api.AudioConfig o) {
  ...
  if (buildCounterAudioConfig < 3) {
    ...
    checkUnnamed5404(o.effectsProfileId!);
    unittest.expect(
      o.pitch!,
...
core.List<api.Voice> buildUnnamed5405() {
  var o = <api.Voice>[];
  o.add(buildVoice());
  o.add(buildVoice());
  return o;
...
void checkUnnamed5405(core.List<api.Voice> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Voice buildVoice() {
  ...
  if (buildCounterVoice < 3) {
    o.languageCodes = buildUnnamed5406();
    o.name = 'foo';
...
void checkVoice(api.Voice o) {
  buildCounterVoice++;
  if (buildCounterVoice < 3) {
    checkUnnamed5406(o.languageCodes!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
