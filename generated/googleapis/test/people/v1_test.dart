...
checkUnnamed1526(core.List<api.ContactGroupResponse> o) {
...
buildContactGroup() {
  ...
  if (buildCounterContactGroup < 3) {
    ...
    o.groupType = "foo";
    o.memberCount = 42;
    o.memberResourceNames = buildUnnamed1527();
...
checkContactGroup(api.ContactGroup o) {
  ...
  if (buildCounterContactGroup < 3) {
    ...
    checkUnnamed1527(o.memberResourceNames);
...
checkUnnamed1528(core.List<api.PersonResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1529(core.List<api.Person> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPerson(o[0]);
  checkPerson(o[1]);
}
...
buildListConnectionsResponse() {
  ...
  if (buildCounterListConnectionsResponse < 3) {
    o.connections = buildUnnamed1529();
    o.nextPageToken = "foo";
    o.nextSyncToken = "foo";
    o.totalItems = 42;
    o.totalPeople = 42;
...
checkListConnectionsResponse(api.ListConnectionsResponse o) {
  buildCounterListConnectionsResponse++;
  if (buildCounterListConnectionsResponse < 3) {
    checkUnnamed1529(o.connections);
...
checkUnnamed1530(core.List<api.ContactGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListContactGroupsResponse() {
  ...
  if (buildCounterListContactGroupsResponse < 3) {
    o.contactGroups = buildUnnamed1530();
    o.nextPageToken = "foo";
    o.nextSyncToken = "foo";
    o.totalItems = 42;
  }
...
checkListContactGroupsResponse(api.ListContactGroupsResponse o) {
  buildCounterListContactGroupsResponse++;
  if (buildCounterListContactGroupsResponse < 3) {
    checkUnnamed1530(o.contactGroups);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    unittest.expect(o.nextSyncToken, unittest.equals('foo'));
    unittest.expect(o.totalItems, unittest.equals(42));
  }
...
buildModifyContactGroupMembersRequest() {
  ...
  if (buildCounterModifyContactGroupMembersRequest < 3) {
    o.resourceNamesToAdd = buildUnnamed1531();
    o.resourceNamesToRemove = buildUnnamed1532();
  }
  buildCounterModifyContactGroupMembersRequest--;
  return o;
}
...
checkModifyContactGroupMembersRequest(api.ModifyContactGroupMembersRequest o) {
  buildCounterModifyContactGroupMembersRequest++;
  if (buildCounterModifyContactGroupMembersRequest < 3) {
    checkUnnamed1531(o.resourceNamesToAdd);
    checkUnnamed1532(o.resourceNamesToRemove);
  }
  buildCounterModifyContactGroupMembersRequest--;
}
...
buildModifyContactGroupMembersResponse() {
  ...
  if (buildCounterModifyContactGroupMembersResponse < 3) {
    o.notFoundResourceNames = buildUnnamed1533();
  }
  buildCounterModifyContactGroupMembersResponse--;
  return o;
}
...
checkModifyContactGroupMembersResponse(
  ...
  buildCounterModifyContactGroupMembersResponse++;
  if (buildCounterModifyContactGroupMembersResponse < 3) {
    checkUnnamed1533(o.notFoundResourceNames);
  }
  buildCounterModifyContactGroupMembersResponse--;
}
...
checkUnnamed1534(core.List<api.Address> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAddress(o[0]);
  checkAddress(o[1]);
}
...
checkUnnamed1535(core.List<api.AgeRangeType> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1536(core.List<api.Biography> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBiography(o[0]);
  checkBiography(o[1]);
}
...
checkUnnamed1537(core.List<api.Birthday> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBirthday(o[0]);
  checkBirthday(o[1]);
}
...
checkUnnamed1538(core.List<api.BraggingRights> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1539(core.List<api.CoverPhoto> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCoverPhoto(o[0]);
  checkCoverPhoto(o[1]);
}
...
checkUnnamed1540(core.List<api.EmailAddress> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1541(core.List<api.Event> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEvent(o[0]);
  checkEvent(o[1]);
}
...
checkUnnamed1542(core.List<api.Gender> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGender(o[0]);
  checkGender(o[1]);
}
...
checkUnnamed1543(core.List<api.ImClient> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkImClient(o[0]);
  checkImClient(o[1]);
}
...
checkUnnamed1544(core.List<api.Interest> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInterest(o[0]);
  checkInterest(o[1]);
}
...
checkUnnamed1545(core.List<api.Locale> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocale(o[0]);
  checkLocale(o[1]);
}
...
checkUnnamed1546(core.List<api.Membership> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMembership(o[0]);
  checkMembership(o[1]);
}
...
checkUnnamed1547(core.List<api.Name> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkName(o[0]);
  checkName(o[1]);
}
...
checkUnnamed1548(core.List<api.Nickname> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNickname(o[0]);
  checkNickname(o[1]);
}
...
checkUnnamed1549(core.List<api.Occupation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOccupation(o[0]);
  checkOccupation(o[1]);
}
...
checkUnnamed1550(core.List<api.Organization> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1551(core.List<api.PhoneNumber> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1552(core.List<api.Photo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPhoto(o[0]);
  checkPhoto(o[1]);
}
...
checkUnnamed1553(core.List<api.Relation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRelation(o[0]);
  checkRelation(o[1]);
}
...
checkUnnamed1554(core.List<api.RelationshipInterest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1555(core.List<api.RelationshipStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1556(core.List<api.Residence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResidence(o[0]);
  checkResidence(o[1]);
}
...
checkUnnamed1557(core.List<api.Skill> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSkill(o[0]);
  checkSkill(o[1]);
}
...
checkUnnamed1558(core.List<api.Tagline> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTagline(o[0]);
  checkTagline(o[1]);
}
...
checkUnnamed1559(core.List<api.Url> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUrl(o[0]);
  checkUrl(o[1]);
}
...
checkUnnamed1560(core.List<api.UserDefined> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPerson() {
  ...
  if (buildCounterPerson < 3) {
    o.addresses = buildUnnamed1534();
    o.ageRange = "foo";
    o.ageRanges = buildUnnamed1535();
    o.biographies = buildUnnamed1536();
    o.birthdays = buildUnnamed1537();
    o.braggingRights = buildUnnamed1538();
    o.coverPhotos = buildUnnamed1539();
    o.emailAddresses = buildUnnamed1540();
    o.etag = "foo";
    o.events = buildUnnamed1541();
    o.genders = buildUnnamed1542();
    o.imClients = buildUnnamed1543();
    o.interests = buildUnnamed1544();
    o.locales = buildUnnamed1545();
    o.memberships = buildUnnamed1546();
    o.metadata = buildPersonMetadata();
    o.names = buildUnnamed1547();
    o.nicknames = buildUnnamed1548();
    o.occupations = buildUnnamed1549();
    o.organizations = buildUnnamed1550();
    o.phoneNumbers = buildUnnamed1551();
    o.photos = buildUnnamed1552();
    o.relations = buildUnnamed1553();
    o.relationshipInterests = buildUnnamed1554();
    o.relationshipStatuses = buildUnnamed1555();
    o.residences = buildUnnamed1556();
    o.resourceName = "foo";
    o.skills = buildUnnamed1557();
    o.taglines = buildUnnamed1558();
    o.urls = buildUnnamed1559();
    o.userDefined = buildUnnamed1560();
  }
  buildCounterPerson--;
  return o;
}
...
checkPerson(api.Person o) {
  buildCounterPerson++;
  if (buildCounterPerson < 3) {
    checkUnnamed1534(o.addresses);
    unittest.expect(o.ageRange, unittest.equals('foo'));
    checkUnnamed1535(o.ageRanges);
    checkUnnamed1536(o.biographies);
    checkUnnamed1537(o.birthdays);
    checkUnnamed1538(o.braggingRights);
    checkUnnamed1539(o.coverPhotos);
    checkUnnamed1540(o.emailAddresses);
    unittest.expect(o.etag, unittest.equals('foo'));
    checkUnnamed1541(o.events);
    checkUnnamed1542(o.genders);
    checkUnnamed1543(o.imClients);
    checkUnnamed1544(o.interests);
    checkUnnamed1545(o.locales);
    checkUnnamed1546(o.memberships);
    checkPersonMetadata(o.metadata);
    checkUnnamed1547(o.names);
    checkUnnamed1548(o.nicknames);
    checkUnnamed1549(o.occupations);
    checkUnnamed1550(o.organizations);
    checkUnnamed1551(o.phoneNumbers);
    checkUnnamed1552(o.photos);
    checkUnnamed1553(o.relations);
    checkUnnamed1554(o.relationshipInterests);
    checkUnnamed1555(o.relationshipStatuses);
    checkUnnamed1556(o.residences);
    unittest.expect(o.resourceName, unittest.equals('foo'));
    checkUnnamed1557(o.skills);
    checkUnnamed1558(o.taglines);
    checkUnnamed1559(o.urls);
    checkUnnamed1560(o.userDefined);
  }
  buildCounterPerson--;
}
...
checkUnnamed1563(core.List<api.Source> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSource(o[0]);
  checkSource(o[1]);
}
...
buildPersonMetadata() {
  ...
  if (buildCounterPersonMetadata < 3) {
    o.deleted = true;
    o.linkedPeopleResourceNames = buildUnnamed1561();
    o.objectType = "foo";
    o.previousResourceNames = buildUnnamed1562();
    o.sources = buildUnnamed1563();
  }
  buildCounterPersonMetadata--;
  return o;
}
...
checkPersonMetadata(api.PersonMetadata o) {
  ...
  if (buildCounterPersonMetadata < 3) {
    unittest.expect(o.deleted, unittest.isTrue);
    checkUnnamed1561(o.linkedPeopleResourceNames);
    unittest.expect(o.objectType, unittest.equals('foo'));
    checkUnnamed1562(o.previousResourceNames);
    checkUnnamed1563(o.sources);
  }
  buildCounterPersonMetadata--;
}
...
main() {
  ...
  unittest.group("resource-ContactGroupsResourceApi", () {
    unittest.test("method--batchGet", () {
      ...
      var arg_resourceNames = buildUnnamed1567();
  ...
  unittest.group("resource-PeopleResourceApi", () {
    ...
    unittest.test("method--getBatchGet", () {
      ...
      var arg_personFields = "foo";
      var arg_requestMask_includeField = "foo";
      var arg_resourceNames = buildUnnamed1568();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
