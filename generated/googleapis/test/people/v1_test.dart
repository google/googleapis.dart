...
checkUnnamed1712(core.List<api.PersonResponse> o) {
...
checkUnnamed1713(core.List<api.Person> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPerson(o[0]);
  checkPerson(o[1]);
}
...
buildListConnectionsResponse() {
  ...
  if (buildCounterListConnectionsResponse < 3) {
    o.connections = buildUnnamed1713();
    o.nextPageToken = "foo";
    o.nextSyncToken = "foo";
  }
  buildCounterListConnectionsResponse--;
...
checkListConnectionsResponse(api.ListConnectionsResponse o) {
  buildCounterListConnectionsResponse++;
  if (buildCounterListConnectionsResponse < 3) {
    checkUnnamed1713(o.connections);
...
checkUnnamed1715(core.List<api.Biography> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBiography(o[0]);
  checkBiography(o[1]);
}
...
checkUnnamed1716(core.List<api.Birthday> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBirthday(o[0]);
  checkBirthday(o[1]);
}
...
checkUnnamed1717(core.List<api.BraggingRights> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1718(core.List<api.CoverPhoto> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCoverPhoto(o[0]);
  checkCoverPhoto(o[1]);
}
...
checkUnnamed1719(core.List<api.EmailAddress> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1720(core.List<api.Event> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEvent(o[0]);
  checkEvent(o[1]);
}
...
checkUnnamed1721(core.List<api.Gender> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGender(o[0]);
  checkGender(o[1]);
}
...
checkUnnamed1722(core.List<api.ImClient> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkImClient(o[0]);
  checkImClient(o[1]);
}
...
checkUnnamed1723(core.List<api.Interest> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInterest(o[0]);
  checkInterest(o[1]);
}
...
checkUnnamed1724(core.List<api.Locale> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocale(o[0]);
  checkLocale(o[1]);
}
...
checkUnnamed1725(core.List<api.Membership> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMembership(o[0]);
  checkMembership(o[1]);
}
...
checkUnnamed1726(core.List<api.Name> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkName(o[0]);
  checkName(o[1]);
}
...
checkUnnamed1727(core.List<api.Nickname> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNickname(o[0]);
  checkNickname(o[1]);
}
...
checkUnnamed1728(core.List<api.Occupation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOccupation(o[0]);
  checkOccupation(o[1]);
}
...
checkUnnamed1729(core.List<api.Organization> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1730(core.List<api.PhoneNumber> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1731(core.List<api.Photo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPhoto(o[0]);
  checkPhoto(o[1]);
}
...
checkUnnamed1732(core.List<api.Relation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRelation(o[0]);
  checkRelation(o[1]);
}
...
checkUnnamed1733(core.List<api.RelationshipInterest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1734(core.List<api.RelationshipStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1735(core.List<api.Residence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResidence(o[0]);
  checkResidence(o[1]);
}
...
checkUnnamed1736(core.List<api.Skill> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSkill(o[0]);
  checkSkill(o[1]);
}
...
checkUnnamed1737(core.List<api.Tagline> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTagline(o[0]);
  checkTagline(o[1]);
}
...
checkUnnamed1738(core.List<api.Url> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUrl(o[0]);
  checkUrl(o[1]);
}
...
buildPerson() {
  ...
  if (buildCounterPerson < 3) {
    ...
    o.ageRange = "foo";
    o.biographies = buildUnnamed1715();
    o.birthdays = buildUnnamed1716();
    o.braggingRights = buildUnnamed1717();
    o.coverPhotos = buildUnnamed1718();
    o.emailAddresses = buildUnnamed1719();
    o.etag = "foo";
    o.events = buildUnnamed1720();
    o.genders = buildUnnamed1721();
    o.imClients = buildUnnamed1722();
    o.interests = buildUnnamed1723();
    o.locales = buildUnnamed1724();
    o.memberships = buildUnnamed1725();
    o.metadata = buildPersonMetadata();
    o.names = buildUnnamed1726();
    o.nicknames = buildUnnamed1727();
    o.occupations = buildUnnamed1728();
    o.organizations = buildUnnamed1729();
    o.phoneNumbers = buildUnnamed1730();
    o.photos = buildUnnamed1731();
    o.relations = buildUnnamed1732();
    o.relationshipInterests = buildUnnamed1733();
    o.relationshipStatuses = buildUnnamed1734();
    o.residences = buildUnnamed1735();
    o.resourceName = "foo";
    o.skills = buildUnnamed1736();
    o.taglines = buildUnnamed1737();
    o.urls = buildUnnamed1738();
  }
  buildCounterPerson--;
  return o;
}
...
checkPerson(api.Person o) {
  ...
  if (buildCounterPerson < 3) {
    ...
    checkUnnamed1715(o.biographies);
    checkUnnamed1716(o.birthdays);
    checkUnnamed1717(o.braggingRights);
    checkUnnamed1718(o.coverPhotos);
    checkUnnamed1719(o.emailAddresses);
    unittest.expect(o.etag, unittest.equals('foo'));
    checkUnnamed1720(o.events);
    checkUnnamed1721(o.genders);
    checkUnnamed1722(o.imClients);
    checkUnnamed1723(o.interests);
    checkUnnamed1724(o.locales);
    checkUnnamed1725(o.memberships);
    checkPersonMetadata(o.metadata);
    checkUnnamed1726(o.names);
    checkUnnamed1727(o.nicknames);
    checkUnnamed1728(o.occupations);
    checkUnnamed1729(o.organizations);
    checkUnnamed1730(o.phoneNumbers);
    checkUnnamed1731(o.photos);
    checkUnnamed1732(o.relations);
    checkUnnamed1733(o.relationshipInterests);
    checkUnnamed1734(o.relationshipStatuses);
    checkUnnamed1735(o.residences);
    unittest.expect(o.resourceName, unittest.equals('foo'));
    checkUnnamed1736(o.skills);
    checkUnnamed1737(o.taglines);
    checkUnnamed1738(o.urls);
  }
  buildCounterPerson--;
}
...
checkUnnamed1740(core.List<api.Source> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSource(o[0]);
  checkSource(o[1]);
}
...
buildPersonMetadata() {
  ...
  if (buildCounterPersonMetadata < 3) {
    o.deleted = true;
    o.objectType = "foo";
    o.previousResourceNames = buildUnnamed1739();
    o.sources = buildUnnamed1740();
  }
  buildCounterPersonMetadata--;
  return o;
}
...
checkPersonMetadata(api.PersonMetadata o) {
  ...
  if (buildCounterPersonMetadata < 3) {
    ...
    checkUnnamed1739(o.previousResourceNames);
    checkUnnamed1740(o.sources);
  }
  buildCounterPersonMetadata--;
}
...
main() {
  ...
  unittest.group("resource-PeopleResourceApi", () {
    ...
    unittest.test("method--getBatchGet", () {
      ...
      var mock = new HttpServerMock();
      api.PeopleResourceApi res = new api.PeopleApi(mock).people;
      var arg_resourceNames = buildUnnamed1741();
      var arg_requestMask_includeField = "foo";
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
