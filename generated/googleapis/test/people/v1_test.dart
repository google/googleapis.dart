...
checkUnnamed1312(core.List<api.PersonResponse> o) {
...
checkUnnamed1313(core.List<api.Person> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPerson(o[0]);
  checkPerson(o[1]);
}
...
buildListConnectionsResponse() {
  ...
  if (buildCounterListConnectionsResponse < 3) {
    o.connections = buildUnnamed1313();
    o.nextPageToken = "foo";
    o.nextSyncToken = "foo";
  }
  buildCounterListConnectionsResponse--;
...
checkListConnectionsResponse(api.ListConnectionsResponse o) {
  buildCounterListConnectionsResponse++;
  if (buildCounterListConnectionsResponse < 3) {
    checkUnnamed1313(o.connections);
...
checkUnnamed1314(core.List<api.Address> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAddress(o[0]);
  checkAddress(o[1]);
}
...
checkUnnamed1315(core.List<api.Biography> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBiography(o[0]);
  checkBiography(o[1]);
}
...
checkUnnamed1316(core.List<api.Birthday> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBirthday(o[0]);
  checkBirthday(o[1]);
}
...
checkUnnamed1317(core.List<api.BraggingRights> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1318(core.List<api.CoverPhoto> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCoverPhoto(o[0]);
  checkCoverPhoto(o[1]);
}
...
checkUnnamed1319(core.List<api.EmailAddress> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1320(core.List<api.Event> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEvent(o[0]);
  checkEvent(o[1]);
}
...
checkUnnamed1321(core.List<api.Gender> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGender(o[0]);
  checkGender(o[1]);
}
...
checkUnnamed1322(core.List<api.ImClient> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkImClient(o[0]);
  checkImClient(o[1]);
}
...
checkUnnamed1323(core.List<api.Interest> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInterest(o[0]);
  checkInterest(o[1]);
}
...
checkUnnamed1324(core.List<api.Locale> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocale(o[0]);
  checkLocale(o[1]);
}
...
checkUnnamed1325(core.List<api.Membership> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMembership(o[0]);
  checkMembership(o[1]);
}
...
checkUnnamed1326(core.List<api.Name> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkName(o[0]);
  checkName(o[1]);
}
...
checkUnnamed1327(core.List<api.Nickname> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNickname(o[0]);
  checkNickname(o[1]);
}
...
checkUnnamed1328(core.List<api.Occupation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOccupation(o[0]);
  checkOccupation(o[1]);
}
...
checkUnnamed1329(core.List<api.Organization> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1330(core.List<api.PhoneNumber> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1331(core.List<api.Photo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPhoto(o[0]);
  checkPhoto(o[1]);
}
...
checkUnnamed1332(core.List<api.Relation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRelation(o[0]);
  checkRelation(o[1]);
}
...
checkUnnamed1333(core.List<api.RelationshipInterest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1334(core.List<api.RelationshipStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1335(core.List<api.Residence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResidence(o[0]);
  checkResidence(o[1]);
}
...
checkUnnamed1336(core.List<api.Skill> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSkill(o[0]);
  checkSkill(o[1]);
}
...
checkUnnamed1337(core.List<api.Tagline> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTagline(o[0]);
  checkTagline(o[1]);
}
...
checkUnnamed1338(core.List<api.Url> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUrl(o[0]);
  checkUrl(o[1]);
}
...
buildPerson() {
  ...
  if (buildCounterPerson < 3) {
    o.addresses = buildUnnamed1314();
    o.ageRange = "foo";
    o.biographies = buildUnnamed1315();
    o.birthdays = buildUnnamed1316();
    o.braggingRights = buildUnnamed1317();
    o.coverPhotos = buildUnnamed1318();
    o.emailAddresses = buildUnnamed1319();
    o.etag = "foo";
    o.events = buildUnnamed1320();
    o.genders = buildUnnamed1321();
    o.imClients = buildUnnamed1322();
    o.interests = buildUnnamed1323();
    o.locales = buildUnnamed1324();
    o.memberships = buildUnnamed1325();
    o.metadata = buildPersonMetadata();
    o.names = buildUnnamed1326();
    o.nicknames = buildUnnamed1327();
    o.occupations = buildUnnamed1328();
    o.organizations = buildUnnamed1329();
    o.phoneNumbers = buildUnnamed1330();
    o.photos = buildUnnamed1331();
    o.relations = buildUnnamed1332();
    o.relationshipInterests = buildUnnamed1333();
    o.relationshipStatuses = buildUnnamed1334();
    o.residences = buildUnnamed1335();
    o.resourceName = "foo";
    o.skills = buildUnnamed1336();
    o.taglines = buildUnnamed1337();
    o.urls = buildUnnamed1338();
  }
  buildCounterPerson--;
  return o;
}
...
checkPerson(api.Person o) {
  buildCounterPerson++;
  if (buildCounterPerson < 3) {
    checkUnnamed1314(o.addresses);
    unittest.expect(o.ageRange, unittest.equals('foo'));
    checkUnnamed1315(o.biographies);
    checkUnnamed1316(o.birthdays);
    checkUnnamed1317(o.braggingRights);
    checkUnnamed1318(o.coverPhotos);
    checkUnnamed1319(o.emailAddresses);
    unittest.expect(o.etag, unittest.equals('foo'));
    checkUnnamed1320(o.events);
    checkUnnamed1321(o.genders);
    checkUnnamed1322(o.imClients);
    checkUnnamed1323(o.interests);
    checkUnnamed1324(o.locales);
    checkUnnamed1325(o.memberships);
    checkPersonMetadata(o.metadata);
    checkUnnamed1326(o.names);
    checkUnnamed1327(o.nicknames);
    checkUnnamed1328(o.occupations);
    checkUnnamed1329(o.organizations);
    checkUnnamed1330(o.phoneNumbers);
    checkUnnamed1331(o.photos);
    checkUnnamed1332(o.relations);
    checkUnnamed1333(o.relationshipInterests);
    checkUnnamed1334(o.relationshipStatuses);
    checkUnnamed1335(o.residences);
    unittest.expect(o.resourceName, unittest.equals('foo'));
    checkUnnamed1336(o.skills);
    checkUnnamed1337(o.taglines);
    checkUnnamed1338(o.urls);
  }
  buildCounterPerson--;
}
...
buildPersonMetadata() {
  ...
  if (buildCounterPersonMetadata < 3) {
    o.deleted = true;
    o.objectType = "foo";
    o.previousResourceNames = buildUnnamed1339();
...
checkPersonMetadata(api.PersonMetadata o) {
  ...
  if (buildCounterPersonMetadata < 3) {
    ...
    checkUnnamed1339(o.previousResourceNames);
...
main() {
  ...
  unittest.group("resource-PeopleResourceApi", () {
    ...
    unittest.test("method--getBatchGet", () {
      ...
      var mock = new HttpServerMock();
      api.PeopleResourceApi res = new api.PeopleApi(mock).people;
      var arg_resourceNames = buildUnnamed1341();
      var arg_requestMask_includeField = "foo";
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
