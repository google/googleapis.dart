...
core.List<api.AuditLogConfig> buildUnnamed5316() => [
      buildAuditLogConfig(),
      buildAuditLogConfig(),
    ];

void checkUnnamed5316(core.List<api.AuditLogConfig> o) {
...
api.AuditConfig buildAuditConfig() {
  ...
  if (buildCounterAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed5316();
    o.service = 'foo';
  }
  buildCounterAuditConfig--;
  return o;
...
void checkAuditConfig(api.AuditConfig o) {
  buildCounterAuditConfig++;
  if (buildCounterAuditConfig < 3) {
    checkUnnamed5316(o.auditLogConfigs!);
    unittest.expect(
      o.service!,
      unittest.equals('foo'),
    );
...
api.AuditLogConfig buildAuditLogConfig() {
  ...
  if (buildCounterAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed5317();
    o.logType = 'foo';
  }
  buildCounterAuditLogConfig--;
  return o;
...
void checkAuditLogConfig(api.AuditLogConfig o) {
  buildCounterAuditLogConfig++;
  if (buildCounterAuditLogConfig < 3) {
    checkUnnamed5317(o.exemptedMembers!);
    unittest.expect(
      o.logType!,
      unittest.equals('foo'),
    );
...
core.List<api.DeploymentLabelEntry> buildUnnamed5319() => [
      buildDeploymentLabelEntry(),
      buildDeploymentLabelEntry(),
    ];

void checkUnnamed5319(core.List<api.DeploymentLabelEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.DeploymentUpdateLabelEntry> buildUnnamed5320() => [
      buildDeploymentUpdateLabelEntry(),
      buildDeploymentUpdateLabelEntry(),
    ];

void checkUnnamed5320(core.List<api.DeploymentUpdateLabelEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Deployment> buildUnnamed5321() => [
      buildDeployment(),
      buildDeployment(),
    ];

void checkUnnamed5321(core.List<api.Deployment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDeployment(o[0]);
  checkDeployment(o[1]);
}
...
api.DeploymentsListResponse buildDeploymentsListResponse() {
  ...
  if (buildCounterDeploymentsListResponse < 3) {
    o.deployments = buildUnnamed5321();
    o.nextPageToken = 'foo';
  }
  buildCounterDeploymentsListResponse--;
  return o;
...
void checkDeploymentsListResponse(api.DeploymentsListResponse o) {
  buildCounterDeploymentsListResponse++;
  if (buildCounterDeploymentsListResponse < 3) {
    checkUnnamed5321(o.deployments!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Binding> buildUnnamed5322() => [
      buildBinding(),
      buildBinding(),
    ];

void checkUnnamed5322(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
core.List<api.ImportFile> buildUnnamed5323() => [
      buildImportFile(),
      buildImportFile(),
    ];

void checkUnnamed5323(core.List<api.ImportFile> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkImportFile(o[0]);
  checkImportFile(o[1]);
}
...
core.List<api.Manifest> buildUnnamed5324() => [
      buildManifest(),
      buildManifest(),
    ];

void checkUnnamed5324(core.List<api.Manifest> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkManifest(o[0]);
  checkManifest(o[1]);
}
...
core.List<api.OperationErrorErrors> buildUnnamed5325() => [
      buildOperationErrorErrors(),
      buildOperationErrorErrors(),
    ];

void checkUnnamed5325(core.List<api.OperationErrorErrors> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.OperationWarningsData> buildUnnamed5326() => [
      buildOperationWarningsData(),
      buildOperationWarningsData(),
    ];

void checkUnnamed5326(core.List<api.OperationWarningsData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.OperationWarnings> buildUnnamed5327() => [
      buildOperationWarnings(),
      buildOperationWarnings(),
    ];

void checkUnnamed5327(core.List<api.OperationWarnings> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Operation> buildUnnamed5328() => [
      buildOperation(),
      buildOperation(),
    ];

void checkUnnamed5328(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
core.List<api.ResourceWarningsData> buildUnnamed5331() => [
      buildResourceWarningsData(),
      buildResourceWarningsData(),
    ];

void checkUnnamed5331(core.List<api.ResourceWarningsData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ResourceWarnings> buildUnnamed5332() => [
      buildResourceWarnings(),
      buildResourceWarnings(),
    ];

void checkUnnamed5332(core.List<api.ResourceWarnings> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ResourceUpdateErrorErrors> buildUnnamed5333() => [
      buildResourceUpdateErrorErrors(),
      buildResourceUpdateErrorErrors(),
    ];

void checkUnnamed5333(core.List<api.ResourceUpdateErrorErrors> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ResourceUpdateWarningsData> buildUnnamed5334() => [
      buildResourceUpdateWarningsData(),
      buildResourceUpdateWarningsData(),
    ];

void checkUnnamed5334(core.List<api.ResourceUpdateWarningsData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ResourceUpdateWarnings> buildUnnamed5335() => [
      buildResourceUpdateWarnings(),
      buildResourceUpdateWarnings(),
    ];

void checkUnnamed5335(core.List<api.ResourceUpdateWarnings> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Resource> buildUnnamed5336() => [
      buildResource(),
      buildResource(),
    ];

void checkUnnamed5336(core.List<api.Resource> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResource(o[0]);
  checkResource(o[1]);
}
...
void checkResourcesListResponse(api.ResourcesListResponse o) {
  ...
  if (buildCounterResourcesListResponse < 3) {
    ...
    checkUnnamed5336(o.resources!);
  }
  buildCounterResourcesListResponse--;
}

core.List<api.ImportFile> buildUnnamed5337() => [
      buildImportFile(),
      buildImportFile(),
    ];

void checkUnnamed5337(core.List<api.ImportFile> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkImportFile(o[0]);
  checkImportFile(o[1]);
}
...
api.TestPermissionsRequest buildTestPermissionsRequest() {
  ...
  if (buildCounterTestPermissionsRequest < 3) {
    o.permissions = buildUnnamed5338();
  }
  buildCounterTestPermissionsRequest--;
  return o;
}
...
void checkTestPermissionsRequest(api.TestPermissionsRequest o) {
  buildCounterTestPermissionsRequest++;
  if (buildCounterTestPermissionsRequest < 3) {
    checkUnnamed5338(o.permissions!);
  }
  buildCounterTestPermissionsRequest--;
}
...
api.TestPermissionsResponse buildTestPermissionsResponse() {
  ...
  if (buildCounterTestPermissionsResponse < 3) {
    o.permissions = buildUnnamed5339();
  }
  buildCounterTestPermissionsResponse--;
  return o;
}
...
void checkTestPermissionsResponse(api.TestPermissionsResponse o) {
  buildCounterTestPermissionsResponse++;
  if (buildCounterTestPermissionsResponse < 3) {
    checkUnnamed5339(o.permissions!);
  }
  buildCounterTestPermissionsResponse--;
}
