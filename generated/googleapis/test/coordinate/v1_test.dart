...
checkUnnamed1021(core.List<api.EnumItemDef> o) {
...
checkUnnamed1022(core.List<api.CustomFieldDef> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1023(core.List<api.CustomField> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildCustomFields() {
  ...
  if (buildCounterCustomFields < 3) {
    o.customField = buildUnnamed1023();
    o.kind = "foo";
  }
  buildCounterCustomFields--;
  return o;
...
checkCustomFields(api.CustomFields o) {
  buildCounterCustomFields++;
  if (buildCounterCustomFields < 3) {
    checkUnnamed1023(o.customField);
    unittest.expect(o.kind, unittest.equals('foo'));
  }
  buildCounterCustomFields--;
}
...
checkUnnamed1024(core.List<api.JobChange> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJobChange(o[0]);
  checkJobChange(o[1]);
}
...
checkUnnamed1025(core.List<api.Job> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJob(o[0]);
  checkJob(o[1]);
}
...
buildLocation() {
  ...
  if (buildCounterLocation < 3) {
    o.addressLine = buildUnnamed1027();
    o.kind = "foo";
    o.lat = 42.0;
    o.lng = 42.0;
  }
...
checkLocation(api.Location o) {
  buildCounterLocation++;
  if (buildCounterLocation < 3) {
    checkUnnamed1027(o.addressLine);
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed1028(core.List<api.LocationRecord> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1029(core.List<api.Team> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTeam(o[0]);
  checkTeam(o[1]);
}
...
checkUnnamed1030(core.List<api.Worker> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWorker(o[0]);
  checkWorker(o[1]);
}
...
main() {
  ...
  unittest.group("resource-JobsResourceApi", () {
    ...
    unittest.test("method--insert", () {
      ...
      var arg_customField = buildUnnamed1031();
    ...
    unittest.test("method--patch", () {
      ...
      var arg_address = "foo";
      var arg_assignee = "foo";
      var arg_customField = buildUnnamed1032();
      var arg_customerName = "foo";
      var arg_customerPhoneNumber = "foo";
      var arg_lat = 42.0;
      var arg_lng = 42.0;
    ...
    unittest.test("method--update", () {
      ...
      var arg_address = "foo";
      var arg_assignee = "foo";
      var arg_customField = buildUnnamed1033();
      var arg_customerName = "foo";
      var arg_customerPhoneNumber = "foo";
      var arg_lat = 42.0;
      var arg_lng = 42.0;
