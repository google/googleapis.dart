...
core.List<api.AclRule> buildUnnamed8() => [
      buildAclRule(),
      buildAclRule(),
    ];

void checkUnnamed8(core.List<api.AclRule> o) {
...
core.List<api.CalendarListEntry> buildUnnamed9() => [
      buildCalendarListEntry(),
      buildCalendarListEntry(),
    ];

void checkUnnamed9(core.List<api.CalendarListEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.EventReminder> buildUnnamed10() => [
      buildEventReminder(),
      buildEventReminder(),
    ];

void checkUnnamed10(core.List<api.EventReminder> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEventReminder(o[0]);
  checkEventReminder(o[1]);
}

core.List<api.CalendarNotification> buildUnnamed11() => [
      buildCalendarNotification(),
      buildCalendarNotification(),
    ];

void checkUnnamed11(core.List<api.CalendarNotification> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.CalendarListEntryNotificationSettings
  ...
  if (buildCounterCalendarListEntryNotificationSettings < 3) {
    o.notifications = buildUnnamed11();
  }
  buildCounterCalendarListEntryNotificationSettings--;
  return o;
}
...
void checkCalendarListEntryNotificationSettings(
  ...
  buildCounterCalendarListEntryNotificationSettings++;
  if (buildCounterCalendarListEntryNotificationSettings < 3) {
    checkUnnamed11(o.notifications!);
  }
  buildCounterCalendarListEntryNotificationSettings--;
}
...
api.CalendarListEntry buildCalendarListEntry() {
  ...
  if (buildCounterCalendarListEntry < 3) {
    ...
    o.colorId = 'foo';
    o.conferenceProperties = buildConferenceProperties();
    o.defaultReminders = buildUnnamed10();
    o.deleted = true;
    o.description = 'foo';
    o.etag = 'foo';
...
void checkCalendarListEntry(api.CalendarListEntry o) {
  ...
  if (buildCounterCalendarListEntry < 3) {
    ...
    checkConferenceProperties(o.conferenceProperties!);
    checkUnnamed10(o.defaultReminders!);
...
core.Map<core.String, api.ColorDefinition> buildUnnamed13() => {
      'x': buildColorDefinition(),
      'y': buildColorDefinition(),
    };

void checkUnnamed13(core.Map<core.String, api.ColorDefinition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkColorDefinition(o['x']!);
  checkColorDefinition(o['y']!);
}

core.Map<core.String, api.ColorDefinition> buildUnnamed14() => {
      'x': buildColorDefinition(),
      'y': buildColorDefinition(),
    };

void checkUnnamed14(core.Map<core.String, api.ColorDefinition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkColorDefinition(o['x']!);
  checkColorDefinition(o['y']!);
}
...
api.Colors buildColors() {
  ...
  if (buildCounterColors < 3) {
    o.calendar = buildUnnamed13();
    o.event = buildUnnamed14();
    o.kind = 'foo';
...
void checkColors(api.Colors o) {
  buildCounterColors++;
  if (buildCounterColors < 3) {
    checkUnnamed13(o.calendar!);
    checkUnnamed14(o.event!);
    unittest.expect(
      o.kind!,
      unittest.equals('foo'),
    );
...
core.List<api.EntryPoint> buildUnnamed15() => [
      buildEntryPoint(),
      buildEntryPoint(),
    ];

void checkUnnamed15(core.List<api.EntryPoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEntryPoint(o[0]);
  checkEntryPoint(o[1]);
}
...
api.ConferenceProperties buildConferenceProperties() {
  ...
  if (buildCounterConferenceProperties < 3) {
    o.allowedConferenceSolutionTypes = buildUnnamed17();
  }
  buildCounterConferenceProperties--;
  return o;
}
...
void checkConferenceProperties(api.ConferenceProperties o) {
  buildCounterConferenceProperties++;
  if (buildCounterConferenceProperties < 3) {
    checkUnnamed17(o.allowedConferenceSolutionTypes!);
  }
  buildCounterConferenceProperties--;
}
...
api.EntryPoint buildEntryPoint() {
  ...
  if (buildCounterEntryPoint < 3) {
    o.accessCode = 'foo';
    o.entryPointFeatures = buildUnnamed18();
...
void checkEntryPoint(api.EntryPoint o) {
  ...
  if (buildCounterEntryPoint < 3) {
    ...
    checkUnnamed18(o.entryPointFeatures!);
    unittest.expect(
      o.entryPointType!,
      unittest.equals('foo'),
    );
...
core.List<api.EventAttachment> buildUnnamed19() => [
      buildEventAttachment(),
      buildEventAttachment(),
    ];

void checkUnnamed19(core.List<api.EventAttachment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEventAttachment(o[0]);
  checkEventAttachment(o[1]);
}

core.List<api.EventAttendee> buildUnnamed20() => [
      buildEventAttendee(),
      buildEventAttendee(),
    ];

void checkUnnamed20(core.List<api.EventAttendee> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.EventExtendedProperties buildEventExtendedProperties() {
  ...
  if (buildCounterEventExtendedProperties < 3) {
    o.private = buildUnnamed21();
    o.shared = buildUnnamed22();
  }
  buildCounterEventExtendedProperties--;
  return o;
}
...
void checkEventExtendedProperties(api.EventExtendedProperties o) {
  buildCounterEventExtendedProperties++;
  if (buildCounterEventExtendedProperties < 3) {
    checkUnnamed21(o.private!);
    checkUnnamed22(o.shared!);
  }
  buildCounterEventExtendedProperties--;
}
...
core.List<api.EventReminder> buildUnnamed25() => [
      buildEventReminder(),
      buildEventReminder(),
    ];

void checkUnnamed25(core.List<api.EventReminder> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEventReminder(o[0]);
  checkEventReminder(o[1]);
}
...
core.List<api.EventReminder> buildUnnamed26() => [
      buildEventReminder(),
      buildEventReminder(),
    ];

void checkUnnamed26(core.List<api.EventReminder> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEventReminder(o[0]);
  checkEventReminder(o[1]);
}

core.List<api.Event> buildUnnamed27() => [
      buildEvent(),
      buildEvent(),
    ];

void checkUnnamed27(core.List<api.Event> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEvent(o[0]);
  checkEvent(o[1]);
}
...
api.Events buildEvents() {
  ...
  if (buildCounterEvents < 3) {
    o.accessRole = 'foo';
    o.defaultReminders = buildUnnamed26();
    o.description = 'foo';
    o.etag = 'foo';
...
void checkEvents(api.Events o) {
  ...
  if (buildCounterEvents < 3) {
    ...
    checkUnnamed26(o.defaultReminders!);
    unittest.expect(
      o.description!,
      unittest.equals('foo'),
    );
...
core.List<api.TimePeriod> buildUnnamed28() => [
      buildTimePeriod(),
      buildTimePeriod(),
    ];

void checkUnnamed28(core.List<api.TimePeriod> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTimePeriod(o[0]);
  checkTimePeriod(o[1]);
}

core.List<api.Error> buildUnnamed29() => [
      buildError(),
      buildError(),
    ];

void checkUnnamed29(core.List<api.Error> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkError(o[0]);
  checkError(o[1]);
}
...
core.List<api.Error> buildUnnamed31() => [
      buildError(),
      buildError(),
    ];
...
void checkFreeBusyGroup(api.FreeBusyGroup o) {
  buildCounterFreeBusyGroup++;
  if (buildCounterFreeBusyGroup < 3) {
    checkUnnamed30(o.calendars!);
    checkUnnamed31(o.errors!);
  }
  buildCounterFreeBusyGroup--;
}

core.List<api.FreeBusyRequestItem> buildUnnamed32() => [
      buildFreeBusyRequestItem(),
      buildFreeBusyRequestItem(),
    ];

void checkUnnamed32(core.List<api.FreeBusyRequestItem> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, api.FreeBusyCalendar> buildUnnamed33() => {
      'x': buildFreeBusyCalendar(),
      'y': buildFreeBusyCalendar(),
    };

void checkUnnamed33(core.Map<core.String, api.FreeBusyCalendar> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFreeBusyCalendar(o['x']!);
  checkFreeBusyCalendar(o['y']!);
}

core.Map<core.String, api.FreeBusyGroup> buildUnnamed34() => {
      'x': buildFreeBusyGroup(),
      'y': buildFreeBusyGroup(),
    };

void checkUnnamed34(core.Map<core.String, api.FreeBusyGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Setting> buildUnnamed35() => [
      buildSetting(),
      buildSetting(),
    ];

void checkUnnamed35(core.List<api.Setting> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSetting(o[0]);
  checkSetting(o[1]);
}
...
void main() {
  ...
  unittest.group('resource-EventsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final arg_pageToken = 'foo';
      final arg_privateExtendedProperty = buildUnnamed36();
      final arg_q = 'foo';
      final arg_sharedExtendedProperty = buildUnnamed37();
      final arg_showDeleted = true;
    ...
    unittest.test('method--watch', () async {
      ...
      final arg_orderBy = 'foo';
      final arg_pageToken = 'foo';
      final arg_privateExtendedProperty = buildUnnamed38();
      final arg_q = 'foo';
      final arg_sharedExtendedProperty = buildUnnamed39();
      final arg_showDeleted = true;
      final arg_showHiddenInvitations = true;
      final arg_singleEvents = true;
      final arg_syncToken = 'foo';
