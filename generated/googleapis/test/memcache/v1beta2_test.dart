...
import 'package:googleapis/memcache/v1beta2.dart' as api;
...
core.int buildCounterApplySoftwareUpdateRequest = 0;
api.ApplySoftwareUpdateRequest buildApplySoftwareUpdateRequest() {
  final o = api.ApplySoftwareUpdateRequest();
  buildCounterApplySoftwareUpdateRequest++;
  if (buildCounterApplySoftwareUpdateRequest < 3) {
    o.applyAll = true;
    o.nodeIds = buildUnnamed1();
  }
  buildCounterApplySoftwareUpdateRequest--;
  return o;
}

void checkApplySoftwareUpdateRequest(api.ApplySoftwareUpdateRequest o) {
  buildCounterApplySoftwareUpdateRequest++;
  if (buildCounterApplySoftwareUpdateRequest < 3) {
    unittest.expect(o.applyAll!, unittest.isTrue);
    checkUnnamed1(o.nodeIds!);
  }
  buildCounterApplySoftwareUpdateRequest--;
}
...
core.int buildCounterGoogleCloudMemcacheV1beta2MaintenancePolicy = 0;
api.GoogleCloudMemcacheV1beta2MaintenancePolicy
buildGoogleCloudMemcacheV1beta2MaintenancePolicy() {
  final o = api.GoogleCloudMemcacheV1beta2MaintenancePolicy();
  buildCounterGoogleCloudMemcacheV1beta2MaintenancePolicy++;
  if (buildCounterGoogleCloudMemcacheV1beta2MaintenancePolicy < 3) {
    o.createTime = 'foo';
    o.description = 'foo';
    o.updateTime = 'foo';
...
void checkGoogleCloudMemcacheV1beta2MaintenancePolicy(
  api.GoogleCloudMemcacheV1beta2MaintenancePolicy o,
) {
  buildCounterGoogleCloudMemcacheV1beta2MaintenancePolicy++;
  if (buildCounterGoogleCloudMemcacheV1beta2MaintenancePolicy < 3) {
...
core.int buildCounterGoogleCloudMemcacheV1beta2UpgradeInstanceRequest = 0;
api.GoogleCloudMemcacheV1beta2UpgradeInstanceRequest
buildGoogleCloudMemcacheV1beta2UpgradeInstanceRequest() {
  final o = api.GoogleCloudMemcacheV1beta2UpgradeInstanceRequest();
  buildCounterGoogleCloudMemcacheV1beta2UpgradeInstanceRequest++;
  if (buildCounterGoogleCloudMemcacheV1beta2UpgradeInstanceRequest < 3) {
...
void checkGoogleCloudMemcacheV1beta2UpgradeInstanceRequest(
  api.GoogleCloudMemcacheV1beta2UpgradeInstanceRequest o,
) {
  buildCounterGoogleCloudMemcacheV1beta2UpgradeInstanceRequest++;
  if (buildCounterGoogleCloudMemcacheV1beta2UpgradeInstanceRequest < 3) {
...
core.List<api.InstanceMessage> buildUnnamed3() => [
  buildInstanceMessage(),
  buildInstanceMessage(),
];

void checkUnnamed3(core.List<api.InstanceMessage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Node> buildUnnamed5() => [buildNode(), buildNode()];

void checkUnnamed5(core.List<api.Node> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNode(o[0]);
  checkNode(o[1]);
}
...
api.Instance buildInstance() {
  ...
  if (buildCounterInstance < 3) {
    ...
    o.displayName = 'foo';
    o.instanceMessages = buildUnnamed3();
    o.labels = buildUnnamed4();
    o.maintenancePolicy = buildGoogleCloudMemcacheV1beta2MaintenancePolicy();
    o.maintenanceSchedule = buildMaintenanceSchedule();
    o.memcacheFullVersion = 'foo';
    o.memcacheNodes = buildUnnamed5();
    o.memcacheVersion = 'foo';
    o.name = 'foo';
    o.nodeConfig = buildNodeConfig();
    o.nodeCount = 42;
    o.parameters = buildMemcacheParameters();
    o.reservedIpRangeId = buildUnnamed6();
    o.satisfiesPzi = true;
    o.satisfiesPzs = true;
    o.state = 'foo';
...
core.List<api.Instance> buildUnnamed8() => [buildInstance(), buildInstance()];
...
void main() {
  ...
  unittest.group('obj-schema-ApplySoftwareUpdateRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildApplySoftwareUpdateRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ApplySoftwareUpdateRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkApplySoftwareUpdateRequest(od);
    });
  });
  ...
  unittest.group('obj-schema-GoogleCloudMemcacheV1beta2MaintenancePolicy', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudMemcacheV1beta2MaintenancePolicy();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudMemcacheV1beta2MaintenancePolicy.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudMemcacheV1beta2MaintenancePolicy(od);
    });
  });

  unittest.group(
    'obj-schema-GoogleCloudMemcacheV1beta2UpgradeInstanceRequest',
    () {
      unittest.test('to-json--from-json', () async {
        final o = buildGoogleCloudMemcacheV1beta2UpgradeInstanceRequest();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api
            .GoogleCloudMemcacheV1beta2UpgradeInstanceRequest.fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
        checkGoogleCloudMemcacheV1beta2UpgradeInstanceRequest(od);
      });
    },
  );
  ...
  unittest.group('resource-ProjectsLocationsInstancesResource', () {
    ...
    unittest.test('method--applySoftwareUpdate', () async {
      final mock = HttpServerMock();
      final res =
          api.CloudMemorystoreForMemcachedApi(
            mock,
          ).projects.locations.instances;
      final arg_request = buildApplySoftwareUpdateRequest();
      final arg_instance = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.ApplySoftwareUpdateRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkApplySoftwareUpdateRequest(obj);
      ...
      final response = await res.applySoftwareUpdate(
        arg_request,
        arg_instance,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--upgrade', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          checkGoogleCloudMemcacheV1beta2UpgradeInstanceRequest(obj);
