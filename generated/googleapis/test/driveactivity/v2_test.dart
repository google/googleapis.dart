...
core.List<api.User> buildUnnamed4788() {
  var o = <api.User>[];
  o.add(buildUser());
  o.add(buildUser());
  return o;
...
void checkUnnamed4788(core.List<api.User> o) {
...
api.Comment buildComment() {
  ...
  if (buildCounterComment < 3) {
    ...
    o.mentionedUsers = buildUnnamed4788();
    o.post = buildPost();
...
void checkComment(api.Comment o) {
  ...
  if (buildCounterComment < 3) {
    ...
    checkUnnamed4788(o.mentionedUsers!);
...
core.List<api.Action> buildUnnamed4789() {
  var o = <api.Action>[];
  o.add(buildAction());
  o.add(buildAction());
  return o;
...
void checkUnnamed4789(core.List<api.Action> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAction(o[0] as api.Action);
  checkAction(o[1] as api.Action);
}

core.List<api.Actor> buildUnnamed4790() {
  var o = <api.Actor>[];
  o.add(buildActor());
  o.add(buildActor());
  return o;
...
void checkUnnamed4790(core.List<api.Actor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkActor(o[0] as api.Actor);
  checkActor(o[1] as api.Actor);
}

core.List<api.Target> buildUnnamed4791() {
  var o = <api.Target>[];
  o.add(buildTarget());
  o.add(buildTarget());
  return o;
...
void checkUnnamed4791(core.List<api.Target> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DriveActivity buildDriveActivity() {
  ...
  if (buildCounterDriveActivity < 3) {
    o.actions = buildUnnamed4789();
    o.actors = buildUnnamed4790();
    o.primaryActionDetail = buildActionDetail();
    o.targets = buildUnnamed4791();
    o.timeRange = buildTimeRange();
    o.timestamp = 'foo';
  }
  buildCounterDriveActivity--;
...
void checkDriveActivity(api.DriveActivity o) {
  buildCounterDriveActivity++;
  if (buildCounterDriveActivity < 3) {
    checkUnnamed4789(o.actions!);
    checkUnnamed4790(o.actors!);
    checkActionDetail(o.primaryActionDetail! as api.ActionDetail);
    checkUnnamed4791(o.targets!);
    checkTimeRange(o.timeRange! as api.TimeRange);
    unittest.expect(
      o.timestamp!,
      unittest.equals('foo'),
...
core.List<api.TargetReference> buildUnnamed4792() {
...
void checkUnnamed4792(core.List<api.TargetReference> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTargetReference(o[0] as api.TargetReference);
  checkTargetReference(o[1] as api.TargetReference);
}

core.List<api.TargetReference> buildUnnamed4793() {
  var o = <api.TargetReference>[];
  o.add(buildTargetReference());
  o.add(buildTargetReference());
  return o;
...
void checkUnnamed4793(core.List<api.TargetReference> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTargetReference(o[0] as api.TargetReference);
  checkTargetReference(o[1] as api.TargetReference);
}
...
api.Move buildMove() {
  ...
  if (buildCounterMove < 3) {
    o.addedParents = buildUnnamed4792();
    o.removedParents = buildUnnamed4793();
  }
  buildCounterMove--;
  return o;
}
...
void checkMove(api.Move o) {
  buildCounterMove++;
  if (buildCounterMove < 3) {
    checkUnnamed4792(o.addedParents!);
    checkUnnamed4793(o.removedParents!);
  }
  buildCounterMove--;
}
...
core.List<api.Permission> buildUnnamed4794() {
  var o = <api.Permission>[];
...
void checkUnnamed4794(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0] as api.Permission);
  checkPermission(o[1] as api.Permission);
}

core.List<api.Permission> buildUnnamed4795() {
  var o = <api.Permission>[];
  o.add(buildPermission());
  o.add(buildPermission());
  return o;
...
void checkUnnamed4795(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0] as api.Permission);
  checkPermission(o[1] as api.Permission);
}
...
api.PermissionChange buildPermissionChange() {
  ...
  if (buildCounterPermissionChange < 3) {
    o.addedPermissions = buildUnnamed4794();
    o.removedPermissions = buildUnnamed4795();
  }
  buildCounterPermissionChange--;
  return o;
}
...
void checkPermissionChange(api.PermissionChange o) {
  buildCounterPermissionChange++;
  if (buildCounterPermissionChange < 3) {
    checkUnnamed4794(o.addedPermissions!);
    checkUnnamed4795(o.removedPermissions!);
  }
  buildCounterPermissionChange--;
}
...
core.List<api.DriveActivity> buildUnnamed4796() {
  var o = <api.DriveActivity>[];
...
void checkUnnamed4796(core.List<api.DriveActivity> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.RestrictionChange> buildUnnamed4797() {
  var o = <api.RestrictionChange>[];
...
void checkUnnamed4797(core.List<api.RestrictionChange> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SettingsChange buildSettingsChange() {
  ...
  if (buildCounterSettingsChange < 3) {
    o.restrictionChanges = buildUnnamed4797();
  }
  buildCounterSettingsChange--;
  return o;
}
...
void checkSettingsChange(api.SettingsChange o) {
  buildCounterSettingsChange++;
  if (buildCounterSettingsChange < 3) {
    checkUnnamed4797(o.restrictionChanges!);
  }
  buildCounterSettingsChange--;
}
