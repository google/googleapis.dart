...
core.List<api.User> buildUnnamed5660() => [
      buildUser(),
      buildUser(),
    ];

void checkUnnamed5660(core.List<api.User> o) {
...
api.Comment buildComment() {
  ...
  if (buildCounterComment < 3) {
    ...
    o.mentionedUsers = buildUnnamed5660();
    o.post = buildPost();
...
void checkComment(api.Comment o) {
  ...
  if (buildCounterComment < 3) {
    ...
    checkUnnamed5660(o.mentionedUsers!);
    checkPost(o.post!);
...
core.List<api.Action> buildUnnamed5661() => [
      buildAction(),
      buildAction(),
    ];

void checkUnnamed5661(core.List<api.Action> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAction(o[0]);
  checkAction(o[1]);
}

core.List<api.Actor> buildUnnamed5662() => [
      buildActor(),
      buildActor(),
    ];

void checkUnnamed5662(core.List<api.Actor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkActor(o[0]);
  checkActor(o[1]);
}

core.List<api.Target> buildUnnamed5663() => [
      buildTarget(),
      buildTarget(),
    ];

void checkUnnamed5663(core.List<api.Target> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTarget(o[0]);
  checkTarget(o[1]);
}
...
api.DriveActivity buildDriveActivity() {
  ...
  if (buildCounterDriveActivity < 3) {
    o.actions = buildUnnamed5661();
    o.actors = buildUnnamed5662();
    o.primaryActionDetail = buildActionDetail();
    o.targets = buildUnnamed5663();
    o.timeRange = buildTimeRange();
    o.timestamp = 'foo';
  }
  buildCounterDriveActivity--;
...
void checkDriveActivity(api.DriveActivity o) {
  buildCounterDriveActivity++;
  if (buildCounterDriveActivity < 3) {
    checkUnnamed5661(o.actions!);
    checkUnnamed5662(o.actors!);
    checkActionDetail(o.primaryActionDetail!);
    checkUnnamed5663(o.targets!);
    checkTimeRange(o.timeRange!);
    unittest.expect(
      o.timestamp!,
      unittest.equals('foo'),
...
core.List<api.TargetReference> buildUnnamed5664() => [
      buildTargetReference(),
      buildTargetReference(),
    ];

void checkUnnamed5664(core.List<api.TargetReference> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTargetReference(o[0]);
  checkTargetReference(o[1]);
}

core.List<api.TargetReference> buildUnnamed5665() => [
      buildTargetReference(),
      buildTargetReference(),
    ];

void checkUnnamed5665(core.List<api.TargetReference> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTargetReference(o[0]);
  checkTargetReference(o[1]);
}
...
api.Move buildMove() {
  ...
  if (buildCounterMove < 3) {
    o.addedParents = buildUnnamed5664();
    o.removedParents = buildUnnamed5665();
  }
  buildCounterMove--;
  return o;
}
...
void checkMove(api.Move o) {
  buildCounterMove++;
  if (buildCounterMove < 3) {
    checkUnnamed5664(o.addedParents!);
    checkUnnamed5665(o.removedParents!);
  }
  buildCounterMove--;
}
...
core.List<api.Permission> buildUnnamed5666() => [
      buildPermission(),
      buildPermission(),
    ];

void checkUnnamed5666(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0]);
  checkPermission(o[1]);
}

core.List<api.Permission> buildUnnamed5667() => [
      buildPermission(),
      buildPermission(),
    ];

void checkUnnamed5667(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0]);
  checkPermission(o[1]);
}
...
api.PermissionChange buildPermissionChange() {
  ...
  if (buildCounterPermissionChange < 3) {
    o.addedPermissions = buildUnnamed5666();
    o.removedPermissions = buildUnnamed5667();
  }
  buildCounterPermissionChange--;
  return o;
}
...
void checkPermissionChange(api.PermissionChange o) {
  buildCounterPermissionChange++;
  if (buildCounterPermissionChange < 3) {
    checkUnnamed5666(o.addedPermissions!);
    checkUnnamed5667(o.removedPermissions!);
  }
  buildCounterPermissionChange--;
}
...
core.List<api.DriveActivity> buildUnnamed5668() => [
      buildDriveActivity(),
      buildDriveActivity(),
    ];

void checkUnnamed5668(core.List<api.DriveActivity> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.RestrictionChange> buildUnnamed5669() => [
      buildRestrictionChange(),
      buildRestrictionChange(),
    ];

void checkUnnamed5669(core.List<api.RestrictionChange> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SettingsChange buildSettingsChange() {
  ...
  if (buildCounterSettingsChange < 3) {
    o.restrictionChanges = buildUnnamed5669();
  }
  buildCounterSettingsChange--;
  return o;
}
...
void checkSettingsChange(api.SettingsChange o) {
  buildCounterSettingsChange++;
  if (buildCounterSettingsChange < 3) {
    checkUnnamed5669(o.restrictionChanges!);
  }
  buildCounterSettingsChange--;
}
