...
core.List<api.CustomDimension> buildUnnamed1819() => [
      buildCustomDimension(),
      buildCustomDimension(),
    ];

void checkUnnamed1819(core.List<api.CustomDimension> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCustomDimension(o[0]);
  checkCustomDimension(o[1]);
}

core.List<api.CustomMetric> buildUnnamed1820() => [
      buildCustomMetric(),
      buildCustomMetric(),
    ];

void checkUnnamed1820(core.List<api.CustomMetric> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Conversion buildConversion() {
  ...
  if (buildCounterConversion < 3) {
    ...
    o.criterionId = 'foo';
    o.currencyCode = 'foo';
    o.customDimension = buildUnnamed1819();
    o.customMetric = buildUnnamed1820();
    o.deviceType = 'foo';
...
void checkConversion(api.Conversion o) {
  ...
  if (buildCounterConversion < 3) {
    ...
    checkUnnamed1819(o.customDimension!);
    checkUnnamed1820(o.customMetric!);
    unittest.expect(
      o.deviceType!,
      unittest.equals('foo'),
    );
...
core.List<api.Conversion> buildUnnamed1821() => [
      buildConversion(),
      buildConversion(),
    ];

void checkUnnamed1821(core.List<api.Conversion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkConversion(o[0]);
  checkConversion(o[1]);
}
...
core.List<api.ReportFiles> buildUnnamed1822() => [
      buildReportFiles(),
      buildReportFiles(),
    ];

void checkUnnamed1822(core.List<api.ReportFiles> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReportFiles(o[0]);
  checkReportFiles(o[1]);
}

core.List<api.ReportRow> buildUnnamed1823() => [
      buildReportRow(),
      buildReportRow(),
    ];

void checkUnnamed1823(core.List<api.ReportRow> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReportRow(o[0]);
  checkReportRow(o[1]);
}
...
core.List<api.ReportApiColumnSpec> buildUnnamed1824() => [
      buildReportApiColumnSpec(),
      buildReportApiColumnSpec(),
    ];

void checkUnnamed1824(core.List<api.ReportApiColumnSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReportApiColumnSpec(o[0]);
  checkReportApiColumnSpec(o[1]);
}

core.List<core.Object> buildUnnamed1825() => [
      {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed1825(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkReportRequestFilters(api.ReportRequestFilters o) {
  ...
  if (buildCounterReportRequestFilters < 3) {
    ...
    checkUnnamed1825(o.values!);
  }
  buildCounterReportRequestFilters--;
}

core.List<api.ReportRequestFilters> buildUnnamed1826() => [
      buildReportRequestFilters(),
      buildReportRequestFilters(),
    ];

void checkUnnamed1826(core.List<api.ReportRequestFilters> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ReportRequestOrderBy> buildUnnamed1827() => [
      buildReportRequestOrderBy(),
      buildReportRequestOrderBy(),
    ];

void checkUnnamed1827(core.List<api.ReportRequestOrderBy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ReportRequest buildReportRequest() {
  ...
  if (buildCounterReportRequest < 3) {
    o.columns = buildUnnamed1824();
    o.downloadFormat = 'foo';
    o.filters = buildUnnamed1826();
    o.includeDeletedEntities = true;
    o.includeRemovedEntities = true;
    o.maxRowsPerFile = 42;
    o.orderBy = buildUnnamed1827();
...
void checkReportRequest(api.ReportRequest o) {
  buildCounterReportRequest++;
  if (buildCounterReportRequest < 3) {
    checkUnnamed1824(o.columns!);
    unittest.expect(
      o.downloadFormat!,
      unittest.equals('foo'),
    );
    checkUnnamed1826(o.filters!);
...
core.List<api.SavedColumn> buildUnnamed1828() => [
      buildSavedColumn(),
      buildSavedColumn(),
    ];

void checkUnnamed1828(core.List<api.SavedColumn> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Availability> buildUnnamed1829() => [
      buildAvailability(),
      buildAvailability(),
    ];

void checkUnnamed1829(core.List<api.Availability> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.UpdateAvailabilityRequest buildUpdateAvailabilityRequest() {
  ...
  if (buildCounterUpdateAvailabilityRequest < 3) {
    o.availabilities = buildUnnamed1829();
  }
  buildCounterUpdateAvailabilityRequest--;
  return o;
}
...
void checkUpdateAvailabilityRequest(api.UpdateAvailabilityRequest o) {
  buildCounterUpdateAvailabilityRequest++;
  if (buildCounterUpdateAvailabilityRequest < 3) {
    checkUnnamed1829(o.availabilities!);
  }
  buildCounterUpdateAvailabilityRequest--;
}

core.List<api.Availability> buildUnnamed1830() => [
      buildAvailability(),
      buildAvailability(),
    ];

void checkUnnamed1830(core.List<api.Availability> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAvailability(o[0]);
  checkAvailability(o[1]);
}
...
api.UpdateAvailabilityResponse buildUpdateAvailabilityResponse() {
  ...
  if (buildCounterUpdateAvailabilityResponse < 3) {
    o.availabilities = buildUnnamed1830();
  }
  buildCounterUpdateAvailabilityResponse--;
  return o;
}
...
void checkUpdateAvailabilityResponse(api.UpdateAvailabilityResponse o) {
  buildCounterUpdateAvailabilityResponse++;
  if (buildCounterUpdateAvailabilityResponse < 3) {
    checkUnnamed1830(o.availabilities!);
  }
  buildCounterUpdateAvailabilityResponse--;
}
