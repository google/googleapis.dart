...
core.List<api.CustomDimension> buildUnnamed723() => [
      buildCustomDimension(),
      buildCustomDimension(),
    ];

void checkUnnamed723(core.List<api.CustomDimension> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCustomDimension(o[0]);
  checkCustomDimension(o[1]);
}

core.List<api.CustomMetric> buildUnnamed724() => [
      buildCustomMetric(),
      buildCustomMetric(),
    ];

void checkUnnamed724(core.List<api.CustomMetric> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Conversion buildConversion() {
  ...
  if (buildCounterConversion < 3) {
    ...
    o.criterionId = 'foo';
    o.currencyCode = 'foo';
    o.customDimension = buildUnnamed723();
    o.customMetric = buildUnnamed724();
    o.deviceType = 'foo';
...
void checkConversion(api.Conversion o) {
  ...
  if (buildCounterConversion < 3) {
    ...
    checkUnnamed723(o.customDimension!);
    checkUnnamed724(o.customMetric!);
    unittest.expect(
      o.deviceType!,
      unittest.equals('foo'),
    );
...
core.List<api.Conversion> buildUnnamed725() => [
      buildConversion(),
      buildConversion(),
    ];

void checkUnnamed725(core.List<api.Conversion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkConversion(o[0]);
  checkConversion(o[1]);
}
...
core.List<api.ReportFiles> buildUnnamed726() => [
      buildReportFiles(),
      buildReportFiles(),
    ];

void checkUnnamed726(core.List<api.ReportFiles> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReportFiles(o[0]);
  checkReportFiles(o[1]);
}

core.List<api.ReportRow> buildUnnamed727() => [
      buildReportRow(),
      buildReportRow(),
    ];

void checkUnnamed727(core.List<api.ReportRow> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReportRow(o[0]);
  checkReportRow(o[1]);
}
...
core.List<api.ReportApiColumnSpec> buildUnnamed728() => [
      buildReportApiColumnSpec(),
      buildReportApiColumnSpec(),
    ];

void checkUnnamed728(core.List<api.ReportApiColumnSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReportApiColumnSpec(o[0]);
  checkReportApiColumnSpec(o[1]);
}

core.List<core.Object> buildUnnamed729() => [
      {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed729(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkReportRequestFilters(api.ReportRequestFilters o) {
  ...
  if (buildCounterReportRequestFilters < 3) {
    ...
    checkUnnamed729(o.values!);
  }
  buildCounterReportRequestFilters--;
}

core.List<api.ReportRequestFilters> buildUnnamed730() => [
      buildReportRequestFilters(),
      buildReportRequestFilters(),
    ];

void checkUnnamed730(core.List<api.ReportRequestFilters> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ReportRequestOrderBy> buildUnnamed731() => [
      buildReportRequestOrderBy(),
      buildReportRequestOrderBy(),
    ];

void checkUnnamed731(core.List<api.ReportRequestOrderBy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkReportRequest(api.ReportRequest o) {
  buildCounterReportRequest++;
  if (buildCounterReportRequest < 3) {
    checkUnnamed728(o.columns!);
    unittest.expect(
      o.downloadFormat!,
      unittest.equals('foo'),
    );
    checkUnnamed730(o.filters!);
...
core.List<api.SavedColumn> buildUnnamed732() => [
      buildSavedColumn(),
      buildSavedColumn(),
    ];

void checkUnnamed732(core.List<api.SavedColumn> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Availability> buildUnnamed733() => [
      buildAvailability(),
      buildAvailability(),
    ];

void checkUnnamed733(core.List<api.Availability> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.UpdateAvailabilityRequest buildUpdateAvailabilityRequest() {
  ...
  if (buildCounterUpdateAvailabilityRequest < 3) {
    o.availabilities = buildUnnamed733();
  }
  buildCounterUpdateAvailabilityRequest--;
  return o;
}
...
void checkUpdateAvailabilityRequest(api.UpdateAvailabilityRequest o) {
  buildCounterUpdateAvailabilityRequest++;
  if (buildCounterUpdateAvailabilityRequest < 3) {
    checkUnnamed733(o.availabilities!);
  }
  buildCounterUpdateAvailabilityRequest--;
}

core.List<api.Availability> buildUnnamed734() => [
      buildAvailability(),
      buildAvailability(),
    ];

void checkUnnamed734(core.List<api.Availability> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAvailability(o[0]);
  checkAvailability(o[1]);
}
...
api.UpdateAvailabilityResponse buildUpdateAvailabilityResponse() {
  ...
  if (buildCounterUpdateAvailabilityResponse < 3) {
    o.availabilities = buildUnnamed734();
  }
  buildCounterUpdateAvailabilityResponse--;
  return o;
}
...
void checkUpdateAvailabilityResponse(api.UpdateAvailabilityResponse o) {
  buildCounterUpdateAvailabilityResponse++;
  if (buildCounterUpdateAvailabilityResponse < 3) {
    checkUnnamed734(o.availabilities!);
  }
  buildCounterUpdateAvailabilityResponse--;
}
