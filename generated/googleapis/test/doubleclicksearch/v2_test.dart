...
checkUnnamed949(core.List<api.CustomDimension> o) {
...
checkUnnamed950(core.List<api.CustomMetric> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildConversion() {
  ...
  if (buildCounterConversion < 3) {
    ...
    o.criterionId = "foo";
    o.currencyCode = "foo";
    o.customDimension = buildUnnamed949();
    o.customMetric = buildUnnamed950();
    o.deviceType = "foo";
...
checkConversion(api.Conversion o) {
  ...
  if (buildCounterConversion < 3) {
    ...
    checkUnnamed949(o.customDimension);
    checkUnnamed950(o.customMetric);
...
checkUnnamed951(core.List<api.Conversion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkConversion(o[0]);
  checkConversion(o[1]);
}
...
checkUnnamed952(core.List<api.ReportFiles> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed953(core.List<api.ReportRow> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReportRow(o[0]);
  checkReportRow(o[1]);
}
...
checkUnnamed954(core.List<api.ReportApiColumnSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed956(core.List<api.ReportRequestFilters> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed957(core.List<api.ReportRequestOrderBy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed958(core.List<api.SavedColumn> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed959(core.List<api.Availability> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUpdateAvailabilityRequest() {
  ...
  if (buildCounterUpdateAvailabilityRequest < 3) {
    o.availabilities = buildUnnamed959();
  }
  buildCounterUpdateAvailabilityRequest--;
  return o;
}
...
checkUpdateAvailabilityRequest(api.UpdateAvailabilityRequest o) {
  buildCounterUpdateAvailabilityRequest++;
  if (buildCounterUpdateAvailabilityRequest < 3) {
    checkUnnamed959(o.availabilities);
  }
  buildCounterUpdateAvailabilityRequest--;
}
