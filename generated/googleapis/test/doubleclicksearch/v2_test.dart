...
checkUnnamed1700(core.List<api.CustomDimension> o) {
...
checkUnnamed1701(core.List<api.CustomMetric> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildConversion() {
  ...
  if (buildCounterConversion < 3) {
    ...
    o.criterionId = "foo";
    o.currencyCode = "foo";
    o.customDimension = buildUnnamed1700();
    o.customMetric = buildUnnamed1701();
    o.deviceType = "foo";
...
checkConversion(api.Conversion o) {
  ...
  if (buildCounterConversion < 3) {
    ...
    checkUnnamed1700(o.customDimension);
    checkUnnamed1701(o.customMetric);
...
checkUnnamed1702(core.List<api.Conversion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkConversion(o[0]);
  checkConversion(o[1]);
}
...
checkUnnamed1703(core.List<api.ReportFiles> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1704(core.List<api.ReportRow> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReportRow(o[0]);
  checkReportRow(o[1]);
}
...
checkUnnamed1705(core.List<api.ReportApiColumnSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1706(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1707(core.List<api.ReportRequestFilters> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1708(core.List<api.ReportRequestOrderBy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1709(core.List<api.SavedColumn> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1710(core.List<api.Availability> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUpdateAvailabilityRequest() {
  ...
  if (buildCounterUpdateAvailabilityRequest < 3) {
    o.availabilities = buildUnnamed1710();
  }
  buildCounterUpdateAvailabilityRequest--;
  return o;
}
...
checkUpdateAvailabilityRequest(api.UpdateAvailabilityRequest o) {
  buildCounterUpdateAvailabilityRequest++;
  if (buildCounterUpdateAvailabilityRequest < 3) {
    checkUnnamed1710(o.availabilities);
  }
  buildCounterUpdateAvailabilityRequest--;
}
...
checkUnnamed1711(core.List<api.Availability> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAvailability(o[0]);
  checkAvailability(o[1]);
}
...
buildUpdateAvailabilityResponse() {
  ...
  if (buildCounterUpdateAvailabilityResponse < 3) {
    o.availabilities = buildUnnamed1711();
  }
  buildCounterUpdateAvailabilityResponse--;
  return o;
}
...
checkUpdateAvailabilityResponse(api.UpdateAvailabilityResponse o) {
  buildCounterUpdateAvailabilityResponse++;
  if (buildCounterUpdateAvailabilityResponse < 3) {
    checkUnnamed1711(o.availabilities);
  }
  buildCounterUpdateAvailabilityResponse--;
}
