...
buildBagDescriptor() {
  ...
  if (buildCounterBagDescriptor < 3) {
    ...
    o.count = 42;
    o.description = buildUnnamed3020();
    o.kind = "foo";
    o.subcode = "foo";
  }
  buildCounterBagDescriptor--;
...
checkBagDescriptor(api.BagDescriptor o) {
  ...
  if (buildCounterBagDescriptor < 3) {
    ...
    checkUnnamed3020(o.description);
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed3021(core.List<api.AircraftData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3022(core.List<api.AirportData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3023(core.List<api.CarrierData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3024(core.List<api.CityData> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCityData(o[0]);
  checkCityData(o[1]);
}
...
checkUnnamed3025(core.List<api.TaxData> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTaxData(o[0]);
  checkTaxData(o[1]);
}
...
buildData() {
  ...
  if (buildCounterData < 3) {
    o.aircraft = buildUnnamed3021();
    o.airport = buildUnnamed3022();
    o.carrier = buildUnnamed3023();
    o.city = buildUnnamed3024();
    o.kind = "foo";
    o.tax = buildUnnamed3025();
  }
  buildCounterData--;
  return o;
}
...
checkData(api.Data o) {
  buildCounterData++;
  if (buildCounterData < 3) {
    checkUnnamed3021(o.aircraft);
    checkUnnamed3022(o.airport);
    checkUnnamed3023(o.carrier);
    checkUnnamed3024(o.city);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed3025(o.tax);
  }
  buildCounterData--;
}
...
checkUnnamed3026(core.List<api.BagDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildFreeBaggageAllowance() {
  ...
  if (buildCounterFreeBaggageAllowance < 3) {
    o.bagDescriptor = buildUnnamed3026();
    o.kilos = 42;
    o.kilosPerPiece = 42;
    o.kind = "foo";
    o.pieces = 42;
...
checkFreeBaggageAllowance(api.FreeBaggageAllowance o) {
  buildCounterFreeBaggageAllowance++;
  if (buildCounterFreeBaggageAllowance < 3) {
    checkUnnamed3026(o.bagDescriptor);
...
checkUnnamed3027(core.List<api.FareInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFareInfo(o[0]);
  checkFareInfo(o[1]);
}
...
checkUnnamed3028(core.List<api.SegmentPricing> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3029(core.List<api.TaxInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTaxInfo(o[0]);
  checkTaxInfo(o[1]);
}
...
buildPricingInfo() {
  ...
  if (buildCounterPricingInfo < 3) {
    ...
    o.saleTaxTotal = "foo";
    o.saleTotal = "foo";
    o.segmentPricing = buildUnnamed3028();
    o.tax = buildUnnamed3029();
  }
  buildCounterPricingInfo--;
  return o;
}
...
checkPricingInfo(api.PricingInfo o) {
  ...
  if (buildCounterPricingInfo < 3) {
    ...
    checkUnnamed3028(o.segmentPricing);
    checkUnnamed3029(o.tax);
  }
  buildCounterPricingInfo--;
}
...
checkUnnamed3030(core.List<api.LegInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLegInfo(o[0]);
  checkLegInfo(o[1]);
}
...
checkUnnamed3031(core.List<api.FreeBaggageAllowance> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSegmentPricing() {
  ...
  if (buildCounterSegmentPricing < 3) {
    o.fareId = "foo";
    o.freeBaggageOption = buildUnnamed3031();
    o.kind = "foo";
    o.segmentId = "foo";
  }
  buildCounterSegmentPricing--;
...
checkSegmentPricing(api.SegmentPricing o) {
  ...
  if (buildCounterSegmentPricing < 3) {
    ...
    checkUnnamed3031(o.freeBaggageOption);
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed3032(core.List<api.SegmentInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSliceInput() {
  ...
  if (buildCounterSliceInput < 3) {
    ...
    o.maxStops = 42;
    o.origin = "foo";
    o.permittedCarrier = buildUnnamed3033();
    o.permittedDepartureTime = buildTimeOfDayRange();
    o.preferredCabin = "foo";
    o.prohibitedCarrier = buildUnnamed3034();
  }
  buildCounterSliceInput--;
  return o;
}
...
checkUnnamed3035(core.List<api.PricingInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3036(core.List<api.SliceInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSliceInfo(o[0]);
  checkSliceInfo(o[1]);
}
...
buildTripOption() {
  ...
  if (buildCounterTripOption < 3) {
    o.id = "foo";
    o.kind = "foo";
    o.pricing = buildUnnamed3035();
    o.saleTotal = "foo";
    o.slice = buildUnnamed3036();
  }
  buildCounterTripOption--;
  return o;
}
...
checkTripOption(api.TripOption o) {
  ...
  if (buildCounterTripOption < 3) {
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed3035(o.pricing);
    unittest.expect(o.saleTotal, unittest.equals('foo'));
    checkUnnamed3036(o.slice);
  }
  buildCounterTripOption--;
}
...
checkUnnamed3037(core.List<api.SliceInput> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSliceInput(o[0]);
  checkSliceInput(o[1]);
}
...
checkUnnamed3038(core.List<api.TripOption> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTripOption(o[0]);
  checkTripOption(o[1]);
}
