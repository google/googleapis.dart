...
buildBagDescriptor() {
  ...
  if (buildCounterBagDescriptor < 3) {
    ...
    o.count = 42;
    o.description = buildUnnamed2457();
    o.kind = "foo";
    o.subcode = "foo";
  }
  buildCounterBagDescriptor--;
...
checkBagDescriptor(api.BagDescriptor o) {
  ...
  if (buildCounterBagDescriptor < 3) {
    ...
    checkUnnamed2457(o.description);
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed2458(core.List<api.AircraftData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2459(core.List<api.AirportData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2460(core.List<api.CarrierData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2461(core.List<api.CityData> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCityData(o[0]);
  checkCityData(o[1]);
}
...
checkUnnamed2462(core.List<api.TaxData> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTaxData(o[0]);
  checkTaxData(o[1]);
}
...
buildData() {
  ...
  if (buildCounterData < 3) {
    o.aircraft = buildUnnamed2458();
    o.airport = buildUnnamed2459();
    o.carrier = buildUnnamed2460();
    o.city = buildUnnamed2461();
    o.kind = "foo";
    o.tax = buildUnnamed2462();
  }
  buildCounterData--;
  return o;
}
...
checkData(api.Data o) {
  buildCounterData++;
  if (buildCounterData < 3) {
    checkUnnamed2458(o.aircraft);
    checkUnnamed2459(o.airport);
    checkUnnamed2460(o.carrier);
    checkUnnamed2461(o.city);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed2462(o.tax);
  }
  buildCounterData--;
}
...
checkUnnamed2463(core.List<api.BagDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildFreeBaggageAllowance() {
  ...
  if (buildCounterFreeBaggageAllowance < 3) {
    o.bagDescriptor = buildUnnamed2463();
    o.kilos = 42;
    o.kilosPerPiece = 42;
    o.kind = "foo";
    o.pieces = 42;
...
checkFreeBaggageAllowance(api.FreeBaggageAllowance o) {
  buildCounterFreeBaggageAllowance++;
  if (buildCounterFreeBaggageAllowance < 3) {
    checkUnnamed2463(o.bagDescriptor);
...
checkUnnamed2464(core.List<api.FareInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFareInfo(o[0]);
  checkFareInfo(o[1]);
}
...
checkUnnamed2465(core.List<api.SegmentPricing> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2466(core.List<api.TaxInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTaxInfo(o[0]);
  checkTaxInfo(o[1]);
}
...
buildPricingInfo() {
  ...
  if (buildCounterPricingInfo < 3) {
    ...
    o.saleTaxTotal = "foo";
    o.saleTotal = "foo";
    o.segmentPricing = buildUnnamed2465();
    o.tax = buildUnnamed2466();
  }
  buildCounterPricingInfo--;
  return o;
}
...
checkPricingInfo(api.PricingInfo o) {
  ...
  if (buildCounterPricingInfo < 3) {
    ...
    checkUnnamed2465(o.segmentPricing);
    checkUnnamed2466(o.tax);
  }
  buildCounterPricingInfo--;
}
...
checkUnnamed2467(core.List<api.LegInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLegInfo(o[0]);
  checkLegInfo(o[1]);
}
...
checkUnnamed2468(core.List<api.FreeBaggageAllowance> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSegmentPricing() {
  ...
  if (buildCounterSegmentPricing < 3) {
    o.fareId = "foo";
    o.freeBaggageOption = buildUnnamed2468();
    o.kind = "foo";
    o.segmentId = "foo";
  }
  buildCounterSegmentPricing--;
...
checkSegmentPricing(api.SegmentPricing o) {
  ...
  if (buildCounterSegmentPricing < 3) {
    ...
    checkUnnamed2468(o.freeBaggageOption);
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed2469(core.List<api.SegmentInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSliceInput() {
  ...
  if (buildCounterSliceInput < 3) {
    ...
    o.maxStops = 42;
    o.origin = "foo";
    o.permittedCarrier = buildUnnamed2470();
    o.permittedDepartureTime = buildTimeOfDayRange();
    o.preferredCabin = "foo";
    o.prohibitedCarrier = buildUnnamed2471();
  }
  buildCounterSliceInput--;
  return o;
}
...
checkUnnamed2472(core.List<api.PricingInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2473(core.List<api.SliceInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSliceInfo(o[0]);
  checkSliceInfo(o[1]);
}
...
buildTripOption() {
  ...
  if (buildCounterTripOption < 3) {
    o.id = "foo";
    o.kind = "foo";
    o.pricing = buildUnnamed2472();
    o.saleTotal = "foo";
    o.slice = buildUnnamed2473();
  }
  buildCounterTripOption--;
  return o;
}
...
checkTripOption(api.TripOption o) {
  ...
  if (buildCounterTripOption < 3) {
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed2472(o.pricing);
    unittest.expect(o.saleTotal, unittest.equals('foo'));
    checkUnnamed2473(o.slice);
  }
  buildCounterTripOption--;
}
...
checkUnnamed2474(core.List<api.SliceInput> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSliceInput(o[0]);
  checkSliceInput(o[1]);
}
...
checkUnnamed2475(core.List<api.TripOption> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTripOption(o[0]);
  checkTripOption(o[1]);
}
