...
core.List<api.LogBucket> buildUnnamed3() => [
  buildLogBucket(),
  buildLogBucket(),
];

void checkUnnamed3(core.List<api.LogBucket> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogBucket(o[0]);
  checkLogBucket(o[1]);
}
...
core.List<api.LogExclusion> buildUnnamed4() => [
  buildLogExclusion(),
  buildLogExclusion(),
];

void checkUnnamed4(core.List<api.LogExclusion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogExclusion(o[0]);
  checkLogExclusion(o[1]);
}
...
void checkListExclusionsResponse(api.ListExclusionsResponse o) {
  buildCounterListExclusionsResponse++;
  if (buildCounterListExclusionsResponse < 3) {
    checkUnnamed4(o.exclusions!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListExclusionsResponse--;
}

core.List<api.Link> buildUnnamed5() => [buildLink(), buildLink()];

void checkUnnamed5(core.List<api.Link> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLink(o[0]);
  checkLink(o[1]);
}
...
void checkListLogEntriesRequest(api.ListLogEntriesRequest o) {
  ...
  if (buildCounterListLogEntriesRequest < 3) {
    ...
    checkUnnamed8(o.resourceNames!);
  }
  buildCounterListLogEntriesRequest--;
}

core.List<api.LogEntry> buildUnnamed9() => [buildLogEntry(), buildLogEntry()];

void checkUnnamed9(core.List<api.LogEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogEntry(o[0]);
  checkLogEntry(o[1]);
}
...
void checkListLogEntriesResponse(api.ListLogEntriesResponse o) {
  buildCounterListLogEntriesResponse++;
  if (buildCounterListLogEntriesResponse < 3) {
    checkUnnamed9(o.entries!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListLogEntriesResponse--;
}

core.List<api.LogMetric> buildUnnamed10() => [
  buildLogMetric(),
  buildLogMetric(),
];

void checkUnnamed10(core.List<api.LogMetric> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogMetric(o[0]);
  checkLogMetric(o[1]);
}
...
core.List<api.LogScope> buildUnnamed11() => [buildLogScope(), buildLogScope()];

void checkUnnamed11(core.List<api.LogScope> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogScope(o[0]);
  checkLogScope(o[1]);
}
...
buildListMonitoredResourceDescriptorsResponse() {
  ...
  if (buildCounterListMonitoredResourceDescriptorsResponse < 3) {
    o.nextPageToken = 'foo';
    o.resourceDescriptors = buildUnnamed13();
  }
  buildCounterListMonitoredResourceDescriptorsResponse--;
  return o;
}
...
void checkListMonitoredResourceDescriptorsResponse(
  ...
  if (buildCounterListMonitoredResourceDescriptorsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed13(o.resourceDescriptors!);
  }
  buildCounterListMonitoredResourceDescriptorsResponse--;
}
...
core.List<api.RecentQuery> buildUnnamed15() => [
  buildRecentQuery(),
  buildRecentQuery(),
];

void checkUnnamed15(core.List<api.RecentQuery> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListRecentQueriesResponse buildListRecentQueriesResponse() {
  ...
  if (buildCounterListRecentQueriesResponse < 3) {
    o.nextPageToken = 'foo';
    o.recentQueries = buildUnnamed15();
...
void checkListRecentQueriesResponse(api.ListRecentQueriesResponse o) {
  ...
  if (buildCounterListRecentQueriesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed15(o.recentQueries!);
    checkUnnamed16(o.unreachable!);
  }
  buildCounterListRecentQueriesResponse--;
}

core.List<api.SavedQuery> buildUnnamed17() => [
  buildSavedQuery(),
  buildSavedQuery(),
];

void checkUnnamed17(core.List<api.SavedQuery> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSavedQuery(o[0]);
  checkSavedQuery(o[1]);
}
...
void checkListSavedQueriesResponse(api.ListSavedQueriesResponse o) {
  ...
  if (buildCounterListSavedQueriesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed17(o.savedQueries!);
    checkUnnamed18(o.unreachable!);
  }
  buildCounterListSavedQueriesResponse--;
}

core.List<api.LogSink> buildUnnamed19() => [buildLogSink(), buildLogSink()];

void checkUnnamed19(core.List<api.LogSink> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogSink(o[0]);
  checkLogSink(o[1]);
}
...
void checkListSinksResponse(api.ListSinksResponse o) {
  ...
  if (buildCounterListSinksResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed19(o.sinks!);
  }
  buildCounterListSinksResponse--;
}

core.List<api.LogView> buildUnnamed20() => [buildLogView(), buildLogView()];

void checkUnnamed20(core.List<api.LogView> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogView(o[0]);
  checkLogView(o[1]);
}
...
core.List<api.IndexConfig> buildUnnamed23() => [
  buildIndexConfig(),
  buildIndexConfig(),
];

void checkUnnamed23(core.List<api.IndexConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.LogBucket buildLogBucket() {
  ...
  if (buildCounterLogBucket < 3) {
    ...
    o.createTime = 'foo';
    o.description = 'foo';
    o.indexConfigs = buildUnnamed23();
    o.lifecycleState = 'foo';
    o.locked = true;
    o.name = 'foo';
    o.restrictedFields = buildUnnamed24();
    o.retentionDays = 42;
    o.updateTime = 'foo';
  }
  buildCounterLogBucket--;
...
void checkLogBucket(api.LogBucket o) {
  ...
  if (buildCounterLogBucket < 3) {
    ...
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    checkUnnamed23(o.indexConfigs!);
    unittest.expect(o.lifecycleState!, unittest.equals('foo'));
    unittest.expect(o.locked!, unittest.isTrue);
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed24(o.restrictedFields!);
...
core.List<api.LogErrorGroup> buildUnnamed25() => [
  buildLogErrorGroup(),
  buildLogErrorGroup(),
];

void checkUnnamed25(core.List<api.LogErrorGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.LogMetric buildLogMetric() {
  ...
  if (buildCounterLogMetric < 3) {
    ...
    o.disabled = true;
    o.filter = 'foo';
    o.labelExtractors = buildUnnamed29();
...
void checkLogMetric(api.LogMetric o) {
  ...
  if (buildCounterLogMetric < 3) {
    ...
    unittest.expect(o.disabled!, unittest.isTrue);
    unittest.expect(o.filter!, unittest.equals('foo'));
    checkUnnamed29(o.labelExtractors!);
...
api.LogScope buildLogScope() {
  ...
  if (buildCounterLogScope < 3) {
    ...
    o.description = 'foo';
    o.name = 'foo';
    o.resourceNames = buildUnnamed30();
    o.updateTime = 'foo';
  }
  buildCounterLogScope--;
  return o;
...
void checkLogScope(api.LogScope o) {
  ...
  if (buildCounterLogScope < 3) {
    ...
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed30(o.resourceNames!);
    unittest.expect(o.updateTime!, unittest.equals('foo'));
  }
  buildCounterLogScope--;
}

core.List<api.LogExclusion> buildUnnamed31() => [
  buildLogExclusion(),
  buildLogExclusion(),
];

void checkUnnamed31(core.List<api.LogExclusion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogExclusion(o[0]);
  checkLogExclusion(o[1]);
}
...
core.List<api.SummaryField> buildUnnamed32() => [
  buildSummaryField(),
  buildSummaryField(),
];

void checkUnnamed32(core.List<api.SummaryField> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.LoggingQuery buildLoggingQuery() {
  ...
  if (buildCounterLoggingQuery < 3) {
    ...
    o.summaryFields = buildUnnamed32();
  }
  buildCounterLoggingQuery--;
  return o;
}
...
void checkLoggingQuery(api.LoggingQuery o) {
  ...
  if (buildCounterLoggingQuery < 3) {
    ...
    checkUnnamed32(o.summaryFields!);
  }
  buildCounterLoggingQuery--;
}

core.List<api.LabelDescriptor> buildUnnamed33() => [
  buildLabelDescriptor(),
  buildLabelDescriptor(),
];

void checkUnnamed33(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MetricDescriptor buildMetricDescriptor() {
  ...
  if (buildCounterMetricDescriptor < 3) {
    ...
    o.metricKind = 'foo';
    o.monitoredResourceTypes = buildUnnamed34();
    o.name = 'foo';
    o.type = 'foo';
    o.unit = 'foo';
    o.valueType = 'foo';
...
void checkMetricDescriptor(api.MetricDescriptor o) {
  ...
  if (buildCounterMetricDescriptor < 3) {
    ...
    checkUnnamed34(o.monitoredResourceTypes!);
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.type!, unittest.equals('foo'));
...
api.MetricDescriptorMetadata buildMetricDescriptorMetadata() {
  ...
  if (buildCounterMetricDescriptorMetadata < 3) {
    ...
    o.launchStage = 'foo';
    o.samplePeriod = 'foo';
    o.timeSeriesResourceHierarchyLevel = buildUnnamed35();
  }
  buildCounterMetricDescriptorMetadata--;
  return o;
}
...
void checkMetricDescriptorMetadata(api.MetricDescriptorMetadata o) {
  ...
  if (buildCounterMetricDescriptorMetadata < 3) {
    ...
    checkUnnamed35(o.timeSeriesResourceHierarchyLevel!);
  }
  buildCounterMetricDescriptorMetadata--;
}
...
api.MonitoredResourceMetadata buildMonitoredResourceMetadata() {
  ...
  if (buildCounterMonitoredResourceMetadata < 3) {
    o.systemLabels = buildUnnamed38();
    o.userLabels = buildUnnamed39();
  }
  buildCounterMonitoredResourceMetadata--;
  return o;
}
...
void checkMonitoredResourceMetadata(api.MonitoredResourceMetadata o) {
  buildCounterMonitoredResourceMetadata++;
  if (buildCounterMonitoredResourceMetadata < 3) {
    checkUnnamed38(o.systemLabels!);
    checkUnnamed39(o.userLabels!);
  }
  buildCounterMonitoredResourceMetadata--;
}
...
api.TailLogEntriesRequest buildTailLogEntriesRequest() {
  ...
  if (buildCounterTailLogEntriesRequest < 3) {
    o.bufferWindow = 'foo';
    o.filter = 'foo';
    o.resourceNames = buildUnnamed45();
  }
  buildCounterTailLogEntriesRequest--;
  return o;
}
...
void checkTailLogEntriesRequest(api.TailLogEntriesRequest o) {
  ...
  if (buildCounterTailLogEntriesRequest < 3) {
    ...
    unittest.expect(o.filter!, unittest.equals('foo'));
    checkUnnamed45(o.resourceNames!);
  }
  buildCounterTailLogEntriesRequest--;
}

core.List<api.LogEntry> buildUnnamed46() => [buildLogEntry(), buildLogEntry()];

void checkUnnamed46(core.List<api.LogEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogEntry(o[0]);
  checkLogEntry(o[1]);
}

core.List<api.SuppressionInfo> buildUnnamed47() => [
  buildSuppressionInfo(),
  buildSuppressionInfo(),
];

void checkUnnamed47(core.List<api.SuppressionInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TailLogEntriesResponse buildTailLogEntriesResponse() {
  ...
  if (buildCounterTailLogEntriesResponse < 3) {
    ...
    o.suppressionInfo = buildUnnamed47();
  }
  buildCounterTailLogEntriesResponse--;
  return o;
}
...
void checkTailLogEntriesResponse(api.TailLogEntriesResponse o) {
  ...
  if (buildCounterTailLogEntriesResponse < 3) {
    ...
    checkUnnamed47(o.suppressionInfo!);
  }
  buildCounterTailLogEntriesResponse--;
}
...
core.List<api.LogEntry> buildUnnamed50() => [buildLogEntry(), buildLogEntry()];

void checkUnnamed50(core.List<api.LogEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogEntry(o[0]);
  checkLogEntry(o[1]);
}
