...
checkUnnamed734(core.List<core.double> o) {
...
checkUnnamed735(core.List<api.LogExclusion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListLogEntriesRequest() {
  ...
  if (buildCounterListLogEntriesRequest < 3) {
    ...
    o.pageSize = 42;
    o.pageToken = "foo";
    o.projectIds = buildUnnamed736();
    o.resourceNames = buildUnnamed737();
  }
  buildCounterListLogEntriesRequest--;
  return o;
}
...
checkListLogEntriesRequest(api.ListLogEntriesRequest o) {
  ...
  if (buildCounterListLogEntriesRequest < 3) {
    ...
    checkUnnamed736(o.projectIds);
    checkUnnamed737(o.resourceNames);
  }
  buildCounterListLogEntriesRequest--;
}
...
checkUnnamed738(core.List<api.LogEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogEntry(o[0]);
  checkLogEntry(o[1]);
}
...
checkUnnamed739(core.List<api.LogMetric> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogMetric(o[0]);
  checkLogMetric(o[1]);
}
...
checkUnnamed741(core.List<api.MonitoredResourceDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListMonitoredResourceDescriptorsResponse() {
  ...
  if (buildCounterListMonitoredResourceDescriptorsResponse < 3) {
    o.nextPageToken = "foo";
    o.resourceDescriptors = buildUnnamed741();
  }
  buildCounterListMonitoredResourceDescriptorsResponse--;
  return o;
}
...
checkListMonitoredResourceDescriptorsResponse(
  ...
  if (buildCounterListMonitoredResourceDescriptorsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed741(o.resourceDescriptors);
  }
  buildCounterListMonitoredResourceDescriptorsResponse--;
}
...
checkUnnamed742(core.List<api.LogSink> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogSink(o[0]);
  checkLogSink(o[1]);
}
...
checkUnnamed743(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed745(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildLogEntry() {
  ...
  if (buildCounterLogEntry < 3) {
    ...
    o.insertId = "foo";
    o.jsonPayload = buildUnnamed743();
    o.labels = buildUnnamed744();
    o.logName = "foo";
    o.metadata = buildMonitoredResourceMetadata();
    o.operation = buildLogEntryOperation();
    o.protoPayload = buildUnnamed745();
...
buildLogMetric() {
  ...
  if (buildCounterLogMetric < 3) {
    ...
    o.description = "foo";
    o.filter = "foo";
    o.labelExtractors = buildUnnamed746();
...
checkLogMetric(api.LogMetric o) {
  ...
  if (buildCounterLogMetric < 3) {
    ...
    unittest.expect(o.description, unittest.equals('foo'));
    unittest.expect(o.filter, unittest.equals('foo'));
    checkUnnamed746(o.labelExtractors);
...
checkUnnamed747(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed749(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelDescriptor(o[0]);
  checkLabelDescriptor(o[1]);
}
...
checkUnnamed750(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildMonitoredResourceMetadata() {
  ...
  if (buildCounterMonitoredResourceMetadata < 3) {
    o.systemLabels = buildUnnamed750();
    o.userLabels = buildUnnamed751();
  }
  buildCounterMonitoredResourceMetadata--;
  return o;
}
...
checkMonitoredResourceMetadata(api.MonitoredResourceMetadata o) {
  buildCounterMonitoredResourceMetadata++;
  if (buildCounterMonitoredResourceMetadata < 3) {
    checkUnnamed750(o.systemLabels);
    checkUnnamed751(o.userLabels);
  }
  buildCounterMonitoredResourceMetadata--;
}
...
checkUnnamed752(core.List<api.LogLine> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogLine(o[0]);
  checkLogLine(o[1]);
}
...
checkUnnamed753(core.List<api.SourceReference> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildRequestLog() {
  ...
  if (buildCounterRequestLog < 3) {
    ...
    o.resource = "foo";
    o.responseSize = "foo";
    o.sourceReference = buildUnnamed753();
    o.startTime = "foo";
    o.status = 42;
    o.taskName = "foo";
    o.taskQueueName = "foo";
...
checkRequestLog(api.RequestLog o) {
  ...
  if (buildCounterRequestLog < 3) {
    ...
    unittest.expect(o.responseSize, unittest.equals('foo'));
    checkUnnamed753(o.sourceReference);
    unittest.expect(o.startTime, unittest.equals('foo'));
    unittest.expect(o.status, unittest.equals(42));
...
checkUnnamed754(core.List<api.LogEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogEntry(o[0]);
  checkLogEntry(o[1]);
}
