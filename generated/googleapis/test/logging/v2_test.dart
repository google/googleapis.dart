...
void checkAppHubService(api.AppHubService o) {
  buildCounterAppHubService++;
  if (buildCounterAppHubService < 3) {
    unittest.expect(o.criticalityType!, unittest.equals('foo'));
...
core.List<api.LogExclusion> buildUnnamed1() => [
  buildLogExclusion(),
  buildLogExclusion(),
];

void checkUnnamed1(core.List<api.LogExclusion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogExclusion(o[0]);
  checkLogExclusion(o[1]);
}

core.int buildCounterDefaultSinkConfig = 0;
api.DefaultSinkConfig buildDefaultSinkConfig() {
  final o = api.DefaultSinkConfig();
  buildCounterDefaultSinkConfig++;
  if (buildCounterDefaultSinkConfig < 3) {
    o.exclusions = buildUnnamed1();
    o.filter = 'foo';
    o.mode = 'foo';
  }
  buildCounterDefaultSinkConfig--;
...
void checkDefaultSinkConfig(api.DefaultSinkConfig o) {
  buildCounterDefaultSinkConfig++;
  if (buildCounterDefaultSinkConfig < 3) {
    checkUnnamed1(o.exclusions!);
    unittest.expect(o.filter!, unittest.equals('foo'));
...
core.int buildCounterFieldSource = 0;
api.FieldSource buildFieldSource() {
  final o = api.FieldSource();
  buildCounterFieldSource++;
  if (buildCounterFieldSource < 3) {
    o.aliasRef = 'foo';
    o.columnType = 'foo';
    o.field = 'foo';
    o.isJson = true;
    o.parentPath = 'foo';
    o.projectedField = buildProjectedField();
  }
  buildCounterFieldSource--;
  return o;
}

void checkFieldSource(api.FieldSource o) {
  buildCounterFieldSource++;
  if (buildCounterFieldSource < 3) {
    unittest.expect(o.aliasRef!, unittest.equals('foo'));
    unittest.expect(o.columnType!, unittest.equals('foo'));
    unittest.expect(o.field!, unittest.equals('foo'));
    unittest.expect(o.isJson!, unittest.isTrue);
    unittest.expect(o.parentPath!, unittest.equals('foo'));
    checkProjectedField(o.projectedField!);
  }
  buildCounterFieldSource--;
}
...
api.FilterExpression buildFilterExpression() {
  ...
  if (buildCounterFilterExpression < 3) {
    o.comparator = 'foo';
    o.fieldSource = buildFieldSource();
    o.fieldSourceValue = buildFieldSource();
    o.isNegation = true;
    o.literalValue = {
      'list': [1, 2, 3],
      'bool': true,
...
void checkFilterExpression(api.FilterExpression o) {
  ...
  if (buildCounterFilterExpression < 3) {
    ...
    checkFieldSource(o.fieldSource!);
    checkFieldSource(o.fieldSourceValue!);
    unittest.expect(o.isNegation!, unittest.isTrue);
    var casted1 = (o.literalValue!) as core.Map;
...
core.List<api.FilterPredicate> buildUnnamed3() => [
  buildFilterPredicate(),
  buildFilterPredicate(),
];

void checkUnnamed3(core.List<api.FilterPredicate> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFilterPredicate(o[0]);
  checkFilterPredicate(o[1]);
}

core.int buildCounterFilterPredicate = 0;
api.FilterPredicate buildFilterPredicate() {
  final o = api.FilterPredicate();
  buildCounterFilterPredicate++;
  if (buildCounterFilterPredicate < 3) {
    o.childPredicates = buildUnnamed3();
    o.leafPredicate = buildFilterExpression();
    o.operatorType = 'foo';
  }
  buildCounterFilterPredicate--;
  return o;
...
void checkFilterPredicate(api.FilterPredicate o) {
  buildCounterFilterPredicate++;
  if (buildCounterFilterPredicate < 3) {
    checkUnnamed3(o.childPredicates!);
    checkFilterExpression(o.leafPredicate!);
    unittest.expect(o.operatorType!, unittest.equals('foo'));
  }
  buildCounterFilterPredicate--;
}
...
core.int buildCounterFunctionApplication = 0;
api.FunctionApplication buildFunctionApplication() {
  final o = api.FunctionApplication();
  buildCounterFunctionApplication++;
  if (buildCounterFunctionApplication < 3) {
...
void checkFunctionApplication(api.FunctionApplication o) {
  buildCounterFunctionApplication++;
  if (buildCounterFunctionApplication < 3) {
...
core.List<api.LogBucket> buildUnnamed5() => [
  buildLogBucket(),
  buildLogBucket(),
];

void checkUnnamed5(core.List<api.LogBucket> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogBucket(o[0]);
  checkLogBucket(o[1]);
}
...
void checkListBucketsResponse(api.ListBucketsResponse o) {
  buildCounterListBucketsResponse++;
  if (buildCounterListBucketsResponse < 3) {
    checkUnnamed5(o.buckets!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListBucketsResponse--;
}

core.List<api.LogExclusion> buildUnnamed6() => [
  buildLogExclusion(),
  buildLogExclusion(),
];

void checkUnnamed6(core.List<api.LogExclusion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogExclusion(o[0]);
  checkLogExclusion(o[1]);
}
...
void checkListExclusionsResponse(api.ListExclusionsResponse o) {
  buildCounterListExclusionsResponse++;
  if (buildCounterListExclusionsResponse < 3) {
    checkUnnamed6(o.exclusions!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListExclusionsResponse--;
}

core.List<api.Link> buildUnnamed7() => [buildLink(), buildLink()];

void checkUnnamed7(core.List<api.Link> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLink(o[0]);
  checkLink(o[1]);
}
...
api.ListLogEntriesRequest buildListLogEntriesRequest() {
  ...
  if (buildCounterListLogEntriesRequest < 3) {
    ...
    o.pageSize = 42;
    o.pageToken = 'foo';
    o.projectIds = buildUnnamed9();
    o.resourceNames = buildUnnamed10();
  }
  buildCounterListLogEntriesRequest--;
  return o;
}
...
void checkListLogEntriesRequest(api.ListLogEntriesRequest o) {
  ...
  if (buildCounterListLogEntriesRequest < 3) {
    ...
    checkUnnamed9(o.projectIds!);
    checkUnnamed10(o.resourceNames!);
  }
  buildCounterListLogEntriesRequest--;
}

core.List<api.LogEntry> buildUnnamed11() => [buildLogEntry(), buildLogEntry()];

void checkUnnamed11(core.List<api.LogEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogEntry(o[0]);
  checkLogEntry(o[1]);
}
...
core.List<api.LogMetric> buildUnnamed12() => [
  buildLogMetric(),
  buildLogMetric(),
];

void checkUnnamed12(core.List<api.LogMetric> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogMetric(o[0]);
  checkLogMetric(o[1]);
}
...
core.List<api.LogScope> buildUnnamed13() => [buildLogScope(), buildLogScope()];

void checkUnnamed13(core.List<api.LogScope> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogScope(o[0]);
  checkLogScope(o[1]);
}

core.int buildCounterListLogScopesResponse = 0;
api.ListLogScopesResponse buildListLogScopesResponse() {
  final o = api.ListLogScopesResponse();
  buildCounterListLogScopesResponse++;
  if (buildCounterListLogScopesResponse < 3) {
    o.logScopes = buildUnnamed13();
    o.nextPageToken = 'foo';
  }
  buildCounterListLogScopesResponse--;
  return o;
...
void checkListLogScopesResponse(api.ListLogScopesResponse o) {
  buildCounterListLogScopesResponse++;
  if (buildCounterListLogScopesResponse < 3) {
    checkUnnamed13(o.logScopes!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListLogScopesResponse--;
}
...
void checkListLogsResponse(api.ListLogsResponse o) {
  buildCounterListLogsResponse++;
  if (buildCounterListLogsResponse < 3) {
    checkUnnamed14(o.logNames!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListLogsResponse--;
}

core.List<api.MonitoredResourceDescriptor> buildUnnamed15() => [
  buildMonitoredResourceDescriptor(),
  buildMonitoredResourceDescriptor(),
];

void checkUnnamed15(core.List<api.MonitoredResourceDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListMonitoredResourceDescriptorsResponse() {
  ...
  if (buildCounterListMonitoredResourceDescriptorsResponse < 3) {
    o.nextPageToken = 'foo';
    o.resourceDescriptors = buildUnnamed15();
  }
  buildCounterListMonitoredResourceDescriptorsResponse--;
  return o;
}
...
void checkListMonitoredResourceDescriptorsResponse(
  ...
  if (buildCounterListMonitoredResourceDescriptorsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed15(o.resourceDescriptors!);
  }
  buildCounterListMonitoredResourceDescriptorsResponse--;
}
...
core.List<api.RecentQuery> buildUnnamed18() => [
  buildRecentQuery(),
  buildRecentQuery(),
];

void checkUnnamed18(core.List<api.RecentQuery> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRecentQuery(o[0]);
  checkRecentQuery(o[1]);
}
...
core.int buildCounterListRecentQueriesResponse = 0;
api.ListRecentQueriesResponse buildListRecentQueriesResponse() {
  final o = api.ListRecentQueriesResponse();
  buildCounterListRecentQueriesResponse++;
  if (buildCounterListRecentQueriesResponse < 3) {
    o.nextPageToken = 'foo';
    o.recentQueries = buildUnnamed18();
...
void checkListRecentQueriesResponse(api.ListRecentQueriesResponse o) {
  buildCounterListRecentQueriesResponse++;
  if (buildCounterListRecentQueriesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed18(o.recentQueries!);
    checkUnnamed19(o.unreachable!);
  }
  buildCounterListRecentQueriesResponse--;
}

core.List<api.SavedQuery> buildUnnamed20() => [
  buildSavedQuery(),
  buildSavedQuery(),
];

void checkUnnamed20(core.List<api.SavedQuery> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSavedQuery(o[0]);
  checkSavedQuery(o[1]);
}
...
void checkListSavedQueriesResponse(api.ListSavedQueriesResponse o) {
  ...
  if (buildCounterListSavedQueriesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed20(o.savedQueries!);
    checkUnnamed21(o.unreachable!);
  }
  buildCounterListSavedQueriesResponse--;
}

core.List<api.LogSink> buildUnnamed22() => [buildLogSink(), buildLogSink()];

void checkUnnamed22(core.List<api.LogSink> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogSink(o[0]);
  checkLogSink(o[1]);
}
...
void checkListSinksResponse(api.ListSinksResponse o) {
  ...
  if (buildCounterListSinksResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed22(o.sinks!);
  }
  buildCounterListSinksResponse--;
}

core.List<api.LogView> buildUnnamed23() => [buildLogView(), buildLogView()];

void checkUnnamed23(core.List<api.LogView> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogView(o[0]);
  checkLogView(o[1]);
}
...
core.List<api.IndexConfig> buildUnnamed26() => [
  buildIndexConfig(),
  buildIndexConfig(),
];

void checkUnnamed26(core.List<api.IndexConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.LogBucket buildLogBucket() {
  ...
  if (buildCounterLogBucket < 3) {
    ...
    o.createTime = 'foo';
    o.description = 'foo';
    o.indexConfigs = buildUnnamed26();
    o.lifecycleState = 'foo';
    o.locked = true;
    o.name = 'foo';
    o.restrictedFields = buildUnnamed27();
    o.retentionDays = 42;
    o.updateTime = 'foo';
  }
  buildCounterLogBucket--;
...
void checkLogBucket(api.LogBucket o) {
  ...
  if (buildCounterLogBucket < 3) {
    ...
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    checkUnnamed26(o.indexConfigs!);
    unittest.expect(o.lifecycleState!, unittest.equals('foo'));
    unittest.expect(o.locked!, unittest.isTrue);
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed27(o.restrictedFields!);
...
core.List<api.LogErrorGroup> buildUnnamed28() => [
  buildLogErrorGroup(),
  buildLogErrorGroup(),
];

void checkUnnamed28(core.List<api.LogErrorGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogErrorGroup(o[0]);
  checkLogErrorGroup(o[1]);
}
...
api.LogEntry buildLogEntry() {
  ...
  if (buildCounterLogEntry < 3) {
    ...
    o.apphubSource = buildAppHub();
    o.errorGroups = buildUnnamed28();
    o.httpRequest = buildHttpRequest();
    o.insertId = 'foo';
    o.jsonPayload = buildUnnamed29();
    o.labels = buildUnnamed30();
    o.logName = 'foo';
    o.metadata = buildMonitoredResourceMetadata();
    o.operation = buildLogEntryOperation();
    o.otel = buildUnnamed31();
    o.protoPayload = buildUnnamed32();
...
void checkLogEntry(api.LogEntry o) {
  ...
  if (buildCounterLogEntry < 3) {
    ...
    checkAppHub(o.apphubSource!);
    checkUnnamed28(o.errorGroups!);
    checkHttpRequest(o.httpRequest!);
    unittest.expect(o.insertId!, unittest.equals('foo'));
    checkUnnamed29(o.jsonPayload!);
    ...
    checkUnnamed31(o.otel!);
    checkUnnamed32(o.protoPayload!);
...
core.int buildCounterLogErrorGroup = 0;
api.LogErrorGroup buildLogErrorGroup() {
  final o = api.LogErrorGroup();
  buildCounterLogErrorGroup++;
  if (buildCounterLogErrorGroup < 3) {
    o.id = 'foo';
  }
  buildCounterLogErrorGroup--;
  return o;
...
void checkLogErrorGroup(api.LogErrorGroup o) {
  buildCounterLogErrorGroup++;
  if (buildCounterLogErrorGroup < 3) {
    unittest.expect(o.id!, unittest.equals('foo'));
  }
...
core.int buildCounterLogScope = 0;
api.LogScope buildLogScope() {
  final o = api.LogScope();
  buildCounterLogScope++;
  if (buildCounterLogScope < 3) {
    o.createTime = 'foo';
    o.description = 'foo';
    o.name = 'foo';
    o.resourceNames = buildUnnamed34();
    o.updateTime = 'foo';
  }
  buildCounterLogScope--;
  return o;
...
void checkLogScope(api.LogScope o) {
  buildCounterLogScope++;
  if (buildCounterLogScope < 3) {
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed34(o.resourceNames!);
    unittest.expect(o.updateTime!, unittest.equals('foo'));
  }
  buildCounterLogScope--;
}

core.List<api.LogExclusion> buildUnnamed35() => [
  buildLogExclusion(),
  buildLogExclusion(),
];

void checkUnnamed35(core.List<api.LogExclusion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogExclusion(o[0]);
  checkLogExclusion(o[1]);
}
...
api.LogSink buildLogSink() {
  ...
  if (buildCounterLogSink < 3) {
    ...
    o.destination = 'foo';
    o.disabled = true;
    o.exclusions = buildUnnamed35();
    o.filter = 'foo';
    o.includeChildren = true;
    o.interceptChildren = true;
    o.name = 'foo';
...
void checkLogSink(api.LogSink o) {
  ...
  if (buildCounterLogSink < 3) {
    ...
    unittest.expect(o.destination!, unittest.equals('foo'));
    unittest.expect(o.disabled!, unittest.isTrue);
    checkUnnamed35(o.exclusions!);
    unittest.expect(o.filter!, unittest.equals('foo'));
    unittest.expect(o.includeChildren!, unittest.isTrue);
    unittest.expect(o.interceptChildren!, unittest.isTrue);
    unittest.expect(o.name!, unittest.equals('foo'));
...
void checkLogSplit(api.LogSplit o) {
  ...
  if (buildCounterLogSplit < 3) {
    ...
    unittest.expect(o.totalSplits!, unittest.equals(42));
...
core.List<api.SummaryField> buildUnnamed36() => [
  buildSummaryField(),
  buildSummaryField(),
];

void checkUnnamed36(core.List<api.SummaryField> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSummaryField(o[0]);
  checkSummaryField(o[1]);
}

core.int buildCounterLoggingQuery = 0;
api.LoggingQuery buildLoggingQuery() {
  final o = api.LoggingQuery();
  buildCounterLoggingQuery++;
  if (buildCounterLoggingQuery < 3) {
    o.filter = 'foo';
    o.summaryFieldEnd = 42;
    o.summaryFieldStart = 42;
    o.summaryFields = buildUnnamed36();
  }
  buildCounterLoggingQuery--;
  return o;
}

void checkLoggingQuery(api.LoggingQuery o) {
  buildCounterLoggingQuery++;
  if (buildCounterLoggingQuery < 3) {
    unittest.expect(o.filter!, unittest.equals('foo'));
    unittest.expect(o.summaryFieldEnd!, unittest.equals(42));
    unittest.expect(o.summaryFieldStart!, unittest.equals(42));
    checkUnnamed36(o.summaryFields!);
  }
  buildCounterLoggingQuery--;
}
...
api.MetricDescriptorMetadata buildMetricDescriptorMetadata() {
  ...
  if (buildCounterMetricDescriptorMetadata < 3) {
    ...
    o.launchStage = 'foo';
    o.samplePeriod = 'foo';
    o.timeSeriesResourceHierarchyLevel = buildUnnamed39();
  }
  buildCounterMetricDescriptorMetadata--;
  return o;
}
...
void checkMetricDescriptorMetadata(api.MetricDescriptorMetadata o) {
  ...
  if (buildCounterMetricDescriptorMetadata < 3) {
    ...
    checkUnnamed39(o.timeSeriesResourceHierarchyLevel!);
  }
  buildCounterMetricDescriptorMetadata--;
}
...
api.OpsAnalyticsQuery buildOpsAnalyticsQuery() {
  ...
  if (buildCounterOpsAnalyticsQuery < 3) {
    o.queryBuilder = buildQueryBuilderConfig();
    o.sqlQueryText = 'foo';
  }
  buildCounterOpsAnalyticsQuery--;
  return o;
...
void checkOpsAnalyticsQuery(api.OpsAnalyticsQuery o) {
  buildCounterOpsAnalyticsQuery++;
  if (buildCounterOpsAnalyticsQuery < 3) {
    checkQueryBuilderConfig(o.queryBuilder!);
    unittest.expect(o.sqlQueryText!, unittest.equals('foo'));
  }
  buildCounterOpsAnalyticsQuery--;
}

core.List<api.Binding> buildUnnamed46() => [buildBinding(), buildBinding()];

void checkUnnamed46(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
core.int buildCounterProjectedField = 0;
api.ProjectedField buildProjectedField() {
  final o = api.ProjectedField();
  buildCounterProjectedField++;
  if (buildCounterProjectedField < 3) {
    o.alias = 'foo';
    o.cast = 'foo';
    o.field = 'foo';
    o.operation = 'foo';
...
void checkProjectedField(api.ProjectedField o) {
  buildCounterProjectedField++;
  if (buildCounterProjectedField < 3) {
    unittest.expect(o.alias!, unittest.equals('foo'));
    unittest.expect(o.cast!, unittest.equals('foo'));
    unittest.expect(o.field!, unittest.equals('foo'));
...
core.List<api.FieldSource> buildUnnamed47() => [
  buildFieldSource(),
  buildFieldSource(),
];

void checkUnnamed47(core.List<api.FieldSource> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFieldSource(o[0]);
  checkFieldSource(o[1]);
}

core.List<api.SortOrderParameter> buildUnnamed48() => [
  buildSortOrderParameter(),
  buildSortOrderParameter(),
];

void checkUnnamed48(core.List<api.SortOrderParameter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSortOrderParameter(o[0]);
  checkSortOrderParameter(o[1]);
}
...
core.int buildCounterQueryBuilderConfig = 0;
api.QueryBuilderConfig buildQueryBuilderConfig() {
  final o = api.QueryBuilderConfig();
  buildCounterQueryBuilderConfig++;
  if (buildCounterQueryBuilderConfig < 3) {
    o.fieldSources = buildUnnamed47();
    o.filter = buildFilterPredicate();
    o.limit = 'foo';
    o.orderBys = buildUnnamed48();
    o.resourceNames = buildUnnamed49();
    o.searchTerm = 'foo';
  }
  buildCounterQueryBuilderConfig--;
  return o;
...
void checkQueryBuilderConfig(api.QueryBuilderConfig o) {
  buildCounterQueryBuilderConfig++;
  if (buildCounterQueryBuilderConfig < 3) {
    checkUnnamed47(o.fieldSources!);
    checkFilterPredicate(o.filter!);
    unittest.expect(o.limit!, unittest.equals('foo'));
    checkUnnamed48(o.orderBys!);
    checkUnnamed49(o.resourceNames!);
    unittest.expect(o.searchTerm!, unittest.equals('foo'));
  }
  buildCounterQueryBuilderConfig--;
}

core.int buildCounterRecentQuery = 0;
api.RecentQuery buildRecentQuery() {
  final o = api.RecentQuery();
  buildCounterRecentQuery++;
  if (buildCounterRecentQuery < 3) {
    o.lastRunTime = 'foo';
    o.loggingQuery = buildLoggingQuery();
    o.name = 'foo';
...
void checkRecentQuery(api.RecentQuery o) {
  buildCounterRecentQuery++;
  if (buildCounterRecentQuery < 3) {
    unittest.expect(o.lastRunTime!, unittest.equals('foo'));
    checkLoggingQuery(o.loggingQuery!);
    unittest.expect(o.name!, unittest.equals('foo'));
...
void checkSettings(api.Settings o) {
  ...
  if (buildCounterSettings < 3) {
    ...
    unittest.expect(o.kmsKeyName!, unittest.equals('foo'));
    unittest.expect(o.kmsServiceAccountId!, unittest.equals('foo'));
    unittest.expect(o.loggingServiceAccountId!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.storageLocation!, unittest.equals('foo'));
  }
  buildCounterSettings--;
}

core.int buildCounterSortOrderParameter = 0;
api.SortOrderParameter buildSortOrderParameter() {
  final o = api.SortOrderParameter();
  buildCounterSortOrderParameter++;
  if (buildCounterSortOrderParameter < 3) {
    o.fieldSource = buildFieldSource();
    o.sortOrderDirection = 'foo';
  }
  buildCounterSortOrderParameter--;
  return o;
}

void checkSortOrderParameter(api.SortOrderParameter o) {
  buildCounterSortOrderParameter++;
  if (buildCounterSortOrderParameter < 3) {
    checkFieldSource(o.fieldSource!);
    unittest.expect(o.sortOrderDirection!, unittest.equals('foo'));
  }
  buildCounterSortOrderParameter--;
}
...
core.int buildCounterSummaryField = 0;
api.SummaryField buildSummaryField() {
  final o = api.SummaryField();
  buildCounterSummaryField++;
  if (buildCounterSummaryField < 3) {
    o.field = 'foo';
  }
  buildCounterSummaryField--;
  return o;
...
void checkSummaryField(api.SummaryField o) {
  buildCounterSummaryField++;
  if (buildCounterSummaryField < 3) {
    unittest.expect(o.field!, unittest.equals('foo'));
  }
...
void main() {
  ...
  unittest.group('obj-schema-DefaultSinkConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildDefaultSinkConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.DefaultSinkConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkDefaultSinkConfig(od);
    });
  });
  ...
  unittest.group('obj-schema-FieldSource', () {
    unittest.test('to-json--from-json', () async {
      final o = buildFieldSource();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.FieldSource.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkFieldSource(od);
    });
  ...
  unittest.group('obj-schema-FilterPredicate', () {
    unittest.test('to-json--from-json', () async {
      final o = buildFilterPredicate();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.FilterPredicate.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkFilterPredicate(od);
    });
  });

  unittest.group('obj-schema-FunctionApplication', () {
    unittest.test('to-json--from-json', () async {
      final o = buildFunctionApplication();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.FunctionApplication.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkFunctionApplication(od);
    });
  });
  ...
  unittest.group('obj-schema-ListLogScopesResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildListLogScopesResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListLogScopesResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkListLogScopesResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-ListRecentQueriesResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildListRecentQueriesResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListRecentQueriesResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkListRecentQueriesResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-LogBucket', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.LogBucket.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkLogBucket(od);
    });
  ...
  unittest.group('obj-schema-LogErrorGroup', () {
    unittest.test('to-json--from-json', () async {
      final o = buildLogErrorGroup();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.LogErrorGroup.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkLogErrorGroup(od);
    });
  });
  ...
  unittest.group('obj-schema-LogMetric', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.LogMetric.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkLogMetric(od);
    });
  ...
  unittest.group('obj-schema-LogScope', () {
    unittest.test('to-json--from-json', () async {
      final o = buildLogScope();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.LogScope.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkLogScope(od);
    });
  ...
  unittest.group('obj-schema-LogSplit', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.LogSplit.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkLogSplit(od);
    });
  ...
  unittest.group('obj-schema-LoggingQuery', () {
    unittest.test('to-json--from-json', () async {
      final o = buildLoggingQuery();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.LoggingQuery.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkLoggingQuery(od);
    });
  });
  ...
  unittest.group('obj-schema-ProjectedField', () {
    unittest.test('to-json--from-json', () async {
      final o = buildProjectedField();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ProjectedField.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkProjectedField(od);
    });
  });

  unittest.group('obj-schema-QueryBuilderConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildQueryBuilderConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.QueryBuilderConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkQueryBuilderConfig(od);
    });
  });

  unittest.group('obj-schema-RecentQuery', () {
    unittest.test('to-json--from-json', () async {
      final o = buildRecentQuery();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.RecentQuery.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkRecentQuery(od);
    });
  ...
  unittest.group('obj-schema-SavedQuery', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.SavedQuery.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkSavedQuery(od);
    });
  ...
  unittest.group('obj-schema-SortOrderParameter', () {
    unittest.test('to-json--from-json', () async {
      final o = buildSortOrderParameter();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.SortOrderParameter.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkSortOrderParameter(od);
    });
  });
  ...
  unittest.group('obj-schema-SummaryField', () {
    unittest.test('to-json--from-json', () async {
      final o = buildSummaryField();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.SummaryField.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkSummaryField(od);
    });
  });
  ...
  unittest.group('resource-BillingAccountsResource', () {
    unittest.test('method--getCmekSettings', () async {
      ...
      final response = await res.getCmekSettings(
        arg_name,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-BillingAccountsLocationsBucketsResource', () {
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.LogBucket.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkLogBucket(obj);
    ...
    unittest.test('method--createAsync', () async {
      ...
      final response = await res.createAsync(
        arg_request,
        arg_parent,
        bucketId: arg_bucketId,
        $fields: arg_$fields,
    ...
    unittest.test('method--updateAsync', () async {
      ...
      final response = await res.updateAsync(
        arg_request,
        arg_name,
        updateMask: arg_updateMask,
        $fields: arg_$fields,
  ...
  unittest.group('resource-BillingAccountsLocationsBucketsViewsResource', () {
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.LogView.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkLogView(obj);
  ...
  unittest.group('resource-BillingAccountsLocationsRecentQueriesResource', () {
    unittest.test('method--list', () async {
      final mock = HttpServerMock();
      final res = api.LoggingApi(mock).billingAccounts.locations.recentQueries;
      final arg_parent = 'foo';
      final arg_filter = 'foo';
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildListRecentQueriesResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      ...
      checkListRecentQueriesResponse(response as api.ListRecentQueriesResponse);
    });
  });

  unittest.group('resource-BillingAccountsLocationsSavedQueriesResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.LoggingApi(mock).billingAccounts.locations.savedQueries;
  ...
  unittest.group('resource-BillingAccountsSinksResource', () {
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.LogSink.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkLogSink(obj);
  ...
  unittest.group('resource-FoldersLocationsLogScopesResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.LoggingApi(mock).folders.locations.logScopes;
      final arg_request = buildLogScope();
      final arg_parent = 'foo';
      final arg_logScopeId = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.LogScope.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkLogScope(obj);
          ...
          unittest.expect(
            queryMap['logScopeId']!.first,
            unittest.equals(arg_logScopeId),
          );
          unittest.expect(
            queryMap['fields']!.first,
            unittest.equals(arg_$fields),
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildLogScope());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.create(
        arg_request,
        arg_parent,
        logScopeId: arg_logScopeId,
        $fields: arg_$fields,
      );
      checkLogScope(response as api.LogScope);
    });
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildListLogScopesResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      ...
      checkListLogScopesResponse(response as api.ListLogScopesResponse);
    });
  ...
  unittest.group('resource-FoldersLocationsRecentQueriesResource', () {
    unittest.test('method--list', () async {
      final mock = HttpServerMock();
      final res = api.LoggingApi(mock).folders.locations.recentQueries;
      final arg_parent = 'foo';
      final arg_filter = 'foo';
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
  ...
  unittest.group('resource-FoldersLocationsSavedQueriesResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.LoggingApi(mock).folders.locations.savedQueries;
      final arg_request = buildSavedQuery();
      final arg_parent = 'foo';
      final arg_savedQueryId = 'foo';
      final arg_$fields = 'foo';
  ...
  unittest.group('resource-OrganizationsResource', () {
    ...
    unittest.test('method--updateCmekSettings', () async {
      ...
      final response = await res.updateCmekSettings(
        arg_request,
        arg_name,
        updateMask: arg_updateMask,
        $fields: arg_$fields,
  ...
  unittest.group('resource-OrganizationsLocationsLogScopesResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.LoggingApi(mock).organizations.locations.logScopes;
      final arg_request = buildLogScope();
      final arg_parent = 'foo';
      final arg_logScopeId = 'foo';
      final arg_$fields = 'foo';
  ...
  unittest.group('resource-OrganizationsLocationsRecentQueriesResource', () {
    unittest.test('method--list', () async {
      final mock = HttpServerMock();
      final res = api.LoggingApi(mock).organizations.locations.recentQueries;
      final arg_parent = 'foo';
      final arg_filter = 'foo';
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
  ...
  unittest.group('resource-OrganizationsLocationsSavedQueriesResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.LoggingApi(mock).organizations.locations.savedQueries;
      final arg_request = buildSavedQuery();
      final arg_parent = 'foo';
      final arg_savedQueryId = 'foo';
      final arg_$fields = 'foo';
  ...
  unittest.group('resource-ProjectsLocationsLogScopesResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.LoggingApi(mock).projects.locations.logScopes;
      final arg_request = buildLogScope();
      final arg_parent = 'foo';
      final arg_logScopeId = 'foo';
      final arg_$fields = 'foo';
  ...
  unittest.group('resource-ProjectsLocationsRecentQueriesResource', () {
    unittest.test('method--list', () async {
      final mock = HttpServerMock();
      final res = api.LoggingApi(mock).projects.locations.recentQueries;
      final arg_parent = 'foo';
      final arg_filter = 'foo';
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
  ...
  unittest.group('resource-ProjectsLocationsSavedQueriesResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.LoggingApi(mock).projects.locations.savedQueries;
      final arg_request = buildSavedQuery();
      final arg_parent = 'foo';
      final arg_savedQueryId = 'foo';
      final arg_$fields = 'foo';
  ...
  unittest.group('resource-ProjectsMetricsResource', () {
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.LogMetric.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkLogMetric(obj);
