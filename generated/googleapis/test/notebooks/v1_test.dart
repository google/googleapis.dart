...
core.List<api.GuestOsFeature> buildUnnamed3214() => [
      buildGuestOsFeature(),
      buildGuestOsFeature(),
    ];

void checkUnnamed3214(core.List<api.GuestOsFeature> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Disk buildDisk() {
  ...
  if (buildCounterDisk < 3) {
    ...
    o.deviceName = 'foo';
    o.diskSizeGb = 'foo';
    o.guestOsFeatures = buildUnnamed3214();
    o.index = 'foo';
    o.interface = 'foo';
    o.kind = 'foo';
    o.licenses = buildUnnamed3215();
    o.mode = 'foo';
    o.source = 'foo';
    o.type = 'foo';
  }
...
void checkDisk(api.Disk o) {
  ...
  if (buildCounterDisk < 3) {
    ...
    checkUnnamed3214(o.guestOsFeatures!);
    unittest.expect(
      o.index!,
      unittest.equals('foo'),
    );
...
core.List<api.Disk> buildUnnamed3218() => [
      buildDisk(),
      buildDisk(),
    ];

void checkUnnamed3218(core.List<api.Disk> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDisk(o[0]);
  checkDisk(o[1]);
}
...
core.List<api.UpgradeHistoryEntry> buildUnnamed3224() => [
      buildUpgradeHistoryEntry(),
      buildUpgradeHistoryEntry(),
    ];

void checkUnnamed3224(core.List<api.UpgradeHistoryEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Instance buildInstance() {
  ...
  if (buildCounterInstance < 3) {
    ...
    o.disks = buildUnnamed3218();
    o.installGpuDriver = true;
    o.instanceOwners = buildUnnamed3219();
    o.kmsKey = 'foo';
    o.labels = buildUnnamed3220();
    o.machineType = 'foo';
    o.metadata = buildUnnamed3221();
    o.name = 'foo';
    o.network = 'foo';
    o.nicType = 'foo';
    ...
    o.serviceAccount = 'foo';
    o.serviceAccountScopes = buildUnnamed3222();
    o.shieldedInstanceConfig = buildShieldedInstanceConfig();
    o.state = 'foo';
    o.subnet = 'foo';
    o.tags = buildUnnamed3223();
    o.updateTime = 'foo';
    o.upgradeHistory = buildUnnamed3224();
    o.vmImage = buildVmImage();
  }
  buildCounterInstance--;
  return o;
...
void checkInstance(api.Instance o) {
  ...
  if (buildCounterInstance < 3) {
    ...
    checkUnnamed3218(o.disks!);
    unittest.expect(o.installGpuDriver!, unittest.isTrue);
    checkUnnamed3219(o.instanceOwners!);
    unittest.expect(
      o.kmsKey!,
      unittest.equals('foo'),
    );
    checkUnnamed3220(o.labels!);
    unittest.expect(
      o.machineType!,
      unittest.equals('foo'),
    );
    checkUnnamed3221(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed3222(o.serviceAccountScopes!);
    ...
    checkUnnamed3223(o.tags!);
    unittest.expect(
      o.updateTime!,
      unittest.equals('foo'),
    );
    checkUnnamed3224(o.upgradeHistory!);
    checkVmImage(o.vmImage!);
  }
  buildCounterInstance--;
}
...
core.List<api.Environment> buildUnnamed3225() => [
      buildEnvironment(),
      buildEnvironment(),
    ];

void checkUnnamed3225(core.List<api.Environment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListEnvironmentsResponse buildListEnvironmentsResponse() {
  ...
  if (buildCounterListEnvironmentsResponse < 3) {
    o.environments = buildUnnamed3225();
    o.nextPageToken = 'foo';
    o.unreachable = buildUnnamed3226();
  }
  buildCounterListEnvironmentsResponse--;
  return o;
}
...
void checkListEnvironmentsResponse(api.ListEnvironmentsResponse o) {
  buildCounterListEnvironmentsResponse++;
  if (buildCounterListEnvironmentsResponse < 3) {
    checkUnnamed3225(o.environments!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
    checkUnnamed3226(o.unreachable!);
  }
  buildCounterListEnvironmentsResponse--;
}

core.List<api.Execution> buildUnnamed3227() => [
      buildExecution(),
      buildExecution(),
    ];

void checkUnnamed3227(core.List<api.Execution> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkExecution(o[0]);
  checkExecution(o[1]);
}
...
api.ListExecutionsResponse buildListExecutionsResponse() {
  ...
  if (buildCounterListExecutionsResponse < 3) {
    o.executions = buildUnnamed3227();
    o.nextPageToken = 'foo';
    o.unreachable = buildUnnamed3228();
  }
  buildCounterListExecutionsResponse--;
  return o;
}
...
void checkListExecutionsResponse(api.ListExecutionsResponse o) {
  buildCounterListExecutionsResponse++;
  if (buildCounterListExecutionsResponse < 3) {
    checkUnnamed3227(o.executions!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
    checkUnnamed3228(o.unreachable!);
  }
  buildCounterListExecutionsResponse--;
}

core.List<api.Instance> buildUnnamed3229() => [
      buildInstance(),
      buildInstance(),
    ];

void checkUnnamed3229(core.List<api.Instance> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInstance(o[0]);
  checkInstance(o[1]);
}
...
api.ListInstancesResponse buildListInstancesResponse() {
  ...
  if (buildCounterListInstancesResponse < 3) {
    o.instances = buildUnnamed3229();
    o.nextPageToken = 'foo';
    o.unreachable = buildUnnamed3230();
  }
  buildCounterListInstancesResponse--;
  return o;
}
...
void checkListInstancesResponse(api.ListInstancesResponse o) {
  buildCounterListInstancesResponse++;
  if (buildCounterListInstancesResponse < 3) {
    checkUnnamed3229(o.instances!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
    checkUnnamed3230(o.unreachable!);
  }
  buildCounterListInstancesResponse--;
}

core.List<api.Location> buildUnnamed3231() => [
      buildLocation(),
      buildLocation(),
    ];

void checkUnnamed3231(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
core.List<api.Operation> buildUnnamed3232() => [
      buildOperation(),
      buildOperation(),
    ];

void checkUnnamed3232(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
void checkListOperationsResponse(api.ListOperationsResponse o) {
  ...
  if (buildCounterListOperationsResponse < 3) {
    ...
    checkUnnamed3232(o.operations!);
  }
  buildCounterListOperationsResponse--;
}

core.List<api.Runtime> buildUnnamed3233() => [
      buildRuntime(),
      buildRuntime(),
    ];

void checkUnnamed3233(core.List<api.Runtime> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRuntime(o[0]);
  checkRuntime(o[1]);
}
...
api.ListRuntimesResponse buildListRuntimesResponse() {
  ...
  if (buildCounterListRuntimesResponse < 3) {
    o.nextPageToken = 'foo';
    o.runtimes = buildUnnamed3233();
    o.unreachable = buildUnnamed3234();
  }
  buildCounterListRuntimesResponse--;
  return o;
}
...
void checkListRuntimesResponse(api.ListRuntimesResponse o) {
  ...
  if (buildCounterListRuntimesResponse < 3) {
    ...
    checkUnnamed3233(o.runtimes!);
    checkUnnamed3234(o.unreachable!);
  }
  buildCounterListRuntimesResponse--;
}

core.List<api.Schedule> buildUnnamed3235() => [
      buildSchedule(),
      buildSchedule(),
    ];

void checkUnnamed3235(core.List<api.Schedule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSchedule(o[0]);
  checkSchedule(o[1]);
}
...
api.ListSchedulesResponse buildListSchedulesResponse() {
  ...
  if (buildCounterListSchedulesResponse < 3) {
    o.nextPageToken = 'foo';
    o.schedules = buildUnnamed3235();
    o.unreachable = buildUnnamed3236();
  }
  buildCounterListSchedulesResponse--;
  return o;
}
...
void checkListSchedulesResponse(api.ListSchedulesResponse o) {
  ...
  if (buildCounterListSchedulesResponse < 3) {
    ...
    checkUnnamed3235(o.schedules!);
    checkUnnamed3236(o.unreachable!);
  }
  buildCounterListSchedulesResponse--;
}

core.List<api.RuntimeGuestOsFeature> buildUnnamed3237() => [
      buildRuntimeGuestOsFeature(),
      buildRuntimeGuestOsFeature(),
    ];

void checkUnnamed3237(core.List<api.RuntimeGuestOsFeature> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.LocalDisk buildLocalDisk() {
  ...
  if (buildCounterLocalDisk < 3) {
    ...
    o.boot = true;
    o.deviceName = 'foo';
    o.guestOsFeatures = buildUnnamed3237();
    o.index = 42;
    o.initializeParams = buildLocalDiskInitializeParams();
    o.interface = 'foo';
    o.kind = 'foo';
    o.licenses = buildUnnamed3238();
    o.mode = 'foo';
    o.source = 'foo';
    o.type = 'foo';
  }
...
void checkLocalDisk(api.LocalDisk o) {
  ...
  if (buildCounterLocalDisk < 3) {
    ...
    checkUnnamed3237(o.guestOsFeatures!);
    unittest.expect(
      o.index!,
      unittest.equals(42),
    );
...
void checkLocalDiskInitializeParams(api.LocalDiskInitializeParams o) {
  ...
  if (buildCounterLocalDiskInitializeParams < 3) {
    ...
    checkUnnamed3239(o.labels!);
  }
  buildCounterLocalDiskInitializeParams--;
}

core.Map<core.String, core.String> buildUnnamed3240() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed3240(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.Location buildLocation() {
  ...
  if (buildCounterLocation < 3) {
    o.displayName = 'foo';
    o.labels = buildUnnamed3240();
    o.locationId = 'foo';
    o.metadata = buildUnnamed3241();
    o.name = 'foo';
  }
  buildCounterLocation--;
  return o;
...
void checkLocation(api.Location o) {
  ...
  if (buildCounterLocation < 3) {
    ...
    checkUnnamed3240(o.labels!);
    unittest.expect(
      o.locationId!,
      unittest.equals('foo'),
    );
    checkUnnamed3241(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed3242();
    o.name = 'foo';
    o.response = buildUnnamed3243();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error!);
    checkUnnamed3242(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed3243(o.response!);
  }
  buildCounterOperation--;
}
...
core.List<api.Binding> buildUnnamed3244() => [
      buildBinding(),
      buildBinding(),
    ];

void checkUnnamed3244(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
core.Map<core.String, core.String> buildUnnamed3247() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed3247(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.RuntimeMetrics buildRuntimeMetrics() {
  ...
  if (buildCounterRuntimeMetrics < 3) {
    o.systemMetrics = buildUnnamed3247();
  }
  buildCounterRuntimeMetrics--;
  return o;
}
...
void checkRuntimeMetrics(api.RuntimeMetrics o) {
  buildCounterRuntimeMetrics++;
  if (buildCounterRuntimeMetrics < 3) {
    checkUnnamed3247(o.systemMetrics!);
  }
  buildCounterRuntimeMetrics--;
}
...
core.List<api.Execution> buildUnnamed3248() => [
      buildExecution(),
      buildExecution(),
    ];

void checkUnnamed3248(core.List<api.Execution> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkExecution(o[0]);
  checkExecution(o[1]);
}
...
api.Schedule buildSchedule() {
  ...
  if (buildCounterSchedule < 3) {
    ...
    o.executionTemplate = buildExecutionTemplate();
    o.name = 'foo';
    o.recentExecutions = buildUnnamed3248();
    o.state = 'foo';
    o.timeZone = 'foo';
    o.updateTime = 'foo';
  }
...
void checkSchedule(api.Schedule o) {
  ...
  if (buildCounterSchedule < 3) {
    ...
    checkUnnamed3248(o.recentExecutions!);
    unittest.expect(
      o.state!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.String> buildUnnamed3249() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed3249(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.TestIamPermissionsResponse buildTestIamPermissionsResponse() {
  ...
  if (buildCounterTestIamPermissionsResponse < 3) {
    o.permissions = buildUnnamed3253();
  }
  buildCounterTestIamPermissionsResponse--;
  return o;
}
...
void checkTestIamPermissionsResponse(api.TestIamPermissionsResponse o) {
  buildCounterTestIamPermissionsResponse++;
  if (buildCounterTestIamPermissionsResponse < 3) {
    checkUnnamed3253(o.permissions!);
  }
  buildCounterTestIamPermissionsResponse--;
}
...
core.List<api.ContainerImage> buildUnnamed3254() => [
      buildContainerImage(),
      buildContainerImage(),
    ];

void checkUnnamed3254(core.List<api.ContainerImage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.String> buildUnnamed3256() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed3256(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
void checkVirtualMachineConfig(api.VirtualMachineConfig o) {
  ...
  if (buildCounterVirtualMachineConfig < 3) {
    checkRuntimeAcceleratorConfig(o.acceleratorConfig!);
    checkUnnamed3254(o.containerImages!);
    checkLocalDisk(o.dataDisk!);
    checkEncryptionConfig(o.encryptionConfig!);
    checkUnnamed3255(o.guestAttributes!);
