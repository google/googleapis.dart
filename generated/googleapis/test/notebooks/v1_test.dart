...
void checkExecution(api.Execution o) {
  ...
  if (buildCounterExecution < 3) {
    ...
    unittest.expect(o.jobUri!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
...
void checkExecutionTemplate(api.ExecutionTemplate o) {
  ...
  if (buildCounterExecutionTemplate < 3) {
    ...
    unittest.expect(o.kernelSpec!, unittest.equals('foo'));
...
core.List<api.Disk> buildUnnamed6() => [buildDisk(), buildDisk()];
...
void checkInstanceConfig(api.InstanceConfig o) {
  ...
  if (buildCounterInstanceConfig < 3) {
    ...
    unittest.expect(o.notebookUpgradeSchedule!, unittest.equals('foo'));
  }
  buildCounterInstanceConfig--;
}
...
core.List<api.Instance> buildUnnamed19() => [buildInstance(), buildInstance()];
...
core.List<api.Runtime> buildUnnamed24() => [buildRuntime(), buildRuntime()];

void checkUnnamed24(core.List<api.Runtime> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRuntime(o[0]);
  checkRuntime(o[1]);
}
...
void checkListRuntimesResponse(api.ListRuntimesResponse o) {
  ...
  if (buildCounterListRuntimesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed24(o.runtimes!);
    checkUnnamed25(o.unreachable!);
  }
  buildCounterListRuntimesResponse--;
}

core.List<api.Schedule> buildUnnamed26() => [buildSchedule(), buildSchedule()];

void checkUnnamed26(core.List<api.Schedule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSchedule(o[0]);
  checkSchedule(o[1]);
}
...
void checkListSchedulesResponse(api.ListSchedulesResponse o) {
  ...
  if (buildCounterListSchedulesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed26(o.schedules!);
    checkUnnamed27(o.unreachable!);
  }
  buildCounterListSchedulesResponse--;
}

core.List<api.RuntimeGuestOsFeature> buildUnnamed28() => [
  buildRuntimeGuestOsFeature(),
  buildRuntimeGuestOsFeature(),
];

void checkUnnamed28(core.List<api.RuntimeGuestOsFeature> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.LocalDisk buildLocalDisk() {
  ...
  if (buildCounterLocalDisk < 3) {
    ...
    o.boot = true;
    o.deviceName = 'foo';
    o.guestOsFeatures = buildUnnamed28();
    o.index = 42;
...
void checkLocalDisk(api.LocalDisk o) {
  ...
  if (buildCounterLocalDisk < 3) {
    ...
    unittest.expect(o.boot!, unittest.isTrue);
    unittest.expect(o.deviceName!, unittest.equals('foo'));
    checkUnnamed28(o.guestOsFeatures!);
...
void checkMigrateInstanceRequest(api.MigrateInstanceRequest o) {
  buildCounterMigrateInstanceRequest++;
  if (buildCounterMigrateInstanceRequest < 3) {
    unittest.expect(o.postStartupScriptOption!, unittest.equals('foo'));
  }
  buildCounterMigrateInstanceRequest--;
}
...
void checkRuntimeAccessConfig(api.RuntimeAccessConfig o) {
  ...
  if (buildCounterRuntimeAccessConfig < 3) {
    ...
    unittest.expect(o.proxyUri!, unittest.equals('foo'));
    unittest.expect(o.runtimeOwner!, unittest.equals('foo'));
  }
  buildCounterRuntimeAccessConfig--;
}
...
api.RuntimeMetrics buildRuntimeMetrics() {
  ...
  if (buildCounterRuntimeMetrics < 3) {
    o.systemMetrics = buildUnnamed39();
  }
  buildCounterRuntimeMetrics--;
  return o;
}
...
void checkRuntimeMetrics(api.RuntimeMetrics o) {
  buildCounterRuntimeMetrics++;
  if (buildCounterRuntimeMetrics < 3) {
    checkUnnamed39(o.systemMetrics!);
  }
  buildCounterRuntimeMetrics--;
}
...
void checkRuntimeSoftwareConfig(api.RuntimeSoftwareConfig o) {
  ...
  if (buildCounterRuntimeSoftwareConfig < 3) {
    ...
    unittest.expect(o.idleShutdownTimeout!, unittest.equals(42));
    unittest.expect(o.installGpuDriver!, unittest.isTrue);
    checkUnnamed42(o.kernels!);
    unittest.expect(o.mixerDisabled!, unittest.isTrue);
    unittest.expect(o.notebookUpgradeSchedule!, unittest.equals('foo'));
    unittest.expect(o.postStartupScript!, unittest.equals('foo'));
    unittest.expect(o.postStartupScriptBehavior!, unittest.equals('foo'));
    unittest.expect(o.upgradeable!, unittest.isTrue);
...
core.List<api.Execution> buildUnnamed43() => [
  buildExecution(),
  buildExecution(),
];

void checkUnnamed43(core.List<api.Execution> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkExecution(o[0]);
  checkExecution(o[1]);
}
...
api.Schedule buildSchedule() {
  ...
  if (buildCounterSchedule < 3) {
    ...
    o.executionTemplate = buildExecutionTemplate();
    o.name = 'foo';
    o.recentExecutions = buildUnnamed43();
    o.state = 'foo';
    o.timeZone = 'foo';
    o.updateTime = 'foo';
  }
...
void checkSchedule(api.Schedule o) {
  ...
  if (buildCounterSchedule < 3) {
    ...
    checkExecutionTemplate(o.executionTemplate!);
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed43(o.recentExecutions!);
    unittest.expect(o.state!, unittest.equals('foo'));
...
core.List<api.ContainerImage> buildUnnamed52() => [
  buildContainerImage(),
  buildContainerImage(),
];

void checkUnnamed52(core.List<api.ContainerImage> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContainerImage(o[0]);
  checkContainerImage(o[1]);
}
...
api.VirtualMachineConfig buildVirtualMachineConfig() {
  ...
  if (buildCounterVirtualMachineConfig < 3) {
    ...
    o.containerImages = buildUnnamed52();
    o.dataDisk = buildLocalDisk();
    o.encryptionConfig = buildEncryptionConfig();
    o.guestAttributes = buildUnnamed53();
...
void main() {
  ...
  unittest.group('obj-schema-BootImage', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.BootImage.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkBootImage(od);
    });
  ...
  unittest.group('obj-schema-LocalDisk', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.LocalDisk.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkLocalDisk(od);
    });
  ...
  unittest.group('resource-ProjectsLocationsExecutionsResource', () {
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Execution.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkExecution(obj);
  ...
  unittest.group('resource-ProjectsLocationsInstancesResource', () {
    ...
    unittest.test('method--getInstanceHealth', () async {
      ...
      final response = await res.getInstanceHealth(
        arg_name,
        $fields: arg_$fields,
      );
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final resp = convert.json.encode(
            buildIsInstanceUpgradeableResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.isUpgradeable(
    ...
    unittest.test('method--migrate', () async {
      ...
      final response = await res.migrate(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--reportEvent', () async {
      ...
      final response = await res.reportEvent(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--setAccelerator', () async {
      ...
      final response = await res.setAccelerator(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--updateMetadataItems', () async {
      ...
      final response = await res.updateMetadataItems(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--upgradeInternal', () async {
      ...
      final response = await res.upgradeInternal(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-ProjectsLocationsRuntimesResource', () {
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Runtime.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkRuntime(obj);
  ...
  unittest.group('resource-ProjectsLocationsSchedulesResource', () {
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Schedule.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkSchedule(obj);
    ...
    unittest.test('method--trigger', () async {
      ...
      final response = await res.trigger(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
