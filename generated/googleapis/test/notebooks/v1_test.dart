...
core.List<core.String> buildUnnamed6106() => [
      'foo',
      'foo',
    ];

void checkUnnamed6106(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.RuntimeMetrics buildRuntimeMetrics() {
  ...
  if (buildCounterRuntimeMetrics < 3) {
    o.systemMetrics = buildUnnamed6107();
  }
  buildCounterRuntimeMetrics--;
  return o;
}
...
void checkRuntimeMetrics(api.RuntimeMetrics o) {
  buildCounterRuntimeMetrics++;
  if (buildCounterRuntimeMetrics < 3) {
    checkUnnamed6107(o.systemMetrics!);
  }
  buildCounterRuntimeMetrics--;
}
...
core.List<api.Execution> buildUnnamed6108() => [
      buildExecution(),
      buildExecution(),
    ];

void checkUnnamed6108(core.List<api.Execution> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkExecution(o[0]);
  checkExecution(o[1]);
}
...
api.Schedule buildSchedule() {
  ...
  if (buildCounterSchedule < 3) {
    ...
    o.executionTemplate = buildExecutionTemplate();
    o.name = 'foo';
    o.recentExecutions = buildUnnamed6108();
    o.state = 'foo';
    o.timeZone = 'foo';
    o.updateTime = 'foo';
  }
...
void checkSchedule(api.Schedule o) {
  ...
  if (buildCounterSchedule < 3) {
    ...
    checkUnnamed6108(o.recentExecutions!);
    unittest.expect(
      o.state!,
      unittest.equals('foo'),
    );
...
core.List<core.Map<core.String, core.Object>> buildUnnamed6111() => [
      buildUnnamed6110(),
      buildUnnamed6110(),
    ];

void checkUnnamed6111(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed6110(o[0]);
  checkUnnamed6110(o[1]);
}
...
api.TestIamPermissionsResponse buildTestIamPermissionsResponse() {
  ...
  if (buildCounterTestIamPermissionsResponse < 3) {
    o.permissions = buildUnnamed6113();
  }
  buildCounterTestIamPermissionsResponse--;
  return o;
}
...
void checkTestIamPermissionsResponse(api.TestIamPermissionsResponse o) {
  buildCounterTestIamPermissionsResponse++;
  if (buildCounterTestIamPermissionsResponse < 3) {
    checkUnnamed6113(o.permissions!);
  }
  buildCounterTestIamPermissionsResponse--;
}
...
core.List<api.ContainerImage> buildUnnamed6114() => [
      buildContainerImage(),
      buildContainerImage(),
    ];

void checkUnnamed6114(core.List<api.ContainerImage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.String> buildUnnamed6117() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed6117(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.VirtualMachineConfig buildVirtualMachineConfig() {
  ...
  if (buildCounterVirtualMachineConfig < 3) {
    o.acceleratorConfig = buildRuntimeAcceleratorConfig();
    o.containerImages = buildUnnamed6114();
    o.dataDisk = buildLocalDisk();
    o.encryptionConfig = buildEncryptionConfig();
    o.guestAttributes = buildUnnamed6115();
    o.internalIpOnly = true;
    o.labels = buildUnnamed6116();
    o.machineType = 'foo';
