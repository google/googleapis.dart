...
core.int buildCounterApproveQueryTemplateRequest = 0;
api.ApproveQueryTemplateRequest buildApproveQueryTemplateRequest() {
  final o = api.ApproveQueryTemplateRequest();
  buildCounterApproveQueryTemplateRequest++;
  if (buildCounterApproveQueryTemplateRequest < 3) {}
  buildCounterApproveQueryTemplateRequest--;
  return o;
}

void checkApproveQueryTemplateRequest(api.ApproveQueryTemplateRequest o) {
  buildCounterApproveQueryTemplateRequest++;
  if (buildCounterApproveQueryTemplateRequest < 3) {}
  buildCounterApproveQueryTemplateRequest--;
}
...
core.List<api.Replica> buildUnnamed2() => [buildReplica(), buildReplica()];

void checkUnnamed2(core.List<api.Replica> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReplica(o[0]);
  checkReplica(o[1]);
}
...
core.List<api.SelectedResource> buildUnnamed4() => [
  buildSelectedResource(),
  buildSelectedResource(),
];

void checkUnnamed4(core.List<api.SelectedResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BigQueryDatasetSource buildBigQueryDatasetSource() {
  ...
  if (buildCounterBigQueryDatasetSource < 3) {
    o.dataset = 'foo';
    o.effectiveReplicas = buildUnnamed2();
    o.replicaLocations = buildUnnamed3();
    o.restrictedExportPolicy = buildRestrictedExportPolicy();
    o.selectedResources = buildUnnamed4();
  }
  buildCounterBigQueryDatasetSource--;
  return o;
}
...
void checkBigQueryDatasetSource(api.BigQueryDatasetSource o) {
  ...
  if (buildCounterBigQueryDatasetSource < 3) {
    ...
    checkUnnamed2(o.effectiveReplicas!);
    checkUnnamed3(o.replicaLocations!);
    checkRestrictedExportPolicy(o.restrictedExportPolicy!);
    checkUnnamed4(o.selectedResources!);
  }
  buildCounterBigQueryDatasetSource--;
}
...
void checkDcrExchangeConfig(api.DcrExchangeConfig o) {
  ...
  if (buildCounterDcrExchangeConfig < 3) {
    ...
    unittest.expect(
      o.singleSelectedResourceSharingRestriction!,
      unittest.isTrue,
    );
  }
  buildCounterDcrExchangeConfig--;
...
api.DestinationDataset buildDestinationDataset() {
  ...
  if (buildCounterDestinationDataset < 3) {
    ...
    o.location = 'foo';
    o.replicaLocations = buildUnnamed7();
  }
  buildCounterDestinationDataset--;
  return o;
}
...
void checkDestinationDataset(api.DestinationDataset o) {
  ...
  if (buildCounterDestinationDataset < 3) {
    ...
    checkUnnamed7(o.replicaLocations!);
  }
  buildCounterDestinationDataset--;
}
...
checkGoogleCloudBigqueryAnalyticshubV1ListingCommercialInfoGoogleCloudMarketplaceInfo(
  ...
  if (buildCounterGoogleCloudBigqueryAnalyticshubV1ListingCommercialInfoGoogleCloudMarketplaceInfo <
      3) {
    unittest.expect(o.commercialState!, unittest.equals('foo'));
    unittest.expect(o.service!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudBigqueryAnalyticshubV1ListingCommercialInfoGoogleCloudMarketplaceInfo--;
}
...
core.List<api.MessageTransform> buildUnnamed9() => [
  buildMessageTransform(),
  buildMessageTransform(),
];

void checkUnnamed9(core.List<api.MessageTransform> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GooglePubsubV1Subscription buildGooglePubsubV1Subscription() {
  ...
  if (buildCounterGooglePubsubV1Subscription < 3) {
    ...
    o.messageTransforms = buildUnnamed9();
    o.name = 'foo';
...
void checkGooglePubsubV1Subscription(api.GooglePubsubV1Subscription o) {
  ...
  if (buildCounterGooglePubsubV1Subscription < 3) {
    ...
    checkUnnamed9(o.messageTransforms!);
    unittest.expect(o.name!, unittest.equals('foo'));
...
void checkLinkedResource(api.LinkedResource o) {
  buildCounterLinkedResource++;
  if (buildCounterLinkedResource < 3) {
    unittest.expect(o.linkedDataset!, unittest.equals('foo'));
    unittest.expect(o.linkedPubsubSubscription!, unittest.equals('foo'));
    unittest.expect(o.listing!, unittest.equals('foo'));
  }
  buildCounterLinkedResource--;
}

core.List<api.DataExchange> buildUnnamed11() => [
  buildDataExchange(),
  buildDataExchange(),
];

void checkUnnamed11(core.List<api.DataExchange> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListDataExchangesResponse buildListDataExchangesResponse() {
  ...
  if (buildCounterListDataExchangesResponse < 3) {
    o.dataExchanges = buildUnnamed11();
    o.nextPageToken = 'foo';
  }
  buildCounterListDataExchangesResponse--;
  return o;
...
void checkListDataExchangesResponse(api.ListDataExchangesResponse o) {
  buildCounterListDataExchangesResponse++;
  if (buildCounterListDataExchangesResponse < 3) {
    checkUnnamed11(o.dataExchanges!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListDataExchangesResponse--;
}

core.List<api.Listing> buildUnnamed12() => [buildListing(), buildListing()];

void checkUnnamed12(core.List<api.Listing> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkListing(o[0]);
  checkListing(o[1]);
}
...
core.List<api.DataExchange> buildUnnamed13() => [
  buildDataExchange(),
  buildDataExchange(),
];

void checkUnnamed13(core.List<api.DataExchange> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataExchange(o[0]);
  checkDataExchange(o[1]);
}
...
api.ListOrgDataExchangesResponse buildListOrgDataExchangesResponse() {
  ...
  if (buildCounterListOrgDataExchangesResponse < 3) {
    o.dataExchanges = buildUnnamed13();
    o.nextPageToken = 'foo';
  }
  buildCounterListOrgDataExchangesResponse--;
  return o;
...
void checkListOrgDataExchangesResponse(api.ListOrgDataExchangesResponse o) {
  buildCounterListOrgDataExchangesResponse++;
  if (buildCounterListOrgDataExchangesResponse < 3) {
    checkUnnamed13(o.dataExchanges!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListOrgDataExchangesResponse--;
}

core.List<api.QueryTemplate> buildUnnamed14() => [
  buildQueryTemplate(),
  buildQueryTemplate(),
];

void checkUnnamed14(core.List<api.QueryTemplate> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQueryTemplate(o[0]);
  checkQueryTemplate(o[1]);
}

core.int buildCounterListQueryTemplatesResponse = 0;
api.ListQueryTemplatesResponse buildListQueryTemplatesResponse() {
  final o = api.ListQueryTemplatesResponse();
  buildCounterListQueryTemplatesResponse++;
  if (buildCounterListQueryTemplatesResponse < 3) {
    o.nextPageToken = 'foo';
    o.queryTemplates = buildUnnamed14();
  }
  buildCounterListQueryTemplatesResponse--;
  return o;
}

void checkListQueryTemplatesResponse(api.ListQueryTemplatesResponse o) {
  buildCounterListQueryTemplatesResponse++;
  if (buildCounterListQueryTemplatesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed14(o.queryTemplates!);
  }
  buildCounterListQueryTemplatesResponse--;
}
...
buildListSharedResourceSubscriptionsResponse() {
  ...
  if (buildCounterListSharedResourceSubscriptionsResponse < 3) {
    o.nextPageToken = 'foo';
    o.sharedResourceSubscriptions = buildUnnamed15();
  }
  buildCounterListSharedResourceSubscriptionsResponse--;
  return o;
}
...
void checkListSharedResourceSubscriptionsResponse(
  ...
  if (buildCounterListSharedResourceSubscriptionsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed15(o.sharedResourceSubscriptions!);
  }
  buildCounterListSharedResourceSubscriptionsResponse--;
}

core.List<api.Subscription> buildUnnamed16() => [
  buildSubscription(),
  buildSubscription(),
];

void checkUnnamed16(core.List<api.Subscription> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSubscription(o[0]);
  checkSubscription(o[1]);
}
...
api.ListSubscriptionsResponse buildListSubscriptionsResponse() {
  ...
  if (buildCounterListSubscriptionsResponse < 3) {
    o.nextPageToken = 'foo';
    o.subscriptions = buildUnnamed16();
  }
  buildCounterListSubscriptionsResponse--;
  return o;
}
...
void checkListSubscriptionsResponse(api.ListSubscriptionsResponse o) {
  ...
  if (buildCounterListSubscriptionsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed16(o.subscriptions!);
  }
  buildCounterListSubscriptionsResponse--;
}
...
api.Listing buildListing() {
  ...
  if (buildCounterListing < 3) {
    ...
    o.state = 'foo';
    o.storedProcedureConfig = buildStoredProcedureConfig();
  }
  buildCounterListing--;
  return o;
}
...
void checkListing(api.Listing o) {
  ...
  if (buildCounterListing < 3) {
    ...
    unittest.expect(o.requestAccess!, unittest.equals('foo'));
    unittest.expect(o.resourceType!, unittest.equals('foo'));
    checkRestrictedExportConfig(o.restrictedExportConfig!);
    unittest.expect(o.state!, unittest.equals('foo'));
    checkStoredProcedureConfig(o.storedProcedureConfig!);
  }
  buildCounterListing--;
}
...
core.List<api.Binding> buildUnnamed21() => [buildBinding(), buildBinding()];
...
api.PubSubTopicSource buildPubSubTopicSource() {
  ...
  if (buildCounterPubSubTopicSource < 3) {
    o.dataAffinityRegions = buildUnnamed22();
    o.topic = 'foo';
  }
  buildCounterPubSubTopicSource--;
  return o;
...
void checkPubSubTopicSource(api.PubSubTopicSource o) {
  buildCounterPubSubTopicSource++;
  if (buildCounterPubSubTopicSource < 3) {
    checkUnnamed22(o.dataAffinityRegions!);
...
core.int buildCounterQueryTemplate = 0;
api.QueryTemplate buildQueryTemplate() {
  final o = api.QueryTemplate();
  buildCounterQueryTemplate++;
  if (buildCounterQueryTemplate < 3) {
    o.createTime = 'foo';
    o.description = 'foo';
    o.displayName = 'foo';
    o.documentation = 'foo';
...
void checkQueryTemplate(api.QueryTemplate o) {
  buildCounterQueryTemplate++;
  if (buildCounterQueryTemplate < 3) {
    ...
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.primaryContact!, unittest.equals('foo'));
    unittest.expect(o.proposer!, unittest.equals('foo'));
    checkRoutine(o.routine!);
    unittest.expect(o.state!, unittest.equals('foo'));
...
void checkReplica(api.Replica o) {
  ...
  if (buildCounterReplica < 3) {
    unittest.expect(o.location!, unittest.equals('foo'));
    unittest.expect(o.primaryState!, unittest.equals('foo'));
    unittest.expect(o.replicaState!, unittest.equals('foo'));
  }
  buildCounterReplica--;
}
...
void checkSelectedResource(api.SelectedResource o) {
  buildCounterSelectedResource++;
  if (buildCounterSelectedResource < 3) {
    unittest.expect(o.routine!, unittest.equals('foo'));
    unittest.expect(o.table!, unittest.equals('foo'));
  }
  buildCounterSelectedResource--;
}
...
core.int buildCounterStoredProcedureConfig = 0;
api.StoredProcedureConfig buildStoredProcedureConfig() {
  final o = api.StoredProcedureConfig();
  buildCounterStoredProcedureConfig++;
  if (buildCounterStoredProcedureConfig < 3) {
    o.allowedStoredProcedureTypes = buildUnnamed26();
    o.enabled = true;
  }
  buildCounterStoredProcedureConfig--;
  return o;
...
void checkStoredProcedureConfig(api.StoredProcedureConfig o) {
  buildCounterStoredProcedureConfig++;
  if (buildCounterStoredProcedureConfig < 3) {
    checkUnnamed26(o.allowedStoredProcedureTypes!);
    unittest.expect(o.enabled!, unittest.isTrue);
  }
  buildCounterStoredProcedureConfig--;
}

core.int buildCounterSubmitQueryTemplateRequest = 0;
api.SubmitQueryTemplateRequest buildSubmitQueryTemplateRequest() {
  final o = api.SubmitQueryTemplateRequest();
  buildCounterSubmitQueryTemplateRequest++;
  if (buildCounterSubmitQueryTemplateRequest < 3) {}
  buildCounterSubmitQueryTemplateRequest--;
  return o;
}

void checkSubmitQueryTemplateRequest(api.SubmitQueryTemplateRequest o) {
  buildCounterSubmitQueryTemplateRequest++;
  if (buildCounterSubmitQueryTemplateRequest < 3) {}
  buildCounterSubmitQueryTemplateRequest--;
}
...
void checkSubscribeDataExchangeRequest(api.SubscribeDataExchangeRequest o) {
  ...
  if (buildCounterSubscribeDataExchangeRequest < 3) {
    ...
    unittest.expect(o.subscriberContact!, unittest.equals('foo'));
...
core.Map<core.String, api.LinkedResource> buildUnnamed27() => {
  'x': buildLinkedResource(),
  'y': buildLinkedResource(),
};

void checkUnnamed27(core.Map<core.String, api.LinkedResource> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLinkedResource(o['x']!);
  checkLinkedResource(o['y']!);
}

core.List<api.LinkedResource> buildUnnamed28() => [
  buildLinkedResource(),
  buildLinkedResource(),
];

void checkUnnamed28(core.List<api.LinkedResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Subscription buildSubscription() {
  ...
  if (buildCounterSubscription < 3) {
    ...
    o.linkedDatasetMap = buildUnnamed27();
    o.linkedResources = buildUnnamed28();
    o.listing = 'foo';
    o.logLinkedDatasetQueryUserEmail = true;
    o.name = 'foo';
...
void checkSubscription(api.Subscription o) {
  ...
  if (buildCounterSubscription < 3) {
    ...
    unittest.expect(o.dataExchange!, unittest.equals('foo'));
    checkDestinationDataset(o.destinationDataset!);
    unittest.expect(o.lastModifyTime!, unittest.equals('foo'));
    checkUnnamed27(o.linkedDatasetMap!);
    checkUnnamed28(o.linkedResources!);
    unittest.expect(o.listing!, unittest.equals('foo'));
    unittest.expect(o.logLinkedDatasetQueryUserEmail!, unittest.isTrue);
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.organizationDisplayName!, unittest.equals('foo'));
...
void main() {
  ...
  unittest.group('obj-schema-ApproveQueryTemplateRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildApproveQueryTemplateRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ApproveQueryTemplateRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkApproveQueryTemplateRequest(od);
    });
  });
  ...
  unittest.group('obj-schema-ListQueryTemplatesResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildListQueryTemplatesResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListQueryTemplatesResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkListQueryTemplatesResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-QueryTemplate', () {
    unittest.test('to-json--from-json', () async {
      final o = buildQueryTemplate();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.QueryTemplate.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkQueryTemplate(od);
    });
  });
  ...
  unittest.group('obj-schema-StoredProcedureConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildStoredProcedureConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.StoredProcedureConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkStoredProcedureConfig(od);
    });
  });

  unittest.group('obj-schema-SubmitQueryTemplateRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildSubmitQueryTemplateRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.SubmitQueryTemplateRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkSubmitQueryTemplateRequest(od);
    });
  });
  ...
  unittest.group('resource-ProjectsLocationsDataExchangesResource', () {
    unittest.test('method--create', () async {
      ...
      final response = await res.create(
        arg_request,
        arg_parent,
        dataExchangeId: arg_dataExchangeId,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--listSubscriptions', () async {
      ...
      final response = await res.listSubscriptions(
        arg_resource,
  ...
  unittest.group('resource-ProjectsLocationsDataExchangesListingsResource', () {
    ...
    unittest.test('method--delete', () async {
      ...
      final response = await res.delete(
        arg_name,
        deleteCommercial: arg_deleteCommercial,
        $fields: arg_$fields,
      );
      checkEmpty(response as api.Empty);
    });
  ...
  unittest.group('resource-ProjectsLocationsDataExchangesQueryTemplatesResource', () {
    unittest.test('method--approve', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.ApproveQueryTemplateRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkApproveQueryTemplateRequest(obj);
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildQueryTemplate());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      ...
      checkQueryTemplate(response as api.QueryTemplate);
    });
    ...
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.QueryTemplate.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkQueryTemplate(obj);
          ...
          unittest.expect(
            queryMap['queryTemplateId']!.first,
            unittest.equals(arg_queryTemplateId),
          );
          unittest.expect(
            queryMap['fields']!.first,
            unittest.equals(arg_$fields),
      ...
      final response = await res.create(
        arg_request,
        arg_parent,
        queryTemplateId: arg_queryTemplateId,
        $fields: arg_$fields,
      );
      checkQueryTemplate(response as api.QueryTemplate);
    });
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildListQueryTemplatesResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      ...
      checkListQueryTemplatesResponse(
        response as api.ListQueryTemplatesResponse,
      );
    });
    ...
    unittest.test('method--submit', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.SubmitQueryTemplateRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkSubmitQueryTemplateRequest(obj);
