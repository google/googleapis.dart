...
import 'package:googleapis/analyticshub/v1beta1.dart' as api;
...
core.int buildCounterGoogleCloudBigqueryDataexchangeV1beta1DestinationDataset =
    0;
api.GoogleCloudBigqueryDataexchangeV1beta1DestinationDataset
buildGoogleCloudBigqueryDataexchangeV1beta1DestinationDataset() {
  final o = api.GoogleCloudBigqueryDataexchangeV1beta1DestinationDataset();
  buildCounterGoogleCloudBigqueryDataexchangeV1beta1DestinationDataset++;
  if (buildCounterGoogleCloudBigqueryDataexchangeV1beta1DestinationDataset <
      3) {
    o.datasetReference =
        buildGoogleCloudBigqueryDataexchangeV1beta1DestinationDatasetReference();
    o.description = 'foo';
    o.friendlyName = 'foo';
...
void checkGoogleCloudBigqueryDataexchangeV1beta1DestinationDataset(
  api.GoogleCloudBigqueryDataexchangeV1beta1DestinationDataset o,
) {
  buildCounterGoogleCloudBigqueryDataexchangeV1beta1DestinationDataset++;
  if (buildCounterGoogleCloudBigqueryDataexchangeV1beta1DestinationDataset <
      3) {
    checkGoogleCloudBigqueryDataexchangeV1beta1DestinationDatasetReference(
      o.datasetReference!,
    );
    unittest.expect(o.description!, unittest.equals('foo'));
...
core.int
buildCounterGoogleCloudBigqueryDataexchangeV1beta1DestinationDatasetReference =
    0;
api.GoogleCloudBigqueryDataexchangeV1beta1DestinationDatasetReference
buildGoogleCloudBigqueryDataexchangeV1beta1DestinationDatasetReference() {
  final o =
      api.GoogleCloudBigqueryDataexchangeV1beta1DestinationDatasetReference();
  buildCounterGoogleCloudBigqueryDataexchangeV1beta1DestinationDatasetReference++;
  if (buildCounterGoogleCloudBigqueryDataexchangeV1beta1DestinationDatasetReference <
      3) {
    o.datasetId = 'foo';
    o.projectId = 'foo';
  }
...
void checkGoogleCloudBigqueryDataexchangeV1beta1DestinationDatasetReference(
  api.GoogleCloudBigqueryDataexchangeV1beta1DestinationDatasetReference o,
) {
  buildCounterGoogleCloudBigqueryDataexchangeV1beta1DestinationDatasetReference++;
  if (buildCounterGoogleCloudBigqueryDataexchangeV1beta1DestinationDatasetReference <
      3) {
...
core.List<api.Listing> buildUnnamed5() => [buildListing(), buildListing()];
...
void checkSubscribeListingRequest(api.SubscribeListingRequest o) {
  buildCounterSubscribeListingRequest++;
  if (buildCounterSubscribeListingRequest < 3) {
    checkGoogleCloudBigqueryDataexchangeV1beta1DestinationDataset(
      o.destinationDataset!,
    );
  }
  buildCounterSubscribeListingRequest--;
...
void main() {
  ...
  unittest.group(
    'obj-schema-GoogleCloudBigqueryDataexchangeV1beta1DestinationDataset',
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudBigqueryDataexchangeV1beta1DestinationDataset();
        ...
        checkGoogleCloudBigqueryDataexchangeV1beta1DestinationDataset(od);
      });
    },
  );

  unittest.group(
    'obj-schema-GoogleCloudBigqueryDataexchangeV1beta1DestinationDatasetReference',
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudBigqueryDataexchangeV1beta1DestinationDatasetReference();
