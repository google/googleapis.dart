...
checkUnnamed1165(core.List<api.Dataset> o) {
...
checkUnnamed1166(core.List<api.AggregateBy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAggregateRequest() {
  ...
  if (buildCounterAggregateRequest < 3) {
    o.aggregateBy = buildUnnamed1166();
    ...
    o.endTimeMillis = "foo";
    o.filteredDataQualityStandard = buildUnnamed1167();
    o.startTimeMillis = "foo";
  }
  buildCounterAggregateRequest--;
  return o;
...
checkAggregateRequest(api.AggregateRequest o) {
  buildCounterAggregateRequest++;
  if (buildCounterAggregateRequest < 3) {
    checkUnnamed1166(o.aggregateBy);
    ...
    unittest.expect(o.endTimeMillis, unittest.equals('foo'));
    checkUnnamed1167(o.filteredDataQualityStandard);
    unittest.expect(o.startTimeMillis, unittest.equals('foo'));
  }
  buildCounterAggregateRequest--;
}
...
checkUnnamed1168(core.List<api.AggregateBucket> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1169(core.List<api.Value> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValue(o[0]);
  checkValue(o[1]);
}
...
buildDataSource() {
  ...
  if (buildCounterDataSource < 3) {
    ...
    o.dataQualityStandard = buildUnnamed1170();
    o.dataStreamId = "foo";
...
checkDataSource(api.DataSource o) {
  ...
  if (buildCounterDataSource < 3) {
    ...
    checkUnnamed1170(o.dataQualityStandard);
...
checkUnnamed1171(core.List<api.DataTypeField> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1172(core.List<api.DataPoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataPoint(o[0]);
  checkDataPoint(o[1]);
}
...
checkUnnamed1173(core.List<api.DataPoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataPoint(o[0]);
  checkDataPoint(o[1]);
}
...
checkUnnamed1174(core.List<api.DataPoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataPoint(o[0]);
  checkDataPoint(o[1]);
}
...
buildListDataPointChangesResponse() {
  ...
  if (buildCounterListDataPointChangesResponse < 3) {
    o.dataSourceId = "foo";
    o.deletedDataPoint = buildUnnamed1173();
    o.insertedDataPoint = buildUnnamed1174();
    o.nextPageToken = "foo";
  }
  buildCounterListDataPointChangesResponse--;
  return o;
...
checkListDataPointChangesResponse(api.ListDataPointChangesResponse o) {
  ...
  if (buildCounterListDataPointChangesResponse < 3) {
    unittest.expect(o.dataSourceId, unittest.equals('foo'));
    checkUnnamed1173(o.deletedDataPoint);
    checkUnnamed1174(o.insertedDataPoint);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListDataPointChangesResponse--;
}
...
checkUnnamed1176(core.List<api.Session> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSession(o[0]);
  checkSession(o[1]);
}
...
checkUnnamed1177(core.List<api.Session> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSession(o[0]);
  checkSession(o[1]);
}
...
buildListSessionsResponse() {
  ...
  if (buildCounterListSessionsResponse < 3) {
    o.deletedSession = buildUnnamed1176();
    o.hasMoreData = true;
    o.nextPageToken = "foo";
    o.session = buildUnnamed1177();
  }
  buildCounterListSessionsResponse--;
  return o;
}
...
checkListSessionsResponse(api.ListSessionsResponse o) {
  buildCounterListSessionsResponse++;
  if (buildCounterListSessionsResponse < 3) {
    checkUnnamed1176(o.deletedSession);
    unittest.expect(o.hasMoreData, unittest.isTrue);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed1177(o.session);
  }
  buildCounterListSessionsResponse--;
}
...
checkUnnamed1178(core.List<api.ValueMapValEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  ...
  unittest.group("resource-UsersDataSourcesResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      api.UsersDataSourcesResourceApi res =
          new api.FitnessApi(mock).users.dataSources;
      var arg_userId = "foo";
      var arg_dataTypeName = buildUnnamed1179();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
