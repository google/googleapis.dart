...
checkUnnamed2240(core.List<api.Dataset> o) {
...
checkUnnamed2241(core.List<api.AggregateBy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAggregateRequest() {
  ...
  if (buildCounterAggregateRequest < 3) {
    o.aggregateBy = buildUnnamed2241();
...
checkAggregateRequest(api.AggregateRequest o) {
  buildCounterAggregateRequest++;
  if (buildCounterAggregateRequest < 3) {
    checkUnnamed2241(o.aggregateBy);
...
checkUnnamed2242(core.List<api.AggregateBucket> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2243(core.List<api.Value> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValue(o[0]);
  checkValue(o[1]);
}
...
checkUnnamed2244(core.List<api.DataTypeField> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2245(core.List<api.DataPoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataPoint(o[0]);
  checkDataPoint(o[1]);
}
...
checkUnnamed2246(core.List<api.DataSource> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataSource(o[0]);
  checkDataSource(o[1]);
}
...
checkUnnamed2247(core.List<api.Session> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSession(o[0]);
  checkSession(o[1]);
}
...
checkUnnamed2248(core.List<api.Session> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSession(o[0]);
  checkSession(o[1]);
}
...
buildListSessionsResponse() {
  ...
  if (buildCounterListSessionsResponse < 3) {
    o.deletedSession = buildUnnamed2247();
    o.nextPageToken = "foo";
    o.session = buildUnnamed2248();
  }
  buildCounterListSessionsResponse--;
  return o;
}
...
checkListSessionsResponse(api.ListSessionsResponse o) {
  buildCounterListSessionsResponse++;
  if (buildCounterListSessionsResponse < 3) {
    checkUnnamed2247(o.deletedSession);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed2248(o.session);
  }
  buildCounterListSessionsResponse--;
}
...
checkUnnamed2249(core.List<api.ValueMapValEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
main() {
  ...
  unittest.group("resource-UsersDataSourcesResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      api.UsersDataSourcesResourceApi res = new api.FitnessApi(mock).users.dataSources;
      var arg_userId = "foo";
      var arg_dataTypeName = buildUnnamed2250();
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
        var index;
