...
buildSubscription() {
  ...
  if (buildCounterSubscription < 3) {
    ...
    o.suspensionReasons = buildUnnamed2195();
...
checkSubscription(api.Subscription o) {
  ...
  if (buildCounterSubscription < 3) {
    ...
    checkUnnamed2195(o.suspensionReasons);
...
checkUnnamed2196(core.List<api.Subscription> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSubscriptions() {
  ...
  if (buildCounterSubscriptions < 3) {
    o.kind = "foo";
    o.nextPageToken = "foo";
    o.subscriptions = buildUnnamed2196();
  }
  buildCounterSubscriptions--;
  return o;
}
...
checkSubscriptions(api.Subscriptions o) {
  ...
  if (buildCounterSubscriptions < 3) {
    ...
    checkUnnamed2196(o.subscriptions);
  }
  buildCounterSubscriptions--;
}
