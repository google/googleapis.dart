...
buildSubscription() {
  ...
  if (buildCounterSubscription < 3) {
    ...
    o.suspensionReasons = buildUnnamed168();
...
checkSubscription(api.Subscription o) {
  ...
  if (buildCounterSubscription < 3) {
    ...
    checkUnnamed168(o.suspensionReasons);
...
checkUnnamed169(core.List<api.Subscription> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSubscriptions() {
  ...
  if (buildCounterSubscriptions < 3) {
    o.kind = "foo";
    o.nextPageToken = "foo";
    o.subscriptions = buildUnnamed169();
  }
  buildCounterSubscriptions--;
  return o;
}
...
checkSubscriptions(api.Subscriptions o) {
  ...
  if (buildCounterSubscriptions < 3) {
    ...
    checkUnnamed169(o.subscriptions);
  }
  buildCounterSubscriptions--;
}
