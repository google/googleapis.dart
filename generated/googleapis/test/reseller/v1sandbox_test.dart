library googleapis.reseller.v1sandbox.test;
...
import 'package:googleapis/reseller/v1sandbox.dart' as api;
...
buildSubscription() {
  ...
  if (buildCounterSubscription < 3) {
    ...
    o.suspensionReasons = buildUnnamed2508();
...
checkSubscription(api.Subscription o) {
  ...
  if (buildCounterSubscription < 3) {
    ...
    checkUnnamed2508(o.suspensionReasons);
...
checkUnnamed2509(core.List<api.Subscription> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSubscriptions() {
  ...
  if (buildCounterSubscriptions < 3) {
    o.kind = "foo";
    o.nextPageToken = "foo";
    o.subscriptions = buildUnnamed2509();
  }
  buildCounterSubscriptions--;
  return o;
}
...
checkSubscriptions(api.Subscriptions o) {
  ...
  if (buildCounterSubscriptions < 3) {
    ...
    checkUnnamed2509(o.subscriptions);
  }
  buildCounterSubscriptions--;
}
  ...
  unittest.group("resource-CustomersResourceApi", () {
    unittest.test("method--get", () {
      ...
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        ...
        pathOffset += 1;
        unittest.expect(path.substring(pathOffset, pathOffset + 24), unittest.equals("apps/reseller/v1sandbox/"));
        pathOffset += 24;
