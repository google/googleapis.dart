...
core.List<api.Feature> buildUnnamed0() => [buildFeature(), buildFeature()];
...
core.List<api.Feature> buildUnnamed3() => [buildFeature(), buildFeature()];
...
core.List<api.Feature> buildUnnamed10() => [buildFeature(), buildFeature()];
...
core.List<api.AsyncAnnotateFileRequest> buildUnnamed12() => [
  buildAsyncAnnotateFileRequest(),
  buildAsyncAnnotateFileRequest(),
];

void checkUnnamed12(core.List<api.AsyncAnnotateFileRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.AnnotateImageRequest> buildUnnamed14() => [
  buildAnnotateImageRequest(),
  buildAnnotateImageRequest(),
];

void checkUnnamed14(core.List<api.AnnotateImageRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.AnnotateFileRequest> buildUnnamed16() => [
  buildAnnotateFileRequest(),
  buildAnnotateFileRequest(),
];

void checkUnnamed16(core.List<api.AnnotateFileRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.AnnotateFileResponse> buildUnnamed17() => [
  buildAnnotateFileResponse(),
  buildAnnotateFileResponse(),
];

void checkUnnamed17(core.List<api.AnnotateFileResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.AnnotateImageRequest> buildUnnamed19() => [
  buildAnnotateImageRequest(),
  buildAnnotateImageRequest(),
];

void checkUnnamed19(core.List<api.AnnotateImageRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAnnotateImageRequest(o[0]);
  checkAnnotateImageRequest(o[1]);
}
...
core.List<api.AnnotateImageResponse> buildUnnamed20() => [
  buildAnnotateImageResponse(),
  buildAnnotateImageResponse(),
];

void checkUnnamed20(core.List<api.AnnotateImageResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAnnotateImageResponse(o[0]);
  checkAnnotateImageResponse(o[1]);
}
...
core.List<api.Paragraph> buildUnnamed21() => [
  buildParagraph(),
  buildParagraph(),
];

void checkUnnamed21(core.List<api.Paragraph> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkParagraph(o[0]);
  checkParagraph(o[1]);
}
...
core.List<api.NormalizedVertex> buildUnnamed22() => [
  buildNormalizedVertex(),
  buildNormalizedVertex(),
];

void checkUnnamed22(core.List<api.NormalizedVertex> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNormalizedVertex(o[0]);
  checkNormalizedVertex(o[1]);
}

core.List<api.Vertex> buildUnnamed23() => [buildVertex(), buildVertex()];

void checkUnnamed23(core.List<api.Vertex> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVertex(o[0]);
  checkVertex(o[1]);
}
...
core.List<api.ColorInfo> buildUnnamed26() => [
  buildColorInfo(),
  buildColorInfo(),
];

void checkUnnamed26(core.List<api.ColorInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkColorInfo(o[0]);
  checkColorInfo(o[1]);
}
...
core.List<api.LocationInfo> buildUnnamed27() => [
  buildLocationInfo(),
  buildLocationInfo(),
];

void checkUnnamed27(core.List<api.LocationInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocationInfo(o[0]);
  checkLocationInfo(o[1]);
}

core.List<api.Property> buildUnnamed28() => [buildProperty(), buildProperty()];

void checkUnnamed28(core.List<api.Property> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProperty(o[0]);
  checkProperty(o[1]);
}
...
core.List<api.Landmark> buildUnnamed29() => [buildLandmark(), buildLandmark()];

void checkUnnamed29(core.List<api.Landmark> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLandmark(o[0]);
  checkLandmark(o[1]);
}
...
core.List<api.ObjectAnnotation> buildUnnamed30() => [
  buildObjectAnnotation(),
  buildObjectAnnotation(),
];

void checkUnnamed30(core.List<api.ObjectAnnotation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkObjectAnnotation(o[0]);
  checkObjectAnnotation(o[1]);
}

core.List<api.Result> buildUnnamed31() => [buildResult(), buildResult()];

void checkUnnamed31(core.List<api.Result> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResult(o[0]);
  checkResult(o[1]);
}
...
api.GroupedResult buildGroupedResult() {
  ...
  if (buildCounterGroupedResult < 3) {
    o.boundingPoly = buildBoundingPoly();
    o.objectAnnotations = buildUnnamed30();
    o.results = buildUnnamed31();
  }
  buildCounterGroupedResult--;
  return o;
}
...
void checkGroupedResult(api.GroupedResult o) {
  ...
  if (buildCounterGroupedResult < 3) {
    checkBoundingPoly(o.boundingPoly!);
    checkUnnamed30(o.objectAnnotations!);
    checkUnnamed31(o.results!);
  }
  buildCounterGroupedResult--;
}
...
api.ImageContext buildImageContext() {
  ...
  if (buildCounterImageContext < 3) {
    ...
    o.languageHints = buildUnnamed32();
...
void checkImageContext(api.ImageContext o) {
  ...
  if (buildCounterImageContext < 3) {
    ...
    checkUnnamed32(o.languageHints!);
...
core.List<api.ProductSet> buildUnnamed35() => [
  buildProductSet(),
  buildProductSet(),
];

void checkUnnamed35(core.List<api.ProductSet> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProductSet(o[0]);
  checkProductSet(o[1]);
}
...
void checkListProductSetsResponse(api.ListProductSetsResponse o) {
  ...
  if (buildCounterListProductSetsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed35(o.productSets!);
  }
  buildCounterListProductSetsResponse--;
}

core.List<api.Product> buildUnnamed36() => [buildProduct(), buildProduct()];

void checkUnnamed36(core.List<api.Product> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProduct(o[0]);
  checkProduct(o[1]);
}
...
void checkListProductsInProductSetResponse(
  ...
  if (buildCounterListProductsInProductSetResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed36(o.products!);
  }
  buildCounterListProductsInProductSetResponse--;
}

core.List<api.Product> buildUnnamed37() => [buildProduct(), buildProduct()];

void checkUnnamed37(core.List<api.Product> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProduct(o[0]);
  checkProduct(o[1]);
}
...
core.List<api.ReferenceImage> buildUnnamed38() => [
  buildReferenceImage(),
  buildReferenceImage(),
];

void checkUnnamed38(core.List<api.ReferenceImage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListReferenceImagesResponse buildListReferenceImagesResponse() {
  ...
  if (buildCounterListReferenceImagesResponse < 3) {
    o.nextPageToken = 'foo';
    o.pageSize = 42;
    o.referenceImages = buildUnnamed38();
  }
  buildCounterListReferenceImagesResponse--;
  return o;
}
...
void checkListReferenceImagesResponse(api.ListReferenceImagesResponse o) {
  ...
  if (buildCounterListReferenceImagesResponse < 3) {
    ...
    checkUnnamed38(o.referenceImages!);
  }
  buildCounterListReferenceImagesResponse--;
}
...
core.List<api.Block> buildUnnamed41() => [buildBlock(), buildBlock()];

void checkUnnamed41(core.List<api.Block> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBlock(o[0]);
  checkBlock(o[1]);
}
...
core.List<api.Word> buildUnnamed42() => [buildWord(), buildWord()];

void checkUnnamed42(core.List<api.Word> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWord(o[0]);
  checkWord(o[1]);
}
...
core.List<api.KeyValue> buildUnnamed43() => [buildKeyValue(), buildKeyValue()];

void checkUnnamed43(core.List<api.KeyValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkKeyValue(o[0]);
  checkKeyValue(o[1]);
}
...
api.Product buildProduct() {
  ...
  if (buildCounterProduct < 3) {
    ...
    o.productLabels = buildUnnamed43();
  }
  buildCounterProduct--;
  return o;
}
...
void checkProduct(api.Product o) {
  ...
  if (buildCounterProduct < 3) {
    ...
    checkUnnamed43(o.productLabels!);
  }
  buildCounterProduct--;
}
...
api.ProductSearchParams buildProductSearchParams() {
  ...
  if (buildCounterProductSearchParams < 3) {
    o.boundingPoly = buildBoundingPoly();
    o.filter = 'foo';
    o.productCategories = buildUnnamed44();
    o.productSet = 'foo';
  }
  buildCounterProductSearchParams--;
  return o;
...
void checkProductSearchParams(api.ProductSearchParams o) {
  ...
  if (buildCounterProductSearchParams < 3) {
    ...
    checkUnnamed44(o.productCategories!);
    unittest.expect(o.productSet!, unittest.equals('foo'));
  }
  buildCounterProductSearchParams--;
}

core.List<api.GroupedResult> buildUnnamed45() => [
  buildGroupedResult(),
  buildGroupedResult(),
];

void checkUnnamed45(core.List<api.GroupedResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGroupedResult(o[0]);
  checkGroupedResult(o[1]);
}

core.List<api.Result> buildUnnamed46() => [buildResult(), buildResult()];

void checkUnnamed46(core.List<api.Result> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResult(o[0]);
  checkResult(o[1]);
}
...
api.ProductSearchResults buildProductSearchResults() {
  ...
  if (buildCounterProductSearchResults < 3) {
    o.indexTime = 'foo';
    o.productGroupedResults = buildUnnamed45();
    o.results = buildUnnamed46();
  }
  buildCounterProductSearchResults--;
  return o;
}
...
void checkProductSearchResults(api.ProductSearchResults o) {
  ...
  if (buildCounterProductSearchResults < 3) {
    ...
    checkUnnamed45(o.productGroupedResults!);
    checkUnnamed46(o.results!);
  }
  buildCounterProductSearchResults--;
}
...
core.List<api.BoundingPoly> buildUnnamed47() => [
  buildBoundingPoly(),
  buildBoundingPoly(),
];

void checkUnnamed47(core.List<api.BoundingPoly> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ReferenceImage buildReferenceImage() {
  ...
  if (buildCounterReferenceImage < 3) {
    o.boundingPolys = buildUnnamed47();
    o.name = 'foo';
    o.uri = 'foo';
  }
  buildCounterReferenceImage--;
...
void checkReferenceImage(api.ReferenceImage o) {
  buildCounterReferenceImage++;
  if (buildCounterReferenceImage < 3) {
    checkUnnamed47(o.boundingPolys!);
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.uri!, unittest.equals('foo'));
  }
  buildCounterReferenceImage--;
...
core.List<api.Page> buildUnnamed50() => [buildPage(), buildPage()];

void checkUnnamed50(core.List<api.Page> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPage(o[0]);
  checkPage(o[1]);
}
...
api.TextDetectionParams buildTextDetectionParams() {
  ...
  if (buildCounterTextDetectionParams < 3) {
    o.advancedOcrOptions = buildUnnamed51();
...
void checkTextDetectionParams(api.TextDetectionParams o) {
  buildCounterTextDetectionParams++;
  if (buildCounterTextDetectionParams < 3) {
    checkUnnamed51(o.advancedOcrOptions!);
    unittest.expect(o.enableTextDetectionConfidenceScore!, unittest.isTrue);
  }
  buildCounterTextDetectionParams--;
}

core.List<api.DetectedLanguage> buildUnnamed52() => [
  buildDetectedLanguage(),
  buildDetectedLanguage(),
];

void checkUnnamed52(core.List<api.DetectedLanguage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TextProperty buildTextProperty() {
  ...
  if (buildCounterTextProperty < 3) {
    ...
    o.detectedLanguages = buildUnnamed52();
  }
  buildCounterTextProperty--;
  return o;
}
...
void checkTextProperty(api.TextProperty o) {
  ...
  if (buildCounterTextProperty < 3) {
    ...
    checkUnnamed52(o.detectedLanguages!);
  }
  buildCounterTextProperty--;
}
...
core.List<api.WebLabel> buildUnnamed53() => [buildWebLabel(), buildWebLabel()];

void checkUnnamed53(core.List<api.WebLabel> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWebLabel(o[0]);
  checkWebLabel(o[1]);
}

core.List<api.WebImage> buildUnnamed54() => [buildWebImage(), buildWebImage()];
...
core.List<api.WebPage> buildUnnamed55() => [buildWebPage(), buildWebPage()];

void checkUnnamed55(core.List<api.WebPage> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWebPage(o[0]);
  checkWebPage(o[1]);
}

core.List<api.WebImage> buildUnnamed56() => [buildWebImage(), buildWebImage()];

void checkUnnamed56(core.List<api.WebImage> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWebImage(o[0]);
  checkWebImage(o[1]);
}

core.List<api.WebImage> buildUnnamed57() => [buildWebImage(), buildWebImage()];

void checkUnnamed57(core.List<api.WebImage> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWebImage(o[0]);
  checkWebImage(o[1]);
}

core.List<api.WebEntity> buildUnnamed58() => [
  buildWebEntity(),
  buildWebEntity(),
];

void checkUnnamed58(core.List<api.WebEntity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWebEntity(o[0]);
  checkWebEntity(o[1]);
}
...
api.WebDetection buildWebDetection() {
  ...
  if (buildCounterWebDetection < 3) {
    o.bestGuessLabels = buildUnnamed53();
    o.fullMatchingImages = buildUnnamed54();
    o.pagesWithMatchingImages = buildUnnamed55();
    o.partialMatchingImages = buildUnnamed56();
    o.visuallySimilarImages = buildUnnamed57();
    o.webEntities = buildUnnamed58();
  }
  buildCounterWebDetection--;
  return o;
}
...
void checkWebDetection(api.WebDetection o) {
  buildCounterWebDetection++;
  if (buildCounterWebDetection < 3) {
    checkUnnamed53(o.bestGuessLabels!);
    checkUnnamed54(o.fullMatchingImages!);
    checkUnnamed55(o.pagesWithMatchingImages!);
    checkUnnamed56(o.partialMatchingImages!);
    checkUnnamed57(o.visuallySimilarImages!);
    checkUnnamed58(o.webEntities!);
  }
  buildCounterWebDetection--;
}
...
core.List<api.WebImage> buildUnnamed59() => [buildWebImage(), buildWebImage()];

void checkUnnamed59(core.List<api.WebImage> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWebImage(o[0]);
  checkWebImage(o[1]);
}

core.List<api.WebImage> buildUnnamed60() => [buildWebImage(), buildWebImage()];

void checkUnnamed60(core.List<api.WebImage> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWebImage(o[0]);
  checkWebImage(o[1]);
}
...
api.WebPage buildWebPage() {
  ...
  if (buildCounterWebPage < 3) {
    o.fullMatchingImages = buildUnnamed59();
    o.pageTitle = 'foo';
    o.partialMatchingImages = buildUnnamed60();
    o.score = 42.0;
    o.url = 'foo';
  }
  buildCounterWebPage--;
...
void checkWebPage(api.WebPage o) {
  buildCounterWebPage++;
  if (buildCounterWebPage < 3) {
    checkUnnamed59(o.fullMatchingImages!);
    unittest.expect(o.pageTitle!, unittest.equals('foo'));
    checkUnnamed60(o.partialMatchingImages!);
    unittest.expect(o.score!, unittest.equals(42.0));
    unittest.expect(o.url!, unittest.equals('foo'));
  }
  buildCounterWebPage--;
...
core.List<api.Symbol> buildUnnamed61() => [buildSymbol(), buildSymbol()];

void checkUnnamed61(core.List<api.Symbol> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSymbol(o[0]);
  checkSymbol(o[1]);
}
...
void main() {
  ...
  unittest.group('obj-schema-ColorInfo', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ColorInfo.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkColorInfo(od);
    });
  ...
  unittest.group('obj-schema-CropHint', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CropHint.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCropHint(od);
    });
  ...
  unittest.group('obj-schema-KeyValue', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.KeyValue.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkKeyValue(od);
    });
  ...
  unittest.group('obj-schema-Landmark', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Landmark.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkLandmark(od);
    });
  ...
  unittest.group('obj-schema-ProductSet', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ProductSet.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkProductSet(od);
    });
  ...
  unittest.group('obj-schema-WebEntity', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.WebEntity.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkWebEntity(od);
    });
  ...
  unittest.group('obj-schema-WebImage', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.WebImage.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkWebImage(od);
    });
  ...
  unittest.group('obj-schema-WebLabel', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.WebLabel.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkWebLabel(od);
    });
  ...
  unittest.group('resource-ProjectsLocationsProductSetsResource', () {
    unittest.test('method--addProduct', () async {
      ...
      final response = await res.addProduct(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--removeProduct', () async {
      ...
      final response = await res.removeProduct(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-ProjectsLocationsProductsResource', () {
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Product.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkProduct(obj);
  ...
  unittest.group('resource-ProjectsLocationsProductsReferenceImagesResource', () {
    unittest.test('method--create', () async {
      ...
      final response = await res.create(
        arg_request,
        arg_parent,
        referenceImageId: arg_referenceImageId,
        $fields: arg_$fields,
      );
