...
void checkAddSubnetworkRequest(api.AddSubnetworkRequest o) {
  ...
  if (buildCounterAddSubnetworkRequest < 3) {
    ...
    unittest.expect(o.computeIdempotencyWindow!, unittest.equals('foo'));
    ...
    unittest.expect(o.outsideAllocationPublicIpRange!, unittest.equals('foo'));
...
core.int buildCounterCloudSQLConfig = 0;
api.CloudSQLConfig buildCloudSQLConfig() {
  final o = api.CloudSQLConfig();
  buildCounterCloudSQLConfig++;
  if (buildCounterCloudSQLConfig < 3) {
    o.service = 'foo';
    o.umbrellaNetwork = 'foo';
    o.umbrellaProject = 'foo';
  }
  buildCounterCloudSQLConfig--;
  return o;
}

void checkCloudSQLConfig(api.CloudSQLConfig o) {
  buildCounterCloudSQLConfig++;
  if (buildCounterCloudSQLConfig < 3) {
    unittest.expect(o.service!, unittest.equals('foo'));
    unittest.expect(o.umbrellaNetwork!, unittest.equals('foo'));
    unittest.expect(o.umbrellaProject!, unittest.equals('foo'));
  }
  buildCounterCloudSQLConfig--;
}
...
core.List<api.CloudSQLConfig> buildUnnamed5() => [
  buildCloudSQLConfig(),
  buildCloudSQLConfig(),
];

void checkUnnamed5(core.List<api.CloudSQLConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCloudSQLConfig(o[0]);
  checkCloudSQLConfig(o[1]);
}
...
void checkUnnamed6(
  core.List<api.GoogleCloudServicenetworkingV1ConsumerConfigReservedRange> o,
) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ConsumerConfig buildConsumerConfig() {
  ...
  if (buildCounterConsumerConfig < 3) {
    o.cloudsqlConfigs = buildUnnamed5();
    ...
    o.reservedRanges = buildUnnamed6();
    o.usedIpRanges = buildUnnamed7();
...
void checkConsumerConfig(api.ConsumerConfig o) {
  buildCounterConsumerConfig++;
  if (buildCounterConsumerConfig < 3) {
    checkUnnamed5(o.cloudsqlConfigs!);
    ...
    checkUnnamed6(o.reservedRanges!);
    checkUnnamed7(o.usedIpRanges!);
...
void main() {
  ...
  unittest.group('obj-schema-CloudSQLConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCloudSQLConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CloudSQLConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCloudSQLConfig(od);
    });
  });
  ...
  unittest.group('obj-schema-Subnetwork', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Subnetwork.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkSubnetwork(od);
    });
  ...
  unittest.group('resource-ServicesConnectionsResource', () {
    ...
    unittest.test('method--deleteConnection', () async {
      ...
      final response = await res.deleteConnection(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-ServicesProjectsGlobalNetworksResource', () {
    unittest.test('method--get', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            queryMap['includeUsedIpRanges']!.first,
            unittest.equals('$arg_includeUsedIpRanges'),
          );
          unittest.expect(
            queryMap['fields']!.first,
            unittest.equals(arg_$fields),
      ...
      final response = await res.get(
        arg_name,
        includeUsedIpRanges: arg_includeUsedIpRanges,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--getVpcServiceControls', () async {
      ...
      final response = await res.getVpcServiceControls(
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--updateConsumerConfig', () async {
      ...
      final response = await res.updateConsumerConfig(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
