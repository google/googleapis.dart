...
core.List<api.TenancyUnit> buildUnnamed2() => [
  buildTenancyUnit(),
  buildTenancyUnit(),
];

void checkUnnamed2(core.List<api.TenancyUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.TenancyUnit> buildUnnamed6() => [
  buildTenancyUnit(),
  buildTenancyUnit(),
];

void checkUnnamed6(core.List<api.TenancyUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTenancyUnit(o[0]);
  checkTenancyUnit(o[1]);
}
...
api.ServiceAccountConfig buildServiceAccountConfig() {
  ...
  if (buildCounterServiceAccountConfig < 3) {
    o.accountId = 'foo';
    o.tenantProjectRoles = buildUnnamed7();
  }
  buildCounterServiceAccountConfig--;
  return o;
}
...
void checkServiceAccountConfig(api.ServiceAccountConfig o) {
  ...
  if (buildCounterServiceAccountConfig < 3) {
    ...
    checkUnnamed7(o.tenantProjectRoles!);
  }
  buildCounterServiceAccountConfig--;
}
...
core.List<api.TenantResource> buildUnnamed10() => [
  buildTenantResource(),
  buildTenantResource(),
];

void checkUnnamed10(core.List<api.TenantResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TenancyUnit buildTenancyUnit() {
  ...
  if (buildCounterTenancyUnit < 3) {
    ...
    o.name = 'foo';
    o.service = 'foo';
    o.tenantResources = buildUnnamed10();
  }
  buildCounterTenancyUnit--;
  return o;
}
...
void checkTenancyUnit(api.TenancyUnit o) {
  ...
  if (buildCounterTenancyUnit < 3) {
    ...
    checkUnnamed10(o.tenantResources!);
  }
  buildCounterTenancyUnit--;
}
...
core.List<api.PolicyBinding> buildUnnamed13() => [
  buildPolicyBinding(),
  buildPolicyBinding(),
];

void checkUnnamed13(core.List<api.PolicyBinding> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TenantProjectPolicy buildTenantProjectPolicy() {
  ...
  if (buildCounterTenantProjectPolicy < 3) {
    o.policyBindings = buildUnnamed13();
  }
  buildCounterTenantProjectPolicy--;
  return o;
}
...
void checkTenantProjectPolicy(api.TenantProjectPolicy o) {
  buildCounterTenantProjectPolicy++;
  if (buildCounterTenantProjectPolicy < 3) {
    checkUnnamed13(o.policyBindings!);
  }
  buildCounterTenantProjectPolicy--;
}
...
void main() {
  ...
  unittest.group('resource-ServicesTenancyUnitsResource', () {
    unittest.test('method--addProject', () async {
      ...
      final response = await res.addProject(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--applyProjectConfig', () async {
      ...
      final response = await res.applyProjectConfig(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--attachProject', () async {
      ...
      final response = await res.attachProject(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--deleteProject', () async {
      ...
      final response = await res.deleteProject(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--removeProject', () async {
      ...
      final response = await res.removeProject(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--undeleteProject', () async {
      ...
      final response = await res.undeleteProject(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
