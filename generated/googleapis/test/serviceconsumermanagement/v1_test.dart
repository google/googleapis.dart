...
core.List<api.Method> buildUnnamed4648() => [
      buildMethod(),
      buildMethod(),
    ];

void checkUnnamed4648(core.List<api.Method> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMethod(o[0]);
  checkMethod(o[1]);
}

core.List<api.Mixin> buildUnnamed4649() => [
      buildMixin(),
      buildMixin(),
    ];

void checkUnnamed4649(core.List<api.Mixin> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMixin(o[0]);
  checkMixin(o[1]);
}

core.List<api.Option> buildUnnamed4650() => [
      buildOption(),
      buildOption(),
    ];

void checkUnnamed4650(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
api.Api buildApi() {
  ...
  if (buildCounterApi < 3) {
    o.methods = buildUnnamed4648();
    o.mixins = buildUnnamed4649();
    o.name = 'foo';
    o.options = buildUnnamed4650();
...
void checkApi(api.Api o) {
  buildCounterApi++;
  if (buildCounterApi < 3) {
    checkUnnamed4648(o.methods!);
    checkUnnamed4649(o.mixins!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed4650(o.options!);
...
core.List<api.JwtLocation> buildUnnamed4651() => [
      buildJwtLocation(),
      buildJwtLocation(),
    ];

void checkUnnamed4651(core.List<api.JwtLocation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AuthProvider buildAuthProvider() {
  ...
  if (buildCounterAuthProvider < 3) {
    ...
    o.issuer = 'foo';
    o.jwksUri = 'foo';
    o.jwtLocations = buildUnnamed4651();
  }
  buildCounterAuthProvider--;
  return o;
}
...
void checkAuthProvider(api.AuthProvider o) {
  ...
  if (buildCounterAuthProvider < 3) {
    ...
    checkUnnamed4651(o.jwtLocations!);
  }
  buildCounterAuthProvider--;
}
...
core.List<api.AuthProvider> buildUnnamed4652() => [
      buildAuthProvider(),
      buildAuthProvider(),
    ];

void checkUnnamed4652(core.List<api.AuthProvider> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAuthProvider(o[0]);
  checkAuthProvider(o[1]);
}

core.List<api.AuthenticationRule> buildUnnamed4653() => [
      buildAuthenticationRule(),
      buildAuthenticationRule(),
    ];

void checkUnnamed4653(core.List<api.AuthenticationRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkAuthentication(api.Authentication o) {
  buildCounterAuthentication++;
  if (buildCounterAuthentication < 3) {
    checkUnnamed4652(o.providers!);
    checkUnnamed4653(o.rules!);
  }
  buildCounterAuthentication--;
}

core.List<api.AuthRequirement> buildUnnamed4654() => [
      buildAuthRequirement(),
      buildAuthRequirement(),
    ];

void checkUnnamed4654(core.List<api.AuthRequirement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AuthenticationRule buildAuthenticationRule() {
  ...
  if (buildCounterAuthenticationRule < 3) {
    ...
    o.requirements = buildUnnamed4654();
    o.selector = 'foo';
  }
  buildCounterAuthenticationRule--;
  return o;
...
void checkAuthenticationRule(api.AuthenticationRule o) {
  ...
  if (buildCounterAuthenticationRule < 3) {
    ...
    checkUnnamed4654(o.requirements!);
    unittest.expect(
      o.selector!,
      unittest.equals('foo'),
    );
...
core.List<api.BackendRule> buildUnnamed4655() => [
      buildBackendRule(),
      buildBackendRule(),
    ];

void checkUnnamed4655(core.List<api.BackendRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.BillingDestination> buildUnnamed4656() => [
      buildBillingDestination(),
      buildBillingDestination(),
    ];

void checkUnnamed4656(core.List<api.BillingDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Billing buildBilling() {
  ...
  if (buildCounterBilling < 3) {
    o.consumerDestinations = buildUnnamed4656();
  }
  buildCounterBilling--;
  return o;
}
...
void checkBilling(api.Billing o) {
  buildCounterBilling++;
  if (buildCounterBilling < 3) {
    checkUnnamed4656(o.consumerDestinations!);
  }
  buildCounterBilling--;
}
...
core.List<core.String> buildUnnamed4657() => [
      'foo',
      'foo',
    ];

void checkUnnamed4657(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.ContextRule> buildUnnamed4658() => [
      buildContextRule(),
      buildContextRule(),
    ];

void checkUnnamed4658(core.List<api.ContextRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ContextRule buildContextRule() {
  ...
  if (buildCounterContextRule < 3) {
    o.allowedRequestExtensions = buildUnnamed4659();
    o.allowedResponseExtensions = buildUnnamed4660();
    o.provided = buildUnnamed4661();
    o.requested = buildUnnamed4662();
    o.selector = 'foo';
  }
  buildCounterContextRule--;
  return o;
...
void checkContextRule(api.ContextRule o) {
  buildCounterContextRule++;
  if (buildCounterContextRule < 3) {
    checkUnnamed4659(o.allowedRequestExtensions!);
    checkUnnamed4660(o.allowedResponseExtensions!);
    checkUnnamed4661(o.provided!);
    checkUnnamed4662(o.requested!);
    unittest.expect(
      o.selector!,
      unittest.equals('foo'),
    );
...
core.List<api.CustomErrorRule> buildUnnamed4663() => [
      buildCustomErrorRule(),
      buildCustomErrorRule(),
    ];

void checkUnnamed4663(core.List<api.CustomErrorRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Page> buildUnnamed4665() => [
      buildPage(),
      buildPage(),
    ];

void checkUnnamed4665(core.List<api.Page> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPage(o[0]);
  checkPage(o[1]);
}

core.List<api.DocumentationRule> buildUnnamed4666() => [
      buildDocumentationRule(),
      buildDocumentationRule(),
    ];

void checkUnnamed4666(core.List<api.DocumentationRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Documentation buildDocumentation() {
  ...
  if (buildCounterDocumentation < 3) {
    ...
    o.overview = 'foo';
    o.pages = buildUnnamed4665();
    o.rules = buildUnnamed4666();
...
void checkDocumentation(api.Documentation o) {
  ...
  if (buildCounterDocumentation < 3) {
    ...
    checkUnnamed4665(o.pages!);
    checkUnnamed4666(o.rules!);
    unittest.expect(
      o.serviceRootUrl!,
      unittest.equals('foo'),
    );
...
core.List<api.EnumValue> buildUnnamed4667() => [
      buildEnumValue(),
      buildEnumValue(),
    ];

void checkUnnamed4667(core.List<api.EnumValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEnumValue(o[0]);
  checkEnumValue(o[1]);
}
...
core.List<api.Option> buildUnnamed4669() => [
      buildOption(),
      buildOption(),
    ];

void checkUnnamed4669(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
void checkEnumValue(api.EnumValue o) {
  ...
  if (buildCounterEnumValue < 3) {
    ...
    checkUnnamed4669(o.options!);
  }
  buildCounterEnumValue--;
}

core.List<api.Option> buildUnnamed4670() => [
      buildOption(),
      buildOption(),
    ];

void checkUnnamed4670(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
core.List<api.HttpRule> buildUnnamed4671() => [
      buildHttpRule(),
      buildHttpRule(),
    ];

void checkUnnamed4671(core.List<api.HttpRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHttpRule(o[0]);
  checkHttpRule(o[1]);
}
...
void checkHttp(api.Http o) {
  ...
  if (buildCounterHttp < 3) {
    ...
    checkUnnamed4671(o.rules!);
  }
  buildCounterHttp--;
}

core.List<api.HttpRule> buildUnnamed4672() => [
      buildHttpRule(),
      buildHttpRule(),
    ];

void checkUnnamed4672(core.List<api.HttpRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHttpRule(o[0]);
  checkHttpRule(o[1]);
}
...
api.HttpRule buildHttpRule() {
  ...
  if (buildCounterHttpRule < 3) {
    o.additionalBindings = buildUnnamed4672();
    o.body = 'foo';
...
void checkHttpRule(api.HttpRule o) {
  buildCounterHttpRule++;
  if (buildCounterHttpRule < 3) {
    checkUnnamed4672(o.additionalBindings!);
    unittest.expect(
      o.body!,
      unittest.equals('foo'),
    );
...
core.List<api.Operation> buildUnnamed4673() => [
      buildOperation(),
      buildOperation(),
    ];

void checkUnnamed4673(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
void checkListOperationsResponse(api.ListOperationsResponse o) {
  ...
  if (buildCounterListOperationsResponse < 3) {
    ...
    checkUnnamed4673(o.operations!);
  }
  buildCounterListOperationsResponse--;
}

core.List<api.TenancyUnit> buildUnnamed4674() => [
      buildTenancyUnit(),
      buildTenancyUnit(),
    ];

void checkUnnamed4674(core.List<api.TenancyUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListTenancyUnitsResponse buildListTenancyUnitsResponse() {
  ...
  if (buildCounterListTenancyUnitsResponse < 3) {
    o.nextPageToken = 'foo';
    o.tenancyUnits = buildUnnamed4674();
  }
  buildCounterListTenancyUnitsResponse--;
  return o;
}
...
void checkListTenancyUnitsResponse(api.ListTenancyUnitsResponse o) {
  ...
  if (buildCounterListTenancyUnitsResponse < 3) {
    ...
    checkUnnamed4674(o.tenancyUnits!);
  }
  buildCounterListTenancyUnitsResponse--;
}

core.List<api.LabelDescriptor> buildUnnamed4675() => [
      buildLabelDescriptor(),
      buildLabelDescriptor(),
    ];

void checkUnnamed4675(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.LoggingDestination> buildUnnamed4676() => [
      buildLoggingDestination(),
      buildLoggingDestination(),
    ];

void checkUnnamed4676(core.List<api.LoggingDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLoggingDestination(o[0]);
  checkLoggingDestination(o[1]);
}

core.List<api.LoggingDestination> buildUnnamed4677() => [
      buildLoggingDestination(),
      buildLoggingDestination(),
    ];

void checkUnnamed4677(core.List<api.LoggingDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLoggingDestination(o[0]);
  checkLoggingDestination(o[1]);
}
...
api.Logging buildLogging() {
  ...
  if (buildCounterLogging < 3) {
    o.consumerDestinations = buildUnnamed4676();
    o.producerDestinations = buildUnnamed4677();
  }
  buildCounterLogging--;
  return o;
}
...
void checkLogging(api.Logging o) {
  buildCounterLogging++;
  if (buildCounterLogging < 3) {
    checkUnnamed4676(o.consumerDestinations!);
    checkUnnamed4677(o.producerDestinations!);
  }
  buildCounterLogging--;
}
...
core.List<api.Option> buildUnnamed4679() => [
      buildOption(),
      buildOption(),
    ];

void checkUnnamed4679(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
core.List<api.LabelDescriptor> buildUnnamed4680() => [
      buildLabelDescriptor(),
      buildLabelDescriptor(),
    ];

void checkUnnamed4680(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelDescriptor(o[0]);
  checkLabelDescriptor(o[1]);
}
...
api.MetricDescriptor buildMetricDescriptor() {
  ...
  if (buildCounterMetricDescriptor < 3) {
    o.description = 'foo';
    o.displayName = 'foo';
    o.labels = buildUnnamed4680();
    o.launchStage = 'foo';
    o.metadata = buildMetricDescriptorMetadata();
    o.metricKind = 'foo';
    o.monitoredResourceTypes = buildUnnamed4681();
    o.name = 'foo';
    o.type = 'foo';
    o.unit = 'foo';
    o.valueType = 'foo';
...
void checkMetricDescriptor(api.MetricDescriptor o) {
  ...
  if (buildCounterMetricDescriptor < 3) {
    ...
    checkUnnamed4681(o.monitoredResourceTypes!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
api.MetricRule buildMetricRule() {
  ...
  if (buildCounterMetricRule < 3) {
    o.metricCosts = buildUnnamed4682();
    o.selector = 'foo';
  }
  buildCounterMetricRule--;
  return o;
...
void checkMetricRule(api.MetricRule o) {
  buildCounterMetricRule++;
  if (buildCounterMetricRule < 3) {
    checkUnnamed4682(o.metricCosts!);
    unittest.expect(
      o.selector!,
      unittest.equals('foo'),
    );
...
core.List<api.LabelDescriptor> buildUnnamed4683() => [
      buildLabelDescriptor(),
      buildLabelDescriptor(),
    ];

void checkUnnamed4683(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelDescriptor(o[0]);
  checkLabelDescriptor(o[1]);
}
...
core.List<api.MonitoringDestination> buildUnnamed4684() => [
      buildMonitoringDestination(),
      buildMonitoringDestination(),
    ];

void checkUnnamed4684(core.List<api.MonitoringDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMonitoringDestination(o[0]);
  checkMonitoringDestination(o[1]);
}

core.List<api.MonitoringDestination> buildUnnamed4685() => [
      buildMonitoringDestination(),
      buildMonitoringDestination(),
    ];

void checkUnnamed4685(core.List<api.MonitoringDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMonitoringDestination(o[0]);
  checkMonitoringDestination(o[1]);
}
...
api.Monitoring buildMonitoring() {
  ...
  if (buildCounterMonitoring < 3) {
    o.consumerDestinations = buildUnnamed4684();
    o.producerDestinations = buildUnnamed4685();
  }
  buildCounterMonitoring--;
  return o;
}
...
void checkMonitoring(api.Monitoring o) {
  buildCounterMonitoring++;
  if (buildCounterMonitoring < 3) {
    checkUnnamed4684(o.consumerDestinations!);
    checkUnnamed4685(o.producerDestinations!);
  }
  buildCounterMonitoring--;
}
...
core.Map<core.String, core.Object> buildUnnamed4687() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed4687(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed4688() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed4688(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed4687();
    o.name = 'foo';
    o.response = buildUnnamed4688();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error!);
    checkUnnamed4687(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed4688(o.response!);
  }
  buildCounterOperation--;
}

core.Map<core.String, core.Object> buildUnnamed4689() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed4689(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkOption(api.Option o) {
  ...
  if (buildCounterOption < 3) {
    ...
    checkUnnamed4689(o.value!);
  }
  buildCounterOption--;
}

core.List<api.Page> buildUnnamed4690() => [
      buildPage(),
      buildPage(),
    ];

void checkUnnamed4690(core.List<api.Page> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPage(o[0]);
  checkPage(o[1]);
}
...
core.List<api.QuotaLimit> buildUnnamed4692() => [
      buildQuotaLimit(),
      buildQuotaLimit(),
    ];

void checkUnnamed4692(core.List<api.QuotaLimit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQuotaLimit(o[0]);
  checkQuotaLimit(o[1]);
}

core.List<api.MetricRule> buildUnnamed4693() => [
      buildMetricRule(),
      buildMetricRule(),
    ];

void checkUnnamed4693(core.List<api.MetricRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetricRule(o[0]);
  checkMetricRule(o[1]);
}
...
api.Quota buildQuota() {
  ...
  if (buildCounterQuota < 3) {
    o.limits = buildUnnamed4692();
    o.metricRules = buildUnnamed4693();
  }
  buildCounterQuota--;
  return o;
}
...
void checkQuota(api.Quota o) {
  buildCounterQuota++;
  if (buildCounterQuota < 3) {
    checkUnnamed4692(o.limits!);
    checkUnnamed4693(o.metricRules!);
  }
  buildCounterQuota--;
}

core.Map<core.String, core.String> buildUnnamed4694() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed4694(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.TenancyUnit> buildUnnamed4695() => [
      buildTenancyUnit(),
      buildTenancyUnit(),
    ];

void checkUnnamed4695(core.List<api.TenancyUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTenancyUnit(o[0]);
  checkTenancyUnit(o[1]);
}
...
api.SearchTenancyUnitsResponse buildSearchTenancyUnitsResponse() {
  ...
  if (buildCounterSearchTenancyUnitsResponse < 3) {
    o.nextPageToken = 'foo';
    o.tenancyUnits = buildUnnamed4695();
  }
  buildCounterSearchTenancyUnitsResponse--;
  return o;
}
...
void checkSearchTenancyUnitsResponse(api.SearchTenancyUnitsResponse o) {
  ...
  if (buildCounterSearchTenancyUnitsResponse < 3) {
    ...
    checkUnnamed4695(o.tenancyUnits!);
  }
  buildCounterSearchTenancyUnitsResponse--;
}

core.List<api.Api> buildUnnamed4696() => [
      buildApi(),
      buildApi(),
    ];

void checkUnnamed4696(core.List<api.Api> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApi(o[0]);
  checkApi(o[1]);
}

core.List<api.Endpoint> buildUnnamed4697() => [
      buildEndpoint(),
      buildEndpoint(),
    ];

void checkUnnamed4697(core.List<api.Endpoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEndpoint(o[0]);
  checkEndpoint(o[1]);
}

core.List<api.Enum> buildUnnamed4698() => [
      buildEnum(),
      buildEnum(),
    ];

void checkUnnamed4698(core.List<api.Enum> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEnum(o[0]);
  checkEnum(o[1]);
}

core.List<api.LogDescriptor> buildUnnamed4699() => [
      buildLogDescriptor(),
      buildLogDescriptor(),
    ];

void checkUnnamed4699(core.List<api.LogDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogDescriptor(o[0]);
  checkLogDescriptor(o[1]);
}

core.List<api.MetricDescriptor> buildUnnamed4700() => [
      buildMetricDescriptor(),
      buildMetricDescriptor(),
    ];

void checkUnnamed4700(core.List<api.MetricDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetricDescriptor(o[0]);
  checkMetricDescriptor(o[1]);
}

core.List<api.MonitoredResourceDescriptor> buildUnnamed4701() => [
      buildMonitoredResourceDescriptor(),
      buildMonitoredResourceDescriptor(),
    ];

void checkUnnamed4701(core.List<api.MonitoredResourceDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMonitoredResourceDescriptor(o[0]);
  checkMonitoredResourceDescriptor(o[1]);
}

core.List<api.Type> buildUnnamed4702() => [
      buildType(),
      buildType(),
    ];

void checkUnnamed4702(core.List<api.Type> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkType(o[0]);
  checkType(o[1]);
}

core.List<api.Type> buildUnnamed4703() => [
      buildType(),
      buildType(),
    ];

void checkUnnamed4703(core.List<api.Type> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkType(o[0]);
  checkType(o[1]);
}
...
api.Service buildService() {
  ...
  if (buildCounterService < 3) {
    ...
    o.endpoints = buildUnnamed4697();
    o.enums = buildUnnamed4698();
    o.http = buildHttp();
    o.id = 'foo';
    o.logging = buildLogging();
    o.logs = buildUnnamed4699();
    o.metrics = buildUnnamed4700();
    o.monitoredResources = buildUnnamed4701();
    ...
    o.systemTypes = buildUnnamed4702();
    o.title = 'foo';
    o.types = buildUnnamed4703();
    o.usage = buildUsage();
  }
  buildCounterService--;
  return o;
...
void checkService(api.Service o) {
  ...
  if (buildCounterService < 3) {
    ...
    checkUnnamed4697(o.endpoints!);
    checkUnnamed4698(o.enums!);
    checkHttp(o.http!);
    unittest.expect(
      o.id!,
      unittest.equals('foo'),
    ...
    checkUnnamed4699(o.logs!);
    checkUnnamed4700(o.metrics!);
    checkUnnamed4701(o.monitoredResources!);
    ...
    checkUnnamed4702(o.systemTypes!);
    unittest.expect(
      o.title!,
      unittest.equals('foo'),
    );
    checkUnnamed4703(o.types!);
    checkUsage(o.usage!);
  }
  buildCounterService--;
}
...
api.ServiceAccountConfig buildServiceAccountConfig() {
  ...
  if (buildCounterServiceAccountConfig < 3) {
    o.accountId = 'foo';
    o.tenantProjectRoles = buildUnnamed4704();
  }
  buildCounterServiceAccountConfig--;
  return o;
}
...
void checkServiceAccountConfig(api.ServiceAccountConfig o) {
  ...
  if (buildCounterServiceAccountConfig < 3) {
    ...
    checkUnnamed4704(o.tenantProjectRoles!);
  }
  buildCounterServiceAccountConfig--;
}
...
core.Map<core.String, core.Object> buildUnnamed4705() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed4705(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed4706() => [
      buildUnnamed4705(),
      buildUnnamed4705(),
    ];

void checkUnnamed4706(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed4705(o[0]);
  checkUnnamed4705(o[1]);
}
...
api.SourceInfo buildSourceInfo() {
  ...
  if (buildCounterSourceInfo < 3) {
    o.sourceFiles = buildUnnamed4706();
  }
  buildCounterSourceInfo--;
  return o;
}
...
void checkSourceInfo(api.SourceInfo o) {
  buildCounterSourceInfo++;
  if (buildCounterSourceInfo < 3) {
    checkUnnamed4706(o.sourceFiles!);
  }
  buildCounterSourceInfo--;
}

core.Map<core.String, core.Object> buildUnnamed4707() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed4707(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed4708() => [
      buildUnnamed4707(),
      buildUnnamed4707(),
    ];

void checkUnnamed4708(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed4707(o[0]);
  checkUnnamed4707(o[1]);
}
...
core.List<api.SystemParameter> buildUnnamed4709() => [
      buildSystemParameter(),
      buildSystemParameter(),
    ];

void checkUnnamed4709(core.List<api.SystemParameter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.SystemParameterRule> buildUnnamed4710() => [
      buildSystemParameterRule(),
      buildSystemParameterRule(),
    ];

void checkUnnamed4710(core.List<api.SystemParameterRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.TenantResource> buildUnnamed4711() => [
      buildTenantResource(),
      buildTenantResource(),
    ];

void checkUnnamed4711(core.List<api.TenantResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TenancyUnit buildTenancyUnit() {
  ...
  if (buildCounterTenancyUnit < 3) {
    ...
    o.name = 'foo';
    o.service = 'foo';
    o.tenantResources = buildUnnamed4711();
  }
  buildCounterTenancyUnit--;
  return o;
}
...
void checkTenancyUnit(api.TenancyUnit o) {
  ...
  if (buildCounterTenancyUnit < 3) {
    ...
    checkUnnamed4711(o.tenantResources!);
  }
  buildCounterTenancyUnit--;
}

core.Map<core.String, core.String> buildUnnamed4712() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed4712(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
void checkTenantProjectConfig(api.TenantProjectConfig o) {
  ...
  if (buildCounterTenantProjectConfig < 3) {
    ...
    checkUnnamed4713(o.services!);
    checkTenantProjectPolicy(o.tenantProjectPolicy!);
  }
  buildCounterTenantProjectConfig--;
}

core.List<api.PolicyBinding> buildUnnamed4714() => [
      buildPolicyBinding(),
      buildPolicyBinding(),
    ];

void checkUnnamed4714(core.List<api.PolicyBinding> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TenantProjectPolicy buildTenantProjectPolicy() {
  ...
  if (buildCounterTenantProjectPolicy < 3) {
    o.policyBindings = buildUnnamed4714();
  }
  buildCounterTenantProjectPolicy--;
  return o;
}
...
void checkTenantProjectPolicy(api.TenantProjectPolicy o) {
  buildCounterTenantProjectPolicy++;
  if (buildCounterTenantProjectPolicy < 3) {
    checkUnnamed4714(o.policyBindings!);
  }
  buildCounterTenantProjectPolicy--;
}
...
core.List<api.Field> buildUnnamed4715() => [
      buildField(),
      buildField(),
    ];

void checkUnnamed4715(core.List<api.Field> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkField(o[0]);
  checkField(o[1]);
}
...
core.List<api.Option> buildUnnamed4717() => [
      buildOption(),
      buildOption(),
    ];

void checkUnnamed4717(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
api.Type buildType() {
  ...
  if (buildCounterType < 3) {
    o.fields = buildUnnamed4715();
    o.name = 'foo';
    o.oneofs = buildUnnamed4716();
    o.options = buildUnnamed4717();
    o.sourceContext = buildSourceContext();
    o.syntax = 'foo';
  }
  buildCounterType--;
...
void checkType(api.Type o) {
  buildCounterType++;
  if (buildCounterType < 3) {
    checkUnnamed4715(o.fields!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed4716(o.oneofs!);
    checkUnnamed4717(o.options!);
    checkSourceContext(o.sourceContext!);
    unittest.expect(
      o.syntax!,
      unittest.equals('foo'),
...
core.List<api.UsageRule> buildUnnamed4719() => [
      buildUsageRule(),
      buildUsageRule(),
    ];

void checkUnnamed4719(core.List<api.UsageRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUsageRule(o[0]);
  checkUsageRule(o[1]);
}
...
core.List<api.V1Beta1QuotaOverride> buildUnnamed4721() => [
      buildV1Beta1QuotaOverride(),
      buildV1Beta1QuotaOverride(),
    ];

void checkUnnamed4721(core.List<api.V1Beta1QuotaOverride> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.V1Beta1QuotaOverride> buildUnnamed4722() => [
      buildV1Beta1QuotaOverride(),
      buildV1Beta1QuotaOverride(),
    ];

void checkUnnamed4722(core.List<api.V1Beta1QuotaOverride> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkV1Beta1QuotaOverride(o[0]);
  checkV1Beta1QuotaOverride(o[1]);
}
...
void checkV1Beta1ImportProducerOverridesResponse(
  ...
  buildCounterV1Beta1ImportProducerOverridesResponse++;
  if (buildCounterV1Beta1ImportProducerOverridesResponse < 3) {
    checkUnnamed4722(o.overrides!);
  }
  buildCounterV1Beta1ImportProducerOverridesResponse--;
}

core.List<api.V1Beta1ProducerQuotaPolicy> buildUnnamed4723() => [
      buildV1Beta1ProducerQuotaPolicy(),
      buildV1Beta1ProducerQuotaPolicy(),
    ];

void checkUnnamed4723(core.List<api.V1Beta1ProducerQuotaPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkV1Beta1ImportProducerQuotaPoliciesResponse(
  ...
  buildCounterV1Beta1ImportProducerQuotaPoliciesResponse++;
  if (buildCounterV1Beta1ImportProducerQuotaPoliciesResponse < 3) {
    checkUnnamed4723(o.policies!);
  }
  buildCounterV1Beta1ImportProducerQuotaPoliciesResponse--;
}

core.Map<core.String, core.String> buildUnnamed4724() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed4724(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.Map<core.String, core.String> buildUnnamed4725() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed4725(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
