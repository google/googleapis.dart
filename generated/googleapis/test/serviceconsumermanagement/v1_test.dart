...
core.List<api.Method> buildUnnamed3924() {
  var o = <api.Method>[];
  o.add(buildMethod());
  o.add(buildMethod());
  return o;
...
void checkUnnamed3924(core.List<api.Method> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMethod(o[0] as api.Method);
  checkMethod(o[1] as api.Method);
}

core.List<api.Mixin> buildUnnamed3925() {
  var o = <api.Mixin>[];
  o.add(buildMixin());
  o.add(buildMixin());
  return o;
...
void checkUnnamed3925(core.List<api.Mixin> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMixin(o[0] as api.Mixin);
  checkMixin(o[1] as api.Mixin);
}

core.List<api.Option> buildUnnamed3926() {
  var o = <api.Option>[];
  o.add(buildOption());
  o.add(buildOption());
  return o;
...
void checkUnnamed3926(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Api buildApi() {
  ...
  if (buildCounterApi < 3) {
    o.methods = buildUnnamed3924();
    o.mixins = buildUnnamed3925();
    o.name = 'foo';
    o.options = buildUnnamed3926();
...
void checkApi(api.Api o) {
  buildCounterApi++;
  if (buildCounterApi < 3) {
    checkUnnamed3924(o.methods);
    checkUnnamed3925(o.mixins);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed3926(o.options);
...
core.List<api.JwtLocation> buildUnnamed3927() {
...
void checkUnnamed3927(core.List<api.JwtLocation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AuthProvider buildAuthProvider() {
  ...
  if (buildCounterAuthProvider < 3) {
    ...
    o.issuer = 'foo';
    o.jwksUri = 'foo';
    o.jwtLocations = buildUnnamed3927();
  }
  buildCounterAuthProvider--;
  return o;
}
...
void checkAuthProvider(api.AuthProvider o) {
  ...
  if (buildCounterAuthProvider < 3) {
    ...
    checkUnnamed3927(o.jwtLocations);
  }
  buildCounterAuthProvider--;
}
...
core.List<api.AuthProvider> buildUnnamed3928() {
  var o = <api.AuthProvider>[];
...
void checkUnnamed3928(core.List<api.AuthProvider> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAuthProvider(o[0] as api.AuthProvider);
  checkAuthProvider(o[1] as api.AuthProvider);
}

core.List<api.AuthenticationRule> buildUnnamed3929() {
...
void checkUnnamed3929(core.List<api.AuthenticationRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Authentication buildAuthentication() {
  ...
  if (buildCounterAuthentication < 3) {
    o.providers = buildUnnamed3928();
    o.rules = buildUnnamed3929();
  }
  buildCounterAuthentication--;
  return o;
}
...
void checkAuthentication(api.Authentication o) {
  buildCounterAuthentication++;
  if (buildCounterAuthentication < 3) {
    checkUnnamed3928(o.providers);
    checkUnnamed3929(o.rules);
  }
  buildCounterAuthentication--;
}

core.List<api.AuthRequirement> buildUnnamed3930() {
  var o = <api.AuthRequirement>[];
...
void checkUnnamed3930(core.List<api.AuthRequirement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AuthenticationRule buildAuthenticationRule() {
  ...
  if (buildCounterAuthenticationRule < 3) {
    ...
    o.requirements = buildUnnamed3930();
    o.selector = 'foo';
  }
  buildCounterAuthenticationRule--;
  return o;
...
void checkAuthenticationRule(api.AuthenticationRule o) {
  ...
  if (buildCounterAuthenticationRule < 3) {
    ...
    checkUnnamed3930(o.requirements);
    unittest.expect(o.selector, unittest.equals('foo'));
  }
  buildCounterAuthenticationRule--;
}

core.List<api.BackendRule> buildUnnamed3931() {
...
void checkUnnamed3931(core.List<api.BackendRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.BillingDestination> buildUnnamed3932() {
...
void checkUnnamed3932(core.List<api.BillingDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Billing buildBilling() {
  ...
  if (buildCounterBilling < 3) {
    o.consumerDestinations = buildUnnamed3932();
  }
  buildCounterBilling--;
  return o;
}
...
void checkBilling(api.Billing o) {
  buildCounterBilling++;
  if (buildCounterBilling < 3) {
    checkUnnamed3932(o.consumerDestinations);
  }
  buildCounterBilling--;
}
...
core.List<api.ContextRule> buildUnnamed3934() {
...
void checkUnnamed3934(core.List<api.ContextRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ContextRule buildContextRule() {
  ...
  if (buildCounterContextRule < 3) {
    o.allowedRequestExtensions = buildUnnamed3935();
    o.allowedResponseExtensions = buildUnnamed3936();
    o.provided = buildUnnamed3937();
    o.requested = buildUnnamed3938();
    o.selector = 'foo';
  }
  buildCounterContextRule--;
  return o;
...
void checkContextRule(api.ContextRule o) {
  buildCounterContextRule++;
  if (buildCounterContextRule < 3) {
    checkUnnamed3935(o.allowedRequestExtensions);
    checkUnnamed3936(o.allowedResponseExtensions);
    checkUnnamed3937(o.provided);
    checkUnnamed3938(o.requested);
    unittest.expect(o.selector, unittest.equals('foo'));
  }
  buildCounterContextRule--;
}
...
core.List<api.CustomErrorRule> buildUnnamed3939() {
...
void checkUnnamed3940(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
core.List<api.Page> buildUnnamed3941() {
  var o = <api.Page>[];
  o.add(buildPage());
  o.add(buildPage());
  return o;
...
void checkUnnamed3941(core.List<api.Page> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPage(o[0] as api.Page);
  checkPage(o[1] as api.Page);
}

core.List<api.DocumentationRule> buildUnnamed3942() {
...
void checkUnnamed3942(core.List<api.DocumentationRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Documentation buildDocumentation() {
  ...
  if (buildCounterDocumentation < 3) {
    ...
    o.overview = 'foo';
    o.pages = buildUnnamed3941();
    o.rules = buildUnnamed3942();
...
void checkDocumentation(api.Documentation o) {
  ...
  if (buildCounterDocumentation < 3) {
    ...
    checkUnnamed3941(o.pages);
    checkUnnamed3942(o.rules);
...
core.List<api.EnumValue> buildUnnamed3944() {
  var o = <api.EnumValue>[];
...
void checkUnnamed3944(core.List<api.EnumValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEnumValue(o[0] as api.EnumValue);
  checkEnumValue(o[1] as api.EnumValue);
}

core.List<api.Option> buildUnnamed3945() {
  var o = <api.Option>[];
  o.add(buildOption());
  o.add(buildOption());
  return o;
...
void checkUnnamed3945(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0] as api.Option);
  checkOption(o[1] as api.Option);
}
...
api.Enum buildEnum() {
  ...
  if (buildCounterEnum < 3) {
    o.enumvalue = buildUnnamed3944();
    o.name = 'foo';
    o.options = buildUnnamed3945();
    o.sourceContext = buildSourceContext();
    o.syntax = 'foo';
  }
  buildCounterEnum--;
...
void checkEnum(api.Enum o) {
  buildCounterEnum++;
  if (buildCounterEnum < 3) {
    checkUnnamed3944(o.enumvalue);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed3945(o.options);
    checkSourceContext(o.sourceContext as api.SourceContext);
    unittest.expect(o.syntax, unittest.equals('foo'));
  }
  buildCounterEnum--;
...
core.List<api.Option> buildUnnamed3946() {
  var o = <api.Option>[];
  o.add(buildOption());
  o.add(buildOption());
  return o;
...
void checkUnnamed3946(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0] as api.Option);
  checkOption(o[1] as api.Option);
}
...
void checkEnumValue(api.EnumValue o) {
  ...
  if (buildCounterEnumValue < 3) {
    ...
    checkUnnamed3946(o.options);
  }
  buildCounterEnumValue--;
}

core.List<api.Option> buildUnnamed3947() {
  var o = <api.Option>[];
  o.add(buildOption());
  o.add(buildOption());
  return o;
...
void checkUnnamed3947(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0] as api.Option);
  checkOption(o[1] as api.Option);
}
...
core.List<api.HttpRule> buildUnnamed3948() {
  var o = <api.HttpRule>[];
  o.add(buildHttpRule());
  o.add(buildHttpRule());
  return o;
...
void checkUnnamed3948(core.List<api.HttpRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.HttpRule> buildUnnamed3949() {
  var o = <api.HttpRule>[];
  o.add(buildHttpRule());
  o.add(buildHttpRule());
  return o;
...
void checkUnnamed3949(core.List<api.HttpRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHttpRule(o[0] as api.HttpRule);
  checkHttpRule(o[1] as api.HttpRule);
}
...
api.HttpRule buildHttpRule() {
  ...
  if (buildCounterHttpRule < 3) {
    o.additionalBindings = buildUnnamed3949();
    o.body = 'foo';
...
void checkHttpRule(api.HttpRule o) {
  buildCounterHttpRule++;
  if (buildCounterHttpRule < 3) {
    checkUnnamed3949(o.additionalBindings);
...
core.List<api.Operation> buildUnnamed3950() {
  var o = <api.Operation>[];
...
void checkUnnamed3950(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListOperationsResponse(api.ListOperationsResponse o) {
  ...
  if (buildCounterListOperationsResponse < 3) {
    ...
    checkUnnamed3950(o.operations);
  }
  buildCounterListOperationsResponse--;
}

core.List<api.TenancyUnit> buildUnnamed3951() {
...
void checkUnnamed3951(core.List<api.TenancyUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListTenancyUnitsResponse buildListTenancyUnitsResponse() {
  ...
  if (buildCounterListTenancyUnitsResponse < 3) {
    o.nextPageToken = 'foo';
    o.tenancyUnits = buildUnnamed3951();
  }
  buildCounterListTenancyUnitsResponse--;
  return o;
}
...
void checkListTenancyUnitsResponse(api.ListTenancyUnitsResponse o) {
  ...
  if (buildCounterListTenancyUnitsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed3951(o.tenancyUnits);
  }
  buildCounterListTenancyUnitsResponse--;
}

core.List<api.LabelDescriptor> buildUnnamed3952() {
  var o = <api.LabelDescriptor>[];
...
void checkUnnamed3952(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.LoggingDestination> buildUnnamed3953() {
...
void checkUnnamed3954(core.List<api.LoggingDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLoggingDestination(o[0] as api.LoggingDestination);
  checkLoggingDestination(o[1] as api.LoggingDestination);
}
...
api.Logging buildLogging() {
  ...
  if (buildCounterLogging < 3) {
    o.consumerDestinations = buildUnnamed3953();
    o.producerDestinations = buildUnnamed3954();
  }
  buildCounterLogging--;
  return o;
}
...
void checkLogging(api.Logging o) {
  buildCounterLogging++;
  if (buildCounterLogging < 3) {
    checkUnnamed3953(o.consumerDestinations);
    checkUnnamed3954(o.producerDestinations);
  }
  buildCounterLogging--;
}
...
void checkLoggingDestination(api.LoggingDestination o) {
  buildCounterLoggingDestination++;
  if (buildCounterLoggingDestination < 3) {
    checkUnnamed3955(o.logs);
    unittest.expect(o.monitoredResource, unittest.equals('foo'));
  }
  buildCounterLoggingDestination--;
}

core.List<api.Option> buildUnnamed3956() {
  var o = <api.Option>[];
  o.add(buildOption());
  o.add(buildOption());
  return o;
...
void checkUnnamed3956(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0] as api.Option);
  checkOption(o[1] as api.Option);
}
...
core.List<api.LabelDescriptor> buildUnnamed3957() {
  var o = <api.LabelDescriptor>[];
  o.add(buildLabelDescriptor());
  o.add(buildLabelDescriptor());
  return o;
...
void checkUnnamed3957(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelDescriptor(o[0] as api.LabelDescriptor);
  checkLabelDescriptor(o[1] as api.LabelDescriptor);
}
...
api.MetricDescriptor buildMetricDescriptor() {
  ...
  if (buildCounterMetricDescriptor < 3) {
    ...
    o.metricKind = 'foo';
    o.monitoredResourceTypes = buildUnnamed3958();
    o.name = 'foo';
    o.type = 'foo';
    o.unit = 'foo';
    o.valueType = 'foo';
...
void checkMetricDescriptor(api.MetricDescriptor o) {
  ...
  if (buildCounterMetricDescriptor < 3) {
    ...
    checkUnnamed3958(o.monitoredResourceTypes);
    unittest.expect(o.name, unittest.equals('foo'));
...
api.MetricRule buildMetricRule() {
  ...
  if (buildCounterMetricRule < 3) {
    o.metricCosts = buildUnnamed3959();
    o.selector = 'foo';
  }
  buildCounterMetricRule--;
  return o;
...
void checkMetricRule(api.MetricRule o) {
  buildCounterMetricRule++;
  if (buildCounterMetricRule < 3) {
    checkUnnamed3959(o.metricCosts);
    unittest.expect(o.selector, unittest.equals('foo'));
  }
  buildCounterMetricRule--;
}
...
core.List<api.LabelDescriptor> buildUnnamed3960() {
  var o = <api.LabelDescriptor>[];
  o.add(buildLabelDescriptor());
  o.add(buildLabelDescriptor());
  return o;
...
void checkUnnamed3960(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelDescriptor(o[0] as api.LabelDescriptor);
  checkLabelDescriptor(o[1] as api.LabelDescriptor);
}
...
core.List<api.MonitoringDestination> buildUnnamed3961() {
...
void checkUnnamed3962(core.List<api.MonitoringDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMonitoringDestination(o[0] as api.MonitoringDestination);
  checkMonitoringDestination(o[1] as api.MonitoringDestination);
}
...
api.Monitoring buildMonitoring() {
  ...
  if (buildCounterMonitoring < 3) {
    o.consumerDestinations = buildUnnamed3961();
    o.producerDestinations = buildUnnamed3962();
  }
  buildCounterMonitoring--;
  return o;
}
...
void checkMonitoring(api.Monitoring o) {
  buildCounterMonitoring++;
  if (buildCounterMonitoring < 3) {
    checkUnnamed3961(o.consumerDestinations);
    checkUnnamed3962(o.producerDestinations);
  }
  buildCounterMonitoring--;
}
...
core.List<api.Page> buildUnnamed3967() {
  var o = <api.Page>[];
  o.add(buildPage());
  o.add(buildPage());
  return o;
...
void checkUnnamed3967(core.List<api.Page> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPage(o[0] as api.Page);
  checkPage(o[1] as api.Page);
}
...
void checkPolicyBinding(api.PolicyBinding o) {
  buildCounterPolicyBinding++;
  if (buildCounterPolicyBinding < 3) {
    checkUnnamed3968(o.members);
    unittest.expect(o.role, unittest.equals('foo'));
  }
  buildCounterPolicyBinding--;
}

core.List<api.QuotaLimit> buildUnnamed3969() {
...
void checkUnnamed3969(core.List<api.QuotaLimit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQuotaLimit(o[0] as api.QuotaLimit);
  checkQuotaLimit(o[1] as api.QuotaLimit);
}

core.List<api.MetricRule> buildUnnamed3970() {
  var o = <api.MetricRule>[];
...
void checkUnnamed3970(core.List<api.MetricRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Quota buildQuota() {
  ...
  if (buildCounterQuota < 3) {
    o.limits = buildUnnamed3969();
    o.metricRules = buildUnnamed3970();
  }
  buildCounterQuota--;
  return o;
}
...
void checkQuota(api.Quota o) {
  buildCounterQuota++;
  if (buildCounterQuota < 3) {
    checkUnnamed3969(o.limits);
    checkUnnamed3970(o.metricRules);
  }
  buildCounterQuota--;
}
...
core.List<api.TenancyUnit> buildUnnamed3972() {
  var o = <api.TenancyUnit>[];
  o.add(buildTenancyUnit());
  o.add(buildTenancyUnit());
  return o;
...
void checkUnnamed3972(core.List<api.TenancyUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTenancyUnit(o[0] as api.TenancyUnit);
  checkTenancyUnit(o[1] as api.TenancyUnit);
}
...
api.SearchTenancyUnitsResponse buildSearchTenancyUnitsResponse() {
  ...
  if (buildCounterSearchTenancyUnitsResponse < 3) {
    o.nextPageToken = 'foo';
    o.tenancyUnits = buildUnnamed3972();
  }
  buildCounterSearchTenancyUnitsResponse--;
  return o;
}
...
void checkSearchTenancyUnitsResponse(api.SearchTenancyUnitsResponse o) {
  ...
  if (buildCounterSearchTenancyUnitsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed3972(o.tenancyUnits);
  }
  buildCounterSearchTenancyUnitsResponse--;
}

core.List<api.Api> buildUnnamed3973() {
  var o = <api.Api>[];
  o.add(buildApi());
  o.add(buildApi());
  return o;
...
void checkUnnamed3973(core.List<api.Api> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApi(o[0] as api.Api);
  checkApi(o[1] as api.Api);
}

core.List<api.Endpoint> buildUnnamed3974() {
  var o = <api.Endpoint>[];
  o.add(buildEndpoint());
  o.add(buildEndpoint());
  return o;
...
void checkUnnamed3974(core.List<api.Endpoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEndpoint(o[0] as api.Endpoint);
  checkEndpoint(o[1] as api.Endpoint);
}

core.List<api.Enum> buildUnnamed3975() {
  var o = <api.Enum>[];
  o.add(buildEnum());
  o.add(buildEnum());
  return o;
...
void checkUnnamed3975(core.List<api.Enum> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEnum(o[0] as api.Enum);
  checkEnum(o[1] as api.Enum);
}

core.List<api.LogDescriptor> buildUnnamed3976() {
  var o = <api.LogDescriptor>[];
...
void checkUnnamed3976(core.List<api.LogDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogDescriptor(o[0] as api.LogDescriptor);
  checkLogDescriptor(o[1] as api.LogDescriptor);
}

core.List<api.MetricDescriptor> buildUnnamed3977() {
  var o = <api.MetricDescriptor>[];
...
void checkUnnamed3977(core.List<api.MetricDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetricDescriptor(o[0] as api.MetricDescriptor);
  checkMetricDescriptor(o[1] as api.MetricDescriptor);
}

core.List<api.MonitoredResourceDescriptor> buildUnnamed3978() {
  var o = <api.MonitoredResourceDescriptor>[];
...
void checkUnnamed3978(core.List<api.MonitoredResourceDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Type> buildUnnamed3979() {
  var o = <api.Type>[];
  o.add(buildType());
  o.add(buildType());
  return o;
...
void checkUnnamed3979(core.List<api.Type> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkType(o[0] as api.Type);
  checkType(o[1] as api.Type);
}

core.List<api.Type> buildUnnamed3980() {
  var o = <api.Type>[];
  o.add(buildType());
  o.add(buildType());
  return o;
...
void checkUnnamed3980(core.List<api.Type> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkType(o[0] as api.Type);
  checkType(o[1] as api.Type);
}
...
api.Service buildService() {
  ...
  if (buildCounterService < 3) {
    ...
    o.endpoints = buildUnnamed3974();
    o.enums = buildUnnamed3975();
    o.http = buildHttp();
    o.id = 'foo';
    o.logging = buildLogging();
    o.logs = buildUnnamed3976();
    o.metrics = buildUnnamed3977();
    o.monitoredResources = buildUnnamed3978();
    ...
    o.systemTypes = buildUnnamed3979();
    o.title = 'foo';
    o.types = buildUnnamed3980();
    o.usage = buildUsage();
  }
  buildCounterService--;
  return o;
...
void checkService(api.Service o) {
  ...
  if (buildCounterService < 3) {
    ...
    checkUnnamed3974(o.endpoints);
    checkUnnamed3975(o.enums);
    checkHttp(o.http as api.Http);
    unittest.expect(o.id, unittest.equals('foo'));
    checkLogging(o.logging as api.Logging);
    checkUnnamed3976(o.logs);
    checkUnnamed3977(o.metrics);
    checkUnnamed3978(o.monitoredResources);
    ...
    checkUnnamed3979(o.systemTypes);
    unittest.expect(o.title, unittest.equals('foo'));
    checkUnnamed3980(o.types);
...
api.ServiceAccountConfig buildServiceAccountConfig() {
  ...
  if (buildCounterServiceAccountConfig < 3) {
    o.accountId = 'foo';
    o.tenantProjectRoles = buildUnnamed3981();
  }
  buildCounterServiceAccountConfig--;
  return o;
}
...
void checkServiceAccountConfig(api.ServiceAccountConfig o) {
  ...
  if (buildCounterServiceAccountConfig < 3) {
    ...
    checkUnnamed3981(o.tenantProjectRoles);
  }
  buildCounterServiceAccountConfig--;
}
...
core.List<core.Map<core.String, core.Object>> buildUnnamed3983() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed3982());
  o.add(buildUnnamed3982());
  return o;
}

void checkUnnamed3983(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed3982(o[0]);
  checkUnnamed3982(o[1]);
}
...
api.SourceInfo buildSourceInfo() {
  ...
  if (buildCounterSourceInfo < 3) {
    o.sourceFiles = buildUnnamed3983();
  }
  buildCounterSourceInfo--;
  return o;
}
...
void checkSourceInfo(api.SourceInfo o) {
  buildCounterSourceInfo++;
  if (buildCounterSourceInfo < 3) {
    checkUnnamed3983(o.sourceFiles);
  }
  buildCounterSourceInfo--;
}
...
core.List<core.Map<core.String, core.Object>> buildUnnamed3985() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed3984());
  o.add(buildUnnamed3984());
  return o;
}

void checkUnnamed3985(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed3984(o[0]);
  checkUnnamed3984(o[1]);
}
...
core.List<api.SystemParameter> buildUnnamed3986() {
  var o = <api.SystemParameter>[];
...
void checkUnnamed3986(core.List<api.SystemParameter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkSystemParameterRule(api.SystemParameterRule o) {
  buildCounterSystemParameterRule++;
  if (buildCounterSystemParameterRule < 3) {
    checkUnnamed3986(o.parameters);
    unittest.expect(o.selector, unittest.equals('foo'));
  }
  buildCounterSystemParameterRule--;
}

core.List<api.SystemParameterRule> buildUnnamed3987() {
  var o = <api.SystemParameterRule>[];
...
void checkUnnamed3987(core.List<api.SystemParameterRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkSystemParameters(api.SystemParameters o) {
  buildCounterSystemParameters++;
  if (buildCounterSystemParameters < 3) {
    checkUnnamed3987(o.rules);
  }
  buildCounterSystemParameters--;
}

core.List<api.TenantResource> buildUnnamed3988() {
...
void checkUnnamed3988(core.List<api.TenantResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TenancyUnit buildTenancyUnit() {
  ...
  if (buildCounterTenancyUnit < 3) {
    ...
    o.name = 'foo';
    o.service = 'foo';
    o.tenantResources = buildUnnamed3988();
  }
  buildCounterTenancyUnit--;
  return o;
}
...
void checkTenancyUnit(api.TenancyUnit o) {
  ...
  if (buildCounterTenancyUnit < 3) {
    ...
    checkUnnamed3988(o.tenantResources);
  }
  buildCounterTenancyUnit--;
}
...
api.TenantProjectConfig buildTenantProjectConfig() {
  ...
  if (buildCounterTenantProjectConfig < 3) {
    ...
    o.folder = 'foo';
    o.labels = buildUnnamed3989();
    o.serviceAccountConfig = buildServiceAccountConfig();
    o.services = buildUnnamed3990();
...
void checkUnnamed3991(core.List<api.PolicyBinding> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TenantProjectPolicy buildTenantProjectPolicy() {
  ...
  if (buildCounterTenantProjectPolicy < 3) {
    o.policyBindings = buildUnnamed3991();
  }
  buildCounterTenantProjectPolicy--;
  return o;
}
...
void checkTenantProjectPolicy(api.TenantProjectPolicy o) {
  buildCounterTenantProjectPolicy++;
  if (buildCounterTenantProjectPolicy < 3) {
    checkUnnamed3991(o.policyBindings);
  }
  buildCounterTenantProjectPolicy--;
}
...
core.List<api.Field> buildUnnamed3992() {
  var o = <api.Field>[];
  o.add(buildField());
  o.add(buildField());
  return o;
...
void checkUnnamed3992(core.List<api.Field> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Option> buildUnnamed3994() {
  var o = <api.Option>[];
  o.add(buildOption());
  o.add(buildOption());
  return o;
...
void checkUnnamed3994(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0] as api.Option);
  checkOption(o[1] as api.Option);
}
...
api.Type buildType() {
  ...
  if (buildCounterType < 3) {
    o.fields = buildUnnamed3992();
    o.name = 'foo';
    o.oneofs = buildUnnamed3993();
    o.options = buildUnnamed3994();
    o.sourceContext = buildSourceContext();
    o.syntax = 'foo';
  }
  buildCounterType--;
...
void checkType(api.Type o) {
  buildCounterType++;
  if (buildCounterType < 3) {
    checkUnnamed3992(o.fields);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed3993(o.oneofs);
    checkUnnamed3994(o.options);
    checkSourceContext(o.sourceContext as api.SourceContext);
    unittest.expect(o.syntax, unittest.equals('foo'));
  }
  buildCounterType--;
...
core.List<api.UsageRule> buildUnnamed3996() {
  var o = <api.UsageRule>[];
...
void checkUnnamed3996(core.List<api.UsageRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Usage buildUsage() {
  ...
  if (buildCounterUsage < 3) {
    ...
    o.requirements = buildUnnamed3995();
    o.rules = buildUnnamed3996();
  }
  buildCounterUsage--;
  return o;
}
...
void checkUsage(api.Usage o) {
  ...
  if (buildCounterUsage < 3) {
    ...
    checkUnnamed3995(o.requirements);
    checkUnnamed3996(o.rules);
  }
  buildCounterUsage--;
}
...
void checkV1AddVisibilityLabelsResponse(api.V1AddVisibilityLabelsResponse o) {
  buildCounterV1AddVisibilityLabelsResponse++;
  if (buildCounterV1AddVisibilityLabelsResponse < 3) {
    checkUnnamed3997(o.labels);
  }
  buildCounterV1AddVisibilityLabelsResponse--;
}

core.List<api.V1Beta1QuotaOverride> buildUnnamed3998() {
...
void checkUnnamed3998(core.List<api.V1Beta1QuotaOverride> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.V1Beta1QuotaOverride> buildUnnamed3999() {
  var o = <api.V1Beta1QuotaOverride>[];
  o.add(buildV1Beta1QuotaOverride());
  o.add(buildV1Beta1QuotaOverride());
  return o;
...
void checkUnnamed3999(core.List<api.V1Beta1QuotaOverride> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkV1Beta1QuotaOverride(o[0] as api.V1Beta1QuotaOverride);
  checkV1Beta1QuotaOverride(o[1] as api.V1Beta1QuotaOverride);
}
...
void checkV1Beta1ImportProducerOverridesResponse(
  ...
  buildCounterV1Beta1ImportProducerOverridesResponse++;
  if (buildCounterV1Beta1ImportProducerOverridesResponse < 3) {
    checkUnnamed3999(o.overrides);
  }
  buildCounterV1Beta1ImportProducerOverridesResponse--;
}

core.List<api.V1Beta1ProducerQuotaPolicy> buildUnnamed4000() {
...
void checkUnnamed4000(core.List<api.V1Beta1ProducerQuotaPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkV1Beta1ImportProducerQuotaPoliciesResponse(
  ...
  buildCounterV1Beta1ImportProducerQuotaPoliciesResponse++;
  if (buildCounterV1Beta1ImportProducerQuotaPoliciesResponse < 3) {
    checkUnnamed4000(o.policies);
  }
  buildCounterV1Beta1ImportProducerQuotaPoliciesResponse--;
}

core.Map<core.String, core.String> buildUnnamed4001() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed4001(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o['x'], unittest.equals('foo'));
  unittest.expect(o['y'], unittest.equals('foo'));
}
...
core.Map<core.String, core.String> buildUnnamed4002() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed4002(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o['x'], unittest.equals('foo'));
  unittest.expect(o['y'], unittest.equals('foo'));
}
