...
import 'package:googleapis/merchantapi/products_v1beta.dart' as api;
...
core.List<api.Certification> buildUnnamed2() => [
  buildCertification(),
  buildCertification(),
];

void checkUnnamed2(core.List<api.Certification> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCertification(o[0]);
  checkCertification(o[1]);
}

core.List<api.CloudExportAdditionalProperties> buildUnnamed3() => [
  buildCloudExportAdditionalProperties(),
  buildCloudExportAdditionalProperties(),
];

void checkUnnamed3(core.List<api.CloudExportAdditionalProperties> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.FreeShippingThreshold> buildUnnamed6() => [
  buildFreeShippingThreshold(),
  buildFreeShippingThreshold(),
];

void checkUnnamed6(core.List<api.FreeShippingThreshold> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.LoyaltyProgram> buildUnnamed11() => [
  buildLoyaltyProgram(),
  buildLoyaltyProgram(),
];

void checkUnnamed11(core.List<api.LoyaltyProgram> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLoyaltyProgram(o[0]);
  checkLoyaltyProgram(o[1]);
}

core.List<api.ProductDetail> buildUnnamed12() => [
  buildProductDetail(),
  buildProductDetail(),
];

void checkUnnamed12(core.List<api.ProductDetail> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Shipping> buildUnnamed16() => [buildShipping(), buildShipping()];

void checkUnnamed16(core.List<api.Shipping> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkShipping(o[0]);
  checkShipping(o[1]);
}
...
core.List<api.ProductSustainabilityIncentive> buildUnnamed19() => [
  buildProductSustainabilityIncentive(),
  buildProductSustainabilityIncentive(),
];

void checkUnnamed19(core.List<api.ProductSustainabilityIncentive> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProductSustainabilityIncentive(o[0]);
  checkProductSustainabilityIncentive(o[1]);
}

core.List<api.Tax> buildUnnamed20() => [buildTax(), buildTax()];

void checkUnnamed20(core.List<api.Tax> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTax(o[0]);
  checkTax(o[1]);
}
...
api.Attributes buildAttributes() {
  ...
  if (buildCounterAttributes < 3) {
    o.additionalImageLinks = buildUnnamed0();
    o.adsGrouping = 'foo';
    o.adsLabels = buildUnnamed1();
    o.adsRedirect = 'foo';
    o.adult = true;
    o.ageGroup = 'foo';
    ...
    o.brand = 'foo';
    o.canonicalLink = 'foo';
    o.certifications = buildUnnamed2();
    o.cloudExportAdditionalProperties = buildUnnamed3();
    o.color = 'foo';
    o.condition = 'foo';
    ...
    o.displayAdsSimilarIds = buildUnnamed4();
    o.displayAdsTitle = 'foo';
    o.displayAdsValue = 42.0;
    o.energyEfficiencyClass = 'foo';
    o.excludedDestinations = buildUnnamed5();
    o.expirationDate = 'foo';
    o.externalSellerId = 'foo';
    o.freeShippingThreshold = buildUnnamed6();
    o.gender = 'foo';
    o.googleProductCategory = 'foo';
    o.gtin = buildUnnamed7();
    o.gtins = buildUnnamed8();
    o.identifierExists = true;
    o.imageLink = 'foo';
    o.includedDestinations = buildUnnamed9();
    o.installment = buildInstallment();
    o.isBundle = true;
    o.itemGroupId = 'foo';
    o.lifestyleImageLinks = buildUnnamed10();
    o.link = 'foo';
    o.linkTemplate = 'foo';
    o.loyaltyPoints = buildLoyaltyPoints();
    o.loyaltyPrograms = buildUnnamed11();
    o.material = 'foo';
    ...
    o.shoppingAdsExcludedCountries = buildUnnamed17();
    o.size = 'foo';
    o.sizeSystem = 'foo';
    o.sizeTypes = buildUnnamed18();
    ...
    o.sustainabilityIncentives = buildUnnamed19();
    o.taxCategory = 'foo';
    o.taxes = buildUnnamed20();
    o.title = 'foo';
...
void checkAttributes(api.Attributes o) {
  buildCounterAttributes++;
  if (buildCounterAttributes < 3) {
    checkUnnamed0(o.additionalImageLinks!);
    unittest.expect(o.adsGrouping!, unittest.equals('foo'));
    checkUnnamed1(o.adsLabels!);
    ...
    checkUnnamed2(o.certifications!);
    checkUnnamed3(o.cloudExportAdditionalProperties!);
    ...
    checkUnnamed4(o.displayAdsSimilarIds!);
    ...
    checkUnnamed17(o.shoppingAdsExcludedCountries!);
    unittest.expect(o.size!, unittest.equals('foo'));
    unittest.expect(o.sizeSystem!, unittest.equals('foo'));
    checkUnnamed18(o.sizeTypes!);
    ...
    checkUnnamed19(o.sustainabilityIncentives!);
    unittest.expect(o.taxCategory!, unittest.equals('foo'));
    checkUnnamed20(o.taxes!);
...
core.List<core.double> buildUnnamed21() => [42.0, 42.0];
...
api.CloudExportAdditionalProperties buildCloudExportAdditionalProperties() {
  ...
  if (buildCounterCloudExportAdditionalProperties < 3) {
    o.boolValue = true;
    o.floatValue = buildUnnamed21();
    o.intValue = buildUnnamed22();
    o.maxValue = 42.0;
    o.minValue = 42.0;
    o.propertyName = 'foo';
    o.textValue = buildUnnamed23();
    o.unitCode = 'foo';
  }
  buildCounterCloudExportAdditionalProperties--;
  return o;
...
void checkCloudExportAdditionalProperties(
  ...
  if (buildCounterCloudExportAdditionalProperties < 3) {
    ...
    checkUnnamed21(o.floatValue!);
    checkUnnamed22(o.intValue!);
    unittest.expect(o.maxValue!, unittest.equals(42.0));
    unittest.expect(o.minValue!, unittest.equals(42.0));
    unittest.expect(o.propertyName!, unittest.equals('foo'));
    checkUnnamed23(o.textValue!);
    unittest.expect(o.unitCode!, unittest.equals('foo'));
  }
  buildCounterCloudExportAdditionalProperties--;
}

core.List<api.CustomAttribute> buildUnnamed24() => [
  buildCustomAttribute(),
  buildCustomAttribute(),
];

void checkUnnamed24(core.List<api.CustomAttribute> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DestinationStatus buildDestinationStatus() {
  ...
  if (buildCounterDestinationStatus < 3) {
    o.approvedCountries = buildUnnamed25();
    o.disapprovedCountries = buildUnnamed26();
    o.pendingCountries = buildUnnamed27();
...
void checkDestinationStatus(api.DestinationStatus o) {
  buildCounterDestinationStatus++;
  if (buildCounterDestinationStatus < 3) {
    checkUnnamed25(o.approvedCountries!);
    checkUnnamed26(o.disapprovedCountries!);
    checkUnnamed27(o.pendingCountries!);
...
api.ItemLevelIssue buildItemLevelIssue() {
  ...
  if (buildCounterItemLevelIssue < 3) {
    o.applicableCountries = buildUnnamed28();
    o.attribute = 'foo';
    o.code = 'foo';
    o.description = 'foo';
    o.detail = 'foo';
...
void checkItemLevelIssue(api.ItemLevelIssue o) {
  buildCounterItemLevelIssue++;
  if (buildCounterItemLevelIssue < 3) {
    checkUnnamed28(o.applicableCountries!);
...
core.List<api.Product> buildUnnamed29() => [buildProduct(), buildProduct()];

void checkUnnamed29(core.List<api.Product> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProduct(o[0]);
  checkProduct(o[1]);
}
...
core.List<api.CustomAttribute> buildUnnamed30() => [
  buildCustomAttribute(),
  buildCustomAttribute(),
];

void checkUnnamed30(core.List<api.CustomAttribute> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCustomAttribute(o[0]);
  checkCustomAttribute(o[1]);
}
...
api.Product buildProduct() {
  ...
  if (buildCounterProduct < 3) {
    ...
    o.customAttributes = buildUnnamed30();
    o.dataSource = 'foo';
    o.feedLabel = 'foo';
    o.name = 'foo';
    o.offerId = 'foo';
...
void checkProduct(api.Product o) {
  ...
  if (buildCounterProduct < 3) {
    ...
    checkUnnamed30(o.customAttributes!);
...
core.List<api.CustomAttribute> buildUnnamed31() => [
  buildCustomAttribute(),
  buildCustomAttribute(),
];

void checkUnnamed31(core.List<api.CustomAttribute> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCustomAttribute(o[0]);
  checkCustomAttribute(o[1]);
}
...
api.ProductInput buildProductInput() {
  ...
  if (buildCounterProductInput < 3) {
    ...
    o.channel = 'foo';
    o.contentLanguage = 'foo';
    o.customAttributes = buildUnnamed31();
    o.feedLabel = 'foo';
    o.name = 'foo';
    o.offerId = 'foo';
    o.product = 'foo';
...
void checkProductInput(api.ProductInput o) {
  ...
  if (buildCounterProductInput < 3) {
    ...
    unittest.expect(o.channel!, unittest.equals('foo'));
    unittest.expect(o.contentLanguage!, unittest.equals('foo'));
    checkUnnamed31(o.customAttributes!);
    unittest.expect(o.feedLabel!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.offerId!, unittest.equals('foo'));
...
core.List<api.DestinationStatus> buildUnnamed32() => [
  buildDestinationStatus(),
  buildDestinationStatus(),
];

void checkUnnamed32(core.List<api.DestinationStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDestinationStatus(o[0]);
  checkDestinationStatus(o[1]);
}

core.List<api.ItemLevelIssue> buildUnnamed33() => [
  buildItemLevelIssue(),
  buildItemLevelIssue(),
];

void checkUnnamed33(core.List<api.ItemLevelIssue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ProductStatus buildProductStatus() {
  ...
  if (buildCounterProductStatus < 3) {
    ...
    o.itemLevelIssues = buildUnnamed33();
...
void checkProductStatus(api.ProductStatus o) {
  ...
  if (buildCounterProductStatus < 3) {
    ...
    checkUnnamed33(o.itemLevelIssues!);
...
core.int buildCounterTax = 0;
api.Tax buildTax() {
  final o = api.Tax();
  buildCounterTax++;
  if (buildCounterTax < 3) {
    o.country = 'foo';
    o.locationId = 'foo';
    o.postalCode = 'foo';
    o.rate = 42.0;
...
void main() {
  ...
  unittest.group('obj-schema-Tax', () {
    unittest.test('to-json--from-json', () async {
      final o = buildTax();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Tax.fromJson(oJson as core.Map<core.String, core.dynamic>);
      checkTax(od);
    });
  });
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            ...
            unittest.equals('products/v1beta/'),
          );
          pathOffset += 16;
