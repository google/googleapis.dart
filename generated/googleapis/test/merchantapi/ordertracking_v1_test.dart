...
import 'package:googleapis/merchantapi/ordertracking_v1.dart' as api;
...
core.List<api.LineItemDetails> buildUnnamed1() => [
  buildLineItemDetails(),
  buildLineItemDetails(),
];

void checkUnnamed1(core.List<api.LineItemDetails> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLineItemDetails(o[0]);
  checkLineItemDetails(o[1]);
}

core.List<api.ShipmentLineItemMapping> buildUnnamed2() => [
  buildShipmentLineItemMapping(),
  buildShipmentLineItemMapping(),
];

void checkUnnamed2(core.List<api.ShipmentLineItemMapping> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkShipmentLineItemMapping(o[0]);
  checkShipmentLineItemMapping(o[1]);
}

core.List<api.ShippingInfo> buildUnnamed3() => [
  buildShippingInfo(),
  buildShippingInfo(),
];

void checkUnnamed3(core.List<api.ShippingInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.OrderTrackingSignal buildOrderTrackingSignal() {
  ...
  if (buildCounterOrderTrackingSignal < 3) {
    ...
    o.lineItems = buildUnnamed1();
    o.merchantId = 'foo';
    o.orderCreatedTime = buildDateTime();
    o.orderId = 'foo';
    o.orderTrackingSignalId = 'foo';
    o.shipmentLineItemMapping = buildUnnamed2();
    o.shippingInfo = buildUnnamed3();
  }
  buildCounterOrderTrackingSignal--;
  return o;
}
...
void checkOrderTrackingSignal(api.OrderTrackingSignal o) {
  ...
  if (buildCounterOrderTrackingSignal < 3) {
    ...
    checkUnnamed2(o.shipmentLineItemMapping!);
    checkUnnamed3(o.shippingInfo!);
  }
  buildCounterOrderTrackingSignal--;
}
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            ...
            unittest.equals('ordertracking/v1/'),
          );
          pathOffset += 17;
