...
import 'package:googleapis/merchantapi/inventories_v1beta.dart' as api;
...
core.List<api.CustomAttribute> buildUnnamed4() => [
  buildCustomAttribute(),
  buildCustomAttribute(),
];

void checkUnnamed4(core.List<api.CustomAttribute> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCustomAttribute(o[0]);
  checkCustomAttribute(o[1]);
}
...
api.RegionalInventory buildRegionalInventory() {
  ...
  if (buildCounterRegionalInventory < 3) {
    o.account = 'foo';
    o.availability = 'foo';
    o.customAttributes = buildUnnamed4();
    o.name = 'foo';
    o.price = buildPrice();
    o.region = 'foo';
    o.salePrice = buildPrice();
...
void checkRegionalInventory(api.RegionalInventory o) {
  ...
  if (buildCounterRegionalInventory < 3) {
    unittest.expect(o.account!, unittest.equals('foo'));
    unittest.expect(o.availability!, unittest.equals('foo'));
    checkUnnamed4(o.customAttributes!);
    unittest.expect(o.name!, unittest.equals('foo'));
    checkPrice(o.price!);
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            ...
            unittest.equals('inventories/v1beta/'),
          );
          pathOffset += 19;
