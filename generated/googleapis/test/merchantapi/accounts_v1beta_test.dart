...
import 'package:googleapis/merchantapi/accounts_v1beta.dart' as api;
...
api.CheckoutSettings buildCheckoutSettings() {
  ...
  if (buildCounterCheckoutSettings < 3) {
    ...
    o.eligibleDestinations = buildUnnamed2();
...
void checkCheckoutSettings(api.CheckoutSettings o) {
  ...
  if (buildCounterCheckoutSettings < 3) {
    ...
    checkUnnamed2(o.eligibleDestinations!);
...
core.List<api.AddAccountService> buildUnnamed3() => [
  buildAddAccountService(),
  buildAddAccountService(),
];

void checkUnnamed3(core.List<api.AddAccountService> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAddAccountService(o[0]);
  checkAddAccountService(o[1]);
}

core.List<api.AddUser> buildUnnamed4() => [buildAddUser(), buildAddUser()];

void checkUnnamed4(core.List<api.AddUser> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAddUser(o[0]);
  checkAddUser(o[1]);
}

core.List<api.CreateUserRequest> buildUnnamed5() => [
  buildCreateUserRequest(),
  buildCreateUserRequest(),
];

void checkUnnamed5(core.List<api.CreateUserRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCreateUserRequest(o[0]);
  checkCreateUserRequest(o[1]);
}
...
api.CreateAndConfigureAccountRequest buildCreateAndConfigureAccountRequest() {
  ...
  if (buildCounterCreateAndConfigureAccountRequest < 3) {
    ...
    o.service = buildUnnamed3();
    o.user = buildUnnamed4();
...
void checkCreateAndConfigureAccountRequest(
  ...
  if (buildCounterCreateAndConfigureAccountRequest < 3) {
    ...
    checkUnnamed3(o.service!);
    checkUnnamed4(o.user!);
    checkUnnamed5(o.users!);
  }
  buildCounterCreateAndConfigureAccountRequest--;
}

core.int buildCounterCreateUserRequest = 0;
api.CreateUserRequest buildCreateUserRequest() {
  final o = api.CreateUserRequest();
  buildCounterCreateUserRequest++;
  if (buildCounterCreateUserRequest < 3) {
    o.parent = 'foo';
    o.user = buildUser();
    o.userId = 'foo';
  }
...
void checkCreateUserRequest(api.CreateUserRequest o) {
  buildCounterCreateUserRequest++;
  if (buildCounterCreateUserRequest < 3) {
...
core.List<api.WarehouseBasedDeliveryTime> buildUnnamed6() => [
  buildWarehouseBasedDeliveryTime(),
  buildWarehouseBasedDeliveryTime(),
];

void checkUnnamed6(core.List<api.WarehouseBasedDeliveryTime> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DeliveryTime buildDeliveryTime() {
  ...
  if (buildCounterDeliveryTime < 3) {
    ...
    o.warehouseBasedDeliveryTimes = buildUnnamed6();
  }
  buildCounterDeliveryTime--;
  return o;
}
...
void checkDeliveryTime(api.DeliveryTime o) {
  ...
  if (buildCounterDeliveryTime < 3) {
    ...
    checkUnnamed6(o.warehouseBasedDeliveryTimes!);
  }
  buildCounterDeliveryTime--;
}
...
core.List<api.LfpProvider> buildUnnamed8() => [
  buildLfpProvider(),
  buildLfpProvider(),
];

void checkUnnamed8(core.List<api.LfpProvider> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GeoTargetArea buildGeoTargetArea() {
  ...
  if (buildCounterGeoTargetArea < 3) {
    o.geotargetCriteriaIds = buildUnnamed9();
  }
  buildCounterGeoTargetArea--;
  return o;
}
...
void checkGeoTargetArea(api.GeoTargetArea o) {
  buildCounterGeoTargetArea++;
  if (buildCounterGeoTargetArea < 3) {
    checkUnnamed9(o.geotargetCriteriaIds!);
  }
  buildCounterGeoTargetArea--;
}
...
core.List<api.LocationIdSet> buildUnnamed10() => [
  buildLocationIdSet(),
  buildLocationIdSet(),
];

void checkUnnamed10(core.List<api.LocationIdSet> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Price> buildUnnamed13() => [buildPrice(), buildPrice()];

void checkUnnamed13(core.List<api.Price> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPrice(o[0]);
  checkPrice(o[1]);
}

core.List<api.Weight> buildUnnamed14() => [buildWeight(), buildWeight()];

void checkUnnamed14(core.List<api.Weight> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWeight(o[0]);
  checkWeight(o[1]);
}
...
api.Headers buildHeaders() {
  ...
  if (buildCounterHeaders < 3) {
    ...
    o.numberOfItems = buildUnnamed11();
    o.postalCodeGroupNames = buildUnnamed12();
    o.prices = buildUnnamed13();
    o.weights = buildUnnamed14();
  }
  buildCounterHeaders--;
  return o;
}
...
void checkHeaders(api.Headers o) {
  ...
  if (buildCounterHeaders < 3) {
    ...
    checkUnnamed11(o.numberOfItems!);
    checkUnnamed12(o.postalCodeGroupNames!);
    checkUnnamed13(o.prices!);
    checkUnnamed14(o.weights!);
  }
  buildCounterHeaders--;
}
...
core.List<api.Impact> buildUnnamed15() => [buildImpact(), buildImpact()];

void checkUnnamed15(core.List<api.Impact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkImpact(o[0]);
  checkImpact(o[1]);
}
...
core.List<api.AccountIssue> buildUnnamed16() => [
  buildAccountIssue(),
  buildAccountIssue(),
];

void checkUnnamed16(core.List<api.AccountIssue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListAccountIssuesResponse buildListAccountIssuesResponse() {
  ...
  if (buildCounterListAccountIssuesResponse < 3) {
    o.accountIssues = buildUnnamed16();
    o.nextPageToken = 'foo';
  }
  buildCounterListAccountIssuesResponse--;
  return o;
...
void checkListAccountIssuesResponse(api.ListAccountIssuesResponse o) {
  buildCounterListAccountIssuesResponse++;
  if (buildCounterListAccountIssuesResponse < 3) {
    checkUnnamed16(o.accountIssues!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListAccountIssuesResponse--;
}

core.List<api.AccountRelationship> buildUnnamed17() => [
  buildAccountRelationship(),
  buildAccountRelationship(),
];

void checkUnnamed17(core.List<api.AccountRelationship> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListAccountRelationshipsResponse buildListAccountRelationshipsResponse() {
  ...
  if (buildCounterListAccountRelationshipsResponse < 3) {
    o.accountRelationships = buildUnnamed17();
    o.nextPageToken = 'foo';
  }
  buildCounterListAccountRelationshipsResponse--;
  return o;
...
void checkListAccountRelationshipsResponse(
  ...
  buildCounterListAccountRelationshipsResponse++;
  if (buildCounterListAccountRelationshipsResponse < 3) {
    checkUnnamed17(o.accountRelationships!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListAccountRelationshipsResponse--;
}

core.List<api.AccountService> buildUnnamed18() => [
  buildAccountService(),
  buildAccountService(),
];

void checkUnnamed18(core.List<api.AccountService> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListAccountServicesResponse buildListAccountServicesResponse() {
  ...
  if (buildCounterListAccountServicesResponse < 3) {
    o.accountServices = buildUnnamed18();
    o.nextPageToken = 'foo';
  }
  buildCounterListAccountServicesResponse--;
  return o;
...
void checkListAccountServicesResponse(api.ListAccountServicesResponse o) {
  buildCounterListAccountServicesResponse++;
  if (buildCounterListAccountServicesResponse < 3) {
    checkUnnamed18(o.accountServices!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListAccountServicesResponse--;
}

core.List<api.Account> buildUnnamed19() => [buildAccount(), buildAccount()];

void checkUnnamed19(core.List<api.Account> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAccount(o[0]);
  checkAccount(o[1]);
}
...
void checkListAccountsResponse(api.ListAccountsResponse o) {
  buildCounterListAccountsResponse++;
  if (buildCounterListAccountsResponse < 3) {
    checkUnnamed19(o.accounts!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListAccountsResponse--;
}

core.List<api.GbpAccount> buildUnnamed20() => [
  buildGbpAccount(),
  buildGbpAccount(),
];

void checkUnnamed20(core.List<api.GbpAccount> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGbpAccount(o[0]);
  checkGbpAccount(o[1]);
}
...
void checkListGbpAccountsResponse(api.ListGbpAccountsResponse o) {
  buildCounterListGbpAccountsResponse++;
  if (buildCounterListGbpAccountsResponse < 3) {
    checkUnnamed20(o.gbpAccounts!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListGbpAccountsResponse--;
}

core.List<api.OmnichannelSetting> buildUnnamed21() => [
  buildOmnichannelSetting(),
  buildOmnichannelSetting(),
];

void checkUnnamed21(core.List<api.OmnichannelSetting> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListOmnichannelSettingsResponse buildListOmnichannelSettingsResponse() {
  ...
  if (buildCounterListOmnichannelSettingsResponse < 3) {
    o.nextPageToken = 'foo';
    o.omnichannelSettings = buildUnnamed21();
  }
  buildCounterListOmnichannelSettingsResponse--;
  return o;
}
...
void checkListOmnichannelSettingsResponse(
  ...
  if (buildCounterListOmnichannelSettingsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed21(o.omnichannelSettings!);
  }
  buildCounterListOmnichannelSettingsResponse--;
}

core.List<api.OnlineReturnPolicy> buildUnnamed22() => [
  buildOnlineReturnPolicy(),
  buildOnlineReturnPolicy(),
];

void checkUnnamed22(core.List<api.OnlineReturnPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListOnlineReturnPoliciesResponse buildListOnlineReturnPoliciesResponse() {
  ...
  if (buildCounterListOnlineReturnPoliciesResponse < 3) {
    o.nextPageToken = 'foo';
    o.onlineReturnPolicies = buildUnnamed22();
  }
  buildCounterListOnlineReturnPoliciesResponse--;
  return o;
}
...
void checkListOnlineReturnPoliciesResponse(
  ...
  if (buildCounterListOnlineReturnPoliciesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed22(o.onlineReturnPolicies!);
  }
  buildCounterListOnlineReturnPoliciesResponse--;
}

core.List<api.Program> buildUnnamed23() => [buildProgram(), buildProgram()];

void checkUnnamed23(core.List<api.Program> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProgram(o[0]);
  checkProgram(o[1]);
}
...
void checkListProgramsResponse(api.ListProgramsResponse o) {
  ...
  if (buildCounterListProgramsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed23(o.programs!);
  }
  buildCounterListProgramsResponse--;
}

core.List<api.Region> buildUnnamed24() => [buildRegion(), buildRegion()];

void checkUnnamed24(core.List<api.Region> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRegion(o[0]);
  checkRegion(o[1]);
}
...
void checkListRegionsResponse(api.ListRegionsResponse o) {
  ...
  if (buildCounterListRegionsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed24(o.regions!);
  }
  buildCounterListRegionsResponse--;
}

core.List<api.Account> buildUnnamed25() => [buildAccount(), buildAccount()];

void checkUnnamed25(core.List<api.Account> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAccount(o[0]);
  checkAccount(o[1]);
}
...
void checkListSubAccountsResponse(api.ListSubAccountsResponse o) {
  buildCounterListSubAccountsResponse++;
  if (buildCounterListSubAccountsResponse < 3) {
    checkUnnamed25(o.accounts!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListSubAccountsResponse--;
}

core.List<api.User> buildUnnamed26() => [buildUser(), buildUser()];

void checkUnnamed26(core.List<api.User> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUser(o[0]);
  checkUser(o[1]);
}
...
void checkLocationIdSet(api.LocationIdSet o) {
  buildCounterLocationIdSet++;
  if (buildCounterLocationIdSet < 3) {
    checkUnnamed27(o.locationIds!);
  }
  buildCounterLocationIdSet--;
}

core.List<api.LoyaltyProgramTiers> buildUnnamed28() => [
  buildLoyaltyProgramTiers(),
  buildLoyaltyProgramTiers(),
];

void checkUnnamed28(core.List<api.LoyaltyProgramTiers> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.LoyaltyProgram buildLoyaltyProgram() {
  ...
  if (buildCounterLoyaltyProgram < 3) {
    o.loyaltyProgramTiers = buildUnnamed28();
    o.programLabel = 'foo';
  }
  buildCounterLoyaltyProgram--;
  return o;
...
void checkLoyaltyProgram(api.LoyaltyProgram o) {
  buildCounterLoyaltyProgram++;
  if (buildCounterLoyaltyProgram < 3) {
    checkUnnamed28(o.loyaltyProgramTiers!);
...
core.List<api.StoreCodeSetWithMov> buildUnnamed29() => [
  buildStoreCodeSetWithMov(),
  buildStoreCodeSetWithMov(),
];

void checkUnnamed29(core.List<api.StoreCodeSetWithMov> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MinimumOrderValueTable buildMinimumOrderValueTable() {
  ...
  if (buildCounterMinimumOrderValueTable < 3) {
    o.storeCodeSetWithMovs = buildUnnamed29();
  }
  buildCounterMinimumOrderValueTable--;
  return o;
}
...
void checkMinimumOrderValueTable(api.MinimumOrderValueTable o) {
  buildCounterMinimumOrderValueTable++;
  if (buildCounterMinimumOrderValueTable < 3) {
    checkUnnamed29(o.storeCodeSetWithMovs!);
  }
  buildCounterMinimumOrderValueTable--;
}
...
core.List<api.SeasonalOverride> buildUnnamed33() => [
  buildSeasonalOverride(),
  buildSeasonalOverride(),
];

void checkUnnamed33(core.List<api.SeasonalOverride> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.OnlineReturnPolicy buildOnlineReturnPolicy() {
  ...
  if (buildCounterOnlineReturnPolicy < 3) {
    ...
    o.itemConditions = buildUnnamed31();
    o.label = 'foo';
    o.name = 'foo';
...
void checkOnlineReturnPolicy(api.OnlineReturnPolicy o) {
  ...
  if (buildCounterOnlineReturnPolicy < 3) {
    ...
    checkUnnamed31(o.itemConditions!);
    ...
    checkUnnamed32(o.returnMethods!);
    ...
    checkUnnamed33(o.seasonalOverrides!);
  }
  buildCounterOnlineReturnPolicy--;
}
...
core.List<api.PostalCodeRange> buildUnnamed36() => [
  buildPostalCodeRange(),
  buildPostalCodeRange(),
];

void checkUnnamed36(core.List<api.PostalCodeRange> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Requirement> buildUnnamed38() => [
  buildRequirement(),
  buildRequirement(),
];

void checkUnnamed38(core.List<api.Requirement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Program buildProgram() {
  ...
  if (buildCounterProgram < 3) {
    o.activeRegionCodes = buildUnnamed37();
    o.documentationUri = 'foo';
    o.name = 'foo';
    o.state = 'foo';
    o.unmetRequirements = buildUnnamed38();
  }
  buildCounterProgram--;
  return o;
}
...
void checkProgram(api.Program o) {
  buildCounterProgram++;
  if (buildCounterProgram < 3) {
    checkUnnamed37(o.activeRegionCodes!);
    unittest.expect(o.documentationUri!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.state!, unittest.equals('foo'));
    checkUnnamed38(o.unmetRequirements!);
  }
  buildCounterProgram--;
}
...
core.List<api.CarrierRate> buildUnnamed40() => [
  buildCarrierRate(),
  buildCarrierRate(),
];

void checkUnnamed40(core.List<api.CarrierRate> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCarrierRate(o[0]);
  checkCarrierRate(o[1]);
}

core.List<api.Table> buildUnnamed41() => [buildTable(), buildTable()];

void checkUnnamed41(core.List<api.Table> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTable(o[0]);
  checkTable(o[1]);
}
...
api.RateGroup buildRateGroup() {
  ...
  if (buildCounterRateGroup < 3) {
    o.applicableShippingLabels = buildUnnamed39();
    o.carrierRates = buildUnnamed40();
    o.mainTable = buildTable();
    o.name = 'foo';
    o.singleValue = buildValue();
    o.subtables = buildUnnamed41();
  }
  buildCounterRateGroup--;
  return o;
}
...
void checkRateGroup(api.RateGroup o) {
  buildCounterRateGroup++;
  if (buildCounterRateGroup < 3) {
    checkUnnamed39(o.applicableShippingLabels!);
    checkUnnamed40(o.carrierRates!);
    checkTable(o.mainTable!);
    unittest.expect(o.name!, unittest.equals('foo'));
    checkValue(o.singleValue!);
    checkUnnamed41(o.subtables!);
  }
  buildCounterRateGroup--;
}
...
api.Requirement buildRequirement() {
  ...
  if (buildCounterRequirement < 3) {
    o.affectedRegionCodes = buildUnnamed42();
    o.documentationUri = 'foo';
    o.title = 'foo';
  }
  buildCounterRequirement--;
...
void checkRequirement(api.Requirement o) {
  buildCounterRequirement++;
  if (buildCounterRequirement < 3) {
    checkUnnamed42(o.affectedRegionCodes!);
    unittest.expect(o.documentationUri!, unittest.equals('foo'));
    unittest.expect(o.title!, unittest.equals('foo'));
  }
  buildCounterRequirement--;
...
core.List<api.Value> buildUnnamed43() => [buildValue(), buildValue()];

void checkUnnamed43(core.List<api.Value> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValue(o[0]);
  checkValue(o[1]);
}
...
core.List<api.LoyaltyProgram> buildUnnamed45() => [
  buildLoyaltyProgram(),
  buildLoyaltyProgram(),
];

void checkUnnamed45(core.List<api.LoyaltyProgram> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLoyaltyProgram(o[0]);
  checkLoyaltyProgram(o[1]);
}

core.List<api.RateGroup> buildUnnamed46() => [
  buildRateGroup(),
  buildRateGroup(),
];

void checkUnnamed46(core.List<api.RateGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRateGroup(o[0]);
  checkRateGroup(o[1]);
}
...
core.List<api.Service> buildUnnamed47() => [buildService(), buildService()];

void checkUnnamed47(core.List<api.Service> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkService(o[0]);
  checkService(o[1]);
}

core.List<api.Warehouse> buildUnnamed48() => [
  buildWarehouse(),
  buildWarehouse(),
];

void checkUnnamed48(core.List<api.Warehouse> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWarehouse(o[0]);
  checkWarehouse(o[1]);
}
...
core.List<api.TransitTimeRow> buildUnnamed53() => [
  buildTransitTimeRow(),
  buildTransitTimeRow(),
];

void checkUnnamed53(core.List<api.TransitTimeRow> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TransitTable buildTransitTable() {
  ...
  if (buildCounterTransitTable < 3) {
    o.postalCodeGroupNames = buildUnnamed52();
    o.rows = buildUnnamed53();
    o.transitTimeLabels = buildUnnamed54();
  }
  buildCounterTransitTable--;
  return o;
}
...
void checkTransitTable(api.TransitTable o) {
  buildCounterTransitTable++;
  if (buildCounterTransitTable < 3) {
    checkUnnamed52(o.postalCodeGroupNames!);
    checkUnnamed53(o.rows!);
    checkUnnamed54(o.transitTimeLabels!);
  }
  buildCounterTransitTable--;
}

core.List<api.TransitTimeValue> buildUnnamed55() => [
  buildTransitTimeValue(),
  buildTransitTimeValue(),
];

void checkUnnamed55(core.List<api.TransitTimeValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void main() {
  ...
  unittest.group('obj-schema-CreateUserRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCreateUserRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CreateUserRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCreateUserRequest(od);
    });
  });
    ...
    unittest.test('method--createAndConfigure', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          pathOffset += 1;
          unittest.expect(
            path.substring(pathOffset, pathOffset + 43),
            unittest.equals('accounts/v1beta/accounts:createAndConfigure'),
          );
          pathOffset += 43;
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            ...
            unittest.equals('accounts/v1beta/'),
          );
          pathOffset += 16;
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            ...
            unittest.equals('accounts/v1beta/accounts'),
          );
          pathOffset += 24;
    ...
    unittest.test('method--retrieveLatest', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          pathOffset += 1;
          unittest.expect(
            path.substring(pathOffset, pathOffset + 45),
            unittest.equals('accounts/v1beta/termsOfService:retrieveLatest'),
          );
          pathOffset += 45;
