...
core.List<api.Gateway> buildUnnamed57() => [
      buildGateway(),
      buildGateway(),
    ];
...
core.List<api.Mesh> buildUnnamed70() => [
      buildMesh(),
      buildMesh(),
    ];
...
core.List<api.TcpRoute> buildUnnamed77() => [
      buildTcpRoute(),
      buildTcpRoute(),
    ];
...
core.List<api.TlsRoute> buildUnnamed79() => [
      buildTlsRoute(),
      buildTlsRoute(),
    ];
...
core.List<api.Binding> buildUnnamed91() => [
      buildBinding(),
      buildBinding(),
    ];
