...
core.List<api.Account> buildUnnamed4259() => [
      buildAccount(),
      buildAccount(),
    ];

void checkUnnamed4259(core.List<api.Account> o) {
...
api.Account buildAccount() {
  ...
  if (buildCounterAccount < 3) {
    ...
    o.name = 'foo';
    o.premium = true;
    o.subAccounts = buildUnnamed4259();
    o.timezone = 'foo';
  }
  buildCounterAccount--;
  return o;
...
void checkAccount(api.Account o) {
  ...
  if (buildCounterAccount < 3) {
    ...
    checkUnnamed4259(o.subAccounts!);
    unittest.expect(
      o.timezone!,
      unittest.equals('foo'),
    );
...
core.List<api.Account> buildUnnamed4260() => [
      buildAccount(),
      buildAccount(),
    ];

void checkUnnamed4260(core.List<api.Account> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAccount(o[0]);
  checkAccount(o[1]);
}
...
core.List<api.AdClient> buildUnnamed4261() => [
      buildAdClient(),
      buildAdClient(),
    ];

void checkUnnamed4261(core.List<api.AdClient> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdClient(o[0]);
  checkAdClient(o[1]);
}
...
core.List<api.AdUnit> buildUnnamed4262() => [
      buildAdUnit(),
      buildAdUnit(),
    ];

void checkUnnamed4262(core.List<api.AdUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdUnit(o[0]);
  checkAdUnit(o[1]);
}
...
core.List<api.AdsenseReportsGenerateResponseHeaders> buildUnnamed4264() => [
      buildAdsenseReportsGenerateResponseHeaders(),
      buildAdsenseReportsGenerateResponseHeaders(),
    ];

void checkUnnamed4264(core.List<api.AdsenseReportsGenerateResponseHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.List<core.String>> buildUnnamed4266() => [
      buildUnnamed4265(),
      buildUnnamed4265(),
    ];

void checkUnnamed4266(core.List<core.List<core.String>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed4265(o[0]);
  checkUnnamed4265(o[1]);
}
...
api.AdsenseReportsGenerateResponse buildAdsenseReportsGenerateResponse() {
  ...
  if (buildCounterAdsenseReportsGenerateResponse < 3) {
    o.averages = buildUnnamed4263();
    o.endDate = 'foo';
    o.headers = buildUnnamed4264();
    o.kind = 'foo';
    o.rows = buildUnnamed4266();
    o.startDate = 'foo';
    o.totalMatchedRows = 'foo';
    o.totals = buildUnnamed4267();
    o.warnings = buildUnnamed4268();
  }
  buildCounterAdsenseReportsGenerateResponse--;
  return o;
}
...
void checkAdsenseReportsGenerateResponse(api.AdsenseReportsGenerateResponse o) {
  buildCounterAdsenseReportsGenerateResponse++;
  if (buildCounterAdsenseReportsGenerateResponse < 3) {
    checkUnnamed4263(o.averages!);
    unittest.expect(
      o.endDate!,
      unittest.equals('foo'),
    );
    checkUnnamed4264(o.headers!);
    unittest.expect(
      o.kind!,
      unittest.equals('foo'),
    );
    checkUnnamed4266(o.rows!);
    unittest.expect(
      o.startDate!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed4267(o.totals!);
    checkUnnamed4268(o.warnings!);
  }
  buildCounterAdsenseReportsGenerateResponse--;
}
...
core.List<api.Alert> buildUnnamed4269() => [
      buildAlert(),
      buildAlert(),
    ];

void checkUnnamed4269(core.List<api.Alert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAlert(o[0]);
  checkAlert(o[1]);
}
...
core.List<api.CustomChannel> buildUnnamed4270() => [
      buildCustomChannel(),
      buildCustomChannel(),
    ];

void checkUnnamed4270(core.List<api.CustomChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ReportingMetadataEntry> buildUnnamed4271() => [
      buildReportingMetadataEntry(),
      buildReportingMetadataEntry(),
    ];

void checkUnnamed4271(core.List<api.ReportingMetadataEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Payment> buildUnnamed4272() => [
      buildPayment(),
      buildPayment(),
    ];

void checkUnnamed4272(core.List<api.Payment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPayment(o[0]);
  checkPayment(o[1]);
}
...
api.ReportingMetadataEntry buildReportingMetadataEntry() {
  ...
  if (buildCounterReportingMetadataEntry < 3) {
    o.compatibleDimensions = buildUnnamed4273();
    o.compatibleMetrics = buildUnnamed4274();
    o.id = 'foo';
    o.kind = 'foo';
    o.requiredDimensions = buildUnnamed4275();
    o.requiredMetrics = buildUnnamed4276();
    o.supportedProducts = buildUnnamed4277();
  }
  buildCounterReportingMetadataEntry--;
  return o;
}
...
void checkReportingMetadataEntry(api.ReportingMetadataEntry o) {
  buildCounterReportingMetadataEntry++;
  if (buildCounterReportingMetadataEntry < 3) {
    checkUnnamed4273(o.compatibleDimensions!);
    checkUnnamed4274(o.compatibleMetrics!);
    unittest.expect(
      o.id!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed4275(o.requiredDimensions!);
    checkUnnamed4276(o.requiredMetrics!);
    checkUnnamed4277(o.supportedProducts!);
  }
  buildCounterReportingMetadataEntry--;
}
...
core.List<api.SavedAdStyle> buildUnnamed4278() => [
      buildSavedAdStyle(),
      buildSavedAdStyle(),
    ];

void checkUnnamed4278(core.List<api.SavedAdStyle> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.SavedReport> buildUnnamed4279() => [
      buildSavedReport(),
      buildSavedReport(),
    ];

void checkUnnamed4279(core.List<api.SavedReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.UrlChannel> buildUnnamed4280() => [
      buildUrlChannel(),
      buildUrlChannel(),
    ];

void checkUnnamed4280(core.List<api.UrlChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUrlChannel(o[0]);
  checkUrlChannel(o[1]);
}
...
void main() {
  ...
  unittest.group('resource-AccountsReportsResource', () {
    unittest.test('method--generate', () async {
      ...
      final arg_dimension = buildUnnamed4281();
      final arg_filter = buildUnnamed4282();
      final arg_locale = 'foo';
      final arg_maxResults = 42;
      final arg_metric = buildUnnamed4283();
      final arg_sort = buildUnnamed4284();
  ...
  unittest.group('resource-ReportsResource', () {
    unittest.test('method--generate', () async {
      ...
      final arg_startDate = 'foo';
      final arg_endDate = 'foo';
      final arg_accountId = buildUnnamed4285();
      final arg_currency = 'foo';
      final arg_dimension = buildUnnamed4286();
      final arg_filter = buildUnnamed4287();
      final arg_locale = 'foo';
      final arg_maxResults = 42;
      final arg_metric = buildUnnamed4288();
      final arg_sort = buildUnnamed4289();
      final arg_startIndex = 42;
      final arg_useTimezoneReporting = true;
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
