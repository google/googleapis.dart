...
checkUnnamed5493(core.List<core.String> o) {
...
checkUnnamed5494(core.List<api.ApiDimensionFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5495(core.List<api.ApiDimensionFilterGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSearchAnalyticsQueryRequest() {
  ...
  if (buildCounterSearchAnalyticsQueryRequest < 3) {
    ...
    o.dataState = "foo";
    o.dimensionFilterGroups = buildUnnamed5495();
...
checkSearchAnalyticsQueryRequest(api.SearchAnalyticsQueryRequest o) {
  ...
  if (buildCounterSearchAnalyticsQueryRequest < 3) {
    ...
    checkUnnamed5495(o.dimensionFilterGroups);
...
checkUnnamed5497(core.List<api.ApiDataRow> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApiDataRow(o[0]);
  checkApiDataRow(o[1]);
}
...
checkUnnamed5498(core.List<api.WmxSitemap> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWmxSitemap(o[0]);
  checkWmxSitemap(o[1]);
}
...
checkUnnamed5499(core.List<api.WmxSite> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWmxSite(o[0]);
  checkWmxSite(o[1]);
}
...
checkUnnamed5500(core.List<api.WmxSitemapContent> o) {
  unittest.expect(o, unittest.hasLength(2));
