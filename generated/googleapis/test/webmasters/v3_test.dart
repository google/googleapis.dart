...
core.List<api.ApiDimensionFilter> buildUnnamed3133() {
  var o = <api.ApiDimensionFilter>[];
...
void checkUnnamed3133(core.List<api.ApiDimensionFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkApiDimensionFilterGroup(api.ApiDimensionFilterGroup o) {
  buildCounterApiDimensionFilterGroup++;
  if (buildCounterApiDimensionFilterGroup < 3) {
    checkUnnamed3133(o.filters);
    unittest.expect(o.groupType, unittest.equals('foo'));
  }
  buildCounterApiDimensionFilterGroup--;
}

core.List<api.ApiDimensionFilterGroup> buildUnnamed3134() {
  var o = <api.ApiDimensionFilterGroup>[];
...
void checkUnnamed3134(core.List<api.ApiDimensionFilterGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SearchAnalyticsQueryRequest buildSearchAnalyticsQueryRequest() {
  ...
  if (buildCounterSearchAnalyticsQueryRequest < 3) {
    ...
    o.dataState = 'foo';
    o.dimensionFilterGroups = buildUnnamed3134();
    o.dimensions = buildUnnamed3135();
    o.endDate = 'foo';
    o.rowLimit = 42;
    o.searchType = 'foo';
    o.startDate = 'foo';
...
void checkSearchAnalyticsQueryRequest(api.SearchAnalyticsQueryRequest o) {
  ...
  if (buildCounterSearchAnalyticsQueryRequest < 3) {
    ...
    checkUnnamed3134(o.dimensionFilterGroups);
    checkUnnamed3135(o.dimensions);
...
core.List<api.ApiDataRow> buildUnnamed3136() {
  var o = <api.ApiDataRow>[];
...
void checkUnnamed3136(core.List<api.ApiDataRow> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkSearchAnalyticsQueryResponse(api.SearchAnalyticsQueryResponse o) {
  ...
  if (buildCounterSearchAnalyticsQueryResponse < 3) {
    ...
    checkUnnamed3136(o.rows);
  }
  buildCounterSearchAnalyticsQueryResponse--;
}

core.List<api.WmxSitemap> buildUnnamed3137() {
...
void checkUnnamed3137(core.List<api.WmxSitemap> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkSitemapsListResponse(api.SitemapsListResponse o) {
  buildCounterSitemapsListResponse++;
  if (buildCounterSitemapsListResponse < 3) {
    checkUnnamed3137(o.sitemap);
  }
  buildCounterSitemapsListResponse--;
}

core.List<api.WmxSite> buildUnnamed3138() {
  var o = <api.WmxSite>[];
  o.add(buildWmxSite());
  o.add(buildWmxSite());
  return o;
...
void checkUnnamed3138(core.List<api.WmxSite> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.WmxSitemapContent> buildUnnamed3139() {
...
void checkUnnamed3139(core.List<api.WmxSitemapContent> o) {
  unittest.expect(o, unittest.hasLength(2));
