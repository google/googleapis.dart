...
import 'package:googleapis/parallelstore/v1beta.dart' as api;
import 'package:http/http.dart' as http;
import 'package:test/test.dart' as unittest;

import '../test_shared.dart';

core.int buildCounterDestinationGcsBucket = 0;
api.DestinationGcsBucket buildDestinationGcsBucket() {
  final o = api.DestinationGcsBucket();
  buildCounterDestinationGcsBucket++;
  if (buildCounterDestinationGcsBucket < 3) {
    o.uri = 'foo';
  }
  buildCounterDestinationGcsBucket--;
  return o;
...
void checkDestinationGcsBucket(api.DestinationGcsBucket o) {
  buildCounterDestinationGcsBucket++;
  if (buildCounterDestinationGcsBucket < 3) {
...
core.int buildCounterDestinationParallelstore = 0;
api.DestinationParallelstore buildDestinationParallelstore() {
  final o = api.DestinationParallelstore();
  buildCounterDestinationParallelstore++;
  if (buildCounterDestinationParallelstore < 3) {
    o.path = 'foo';
  }
  buildCounterDestinationParallelstore--;
  return o;
...
void checkDestinationParallelstore(api.DestinationParallelstore o) {
  buildCounterDestinationParallelstore++;
  if (buildCounterDestinationParallelstore < 3) {
...
void checkExportDataRequest(api.ExportDataRequest o) {
  ...
  if (buildCounterExportDataRequest < 3) {
    ...
    checkSourceParallelstore(o.sourceParallelstore!);
  }
  buildCounterExportDataRequest--;
}
...
void checkImportDataRequest(api.ImportDataRequest o) {
  ...
  if (buildCounterImportDataRequest < 3) {
    ...
    unittest.expect(o.requestId!, unittest.equals('foo'));
    unittest.expect(o.serviceAccount!, unittest.equals('foo'));
    checkSourceGcsBucket(o.sourceGcsBucket!);
  }
  buildCounterImportDataRequest--;
}
...
void checkInstance(api.Instance o) {
  buildCounterInstance++;
  if (buildCounterInstance < 3) {
    checkUnnamed0(o.accessPoints!);
    unittest.expect(o.capacityGib!, unittest.equals('foo'));
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.daosVersion!, unittest.equals('foo'));
    unittest.expect(o.deploymentType!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.directoryStripeLevel!, unittest.equals('foo'));
    unittest.expect(o.effectiveReservedIpRange!, unittest.equals('foo'));
    unittest.expect(o.fileStripeLevel!, unittest.equals('foo'));
...
core.List<api.Instance> buildUnnamed2() => [buildInstance(), buildInstance()];

void checkUnnamed2(core.List<api.Instance> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInstance(o[0]);
  checkInstance(o[1]);
}
...
core.int buildCounterSourceGcsBucket = 0;
api.SourceGcsBucket buildSourceGcsBucket() {
  final o = api.SourceGcsBucket();
  buildCounterSourceGcsBucket++;
  if (buildCounterSourceGcsBucket < 3) {
    o.uri = 'foo';
  }
  buildCounterSourceGcsBucket--;
  return o;
...
void checkSourceGcsBucket(api.SourceGcsBucket o) {
  buildCounterSourceGcsBucket++;
  if (buildCounterSourceGcsBucket < 3) {
    unittest.expect(o.uri!, unittest.equals('foo'));
  }
...
core.int buildCounterSourceParallelstore = 0;
api.SourceParallelstore buildSourceParallelstore() {
  final o = api.SourceParallelstore();
  buildCounterSourceParallelstore++;
  if (buildCounterSourceParallelstore < 3) {
    o.path = 'foo';
  }
  buildCounterSourceParallelstore--;
  return o;
...
void checkSourceParallelstore(api.SourceParallelstore o) {
  buildCounterSourceParallelstore++;
  if (buildCounterSourceParallelstore < 3) {
    unittest.expect(o.path!, unittest.equals('foo'));
  }
...
void main() {
  unittest.group('obj-schema-DestinationGcsBucket', () {
    unittest.test('to-json--from-json', () async {
      final o = buildDestinationGcsBucket();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.DestinationGcsBucket.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkDestinationGcsBucket(od);
    });
  });

  unittest.group('obj-schema-DestinationParallelstore', () {
    unittest.test('to-json--from-json', () async {
      final o = buildDestinationParallelstore();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.DestinationParallelstore.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkDestinationParallelstore(od);
    });
  });
  ...
  unittest.group('obj-schema-SourceGcsBucket', () {
    unittest.test('to-json--from-json', () async {
      final o = buildSourceGcsBucket();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.SourceGcsBucket.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkSourceGcsBucket(od);
    });
  });

  unittest.group('obj-schema-SourceParallelstore', () {
    unittest.test('to-json--from-json', () async {
      final o = buildSourceParallelstore();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.SourceParallelstore.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkSourceParallelstore(od);
    });
  });
  ...
  unittest.group('resource-ProjectsLocationsResource', () {
    unittest.test('method--get', () async {
      ...
      final res = api.ParallelstoreApi(mock).projects.locations;
      final arg_name = 'foo';
  ...
  unittest.group('resource-ProjectsLocationsInstancesResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.ParallelstoreApi(mock).projects.locations.instances;
  ...
  unittest.group('resource-ProjectsLocationsOperationsResource', () {
    unittest.test('method--cancel', () async {
      final mock = HttpServerMock();
      final res = api.ParallelstoreApi(mock).projects.locations.operations;
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
