...
void checkAdWordsLocationExtensions(api.AdWordsLocationExtensions o) {
  buildCounterAdWordsLocationExtensions++;
  if (buildCounterAdWordsLocationExtensions < 3) {
    unittest.expect(o.adPhone!, unittest.equals('foo'));
  }
  buildCounterAdWordsLocationExtensions--;
}
...
void checkAttributeMetadata(api.AttributeMetadata o) {
  ...
  if (buildCounterAttributeMetadata < 3) {
    ...
    unittest.expect(o.groupDisplayName!, unittest.equals('foo'));
...
core.List<api.Category> buildUnnamed4() => [buildCategory(), buildCategory()];
...
core.List<api.ChainUri> buildUnnamed10() => [buildChainUri(), buildChainUri()];
...
void checkChain(api.Chain o) {
  ...
  if (buildCounterChain < 3) {
    ...
    unittest.expect(o.locationCount!, unittest.equals(42));
    unittest.expect(o.name!, unittest.equals('foo'));
...
void checkGoogleLocation(api.GoogleLocation o) {
  ...
  if (buildCounterGoogleLocation < 3) {
    ...
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.requestAdminRightsUri!, unittest.equals('foo'));
  }
  buildCounterGoogleLocation--;
}
...
void checkGoogleUpdatedLocation(api.GoogleUpdatedLocation o) {
  ...
  if (buildCounterGoogleUpdatedLocation < 3) {
    ...
    checkLocation(o.location!);
    unittest.expect(o.pendingMask!, unittest.equals('foo'));
  }
  buildCounterGoogleUpdatedLocation--;
}
...
core.List<api.Category> buildUnnamed12() => [buildCategory(), buildCategory()];
...
void checkMetadata(api.Metadata o) {
  ...
  if (buildCounterMetadata < 3) {
    ...
    unittest.expect(o.duplicateLocation!, unittest.equals('foo'));
    ...
    unittest.expect(o.mapsUri!, unittest.equals('foo'));
    unittest.expect(o.newReviewUri!, unittest.equals('foo'));
...
void checkMoreHours(api.MoreHours o) {
  buildCounterMoreHours++;
  if (buildCounterMoreHours < 3) {
    unittest.expect(o.hoursTypeId!, unittest.equals('foo'));
...
void checkMoreHoursType(api.MoreHoursType o) {
  ...
  if (buildCounterMoreHoursType < 3) {
    unittest.expect(o.displayName!, unittest.equals('foo'));
    unittest.expect(o.hoursTypeId!, unittest.equals('foo'));
    unittest.expect(o.localizedDisplayName!, unittest.equals('foo'));
  }
  buildCounterMoreHoursType--;
}
...
void checkPhoneNumbers(api.PhoneNumbers o) {
  ...
  if (buildCounterPhoneNumbers < 3) {
    ...
    unittest.expect(o.primaryPhone!, unittest.equals('foo'));
  }
  buildCounterPhoneNumbers--;
}
...
void checkRelationshipData(api.RelationshipData o) {
  ...
  if (buildCounterRelationshipData < 3) {
    ...
    unittest.expect(o.parentChain!, unittest.equals('foo'));
...
core.List<api.Chain> buildUnnamed25() => [buildChain(), buildChain()];
...
void checkServiceAreaBusiness(api.ServiceAreaBusiness o) {
  buildCounterServiceAreaBusiness++;
  if (buildCounterServiceAreaBusiness < 3) {
    unittest.expect(o.businessType!, unittest.equals('foo'));
...
void checkServiceType(api.ServiceType o) {
  ...
  if (buildCounterServiceType < 3) {
    unittest.expect(o.displayName!, unittest.equals('foo'));
    unittest.expect(o.serviceTypeId!, unittest.equals('foo'));
  }
  buildCounterServiceType--;
}
...
void checkTimePeriod(api.TimePeriod o) {
  buildCounterTimePeriod++;
  if (buildCounterTimePeriod < 3) {
    unittest.expect(o.closeDay!, unittest.equals('foo'));
    checkTimeOfDay(o.closeTime!);
    unittest.expect(o.openDay!, unittest.equals('foo'));
    checkTimeOfDay(o.openTime!);
  }
  buildCounterTimePeriod--;
}
...
void main() {
  ...
  unittest.group('obj-schema-ChainName', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ChainName.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkChainName(od);
    });
  ...
  unittest.group('obj-schema-ChainUri', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ChainUri.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkChainUri(od);
    });
  ...
  unittest.group('obj-schema-MoreHours', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.MoreHours.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkMoreHours(od);
    });
  ...
  unittest.group('obj-schema-OpenInfo', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.OpenInfo.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkOpenInfo(od);
    });
  ...
  unittest.group('obj-schema-PlaceInfo', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.PlaceInfo.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPlaceInfo(od);
    });
    ...
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Location.fromJson(
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final resp = convert.json.encode(
            buildListAttributeMetadataResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
    ...
    unittest.test('method--search', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildSearchGoogleLocationsResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
  ...
  unittest.group('resource-LocationsResource', () {
    ...
    unittest.test('method--updateAttributes', () async {
      ...
      final response = await res.updateAttributes(
        arg_request,
        arg_name,
        attributeMask: arg_attributeMask,
        $fields: arg_$fields,
      );
      checkAttributes(response as api.Attributes);
    });
