...
core.List<api.AdUnit> buildUnnamed51() => [
      buildAdUnit(),
      buildAdUnit(),
    ];

void checkUnnamed51(core.List<api.AdUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdUnit(o[0]);
  checkAdUnit(o[1]);
}
...
core.List<api.App> buildUnnamed52() => [
      buildApp(),
      buildApp(),
    ];

void checkUnnamed52(core.List<api.App> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApp(o[0]);
  checkApp(o[1]);
}
...
core.List<api.PublisherAccount> buildUnnamed53() => [
      buildPublisherAccount(),
      buildPublisherAccount(),
    ];

void checkUnnamed53(core.List<api.PublisherAccount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.MediationReportSpecDimensionFilter> buildUnnamed54() => [
      buildMediationReportSpecDimensionFilter(),
      buildMediationReportSpecDimensionFilter(),
    ];

void checkUnnamed54(core.List<api.MediationReportSpecDimensionFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.MediationReportSpecSortCondition> buildUnnamed57() => [
      buildMediationReportSpecSortCondition(),
      buildMediationReportSpecSortCondition(),
    ];

void checkUnnamed57(core.List<api.MediationReportSpecSortCondition> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkMediationReportSpec(api.MediationReportSpec o) {
  ...
  if (buildCounterMediationReportSpec < 3) {
    ...
    checkUnnamed54(o.dimensionFilters!);
    ...
    checkUnnamed57(o.sortConditions!);
    unittest.expect(
      o.timeZone!,
      unittest.equals('foo'),
    );
...
core.List<api.NetworkReportSpecDimensionFilter> buildUnnamed58() => [
      buildNetworkReportSpecDimensionFilter(),
      buildNetworkReportSpecDimensionFilter(),
    ];

void checkUnnamed58(core.List<api.NetworkReportSpecDimensionFilter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.NetworkReportSpecSortCondition> buildUnnamed61() => [
      buildNetworkReportSpecSortCondition(),
      buildNetworkReportSpecSortCondition(),
    ];

void checkUnnamed61(core.List<api.NetworkReportSpecSortCondition> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.NetworkReportSpec buildNetworkReportSpec() {
  ...
  if (buildCounterNetworkReportSpec < 3) {
    o.dateRange = buildDateRange();
    o.dimensionFilters = buildUnnamed58();
    o.dimensions = buildUnnamed59();
    o.localizationSettings = buildLocalizationSettings();
    o.maxReportRows = 42;
    o.metrics = buildUnnamed60();
    o.sortConditions = buildUnnamed61();
    o.timeZone = 'foo';
  }
  buildCounterNetworkReportSpec--;
  return o;
...
void checkNetworkReportSpec(api.NetworkReportSpec o) {
  ...
  if (buildCounterNetworkReportSpec < 3) {
    checkDateRange(o.dateRange!);
    checkUnnamed58(o.dimensionFilters!);
    checkUnnamed59(o.dimensions!);
    checkLocalizationSettings(o.localizationSettings!);
    unittest.expect(
      o.maxReportRows!,
      unittest.equals(42),
    ...
    checkUnnamed61(o.sortConditions!);
    unittest.expect(
      o.timeZone!,
      unittest.equals('foo'),
    );
...
core.List<api.ReportWarning> buildUnnamed62() => [
      buildReportWarning(),
      buildReportWarning(),
    ];

void checkUnnamed62(core.List<api.ReportWarning> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, api.ReportRowDimensionValue> buildUnnamed63() => {
      'x': buildReportRowDimensionValue(),
      'y': buildReportRowDimensionValue(),
    };

void checkUnnamed63(core.Map<core.String, api.ReportRowDimensionValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReportRowDimensionValue(o['x']!);
  checkReportRowDimensionValue(o['y']!);
}

core.Map<core.String, api.ReportRowMetricValue> buildUnnamed64() => {
      'x': buildReportRowMetricValue(),
      'y': buildReportRowMetricValue(),
    };

void checkUnnamed64(core.Map<core.String, api.ReportRowMetricValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ReportRow buildReportRow() {
  ...
  if (buildCounterReportRow < 3) {
    o.dimensionValues = buildUnnamed63();
    o.metricValues = buildUnnamed64();
  }
  buildCounterReportRow--;
  return o;
}
...
void checkReportRow(api.ReportRow o) {
  buildCounterReportRow++;
  if (buildCounterReportRow < 3) {
    checkUnnamed63(o.dimensionValues!);
    checkUnnamed64(o.metricValues!);
  }
  buildCounterReportRow--;
}
