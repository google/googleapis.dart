...
import 'package:googleapis/alertcenter/v1beta1.dart' as api;
...
core.List<api.Alert> buildUnnamed8() => [buildAlert(), buildAlert()];
...
void main() {
  ...
  unittest.group('resource-AlertsResource', () {
    ...
    unittest.test('method--batchUndelete', () async {
      ...
      final response = await res.batchUndelete(
        arg_request,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--getMetadata', () async {
      ...
      final response = await res.getMetadata(
        arg_alertId,
        customerId: arg_customerId,
        $fields: arg_$fields,
      );
