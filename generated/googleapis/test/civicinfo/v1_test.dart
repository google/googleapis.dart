...
checkUnnamed403(core.List<api.ElectionOfficial> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAdministrativeBody() {
  ...
  if (buildCounterAdministrativeBody < 3) {
    ...
    o.electionOfficials = buildUnnamed403();
    ...
    o.voterServices = buildUnnamed404();
...
checkAdministrativeBody(api.AdministrativeBody o) {
  ...
  if (buildCounterAdministrativeBody < 3) {
    ...
    checkUnnamed403(o.electionOfficials);
    ...
    checkUnnamed404(o.voterServices);
...
checkUnnamed405(core.List<api.Channel> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkChannel(o[0]);
  checkChannel(o[1]);
}
...
checkUnnamed406(core.List<api.Candidate> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCandidate(o[0]);
  checkCandidate(o[1]);
}
...
checkUnnamed407(core.List<api.Source> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSource(o[0]);
  checkSource(o[1]);
}
...
checkUnnamed408(core.List<api.DivisionSearchResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed410(core.List<api.Election> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkElection(o[0]);
  checkElection(o[1]);
}
...
buildGeographicDivision() {
  ...
  if (buildCounterGeographicDivision < 3) {
    o.alsoKnownAs = buildUnnamed411();
    o.name = "foo";
    o.officeIds = buildUnnamed412();
    o.scope = "foo";
  }
  buildCounterGeographicDivision--;
  return o;
...
checkGeographicDivision(api.GeographicDivision o) {
  buildCounterGeographicDivision++;
  if (buildCounterGeographicDivision < 3) {
    checkUnnamed411(o.alsoKnownAs);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed412(o.officeIds);
    unittest.expect(o.scope, unittest.equals('foo'));
  }
  buildCounterGeographicDivision--;
}
...
checkUnnamed422(core.Map<core.String, api.Office> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOffice(o["x"]);
  checkOffice(o["y"]);
}
...
checkUnnamed423(core.Map<core.String, api.Official> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOfficial(o["x"]);
  checkOfficial(o["y"]);
}
...
checkUnnamed424(core.List<api.Contest> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContest(o[0]);
  checkContest(o[1]);
}
...
checkUnnamed425(core.List<api.PollingLocation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed426(core.List<api.PollingLocation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPollingLocation(o[0]);
  checkPollingLocation(o[1]);
}
...
checkUnnamed428(core.List<api.AdministrationRegion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildVoterInfoResponse() {
  ...
  if (buildCounterVoterInfoResponse < 3) {
    o.contests = buildUnnamed424();
    o.dropOffLocations = buildUnnamed425();
    o.earlyVoteSites = buildUnnamed426();
    o.election = buildElection();
    o.kind = "foo";
    o.normalizedInput = buildSimpleAddressType();
    o.pollingLocations = buildUnnamed427();
    o.precinctId = "foo";
    o.state = buildUnnamed428();
    o.status = "foo";
  }
  buildCounterVoterInfoResponse--;
  return o;
...
checkVoterInfoResponse(api.VoterInfoResponse o) {
  buildCounterVoterInfoResponse++;
  if (buildCounterVoterInfoResponse < 3) {
    checkUnnamed424(o.contests);
    checkUnnamed425(o.dropOffLocations);
    checkUnnamed426(o.earlyVoteSites);
    checkElection(o.election);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkSimpleAddressType(o.normalizedInput);
    checkUnnamed427(o.pollingLocations);
    unittest.expect(o.precinctId, unittest.equals('foo'));
    checkUnnamed428(o.state);
    unittest.expect(o.status, unittest.equals('foo'));
  }
  buildCounterVoterInfoResponse--;
}
