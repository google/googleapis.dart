...
checkUnnamed1017(core.List<api.Post> o) {
...
checkUnnamed1018(core.List<api.BlogUserInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1019(core.List<api.Blog> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBlog(o[0]);
  checkBlog(o[1]);
}
...
buildBlogList() {
  ...
  if (buildCounterBlogList < 3) {
    o.blogUserInfos = buildUnnamed1018();
...
checkBlogList(api.BlogList o) {
  buildCounterBlogList++;
  if (buildCounterBlogList < 3) {
    checkUnnamed1018(o.blogUserInfos);
...
checkUnnamed1020(core.List<api.Comment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkComment(o[0]);
  checkComment(o[1]);
}
...
checkUnnamed1021(core.List<api.Page> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPage(o[0]);
  checkPage(o[1]);
}
...
checkUnnamed1022(core.List<api.PageviewsCounts> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1023(core.List<api.PostImages> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPostImages(o[0]);
  checkPostImages(o[1]);
}
...
checkUnnamed1025(core.List<api.Comment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkComment(o[0]);
  checkComment(o[1]);
}
...
buildPost() {
  ...
  if (buildCounterPost < 3) {
    ...
    o.etag = "foo";
    o.id = "foo";
    o.images = buildUnnamed1023();
    o.kind = "foo";
    o.labels = buildUnnamed1024();
...
checkPost(api.Post o) {
  ...
  if (buildCounterPost < 3) {
    ...
    unittest.expect(o.etag, unittest.equals('foo'));
    unittest.expect(o.id, unittest.equals('foo'));
    checkUnnamed1023(o.images);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1024(o.labels);
...
checkUnnamed1027(core.List<api.PostUserInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
main() {
  ...
  unittest.group("resource-BlogsResourceApi", () {
    ...
    unittest.test("method--listByUser", () {
      ...
      var arg_role = buildUnnamed1028();
      var arg_status = buildUnnamed1029();
      var arg_view = "foo";
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group("resource-CommentsResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_status = buildUnnamed1030();
      var arg_view = "foo";
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
    ...
    unittest.test("method--listByBlog", () {
      ...
      var arg_pageToken = "foo";
      var arg_startDate = core.DateTime.parse("2002-02-27T14:01:02");
      var arg_status = buildUnnamed1031();
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
        var index;
  ...
  unittest.group("resource-PageViewsResourceApi", () {
    unittest.test("method--get", () {
      ...
      var arg_blogId = "foo";
      var arg_range = buildUnnamed1032();
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
        var index;
  ...
  unittest.group("resource-PagesResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_maxResults = 42;
      var arg_pageToken = "foo";
      var arg_status = buildUnnamed1033();
      var arg_view = "foo";
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group("resource-PostUserInfosResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_pageToken = "foo";
      var arg_startDate = core.DateTime.parse("2002-02-27T14:01:02");
      var arg_status = buildUnnamed1034();
      var arg_view = "foo";
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group("resource-PostsResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_pageToken = "foo";
      var arg_startDate = core.DateTime.parse("2002-02-27T14:01:02");
      var arg_status = buildUnnamed1035();
      var arg_view = "foo";
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
