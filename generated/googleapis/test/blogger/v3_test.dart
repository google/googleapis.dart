...
core.List<api.Comment> buildUnnamed8() => [buildComment(), buildComment()];
...
core.List<api.Post> buildUnnamed9() => [buildPost(), buildPost()];
...
void main() {
  ...
  unittest.group('obj-schema-Pageviews', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Pageviews.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPageviews(od);
    });
  ...
  unittest.group('resource-BlogsResource', () {
    ...
    unittest.test('method--getByUrl', () async {
      ...
      final response = await res.getByUrl(
        arg_url,
        view: arg_view,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--listByUser', () async {
      ...
      final response = await res.listByUser(
        arg_userId,
  ...
  unittest.group('resource-CommentsResource', () {
    ...
    unittest.test('method--listByBlog', () async {
      ...
      final response = await res.listByBlog(
        arg_blogId,
        endDate: arg_endDate,
        fetchBodies: arg_fetchBodies,
        maxResults: arg_maxResults,
  ...
  unittest.group('resource-PostsResource', () {
    ...
    unittest.test('method--getByPath', () async {
      ...
      final response = await res.getByPath(
        arg_blogId,
        arg_path,
        maxComments: arg_maxComments,
        view: arg_view,
