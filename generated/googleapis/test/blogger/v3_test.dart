...
checkUnnamed4382(core.List<api.Post> o) {
...
checkUnnamed4383(core.List<api.BlogUserInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4384(core.List<api.Blog> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBlog(o[0]);
  checkBlog(o[1]);
}
...
buildBlogList() {
  ...
  if (buildCounterBlogList < 3) {
    o.blogUserInfos = buildUnnamed4383();
...
checkBlogList(api.BlogList o) {
  buildCounterBlogList++;
  if (buildCounterBlogList < 3) {
    checkUnnamed4383(o.blogUserInfos);
...
checkUnnamed4385(core.List<api.Comment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkComment(o[0]);
  checkComment(o[1]);
}
...
checkUnnamed4386(core.List<api.Page> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPage(o[0]);
  checkPage(o[1]);
}
...
checkUnnamed4387(core.List<api.PageviewsCounts> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4388(core.List<api.PostImages> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPostImages(o[0]);
  checkPostImages(o[1]);
}
...
checkUnnamed4390(core.List<api.Comment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkComment(o[0]);
  checkComment(o[1]);
}
...
buildPost() {
  ...
  if (buildCounterPost < 3) {
    ...
    o.etag = "foo";
    o.id = "foo";
    o.images = buildUnnamed4388();
    o.kind = "foo";
    o.labels = buildUnnamed4389();
...
checkPost(api.Post o) {
  ...
  if (buildCounterPost < 3) {
    ...
    unittest.expect(o.etag, unittest.equals('foo'));
    unittest.expect(o.id, unittest.equals('foo'));
    checkUnnamed4388(o.images);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed4389(o.labels);
...
checkUnnamed4391(core.List<api.Post> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPost(o[0]);
  checkPost(o[1]);
}
...
checkUnnamed4392(core.List<api.PostUserInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
main() {
  ...
  unittest.group("resource-BlogsResourceApi", () {
    ...
    unittest.test("method--listByUser", () {
      ...
      var arg_status = buildUnnamed4393();
      var arg_role = buildUnnamed4394();
      var arg_view = "foo";
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
  ...
  unittest.group("resource-CommentsResourceApi", () {
    ...
    unittest.test("method--listByBlog", () {
      ...
      var arg_fetchBodies = true;
      var arg_pageToken = "foo";
      var arg_status = buildUnnamed4395();
      var arg_maxResults = 42;
      var arg_startDate = "foo";
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
  ...
  unittest.group("resource-PageViewsResourceApi", () {
    unittest.test("method--get", () {
      ...
      var arg_blogId = "foo";
      var arg_range = buildUnnamed4396();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group("resource-PagesResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_blogId = "foo";
      var arg_view = "foo";
      var arg_status = buildUnnamed4397();
      var arg_fetchBodies = true;
      var arg_maxResults = 42;
      var arg_pageToken = "foo";
      var arg_$fields = "foo";
  ...
  unittest.group("resource-PostUserInfosResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_labels = "foo";
      var arg_orderBy = "foo";
      var arg_status = buildUnnamed4398();
      var arg_view = "foo";
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
  ...
  unittest.group("resource-PostsResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_labels = "foo";
      var arg_fetchImages = true;
      var arg_status = buildUnnamed4399();
      var arg_orderBy = "foo";
      var arg_startDate = "foo";
      var arg_view = "foo";
      var arg_$fields = "foo";
