...
core.List<api.CreatePermissionRequest> buildUnnamed6357() => [
      buildCreatePermissionRequest(),
      buildCreatePermissionRequest(),
    ];

void checkUnnamed6357(core.List<api.CreatePermissionRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkBatchCreatePermissionsRequest(api.BatchCreatePermissionsRequest o) {
  buildCounterBatchCreatePermissionsRequest++;
  if (buildCounterBatchCreatePermissionsRequest < 3) {
    checkUnnamed6357(o.requests!);
  }
  buildCounterBatchCreatePermissionsRequest--;
}

core.List<api.Permission> buildUnnamed6358() => [
      buildPermission(),
      buildPermission(),
    ];

void checkUnnamed6358(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0]);
  checkPermission(o[1]);
}
...
api.BatchCreatePermissionsResponse buildBatchCreatePermissionsResponse() {
  ...
  if (buildCounterBatchCreatePermissionsResponse < 3) {
    o.permissions = buildUnnamed6358();
  }
  buildCounterBatchCreatePermissionsResponse--;
  return o;
}
...
void checkBatchCreatePermissionsResponse(api.BatchCreatePermissionsResponse o) {
  buildCounterBatchCreatePermissionsResponse++;
  if (buildCounterBatchCreatePermissionsResponse < 3) {
    checkUnnamed6358(o.permissions!);
  }
  buildCounterBatchCreatePermissionsResponse--;
}
...
core.List<api.ListItem> buildUnnamed6360() => [
      buildListItem(),
      buildListItem(),
    ];

void checkUnnamed6360(core.List<api.ListItem> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkListItem(o[0]);
  checkListItem(o[1]);
}
...
void checkListContent(api.ListContent o) {
  buildCounterListContent++;
  if (buildCounterListContent < 3) {
    checkUnnamed6360(o.listItems!);
  }
  buildCounterListContent--;
}

core.List<api.ListItem> buildUnnamed6361() => [
      buildListItem(),
      buildListItem(),
    ];

void checkUnnamed6361(core.List<api.ListItem> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkListItem(o[0]);
  checkListItem(o[1]);
}
...
api.ListItem buildListItem() {
  ...
  if (buildCounterListItem < 3) {
    o.checked = true;
    o.childListItems = buildUnnamed6361();
...
void checkListItem(api.ListItem o) {
  ...
  if (buildCounterListItem < 3) {
    ...
    checkUnnamed6361(o.childListItems!);
    checkTextContent(o.text!);
  }
  buildCounterListItem--;
}

core.List<api.Note> buildUnnamed6362() => [
      buildNote(),
      buildNote(),
    ];

void checkUnnamed6362(core.List<api.Note> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNote(o[0]);
  checkNote(o[1]);
}
...
void checkListNotesResponse(api.ListNotesResponse o) {
  ...
  if (buildCounterListNotesResponse < 3) {
    ...
    checkUnnamed6362(o.notes!);
  }
  buildCounterListNotesResponse--;
}

core.List<api.Attachment> buildUnnamed6363() => [
      buildAttachment(),
      buildAttachment(),
    ];

void checkUnnamed6363(core.List<api.Attachment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachment(o[0]);
  checkAttachment(o[1]);
}

core.List<api.Permission> buildUnnamed6364() => [
      buildPermission(),
      buildPermission(),
    ];

void checkUnnamed6364(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0]);
  checkPermission(o[1]);
}
...
api.Note buildNote() {
  ...
  if (buildCounterNote < 3) {
    o.attachments = buildUnnamed6363();
    o.body = buildSection();
    o.createTime = 'foo';
    o.name = 'foo';
...
void checkNote(api.Note o) {
  buildCounterNote++;
  if (buildCounterNote < 3) {
    checkUnnamed6363(o.attachments!);
    checkSection(o.body!);
    unittest.expect(
      o.createTime!,
      unittest.equals('foo'),
