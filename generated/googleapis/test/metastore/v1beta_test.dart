...
import 'package:googleapis/metastore/v1beta.dart' as api;
...
core.int buildCounterCustomRegionConfig = 0;
api.CustomRegionConfig buildCustomRegionConfig() {
  final o = api.CustomRegionConfig();
  buildCounterCustomRegionConfig++;
  if (buildCounterCustomRegionConfig < 3) {
    o.readOnlyRegions = buildUnnamed6();
    o.readWriteRegions = buildUnnamed7();
  }
  buildCounterCustomRegionConfig--;
  return o;
}

void checkCustomRegionConfig(api.CustomRegionConfig o) {
  buildCounterCustomRegionConfig++;
  if (buildCounterCustomRegionConfig < 3) {
    checkUnnamed6(o.readOnlyRegions!);
    checkUnnamed7(o.readWriteRegions!);
  }
  buildCounterCustomRegionConfig--;
}
...
core.Map<core.String, api.Lake> buildUnnamed8() => {
  'x': buildLake(),
  'y': buildLake(),
};

void checkUnnamed8(core.Map<core.String, api.Lake> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLake(o['x']!);
  checkLake(o['y']!);
}
...
core.Map<core.String, api.BackendMetastore> buildUnnamed10() => {
  'x': buildBackendMetastore(),
  'y': buildBackendMetastore(),
};

void checkUnnamed10(core.Map<core.String, api.BackendMetastore> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Federation buildFederation() {
  ...
  if (buildCounterFederation < 3) {
    o.backendMetastores = buildUnnamed10();
    o.createTime = 'foo';
    o.endpointUri = 'foo';
...
void checkFederation(api.Federation o) {
  buildCounterFederation++;
  if (buildCounterFederation < 3) {
    checkUnnamed10(o.backendMetastores!);
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.endpointUri!, unittest.equals('foo'));
...
core.Map<core.String, api.AuxiliaryVersionConfig> buildUnnamed13() => {
  'x': buildAuxiliaryVersionConfig(),
  'y': buildAuxiliaryVersionConfig(),
};

void checkUnnamed13(core.Map<core.String, api.AuxiliaryVersionConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.HiveMetastoreConfig buildHiveMetastoreConfig() {
  ...
  if (buildCounterHiveMetastoreConfig < 3) {
    o.auxiliaryVersions = buildUnnamed13();
    o.configOverrides = buildUnnamed14();
...
void checkHiveMetastoreConfig(api.HiveMetastoreConfig o) {
  buildCounterHiveMetastoreConfig++;
  if (buildCounterHiveMetastoreConfig < 3) {
    checkUnnamed13(o.auxiliaryVersions!);
    checkUnnamed14(o.configOverrides!);
...
core.List<api.Backup> buildUnnamed15() => [buildBackup(), buildBackup()];
...
core.List<api.Federation> buildUnnamed17() => [
  buildFederation(),
  buildFederation(),
];

void checkUnnamed17(core.List<api.Federation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFederation(o[0]);
  checkFederation(o[1]);
}
...
core.List<api.MetadataImport> buildUnnamed20() => [
  buildMetadataImport(),
  buildMetadataImport(),
];

void checkUnnamed20(core.List<api.MetadataImport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListMetadataImportsResponse buildListMetadataImportsResponse() {
  ...
  if (buildCounterListMetadataImportsResponse < 3) {
    o.metadataImports = buildUnnamed20();
    o.nextPageToken = 'foo';
...
void checkListMetadataImportsResponse(api.ListMetadataImportsResponse o) {
  buildCounterListMetadataImportsResponse++;
  if (buildCounterListMetadataImportsResponse < 3) {
    checkUnnamed20(o.metadataImports!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
...
core.List<api.MigrationExecution> buildUnnamed22() => [
  buildMigrationExecution(),
  buildMigrationExecution(),
];

void checkUnnamed22(core.List<api.MigrationExecution> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListMigrationExecutionsResponse buildListMigrationExecutionsResponse() {
  ...
  if (buildCounterListMigrationExecutionsResponse < 3) {
    o.migrationExecutions = buildUnnamed22();
    o.nextPageToken = 'foo';
...
void checkListMigrationExecutionsResponse(
  ...
  buildCounterListMigrationExecutionsResponse++;
  if (buildCounterListMigrationExecutionsResponse < 3) {
    checkUnnamed22(o.migrationExecutions!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
...
core.List<api.RootCACertificate> buildUnnamed31() => [
  buildRootCACertificate(),
  buildRootCACertificate(),
];

void checkUnnamed31(core.List<api.RootCACertificate> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRootCACertificate(o[0]);
  checkRootCACertificate(o[1]);
}

core.int buildCounterMultiRegionConfig = 0;
api.MultiRegionConfig buildMultiRegionConfig() {
  final o = api.MultiRegionConfig();
  buildCounterMultiRegionConfig++;
  if (buildCounterMultiRegionConfig < 3) {
    o.certificates = buildUnnamed31();
    o.customRegionConfig = buildCustomRegionConfig();
  }
  buildCounterMultiRegionConfig--;
  return o;
}

void checkMultiRegionConfig(api.MultiRegionConfig o) {
  buildCounterMultiRegionConfig++;
  if (buildCounterMultiRegionConfig < 3) {
    checkUnnamed31(o.certificates!);
    checkCustomRegionConfig(o.customRegionConfig!);
  }
  buildCounterMultiRegionConfig--;
}
...
void checkNetworkConfig(api.NetworkConfig o) {
  ...
  if (buildCounterNetworkConfig < 3) {
    ...
    unittest.expect(o.customRoutesEnabled!, unittest.isTrue);
  }
  buildCounterNetworkConfig--;
}
...
core.int buildCounterRootCACertificate = 0;
api.RootCACertificate buildRootCACertificate() {
  final o = api.RootCACertificate();
  buildCounterRootCACertificate++;
  if (buildCounterRootCACertificate < 3) {
    o.certificate = 'foo';
...
void checkRootCACertificate(api.RootCACertificate o) {
  buildCounterRootCACertificate++;
  if (buildCounterRootCACertificate < 3) {
...
api.Service buildService() {
  ...
  if (buildCounterService < 3) {
    ...
    o.multiRegionConfig = buildMultiRegionConfig();
    o.name = 'foo';
    o.network = 'foo';
    o.networkConfig = buildNetworkConfig();
    o.port = 42;
...
void checkService(api.Service o) {
  ...
  if (buildCounterService < 3) {
    ...
    checkMultiRegionConfig(o.multiRegionConfig!);
    unittest.expect(o.name!, unittest.equals('foo'));
...
void main() {
  ...
  unittest.group('obj-schema-CustomRegionConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCustomRegionConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CustomRegionConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCustomRegionConfig(od);
    });
  });
  ...
  unittest.group('obj-schema-MultiRegionConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildMultiRegionConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.MultiRegionConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkMultiRegionConfig(od);
    });
  });
  ...
  unittest.group('obj-schema-RootCACertificate', () {
    unittest.test('to-json--from-json', () async {
      final o = buildRootCACertificate();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.RootCACertificate.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkRootCACertificate(od);
    });
  });
  ...
  unittest.group('resource-ProjectsLocationsServicesResource', () {
    ...
    unittest.test('method--removeIamPolicy', () async {
      ...
      final response = await res.removeIamPolicy(
        arg_request,
        arg_resource,
        $fields: arg_$fields,
      );
