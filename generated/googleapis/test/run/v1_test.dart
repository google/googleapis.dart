...
core.int buildCounterCSIVolumeSource = 0;
api.CSIVolumeSource buildCSIVolumeSource() {
  final o = api.CSIVolumeSource();
  buildCounterCSIVolumeSource++;
  if (buildCounterCSIVolumeSource < 3) {
    o.driver = 'foo';
    o.readOnly = true;
    o.volumeAttributes = buildUnnamed3();
  }
  buildCounterCSIVolumeSource--;
  return o;
}

void checkCSIVolumeSource(api.CSIVolumeSource o) {
  buildCounterCSIVolumeSource++;
  if (buildCounterCSIVolumeSource < 3) {
    unittest.expect(o.driver!, unittest.equals('foo'));
    unittest.expect(o.readOnly!, unittest.isTrue);
    checkUnnamed3(o.volumeAttributes!);
  }
  buildCounterCSIVolumeSource--;
}
...
core.List<api.KeyToPath> buildUnnamed4() => [
  buildKeyToPath(),
  buildKeyToPath(),
];

void checkUnnamed4(core.List<api.KeyToPath> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkKeyToPath(o[0]);
  checkKeyToPath(o[1]);
}
...
core.List<api.GoogleCloudRunV1Condition> buildUnnamed5() => [
  buildGoogleCloudRunV1Condition(),
  buildGoogleCloudRunV1Condition(),
];

void checkUnnamed5(core.List<api.GoogleCloudRunV1Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.EnvVar> buildUnnamed8() => [buildEnvVar(), buildEnvVar()];

void checkUnnamed8(core.List<api.EnvVar> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEnvVar(o[0]);
  checkEnvVar(o[1]);
}

core.List<api.EnvFromSource> buildUnnamed9() => [
  buildEnvFromSource(),
  buildEnvFromSource(),
];

void checkUnnamed9(core.List<api.EnvFromSource> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEnvFromSource(o[0]);
  checkEnvFromSource(o[1]);
}

core.List<api.ContainerPort> buildUnnamed10() => [
  buildContainerPort(),
  buildContainerPort(),
];

void checkUnnamed10(core.List<api.ContainerPort> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContainerPort(o[0]);
  checkContainerPort(o[1]);
}

core.List<api.VolumeMount> buildUnnamed11() => [
  buildVolumeMount(),
  buildVolumeMount(),
];

void checkUnnamed11(core.List<api.VolumeMount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Container buildContainer() {
  ...
  if (buildCounterContainer < 3) {
    o.args = buildUnnamed6();
    o.command = buildUnnamed7();
    o.env = buildUnnamed8();
    o.envFrom = buildUnnamed9();
    o.image = 'foo';
...
void checkContainer(api.Container o) {
  buildCounterContainer++;
  if (buildCounterContainer < 3) {
    checkUnnamed6(o.args!);
    checkUnnamed7(o.command!);
    checkUnnamed8(o.env!);
    checkUnnamed9(o.envFrom!);
...
core.List<api.EnvVar> buildUnnamed13() => [buildEnvVar(), buildEnvVar()];

void checkUnnamed13(core.List<api.EnvVar> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEnvVar(o[0]);
  checkEnvVar(o[1]);
}

core.int buildCounterContainerOverride = 0;
api.ContainerOverride buildContainerOverride() {
  final o = api.ContainerOverride();
...
void checkContainerOverride(api.ContainerOverride o) {
  buildCounterContainerOverride++;
  if (buildCounterContainerOverride < 3) {
...
core.List<api.ResourceRecord> buildUnnamed15() => [
  buildResourceRecord(),
  buildResourceRecord(),
];

void checkUnnamed15(core.List<api.ResourceRecord> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DomainMappingStatus buildDomainMappingStatus() {
  ...
  if (buildCounterDomainMappingStatus < 3) {
    ...
    o.observedGeneration = 42;
    o.resourceRecords = buildUnnamed15();
    o.url = 'foo';
  }
  buildCounterDomainMappingStatus--;
  return o;
...
void checkDomainMappingStatus(api.DomainMappingStatus o) {
  ...
  if (buildCounterDomainMappingStatus < 3) {
    ...
    unittest.expect(o.observedGeneration!, unittest.equals(42));
    checkUnnamed15(o.resourceRecords!);
    unittest.expect(o.url!, unittest.equals('foo'));
  }
  buildCounterDomainMappingStatus--;
}
...
void checkExecutionReference(api.ExecutionReference o) {
  ...
  if (buildCounterExecutionReference < 3) {
    ...
    unittest.expect(o.completionTimestamp!, unittest.equals('foo'));
...
core.List<api.GoogleCloudRunV1Condition> buildUnnamed17() => [
  buildGoogleCloudRunV1Condition(),
  buildGoogleCloudRunV1Condition(),
];

void checkUnnamed17(core.List<api.GoogleCloudRunV1Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV1Condition(o[0]);
  checkGoogleCloudRunV1Condition(o[1]);
}
...
core.List<api.HTTPHeader> buildUnnamed24() => [
  buildHTTPHeader(),
  buildHTTPHeader(),
];

void checkUnnamed24(core.List<api.HTTPHeader> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHTTPHeader(o[0]);
  checkHTTPHeader(o[1]);
}
...
api.Instance buildInstance() {
  ...
  if (buildCounterInstance < 3) {
    ...
    o.kind = 'foo';
    o.metadata = buildObjectMeta();
    o.spec = buildInstanceSpec();
    o.status = buildInstanceStatus();
  }
  buildCounterInstance--;
  return o;
}
...
void checkInstance(api.Instance o) {
  ...
  if (buildCounterInstance < 3) {
    ...
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkObjectMeta(o.metadata!);
    checkInstanceSpec(o.spec!);
    checkInstanceStatus(o.status!);
  }
  buildCounterInstance--;
}

core.List<api.Container> buildUnnamed25() => [
  buildContainer(),
  buildContainer(),
];

void checkUnnamed25(core.List<api.Container> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContainer(o[0]);
  checkContainer(o[1]);
}
...
core.List<api.Volume> buildUnnamed27() => [buildVolume(), buildVolume()];
...
core.int buildCounterInstanceSpec = 0;
api.InstanceSpec buildInstanceSpec() {
  final o = api.InstanceSpec();
...
void checkInstanceSpec(api.InstanceSpec o) {
  buildCounterInstanceSpec++;
  if (buildCounterInstanceSpec < 3) {
...
core.int buildCounterInstanceSplit = 0;
api.InstanceSplit buildInstanceSplit() {
  final o = api.InstanceSplit();
  buildCounterInstanceSplit++;
  if (buildCounterInstanceSplit < 3) {
...
void checkInstanceSplit(api.InstanceSplit o) {
  buildCounterInstanceSplit++;
  if (buildCounterInstanceSplit < 3) {
...
core.List<api.GoogleCloudRunV1Condition> buildUnnamed28() => [
  buildGoogleCloudRunV1Condition(),
  buildGoogleCloudRunV1Condition(),
];

void checkUnnamed28(core.List<api.GoogleCloudRunV1Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV1Condition(o[0]);
  checkGoogleCloudRunV1Condition(o[1]);
}
...
core.List<api.GoogleCloudRunV1Condition> buildUnnamed30() => [
  buildGoogleCloudRunV1Condition(),
  buildGoogleCloudRunV1Condition(),
];

void checkUnnamed30(core.List<api.GoogleCloudRunV1Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV1Condition(o[0]);
  checkGoogleCloudRunV1Condition(o[1]);
}
...
core.List<api.AuthorizedDomain> buildUnnamed31() => [
  buildAuthorizedDomain(),
  buildAuthorizedDomain(),
];

void checkUnnamed31(core.List<api.AuthorizedDomain> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Configuration> buildUnnamed32() => [
  buildConfiguration(),
  buildConfiguration(),
];

void checkUnnamed32(core.List<api.Configuration> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.DomainMapping> buildUnnamed34() => [
  buildDomainMapping(),
  buildDomainMapping(),
];

void checkUnnamed34(core.List<api.DomainMapping> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Execution> buildUnnamed36() => [
  buildExecution(),
  buildExecution(),
];

void checkUnnamed36(core.List<api.Execution> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkExecution(o[0]);
  checkExecution(o[1]);
}
...
core.List<api.Instance> buildUnnamed38() => [buildInstance(), buildInstance()];

void checkUnnamed38(core.List<api.Instance> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInstance(o[0]);
  checkInstance(o[1]);
}
...
core.List<api.Job> buildUnnamed40() => [buildJob(), buildJob()];

void checkUnnamed40(core.List<api.Job> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJob(o[0]);
  checkJob(o[1]);
}
...
core.List<api.Revision> buildUnnamed43() => [buildRevision(), buildRevision()];

void checkUnnamed43(core.List<api.Revision> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRevision(o[0]);
  checkRevision(o[1]);
}
...
core.List<api.Route> buildUnnamed45() => [buildRoute(), buildRoute()];

void checkUnnamed45(core.List<api.Route> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRoute(o[0]);
  checkRoute(o[1]);
}
...
core.List<api.Task> buildUnnamed49() => [buildTask(), buildTask()];

void checkUnnamed49(core.List<api.Task> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTask(o[0]);
  checkTask(o[1]);
}
...
core.List<api.WorkerPool> buildUnnamed51() => [
  buildWorkerPool(),
  buildWorkerPool(),
];

void checkUnnamed51(core.List<api.WorkerPool> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWorkerPool(o[0]);
  checkWorkerPool(o[1]);
}
...
core.int buildCounterNFSVolumeSource = 0;
api.NFSVolumeSource buildNFSVolumeSource() {
  final o = api.NFSVolumeSource();
  buildCounterNFSVolumeSource++;
  if (buildCounterNFSVolumeSource < 3) {
    o.path = 'foo';
    o.readOnly = true;
    o.server = 'foo';
  }
...
void checkNFSVolumeSource(api.NFSVolumeSource o) {
  buildCounterNFSVolumeSource++;
  if (buildCounterNFSVolumeSource < 3) {
    unittest.expect(o.path!, unittest.equals('foo'));
    unittest.expect(o.readOnly!, unittest.isTrue);
...
core.List<api.OwnerReference> buildUnnamed58() => [
  buildOwnerReference(),
  buildOwnerReference(),
];

void checkUnnamed58(core.List<api.OwnerReference> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ObjectMeta buildObjectMeta() {
  ...
  if (buildCounterObjectMeta < 3) {
    ...
    o.deletionTimestamp = 'foo';
    o.finalizers = buildUnnamed56();
    o.generateName = 'foo';
    o.generation = 42;
    o.labels = buildUnnamed57();
    o.name = 'foo';
    o.namespace = 'foo';
    o.ownerReferences = buildUnnamed58();
    o.resourceVersion = 'foo';
    o.selfLink = 'foo';
    o.uid = 'foo';
  }
...
void checkObjectMeta(api.ObjectMeta o) {
  ...
  if (buildCounterObjectMeta < 3) {
    ...
    checkUnnamed58(o.ownerReferences!);
    unittest.expect(o.resourceVersion!, unittest.equals('foo'));
    unittest.expect(o.selfLink!, unittest.equals('foo'));
...
core.List<api.ContainerOverride> buildUnnamed59() => [
  buildContainerOverride(),
  buildContainerOverride(),
];

void checkUnnamed59(core.List<api.ContainerOverride> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContainerOverride(o[0]);
  checkContainerOverride(o[1]);
}

core.int buildCounterOverrides = 0;
api.Overrides buildOverrides() {
  final o = api.Overrides();
...
void checkOverrides(api.Overrides o) {
  buildCounterOverrides++;
  if (buildCounterOverrides < 3) {
...
core.List<api.Binding> buildUnnamed61() => [buildBinding(), buildBinding()];
...
api.ResourceRequirements buildResourceRequirements() {
  ...
  if (buildCounterResourceRequirements < 3) {
    o.limits = buildUnnamed62();
    o.requests = buildUnnamed63();
  }
  buildCounterResourceRequirements--;
  return o;
}
...
void checkResourceRequirements(api.ResourceRequirements o) {
  buildCounterResourceRequirements++;
  if (buildCounterResourceRequirements < 3) {
    checkUnnamed62(o.limits!);
    checkUnnamed63(o.requests!);
  }
  buildCounterResourceRequirements--;
}
...
core.List<api.Container> buildUnnamed64() => [
  buildContainer(),
  buildContainer(),
];

void checkUnnamed64(core.List<api.Container> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContainer(o[0]);
  checkContainer(o[1]);
}

core.List<api.LocalObjectReference> buildUnnamed65() => [
  buildLocalObjectReference(),
  buildLocalObjectReference(),
];

void checkUnnamed65(core.List<api.LocalObjectReference> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Volume> buildUnnamed67() => [buildVolume(), buildVolume()];

void checkUnnamed67(core.List<api.Volume> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVolume(o[0]);
  checkVolume(o[1]);
}
...
api.RevisionSpec buildRevisionSpec() {
  ...
  if (buildCounterRevisionSpec < 3) {
    ...
    o.imagePullSecrets = buildUnnamed65();
    o.nodeSelector = buildUnnamed66();
...
void checkRevisionSpec(api.RevisionSpec o) {
  ...
  if (buildCounterRevisionSpec < 3) {
    ...
    checkUnnamed65(o.imagePullSecrets!);
    checkUnnamed66(o.nodeSelector!);
    unittest.expect(o.runtimeClassName!, unittest.equals('foo'));
    unittest.expect(o.serviceAccountName!, unittest.equals('foo'));
    unittest.expect(o.timeoutSeconds!, unittest.equals(42));
...
core.List<api.GoogleCloudRunV1Condition> buildUnnamed68() => [
  buildGoogleCloudRunV1Condition(),
  buildGoogleCloudRunV1Condition(),
];

void checkUnnamed68(core.List<api.GoogleCloudRunV1Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV1Condition(o[0]);
  checkGoogleCloudRunV1Condition(o[1]);
}
...
void checkRevisionStatus(api.RevisionStatus o) {
  ...
  if (buildCounterRevisionStatus < 3) {
    ...
    unittest.expect(o.desiredReplicas!, unittest.equals(42));
...
core.List<api.TrafficTarget> buildUnnamed69() => [
  buildTrafficTarget(),
  buildTrafficTarget(),
];

void checkUnnamed69(core.List<api.TrafficTarget> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkRouteSpec(api.RouteSpec o) {
  buildCounterRouteSpec++;
  if (buildCounterRouteSpec < 3) {
    checkUnnamed69(o.traffic!);
  }
  buildCounterRouteSpec--;
}

core.List<api.GoogleCloudRunV1Condition> buildUnnamed70() => [
  buildGoogleCloudRunV1Condition(),
  buildGoogleCloudRunV1Condition(),
];

void checkUnnamed70(core.List<api.GoogleCloudRunV1Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV1Condition(o[0]);
  checkGoogleCloudRunV1Condition(o[1]);
}

core.List<api.TrafficTarget> buildUnnamed71() => [
  buildTrafficTarget(),
  buildTrafficTarget(),
];

void checkUnnamed71(core.List<api.TrafficTarget> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTrafficTarget(o[0]);
  checkTrafficTarget(o[1]);
}
...
core.List<api.KeyToPath> buildUnnamed72() => [
  buildKeyToPath(),
  buildKeyToPath(),
];

void checkUnnamed72(core.List<api.KeyToPath> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkKeyToPath(o[0]);
  checkKeyToPath(o[1]);
}
...
core.List<api.TrafficTarget> buildUnnamed73() => [
  buildTrafficTarget(),
  buildTrafficTarget(),
];

void checkUnnamed73(core.List<api.TrafficTarget> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTrafficTarget(o[0]);
  checkTrafficTarget(o[1]);
}
...
void checkServiceSpec(api.ServiceSpec o) {
  ...
  if (buildCounterServiceSpec < 3) {
    checkRevisionTemplate(o.template!);
    checkUnnamed73(o.traffic!);
  }
  buildCounterServiceSpec--;
}

core.List<api.GoogleCloudRunV1Condition> buildUnnamed74() => [
  buildGoogleCloudRunV1Condition(),
  buildGoogleCloudRunV1Condition(),
];

void checkUnnamed74(core.List<api.GoogleCloudRunV1Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV1Condition(o[0]);
  checkGoogleCloudRunV1Condition(o[1]);
}

core.List<api.TrafficTarget> buildUnnamed75() => [
  buildTrafficTarget(),
  buildTrafficTarget(),
];

void checkUnnamed75(core.List<api.TrafficTarget> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTrafficTarget(o[0]);
  checkTrafficTarget(o[1]);
}
...
core.List<api.StatusCause> buildUnnamed76() => [
  buildStatusCause(),
  buildStatusCause(),
];

void checkUnnamed76(core.List<api.StatusCause> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Container> buildUnnamed77() => [
  buildContainer(),
  buildContainer(),
];

void checkUnnamed77(core.List<api.Container> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContainer(o[0]);
  checkContainer(o[1]);
}
...
core.List<api.Volume> buildUnnamed79() => [buildVolume(), buildVolume()];

void checkUnnamed79(core.List<api.Volume> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVolume(o[0]);
  checkVolume(o[1]);
}
...
api.TaskSpec buildTaskSpec() {
  ...
  if (buildCounterTaskSpec < 3) {
    ...
    o.maxRetries = 42;
    o.nodeSelector = buildUnnamed78();
    o.serviceAccountName = 'foo';
    o.timeoutSeconds = 'foo';
    o.volumes = buildUnnamed79();
  }
  buildCounterTaskSpec--;
  return o;
}
...
void checkTaskSpec(api.TaskSpec o) {
  ...
  if (buildCounterTaskSpec < 3) {
    ...
    checkUnnamed78(o.nodeSelector!);
    unittest.expect(o.serviceAccountName!, unittest.equals('foo'));
    unittest.expect(o.timeoutSeconds!, unittest.equals('foo'));
    checkUnnamed79(o.volumes!);
  }
  buildCounterTaskSpec--;
}

core.List<api.GoogleCloudRunV1Condition> buildUnnamed80() => [
  buildGoogleCloudRunV1Condition(),
  buildGoogleCloudRunV1Condition(),
];

void checkUnnamed80(core.List<api.GoogleCloudRunV1Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV1Condition(o[0]);
  checkGoogleCloudRunV1Condition(o[1]);
}
...
api.Volume buildVolume() {
  ...
  if (buildCounterVolume < 3) {
    ...
    o.csi = buildCSIVolumeSource();
    o.emptyDir = buildEmptyDirVolumeSource();
    o.name = 'foo';
    o.nfs = buildNFSVolumeSource();
...
void checkVolume(api.Volume o) {
  ...
  if (buildCounterVolume < 3) {
    ...
    checkCSIVolumeSource(o.csi!);
    checkEmptyDirVolumeSource(o.emptyDir!);
    unittest.expect(o.name!, unittest.equals('foo'));
    checkNFSVolumeSource(o.nfs!);
...
api.WorkerPool buildWorkerPool() {
  ...
  if (buildCounterWorkerPool < 3) {
    ...
    o.kind = 'foo';
    o.metadata = buildObjectMeta();
    o.spec = buildWorkerPoolSpec();
    o.status = buildWorkerPoolStatus();
  }
  buildCounterWorkerPool--;
  return o;
}
...
void checkWorkerPool(api.WorkerPool o) {
  ...
  if (buildCounterWorkerPool < 3) {
    ...
    unittest.expect(o.kind!, unittest.equals('foo'));
    checkObjectMeta(o.metadata!);
    checkWorkerPoolSpec(o.spec!);
    checkWorkerPoolStatus(o.status!);
  }
  buildCounterWorkerPool--;
}

core.List<api.InstanceSplit> buildUnnamed83() => [
  buildInstanceSplit(),
  buildInstanceSplit(),
];

void checkUnnamed83(core.List<api.InstanceSplit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInstanceSplit(o[0]);
  checkInstanceSplit(o[1]);
}

core.int buildCounterWorkerPoolSpec = 0;
api.WorkerPoolSpec buildWorkerPoolSpec() {
  final o = api.WorkerPoolSpec();
  buildCounterWorkerPoolSpec++;
  if (buildCounterWorkerPoolSpec < 3) {
    o.instanceSplits = buildUnnamed83();
    o.template = buildRevisionTemplate();
  }
  buildCounterWorkerPoolSpec--;
  return o;
...
void checkWorkerPoolSpec(api.WorkerPoolSpec o) {
  buildCounterWorkerPoolSpec++;
  if (buildCounterWorkerPoolSpec < 3) {
    checkUnnamed83(o.instanceSplits!);
    checkRevisionTemplate(o.template!);
  }
  buildCounterWorkerPoolSpec--;
}

core.List<api.GoogleCloudRunV1Condition> buildUnnamed84() => [
  buildGoogleCloudRunV1Condition(),
  buildGoogleCloudRunV1Condition(),
];

void checkUnnamed84(core.List<api.GoogleCloudRunV1Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV1Condition(o[0]);
  checkGoogleCloudRunV1Condition(o[1]);
}

core.List<api.InstanceSplit> buildUnnamed85() => [
  buildInstanceSplit(),
  buildInstanceSplit(),
];

void checkUnnamed85(core.List<api.InstanceSplit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInstanceSplit(o[0]);
  checkInstanceSplit(o[1]);
}

core.int buildCounterWorkerPoolStatus = 0;
api.WorkerPoolStatus buildWorkerPoolStatus() {
  final o = api.WorkerPoolStatus();
  buildCounterWorkerPoolStatus++;
  if (buildCounterWorkerPoolStatus < 3) {
    o.conditions = buildUnnamed84();
    o.instanceSplits = buildUnnamed85();
    o.latestCreatedRevisionName = 'foo';
    o.latestReadyRevisionName = 'foo';
    o.observedGeneration = 42;
  }
...
void checkWorkerPoolStatus(api.WorkerPoolStatus o) {
  buildCounterWorkerPoolStatus++;
  if (buildCounterWorkerPoolStatus < 3) {
    checkUnnamed84(o.conditions!);
    checkUnnamed85(o.instanceSplits!);
    unittest.expect(o.latestCreatedRevisionName!, unittest.equals('foo'));
    unittest.expect(o.latestReadyRevisionName!, unittest.equals('foo'));
    unittest.expect(o.observedGeneration!, unittest.equals(42));
  }
...
void main() {
  ...
  unittest.group('obj-schema-CSIVolumeSource', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCSIVolumeSource();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CSIVolumeSource.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCSIVolumeSource(od);
    });
  });
  ...
  unittest.group('obj-schema-ContainerOverride', () {
    unittest.test('to-json--from-json', () async {
      final o = buildContainerOverride();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ContainerOverride.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkContainerOverride(od);
    });
  });
  ...
  unittest.group('obj-schema-ExecAction', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ExecAction.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkExecAction(od);
    });
  ...
  unittest.group('obj-schema-GRPCAction', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GRPCAction.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGRPCAction(od);
    });
  ...
  unittest.group('obj-schema-InstanceSpec', () {
    unittest.test('to-json--from-json', () async {
      final o = buildInstanceSpec();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.InstanceSpec.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkInstanceSpec(od);
    });
  });

  unittest.group('obj-schema-InstanceSplit', () {
    unittest.test('to-json--from-json', () async {
      final o = buildInstanceSplit();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.InstanceSplit.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkInstanceSplit(od);
    });
  });
  ...
  unittest.group('obj-schema-KeyToPath', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.KeyToPath.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkKeyToPath(od);
    });
  ...
  unittest.group('obj-schema-ListMeta', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListMeta.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkListMeta(od);
    });
  ...
  unittest.group('obj-schema-NFSVolumeSource', () {
    unittest.test('to-json--from-json', () async {
      final o = buildNFSVolumeSource();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.NFSVolumeSource.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkNFSVolumeSource(od);
    });
  });
  ...
  unittest.group('obj-schema-ObjectMeta', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ObjectMeta.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkObjectMeta(od);
    });
  ...
  unittest.group('obj-schema-Overrides', () {
    unittest.test('to-json--from-json', () async {
      final o = buildOverrides();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Overrides.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkOverrides(od);
    });
  ...
  unittest.group('obj-schema-RouteSpec', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.RouteSpec.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkRouteSpec(od);
    });
  ...
  unittest.group('obj-schema-WorkerPoolSpec', () {
    unittest.test('to-json--from-json', () async {
      final o = buildWorkerPoolSpec();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.WorkerPoolSpec.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkWorkerPoolSpec(od);
    });
  });

  unittest.group('obj-schema-WorkerPoolStatus', () {
    unittest.test('to-json--from-json', () async {
      final o = buildWorkerPoolStatus();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.WorkerPoolStatus.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkWorkerPoolStatus(od);
    });
  });
  ...
  unittest.group('resource-NamespacesInstancesResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
    ...
    unittest.test('method--replaceInstance', () async {
      final mock = HttpServerMock();
      final res = api.CloudRunApi(mock).namespaces.instances;
      final arg_request = buildInstance();
      final arg_name = 'foo';
  ...
  unittest.group('resource-NamespacesServicesResource', () {
    ...
    unittest.test('method--replaceService', () async {
      ...
      final response = await res.replaceService(
        arg_request,
        arg_name,
        dryRun: arg_dryRun,
        $fields: arg_$fields,
  ...
  unittest.group('resource-NamespacesWorkerpoolsResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.CloudRunApi(mock).namespaces.workerpools;
    ...
    unittest.test('method--replaceWorkerPool', () async {
      final mock = HttpServerMock();
      final res = api.CloudRunApi(mock).namespaces.workerpools;
      final arg_request = buildWorkerPool();
      final arg_name = 'foo';
      ...
      final response = await res.replaceWorkerPool(
        arg_request,
        arg_name,
        dryRun: arg_dryRun,
        $fields: arg_$fields,
  ...
  unittest.group('resource-ProjectsLocationsResource', () {
    unittest.test('method--list', () async {
      ...
      final arg_name = 'foo';
      final arg_extraLocationTypes = buildUnnamed86();
