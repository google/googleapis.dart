...
core.List<api.AuditLogConfig> buildUnnamed1050() => [
      buildAuditLogConfig(),
      buildAuditLogConfig(),
    ];

void checkUnnamed1050(core.List<api.AuditLogConfig> o) {
...
api.AuditConfig buildAuditConfig() {
  ...
  if (buildCounterAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed1050();
    o.service = 'foo';
  }
  buildCounterAuditConfig--;
  return o;
...
void checkAuditConfig(api.AuditConfig o) {
  buildCounterAuditConfig++;
  if (buildCounterAuditConfig < 3) {
    checkUnnamed1050(o.auditLogConfigs!);
    unittest.expect(
      o.service!,
      unittest.equals('foo'),
    );
...
core.List<core.String> buildUnnamed1051() => [
      'foo',
      'foo',
    ];

void checkUnnamed1051(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.AuditLogConfig buildAuditLogConfig() {
  ...
  if (buildCounterAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed1051();
    o.logType = 'foo';
  }
  buildCounterAuditLogConfig--;
  return o;
...
void checkAuditLogConfig(api.AuditLogConfig o) {
  buildCounterAuditLogConfig++;
  if (buildCounterAuditLogConfig < 3) {
    checkUnnamed1051(o.exemptedMembers!);
    unittest.expect(
      o.logType!,
      unittest.equals('foo'),
    );
...
core.List<api.KeyToPath> buildUnnamed1053() => [
      buildKeyToPath(),
      buildKeyToPath(),
    ];

void checkUnnamed1053(core.List<api.KeyToPath> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkKeyToPath(o[0]);
  checkKeyToPath(o[1]);
}
...
core.List<api.GoogleCloudRunV1Condition> buildUnnamed1054() => [
      buildGoogleCloudRunV1Condition(),
      buildGoogleCloudRunV1Condition(),
    ];

void checkUnnamed1054(core.List<api.GoogleCloudRunV1Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.String> buildUnnamed1055() => [
      'foo',
      'foo',
    ];

void checkUnnamed1055(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<core.String> buildUnnamed1056() => [
      'foo',
      'foo',
    ];

void checkUnnamed1056(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.EnvVar> buildUnnamed1057() => [
      buildEnvVar(),
      buildEnvVar(),
    ];

void checkUnnamed1057(core.List<api.EnvVar> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEnvVar(o[0]);
  checkEnvVar(o[1]);
}

core.List<api.EnvFromSource> buildUnnamed1058() => [
      buildEnvFromSource(),
      buildEnvFromSource(),
    ];

void checkUnnamed1058(core.List<api.EnvFromSource> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEnvFromSource(o[0]);
  checkEnvFromSource(o[1]);
}

core.List<api.ContainerPort> buildUnnamed1059() => [
      buildContainerPort(),
      buildContainerPort(),
    ];

void checkUnnamed1059(core.List<api.ContainerPort> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContainerPort(o[0]);
  checkContainerPort(o[1]);
}

core.List<api.VolumeMount> buildUnnamed1060() => [
      buildVolumeMount(),
      buildVolumeMount(),
    ];

void checkUnnamed1060(core.List<api.VolumeMount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Container buildContainer() {
  ...
  if (buildCounterContainer < 3) {
    o.args = buildUnnamed1055();
    o.command = buildUnnamed1056();
    o.env = buildUnnamed1057();
    o.envFrom = buildUnnamed1058();
    o.image = 'foo';
    o.imagePullPolicy = 'foo';
    o.livenessProbe = buildProbe();
    o.name = 'foo';
    o.ports = buildUnnamed1059();
    ...
    o.volumeMounts = buildUnnamed1060();
    o.workingDir = 'foo';
  }
  buildCounterContainer--;
  return o;
...
void checkContainer(api.Container o) {
  buildCounterContainer++;
  if (buildCounterContainer < 3) {
    checkUnnamed1055(o.args!);
    checkUnnamed1056(o.command!);
    checkUnnamed1057(o.env!);
    checkUnnamed1058(o.envFrom!);
    unittest.expect(
      o.image!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed1060(o.volumeMounts!);
    unittest.expect(
      o.workingDir!,
      unittest.equals('foo'),
    );
...
core.List<api.GoogleCloudRunV1Condition> buildUnnamed1061() => [
      buildGoogleCloudRunV1Condition(),
      buildGoogleCloudRunV1Condition(),
    ];

void checkUnnamed1061(core.List<api.GoogleCloudRunV1Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV1Condition(o[0]);
  checkGoogleCloudRunV1Condition(o[1]);
}

core.List<api.ResourceRecord> buildUnnamed1062() => [
      buildResourceRecord(),
      buildResourceRecord(),
    ];

void checkUnnamed1062(core.List<api.ResourceRecord> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DomainMappingStatus buildDomainMappingStatus() {
  ...
  if (buildCounterDomainMappingStatus < 3) {
    ...
    o.observedGeneration = 42;
    o.resourceRecords = buildUnnamed1062();
    o.url = 'foo';
  }
  buildCounterDomainMappingStatus--;
  return o;
...
void checkDomainMappingStatus(api.DomainMappingStatus o) {
  ...
  if (buildCounterDomainMappingStatus < 3) {
    ...
    checkUnnamed1062(o.resourceRecords!);
    unittest.expect(
      o.url!,
      unittest.equals('foo'),
    );
...
void checkUnnamed1063(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.HTTPHeader> buildUnnamed1064() => [
      buildHTTPHeader(),
      buildHTTPHeader(),
    ];

void checkUnnamed1064(core.List<api.HTTPHeader> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHTTPHeader(o[0]);
  checkHTTPHeader(o[1]);
}
...
api.HTTPGetAction buildHTTPGetAction() {
  ...
  if (buildCounterHTTPGetAction < 3) {
    o.host = 'foo';
    o.httpHeaders = buildUnnamed1064();
    o.path = 'foo';
    o.scheme = 'foo';
  }
  buildCounterHTTPGetAction--;
...
void checkHTTPGetAction(api.HTTPGetAction o) {
  ...
  if (buildCounterHTTPGetAction < 3) {
    ...
    checkUnnamed1064(o.httpHeaders!);
    unittest.expect(
      o.path!,
      unittest.equals('foo'),
    );
...
core.List<api.AuthorizedDomain> buildUnnamed1065() => [
      buildAuthorizedDomain(),
      buildAuthorizedDomain(),
    ];

void checkUnnamed1065(core.List<api.AuthorizedDomain> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Configuration> buildUnnamed1066() => [
      buildConfiguration(),
      buildConfiguration(),
    ];

void checkUnnamed1066(core.List<api.Configuration> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkConfiguration(o[0]);
  checkConfiguration(o[1]);
}

core.List<core.String> buildUnnamed1067() => [
      'foo',
      'foo',
    ];

void checkUnnamed1067(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.ListConfigurationsResponse buildListConfigurationsResponse() {
  ...
  if (buildCounterListConfigurationsResponse < 3) {
    ...
    o.unreachable = buildUnnamed1067();
  }
  buildCounterListConfigurationsResponse--;
  return o;
}
...
void checkListConfigurationsResponse(api.ListConfigurationsResponse o) {
  ...
  if (buildCounterListConfigurationsResponse < 3) {
    ...
    checkUnnamed1067(o.unreachable!);
  }
  buildCounterListConfigurationsResponse--;
}

core.List<api.DomainMapping> buildUnnamed1068() => [
      buildDomainMapping(),
      buildDomainMapping(),
    ];

void checkUnnamed1068(core.List<api.DomainMapping> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDomainMapping(o[0]);
  checkDomainMapping(o[1]);
}

core.List<core.String> buildUnnamed1069() => [
      'foo',
      'foo',
    ];

void checkUnnamed1069(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.ListDomainMappingsResponse buildListDomainMappingsResponse() {
  ...
  if (buildCounterListDomainMappingsResponse < 3) {
    ...
    o.kind = 'foo';
    o.metadata = buildListMeta();
    o.unreachable = buildUnnamed1069();
  }
  buildCounterListDomainMappingsResponse--;
  return o;
}
...
void checkListDomainMappingsResponse(api.ListDomainMappingsResponse o) {
  ...
  if (buildCounterListDomainMappingsResponse < 3) {
    ...
    checkListMeta(o.metadata!);
    checkUnnamed1069(o.unreachable!);
  }
  buildCounterListDomainMappingsResponse--;
}

core.List<api.Location> buildUnnamed1070() => [
      buildLocation(),
      buildLocation(),
    ];

void checkUnnamed1070(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
core.List<api.Revision> buildUnnamed1071() => [
      buildRevision(),
      buildRevision(),
    ];

void checkUnnamed1071(core.List<api.Revision> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRevision(o[0]);
  checkRevision(o[1]);
}

core.List<core.String> buildUnnamed1072() => [
      'foo',
      'foo',
    ];

void checkUnnamed1072(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.ListRevisionsResponse buildListRevisionsResponse() {
  ...
  if (buildCounterListRevisionsResponse < 3) {
    ...
    o.kind = 'foo';
    o.metadata = buildListMeta();
    o.unreachable = buildUnnamed1072();
  }
  buildCounterListRevisionsResponse--;
  return o;
}
...
void checkListRevisionsResponse(api.ListRevisionsResponse o) {
  ...
  if (buildCounterListRevisionsResponse < 3) {
    ...
    checkListMeta(o.metadata!);
    checkUnnamed1072(o.unreachable!);
  }
  buildCounterListRevisionsResponse--;
}

core.List<api.Route> buildUnnamed1073() => [
      buildRoute(),
      buildRoute(),
    ];

void checkUnnamed1073(core.List<api.Route> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRoute(o[0]);
  checkRoute(o[1]);
}

core.List<core.String> buildUnnamed1074() => [
      'foo',
      'foo',
    ];

void checkUnnamed1074(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.ListRoutesResponse buildListRoutesResponse() {
  ...
  if (buildCounterListRoutesResponse < 3) {
    ...
    o.kind = 'foo';
    o.metadata = buildListMeta();
    o.unreachable = buildUnnamed1074();
  }
  buildCounterListRoutesResponse--;
  return o;
}
...
void checkListRoutesResponse(api.ListRoutesResponse o) {
  ...
  if (buildCounterListRoutesResponse < 3) {
    ...
    checkListMeta(o.metadata!);
    checkUnnamed1074(o.unreachable!);
  }
  buildCounterListRoutesResponse--;
}

core.List<api.Service> buildUnnamed1075() => [
      buildService(),
      buildService(),
    ];

void checkUnnamed1075(core.List<api.Service> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkService(o[0]);
  checkService(o[1]);
}
...
core.List<core.String> buildUnnamed1080() => [
      'foo',
      'foo',
    ];

void checkUnnamed1080(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.Map<core.String, core.String> buildUnnamed1081() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed1081(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.OwnerReference> buildUnnamed1082() => [
      buildOwnerReference(),
      buildOwnerReference(),
    ];

void checkUnnamed1082(core.List<api.OwnerReference> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ObjectMeta buildObjectMeta() {
  ...
  if (buildCounterObjectMeta < 3) {
    o.annotations = buildUnnamed1079();
    o.clusterName = 'foo';
    o.creationTimestamp = 'foo';
    o.deletionGracePeriodSeconds = 42;
    o.deletionTimestamp = 'foo';
    o.finalizers = buildUnnamed1080();
    o.generateName = 'foo';
    o.generation = 42;
    o.labels = buildUnnamed1081();
    o.name = 'foo';
    o.namespace = 'foo';
    o.ownerReferences = buildUnnamed1082();
    o.resourceVersion = 'foo';
    o.selfLink = 'foo';
    o.uid = 'foo';
  }
...
void checkObjectMeta(api.ObjectMeta o) {
  buildCounterObjectMeta++;
  if (buildCounterObjectMeta < 3) {
    checkUnnamed1079(o.annotations!);
    unittest.expect(
      o.clusterName!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed1082(o.ownerReferences!);
    unittest.expect(
      o.resourceVersion!,
      unittest.equals('foo'),
    );
...
core.List<api.AuditConfig> buildUnnamed1083() => [
      buildAuditConfig(),
      buildAuditConfig(),
    ];

void checkUnnamed1083(core.List<api.AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAuditConfig(o[0]);
  checkAuditConfig(o[1]);
}

core.List<api.Binding> buildUnnamed1084() => [
      buildBinding(),
      buildBinding(),
    ];

void checkUnnamed1084(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
api.Policy buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.auditConfigs = buildUnnamed1083();
    o.bindings = buildUnnamed1084();
    o.etag = 'foo';
    o.version = 42;
  }
  buildCounterPolicy--;
...
void checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed1083(o.auditConfigs!);
    checkUnnamed1084(o.bindings!);
    unittest.expect(
      o.etag!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.String> buildUnnamed1085() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed1085(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.Map<core.String, core.String> buildUnnamed1086() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed1086(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.ResourceRequirements buildResourceRequirements() {
  ...
  if (buildCounterResourceRequirements < 3) {
    o.limits = buildUnnamed1085();
    o.requests = buildUnnamed1086();
  }
  buildCounterResourceRequirements--;
  return o;
}
...
void checkResourceRequirements(api.ResourceRequirements o) {
  buildCounterResourceRequirements++;
  if (buildCounterResourceRequirements < 3) {
    checkUnnamed1085(o.limits!);
    checkUnnamed1086(o.requests!);
  }
  buildCounterResourceRequirements--;
}
...
core.List<api.Container> buildUnnamed1087() => [
      buildContainer(),
      buildContainer(),
    ];

void checkUnnamed1087(core.List<api.Container> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContainer(o[0]);
  checkContainer(o[1]);
}

core.List<api.Volume> buildUnnamed1088() => [
      buildVolume(),
      buildVolume(),
    ];

void checkUnnamed1088(core.List<api.Volume> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVolume(o[0]);
  checkVolume(o[1]);
}
...
api.RevisionSpec buildRevisionSpec() {
  ...
  if (buildCounterRevisionSpec < 3) {
    ...
    o.containers = buildUnnamed1087();
    o.serviceAccountName = 'foo';
    o.timeoutSeconds = 42;
    o.volumes = buildUnnamed1088();
  }
  buildCounterRevisionSpec--;
  return o;
}
...
void checkRevisionSpec(api.RevisionSpec o) {
  ...
  if (buildCounterRevisionSpec < 3) {
    ...
    checkUnnamed1088(o.volumes!);
  }
  buildCounterRevisionSpec--;
}

core.List<api.GoogleCloudRunV1Condition> buildUnnamed1089() => [
      buildGoogleCloudRunV1Condition(),
      buildGoogleCloudRunV1Condition(),
    ];

void checkUnnamed1089(core.List<api.GoogleCloudRunV1Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV1Condition(o[0]);
  checkGoogleCloudRunV1Condition(o[1]);
}
...
core.List<api.TrafficTarget> buildUnnamed1090() => [
      buildTrafficTarget(),
      buildTrafficTarget(),
    ];

void checkUnnamed1090(core.List<api.TrafficTarget> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkRouteSpec(api.RouteSpec o) {
  buildCounterRouteSpec++;
  if (buildCounterRouteSpec < 3) {
    checkUnnamed1090(o.traffic!);
  }
  buildCounterRouteSpec--;
}

core.List<api.GoogleCloudRunV1Condition> buildUnnamed1091() => [
      buildGoogleCloudRunV1Condition(),
      buildGoogleCloudRunV1Condition(),
    ];

void checkUnnamed1091(core.List<api.GoogleCloudRunV1Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV1Condition(o[0]);
  checkGoogleCloudRunV1Condition(o[1]);
}

core.List<api.TrafficTarget> buildUnnamed1092() => [
      buildTrafficTarget(),
      buildTrafficTarget(),
    ];

void checkUnnamed1092(core.List<api.TrafficTarget> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTrafficTarget(o[0]);
  checkTrafficTarget(o[1]);
}
...
api.RouteStatus buildRouteStatus() {
  ...
  if (buildCounterRouteStatus < 3) {
    ...
    o.conditions = buildUnnamed1091();
    o.observedGeneration = 42;
    o.traffic = buildUnnamed1092();
    o.url = 'foo';
  }
  buildCounterRouteStatus--;
  return o;
...
void checkRouteStatus(api.RouteStatus o) {
  ...
  if (buildCounterRouteStatus < 3) {
    ...
    checkUnnamed1091(o.conditions!);
    unittest.expect(
      o.observedGeneration!,
      unittest.equals(42),
    );
    checkUnnamed1092(o.traffic!);
    unittest.expect(
      o.url!,
      unittest.equals('foo'),
    );
...
core.List<api.KeyToPath> buildUnnamed1093() => [
      buildKeyToPath(),
      buildKeyToPath(),
    ];

void checkUnnamed1093(core.List<api.KeyToPath> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkKeyToPath(o[0]);
  checkKeyToPath(o[1]);
}
...
core.List<api.TrafficTarget> buildUnnamed1094() => [
      buildTrafficTarget(),
      buildTrafficTarget(),
    ];

void checkUnnamed1094(core.List<api.TrafficTarget> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTrafficTarget(o[0]);
  checkTrafficTarget(o[1]);
}
...
void checkServiceSpec(api.ServiceSpec o) {
  ...
  if (buildCounterServiceSpec < 3) {
    checkRevisionTemplate(o.template!);
    checkUnnamed1094(o.traffic!);
  }
  buildCounterServiceSpec--;
}

core.List<api.GoogleCloudRunV1Condition> buildUnnamed1095() => [
      buildGoogleCloudRunV1Condition(),
      buildGoogleCloudRunV1Condition(),
    ];

void checkUnnamed1095(core.List<api.GoogleCloudRunV1Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV1Condition(o[0]);
  checkGoogleCloudRunV1Condition(o[1]);
}

core.List<api.TrafficTarget> buildUnnamed1096() => [
      buildTrafficTarget(),
      buildTrafficTarget(),
    ];

void checkUnnamed1096(core.List<api.TrafficTarget> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTrafficTarget(o[0]);
  checkTrafficTarget(o[1]);
}
...
api.ServiceStatus buildServiceStatus() {
  ...
  if (buildCounterServiceStatus < 3) {
    o.address = buildAddressable();
    o.conditions = buildUnnamed1095();
    o.latestCreatedRevisionName = 'foo';
    o.latestReadyRevisionName = 'foo';
    o.observedGeneration = 42;
    o.traffic = buildUnnamed1096();
    o.url = 'foo';
  }
  buildCounterServiceStatus--;
  return o;
...
core.List<api.StatusCause> buildUnnamed1097() => [
      buildStatusCause(),
      buildStatusCause(),
    ];

void checkUnnamed1097(core.List<api.StatusCause> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.String> buildUnnamed1098() => [
      'foo',
      'foo',
    ];

void checkUnnamed1098(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
