...
void checkGoogleCloudRunV2BinaryAuthorization(
  ...
  buildCounterGoogleCloudRunV2BinaryAuthorization++;
  if (buildCounterGoogleCloudRunV2BinaryAuthorization < 3) {
    unittest.expect(o.breakglassJustification!, unittest.equals('foo'));
...
core.int buildCounterGoogleCloudRunV2BuildConfig = 0;
api.GoogleCloudRunV2BuildConfig buildGoogleCloudRunV2BuildConfig() {
  final o = api.GoogleCloudRunV2BuildConfig();
  buildCounterGoogleCloudRunV2BuildConfig++;
  if (buildCounterGoogleCloudRunV2BuildConfig < 3) {
    o.baseImage = 'foo';
...
void checkGoogleCloudRunV2BuildConfig(api.GoogleCloudRunV2BuildConfig o) {
  buildCounterGoogleCloudRunV2BuildConfig++;
  if (buildCounterGoogleCloudRunV2BuildConfig < 3) {
    unittest.expect(o.baseImage!, unittest.equals('foo'));
    unittest.expect(o.enableAutomaticUpdates!, unittest.isTrue);
    checkUnnamed0(o.environmentVariables!);
    unittest.expect(o.functionTarget!, unittest.equals('foo'));
    unittest.expect(o.imageUri!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.serviceAccount!, unittest.equals('foo'));
    unittest.expect(o.sourceLocation!, unittest.equals('foo'));
    unittest.expect(o.workerPool!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudRunV2BuildConfig--;
}

core.int buildCounterGoogleCloudRunV2BuildInfo = 0;
api.GoogleCloudRunV2BuildInfo buildGoogleCloudRunV2BuildInfo() {
  final o = api.GoogleCloudRunV2BuildInfo();
  buildCounterGoogleCloudRunV2BuildInfo++;
  if (buildCounterGoogleCloudRunV2BuildInfo < 3) {
    o.functionTarget = 'foo';
    o.sourceLocation = 'foo';
  }
  buildCounterGoogleCloudRunV2BuildInfo--;
...
void checkGoogleCloudRunV2BuildInfo(api.GoogleCloudRunV2BuildInfo o) {
  buildCounterGoogleCloudRunV2BuildInfo++;
  if (buildCounterGoogleCloudRunV2BuildInfo < 3) {
    unittest.expect(o.functionTarget!, unittest.equals('foo'));
    unittest.expect(o.sourceLocation!, unittest.equals('foo'));
...
core.int buildCounterGoogleCloudRunV2BuildpacksBuild = 0;
api.GoogleCloudRunV2BuildpacksBuild buildGoogleCloudRunV2BuildpacksBuild() {
  final o = api.GoogleCloudRunV2BuildpacksBuild();
  buildCounterGoogleCloudRunV2BuildpacksBuild++;
  if (buildCounterGoogleCloudRunV2BuildpacksBuild < 3) {
    o.baseImage = 'foo';
    o.cacheImageUri = 'foo';
    o.enableAutomaticUpdates = true;
    o.environmentVariables = buildUnnamed1();
    o.functionTarget = 'foo';
...
void checkGoogleCloudRunV2BuildpacksBuild(
  api.GoogleCloudRunV2BuildpacksBuild o,
) {
  buildCounterGoogleCloudRunV2BuildpacksBuild++;
  if (buildCounterGoogleCloudRunV2BuildpacksBuild < 3) {
    unittest.expect(o.baseImage!, unittest.equals('foo'));
    unittest.expect(o.cacheImageUri!, unittest.equals('foo'));
    unittest.expect(o.enableAutomaticUpdates!, unittest.isTrue);
    checkUnnamed1(o.environmentVariables!);
    unittest.expect(o.functionTarget!, unittest.equals('foo'));
    unittest.expect(o.projectDescriptor!, unittest.equals('foo'));
...
void checkGoogleCloudRunV2CloudSqlInstance(
  ...
  buildCounterGoogleCloudRunV2CloudSqlInstance++;
  if (buildCounterGoogleCloudRunV2CloudSqlInstance < 3) {
    checkUnnamed2(o.instances!);
  }
  buildCounterGoogleCloudRunV2CloudSqlInstance--;
}

core.int buildCounterGoogleCloudRunV2CloudStorageSource = 0;
api.GoogleCloudRunV2CloudStorageSource
buildGoogleCloudRunV2CloudStorageSource() {
  final o = api.GoogleCloudRunV2CloudStorageSource();
  buildCounterGoogleCloudRunV2CloudStorageSource++;
  if (buildCounterGoogleCloudRunV2CloudStorageSource < 3) {
    o.bucket = 'foo';
    o.generation = 'foo';
    o.object = 'foo';
  }
...
void checkGoogleCloudRunV2CloudStorageSource(
  api.GoogleCloudRunV2CloudStorageSource o,
) {
  buildCounterGoogleCloudRunV2CloudStorageSource++;
  if (buildCounterGoogleCloudRunV2CloudStorageSource < 3) {
...
void checkGoogleCloudRunV2Condition(api.GoogleCloudRunV2Condition o) {
  ...
  if (buildCounterGoogleCloudRunV2Condition < 3) {
    ...
    unittest.expect(o.revisionReason!, unittest.equals('foo'));
...
core.List<api.GoogleCloudRunV2EnvVar> buildUnnamed6() => [
  buildGoogleCloudRunV2EnvVar(),
  buildGoogleCloudRunV2EnvVar(),
];

void checkUnnamed6(core.List<api.GoogleCloudRunV2EnvVar> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV2EnvVar(o[0]);
  checkGoogleCloudRunV2EnvVar(o[1]);
}

core.List<api.GoogleCloudRunV2ContainerPort> buildUnnamed7() => [
  buildGoogleCloudRunV2ContainerPort(),
  buildGoogleCloudRunV2ContainerPort(),
];

void checkUnnamed7(core.List<api.GoogleCloudRunV2ContainerPort> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV2ContainerPort(o[0]);
  checkGoogleCloudRunV2ContainerPort(o[1]);
}

core.List<api.GoogleCloudRunV2VolumeMount> buildUnnamed8() => [
  buildGoogleCloudRunV2VolumeMount(),
  buildGoogleCloudRunV2VolumeMount(),
];

void checkUnnamed8(core.List<api.GoogleCloudRunV2VolumeMount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleCloudRunV2Container buildGoogleCloudRunV2Container() {
  ...
  if (buildCounterGoogleCloudRunV2Container < 3) {
    ...
    o.baseImageUri = 'foo';
    o.buildInfo = buildGoogleCloudRunV2BuildInfo();
    o.command = buildUnnamed4();
    o.dependsOn = buildUnnamed5();
    o.env = buildUnnamed6();
    o.image = 'foo';
...
void checkGoogleCloudRunV2Container(api.GoogleCloudRunV2Container o) {
  ...
  if (buildCounterGoogleCloudRunV2Container < 3) {
    ...
    unittest.expect(o.baseImageUri!, unittest.equals('foo'));
    checkGoogleCloudRunV2BuildInfo(o.buildInfo!);
    checkUnnamed4(o.command!);
    checkUnnamed5(o.dependsOn!);
    checkUnnamed6(o.env!);
...
core.List<api.GoogleCloudRunV2EnvVar> buildUnnamed10() => [
  buildGoogleCloudRunV2EnvVar(),
  buildGoogleCloudRunV2EnvVar(),
];

void checkUnnamed10(core.List<api.GoogleCloudRunV2EnvVar> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV2EnvVar(o[0]);
  checkGoogleCloudRunV2EnvVar(o[1]);
}
...
core.int buildCounterGoogleCloudRunV2ContainerStatus = 0;
api.GoogleCloudRunV2ContainerStatus buildGoogleCloudRunV2ContainerStatus() {
  final o = api.GoogleCloudRunV2ContainerStatus();
  buildCounterGoogleCloudRunV2ContainerStatus++;
  if (buildCounterGoogleCloudRunV2ContainerStatus < 3) {
    o.imageDigest = 'foo';
    o.name = 'foo';
  }
  buildCounterGoogleCloudRunV2ContainerStatus--;
...
void checkGoogleCloudRunV2ContainerStatus(
  api.GoogleCloudRunV2ContainerStatus o,
) {
  buildCounterGoogleCloudRunV2ContainerStatus++;
  if (buildCounterGoogleCloudRunV2ContainerStatus < 3) {
...
core.int buildCounterGoogleCloudRunV2DockerBuild = 0;
api.GoogleCloudRunV2DockerBuild buildGoogleCloudRunV2DockerBuild() {
  final o = api.GoogleCloudRunV2DockerBuild();
  buildCounterGoogleCloudRunV2DockerBuild++;
  if (buildCounterGoogleCloudRunV2DockerBuild < 3) {}
  buildCounterGoogleCloudRunV2DockerBuild--;
  return o;
}

void checkGoogleCloudRunV2DockerBuild(api.GoogleCloudRunV2DockerBuild o) {
  buildCounterGoogleCloudRunV2DockerBuild++;
  if (buildCounterGoogleCloudRunV2DockerBuild < 3) {}
  buildCounterGoogleCloudRunV2DockerBuild--;
}
...
void checkGoogleCloudRunV2EmptyDirVolumeSource(
  ...
  if (buildCounterGoogleCloudRunV2EmptyDirVolumeSource < 3) {
    ...
    unittest.expect(o.sizeLimit!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudRunV2EmptyDirVolumeSource--;
}
...
void checkGoogleCloudRunV2Execution(api.GoogleCloudRunV2Execution o) {
  ...
  if (buildCounterGoogleCloudRunV2Execution < 3) {
    ...
    unittest.expect(o.cancelledCount!, unittest.equals(42));
    ...
    unittest.expect(o.retriedCount!, unittest.equals(42));
    unittest.expect(o.runningCount!, unittest.equals(42));
    unittest.expect(o.satisfiesPzs!, unittest.isTrue);
    unittest.expect(o.startTime!, unittest.equals('foo'));
    unittest.expect(o.succeededCount!, unittest.equals(42));
...
void checkGoogleCloudRunV2ExecutionReference(
  ...
  buildCounterGoogleCloudRunV2ExecutionReference++;
  if (buildCounterGoogleCloudRunV2ExecutionReference < 3) {
    unittest.expect(o.completionStatus!, unittest.equals('foo'));
    unittest.expect(o.completionTime!, unittest.equals('foo'));
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.deleteTime!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
...
void checkGoogleCloudRunV2ExportImageRequest(
  ...
  buildCounterGoogleCloudRunV2ExportImageRequest++;
  if (buildCounterGoogleCloudRunV2ExportImageRequest < 3) {
    unittest.expect(o.destinationRepo!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudRunV2ExportImageRequest--;
}
...
core.List<api.GoogleCloudRunV2ImageExportStatus> buildUnnamed16() => [
  buildGoogleCloudRunV2ImageExportStatus(),
  buildGoogleCloudRunV2ImageExportStatus(),
];

void checkUnnamed16(core.List<api.GoogleCloudRunV2ImageExportStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildGoogleCloudRunV2ExportStatusResponse() {
  ...
  if (buildCounterGoogleCloudRunV2ExportStatusResponse < 3) {
    o.imageExportStatuses = buildUnnamed16();
    o.operationId = 'foo';
...
void checkGoogleCloudRunV2ExportStatusResponse(
  ...
  buildCounterGoogleCloudRunV2ExportStatusResponse++;
  if (buildCounterGoogleCloudRunV2ExportStatusResponse < 3) {
    checkUnnamed16(o.imageExportStatuses!);
    unittest.expect(o.operationId!, unittest.equals('foo'));
...
core.List<api.GoogleCloudRunV2HTTPHeader> buildUnnamed18() => [
  buildGoogleCloudRunV2HTTPHeader(),
  buildGoogleCloudRunV2HTTPHeader(),
];

void checkUnnamed18(core.List<api.GoogleCloudRunV2HTTPHeader> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkGoogleCloudRunV2ImageExportStatus(
  ...
  buildCounterGoogleCloudRunV2ImageExportStatus++;
  if (buildCounterGoogleCloudRunV2ImageExportStatus < 3) {
    unittest.expect(o.exportJobState!, unittest.equals('foo'));
    unittest.expect(o.exportedImageDigest!, unittest.equals('foo'));
...
core.List<api.GoogleCloudRunV2SourceFile> buildUnnamed19() => [
  buildGoogleCloudRunV2SourceFile(),
  buildGoogleCloudRunV2SourceFile(),
];

void checkUnnamed19(core.List<api.GoogleCloudRunV2SourceFile> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV2SourceFile(o[0]);
  checkGoogleCloudRunV2SourceFile(o[1]);
}

core.int buildCounterGoogleCloudRunV2InlinedSource = 0;
api.GoogleCloudRunV2InlinedSource buildGoogleCloudRunV2InlinedSource() {
  final o = api.GoogleCloudRunV2InlinedSource();
  buildCounterGoogleCloudRunV2InlinedSource++;
  if (buildCounterGoogleCloudRunV2InlinedSource < 3) {
...
void checkGoogleCloudRunV2InlinedSource(api.GoogleCloudRunV2InlinedSource o) {
  buildCounterGoogleCloudRunV2InlinedSource++;
  if (buildCounterGoogleCloudRunV2InlinedSource < 3) {
...
core.List<api.GoogleCloudRunV2ContainerStatus> buildUnnamed22() => [
  buildGoogleCloudRunV2ContainerStatus(),
  buildGoogleCloudRunV2ContainerStatus(),
];

void checkUnnamed22(core.List<api.GoogleCloudRunV2ContainerStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV2ContainerStatus(o[0]);
  checkGoogleCloudRunV2ContainerStatus(o[1]);
}
...
core.List<api.GoogleCloudRunV2Volume> buildUnnamed26() => [
  buildGoogleCloudRunV2Volume(),
  buildGoogleCloudRunV2Volume(),
];

void checkUnnamed26(core.List<api.GoogleCloudRunV2Volume> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV2Volume(o[0]);
  checkGoogleCloudRunV2Volume(o[1]);
}

core.int buildCounterGoogleCloudRunV2Instance = 0;
api.GoogleCloudRunV2Instance buildGoogleCloudRunV2Instance() {
  final o = api.GoogleCloudRunV2Instance();
  buildCounterGoogleCloudRunV2Instance++;
  if (buildCounterGoogleCloudRunV2Instance < 3) {
    o.annotations = buildUnnamed20();
    o.binaryAuthorization = buildGoogleCloudRunV2BinaryAuthorization();
    o.client = 'foo';
    o.clientVersion = 'foo';
    o.conditions = buildUnnamed21();
    o.containerStatuses = buildUnnamed22();
    ...
    o.expireTime = 'foo';
    o.generation = 'foo';
    o.gpuZonalRedundancyDisabled = true;
    o.iapEnabled = true;
    o.ingress = 'foo';
    o.invokerIamDisabled = true;
...
void checkGoogleCloudRunV2Instance(api.GoogleCloudRunV2Instance o) {
  buildCounterGoogleCloudRunV2Instance++;
  if (buildCounterGoogleCloudRunV2Instance < 3) {
    ...
    checkUnnamed22(o.containerStatuses!);
    ...
    unittest.expect(o.encryptionKeyRevocationAction!, unittest.equals('foo'));
    unittest.expect(o.encryptionKeyShutdownDuration!, unittest.equals('foo'));
    unittest.expect(o.etag!, unittest.equals('foo'));
    unittest.expect(o.expireTime!, unittest.equals('foo'));
    unittest.expect(o.generation!, unittest.equals('foo'));
    unittest.expect(o.gpuZonalRedundancyDisabled!, unittest.isTrue);
    unittest.expect(o.iapEnabled!, unittest.isTrue);
    unittest.expect(o.ingress!, unittest.equals('foo'));
    unittest.expect(o.invokerIamDisabled!, unittest.isTrue);
...
core.int buildCounterGoogleCloudRunV2InstanceSplit = 0;
api.GoogleCloudRunV2InstanceSplit buildGoogleCloudRunV2InstanceSplit() {
  final o = api.GoogleCloudRunV2InstanceSplit();
  buildCounterGoogleCloudRunV2InstanceSplit++;
  if (buildCounterGoogleCloudRunV2InstanceSplit < 3) {
    o.percent = 42;
    o.revision = 'foo';
    o.type = 'foo';
  }
...
void checkGoogleCloudRunV2InstanceSplit(api.GoogleCloudRunV2InstanceSplit o) {
  buildCounterGoogleCloudRunV2InstanceSplit++;
  if (buildCounterGoogleCloudRunV2InstanceSplit < 3) {
...
core.int buildCounterGoogleCloudRunV2InstanceSplitStatus = 0;
api.GoogleCloudRunV2InstanceSplitStatus
buildGoogleCloudRunV2InstanceSplitStatus() {
  final o = api.GoogleCloudRunV2InstanceSplitStatus();
  buildCounterGoogleCloudRunV2InstanceSplitStatus++;
  if (buildCounterGoogleCloudRunV2InstanceSplitStatus < 3) {
    o.percent = 42;
    o.revision = 'foo';
    o.type = 'foo';
  }
...
void checkGoogleCloudRunV2InstanceSplitStatus(
  api.GoogleCloudRunV2InstanceSplitStatus o,
) {
  buildCounterGoogleCloudRunV2InstanceSplitStatus++;
  if (buildCounterGoogleCloudRunV2InstanceSplitStatus < 3) {
    unittest.expect(o.percent!, unittest.equals(42));
...
void checkGoogleCloudRunV2Job(api.GoogleCloudRunV2Job o) {
  ...
  if (buildCounterGoogleCloudRunV2Job < 3) {
    ...
    unittest.expect(o.observedGeneration!, unittest.equals('foo'));
    unittest.expect(o.reconciling!, unittest.isTrue);
    unittest.expect(o.runExecutionToken!, unittest.equals('foo'));
    unittest.expect(o.satisfiesPzs!, unittest.isTrue);
    unittest.expect(o.startExecutionToken!, unittest.equals('foo'));
...
core.List<api.GoogleCloudRunV2Execution> buildUnnamed30() => [
  buildGoogleCloudRunV2Execution(),
  buildGoogleCloudRunV2Execution(),
];

void checkUnnamed30(core.List<api.GoogleCloudRunV2Execution> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkGoogleCloudRunV2ListExecutionsResponse(
  ...
  buildCounterGoogleCloudRunV2ListExecutionsResponse++;
  if (buildCounterGoogleCloudRunV2ListExecutionsResponse < 3) {
    checkUnnamed30(o.executions!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudRunV2ListExecutionsResponse--;
}

core.List<api.GoogleCloudRunV2Instance> buildUnnamed31() => [
  buildGoogleCloudRunV2Instance(),
  buildGoogleCloudRunV2Instance(),
];

void checkUnnamed31(core.List<api.GoogleCloudRunV2Instance> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV2Instance(o[0]);
  checkGoogleCloudRunV2Instance(o[1]);
}

core.int buildCounterGoogleCloudRunV2ListInstancesResponse = 0;
api.GoogleCloudRunV2ListInstancesResponse
buildGoogleCloudRunV2ListInstancesResponse() {
  final o = api.GoogleCloudRunV2ListInstancesResponse();
  buildCounterGoogleCloudRunV2ListInstancesResponse++;
  if (buildCounterGoogleCloudRunV2ListInstancesResponse < 3) {
...
void checkGoogleCloudRunV2ListInstancesResponse(
  api.GoogleCloudRunV2ListInstancesResponse o,
) {
  buildCounterGoogleCloudRunV2ListInstancesResponse++;
  if (buildCounterGoogleCloudRunV2ListInstancesResponse < 3) {
...
core.List<api.GoogleCloudRunV2Job> buildUnnamed32() => [
  buildGoogleCloudRunV2Job(),
  buildGoogleCloudRunV2Job(),
];

void checkUnnamed32(core.List<api.GoogleCloudRunV2Job> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleCloudRunV2Revision> buildUnnamed33() => [
  buildGoogleCloudRunV2Revision(),
  buildGoogleCloudRunV2Revision(),
];

void checkUnnamed33(core.List<api.GoogleCloudRunV2Revision> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkGoogleCloudRunV2ListRevisionsResponse(
  ...
  if (buildCounterGoogleCloudRunV2ListRevisionsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed33(o.revisions!);
  }
  buildCounterGoogleCloudRunV2ListRevisionsResponse--;
}

core.List<api.GoogleCloudRunV2Service> buildUnnamed34() => [
  buildGoogleCloudRunV2Service(),
  buildGoogleCloudRunV2Service(),
];

void checkUnnamed34(core.List<api.GoogleCloudRunV2Service> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleCloudRunV2Task> buildUnnamed36() => [
  buildGoogleCloudRunV2Task(),
  buildGoogleCloudRunV2Task(),
];

void checkUnnamed36(core.List<api.GoogleCloudRunV2Task> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleCloudRunV2WorkerPool> buildUnnamed37() => [
  buildGoogleCloudRunV2WorkerPool(),
  buildGoogleCloudRunV2WorkerPool(),
];

void checkUnnamed37(core.List<api.GoogleCloudRunV2WorkerPool> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV2WorkerPool(o[0]);
  checkGoogleCloudRunV2WorkerPool(o[1]);
}

core.int buildCounterGoogleCloudRunV2ListWorkerPoolsResponse = 0;
api.GoogleCloudRunV2ListWorkerPoolsResponse
buildGoogleCloudRunV2ListWorkerPoolsResponse() {
  final o = api.GoogleCloudRunV2ListWorkerPoolsResponse();
  buildCounterGoogleCloudRunV2ListWorkerPoolsResponse++;
  if (buildCounterGoogleCloudRunV2ListWorkerPoolsResponse < 3) {
    o.nextPageToken = 'foo';
    o.workerPools = buildUnnamed37();
  }
  buildCounterGoogleCloudRunV2ListWorkerPoolsResponse--;
  return o;
}

void checkGoogleCloudRunV2ListWorkerPoolsResponse(
  api.GoogleCloudRunV2ListWorkerPoolsResponse o,
) {
  buildCounterGoogleCloudRunV2ListWorkerPoolsResponse++;
  if (buildCounterGoogleCloudRunV2ListWorkerPoolsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed37(o.workerPools!);
  }
  buildCounterGoogleCloudRunV2ListWorkerPoolsResponse--;
}
...
core.int buildCounterGoogleCloudRunV2MultiRegionSettings = 0;
api.GoogleCloudRunV2MultiRegionSettings
buildGoogleCloudRunV2MultiRegionSettings() {
  final o = api.GoogleCloudRunV2MultiRegionSettings();
  buildCounterGoogleCloudRunV2MultiRegionSettings++;
  if (buildCounterGoogleCloudRunV2MultiRegionSettings < 3) {
    o.multiRegionId = 'foo';
    o.regions = buildUnnamed38();
  }
  buildCounterGoogleCloudRunV2MultiRegionSettings--;
  return o;
}

void checkGoogleCloudRunV2MultiRegionSettings(
  api.GoogleCloudRunV2MultiRegionSettings o,
) {
  buildCounterGoogleCloudRunV2MultiRegionSettings++;
  if (buildCounterGoogleCloudRunV2MultiRegionSettings < 3) {
    unittest.expect(o.multiRegionId!, unittest.equals('foo'));
    checkUnnamed38(o.regions!);
  }
  buildCounterGoogleCloudRunV2MultiRegionSettings--;
}
...
void checkGoogleCloudRunV2NodeSelector(api.GoogleCloudRunV2NodeSelector o) {
  buildCounterGoogleCloudRunV2NodeSelector++;
  if (buildCounterGoogleCloudRunV2NodeSelector < 3) {
    unittest.expect(o.accelerator!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudRunV2NodeSelector--;
}

core.List<api.GoogleCloudRunV2ContainerOverride> buildUnnamed40() => [
  buildGoogleCloudRunV2ContainerOverride(),
  buildGoogleCloudRunV2ContainerOverride(),
];

void checkUnnamed40(core.List<api.GoogleCloudRunV2ContainerOverride> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleCloudRunV2Revision buildGoogleCloudRunV2Revision() {
  ...
  if (buildCounterGoogleCloudRunV2Revision < 3) {
    ...
    o.service = 'foo';
    o.serviceAccount = 'foo';
    o.serviceMesh = buildGoogleCloudRunV2ServiceMesh();
...
void checkGoogleCloudRunV2Revision(api.GoogleCloudRunV2Revision o) {
  ...
  if (buildCounterGoogleCloudRunV2Revision < 3) {
    ...
    unittest.expect(o.encryptionKeyShutdownDuration!, unittest.equals('foo'));
    unittest.expect(o.etag!, unittest.equals('foo'));
    unittest.expect(o.executionEnvironment!, unittest.equals('foo'));
    unittest.expect(o.expireTime!, unittest.equals('foo'));
    unittest.expect(o.generation!, unittest.equals('foo'));
    unittest.expect(o.gpuZonalRedundancyDisabled!, unittest.isTrue);
    ...
    unittest.expect(o.service!, unittest.equals('foo'));
    unittest.expect(o.serviceAccount!, unittest.equals('foo'));
    checkGoogleCloudRunV2ServiceMesh(o.serviceMesh!);
...
api.GoogleCloudRunV2RevisionScaling buildGoogleCloudRunV2RevisionScaling() {
  ...
  if (buildCounterGoogleCloudRunV2RevisionScaling < 3) {
    o.concurrencyUtilization = 42.0;
    o.cpuUtilization = 42.0;
...
void checkGoogleCloudRunV2RevisionScaling(
  ...
  buildCounterGoogleCloudRunV2RevisionScaling++;
  if (buildCounterGoogleCloudRunV2RevisionScaling < 3) {
    unittest.expect(o.concurrencyUtilization!, unittest.equals(42.0));
    unittest.expect(o.cpuUtilization!, unittest.equals(42.0));
...
void checkGoogleCloudRunV2RevisionScalingStatus(
  ...
  buildCounterGoogleCloudRunV2RevisionScalingStatus++;
  if (buildCounterGoogleCloudRunV2RevisionScalingStatus < 3) {
    unittest.expect(o.desiredMinInstanceCount!, unittest.equals(42));
  }
  buildCounterGoogleCloudRunV2RevisionScalingStatus--;
}
...
core.List<api.GoogleCloudRunV2Volume> buildUnnamed50() => [
  buildGoogleCloudRunV2Volume(),
  buildGoogleCloudRunV2Volume(),
];

void checkUnnamed50(core.List<api.GoogleCloudRunV2Volume> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV2Volume(o[0]);
  checkGoogleCloudRunV2Volume(o[1]);
}
...
core.List<api.GoogleCloudRunV2VersionToPath> buildUnnamed51() => [
  buildGoogleCloudRunV2VersionToPath(),
  buildGoogleCloudRunV2VersionToPath(),
];

void checkUnnamed51(core.List<api.GoogleCloudRunV2VersionToPath> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleCloudRunV2Condition> buildUnnamed53() => [
  buildGoogleCloudRunV2Condition(),
  buildGoogleCloudRunV2Condition(),
];

void checkUnnamed53(core.List<api.GoogleCloudRunV2Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV2Condition(o[0]);
  checkGoogleCloudRunV2Condition(o[1]);
}
...
core.List<api.GoogleCloudRunV2TrafficTarget> buildUnnamed56() => [
  buildGoogleCloudRunV2TrafficTarget(),
  buildGoogleCloudRunV2TrafficTarget(),
];

void checkUnnamed56(core.List<api.GoogleCloudRunV2TrafficTarget> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV2TrafficTarget(o[0]);
  checkGoogleCloudRunV2TrafficTarget(o[1]);
}

core.List<api.GoogleCloudRunV2TrafficTargetStatus> buildUnnamed57() => [
  buildGoogleCloudRunV2TrafficTargetStatus(),
  buildGoogleCloudRunV2TrafficTargetStatus(),
];

void checkUnnamed57(core.List<api.GoogleCloudRunV2TrafficTargetStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleCloudRunV2Service buildGoogleCloudRunV2Service() {
  ...
  if (buildCounterGoogleCloudRunV2Service < 3) {
    ...
    o.binaryAuthorization = buildGoogleCloudRunV2BinaryAuthorization();
    o.buildConfig = buildGoogleCloudRunV2BuildConfig();
    o.client = 'foo';
    o.clientVersion = 'foo';
    o.conditions = buildUnnamed53();
    o.createTime = 'foo';
    o.creator = 'foo';
    o.customAudiences = buildUnnamed54();
    o.defaultUriDisabled = true;
    o.deleteTime = 'foo';
    o.description = 'foo';
    ...
    o.launchStage = 'foo';
    o.multiRegionSettings = buildGoogleCloudRunV2MultiRegionSettings();
    o.name = 'foo';
    o.observedGeneration = 'foo';
    o.reconciling = true;
    o.satisfiesPzs = true;
    ...
    o.trafficStatuses = buildUnnamed57();
    o.uid = 'foo';
    o.updateTime = 'foo';
    o.uri = 'foo';
    o.urls = buildUnnamed58();
  }
  buildCounterGoogleCloudRunV2Service--;
  return o;
}
...
void checkGoogleCloudRunV2Service(api.GoogleCloudRunV2Service o) {
  ...
  if (buildCounterGoogleCloudRunV2Service < 3) {
    ...
    checkGoogleCloudRunV2BinaryAuthorization(o.binaryAuthorization!);
    checkGoogleCloudRunV2BuildConfig(o.buildConfig!);
    unittest.expect(o.client!, unittest.equals('foo'));
    unittest.expect(o.clientVersion!, unittest.equals('foo'));
    checkUnnamed53(o.conditions!);
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.creator!, unittest.equals('foo'));
    checkUnnamed54(o.customAudiences!);
    unittest.expect(o.defaultUriDisabled!, unittest.isTrue);
    unittest.expect(o.deleteTime!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    ...
    unittest.expect(o.lastModifier!, unittest.equals('foo'));
    unittest.expect(o.latestCreatedRevision!, unittest.equals('foo'));
    unittest.expect(o.latestReadyRevision!, unittest.equals('foo'));
    unittest.expect(o.launchStage!, unittest.equals('foo'));
    checkGoogleCloudRunV2MultiRegionSettings(o.multiRegionSettings!);
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.observedGeneration!, unittest.equals('foo'));
    unittest.expect(o.reconciling!, unittest.isTrue);
    unittest.expect(o.satisfiesPzs!, unittest.isTrue);
    ...
    checkUnnamed57(o.trafficStatuses!);
    unittest.expect(o.uid!, unittest.equals('foo'));
    unittest.expect(o.updateTime!, unittest.equals('foo'));
    unittest.expect(o.uri!, unittest.equals('foo'));
    checkUnnamed58(o.urls!);
  }
  buildCounterGoogleCloudRunV2Service--;
}

core.int buildCounterGoogleCloudRunV2ServiceMesh = 0;
api.GoogleCloudRunV2ServiceMesh buildGoogleCloudRunV2ServiceMesh() {
  final o = api.GoogleCloudRunV2ServiceMesh();
  buildCounterGoogleCloudRunV2ServiceMesh++;
  if (buildCounterGoogleCloudRunV2ServiceMesh < 3) {
    o.mesh = 'foo';
  }
  buildCounterGoogleCloudRunV2ServiceMesh--;
  return o;
...
void checkGoogleCloudRunV2ServiceMesh(api.GoogleCloudRunV2ServiceMesh o) {
  buildCounterGoogleCloudRunV2ServiceMesh++;
  if (buildCounterGoogleCloudRunV2ServiceMesh < 3) {
...
core.int buildCounterGoogleCloudRunV2SourceCode = 0;
api.GoogleCloudRunV2SourceCode buildGoogleCloudRunV2SourceCode() {
  final o = api.GoogleCloudRunV2SourceCode();
  buildCounterGoogleCloudRunV2SourceCode++;
  if (buildCounterGoogleCloudRunV2SourceCode < 3) {
    o.cloudStorageSource = buildGoogleCloudRunV2CloudStorageSource();
    o.inlinedSource = buildGoogleCloudRunV2InlinedSource();
  }
  buildCounterGoogleCloudRunV2SourceCode--;
  return o;
}

void checkGoogleCloudRunV2SourceCode(api.GoogleCloudRunV2SourceCode o) {
  buildCounterGoogleCloudRunV2SourceCode++;
  if (buildCounterGoogleCloudRunV2SourceCode < 3) {
    checkGoogleCloudRunV2CloudStorageSource(o.cloudStorageSource!);
    checkGoogleCloudRunV2InlinedSource(o.inlinedSource!);
  }
  buildCounterGoogleCloudRunV2SourceCode--;
}

core.int buildCounterGoogleCloudRunV2SourceFile = 0;
api.GoogleCloudRunV2SourceFile buildGoogleCloudRunV2SourceFile() {
  final o = api.GoogleCloudRunV2SourceFile();
  buildCounterGoogleCloudRunV2SourceFile++;
  if (buildCounterGoogleCloudRunV2SourceFile < 3) {
    o.content = 'foo';
    o.filename = 'foo';
  }
  buildCounterGoogleCloudRunV2SourceFile--;
...
void checkGoogleCloudRunV2SourceFile(api.GoogleCloudRunV2SourceFile o) {
  buildCounterGoogleCloudRunV2SourceFile++;
  if (buildCounterGoogleCloudRunV2SourceFile < 3) {
...
core.int buildCounterGoogleCloudRunV2StartInstanceRequest = 0;
api.GoogleCloudRunV2StartInstanceRequest
buildGoogleCloudRunV2StartInstanceRequest() {
  final o = api.GoogleCloudRunV2StartInstanceRequest();
  buildCounterGoogleCloudRunV2StartInstanceRequest++;
  if (buildCounterGoogleCloudRunV2StartInstanceRequest < 3) {
    o.etag = 'foo';
    o.validateOnly = true;
  }
  buildCounterGoogleCloudRunV2StartInstanceRequest--;
...
void checkGoogleCloudRunV2StartInstanceRequest(
  api.GoogleCloudRunV2StartInstanceRequest o,
) {
  buildCounterGoogleCloudRunV2StartInstanceRequest++;
  if (buildCounterGoogleCloudRunV2StartInstanceRequest < 3) {
    unittest.expect(o.etag!, unittest.equals('foo'));
...
core.int buildCounterGoogleCloudRunV2StopInstanceRequest = 0;
api.GoogleCloudRunV2StopInstanceRequest
buildGoogleCloudRunV2StopInstanceRequest() {
  final o = api.GoogleCloudRunV2StopInstanceRequest();
  buildCounterGoogleCloudRunV2StopInstanceRequest++;
  if (buildCounterGoogleCloudRunV2StopInstanceRequest < 3) {
    o.etag = 'foo';
    o.validateOnly = true;
  }
  buildCounterGoogleCloudRunV2StopInstanceRequest--;
...
void checkGoogleCloudRunV2StopInstanceRequest(
  api.GoogleCloudRunV2StopInstanceRequest o,
) {
  buildCounterGoogleCloudRunV2StopInstanceRequest++;
  if (buildCounterGoogleCloudRunV2StopInstanceRequest < 3) {
    unittest.expect(o.etag!, unittest.equals('foo'));
...
core.int buildCounterGoogleCloudRunV2StorageSource = 0;
api.GoogleCloudRunV2StorageSource buildGoogleCloudRunV2StorageSource() {
  final o = api.GoogleCloudRunV2StorageSource();
  buildCounterGoogleCloudRunV2StorageSource++;
  if (buildCounterGoogleCloudRunV2StorageSource < 3) {
    o.bucket = 'foo';
    o.generation = 'foo';
    o.object = 'foo';
  }
...
void checkGoogleCloudRunV2StorageSource(api.GoogleCloudRunV2StorageSource o) {
  buildCounterGoogleCloudRunV2StorageSource++;
  if (buildCounterGoogleCloudRunV2StorageSource < 3) {
    unittest.expect(o.bucket!, unittest.equals('foo'));
    unittest.expect(o.generation!, unittest.equals('foo'));
...
core.int buildCounterGoogleCloudRunV2SubmitBuildRequest = 0;
api.GoogleCloudRunV2SubmitBuildRequest
buildGoogleCloudRunV2SubmitBuildRequest() {
  final o = api.GoogleCloudRunV2SubmitBuildRequest();
  buildCounterGoogleCloudRunV2SubmitBuildRequest++;
  if (buildCounterGoogleCloudRunV2SubmitBuildRequest < 3) {
...
void checkGoogleCloudRunV2SubmitBuildRequest(
  api.GoogleCloudRunV2SubmitBuildRequest o,
) {
  buildCounterGoogleCloudRunV2SubmitBuildRequest++;
  if (buildCounterGoogleCloudRunV2SubmitBuildRequest < 3) {
...
core.int buildCounterGoogleCloudRunV2SubmitBuildResponse = 0;
api.GoogleCloudRunV2SubmitBuildResponse
buildGoogleCloudRunV2SubmitBuildResponse() {
  final o = api.GoogleCloudRunV2SubmitBuildResponse();
  buildCounterGoogleCloudRunV2SubmitBuildResponse++;
  if (buildCounterGoogleCloudRunV2SubmitBuildResponse < 3) {
    o.baseImageUri = 'foo';
    o.baseImageWarning = 'foo';
    o.buildOperation = buildGoogleLongrunningOperation();
  }
  buildCounterGoogleCloudRunV2SubmitBuildResponse--;
  return o;
}

void checkGoogleCloudRunV2SubmitBuildResponse(
  api.GoogleCloudRunV2SubmitBuildResponse o,
) {
  buildCounterGoogleCloudRunV2SubmitBuildResponse++;
  if (buildCounterGoogleCloudRunV2SubmitBuildResponse < 3) {
    unittest.expect(o.baseImageUri!, unittest.equals('foo'));
    unittest.expect(o.baseImageWarning!, unittest.equals('foo'));
    checkGoogleLongrunningOperation(o.buildOperation!);
  }
  buildCounterGoogleCloudRunV2SubmitBuildResponse--;
}
...
core.List<api.GoogleCloudRunV2Condition> buildUnnamed61() => [
  buildGoogleCloudRunV2Condition(),
  buildGoogleCloudRunV2Condition(),
];

void checkUnnamed61(core.List<api.GoogleCloudRunV2Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV2Condition(o[0]);
  checkGoogleCloudRunV2Condition(o[1]);
}

core.List<api.GoogleCloudRunV2Container> buildUnnamed62() => [
  buildGoogleCloudRunV2Container(),
  buildGoogleCloudRunV2Container(),
];

void checkUnnamed62(core.List<api.GoogleCloudRunV2Container> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV2Container(o[0]);
  checkGoogleCloudRunV2Container(o[1]);
}
...
core.List<api.GoogleCloudRunV2Volume> buildUnnamed64() => [
  buildGoogleCloudRunV2Volume(),
  buildGoogleCloudRunV2Volume(),
];

void checkUnnamed64(core.List<api.GoogleCloudRunV2Volume> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV2Volume(o[0]);
  checkGoogleCloudRunV2Volume(o[1]);
}
...
api.GoogleCloudRunV2Task buildGoogleCloudRunV2Task() {
  ...
  if (buildCounterGoogleCloudRunV2Task < 3) {
    o.annotations = buildUnnamed60();
    o.completionTime = 'foo';
    o.conditions = buildUnnamed61();
    o.containers = buildUnnamed62();
    o.createTime = 'foo';
    o.deleteTime = 'foo';
    o.encryptionKey = 'foo';
    o.etag = 'foo';
...
void checkGoogleCloudRunV2Task(api.GoogleCloudRunV2Task o) {
  buildCounterGoogleCloudRunV2Task++;
  if (buildCounterGoogleCloudRunV2Task < 3) {
    checkUnnamed60(o.annotations!);
    unittest.expect(o.completionTime!, unittest.equals('foo'));
    checkUnnamed61(o.conditions!);
    checkUnnamed62(o.containers!);
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.deleteTime!, unittest.equals('foo'));
    unittest.expect(o.encryptionKey!, unittest.equals('foo'));
    unittest.expect(o.etag!, unittest.equals('foo'));
    ...
    unittest.expect(o.observedGeneration!, unittest.equals('foo'));
    unittest.expect(o.reconciling!, unittest.isTrue);
    unittest.expect(o.retried!, unittest.equals(42));
    unittest.expect(o.satisfiesPzs!, unittest.isTrue);
...
void checkGoogleCloudRunV2TaskAttemptResult(
  ...
  if (buildCounterGoogleCloudRunV2TaskAttemptResult < 3) {
    ...
    unittest.expect(o.termSignal!, unittest.equals(42));
  }
  buildCounterGoogleCloudRunV2TaskAttemptResult--;
}

core.List<api.GoogleCloudRunV2Container> buildUnnamed65() => [
  buildGoogleCloudRunV2Container(),
  buildGoogleCloudRunV2Container(),
];

void checkUnnamed65(core.List<api.GoogleCloudRunV2Container> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV2Container(o[0]);
  checkGoogleCloudRunV2Container(o[1]);
}

core.List<api.GoogleCloudRunV2Volume> buildUnnamed66() => [
  buildGoogleCloudRunV2Volume(),
  buildGoogleCloudRunV2Volume(),
];

void checkUnnamed66(core.List<api.GoogleCloudRunV2Volume> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV2Volume(o[0]);
  checkGoogleCloudRunV2Volume(o[1]);
}
...
core.List<api.GoogleCloudRunV2NetworkInterface> buildUnnamed67() => [
  buildGoogleCloudRunV2NetworkInterface(),
  buildGoogleCloudRunV2NetworkInterface(),
];

void checkUnnamed67(core.List<api.GoogleCloudRunV2NetworkInterface> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleCloudRunV2VpcAccess buildGoogleCloudRunV2VpcAccess() {
  ...
  if (buildCounterGoogleCloudRunV2VpcAccess < 3) {
    o.connector = 'foo';
    o.egress = 'foo';
    o.networkInterfaces = buildUnnamed67();
  }
  buildCounterGoogleCloudRunV2VpcAccess--;
  return o;
}
...
void checkGoogleCloudRunV2VpcAccess(api.GoogleCloudRunV2VpcAccess o) {
  buildCounterGoogleCloudRunV2VpcAccess++;
  if (buildCounterGoogleCloudRunV2VpcAccess < 3) {
    unittest.expect(o.connector!, unittest.equals('foo'));
    unittest.expect(o.egress!, unittest.equals('foo'));
    checkUnnamed67(o.networkInterfaces!);
  }
  buildCounterGoogleCloudRunV2VpcAccess--;
}
...
core.List<api.GoogleCloudRunV2Condition> buildUnnamed69() => [
  buildGoogleCloudRunV2Condition(),
  buildGoogleCloudRunV2Condition(),
];

void checkUnnamed69(core.List<api.GoogleCloudRunV2Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV2Condition(o[0]);
  checkGoogleCloudRunV2Condition(o[1]);
}
...
core.List<api.GoogleCloudRunV2InstanceSplitStatus> buildUnnamed71() => [
  buildGoogleCloudRunV2InstanceSplitStatus(),
  buildGoogleCloudRunV2InstanceSplitStatus(),
];

void checkUnnamed71(core.List<api.GoogleCloudRunV2InstanceSplitStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV2InstanceSplitStatus(o[0]);
  checkGoogleCloudRunV2InstanceSplitStatus(o[1]);
}

core.List<api.GoogleCloudRunV2InstanceSplit> buildUnnamed72() => [
  buildGoogleCloudRunV2InstanceSplit(),
  buildGoogleCloudRunV2InstanceSplit(),
];

void checkUnnamed72(core.List<api.GoogleCloudRunV2InstanceSplit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV2InstanceSplit(o[0]);
  checkGoogleCloudRunV2InstanceSplit(o[1]);
}
...
core.int buildCounterGoogleCloudRunV2WorkerPool = 0;
api.GoogleCloudRunV2WorkerPool buildGoogleCloudRunV2WorkerPool() {
  final o = api.GoogleCloudRunV2WorkerPool();
  buildCounterGoogleCloudRunV2WorkerPool++;
  if (buildCounterGoogleCloudRunV2WorkerPool < 3) {
    o.annotations = buildUnnamed68();
    o.binaryAuthorization = buildGoogleCloudRunV2BinaryAuthorization();
    o.client = 'foo';
    o.clientVersion = 'foo';
    ...
    o.createTime = 'foo';
    o.creator = 'foo';
    o.customAudiences = buildUnnamed70();
    o.deleteTime = 'foo';
    o.description = 'foo';
    o.etag = 'foo';
    o.expireTime = 'foo';
    o.generation = 'foo';
    o.instanceSplitStatuses = buildUnnamed71();
    o.instanceSplits = buildUnnamed72();
    ...
    o.reconciling = true;
    o.satisfiesPzs = true;
    o.scaling = buildGoogleCloudRunV2WorkerPoolScaling();
    o.template = buildGoogleCloudRunV2WorkerPoolRevisionTemplate();
    o.terminalCondition = buildGoogleCloudRunV2Condition();
    o.threatDetectionEnabled = true;
    o.uid = 'foo';
    o.updateTime = 'foo';
...
void checkGoogleCloudRunV2WorkerPool(api.GoogleCloudRunV2WorkerPool o) {
  buildCounterGoogleCloudRunV2WorkerPool++;
  if (buildCounterGoogleCloudRunV2WorkerPool < 3) {
    checkUnnamed68(o.annotations!);
    checkGoogleCloudRunV2BinaryAuthorization(o.binaryAuthorization!);
    unittest.expect(o.client!, unittest.equals('foo'));
    unittest.expect(o.clientVersion!, unittest.equals('foo'));
    ...
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.creator!, unittest.equals('foo'));
    checkUnnamed70(o.customAudiences!);
    unittest.expect(o.deleteTime!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.etag!, unittest.equals('foo'));
    unittest.expect(o.expireTime!, unittest.equals('foo'));
    unittest.expect(o.generation!, unittest.equals('foo'));
    checkUnnamed71(o.instanceSplitStatuses!);
    checkUnnamed72(o.instanceSplits!);
    ...
    unittest.expect(o.reconciling!, unittest.isTrue);
    unittest.expect(o.satisfiesPzs!, unittest.isTrue);
    checkGoogleCloudRunV2WorkerPoolScaling(o.scaling!);
    checkGoogleCloudRunV2WorkerPoolRevisionTemplate(o.template!);
    checkGoogleCloudRunV2Condition(o.terminalCondition!);
    unittest.expect(o.threatDetectionEnabled!, unittest.isTrue);
    unittest.expect(o.uid!, unittest.equals('foo'));
    unittest.expect(o.updateTime!, unittest.equals('foo'));
...
core.List<api.GoogleCloudRunV2Container> buildUnnamed75() => [
  buildGoogleCloudRunV2Container(),
  buildGoogleCloudRunV2Container(),
];

void checkUnnamed75(core.List<api.GoogleCloudRunV2Container> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV2Container(o[0]);
  checkGoogleCloudRunV2Container(o[1]);
}
...
core.List<api.GoogleCloudRunV2Volume> buildUnnamed77() => [
  buildGoogleCloudRunV2Volume(),
  buildGoogleCloudRunV2Volume(),
];

void checkUnnamed77(core.List<api.GoogleCloudRunV2Volume> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudRunV2Volume(o[0]);
  checkGoogleCloudRunV2Volume(o[1]);
}

core.int buildCounterGoogleCloudRunV2WorkerPoolRevisionTemplate = 0;
api.GoogleCloudRunV2WorkerPoolRevisionTemplate
buildGoogleCloudRunV2WorkerPoolRevisionTemplate() {
  final o = api.GoogleCloudRunV2WorkerPoolRevisionTemplate();
  buildCounterGoogleCloudRunV2WorkerPoolRevisionTemplate++;
  if (buildCounterGoogleCloudRunV2WorkerPoolRevisionTemplate < 3) {
    o.annotations = buildUnnamed74();
    o.client = 'foo';
    o.clientVersion = 'foo';
    o.containers = buildUnnamed75();
    o.encryptionKey = 'foo';
    o.encryptionKeyRevocationAction = 'foo';
    o.encryptionKeyShutdownDuration = 'foo';
    o.gpuZonalRedundancyDisabled = true;
...
void checkGoogleCloudRunV2WorkerPoolRevisionTemplate(
  api.GoogleCloudRunV2WorkerPoolRevisionTemplate o,
) {
  buildCounterGoogleCloudRunV2WorkerPoolRevisionTemplate++;
  if (buildCounterGoogleCloudRunV2WorkerPoolRevisionTemplate < 3) {
    ...
    unittest.expect(o.serviceAccount!, unittest.equals('foo'));
    checkGoogleCloudRunV2ServiceMesh(o.serviceMesh!);
    checkUnnamed77(o.volumes!);
    checkGoogleCloudRunV2VpcAccess(o.vpcAccess!);
  }
  buildCounterGoogleCloudRunV2WorkerPoolRevisionTemplate--;
}

core.int buildCounterGoogleCloudRunV2WorkerPoolScaling = 0;
api.GoogleCloudRunV2WorkerPoolScaling buildGoogleCloudRunV2WorkerPoolScaling() {
  final o = api.GoogleCloudRunV2WorkerPoolScaling();
  buildCounterGoogleCloudRunV2WorkerPoolScaling++;
  if (buildCounterGoogleCloudRunV2WorkerPoolScaling < 3) {
    o.manualInstanceCount = 42;
  }
  buildCounterGoogleCloudRunV2WorkerPoolScaling--;
  return o;
...
void checkGoogleCloudRunV2WorkerPoolScaling(
  api.GoogleCloudRunV2WorkerPoolScaling o,
) {
  buildCounterGoogleCloudRunV2WorkerPoolScaling++;
  if (buildCounterGoogleCloudRunV2WorkerPoolScaling < 3) {
    unittest.expect(o.manualInstanceCount!, unittest.equals(42));
...
void checkUnnamed78(core.List<api.GoogleIamV1AuditLogConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleIamV1AuditConfig buildGoogleIamV1AuditConfig() {
  ...
  if (buildCounterGoogleIamV1AuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed78();
    o.service = 'foo';
  }
  buildCounterGoogleIamV1AuditConfig--;
  return o;
...
void checkGoogleIamV1AuditConfig(api.GoogleIamV1AuditConfig o) {
  buildCounterGoogleIamV1AuditConfig++;
  if (buildCounterGoogleIamV1AuditConfig < 3) {
    checkUnnamed78(o.auditLogConfigs!);
    unittest.expect(o.service!, unittest.equals('foo'));
  }
  buildCounterGoogleIamV1AuditConfig--;
}
...
api.GoogleIamV1AuditLogConfig buildGoogleIamV1AuditLogConfig() {
  ...
  if (buildCounterGoogleIamV1AuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed79();
    o.logType = 'foo';
  }
  buildCounterGoogleIamV1AuditLogConfig--;
  return o;
...
void checkGoogleIamV1AuditLogConfig(api.GoogleIamV1AuditLogConfig o) {
  buildCounterGoogleIamV1AuditLogConfig++;
  if (buildCounterGoogleIamV1AuditLogConfig < 3) {
    checkUnnamed79(o.exemptedMembers!);
...
void checkGoogleIamV1Binding(api.GoogleIamV1Binding o) {
  ...
  if (buildCounterGoogleIamV1Binding < 3) {
    ...
    checkUnnamed80(o.members!);
    unittest.expect(o.role!, unittest.equals('foo'));
  }
  buildCounterGoogleIamV1Binding--;
}

core.List<api.GoogleIamV1AuditConfig> buildUnnamed81() => [
  buildGoogleIamV1AuditConfig(),
  buildGoogleIamV1AuditConfig(),
];

void checkUnnamed81(core.List<api.GoogleIamV1AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleIamV1AuditConfig(o[0]);
  checkGoogleIamV1AuditConfig(o[1]);
}

core.List<api.GoogleIamV1Binding> buildUnnamed82() => [
  buildGoogleIamV1Binding(),
  buildGoogleIamV1Binding(),
];

void checkUnnamed82(core.List<api.GoogleIamV1Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleLongrunningOperation> buildUnnamed85() => [
  buildGoogleLongrunningOperation(),
  buildGoogleLongrunningOperation(),
];

void checkUnnamed85(core.List<api.GoogleLongrunningOperation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void main() {
  ...
  unittest.group('obj-schema-GoogleCloudRunV2BuildConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2BuildConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2BuildConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2BuildConfig(od);
    });
  });

  unittest.group('obj-schema-GoogleCloudRunV2BuildInfo', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2BuildInfo();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2BuildInfo.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2BuildInfo(od);
    });
  });

  unittest.group('obj-schema-GoogleCloudRunV2BuildpacksBuild', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2BuildpacksBuild();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2BuildpacksBuild.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2BuildpacksBuild(od);
    });
  });
  ...
  unittest.group('obj-schema-GoogleCloudRunV2CloudStorageSource', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2CloudStorageSource();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2CloudStorageSource.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2CloudStorageSource(od);
    });
  });
  ...
  unittest.group('obj-schema-GoogleCloudRunV2ContainerStatus', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2ContainerStatus();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2ContainerStatus.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2ContainerStatus(od);
    });
  });

  unittest.group('obj-schema-GoogleCloudRunV2DockerBuild', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2DockerBuild();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2DockerBuild.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2DockerBuild(od);
    });
  });
  ...
  unittest.group('obj-schema-GoogleCloudRunV2InlinedSource', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2InlinedSource();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2InlinedSource.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2InlinedSource(od);
    });
  });

  unittest.group('obj-schema-GoogleCloudRunV2Instance', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2Instance();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2Instance.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2Instance(od);
    });
  });

  unittest.group('obj-schema-GoogleCloudRunV2InstanceSplit', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2InstanceSplit();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2InstanceSplit.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2InstanceSplit(od);
    });
  });

  unittest.group('obj-schema-GoogleCloudRunV2InstanceSplitStatus', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2InstanceSplitStatus();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2InstanceSplitStatus.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2InstanceSplitStatus(od);
    });
  });
  ...
  unittest.group('obj-schema-GoogleCloudRunV2ListInstancesResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2ListInstancesResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2ListInstancesResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2ListInstancesResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-GoogleCloudRunV2ListWorkerPoolsResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2ListWorkerPoolsResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2ListWorkerPoolsResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2ListWorkerPoolsResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-GoogleCloudRunV2MultiRegionSettings', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2MultiRegionSettings();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2MultiRegionSettings.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2MultiRegionSettings(od);
    });
  });
  ...
  unittest.group('obj-schema-GoogleCloudRunV2ServiceMesh', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2ServiceMesh();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2ServiceMesh.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2ServiceMesh(od);
    });
  });
  ...
  unittest.group('obj-schema-GoogleCloudRunV2SourceCode', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2SourceCode();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2SourceCode.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2SourceCode(od);
    });
  });

  unittest.group('obj-schema-GoogleCloudRunV2SourceFile', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2SourceFile();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2SourceFile.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2SourceFile(od);
    });
  });

  unittest.group('obj-schema-GoogleCloudRunV2StartInstanceRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2StartInstanceRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2StartInstanceRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2StartInstanceRequest(od);
    });
  });

  unittest.group('obj-schema-GoogleCloudRunV2StopInstanceRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2StopInstanceRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2StopInstanceRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2StopInstanceRequest(od);
    });
  });

  unittest.group('obj-schema-GoogleCloudRunV2StorageSource', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2StorageSource();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2StorageSource.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2StorageSource(od);
    });
  });

  unittest.group('obj-schema-GoogleCloudRunV2SubmitBuildRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2SubmitBuildRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2SubmitBuildRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2SubmitBuildRequest(od);
    });
  });

  unittest.group('obj-schema-GoogleCloudRunV2SubmitBuildResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2SubmitBuildResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2SubmitBuildResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2SubmitBuildResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-GoogleCloudRunV2WorkerPool', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2WorkerPool();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2WorkerPool.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2WorkerPool(od);
    });
  });

  unittest.group('obj-schema-GoogleCloudRunV2WorkerPoolRevisionTemplate', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2WorkerPoolRevisionTemplate();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2WorkerPoolRevisionTemplate.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudRunV2WorkerPoolRevisionTemplate(od);
    });
  });

  unittest.group('obj-schema-GoogleCloudRunV2WorkerPoolScaling', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudRunV2WorkerPoolScaling();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudRunV2WorkerPoolScaling.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
  ...
  unittest.group('resource-ProjectsLocationsResource', () {
    unittest.test('method--exportImage', () async {
      ...
      final response = await res.exportImage(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--exportImageMetadata', () async {
      ...
      final response = await res.exportImageMetadata(
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--exportProjectMetadata', () async {
      final mock = HttpServerMock();
      final res = api.CloudRunApi(mock).projects.locations;
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      ...
      final response = await res.exportProjectMetadata(
        arg_name,
        $fields: arg_$fields,
      );
      checkGoogleCloudRunV2Metadata(response as api.GoogleCloudRunV2Metadata);
  ...
  unittest.group('resource-ProjectsLocationsBuildsResource', () {
    unittest.test('method--submit', () async {
      final mock = HttpServerMock();
      final res = api.CloudRunApi(mock).projects.locations.builds;
      final arg_request = buildGoogleCloudRunV2SubmitBuildRequest();
      final arg_parent = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.GoogleCloudRunV2SubmitBuildRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkGoogleCloudRunV2SubmitBuildRequest(obj);
      ...
      checkGoogleCloudRunV2SubmitBuildResponse(
        response as api.GoogleCloudRunV2SubmitBuildResponse,
      );
    });
  });
  ...
  unittest.group('resource-ProjectsLocationsInstancesResource', () {
    unittest.test('method--create', () async {
      ...
      final arg_request = buildGoogleCloudRunV2Instance();
      final arg_parent = 'foo';
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.GoogleCloudRunV2Instance.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkGoogleCloudRunV2Instance(obj);
    ...
    unittest.test('method--get', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildGoogleCloudRunV2Instance());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
    ...
    unittest.test('method--list', () async {
      ...
      checkGoogleCloudRunV2ListInstancesResponse(
        response as api.GoogleCloudRunV2ListInstancesResponse,
      );
    });
    ...
    unittest.test('method--start', () async {
      final mock = HttpServerMock();
      final res = api.CloudRunApi(mock).projects.locations.instances;
      final arg_request = buildGoogleCloudRunV2StartInstanceRequest();
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.GoogleCloudRunV2StartInstanceRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkGoogleCloudRunV2StartInstanceRequest(obj);
    ...
    unittest.test('method--stop', () async {
      final mock = HttpServerMock();
      final res = api.CloudRunApi(mock).projects.locations.instances;
      final arg_request = buildGoogleCloudRunV2StopInstanceRequest();
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.GoogleCloudRunV2StopInstanceRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkGoogleCloudRunV2StopInstanceRequest(obj);
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildGoogleCloudRunV2ListJobsResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
  ...
  unittest.group('resource-ProjectsLocationsJobsExecutionsResource', () {
    ...
    unittest.test('method--exportStatus', () async {
      ...
      final response = await res.exportStatus(
        arg_name,
        arg_operationId,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildGoogleCloudRunV2ListTasksResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
  ...
  unittest.group('resource-ProjectsLocationsServicesResource', () {
    ...
    unittest.test('method--patch', () async {
      ...
      final arg_name = 'foo';
      final arg_allowMissing = true;
      final arg_forceNewRevision = true;
      final arg_updateMask = 'foo';
      final arg_validateOnly = true;
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            queryMap['forceNewRevision']!.first,
            unittest.equals('$arg_forceNewRevision'),
          );
          unittest.expect(
            queryMap['updateMask']!.first,
            unittest.equals(arg_updateMask),
      ...
      final response = await res.patch(
        ...
        arg_name,
        allowMissing: arg_allowMissing,
        forceNewRevision: arg_forceNewRevision,
        updateMask: arg_updateMask,
        validateOnly: arg_validateOnly,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-ProjectsLocationsWorkerPoolsResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.CloudRunApi(mock).projects.locations.workerPools;
      final arg_request = buildGoogleCloudRunV2WorkerPool();
      final arg_parent = 'foo';
      final arg_validateOnly = true;
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.GoogleCloudRunV2WorkerPool.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkGoogleCloudRunV2WorkerPool(obj);
    ...
    unittest.test('method--get', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildGoogleCloudRunV2WorkerPool());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.get(arg_name, $fields: arg_$fields);
      checkGoogleCloudRunV2WorkerPool(
        response as api.GoogleCloudRunV2WorkerPool,
      );
    });
    ...
    unittest.test('method--list', () async {
      ...
      checkGoogleCloudRunV2ListWorkerPoolsResponse(
        response as api.GoogleCloudRunV2ListWorkerPoolsResponse,
      );
    });
