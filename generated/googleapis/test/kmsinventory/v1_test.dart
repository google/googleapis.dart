...
void main() {
  unittest.group(
    'obj-schema-GoogleCloudKmsInventoryV1ListCryptoKeysResponse',
    () {
  ...
  unittest.group(
    'obj-schema-GoogleCloudKmsV1ExternalProtectionLevelOptions',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudKmsV1KeyAccessJustificationsPolicy',
    () {
      unittest.test('to-json--from-json', () async {
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudKmsV1KeyOperationAttestationCertificateChains();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudKmsV1KeyOperationAttestationCertificateChains
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
