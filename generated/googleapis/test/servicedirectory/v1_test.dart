...
import 'package:googleapis/servicedirectory/v1.dart' as api;
...
core.Map<core.String, core.String> buildUnnamed6884() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed6884(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.Endpoint buildEndpoint() {
  ...
  if (buildCounterEndpoint < 3) {
    o.address = 'foo';
    o.annotations = buildUnnamed6884();
    o.name = 'foo';
    o.port = 42;
  }
  buildCounterEndpoint--;
...
void checkEndpoint(api.Endpoint o) {
  ...
  if (buildCounterEndpoint < 3) {
    ...
    checkUnnamed6884(o.annotations!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
core.List<api.Endpoint> buildUnnamed6885() => [
      buildEndpoint(),
      buildEndpoint(),
    ];

void checkUnnamed6885(core.List<api.Endpoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEndpoint(o[0]);
  checkEndpoint(o[1]);
}
...
core.List<api.Location> buildUnnamed6886() => [
      buildLocation(),
      buildLocation(),
    ];

void checkUnnamed6886(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
core.List<api.Namespace> buildUnnamed6887() => [
      buildNamespace(),
      buildNamespace(),
    ];

void checkUnnamed6887(core.List<api.Namespace> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNamespace(o[0]);
  checkNamespace(o[1]);
}
...
api.ListNamespacesResponse buildListNamespacesResponse() {
  final o = api.ListNamespacesResponse();
  buildCounterListNamespacesResponse++;
  if (buildCounterListNamespacesResponse < 3) {
    o.namespaces = buildUnnamed6887();
    o.nextPageToken = 'foo';
  }
  buildCounterListNamespacesResponse--;
  return o;
...
void checkListNamespacesResponse(api.ListNamespacesResponse o) {
  buildCounterListNamespacesResponse++;
  if (buildCounterListNamespacesResponse < 3) {
    checkUnnamed6887(o.namespaces!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Service> buildUnnamed6888() => [
      buildService(),
      buildService(),
    ];

void checkUnnamed6888(core.List<api.Service> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkService(o[0]);
  checkService(o[1]);
}
...
void checkListServicesResponse(api.ListServicesResponse o) {
  ...
  if (buildCounterListServicesResponse < 3) {
    ...
    checkUnnamed6888(o.services!);
  }
  buildCounterListServicesResponse--;
}

core.Map<core.String, core.String> buildUnnamed6889() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed6889(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.Map<core.String, core.String> buildUnnamed6891() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed6891(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.Binding> buildUnnamed6892() => [
      buildBinding(),
      buildBinding(),
    ];

void checkUnnamed6892(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
core.int buildCounterResolveServiceRequest = 0;
api.ResolveServiceRequest buildResolveServiceRequest() {
  final o = api.ResolveServiceRequest();
  buildCounterResolveServiceRequest++;
  if (buildCounterResolveServiceRequest < 3) {
...
void checkResolveServiceRequest(api.ResolveServiceRequest o) {
  buildCounterResolveServiceRequest++;
  if (buildCounterResolveServiceRequest < 3) {
    unittest.expect(
      o.endpointFilter!,
...
core.int buildCounterResolveServiceResponse = 0;
api.ResolveServiceResponse buildResolveServiceResponse() {
  final o = api.ResolveServiceResponse();
...
core.Map<core.String, core.String> buildUnnamed6893() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed6893(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.Endpoint> buildUnnamed6894() => [
      buildEndpoint(),
      buildEndpoint(),
    ];

void checkUnnamed6894(core.List<api.Endpoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEndpoint(o[0]);
  checkEndpoint(o[1]);
}
...
api.Service buildService() {
  ...
  if (buildCounterService < 3) {
    o.annotations = buildUnnamed6893();
    o.endpoints = buildUnnamed6894();
    o.name = 'foo';
  }
  buildCounterService--;
  return o;
...
void checkService(api.Service o) {
  buildCounterService++;
  if (buildCounterService < 3) {
    checkUnnamed6893(o.annotations!);
    checkUnnamed6894(o.endpoints!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
api.TestIamPermissionsRequest buildTestIamPermissionsRequest() {
  ...
  if (buildCounterTestIamPermissionsRequest < 3) {
    o.permissions = buildUnnamed6895();
  }
  buildCounterTestIamPermissionsRequest--;
  return o;
}
...
void checkTestIamPermissionsRequest(api.TestIamPermissionsRequest o) {
  buildCounterTestIamPermissionsRequest++;
  if (buildCounterTestIamPermissionsRequest < 3) {
    checkUnnamed6895(o.permissions!);
  }
  buildCounterTestIamPermissionsRequest--;
}
...
void main() {
  ...
  unittest.group('obj-schema-ListNamespacesResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildListNamespacesResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListNamespacesResponse.fromJson(
          oJson as core.Map<core.String, core.dynamic>);
  ...
  unittest.group('obj-schema-ResolveServiceRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildResolveServiceRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ResolveServiceRequest.fromJson(
          oJson as core.Map<core.String, core.dynamic>);
  ...
  unittest.group('obj-schema-ResolveServiceResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildResolveServiceResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ResolveServiceResponse.fromJson(
          oJson as core.Map<core.String, core.dynamic>);
  ...
  unittest.group('resource-ProjectsLocationsResource', () {
    unittest.test('method--get', () async {
      ...
      final res = api.ServiceDirectoryApi(mock).projects.locations;
      final arg_name = 'foo';
  ...
  unittest.group('resource-ProjectsLocationsNamespacesResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.ServiceDirectoryApi(mock).projects.locations.namespaces;
      final arg_request = buildNamespace();
      final arg_parent = 'foo';
      final arg_namespaceId = 'foo';
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final obj =
        ...
        unittest.expect(
          queryMap['namespaceId']!.first,
          unittest.equals(arg_namespaceId),
        );
        unittest.expect(
          queryMap['fields']!.first,
          unittest.equals(arg_$fields),
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        final resp = convert.json.encode(buildListNamespacesResponse());
        return async.Future.value(stringResponse(200, h, resp));
      }), true);
  ...
  unittest.group('resource-ProjectsLocationsNamespacesServicesResource', () {
    ...
    unittest.test('method--resolve', () async {
      ...
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final obj = api.ResolveServiceRequest.fromJson(
            json as core.Map<core.String, core.dynamic>);
        ...
        final resp = convert.json.encode(buildResolveServiceResponse());
        return async.Future.value(stringResponse(200, h, resp));
      }), true);
      final response =
  ...
  unittest.group(
    ...
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.ServiceDirectoryApi(mock)
          .projects
          .locations
          .namespaces
          .services
