...
import 'package:googleapis/servicedirectory/v1beta1.dart' as api;
...
core.List<api.Endpoint> buildUnnamed10() => [buildEndpoint(), buildEndpoint()];

void checkUnnamed10(core.List<api.Endpoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEndpoint(o[0]);
  checkEndpoint(o[1]);
}
...
void main() {
  ...
  unittest.group('resource-ProjectsLocationsNamespacesWorkloadsResource', () {
    unittest.test('method--getIamPolicy', () async {
      final mock = HttpServerMock();
      final res =
          api.ServiceDirectoryApi(mock).projects.locations.namespaces.workloads;
      final arg_request = buildGetIamPolicyRequest();
      final arg_resource = 'foo';
      final arg_$fields = 'foo';
      mock.register(
