...
import 'package:googleapis/speech/v1p1beta1.dart' as api;
...
core.List<api.Phrase> buildUnnamed9() => [buildPhrase(), buildPhrase()];
...
core.List<api.WordInfo> buildUnnamed17() => [buildWordInfo(), buildWordInfo()];
...
core.List<api.Entry> buildUnnamed21() => [buildEntry(), buildEntry()];
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            ...
            unittest.equals('v1p1beta1/operations/'),
          );
          pathOffset += 21;
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            ...
            unittest.equals('v1p1beta1/speech:longrunningrecognize'),
          );
          pathOffset += 37;
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            ...
            unittest.equals('v1p1beta1/speech:recognize'),
          );
          pathOffset += 26;
