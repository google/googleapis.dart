...
core.List<api.Operation> buildUnnamed3924() => [
      buildOperation(),
      buildOperation(),
    ];

void checkUnnamed3924(core.List<api.Operation> o) {
...
core.List<api.SpeechRecognitionResult> buildUnnamed3925() => [
      buildSpeechRecognitionResult(),
      buildSpeechRecognitionResult(),
    ];

void checkUnnamed3925(core.List<api.SpeechRecognitionResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkLongRunningRecognizeResponse(api.LongRunningRecognizeResponse o) {
  buildCounterLongRunningRecognizeResponse++;
  if (buildCounterLongRunningRecognizeResponse < 3) {
    checkUnnamed3925(o.results!);
  }
  buildCounterLongRunningRecognizeResponse--;
}

core.Map<core.String, core.Object> buildUnnamed3926() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed3926(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed3927() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed3927(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.SpeechContext> buildUnnamed3928() => [
      buildSpeechContext(),
      buildSpeechContext(),
    ];

void checkUnnamed3928(core.List<api.SpeechContext> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.RecognitionConfig buildRecognitionConfig() {
  ...
  if (buildCounterRecognitionConfig < 3) {
    ...
    o.speechContexts = buildUnnamed3928();
    o.useEnhanced = true;
  }
  buildCounterRecognitionConfig--;
  return o;
...
void checkRecognitionConfig(api.RecognitionConfig o) {
  ...
  if (buildCounterRecognitionConfig < 3) {
    ...
    checkUnnamed3928(o.speechContexts!);
...
core.List<api.SpeechRecognitionResult> buildUnnamed3929() => [
      buildSpeechRecognitionResult(),
      buildSpeechRecognitionResult(),
    ];

void checkUnnamed3929(core.List<api.SpeechRecognitionResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSpeechRecognitionResult(o[0]);
  checkSpeechRecognitionResult(o[1]);
}
...
void checkSpeechContext(api.SpeechContext o) {
  buildCounterSpeechContext++;
  if (buildCounterSpeechContext < 3) {
    checkUnnamed3930(o.phrases!);
  }
  buildCounterSpeechContext--;
}

core.List<api.WordInfo> buildUnnamed3931() => [
      buildWordInfo(),
      buildWordInfo(),
    ];

void checkUnnamed3931(core.List<api.WordInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWordInfo(o[0]);
  checkWordInfo(o[1]);
}
...
void checkSpeechRecognitionAlternative(api.SpeechRecognitionAlternative o) {
  ...
  if (buildCounterSpeechRecognitionAlternative < 3) {
    ...
    checkUnnamed3931(o.words!);
  }
  buildCounterSpeechRecognitionAlternative--;
}

core.List<api.SpeechRecognitionAlternative> buildUnnamed3932() => [
      buildSpeechRecognitionAlternative(),
      buildSpeechRecognitionAlternative(),
    ];

void checkUnnamed3932(core.List<api.SpeechRecognitionAlternative> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SpeechRecognitionResult buildSpeechRecognitionResult() {
  ...
  if (buildCounterSpeechRecognitionResult < 3) {
    o.alternatives = buildUnnamed3932();
    o.channelTag = 42;
  }
  buildCounterSpeechRecognitionResult--;
  return o;
...
void checkSpeechRecognitionResult(api.SpeechRecognitionResult o) {
  buildCounterSpeechRecognitionResult++;
  if (buildCounterSpeechRecognitionResult < 3) {
    checkUnnamed3932(o.alternatives!);
    unittest.expect(
      o.channelTag!,
      unittest.equals(42),
    );
...
core.Map<core.String, core.Object> buildUnnamed3933() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed3933(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed3934() => [
      buildUnnamed3933(),
      buildUnnamed3933(),
    ];

void checkUnnamed3934(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed3933(o[0]);
  checkUnnamed3933(o[1]);
}
