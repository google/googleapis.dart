...
void checkCreateCustomClassRequest(api.CreateCustomClassRequest o) {
  ...
  if (buildCounterCreateCustomClassRequest < 3) {
    ...
    unittest.expect(o.customClassId!, unittest.equals('foo'));
  }
  buildCounterCreateCustomClassRequest--;
}
...
void checkCreatePhraseSetRequest(api.CreatePhraseSetRequest o) {
  ...
  if (buildCounterCreatePhraseSetRequest < 3) {
    ...
    unittest.expect(o.phraseSetId!, unittest.equals('foo'));
  }
  buildCounterCreatePhraseSetRequest--;
}
...
void checkEntry(api.Entry o) {
  ...
  if (buildCounterEntry < 3) {
    ...
    unittest.expect(o.search!, unittest.equals('foo'));
  }
  buildCounterEntry--;
}
...
core.List<api.Phrase> buildUnnamed10() => [buildPhrase(), buildPhrase()];

void checkUnnamed10(core.List<api.Phrase> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPhrase(o[0]);
  checkPhrase(o[1]);
}
...
core.List<api.SpeechContext> buildUnnamed12() => [
  buildSpeechContext(),
  buildSpeechContext(),
];

void checkUnnamed12(core.List<api.SpeechContext> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.RecognitionConfig buildRecognitionConfig() {
  ...
  if (buildCounterRecognitionConfig < 3) {
    ...
    o.alternativeLanguageCodes = buildUnnamed11();
    ...
    o.speechContexts = buildUnnamed12();
...
void checkRecognitionConfig(api.RecognitionConfig o) {
  ...
  if (buildCounterRecognitionConfig < 3) {
    ...
    checkUnnamed11(o.alternativeLanguageCodes!);
    ...
    checkUnnamed12(o.speechContexts!);
...
core.List<api.SpeechRecognitionResult> buildUnnamed13() => [
  buildSpeechRecognitionResult(),
  buildSpeechRecognitionResult(),
];

void checkUnnamed13(core.List<api.SpeechRecognitionResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkRecognizeResponse(api.RecognizeResponse o) {
  ...
  if (buildCounterRecognizeResponse < 3) {
    ...
    checkUnnamed13(o.results!);
    checkSpeechAdaptationInfo(o.speechAdaptationInfo!);
    unittest.expect(o.totalBilledTime!, unittest.equals('foo'));
...
core.List<api.CustomClass> buildUnnamed14() => [
  buildCustomClass(),
  buildCustomClass(),
];

void checkUnnamed14(core.List<api.CustomClass> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCustomClass(o[0]);
  checkCustomClass(o[1]);
}
...
core.List<api.PhraseSet> buildUnnamed16() => [
  buildPhraseSet(),
  buildPhraseSet(),
];

void checkUnnamed16(core.List<api.PhraseSet> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPhraseSet(o[0]);
  checkPhraseSet(o[1]);
}
...
api.SpeechAdaptation buildSpeechAdaptation() {
  ...
  if (buildCounterSpeechAdaptation < 3) {
    ...
    o.customClasses = buildUnnamed14();
    o.phraseSetReferences = buildUnnamed15();
    o.phraseSets = buildUnnamed16();
  }
  buildCounterSpeechAdaptation--;
  return o;
}
...
void checkSpeechAdaptation(api.SpeechAdaptation o) {
  ...
  if (buildCounterSpeechAdaptation < 3) {
    ...
    checkUnnamed14(o.customClasses!);
    checkUnnamed15(o.phraseSetReferences!);
    checkUnnamed16(o.phraseSets!);
  }
  buildCounterSpeechAdaptation--;
}
...
void checkSpeechAdaptationInfo(api.SpeechAdaptationInfo o) {
  ...
  if (buildCounterSpeechAdaptationInfo < 3) {
    ...
    unittest.expect(o.timeoutMessage!, unittest.equals('foo'));
  }
  buildCounterSpeechAdaptationInfo--;
}
...
void checkSpeechContext(api.SpeechContext o) {
  ...
  if (buildCounterSpeechContext < 3) {
    unittest.expect(o.boost!, unittest.equals(42.0));
    checkUnnamed17(o.phrases!);
  }
  buildCounterSpeechContext--;
}

core.List<api.WordInfo> buildUnnamed18() => [buildWordInfo(), buildWordInfo()];

void checkUnnamed18(core.List<api.WordInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWordInfo(o[0]);
  checkWordInfo(o[1]);
}
...
void checkSpeechRecognitionAlternative(api.SpeechRecognitionAlternative o) {
  ...
  if (buildCounterSpeechRecognitionAlternative < 3) {
    ...
    checkUnnamed18(o.words!);
  }
  buildCounterSpeechRecognitionAlternative--;
}

core.List<api.SpeechRecognitionAlternative> buildUnnamed19() => [
  buildSpeechRecognitionAlternative(),
  buildSpeechRecognitionAlternative(),
];

void checkUnnamed19(core.List<api.SpeechRecognitionAlternative> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkSpeechRecognitionResult(api.SpeechRecognitionResult o) {
  buildCounterSpeechRecognitionResult++;
  if (buildCounterSpeechRecognitionResult < 3) {
    checkUnnamed19(o.alternatives!);
    unittest.expect(o.channelTag!, unittest.equals(42));
    unittest.expect(o.languageCode!, unittest.equals('foo'));
    unittest.expect(o.resultEndTime!, unittest.equals('foo'));
  }
  buildCounterSpeechRecognitionResult--;
}
...
core.List<api.Entry> buildUnnamed22() => [buildEntry(), buildEntry()];

void checkUnnamed22(core.List<api.Entry> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEntry(o[0]);
  checkEntry(o[1]);
}
...
void checkWordInfo(api.WordInfo o) {
  ...
  if (buildCounterWordInfo < 3) {
    ...
    unittest.expect(o.speakerLabel!, unittest.equals('foo'));
    unittest.expect(o.speakerTag!, unittest.equals(42));
...
void main() {
  ...
  unittest.group('obj-schema-ClassItem', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ClassItem.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkClassItem(od);
    });
  ...
  unittest.group('obj-schema-PhraseSet', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.PhraseSet.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPhraseSet(od);
    });
  ...
  unittest.group('obj-schema-WordInfo', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.WordInfo.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkWordInfo(od);
    });
  ...
  unittest.group('resource-ProjectsLocationsPhraseSetsResource', () {
    ...
    unittest.test('method--patch', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.PhraseSet.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkPhraseSet(obj);
  ...
  unittest.group('resource-SpeechResource', () {
    unittest.test('method--longrunningrecognize', () async {
      ...
      final response = await res.longrunningrecognize(
        arg_request,
        $fields: arg_$fields,
      );
      checkOperation(response as api.Operation);
