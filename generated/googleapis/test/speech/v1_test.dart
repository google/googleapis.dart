...
core.List<api.Operation> buildUnnamed6054() => [
      buildOperation(),
      buildOperation(),
    ];

void checkUnnamed6054(core.List<api.Operation> o) {
...
core.Map<core.String, core.Object> buildUnnamed6056() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed6056(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed6056();
    o.name = 'foo';
    o.response = buildUnnamed6057();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error!);
    checkUnnamed6056(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed6057(o.response!);
  }
  buildCounterOperation--;
}
...
core.List<api.SpeechContext> buildUnnamed6058() => [
      buildSpeechContext(),
      buildSpeechContext(),
    ];

void checkUnnamed6058(core.List<api.SpeechContext> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.RecognitionConfig buildRecognitionConfig() {
  ...
  if (buildCounterRecognitionConfig < 3) {
    ...
    o.speechContexts = buildUnnamed6058();
    o.useEnhanced = true;
  }
  buildCounterRecognitionConfig--;
  return o;
...
void checkRecognitionConfig(api.RecognitionConfig o) {
  ...
  if (buildCounterRecognitionConfig < 3) {
    ...
    checkUnnamed6058(o.speechContexts!);
...
core.List<api.SpeechRecognitionResult> buildUnnamed6059() => [
      buildSpeechRecognitionResult(),
      buildSpeechRecognitionResult(),
    ];

void checkUnnamed6059(core.List<api.SpeechRecognitionResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSpeechRecognitionResult(o[0]);
  checkSpeechRecognitionResult(o[1]);
}
...
void checkSpeechContext(api.SpeechContext o) {
  buildCounterSpeechContext++;
  if (buildCounterSpeechContext < 3) {
    checkUnnamed6060(o.phrases!);
  }
  buildCounterSpeechContext--;
}

core.List<api.WordInfo> buildUnnamed6061() => [
      buildWordInfo(),
      buildWordInfo(),
    ];

void checkUnnamed6061(core.List<api.WordInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWordInfo(o[0]);
  checkWordInfo(o[1]);
}
...
void checkSpeechRecognitionAlternative(api.SpeechRecognitionAlternative o) {
  ...
  if (buildCounterSpeechRecognitionAlternative < 3) {
    ...
    checkUnnamed6061(o.words!);
  }
  buildCounterSpeechRecognitionAlternative--;
}

core.List<api.SpeechRecognitionAlternative> buildUnnamed6062() => [
      buildSpeechRecognitionAlternative(),
      buildSpeechRecognitionAlternative(),
    ];

void checkUnnamed6062(core.List<api.SpeechRecognitionAlternative> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SpeechRecognitionResult buildSpeechRecognitionResult() {
  ...
  if (buildCounterSpeechRecognitionResult < 3) {
    o.alternatives = buildUnnamed6062();
    o.channelTag = 42;
  }
  buildCounterSpeechRecognitionResult--;
  return o;
...
void checkSpeechRecognitionResult(api.SpeechRecognitionResult o) {
  buildCounterSpeechRecognitionResult++;
  if (buildCounterSpeechRecognitionResult < 3) {
    checkUnnamed6062(o.alternatives!);
    unittest.expect(
      o.channelTag!,
      unittest.equals(42),
    );
...
core.List<core.Map<core.String, core.Object>> buildUnnamed6064() => [
      buildUnnamed6063(),
      buildUnnamed6063(),
    ];

void checkUnnamed6064(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed6063(o[0]);
  checkUnnamed6063(o[1]);
}
