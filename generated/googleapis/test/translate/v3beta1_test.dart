...
import 'package:googleapis/translate/v3beta1.dart' as api;
...
void checkBatchTranslateDocumentRequest(api.BatchTranslateDocumentRequest o) {
  buildCounterBatchTranslateDocumentRequest++;
  if (buildCounterBatchTranslateDocumentRequest < 3) {
    unittest.expect(o.customizedAttribution!, unittest.equals('foo'));
...
core.List<api.Glossary> buildUnnamed14() => [buildGlossary(), buildGlossary()];
...
void main() {
  ...
  unittest.group('obj-schema-Glossary', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Glossary.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGlossary(od);
    });
  ...
  unittest.group('resource-ProjectsResource', () {
    unittest.test('method--detectLanguage', () async {
      ...
      final response = await res.detectLanguage(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--getSupportedLanguages', () async {
      ...
      final response = await res.getSupportedLanguages(
        arg_parent,
    ...
    unittest.test('method--translateText', () async {
      ...
      final response = await res.translateText(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-ProjectsLocationsResource', () {
    unittest.test('method--batchTranslateDocument', () async {
      ...
      final response = await res.batchTranslateDocument(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--batchTranslateText', () async {
      ...
      final response = await res.batchTranslateText(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--translateDocument', () async {
      ...
      final response = await res.translateDocument(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-ProjectsLocationsGlossariesResource', () {
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Glossary.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkGlossary(obj);
