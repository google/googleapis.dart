...
core.Map<core.String, api.TranslateTextGlossaryConfig> buildUnnamed5690() {
...
core.List<api.InputConfig> buildUnnamed5691() {
...
void checkUnnamed5691(core.List<api.InputConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInputConfig(o[0] as api.InputConfig);
  checkInputConfig(o[1] as api.InputConfig);
}

core.Map<core.String, core.String> buildUnnamed5692() {
...
void checkUnnamed5692(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BatchTranslateTextRequest buildBatchTranslateTextRequest() {
  ...
  if (buildCounterBatchTranslateTextRequest < 3) {
    o.glossaries = buildUnnamed5690();
    o.inputConfigs = buildUnnamed5691();
    o.labels = buildUnnamed5692();
    o.models = buildUnnamed5693();
    o.outputConfig = buildOutputConfig();
    o.sourceLanguageCode = 'foo';
    o.targetLanguageCodes = buildUnnamed5694();
  }
  buildCounterBatchTranslateTextRequest--;
  return o;
}
...
void checkBatchTranslateTextRequest(api.BatchTranslateTextRequest o) {
  buildCounterBatchTranslateTextRequest++;
  if (buildCounterBatchTranslateTextRequest < 3) {
    checkUnnamed5690(o.glossaries);
    checkUnnamed5691(o.inputConfigs);
    checkUnnamed5692(o.labels);
    checkUnnamed5693(o.models);
    checkOutputConfig(o.outputConfig as api.OutputConfig);
    unittest.expect(o.sourceLanguageCode, unittest.equals('foo'));
    checkUnnamed5694(o.targetLanguageCodes);
  }
  buildCounterBatchTranslateTextRequest--;
}
...
core.Map<core.String, core.String> buildUnnamed5695() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed5695(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o['x'], unittest.equals('foo'));
  unittest.expect(o['y'], unittest.equals('foo'));
}
...
core.List<api.DetectedLanguage> buildUnnamed5696() {
...
void checkUnnamed5696(core.List<api.DetectedLanguage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.LanguageCodesSet buildLanguageCodesSet() {
  ...
  if (buildCounterLanguageCodesSet < 3) {
    o.languageCodes = buildUnnamed5697();
  }
  buildCounterLanguageCodesSet--;
  return o;
}
...
void checkLanguageCodesSet(api.LanguageCodesSet o) {
  buildCounterLanguageCodesSet++;
  if (buildCounterLanguageCodesSet < 3) {
    checkUnnamed5697(o.languageCodes);
  }
  buildCounterLanguageCodesSet--;
}

core.List<api.Glossary> buildUnnamed5698() {
  var o = <api.Glossary>[];
  o.add(buildGlossary());
  o.add(buildGlossary());
  return o;
...
void checkUnnamed5698(core.List<api.Glossary> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListGlossariesResponse(api.ListGlossariesResponse o) {
  buildCounterListGlossariesResponse++;
  if (buildCounterListGlossariesResponse < 3) {
    checkUnnamed5698(o.glossaries);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListGlossariesResponse--;
}

core.List<api.Location> buildUnnamed5699() {
  var o = <api.Location>[];
  o.add(buildLocation());
  o.add(buildLocation());
  return o;
...
void checkUnnamed5699(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListLocationsResponse(api.ListLocationsResponse o) {
  buildCounterListLocationsResponse++;
  if (buildCounterListLocationsResponse < 3) {
    checkUnnamed5699(o.locations);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListLocationsResponse--;
}

core.List<api.Operation> buildUnnamed5700() {
  var o = <api.Operation>[];
...
void checkUnnamed5700(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListOperationsResponse(api.ListOperationsResponse o) {
  ...
  if (buildCounterListOperationsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed5700(o.operations);
  }
  buildCounterListOperationsResponse--;
}

core.Map<core.String, core.String> buildUnnamed5701() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed5701(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o['x'], unittest.equals('foo'));
  unittest.expect(o['y'], unittest.equals('foo'));
}
...
void checkLocation(api.Location o) {
  ...
  if (buildCounterLocation < 3) {
    ...
    checkUnnamed5702(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
  }
  buildCounterLocation--;
}

core.Map<core.String, core.Object> buildUnnamed5703() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed5703(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed5704() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed5704(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed5703();
    o.name = 'foo';
    o.response = buildUnnamed5704();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkUnnamed5703(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed5704(o.response);
  }
  buildCounterOperation--;
}
...
core.List<core.Map<core.String, core.Object>> buildUnnamed5706() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed5705());
  o.add(buildUnnamed5705());
  return o;
}

void checkUnnamed5706(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed5705(o[0]);
  checkUnnamed5705(o[1]);
}
...
core.List<api.SupportedLanguage> buildUnnamed5707() {
  var o = <api.SupportedLanguage>[];
...
void checkUnnamed5707(core.List<api.SupportedLanguage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.String> buildUnnamed5709() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed5709(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o['x'], unittest.equals('foo'));
  unittest.expect(o['y'], unittest.equals('foo'));
}
...
core.List<api.Translation> buildUnnamed5710() {
...
void checkUnnamed5710(core.List<api.Translation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTranslation(o[0] as api.Translation);
  checkTranslation(o[1] as api.Translation);
}

core.List<api.Translation> buildUnnamed5711() {
  var o = <api.Translation>[];
  o.add(buildTranslation());
  o.add(buildTranslation());
  return o;
...
void checkUnnamed5711(core.List<api.Translation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTranslation(o[0] as api.Translation);
  checkTranslation(o[1] as api.Translation);
}
...
api.TranslateTextResponse buildTranslateTextResponse() {
  ...
  if (buildCounterTranslateTextResponse < 3) {
    o.glossaryTranslations = buildUnnamed5710();
    o.translations = buildUnnamed5711();
  }
  buildCounterTranslateTextResponse--;
  return o;
}
...
void checkTranslateTextResponse(api.TranslateTextResponse o) {
  buildCounterTranslateTextResponse++;
  if (buildCounterTranslateTextResponse < 3) {
    checkUnnamed5710(o.glossaryTranslations);
    checkUnnamed5711(o.translations);
  }
  buildCounterTranslateTextResponse--;
}
