...
core.Map<core.String, api.TranslateTextGlossaryConfig> buildUnnamed6128() {
...
core.List<api.InputConfig> buildUnnamed6129() {
...
void checkUnnamed6129(core.List<api.InputConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.String> buildUnnamed6132() {
  var o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed6132(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.BatchTranslateTextRequest buildBatchTranslateTextRequest() {
  ...
  if (buildCounterBatchTranslateTextRequest < 3) {
    o.glossaries = buildUnnamed6128();
    o.inputConfigs = buildUnnamed6129();
    o.labels = buildUnnamed6130();
    o.models = buildUnnamed6131();
    o.outputConfig = buildOutputConfig();
    o.sourceLanguageCode = 'foo';
    o.targetLanguageCodes = buildUnnamed6132();
  }
  buildCounterBatchTranslateTextRequest--;
  return o;
}
...
void checkBatchTranslateTextRequest(api.BatchTranslateTextRequest o) {
  buildCounterBatchTranslateTextRequest++;
  if (buildCounterBatchTranslateTextRequest < 3) {
    checkUnnamed6128(o.glossaries!);
    checkUnnamed6129(o.inputConfigs!);
    checkUnnamed6130(o.labels!);
    checkUnnamed6131(o.models!);
    checkOutputConfig(o.outputConfig! as api.OutputConfig);
    unittest.expect(
      o.sourceLanguageCode!,
      unittest.equals('foo'),
    );
    checkUnnamed6132(o.targetLanguageCodes!);
  }
  buildCounterBatchTranslateTextRequest--;
}
...
core.List<api.DetectedLanguage> buildUnnamed6134() {
...
void checkUnnamed6134(core.List<api.DetectedLanguage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.LanguageCodesSet buildLanguageCodesSet() {
  ...
  if (buildCounterLanguageCodesSet < 3) {
    o.languageCodes = buildUnnamed6135();
  }
  buildCounterLanguageCodesSet--;
  return o;
}
...
void checkLanguageCodesSet(api.LanguageCodesSet o) {
  buildCounterLanguageCodesSet++;
  if (buildCounterLanguageCodesSet < 3) {
    checkUnnamed6135(o.languageCodes!);
  }
  buildCounterLanguageCodesSet--;
}

core.List<api.Glossary> buildUnnamed6136() {
  var o = <api.Glossary>[];
  o.add(buildGlossary());
  o.add(buildGlossary());
  return o;
...
void checkUnnamed6136(core.List<api.Glossary> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Location> buildUnnamed6137() {
  var o = <api.Location>[];
  o.add(buildLocation());
  o.add(buildLocation());
  return o;
...
void checkUnnamed6137(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Operation> buildUnnamed6138() {
  var o = <api.Operation>[];
...
void checkUnnamed6138(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListOperationsResponse(api.ListOperationsResponse o) {
  ...
  if (buildCounterListOperationsResponse < 3) {
    ...
    checkUnnamed6138(o.operations!);
  }
  buildCounterListOperationsResponse--;
}

core.Map<core.String, core.String> buildUnnamed6139() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed6139(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.SupportedLanguage> buildUnnamed6145() {
  var o = <api.SupportedLanguage>[];
...
void checkUnnamed6145(core.List<api.SupportedLanguage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Translation> buildUnnamed6148() {
...
void checkUnnamed6148(core.List<api.Translation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTranslation(o[0] as api.Translation);
  checkTranslation(o[1] as api.Translation);
}

core.List<api.Translation> buildUnnamed6149() {
  var o = <api.Translation>[];
  o.add(buildTranslation());
  o.add(buildTranslation());
  return o;
...
void checkUnnamed6149(core.List<api.Translation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTranslation(o[0] as api.Translation);
  checkTranslation(o[1] as api.Translation);
}
...
api.TranslateTextResponse buildTranslateTextResponse() {
  ...
  if (buildCounterTranslateTextResponse < 3) {
    o.glossaryTranslations = buildUnnamed6148();
    o.translations = buildUnnamed6149();
  }
  buildCounterTranslateTextResponse--;
  return o;
}
...
void checkTranslateTextResponse(api.TranslateTextResponse o) {
  buildCounterTranslateTextResponse++;
  if (buildCounterTranslateTextResponse < 3) {
    checkUnnamed6148(o.glossaryTranslations!);
    checkUnnamed6149(o.translations!);
  }
  buildCounterTranslateTextResponse--;
}
