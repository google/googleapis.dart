...
core.Map<core.String, api.TranslateTextGlossaryConfig> buildUnnamed6774() => {
...
core.List<api.InputConfig> buildUnnamed6775() => [
      buildInputConfig(),
      buildInputConfig(),
    ];

void checkUnnamed6775(core.List<api.InputConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInputConfig(o[0]);
  checkInputConfig(o[1]);
}

core.Map<core.String, core.String> buildUnnamed6776() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed6776(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.BatchTranslateTextRequest buildBatchTranslateTextRequest() {
  ...
  if (buildCounterBatchTranslateTextRequest < 3) {
    o.glossaries = buildUnnamed6774();
    o.inputConfigs = buildUnnamed6775();
    o.labels = buildUnnamed6776();
    o.models = buildUnnamed6777();
    o.outputConfig = buildOutputConfig();
    o.sourceLanguageCode = 'foo';
    o.targetLanguageCodes = buildUnnamed6778();
  }
  buildCounterBatchTranslateTextRequest--;
  return o;
}
...
void checkBatchTranslateTextRequest(api.BatchTranslateTextRequest o) {
  buildCounterBatchTranslateTextRequest++;
  if (buildCounterBatchTranslateTextRequest < 3) {
    checkUnnamed6774(o.glossaries!);
    checkUnnamed6775(o.inputConfigs!);
    checkUnnamed6776(o.labels!);
    checkUnnamed6777(o.models!);
    checkOutputConfig(o.outputConfig!);
    unittest.expect(
      o.sourceLanguageCode!,
      unittest.equals('foo'),
    );
    checkUnnamed6778(o.targetLanguageCodes!);
  }
  buildCounterBatchTranslateTextRequest--;
}
...
core.List<api.DetectedLanguage> buildUnnamed6780() => [
      buildDetectedLanguage(),
      buildDetectedLanguage(),
    ];

void checkUnnamed6780(core.List<api.DetectedLanguage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.LanguageCodesSet buildLanguageCodesSet() {
  ...
  if (buildCounterLanguageCodesSet < 3) {
    o.languageCodes = buildUnnamed6781();
  }
  buildCounterLanguageCodesSet--;
  return o;
}
...
void checkLanguageCodesSet(api.LanguageCodesSet o) {
  buildCounterLanguageCodesSet++;
  if (buildCounterLanguageCodesSet < 3) {
    checkUnnamed6781(o.languageCodes!);
  }
  buildCounterLanguageCodesSet--;
}

core.List<api.Glossary> buildUnnamed6782() => [
      buildGlossary(),
      buildGlossary(),
    ];

void checkUnnamed6782(core.List<api.Glossary> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGlossary(o[0]);
  checkGlossary(o[1]);
}
...
core.Map<core.String, core.Object> buildUnnamed6787() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed6787(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed6790() => [
      buildUnnamed6789(),
      buildUnnamed6789(),
    ];

void checkUnnamed6790(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed6789(o[0]);
  checkUnnamed6789(o[1]);
}
...
core.List<api.SupportedLanguage> buildUnnamed6791() => [
      buildSupportedLanguage(),
      buildSupportedLanguage(),
    ];

void checkUnnamed6791(core.List<api.SupportedLanguage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.String> buildUnnamed6793() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed6793(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.TranslateTextRequest buildTranslateTextRequest() {
  ...
  if (buildCounterTranslateTextRequest < 3) {
    o.contents = buildUnnamed6792();
    o.glossaryConfig = buildTranslateTextGlossaryConfig();
    o.labels = buildUnnamed6793();
    o.mimeType = 'foo';
    o.model = 'foo';
    o.sourceLanguageCode = 'foo';
    o.targetLanguageCode = 'foo';
...
void checkTranslateTextRequest(api.TranslateTextRequest o) {
  buildCounterTranslateTextRequest++;
  if (buildCounterTranslateTextRequest < 3) {
    checkUnnamed6792(o.contents!);
    checkTranslateTextGlossaryConfig(o.glossaryConfig!);
    checkUnnamed6793(o.labels!);
    unittest.expect(
      o.mimeType!,
      unittest.equals('foo'),
    );
...
core.List<api.Translation> buildUnnamed6794() => [
      buildTranslation(),
      buildTranslation(),
    ];

void checkUnnamed6794(core.List<api.Translation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTranslation(o[0]);
  checkTranslation(o[1]);
}

core.List<api.Translation> buildUnnamed6795() => [
      buildTranslation(),
      buildTranslation(),
    ];

void checkUnnamed6795(core.List<api.Translation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTranslation(o[0]);
  checkTranslation(o[1]);
}
...
api.TranslateTextResponse buildTranslateTextResponse() {
  ...
  if (buildCounterTranslateTextResponse < 3) {
    o.glossaryTranslations = buildUnnamed6794();
    o.translations = buildUnnamed6795();
  }
  buildCounterTranslateTextResponse--;
  return o;
}
...
void checkTranslateTextResponse(api.TranslateTextResponse o) {
  buildCounterTranslateTextResponse++;
  if (buildCounterTranslateTextResponse < 3) {
    checkUnnamed6794(o.glossaryTranslations!);
    checkUnnamed6795(o.translations!);
  }
  buildCounterTranslateTextResponse--;
}
