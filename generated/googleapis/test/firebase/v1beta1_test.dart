...
import 'package:googleapis/firebase/v1beta1.dart' as api;
...
void checkAndroidApp(api.AndroidApp o) {
  buildCounterAndroidApp++;
  if (buildCounterAndroidApp < 3) {
    unittest.expect(o.apiKeyId!, unittest.equals('foo'));
...
core.List<api.IosApp> buildUnnamed8() => [buildIosApp(), buildIosApp()];
...
core.List<api.WebApp> buildUnnamed10() => [buildWebApp(), buildWebApp()];
...
void main() {
  ...
  unittest.group('obj-schema-AndroidApp', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.AndroidApp.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkAndroidApp(od);
    });
  ...
  unittest.group('resource-ProjectsResource', () {
    ...
    unittest.test('method--addGoogleAnalytics', () async {
      ...
      final response = await res.addGoogleAnalytics(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--getAdminSdkConfig', () async {
      ...
      final response = await res.getAdminSdkConfig(
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--getAnalyticsDetails', () async {
      ...
      final response = await res.getAnalyticsDetails(
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--removeAnalytics', () async {
      ...
      final response = await res.removeAnalytics(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--searchApps', () async {
      ...
      final response = await res.searchApps(
        arg_parent,
        filter: arg_filter,
        pageSize: arg_pageSize,
        pageToken: arg_pageToken,
