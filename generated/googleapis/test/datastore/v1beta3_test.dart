...
import 'package:googleapis/datastore/v1beta3.dart' as api;
...
core.List<api.Key> buildUnnamed3() => [buildKey(), buildKey()];
...
core.List<api.Key> buildUnnamed4() => [buildKey(), buildKey()];
...
core.List<api.Value> buildUnnamed5() => [buildValue(), buildValue()];
...
core.List<api.Mutation> buildUnnamed6() => [buildMutation(), buildMutation()];
...
core.List<api.Filter> buildUnnamed8() => [buildFilter(), buildFilter()];
...
void checkFindNearest(api.FindNearest o) {
  ...
  if (buildCounterFindNearest < 3) {
    ...
    unittest.expect(o.distanceResultProperty!, unittest.equals('foo'));
...
core.Map<core.String, api.GqlQueryParameter> buildUnnamed11() => {
  'x': buildGqlQueryParameter(),
  'y': buildGqlQueryParameter(),
};

void checkUnnamed11(core.Map<core.String, api.GqlQueryParameter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGqlQueryParameter(o['x']!);
  checkGqlQueryParameter(o['y']!);
}

core.List<api.GqlQueryParameter> buildUnnamed12() => [
  buildGqlQueryParameter(),
  buildGqlQueryParameter(),
];

void checkUnnamed12(core.List<api.GqlQueryParameter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GqlQuery buildGqlQuery() {
  ...
  if (buildCounterGqlQuery < 3) {
    ...
    o.namedBindings = buildUnnamed11();
    o.positionalBindings = buildUnnamed12();
    o.queryString = 'foo';
  }
  buildCounterGqlQuery--;
  return o;
...
void checkGqlQuery(api.GqlQuery o) {
  ...
  if (buildCounterGqlQuery < 3) {
    ...
    checkUnnamed11(o.namedBindings!);
    checkUnnamed12(o.positionalBindings!);
...
core.List<api.PathElement> buildUnnamed13() => [
  buildPathElement(),
  buildPathElement(),
];

void checkUnnamed13(core.List<api.PathElement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Key> buildUnnamed14() => [buildKey(), buildKey()];

void checkUnnamed14(core.List<api.Key> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkKey(o[0]);
  checkKey(o[1]);
}
...
core.List<api.Key> buildUnnamed15() => [buildKey(), buildKey()];

void checkUnnamed15(core.List<api.Key> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkKey(o[0]);
  checkKey(o[1]);
}

core.List<api.EntityResult> buildUnnamed16() => [
  buildEntityResult(),
  buildEntityResult(),
];

void checkUnnamed16(core.List<api.EntityResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEntityResult(o[0]);
  checkEntityResult(o[1]);
}

core.List<api.EntityResult> buildUnnamed17() => [
  buildEntityResult(),
  buildEntityResult(),
];

void checkUnnamed17(core.List<api.EntityResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEntityResult(o[0]);
  checkEntityResult(o[1]);
}
...
api.LookupResponse buildLookupResponse() {
  ...
  if (buildCounterLookupResponse < 3) {
    o.deferred = buildUnnamed15();
    o.found = buildUnnamed16();
    o.missing = buildUnnamed17();
    o.readTime = 'foo';
  }
  buildCounterLookupResponse--;
  return o;
...
void checkLookupResponse(api.LookupResponse o) {
  buildCounterLookupResponse++;
  if (buildCounterLookupResponse < 3) {
    checkUnnamed15(o.deferred!);
    checkUnnamed16(o.found!);
    checkUnnamed17(o.missing!);
    unittest.expect(o.readTime!, unittest.equals('foo'));
  }
  buildCounterLookupResponse--;
}

core.List<api.PropertyTransform> buildUnnamed18() => [
  buildPropertyTransform(),
  buildPropertyTransform(),
];

void checkUnnamed18(core.List<api.PropertyTransform> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPropertyTransform(o[0]);
  checkPropertyTransform(o[1]);
}
...
api.Mutation buildMutation() {
  ...
  if (buildCounterMutation < 3) {
    ...
    o.propertyMask = buildPropertyMask();
    o.propertyTransforms = buildUnnamed18();
...
void checkMutation(api.Mutation o) {
  ...
  if (buildCounterMutation < 3) {
    ...
    checkPropertyMask(o.propertyMask!);
    checkUnnamed18(o.propertyTransforms!);
...
core.List<api.Value> buildUnnamed19() => [buildValue(), buildValue()];

void checkUnnamed19(core.List<api.Value> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValue(o[0]);
  checkValue(o[1]);
}
...
api.MutationResult buildMutationResult() {
  ...
  if (buildCounterMutationResult < 3) {
    ...
    o.createTime = 'foo';
    o.key = buildKey();
    o.transformResults = buildUnnamed19();
    o.updateTime = 'foo';
    o.version = 'foo';
  }
  buildCounterMutationResult--;
...
void checkMutationResult(api.MutationResult o) {
  ...
  if (buildCounterMutationResult < 3) {
    ...
    unittest.expect(o.createTime!, unittest.equals('foo'));
    checkKey(o.key!);
    checkUnnamed19(o.transformResults!);
    unittest.expect(o.updateTime!, unittest.equals('foo'));
    unittest.expect(o.version!, unittest.equals('foo'));
  }
  buildCounterMutationResult--;
...
core.int buildCounterPropertyTransform = 0;
api.PropertyTransform buildPropertyTransform() {
  final o = api.PropertyTransform();
  buildCounterPropertyTransform++;
  if (buildCounterPropertyTransform < 3) {
...
void checkPropertyTransform(api.PropertyTransform o) {
  buildCounterPropertyTransform++;
  if (buildCounterPropertyTransform < 3) {
...
core.List<api.Key> buildUnnamed28() => [buildKey(), buildKey()];
...
void main() {
  ...
  unittest.group('obj-schema-GqlQuery', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GqlQuery.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGqlQuery(od);
    });
  ...
  unittest.group('obj-schema-PropertyTransform', () {
    unittest.test('to-json--from-json', () async {
      final o = buildPropertyTransform();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.PropertyTransform.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPropertyTransform(od);
    });
  });
  ...
  unittest.group('resource-ProjectsResource', () {
    unittest.test('method--allocateIds', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            ...
            unittest.equals('v1beta3/projects/'),
          );
          pathOffset += 17;
      ...
      final response = await res.allocateIds(
        arg_request,
        arg_projectId,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--reserveIds', () async {
      ...
      final response = await res.reserveIds(
        arg_request,
        arg_projectId,
        $fields: arg_$fields,
      );
