...
core.List<api.AppTrackInfo> buildUnnamed6034() {
  var o = <api.AppTrackInfo>[];
...
void checkUnnamed6034(core.List<api.AppTrackInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAppTrackInfo(o[0] as api.AppTrackInfo);
  checkAppTrackInfo(o[1] as api.AppTrackInfo);
}

core.List<api.ManagedProperty> buildUnnamed6035() {
...
void checkUnnamed6035(core.List<api.ManagedProperty> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkManagedProperty(o[0] as api.ManagedProperty);
  checkManagedProperty(o[1] as api.ManagedProperty);
}

core.List<api.ApplicationPermission> buildUnnamed6036() {
...
void checkUnnamed6036(core.List<api.ApplicationPermission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Application buildApplication() {
  ...
  if (buildCounterApplication < 3) {
    o.appTracks = buildUnnamed6034();
    o.managedProperties = buildUnnamed6035();
    o.name = 'foo';
    o.permissions = buildUnnamed6036();
    o.title = 'foo';
  }
  buildCounterApplication--;
  return o;
...
void checkApplication(api.Application o) {
  buildCounterApplication++;
  if (buildCounterApplication < 3) {
    checkUnnamed6034(o.appTracks);
    checkUnnamed6035(o.managedProperties);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed6036(o.permissions);
...
core.List<api.PermissionGrant> buildUnnamed6040() {
...
void checkUnnamed6040(core.List<api.PermissionGrant> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkApplicationPolicy(api.ApplicationPolicy o) {
  buildCounterApplicationPolicy++;
  if (buildCounterApplicationPolicy < 3) {
    checkUnnamed6037(o.accessibleTrackIds);
    ...
    unittest.expect(o.packageName, unittest.equals('foo'));
    checkUnnamed6040(o.permissionGrants);
  }
  buildCounterApplicationPolicy--;
}

core.List<api.ApplicationEvent> buildUnnamed6041() {
  var o = <api.ApplicationEvent>[];
...
void checkUnnamed6041(core.List<api.ApplicationEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApplicationEvent(o[0] as api.ApplicationEvent);
  checkApplicationEvent(o[1] as api.ApplicationEvent);
}

core.List<api.KeyedAppState> buildUnnamed6042() {
...
void checkUnnamed6042(core.List<api.KeyedAppState> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ApplicationReport buildApplicationReport() {
  ...
  if (buildCounterApplicationReport < 3) {
    ...
    o.displayName = 'foo';
    o.events = buildUnnamed6041();
    o.installerPackageName = 'foo';
    o.keyedAppStates = buildUnnamed6042();
    o.packageName = 'foo';
    o.packageSha256Hash = 'foo';
    o.signingKeyCertFingerprints = buildUnnamed6043();
    o.state = 'foo';
    o.versionCode = 42;
    o.versionName = 'foo';
  }
...
api.ChoosePrivateKeyRule buildChoosePrivateKeyRule() {
  ...
  if (buildCounterChoosePrivateKeyRule < 3) {
    o.packageNames = buildUnnamed6044();
...
void checkChoosePrivateKeyRule(api.ChoosePrivateKeyRule o) {
  buildCounterChoosePrivateKeyRule++;
  if (buildCounterChoosePrivateKeyRule < 3) {
    checkUnnamed6044(o.packageNames);
...
api.Command buildCommand() {
  ...
  if (buildCounterCommand < 3) {
    ...
    o.errorCode = 'foo';
    o.newPassword = 'foo';
    o.resetPasswordFlags = buildUnnamed6045();
    o.type = 'foo';
    o.userName = 'foo';
  }
  buildCounterCommand--;
...
void checkCommand(api.Command o) {
  ...
  if (buildCounterCommand < 3) {
    ...
    checkUnnamed6045(o.resetPasswordFlags);
...
api.ComplianceRule buildComplianceRule() {
  ...
  if (buildCounterComplianceRule < 3) {
    ...
    o.packageNamesToDisable = buildUnnamed6046();
  }
  buildCounterComplianceRule--;
  return o;
}
...
void checkComplianceRule(api.ComplianceRule o) {
  ...
  if (buildCounterComplianceRule < 3) {
    ...
    checkUnnamed6046(o.packageNamesToDisable);
  }
  buildCounterComplianceRule--;
}
...
core.List<api.ApplicationReport> buildUnnamed6047() {
  var o = <api.ApplicationReport>[];
...
void checkUnnamed6048(core.List<api.Display> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDisplay(o[0] as api.Display);
  checkDisplay(o[1] as api.Display);
}

core.List<api.HardwareStatus> buildUnnamed6049() {
...
void checkUnnamed6049(core.List<api.HardwareStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHardwareStatus(o[0] as api.HardwareStatus);
  checkHardwareStatus(o[1] as api.HardwareStatus);
}

core.List<api.MemoryEvent> buildUnnamed6050() {
...
void checkUnnamed6050(core.List<api.MemoryEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMemoryEvent(o[0] as api.MemoryEvent);
  checkMemoryEvent(o[1] as api.MemoryEvent);
}

core.List<api.NonComplianceDetail> buildUnnamed6051() {
...
void checkUnnamed6052(core.List<api.PowerManagementEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.String> buildUnnamed6054() {
...
void checkUnnamed6054(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Device buildDevice() {
  ...
  if (buildCounterDevice < 3) {
    o.apiLevel = 42;
    o.applicationReports = buildUnnamed6047();
...
void checkDevice(api.Device o) {
  ...
  if (buildCounterDevice < 3) {
    ...
    checkUnnamed6047(o.applicationReports);
    ...
    checkUnnamed6049(o.hardwareStatusSamples);
    ...
    checkUnnamed6052(o.powerManagementEvents);
    checkUnnamed6053(o.previousDeviceNames);
    checkSecurityPosture(o.securityPosture as api.SecurityPosture);
    checkSoftwareInfo(o.softwareInfo as api.SoftwareInfo);
    unittest.expect(o.state, unittest.equals('foo'));
    checkUnnamed6054(o.systemProperties);
...
core.List<api.SigninDetail> buildUnnamed6056() {
...
void checkUnnamed6056(core.List<api.SigninDetail> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSigninDetail(o[0] as api.SigninDetail);
  checkSigninDetail(o[1] as api.SigninDetail);
}

core.List<api.TermsAndConditions> buildUnnamed6057() {
...
void checkUnnamed6057(core.List<api.TermsAndConditions> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Enterprise buildEnterprise() {
  ...
  if (buildCounterEnterprise < 3) {
    ...
    o.enabledNotificationTypes = buildUnnamed6055();
    o.enterpriseDisplayName = 'foo';
    o.logo = buildExternalData();
    o.name = 'foo';
    o.primaryColor = 42;
    o.pubsubTopic = 'foo';
    o.signinDetails = buildUnnamed6056();
    o.termsAndConditions = buildUnnamed6057();
  }
  buildCounterEnterprise--;
  return o;
}
...
void checkEnterprise(api.Enterprise o) {
  ...
  if (buildCounterEnterprise < 3) {
    ...
    checkUnnamed6055(o.enabledNotificationTypes);
    ...
    checkUnnamed6056(o.signinDetails);
    checkUnnamed6057(o.termsAndConditions);
  }
  buildCounterEnterprise--;
}
...
core.List<core.double> buildUnnamed6058() {
  var o = <core.double>[];
  o.add(42.0);
  o.add(42.0);
  return o;
...
void checkUnnamed6058(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}

core.List<core.double> buildUnnamed6059() {
  var o = <core.double>[];
  o.add(42.0);
  o.add(42.0);
  return o;
...
void checkUnnamed6059(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}

core.List<core.double> buildUnnamed6060() {
  var o = <core.double>[];
  o.add(42.0);
  o.add(42.0);
  return o;
...
void checkUnnamed6060(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}

core.List<core.double> buildUnnamed6061() {
  var o = <core.double>[];
  o.add(42.0);
  o.add(42.0);
  return o;
...
void checkUnnamed6061(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}

core.List<core.double> buildUnnamed6062() {
  var o = <core.double>[];
  o.add(42.0);
  o.add(42.0);
  return o;
...
void checkUnnamed6062(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}

core.List<core.double> buildUnnamed6063() {
  var o = <core.double>[];
  o.add(42.0);
  o.add(42.0);
  return o;
...
void checkUnnamed6063(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}

core.List<core.double> buildUnnamed6064() {
  var o = <core.double>[];
  o.add(42.0);
  o.add(42.0);
  return o;
...
void checkUnnamed6064(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}

core.List<core.double> buildUnnamed6065() {
  var o = <core.double>[];
  o.add(42.0);
  o.add(42.0);
  return o;
...
void checkUnnamed6065(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}
...
api.HardwareInfo buildHardwareInfo() {
  ...
  if (buildCounterHardwareInfo < 3) {
    o.batteryShutdownTemperatures = buildUnnamed6058();
    o.batteryThrottlingTemperatures = buildUnnamed6059();
    o.brand = 'foo';
    o.cpuShutdownTemperatures = buildUnnamed6060();
    o.cpuThrottlingTemperatures = buildUnnamed6061();
    o.deviceBasebandVersion = 'foo';
    o.gpuShutdownTemperatures = buildUnnamed6062();
    o.gpuThrottlingTemperatures = buildUnnamed6063();
    o.hardware = 'foo';
    o.manufacturer = 'foo';
    o.model = 'foo';
    o.serialNumber = 'foo';
    o.skinShutdownTemperatures = buildUnnamed6064();
    o.skinThrottlingTemperatures = buildUnnamed6065();
  }
  buildCounterHardwareInfo--;
  return o;
}
...
void checkHardwareInfo(api.HardwareInfo o) {
  buildCounterHardwareInfo++;
  if (buildCounterHardwareInfo < 3) {
    checkUnnamed6058(o.batteryShutdownTemperatures);
    checkUnnamed6059(o.batteryThrottlingTemperatures);
    unittest.expect(o.brand, unittest.equals('foo'));
    checkUnnamed6060(o.cpuShutdownTemperatures);
    checkUnnamed6061(o.cpuThrottlingTemperatures);
    unittest.expect(o.deviceBasebandVersion, unittest.equals('foo'));
    checkUnnamed6062(o.gpuShutdownTemperatures);
    checkUnnamed6063(o.gpuThrottlingTemperatures);
    unittest.expect(o.hardware, unittest.equals('foo'));
    unittest.expect(o.manufacturer, unittest.equals('foo'));
    unittest.expect(o.model, unittest.equals('foo'));
    unittest.expect(o.serialNumber, unittest.equals('foo'));
    checkUnnamed6064(o.skinShutdownTemperatures);
    checkUnnamed6065(o.skinThrottlingTemperatures);
  }
  buildCounterHardwareInfo--;
}

core.List<core.double> buildUnnamed6066() {
  var o = <core.double>[];
  o.add(42.0);
  o.add(42.0);
  return o;
...
void checkUnnamed6066(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}

core.List<core.double> buildUnnamed6067() {
  var o = <core.double>[];
  o.add(42.0);
  o.add(42.0);
  return o;
...
void checkUnnamed6067(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}

core.List<core.double> buildUnnamed6068() {
  var o = <core.double>[];
  o.add(42.0);
  o.add(42.0);
  return o;
...
void checkUnnamed6068(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}

core.List<core.double> buildUnnamed6069() {
  var o = <core.double>[];
  o.add(42.0);
  o.add(42.0);
  return o;
...
void checkUnnamed6069(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}

core.List<core.double> buildUnnamed6070() {
  var o = <core.double>[];
  o.add(42.0);
  o.add(42.0);
  return o;
...
void checkUnnamed6070(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}

core.List<core.double> buildUnnamed6071() {
  var o = <core.double>[];
  o.add(42.0);
  o.add(42.0);
  return o;
...
void checkUnnamed6071(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}
...
api.HardwareStatus buildHardwareStatus() {
  ...
  if (buildCounterHardwareStatus < 3) {
    o.batteryTemperatures = buildUnnamed6066();
    o.cpuTemperatures = buildUnnamed6067();
    o.cpuUsages = buildUnnamed6068();
    o.createTime = 'foo';
    o.fanSpeeds = buildUnnamed6069();
    o.gpuTemperatures = buildUnnamed6070();
    o.skinTemperatures = buildUnnamed6071();
  }
  buildCounterHardwareStatus--;
  return o;
}
...
void checkHardwareStatus(api.HardwareStatus o) {
  buildCounterHardwareStatus++;
  if (buildCounterHardwareStatus < 3) {
    checkUnnamed6066(o.batteryTemperatures);
    checkUnnamed6067(o.cpuTemperatures);
    checkUnnamed6068(o.cpuUsages);
    unittest.expect(o.createTime, unittest.equals('foo'));
    checkUnnamed6069(o.fanSpeeds);
    checkUnnamed6070(o.gpuTemperatures);
    checkUnnamed6071(o.skinTemperatures);
  }
  buildCounterHardwareStatus--;
}
...
core.List<api.Device> buildUnnamed6072() {
  var o = <api.Device>[];
  o.add(buildDevice());
  o.add(buildDevice());
  return o;
...
void checkUnnamed6072(core.List<api.Device> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListDevicesResponse(api.ListDevicesResponse o) {
  buildCounterListDevicesResponse++;
  if (buildCounterListDevicesResponse < 3) {
    checkUnnamed6072(o.devices);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListDevicesResponse--;
}

core.List<api.Enterprise> buildUnnamed6073() {
  var o = <api.Enterprise>[];
...
void checkUnnamed6073(core.List<api.Enterprise> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListEnterprisesResponse buildListEnterprisesResponse() {
  ...
  if (buildCounterListEnterprisesResponse < 3) {
    o.enterprises = buildUnnamed6073();
    o.nextPageToken = 'foo';
  }
  buildCounterListEnterprisesResponse--;
  return o;
...
void checkListEnterprisesResponse(api.ListEnterprisesResponse o) {
  buildCounterListEnterprisesResponse++;
  if (buildCounterListEnterprisesResponse < 3) {
    checkUnnamed6073(o.enterprises);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListEnterprisesResponse--;
}

core.List<api.Operation> buildUnnamed6074() {
  var o = <api.Operation>[];
...
void checkUnnamed6074(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListOperationsResponse(api.ListOperationsResponse o) {
  ...
  if (buildCounterListOperationsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed6074(o.operations);
  }
  buildCounterListOperationsResponse--;
}

core.List<api.Policy> buildUnnamed6075() {
  var o = <api.Policy>[];
  o.add(buildPolicy());
  o.add(buildPolicy());
  return o;
...
void checkUnnamed6075(core.List<api.Policy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListPoliciesResponse(api.ListPoliciesResponse o) {
  ...
  if (buildCounterListPoliciesResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed6075(o.policies);
  }
  buildCounterListPoliciesResponse--;
}

core.List<api.WebApp> buildUnnamed6076() {
  var o = <api.WebApp>[];
  o.add(buildWebApp());
  o.add(buildWebApp());
  return o;
...
void checkUnnamed6076(core.List<api.WebApp> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ManagedConfigurationTemplate buildManagedConfigurationTemplate() {
  ...
  if (buildCounterManagedConfigurationTemplate < 3) {
    o.configurationVariables = buildUnnamed6077();
    o.templateId = 'foo';
  }
  buildCounterManagedConfigurationTemplate--;
  return o;
...
void checkManagedConfigurationTemplate(api.ManagedConfigurationTemplate o) {
  buildCounterManagedConfigurationTemplate++;
  if (buildCounterManagedConfigurationTemplate < 3) {
    checkUnnamed6077(o.configurationVariables);
    unittest.expect(o.templateId, unittest.equals('foo'));
  }
  buildCounterManagedConfigurationTemplate--;
}

core.List<api.ManagedPropertyEntry> buildUnnamed6078() {
...
void checkUnnamed6079(core.List<api.ManagedProperty> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkManagedProperty(o[0] as api.ManagedProperty);
  checkManagedProperty(o[1] as api.ManagedProperty);
}
...
api.ManagedProperty buildManagedProperty() {
  ...
  if (buildCounterManagedProperty < 3) {
    ...
    o.description = 'foo';
    o.entries = buildUnnamed6078();
    o.key = 'foo';
    o.nestedProperties = buildUnnamed6079();
    o.title = 'foo';
    o.type = 'foo';
  }
  buildCounterManagedProperty--;
...
void checkManagedProperty(api.ManagedProperty o) {
  ...
  if (buildCounterManagedProperty < 3) {
    ...
    unittest.expect(o.description, unittest.equals('foo'));
    checkUnnamed6078(o.entries);
    unittest.expect(o.key, unittest.equals('foo'));
    checkUnnamed6079(o.nestedProperties);
    unittest.expect(o.title, unittest.equals('foo'));
    unittest.expect(o.type, unittest.equals('foo'));
  }
  buildCounterManagedProperty--;
...
core.List<api.TelephonyInfo> buildUnnamed6080() {
...
void checkUnnamed6080(core.List<api.TelephonyInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.NetworkInfo buildNetworkInfo() {
  ...
  if (buildCounterNetworkInfo < 3) {
    ...
    o.telephonyInfos = buildUnnamed6080();
...
void checkNetworkInfo(api.NetworkInfo o) {
  ...
  if (buildCounterNetworkInfo < 3) {
    ...
    checkUnnamed6080(o.telephonyInfos);
...
core.Map<core.String, core.Object> buildUnnamed6081() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed6081(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed6082() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed6082(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PackageNameList buildPackageNameList() {
  ...
  if (buildCounterPackageNameList < 3) {
    o.packageNames = buildUnnamed6083();
  }
  buildCounterPackageNameList--;
  return o;
}
...
void checkPackageNameList(api.PackageNameList o) {
  buildCounterPackageNameList++;
  if (buildCounterPackageNameList < 3) {
    checkUnnamed6083(o.packageNames);
  }
  buildCounterPackageNameList--;
}
...
api.PersistentPreferredActivity buildPersistentPreferredActivity() {
  ...
  if (buildCounterPersistentPreferredActivity < 3) {
    o.actions = buildUnnamed6084();
    o.categories = buildUnnamed6085();
...
void checkPersistentPreferredActivity(api.PersistentPreferredActivity o) {
  buildCounterPersistentPreferredActivity++;
  if (buildCounterPersistentPreferredActivity < 3) {
    checkUnnamed6084(o.actions);
    checkUnnamed6085(o.categories);
...
core.List<api.PersonalApplicationPolicy> buildUnnamed6087() {
  var o = <api.PersonalApplicationPolicy>[];
...
void checkUnnamed6087(core.List<api.PersonalApplicationPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PersonalUsagePolicies buildPersonalUsagePolicies() {
  ...
  if (buildCounterPersonalUsagePolicies < 3) {
    o.accountTypesWithManagementDisabled = buildUnnamed6086();
    o.cameraDisabled = true;
    o.maxDaysWithWorkOff = 42;
    o.personalApplications = buildUnnamed6087();
...
core.List<api.ApplicationPolicy> buildUnnamed6090() {
  var o = <api.ApplicationPolicy>[];
...
void checkUnnamed6090(core.List<api.ApplicationPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApplicationPolicy(o[0] as api.ApplicationPolicy);
  checkApplicationPolicy(o[1] as api.ApplicationPolicy);
}

core.List<api.ChoosePrivateKeyRule> buildUnnamed6091() {
  var o = <api.ChoosePrivateKeyRule>[];
...
void checkUnnamed6092(core.List<api.ComplianceRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.PasswordRequirements> buildUnnamed6096() {
  var o = <api.PasswordRequirements>[];
...
void checkUnnamed6097(core.List<api.PermissionGrant> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermissionGrant(o[0] as api.PermissionGrant);
  checkPermissionGrant(o[1] as api.PermissionGrant);
}

core.List<api.PersistentPreferredActivity> buildUnnamed6098() {
  var o = <api.PersistentPreferredActivity>[];
...
void checkUnnamed6098(core.List<api.PersistentPreferredActivity> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.PolicyEnforcementRule> buildUnnamed6099() {
...
void checkUnnamed6100(core.List<api.SetupAction> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Policy buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.accountTypesWithManagementDisabled = buildUnnamed6088();
    ...
    o.androidDevicePolicyTracks = buildUnnamed6089();
    o.appAutoUpdatePolicy = 'foo';
    o.applications = buildUnnamed6090();
    ...
    o.choosePrivateKeyRules = buildUnnamed6091();
    o.complianceRules = buildUnnamed6092();
    ...
    o.setupActions = buildUnnamed6100();
    ...
    o.stayOnPluggedModes = buildUnnamed6101();
...
void checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed6088(o.accountTypesWithManagementDisabled);
    ...
    checkUnnamed6089(o.androidDevicePolicyTracks);
    unittest.expect(o.appAutoUpdatePolicy, unittest.equals('foo'));
    checkUnnamed6090(o.applications);
    ...
    checkUnnamed6091(o.choosePrivateKeyRules);
    checkUnnamed6092(o.complianceRules);
    ...
    checkUnnamed6093(o.frpAdminEmails);
    ...
    checkUnnamed6094(o.keyguardDisabledFeatures);
    ...
    checkUnnamed6098(o.persistentPreferredActivities);
    ...
    checkUnnamed6099(o.policyEnforcementRules);
    ...
    checkUnnamed6100(o.setupActions);
    ...
    checkUnnamed6101(o.stayOnPluggedModes);
...
core.List<api.UserFacingMessage> buildUnnamed6102() {
...
void checkUnnamed6102(core.List<api.UserFacingMessage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ProxyInfo buildProxyInfo() {
  ...
  if (buildCounterProxyInfo < 3) {
    o.excludedHosts = buildUnnamed6103();
    o.host = 'foo';
    o.pacUri = 'foo';
    o.port = 42;
  }
...
void checkProxyInfo(api.ProxyInfo o) {
  buildCounterProxyInfo++;
  if (buildCounterProxyInfo < 3) {
    checkUnnamed6103(o.excludedHosts);
...
core.List<api.PostureDetail> buildUnnamed6104() {
  var o = <api.PostureDetail>[];
...
void checkUnnamed6104(core.List<api.PostureDetail> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SecurityPosture buildSecurityPosture() {
  ...
  if (buildCounterSecurityPosture < 3) {
    o.devicePosture = 'foo';
    o.postureDetails = buildUnnamed6104();
  }
  buildCounterSecurityPosture--;
  return o;
}
...
void checkSecurityPosture(api.SecurityPosture o) {
  ...
  if (buildCounterSecurityPosture < 3) {
    ...
    checkUnnamed6104(o.postureDetails);
  }
  buildCounterSecurityPosture--;
}
...
core.List<core.Map<core.String, core.Object>> buildUnnamed6106() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed6105());
  o.add(buildUnnamed6105());
  return o;
}

void checkUnnamed6106(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed6105(o[0]);
  checkUnnamed6105(o[1]);
}
...
core.List<api.FreezePeriod> buildUnnamed6107() {
  var o = <api.FreezePeriod>[];
...
void checkUnnamed6107(core.List<api.FreezePeriod> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SystemUpdate buildSystemUpdate() {
  ...
  if (buildCounterSystemUpdate < 3) {
    o.endMinutes = 42;
    o.freezePeriods = buildUnnamed6107();
    o.startMinutes = 42;
    o.type = 'foo';
  }
  buildCounterSystemUpdate--;
...
void checkSystemUpdate(api.SystemUpdate o) {
  ...
  if (buildCounterSystemUpdate < 3) {
    ...
    checkUnnamed6107(o.freezePeriods);
...
api.UserFacingMessage buildUserFacingMessage() {
  ...
  if (buildCounterUserFacingMessage < 3) {
    ...
    o.localizedMessages = buildUnnamed6108();
  }
  buildCounterUserFacingMessage--;
  return o;
}
...
void checkUserFacingMessage(api.UserFacingMessage o) {
  ...
  if (buildCounterUserFacingMessage < 3) {
    ...
    checkUnnamed6108(o.localizedMessages);
  }
  buildCounterUserFacingMessage--;
}

core.List<api.WebAppIcon> buildUnnamed6109() {
...
void checkUnnamed6109(core.List<api.WebAppIcon> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.WebToken buildWebToken() {
  ...
  if (buildCounterWebToken < 3) {
    o.enabledFeatures = buildUnnamed6110();
    o.name = 'foo';
...
void checkWebToken(api.WebToken o) {
  buildCounterWebToken++;
  if (buildCounterWebToken < 3) {
    checkUnnamed6110(o.enabledFeatures);
    unittest.expect(o.name, unittest.equals('foo'));
...
void main() {
  ...
  unittest.group('resource-EnterprisesDevicesResource', () {
    unittest.test('method--delete', () {
      ...
      var arg_name = 'foo';
      var arg_wipeDataFlags = buildUnnamed6112();
