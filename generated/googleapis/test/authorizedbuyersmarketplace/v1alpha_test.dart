...
import 'package:googleapis/authorizedbuyersmarketplace/v1alpha.dart' as api;
...
void checkAddCreativeRequest(api.AddCreativeRequest o) {
  buildCounterAddCreativeRequest++;
  if (buildCounterAddCreativeRequest < 3) {
    unittest.expect(o.creative!, unittest.equals('foo'));
  }
  buildCounterAddCreativeRequest--;
}
...
core.List<api.MediaPlanner> buildUnnamed3() => [
  buildMediaPlanner(),
  buildMediaPlanner(),
];

void checkUnnamed3(core.List<api.MediaPlanner> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AuctionPackage buildAuctionPackage() {
  ...
  if (buildCounterAuctionPackage < 3) {
    ...
    o.name = 'foo';
    o.subscribedBuyers = buildUnnamed1();
    o.subscribedClients = buildUnnamed2();
    o.subscribedMediaPlanners = buildUnnamed3();
    o.updateTime = 'foo';
  }
  buildCounterAuctionPackage--;
  return o;
...
void checkAuctionPackage(api.AuctionPackage o) {
  ...
  if (buildCounterAuctionPackage < 3) {
    ...
    unittest.expect(o.dealOwnerSeatId!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.displayName!, unittest.equals('foo'));
    checkUnnamed0(o.eligibleSeatIds!);
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed1(o.subscribedBuyers!);
    checkUnnamed2(o.subscribedClients!);
    checkUnnamed3(o.subscribedMediaPlanners!);
    unittest.expect(o.updateTime!, unittest.equals('foo'));
  }
  buildCounterAuctionPackage--;
}

core.List<api.UpdateDealRequest> buildUnnamed4() => [
  buildUpdateDealRequest(),
  buildUpdateDealRequest(),
];

void checkUnnamed4(core.List<api.UpdateDealRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Deal> buildUnnamed5() => [buildDeal(), buildDeal()];

void checkUnnamed5(core.List<api.Deal> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDeal(o[0]);
  checkDeal(o[1]);
}
...
void checkCreativeRequirements(api.CreativeRequirements o) {
  ...
  if (buildCounterCreativeRequirements < 3) {
    ...
    unittest.expect(o.maxAdDurationMs!, unittest.equals('foo'));
...
api.CriteriaTargeting buildCriteriaTargeting() {
  ...
  if (buildCounterCriteriaTargeting < 3) {
    o.excludedCriteriaIds = buildUnnamed6();
    o.targetedCriteriaIds = buildUnnamed7();
  }
  buildCounterCriteriaTargeting--;
  return o;
}
...
void checkCriteriaTargeting(api.CriteriaTargeting o) {
  buildCounterCriteriaTargeting++;
  if (buildCounterCriteriaTargeting < 3) {
    checkUnnamed6(o.excludedCriteriaIds!);
    checkUnnamed7(o.targetedCriteriaIds!);
  }
  buildCounterCriteriaTargeting--;
}
...
core.List<api.DayPart> buildUnnamed8() => [buildDayPart(), buildDayPart()];

void checkUnnamed8(core.List<api.DayPart> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDayPart(o[0]);
  checkDayPart(o[1]);
}
...
api.Deal buildDeal() {
  ...
  if (buildCounterDeal < 3) {
    ...
    o.description = 'foo';
    o.displayName = 'foo';
    o.eligibleSeatIds = buildUnnamed9();
    o.estimatedGrossSpend = buildMoney();
    o.flightEndTime = 'foo';
    o.flightStartTime = 'foo';
    o.mediaPlanner = buildMediaPlanner();
    o.name = 'foo';
...
void checkDeal(api.Deal o) {
  buildCounterDeal++;
  if (buildCounterDeal < 3) {
    unittest.expect(o.billedBuyer!, unittest.equals('foo'));
    unittest.expect(o.buyer!, unittest.equals('foo'));
    unittest.expect(o.buyerPermissionType!, unittest.equals('foo'));
    ...
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.displayName!, unittest.equals('foo'));
    checkUnnamed9(o.eligibleSeatIds!);
    checkMoney(o.estimatedGrossSpend!);
    unittest.expect(o.flightEndTime!, unittest.equals('foo'));
    unittest.expect(o.flightStartTime!, unittest.equals('foo'));
    checkMediaPlanner(o.mediaPlanner!);
    unittest.expect(o.name!, unittest.equals('foo'));
    ...
    unittest.expect(o.proposalRevision!, unittest.equals('foo'));
    unittest.expect(o.publisherProfile!, unittest.equals('foo'));
...
void checkDealPausingInfo(api.DealPausingInfo o) {
  buildCounterDealPausingInfo++;
  if (buildCounterDealPausingInfo < 3) {
    unittest.expect(o.pauseReason!, unittest.equals('foo'));
    unittest.expect(o.pauseRole!, unittest.equals('foo'));
    unittest.expect(o.pausingConsented!, unittest.isTrue);
  }
  buildCounterDealPausingInfo--;
}

core.List<api.FrequencyCap> buildUnnamed10() => [
  buildFrequencyCap(),
  buildFrequencyCap(),
];

void checkUnnamed10(core.List<api.FrequencyCap> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkDeliveryControl(api.DeliveryControl o) {
  buildCounterDeliveryControl++;
  if (buildCounterDeliveryControl < 3) {
    unittest.expect(o.companionDeliveryType!, unittest.equals('foo'));
    unittest.expect(o.creativeRotationType!, unittest.equals('foo'));
    unittest.expect(o.deliveryRateType!, unittest.equals('foo'));
    checkUnnamed10(o.frequencyCap!);
    unittest.expect(o.roadblockingType!, unittest.equals('foo'));
  }
  buildCounterDeliveryControl--;
}
...
void checkFinalizedDeal(api.FinalizedDeal o) {
  ...
  if (buildCounterFinalizedDeal < 3) {
    ...
    unittest.expect(o.dealServingStatus!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
...
buildFirstPartyMobileApplicationTargeting() {
  ...
  if (buildCounterFirstPartyMobileApplicationTargeting < 3) {
    o.excludedAppIds = buildUnnamed11();
    o.targetedAppIds = buildUnnamed12();
  }
  buildCounterFirstPartyMobileApplicationTargeting--;
  return o;
}
...
void checkFirstPartyMobileApplicationTargeting(
  ...
  buildCounterFirstPartyMobileApplicationTargeting++;
  if (buildCounterFirstPartyMobileApplicationTargeting < 3) {
    checkUnnamed11(o.excludedAppIds!);
    checkUnnamed12(o.targetedAppIds!);
  }
  buildCounterFirstPartyMobileApplicationTargeting--;
}
...
void checkFrequencyCap(api.FrequencyCap o) {
  ...
  if (buildCounterFrequencyCap < 3) {
    ...
    unittest.expect(o.timeUnitsCount!, unittest.equals(42));
  }
  buildCounterFrequencyCap--;
}

core.List<api.AdSize> buildUnnamed13() => [buildAdSize(), buildAdSize()];

void checkUnnamed13(core.List<api.AdSize> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdSize(o[0]);
  checkAdSize(o[1]);
}

core.List<api.AdSize> buildUnnamed14() => [buildAdSize(), buildAdSize()];

void checkUnnamed14(core.List<api.AdSize> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdSize(o[0]);
  checkAdSize(o[1]);
}
...
api.InventorySizeTargeting buildInventorySizeTargeting() {
  ...
  if (buildCounterInventorySizeTargeting < 3) {
    o.excludedInventorySizes = buildUnnamed13();
    o.targetedInventorySizes = buildUnnamed14();
  }
  buildCounterInventorySizeTargeting--;
  return o;
}
...
void checkInventorySizeTargeting(api.InventorySizeTargeting o) {
  buildCounterInventorySizeTargeting++;
  if (buildCounterInventorySizeTargeting < 3) {
    checkUnnamed13(o.excludedInventorySizes!);
    checkUnnamed14(o.targetedInventorySizes!);
  }
  buildCounterInventorySizeTargeting--;
}
...
core.int buildCounterInventoryTypeTargeting = 0;
api.InventoryTypeTargeting buildInventoryTypeTargeting() {
  final o = api.InventoryTypeTargeting();
  buildCounterInventoryTypeTargeting++;
  if (buildCounterInventoryTypeTargeting < 3) {
    o.inventoryTypes = buildUnnamed15();
  }
  buildCounterInventoryTypeTargeting--;
  return o;
}

void checkInventoryTypeTargeting(api.InventoryTypeTargeting o) {
  buildCounterInventoryTypeTargeting++;
  if (buildCounterInventoryTypeTargeting < 3) {
    checkUnnamed15(o.inventoryTypes!);
  }
  buildCounterInventoryTypeTargeting--;
}

core.List<api.AuctionPackage> buildUnnamed16() => [
  buildAuctionPackage(),
  buildAuctionPackage(),
];

void checkUnnamed16(core.List<api.AuctionPackage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListAuctionPackagesResponse buildListAuctionPackagesResponse() {
  ...
  if (buildCounterListAuctionPackagesResponse < 3) {
    o.auctionPackages = buildUnnamed16();
    o.nextPageToken = 'foo';
  }
  buildCounterListAuctionPackagesResponse--;
  return o;
...
void checkListAuctionPackagesResponse(api.ListAuctionPackagesResponse o) {
  buildCounterListAuctionPackagesResponse++;
  if (buildCounterListAuctionPackagesResponse < 3) {
    checkUnnamed16(o.auctionPackages!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListAuctionPackagesResponse--;
}

core.List<api.ClientUser> buildUnnamed17() => [
  buildClientUser(),
  buildClientUser(),
];

void checkUnnamed17(core.List<api.ClientUser> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkClientUser(o[0]);
  checkClientUser(o[1]);
}
...
void checkListClientUsersResponse(api.ListClientUsersResponse o) {
  buildCounterListClientUsersResponse++;
  if (buildCounterListClientUsersResponse < 3) {
    checkUnnamed17(o.clientUsers!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListClientUsersResponse--;
}

core.List<api.Client> buildUnnamed18() => [buildClient(), buildClient()];

void checkUnnamed18(core.List<api.Client> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkClient(o[0]);
  checkClient(o[1]);
}
...
void checkListClientsResponse(api.ListClientsResponse o) {
  buildCounterListClientsResponse++;
  if (buildCounterListClientsResponse < 3) {
    checkUnnamed18(o.clients!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListClientsResponse--;
}

core.List<api.DataSegment> buildUnnamed19() => [
  buildDataSegment(),
  buildDataSegment(),
];

void checkUnnamed19(core.List<api.DataSegment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListDataSegmentsResponse(api.ListDataSegmentsResponse o) {
  buildCounterListDataSegmentsResponse++;
  if (buildCounterListDataSegmentsResponse < 3) {
    checkUnnamed19(o.dataSegments!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListDataSegmentsResponse--;
}

core.List<api.Deal> buildUnnamed20() => [buildDeal(), buildDeal()];

void checkUnnamed20(core.List<api.Deal> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDeal(o[0]);
  checkDeal(o[1]);
}
...
void checkListDealsResponse(api.ListDealsResponse o) {
  buildCounterListDealsResponse++;
  if (buildCounterListDealsResponse < 3) {
    checkUnnamed20(o.deals!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListDealsResponse--;
}

core.List<api.FinalizedDeal> buildUnnamed21() => [
  buildFinalizedDeal(),
  buildFinalizedDeal(),
];

void checkUnnamed21(core.List<api.FinalizedDeal> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListFinalizedDealsResponse buildListFinalizedDealsResponse() {
  ...
  if (buildCounterListFinalizedDealsResponse < 3) {
    o.finalizedDeals = buildUnnamed21();
    o.nextPageToken = 'foo';
  }
  buildCounterListFinalizedDealsResponse--;
  return o;
...
void checkListFinalizedDealsResponse(api.ListFinalizedDealsResponse o) {
  buildCounterListFinalizedDealsResponse++;
  if (buildCounterListFinalizedDealsResponse < 3) {
    checkUnnamed21(o.finalizedDeals!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListFinalizedDealsResponse--;
}

core.List<api.Proposal> buildUnnamed22() => [buildProposal(), buildProposal()];

void checkUnnamed22(core.List<api.Proposal> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProposal(o[0]);
  checkProposal(o[1]);
}
...
void checkListProposalsResponse(api.ListProposalsResponse o) {
  ...
  if (buildCounterListProposalsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed22(o.proposals!);
  }
  buildCounterListProposalsResponse--;
}

core.List<api.PublisherProfile> buildUnnamed23() => [
  buildPublisherProfile(),
  buildPublisherProfile(),
];

void checkUnnamed23(core.List<api.PublisherProfile> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListPublisherProfilesResponse buildListPublisherProfilesResponse() {
  ...
  if (buildCounterListPublisherProfilesResponse < 3) {
    o.nextPageToken = 'foo';
    o.publisherProfiles = buildUnnamed23();
  }
  buildCounterListPublisherProfilesResponse--;
  return o;
}
...
void checkListPublisherProfilesResponse(api.ListPublisherProfilesResponse o) {
  ...
  if (buildCounterListPublisherProfilesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed23(o.publisherProfiles!);
  }
  buildCounterListPublisherProfilesResponse--;
}
...
api.MarketplaceTargeting buildMarketplaceTargeting() {
  ...
  if (buildCounterMarketplaceTargeting < 3) {
    ...
    o.excludedSensitiveCategoryIds = buildUnnamed24();
    o.geoTargeting = buildCriteriaTargeting();
    o.inventorySizeTargeting = buildInventorySizeTargeting();
    o.inventoryTypeTargeting = buildInventoryTypeTargeting();
...
void checkMarketplaceTargeting(api.MarketplaceTargeting o) {
  ...
  if (buildCounterMarketplaceTargeting < 3) {
    ...
    checkUnnamed24(o.excludedSensitiveCategoryIds!);
    checkCriteriaTargeting(o.geoTargeting!);
    checkInventorySizeTargeting(o.inventorySizeTargeting!);
    checkInventoryTypeTargeting(o.inventoryTypeTargeting!);
...
void checkProgrammaticGuaranteedTerms(api.ProgrammaticGuaranteedTerms o) {
  ...
  if (buildCounterProgrammaticGuaranteedTerms < 3) {
    ...
    unittest.expect(o.impressionCap!, unittest.equals('foo'));
    unittest.expect(o.minimumDailyLooks!, unittest.equals('foo'));
    unittest.expect(o.percentShareOfVoice!, unittest.equals('foo'));
    unittest.expect(o.reservationType!, unittest.equals('foo'));
  }
  buildCounterProgrammaticGuaranteedTerms--;
}

core.List<api.Contact> buildUnnamed25() => [buildContact(), buildContact()];

void checkUnnamed25(core.List<api.Contact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContact(o[0]);
  checkContact(o[1]);
}

core.List<api.Note> buildUnnamed26() => [buildNote(), buildNote()];

void checkUnnamed26(core.List<api.Note> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNote(o[0]);
  checkNote(o[1]);
}

core.List<api.Contact> buildUnnamed27() => [buildContact(), buildContact()];

void checkUnnamed27(core.List<api.Contact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContact(o[0]);
  checkContact(o[1]);
}
...
api.Proposal buildProposal() {
  ...
  if (buildCounterProposal < 3) {
    o.billedBuyer = 'foo';
    o.buyer = 'foo';
    o.buyerContacts = buildUnnamed25();
    ...
    o.name = 'foo';
    o.notes = buildUnnamed26();
    o.originatorRole = 'foo';
    o.pausingConsented = true;
    o.proposalRevision = 'foo';
    o.publisherProfile = 'foo';
    o.sellerContacts = buildUnnamed27();
    o.state = 'foo';
...
void checkProposal(api.Proposal o) {
  ...
  if (buildCounterProposal < 3) {
    unittest.expect(o.billedBuyer!, unittest.equals('foo'));
    unittest.expect(o.buyer!, unittest.equals('foo'));
    checkUnnamed25(o.buyerContacts!);
    ...
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed26(o.notes!);
    unittest.expect(o.originatorRole!, unittest.equals('foo'));
    unittest.expect(o.pausingConsented!, unittest.isTrue);
    unittest.expect(o.proposalRevision!, unittest.equals('foo'));
    unittest.expect(o.publisherProfile!, unittest.equals('foo'));
    checkUnnamed27(o.sellerContacts!);
    unittest.expect(o.state!, unittest.equals('foo'));
...
core.List<api.PublisherProfileMobileApplication> buildUnnamed29() => [
  buildPublisherProfileMobileApplication(),
  buildPublisherProfileMobileApplication(),
];

void checkUnnamed29(core.List<api.PublisherProfileMobileApplication> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkPublisherProfile(api.PublisherProfile o) {
  ...
  if (buildCounterPublisherProfile < 3) {
    ...
    checkUnnamed29(o.mobileApps!);
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.overview!, unittest.equals('foo'));
    unittest.expect(o.pitchStatement!, unittest.equals('foo'));
    unittest.expect(o.programmaticDealsContact!, unittest.equals('foo'));
    unittest.expect(o.publisherCode!, unittest.equals('foo'));
    unittest.expect(o.samplePageUrl!, unittest.equals('foo'));
    checkUnnamed30(o.topHeadlines!);
  }
  buildCounterPublisherProfile--;
}
...
void checkRtbMetrics(api.RtbMetrics o) {
  buildCounterRtbMetrics++;
  if (buildCounterRtbMetrics < 3) {
    unittest.expect(o.adImpressions7Days!, unittest.equals('foo'));
    unittest.expect(o.bidRate7Days!, unittest.equals(42.0));
    unittest.expect(o.bidRequests7Days!, unittest.equals('foo'));
    unittest.expect(o.bids7Days!, unittest.equals('foo'));
    unittest.expect(o.filteredBidRate7Days!, unittest.equals(42.0));
    unittest.expect(o.mustBidRateCurrentMonth!, unittest.equals(42.0));
  }
  buildCounterRtbMetrics--;
}

core.List<api.Contact> buildUnnamed31() => [buildContact(), buildContact()];

void checkUnnamed31(core.List<api.Contact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContact(o[0]);
  checkContact(o[1]);
}
...
api.SendRfpRequest buildSendRfpRequest() {
  ...
  if (buildCounterSendRfpRequest < 3) {
    o.buyerContacts = buildUnnamed31();
    o.client = 'foo';
    o.displayName = 'foo';
    o.estimatedGrossSpend = buildMoney();
    o.flightEndTime = 'foo';
...
void checkSendRfpRequest(api.SendRfpRequest o) {
  buildCounterSendRfpRequest++;
  if (buildCounterSendRfpRequest < 3) {
    checkUnnamed31(o.buyerContacts!);
    unittest.expect(o.client!, unittest.equals('foo'));
    unittest.expect(o.displayName!, unittest.equals('foo'));
    checkMoney(o.estimatedGrossSpend!);
    unittest.expect(o.flightEndTime!, unittest.equals('foo'));
...
api.UriTargeting buildUriTargeting() {
  ...
  if (buildCounterUriTargeting < 3) {
    o.excludedUris = buildUnnamed34();
    o.targetedUris = buildUnnamed35();
  }
  buildCounterUriTargeting--;
  return o;
}
...
void checkUriTargeting(api.UriTargeting o) {
  buildCounterUriTargeting++;
  if (buildCounterUriTargeting < 3) {
    checkUnnamed34(o.excludedUris!);
    checkUnnamed35(o.targetedUris!);
  }
  buildCounterUriTargeting--;
}
...
api.VideoTargeting buildVideoTargeting() {
  ...
  if (buildCounterVideoTargeting < 3) {
    o.excludedPositionTypes = buildUnnamed36();
    o.targetedPositionTypes = buildUnnamed37();
  }
  buildCounterVideoTargeting--;
  return o;
}
...
void checkVideoTargeting(api.VideoTargeting o) {
  buildCounterVideoTargeting++;
  if (buildCounterVideoTargeting < 3) {
    checkUnnamed36(o.excludedPositionTypes!);
    checkUnnamed37(o.targetedPositionTypes!);
  }
  buildCounterVideoTargeting--;
}
...
void main() {
  ...
  unittest.group('obj-schema-ClientUser', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ClientUser.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkClientUser(od);
    });
  ...
  unittest.group('obj-schema-InventoryTypeTargeting', () {
    unittest.test('to-json--from-json', () async {
      final o = buildInventoryTypeTargeting();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.InventoryTypeTargeting.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkInventoryTypeTargeting(od);
    });
  });
  ...
  unittest.group('obj-schema-Proposal', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Proposal.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkProposal(od);
    });
  ...
  unittest.group('obj-schema-RtbMetrics', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.RtbMetrics.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkRtbMetrics(od);
    });
  ...
  unittest.group('resource-BuyersAuctionPackagesResource', () {
    ...
    unittest.test('method--unsubscribe', () async {
      ...
      final response = await res.unsubscribe(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-BuyersDataSegmentsResource', () {
    unittest.test('method--activate', () async {
      final mock = HttpServerMock();
      final res = api.AuthorizedBuyersMarketplaceApi(mock).buyers.dataSegments;
  ...
  unittest.group('resource-BuyersFinalizedDealsResource', () {
    unittest.test('method--addCreative', () async {
      ...
      final response = await res.addCreative(
        arg_request,
        arg_deal,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--setReadyToServe', () async {
      ...
      final response = await res.setReadyToServe(
        arg_request,
        arg_deal,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-BuyersProposalsResource', () {
    ...
    unittest.test('method--patch', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Proposal.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkProposal(obj);
    ...
    unittest.test('method--sendRfp', () async {
      ...
      final response = await res.sendRfp(
        arg_request,
        arg_buyer,
        $fields: arg_$fields,
      );
