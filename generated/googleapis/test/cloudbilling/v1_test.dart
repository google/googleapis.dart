...
checkUnnamed838(core.List<api.AuditLogConfig> o) {
...
checkUnnamed841(core.List<api.BillingAccount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListBillingAccountsResponse() {
  ...
  if (buildCounterListBillingAccountsResponse < 3) {
    o.billingAccounts = buildUnnamed841();
    o.nextPageToken = "foo";
  }
  buildCounterListBillingAccountsResponse--;
  return o;
...
checkListBillingAccountsResponse(api.ListBillingAccountsResponse o) {
  buildCounterListBillingAccountsResponse++;
  if (buildCounterListBillingAccountsResponse < 3) {
    checkUnnamed841(o.billingAccounts);
...
checkUnnamed842(core.List<api.ProjectBillingInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListProjectBillingInfoResponse() {
  ...
  if (buildCounterListProjectBillingInfoResponse < 3) {
    o.nextPageToken = "foo";
    o.projectBillingInfo = buildUnnamed842();
  }
  buildCounterListProjectBillingInfoResponse--;
  return o;
}
...
checkListProjectBillingInfoResponse(api.ListProjectBillingInfoResponse o) {
  ...
  if (buildCounterListProjectBillingInfoResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed842(o.projectBillingInfo);
  }
  buildCounterListProjectBillingInfoResponse--;
}
...
checkUnnamed843(core.List<api.Service> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkService(o[0]);
  checkService(o[1]);
}
...
checkUnnamed844(core.List<api.Sku> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSku(o[0]);
  checkSku(o[1]);
}
...
checkUnnamed845(core.List<api.AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed846(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.auditConfigs = buildUnnamed845();
    o.bindings = buildUnnamed846();
    o.etag = "foo";
    o.version = 42;
  }
  buildCounterPolicy--;
...
checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed845(o.auditConfigs);
    checkUnnamed846(o.bindings);
...
checkUnnamed847(core.List<api.TierRate> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTierRate(o[0]);
  checkTierRate(o[1]);
}
...
checkUnnamed848(core.List<api.PricingInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSku() {
  ...
  if (buildCounterSku < 3) {
    ...
    o.description = "foo";
    o.name = "foo";
    o.pricingInfo = buildUnnamed848();
    o.serviceProviderName = "foo";
    o.serviceRegions = buildUnnamed849();
    o.skuId = "foo";
  }
  buildCounterSku--;
  return o;
...
checkSku(api.Sku o) {
  ...
  if (buildCounterSku < 3) {
    ...
    unittest.expect(o.description, unittest.equals('foo'));
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed848(o.pricingInfo);
    unittest.expect(o.serviceProviderName, unittest.equals('foo'));
    checkUnnamed849(o.serviceRegions);
