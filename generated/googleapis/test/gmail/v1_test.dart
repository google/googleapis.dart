...
api.BatchModifyMessagesRequest buildBatchModifyMessagesRequest() {
  ...
  if (buildCounterBatchModifyMessagesRequest < 3) {
    o.addLabelIds = buildUnnamed3281();
    o.ids = buildUnnamed3282();
    o.removeLabelIds = buildUnnamed3283();
  }
  buildCounterBatchModifyMessagesRequest--;
  return o;
}
...
void checkBatchModifyMessagesRequest(api.BatchModifyMessagesRequest o) {
  buildCounterBatchModifyMessagesRequest++;
  if (buildCounterBatchModifyMessagesRequest < 3) {
    checkUnnamed3281(o.addLabelIds!);
    checkUnnamed3282(o.ids!);
    checkUnnamed3283(o.removeLabelIds!);
  }
  buildCounterBatchModifyMessagesRequest--;
}
...
api.FilterAction buildFilterAction() {
  ...
  if (buildCounterFilterAction < 3) {
    o.addLabelIds = buildUnnamed3284();
    o.forward = 'foo';
    o.removeLabelIds = buildUnnamed3285();
  }
  buildCounterFilterAction--;
  return o;
}
...
void checkFilterAction(api.FilterAction o) {
  buildCounterFilterAction++;
  if (buildCounterFilterAction < 3) {
    checkUnnamed3284(o.addLabelIds!);
    unittest.expect(
      o.forward!,
      unittest.equals('foo'),
    );
    checkUnnamed3285(o.removeLabelIds!);
  }
  buildCounterFilterAction--;
}
...
core.List<api.HistoryLabelAdded> buildUnnamed3286() => [
      buildHistoryLabelAdded(),
      buildHistoryLabelAdded(),
    ];

void checkUnnamed3286(core.List<api.HistoryLabelAdded> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHistoryLabelAdded(o[0]);
  checkHistoryLabelAdded(o[1]);
}

core.List<api.HistoryLabelRemoved> buildUnnamed3287() => [
      buildHistoryLabelRemoved(),
      buildHistoryLabelRemoved(),
    ];

void checkUnnamed3287(core.List<api.HistoryLabelRemoved> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHistoryLabelRemoved(o[0]);
  checkHistoryLabelRemoved(o[1]);
}

core.List<api.Message> buildUnnamed3288() => [
      buildMessage(),
      buildMessage(),
    ];

void checkUnnamed3288(core.List<api.Message> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMessage(o[0]);
  checkMessage(o[1]);
}

core.List<api.HistoryMessageAdded> buildUnnamed3289() => [
      buildHistoryMessageAdded(),
      buildHistoryMessageAdded(),
    ];

void checkUnnamed3289(core.List<api.HistoryMessageAdded> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHistoryMessageAdded(o[0]);
  checkHistoryMessageAdded(o[1]);
}

core.List<api.HistoryMessageDeleted> buildUnnamed3290() => [
      buildHistoryMessageDeleted(),
      buildHistoryMessageDeleted(),
    ];

void checkUnnamed3290(core.List<api.HistoryMessageDeleted> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.History buildHistory() {
  ...
  if (buildCounterHistory < 3) {
    o.id = 'foo';
    o.labelsAdded = buildUnnamed3286();
    o.labelsRemoved = buildUnnamed3287();
    o.messages = buildUnnamed3288();
    o.messagesAdded = buildUnnamed3289();
    o.messagesDeleted = buildUnnamed3290();
  }
  buildCounterHistory--;
  return o;
}
...
void checkHistory(api.History o) {
  ...
  if (buildCounterHistory < 3) {
    ...
    checkUnnamed3286(o.labelsAdded!);
    checkUnnamed3287(o.labelsRemoved!);
    checkUnnamed3288(o.messages!);
    checkUnnamed3289(o.messagesAdded!);
    checkUnnamed3290(o.messagesDeleted!);
  }
  buildCounterHistory--;
}
...
core.List<api.Delegate> buildUnnamed3293() => [
      buildDelegate(),
      buildDelegate(),
    ];

void checkUnnamed3293(core.List<api.Delegate> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDelegate(o[0]);
  checkDelegate(o[1]);
}
...
void checkListDelegatesResponse(api.ListDelegatesResponse o) {
  buildCounterListDelegatesResponse++;
  if (buildCounterListDelegatesResponse < 3) {
    checkUnnamed3293(o.delegates!);
  }
  buildCounterListDelegatesResponse--;
}

core.List<api.Draft> buildUnnamed3294() => [
      buildDraft(),
      buildDraft(),
    ];

void checkUnnamed3294(core.List<api.Draft> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDraft(o[0]);
  checkDraft(o[1]);
}
...
core.List<api.Filter> buildUnnamed3295() => [
      buildFilter(),
      buildFilter(),
    ];

void checkUnnamed3295(core.List<api.Filter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFilter(o[0]);
  checkFilter(o[1]);
}
...
void checkListFiltersResponse(api.ListFiltersResponse o) {
  buildCounterListFiltersResponse++;
  if (buildCounterListFiltersResponse < 3) {
    checkUnnamed3295(o.filter!);
  }
  buildCounterListFiltersResponse--;
}

core.List<api.ForwardingAddress> buildUnnamed3296() => [
      buildForwardingAddress(),
      buildForwardingAddress(),
    ];

void checkUnnamed3296(core.List<api.ForwardingAddress> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListForwardingAddressesResponse buildListForwardingAddressesResponse() {
  ...
  if (buildCounterListForwardingAddressesResponse < 3) {
    o.forwardingAddresses = buildUnnamed3296();
  }
  buildCounterListForwardingAddressesResponse--;
  return o;
}
...
void checkListForwardingAddressesResponse(
  ...
  buildCounterListForwardingAddressesResponse++;
  if (buildCounterListForwardingAddressesResponse < 3) {
    checkUnnamed3296(o.forwardingAddresses!);
  }
  buildCounterListForwardingAddressesResponse--;
}

core.List<api.History> buildUnnamed3297() => [
      buildHistory(),
      buildHistory(),
    ];

void checkUnnamed3297(core.List<api.History> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHistory(o[0]);
  checkHistory(o[1]);
}
...
core.List<api.Label> buildUnnamed3298() => [
      buildLabel(),
      buildLabel(),
    ];

void checkUnnamed3298(core.List<api.Label> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabel(o[0]);
  checkLabel(o[1]);
}
...
core.List<api.Message> buildUnnamed3299() => [
      buildMessage(),
      buildMessage(),
    ];

void checkUnnamed3299(core.List<api.Message> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMessage(o[0]);
  checkMessage(o[1]);
}
...
core.List<api.SendAs> buildUnnamed3300() => [
      buildSendAs(),
      buildSendAs(),
    ];

void checkUnnamed3300(core.List<api.SendAs> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSendAs(o[0]);
  checkSendAs(o[1]);
}
...
void checkListSendAsResponse(api.ListSendAsResponse o) {
  buildCounterListSendAsResponse++;
  if (buildCounterListSendAsResponse < 3) {
    checkUnnamed3300(o.sendAs!);
  }
  buildCounterListSendAsResponse--;
}

core.List<api.SmimeInfo> buildUnnamed3301() => [
      buildSmimeInfo(),
      buildSmimeInfo(),
    ];

void checkUnnamed3301(core.List<api.SmimeInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSmimeInfo(o[0]);
  checkSmimeInfo(o[1]);
}
...
void checkListSmimeInfoResponse(api.ListSmimeInfoResponse o) {
  buildCounterListSmimeInfoResponse++;
  if (buildCounterListSmimeInfoResponse < 3) {
    checkUnnamed3301(o.smimeInfo!);
  }
  buildCounterListSmimeInfoResponse--;
}

core.List<api.Thread> buildUnnamed3302() => [
      buildThread(),
      buildThread(),
    ];

void checkUnnamed3302(core.List<api.Thread> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkThread(o[0]);
  checkThread(o[1]);
}
...
core.List<api.MessagePartHeader> buildUnnamed3304() => [
      buildMessagePartHeader(),
      buildMessagePartHeader(),
    ];

void checkUnnamed3304(core.List<api.MessagePartHeader> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMessagePartHeader(o[0]);
  checkMessagePartHeader(o[1]);
}

core.List<api.MessagePart> buildUnnamed3305() => [
      buildMessagePart(),
      buildMessagePart(),
    ];

void checkUnnamed3305(core.List<api.MessagePart> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MessagePart buildMessagePart() {
  ...
  if (buildCounterMessagePart < 3) {
    ...
    o.filename = 'foo';
    o.headers = buildUnnamed3304();
    o.mimeType = 'foo';
    o.partId = 'foo';
    o.parts = buildUnnamed3305();
  }
  buildCounterMessagePart--;
  return o;
}
...
api.ModifyMessageRequest buildModifyMessageRequest() {
  ...
  if (buildCounterModifyMessageRequest < 3) {
    o.addLabelIds = buildUnnamed3306();
    o.removeLabelIds = buildUnnamed3307();
  }
  buildCounterModifyMessageRequest--;
  return o;
}
...
void checkModifyMessageRequest(api.ModifyMessageRequest o) {
  buildCounterModifyMessageRequest++;
  if (buildCounterModifyMessageRequest < 3) {
    checkUnnamed3306(o.addLabelIds!);
    checkUnnamed3307(o.removeLabelIds!);
  }
  buildCounterModifyMessageRequest--;
}
...
api.ModifyThreadRequest buildModifyThreadRequest() {
  ...
  if (buildCounterModifyThreadRequest < 3) {
    o.addLabelIds = buildUnnamed3308();
    o.removeLabelIds = buildUnnamed3309();
  }
  buildCounterModifyThreadRequest--;
  return o;
}
...
void checkModifyThreadRequest(api.ModifyThreadRequest o) {
  buildCounterModifyThreadRequest++;
  if (buildCounterModifyThreadRequest < 3) {
    checkUnnamed3308(o.addLabelIds!);
    checkUnnamed3309(o.removeLabelIds!);
  }
  buildCounterModifyThreadRequest--;
}
...
core.List<api.Message> buildUnnamed3310() => [
      buildMessage(),
      buildMessage(),
    ];

void checkUnnamed3310(core.List<api.Message> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMessage(o[0]);
  checkMessage(o[1]);
}
...
void main() {
  ...
  unittest.group('resource-UsersHistoryResource', () {
    unittest.test('method--list', () async {
      ...
      final arg_userId = 'foo';
      final arg_historyTypes = buildUnnamed3312();
  ...
  unittest.group('resource-UsersMessagesResource', () {
    ...
    unittest.test('method--get', () async {
      ...
      final arg_id = 'foo';
      final arg_format = 'foo';
      final arg_metadataHeaders = buildUnnamed3313();
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final path = (req.url).path;
        var pathOffset = 0;
    ...
    unittest.test('method--list', () async {
      ...
      final arg_userId = 'foo';
      final arg_includeSpamTrash = true;
      final arg_labelIds = buildUnnamed3314();
      final arg_maxResults = 42;
      final arg_pageToken = 'foo';
      final arg_q = 'foo';
      final arg_$fields = 'foo';
  ...
  unittest.group('resource-UsersThreadsResource', () {
    ...
    unittest.test('method--get', () async {
      ...
      final arg_id = 'foo';
      final arg_format = 'foo';
      final arg_metadataHeaders = buildUnnamed3315();
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final path = (req.url).path;
        var pathOffset = 0;
    ...
    unittest.test('method--list', () async {
      ...
      final arg_userId = 'foo';
      final arg_includeSpamTrash = true;
      final arg_labelIds = buildUnnamed3316();
      final arg_maxResults = 42;
      final arg_pageToken = 'foo';
      final arg_q = 'foo';
      final arg_$fields = 'foo';
