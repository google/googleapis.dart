...
void checkActiveDirectory(api.ActiveDirectory o) {
  ...
  if (buildCounterActiveDirectory < 3) {
    ...
    unittest.expect(o.kdcHostname!, unittest.equals('foo'));
    unittest.expect(o.kdcIp!, unittest.equals('foo'));
    checkUnnamed2(o.labels!);
    unittest.expect(o.ldapSigning!, unittest.isTrue);
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.netBiosPrefix!, unittest.equals('foo'));
...
api.Backup buildBackup() {
  ...
  if (buildCounterBackup < 3) {
    ...
    o.name = 'foo';
    o.ontapSource = buildOntapSource();
    o.satisfiesPzi = true;
    o.satisfiesPzs = true;
...
void checkBackup(api.Backup o) {
  buildCounterBackup++;
  if (buildCounterBackup < 3) {
    unittest.expect(o.backupRegion!, unittest.equals('foo'));
    unittest.expect(o.backupType!, unittest.equals('foo'));
    unittest.expect(o.chainStorageBytes!, unittest.equals('foo'));
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.enforcedRetentionEndTime!, unittest.equals('foo'));
    checkUnnamed4(o.labels!);
    unittest.expect(o.name!, unittest.equals('foo'));
    checkOntapSource(o.ontapSource!);
    unittest.expect(o.satisfiesPzi!, unittest.isTrue);
    unittest.expect(o.satisfiesPzs!, unittest.isTrue);
    unittest.expect(o.sourceSnapshot!, unittest.equals('foo'));
    unittest.expect(o.sourceVolume!, unittest.equals('foo'));
    unittest.expect(o.state!, unittest.equals('foo'));
    unittest.expect(o.volumeRegion!, unittest.equals('foo'));
    unittest.expect(o.volumeUsageBytes!, unittest.equals('foo'));
  }
  buildCounterBackup--;
}
...
void checkBackupConfig(api.BackupConfig o) {
  buildCounterBackupConfig++;
  if (buildCounterBackupConfig < 3) {
    unittest.expect(o.backupChainBytes!, unittest.equals('foo'));
...
void checkBackupPolicy(api.BackupPolicy o) {
  buildCounterBackupPolicy++;
  if (buildCounterBackupPolicy < 3) {
    unittest.expect(o.assignedVolumeCount!, unittest.equals(42));
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.dailyBackupLimit!, unittest.equals(42));
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.enabled!, unittest.isTrue);
    checkUnnamed6(o.labels!);
    unittest.expect(o.monthlyBackupLimit!, unittest.equals(42));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.state!, unittest.equals('foo'));
    unittest.expect(o.weeklyBackupLimit!, unittest.equals(42));
  }
  buildCounterBackupPolicy--;
}
...
void checkBackupRetentionPolicy(api.BackupRetentionPolicy o) {
  buildCounterBackupRetentionPolicy++;
  if (buildCounterBackupRetentionPolicy < 3) {
    unittest.expect(o.backupMinimumEnforcedRetentionDays!, unittest.equals(42));
...
void checkBackupVault(api.BackupVault o) {
  ...
  if (buildCounterBackupVault < 3) {
    ...
    unittest.expect(o.backupVaultType!, unittest.equals('foo'));
    unittest.expect(o.backupsCryptoKeyVersion!, unittest.equals('foo'));
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.destinationBackupVault!, unittest.equals('foo'));
    ...
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.sourceBackupVault!, unittest.equals('foo'));
    unittest.expect(o.sourceRegion!, unittest.equals('foo'));
    unittest.expect(o.state!, unittest.equals('foo'));
  }
  buildCounterBackupVault--;
}
...
core.int buildCounterBlockDevice = 0;
api.BlockDevice buildBlockDevice() {
  final o = api.BlockDevice();
  buildCounterBlockDevice++;
  if (buildCounterBlockDevice < 3) {
    o.hostGroups = buildUnnamed9();
    o.identifier = 'foo';
    o.name = 'foo';
    o.osType = 'foo';
    o.sizeGib = 'foo';
...
void checkBlockDevice(api.BlockDevice o) {
  buildCounterBlockDevice++;
  if (buildCounterBlockDevice < 3) {
    checkUnnamed9(o.hostGroups!);
...
core.int buildCounterCacheConfig = 0;
api.CacheConfig buildCacheConfig() {
  final o = api.CacheConfig();
  buildCounterCacheConfig++;
  if (buildCounterCacheConfig < 3) {
    o.cachePrePopulate = buildCachePrePopulate();
    o.cachePrePopulateState = 'foo';
    o.cifsChangeNotifyEnabled = true;
    o.writebackEnabled = true;
  }
  buildCounterCacheConfig--;
  return o;
}

void checkCacheConfig(api.CacheConfig o) {
  buildCounterCacheConfig++;
  if (buildCounterCacheConfig < 3) {
    checkCachePrePopulate(o.cachePrePopulate!);
    unittest.expect(o.cachePrePopulateState!, unittest.equals('foo'));
    unittest.expect(o.cifsChangeNotifyEnabled!, unittest.isTrue);
    unittest.expect(o.writebackEnabled!, unittest.isTrue);
  }
  buildCounterCacheConfig--;
}
...
core.int buildCounterCacheParameters = 0;
api.CacheParameters buildCacheParameters() {
  final o = api.CacheParameters();
  buildCounterCacheParameters++;
  if (buildCounterCacheParameters < 3) {
    o.cacheConfig = buildCacheConfig();
    o.cacheState = 'foo';
    o.command = 'foo';
    o.enableGlobalFileLock = true;
    o.passphrase = 'foo';
    o.peerClusterName = 'foo';
    o.peerIpAddresses = buildUnnamed10();
    o.peerSvmName = 'foo';
    o.peerVolumeName = 'foo';
    o.peeringCommandExpiryTime = 'foo';
    o.stateDetails = 'foo';
  }
  buildCounterCacheParameters--;
  return o;
...
void checkCacheParameters(api.CacheParameters o) {
  buildCounterCacheParameters++;
  if (buildCounterCacheParameters < 3) {
    checkCacheConfig(o.cacheConfig!);
    unittest.expect(o.cacheState!, unittest.equals('foo'));
    unittest.expect(o.command!, unittest.equals('foo'));
    unittest.expect(o.enableGlobalFileLock!, unittest.isTrue);
    unittest.expect(o.passphrase!, unittest.equals('foo'));
    unittest.expect(o.peerClusterName!, unittest.equals('foo'));
    checkUnnamed10(o.peerIpAddresses!);
    unittest.expect(o.peerSvmName!, unittest.equals('foo'));
    unittest.expect(o.peerVolumeName!, unittest.equals('foo'));
    unittest.expect(o.peeringCommandExpiryTime!, unittest.equals('foo'));
    unittest.expect(o.stateDetails!, unittest.equals('foo'));
  }
  buildCounterCacheParameters--;
}
...
core.int buildCounterCachePrePopulate = 0;
api.CachePrePopulate buildCachePrePopulate() {
  final o = api.CachePrePopulate();
  buildCounterCachePrePopulate++;
  if (buildCounterCachePrePopulate < 3) {
    o.excludePathList = buildUnnamed11();
    o.pathList = buildUnnamed12();
    o.recursion = true;
  }
  buildCounterCachePrePopulate--;
  return o;
...
void checkCachePrePopulate(api.CachePrePopulate o) {
  buildCounterCachePrePopulate++;
  if (buildCounterCachePrePopulate < 3) {
    checkUnnamed11(o.excludePathList!);
    checkUnnamed12(o.pathList!);
    unittest.expect(o.recursion!, unittest.isTrue);
  }
  buildCounterCachePrePopulate--;
}
...
core.int buildCounterCloneDetails = 0;
api.CloneDetails buildCloneDetails() {
  final o = api.CloneDetails();
  buildCounterCloneDetails++;
  if (buildCounterCloneDetails < 3) {
    o.sharedSpaceGib = 'foo';
    o.sourceSnapshot = 'foo';
    o.sourceVolume = 'foo';
    o.splitState = 'foo';
  }
...
void checkCloneDetails(api.CloneDetails o) {
  buildCounterCloneDetails++;
  if (buildCounterCloneDetails < 3) {
    unittest.expect(o.sharedSpaceGib!, unittest.equals('foo'));
    unittest.expect(o.sourceSnapshot!, unittest.equals('foo'));
    unittest.expect(o.sourceVolume!, unittest.equals('foo'));
    unittest.expect(o.splitState!, unittest.equals('foo'));
  }
  buildCounterCloneDetails--;
}
...
void checkDailySchedule(api.DailySchedule o) {
  buildCounterDailySchedule++;
  if (buildCounterDailySchedule < 3) {
    unittest.expect(o.hour!, unittest.equals(42.0));
    unittest.expect(o.minute!, unittest.equals(42.0));
    unittest.expect(o.snapshotsToKeep!, unittest.equals(42.0));
  }
  buildCounterDailySchedule--;
}
...
api.EstablishPeeringRequest buildEstablishPeeringRequest() {
  ...
  if (buildCounterEstablishPeeringRequest < 3) {
    o.peerClusterName = 'foo';
    o.peerIpAddresses = buildUnnamed13();
    o.peerSvmName = 'foo';
    o.peerVolumeName = 'foo';
  }
  buildCounterEstablishPeeringRequest--;
...
void checkEstablishPeeringRequest(api.EstablishPeeringRequest o) {
  ...
  if (buildCounterEstablishPeeringRequest < 3) {
    unittest.expect(o.peerClusterName!, unittest.equals('foo'));
    checkUnnamed13(o.peerIpAddresses!);
    unittest.expect(o.peerSvmName!, unittest.equals('foo'));
    unittest.expect(o.peerVolumeName!, unittest.equals('foo'));
  }
  buildCounterEstablishPeeringRequest--;
...
core.int buildCounterEstablishVolumePeeringRequest = 0;
api.EstablishVolumePeeringRequest buildEstablishVolumePeeringRequest() {
  final o = api.EstablishVolumePeeringRequest();
  buildCounterEstablishVolumePeeringRequest++;
  if (buildCounterEstablishVolumePeeringRequest < 3) {
    o.peerClusterName = 'foo';
    o.peerIpAddresses = buildUnnamed14();
    o.peerSvmName = 'foo';
    o.peerVolumeName = 'foo';
  }
  buildCounterEstablishVolumePeeringRequest--;
...
void checkEstablishVolumePeeringRequest(api.EstablishVolumePeeringRequest o) {
  buildCounterEstablishVolumePeeringRequest++;
  if (buildCounterEstablishVolumePeeringRequest < 3) {
    unittest.expect(o.peerClusterName!, unittest.equals('foo'));
    checkUnnamed14(o.peerIpAddresses!);
    unittest.expect(o.peerSvmName!, unittest.equals('foo'));
    unittest.expect(o.peerVolumeName!, unittest.equals('foo'));
  }
  buildCounterEstablishVolumePeeringRequest--;
...
core.int buildCounterExecuteOntapDeleteResponse = 0;
api.ExecuteOntapDeleteResponse buildExecuteOntapDeleteResponse() {
  final o = api.ExecuteOntapDeleteResponse();
  buildCounterExecuteOntapDeleteResponse++;
  if (buildCounterExecuteOntapDeleteResponse < 3) {
    o.body = buildUnnamed15();
  }
  buildCounterExecuteOntapDeleteResponse--;
  return o;
}

void checkExecuteOntapDeleteResponse(api.ExecuteOntapDeleteResponse o) {
  buildCounterExecuteOntapDeleteResponse++;
  if (buildCounterExecuteOntapDeleteResponse < 3) {
    checkUnnamed15(o.body!);
  }
  buildCounterExecuteOntapDeleteResponse--;
}
...
core.int buildCounterExecuteOntapGetResponse = 0;
api.ExecuteOntapGetResponse buildExecuteOntapGetResponse() {
  final o = api.ExecuteOntapGetResponse();
  buildCounterExecuteOntapGetResponse++;
  if (buildCounterExecuteOntapGetResponse < 3) {
    o.body = buildUnnamed16();
  }
  buildCounterExecuteOntapGetResponse--;
  return o;
}

void checkExecuteOntapGetResponse(api.ExecuteOntapGetResponse o) {
  buildCounterExecuteOntapGetResponse++;
  if (buildCounterExecuteOntapGetResponse < 3) {
    checkUnnamed16(o.body!);
  }
  buildCounterExecuteOntapGetResponse--;
}
...
core.int buildCounterExecuteOntapPatchRequest = 0;
api.ExecuteOntapPatchRequest buildExecuteOntapPatchRequest() {
  final o = api.ExecuteOntapPatchRequest();
  buildCounterExecuteOntapPatchRequest++;
  if (buildCounterExecuteOntapPatchRequest < 3) {
    o.body = buildUnnamed17();
  }
  buildCounterExecuteOntapPatchRequest--;
  return o;
}

void checkExecuteOntapPatchRequest(api.ExecuteOntapPatchRequest o) {
  buildCounterExecuteOntapPatchRequest++;
  if (buildCounterExecuteOntapPatchRequest < 3) {
    checkUnnamed17(o.body!);
  }
  buildCounterExecuteOntapPatchRequest--;
}
...
core.int buildCounterExecuteOntapPatchResponse = 0;
api.ExecuteOntapPatchResponse buildExecuteOntapPatchResponse() {
  final o = api.ExecuteOntapPatchResponse();
  buildCounterExecuteOntapPatchResponse++;
  if (buildCounterExecuteOntapPatchResponse < 3) {
    o.body = buildUnnamed18();
  }
  buildCounterExecuteOntapPatchResponse--;
  return o;
}

void checkExecuteOntapPatchResponse(api.ExecuteOntapPatchResponse o) {
  buildCounterExecuteOntapPatchResponse++;
  if (buildCounterExecuteOntapPatchResponse < 3) {
    checkUnnamed18(o.body!);
  }
  buildCounterExecuteOntapPatchResponse--;
}
...
core.int buildCounterExecuteOntapPostRequest = 0;
api.ExecuteOntapPostRequest buildExecuteOntapPostRequest() {
  final o = api.ExecuteOntapPostRequest();
  buildCounterExecuteOntapPostRequest++;
  if (buildCounterExecuteOntapPostRequest < 3) {
    o.body = buildUnnamed19();
  }
  buildCounterExecuteOntapPostRequest--;
  return o;
}

void checkExecuteOntapPostRequest(api.ExecuteOntapPostRequest o) {
  buildCounterExecuteOntapPostRequest++;
  if (buildCounterExecuteOntapPostRequest < 3) {
    checkUnnamed19(o.body!);
  }
  buildCounterExecuteOntapPostRequest--;
}
...
core.int buildCounterExecuteOntapPostResponse = 0;
api.ExecuteOntapPostResponse buildExecuteOntapPostResponse() {
  final o = api.ExecuteOntapPostResponse();
  buildCounterExecuteOntapPostResponse++;
  if (buildCounterExecuteOntapPostResponse < 3) {
    o.body = buildUnnamed20();
  }
  buildCounterExecuteOntapPostResponse--;
  return o;
}

void checkExecuteOntapPostResponse(api.ExecuteOntapPostResponse o) {
  buildCounterExecuteOntapPostResponse++;
  if (buildCounterExecuteOntapPostResponse < 3) {
    checkUnnamed20(o.body!);
  }
  buildCounterExecuteOntapPostResponse--;
}

core.List<api.SimpleExportPolicyRule> buildUnnamed21() => [
  buildSimpleExportPolicyRule(),
  buildSimpleExportPolicyRule(),
];

void checkUnnamed21(core.List<api.SimpleExportPolicyRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.int buildCounterHostGroup = 0;
api.HostGroup buildHostGroup() {
  final o = api.HostGroup();
  buildCounterHostGroup++;
  if (buildCounterHostGroup < 3) {
    o.createTime = 'foo';
    o.description = 'foo';
    o.hosts = buildUnnamed22();
...
void checkHostGroup(api.HostGroup o) {
  buildCounterHostGroup++;
  if (buildCounterHostGroup < 3) {
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    checkUnnamed22(o.hosts!);
...
void checkHybridPeeringDetails(api.HybridPeeringDetails o) {
  ...
  if (buildCounterHybridPeeringDetails < 3) {
    unittest.expect(o.command!, unittest.equals('foo'));
    unittest.expect(o.commandExpiryTime!, unittest.equals('foo'));
    unittest.expect(o.passphrase!, unittest.equals('foo'));
    unittest.expect(o.peerClusterName!, unittest.equals('foo'));
    unittest.expect(o.peerSvmName!, unittest.equals('foo'));
    unittest.expect(o.peerVolumeName!, unittest.equals('foo'));
    unittest.expect(o.subnetIp!, unittest.equals('foo'));
  }
  buildCounterHybridPeeringDetails--;
}
...
api.HybridReplicationParameters buildHybridReplicationParameters() {
  ...
  if (buildCounterHybridReplicationParameters < 3) {
    ...
    o.peerClusterName = 'foo';
    o.peerIpAddresses = buildUnnamed25();
    o.peerSvmName = 'foo';
    o.peerVolumeName = 'foo';
    o.replication = 'foo';
...
void checkHybridReplicationParameters(api.HybridReplicationParameters o) {
  ...
  if (buildCounterHybridReplicationParameters < 3) {
    ...
    unittest.expect(o.peerClusterName!, unittest.equals('foo'));
    checkUnnamed25(o.peerIpAddresses!);
    unittest.expect(o.peerSvmName!, unittest.equals('foo'));
    unittest.expect(o.peerVolumeName!, unittest.equals('foo'));
...
core.int buildCounterLargeCapacityConfig = 0;
api.LargeCapacityConfig buildLargeCapacityConfig() {
  final o = api.LargeCapacityConfig();
  buildCounterLargeCapacityConfig++;
  if (buildCounterLargeCapacityConfig < 3) {
    o.constituentCount = 42;
  }
  buildCounterLargeCapacityConfig--;
  return o;
}

void checkLargeCapacityConfig(api.LargeCapacityConfig o) {
  buildCounterLargeCapacityConfig++;
  if (buildCounterLargeCapacityConfig < 3) {
    unittest.expect(o.constituentCount!, unittest.equals(42));
  }
  buildCounterLargeCapacityConfig--;
}

core.List<api.ActiveDirectory> buildUnnamed27() => [
  buildActiveDirectory(),
  buildActiveDirectory(),
];

void checkUnnamed27(core.List<api.ActiveDirectory> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListActiveDirectoriesResponse buildListActiveDirectoriesResponse() {
  ...
  if (buildCounterListActiveDirectoriesResponse < 3) {
    o.activeDirectories = buildUnnamed27();
    o.nextPageToken = 'foo';
...
void checkListActiveDirectoriesResponse(api.ListActiveDirectoriesResponse o) {
  buildCounterListActiveDirectoriesResponse++;
  if (buildCounterListActiveDirectoriesResponse < 3) {
    checkUnnamed27(o.activeDirectories!);
...
core.List<api.VolumeBackupConfig> buildUnnamed30() => [
  buildVolumeBackupConfig(),
  buildVolumeBackupConfig(),
];

void checkUnnamed30(core.List<api.VolumeBackupConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVolumeBackupConfig(o[0]);
  checkVolumeBackupConfig(o[1]);
}

core.int buildCounterListBackupConfigsResponse = 0;
api.ListBackupConfigsResponse buildListBackupConfigsResponse() {
  final o = api.ListBackupConfigsResponse();
  buildCounterListBackupConfigsResponse++;
  if (buildCounterListBackupConfigsResponse < 3) {
    o.nextPageToken = 'foo';
    o.unreachable = buildUnnamed29();
    o.volumeBackupConfigs = buildUnnamed30();
  }
  buildCounterListBackupConfigsResponse--;
  return o;
}

void checkListBackupConfigsResponse(api.ListBackupConfigsResponse o) {
  buildCounterListBackupConfigsResponse++;
  if (buildCounterListBackupConfigsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed29(o.unreachable!);
    checkUnnamed30(o.volumeBackupConfigs!);
  }
  buildCounterListBackupConfigsResponse--;
}

core.List<api.BackupPolicy> buildUnnamed31() => [
  buildBackupPolicy(),
  buildBackupPolicy(),
];

void checkUnnamed31(core.List<api.BackupPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListBackupPoliciesResponse buildListBackupPoliciesResponse() {
  ...
  if (buildCounterListBackupPoliciesResponse < 3) {
    o.backupPolicies = buildUnnamed31();
    o.nextPageToken = 'foo';
...
void checkListBackupPoliciesResponse(api.ListBackupPoliciesResponse o) {
  buildCounterListBackupPoliciesResponse++;
  if (buildCounterListBackupPoliciesResponse < 3) {
    checkUnnamed31(o.backupPolicies!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
...
core.List<api.BackupVault> buildUnnamed33() => [
  buildBackupVault(),
  buildBackupVault(),
];

void checkUnnamed33(core.List<api.BackupVault> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Backup> buildUnnamed35() => [buildBackup(), buildBackup()];

void checkUnnamed35(core.List<api.Backup> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBackup(o[0]);
  checkBackup(o[1]);
}
...
core.List<api.HostGroup> buildUnnamed37() => [
  buildHostGroup(),
  buildHostGroup(),
];

void checkUnnamed37(core.List<api.HostGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHostGroup(o[0]);
  checkHostGroup(o[1]);
}
...
core.int buildCounterListHostGroupsResponse = 0;
api.ListHostGroupsResponse buildListHostGroupsResponse() {
  final o = api.ListHostGroupsResponse();
  buildCounterListHostGroupsResponse++;
  if (buildCounterListHostGroupsResponse < 3) {
    o.hostGroups = buildUnnamed37();
    o.nextPageToken = 'foo';
...
void checkListHostGroupsResponse(api.ListHostGroupsResponse o) {
  buildCounterListHostGroupsResponse++;
  if (buildCounterListHostGroupsResponse < 3) {
    checkUnnamed37(o.hostGroups!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
...
core.List<api.KmsConfig> buildUnnamed39() => [
  buildKmsConfig(),
  buildKmsConfig(),
];

void checkUnnamed39(core.List<api.KmsConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkKmsConfig(o[0]);
  checkKmsConfig(o[1]);
}
...
core.List<api.QuotaRule> buildUnnamed44() => [
  buildQuotaRule(),
  buildQuotaRule(),
];

void checkUnnamed44(core.List<api.QuotaRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQuotaRule(o[0]);
  checkQuotaRule(o[1]);
}
...
core.int buildCounterListQuotaRulesResponse = 0;
api.ListQuotaRulesResponse buildListQuotaRulesResponse() {
  final o = api.ListQuotaRulesResponse();
  buildCounterListQuotaRulesResponse++;
  if (buildCounterListQuotaRulesResponse < 3) {
    o.nextPageToken = 'foo';
    o.quotaRules = buildUnnamed44();
...
void checkListQuotaRulesResponse(api.ListQuotaRulesResponse o) {
  buildCounterListQuotaRulesResponse++;
  if (buildCounterListQuotaRulesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed44(o.quotaRules!);
    checkUnnamed45(o.unreachable!);
  }
  buildCounterListQuotaRulesResponse--;
}

core.List<api.Replication> buildUnnamed46() => [
  buildReplication(),
  buildReplication(),
];

void checkUnnamed46(core.List<api.Replication> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListReplicationsResponse(api.ListReplicationsResponse o) {
  ...
  if (buildCounterListReplicationsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed46(o.replications!);
    checkUnnamed47(o.unreachable!);
  }
  buildCounterListReplicationsResponse--;
}

core.List<api.Snapshot> buildUnnamed48() => [buildSnapshot(), buildSnapshot()];

void checkUnnamed48(core.List<api.Snapshot> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSnapshot(o[0]);
  checkSnapshot(o[1]);
}
...
void checkListSnapshotsResponse(api.ListSnapshotsResponse o) {
  ...
  if (buildCounterListSnapshotsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed48(o.snapshots!);
    checkUnnamed49(o.unreachable!);
  }
  buildCounterListSnapshotsResponse--;
}

core.List<api.StoragePool> buildUnnamed50() => [
  buildStoragePool(),
  buildStoragePool(),
];

void checkUnnamed50(core.List<api.StoragePool> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Volume> buildUnnamed53() => [buildVolume(), buildVolume()];

void checkUnnamed53(core.List<api.Volume> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVolume(o[0]);
  checkVolume(o[1]);
}
...
void checkMonthlySchedule(api.MonthlySchedule o) {
  buildCounterMonthlySchedule++;
  if (buildCounterMonthlySchedule < 3) {
    unittest.expect(o.daysOfMonth!, unittest.equals('foo'));
    unittest.expect(o.hour!, unittest.equals(42.0));
    unittest.expect(o.minute!, unittest.equals(42.0));
    unittest.expect(o.snapshotsToKeep!, unittest.equals(42.0));
  }
...
void checkMountOption(api.MountOption o) {
  buildCounterMountOption++;
  if (buildCounterMountOption < 3) {
    unittest.expect(o.export!, unittest.equals('foo'));
    unittest.expect(o.exportFull!, unittest.equals('foo'));
    unittest.expect(o.instructions!, unittest.equals('foo'));
...
core.int buildCounterOntapSource = 0;
api.OntapSource buildOntapSource() {
  final o = api.OntapSource();
  buildCounterOntapSource++;
  if (buildCounterOntapSource < 3) {
    o.snapshotUuid = 'foo';
    o.storagePool = 'foo';
    o.volumeUuid = 'foo';
  }
...
void checkOntapSource(api.OntapSource o) {
  buildCounterOntapSource++;
  if (buildCounterOntapSource < 3) {
    unittest.expect(o.snapshotUuid!, unittest.equals('foo'));
    unittest.expect(o.storagePool!, unittest.equals('foo'));
    unittest.expect(o.volumeUuid!, unittest.equals('foo'));
  }
  buildCounterOntapSource--;
}

core.int buildCounterOntapVolumeTarget = 0;
api.OntapVolumeTarget buildOntapVolumeTarget() {
  final o = api.OntapVolumeTarget();
  buildCounterOntapVolumeTarget++;
  if (buildCounterOntapVolumeTarget < 3) {
    o.restoreDestinationPath = 'foo';
    o.volumeUuid = 'foo';
  }
  buildCounterOntapVolumeTarget--;
  return o;
...
void checkOntapVolumeTarget(api.OntapVolumeTarget o) {
  buildCounterOntapVolumeTarget++;
  if (buildCounterOntapVolumeTarget < 3) {
    unittest.expect(o.restoreDestinationPath!, unittest.equals('foo'));
    unittest.expect(o.volumeUuid!, unittest.equals('foo'));
  }
  buildCounterOntapVolumeTarget--;
}
...
core.int buildCounterQuotaRule = 0;
api.QuotaRule buildQuotaRule() {
  final o = api.QuotaRule();
  buildCounterQuotaRule++;
  if (buildCounterQuotaRule < 3) {
    o.createTime = 'foo';
    o.description = 'foo';
    o.diskLimitMib = 42;
...
void checkQuotaRule(api.QuotaRule o) {
  buildCounterQuotaRule++;
  if (buildCounterQuotaRule < 3) {
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.diskLimitMib!, unittest.equals(42));
...
void checkReplication(api.Replication o) {
  ...
  if (buildCounterReplication < 3) {
    ...
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.destinationVolume!, unittest.equals('foo'));
...
core.int buildCounterRestoreBackupFilesRequest = 0;
api.RestoreBackupFilesRequest buildRestoreBackupFilesRequest() {
  final o = api.RestoreBackupFilesRequest();
  buildCounterRestoreBackupFilesRequest++;
  if (buildCounterRestoreBackupFilesRequest < 3) {
    o.backup = 'foo';
    o.fileList = buildUnnamed60();
    o.restoreDestinationPath = 'foo';
  }
  buildCounterRestoreBackupFilesRequest--;
  return o;
...
void checkRestoreBackupFilesRequest(api.RestoreBackupFilesRequest o) {
  buildCounterRestoreBackupFilesRequest++;
  if (buildCounterRestoreBackupFilesRequest < 3) {
    unittest.expect(o.backup!, unittest.equals('foo'));
    checkUnnamed60(o.fileList!);
    unittest.expect(o.restoreDestinationPath!, unittest.equals('foo'));
  }
  buildCounterRestoreBackupFilesRequest--;
}
...
core.int buildCounterRestoreVolumeRequest = 0;
api.RestoreVolumeRequest buildRestoreVolumeRequest() {
  final o = api.RestoreVolumeRequest();
  buildCounterRestoreVolumeRequest++;
  if (buildCounterRestoreVolumeRequest < 3) {
    o.backupSource = buildBackupSource();
    o.ontapVolumeTarget = buildOntapVolumeTarget();
  }
  buildCounterRestoreVolumeRequest--;
  return o;
}

void checkRestoreVolumeRequest(api.RestoreVolumeRequest o) {
  buildCounterRestoreVolumeRequest++;
  if (buildCounterRestoreVolumeRequest < 3) {
    checkBackupSource(o.backupSource!);
    checkOntapVolumeTarget(o.ontapVolumeTarget!);
  }
  buildCounterRestoreVolumeRequest--;
}
...
void checkSnapshot(api.Snapshot o) {
  ...
  if (buildCounterSnapshot < 3) {
    ...
    unittest.expect(o.state!, unittest.equals('foo'));
    unittest.expect(o.stateDetails!, unittest.equals('foo'));
    unittest.expect(o.usedBytes!, unittest.equals(42.0));
  }
  buildCounterSnapshot--;
}
...
core.int buildCounterSplitStatus = 0;
api.SplitStatus buildSplitStatus() {
  final o = api.SplitStatus();
  buildCounterSplitStatus++;
  if (buildCounterSplitStatus < 3) {
...
void checkSplitStatus(api.SplitStatus o) {
  buildCounterSplitStatus++;
  if (buildCounterSplitStatus < 3) {
...
core.int buildCounterStartSplitRequest = 0;
api.StartSplitRequest buildStartSplitRequest() {
  final o = api.StartSplitRequest();
  buildCounterStartSplitRequest++;
  if (buildCounterStartSplitRequest < 3) {}
  buildCounterStartSplitRequest--;
  return o;
}

void checkStartSplitRequest(api.StartSplitRequest o) {
  buildCounterStartSplitRequest++;
  if (buildCounterStartSplitRequest < 3) {}
  buildCounterStartSplitRequest--;
}
...
void checkStoragePool(api.StoragePool o) {
  ...
  if (buildCounterStoragePool < 3) {
    ...
    unittest.expect(o.state!, unittest.equals('foo'));
    unittest.expect(o.stateDetails!, unittest.equals('foo'));
    unittest.expect(o.totalIops!, unittest.equals('foo'));
    unittest.expect(o.totalThroughputMibps!, unittest.equals('foo'));
    unittest.expect(o.type!, unittest.equals('foo'));
    unittest.expect(o.volumeCapacityGib!, unittest.equals('foo'));
...
void checkTieringPolicy(api.TieringPolicy o) {
  buildCounterTieringPolicy++;
  if (buildCounterTieringPolicy < 3) {
    unittest.expect(o.coolingThresholdDays!, unittest.equals(42));
    unittest.expect(o.hotTierBypassModeEnabled!, unittest.isTrue);
    unittest.expect(o.tierAction!, unittest.equals('foo'));
  }
  buildCounterTieringPolicy--;
}
...
void checkTransferStats(api.TransferStats o) {
  buildCounterTransferStats++;
  if (buildCounterTransferStats < 3) {
    unittest.expect(o.lagDuration!, unittest.equals('foo'));
    unittest.expect(o.lastTransferBytes!, unittest.equals('foo'));
    unittest.expect(o.lastTransferDuration!, unittest.equals('foo'));
    unittest.expect(o.lastTransferEndTime!, unittest.equals('foo'));
    unittest.expect(o.lastTransferError!, unittest.equals('foo'));
    unittest.expect(o.totalTransferDuration!, unittest.equals('foo'));
    unittest.expect(o.transferBytes!, unittest.equals('foo'));
    unittest.expect(o.updateTime!, unittest.equals('foo'));
  }
  buildCounterTransferStats--;
}

core.int buildCounterUpdateBackupConfigRequest = 0;
api.UpdateBackupConfigRequest buildUpdateBackupConfigRequest() {
  final o = api.UpdateBackupConfigRequest();
  buildCounterUpdateBackupConfigRequest++;
  if (buildCounterUpdateBackupConfigRequest < 3) {
...
void checkUpdateBackupConfigRequest(api.UpdateBackupConfigRequest o) {
  buildCounterUpdateBackupConfigRequest++;
  if (buildCounterUpdateBackupConfigRequest < 3) {
...
void checkValidateDirectoryServiceRequest(
  ...
  buildCounterValidateDirectoryServiceRequest++;
  if (buildCounterValidateDirectoryServiceRequest < 3) {
    unittest.expect(o.directoryServiceType!, unittest.equals('foo'));
  }
  buildCounterValidateDirectoryServiceRequest--;
}
...
void checkVerifyKmsConfigResponse(api.VerifyKmsConfigResponse o) {
  buildCounterVerifyKmsConfigResponse++;
  if (buildCounterVerifyKmsConfigResponse < 3) {
    unittest.expect(o.healthError!, unittest.equals('foo'));
    unittest.expect(o.healthy!, unittest.isTrue);
    unittest.expect(o.instructions!, unittest.equals('foo'));
  }
  buildCounterVerifyKmsConfigResponse--;
...
core.List<api.BlockDevice> buildUnnamed66() => [
  buildBlockDevice(),
  buildBlockDevice(),
];

void checkUnnamed66(core.List<api.BlockDevice> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBlockDevice(o[0]);
  checkBlockDevice(o[1]);
}
...
core.List<api.MountOption> buildUnnamed68() => [
  buildMountOption(),
  buildMountOption(),
];

void checkUnnamed68(core.List<api.MountOption> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Volume buildVolume() {
  ...
  if (buildCounterVolume < 3) {
    o.activeDirectory = 'foo';
    o.backupConfig = buildBackupConfig();
    o.blockDevices = buildUnnamed66();
    o.cacheParameters = buildCacheParameters();
    o.capacityGib = 'foo';
    o.cloneDetails = buildCloneDetails();
    ...
    o.largeCapacityConfig = buildLargeCapacityConfig();
    o.ldapEnabled = true;
    o.mountOptions = buildUnnamed68();
    o.multipleEndpoints = true;
    o.name = 'foo';
    o.network = 'foo';
    o.protocols = buildUnnamed69();
    o.psaRange = 'foo';
    o.replicaZone = 'foo';
    o.restoreParameters = buildRestoreParameters();
    o.restrictedActions = buildUnnamed70();
    o.securityStyle = 'foo';
    o.serviceLevel = 'foo';
    o.shareName = 'foo';
    o.smbSettings = buildUnnamed71();
    o.snapReserve = 42.0;
...
void checkVolume(api.Volume o) {
  ...
  if (buildCounterVolume < 3) {
    unittest.expect(o.activeDirectory!, unittest.equals('foo'));
    checkBackupConfig(o.backupConfig!);
    checkUnnamed66(o.blockDevices!);
    checkCacheParameters(o.cacheParameters!);
    unittest.expect(o.capacityGib!, unittest.equals('foo'));
    checkCloneDetails(o.cloneDetails!);
    unittest.expect(o.coldTierSizeGib!, unittest.equals('foo'));
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.encryptionType!, unittest.equals('foo'));
    ...
    checkLargeCapacityConfig(o.largeCapacityConfig!);
    unittest.expect(o.ldapEnabled!, unittest.isTrue);
    checkUnnamed68(o.mountOptions!);
    unittest.expect(o.multipleEndpoints!, unittest.isTrue);
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.network!, unittest.equals('foo'));
    checkUnnamed69(o.protocols!);
    unittest.expect(o.psaRange!, unittest.equals('foo'));
    unittest.expect(o.replicaZone!, unittest.equals('foo'));
    checkRestoreParameters(o.restoreParameters!);
    checkUnnamed70(o.restrictedActions!);
    unittest.expect(o.securityStyle!, unittest.equals('foo'));
    unittest.expect(o.serviceLevel!, unittest.equals('foo'));
    unittest.expect(o.shareName!, unittest.equals('foo'));
    checkUnnamed71(o.smbSettings!);
...
core.int buildCounterVolumeBackupConfig = 0;
api.VolumeBackupConfig buildVolumeBackupConfig() {
  final o = api.VolumeBackupConfig();
  buildCounterVolumeBackupConfig++;
  if (buildCounterVolumeBackupConfig < 3) {
    o.backupConfig = buildBackupConfig();
    o.volumeUuid = 'foo';
  }
  buildCounterVolumeBackupConfig--;
...
void checkVolumeBackupConfig(api.VolumeBackupConfig o) {
  buildCounterVolumeBackupConfig++;
  if (buildCounterVolumeBackupConfig < 3) {
    checkBackupConfig(o.backupConfig!);
    unittest.expect(o.volumeUuid!, unittest.equals('foo'));
...
void main() {
  ...
  unittest.group('obj-schema-BlockDevice', () {
    unittest.test('to-json--from-json', () async {
      final o = buildBlockDevice();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.BlockDevice.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkBlockDevice(od);
    });
  ...
  unittest.group('obj-schema-CacheConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCacheConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CacheConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCacheConfig(od);
    });
  ...
  unittest.group('obj-schema-CacheParameters', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCacheParameters();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CacheParameters.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCacheParameters(od);
    });
  });

  unittest.group('obj-schema-CachePrePopulate', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCachePrePopulate();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CachePrePopulate.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCachePrePopulate(od);
    });
  });
  ...
  unittest.group('obj-schema-CloneDetails', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCloneDetails();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.CloneDetails.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCloneDetails(od);
    });
  });
  ...
  unittest.group('obj-schema-EstablishVolumePeeringRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildEstablishVolumePeeringRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.EstablishVolumePeeringRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkEstablishVolumePeeringRequest(od);
    });
  });

  unittest.group('obj-schema-ExecuteOntapDeleteResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildExecuteOntapDeleteResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ExecuteOntapDeleteResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkExecuteOntapDeleteResponse(od);
    });
  });

  unittest.group('obj-schema-ExecuteOntapGetResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildExecuteOntapGetResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ExecuteOntapGetResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkExecuteOntapGetResponse(od);
    });
  });

  unittest.group('obj-schema-ExecuteOntapPatchRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildExecuteOntapPatchRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ExecuteOntapPatchRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkExecuteOntapPatchRequest(od);
    });
  });

  unittest.group('obj-schema-ExecuteOntapPatchResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildExecuteOntapPatchResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ExecuteOntapPatchResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkExecuteOntapPatchResponse(od);
    });
  });

  unittest.group('obj-schema-ExecuteOntapPostRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildExecuteOntapPostRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ExecuteOntapPostRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkExecuteOntapPostRequest(od);
    });
  });

  unittest.group('obj-schema-ExecuteOntapPostResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildExecuteOntapPostResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ExecuteOntapPostResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkExecuteOntapPostResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-HostGroup', () {
    unittest.test('to-json--from-json', () async {
      final o = buildHostGroup();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.HostGroup.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkHostGroup(od);
    });
  ...
  unittest.group('obj-schema-KmsConfig', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.KmsConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkKmsConfig(od);
    });
  ...
  unittest.group('obj-schema-LargeCapacityConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildLargeCapacityConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.LargeCapacityConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkLargeCapacityConfig(od);
    });
  });
  ...
  unittest.group('obj-schema-ListBackupConfigsResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildListBackupConfigsResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListBackupConfigsResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkListBackupConfigsResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-ListHostGroupsResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildListHostGroupsResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListHostGroupsResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkListHostGroupsResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-ListQuotaRulesResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildListQuotaRulesResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListQuotaRulesResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkListQuotaRulesResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-OntapSource', () {
    unittest.test('to-json--from-json', () async {
      final o = buildOntapSource();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.OntapSource.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkOntapSource(od);
    });
  ...
  unittest.group('obj-schema-OntapVolumeTarget', () {
    unittest.test('to-json--from-json', () async {
      final o = buildOntapVolumeTarget();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.OntapVolumeTarget.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkOntapVolumeTarget(od);
    });
  });
  ...
  unittest.group('obj-schema-QuotaRule', () {
    unittest.test('to-json--from-json', () async {
      final o = buildQuotaRule();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.QuotaRule.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkQuotaRule(od);
    });
  ...
  unittest.group('obj-schema-RestoreBackupFilesRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildRestoreBackupFilesRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.RestoreBackupFilesRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkRestoreBackupFilesRequest(od);
    });
  });
  ...
  unittest.group('obj-schema-RestoreVolumeRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildRestoreVolumeRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.RestoreVolumeRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkRestoreVolumeRequest(od);
    });
  });
  ...
  unittest.group('obj-schema-SplitStatus', () {
    unittest.test('to-json--from-json', () async {
      final o = buildSplitStatus();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.SplitStatus.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkSplitStatus(od);
    });
  ...
  unittest.group('obj-schema-StartSplitRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildStartSplitRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.StartSplitRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkStartSplitRequest(od);
    });
  });
  ...
  unittest.group('obj-schema-UpdateBackupConfigRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildUpdateBackupConfigRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.UpdateBackupConfigRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkUpdateBackupConfigRequest(od);
    });
  });
  ...
  unittest.group('obj-schema-VolumeBackupConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildVolumeBackupConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.VolumeBackupConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkVolumeBackupConfig(od);
    });
  });
  ...
  unittest.group('resource-ProjectsLocationsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.NetAppFilesApi(mock).projects.locations;
      final arg_name = 'foo';
      final arg_extraLocationTypes = buildUnnamed72();
  ...
  unittest.group('resource-ProjectsLocationsActiveDirectoriesResource', () {
    unittest.test('method--create', () async {
      ...
      final response = await res.create(
        arg_request,
        arg_parent,
        activeDirectoryId: arg_activeDirectoryId,
        $fields: arg_$fields,
      );
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final resp = convert.json.encode(
            buildListActiveDirectoriesResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
  ...
  unittest.group('resource-ProjectsLocationsBackupPoliciesResource', () {
    unittest.test('method--create', () async {
      ...
      final response = await res.create(
        arg_request,
        arg_parent,
        backupPolicyId: arg_backupPolicyId,
        $fields: arg_$fields,
      );
      checkOperation(response as api.Operation);
    });
  ...
  unittest.group('resource-ProjectsLocationsHostGroupsResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.NetAppFilesApi(mock).projects.locations.hostGroups;
      final arg_request = buildHostGroup();
      final arg_parent = 'foo';
      final arg_hostGroupId = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.HostGroup.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkHostGroup(obj);
          ...
          unittest.expect(
            queryMap['hostGroupId']!.first,
            unittest.equals(arg_hostGroupId),
          );
          unittest.expect(
            queryMap['fields']!.first,
            unittest.equals(arg_$fields),
    ...
    unittest.test('method--get', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildHostGroup());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.get(arg_name, $fields: arg_$fields);
      checkHostGroup(response as api.HostGroup);
    });
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildListHostGroupsResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      ...
      checkListHostGroupsResponse(response as api.ListHostGroupsResponse);
    });
  ...
  unittest.group('resource-ProjectsLocationsKmsConfigsResource', () {
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.KmsConfig.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkKmsConfig(obj);
  ...
  unittest.group('resource-ProjectsLocationsStoragePoolsResource', () {
    unittest.test('method--create', () async {
      ...
      final response = await res.create(
        arg_request,
        arg_parent,
        storagePoolId: arg_storagePoolId,
        $fields: arg_$fields,
      );
      checkOperation(response as api.Operation);
    });
    ...
    unittest.test('method--restoreVolume', () async {
      final mock = HttpServerMock();
      final res = api.NetAppFilesApi(mock).projects.locations.storagePools;
      final arg_request = buildRestoreVolumeRequest();
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.RestoreVolumeRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkRestoreVolumeRequest(obj);
      ...
      final response = await res.restoreVolume(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--updateBackupConfig', () async {
      final mock = HttpServerMock();
      final res = api.NetAppFilesApi(mock).projects.locations.storagePools;
      final arg_request = buildUpdateBackupConfigRequest();
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.UpdateBackupConfigRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkUpdateBackupConfigRequest(obj);
      ...
      final response = await res.updateBackupConfig(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--validateDirectoryService', () async {
      ...
      final response = await res.validateDirectoryService(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
  ...
  unittest.group(
    'resource-ProjectsLocationsStoragePoolsBackupConfigsResource',
    () {
      unittest.test('method--list', () async {
        final mock = HttpServerMock();
        final res = api.NetAppFilesApi(
          mock,
        ).projects.locations.storagePools.backupConfigs;
        final arg_parent = 'foo';
        final arg_filter = 'foo';
        final arg_orderBy = 'foo';
        final arg_pageSize = 42;
        ...
        mock.register(
          unittest.expectAsync2((http.BaseRequest req, json) {
            ...
            final h = {'content-type': 'application/json; charset=utf-8'};
            final resp = convert.json.encode(buildListBackupConfigsResponse());
            return async.Future.value(stringResponse(200, h, resp));
          }),
          true,
        );
        ...
        checkListBackupConfigsResponse(
          response as api.ListBackupConfigsResponse,
        );
      });
    },
  );

  unittest.group('resource-ProjectsLocationsStoragePoolsOntapResource', () {
    unittest.test('method--executeOntapDelete', () async {
      final mock = HttpServerMock();
      final res = api.NetAppFilesApi(
        mock,
      ).projects.locations.storagePools.ontap;
      final arg_ontapPath = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final path = req.url.path;
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildExecuteOntapDeleteResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.executeOntapDelete(
        arg_ontapPath,
        $fields: arg_$fields,
      );
      checkExecuteOntapDeleteResponse(
        response as api.ExecuteOntapDeleteResponse,
      );
    });

    unittest.test('method--executeOntapGet', () async {
      final mock = HttpServerMock();
      final res = api.NetAppFilesApi(
        mock,
      ).projects.locations.storagePools.ontap;
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildExecuteOntapGetResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.executeOntapGet(
        arg_ontapPath,
        $fields: arg_$fields,
      );
      checkExecuteOntapGetResponse(response as api.ExecuteOntapGetResponse);
    });

    unittest.test('method--executeOntapPatch', () async {
      final mock = HttpServerMock();
      final res = api.NetAppFilesApi(
        mock,
      ).projects.locations.storagePools.ontap;
      final arg_request = buildExecuteOntapPatchRequest();
      final arg_ontapPath = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.ExecuteOntapPatchRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkExecuteOntapPatchRequest(obj);
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildExecuteOntapPatchResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.executeOntapPatch(
        arg_request,
        arg_ontapPath,
        $fields: arg_$fields,
      );
      checkExecuteOntapPatchResponse(response as api.ExecuteOntapPatchResponse);
    });

    unittest.test('method--executeOntapPost', () async {
      final mock = HttpServerMock();
      final res = api.NetAppFilesApi(
        mock,
      ).projects.locations.storagePools.ontap;
      final arg_request = buildExecuteOntapPostRequest();
      final arg_ontapPath = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.ExecuteOntapPostRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkExecuteOntapPostRequest(obj);
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildExecuteOntapPostResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.executeOntapPost(
        arg_request,
        arg_ontapPath,
        $fields: arg_$fields,
      );
      checkExecuteOntapPostResponse(response as api.ExecuteOntapPostResponse);
    });
  });
  ...
  unittest.group('resource-ProjectsLocationsVolumesResource', () {
    ...
    unittest.test('method--establishPeering', () async {
      final mock = HttpServerMock();
      final res = api.NetAppFilesApi(mock).projects.locations.volumes;
      final arg_request = buildEstablishVolumePeeringRequest();
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.EstablishVolumePeeringRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkEstablishVolumePeeringRequest(obj);
      ...
      final response = await res.establishPeering(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--getSplitStatus', () async {
      final mock = HttpServerMock();
      final res = api.NetAppFilesApi(mock).projects.locations.volumes;
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildSplitStatus());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.getSplitStatus(arg_name, $fields: arg_$fields);
      checkSplitStatus(response as api.SplitStatus);
    });
    ...
    unittest.test('method--restore', () async {
      final mock = HttpServerMock();
      final res = api.NetAppFilesApi(mock).projects.locations.volumes;
      final arg_request = buildRestoreBackupFilesRequest();
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.RestoreBackupFilesRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkRestoreBackupFilesRequest(obj);
    ...
    unittest.test('method--startSplit', () async {
      final mock = HttpServerMock();
      final res = api.NetAppFilesApi(mock).projects.locations.volumes;
      final arg_request = buildStartSplitRequest();
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.StartSplitRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkStartSplitRequest(obj);
      ...
      final response = await res.startSplit(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-ProjectsLocationsVolumesQuotaRulesResource', () {
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.QuotaRule.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkQuotaRule(obj);
          ...
          unittest.expect(
            queryMap['quotaRuleId']!.first,
            unittest.equals(arg_quotaRuleId),
          );
          unittest.expect(
            queryMap['fields']!.first,
            unittest.equals(arg_$fields),
    ...
    unittest.test('method--get', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildQuotaRule());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.get(arg_name, $fields: arg_$fields);
      checkQuotaRule(response as api.QuotaRule);
    });
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildListQuotaRulesResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      ...
      checkListQuotaRulesResponse(response as api.ListQuotaRulesResponse);
    });
  ...
  unittest.group('resource-ProjectsLocationsVolumesReplicationsResource', () {
    unittest.test('method--create', () async {
      ...
      final response = await res.create(
        arg_request,
        arg_parent,
        replicationId: arg_replicationId,
        $fields: arg_$fields,
      );
      checkOperation(response as api.Operation);
    });
    ...
    unittest.test('method--reverseDirection', () async {
      ...
      final response = await res.reverseDirection(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
