...
core.List<api.DatabaseConnectionStringProfile> buildUnnamed2() => [
      buildDatabaseConnectionStringProfile(),
      buildDatabaseConnectionStringProfile(),
    ];

void checkUnnamed2(core.List<api.DatabaseConnectionStringProfile> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.CustomerContact> buildUnnamed4() => [
      buildCustomerContact(),
      buildCustomerContact(),
    ];

void checkUnnamed4(core.List<api.CustomerContact> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ScheduledOperationDetails> buildUnnamed6() => [
      buildScheduledOperationDetails(),
      buildScheduledOperationDetails(),
    ];

void checkUnnamed6(core.List<api.ScheduledOperationDetails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AutonomousDatabaseProperties buildAutonomousDatabaseProperties() {
  ...
  if (buildCounterAutonomousDatabaseProperties < 3) {
    ...
    o.availableUpgradeVersions = buildUnnamed3();
    ...
    o.cpuCoreCount = 42;
    o.customerContacts = buildUnnamed4();
    o.dataSafeState = 'foo';
    ...
    o.role = 'foo';
    o.scheduledOperationDetails = buildUnnamed6();
    o.secretId = 'foo';
    o.sqlWebDeveloperUrl = 'foo';
    o.state = 'foo';
    o.supportedCloneRegions = buildUnnamed7();
...
void checkAutonomousDatabaseProperties(api.AutonomousDatabaseProperties o) {
  ...
  if (buildCounterAutonomousDatabaseProperties < 3) {
    unittest.expect(
      o.actualUsedDataStorageSizeTb!,
      unittest.equals(42.0),
    );
    unittest.expect(
      o.allocatedStorageSizeTb!,
      unittest.equals(42.0),
    );
    ...
    checkUnnamed3(o.availableUpgradeVersions!);
    unittest.expect(
      o.backupRetentionPeriodDays!,
      unittest.equals(42),
    );
    unittest.expect(
      o.characterSet!,
    ...
    checkUnnamed4(o.customerContacts!);
    unittest.expect(
      o.dataSafeState!,
      unittest.equals('foo'),
    );
    ...
    unittest.expect(
      o.localDisasterRecoveryType!,
      unittest.equals('foo'),
    );
    checkAutonomousDatabaseStandbySummary(o.localStandbyDb!);
    unittest.expect(
      o.maintenanceBeginTime!,
      unittest.equals('foo'),
    );
    unittest.expect(
      o.maintenanceEndTime!,
      unittest.equals('foo'),
    );
    unittest.expect(
      o.maintenanceScheduleType!,
      unittest.equals('foo'),
    );
    unittest.expect(
      o.memoryPerOracleComputeUnitGbs!,
      unittest.equals(42),
    );
    unittest.expect(
      o.memoryTableGbs!,
    ...
    unittest.expect(
      o.operationsInsightsState!,
      unittest.equals('foo'),
    );
    checkUnnamed5(o.peerDbIds!);
    unittest.expect(
      o.permissionLevel!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed6(o.scheduledOperationDetails!);
    unittest.expect(
      o.secretId!,
      unittest.equals('foo'),
    );
    unittest.expect(
      o.sqlWebDeveloperUrl!,
      unittest.equals('foo'),
    );
    unittest.expect(
      o.state!,
    ...
    checkUnnamed7(o.supportedCloneRegions!);
    unittest.expect(
      o.totalAutoBackupStorageSizeGbs!,
      unittest.equals(42.0),
    );
    unittest.expect(
      o.usedDataStorageSizeTbs!,
      unittest.equals(42),
    );
    unittest.expect(
      o.vaultId!,
...
void checkAutonomousDatabaseStandbySummary(
  ...
  if (buildCounterAutonomousDatabaseStandbySummary < 3) {
    unittest.expect(
      o.dataGuardRoleChangedTime!,
      unittest.equals('foo'),
    );
    unittest.expect(
      o.disasterRecoveryRoleChangedTime!,
      unittest.equals('foo'),
    );
    unittest.expect(
      o.lagTimeDuration!,
...
void checkCloudAccountDetails(api.CloudAccountDetails o) {
  ...
  if (buildCounterCloudAccountDetails < 3) {
    ...
    unittest.expect(
      o.cloudAccountHomeRegion!,
      unittest.equals('foo'),
    );
    unittest.expect(
      o.linkExistingAccountUri!,
      unittest.equals('foo'),
    );
  }
  buildCounterCloudAccountDetails--;
...
core.List<api.CustomerContact> buildUnnamed9() => [
      buildCustomerContact(),
      buildCustomerContact(),
    ];

void checkUnnamed9(core.List<api.CustomerContact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCustomerContact(o[0]);
  checkCustomerContact(o[1]);
}
...
api.CloudExadataInfrastructureProperties
  ...
  if (buildCounterCloudExadataInfrastructureProperties < 3) {
    ...
    o.computeCount = 42;
    o.cpuCount = 42;
    o.customerContacts = buildUnnamed9();
...
void checkCloudExadataInfrastructureProperties(
  ...
  if (buildCounterCloudExadataInfrastructureProperties < 3) {
    unittest.expect(
      o.activatedStorageCount!,
      unittest.equals(42),
    );
    unittest.expect(
      o.additionalStorageCount!,
      unittest.equals(42),
    );
    unittest.expect(
      o.availableStorageSizeGb!,
      unittest.equals(42),
    );
    unittest.expect(
      o.computeCount!,
    ...
    checkUnnamed9(o.customerContacts!);
    unittest.expect(
      o.dataStorageSizeTb!,
      unittest.equals(42.0),
    );
    unittest.expect(
      o.dbNodeStorageSizeGb!,
      unittest.equals(42),
    );
    unittest.expect(
      o.dbServerVersion!,
    ...
    unittest.expect(
      o.monthlyDbServerVersion!,
      unittest.equals('foo'),
    );
    unittest.expect(
      o.monthlyStorageServerVersion!,
      unittest.equals('foo'),
    );
    unittest.expect(
      o.nextMaintenanceRunId!,
      unittest.equals('foo'),
    );
    unittest.expect(
      o.nextMaintenanceRunTime!,
      unittest.equals('foo'),
    );
    unittest.expect(
      o.nextSecurityMaintenanceRunTime!,
      unittest.equals('foo'),
    );
    unittest.expect(
      o.ociUrl!,
    ...
    unittest.expect(
      o.storageServerVersion!,
      unittest.equals('foo'),
    );
    unittest.expect(
      o.totalStorageSizeGb!,
      unittest.equals(42),
    );
  }
  buildCounterCloudExadataInfrastructureProperties--;
...
api.CloudVmClusterProperties buildCloudVmClusterProperties() {
  ...
  if (buildCounterCloudVmClusterProperties < 3) {
    ...
    o.dataStorageSizeTb = 42.0;
    o.dbNodeStorageSizeGb = 42;
    o.dbServerOcids = buildUnnamed11();
...
void checkCloudVmClusterProperties(api.CloudVmClusterProperties o) {
  ...
  if (buildCounterCloudVmClusterProperties < 3) {
    ...
    checkUnnamed11(o.dbServerOcids!);
    ...
    checkUnnamed12(o.scanIpIds!);
    unittest.expect(
      o.scanListenerPortTcp!,
      unittest.equals(42),
    );
    unittest.expect(
      o.scanListenerPortTcpSsl!,
      unittest.equals(42),
    );
    unittest.expect(
      o.shape!,
    ...
    checkUnnamed13(o.sshPublicKeys!);
    unittest.expect(
      o.state!,
      unittest.equals('foo'),
    );
...
void checkDbSystemShape(api.DbSystemShape o) {
  ...
  if (buildCounterDbSystemShape < 3) {
    unittest.expect(
      o.availableCoreCountPerNode!,
      unittest.equals(42),
    );
    unittest.expect(
      o.availableDataStorageTb!,
      unittest.equals(42),
    );
    unittest.expect(
      o.availableMemoryPerNodeGb!,
      unittest.equals(42),
    );
    unittest.expect(
      o.maxNodeCount!,
    ...
    unittest.expect(
      o.minCoreCountPerNode!,
      unittest.equals(42),
    );
    unittest.expect(
      o.minDbNodeStoragePerNodeGb!,
      unittest.equals(42),
    );
    unittest.expect(
      o.minMemoryPerNodeGb!,
      unittest.equals(42),
    );
    unittest.expect(
      o.minNodeCount!,
...
core.List<api.AutonomousDatabaseBackup> buildUnnamed15() => [
      buildAutonomousDatabaseBackup(),
      buildAutonomousDatabaseBackup(),
    ];

void checkUnnamed15(core.List<api.AutonomousDatabaseBackup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListAutonomousDatabaseBackupsResponse
  ...
  if (buildCounterListAutonomousDatabaseBackupsResponse < 3) {
    o.autonomousDatabaseBackups = buildUnnamed15();
    o.nextPageToken = 'foo';
  }
  buildCounterListAutonomousDatabaseBackupsResponse--;
  return o;
...
void checkListAutonomousDatabaseBackupsResponse(
  ...
  buildCounterListAutonomousDatabaseBackupsResponse++;
  if (buildCounterListAutonomousDatabaseBackupsResponse < 3) {
    checkUnnamed15(o.autonomousDatabaseBackups!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.AutonomousDatabaseCharacterSet> buildUnnamed16() => [
      buildAutonomousDatabaseCharacterSet(),
      buildAutonomousDatabaseCharacterSet(),
    ];

void checkUnnamed16(core.List<api.AutonomousDatabaseCharacterSet> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListAutonomousDatabaseCharacterSetsResponse
  ...
  if (buildCounterListAutonomousDatabaseCharacterSetsResponse < 3) {
    o.autonomousDatabaseCharacterSets = buildUnnamed16();
    o.nextPageToken = 'foo';
  }
  buildCounterListAutonomousDatabaseCharacterSetsResponse--;
  return o;
...
void checkListAutonomousDatabaseCharacterSetsResponse(
  ...
  buildCounterListAutonomousDatabaseCharacterSetsResponse++;
  if (buildCounterListAutonomousDatabaseCharacterSetsResponse < 3) {
    checkUnnamed16(o.autonomousDatabaseCharacterSets!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.AutonomousDatabase> buildUnnamed17() => [
      buildAutonomousDatabase(),
      buildAutonomousDatabase(),
    ];

void checkUnnamed17(core.List<api.AutonomousDatabase> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListAutonomousDatabasesResponse buildListAutonomousDatabasesResponse() {
  ...
  if (buildCounterListAutonomousDatabasesResponse < 3) {
    o.autonomousDatabases = buildUnnamed17();
    o.nextPageToken = 'foo';
  }
  buildCounterListAutonomousDatabasesResponse--;
  return o;
...
void checkListAutonomousDatabasesResponse(
  ...
  buildCounterListAutonomousDatabasesResponse++;
  if (buildCounterListAutonomousDatabasesResponse < 3) {
    checkUnnamed17(o.autonomousDatabases!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.AutonomousDbVersion> buildUnnamed18() => [
      buildAutonomousDbVersion(),
      buildAutonomousDbVersion(),
    ];

void checkUnnamed18(core.List<api.AutonomousDbVersion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListAutonomousDbVersionsResponse buildListAutonomousDbVersionsResponse() {
  ...
  if (buildCounterListAutonomousDbVersionsResponse < 3) {
    o.autonomousDbVersions = buildUnnamed18();
    o.nextPageToken = 'foo';
  }
  buildCounterListAutonomousDbVersionsResponse--;
  return o;
...
void checkListAutonomousDbVersionsResponse(
  ...
  buildCounterListAutonomousDbVersionsResponse++;
  if (buildCounterListAutonomousDbVersionsResponse < 3) {
    checkUnnamed18(o.autonomousDbVersions!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.CloudExadataInfrastructure> buildUnnamed19() => [
      buildCloudExadataInfrastructure(),
      buildCloudExadataInfrastructure(),
    ];

void checkUnnamed19(core.List<api.CloudExadataInfrastructure> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListCloudExadataInfrastructuresResponse
  ...
  if (buildCounterListCloudExadataInfrastructuresResponse < 3) {
    o.cloudExadataInfrastructures = buildUnnamed19();
    o.nextPageToken = 'foo';
  }
  buildCounterListCloudExadataInfrastructuresResponse--;
  return o;
...
void checkListCloudExadataInfrastructuresResponse(
  ...
  buildCounterListCloudExadataInfrastructuresResponse++;
  if (buildCounterListCloudExadataInfrastructuresResponse < 3) {
    checkUnnamed19(o.cloudExadataInfrastructures!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.CloudVmCluster> buildUnnamed20() => [
      buildCloudVmCluster(),
      buildCloudVmCluster(),
    ];

void checkUnnamed20(core.List<api.CloudVmCluster> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListCloudVmClustersResponse buildListCloudVmClustersResponse() {
  ...
  if (buildCounterListCloudVmClustersResponse < 3) {
    o.cloudVmClusters = buildUnnamed20();
    o.nextPageToken = 'foo';
  }
  buildCounterListCloudVmClustersResponse--;
  return o;
...
void checkListCloudVmClustersResponse(api.ListCloudVmClustersResponse o) {
  buildCounterListCloudVmClustersResponse++;
  if (buildCounterListCloudVmClustersResponse < 3) {
    checkUnnamed20(o.cloudVmClusters!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.DbNode> buildUnnamed21() => [
      buildDbNode(),
      buildDbNode(),
    ];

void checkUnnamed21(core.List<api.DbNode> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDbNode(o[0]);
  checkDbNode(o[1]);
}
...
core.List<api.DbServer> buildUnnamed22() => [
      buildDbServer(),
      buildDbServer(),
    ];

void checkUnnamed22(core.List<api.DbServer> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDbServer(o[0]);
  checkDbServer(o[1]);
}
...
core.List<api.DbSystemShape> buildUnnamed23() => [
      buildDbSystemShape(),
      buildDbSystemShape(),
    ];

void checkUnnamed23(core.List<api.DbSystemShape> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListDbSystemShapesResponse buildListDbSystemShapesResponse() {
  ...
  if (buildCounterListDbSystemShapesResponse < 3) {
    o.dbSystemShapes = buildUnnamed23();
    o.nextPageToken = 'foo';
  }
  buildCounterListDbSystemShapesResponse--;
  return o;
...
void checkListDbSystemShapesResponse(api.ListDbSystemShapesResponse o) {
  buildCounterListDbSystemShapesResponse++;
  if (buildCounterListDbSystemShapesResponse < 3) {
    checkUnnamed23(o.dbSystemShapes!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Entitlement> buildUnnamed24() => [
      buildEntitlement(),
      buildEntitlement(),
    ];

void checkUnnamed24(core.List<api.Entitlement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GiVersion> buildUnnamed25() => [
      buildGiVersion(),
      buildGiVersion(),
    ];

void checkUnnamed25(core.List<api.GiVersion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGiVersion(o[0]);
  checkGiVersion(o[1]);
}
...
core.List<core.int> buildUnnamed31() => [
      42,
      42,
    ];
...
api.MaintenanceWindow buildMaintenanceWindow() {
  ...
  if (buildCounterMaintenanceWindow < 3) {
    ...
    o.daysOfWeek = buildUnnamed30();
    o.hoursOfDay = buildUnnamed31();
    o.isCustomActionTimeoutEnabled = true;
    o.leadTimeWeek = 42;
    o.months = buildUnnamed32();
    o.patchingMode = 'foo';
    o.preference = 'foo';
    o.weeksOfMonth = buildUnnamed33();
  }
  buildCounterMaintenanceWindow--;
  return o;
}
...
void checkMaintenanceWindow(api.MaintenanceWindow o) {
  ...
  if (buildCounterMaintenanceWindow < 3) {
    unittest.expect(
      o.customActionTimeoutMins!,
      unittest.equals(42),
    );
    checkUnnamed30(o.daysOfWeek!);
    checkUnnamed31(o.hoursOfDay!);
    unittest.expect(o.isCustomActionTimeoutEnabled!, unittest.isTrue);
    unittest.expect(
      o.leadTimeWeek!,
      unittest.equals(42),
    );
    checkUnnamed32(o.months!);
    unittest.expect(
      o.patchingMode!,
      unittest.equals('foo'),
    );
...
void main() {
  ...
  unittest.group('obj-schema-DbNode', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od =
          api.DbNode.fromJson(oJson as core.Map<core.String, core.dynamic>);
      checkDbNode(od);
    });
  });
  ...
  unittest.group('obj-schema-DbServer', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od =
          api.DbServer.fromJson(oJson as core.Map<core.String, core.dynamic>);
      checkDbServer(od);
    });
  });
  ...
  unittest.group('obj-schema-GiVersion', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od =
          api.GiVersion.fromJson(oJson as core.Map<core.String, core.dynamic>);
      checkGiVersion(od);
    });
  });
  ...
  unittest.group('resource-ProjectsLocationsAutonomousDatabaseBackupsResource',
      () {
    unittest.test('method--list', () async {
      final mock = HttpServerMock();
      final res = api.OracleDatabaseApi(mock)
          .projects
          .locations
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        final resp =
            convert.json.encode(buildListAutonomousDatabaseBackupsResponse());
        return async.Future.value(stringResponse(200, h, resp));
      }), true);
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        final resp = convert.json
            .encode(buildListAutonomousDatabaseCharacterSetsResponse());
        return async.Future.value(stringResponse(200, h, resp));
      }), true);
      final response = await res.list(arg_parent,
          filter: arg_filter,
  ...
  unittest.group('resource-ProjectsLocationsAutonomousDatabasesResource', () {
    ...
    unittest.test('method--generateWallet', () async {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        final resp = convert.json
            .encode(buildGenerateAutonomousDatabaseWalletResponse());
        return async.Future.value(stringResponse(200, h, resp));
      }), true);
      final response =
          await res.generateWallet(arg_request, arg_name, $fields: arg_$fields);
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        final resp =
            convert.json.encode(buildListAutonomousDatabasesResponse());
        return async.Future.value(stringResponse(200, h, resp));
      }), true);
      final response = await res.list(arg_parent,
          filter: arg_filter,
  ...
  unittest.group('resource-ProjectsLocationsAutonomousDbVersionsResource', () {
    unittest.test('method--list', () async {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        final resp =
            convert.json.encode(buildListAutonomousDbVersionsResponse());
        return async.Future.value(stringResponse(200, h, resp));
      }), true);
      final response = await res.list(arg_parent,
          pageSize: arg_pageSize,
  ...
  unittest.group(
      'resource-ProjectsLocationsCloudExadataInfrastructuresResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.OracleDatabaseApi(mock)
          .projects
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        final resp =
            convert.json.encode(buildListCloudExadataInfrastructuresResponse());
        return async.Future.value(stringResponse(200, h, resp));
      }), true);
      final response = await res.list(arg_parent,
          pageSize: arg_pageSize,
