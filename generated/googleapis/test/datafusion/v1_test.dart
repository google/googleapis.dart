...
core.List<api.AuditLogConfig> buildUnnamed3676() => [
      buildAuditLogConfig(),
      buildAuditLogConfig(),
    ];

void checkUnnamed3676(core.List<api.AuditLogConfig> o) {
...
api.AuditConfig buildAuditConfig() {
  ...
  if (buildCounterAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed3676();
    o.service = 'foo';
  }
  buildCounterAuditConfig--;
  return o;
...
void checkAuditConfig(api.AuditConfig o) {
  buildCounterAuditConfig++;
  if (buildCounterAuditConfig < 3) {
    checkUnnamed3676(o.auditLogConfigs!);
    unittest.expect(
      o.service!,
      unittest.equals('foo'),
    );
...
api.AuditLogConfig buildAuditLogConfig() {
  ...
  if (buildCounterAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed3677();
    o.logType = 'foo';
  }
  buildCounterAuditLogConfig--;
  return o;
...
void checkAuditLogConfig(api.AuditLogConfig o) {
  buildCounterAuditLogConfig++;
  if (buildCounterAuditLogConfig < 3) {
    checkUnnamed3677(o.exemptedMembers!);
    unittest.expect(
      o.logType!,
      unittest.equals('foo'),
    );
...
core.List<api.Accelerator> buildUnnamed3679() => [
      buildAccelerator(),
      buildAccelerator(),
    ];

void checkUnnamed3679(core.List<api.Accelerator> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAccelerator(o[0]);
  checkAccelerator(o[1]);
}

core.List<api.Version> buildUnnamed3680() => [
      buildVersion(),
      buildVersion(),
    ];

void checkUnnamed3680(core.List<api.Version> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVersion(o[0]);
  checkVersion(o[1]);
}

core.Map<core.String, core.String> buildUnnamed3681() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed3681(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.Map<core.String, core.String> buildUnnamed3682() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed3682(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.Instance buildInstance() {
  ...
  if (buildCounterInstance < 3) {
    o.accelerators = buildUnnamed3679();
    o.apiEndpoint = 'foo';
    o.availableVersion = buildUnnamed3680();
    o.createTime = 'foo';
...
void checkInstance(api.Instance o) {
  buildCounterInstance++;
  if (buildCounterInstance < 3) {
    checkUnnamed3679(o.accelerators!);
    unittest.expect(
      o.apiEndpoint!,
      unittest.equals('foo'),
    );
    checkUnnamed3680(o.availableVersion!);
    unittest.expect(
      o.createTime!,
      unittest.equals('foo'),
    );
...
core.List<api.Version> buildUnnamed3683() => [
      buildVersion(),
      buildVersion(),
    ];

void checkUnnamed3683(core.List<api.Version> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVersion(o[0]);
  checkVersion(o[1]);
}
...
api.ListAvailableVersionsResponse buildListAvailableVersionsResponse() {
  ...
  if (buildCounterListAvailableVersionsResponse < 3) {
    o.availableVersions = buildUnnamed3683();
    o.nextPageToken = 'foo';
  }
  buildCounterListAvailableVersionsResponse--;
  return o;
...
void checkListAvailableVersionsResponse(api.ListAvailableVersionsResponse o) {
  buildCounterListAvailableVersionsResponse++;
  if (buildCounterListAvailableVersionsResponse < 3) {
    checkUnnamed3683(o.availableVersions!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Instance> buildUnnamed3684() => [
      buildInstance(),
      buildInstance(),
    ];

void checkUnnamed3684(core.List<api.Instance> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInstance(o[0]);
  checkInstance(o[1]);
}
...
api.ListInstancesResponse buildListInstancesResponse() {
  ...
  if (buildCounterListInstancesResponse < 3) {
    o.instances = buildUnnamed3684();
    o.nextPageToken = 'foo';
    o.unreachable = buildUnnamed3685();
  }
  buildCounterListInstancesResponse--;
  return o;
}
...
void checkListInstancesResponse(api.ListInstancesResponse o) {
  buildCounterListInstancesResponse++;
  if (buildCounterListInstancesResponse < 3) {
    checkUnnamed3684(o.instances!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
    checkUnnamed3685(o.unreachable!);
  }
  buildCounterListInstancesResponse--;
}

core.List<api.Location> buildUnnamed3686() => [
      buildLocation(),
      buildLocation(),
    ];

void checkUnnamed3686(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
core.List<api.Operation> buildUnnamed3687() => [
      buildOperation(),
      buildOperation(),
    ];

void checkUnnamed3687(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
core.Map<core.String, core.String> buildUnnamed3688() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed3688(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.Map<core.String, core.String> buildUnnamed3692() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed3692(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.OperationMetadata buildOperationMetadata() {
  ...
  if (buildCounterOperationMetadata < 3) {
    o.additionalStatus = buildUnnamed3692();
    o.apiVersion = 'foo';
    o.createTime = 'foo';
    o.endTime = 'foo';
...
void checkOperationMetadata(api.OperationMetadata o) {
  buildCounterOperationMetadata++;
  if (buildCounterOperationMetadata < 3) {
    checkUnnamed3692(o.additionalStatus!);
    unittest.expect(
      o.apiVersion!,
      unittest.equals('foo'),
    );
...
core.List<api.AuditConfig> buildUnnamed3693() => [
      buildAuditConfig(),
      buildAuditConfig(),
    ];

void checkUnnamed3693(core.List<api.AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAuditConfig(o[0]);
  checkAuditConfig(o[1]);
}

core.List<api.Binding> buildUnnamed3694() => [
      buildBinding(),
      buildBinding(),
    ];

void checkUnnamed3694(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
api.Policy buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.auditConfigs = buildUnnamed3693();
    o.bindings = buildUnnamed3694();
    o.etag = 'foo';
    o.version = 42;
  }
  buildCounterPolicy--;
...
void checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed3693(o.auditConfigs!);
    checkUnnamed3694(o.bindings!);
    unittest.expect(
      o.etag!,
      unittest.equals('foo'),
    );
...
api.Version buildVersion() {
  ...
  if (buildCounterVersion < 3) {
    o.availableFeatures = buildUnnamed3699();
...
void checkVersion(api.Version o) {
  buildCounterVersion++;
  if (buildCounterVersion < 3) {
    checkUnnamed3699(o.availableFeatures!);
