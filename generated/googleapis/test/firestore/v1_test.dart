...
core.int buildCounterExecutePipelineRequest = 0;
api.ExecutePipelineRequest buildExecutePipelineRequest() {
  final o = api.ExecutePipelineRequest();
  buildCounterExecutePipelineRequest++;
  if (buildCounterExecutePipelineRequest < 3) {
    o.autoCommitTransaction = true;
    o.newTransaction = buildTransactionOptions();
    o.readTime = 'foo';
    o.requestOptions = buildRequestOptions();
    o.structuredPipeline = buildStructuredPipeline();
    o.transaction = 'foo';
  }
  buildCounterExecutePipelineRequest--;
  return o;
...
void checkExecutePipelineRequest(api.ExecutePipelineRequest o) {
  buildCounterExecutePipelineRequest++;
  if (buildCounterExecutePipelineRequest < 3) {
    unittest.expect(o.autoCommitTransaction!, unittest.isTrue);
    checkTransactionOptions(o.newTransaction!);
    unittest.expect(o.readTime!, unittest.equals('foo'));
    checkRequestOptions(o.requestOptions!);
    checkStructuredPipeline(o.structuredPipeline!);
    unittest.expect(o.transaction!, unittest.equals('foo'));
  }
  buildCounterExecutePipelineRequest--;
}

core.List<api.Document> buildUnnamed14() => [buildDocument(), buildDocument()];

void checkUnnamed14(core.List<api.Document> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDocument(o[0]);
  checkDocument(o[1]);
}

core.int buildCounterExecutePipelineResponse = 0;
api.ExecutePipelineResponse buildExecutePipelineResponse() {
  final o = api.ExecutePipelineResponse();
  buildCounterExecutePipelineResponse++;
  if (buildCounterExecutePipelineResponse < 3) {
    o.executionTime = 'foo';
    o.explainStats = buildExplainStats();
    o.results = buildUnnamed14();
    o.transaction = 'foo';
  }
  buildCounterExecutePipelineResponse--;
  return o;
...
void checkExecutePipelineResponse(api.ExecutePipelineResponse o) {
  buildCounterExecutePipelineResponse++;
  if (buildCounterExecutePipelineResponse < 3) {
    unittest.expect(o.executionTime!, unittest.equals('foo'));
    checkExplainStats(o.explainStats!);
    checkUnnamed14(o.results!);
    unittest.expect(o.transaction!, unittest.equals('foo'));
  }
  buildCounterExecutePipelineResponse--;
}
...
core.int buildCounterExplainStats = 0;
api.ExplainStats buildExplainStats() {
  final o = api.ExplainStats();
  buildCounterExplainStats++;
  if (buildCounterExplainStats < 3) {
...
void checkExplainStats(api.ExplainStats o) {
  buildCounterExplainStats++;
  if (buildCounterExplainStats < 3) {
...
core.List<api.Value> buildUnnamed17() => [buildValue(), buildValue()];

void checkUnnamed17(core.List<api.Value> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValue(o[0]);
  checkValue(o[1]);
}

core.Map<core.String, api.Value> buildUnnamed18() => {
  'x': buildValue(),
  'y': buildValue(),
};

void checkUnnamed18(core.Map<core.String, api.Value> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValue(o['x']!);
  checkValue(o['y']!);
}
...
void checkGoogleFirestoreAdminV1Backup(api.GoogleFirestoreAdminV1Backup o) {
  ...
  if (buildCounterGoogleFirestoreAdminV1Backup < 3) {
    ...
    unittest.expect(o.databaseUid!, unittest.equals('foo'));
...
core.int buildCounterGoogleFirestoreAdminV1BackupSource = 0;
api.GoogleFirestoreAdminV1BackupSource
buildGoogleFirestoreAdminV1BackupSource() {
  final o = api.GoogleFirestoreAdminV1BackupSource();
  buildCounterGoogleFirestoreAdminV1BackupSource++;
  if (buildCounterGoogleFirestoreAdminV1BackupSource < 3) {
    o.backup = 'foo';
  }
  buildCounterGoogleFirestoreAdminV1BackupSource--;
  return o;
...
void checkGoogleFirestoreAdminV1BackupSource(
  api.GoogleFirestoreAdminV1BackupSource o,
) {
  buildCounterGoogleFirestoreAdminV1BackupSource++;
  if (buildCounterGoogleFirestoreAdminV1BackupSource < 3) {
...
core.int buildCounterGoogleFirestoreAdminV1BulkDeleteDocumentsRequest = 0;
api.GoogleFirestoreAdminV1BulkDeleteDocumentsRequest
buildGoogleFirestoreAdminV1BulkDeleteDocumentsRequest() {
  final o = api.GoogleFirestoreAdminV1BulkDeleteDocumentsRequest();
  buildCounterGoogleFirestoreAdminV1BulkDeleteDocumentsRequest++;
  if (buildCounterGoogleFirestoreAdminV1BulkDeleteDocumentsRequest < 3) {
    o.collectionIds = buildUnnamed19();
    o.namespaceIds = buildUnnamed20();
  }
  buildCounterGoogleFirestoreAdminV1BulkDeleteDocumentsRequest--;
  return o;
}

void checkGoogleFirestoreAdminV1BulkDeleteDocumentsRequest(
  api.GoogleFirestoreAdminV1BulkDeleteDocumentsRequest o,
) {
  buildCounterGoogleFirestoreAdminV1BulkDeleteDocumentsRequest++;
  if (buildCounterGoogleFirestoreAdminV1BulkDeleteDocumentsRequest < 3) {
    checkUnnamed19(o.collectionIds!);
    checkUnnamed20(o.namespaceIds!);
  }
  buildCounterGoogleFirestoreAdminV1BulkDeleteDocumentsRequest--;
}

core.int buildCounterGoogleFirestoreAdminV1ChangeStream = 0;
api.GoogleFirestoreAdminV1ChangeStream
buildGoogleFirestoreAdminV1ChangeStream() {
  final o = api.GoogleFirestoreAdminV1ChangeStream();
  buildCounterGoogleFirestoreAdminV1ChangeStream++;
  if (buildCounterGoogleFirestoreAdminV1ChangeStream < 3) {
    o.collectionGroupScope = buildGoogleFirestoreAdminV1CollectionGroupScope();
    o.createTime = 'foo';
    o.databaseScope = buildGoogleFirestoreAdminV1DatabaseScope();
    o.etag = 'foo';
    o.name = 'foo';
...
void checkGoogleFirestoreAdminV1ChangeStream(
  api.GoogleFirestoreAdminV1ChangeStream o,
) {
  buildCounterGoogleFirestoreAdminV1ChangeStream++;
  if (buildCounterGoogleFirestoreAdminV1ChangeStream < 3) {
    checkGoogleFirestoreAdminV1CollectionGroupScope(o.collectionGroupScope!);
    unittest.expect(o.createTime!, unittest.equals('foo'));
    checkGoogleFirestoreAdminV1DatabaseScope(o.databaseScope!);
...
core.int buildCounterGoogleFirestoreAdminV1CloneDatabaseRequest = 0;
api.GoogleFirestoreAdminV1CloneDatabaseRequest
buildGoogleFirestoreAdminV1CloneDatabaseRequest() {
  final o = api.GoogleFirestoreAdminV1CloneDatabaseRequest();
  buildCounterGoogleFirestoreAdminV1CloneDatabaseRequest++;
  if (buildCounterGoogleFirestoreAdminV1CloneDatabaseRequest < 3) {
    o.databaseId = 'foo';
    o.encryptionConfig = buildGoogleFirestoreAdminV1EncryptionConfig();
    o.pitrSnapshot = buildGoogleFirestoreAdminV1PitrSnapshot();
...
void checkGoogleFirestoreAdminV1CloneDatabaseRequest(
  api.GoogleFirestoreAdminV1CloneDatabaseRequest o,
) {
  buildCounterGoogleFirestoreAdminV1CloneDatabaseRequest++;
  if (buildCounterGoogleFirestoreAdminV1CloneDatabaseRequest < 3) {
    unittest.expect(o.databaseId!, unittest.equals('foo'));
    checkGoogleFirestoreAdminV1EncryptionConfig(o.encryptionConfig!);
    checkGoogleFirestoreAdminV1PitrSnapshot(o.pitrSnapshot!);
...
api.GoogleFirestoreAdminV1CmekConfig buildGoogleFirestoreAdminV1CmekConfig() {
  ...
  if (buildCounterGoogleFirestoreAdminV1CmekConfig < 3) {
    o.activeKeyVersion = buildUnnamed22();
    o.kmsKeyName = 'foo';
  }
  buildCounterGoogleFirestoreAdminV1CmekConfig--;
  return o;
...
void checkGoogleFirestoreAdminV1CmekConfig(
  ...
  buildCounterGoogleFirestoreAdminV1CmekConfig++;
  if (buildCounterGoogleFirestoreAdminV1CmekConfig < 3) {
    checkUnnamed22(o.activeKeyVersion!);
    unittest.expect(o.kmsKeyName!, unittest.equals('foo'));
  }
  buildCounterGoogleFirestoreAdminV1CmekConfig--;
}

core.int buildCounterGoogleFirestoreAdminV1CollectionGroupScope = 0;
api.GoogleFirestoreAdminV1CollectionGroupScope
buildGoogleFirestoreAdminV1CollectionGroupScope() {
  final o = api.GoogleFirestoreAdminV1CollectionGroupScope();
  buildCounterGoogleFirestoreAdminV1CollectionGroupScope++;
  if (buildCounterGoogleFirestoreAdminV1CollectionGroupScope < 3) {
    o.collectionGroupId = 'foo';
  }
  buildCounterGoogleFirestoreAdminV1CollectionGroupScope--;
  return o;
}

void checkGoogleFirestoreAdminV1CollectionGroupScope(
  api.GoogleFirestoreAdminV1CollectionGroupScope o,
) {
  buildCounterGoogleFirestoreAdminV1CollectionGroupScope++;
  if (buildCounterGoogleFirestoreAdminV1CollectionGroupScope < 3) {
    unittest.expect(o.collectionGroupId!, unittest.equals('foo'));
  }
  buildCounterGoogleFirestoreAdminV1CollectionGroupScope--;
}

core.int buildCounterGoogleFirestoreAdminV1CustomerManagedEncryptionOptions = 0;
api.GoogleFirestoreAdminV1CustomerManagedEncryptionOptions
buildGoogleFirestoreAdminV1CustomerManagedEncryptionOptions() {
  final o = api.GoogleFirestoreAdminV1CustomerManagedEncryptionOptions();
  buildCounterGoogleFirestoreAdminV1CustomerManagedEncryptionOptions++;
  if (buildCounterGoogleFirestoreAdminV1CustomerManagedEncryptionOptions < 3) {
    o.kmsKeyName = 'foo';
  }
  buildCounterGoogleFirestoreAdminV1CustomerManagedEncryptionOptions--;
  return o;
...
void checkGoogleFirestoreAdminV1CustomerManagedEncryptionOptions(
  api.GoogleFirestoreAdminV1CustomerManagedEncryptionOptions o,
) {
  buildCounterGoogleFirestoreAdminV1CustomerManagedEncryptionOptions++;
  if (buildCounterGoogleFirestoreAdminV1CustomerManagedEncryptionOptions < 3) {
    unittest.expect(o.kmsKeyName!, unittest.equals('foo'));
...
api.GoogleFirestoreAdminV1Database buildGoogleFirestoreAdminV1Database() {
  ...
  if (buildCounterGoogleFirestoreAdminV1Database < 3) {
    ...
    o.etag = 'foo';
    o.firestoreDataAccessMode = 'foo';
    o.freeTier = true;
    o.keyPrefix = 'foo';
    o.locationId = 'foo';
    o.mongodbCompatibleDataAccessMode = 'foo';
    o.name = 'foo';
    o.pointInTimeRecoveryEnablement = 'foo';
    o.previousId = 'foo';
    o.realtimeUpdatesMode = 'foo';
    o.sourceInfo = buildGoogleFirestoreAdminV1SourceInfo();
...
void checkGoogleFirestoreAdminV1Database(api.GoogleFirestoreAdminV1Database o) {
  buildCounterGoogleFirestoreAdminV1Database++;
  if (buildCounterGoogleFirestoreAdminV1Database < 3) {
    unittest.expect(o.appEngineIntegrationMode!, unittest.equals('foo'));
    checkGoogleFirestoreAdminV1CmekConfig(o.cmekConfig!);
    unittest.expect(o.concurrencyMode!, unittest.equals('foo'));
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.databaseEdition!, unittest.equals('foo'));
    unittest.expect(o.deleteProtectionState!, unittest.equals('foo'));
    unittest.expect(o.deleteTime!, unittest.equals('foo'));
    unittest.expect(o.earliestVersionTime!, unittest.equals('foo'));
    unittest.expect(o.etag!, unittest.equals('foo'));
    unittest.expect(o.firestoreDataAccessMode!, unittest.equals('foo'));
    unittest.expect(o.freeTier!, unittest.isTrue);
    unittest.expect(o.keyPrefix!, unittest.equals('foo'));
    unittest.expect(o.locationId!, unittest.equals('foo'));
    unittest.expect(o.mongodbCompatibleDataAccessMode!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.pointInTimeRecoveryEnablement!, unittest.equals('foo'));
    unittest.expect(o.previousId!, unittest.equals('foo'));
    unittest.expect(o.realtimeUpdatesMode!, unittest.equals('foo'));
    checkGoogleFirestoreAdminV1SourceInfo(o.sourceInfo!);
...
core.int buildCounterGoogleFirestoreAdminV1DatabaseScope = 0;
api.GoogleFirestoreAdminV1DatabaseScope
buildGoogleFirestoreAdminV1DatabaseScope() {
  final o = api.GoogleFirestoreAdminV1DatabaseScope();
  buildCounterGoogleFirestoreAdminV1DatabaseScope++;
  if (buildCounterGoogleFirestoreAdminV1DatabaseScope < 3) {}
  buildCounterGoogleFirestoreAdminV1DatabaseScope--;
  return o;
}

void checkGoogleFirestoreAdminV1DatabaseScope(
  api.GoogleFirestoreAdminV1DatabaseScope o,
) {
  buildCounterGoogleFirestoreAdminV1DatabaseScope++;
  if (buildCounterGoogleFirestoreAdminV1DatabaseScope < 3) {}
  buildCounterGoogleFirestoreAdminV1DatabaseScope--;
...
core.int buildCounterGoogleFirestoreAdminV1DisableUserCredsRequest = 0;
api.GoogleFirestoreAdminV1DisableUserCredsRequest
buildGoogleFirestoreAdminV1DisableUserCredsRequest() {
  final o = api.GoogleFirestoreAdminV1DisableUserCredsRequest();
  buildCounterGoogleFirestoreAdminV1DisableUserCredsRequest++;
  if (buildCounterGoogleFirestoreAdminV1DisableUserCredsRequest < 3) {}
  buildCounterGoogleFirestoreAdminV1DisableUserCredsRequest--;
  return o;
}

void checkGoogleFirestoreAdminV1DisableUserCredsRequest(
  api.GoogleFirestoreAdminV1DisableUserCredsRequest o,
) {
  buildCounterGoogleFirestoreAdminV1DisableUserCredsRequest++;
  if (buildCounterGoogleFirestoreAdminV1DisableUserCredsRequest < 3) {}
  buildCounterGoogleFirestoreAdminV1DisableUserCredsRequest--;
...
core.int buildCounterGoogleFirestoreAdminV1EnableUserCredsRequest = 0;
api.GoogleFirestoreAdminV1EnableUserCredsRequest
buildGoogleFirestoreAdminV1EnableUserCredsRequest() {
  final o = api.GoogleFirestoreAdminV1EnableUserCredsRequest();
  buildCounterGoogleFirestoreAdminV1EnableUserCredsRequest++;
  if (buildCounterGoogleFirestoreAdminV1EnableUserCredsRequest < 3) {}
  buildCounterGoogleFirestoreAdminV1EnableUserCredsRequest--;
  return o;
}

void checkGoogleFirestoreAdminV1EnableUserCredsRequest(
  api.GoogleFirestoreAdminV1EnableUserCredsRequest o,
) {
  buildCounterGoogleFirestoreAdminV1EnableUserCredsRequest++;
  if (buildCounterGoogleFirestoreAdminV1EnableUserCredsRequest < 3) {}
  buildCounterGoogleFirestoreAdminV1EnableUserCredsRequest--;
...
core.int buildCounterGoogleFirestoreAdminV1EncryptionConfig = 0;
api.GoogleFirestoreAdminV1EncryptionConfig
buildGoogleFirestoreAdminV1EncryptionConfig() {
  final o = api.GoogleFirestoreAdminV1EncryptionConfig();
  buildCounterGoogleFirestoreAdminV1EncryptionConfig++;
  if (buildCounterGoogleFirestoreAdminV1EncryptionConfig < 3) {
    o.customerManagedEncryption =
        buildGoogleFirestoreAdminV1CustomerManagedEncryptionOptions();
    o.googleDefaultEncryption =
        buildGoogleFirestoreAdminV1GoogleDefaultEncryptionOptions();
    o.useSourceEncryption =
        buildGoogleFirestoreAdminV1SourceEncryptionOptions();
  }
  buildCounterGoogleFirestoreAdminV1EncryptionConfig--;
  return o;
}

void checkGoogleFirestoreAdminV1EncryptionConfig(
  api.GoogleFirestoreAdminV1EncryptionConfig o,
) {
  buildCounterGoogleFirestoreAdminV1EncryptionConfig++;
  if (buildCounterGoogleFirestoreAdminV1EncryptionConfig < 3) {
    checkGoogleFirestoreAdminV1CustomerManagedEncryptionOptions(
      o.customerManagedEncryption!,
    );
    checkGoogleFirestoreAdminV1GoogleDefaultEncryptionOptions(
      o.googleDefaultEncryption!,
    );
    checkGoogleFirestoreAdminV1SourceEncryptionOptions(o.useSourceEncryption!);
  }
  buildCounterGoogleFirestoreAdminV1EncryptionConfig--;
}
...
core.int buildCounterGoogleFirestoreAdminV1GoogleDefaultEncryptionOptions = 0;
api.GoogleFirestoreAdminV1GoogleDefaultEncryptionOptions
buildGoogleFirestoreAdminV1GoogleDefaultEncryptionOptions() {
  final o = api.GoogleFirestoreAdminV1GoogleDefaultEncryptionOptions();
  buildCounterGoogleFirestoreAdminV1GoogleDefaultEncryptionOptions++;
  if (buildCounterGoogleFirestoreAdminV1GoogleDefaultEncryptionOptions < 3) {}
  buildCounterGoogleFirestoreAdminV1GoogleDefaultEncryptionOptions--;
  return o;
}

void checkGoogleFirestoreAdminV1GoogleDefaultEncryptionOptions(
  api.GoogleFirestoreAdminV1GoogleDefaultEncryptionOptions o,
) {
  buildCounterGoogleFirestoreAdminV1GoogleDefaultEncryptionOptions++;
  if (buildCounterGoogleFirestoreAdminV1GoogleDefaultEncryptionOptions < 3) {}
  buildCounterGoogleFirestoreAdminV1GoogleDefaultEncryptionOptions--;
...
void checkGoogleFirestoreAdminV1ImportDocumentsRequest(
  ...
  if (buildCounterGoogleFirestoreAdminV1ImportDocumentsRequest < 3) {
    ...
    checkUnnamed27(o.namespaceIds!);
  }
  buildCounterGoogleFirestoreAdminV1ImportDocumentsRequest--;
}

core.List<api.GoogleFirestoreAdminV1IndexField> buildUnnamed28() => [
  buildGoogleFirestoreAdminV1IndexField(),
  buildGoogleFirestoreAdminV1IndexField(),
];

void checkUnnamed28(core.List<api.GoogleFirestoreAdminV1IndexField> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleFirestoreAdminV1Index buildGoogleFirestoreAdminV1Index() {
  ...
  if (buildCounterGoogleFirestoreAdminV1Index < 3) {
    ...
    o.name = 'foo';
    o.queryScope = 'foo';
    o.searchIndexOptions = buildGoogleFirestoreAdminV1SearchIndexOptions();
    o.shardCount = 42;
    o.state = 'foo';
    o.unique = true;
  }
...
void checkGoogleFirestoreAdminV1Index(api.GoogleFirestoreAdminV1Index o) {
  buildCounterGoogleFirestoreAdminV1Index++;
  if (buildCounterGoogleFirestoreAdminV1Index < 3) {
    unittest.expect(o.apiScope!, unittest.equals('foo'));
    unittest.expect(o.density!, unittest.equals('foo'));
    checkUnnamed28(o.fields!);
    unittest.expect(o.multikey!, unittest.isTrue);
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.queryScope!, unittest.equals('foo'));
    checkGoogleFirestoreAdminV1SearchIndexOptions(o.searchIndexOptions!);
...
core.List<api.GoogleFirestoreAdminV1Index> buildUnnamed29() => [
  buildGoogleFirestoreAdminV1Index(),
  buildGoogleFirestoreAdminV1Index(),
];

void checkUnnamed29(core.List<api.GoogleFirestoreAdminV1Index> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleFirestoreAdminV1IndexField buildGoogleFirestoreAdminV1IndexField() {
  ...
  if (buildCounterGoogleFirestoreAdminV1IndexField < 3) {
    ...
    o.fieldPath = 'foo';
    o.order = 'foo';
    o.searchConfig = buildGoogleFirestoreAdminV1SearchConfig();
...
void checkGoogleFirestoreAdminV1IndexField(
  ...
  if (buildCounterGoogleFirestoreAdminV1IndexField < 3) {
    ...
    checkGoogleFirestoreAdminV1SearchConfig(o.searchConfig!);
    checkGoogleFirestoreAdminV1VectorConfig(o.vectorConfig!);
  }
  buildCounterGoogleFirestoreAdminV1IndexField--;
}

core.List<api.GoogleFirestoreAdminV1BackupSchedule> buildUnnamed30() => [
  buildGoogleFirestoreAdminV1BackupSchedule(),
  buildGoogleFirestoreAdminV1BackupSchedule(),
];

void checkUnnamed30(core.List<api.GoogleFirestoreAdminV1BackupSchedule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildGoogleFirestoreAdminV1ListBackupSchedulesResponse() {
  ...
  if (buildCounterGoogleFirestoreAdminV1ListBackupSchedulesResponse < 3) {
    o.backupSchedules = buildUnnamed30();
  }
  buildCounterGoogleFirestoreAdminV1ListBackupSchedulesResponse--;
  return o;
}
...
void checkGoogleFirestoreAdminV1ListBackupSchedulesResponse(
  ...
  buildCounterGoogleFirestoreAdminV1ListBackupSchedulesResponse++;
  if (buildCounterGoogleFirestoreAdminV1ListBackupSchedulesResponse < 3) {
    checkUnnamed30(o.backupSchedules!);
  }
  buildCounterGoogleFirestoreAdminV1ListBackupSchedulesResponse--;
}

core.List<api.GoogleFirestoreAdminV1Backup> buildUnnamed31() => [
  buildGoogleFirestoreAdminV1Backup(),
  buildGoogleFirestoreAdminV1Backup(),
];

void checkUnnamed31(core.List<api.GoogleFirestoreAdminV1Backup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkGoogleFirestoreAdminV1ListBackupsResponse(
  ...
  buildCounterGoogleFirestoreAdminV1ListBackupsResponse++;
  if (buildCounterGoogleFirestoreAdminV1ListBackupsResponse < 3) {
    checkUnnamed31(o.backups!);
    checkUnnamed32(o.unreachable!);
  }
  buildCounterGoogleFirestoreAdminV1ListBackupsResponse--;
}

core.List<api.GoogleFirestoreAdminV1ChangeStream> buildUnnamed33() => [
  buildGoogleFirestoreAdminV1ChangeStream(),
  buildGoogleFirestoreAdminV1ChangeStream(),
];

void checkUnnamed33(core.List<api.GoogleFirestoreAdminV1ChangeStream> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleFirestoreAdminV1ChangeStream(o[0]);
  checkGoogleFirestoreAdminV1ChangeStream(o[1]);
}

core.int buildCounterGoogleFirestoreAdminV1ListChangeStreamsResponse = 0;
api.GoogleFirestoreAdminV1ListChangeStreamsResponse
buildGoogleFirestoreAdminV1ListChangeStreamsResponse() {
  final o = api.GoogleFirestoreAdminV1ListChangeStreamsResponse();
  buildCounterGoogleFirestoreAdminV1ListChangeStreamsResponse++;
  if (buildCounterGoogleFirestoreAdminV1ListChangeStreamsResponse < 3) {
    o.changeStreams = buildUnnamed33();
  }
  buildCounterGoogleFirestoreAdminV1ListChangeStreamsResponse--;
  return o;
}

void checkGoogleFirestoreAdminV1ListChangeStreamsResponse(
  api.GoogleFirestoreAdminV1ListChangeStreamsResponse o,
) {
  buildCounterGoogleFirestoreAdminV1ListChangeStreamsResponse++;
  if (buildCounterGoogleFirestoreAdminV1ListChangeStreamsResponse < 3) {
    checkUnnamed33(o.changeStreams!);
  }
  buildCounterGoogleFirestoreAdminV1ListChangeStreamsResponse--;
}

core.List<api.GoogleFirestoreAdminV1Database> buildUnnamed34() => [
  buildGoogleFirestoreAdminV1Database(),
  buildGoogleFirestoreAdminV1Database(),
];

void checkUnnamed34(core.List<api.GoogleFirestoreAdminV1Database> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkGoogleFirestoreAdminV1ListDatabasesResponse(
  ...
  buildCounterGoogleFirestoreAdminV1ListDatabasesResponse++;
  if (buildCounterGoogleFirestoreAdminV1ListDatabasesResponse < 3) {
    checkUnnamed34(o.databases!);
    checkUnnamed35(o.unreachable!);
  }
  buildCounterGoogleFirestoreAdminV1ListDatabasesResponse--;
}

core.List<api.GoogleFirestoreAdminV1Field> buildUnnamed36() => [
  buildGoogleFirestoreAdminV1Field(),
  buildGoogleFirestoreAdminV1Field(),
];

void checkUnnamed36(core.List<api.GoogleFirestoreAdminV1Field> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleFirestoreAdminV1Index> buildUnnamed37() => [
  buildGoogleFirestoreAdminV1Index(),
  buildGoogleFirestoreAdminV1Index(),
];

void checkUnnamed37(core.List<api.GoogleFirestoreAdminV1Index> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleFirestoreAdminV1Index(o[0]);
  checkGoogleFirestoreAdminV1Index(o[1]);
}
...
void checkGoogleFirestoreAdminV1ListIndexesResponse(
  ...
  buildCounterGoogleFirestoreAdminV1ListIndexesResponse++;
  if (buildCounterGoogleFirestoreAdminV1ListIndexesResponse < 3) {
    checkUnnamed37(o.indexes!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterGoogleFirestoreAdminV1ListIndexesResponse--;
}

core.List<api.GoogleFirestoreAdminV1UserCreds> buildUnnamed38() => [
  buildGoogleFirestoreAdminV1UserCreds(),
  buildGoogleFirestoreAdminV1UserCreds(),
];

void checkUnnamed38(core.List<api.GoogleFirestoreAdminV1UserCreds> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleFirestoreAdminV1UserCreds(o[0]);
  checkGoogleFirestoreAdminV1UserCreds(o[1]);
}

core.int buildCounterGoogleFirestoreAdminV1ListUserCredsResponse = 0;
api.GoogleFirestoreAdminV1ListUserCredsResponse
buildGoogleFirestoreAdminV1ListUserCredsResponse() {
  final o = api.GoogleFirestoreAdminV1ListUserCredsResponse();
  buildCounterGoogleFirestoreAdminV1ListUserCredsResponse++;
  if (buildCounterGoogleFirestoreAdminV1ListUserCredsResponse < 3) {
    o.userCreds = buildUnnamed38();
  }
  buildCounterGoogleFirestoreAdminV1ListUserCredsResponse--;
  return o;
}

void checkGoogleFirestoreAdminV1ListUserCredsResponse(
  api.GoogleFirestoreAdminV1ListUserCredsResponse o,
) {
  buildCounterGoogleFirestoreAdminV1ListUserCredsResponse++;
  if (buildCounterGoogleFirestoreAdminV1ListUserCredsResponse < 3) {
    checkUnnamed38(o.userCreds!);
  }
  buildCounterGoogleFirestoreAdminV1ListUserCredsResponse--;
}

core.int buildCounterGoogleFirestoreAdminV1PitrSnapshot = 0;
api.GoogleFirestoreAdminV1PitrSnapshot
buildGoogleFirestoreAdminV1PitrSnapshot() {
  final o = api.GoogleFirestoreAdminV1PitrSnapshot();
  buildCounterGoogleFirestoreAdminV1PitrSnapshot++;
  if (buildCounterGoogleFirestoreAdminV1PitrSnapshot < 3) {
    o.database = 'foo';
    o.databaseUid = 'foo';
    o.snapshotTime = 'foo';
  }
...
void checkGoogleFirestoreAdminV1PitrSnapshot(
  api.GoogleFirestoreAdminV1PitrSnapshot o,
) {
  buildCounterGoogleFirestoreAdminV1PitrSnapshot++;
  if (buildCounterGoogleFirestoreAdminV1PitrSnapshot < 3) {
    unittest.expect(o.database!, unittest.equals('foo'));
...
core.int buildCounterGoogleFirestoreAdminV1ResetUserPasswordRequest = 0;
api.GoogleFirestoreAdminV1ResetUserPasswordRequest
buildGoogleFirestoreAdminV1ResetUserPasswordRequest() {
  final o = api.GoogleFirestoreAdminV1ResetUserPasswordRequest();
  buildCounterGoogleFirestoreAdminV1ResetUserPasswordRequest++;
  if (buildCounterGoogleFirestoreAdminV1ResetUserPasswordRequest < 3) {}
  buildCounterGoogleFirestoreAdminV1ResetUserPasswordRequest--;
  return o;
}

void checkGoogleFirestoreAdminV1ResetUserPasswordRequest(
  api.GoogleFirestoreAdminV1ResetUserPasswordRequest o,
) {
  buildCounterGoogleFirestoreAdminV1ResetUserPasswordRequest++;
  if (buildCounterGoogleFirestoreAdminV1ResetUserPasswordRequest < 3) {}
  buildCounterGoogleFirestoreAdminV1ResetUserPasswordRequest--;
...
core.int buildCounterGoogleFirestoreAdminV1ResourceIdentity = 0;
api.GoogleFirestoreAdminV1ResourceIdentity
buildGoogleFirestoreAdminV1ResourceIdentity() {
  final o = api.GoogleFirestoreAdminV1ResourceIdentity();
  buildCounterGoogleFirestoreAdminV1ResourceIdentity++;
  if (buildCounterGoogleFirestoreAdminV1ResourceIdentity < 3) {
    o.principal = 'foo';
  }
  buildCounterGoogleFirestoreAdminV1ResourceIdentity--;
  return o;
...
void checkGoogleFirestoreAdminV1ResourceIdentity(
  api.GoogleFirestoreAdminV1ResourceIdentity o,
) {
  buildCounterGoogleFirestoreAdminV1ResourceIdentity++;
  if (buildCounterGoogleFirestoreAdminV1ResourceIdentity < 3) {
...
core.int buildCounterGoogleFirestoreAdminV1SearchConfig = 0;
api.GoogleFirestoreAdminV1SearchConfig
buildGoogleFirestoreAdminV1SearchConfig() {
  final o = api.GoogleFirestoreAdminV1SearchConfig();
  buildCounterGoogleFirestoreAdminV1SearchConfig++;
  if (buildCounterGoogleFirestoreAdminV1SearchConfig < 3) {
    o.geoSpec = buildGoogleFirestoreAdminV1SearchGeoSpec();
    o.textSpec = buildGoogleFirestoreAdminV1SearchTextSpec();
  }
  buildCounterGoogleFirestoreAdminV1SearchConfig--;
  return o;
}

void checkGoogleFirestoreAdminV1SearchConfig(
  api.GoogleFirestoreAdminV1SearchConfig o,
) {
  buildCounterGoogleFirestoreAdminV1SearchConfig++;
  if (buildCounterGoogleFirestoreAdminV1SearchConfig < 3) {
    checkGoogleFirestoreAdminV1SearchGeoSpec(o.geoSpec!);
    checkGoogleFirestoreAdminV1SearchTextSpec(o.textSpec!);
  }
  buildCounterGoogleFirestoreAdminV1SearchConfig--;
}

core.int buildCounterGoogleFirestoreAdminV1SearchGeoSpec = 0;
api.GoogleFirestoreAdminV1SearchGeoSpec
buildGoogleFirestoreAdminV1SearchGeoSpec() {
  final o = api.GoogleFirestoreAdminV1SearchGeoSpec();
  buildCounterGoogleFirestoreAdminV1SearchGeoSpec++;
  if (buildCounterGoogleFirestoreAdminV1SearchGeoSpec < 3) {
    o.geoJsonIndexingDisabled = true;
  }
  buildCounterGoogleFirestoreAdminV1SearchGeoSpec--;
  return o;
}

void checkGoogleFirestoreAdminV1SearchGeoSpec(
  api.GoogleFirestoreAdminV1SearchGeoSpec o,
) {
  buildCounterGoogleFirestoreAdminV1SearchGeoSpec++;
  if (buildCounterGoogleFirestoreAdminV1SearchGeoSpec < 3) {
    unittest.expect(o.geoJsonIndexingDisabled!, unittest.isTrue);
  }
  buildCounterGoogleFirestoreAdminV1SearchGeoSpec--;
}

core.int buildCounterGoogleFirestoreAdminV1SearchIndexOptions = 0;
api.GoogleFirestoreAdminV1SearchIndexOptions
buildGoogleFirestoreAdminV1SearchIndexOptions() {
  final o = api.GoogleFirestoreAdminV1SearchIndexOptions();
  buildCounterGoogleFirestoreAdminV1SearchIndexOptions++;
  if (buildCounterGoogleFirestoreAdminV1SearchIndexOptions < 3) {
    o.textLanguage = 'foo';
    o.textLanguageOverrideFieldPath = 'foo';
  }
  buildCounterGoogleFirestoreAdminV1SearchIndexOptions--;
  return o;
}

void checkGoogleFirestoreAdminV1SearchIndexOptions(
  api.GoogleFirestoreAdminV1SearchIndexOptions o,
) {
  buildCounterGoogleFirestoreAdminV1SearchIndexOptions++;
  if (buildCounterGoogleFirestoreAdminV1SearchIndexOptions < 3) {
    unittest.expect(o.textLanguage!, unittest.equals('foo'));
    unittest.expect(o.textLanguageOverrideFieldPath!, unittest.equals('foo'));
  }
  buildCounterGoogleFirestoreAdminV1SearchIndexOptions--;
}

core.int buildCounterGoogleFirestoreAdminV1SearchTextIndexSpec = 0;
api.GoogleFirestoreAdminV1SearchTextIndexSpec
buildGoogleFirestoreAdminV1SearchTextIndexSpec() {
  final o = api.GoogleFirestoreAdminV1SearchTextIndexSpec();
  buildCounterGoogleFirestoreAdminV1SearchTextIndexSpec++;
  if (buildCounterGoogleFirestoreAdminV1SearchTextIndexSpec < 3) {
    o.indexType = 'foo';
    o.matchType = 'foo';
  }
  buildCounterGoogleFirestoreAdminV1SearchTextIndexSpec--;
...
void checkGoogleFirestoreAdminV1SearchTextIndexSpec(
  api.GoogleFirestoreAdminV1SearchTextIndexSpec o,
) {
  buildCounterGoogleFirestoreAdminV1SearchTextIndexSpec++;
  if (buildCounterGoogleFirestoreAdminV1SearchTextIndexSpec < 3) {
    unittest.expect(o.indexType!, unittest.equals('foo'));
    unittest.expect(o.matchType!, unittest.equals('foo'));
  }
  buildCounterGoogleFirestoreAdminV1SearchTextIndexSpec--;
}

core.List<api.GoogleFirestoreAdminV1SearchTextIndexSpec> buildUnnamed40() => [
  buildGoogleFirestoreAdminV1SearchTextIndexSpec(),
  buildGoogleFirestoreAdminV1SearchTextIndexSpec(),
];

void checkUnnamed40(
  core.List<api.GoogleFirestoreAdminV1SearchTextIndexSpec> o,
) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleFirestoreAdminV1SearchTextIndexSpec(o[0]);
  checkGoogleFirestoreAdminV1SearchTextIndexSpec(o[1]);
}

core.int buildCounterGoogleFirestoreAdminV1SearchTextSpec = 0;
api.GoogleFirestoreAdminV1SearchTextSpec
buildGoogleFirestoreAdminV1SearchTextSpec() {
  final o = api.GoogleFirestoreAdminV1SearchTextSpec();
  buildCounterGoogleFirestoreAdminV1SearchTextSpec++;
  if (buildCounterGoogleFirestoreAdminV1SearchTextSpec < 3) {
    o.indexSpecs = buildUnnamed40();
  }
  buildCounterGoogleFirestoreAdminV1SearchTextSpec--;
  return o;
}

void checkGoogleFirestoreAdminV1SearchTextSpec(
  api.GoogleFirestoreAdminV1SearchTextSpec o,
) {
  buildCounterGoogleFirestoreAdminV1SearchTextSpec++;
  if (buildCounterGoogleFirestoreAdminV1SearchTextSpec < 3) {
    checkUnnamed40(o.indexSpecs!);
  }
  buildCounterGoogleFirestoreAdminV1SearchTextSpec--;
}

core.int buildCounterGoogleFirestoreAdminV1SourceEncryptionOptions = 0;
api.GoogleFirestoreAdminV1SourceEncryptionOptions
buildGoogleFirestoreAdminV1SourceEncryptionOptions() {
  final o = api.GoogleFirestoreAdminV1SourceEncryptionOptions();
  buildCounterGoogleFirestoreAdminV1SourceEncryptionOptions++;
  if (buildCounterGoogleFirestoreAdminV1SourceEncryptionOptions < 3) {}
  buildCounterGoogleFirestoreAdminV1SourceEncryptionOptions--;
  return o;
}

void checkGoogleFirestoreAdminV1SourceEncryptionOptions(
  api.GoogleFirestoreAdminV1SourceEncryptionOptions o,
) {
  buildCounterGoogleFirestoreAdminV1SourceEncryptionOptions++;
  if (buildCounterGoogleFirestoreAdminV1SourceEncryptionOptions < 3) {}
  buildCounterGoogleFirestoreAdminV1SourceEncryptionOptions--;
...
core.int buildCounterGoogleFirestoreAdminV1SourceInfo = 0;
api.GoogleFirestoreAdminV1SourceInfo buildGoogleFirestoreAdminV1SourceInfo() {
  final o = api.GoogleFirestoreAdminV1SourceInfo();
  buildCounterGoogleFirestoreAdminV1SourceInfo++;
  if (buildCounterGoogleFirestoreAdminV1SourceInfo < 3) {
    o.backup = buildGoogleFirestoreAdminV1BackupSource();
    o.operation = 'foo';
  }
  buildCounterGoogleFirestoreAdminV1SourceInfo--;
  return o;
...
void checkGoogleFirestoreAdminV1SourceInfo(
  api.GoogleFirestoreAdminV1SourceInfo o,
) {
  buildCounterGoogleFirestoreAdminV1SourceInfo++;
  if (buildCounterGoogleFirestoreAdminV1SourceInfo < 3) {
    checkGoogleFirestoreAdminV1BackupSource(o.backup!);
...
void checkGoogleFirestoreAdminV1Stats(api.GoogleFirestoreAdminV1Stats o) {
  buildCounterGoogleFirestoreAdminV1Stats++;
  if (buildCounterGoogleFirestoreAdminV1Stats < 3) {
    unittest.expect(o.documentCount!, unittest.equals('foo'));
    unittest.expect(o.indexCount!, unittest.equals('foo'));
...
void checkGoogleFirestoreAdminV1TtlConfig(
  ...
  buildCounterGoogleFirestoreAdminV1TtlConfig++;
  if (buildCounterGoogleFirestoreAdminV1TtlConfig < 3) {
    unittest.expect(o.expirationOffset!, unittest.equals('foo'));
    unittest.expect(o.state!, unittest.equals('foo'));
  }
  buildCounterGoogleFirestoreAdminV1TtlConfig--;
}

core.int buildCounterGoogleFirestoreAdminV1UserCreds = 0;
api.GoogleFirestoreAdminV1UserCreds buildGoogleFirestoreAdminV1UserCreds() {
  final o = api.GoogleFirestoreAdminV1UserCreds();
  buildCounterGoogleFirestoreAdminV1UserCreds++;
  if (buildCounterGoogleFirestoreAdminV1UserCreds < 3) {
    o.createTime = 'foo';
    o.name = 'foo';
    o.resourceIdentity = buildGoogleFirestoreAdminV1ResourceIdentity();
    o.securePassword = 'foo';
    o.state = 'foo';
    o.updateTime = 'foo';
  }
  buildCounterGoogleFirestoreAdminV1UserCreds--;
...
void checkGoogleFirestoreAdminV1UserCreds(
  api.GoogleFirestoreAdminV1UserCreds o,
) {
  buildCounterGoogleFirestoreAdminV1UserCreds++;
  if (buildCounterGoogleFirestoreAdminV1UserCreds < 3) {
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    checkGoogleFirestoreAdminV1ResourceIdentity(o.resourceIdentity!);
    unittest.expect(o.securePassword!, unittest.equals('foo'));
    unittest.expect(o.state!, unittest.equals('foo'));
    unittest.expect(o.updateTime!, unittest.equals('foo'));
  }
  buildCounterGoogleFirestoreAdminV1UserCreds--;
...
void checkGoogleFirestoreAdminV1VectorConfig(
  ...
  buildCounterGoogleFirestoreAdminV1VectorConfig++;
  if (buildCounterGoogleFirestoreAdminV1VectorConfig < 3) {
    unittest.expect(o.dimension!, unittest.equals(42));
...
core.List<api.GoogleLongrunningOperation> buildUnnamed41() => [
  buildGoogleLongrunningOperation(),
  buildGoogleLongrunningOperation(),
];

void checkUnnamed41(core.List<api.GoogleLongrunningOperation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListCollectionIdsResponse buildListCollectionIdsResponse() {
  ...
  if (buildCounterListCollectionIdsResponse < 3) {
    o.collectionIds = buildUnnamed45();
    o.nextPageToken = 'foo';
  }
  buildCounterListCollectionIdsResponse--;
  return o;
...
void checkListCollectionIdsResponse(api.ListCollectionIdsResponse o) {
  buildCounterListCollectionIdsResponse++;
  if (buildCounterListCollectionIdsResponse < 3) {
    checkUnnamed45(o.collectionIds!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListCollectionIdsResponse--;
}

core.List<api.Document> buildUnnamed46() => [buildDocument(), buildDocument()];

void checkUnnamed46(core.List<api.Document> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDocument(o[0]);
  checkDocument(o[1]);
}
...
void checkListDocumentsResponse(api.ListDocumentsResponse o) {
  buildCounterListDocumentsResponse++;
  if (buildCounterListDocumentsResponse < 3) {
    checkUnnamed46(o.documents!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListDocumentsResponse--;
}

core.List<api.Location> buildUnnamed47() => [buildLocation(), buildLocation()];
...
core.Map<core.String, api.Value> buildUnnamed50() => {
  'x': buildValue(),
  'y': buildValue(),
};

void checkUnnamed50(core.Map<core.String, api.Value> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValue(o['x']!);
  checkValue(o['y']!);
}
...
core.List<api.Cursor> buildUnnamed51() => [buildCursor(), buildCursor()];

void checkUnnamed51(core.List<api.Cursor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCursor(o[0]);
  checkCursor(o[1]);
}
...
void checkPartitionQueryResponse(api.PartitionQueryResponse o) {
  ...
  if (buildCounterPartitionQueryResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed51(o.partitions!);
  }
  buildCounterPartitionQueryResponse--;
}

core.List<api.Stage> buildUnnamed52() => [buildStage(), buildStage()];

void checkUnnamed52(core.List<api.Stage> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStage(o[0]);
  checkStage(o[1]);
}
...
core.List<api.FieldReference> buildUnnamed55() => [
  buildFieldReference(),
  buildFieldReference(),
];

void checkUnnamed55(core.List<api.FieldReference> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.RunQueryResponse buildRunQueryResponse() {
  return [buildRunQueryResponseElement(), buildRunQueryResponseElement()];
}
...
core.List<api.Value> buildUnnamed57() => [buildValue(), buildValue()];

void checkUnnamed57(core.List<api.Value> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValue(o[0]);
  checkValue(o[1]);
}

core.Map<core.String, api.Value> buildUnnamed58() => {
  'x': buildValue(),
  'y': buildValue(),
};

void checkUnnamed58(core.Map<core.String, api.Value> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValue(o['x']!);
  checkValue(o['y']!);
}
...
core.List<api.Aggregation> buildUnnamed61() => [
  buildAggregation(),
  buildAggregation(),
];

void checkUnnamed61(core.List<api.Aggregation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkStructuredAggregationQuery(api.StructuredAggregationQuery o) {
  buildCounterStructuredAggregationQuery++;
  if (buildCounterStructuredAggregationQuery < 3) {
    checkUnnamed61(o.aggregations!);
    checkStructuredQuery(o.structuredQuery!);
  }
  buildCounterStructuredAggregationQuery--;
}

core.Map<core.String, api.Value> buildUnnamed62() => {
  'x': buildValue(),
  'y': buildValue(),
};

void checkUnnamed62(core.Map<core.String, api.Value> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValue(o['x']!);
  checkValue(o['y']!);
}

core.int buildCounterStructuredPipeline = 0;
api.StructuredPipeline buildStructuredPipeline() {
  final o = api.StructuredPipeline();
  buildCounterStructuredPipeline++;
  if (buildCounterStructuredPipeline < 3) {
    o.options = buildUnnamed62();
...
void checkStructuredPipeline(api.StructuredPipeline o) {
  buildCounterStructuredPipeline++;
  if (buildCounterStructuredPipeline < 3) {
    checkUnnamed62(o.options!);
    checkPipeline(o.pipeline!);
  }
  buildCounterStructuredPipeline--;
}

core.List<api.CollectionSelector> buildUnnamed63() => [
  buildCollectionSelector(),
  buildCollectionSelector(),
];

void checkUnnamed63(core.List<api.CollectionSelector> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCollectionSelector(o[0]);
  checkCollectionSelector(o[1]);
}

core.List<api.Order> buildUnnamed64() => [buildOrder(), buildOrder()];

void checkUnnamed64(core.List<api.Order> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrder(o[0]);
  checkOrder(o[1]);
}
...
api.StructuredQuery buildStructuredQuery() {
  ...
  if (buildCounterStructuredQuery < 3) {
    ...
    o.from = buildUnnamed63();
    o.limit = 42;
    o.offset = 42;
    o.orderBy = buildUnnamed64();
...
void checkStructuredQuery(api.StructuredQuery o) {
  ...
  if (buildCounterStructuredQuery < 3) {
    ...
    checkUnnamed63(o.from!);
    unittest.expect(o.limit!, unittest.equals(42));
    unittest.expect(o.offset!, unittest.equals(42));
    checkUnnamed64(o.orderBy!);
...
api.Value buildValue() {
  ...
  if (buildCounterValue < 3) {
    ...
    o.bytesValue = 'foo';
    o.doubleValue = 42.0;
    o.fieldReferenceValue = 'foo';
    o.functionValue = buildFunction_();
    o.geoPointValue = buildLatLng();
    o.integerValue = 'foo';
    o.mapValue = buildMapValue();
    o.nullValue = 'NULL_VALUE';
    o.pipelineValue = buildPipeline();
    o.referenceValue = 'foo';
    o.stringValue = 'foo';
    o.timestampValue = 'foo';
    o.variableReferenceValue = 'foo';
  }
  buildCounterValue--;
  return o;
}
...
void checkValue(api.Value o) {
  ...
  if (buildCounterValue < 3) {
    ...
    unittest.expect(o.fieldReferenceValue!, unittest.equals('foo'));
    checkFunction_(o.functionValue!);
    ...
    checkPipeline(o.pipelineValue!);
    unittest.expect(o.referenceValue!, unittest.equals('foo'));
    unittest.expect(o.stringValue!, unittest.equals('foo'));
    unittest.expect(o.timestampValue!, unittest.equals('foo'));
    unittest.expect(o.variableReferenceValue!, unittest.equals('foo'));
  }
  buildCounterValue--;
}

core.List<api.FieldTransform> buildUnnamed65() => [
  buildFieldTransform(),
  buildFieldTransform(),
];

void checkUnnamed65(core.List<api.FieldTransform> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFieldTransform(o[0]);
  checkFieldTransform(o[1]);
}
...
api.Write buildWrite() {
  ...
  if (buildCounterWrite < 3) {
    ...
    o.updateTransforms = buildUnnamed65();
  }
  buildCounterWrite--;
  return o;
}
...
void checkWrite(api.Write o) {
  ...
  if (buildCounterWrite < 3) {
    ...
    checkUnnamed65(o.updateTransforms!);
  }
  buildCounterWrite--;
}
...
core.List<api.Write> buildUnnamed67() => [buildWrite(), buildWrite()];

void checkUnnamed67(core.List<api.Write> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWrite(o[0]);
  checkWrite(o[1]);
}
...
void checkWriteRequest(api.WriteRequest o) {
  ...
  if (buildCounterWriteRequest < 3) {
    ...
    checkUnnamed67(o.writes!);
  }
  buildCounterWriteRequest--;
}

core.List<api.WriteResult> buildUnnamed68() => [
  buildWriteResult(),
  buildWriteResult(),
];

void checkUnnamed68(core.List<api.WriteResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWriteResult(o[0]);
  checkWriteResult(o[1]);
}
...
void checkWriteResponse(api.WriteResponse o) {
  ...
  if (buildCounterWriteResponse < 3) {
    ...
    unittest.expect(o.streamId!, unittest.equals('foo'));
    unittest.expect(o.streamToken!, unittest.equals('foo'));
    checkUnnamed68(o.writeResults!);
  }
  buildCounterWriteResponse--;
}

core.List<api.Value> buildUnnamed69() => [buildValue(), buildValue()];

void checkUnnamed69(core.List<api.Value> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValue(o[0]);
  checkValue(o[1]);
}
...
api.WriteResult buildWriteResult() {
  ...
  if (buildCounterWriteResult < 3) {
    o.transformResults = buildUnnamed69();
    o.updateTime = 'foo';
  }
  buildCounterWriteResult--;
  return o;
...
void checkWriteResult(api.WriteResult o) {
  buildCounterWriteResult++;
  if (buildCounterWriteResult < 3) {
    checkUnnamed69(o.transformResults!);
    unittest.expect(o.updateTime!, unittest.equals('foo'));
  }
  buildCounterWriteResult--;
}
...
void main() {
  ...
  unittest.group('obj-schema-ExecutePipelineRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildExecutePipelineRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ExecutePipelineRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkExecutePipelineRequest(od);
    });
  });

  unittest.group('obj-schema-ExecutePipelineResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildExecutePipelineResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ExecutePipelineResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkExecutePipelineResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-ExplainStats', () {
    unittest.test('to-json--from-json', () async {
      final o = buildExplainStats();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ExplainStats.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkExplainStats(od);
    });
  });
  ...
  unittest.group('obj-schema-GoogleFirestoreAdminV1BackupSource', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleFirestoreAdminV1BackupSource();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleFirestoreAdminV1BackupSource.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleFirestoreAdminV1BackupSource(od);
    });
  });

  unittest.group(
    'obj-schema-GoogleFirestoreAdminV1BulkDeleteDocumentsRequest',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group('obj-schema-GoogleFirestoreAdminV1ChangeStream', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleFirestoreAdminV1ChangeStream();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleFirestoreAdminV1ChangeStream.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleFirestoreAdminV1ChangeStream(od);
    });
  });

  unittest.group('obj-schema-GoogleFirestoreAdminV1CloneDatabaseRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleFirestoreAdminV1CloneDatabaseRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleFirestoreAdminV1CloneDatabaseRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleFirestoreAdminV1CloneDatabaseRequest(od);
    });
  });
  ...
  unittest.group('obj-schema-GoogleFirestoreAdminV1CollectionGroupScope', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleFirestoreAdminV1CollectionGroupScope();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleFirestoreAdminV1CollectionGroupScope.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleFirestoreAdminV1CollectionGroupScope(od);
    });
  });

  unittest.group(
    'obj-schema-GoogleFirestoreAdminV1CustomerManagedEncryptionOptions',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group('obj-schema-GoogleFirestoreAdminV1DatabaseScope', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleFirestoreAdminV1DatabaseScope();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleFirestoreAdminV1DatabaseScope.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleFirestoreAdminV1DatabaseScope(od);
    });
  });

  unittest.group(
    'obj-schema-GoogleFirestoreAdminV1DisableUserCredsRequest',
    () {
      unittest.test('to-json--from-json', () async {
        final o = buildGoogleFirestoreAdminV1DisableUserCredsRequest();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleFirestoreAdminV1DisableUserCredsRequest.fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
        checkGoogleFirestoreAdminV1DisableUserCredsRequest(od);
      });
    },
  );

  unittest.group('obj-schema-GoogleFirestoreAdminV1EnableUserCredsRequest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleFirestoreAdminV1EnableUserCredsRequest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleFirestoreAdminV1EnableUserCredsRequest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleFirestoreAdminV1EnableUserCredsRequest(od);
    });
  });

  unittest.group('obj-schema-GoogleFirestoreAdminV1EncryptionConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleFirestoreAdminV1EncryptionConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleFirestoreAdminV1EncryptionConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleFirestoreAdminV1EncryptionConfig(od);
    });
  });
  ...
  unittest.group(
    'obj-schema-GoogleFirestoreAdminV1GoogleDefaultEncryptionOptions',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleFirestoreAdminV1ListBackupSchedulesResponse',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleFirestoreAdminV1ListChangeStreamsResponse',
    () {
      unittest.test('to-json--from-json', () async {
        final o = buildGoogleFirestoreAdminV1ListChangeStreamsResponse();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleFirestoreAdminV1ListChangeStreamsResponse.fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
        checkGoogleFirestoreAdminV1ListChangeStreamsResponse(od);
      });
    },
  );
  ...
  unittest.group('obj-schema-GoogleFirestoreAdminV1ListUserCredsResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleFirestoreAdminV1ListUserCredsResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleFirestoreAdminV1ListUserCredsResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleFirestoreAdminV1ListUserCredsResponse(od);
    });
  });

  unittest.group('obj-schema-GoogleFirestoreAdminV1PitrSnapshot', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleFirestoreAdminV1PitrSnapshot();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleFirestoreAdminV1PitrSnapshot.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleFirestoreAdminV1PitrSnapshot(od);
    });
  });

  unittest.group(
    'obj-schema-GoogleFirestoreAdminV1ResetUserPasswordRequest',
    () {
      unittest.test('to-json--from-json', () async {
        final o = buildGoogleFirestoreAdminV1ResetUserPasswordRequest();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleFirestoreAdminV1ResetUserPasswordRequest.fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
        checkGoogleFirestoreAdminV1ResetUserPasswordRequest(od);
      });
    },
  );

  unittest.group('obj-schema-GoogleFirestoreAdminV1ResourceIdentity', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleFirestoreAdminV1ResourceIdentity();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleFirestoreAdminV1ResourceIdentity.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleFirestoreAdminV1ResourceIdentity(od);
    });
  });
  ...
  unittest.group('obj-schema-GoogleFirestoreAdminV1SearchConfig', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleFirestoreAdminV1SearchConfig();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleFirestoreAdminV1SearchConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleFirestoreAdminV1SearchConfig(od);
    });
  });

  unittest.group('obj-schema-GoogleFirestoreAdminV1SearchGeoSpec', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleFirestoreAdminV1SearchGeoSpec();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleFirestoreAdminV1SearchGeoSpec.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleFirestoreAdminV1SearchGeoSpec(od);
    });
  });

  unittest.group('obj-schema-GoogleFirestoreAdminV1SearchIndexOptions', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleFirestoreAdminV1SearchIndexOptions();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleFirestoreAdminV1SearchIndexOptions.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleFirestoreAdminV1SearchIndexOptions(od);
    });
  });

  unittest.group('obj-schema-GoogleFirestoreAdminV1SearchTextIndexSpec', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleFirestoreAdminV1SearchTextIndexSpec();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleFirestoreAdminV1SearchTextIndexSpec.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleFirestoreAdminV1SearchTextIndexSpec(od);
    });
  });

  unittest.group('obj-schema-GoogleFirestoreAdminV1SearchTextSpec', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleFirestoreAdminV1SearchTextSpec();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleFirestoreAdminV1SearchTextSpec.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleFirestoreAdminV1SearchTextSpec(od);
    });
  });

  unittest.group(
    'obj-schema-GoogleFirestoreAdminV1SourceEncryptionOptions',
    () {
      unittest.test('to-json--from-json', () async {
        final o = buildGoogleFirestoreAdminV1SourceEncryptionOptions();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleFirestoreAdminV1SourceEncryptionOptions.fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
        checkGoogleFirestoreAdminV1SourceEncryptionOptions(od);
      });
    },
  );

  unittest.group('obj-schema-GoogleFirestoreAdminV1SourceInfo', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleFirestoreAdminV1SourceInfo();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleFirestoreAdminV1SourceInfo.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleFirestoreAdminV1SourceInfo(od);
    });
  });
  ...
  unittest.group('obj-schema-GoogleFirestoreAdminV1UserCreds', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleFirestoreAdminV1UserCreds();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleFirestoreAdminV1UserCreds.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleFirestoreAdminV1UserCreds(od);
    });
  });
  ...
  unittest.group('obj-schema-StructuredPipeline', () {
    unittest.test('to-json--from-json', () async {
      final o = buildStructuredPipeline();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.StructuredPipeline.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkStructuredPipeline(od);
    });
  });
  ...
  unittest.group('resource-ProjectsDatabasesResource', () {
    unittest.test('method--bulkDeleteDocuments', () async {
      ...
      final response = await res.bulkDeleteDocuments(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--clone', () async {
      final mock = HttpServerMock();
      final res = api.FirestoreApi(mock).projects.databases;
      final arg_request = buildGoogleFirestoreAdminV1CloneDatabaseRequest();
      final arg_parent = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.GoogleFirestoreAdminV1CloneDatabaseRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkGoogleFirestoreAdminV1CloneDatabaseRequest(obj);
  ...
  unittest.group('resource-ProjectsDatabasesChangeStreamsResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.FirestoreApi(mock).projects.databases.changeStreams;
      final arg_request = buildGoogleFirestoreAdminV1ChangeStream();
      final arg_parent = 'foo';
      final arg_changeStreamId = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.GoogleFirestoreAdminV1ChangeStream.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkGoogleFirestoreAdminV1ChangeStream(obj);
          ...
          unittest.expect(
            queryMap['changeStreamId']!.first,
            unittest.equals(arg_changeStreamId),
          );
          unittest.expect(
            queryMap['fields']!.first,
            unittest.equals(arg_$fields),
      ...
      final response = await res.create(
        arg_request,
        arg_parent,
        changeStreamId: arg_changeStreamId,
        $fields: arg_$fields,
      );
      checkGoogleFirestoreAdminV1ChangeStream(
        response as api.GoogleFirestoreAdminV1ChangeStream,
      );
    });
    ...
    unittest.test('method--list', () async {
      ...
      final response = await res.list(arg_parent, $fields: arg_$fields);
      checkGoogleFirestoreAdminV1ListChangeStreamsResponse(
        response as api.GoogleFirestoreAdminV1ListChangeStreamsResponse,
      );
    });
  });
  ...
  unittest.group('resource-ProjectsDatabasesDocumentsResource', () {
    ...
    unittest.test('method--createDocument', () async {
      ...
      final arg_mask_fieldPaths = buildUnnamed70();
      final arg_requestOptions_requestTags = buildUnnamed71();
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            queryMap['requestOptions.requestTags']!,
            unittest.equals(arg_requestOptions_requestTags),
          );
          unittest.expect(
            queryMap['fields']!.first,
            unittest.equals(arg_$fields),
      ...
      final response = await res.createDocument(
        ...
        requestOptions_requestTags: arg_requestOptions_requestTags,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--delete', () async {
      ...
      final arg_requestOptions_requestTags = buildUnnamed72();
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final path = req.url.path;
    ...
    unittest.test('method--executePipeline', () async {
      final mock = HttpServerMock();
      final res = api.FirestoreApi(mock).projects.databases.documents;
      final arg_request = buildExecutePipelineRequest();
      final arg_database = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.ExecutePipelineRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkExecutePipelineRequest(obj);
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildExecutePipelineResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.executePipeline(
        arg_request,
        arg_database,
        $fields: arg_$fields,
      );
      checkExecutePipelineResponse(response as api.ExecutePipelineResponse);
    });
    ...
    unittest.test('method--get', () async {
      ...
      final res = api.FirestoreApi(mock).projects.databases.documents;
      final arg_name = 'foo';
      final arg_mask_fieldPaths = buildUnnamed73();
      final arg_readTime = 'foo';
      final arg_requestOptions_requestTags = buildUnnamed74();
    ...
    unittest.test('method--list', () async {
      ...
      final arg_parent = 'foo';
      final arg_collectionId = 'foo';
      final arg_mask_fieldPaths = buildUnnamed75();
      final arg_orderBy = 'foo';
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_readTime = 'foo';
      final arg_recursive = true;
      final arg_requestOptions_requestTags = buildUnnamed76();
    ...
    unittest.test('method--listDocuments', () async {
      ...
      final arg_parent = 'foo';
      final arg_collectionId = 'foo';
      final arg_mask_fieldPaths = buildUnnamed77();
      final arg_orderBy = 'foo';
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_readTime = 'foo';
      final arg_recursive = true;
      final arg_requestOptions_requestTags = buildUnnamed78();
      final arg_showMissing = true;
      final arg_transaction = 'foo';
      final arg_$fields = 'foo';
      mock.register(
    ...
    unittest.test('method--patch', () async {
      ...
      final arg_currentDocument_exists = true;
      final arg_currentDocument_updateTime = 'foo';
      final arg_mask_fieldPaths = buildUnnamed79();
      final arg_requestOptions_requestTags = buildUnnamed80();
      final arg_updateMask_fieldPaths = buildUnnamed81();
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Document.fromJson(
  ...
  unittest.group('resource-ProjectsDatabasesUserCredsResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.FirestoreApi(mock).projects.databases.userCreds;
      final arg_request = buildGoogleFirestoreAdminV1UserCreds();
      final arg_parent = 'foo';
      final arg_userCredsId = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.GoogleFirestoreAdminV1UserCreds.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkGoogleFirestoreAdminV1UserCreds(obj);
          ...
          unittest.expect(
            queryMap['userCredsId']!.first,
            unittest.equals(arg_userCredsId),
          );
          unittest.expect(
            queryMap['fields']!.first,
            unittest.equals(arg_$fields),
      ...
      final response = await res.create(
        arg_request,
        arg_parent,
        userCredsId: arg_userCredsId,
        $fields: arg_$fields,
      );
      checkGoogleFirestoreAdminV1UserCreds(
        response as api.GoogleFirestoreAdminV1UserCreds,
      );
    });
    ...
    unittest.test('method--disable', () async {
      final mock = HttpServerMock();
      final res = api.FirestoreApi(mock).projects.databases.userCreds;
      final arg_request = buildGoogleFirestoreAdminV1DisableUserCredsRequest();
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
    ...
    unittest.test('method--enable', () async {
      final mock = HttpServerMock();
      final res = api.FirestoreApi(mock).projects.databases.userCreds;
      final arg_request = buildGoogleFirestoreAdminV1EnableUserCredsRequest();
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.GoogleFirestoreAdminV1EnableUserCredsRequest.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkGoogleFirestoreAdminV1EnableUserCredsRequest(obj);
    ...
    unittest.test('method--list', () async {
      ...
      final response = await res.list(arg_parent, $fields: arg_$fields);
      checkGoogleFirestoreAdminV1ListUserCredsResponse(
        response as api.GoogleFirestoreAdminV1ListUserCredsResponse,
      );
    });
    ...
    unittest.test('method--resetPassword', () async {
      final mock = HttpServerMock();
      final res = api.FirestoreApi(mock).projects.databases.userCreds;
      final arg_request = buildGoogleFirestoreAdminV1ResetUserPasswordRequest();
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
  ...
  unittest.group('resource-ProjectsLocationsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.FirestoreApi(mock).projects.locations;
      final arg_name = 'foo';
      final arg_extraLocationTypes = buildUnnamed82();
      final arg_filter = 'foo';
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_$fields = 'foo';
