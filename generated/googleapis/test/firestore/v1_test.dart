...
core.List<api.Value> buildUnnamed3591() => [
      buildValue(),
      buildValue(),
    ];

void checkUnnamed3591(core.List<api.Value> o) {
...
core.List<api.Write> buildUnnamed3594() => [
      buildWrite(),
      buildWrite(),
    ];

void checkUnnamed3594(core.List<api.Write> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWrite(o[0]);
  checkWrite(o[1]);
}
...
void checkBatchWriteRequest(api.BatchWriteRequest o) {
  ...
  if (buildCounterBatchWriteRequest < 3) {
    ...
    checkUnnamed3594(o.writes!);
  }
  buildCounterBatchWriteRequest--;
}

core.List<api.Status> buildUnnamed3595() => [
      buildStatus(),
      buildStatus(),
    ];

void checkUnnamed3595(core.List<api.Status> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatus(o[0]);
  checkStatus(o[1]);
}

core.List<api.WriteResult> buildUnnamed3596() => [
      buildWriteResult(),
      buildWriteResult(),
    ];

void checkUnnamed3596(core.List<api.WriteResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BatchWriteResponse buildBatchWriteResponse() {
  ...
  if (buildCounterBatchWriteResponse < 3) {
    o.status = buildUnnamed3595();
    o.writeResults = buildUnnamed3596();
  }
  buildCounterBatchWriteResponse--;
  return o;
}
...
void checkBatchWriteResponse(api.BatchWriteResponse o) {
  buildCounterBatchWriteResponse++;
  if (buildCounterBatchWriteResponse < 3) {
    checkUnnamed3595(o.status!);
    checkUnnamed3596(o.writeResults!);
  }
  buildCounterBatchWriteResponse--;
}
...
core.List<api.Write> buildUnnamed3597() => [
      buildWrite(),
      buildWrite(),
    ];

void checkUnnamed3597(core.List<api.Write> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWrite(o[0]);
  checkWrite(o[1]);
}
...
void checkCommitRequest(api.CommitRequest o) {
  ...
  if (buildCounterCommitRequest < 3) {
    ...
    checkUnnamed3597(o.writes!);
  }
  buildCounterCommitRequest--;
}

core.List<api.WriteResult> buildUnnamed3598() => [
      buildWriteResult(),
      buildWriteResult(),
    ];

void checkUnnamed3598(core.List<api.WriteResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWriteResult(o[0]);
  checkWriteResult(o[1]);
}
...
api.CommitResponse buildCommitResponse() {
  ...
  if (buildCounterCommitResponse < 3) {
    o.commitTime = 'foo';
    o.writeResults = buildUnnamed3598();
  }
  buildCounterCommitResponse--;
  return o;
}
...
void checkCommitResponse(api.CommitResponse o) {
  ...
  if (buildCounterCommitResponse < 3) {
    ...
    checkUnnamed3598(o.writeResults!);
  }
  buildCounterCommitResponse--;
}

core.List<api.Filter> buildUnnamed3599() => [
      buildFilter(),
      buildFilter(),
    ];

void checkUnnamed3599(core.List<api.Filter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFilter(o[0]);
  checkFilter(o[1]);
}
...
core.List<api.Value> buildUnnamed3600() => [
      buildValue(),
      buildValue(),
    ];

void checkUnnamed3600(core.List<api.Value> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValue(o[0]);
  checkValue(o[1]);
}
...
void checkCursor(api.Cursor o) {
  ...
  if (buildCounterCursor < 3) {
    ...
    checkUnnamed3600(o.values!);
  }
  buildCounterCursor--;
}

core.Map<core.String, api.Value> buildUnnamed3601() => {
      'x': buildValue(),
      'y': buildValue(),
    };

void checkUnnamed3601(core.Map<core.String, api.Value> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValue(o['x']!);
  checkValue(o['y']!);
}
...
core.List<core.int> buildUnnamed3602() => [
      42,
      42,
    ];

void checkUnnamed3602(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
core.List<core.int> buildUnnamed3603() => [
      42,
      42,
    ];

void checkUnnamed3603(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
api.DocumentChange buildDocumentChange() {
  ...
  if (buildCounterDocumentChange < 3) {
    ...
    o.removedTargetIds = buildUnnamed3602();
    o.targetIds = buildUnnamed3603();
  }
  buildCounterDocumentChange--;
  return o;
}
...
void checkDocumentChange(api.DocumentChange o) {
  ...
  if (buildCounterDocumentChange < 3) {
    ...
    checkUnnamed3602(o.removedTargetIds!);
    checkUnnamed3603(o.targetIds!);
  }
  buildCounterDocumentChange--;
}

core.List<core.int> buildUnnamed3604() => [
      42,
      42,
    ];

void checkUnnamed3604(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
api.DocumentDelete buildDocumentDelete() {
  ...
  if (buildCounterDocumentDelete < 3) {
    o.document = 'foo';
    o.readTime = 'foo';
    o.removedTargetIds = buildUnnamed3604();
  }
  buildCounterDocumentDelete--;
  return o;
}
...
void checkDocumentDelete(api.DocumentDelete o) {
  ...
  if (buildCounterDocumentDelete < 3) {
    ...
    checkUnnamed3604(o.removedTargetIds!);
  }
  buildCounterDocumentDelete--;
}
...
void checkDocumentMask(api.DocumentMask o) {
  buildCounterDocumentMask++;
  if (buildCounterDocumentMask < 3) {
    checkUnnamed3605(o.fieldPaths!);
  }
  buildCounterDocumentMask--;
}

core.List<core.int> buildUnnamed3606() => [
      42,
      42,
    ];

void checkUnnamed3606(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
api.DocumentRemove buildDocumentRemove() {
  ...
  if (buildCounterDocumentRemove < 3) {
    o.document = 'foo';
    o.readTime = 'foo';
    o.removedTargetIds = buildUnnamed3606();
  }
  buildCounterDocumentRemove--;
  return o;
}
...
void checkDocumentRemove(api.DocumentRemove o) {
  ...
  if (buildCounterDocumentRemove < 3) {
    ...
    checkUnnamed3606(o.removedTargetIds!);
  }
  buildCounterDocumentRemove--;
}

core.List<api.FieldTransform> buildUnnamed3607() => [
      buildFieldTransform(),
      buildFieldTransform(),
    ];

void checkUnnamed3607(core.List<api.FieldTransform> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DocumentTransform buildDocumentTransform() {
  ...
  if (buildCounterDocumentTransform < 3) {
    o.document = 'foo';
    o.fieldTransforms = buildUnnamed3607();
  }
  buildCounterDocumentTransform--;
  return o;
}
...
void checkDocumentTransform(api.DocumentTransform o) {
  ...
  if (buildCounterDocumentTransform < 3) {
    ...
    checkUnnamed3607(o.fieldTransforms!);
  }
  buildCounterDocumentTransform--;
}
...
api.GoogleFirestoreAdminV1ExportDocumentsMetadata
  ...
  if (buildCounterGoogleFirestoreAdminV1ExportDocumentsMetadata < 3) {
    o.collectionIds = buildUnnamed3609();
    o.endTime = 'foo';
...
void checkGoogleFirestoreAdminV1ExportDocumentsMetadata(
  ...
  buildCounterGoogleFirestoreAdminV1ExportDocumentsMetadata++;
  if (buildCounterGoogleFirestoreAdminV1ExportDocumentsMetadata < 3) {
    checkUnnamed3609(o.collectionIds!);
    unittest.expect(
      o.endTime!,
      unittest.equals('foo'),
    );
...
api.GoogleFirestoreAdminV1ExportDocumentsRequest
  ...
  if (buildCounterGoogleFirestoreAdminV1ExportDocumentsRequest < 3) {
    o.collectionIds = buildUnnamed3610();
    o.outputUriPrefix = 'foo';
  }
  buildCounterGoogleFirestoreAdminV1ExportDocumentsRequest--;
  return o;
...
void checkGoogleFirestoreAdminV1ExportDocumentsRequest(
  ...
  buildCounterGoogleFirestoreAdminV1ExportDocumentsRequest++;
  if (buildCounterGoogleFirestoreAdminV1ExportDocumentsRequest < 3) {
    checkUnnamed3610(o.collectionIds!);
    unittest.expect(
      o.outputUriPrefix!,
      unittest.equals('foo'),
    );
...
core.List<api.GoogleFirestoreAdminV1IndexConfigDelta> buildUnnamed3611() => [
      buildGoogleFirestoreAdminV1IndexConfigDelta(),
      buildGoogleFirestoreAdminV1IndexConfigDelta(),
    ];

void checkUnnamed3611(core.List<api.GoogleFirestoreAdminV1IndexConfigDelta> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleFirestoreAdminV1FieldOperationMetadata
  ...
  if (buildCounterGoogleFirestoreAdminV1FieldOperationMetadata < 3) {
    o.endTime = 'foo';
    o.field = 'foo';
    o.indexConfigDeltas = buildUnnamed3611();
    o.progressBytes = buildGoogleFirestoreAdminV1Progress();
    o.progressDocuments = buildGoogleFirestoreAdminV1Progress();
    o.startTime = 'foo';
    o.state = 'foo';
...
void checkGoogleFirestoreAdminV1FieldOperationMetadata(
  ...
  if (buildCounterGoogleFirestoreAdminV1FieldOperationMetadata < 3) {
    ...
    checkUnnamed3611(o.indexConfigDeltas!);
    checkGoogleFirestoreAdminV1Progress(o.progressBytes!);
    checkGoogleFirestoreAdminV1Progress(o.progressDocuments!);
    unittest.expect(
      o.startTime!,
...
api.GoogleFirestoreAdminV1ImportDocumentsMetadata
  ...
  if (buildCounterGoogleFirestoreAdminV1ImportDocumentsMetadata < 3) {
    o.collectionIds = buildUnnamed3612();
    o.endTime = 'foo';
...
void checkGoogleFirestoreAdminV1ImportDocumentsMetadata(
  ...
  buildCounterGoogleFirestoreAdminV1ImportDocumentsMetadata++;
  if (buildCounterGoogleFirestoreAdminV1ImportDocumentsMetadata < 3) {
    checkUnnamed3612(o.collectionIds!);
    unittest.expect(
      o.endTime!,
      unittest.equals('foo'),
    );
...
api.GoogleFirestoreAdminV1ImportDocumentsRequest
  ...
  if (buildCounterGoogleFirestoreAdminV1ImportDocumentsRequest < 3) {
    o.collectionIds = buildUnnamed3613();
    o.inputUriPrefix = 'foo';
  }
  buildCounterGoogleFirestoreAdminV1ImportDocumentsRequest--;
  return o;
...
void checkGoogleFirestoreAdminV1ImportDocumentsRequest(
  ...
  buildCounterGoogleFirestoreAdminV1ImportDocumentsRequest++;
  if (buildCounterGoogleFirestoreAdminV1ImportDocumentsRequest < 3) {
    checkUnnamed3613(o.collectionIds!);
    unittest.expect(
      o.inputUriPrefix!,
      unittest.equals('foo'),
    );
...
core.List<api.GoogleFirestoreAdminV1IndexField> buildUnnamed3614() => [
      buildGoogleFirestoreAdminV1IndexField(),
      buildGoogleFirestoreAdminV1IndexField(),
    ];

void checkUnnamed3614(core.List<api.GoogleFirestoreAdminV1IndexField> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleFirestoreAdminV1Index> buildUnnamed3615() => [
      buildGoogleFirestoreAdminV1Index(),
      buildGoogleFirestoreAdminV1Index(),
    ];

void checkUnnamed3615(core.List<api.GoogleFirestoreAdminV1Index> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleFirestoreAdminV1Field> buildUnnamed3616() => [
      buildGoogleFirestoreAdminV1Field(),
      buildGoogleFirestoreAdminV1Field(),
    ];

void checkUnnamed3616(core.List<api.GoogleFirestoreAdminV1Field> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleFirestoreAdminV1Index> buildUnnamed3617() => [
      buildGoogleFirestoreAdminV1Index(),
      buildGoogleFirestoreAdminV1Index(),
    ];

void checkUnnamed3617(core.List<api.GoogleFirestoreAdminV1Index> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleFirestoreAdminV1Index(o[0]);
  checkGoogleFirestoreAdminV1Index(o[1]);
}
...
core.List<api.GoogleLongrunningOperation> buildUnnamed3618() => [
      buildGoogleLongrunningOperation(),
      buildGoogleLongrunningOperation(),
    ];

void checkUnnamed3618(core.List<api.GoogleLongrunningOperation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListCollectionIdsResponse buildListCollectionIdsResponse() {
  ...
  if (buildCounterListCollectionIdsResponse < 3) {
    o.collectionIds = buildUnnamed3621();
    o.nextPageToken = 'foo';
  }
  buildCounterListCollectionIdsResponse--;
  return o;
...
void checkListCollectionIdsResponse(api.ListCollectionIdsResponse o) {
  buildCounterListCollectionIdsResponse++;
  if (buildCounterListCollectionIdsResponse < 3) {
    checkUnnamed3621(o.collectionIds!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Document> buildUnnamed3622() => [
      buildDocument(),
      buildDocument(),
    ];

void checkUnnamed3622(core.List<api.Document> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDocument(o[0]);
  checkDocument(o[1]);
}
...
core.List<api.Location> buildUnnamed3623() => [
      buildLocation(),
      buildLocation(),
    ];

void checkUnnamed3623(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
core.Map<core.String, core.String> buildUnnamed3624() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed3624(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.Map<core.String, core.Object> buildUnnamed3626() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed3626(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Location buildLocation() {
  ...
  if (buildCounterLocation < 3) {
    o.displayName = 'foo';
    o.labels = buildUnnamed3625();
    o.locationId = 'foo';
    o.metadata = buildUnnamed3626();
    o.name = 'foo';
  }
  buildCounterLocation--;
  return o;
...
void checkLocation(api.Location o) {
  ...
  if (buildCounterLocation < 3) {
    ...
    checkUnnamed3625(o.labels!);
    unittest.expect(
      o.locationId!,
      unittest.equals('foo'),
    );
    checkUnnamed3626(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, api.Value> buildUnnamed3627() => {
      'x': buildValue(),
      'y': buildValue(),
    };

void checkUnnamed3627(core.Map<core.String, api.Value> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValue(o['x']!);
  checkValue(o['y']!);
}
...
core.List<api.Cursor> buildUnnamed3628() => [
      buildCursor(),
      buildCursor(),
    ];

void checkUnnamed3628(core.List<api.Cursor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCursor(o[0]);
  checkCursor(o[1]);
}
...
core.List<api.FieldReference> buildUnnamed3629() => [
      buildFieldReference(),
      buildFieldReference(),
    ];

void checkUnnamed3629(core.List<api.FieldReference> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed3631() => [
      buildUnnamed3630(),
      buildUnnamed3630(),
    ];

void checkUnnamed3631(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed3630(o[0]);
  checkUnnamed3630(o[1]);
}
...
core.List<api.CollectionSelector> buildUnnamed3632() => [
      buildCollectionSelector(),
      buildCollectionSelector(),
    ];

void checkUnnamed3632(core.List<api.CollectionSelector> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCollectionSelector(o[0]);
  checkCollectionSelector(o[1]);
}

core.List<api.Order> buildUnnamed3633() => [
      buildOrder(),
      buildOrder(),
    ];

void checkUnnamed3633(core.List<api.Order> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrder(o[0]);
  checkOrder(o[1]);
}
...
api.StructuredQuery buildStructuredQuery() {
  ...
  if (buildCounterStructuredQuery < 3) {
    o.endAt = buildCursor();
    o.from = buildUnnamed3632();
    o.limit = 42;
    o.offset = 42;
    o.orderBy = buildUnnamed3633();
...
core.List<core.int> buildUnnamed3634() => [
      42,
      42,
    ];

void checkUnnamed3634(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42),
...
core.List<api.FieldTransform> buildUnnamed3635() => [
      buildFieldTransform(),
      buildFieldTransform(),
    ];

void checkUnnamed3635(core.List<api.FieldTransform> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFieldTransform(o[0]);
  checkFieldTransform(o[1]);
}
...
api.Write buildWrite() {
  ...
  if (buildCounterWrite < 3) {
    ...
    o.updateTransforms = buildUnnamed3635();
  }
  buildCounterWrite--;
  return o;
}
...
void checkWrite(api.Write o) {
  ...
  if (buildCounterWrite < 3) {
    ...
    checkUnnamed3635(o.updateTransforms!);
  }
  buildCounterWrite--;
}

core.Map<core.String, core.String> buildUnnamed3636() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed3636(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.Write> buildUnnamed3637() => [
      buildWrite(),
      buildWrite(),
    ];

void checkUnnamed3637(core.List<api.Write> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWrite(o[0]);
  checkWrite(o[1]);
}
...
api.WriteRequest buildWriteRequest() {
  ...
  if (buildCounterWriteRequest < 3) {
    o.labels = buildUnnamed3636();
    o.streamId = 'foo';
    o.streamToken = 'foo';
    o.writes = buildUnnamed3637();
  }
  buildCounterWriteRequest--;
  return o;
}
...
void checkWriteRequest(api.WriteRequest o) {
  ...
  if (buildCounterWriteRequest < 3) {
    ...
    checkUnnamed3637(o.writes!);
  }
  buildCounterWriteRequest--;
}

core.List<api.WriteResult> buildUnnamed3638() => [
      buildWriteResult(),
      buildWriteResult(),
    ];

void checkUnnamed3638(core.List<api.WriteResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWriteResult(o[0]);
  checkWriteResult(o[1]);
}
...
api.WriteResponse buildWriteResponse() {
  ...
  if (buildCounterWriteResponse < 3) {
    ...
    o.streamId = 'foo';
    o.streamToken = 'foo';
    o.writeResults = buildUnnamed3638();
  }
  buildCounterWriteResponse--;
  return o;
}
...
void checkWriteResponse(api.WriteResponse o) {
  ...
  if (buildCounterWriteResponse < 3) {
    ...
    checkUnnamed3638(o.writeResults!);
  }
  buildCounterWriteResponse--;
}

core.List<api.Value> buildUnnamed3639() => [
      buildValue(),
      buildValue(),
    ];

void checkUnnamed3639(core.List<api.Value> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValue(o[0]);
  checkValue(o[1]);
}
...
api.WriteResult buildWriteResult() {
  ...
  if (buildCounterWriteResult < 3) {
    o.transformResults = buildUnnamed3639();
    o.updateTime = 'foo';
  }
  buildCounterWriteResult--;
  return o;
...
void checkWriteResult(api.WriteResult o) {
  buildCounterWriteResult++;
  if (buildCounterWriteResult < 3) {
    checkUnnamed3639(o.transformResults!);
    unittest.expect(
      o.updateTime!,
      unittest.equals('foo'),
    );
...
core.List<core.String> buildUnnamed3641() => [
      'foo',
      'foo',
    ];

void checkUnnamed3641(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
void main() {
  ...
  unittest.group('resource-ProjectsDatabasesDocumentsResource', () {
    ...
    unittest.test('method--createDocument', () async {
      ...
      final arg_mask_fieldPaths = buildUnnamed3640();
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final obj =
    ...
    unittest.test('method--get', () async {
      ...
      final res = api.FirestoreApi(mock).projects.databases.documents;
      final arg_name = 'foo';
      final arg_mask_fieldPaths = buildUnnamed3641();
    ...
    unittest.test('method--list', () async {
      ...
      final arg_parent = 'foo';
      final arg_collectionId = 'foo';
      final arg_mask_fieldPaths = buildUnnamed3642();
    ...
    unittest.test('method--patch', () async {
      ...
      final arg_currentDocument_exists = true;
      final arg_currentDocument_updateTime = 'foo';
      final arg_mask_fieldPaths = buildUnnamed3643();
      final arg_updateMask_fieldPaths = buildUnnamed3644();
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final obj =
            api.Document.fromJson(json as core.Map<core.String, core.dynamic>);
