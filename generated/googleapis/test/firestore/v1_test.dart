...
core.List<api.Document> buildUnnamed35() => [
      buildDocument(),
      buildDocument(),
    ];
...
core.List<api.Cursor> buildUnnamed40() => [
      buildCursor(),
      buildCursor(),
    ];
...
core.List<api.Order> buildUnnamed48() => [
      buildOrder(),
      buildOrder(),
    ];
...
core.List<api.Write> buildUnnamed51() => [
      buildWrite(),
      buildWrite(),
    ];
...
core.List<api.Value> buildUnnamed53() => [
      buildValue(),
      buildValue(),
    ];
