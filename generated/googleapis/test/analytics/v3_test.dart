...
core.List<api.AccountSummary> buildUnnamed1878() => [
      buildAccountSummary(),
      buildAccountSummary(),
    ];

void checkUnnamed1878(core.List<api.AccountSummary> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.WebPropertySummary> buildUnnamed1879() => [
      buildWebPropertySummary(),
      buildWebPropertySummary(),
    ];

void checkUnnamed1879(core.List<api.WebPropertySummary> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AccountSummary buildAccountSummary() {
  ...
  if (buildCounterAccountSummary < 3) {
    ...
    o.name = 'foo';
    o.starred = true;
    o.webProperties = buildUnnamed1879();
  }
  buildCounterAccountSummary--;
  return o;
}
...
void checkAccountSummary(api.AccountSummary o) {
  ...
  if (buildCounterAccountSummary < 3) {
    ...
    unittest.expect(o.starred!, unittest.isTrue);
    checkUnnamed1879(o.webProperties!);
  }
  buildCounterAccountSummary--;
}
...
core.List<api.Account> buildUnnamed1880() => [
      buildAccount(),
      buildAccount(),
    ];

void checkUnnamed1880(core.List<api.Account> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAccount(o[0]);
  checkAccount(o[1]);
}
...
api.AnalyticsDataimportDeleteUploadDataRequest
  ...
  if (buildCounterAnalyticsDataimportDeleteUploadDataRequest < 3) {
    o.customDataImportUids = buildUnnamed1881();
  }
  buildCounterAnalyticsDataimportDeleteUploadDataRequest--;
  return o;
}
...
void checkAnalyticsDataimportDeleteUploadDataRequest(
  ...
  buildCounterAnalyticsDataimportDeleteUploadDataRequest++;
  if (buildCounterAnalyticsDataimportDeleteUploadDataRequest < 3) {
    checkUnnamed1881(o.customDataImportUids!);
  }
  buildCounterAnalyticsDataimportDeleteUploadDataRequest--;
}

core.Map<core.String, core.String> buildUnnamed1882() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed1882(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.Column> buildUnnamed1884() => [
      buildColumn(),
      buildColumn(),
    ];

void checkUnnamed1884(core.List<api.Column> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkColumn(o[0]);
  checkColumn(o[1]);
}
...
api.Columns buildColumns() {
  ...
  if (buildCounterColumns < 3) {
    o.attributeNames = buildUnnamed1883();
    o.etag = 'foo';
...
void checkColumns(api.Columns o) {
  buildCounterColumns++;
  if (buildCounterColumns < 3) {
    checkUnnamed1883(o.attributeNames!);
    unittest.expect(
      o.etag!,
      unittest.equals('foo'),
    );
...
api.CustomDataSource buildCustomDataSource() {
  ...
  if (buildCounterCustomDataSource < 3) {
    ...
    o.profilesLinked = buildUnnamed1885();
    o.schema = buildUnnamed1886();
    o.selfLink = 'foo';
    o.type = 'foo';
    o.updated = core.DateTime.parse('2002-02-27T14:01:02');
    o.uploadType = 'foo';
...
void checkCustomDataSource(api.CustomDataSource o) {
  ...
  if (buildCounterCustomDataSource < 3) {
    ...
    checkUnnamed1885(o.profilesLinked!);
    checkUnnamed1886(o.schema!);
    unittest.expect(
      o.selfLink!,
      unittest.equals('foo'),
    );
...
core.List<api.CustomDataSource> buildUnnamed1887() => [
      buildCustomDataSource(),
      buildCustomDataSource(),
    ];

void checkUnnamed1887(core.List<api.CustomDataSource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.CustomDimension> buildUnnamed1888() => [
      buildCustomDimension(),
      buildCustomDimension(),
    ];

void checkUnnamed1888(core.List<api.CustomDimension> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.CustomMetric> buildUnnamed1889() => [
      buildCustomMetric(),
      buildCustomMetric(),
    ];

void checkUnnamed1889(core.List<api.CustomMetric> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.AdWordsAccount> buildUnnamed1890() => [
      buildAdWordsAccount(),
      buildAdWordsAccount(),
    ];

void checkUnnamed1890(core.List<api.AdWordsAccount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.EntityAdWordsLink buildEntityAdWordsLink() {
  ...
  if (buildCounterEntityAdWordsLink < 3) {
    o.adWordsAccounts = buildUnnamed1890();
    o.entity = buildEntityAdWordsLinkEntity();
    o.id = 'foo';
    o.kind = 'foo';
    o.name = 'foo';
    o.profileIds = buildUnnamed1891();
    o.selfLink = 'foo';
  }
  buildCounterEntityAdWordsLink--;
  return o;
...
void checkEntityAdWordsLink(api.EntityAdWordsLink o) {
  buildCounterEntityAdWordsLink++;
  if (buildCounterEntityAdWordsLink < 3) {
    checkUnnamed1890(o.adWordsAccounts!);
...
core.List<api.EntityAdWordsLink> buildUnnamed1892() => [
      buildEntityAdWordsLink(),
      buildEntityAdWordsLink(),
    ];

void checkUnnamed1892(core.List<api.EntityAdWordsLink> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.EntityUserLinkPermissions buildEntityUserLinkPermissions() {
  ...
  if (buildCounterEntityUserLinkPermissions < 3) {
    o.effective = buildUnnamed1893();
    o.local = buildUnnamed1894();
  }
  buildCounterEntityUserLinkPermissions--;
  return o;
}
...
void checkEntityUserLinkPermissions(api.EntityUserLinkPermissions o) {
  buildCounterEntityUserLinkPermissions++;
  if (buildCounterEntityUserLinkPermissions < 3) {
    checkUnnamed1893(o.effective!);
    checkUnnamed1894(o.local!);
  }
  buildCounterEntityUserLinkPermissions--;
}
...
core.List<api.EntityUserLink> buildUnnamed1895() => [
      buildEntityUserLink(),
      buildEntityUserLink(),
    ];

void checkUnnamed1895(core.List<api.EntityUserLink> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ExperimentVariations> buildUnnamed1896() => [
      buildExperimentVariations(),
      buildExperimentVariations(),
    ];

void checkUnnamed1896(core.List<api.ExperimentVariations> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Experiment> buildUnnamed1897() => [
      buildExperiment(),
      buildExperiment(),
    ];

void checkUnnamed1897(core.List<api.Experiment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkExperiment(o[0]);
  checkExperiment(o[1]);
}
...
core.List<api.Filter> buildUnnamed1898() => [
      buildFilter(),
      buildFilter(),
    ];

void checkUnnamed1898(core.List<api.Filter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFilter(o[0]);
  checkFilter(o[1]);
}
...
core.List<api.GaDataColumnHeaders> buildUnnamed1899() => [
      buildGaDataColumnHeaders(),
      buildGaDataColumnHeaders(),
    ];

void checkUnnamed1899(core.List<api.GaDataColumnHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GaDataDataTableCols> buildUnnamed1900() => [
      buildGaDataDataTableCols(),
      buildGaDataDataTableCols(),
    ];

void checkUnnamed1900(core.List<api.GaDataDataTableCols> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GaDataDataTableRowsC> buildUnnamed1901() => [
      buildGaDataDataTableRowsC(),
      buildGaDataDataTableRowsC(),
    ];

void checkUnnamed1901(core.List<api.GaDataDataTableRowsC> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkGaDataDataTableRows(api.GaDataDataTableRows o) {
  buildCounterGaDataDataTableRows++;
  if (buildCounterGaDataDataTableRows < 3) {
    checkUnnamed1901(o.c!);
  }
  buildCounterGaDataDataTableRows--;
}

core.List<api.GaDataDataTableRows> buildUnnamed1902() => [
      buildGaDataDataTableRows(),
      buildGaDataDataTableRows(),
    ];

void checkUnnamed1902(core.List<api.GaDataDataTableRows> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GaDataDataTable buildGaDataDataTable() {
  ...
  if (buildCounterGaDataDataTable < 3) {
    o.cols = buildUnnamed1900();
    o.rows = buildUnnamed1902();
  }
  buildCounterGaDataDataTable--;
  return o;
}
...
void checkGaDataDataTable(api.GaDataDataTable o) {
  buildCounterGaDataDataTable++;
  if (buildCounterGaDataDataTable < 3) {
    checkUnnamed1900(o.cols!);
    checkUnnamed1902(o.rows!);
  }
  buildCounterGaDataDataTable--;
}
...
api.GaDataQuery buildGaDataQuery() {
  ...
  if (buildCounterGaDataQuery < 3) {
    ...
    o.ids = 'foo';
    o.maxResults = 42;
    o.metrics = buildUnnamed1903();
    o.samplingLevel = 'foo';
    o.segment = 'foo';
    o.sort = buildUnnamed1904();
    o.startDate = 'foo';
    o.startIndex = 42;
  }
  buildCounterGaDataQuery--;
...
core.List<core.List<core.String>> buildUnnamed1906() => [
      buildUnnamed1905(),
      buildUnnamed1905(),
    ];

void checkUnnamed1906(core.List<core.List<core.String>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1905(o[0]);
  checkUnnamed1905(o[1]);
}

core.Map<core.String, core.String> buildUnnamed1907() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed1907(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.GaData buildGaData() {
  ...
  if (buildCounterGaData < 3) {
    o.columnHeaders = buildUnnamed1899();
    ...
    o.rows = buildUnnamed1906();
    o.sampleSize = 'foo';
    o.sampleSpace = 'foo';
    o.selfLink = 'foo';
    o.totalResults = 42;
    o.totalsForAllResults = buildUnnamed1907();
  }
  buildCounterGaData--;
  return o;
}
...
void checkGaData(api.GaData o) {
  buildCounterGaData++;
  if (buildCounterGaData < 3) {
    checkUnnamed1899(o.columnHeaders!);
    ...
    checkUnnamed1907(o.totalsForAllResults!);
  }
  buildCounterGaData--;
}
...
core.List<api.GoalEventDetailsEventConditions> buildUnnamed1908() => [
      buildGoalEventDetailsEventConditions(),
      buildGoalEventDetailsEventConditions(),
    ];

void checkUnnamed1908(core.List<api.GoalEventDetailsEventConditions> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoalEventDetails buildGoalEventDetails() {
  ...
  if (buildCounterGoalEventDetails < 3) {
    o.eventConditions = buildUnnamed1908();
...
void checkGoalEventDetails(api.GoalEventDetails o) {
  buildCounterGoalEventDetails++;
  if (buildCounterGoalEventDetails < 3) {
    checkUnnamed1908(o.eventConditions!);
...
core.List<api.GoalUrlDestinationDetailsSteps> buildUnnamed1909() => [
      buildGoalUrlDestinationDetailsSteps(),
      buildGoalUrlDestinationDetailsSteps(),
    ];

void checkUnnamed1909(core.List<api.GoalUrlDestinationDetailsSteps> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Goal> buildUnnamed1910() => [
      buildGoal(),
      buildGoal(),
    ];

void checkUnnamed1910(core.List<api.Goal> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoal(o[0]);
  checkGoal(o[1]);
}
...
core.List<api.McfDataColumnHeaders> buildUnnamed1911() => [
      buildMcfDataColumnHeaders(),
      buildMcfDataColumnHeaders(),
    ];

void checkUnnamed1911(core.List<api.McfDataColumnHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.McfDataQuery buildMcfDataQuery() {
  ...
  if (buildCounterMcfDataQuery < 3) {
    ...
    o.ids = 'foo';
    o.maxResults = 42;
    o.metrics = buildUnnamed1912();
    o.samplingLevel = 'foo';
    o.segment = 'foo';
    o.sort = buildUnnamed1913();
    o.startDate = 'foo';
    o.startIndex = 42;
  }
  buildCounterMcfDataQuery--;
...
core.List<api.McfDataRowsConversionPathValue> buildUnnamed1914() => [
      buildMcfDataRowsConversionPathValue(),
      buildMcfDataRowsConversionPathValue(),
    ];

void checkUnnamed1914(core.List<api.McfDataRowsConversionPathValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.McfDataRows buildMcfDataRows() {
  ...
  if (buildCounterMcfDataRows < 3) {
    o.conversionPathValue = buildUnnamed1914();
...
void checkMcfDataRows(api.McfDataRows o) {
  buildCounterMcfDataRows++;
  if (buildCounterMcfDataRows < 3) {
    checkUnnamed1914(o.conversionPathValue!);
    unittest.expect(
      o.primitiveValue!,
      unittest.equals('foo'),
    );
...
core.List<api.McfDataRows> buildUnnamed1915() => [
      buildMcfDataRows(),
      buildMcfDataRows(),
    ];

void checkUnnamed1915(core.List<api.McfDataRows> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMcfDataRows(o[0]);
  checkMcfDataRows(o[1]);
}

core.List<core.List<api.McfDataRows>> buildUnnamed1916() => [
      buildUnnamed1915(),
      buildUnnamed1915(),
    ];

void checkUnnamed1916(core.List<core.List<api.McfDataRows>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1915(o[0]);
  checkUnnamed1915(o[1]);
}

core.Map<core.String, core.String> buildUnnamed1917() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed1917(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.McfData buildMcfData() {
  ...
  if (buildCounterMcfData < 3) {
    o.columnHeaders = buildUnnamed1911();
    o.containsSampledData = true;
    o.id = 'foo';
    o.itemsPerPage = 42;
    o.kind = 'foo';
    ...
    o.rows = buildUnnamed1916();
    o.sampleSize = 'foo';
    o.sampleSpace = 'foo';
    o.selfLink = 'foo';
    o.totalResults = 42;
    o.totalsForAllResults = buildUnnamed1917();
  }
  buildCounterMcfData--;
  return o;
}
...
void checkMcfData(api.McfData o) {
  buildCounterMcfData++;
  if (buildCounterMcfData < 3) {
    checkUnnamed1911(o.columnHeaders!);
    unittest.expect(o.containsSampledData!, unittest.isTrue);
    unittest.expect(
      o.id!,
      unittest.equals('foo'),
    ...
    checkUnnamed1917(o.totalsForAllResults!);
  }
  buildCounterMcfData--;
}
...
core.List<api.ProfileFilterLink> buildUnnamed1919() => [
      buildProfileFilterLink(),
      buildProfileFilterLink(),
    ];

void checkUnnamed1919(core.List<api.ProfileFilterLink> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Profile> buildUnnamed1920() => [
      buildProfile(),
      buildProfile(),
    ];

void checkUnnamed1920(core.List<api.Profile> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProfile(o[0]);
  checkProfile(o[1]);
}
...
core.List<api.RealtimeDataColumnHeaders> buildUnnamed1921() => [
      buildRealtimeDataColumnHeaders(),
      buildRealtimeDataColumnHeaders(),
    ];

void checkUnnamed1921(core.List<api.RealtimeDataColumnHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.RealtimeDataQuery buildRealtimeDataQuery() {
  ...
  if (buildCounterRealtimeDataQuery < 3) {
    ...
    o.ids = 'foo';
    o.maxResults = 42;
    o.metrics = buildUnnamed1922();
    o.sort = buildUnnamed1923();
  }
  buildCounterRealtimeDataQuery--;
  return o;
}
...
void checkRealtimeDataQuery(api.RealtimeDataQuery o) {
  ...
  if (buildCounterRealtimeDataQuery < 3) {
    ...
    checkUnnamed1922(o.metrics!);
    checkUnnamed1923(o.sort!);
  }
  buildCounterRealtimeDataQuery--;
}
...
core.List<core.List<core.String>> buildUnnamed1925() => [
      buildUnnamed1924(),
      buildUnnamed1924(),
    ];

void checkUnnamed1925(core.List<core.List<core.String>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.RealtimeData buildRealtimeData() {
  ...
  if (buildCounterRealtimeData < 3) {
    o.columnHeaders = buildUnnamed1921();
    o.id = 'foo';
    o.kind = 'foo';
    o.profileInfo = buildRealtimeDataProfileInfo();
    o.query = buildRealtimeDataQuery();
    o.rows = buildUnnamed1925();
    o.selfLink = 'foo';
    o.totalResults = 42;
    o.totalsForAllResults = buildUnnamed1926();
  }
  buildCounterRealtimeData--;
  return o;
}
...
void checkRealtimeData(api.RealtimeData o) {
  buildCounterRealtimeData++;
  if (buildCounterRealtimeData < 3) {
    checkUnnamed1921(o.columnHeaders!);
    unittest.expect(
      o.id!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed1926(o.totalsForAllResults!);
  }
  buildCounterRealtimeData--;
}
...
core.List<api.LinkedForeignAccount> buildUnnamed1927() => [
      buildLinkedForeignAccount(),
      buildLinkedForeignAccount(),
    ];

void checkUnnamed1927(core.List<api.LinkedForeignAccount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.RemarketingAudience buildRemarketingAudience() {
  ...
  if (buildCounterRemarketingAudience < 3) {
    ...
    o.internalWebPropertyId = 'foo';
    o.kind = 'foo';
    o.linkedAdAccounts = buildUnnamed1927();
    o.linkedViews = buildUnnamed1928();
    o.name = 'foo';
...
void checkRemarketingAudience(api.RemarketingAudience o) {
  ...
  if (buildCounterRemarketingAudience < 3) {
    ...
    checkUnnamed1927(o.linkedAdAccounts!);
    checkUnnamed1928(o.linkedViews!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
core.List<api.RemarketingAudience> buildUnnamed1929() => [
      buildRemarketingAudience(),
      buildRemarketingAudience(),
    ];

void checkUnnamed1929(core.List<api.RemarketingAudience> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Segment> buildUnnamed1930() => [
      buildSegment(),
      buildSegment(),
    ];

void checkUnnamed1930(core.List<api.Segment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSegment(o[0]);
  checkSegment(o[1]);
}
...
core.List<api.UnsampledReport> buildUnnamed1931() => [
      buildUnsampledReport(),
      buildUnsampledReport(),
    ];

void checkUnnamed1931(core.List<api.UnsampledReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Upload> buildUnnamed1933() => [
      buildUpload(),
      buildUpload(),
    ];

void checkUnnamed1933(core.List<api.Upload> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUpload(o[0]);
  checkUpload(o[1]);
}
...
core.List<api.ProfileSummary> buildUnnamed1934() => [
      buildProfileSummary(),
      buildProfileSummary(),
    ];

void checkUnnamed1934(core.List<api.ProfileSummary> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Webproperty> buildUnnamed1935() => [
      buildWebproperty(),
      buildWebproperty(),
    ];

void checkUnnamed1935(core.List<api.Webproperty> o) {
  unittest.expect(o, unittest.hasLength(2));
