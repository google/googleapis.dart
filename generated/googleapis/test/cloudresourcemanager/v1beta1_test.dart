...
import 'package:googleapis/cloudresourcemanager/v1beta1.dart' as api;
...
core.List<api.Organization> buildUnnamed4() => [
  buildOrganization(),
  buildOrganization(),
];

void checkUnnamed4(core.List<api.Organization> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListOrganizationsResponse(api.ListOrganizationsResponse o) {
  ...
  if (buildCounterListOrganizationsResponse < 3) {
    ...
    checkUnnamed4(o.organizations!);
  }
  buildCounterListOrganizationsResponse--;
}

core.List<api.Project> buildUnnamed5() => [buildProject(), buildProject()];

void checkUnnamed5(core.List<api.Project> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProject(o[0]);
  checkProject(o[1]);
}
...
api.Project buildProject() {
  ...
  if (buildCounterProject < 3) {
    o.configuredCapabilities = buildUnnamed8();
    o.createTime = 'foo';
...
void checkProject(api.Project o) {
  buildCounterProject++;
  if (buildCounterProject < 3) {
    checkUnnamed8(o.configuredCapabilities!);
...
void main() {
  ...
  unittest.group('obj-schema-ListOrganizationsResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildListOrganizationsResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListOrganizationsResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
  ...
  unittest.group('resource-OrganizationsResource', () {
    unittest.test('method--get', () async {
      ...
      final response = await res.get(
        arg_name,
        organizationId: arg_organizationId,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildListOrganizationsResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      ...
      checkListOrganizationsResponse(response as api.ListOrganizationsResponse);
    });
    ...
    unittest.test('method--update', () async {
      final mock = HttpServerMock();
      final res = api.CloudResourceManagerApi(mock).organizations;
      final arg_request = buildOrganization();
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Organization.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
  ...
  unittest.group('resource-ProjectsResource', () {
    unittest.test('method--create', () async {
      ...
      final response = await res.create(
        arg_request,
        useLegacyStack: arg_useLegacyStack,
        $fields: arg_$fields,
      );
