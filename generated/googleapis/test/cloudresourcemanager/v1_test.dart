...
checkUnnamed1278(core.List<api.AuditLogConfig> o) {
...
buildAuditConfig() {
  ...
  if (buildCounterAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed1278();
    o.service = "foo";
  }
  buildCounterAuditConfig--;
  return o;
...
checkAuditConfig(api.AuditConfig o) {
  buildCounterAuditConfig++;
  if (buildCounterAuditConfig < 3) {
    checkUnnamed1278(o.auditLogConfigs);
...
buildAuditLogConfig() {
  ...
  if (buildCounterAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed1279();
    o.logType = "foo";
  }
  buildCounterAuditLogConfig--;
  return o;
...
checkAuditLogConfig(api.AuditLogConfig o) {
  buildCounterAuditLogConfig++;
  if (buildCounterAuditLogConfig < 3) {
    checkUnnamed1279(o.exemptedMembers);
...
checkUnnamed1281(core.List<api.Ancestor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAncestor(o[0]);
  checkAncestor(o[1]);
}
...
buildLien() {
  ...
  if (buildCounterLien < 3) {
    ...
    o.parent = "foo";
    o.reason = "foo";
    o.restrictions = buildUnnamed1282();
  }
  buildCounterLien--;
  return o;
}
...
checkLien(api.Lien o) {
  ...
  if (buildCounterLien < 3) {
    ...
    checkUnnamed1282(o.restrictions);
  }
  buildCounterLien--;
}
...
checkUnnamed1283(core.List<api.Constraint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkConstraint(o[0]);
  checkConstraint(o[1]);
}
...
buildListAvailableOrgPolicyConstraintsResponse() {
  ...
  if (buildCounterListAvailableOrgPolicyConstraintsResponse < 3) {
    o.constraints = buildUnnamed1283();
    o.nextPageToken = "foo";
  }
  buildCounterListAvailableOrgPolicyConstraintsResponse--;
  return o;
...
checkListAvailableOrgPolicyConstraintsResponse(
  ...
  buildCounterListAvailableOrgPolicyConstraintsResponse++;
  if (buildCounterListAvailableOrgPolicyConstraintsResponse < 3) {
    checkUnnamed1283(o.constraints);
...
checkUnnamed1284(core.List<api.Lien> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLien(o[0]);
  checkLien(o[1]);
}
...
checkUnnamed1285(core.List<api.OrgPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrgPolicy(o[0]);
  checkOrgPolicy(o[1]);
}
...
buildListPolicy() {
  ...
  if (buildCounterListPolicy < 3) {
    o.allValues = "foo";
    o.allowedValues = buildUnnamed1286();
    o.deniedValues = buildUnnamed1287();
...
checkListPolicy(api.ListPolicy o) {
  ...
  if (buildCounterListPolicy < 3) {
    ...
    checkUnnamed1286(o.allowedValues);
    checkUnnamed1287(o.deniedValues);
...
checkUnnamed1288(core.List<api.Project> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProject(o[0]);
  checkProject(o[1]);
}
...
checkUnnamed1289(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1291(core.List<api.AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1292(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.auditConfigs = buildUnnamed1291();
    o.bindings = buildUnnamed1292();
    o.etag = "foo";
    o.version = 42;
  }
  buildCounterPolicy--;
...
checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed1291(o.auditConfigs);
    checkUnnamed1292(o.bindings);
    unittest.expect(o.etag, unittest.equals('foo'));
    unittest.expect(o.version, unittest.equals(42));
  }
  buildCounterPolicy--;
...
checkUnnamed1294(core.List<api.Organization> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSearchOrganizationsResponse() {
  ...
  if (buildCounterSearchOrganizationsResponse < 3) {
    o.nextPageToken = "foo";
    o.organizations = buildUnnamed1294();
  }
  buildCounterSearchOrganizationsResponse--;
  return o;
}
...
checkSearchOrganizationsResponse(api.SearchOrganizationsResponse o) {
  ...
  if (buildCounterSearchOrganizationsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed1294(o.organizations);
  }
  buildCounterSearchOrganizationsResponse--;
}
...
checkUnnamed1295(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed1296() {
  ...
  o.add(buildUnnamed1295());
  o.add(buildUnnamed1295());
  return o;
}

checkUnnamed1296(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1295(o[0]);
  checkUnnamed1295(o[1]);
}
...
buildTestIamPermissionsRequest() {
  ...
  if (buildCounterTestIamPermissionsRequest < 3) {
    o.permissions = buildUnnamed1297();
  }
  buildCounterTestIamPermissionsRequest--;
  return o;
}
...
checkTestIamPermissionsRequest(api.TestIamPermissionsRequest o) {
  buildCounterTestIamPermissionsRequest++;
  if (buildCounterTestIamPermissionsRequest < 3) {
    checkUnnamed1297(o.permissions);
  }
  buildCounterTestIamPermissionsRequest--;
}
