...
checkUnnamed1948(core.List<api.AuditLogConfig> o) {
...
buildAuditConfig() {
  ...
  if (buildCounterAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed1948();
    o.service = "foo";
  }
  buildCounterAuditConfig--;
  return o;
...
checkAuditConfig(api.AuditConfig o) {
  buildCounterAuditConfig++;
  if (buildCounterAuditConfig < 3) {
    checkUnnamed1948(o.auditLogConfigs);
...
buildAuditLogConfig() {
  ...
  if (buildCounterAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed1949();
    o.logType = "foo";
  }
  buildCounterAuditLogConfig--;
  return o;
...
checkAuditLogConfig(api.AuditLogConfig o) {
  buildCounterAuditLogConfig++;
  if (buildCounterAuditLogConfig < 3) {
    checkUnnamed1949(o.exemptedMembers);
...
checkUnnamed1951(core.List<api.Ancestor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAncestor(o[0]);
  checkAncestor(o[1]);
}
...
buildLien() {
  ...
  if (buildCounterLien < 3) {
    ...
    o.parent = "foo";
    o.reason = "foo";
    o.restrictions = buildUnnamed1952();
  }
  buildCounterLien--;
  return o;
}
...
checkLien(api.Lien o) {
  ...
  if (buildCounterLien < 3) {
    ...
    checkUnnamed1952(o.restrictions);
  }
  buildCounterLien--;
}
...
checkUnnamed1953(core.List<api.Constraint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkConstraint(o[0]);
  checkConstraint(o[1]);
}
...
buildListAvailableOrgPolicyConstraintsResponse() {
  ...
  if (buildCounterListAvailableOrgPolicyConstraintsResponse < 3) {
    o.constraints = buildUnnamed1953();
    o.nextPageToken = "foo";
  }
  buildCounterListAvailableOrgPolicyConstraintsResponse--;
  return o;
...
checkListAvailableOrgPolicyConstraintsResponse(
  ...
  buildCounterListAvailableOrgPolicyConstraintsResponse++;
  if (buildCounterListAvailableOrgPolicyConstraintsResponse < 3) {
    checkUnnamed1953(o.constraints);
...
checkUnnamed1954(core.List<api.Lien> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLien(o[0]);
  checkLien(o[1]);
}
...
checkUnnamed1955(core.List<api.OrgPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrgPolicy(o[0]);
  checkOrgPolicy(o[1]);
}
...
buildListPolicy() {
  ...
  if (buildCounterListPolicy < 3) {
    o.allValues = "foo";
    o.allowedValues = buildUnnamed1956();
    o.deniedValues = buildUnnamed1957();
...
checkListPolicy(api.ListPolicy o) {
  ...
  if (buildCounterListPolicy < 3) {
    ...
    checkUnnamed1956(o.allowedValues);
    checkUnnamed1957(o.deniedValues);
...
checkUnnamed1958(core.List<api.Project> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProject(o[0]);
  checkProject(o[1]);
}
...
checkUnnamed1959(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed1959();
    o.name = "foo";
    o.response = buildUnnamed1960();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed1959(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed1960(o.response);
  }
  buildCounterOperation--;
}
...
checkUnnamed1961(core.List<api.AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1962(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.auditConfigs = buildUnnamed1961();
    o.bindings = buildUnnamed1962();
    o.etag = "foo";
    o.version = 42;
  }
  buildCounterPolicy--;
...
checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed1961(o.auditConfigs);
    checkUnnamed1962(o.bindings);
    unittest.expect(o.etag, unittest.equals('foo'));
    unittest.expect(o.version, unittest.equals(42));
  }
  buildCounterPolicy--;
...
checkUnnamed1963(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1964(core.List<api.Organization> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSearchOrganizationsResponse() {
  ...
  if (buildCounterSearchOrganizationsResponse < 3) {
    o.nextPageToken = "foo";
    o.organizations = buildUnnamed1964();
  }
  buildCounterSearchOrganizationsResponse--;
  return o;
}
...
checkSearchOrganizationsResponse(api.SearchOrganizationsResponse o) {
  ...
  if (buildCounterSearchOrganizationsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed1964(o.organizations);
  }
  buildCounterSearchOrganizationsResponse--;
}
...
checkUnnamed1966(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildTestIamPermissionsResponse() {
  ...
  if (buildCounterTestIamPermissionsResponse < 3) {
    o.permissions = buildUnnamed1968();
  }
  buildCounterTestIamPermissionsResponse--;
  return o;
}
...
checkTestIamPermissionsResponse(api.TestIamPermissionsResponse o) {
  buildCounterTestIamPermissionsResponse++;
  if (buildCounterTestIamPermissionsResponse < 3) {
    checkUnnamed1968(o.permissions);
  }
  buildCounterTestIamPermissionsResponse--;
}
