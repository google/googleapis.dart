...
core.List<api.Ancestor> buildUnnamed3() => [buildAncestor(), buildAncestor()];
...
core.List<api.Lien> buildUnnamed6() => [buildLien(), buildLien()];
...
void main() {
  unittest.group('obj-schema-Ancestor', () {
    unittest.test('to-json--from-json', () async {
      ...
      final od = api.Ancestor.fromJson(
  ...
  unittest.group('obj-schema-ListPolicy', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListPolicy.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkListPolicy(od);
    });
  ...
  unittest.group('obj-schema-ResourceId', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ResourceId.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkResourceId(od);
    });
  ...
  unittest.group('resource-FoldersResource', () {
    unittest.test('method--clearOrgPolicy', () async {
      ...
      final response = await res.clearOrgPolicy(
        arg_request,
        arg_resource,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--getOrgPolicy', () async {
      ...
      final response = await res.getOrgPolicy(
        arg_request,
        arg_resource,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--listOrgPolicies', () async {
      ...
      final response = await res.listOrgPolicies(
        arg_request,
        arg_resource,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--setOrgPolicy', () async {
      ...
      final response = await res.setOrgPolicy(
        arg_request,
        arg_resource,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-ProjectsResource', () {
    ...
    unittest.test('method--getAncestry', () async {
      ...
      final response = await res.getAncestry(
        arg_request,
        arg_projectId,
        $fields: arg_$fields,
      );
