...
api.Folder buildFolder() {
  ...
  if (buildCounterFolder < 3) {
    o.configuredCapabilities = buildUnnamed3();
    o.createTime = 'foo';
    o.displayName = 'foo';
...
void checkFolder(api.Folder o) {
  buildCounterFolder++;
  if (buildCounterFolder < 3) {
    checkUnnamed3(o.configuredCapabilities!);
...
core.List<api.Folder> buildUnnamed5() => [buildFolder(), buildFolder()];
...
core.List<api.Folder> buildUnnamed10() => [buildFolder(), buildFolder()];

void checkUnnamed10(core.List<api.Folder> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFolder(o[0]);
  checkFolder(o[1]);
}
