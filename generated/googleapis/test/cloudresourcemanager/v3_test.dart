...
core.int buildCounterCapability = 0;
api.Capability buildCapability() {
  final o = api.Capability();
  buildCounterCapability++;
  if (buildCounterCapability < 3) {
    o.name = 'foo';
    o.value = true;
  }
  buildCounterCapability--;
...
void checkCapability(api.Capability o) {
  buildCounterCapability++;
  if (buildCounterCapability < 3) {
...
core.int buildCounterEffectiveTagBindingCollection = 0;
api.EffectiveTagBindingCollection buildEffectiveTagBindingCollection() {
  final o = api.EffectiveTagBindingCollection();
  buildCounterEffectiveTagBindingCollection++;
  if (buildCounterEffectiveTagBindingCollection < 3) {
    o.effectiveTags = buildUnnamed3();
...
void checkEffectiveTagBindingCollection(api.EffectiveTagBindingCollection o) {
  buildCounterEffectiveTagBindingCollection++;
  if (buildCounterEffectiveTagBindingCollection < 3) {
    checkUnnamed3(o.effectiveTags!);
...
core.int buildCounterFetchResourceSemanticsResponse = 0;
api.FetchResourceSemanticsResponse buildFetchResourceSemanticsResponse() {
  final o = api.FetchResourceSemanticsResponse();
  buildCounterFetchResourceSemanticsResponse++;
  if (buildCounterFetchResourceSemanticsResponse < 3) {
    o.fullResourceName = 'foo';
    o.semantics = buildUnnamed4();
  }
  buildCounterFetchResourceSemanticsResponse--;
  return o;
}

void checkFetchResourceSemanticsResponse(api.FetchResourceSemanticsResponse o) {
  buildCounterFetchResourceSemanticsResponse++;
  if (buildCounterFetchResourceSemanticsResponse < 3) {
    unittest.expect(o.fullResourceName!, unittest.equals('foo'));
    checkUnnamed4(o.semantics!);
  }
  buildCounterFetchResourceSemanticsResponse--;
}
...
api.Folder buildFolder() {
  ...
  if (buildCounterFolder < 3) {
    o.configuredCapabilities = buildUnnamed5();
    o.createTime = 'foo';
    o.deleteTime = 'foo';
    o.displayName = 'foo';
    o.etag = 'foo';
    o.managementProject = 'foo';
    o.name = 'foo';
    o.parent = 'foo';
    o.state = 'foo';
...
void checkFolder(api.Folder o) {
  buildCounterFolder++;
  if (buildCounterFolder < 3) {
    checkUnnamed5(o.configuredCapabilities!);
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.deleteTime!, unittest.equals('foo'));
    unittest.expect(o.displayName!, unittest.equals('foo'));
    unittest.expect(o.etag!, unittest.equals('foo'));
    unittest.expect(o.managementProject!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
...
void checkLien(api.Lien o) {
  ...
  if (buildCounterLien < 3) {
    ...
    checkUnnamed7(o.restrictions!);
  }
  buildCounterLien--;
}

core.List<api.EffectiveTag> buildUnnamed8() => [
  buildEffectiveTag(),
  buildEffectiveTag(),
];

void checkUnnamed8(core.List<api.EffectiveTag> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListEffectiveTagsResponse(api.ListEffectiveTagsResponse o) {
  buildCounterListEffectiveTagsResponse++;
  if (buildCounterListEffectiveTagsResponse < 3) {
    checkUnnamed8(o.effectiveTags!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListEffectiveTagsResponse--;
}

core.List<api.Folder> buildUnnamed9() => [buildFolder(), buildFolder()];
...
void checkListFoldersResponse(api.ListFoldersResponse o) {
  buildCounterListFoldersResponse++;
  if (buildCounterListFoldersResponse < 3) {
    checkUnnamed9(o.folders!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListFoldersResponse--;
}

core.List<api.Lien> buildUnnamed10() => [buildLien(), buildLien()];

void checkUnnamed10(core.List<api.Lien> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLien(o[0]);
  checkLien(o[1]);
}
...
void checkListLiensResponse(api.ListLiensResponse o) {
  buildCounterListLiensResponse++;
  if (buildCounterListLiensResponse < 3) {
    checkUnnamed10(o.liens!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListLiensResponse--;
}

core.List<api.Project> buildUnnamed11() => [buildProject(), buildProject()];

void checkUnnamed11(core.List<api.Project> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProject(o[0]);
  checkProject(o[1]);
}
...
void checkListProjectsResponse(api.ListProjectsResponse o) {
  ...
  if (buildCounterListProjectsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed11(o.projects!);
  }
  buildCounterListProjectsResponse--;
}

core.List<api.TagBinding> buildUnnamed12() => [
  buildTagBinding(),
  buildTagBinding(),
];

void checkUnnamed12(core.List<api.TagBinding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTagBinding(o[0]);
  checkTagBinding(o[1]);
}
...
void checkListTagBindingsResponse(api.ListTagBindingsResponse o) {
  ...
  if (buildCounterListTagBindingsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed12(o.tagBindings!);
  }
  buildCounterListTagBindingsResponse--;
}

core.List<api.TagHold> buildUnnamed13() => [buildTagHold(), buildTagHold()];

void checkUnnamed13(core.List<api.TagHold> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTagHold(o[0]);
  checkTagHold(o[1]);
}
...
void checkListTagHoldsResponse(api.ListTagHoldsResponse o) {
  ...
  if (buildCounterListTagHoldsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed13(o.tagHolds!);
  }
  buildCounterListTagHoldsResponse--;
}

core.List<api.TagKey> buildUnnamed14() => [buildTagKey(), buildTagKey()];

void checkUnnamed14(core.List<api.TagKey> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTagKey(o[0]);
  checkTagKey(o[1]);
}
...
void checkListTagKeysResponse(api.ListTagKeysResponse o) {
  ...
  if (buildCounterListTagKeysResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed14(o.tagKeys!);
  }
  buildCounterListTagKeysResponse--;
}

core.List<api.TagValue> buildUnnamed15() => [buildTagValue(), buildTagValue()];

void checkUnnamed15(core.List<api.TagValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTagValue(o[0]);
  checkTagValue(o[1]);
}
...
api.Project buildProject() {
  ...
  if (buildCounterProject < 3) {
    o.configuredCapabilities = buildUnnamed20();
    o.createTime = 'foo';
    o.deleteTime = 'foo';
    o.displayName = 'foo';
    o.etag = 'foo';
...
void checkProject(api.Project o) {
  buildCounterProject++;
  if (buildCounterProject < 3) {
    checkUnnamed20(o.configuredCapabilities!);
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.deleteTime!, unittest.equals('foo'));
    unittest.expect(o.displayName!, unittest.equals('foo'));
    unittest.expect(o.etag!, unittest.equals('foo'));
...
core.List<api.Folder> buildUnnamed23() => [buildFolder(), buildFolder()];
...
core.List<api.Organization> buildUnnamed24() => [
  buildOrganization(),
  buildOrganization(),
];

void checkUnnamed24(core.List<api.Organization> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SearchOrganizationsResponse buildSearchOrganizationsResponse() {
  ...
  if (buildCounterSearchOrganizationsResponse < 3) {
    o.nextPageToken = 'foo';
    o.organizations = buildUnnamed24();
  }
  buildCounterSearchOrganizationsResponse--;
  return o;
}
...
void checkSearchOrganizationsResponse(api.SearchOrganizationsResponse o) {
  ...
  if (buildCounterSearchOrganizationsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed24(o.organizations!);
  }
  buildCounterSearchOrganizationsResponse--;
}

core.List<api.Project> buildUnnamed25() => [buildProject(), buildProject()];

void checkUnnamed25(core.List<api.Project> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProject(o[0]);
  checkProject(o[1]);
}
...
void checkTagBinding(api.TagBinding o) {
  ...
  if (buildCounterTagBinding < 3) {
    ...
    unittest.expect(o.parent!, unittest.equals('foo'));
    unittest.expect(o.tagValue!, unittest.equals('foo'));
    unittest.expect(o.tagValueNamespacedName!, unittest.equals('foo'));
  }
  buildCounterTagBinding--;
}
...
core.int buildCounterTagBindingCollection = 0;
api.TagBindingCollection buildTagBindingCollection() {
  final o = api.TagBindingCollection();
  buildCounterTagBindingCollection++;
  if (buildCounterTagBindingCollection < 3) {
    o.etag = 'foo';
    o.fullResourceName = 'foo';
    o.name = 'foo';
...
void checkTagBindingCollection(api.TagBindingCollection o) {
  buildCounterTagBindingCollection++;
  if (buildCounterTagBindingCollection < 3) {
    unittest.expect(o.etag!, unittest.equals('foo'));
    unittest.expect(o.fullResourceName!, unittest.equals('foo'));
...
void checkTagHold(api.TagHold o) {
  ...
  if (buildCounterTagHold < 3) {
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.helpLink!, unittest.equals('foo'));
    unittest.expect(o.holder!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.origin!, unittest.equals('foo'));
  }
  buildCounterTagHold--;
...
void main() {
  ...
  unittest.group('obj-schema-Capability', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCapability();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Capability.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCapability(od);
    });
  ...
  unittest.group('obj-schema-EffectiveTagBindingCollection', () {
    unittest.test('to-json--from-json', () async {
      final o = buildEffectiveTagBindingCollection();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.EffectiveTagBindingCollection.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkEffectiveTagBindingCollection(od);
    });
  });
  ...
  unittest.group('obj-schema-FetchResourceSemanticsResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildFetchResourceSemanticsResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.FetchResourceSemanticsResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkFetchResourceSemanticsResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-TagBinding', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.TagBinding.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkTagBinding(od);
    });
  ...
  unittest.group('obj-schema-TagBindingCollection', () {
    unittest.test('to-json--from-json', () async {
      final o = buildTagBindingCollection();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.TagBindingCollection.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkTagBindingCollection(od);
    });
  });
  ...
  unittest.group('obj-schema-TagValue', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.TagValue.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkTagValue(od);
    });
  ...
  unittest.group('resource-FoldersCapabilitiesResource', () {
    unittest.test('method--get', () async {
      final mock = HttpServerMock();
      final res = api.CloudResourceManagerApi(mock).folders.capabilities;
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildCapability());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.get(arg_name, $fields: arg_$fields);
      checkCapability(response as api.Capability);
    });

    unittest.test('method--patch', () async {
      final mock = HttpServerMock();
      final res = api.CloudResourceManagerApi(mock).folders.capabilities;
      final arg_request = buildCapability();
      final arg_name = 'foo';
      final arg_updateMask = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Capability.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkCapability(obj);
  ...
  unittest.group('resource-LocationsEffectiveTagBindingCollectionsResource', () {
    unittest.test('method--get', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final resp = convert.json.encode(
            buildEffectiveTagBindingCollection(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      ...
      final response = await res.get(arg_name, $fields: arg_$fields);
      checkEffectiveTagBindingCollection(
        response as api.EffectiveTagBindingCollection,
      );
    });
  });
  ...
  unittest.group('resource-LocationsTagBindingCollectionsResource', () {
    unittest.test('method--get', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildTagBindingCollection());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
    ...
    unittest.test('method--patch', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.TagBindingCollection.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkTagBindingCollection(obj);
  ...
  unittest.group('resource-ProjectsResource', () {
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Project.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkProject(obj);
  ...
  unittest.group('resource-TagKeysResource', () {
    ...
    unittest.test('method--getNamespaced', () async {
      ...
      final response = await res.getNamespaced(
        name: arg_name,
        $fields: arg_$fields,
      );
      checkTagKey(response as api.TagKey);
  ...
  unittest.group('resource-TagValuesResource', () {
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.TagValue.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkTagValue(obj);
  ...
  unittest.group('resource-TagValuesTagHoldsResource', () {
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.TagHold.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkTagHold(obj);
  ...
  unittest.group('resource-V3Resource', () {
    unittest.test('method--fetchResourceSemantics', () async {
      final mock = HttpServerMock();
      final res = api.CloudResourceManagerApi(mock).v3;
      final arg_fullResourceName = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final path = req.url.path;
          ...
          unittest.expect(
            ...
            unittest.equals('v3:fetchResourceSemantics'),
          );
          pathOffset += 25;
          ...
          unittest.expect(
            queryMap['fullResourceName']!.first,
            unittest.equals(arg_fullResourceName),
          );
          unittest.expect(
            queryMap['fields']!.first,
            unittest.equals(arg_$fields),
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildFetchResourceSemanticsResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.fetchResourceSemantics(
        fullResourceName: arg_fullResourceName,
        $fields: arg_$fields,
      );
      checkFetchResourceSemanticsResponse(
        response as api.FetchResourceSemanticsResponse,
      );
    });
  });
}
