...
core.List<api.PartnerClaim> buildUnnamed3717() => [
      buildPartnerClaim(),
      buildPartnerClaim(),
    ];

void checkUnnamed3717(core.List<api.PartnerClaim> o) {
...
api.Company buildCompany() {
  ...
  if (buildCounterCompany < 3) {
    o.adminEmails = buildUnnamed3718();
    o.companyId = 'foo';
    o.companyName = 'foo';
    o.languageCode = 'foo';
    o.name = 'foo';
    o.ownerEmails = buildUnnamed3719();
...
void checkCompany(api.Company o) {
  buildCounterCompany++;
  if (buildCounterCompany < 3) {
    checkUnnamed3718(o.adminEmails!);
    unittest.expect(
      o.companyId!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed3719(o.ownerEmails!);
...
core.List<api.Configuration> buildUnnamed3720() => [
      buildConfiguration(),
      buildConfiguration(),
    ];

void checkUnnamed3720(core.List<api.Configuration> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.CustomerListConfigurationsResponse
  ...
  if (buildCounterCustomerListConfigurationsResponse < 3) {
    o.configurations = buildUnnamed3720();
  }
  buildCounterCustomerListConfigurationsResponse--;
  return o;
}
...
void checkCustomerListConfigurationsResponse(
  ...
  buildCounterCustomerListConfigurationsResponse++;
  if (buildCounterCustomerListConfigurationsResponse < 3) {
    checkUnnamed3720(o.configurations!);
  }
  buildCounterCustomerListConfigurationsResponse--;
}

core.List<api.Company> buildUnnamed3721() => [
      buildCompany(),
      buildCompany(),
    ];

void checkUnnamed3721(core.List<api.Company> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCompany(o[0]);
  checkCompany(o[1]);
}
...
core.List<api.Device> buildUnnamed3722() => [
      buildDevice(),
      buildDevice(),
    ];

void checkUnnamed3722(core.List<api.Device> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDevice(o[0]);
  checkDevice(o[1]);
}
...
core.List<api.Dpc> buildUnnamed3723() => [
      buildDpc(),
      buildDpc(),
    ];

void checkUnnamed3723(core.List<api.Dpc> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDpc(o[0]);
  checkDpc(o[1]);
}
...
core.List<api.DeviceClaim> buildUnnamed3724() => [
      buildDeviceClaim(),
      buildDeviceClaim(),
    ];

void checkUnnamed3724(core.List<api.DeviceClaim> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.OperationPerDevice> buildUnnamed3726() => [
      buildOperationPerDevice(),
      buildOperationPerDevice(),
    ];

void checkUnnamed3726(core.List<api.OperationPerDevice> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DevicesLongRunningOperationResponse
  ...
  if (buildCounterDevicesLongRunningOperationResponse < 3) {
    o.perDeviceStatus = buildUnnamed3726();
    o.successCount = 42;
  }
  buildCounterDevicesLongRunningOperationResponse--;
  return o;
...
void checkDevicesLongRunningOperationResponse(
  ...
  buildCounterDevicesLongRunningOperationResponse++;
  if (buildCounterDevicesLongRunningOperationResponse < 3) {
    checkUnnamed3726(o.perDeviceStatus!);
    unittest.expect(
      o.successCount!,
      unittest.equals(42),
    );
...
core.List<api.Device> buildUnnamed3727() => [
      buildDevice(),
      buildDevice(),
    ];

void checkUnnamed3727(core.List<api.Device> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDevice(o[0]);
  checkDevice(o[1]);
}
...
core.List<core.String> buildUnnamed3728() => [
      'foo',
      'foo',
    ];

void checkUnnamed3728(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.Device> buildUnnamed3729() => [
      buildDevice(),
      buildDevice(),
    ];

void checkUnnamed3729(core.List<api.Device> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDevice(o[0]);
  checkDevice(o[1]);
}
...
core.List<api.Company> buildUnnamed3730() => [
      buildCompany(),
      buildCompany(),
    ];

void checkUnnamed3730(core.List<api.Company> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCompany(o[0]);
  checkCompany(o[1]);
}
...
core.List<api.Company> buildUnnamed3731() => [
      buildCompany(),
      buildCompany(),
    ];

void checkUnnamed3731(core.List<api.Company> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCompany(o[0]);
  checkCompany(o[1]);
}
...
core.List<api.Company> buildUnnamed3732() => [
      buildCompany(),
      buildCompany(),
    ];

void checkUnnamed3732(core.List<api.Company> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCompany(o[0]);
  checkCompany(o[1]);
}
...
void checkListVendorsResponse(api.ListVendorsResponse o) {
  ...
  if (buildCounterListVendorsResponse < 3) {
    ...
    checkUnnamed3732(o.vendors!);
  }
  buildCounterListVendorsResponse--;
}

core.Map<core.String, core.Object> buildUnnamed3733() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed3733(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed3733();
    o.name = 'foo';
    o.response = buildUnnamed3734();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error!);
    checkUnnamed3733(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed3734(o.response!);
  }
  buildCounterOperation--;
}
...
core.List<core.Map<core.String, core.Object>> buildUnnamed3736() => [
      buildUnnamed3735(),
      buildUnnamed3735(),
    ];

void checkUnnamed3736(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.PartnerUnclaim> buildUnnamed3737() => [
      buildPartnerUnclaim(),
      buildPartnerUnclaim(),
    ];

void checkUnnamed3737(core.List<api.PartnerUnclaim> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkUnclaimDevicesRequest(api.UnclaimDevicesRequest o) {
  buildCounterUnclaimDevicesRequest++;
  if (buildCounterUnclaimDevicesRequest < 3) {
    checkUnnamed3737(o.unclaims!);
  }
  buildCounterUnclaimDevicesRequest--;
}

core.List<api.UpdateMetadataArguments> buildUnnamed3738() => [
      buildUpdateMetadataArguments(),
      buildUpdateMetadataArguments(),
    ];

void checkUnnamed3738(core.List<api.UpdateMetadataArguments> o) {
  unittest.expect(o, unittest.hasLength(2));
