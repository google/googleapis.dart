...
void main() {
  ...
  unittest.group('resource-OrganizationsLocationsGlobalTenantsResource', () {
    unittest.test('method--getIamPolicy', () async {
      final mock = HttpServerMock();
      final res =
          api.BeyondCorpApi(mock).organizations.locations.global.tenants;
  ...
  unittest.group(
      'resource-OrganizationsLocationsGlobalTenantsProxyConfigsResource', () {
    unittest.test('method--getIamPolicy', () async {
      final mock = HttpServerMock();
