...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed6271();
    o.name = 'foo';
    o.response = buildUnnamed6272();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error!);
    checkUnnamed6271(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed6272(o.response!);
  }
  buildCounterOperation--;
}
...
core.List<core.Map<core.String, core.Object>> buildUnnamed6274() {
  final o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed6273());
  o.add(buildUnnamed6273());
  return o;
}

void checkUnnamed6274(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed6273(o[0]);
  checkUnnamed6273(o[1]);
}
...
core.List<api.V2AndroidApplication> buildUnnamed6275() {
  final o = <api.V2AndroidApplication>[];
...
void checkUnnamed6275(core.List<api.V2AndroidApplication> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.V2AndroidKeyRestrictions buildV2AndroidKeyRestrictions() {
  ...
  if (buildCounterV2AndroidKeyRestrictions < 3) {
    o.allowedApplications = buildUnnamed6275();
  }
  buildCounterV2AndroidKeyRestrictions--;
  return o;
}
...
void checkV2AndroidKeyRestrictions(api.V2AndroidKeyRestrictions o) {
  buildCounterV2AndroidKeyRestrictions++;
  if (buildCounterV2AndroidKeyRestrictions < 3) {
    checkUnnamed6275(o.allowedApplications!);
  }
  buildCounterV2AndroidKeyRestrictions--;
}

core.List<core.String> buildUnnamed6276() {
  final o = <core.String>[];
  o.add('foo');
  o.add('foo');
  return o;
...
void checkUnnamed6276(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.V2BrowserKeyRestrictions buildV2BrowserKeyRestrictions() {
  ...
  if (buildCounterV2BrowserKeyRestrictions < 3) {
    o.allowedReferrers = buildUnnamed6277();
  }
  buildCounterV2BrowserKeyRestrictions--;
  return o;
}
...
void checkV2BrowserKeyRestrictions(api.V2BrowserKeyRestrictions o) {
  buildCounterV2BrowserKeyRestrictions++;
  if (buildCounterV2BrowserKeyRestrictions < 3) {
    checkUnnamed6277(o.allowedReferrers!);
  }
  buildCounterV2BrowserKeyRestrictions--;
}
...
api.V2IosKeyRestrictions buildV2IosKeyRestrictions() {
  ...
  if (buildCounterV2IosKeyRestrictions < 3) {
    o.allowedBundleIds = buildUnnamed6278();
  }
  buildCounterV2IosKeyRestrictions--;
  return o;
}
...
void checkV2IosKeyRestrictions(api.V2IosKeyRestrictions o) {
  buildCounterV2IosKeyRestrictions++;
  if (buildCounterV2IosKeyRestrictions < 3) {
    checkUnnamed6278(o.allowedBundleIds!);
  }
  buildCounterV2IosKeyRestrictions--;
}
...
core.List<api.V2Key> buildUnnamed6279() {
  final o = <api.V2Key>[];
  o.add(buildV2Key());
  o.add(buildV2Key());
  return o;
...
void checkUnnamed6279(core.List<api.V2Key> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkV2Key(o[0]);
  checkV2Key(o[1]);
}
...
core.List<api.V2ApiTarget> buildUnnamed6280() {
  final o = <api.V2ApiTarget>[];
...
void checkUnnamed6280(core.List<api.V2ApiTarget> o) {
  unittest.expect(o, unittest.hasLength(2));
