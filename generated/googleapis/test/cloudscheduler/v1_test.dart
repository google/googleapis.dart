...
core.Map<core.String, core.String> buildUnnamed5748() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed5748(core.Map<core.String, core.String> o) {
...
core.Map<core.String, core.String> buildUnnamed5749() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed5749(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.Job> buildUnnamed5750() => [
      buildJob(),
      buildJob(),
    ];

void checkUnnamed5750(core.List<api.Job> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJob(o[0]);
  checkJob(o[1]);
}
...
core.List<api.Location> buildUnnamed5751() => [
      buildLocation(),
      buildLocation(),
    ];

void checkUnnamed5751(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
core.Map<core.String, core.String> buildUnnamed5752() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed5752(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.Location buildLocation() {
  ...
  if (buildCounterLocation < 3) {
    o.displayName = 'foo';
    o.labels = buildUnnamed5752();
    o.locationId = 'foo';
    o.metadata = buildUnnamed5753();
    o.name = 'foo';
  }
  buildCounterLocation--;
  return o;
...
void checkLocation(api.Location o) {
  ...
  if (buildCounterLocation < 3) {
    ...
    checkUnnamed5752(o.labels!);
    unittest.expect(
      o.locationId!,
      unittest.equals('foo'),
    );
    checkUnnamed5753(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.String> buildUnnamed5754() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed5754(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<core.Map<core.String, core.Object>> buildUnnamed5757() => [
      buildUnnamed5756(),
      buildUnnamed5756(),
    ];

void checkUnnamed5757(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed5756(o[0]);
  checkUnnamed5756(o[1]);
}
