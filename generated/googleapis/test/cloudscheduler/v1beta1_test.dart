...
import 'package:googleapis/cloudscheduler/v1beta1.dart' as api;
...
void checkJob(api.Job o) {
  ...
  if (buildCounterJob < 3) {
    ...
    unittest.expect(o.legacyAppEngineCron!, unittest.isTrue);
...
void main() {
  ...
  unittest.group('resource-ProjectsLocationsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final res = api.CloudSchedulerApi(mock).projects.locations;
      final arg_name = 'foo';
      final arg_extraLocationTypes = buildUnnamed9();
  ...
  unittest.group('resource-ProjectsLocationsJobsResource', () {
    ...
    unittest.test('method--delete', () async {
      ...
      final res = api.CloudSchedulerApi(mock).projects.locations.jobs;
      final arg_name = 'foo';
      final arg_legacyAppEngineCron = true;
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final path = req.url.path;
          ...
          unittest.expect(
            queryMap['legacyAppEngineCron']!.first,
            unittest.equals('$arg_legacyAppEngineCron'),
          );
          unittest.expect(
            queryMap['fields']!.first,
            unittest.equals(arg_$fields),
      ...
      final response = await res.delete(
        arg_name,
        legacyAppEngineCron: arg_legacyAppEngineCron,
        $fields: arg_$fields,
      );
