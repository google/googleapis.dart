...
checkUnnamed3501(core.List<api.DynamicLinkWarning> o) {
...
checkUnnamed3502(core.List<api.DynamicLinkWarning> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDynamicLinkWarning(o[0]);
  checkDynamicLinkWarning(o[1]);
}
...
checkUnnamed3503(core.List<api.DynamicLinkEventStat> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildDynamicLinkStats() {
  ...
  if (buildCounterDynamicLinkStats < 3) {
    o.linkEventStats = buildUnnamed3503();
  }
  buildCounterDynamicLinkStats--;
  return o;
}
...
checkDynamicLinkStats(api.DynamicLinkStats o) {
  buildCounterDynamicLinkStats++;
  if (buildCounterDynamicLinkStats < 3) {
    checkUnnamed3503(o.linkEventStats);
  }
  buildCounterDynamicLinkStats--;
}
...
buildManagedShortLink() {
  ...
  if (buildCounterManagedShortLink < 3) {
    o.creationTime = "foo";
    o.flaggedAttribute = buildUnnamed3504();
...
checkManagedShortLink(api.ManagedShortLink o) {
  ...
  if (buildCounterManagedShortLink < 3) {
    ...
    checkUnnamed3504(o.flaggedAttribute);
