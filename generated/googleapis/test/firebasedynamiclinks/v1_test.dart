...
core.List<api.DynamicLinkWarning> buildUnnamed3153() {
...
void checkUnnamed3153(core.List<api.DynamicLinkWarning> o) {
...
core.List<api.DynamicLinkWarning> buildUnnamed3154() {
  var o = <api.DynamicLinkWarning>[];
  o.add(buildDynamicLinkWarning());
  o.add(buildDynamicLinkWarning());
  return o;
...
void checkUnnamed3154(core.List<api.DynamicLinkWarning> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDynamicLinkWarning(o[0] as api.DynamicLinkWarning);
  checkDynamicLinkWarning(o[1] as api.DynamicLinkWarning);
}
...
core.List<api.DynamicLinkEventStat> buildUnnamed3155() {
  var o = <api.DynamicLinkEventStat>[];
...
void checkUnnamed3155(core.List<api.DynamicLinkEventStat> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DynamicLinkStats buildDynamicLinkStats() {
  ...
  if (buildCounterDynamicLinkStats < 3) {
    o.linkEventStats = buildUnnamed3155();
  }
  buildCounterDynamicLinkStats--;
  return o;
}
...
void checkDynamicLinkStats(api.DynamicLinkStats o) {
  buildCounterDynamicLinkStats++;
  if (buildCounterDynamicLinkStats < 3) {
    checkUnnamed3155(o.linkEventStats);
  }
  buildCounterDynamicLinkStats--;
}
...
api.ManagedShortLink buildManagedShortLink() {
  ...
  if (buildCounterManagedShortLink < 3) {
    o.creationTime = 'foo';
    o.flaggedAttribute = buildUnnamed3156();
...
void checkManagedShortLink(api.ManagedShortLink o) {
  ...
  if (buildCounterManagedShortLink < 3) {
    ...
    checkUnnamed3156(o.flaggedAttribute);
