...
core.List<api.DynamicLinkWarning> buildUnnamed120() => [
      buildDynamicLinkWarning(),
      buildDynamicLinkWarning(),
    ];

void checkUnnamed120(core.List<api.DynamicLinkWarning> o) {
...
core.List<api.DynamicLinkWarning> buildUnnamed121() => [
      buildDynamicLinkWarning(),
      buildDynamicLinkWarning(),
    ];

void checkUnnamed121(core.List<api.DynamicLinkWarning> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDynamicLinkWarning(o[0]);
  checkDynamicLinkWarning(o[1]);
}
...
core.List<api.DynamicLinkEventStat> buildUnnamed122() => [
      buildDynamicLinkEventStat(),
      buildDynamicLinkEventStat(),
    ];

void checkUnnamed122(core.List<api.DynamicLinkEventStat> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DynamicLinkStats buildDynamicLinkStats() {
  ...
  if (buildCounterDynamicLinkStats < 3) {
    o.linkEventStats = buildUnnamed122();
  }
  buildCounterDynamicLinkStats--;
  return o;
}
...
void checkDynamicLinkStats(api.DynamicLinkStats o) {
  buildCounterDynamicLinkStats++;
  if (buildCounterDynamicLinkStats < 3) {
    checkUnnamed122(o.linkEventStats!);
  }
  buildCounterDynamicLinkStats--;
}
...
api.ManagedShortLink buildManagedShortLink() {
  ...
  if (buildCounterManagedShortLink < 3) {
    o.creationTime = 'foo';
    o.flaggedAttribute = buildUnnamed123();
...
void checkManagedShortLink(api.ManagedShortLink o) {
  ...
  if (buildCounterManagedShortLink < 3) {
    ...
    checkUnnamed123(o.flaggedAttribute!);
