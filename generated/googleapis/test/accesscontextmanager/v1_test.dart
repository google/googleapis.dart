...
core.List<api.MethodSelector> buildUnnamed6448() {
...
void checkUnnamed6448(core.List<api.MethodSelector> o) {
...
api.ApiOperation buildApiOperation() {
  ...
  if (buildCounterApiOperation < 3) {
    o.methodSelectors = buildUnnamed6448();
    o.serviceName = 'foo';
  }
  buildCounterApiOperation--;
  return o;
...
void checkApiOperation(api.ApiOperation o) {
  buildCounterApiOperation++;
  if (buildCounterApiOperation < 3) {
    checkUnnamed6448(o.methodSelectors!);
    unittest.expect(
      o.serviceName!,
      unittest.equals('foo'),
    );
...
core.List<api.Condition> buildUnnamed6449() {
  var o = <api.Condition>[];
...
void checkUnnamed6449(core.List<api.Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ServicePerimeter> buildUnnamed6450() {
...
void checkUnnamed6450(core.List<api.ServicePerimeter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.CommitServicePerimetersResponse buildCommitServicePerimetersResponse() {
  ...
  if (buildCounterCommitServicePerimetersResponse < 3) {
    o.servicePerimeters = buildUnnamed6450();
  }
  buildCounterCommitServicePerimetersResponse--;
  return o;
}
...
void checkCommitServicePerimetersResponse(
  ...
  buildCounterCommitServicePerimetersResponse++;
  if (buildCounterCommitServicePerimetersResponse < 3) {
    checkUnnamed6450(o.servicePerimeters!);
  }
  buildCounterCommitServicePerimetersResponse--;
}
...
api.Condition buildCondition() {
  ...
  if (buildCounterCondition < 3) {
    ...
    o.ipSubnetworks = buildUnnamed6451();
    o.members = buildUnnamed6452();
    o.negate = true;
    o.regions = buildUnnamed6453();
    o.requiredAccessLevels = buildUnnamed6454();
  }
  buildCounterCondition--;
  return o;
}
...
void checkCondition(api.Condition o) {
  ...
  if (buildCounterCondition < 3) {
    ...
    checkUnnamed6451(o.ipSubnetworks!);
    checkUnnamed6452(o.members!);
    unittest.expect(o.negate!, unittest.isTrue);
    checkUnnamed6453(o.regions!);
    checkUnnamed6454(o.requiredAccessLevels!);
  }
  buildCounterCondition--;
}
...
core.List<api.OsConstraint> buildUnnamed6457() {
...
void checkUnnamed6457(core.List<api.OsConstraint> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DevicePolicy buildDevicePolicy() {
  ...
  if (buildCounterDevicePolicy < 3) {
    o.allowedDeviceManagementLevels = buildUnnamed6455();
    o.allowedEncryptionStatuses = buildUnnamed6456();
    o.osConstraints = buildUnnamed6457();
...
void checkDevicePolicy(api.DevicePolicy o) {
  buildCounterDevicePolicy++;
  if (buildCounterDevicePolicy < 3) {
    checkUnnamed6455(o.allowedDeviceManagementLevels!);
    checkUnnamed6456(o.allowedEncryptionStatuses!);
    checkUnnamed6457(o.osConstraints!);
...
core.List<api.ApiOperation> buildUnnamed6459() {
  var o = <api.ApiOperation>[];
...
void checkUnnamed6459(core.List<api.ApiOperation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GcpUserAccessBinding buildGcpUserAccessBinding() {
  ...
  if (buildCounterGcpUserAccessBinding < 3) {
    o.accessLevels = buildUnnamed6461();
    o.groupKey = 'foo';
    o.name = 'foo';
  }
  buildCounterGcpUserAccessBinding--;
...
void checkGcpUserAccessBinding(api.GcpUserAccessBinding o) {
  buildCounterGcpUserAccessBinding++;
  if (buildCounterGcpUserAccessBinding < 3) {
    checkUnnamed6461(o.accessLevels!);
    unittest.expect(
      o.groupKey!,
      unittest.equals('foo'),
    );
...
core.List<api.IngressSource> buildUnnamed6463() {
...
void checkUnnamed6463(core.List<api.IngressSource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.IngressFrom buildIngressFrom() {
  ...
  if (buildCounterIngressFrom < 3) {
    o.identities = buildUnnamed6462();
    o.identityType = 'foo';
    o.sources = buildUnnamed6463();
  }
  buildCounterIngressFrom--;
  return o;
}
...
void checkIngressFrom(api.IngressFrom o) {
  buildCounterIngressFrom++;
  if (buildCounterIngressFrom < 3) {
    checkUnnamed6462(o.identities!);
    unittest.expect(
      o.identityType!,
      unittest.equals('foo'),
    );
    checkUnnamed6463(o.sources!);
  }
  buildCounterIngressFrom--;
}
...
core.List<api.ApiOperation> buildUnnamed6464() {
  var o = <api.ApiOperation>[];
  o.add(buildApiOperation());
  o.add(buildApiOperation());
  return o;
...
void checkUnnamed6464(core.List<api.ApiOperation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApiOperation(o[0] as api.ApiOperation);
  checkApiOperation(o[1] as api.ApiOperation);
}
...
void checkIngressTo(api.IngressTo o) {
  buildCounterIngressTo++;
  if (buildCounterIngressTo < 3) {
    checkUnnamed6464(o.operations!);
    checkUnnamed6465(o.resources!);
  }
  buildCounterIngressTo--;
}

core.List<api.AccessLevel> buildUnnamed6466() {
  var o = <api.AccessLevel>[];
...
void checkUnnamed6466(core.List<api.AccessLevel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListAccessLevelsResponse buildListAccessLevelsResponse() {
  ...
  if (buildCounterListAccessLevelsResponse < 3) {
    o.accessLevels = buildUnnamed6466();
    o.nextPageToken = 'foo';
  }
  buildCounterListAccessLevelsResponse--;
  return o;
...
void checkListAccessLevelsResponse(api.ListAccessLevelsResponse o) {
  buildCounterListAccessLevelsResponse++;
  if (buildCounterListAccessLevelsResponse < 3) {
    checkUnnamed6466(o.accessLevels!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.AccessPolicy> buildUnnamed6467() {
  var o = <api.AccessPolicy>[];
...
void checkUnnamed6467(core.List<api.AccessPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListAccessPoliciesResponse buildListAccessPoliciesResponse() {
  ...
  if (buildCounterListAccessPoliciesResponse < 3) {
    o.accessPolicies = buildUnnamed6467();
    o.nextPageToken = 'foo';
  }
  buildCounterListAccessPoliciesResponse--;
  return o;
...
void checkListAccessPoliciesResponse(api.ListAccessPoliciesResponse o) {
  buildCounterListAccessPoliciesResponse++;
  if (buildCounterListAccessPoliciesResponse < 3) {
    checkUnnamed6467(o.accessPolicies!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.GcpUserAccessBinding> buildUnnamed6468() {
  var o = <api.GcpUserAccessBinding>[];
...
void checkUnnamed6468(core.List<api.GcpUserAccessBinding> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListGcpUserAccessBindingsResponse buildListGcpUserAccessBindingsResponse() {
  ...
  if (buildCounterListGcpUserAccessBindingsResponse < 3) {
    o.gcpUserAccessBindings = buildUnnamed6468();
    o.nextPageToken = 'foo';
  }
  buildCounterListGcpUserAccessBindingsResponse--;
  return o;
...
void checkListGcpUserAccessBindingsResponse(
  ...
  buildCounterListGcpUserAccessBindingsResponse++;
  if (buildCounterListGcpUserAccessBindingsResponse < 3) {
    checkUnnamed6468(o.gcpUserAccessBindings!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Operation> buildUnnamed6469() {
  var o = <api.Operation>[];
...
void checkUnnamed6469(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListOperationsResponse(api.ListOperationsResponse o) {
  ...
  if (buildCounterListOperationsResponse < 3) {
    ...
    checkUnnamed6469(o.operations!);
  }
  buildCounterListOperationsResponse--;
}

core.List<api.ServicePerimeter> buildUnnamed6470() {
  var o = <api.ServicePerimeter>[];
  o.add(buildServicePerimeter());
  o.add(buildServicePerimeter());
  return o;
...
void checkUnnamed6470(core.List<api.ServicePerimeter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkServicePerimeter(o[0] as api.ServicePerimeter);
  checkServicePerimeter(o[1] as api.ServicePerimeter);
}
...
api.ListServicePerimetersResponse buildListServicePerimetersResponse() {
  ...
  if (buildCounterListServicePerimetersResponse < 3) {
    o.nextPageToken = 'foo';
    o.servicePerimeters = buildUnnamed6470();
  }
  buildCounterListServicePerimetersResponse--;
  return o;
}
...
void checkListServicePerimetersResponse(api.ListServicePerimetersResponse o) {
  ...
  if (buildCounterListServicePerimetersResponse < 3) {
    ...
    checkUnnamed6470(o.servicePerimeters!);
  }
  buildCounterListServicePerimetersResponse--;
}
...
core.Map<core.String, core.Object> buildUnnamed6471() {
...
void checkUnnamed6471(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.AccessLevel> buildUnnamed6473() {
  var o = <api.AccessLevel>[];
  o.add(buildAccessLevel());
  o.add(buildAccessLevel());
  return o;
...
void checkUnnamed6473(core.List<api.AccessLevel> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAccessLevel(o[0] as api.AccessLevel);
  checkAccessLevel(o[1] as api.AccessLevel);
}
...
api.ReplaceAccessLevelsRequest buildReplaceAccessLevelsRequest() {
  ...
  if (buildCounterReplaceAccessLevelsRequest < 3) {
    o.accessLevels = buildUnnamed6473();
    o.etag = 'foo';
  }
  buildCounterReplaceAccessLevelsRequest--;
  return o;
...
void checkReplaceAccessLevelsRequest(api.ReplaceAccessLevelsRequest o) {
  buildCounterReplaceAccessLevelsRequest++;
  if (buildCounterReplaceAccessLevelsRequest < 3) {
    checkUnnamed6473(o.accessLevels!);
    unittest.expect(
      o.etag!,
      unittest.equals('foo'),
    );
...
core.List<api.AccessLevel> buildUnnamed6474() {
  var o = <api.AccessLevel>[];
  o.add(buildAccessLevel());
  o.add(buildAccessLevel());
  return o;
...
void checkUnnamed6474(core.List<api.AccessLevel> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAccessLevel(o[0] as api.AccessLevel);
  checkAccessLevel(o[1] as api.AccessLevel);
}
...
api.ReplaceAccessLevelsResponse buildReplaceAccessLevelsResponse() {
  ...
  if (buildCounterReplaceAccessLevelsResponse < 3) {
    o.accessLevels = buildUnnamed6474();
  }
  buildCounterReplaceAccessLevelsResponse--;
  return o;
}
...
void checkReplaceAccessLevelsResponse(api.ReplaceAccessLevelsResponse o) {
  buildCounterReplaceAccessLevelsResponse++;
  if (buildCounterReplaceAccessLevelsResponse < 3) {
    checkUnnamed6474(o.accessLevels!);
  }
  buildCounterReplaceAccessLevelsResponse--;
}

core.List<api.ServicePerimeter> buildUnnamed6475() {
  var o = <api.ServicePerimeter>[];
  o.add(buildServicePerimeter());
  o.add(buildServicePerimeter());
  return o;
...
void checkUnnamed6475(core.List<api.ServicePerimeter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkServicePerimeter(o[0] as api.ServicePerimeter);
  checkServicePerimeter(o[1] as api.ServicePerimeter);
}
...
api.ReplaceServicePerimetersRequest buildReplaceServicePerimetersRequest() {
  ...
  if (buildCounterReplaceServicePerimetersRequest < 3) {
    o.etag = 'foo';
    o.servicePerimeters = buildUnnamed6475();
  }
  buildCounterReplaceServicePerimetersRequest--;
  return o;
}
...
void checkReplaceServicePerimetersRequest(
  ...
  if (buildCounterReplaceServicePerimetersRequest < 3) {
    ...
    checkUnnamed6475(o.servicePerimeters!);
  }
  buildCounterReplaceServicePerimetersRequest--;
}

core.List<api.ServicePerimeter> buildUnnamed6476() {
  var o = <api.ServicePerimeter>[];
  o.add(buildServicePerimeter());
  o.add(buildServicePerimeter());
  return o;
...
void checkUnnamed6476(core.List<api.ServicePerimeter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkServicePerimeter(o[0] as api.ServicePerimeter);
  checkServicePerimeter(o[1] as api.ServicePerimeter);
}
...
api.ReplaceServicePerimetersResponse buildReplaceServicePerimetersResponse() {
  ...
  if (buildCounterReplaceServicePerimetersResponse < 3) {
    o.servicePerimeters = buildUnnamed6476();
  }
  buildCounterReplaceServicePerimetersResponse--;
  return o;
}
...
void checkReplaceServicePerimetersResponse(
  ...
  buildCounterReplaceServicePerimetersResponse++;
  if (buildCounterReplaceServicePerimetersResponse < 3) {
    checkUnnamed6476(o.servicePerimeters!);
  }
  buildCounterReplaceServicePerimetersResponse--;
}
...
core.List<api.EgressPolicy> buildUnnamed6478() {
  var o = <api.EgressPolicy>[];
...
void checkUnnamed6478(core.List<api.EgressPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEgressPolicy(o[0] as api.EgressPolicy);
  checkEgressPolicy(o[1] as api.EgressPolicy);
}

core.List<api.IngressPolicy> buildUnnamed6479() {
  var o = <api.IngressPolicy>[];
...
void checkUnnamed6479(core.List<api.IngressPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ServicePerimeterConfig buildServicePerimeterConfig() {
  ...
  if (buildCounterServicePerimeterConfig < 3) {
    o.accessLevels = buildUnnamed6477();
    o.egressPolicies = buildUnnamed6478();
    o.ingressPolicies = buildUnnamed6479();
    o.resources = buildUnnamed6480();
    o.restrictedServices = buildUnnamed6481();
...
void checkServicePerimeterConfig(api.ServicePerimeterConfig o) {
  buildCounterServicePerimeterConfig++;
  if (buildCounterServicePerimeterConfig < 3) {
    checkUnnamed6477(o.accessLevels!);
    checkUnnamed6478(o.egressPolicies!);
    checkUnnamed6479(o.ingressPolicies!);
    checkUnnamed6480(o.resources!);
    checkUnnamed6481(o.restrictedServices!);
...
core.List<core.Map<core.String, core.Object>> buildUnnamed6483() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed6482());
  o.add(buildUnnamed6482());
  return o;
}

void checkUnnamed6483(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed6482(o[0]);
  checkUnnamed6482(o[1]);
}
...
api.VpcAccessibleServices buildVpcAccessibleServices() {
  ...
  if (buildCounterVpcAccessibleServices < 3) {
    o.allowedServices = buildUnnamed6484();
...
void checkVpcAccessibleServices(api.VpcAccessibleServices o) {
  buildCounterVpcAccessibleServices++;
  if (buildCounterVpcAccessibleServices < 3) {
    checkUnnamed6484(o.allowedServices!);
