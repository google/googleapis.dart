...
checkUnnamed618(core.List<api.Stats> o) {
...
checkUnnamed619(core.List<api.DoubleValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed620(core.List<api.IntValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIntValue(o[0]);
  checkIntValue(o[1]);
}
...
checkUnnamed621(core.List<api.StringValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildStats() {
  ...
  if (buildCounterStats < 3) {
    o.doubleValues = buildUnnamed619();
    o.intValues = buildUnnamed620();
    o.stringValues = buildUnnamed621();
    o.time = 42.0;
  }
  buildCounterStats--;
  return o;
...
checkStats(api.Stats o) {
  buildCounterStats++;
  if (buildCounterStats < 3) {
    checkUnnamed619(o.doubleValues);
    checkUnnamed620(o.intValues);
    checkUnnamed621(o.stringValues);
