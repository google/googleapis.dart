...
core.List<api.Parameter> buildUnnamed5735() => [
      buildParameter(),
      buildParameter(),
    ];

void checkUnnamed5735(core.List<api.Parameter> o) {
...
core.List<api.Parameter> buildUnnamed5736() => [
      buildParameter(),
      buildParameter(),
    ];

void checkUnnamed5736(core.List<api.Parameter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkParameter(o[0]);
  checkParameter(o[1]);
}
...
api.Container buildContainer() {
  ...
  if (buildCounterContainer < 3) {
    ...
    o.publicId = 'foo';
    o.tagManagerUrl = 'foo';
    o.usageContext = buildUnnamed5738();
  }
  buildCounterContainer--;
  return o;
}
...
void checkContainer(api.Container o) {
  ...
  if (buildCounterContainer < 3) {
    ...
    checkUnnamed5738(o.usageContext!);
  }
  buildCounterContainer--;
}
...
core.List<api.BuiltInVariable> buildUnnamed5739() => [
      buildBuiltInVariable(),
      buildBuiltInVariable(),
    ];

void checkUnnamed5739(core.List<api.BuiltInVariable> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuiltInVariable(o[0]);
  checkBuiltInVariable(o[1]);
}

core.List<api.Client> buildUnnamed5740() => [
      buildClient(),
      buildClient(),
    ];

void checkUnnamed5740(core.List<api.Client> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkClient(o[0]);
  checkClient(o[1]);
}

core.List<api.CustomTemplate> buildUnnamed5741() => [
      buildCustomTemplate(),
      buildCustomTemplate(),
    ];

void checkUnnamed5741(core.List<api.CustomTemplate> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCustomTemplate(o[0]);
  checkCustomTemplate(o[1]);
}

core.List<api.Folder> buildUnnamed5742() => [
      buildFolder(),
      buildFolder(),
    ];

void checkUnnamed5742(core.List<api.Folder> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFolder(o[0]);
  checkFolder(o[1]);
}

core.List<api.Tag> buildUnnamed5743() => [
      buildTag(),
      buildTag(),
    ];

void checkUnnamed5743(core.List<api.Tag> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTag(o[0]);
  checkTag(o[1]);
}

core.List<api.Trigger> buildUnnamed5744() => [
      buildTrigger(),
      buildTrigger(),
    ];

void checkUnnamed5744(core.List<api.Trigger> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTrigger(o[0]);
  checkTrigger(o[1]);
}

core.List<api.Variable> buildUnnamed5745() => [
      buildVariable(),
      buildVariable(),
    ];

void checkUnnamed5745(core.List<api.Variable> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVariable(o[0]);
  checkVariable(o[1]);
}

core.List<api.Zone> buildUnnamed5746() => [
      buildZone(),
      buildZone(),
    ];

void checkUnnamed5746(core.List<api.Zone> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkZone(o[0]);
  checkZone(o[1]);
}
...
api.ContainerVersion buildContainerVersion() {
  ...
  if (buildCounterContainerVersion < 3) {
    o.accountId = 'foo';
    o.builtInVariable = buildUnnamed5739();
    o.client = buildUnnamed5740();
    o.container = buildContainer();
    o.containerId = 'foo';
    o.containerVersionId = 'foo';
    o.customTemplate = buildUnnamed5741();
    o.deleted = true;
    o.description = 'foo';
    o.fingerprint = 'foo';
    o.folder = buildUnnamed5742();
    o.name = 'foo';
    o.path = 'foo';
    o.tag = buildUnnamed5743();
    o.tagManagerUrl = 'foo';
    o.trigger = buildUnnamed5744();
    o.variable = buildUnnamed5745();
    o.zone = buildUnnamed5746();
  }
  buildCounterContainerVersion--;
  return o;
}
...
void checkContainerVersion(api.ContainerVersion o) {
  ...
  if (buildCounterContainerVersion < 3) {
    ...
    checkUnnamed5739(o.builtInVariable!);
    checkUnnamed5740(o.client!);
    ...
    checkUnnamed5741(o.customTemplate!);
    ...
    checkUnnamed5743(o.tag!);
    unittest.expect(
      o.tagManagerUrl!,
      unittest.equals('foo'),
    );
    checkUnnamed5744(o.trigger!);
    checkUnnamed5745(o.variable!);
    checkUnnamed5746(o.zone!);
  }
  buildCounterContainerVersion--;
}
...
core.List<api.BuiltInVariable> buildUnnamed5747() => [
      buildBuiltInVariable(),
      buildBuiltInVariable(),
    ];

void checkUnnamed5747(core.List<api.BuiltInVariable> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuiltInVariable(o[0]);
  checkBuiltInVariable(o[1]);
}
...
api.CreateBuiltInVariableResponse buildCreateBuiltInVariableResponse() {
  ...
  if (buildCounterCreateBuiltInVariableResponse < 3) {
    o.builtInVariable = buildUnnamed5747();
  }
  buildCounterCreateBuiltInVariableResponse--;
  return o;
}
...
void checkCreateBuiltInVariableResponse(api.CreateBuiltInVariableResponse o) {
  buildCounterCreateBuiltInVariableResponse++;
  if (buildCounterCreateBuiltInVariableResponse < 3) {
    checkUnnamed5747(o.builtInVariable!);
  }
  buildCounterCreateBuiltInVariableResponse--;
}
...
core.List<api.Trigger> buildUnnamed5749() => [
      buildTrigger(),
      buildTrigger(),
    ];

void checkUnnamed5749(core.List<api.Trigger> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTrigger(o[0]);
  checkTrigger(o[1]);
}

core.List<api.Variable> buildUnnamed5750() => [
      buildVariable(),
      buildVariable(),
    ];

void checkUnnamed5750(core.List<api.Variable> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVariable(o[0]);
  checkVariable(o[1]);
}
...
api.FolderEntities buildFolderEntities() {
  ...
  if (buildCounterFolderEntities < 3) {
    ...
    o.trigger = buildUnnamed5749();
    o.variable = buildUnnamed5750();
  }
  buildCounterFolderEntities--;
  return o;
}
...
void checkFolderEntities(api.FolderEntities o) {
  ...
  if (buildCounterFolderEntities < 3) {
    ...
    checkUnnamed5749(o.trigger!);
    checkUnnamed5750(o.variable!);
  }
  buildCounterFolderEntities--;
}
...
core.List<api.MergeConflict> buildUnnamed5751() => [
      buildMergeConflict(),
      buildMergeConflict(),
    ];

void checkUnnamed5751(core.List<api.MergeConflict> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMergeConflict(o[0]);
  checkMergeConflict(o[1]);
}

core.List<api.Entity> buildUnnamed5752() => [
      buildEntity(),
      buildEntity(),
    ];

void checkUnnamed5752(core.List<api.Entity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEntity(o[0]);
  checkEntity(o[1]);
}
...
api.GetWorkspaceStatusResponse buildGetWorkspaceStatusResponse() {
  ...
  if (buildCounterGetWorkspaceStatusResponse < 3) {
    o.mergeConflict = buildUnnamed5751();
    o.workspaceChange = buildUnnamed5752();
  }
  buildCounterGetWorkspaceStatusResponse--;
  return o;
}
...
void checkGetWorkspaceStatusResponse(api.GetWorkspaceStatusResponse o) {
  buildCounterGetWorkspaceStatusResponse++;
  if (buildCounterGetWorkspaceStatusResponse < 3) {
    checkUnnamed5751(o.mergeConflict!);
    checkUnnamed5752(o.workspaceChange!);
  }
  buildCounterGetWorkspaceStatusResponse--;
}

core.List<api.Account> buildUnnamed5753() => [
      buildAccount(),
      buildAccount(),
    ];

void checkUnnamed5753(core.List<api.Account> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAccount(o[0]);
  checkAccount(o[1]);
}
...
core.List<api.ContainerVersionHeader> buildUnnamed5754() => [
      buildContainerVersionHeader(),
      buildContainerVersionHeader(),
    ];

void checkUnnamed5754(core.List<api.ContainerVersionHeader> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListContainerVersionsResponse buildListContainerVersionsResponse() {
  ...
  if (buildCounterListContainerVersionsResponse < 3) {
    o.containerVersionHeader = buildUnnamed5754();
    o.nextPageToken = 'foo';
  }
  buildCounterListContainerVersionsResponse--;
  return o;
...
void checkListContainerVersionsResponse(api.ListContainerVersionsResponse o) {
  buildCounterListContainerVersionsResponse++;
  if (buildCounterListContainerVersionsResponse < 3) {
    checkUnnamed5754(o.containerVersionHeader!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Container> buildUnnamed5755() => [
      buildContainer(),
      buildContainer(),
    ];

void checkUnnamed5755(core.List<api.Container> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContainer(o[0]);
  checkContainer(o[1]);
}
...
core.List<api.BuiltInVariable> buildUnnamed5756() => [
      buildBuiltInVariable(),
      buildBuiltInVariable(),
    ];

void checkUnnamed5756(core.List<api.BuiltInVariable> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuiltInVariable(o[0]);
  checkBuiltInVariable(o[1]);
}
...
api.ListEnabledBuiltInVariablesResponse
  ...
  if (buildCounterListEnabledBuiltInVariablesResponse < 3) {
    o.builtInVariable = buildUnnamed5756();
    o.nextPageToken = 'foo';
  }
  buildCounterListEnabledBuiltInVariablesResponse--;
  return o;
...
void checkListEnabledBuiltInVariablesResponse(
  ...
  buildCounterListEnabledBuiltInVariablesResponse++;
  if (buildCounterListEnabledBuiltInVariablesResponse < 3) {
    checkUnnamed5756(o.builtInVariable!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Environment> buildUnnamed5757() => [
      buildEnvironment(),
      buildEnvironment(),
    ];

void checkUnnamed5757(core.List<api.Environment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListEnvironmentsResponse buildListEnvironmentsResponse() {
  ...
  if (buildCounterListEnvironmentsResponse < 3) {
    o.environment = buildUnnamed5757();
    o.nextPageToken = 'foo';
  }
  buildCounterListEnvironmentsResponse--;
  return o;
...
void checkListEnvironmentsResponse(api.ListEnvironmentsResponse o) {
  buildCounterListEnvironmentsResponse++;
  if (buildCounterListEnvironmentsResponse < 3) {
    checkUnnamed5757(o.environment!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Folder> buildUnnamed5758() => [
      buildFolder(),
      buildFolder(),
    ];

void checkUnnamed5758(core.List<api.Folder> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFolder(o[0]);
  checkFolder(o[1]);
}
...
core.List<api.Tag> buildUnnamed5759() => [
      buildTag(),
      buildTag(),
    ];

void checkUnnamed5759(core.List<api.Tag> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTag(o[0]);
  checkTag(o[1]);
}
...
void checkListTagsResponse(api.ListTagsResponse o) {
  ...
  if (buildCounterListTagsResponse < 3) {
    ...
    checkUnnamed5759(o.tag!);
  }
  buildCounterListTagsResponse--;
}

core.List<api.CustomTemplate> buildUnnamed5760() => [
      buildCustomTemplate(),
      buildCustomTemplate(),
    ];

void checkUnnamed5760(core.List<api.CustomTemplate> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCustomTemplate(o[0]);
  checkCustomTemplate(o[1]);
}
...
void checkListTemplatesResponse(api.ListTemplatesResponse o) {
  ...
  if (buildCounterListTemplatesResponse < 3) {
    ...
    checkUnnamed5760(o.template!);
  }
  buildCounterListTemplatesResponse--;
}

core.List<api.Trigger> buildUnnamed5761() => [
      buildTrigger(),
      buildTrigger(),
    ];

void checkUnnamed5761(core.List<api.Trigger> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTrigger(o[0]);
  checkTrigger(o[1]);
}
...
void checkListTriggersResponse(api.ListTriggersResponse o) {
  ...
  if (buildCounterListTriggersResponse < 3) {
    ...
    checkUnnamed5761(o.trigger!);
  }
  buildCounterListTriggersResponse--;
}

core.List<api.UserPermission> buildUnnamed5762() => [
      buildUserPermission(),
      buildUserPermission(),
    ];

void checkUnnamed5762(core.List<api.UserPermission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListUserPermissionsResponse buildListUserPermissionsResponse() {
  ...
  if (buildCounterListUserPermissionsResponse < 3) {
    o.nextPageToken = 'foo';
    o.userPermission = buildUnnamed5762();
  }
  buildCounterListUserPermissionsResponse--;
  return o;
}
...
void checkListUserPermissionsResponse(api.ListUserPermissionsResponse o) {
  ...
  if (buildCounterListUserPermissionsResponse < 3) {
    ...
    checkUnnamed5762(o.userPermission!);
  }
  buildCounterListUserPermissionsResponse--;
}

core.List<api.Variable> buildUnnamed5763() => [
      buildVariable(),
      buildVariable(),
    ];

void checkUnnamed5763(core.List<api.Variable> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVariable(o[0]);
  checkVariable(o[1]);
}
...
void checkListVariablesResponse(api.ListVariablesResponse o) {
  ...
  if (buildCounterListVariablesResponse < 3) {
    ...
    checkUnnamed5763(o.variable!);
  }
  buildCounterListVariablesResponse--;
}

core.List<api.Workspace> buildUnnamed5764() => [
      buildWorkspace(),
      buildWorkspace(),
    ];

void checkUnnamed5764(core.List<api.Workspace> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWorkspace(o[0]);
  checkWorkspace(o[1]);
}
...
void checkListWorkspacesResponse(api.ListWorkspacesResponse o) {
  ...
  if (buildCounterListWorkspacesResponse < 3) {
    ...
    checkUnnamed5764(o.workspace!);
  }
  buildCounterListWorkspacesResponse--;
}

core.List<api.Zone> buildUnnamed5765() => [
      buildZone(),
      buildZone(),
    ];

void checkUnnamed5765(core.List<api.Zone> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkZone(o[0]);
  checkZone(o[1]);
}
...
core.List<api.Parameter> buildUnnamed5766() => [
      buildParameter(),
      buildParameter(),
    ];

void checkUnnamed5766(core.List<api.Parameter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkParameter(o[0]);
  checkParameter(o[1]);
}

core.List<api.Parameter> buildUnnamed5767() => [
      buildParameter(),
      buildParameter(),
    ];

void checkUnnamed5767(core.List<api.Parameter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkParameter(o[0]);
  checkParameter(o[1]);
}
...
api.Parameter buildParameter() {
  ...
  if (buildCounterParameter < 3) {
    o.key = 'foo';
    o.list = buildUnnamed5766();
    o.map = buildUnnamed5767();
    o.type = 'foo';
    o.value = 'foo';
  }
  buildCounterParameter--;
...
void checkParameter(api.Parameter o) {
  ...
  if (buildCounterParameter < 3) {
    ...
    checkUnnamed5766(o.list!);
    checkUnnamed5767(o.map!);
    unittest.expect(
      o.type!,
      unittest.equals('foo'),
    );
...
core.List<api.MergeConflict> buildUnnamed5768() => [
      buildMergeConflict(),
      buildMergeConflict(),
    ];

void checkUnnamed5768(core.List<api.MergeConflict> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMergeConflict(o[0]);
  checkMergeConflict(o[1]);
}
...
api.SyncWorkspaceResponse buildSyncWorkspaceResponse() {
  ...
  if (buildCounterSyncWorkspaceResponse < 3) {
    o.mergeConflict = buildUnnamed5768();
    o.syncStatus = buildSyncStatus();
  }
  buildCounterSyncWorkspaceResponse--;
  return o;
...
void checkSyncWorkspaceResponse(api.SyncWorkspaceResponse o) {
  buildCounterSyncWorkspaceResponse++;
  if (buildCounterSyncWorkspaceResponse < 3) {
    checkUnnamed5768(o.mergeConflict!);
    checkSyncStatus(o.syncStatus!);
  }
  buildCounterSyncWorkspaceResponse--;
}
...
core.List<api.Parameter> buildUnnamed5773() => [
      buildParameter(),
      buildParameter(),
    ];

void checkUnnamed5773(core.List<api.Parameter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkParameter(o[0]);
  checkParameter(o[1]);
}

core.List<api.SetupTag> buildUnnamed5774() => [
      buildSetupTag(),
      buildSetupTag(),
    ];

void checkUnnamed5774(core.List<api.SetupTag> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSetupTag(o[0]);
  checkSetupTag(o[1]);
}

core.List<api.TeardownTag> buildUnnamed5775() => [
      buildTeardownTag(),
      buildTeardownTag(),
    ];

void checkUnnamed5775(core.List<api.TeardownTag> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Tag buildTag() {
  ...
  if (buildCounterTag < 3) {
    o.accountId = 'foo';
    o.blockingRuleId = buildUnnamed5769();
    o.blockingTriggerId = buildUnnamed5770();
    o.containerId = 'foo';
    o.fingerprint = 'foo';
    o.firingRuleId = buildUnnamed5771();
    o.firingTriggerId = buildUnnamed5772();
    o.liveOnly = true;
    o.monitoringMetadata = buildParameter();
    o.monitoringMetadataTagNameKey = 'foo';
    o.name = 'foo';
    o.notes = 'foo';
    o.parameter = buildUnnamed5773();
    o.parentFolderId = 'foo';
    o.path = 'foo';
    o.paused = true;
    ...
    o.setupTag = buildUnnamed5774();
    o.tagFiringOption = 'foo';
    o.tagId = 'foo';
    o.tagManagerUrl = 'foo';
    o.teardownTag = buildUnnamed5775();
    o.type = 'foo';
    o.workspaceId = 'foo';
  }
  buildCounterTag--;
...
void checkTag(api.Tag o) {
  ...
  if (buildCounterTag < 3) {
    ...
    checkUnnamed5769(o.blockingRuleId!);
    checkUnnamed5770(o.blockingTriggerId!);
    unittest.expect(
      o.containerId!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed5771(o.firingRuleId!);
    checkUnnamed5772(o.firingTriggerId!);
    ...
    checkUnnamed5775(o.teardownTag!);
    unittest.expect(
      o.type!,
      unittest.equals('foo'),
    );
...
core.List<api.Condition> buildUnnamed5776() => [
      buildCondition(),
      buildCondition(),
    ];

void checkUnnamed5776(core.List<api.Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCondition(o[0]);
  checkCondition(o[1]);
}

core.List<api.Condition> buildUnnamed5777() => [
      buildCondition(),
      buildCondition(),
    ];

void checkUnnamed5777(core.List<api.Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCondition(o[0]);
  checkCondition(o[1]);
}

core.List<api.Condition> buildUnnamed5778() => [
      buildCondition(),
      buildCondition(),
    ];

void checkUnnamed5778(core.List<api.Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCondition(o[0]);
  checkCondition(o[1]);
}

core.List<api.Parameter> buildUnnamed5779() => [
      buildParameter(),
      buildParameter(),
    ];

void checkUnnamed5779(core.List<api.Parameter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkParameter(o[0]);
  checkParameter(o[1]);
}
...
void checkTrigger(api.Trigger o) {
  ...
  if (buildCounterTrigger < 3) {
    ...
    checkUnnamed5776(o.autoEventFilter!);
    ...
    checkUnnamed5777(o.customEventFilter!);
    checkParameter(o.eventName!);
    checkUnnamed5778(o.filter!);
    unittest.expect(
      o.fingerprint!,
      unittest.equals('foo'),
    );
...
core.List<api.ContainerAccess> buildUnnamed5780() => [
      buildContainerAccess(),
      buildContainerAccess(),
    ];

void checkUnnamed5780(core.List<api.ContainerAccess> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.UserPermission buildUserPermission() {
  ...
  if (buildCounterUserPermission < 3) {
    ...
    o.accountId = 'foo';
    o.containerAccess = buildUnnamed5780();
    o.emailAddress = 'foo';
    o.path = 'foo';
  }
  buildCounterUserPermission--;
...
void checkUserPermission(api.UserPermission o) {
  ...
  if (buildCounterUserPermission < 3) {
    ...
    checkUnnamed5780(o.containerAccess!);
    unittest.expect(
      o.emailAddress!,
      unittest.equals('foo'),
    );
...
core.List<api.Parameter> buildUnnamed5783() => [
      buildParameter(),
      buildParameter(),
    ];

void checkUnnamed5783(core.List<api.Parameter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkParameter(o[0]);
  checkParameter(o[1]);
}
...
api.Variable buildVariable() {
  ...
  if (buildCounterVariable < 3) {
    o.accountId = 'foo';
    o.containerId = 'foo';
    o.disablingTriggerId = buildUnnamed5781();
    o.enablingTriggerId = buildUnnamed5782();
    o.fingerprint = 'foo';
    o.formatValue = buildVariableFormatValue();
    o.name = 'foo';
    o.notes = 'foo';
    o.parameter = buildUnnamed5783();
    o.parentFolderId = 'foo';
    o.path = 'foo';
    o.scheduleEndMs = 'foo';
    o.scheduleStartMs = 'foo';
...
void checkVariable(api.Variable o) {
  ...
  if (buildCounterVariable < 3) {
    ...
    checkUnnamed5781(o.disablingTriggerId!);
    checkUnnamed5782(o.enablingTriggerId!);
    unittest.expect(
      o.fingerprint!,
      unittest.equals('foo'),
    );
...
core.List<api.ZoneChildContainer> buildUnnamed5784() => [
      buildZoneChildContainer(),
      buildZoneChildContainer(),
    ];

void checkUnnamed5784(core.List<api.ZoneChildContainer> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Zone buildZone() {
  ...
  if (buildCounterZone < 3) {
    ...
    o.childContainer = buildUnnamed5784();
    o.containerId = 'foo';
    o.fingerprint = 'foo';
    o.name = 'foo';
    o.notes = 'foo';
...
void checkZone(api.Zone o) {
  ...
  if (buildCounterZone < 3) {
    ...
    checkUnnamed5784(o.childContainer!);
    unittest.expect(
      o.containerId!,
      unittest.equals('foo'),
    );
...
core.List<api.Condition> buildUnnamed5785() => [
      buildCondition(),
      buildCondition(),
    ];

void checkUnnamed5785(core.List<api.Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCondition(o[0]);
  checkCondition(o[1]);
}
...
api.ZoneBoundary buildZoneBoundary() {
  ...
  if (buildCounterZoneBoundary < 3) {
    o.condition = buildUnnamed5785();
    o.customEvaluationTriggerId = buildUnnamed5786();
  }
  buildCounterZoneBoundary--;
  return o;
}
...
void checkZoneBoundary(api.ZoneBoundary o) {
  buildCounterZoneBoundary++;
  if (buildCounterZoneBoundary < 3) {
    checkUnnamed5785(o.condition!);
    checkUnnamed5786(o.customEvaluationTriggerId!);
  }
  buildCounterZoneBoundary--;
}
...
api.ZoneTypeRestriction buildZoneTypeRestriction() {
  ...
  if (buildCounterZoneTypeRestriction < 3) {
    o.enable = true;
    o.whitelistedTypeId = buildUnnamed5787();
  }
  buildCounterZoneTypeRestriction--;
  return o;
}
...
void checkZoneTypeRestriction(api.ZoneTypeRestriction o) {
  ...
  if (buildCounterZoneTypeRestriction < 3) {
    ...
    checkUnnamed5787(o.whitelistedTypeId!);
  }
  buildCounterZoneTypeRestriction--;
}
...
void main() {
  ...
  unittest.group(
    ...
    unittest.test('method--create', () async {
      ...
      final res = api.TagManagerApi(mock)
          ...
          .builtInVariables;
      final arg_parent = 'foo';
      final arg_type = buildUnnamed5788();
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final path = (req.url).path;
        var pathOffset = 0;
    ...
    unittest.test('method--delete', () async {
      ...
      final res = api.TagManagerApi(mock)
          ...
          .builtInVariables;
      final arg_path = 'foo';
      final arg_type = buildUnnamed5789();
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group('resource-AccountsContainersWorkspacesFoldersResource', () {
    ...
    unittest.test('method--moveEntitiesToFolder', () async {
      ...
      final arg_request = buildFolder();
      final arg_path = 'foo';
      final arg_tagId = buildUnnamed5790();
      final arg_triggerId = buildUnnamed5791();
      final arg_variableId = buildUnnamed5792();
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final obj =
            api.Folder.fromJson(json as core.Map<core.String, core.dynamic>);
