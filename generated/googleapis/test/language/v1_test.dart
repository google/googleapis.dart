...
core.List<api.Entity> buildUnnamed5627() => [
      buildEntity(),
      buildEntity(),
    ];

void checkUnnamed5627(core.List<api.Entity> o) {
...
core.List<api.Entity> buildUnnamed5628() => [
      buildEntity(),
      buildEntity(),
    ];

void checkUnnamed5628(core.List<api.Entity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEntity(o[0]);
  checkEntity(o[1]);
}
...
core.List<api.Sentence> buildUnnamed5629() => [
      buildSentence(),
      buildSentence(),
    ];

void checkUnnamed5629(core.List<api.Sentence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSentence(o[0]);
  checkSentence(o[1]);
}
...
core.List<api.Sentence> buildUnnamed5630() => [
      buildSentence(),
      buildSentence(),
    ];

void checkUnnamed5630(core.List<api.Sentence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSentence(o[0]);
  checkSentence(o[1]);
}

core.List<api.Token> buildUnnamed5631() => [
      buildToken(),
      buildToken(),
    ];

void checkUnnamed5631(core.List<api.Token> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkToken(o[0]);
  checkToken(o[1]);
}
...
api.AnalyzeSyntaxResponse buildAnalyzeSyntaxResponse() {
  ...
  if (buildCounterAnalyzeSyntaxResponse < 3) {
    o.language = 'foo';
    o.sentences = buildUnnamed5630();
    o.tokens = buildUnnamed5631();
  }
  buildCounterAnalyzeSyntaxResponse--;
  return o;
}
...
void checkAnalyzeSyntaxResponse(api.AnalyzeSyntaxResponse o) {
  ...
  if (buildCounterAnalyzeSyntaxResponse < 3) {
    ...
    checkUnnamed5630(o.sentences!);
    checkUnnamed5631(o.tokens!);
  }
  buildCounterAnalyzeSyntaxResponse--;
}
...
core.List<api.ClassificationCategory> buildUnnamed5632() => [
      buildClassificationCategory(),
      buildClassificationCategory(),
    ];

void checkUnnamed5632(core.List<api.ClassificationCategory> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkClassificationCategory(o[0]);
  checkClassificationCategory(o[1]);
}

core.List<api.Entity> buildUnnamed5633() => [
      buildEntity(),
      buildEntity(),
    ];

void checkUnnamed5633(core.List<api.Entity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEntity(o[0]);
  checkEntity(o[1]);
}

core.List<api.Sentence> buildUnnamed5634() => [
      buildSentence(),
      buildSentence(),
    ];

void checkUnnamed5634(core.List<api.Sentence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSentence(o[0]);
  checkSentence(o[1]);
}

core.List<api.Token> buildUnnamed5635() => [
      buildToken(),
      buildToken(),
    ];

void checkUnnamed5635(core.List<api.Token> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkToken(o[0]);
  checkToken(o[1]);
}
...
api.AnnotateTextResponse buildAnnotateTextResponse() {
  ...
  if (buildCounterAnnotateTextResponse < 3) {
    o.categories = buildUnnamed5632();
    o.documentSentiment = buildSentiment();
    o.entities = buildUnnamed5633();
    o.language = 'foo';
    o.sentences = buildUnnamed5634();
    o.tokens = buildUnnamed5635();
  }
  buildCounterAnnotateTextResponse--;
  return o;
}
...
void checkAnnotateTextResponse(api.AnnotateTextResponse o) {
  buildCounterAnnotateTextResponse++;
  if (buildCounterAnnotateTextResponse < 3) {
    checkUnnamed5632(o.categories!);
    checkSentiment(o.documentSentiment!);
    checkUnnamed5633(o.entities!);
    unittest.expect(
      o.language!,
      unittest.equals('foo'),
    );
    checkUnnamed5634(o.sentences!);
    checkUnnamed5635(o.tokens!);
  }
  buildCounterAnnotateTextResponse--;
}
...
core.List<api.ClassificationCategory> buildUnnamed5636() => [
      buildClassificationCategory(),
      buildClassificationCategory(),
    ];

void checkUnnamed5636(core.List<api.ClassificationCategory> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkClassificationCategory(o[0]);
  checkClassificationCategory(o[1]);
}
...
core.List<api.EntityMention> buildUnnamed5637() => [
      buildEntityMention(),
      buildEntityMention(),
    ];

void checkUnnamed5637(core.List<api.EntityMention> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Entity buildEntity() {
  ...
  if (buildCounterEntity < 3) {
    o.mentions = buildUnnamed5637();
    o.metadata = buildUnnamed5638();
    o.name = 'foo';
    o.salience = 42.0;
...
void checkEntity(api.Entity o) {
  buildCounterEntity++;
  if (buildCounterEntity < 3) {
    checkUnnamed5637(o.mentions!);
    checkUnnamed5638(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.Object> buildUnnamed5639() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed5639(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed5640() => [
      buildUnnamed5639(),
      buildUnnamed5639(),
    ];

void checkUnnamed5640(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed5639(o[0]);
  checkUnnamed5639(o[1]);
}
