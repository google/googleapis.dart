...
import 'package:googleapis/ids/v1.dart' as api;
...
void checkEndpoint(api.Endpoint o) {
  ...
  if (buildCounterEndpoint < 3) {
    ...
    unittest.expect(o.endpointForwardingRule!, unittest.equals('foo'));
    ...
    checkUnnamed4(o.threatExceptions!);
    unittest.expect(o.trafficLogs!, unittest.isTrue);
...
core.List<api.Endpoint> buildUnnamed5() => [buildEndpoint(), buildEndpoint()];

void checkUnnamed5(core.List<api.Endpoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEndpoint(o[0]);
  checkEndpoint(o[1]);
}
...
core.List<api.Binding> buildUnnamed14() => [buildBinding(), buildBinding()];
...
void main() {
  ...
  unittest.group('resource-ProjectsLocationsResource', () {
    unittest.test('method--get', () async {
      ...
      final res = api.IDSApi(mock).projects.locations;
      final arg_name = 'foo';
  ...
  unittest.group('resource-ProjectsLocationsEndpointsResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.IDSApi(mock).projects.locations.endpoints;
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Endpoint.fromJson(
  ...
  unittest.group('resource-ProjectsLocationsOperationsResource', () {
    unittest.test('method--cancel', () async {
      final mock = HttpServerMock();
      final res = api.IDSApi(mock).projects.locations.operations;
