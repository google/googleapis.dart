...
checkUnnamed622(core.List<api.Trace> o) {
...
checkUnnamed623(core.List<api.TraceSpan> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTraceSpan(o[0]);
  checkTraceSpan(o[1]);
}
...
checkUnnamed625(core.List<api.Trace> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTrace(o[0]);
  checkTrace(o[1]);
}
...
main() {
  ...
  unittest.group("resource-V1ResourceApi", () {
    unittest.test("method--getDiscovery", () {
      ...
      var arg_format = "foo";
      var arg_labels = buildUnnamed626();
      var arg_version = "foo";
      var arg_args = buildUnnamed627();
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
        var index;
