...
core.Map<core.String, api.AttributeValue> buildUnnamed1485() {
...
void checkUnnamed1485(core.Map<core.String, api.AttributeValue> o) {
...
api.Attributes buildAttributes() {
  ...
  if (buildCounterAttributes < 3) {
    o.attributeMap = buildUnnamed1485();
...
void checkAttributes(api.Attributes o) {
  buildCounterAttributes++;
  if (buildCounterAttributes < 3) {
    checkUnnamed1485(o.attributeMap);
    unittest.expect(o.droppedAttributesCount, unittest.equals(42));
  }
  buildCounterAttributes--;
}

core.List<api.Span> buildUnnamed1486() {
  var o = <api.Span>[];
  o.add(buildSpan());
  o.add(buildSpan());
  return o;
...
void checkUnnamed1486(core.List<api.Span> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Link> buildUnnamed1487() {
  var o = <api.Link>[];
  o.add(buildLink());
  o.add(buildLink());
  return o;
...
void checkUnnamed1487(core.List<api.Link> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.StackFrame> buildUnnamed1488() {
  var o = <api.StackFrame>[];
...
void checkUnnamed1488(core.List<api.StackFrame> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed1490() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed1489());
  o.add(buildUnnamed1489());
  return o;
}

void checkUnnamed1490(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1489(o[0]);
  checkUnnamed1489(o[1]);
}
...
core.List<api.TimeEvent> buildUnnamed1491() {
  var o = <api.TimeEvent>[];
...
void checkUnnamed1491(core.List<api.TimeEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
