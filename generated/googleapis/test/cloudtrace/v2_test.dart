...
core.Map<core.String, api.AttributeValue> buildUnnamed716() => {
      'x': buildAttributeValue(),
      'y': buildAttributeValue(),
    };

void checkUnnamed716(core.Map<core.String, api.AttributeValue> o) {
...
api.Attributes buildAttributes() {
  ...
  if (buildCounterAttributes < 3) {
    o.attributeMap = buildUnnamed716();
...
void checkAttributes(api.Attributes o) {
  buildCounterAttributes++;
  if (buildCounterAttributes < 3) {
    checkUnnamed716(o.attributeMap!);
    unittest.expect(
...
core.List<api.Span> buildUnnamed717() => [
      buildSpan(),
      buildSpan(),
    ];

void checkUnnamed717(core.List<api.Span> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSpan(o[0]);
  checkSpan(o[1]);
}
...
core.List<api.Link> buildUnnamed718() => [
      buildLink(),
      buildLink(),
    ];

void checkUnnamed718(core.List<api.Link> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLink(o[0]);
  checkLink(o[1]);
}
...
core.List<api.StackFrame> buildUnnamed719() => [
      buildStackFrame(),
      buildStackFrame(),
    ];

void checkUnnamed719(core.List<api.StackFrame> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStackFrame(o[0]);
  checkStackFrame(o[1]);
}
...
core.Map<core.String, core.Object> buildUnnamed720() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed720(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed721() => [
      buildUnnamed720(),
      buildUnnamed720(),
    ];

void checkUnnamed721(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed720(o[0]);
  checkUnnamed720(o[1]);
}
...
core.List<api.TimeEvent> buildUnnamed722() => [
      buildTimeEvent(),
      buildTimeEvent(),
    ];

void checkUnnamed722(core.List<api.TimeEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTimeEvent(o[0]);
  checkTimeEvent(o[1]);
}
