...
core.Map<core.String, api.AttributeValue> buildUnnamed1480() {
...
void checkUnnamed1480(core.Map<core.String, api.AttributeValue> o) {
...
api.Attributes buildAttributes() {
  ...
  if (buildCounterAttributes < 3) {
    o.attributeMap = buildUnnamed1480();
...
void checkAttributes(api.Attributes o) {
  buildCounterAttributes++;
  if (buildCounterAttributes < 3) {
    checkUnnamed1480(o.attributeMap);
    unittest.expect(o.droppedAttributesCount, unittest.equals(42));
  }
  buildCounterAttributes--;
}

core.List<api.Span> buildUnnamed1481() {
  var o = <api.Span>[];
  o.add(buildSpan());
  o.add(buildSpan());
  return o;
...
void checkUnnamed1481(core.List<api.Span> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Link> buildUnnamed1482() {
  var o = <api.Link>[];
  o.add(buildLink());
  o.add(buildLink());
  return o;
...
void checkUnnamed1482(core.List<api.Link> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.StackFrame> buildUnnamed1483() {
  var o = <api.StackFrame>[];
...
void checkUnnamed1483(core.List<api.StackFrame> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed1485() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed1484());
  o.add(buildUnnamed1484());
  return o;
}

void checkUnnamed1485(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1484(o[0]);
  checkUnnamed1484(o[1]);
}
...
core.List<api.TimeEvent> buildUnnamed1486() {
  var o = <api.TimeEvent>[];
...
void checkUnnamed1486(core.List<api.TimeEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
