...
void checkCrmlogErrorCode(api.CrmlogErrorCode o) {
  buildCounterCrmlogErrorCode++;
  if (buildCounterCrmlogErrorCode < 3) {
    unittest.expect(o.commonErrorCode!, unittest.equals('foo'));
  }
  buildCounterCrmlogErrorCode--;
}
...
void checkEnterpriseCrmEventbusProtoAttributes(
  ...
  if (buildCounterEnterpriseCrmEventbusProtoAttributes < 3) {
    ...
    unittest.expect(o.searchable!, unittest.equals('foo'));
...
void checkEnterpriseCrmEventbusProtoBaseAlertConfigThresholdValue(
  ...
  buildCounterEnterpriseCrmEventbusProtoBaseAlertConfigThresholdValue++;
  if (buildCounterEnterpriseCrmEventbusProtoBaseAlertConfigThresholdValue < 3) {
    unittest.expect(o.absolute!, unittest.equals('foo'));
    unittest.expect(o.percentage!, unittest.equals(42));
  }
  buildCounterEnterpriseCrmEventbusProtoBaseAlertConfigThresholdValue--;
}

core.List<core.bool> buildUnnamed3() => [true, true];
...
void checkEnterpriseCrmEventbusProtoBuganizerNotification(
  ...
  buildCounterEnterpriseCrmEventbusProtoBuganizerNotification++;
  if (buildCounterEnterpriseCrmEventbusProtoBuganizerNotification < 3) {
    unittest.expect(o.assigneeEmailAddress!, unittest.equals('foo'));
...
void checkEnterpriseCrmEventbusProtoCloudLoggingDetails(
  ...
  buildCounterEnterpriseCrmEventbusProtoCloudLoggingDetails++;
  if (buildCounterEnterpriseCrmEventbusProtoCloudLoggingDetails < 3) {
    unittest.expect(o.cloudLoggingSeverity!, unittest.equals('foo'));
...
void checkEnterpriseCrmEventbusProtoCloudSchedulerConfig(
  ...
  buildCounterEnterpriseCrmEventbusProtoCloudSchedulerConfig++;
  if (buildCounterEnterpriseCrmEventbusProtoCloudSchedulerConfig < 3) {
    unittest.expect(o.cronTab!, unittest.equals('foo'));
...
void checkEnterpriseCrmEventbusProtoCondition(
  ...
  buildCounterEnterpriseCrmEventbusProtoCondition++;
  if (buildCounterEnterpriseCrmEventbusProtoCondition < 3) {
    unittest.expect(o.eventPropertyKey!, unittest.equals('foo'));
...
void checkEnterpriseCrmEventbusProtoConditionResult(
  ...
  buildCounterEnterpriseCrmEventbusProtoConditionResult++;
  if (buildCounterEnterpriseCrmEventbusProtoConditionResult < 3) {
    unittest.expect(o.currentTaskNumber!, unittest.equals('foo'));
    unittest.expect(o.nextTaskNumber!, unittest.equals('foo'));
...
void checkEnterpriseCrmEventbusProtoCustomSuspensionRequest(
  ...
  if (buildCounterEnterpriseCrmEventbusProtoCustomSuspensionRequest < 3) {
    ...
    unittest.expect(o.suspensionInfoEventParameterKey!, unittest.equals('foo'));
  }
  buildCounterEnterpriseCrmEventbusProtoCustomSuspensionRequest--;
}

core.List<core.double> buildUnnamed6() => [42.0, 42.0];
...
core.List<core.double> buildUnnamed7() => [42.0, 42.0];
...
void checkEnterpriseCrmEventbusProtoErrorDetail(
  ...
  if (buildCounterEnterpriseCrmEventbusProtoErrorDetail < 3) {
    ...
    unittest.expect(o.taskNumber!, unittest.equals(42));
  }
  buildCounterEnterpriseCrmEventbusProtoErrorDetail--;
}
...
void checkEnterpriseCrmEventbusProtoEventExecutionDetails(
  ...
  buildCounterEnterpriseCrmEventbusProtoEventExecutionDetails++;
  if (buildCounterEnterpriseCrmEventbusProtoEventExecutionDetails < 3) {
    unittest.expect(o.cancelReason!, unittest.equals('foo'));
    ...
    unittest.expect(o.eventExecutionState!, unittest.equals('foo'));
    unittest.expect(o.eventRetriesFromBeginningCount!, unittest.equals(42));
    unittest.expect(o.logFilePath!, unittest.equals('foo'));
    unittest.expect(o.networkAddress!, unittest.equals('foo'));
    unittest.expect(o.nextExecutionTime!, unittest.equals('foo'));
    unittest.expect(o.ryeLockUnheldCount!, unittest.equals(42));
  }
  buildCounterEnterpriseCrmEventbusProtoEventExecutionDetails--;
}
...
void checkEnterpriseCrmEventbusProtoEventExecutionSnapshot(
  ...
  buildCounterEnterpriseCrmEventbusProtoEventExecutionSnapshot++;
  if (buildCounterEnterpriseCrmEventbusProtoEventExecutionSnapshot < 3) {
    unittest.expect(o.checkpointTaskNumber!, unittest.equals('foo'));
    unittest.expect(o.clientId!, unittest.equals('foo'));
    checkUnnamed11(o.conditionResults!);
    checkEnterpriseCrmEventbusProtoEventParameters(o.diffParams!);
    unittest.expect(o.eventExecutionInfoId!, unittest.equals('foo'));
    unittest.expect(o.eventExecutionSnapshotId!, unittest.equals('foo'));
    ...
    unittest.expect(o.workflowName!, unittest.equals('foo'));
  }
  buildCounterEnterpriseCrmEventbusProtoEventExecutionSnapshot--;
}
...
void
  ...
  if (buildCounterEnterpriseCrmEventbusProtoEventExecutionSnapshotEventExecutionSnapshotMetadata <
    ...
    unittest.expect(o.eventAttemptNum!, unittest.equals(42));
    unittest.expect(o.integrationName!, unittest.equals('foo'));
    unittest.expect(o.taskAttemptNum!, unittest.equals(42));
    unittest.expect(o.taskLabel!, unittest.equals('foo'));
    unittest.expect(o.taskName!, unittest.equals('foo'));
...
void checkEnterpriseCrmEventbusProtoExecutionTraceInfo(
  ...
  buildCounterEnterpriseCrmEventbusProtoExecutionTraceInfo++;
  if (buildCounterEnterpriseCrmEventbusProtoExecutionTraceInfo < 3) {
    unittest.expect(o.parentEventExecutionInfoId!, unittest.equals('foo'));
...
void checkEnterpriseCrmEventbusProtoFailurePolicy(
  ...
  buildCounterEnterpriseCrmEventbusProtoFailurePolicy++;
  if (buildCounterEnterpriseCrmEventbusProtoFailurePolicy < 3) {
    unittest.expect(o.intervalInSeconds!, unittest.equals('foo'));
    unittest.expect(o.maxNumRetries!, unittest.equals(42));
    unittest.expect(o.retryCondition!, unittest.equals('foo'));
    unittest.expect(o.retryStrategy!, unittest.equals('foo'));
  }
  buildCounterEnterpriseCrmEventbusProtoFailurePolicy--;
}
...
void checkEnterpriseCrmEventbusProtoLogSettings(
  ...
  buildCounterEnterpriseCrmEventbusProtoLogSettings++;
  if (buildCounterEnterpriseCrmEventbusProtoLogSettings < 3) {
    unittest.expect(o.logFieldName!, unittest.equals('foo'));
    unittest.expect(o.seedPeriod!, unittest.equals('foo'));
    unittest.expect(o.seedScope!, unittest.equals('foo'));
  }
  buildCounterEnterpriseCrmEventbusProtoLogSettings--;
}
...
void checkEnterpriseCrmEventbusProtoNextTask(
  ...
  if (buildCounterEnterpriseCrmEventbusProtoNextTask < 3) {
    ...
    unittest.expect(o.taskConfigId!, unittest.equals('foo'));
    unittest.expect(o.taskNumber!, unittest.equals('foo'));
  }
  buildCounterEnterpriseCrmEventbusProtoNextTask--;
}
...
void checkEnterpriseCrmEventbusProtoNodeIdentifier(
  ...
  buildCounterEnterpriseCrmEventbusProtoNodeIdentifier++;
  if (buildCounterEnterpriseCrmEventbusProtoNodeIdentifier < 3) {
    unittest.expect(o.elementIdentifier!, unittest.equals('foo'));
    unittest.expect(o.elementType!, unittest.equals('foo'));
  }
  buildCounterEnterpriseCrmEventbusProtoNodeIdentifier--;
}
...
void checkEnterpriseCrmEventbusProtoNotification(
  ...
  if (buildCounterEnterpriseCrmEventbusProtoNotification < 3) {
    ...
    unittest.expect(o.escalatorQueue!, unittest.equals('foo'));
...
void checkEnterpriseCrmEventbusProtoParamSpecEntryConfig(
  ...
  buildCounterEnterpriseCrmEventbusProtoParamSpecEntryConfig++;
  if (buildCounterEnterpriseCrmEventbusProtoParamSpecEntryConfig < 3) {
    unittest.expect(o.descriptivePhrase!, unittest.equals('foo'));
    unittest.expect(o.helpText!, unittest.equals('foo'));
    unittest.expect(o.hideDefaultValue!, unittest.isTrue);
    unittest.expect(o.inputDisplayOption!, unittest.equals('foo'));
    unittest.expect(o.isHidden!, unittest.isTrue);
    unittest.expect(o.label!, unittest.equals('foo'));
    unittest.expect(o.parameterNameOption!, unittest.equals('foo'));
    unittest.expect(o.subSectionLabel!, unittest.equals('foo'));
    unittest.expect(o.uiPlaceholderText!, unittest.equals('foo'));
  }
  buildCounterEnterpriseCrmEventbusProtoParamSpecEntryConfig--;
}
...
void checkEnterpriseCrmEventbusProtoSerializedObjectParameter(
  ...
  buildCounterEnterpriseCrmEventbusProtoSerializedObjectParameter++;
  if (buildCounterEnterpriseCrmEventbusProtoSerializedObjectParameter < 3) {
    unittest.expect(o.objectValue!, unittest.equals('foo'));
  }
  buildCounterEnterpriseCrmEventbusProtoSerializedObjectParameter--;
}
...
void checkEnterpriseCrmEventbusProtoSuccessPolicy(
  ...
  buildCounterEnterpriseCrmEventbusProtoSuccessPolicy++;
  if (buildCounterEnterpriseCrmEventbusProtoSuccessPolicy < 3) {
    unittest.expect(o.finalState!, unittest.equals('foo'));
  }
  buildCounterEnterpriseCrmEventbusProtoSuccessPolicy--;
}
...
void checkEnterpriseCrmEventbusProtoSuspensionAuthPermissions(
  ...
  if (buildCounterEnterpriseCrmEventbusProtoSuspensionAuthPermissions < 3) {
    ...
    unittest.expect(o.loasRole!, unittest.equals('foo'));
    unittest.expect(o.mdbGroup!, unittest.equals('foo'));
  }
  buildCounterEnterpriseCrmEventbusProtoSuspensionAuthPermissions--;
}
...
void checkEnterpriseCrmEventbusProtoSuspensionExpiration(
  ...
  buildCounterEnterpriseCrmEventbusProtoSuspensionExpiration++;
  if (buildCounterEnterpriseCrmEventbusProtoSuspensionExpiration < 3) {
    unittest.expect(o.expireAfterMs!, unittest.equals(42));
    unittest.expect(o.liftWhenExpired!, unittest.isTrue);
    unittest.expect(o.remindAfterMs!, unittest.equals(42));
  }
  buildCounterEnterpriseCrmEventbusProtoSuspensionExpiration--;
}
...
void checkEnterpriseCrmEventbusProtoTaskAlertConfig(
  ...
  if (buildCounterEnterpriseCrmEventbusProtoTaskAlertConfig < 3) {
    ...
    unittest.expect(o.alertName!, unittest.equals('foo'));
    unittest.expect(o.clientId!, unittest.equals('foo'));
    unittest.expect(o.durationThresholdMs!, unittest.equals('foo'));
    checkEnterpriseCrmEventbusProtoBaseAlertConfigErrorEnumList(
      o.errorEnumList!,
    );
    unittest.expect(o.metricType!, unittest.equals('foo'));
    unittest.expect(o.numAggregationPeriods!, unittest.equals(42));
    unittest.expect(o.onlyFinalAttempt!, unittest.isTrue);
    unittest.expect(o.playbookUrl!, unittest.equals('foo'));
    unittest.expect(o.thresholdType!, unittest.equals('foo'));
...
void checkEnterpriseCrmEventbusProtoTaskMetadata(
  ...
  buildCounterEnterpriseCrmEventbusProtoTaskMetadata++;
  if (buildCounterEnterpriseCrmEventbusProtoTaskMetadata < 3) {
    unittest.expect(o.activeTaskName!, unittest.equals('foo'));
    checkUnnamed27(o.admins!);
    unittest.expect(o.category!, unittest.equals('foo'));
    unittest.expect(o.codeSearchLink!, unittest.equals('foo'));
    unittest.expect(o.defaultJsonValidationOption!, unittest.equals('foo'));
    unittest.expect(o.defaultSpec!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.descriptiveName!, unittest.equals('foo'));
    unittest.expect(o.docMarkdown!, unittest.equals('foo'));
    unittest.expect(o.externalCategory!, unittest.equals('foo'));
    unittest.expect(o.externalCategorySequence!, unittest.equals(42));
    unittest.expect(o.externalDocHtml!, unittest.equals('foo'));
    unittest.expect(o.externalDocLink!, unittest.equals('foo'));
    unittest.expect(o.externalDocMarkdown!, unittest.equals('foo'));
    unittest.expect(o.g3DocLink!, unittest.equals('foo'));
    unittest.expect(o.iconLink!, unittest.equals('foo'));
    unittest.expect(o.isDeprecated!, unittest.isTrue);
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.standaloneExternalDocHtml!, unittest.equals('foo'));
...
void checkEnterpriseCrmEventbusProtoTaskMetadataAdmin(
  ...
  buildCounterEnterpriseCrmEventbusProtoTaskMetadataAdmin++;
  if (buildCounterEnterpriseCrmEventbusProtoTaskMetadataAdmin < 3) {
    unittest.expect(o.googleGroupEmail!, unittest.equals('foo'));
...
void checkEnterpriseCrmEventbusStats(api.EnterpriseCrmEventbusStats o) {
  ...
  if (buildCounterEnterpriseCrmEventbusStats < 3) {
    ...
    unittest.expect(o.durationInSeconds!, unittest.equals(42.0));
    unittest.expect(o.errorRate!, unittest.equals(42.0));
    unittest.expect(o.qps!, unittest.equals(42.0));
    unittest.expect(o.warningRate!, unittest.equals(42.0));
  }
  buildCounterEnterpriseCrmEventbusStats--;
}
...
void checkEnterpriseCrmEventbusStatsDimensions(
  ...
  if (buildCounterEnterpriseCrmEventbusStatsDimensions < 3) {
    unittest.expect(o.clientId!, unittest.equals('foo'));
    unittest.expect(o.enumFilterType!, unittest.equals('foo'));
    unittest.expect(o.errorEnumString!, unittest.equals('foo'));
    unittest.expect(o.retryAttempt!, unittest.equals('foo'));
    unittest.expect(o.taskName!, unittest.equals('foo'));
    unittest.expect(o.taskNumber!, unittest.equals('foo'));
    unittest.expect(o.triggerId!, unittest.equals('foo'));
    unittest.expect(o.warningEnumString!, unittest.equals('foo'));
    unittest.expect(o.workflowId!, unittest.equals('foo'));
    unittest.expect(o.workflowName!, unittest.equals('foo'));
  }
  buildCounterEnterpriseCrmEventbusStatsDimensions--;
}

core.List<core.bool> buildUnnamed32() => [true, true];
...
void checkUnnamed35(
  core.List<api.EnterpriseCrmFrontendsEventbusProtoEventExecutionSnapshot> o,
) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkEnterpriseCrmFrontendsEventbusProtoEventExecutionInfo(
  ...
  if (buildCounterEnterpriseCrmFrontendsEventbusProtoEventExecutionInfo < 3) {
    ...
    unittest.expect(o.integrationVersionUserLabel!, unittest.equals('foo'));
    unittest.expect(o.lastModifiedTime!, unittest.equals('foo'));
    unittest.expect(o.postMethod!, unittest.equals('foo'));
...
void checkEnterpriseCrmFrontendsEventbusProtoParamSpecEntry(
  ...
  if (buildCounterEnterpriseCrmFrontendsEventbusProtoParamSpecEntry < 3) {
    ...
    unittest.expect(o.collectionElementClassName!, unittest.equals('foo'));
...
void checkEnterpriseCrmFrontendsEventbusProtoParameterValueType(
  ...
  if (buildCounterEnterpriseCrmFrontendsEventbusProtoParameterValueType < 3) {
    ...
    unittest.expect(o.intValue!, unittest.equals('foo'));
    unittest.expect(o.jsonValue!, unittest.equals('foo'));
...
void checkEnterpriseCrmFrontendsEventbusProtoTaskConfig(
  ...
  if (buildCounterEnterpriseCrmFrontendsEventbusProtoTaskConfig < 3) {
    ...
    unittest.expect(o.precondition!, unittest.equals('foo'));
    unittest.expect(o.preconditionLabel!, unittest.equals('foo'));
    ...
    unittest.expect(o.taskExecutionStrategy!, unittest.equals('foo'));
    unittest.expect(o.taskName!, unittest.equals('foo'));
    unittest.expect(o.taskNumber!, unittest.equals('foo'));
    unittest.expect(o.taskSpec!, unittest.equals('foo'));
    unittest.expect(o.taskTemplateName!, unittest.equals('foo'));
...
void checkEnterpriseCrmFrontendsEventbusProtoTriggerConfig(
  ...
  if (buildCounterEnterpriseCrmFrontendsEventbusProtoTriggerConfig < 3) {
    ...
    unittest.expect(o.triggerType!, unittest.equals('foo'));
  }
  buildCounterEnterpriseCrmFrontendsEventbusProtoTriggerConfig--;
}
...
void checkUnnamed56(
  core.List<api.EnterpriseCrmFrontendsEventbusProtoWorkflowParameterEntry> o,
) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkEnterpriseCrmFrontendsEventbusProtoWorkflowParameterEntry(
  ...
  if (buildCounterEnterpriseCrmFrontendsEventbusProtoWorkflowParameterEntry <
    ...
    checkEnterpriseCrmFrontendsEventbusProtoParameterValueType(o.defaultValue!);
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.inOutType!, unittest.equals('foo'));
    ...
    unittest.expect(o.protoDefName!, unittest.equals('foo'));
    unittest.expect(o.protoDefPath!, unittest.equals('foo'));
    unittest.expect(o.required!, unittest.isTrue);
  }
  buildCounterEnterpriseCrmFrontendsEventbusProtoWorkflowParameterEntry--;
}
...
void checkGoogleCloudIntegrationsV1alphaAccessToken(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaAccessToken < 3) {
    ...
    unittest.expect(o.accessTokenExpireTime!, unittest.equals('foo'));
    unittest.expect(o.refreshToken!, unittest.equals('foo'));
    unittest.expect(o.refreshTokenExpireTime!, unittest.equals('foo'));
...
core.int buildCounterGoogleCloudIntegrationsV1alphaApiTriggerResource = 0;
api.GoogleCloudIntegrationsV1alphaApiTriggerResource
    buildGoogleCloudIntegrationsV1alphaApiTriggerResource() {
  final o = api.GoogleCloudIntegrationsV1alphaApiTriggerResource();
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaApiTriggerResource < 3) {
    ...
    o.triggerId = buildUnnamed69();
  }
  buildCounterGoogleCloudIntegrationsV1alphaApiTriggerResource--;
  return o;
}

void checkGoogleCloudIntegrationsV1alphaApiTriggerResource(
  api.GoogleCloudIntegrationsV1alphaApiTriggerResource o,
) {
  buildCounterGoogleCloudIntegrationsV1alphaApiTriggerResource++;
  if (buildCounterGoogleCloudIntegrationsV1alphaApiTriggerResource < 3) {
    unittest.expect(o.integrationResource!, unittest.equals('foo'));
    checkUnnamed69(o.triggerId!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaApiTriggerResource--;
}
...
void checkGoogleCloudIntegrationsV1alphaAssertion(
  ...
  buildCounterGoogleCloudIntegrationsV1alphaAssertion++;
  if (buildCounterGoogleCloudIntegrationsV1alphaAssertion < 3) {
    unittest.expect(o.assertionStrategy!, unittest.equals('foo'));
    unittest.expect(o.condition!, unittest.equals('foo'));
...
api.GoogleCloudIntegrationsV1alphaAuthConfig
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaAuthConfig < 3) {
    ...
    o.expiryNotificationDuration = buildUnnamed70();
...
void checkGoogleCloudIntegrationsV1alphaAuthConfig(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaAuthConfig < 3) {
    ...
    checkUnnamed70(o.expiryNotificationDuration!);
    ...
    unittest.expect(o.state!, unittest.equals('foo'));
    unittest.expect(o.updateTime!, unittest.equals('foo'));
    unittest.expect(o.validTime!, unittest.equals('foo'));
...
core.List<core.bool> buildUnnamed71() => [true, true];

void checkUnnamed71(core.List<core.bool> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.isTrue);
  unittest.expect(o[1], unittest.isTrue);
}
...
api.GoogleCloudIntegrationsV1alphaBooleanParameterArray
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaBooleanParameterArray < 3) {
    o.booleanValues = buildUnnamed71();
  }
  buildCounterGoogleCloudIntegrationsV1alphaBooleanParameterArray--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaBooleanParameterArray(
  ...
  buildCounterGoogleCloudIntegrationsV1alphaBooleanParameterArray++;
  if (buildCounterGoogleCloudIntegrationsV1alphaBooleanParameterArray < 3) {
    checkUnnamed71(o.booleanValues!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaBooleanParameterArray--;
}
...
void checkGoogleCloudIntegrationsV1alphaCertificate(
  ...
  buildCounterGoogleCloudIntegrationsV1alphaCertificate++;
  if (buildCounterGoogleCloudIntegrationsV1alphaCertificate < 3) {
    unittest.expect(o.certificateStatus!, unittest.equals('foo'));
    ...
    unittest.expect(o.validEndTime!, unittest.equals('foo'));
    unittest.expect(o.validStartTime!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaCertificate--;
}
...
void checkGoogleCloudIntegrationsV1alphaClientCertificate(
  ...
  buildCounterGoogleCloudIntegrationsV1alphaClientCertificate++;
  if (buildCounterGoogleCloudIntegrationsV1alphaClientCertificate < 3) {
    unittest.expect(o.encryptedPrivateKey!, unittest.equals('foo'));
...
void checkGoogleCloudIntegrationsV1alphaClientConfig(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaClientConfig < 3) {
    ...
    unittest.expect(o.clientState!, unittest.equals('foo'));
    ...
    unittest.expect(o.runAsServiceAccount!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaClientConfig--;
}
...
void checkGoogleCloudIntegrationsV1alphaCloudKmsConfig(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaCloudKmsConfig < 3) {
    unittest.expect(o.key!, unittest.equals('foo'));
    unittest.expect(o.keyVersion!, unittest.equals('foo'));
    unittest.expect(o.kmsLocation!, unittest.equals('foo'));
    unittest.expect(o.kmsProjectId!, unittest.equals('foo'));
    unittest.expect(o.kmsRing!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaCloudKmsConfig--;
}
...
core.List<api.GoogleCloudIntegrationsV1alphaFailurePolicy> buildUnnamed72() => [
...
api.GoogleCloudIntegrationsV1alphaConditionalFailurePolicies
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaConditionalFailurePolicies <
    ...
    o.failurePolicies = buildUnnamed72();
  }
  buildCounterGoogleCloudIntegrationsV1alphaConditionalFailurePolicies--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaConditionalFailurePolicies(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaConditionalFailurePolicies <
    ...
    checkUnnamed72(o.failurePolicies!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaConditionalFailurePolicies--;
}
...
void checkGoogleCloudIntegrationsV1alphaCreateAppsScriptProjectRequest(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaCreateAppsScriptProjectRequest <
      3) {
    unittest.expect(o.appsScriptProject!, unittest.equals('foo'));
    unittest.expect(o.authConfigId!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaCreateAppsScriptProjectRequest--;
}
...
void checkGoogleCloudIntegrationsV1alphaCreateCloudFunctionResponse(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaCreateCloudFunctionResponse <
      3) {
    unittest.expect(o.triggerUrl!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaCreateCloudFunctionResponse--;
}
...
core.List<core.double> buildUnnamed75() => [42.0, 42.0];

void checkUnnamed75(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42.0));
  unittest.expect(o[1], unittest.equals(42.0));
}
...
core.List<api.GoogleCloudIntegrationsV1alphaSerializedFile> buildUnnamed76() =>
    [
...
core.List<api.GoogleCloudIntegrationsV1alphaFile> buildUnnamed77() => [
      buildGoogleCloudIntegrationsV1alphaFile(),
      buildGoogleCloudIntegrationsV1alphaFile(),
    ];

void checkUnnamed77(core.List<api.GoogleCloudIntegrationsV1alphaFile> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void
  ...
  api.GoogleCloudIntegrationsV1alphaEnumerateConnectorPlatformRegionsResponse o,
) {
  buildCounterGoogleCloudIntegrationsV1alphaEnumerateConnectorPlatformRegionsResponse++;
  if (buildCounterGoogleCloudIntegrationsV1alphaEnumerateConnectorPlatformRegionsResponse <
      3) {
    checkUnnamed78(o.regions!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaEnumerateConnectorPlatformRegionsResponse--;
}

core.List<api.GoogleCloudIntegrationsV1alphaNextTask> buildUnnamed79() => [
      buildGoogleCloudIntegrationsV1alphaNextTask(),
      buildGoogleCloudIntegrationsV1alphaNextTask(),
    ];

void checkUnnamed79(core.List<api.GoogleCloudIntegrationsV1alphaNextTask> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleCloudIntegrationsV1alphaErrorCatcherConfig
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaErrorCatcherConfig < 3) {
    ...
    o.startErrorTasks = buildUnnamed79();
  }
  buildCounterGoogleCloudIntegrationsV1alphaErrorCatcherConfig--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaErrorCatcherConfig(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaErrorCatcherConfig < 3) {
    ...
    checkUnnamed79(o.startErrorTasks!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaErrorCatcherConfig--;
}
...
api.GoogleCloudIntegrationsV1alphaExecuteIntegrationsResponse
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaExecuteIntegrationsResponse <
    ...
    o.executionId = 'foo';
    o.outputParameters = buildUnnamed82();
...
void checkGoogleCloudIntegrationsV1alphaExecuteIntegrationsResponse(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaExecuteIntegrationsResponse <
    ...
    unittest.expect(o.executionId!, unittest.equals('foo'));
    checkUnnamed82(o.outputParameters!);
...
api.GoogleCloudIntegrationsV1alphaExecuteTestCaseRequest
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaExecuteTestCaseRequest < 3) {
    o.inputParameters = buildUnnamed84();
  }
  buildCounterGoogleCloudIntegrationsV1alphaExecuteTestCaseRequest--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaExecuteTestCaseRequest(
  ...
  buildCounterGoogleCloudIntegrationsV1alphaExecuteTestCaseRequest++;
  if (buildCounterGoogleCloudIntegrationsV1alphaExecuteTestCaseRequest < 3) {
    checkUnnamed84(o.inputParameters!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaExecuteTestCaseRequest--;
}

core.List<api.GoogleCloudIntegrationsV1alphaAssertionResult> buildUnnamed85() =>
    [
      buildGoogleCloudIntegrationsV1alphaAssertionResult(),
      buildGoogleCloudIntegrationsV1alphaAssertionResult(),
    ];
...
api.GoogleCloudIntegrationsV1alphaExecuteTestCaseResponse
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaExecuteTestCaseResponse < 3) {
    o.assertionResults = buildUnnamed85();
    o.executionId = 'foo';
    o.outputParameters = buildUnnamed86();
...
void checkGoogleCloudIntegrationsV1alphaExecuteTestCaseResponse(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaExecuteTestCaseResponse < 3) {
    ...
    unittest.expect(o.executionId!, unittest.equals('foo'));
    checkUnnamed86(o.outputParameters!);
    unittest.expect(o.testExecutionState!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaExecuteTestCaseResponse--;
}

core.List<api.GoogleCloudIntegrationsV1alphaExecution> buildUnnamed87() => [
      buildGoogleCloudIntegrationsV1alphaExecution(),
      buildGoogleCloudIntegrationsV1alphaExecution(),
    ];

void checkUnnamed87(core.List<api.GoogleCloudIntegrationsV1alphaExecution> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleCloudIntegrationsV1alphaExecution
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaExecution < 3) {
    o.cloudLoggingDetails =
        buildGoogleCloudIntegrationsV1alphaCloudLoggingDetails();
    o.createTime = 'foo';
    o.directSubExecutions = buildUnnamed87();
    o.eventExecutionDetails =
        buildEnterpriseCrmEventbusProtoEventExecutionDetails();
    ...
    o.requestParameters = buildUnnamed88();
    o.requestParams = buildUnnamed89();
    o.responseParameters = buildUnnamed90();
    o.responseParams = buildUnnamed91();
    o.snapshotNumber = 'foo';
    o.triggerId = 'foo';
    o.updateTime = 'foo';
  }
...
void checkGoogleCloudIntegrationsV1alphaExecution(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaExecution < 3) {
    ...
    unittest.expect(o.createTime!, unittest.equals('foo'));
    checkUnnamed87(o.directSubExecutions!);
    ...
    unittest.expect(o.executionMethod!, unittest.equals('foo'));
    ...
    checkUnnamed88(o.requestParameters!);
    checkUnnamed89(o.requestParams!);
    checkUnnamed90(o.responseParameters!);
    checkUnnamed91(o.responseParams!);
    unittest.expect(o.snapshotNumber!, unittest.equals('foo'));
    unittest.expect(o.triggerId!, unittest.equals('foo'));
    unittest.expect(o.updateTime!, unittest.equals('foo'));
  }
...
core.List<api.GoogleCloudIntegrationsV1alphaAttemptStats> buildUnnamed92() => [
      buildGoogleCloudIntegrationsV1alphaAttemptStats(),
      buildGoogleCloudIntegrationsV1alphaAttemptStats(),
    ];
...
api.GoogleCloudIntegrationsV1alphaExecutionDetails
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaExecutionDetails < 3) {
    o.attemptStats = buildUnnamed92();
    o.eventExecutionSnapshotsSize = 'foo';
    o.executionSnapshots = buildUnnamed93();
    o.state = 'foo';
  }
  buildCounterGoogleCloudIntegrationsV1alphaExecutionDetails--;
  return o;
...
void checkGoogleCloudIntegrationsV1alphaExecutionDetails(
  ...
  buildCounterGoogleCloudIntegrationsV1alphaExecutionDetails++;
  if (buildCounterGoogleCloudIntegrationsV1alphaExecutionDetails < 3) {
    checkUnnamed92(o.attemptStats!);
    unittest.expect(o.eventExecutionSnapshotsSize!, unittest.equals('foo'));
    checkUnnamed93(o.executionSnapshots!);
    unittest.expect(o.state!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaExecutionDetails--;
}
...
api.GoogleCloudIntegrationsV1alphaExecutionReplayInfo
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaExecutionReplayInfo < 3) {
    ...
    o.replayMode = 'foo';
    o.replayReason = 'foo';
    o.replayedExecutionInfoIds = buildUnnamed94();
  }
  buildCounterGoogleCloudIntegrationsV1alphaExecutionReplayInfo--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaExecutionReplayInfo(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaExecutionReplayInfo < 3) {
    ...
    unittest.expect(o.replayMode!, unittest.equals('foo'));
    unittest.expect(o.replayReason!, unittest.equals('foo'));
    checkUnnamed94(o.replayedExecutionInfoIds!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaExecutionReplayInfo--;
}
...
api.GoogleCloudIntegrationsV1alphaExecutionSnapshot
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaExecutionSnapshot < 3) {
    ...
    o.params = buildUnnamed95();
    o.taskExecutionDetails = buildUnnamed96();
  }
  buildCounterGoogleCloudIntegrationsV1alphaExecutionSnapshot--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaExecutionSnapshot(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaExecutionSnapshot < 3) {
    ...
    checkUnnamed95(o.params!);
    checkUnnamed96(o.taskExecutionDetails!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaExecutionSnapshot--;
}
...
api.GoogleCloudIntegrationsV1alphaExecutionSnapshotExecutionSnapshotMetadata
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaExecutionSnapshotExecutionSnapshotMetadata <
      3) {
    o.ancestorIterationNumbers = buildUnnamed97();
    o.ancestorTaskNumbers = buildUnnamed98();
...
void
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaExecutionSnapshotExecutionSnapshotMetadata <
      3) {
    checkUnnamed97(o.ancestorIterationNumbers!);
    checkUnnamed98(o.ancestorTaskNumbers!);
    unittest.expect(o.executionAttempt!, unittest.equals(42));
    unittest.expect(o.integrationName!, unittest.equals('foo'));
    unittest.expect(o.task!, unittest.equals('foo'));
    unittest.expect(o.taskAttempt!, unittest.equals(42));
    unittest.expect(o.taskLabel!, unittest.equals('foo'));
    unittest.expect(o.taskNumber!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaExecutionSnapshotExecutionSnapshotMetadata--;
...
void checkGoogleCloudIntegrationsV1alphaFailurePolicy(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaFailurePolicy < 3) {
    unittest.expect(o.condition!, unittest.equals('foo'));
    unittest.expect(o.intervalTime!, unittest.equals('foo'));
...
api.GoogleCloudIntegrationsV1alphaFile
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaFile < 3) {
    o.integrationConfig = buildUnnamed99();
...
void checkGoogleCloudIntegrationsV1alphaFile(
  ...
  buildCounterGoogleCloudIntegrationsV1alphaFile++;
  if (buildCounterGoogleCloudIntegrationsV1alphaFile < 3) {
    checkUnnamed99(o.integrationConfig!);
...
void checkUnnamed100(
  ...
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudIntegrationsV1alphaApiTriggerResource(o[0]);
  checkGoogleCloudIntegrationsV1alphaApiTriggerResource(o[1]);
}

core.int buildCounterGoogleCloudIntegrationsV1alphaGenerateOpenApiSpecRequest =
    0;
api.GoogleCloudIntegrationsV1alphaGenerateOpenApiSpecRequest
  ...
  final o = api.GoogleCloudIntegrationsV1alphaGenerateOpenApiSpecRequest();
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaGenerateOpenApiSpecRequest <
      3) {
    o.apiTriggerResources = buildUnnamed100();
    o.fileFormat = 'foo';
  }
  buildCounterGoogleCloudIntegrationsV1alphaGenerateOpenApiSpecRequest--;
  return o;
...
void checkGoogleCloudIntegrationsV1alphaGenerateOpenApiSpecRequest(
  api.GoogleCloudIntegrationsV1alphaGenerateOpenApiSpecRequest o,
) {
  buildCounterGoogleCloudIntegrationsV1alphaGenerateOpenApiSpecRequest++;
  if (buildCounterGoogleCloudIntegrationsV1alphaGenerateOpenApiSpecRequest <
      3) {
    checkUnnamed100(o.apiTriggerResources!);
    unittest.expect(o.fileFormat!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaGenerateOpenApiSpecRequest--;
}

core.int buildCounterGoogleCloudIntegrationsV1alphaGenerateOpenApiSpecResponse =
    0;
api.GoogleCloudIntegrationsV1alphaGenerateOpenApiSpecResponse
  ...
  final o = api.GoogleCloudIntegrationsV1alphaGenerateOpenApiSpecResponse();
  buildCounterGoogleCloudIntegrationsV1alphaGenerateOpenApiSpecResponse++;
  if (buildCounterGoogleCloudIntegrationsV1alphaGenerateOpenApiSpecResponse <
      3) {
    o.openApiSpec = 'foo';
  }
  buildCounterGoogleCloudIntegrationsV1alphaGenerateOpenApiSpecResponse--;
...
void checkGoogleCloudIntegrationsV1alphaGenerateOpenApiSpecResponse(
  api.GoogleCloudIntegrationsV1alphaGenerateOpenApiSpecResponse o,
) {
  buildCounterGoogleCloudIntegrationsV1alphaGenerateOpenApiSpecResponse++;
  if (buildCounterGoogleCloudIntegrationsV1alphaGenerateOpenApiSpecResponse <
      3) {
    unittest.expect(o.openApiSpec!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaGenerateOpenApiSpecResponse--;
}
...
api.GoogleCloudIntegrationsV1alphaImportTemplateRequest
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaImportTemplateRequest < 3) {
    ...
    o.subIntegrations = buildUnnamed101();
  }
  buildCounterGoogleCloudIntegrationsV1alphaImportTemplateRequest--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaImportTemplateRequest(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaImportTemplateRequest < 3) {
    ...
    checkUnnamed101(o.subIntegrations!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaImportTemplateRequest--;
}
...
api.GoogleCloudIntegrationsV1alphaImportTemplateResponse
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaImportTemplateResponse < 3) {
    o.integrationVersion =
        buildGoogleCloudIntegrationsV1alphaIntegrationVersion();
    o.subIntegrationVersions = buildUnnamed102();
  }
  buildCounterGoogleCloudIntegrationsV1alphaImportTemplateResponse--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaImportTemplateResponse(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaImportTemplateResponse < 3) {
    ...
    checkUnnamed102(o.subIntegrationVersions!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaImportTemplateResponse--;
}
...
void checkGoogleCloudIntegrationsV1alphaIntegrationAlertConfig(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaIntegrationAlertConfig < 3) {
    unittest.expect(o.aggregationPeriod!, unittest.equals('foo'));
    unittest.expect(o.alertThreshold!, unittest.equals(42));
    unittest.expect(o.disableAlert!, unittest.isTrue);
    unittest.expect(o.displayName!, unittest.equals('foo'));
    unittest.expect(o.durationThreshold!, unittest.equals('foo'));
    unittest.expect(o.metricType!, unittest.equals('foo'));
    unittest.expect(o.onlyFinalAttempt!, unittest.isTrue);
    unittest.expect(o.thresholdType!, unittest.equals('foo'));
...
void checkGoogleCloudIntegrationsV1alphaIntegrationParameter(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaIntegrationParameter < 3) {
    ...
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.displayName!, unittest.equals('foo'));
    unittest.expect(o.inputOutputType!, unittest.equals('foo'));
    unittest.expect(o.isTransient!, unittest.isTrue);
    unittest.expect(o.jsonSchema!, unittest.equals('foo'));
    unittest.expect(o.key!, unittest.equals('foo'));
    unittest.expect(o.masked!, unittest.isTrue);
...
core.List<api.GoogleCloudIntegrationsV1alphaTaskConfig> buildUnnamed107() => [
...
core.List<api.GoogleCloudIntegrationsV1alphaTriggerConfig> buildUnnamed109() =>
    [
...
api.GoogleCloudIntegrationsV1alphaIntegrationVersion
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaIntegrationVersion < 3) {
    ...
    o.description = 'foo';
    o.enableVariableMasking = true;
    o.errorCatcherConfigs = buildUnnamed104();
    o.integrationConfigParameters = buildUnnamed105();
    o.integrationParameters = buildUnnamed106();
    ...
    o.state = 'foo';
    o.status = 'foo';
    o.taskConfigs = buildUnnamed107();
    o.taskConfigsInternal = buildUnnamed108();
    o.teardown = buildEnterpriseCrmEventbusProtoTeardown();
    o.triggerConfigs = buildUnnamed109();
    o.triggerConfigsInternal = buildUnnamed110();
    o.updateTime = 'foo';
    o.userLabel = 'foo';
  }
  buildCounterGoogleCloudIntegrationsV1alphaIntegrationVersion--;
...
void checkGoogleCloudIntegrationsV1alphaIntegrationVersion(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaIntegrationVersion < 3) {
    ...
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.createdFromTemplate!, unittest.equals('foo'));
    unittest.expect(o.databasePersistencePolicy!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.enableVariableMasking!, unittest.isTrue);
    checkUnnamed104(o.errorCatcherConfigs!);
    checkUnnamed105(o.integrationConfigParameters!);
    checkUnnamed106(o.integrationParameters!);
    checkEnterpriseCrmFrontendsEventbusProtoWorkflowParameters(
      o.integrationParametersInternal!,
    );
    unittest.expect(o.lastModifierEmail!, unittest.equals('foo'));
    unittest.expect(o.lockHolder!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.origin!, unittest.equals('foo'));
    unittest.expect(o.parentTemplateId!, unittest.equals('foo'));
    unittest.expect(o.runAsServiceAccount!, unittest.equals('foo'));
    unittest.expect(o.snapshotNumber!, unittest.equals('foo'));
    unittest.expect(o.state!, unittest.equals('foo'));
    unittest.expect(o.status!, unittest.equals('foo'));
    checkUnnamed107(o.taskConfigs!);
    checkUnnamed108(o.taskConfigsInternal!);
    checkEnterpriseCrmEventbusProtoTeardown(o.teardown!);
    checkUnnamed109(o.triggerConfigs!);
    checkUnnamed110(o.triggerConfigsInternal!);
    unittest.expect(o.updateTime!, unittest.equals('foo'));
...
void checkGoogleCloudIntegrationsV1alphaJwt(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaJwt < 3) {
    ...
    unittest.expect(o.jwtHeader!, unittest.equals('foo'));
    unittest.expect(o.jwtPayload!, unittest.equals('foo'));
...
void checkGoogleCloudIntegrationsV1alphaLiftSuspensionRequest(
  ...
  buildCounterGoogleCloudIntegrationsV1alphaLiftSuspensionRequest++;
  if (buildCounterGoogleCloudIntegrationsV1alphaLiftSuspensionRequest < 3) {
    unittest.expect(o.suspensionResult!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaLiftSuspensionRequest--;
}
...
core.List<api.GoogleCloudIntegrationsV1alphaAuthConfig> buildUnnamed111() => [
      buildGoogleCloudIntegrationsV1alphaAuthConfig(),
      buildGoogleCloudIntegrationsV1alphaAuthConfig(),
    ];
...
core.List<api.GoogleCloudIntegrationsV1alphaCertificate> buildUnnamed112() => [
      buildGoogleCloudIntegrationsV1alphaCertificate(),
      buildGoogleCloudIntegrationsV1alphaCertificate(),
    ];
...
api.GoogleCloudIntegrationsV1alphaListCertificatesResponse
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaListCertificatesResponse < 3) {
    o.certificates = buildUnnamed112();
    o.nextPageToken = 'foo';
  }
  buildCounterGoogleCloudIntegrationsV1alphaListCertificatesResponse--;
  return o;
...
void checkGoogleCloudIntegrationsV1alphaListCertificatesResponse(
  ...
  buildCounterGoogleCloudIntegrationsV1alphaListCertificatesResponse++;
  if (buildCounterGoogleCloudIntegrationsV1alphaListCertificatesResponse < 3) {
    checkUnnamed112(o.certificates!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaListCertificatesResponse--;
}

core.List<api.GoogleCloudConnectorsV1Connection> buildUnnamed113() => [
      buildGoogleCloudConnectorsV1Connection(),
      buildGoogleCloudConnectorsV1Connection(),
    ];

void checkUnnamed113(core.List<api.GoogleCloudConnectorsV1Connection> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleCloudIntegrationsV1alphaExecution> buildUnnamed115() => [
      buildGoogleCloudIntegrationsV1alphaExecution(),
      buildGoogleCloudIntegrationsV1alphaExecution(),
    ];

void checkUnnamed115(core.List<api.GoogleCloudIntegrationsV1alphaExecution> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudIntegrationsV1alphaExecution(o[0]);
  checkGoogleCloudIntegrationsV1alphaExecution(o[1]);
}
...
api.GoogleCloudIntegrationsV1alphaListExecutionsResponse
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaListExecutionsResponse < 3) {
    o.executionInfos = buildUnnamed114();
    o.executions = buildUnnamed115();
    o.nextPageToken = 'foo';
  }
  buildCounterGoogleCloudIntegrationsV1alphaListExecutionsResponse--;
  return o;
...
void checkGoogleCloudIntegrationsV1alphaListExecutionsResponse(
  ...
  buildCounterGoogleCloudIntegrationsV1alphaListExecutionsResponse++;
  if (buildCounterGoogleCloudIntegrationsV1alphaListExecutionsResponse < 3) {
    checkUnnamed114(o.executionInfos!);
    checkUnnamed115(o.executions!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaListExecutionsResponse--;
}
...
api.GoogleCloudIntegrationsV1alphaListIntegrationVersionsResponse
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaListIntegrationVersionsResponse <
      3) {
    o.integrationVersions = buildUnnamed116();
    o.nextPageToken = 'foo';
    o.noPermission = true;
  }
  buildCounterGoogleCloudIntegrationsV1alphaListIntegrationVersionsResponse--;
...
void checkGoogleCloudIntegrationsV1alphaListIntegrationVersionsResponse(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaListIntegrationVersionsResponse <
      3) {
    checkUnnamed116(o.integrationVersions!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
...
core.List<api.GoogleCloudIntegrationsV1alphaIntegration> buildUnnamed117() => [
      buildGoogleCloudIntegrationsV1alphaIntegration(),
      buildGoogleCloudIntegrationsV1alphaIntegration(),
    ];
...
api.GoogleCloudIntegrationsV1alphaListIntegrationsResponse
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaListIntegrationsResponse < 3) {
    o.integrations = buildUnnamed117();
    o.nextPageToken = 'foo';
  }
  buildCounterGoogleCloudIntegrationsV1alphaListIntegrationsResponse--;
  return o;
...
void checkGoogleCloudIntegrationsV1alphaListIntegrationsResponse(
  ...
  buildCounterGoogleCloudIntegrationsV1alphaListIntegrationsResponse++;
  if (buildCounterGoogleCloudIntegrationsV1alphaListIntegrationsResponse < 3) {
    checkUnnamed117(o.integrations!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaListIntegrationsResponse--;
}
...
api.GoogleCloudIntegrationsV1alphaListRuntimeActionSchemasResponse
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaListRuntimeActionSchemasResponse <
      3) {
    o.nextPageToken = 'foo';
    o.runtimeActionSchemas = buildUnnamed118();
  }
  buildCounterGoogleCloudIntegrationsV1alphaListRuntimeActionSchemasResponse--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaListRuntimeActionSchemasResponse(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaListRuntimeActionSchemasResponse <
      3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed118(o.runtimeActionSchemas!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaListRuntimeActionSchemasResponse--;
}
...
api.GoogleCloudIntegrationsV1alphaListRuntimeEntitySchemasResponse
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaListRuntimeEntitySchemasResponse <
      3) {
    o.nextPageToken = 'foo';
    o.runtimeEntitySchemas = buildUnnamed119();
  }
  buildCounterGoogleCloudIntegrationsV1alphaListRuntimeEntitySchemasResponse--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaListRuntimeEntitySchemasResponse(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaListRuntimeEntitySchemasResponse <
      3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed119(o.runtimeEntitySchemas!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaListRuntimeEntitySchemasResponse--;
}

core.List<api.GoogleCloudIntegrationsV1alphaSfdcChannel> buildUnnamed120() => [
...
api.GoogleCloudIntegrationsV1alphaListSfdcChannelsResponse
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaListSfdcChannelsResponse < 3) {
    o.nextPageToken = 'foo';
    o.sfdcChannels = buildUnnamed120();
  }
  buildCounterGoogleCloudIntegrationsV1alphaListSfdcChannelsResponse--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaListSfdcChannelsResponse(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaListSfdcChannelsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed120(o.sfdcChannels!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaListSfdcChannelsResponse--;
}

core.List<api.GoogleCloudIntegrationsV1alphaSfdcInstance> buildUnnamed121() => [
...
api.GoogleCloudIntegrationsV1alphaListSfdcInstancesResponse
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaListSfdcInstancesResponse < 3) {
    o.nextPageToken = 'foo';
    o.sfdcInstances = buildUnnamed121();
  }
  buildCounterGoogleCloudIntegrationsV1alphaListSfdcInstancesResponse--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaListSfdcInstancesResponse(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaListSfdcInstancesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed121(o.sfdcInstances!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaListSfdcInstancesResponse--;
}

core.List<api.GoogleCloudIntegrationsV1alphaSuspension> buildUnnamed122() => [
...
void checkGoogleCloudIntegrationsV1alphaListSuspensionsResponse(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaListSuspensionsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed122(o.suspensions!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaListSuspensionsResponse--;
}

core.List<api.GoogleCloudIntegrationsV1alphaTemplate> buildUnnamed123() => [
      buildGoogleCloudIntegrationsV1alphaTemplate(),
      buildGoogleCloudIntegrationsV1alphaTemplate(),
    ];

void checkUnnamed123(core.List<api.GoogleCloudIntegrationsV1alphaTemplate> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkGoogleCloudIntegrationsV1alphaListTemplatesResponse(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaListTemplatesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed123(o.templates!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaListTemplatesResponse--;
}

core.List<api.GoogleCloudIntegrationsV1alphaExecution> buildUnnamed124() => [
      buildGoogleCloudIntegrationsV1alphaExecution(),
      buildGoogleCloudIntegrationsV1alphaExecution(),
    ];

void checkUnnamed124(core.List<api.GoogleCloudIntegrationsV1alphaExecution> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudIntegrationsV1alphaExecution(o[0]);
  checkGoogleCloudIntegrationsV1alphaExecution(o[1]);
}
...
void checkGoogleCloudIntegrationsV1alphaListTestCaseExecutionsResponse(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaListTestCaseExecutionsResponse <
      3) {
    checkUnnamed124(o.executions!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaListTestCaseExecutionsResponse--;
}

core.List<api.GoogleCloudIntegrationsV1alphaTestCase> buildUnnamed125() => [
      buildGoogleCloudIntegrationsV1alphaTestCase(),
      buildGoogleCloudIntegrationsV1alphaTestCase(),
    ];

void checkUnnamed125(core.List<api.GoogleCloudIntegrationsV1alphaTestCase> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkGoogleCloudIntegrationsV1alphaListTestCasesResponse(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaListTestCasesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed125(o.testCases!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaListTestCasesResponse--;
}

core.List<api.GoogleCloudIntegrationsV1alphaEventParameter> buildUnnamed126() =>
    [
      buildGoogleCloudIntegrationsV1alphaEventParameter(),
      buildGoogleCloudIntegrationsV1alphaEventParameter(),
    ];
...
void checkGoogleCloudIntegrationsV1alphaOAuth2AuthorizationCode(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaOAuth2AuthorizationCode < 3) {
    ...
    unittest.expect(o.authCode!, unittest.equals('foo'));
    unittest.expect(o.authEndpoint!, unittest.equals('foo'));
...
void checkGoogleCloudIntegrationsV1alphaOidcToken(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaOidcToken < 3) {
    ...
    unittest.expect(o.serviceAccountEmail!, unittest.equals('foo'));
    unittest.expect(o.token!, unittest.equals('foo'));
    unittest.expect(o.tokenExpireTime!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaOidcToken--;
}
...
void checkGoogleCloudIntegrationsV1alphaParameterMapField(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaParameterMapField < 3) {
    ...
    unittest.expect(o.referenceKey!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaParameterMapField--;
}
...
api.GoogleCloudIntegrationsV1alphaProjectProperties
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaProjectProperties < 3) {
    ...
    o.provisionedRegions = buildUnnamed128();
  }
  buildCounterGoogleCloudIntegrationsV1alphaProjectProperties--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaProjectProperties(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaProjectProperties < 3) {
    ...
    checkUnnamed128(o.provisionedRegions!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaProjectProperties--;
}
...
api.GoogleCloudIntegrationsV1alphaPublishIntegrationVersionRequest
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaPublishIntegrationVersionRequest <
      3) {
    o.configParameters = buildUnnamed129();
  }
  buildCounterGoogleCloudIntegrationsV1alphaPublishIntegrationVersionRequest--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaPublishIntegrationVersionRequest(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaPublishIntegrationVersionRequest <
      3) {
    checkUnnamed129(o.configParameters!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaPublishIntegrationVersionRequest--;
}
...
api.GoogleCloudIntegrationsV1alphaReplayExecutionResponse
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaReplayExecutionResponse < 3) {
    o.executionId = 'foo';
    o.outputParameters = buildUnnamed130();
...
void checkGoogleCloudIntegrationsV1alphaReplayExecutionResponse(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaReplayExecutionResponse < 3) {
    unittest.expect(o.executionId!, unittest.equals('foo'));
    checkUnnamed130(o.outputParameters!);
...
void checkGoogleCloudIntegrationsV1alphaRuntimeActionSchema(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaRuntimeActionSchema < 3) {
    ...
    unittest.expect(o.inputSchema!, unittest.equals('foo'));
...
void checkGoogleCloudIntegrationsV1alphaRuntimeEntitySchema(
  ...
  buildCounterGoogleCloudIntegrationsV1alphaRuntimeEntitySchema++;
  if (buildCounterGoogleCloudIntegrationsV1alphaRuntimeEntitySchema < 3) {
    unittest.expect(o.arrayFieldSchema!, unittest.equals('foo'));
    unittest.expect(o.entity!, unittest.equals('foo'));
    unittest.expect(o.fieldSchema!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaRuntimeEntitySchema--;
}
...
api.GoogleCloudIntegrationsV1alphaScheduleIntegrationsRequest
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaScheduleIntegrationsRequest <
      3) {
    o.inputParameters = buildUnnamed131();
    o.parameterEntries = buildUnnamed132();
    o.parameters = buildEnterpriseCrmEventbusProtoEventParameters();
    o.requestId = 'foo';
    o.scheduleTime = 'foo';
    o.triggerId = 'foo';
...
void checkGoogleCloudIntegrationsV1alphaScheduleIntegrationsRequest(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaScheduleIntegrationsRequest <
      3) {
    checkUnnamed131(o.inputParameters!);
    checkUnnamed132(o.parameterEntries!);
    checkEnterpriseCrmEventbusProtoEventParameters(o.parameters!);
    unittest.expect(o.requestId!, unittest.equals('foo'));
    unittest.expect(o.scheduleTime!, unittest.equals('foo'));
    unittest.expect(o.triggerId!, unittest.equals('foo'));
    unittest.expect(o.userGeneratedExecutionId!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaScheduleIntegrationsRequest--;
}
...
api.GoogleCloudIntegrationsV1alphaScheduleIntegrationsResponse
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaScheduleIntegrationsResponse <
      3) {
    o.executionInfoIds = buildUnnamed133();
  }
  buildCounterGoogleCloudIntegrationsV1alphaScheduleIntegrationsResponse--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaScheduleIntegrationsResponse(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaScheduleIntegrationsResponse <
      3) {
    checkUnnamed133(o.executionInfoIds!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaScheduleIntegrationsResponse--;
}

core.List<api.GoogleCloudIntegrationsV1alphaTemplate> buildUnnamed134() => [
      buildGoogleCloudIntegrationsV1alphaTemplate(),
      buildGoogleCloudIntegrationsV1alphaTemplate(),
    ];

void checkUnnamed134(core.List<api.GoogleCloudIntegrationsV1alphaTemplate> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudIntegrationsV1alphaTemplate(o[0]);
  checkGoogleCloudIntegrationsV1alphaTemplate(o[1]);
}
...
void checkGoogleCloudIntegrationsV1alphaSfdcChannel(
  ...
  buildCounterGoogleCloudIntegrationsV1alphaSfdcChannel++;
  if (buildCounterGoogleCloudIntegrationsV1alphaSfdcChannel < 3) {
    unittest.expect(o.channelTopic!, unittest.equals('foo'));
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.deleteTime!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.displayName!, unittest.equals('foo'));
    unittest.expect(o.isActive!, unittest.isTrue);
    unittest.expect(o.lastReplayId!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.updateTime!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaSfdcChannel--;
...
api.GoogleCloudIntegrationsV1alphaSfdcInstance
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaSfdcInstance < 3) {
    o.authConfigId = buildUnnamed135();
    o.createTime = 'foo';
    o.deleteTime = 'foo';
    o.description = 'foo';
    o.displayName = 'foo';
...
void checkGoogleCloudIntegrationsV1alphaSfdcInstance(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaSfdcInstance < 3) {
    ...
    unittest.expect(o.displayName!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.serviceAuthority!, unittest.equals('foo'));
    unittest.expect(o.sfdcOrgId!, unittest.equals('foo'));
    unittest.expect(o.updateTime!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaSfdcInstance--;
}
...
api.GoogleCloudIntegrationsV1alphaShareTemplateRequest
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaShareTemplateRequest < 3) {
    o.resourceNames = buildUnnamed136();
  }
  buildCounterGoogleCloudIntegrationsV1alphaShareTemplateRequest--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaShareTemplateRequest(
  ...
  buildCounterGoogleCloudIntegrationsV1alphaShareTemplateRequest++;
  if (buildCounterGoogleCloudIntegrationsV1alphaShareTemplateRequest < 3) {
    checkUnnamed136(o.resourceNames!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaShareTemplateRequest--;
}
...
api.GoogleCloudIntegrationsV1alphaStringParameterArray
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaStringParameterArray < 3) {
    o.stringValues = buildUnnamed137();
  }
  buildCounterGoogleCloudIntegrationsV1alphaStringParameterArray--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaStringParameterArray(
  ...
  buildCounterGoogleCloudIntegrationsV1alphaStringParameterArray++;
  if (buildCounterGoogleCloudIntegrationsV1alphaStringParameterArray < 3) {
    checkUnnamed137(o.stringValues!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaStringParameterArray--;
}
...
api.GoogleCloudIntegrationsV1alphaSuspensionApprovalConfig
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaSuspensionApprovalConfig < 3) {
    o.customMessage = 'foo';
    o.emailAddresses = buildUnnamed138();
    o.expiration =
...
void checkGoogleCloudIntegrationsV1alphaSuspensionApprovalConfig(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaSuspensionApprovalConfig < 3) {
    unittest.expect(o.customMessage!, unittest.equals('foo'));
    checkUnnamed138(o.emailAddresses!);
...
void checkGoogleCloudIntegrationsV1alphaSuspensionApprovalExpiration(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaSuspensionApprovalExpiration <
    ...
    unittest.expect(o.liftWhenExpired!, unittest.isTrue);
    unittest.expect(o.remindTime!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaSuspensionApprovalExpiration--;
}
...
void checkGoogleCloudIntegrationsV1alphaSuspensionAudit(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaSuspensionAudit < 3) {
    ...
    unittest.expect(o.resolver!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaSuspensionAudit--;
}
...
core.List<api.GoogleCloudIntegrationsV1alphaNextTask> buildUnnamed139() => [
      buildGoogleCloudIntegrationsV1alphaNextTask(),
      buildGoogleCloudIntegrationsV1alphaNextTask(),
    ];

void checkUnnamed139(core.List<api.GoogleCloudIntegrationsV1alphaNextTask> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudIntegrationsV1alphaNextTask(o[0]);
  checkGoogleCloudIntegrationsV1alphaNextTask(o[1]);
}
...
void checkGoogleCloudIntegrationsV1alphaTaskConfig(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaTaskConfig < 3) {
    ...
    unittest.expect(o.taskExecutionStrategy!, unittest.equals('foo'));
    unittest.expect(o.taskId!, unittest.equals('foo'));
    unittest.expect(o.taskTemplate!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaTaskConfig--;
}

core.List<api.GoogleCloudIntegrationsV1alphaAttemptStats> buildUnnamed141() => [
      buildGoogleCloudIntegrationsV1alphaAttemptStats(),
      buildGoogleCloudIntegrationsV1alphaAttemptStats(),
    ];
...
api.GoogleCloudIntegrationsV1alphaTaskExecutionDetails
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaTaskExecutionDetails < 3) {
    o.taskAttemptStats = buildUnnamed141();
    o.taskExecutionState = 'foo';
    o.taskNumber = 'foo';
  }
  buildCounterGoogleCloudIntegrationsV1alphaTaskExecutionDetails--;
...
void checkGoogleCloudIntegrationsV1alphaTaskExecutionDetails(
  ...
  buildCounterGoogleCloudIntegrationsV1alphaTaskExecutionDetails++;
  if (buildCounterGoogleCloudIntegrationsV1alphaTaskExecutionDetails < 3) {
    checkUnnamed141(o.taskAttemptStats!);
    unittest.expect(o.taskExecutionState!, unittest.equals('foo'));
    unittest.expect(o.taskNumber!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaTaskExecutionDetails--;
...
api.GoogleCloudIntegrationsV1alphaTemplate
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaTemplate < 3) {
    o.author = 'foo';
    o.categories = buildUnnamed142();
    o.components = buildUnnamed143();
    o.createTime = 'foo';
    o.description = 'foo';
    o.displayName = 'foo';
    o.docLink = 'foo';
...
void checkGoogleCloudIntegrationsV1alphaTemplate(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaTemplate < 3) {
    ...
    checkUnnamed142(o.categories!);
    checkUnnamed143(o.components!);
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.displayName!, unittest.equals('foo'));
...
api.GoogleCloudIntegrationsV1alphaTemplateBundle
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaTemplateBundle < 3) {
    o.integrationVersionTemplate =
        buildGoogleCloudIntegrationsV1alphaIntegrationVersionTemplate();
    o.subIntegrationVersionTemplates = buildUnnamed146();
  }
  buildCounterGoogleCloudIntegrationsV1alphaTemplateBundle--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaTemplateBundle(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaTemplateBundle < 3) {
    ...
    checkUnnamed146(o.subIntegrationVersionTemplates!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaTemplateBundle--;
}
...
core.List<api.GoogleCloudIntegrationsV1alphaTestTaskConfig> buildUnnamed148() =>
    [
...
api.GoogleCloudIntegrationsV1alphaTestCase
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaTestCase < 3) {
    ...
    o.name = 'foo';
    o.testInputParameters = buildUnnamed147();
    o.testTaskConfigs = buildUnnamed148();
...
void checkGoogleCloudIntegrationsV1alphaTestCase(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaTestCase < 3) {
    ...
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed147(o.testInputParameters!);
    checkUnnamed148(o.testTaskConfigs!);
...
core.Map<core.String, core.Object?> buildUnnamed149() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo',
...
void checkUnnamed149(core.Map<core.String, core.Object?> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleCloudIntegrationsV1alphaTestIntegrationsRequest
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaTestIntegrationsRequest < 3) {
    o.clientId = 'foo';
    o.configParameters = buildUnnamed149();
    o.deadlineSecondsTime = 'foo';
    o.inputParameters = buildUnnamed150();
    o.integrationVersion =
        buildGoogleCloudIntegrationsV1alphaIntegrationVersion();
    o.parameters = buildEnterpriseCrmFrontendsEventbusProtoEventParameters();
    o.testMode = true;
...
void checkGoogleCloudIntegrationsV1alphaTestIntegrationsRequest(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaTestIntegrationsRequest < 3) {
    unittest.expect(o.clientId!, unittest.equals('foo'));
    checkUnnamed149(o.configParameters!);
    unittest.expect(o.deadlineSecondsTime!, unittest.equals('foo'));
    checkUnnamed150(o.inputParameters!);
    checkGoogleCloudIntegrationsV1alphaIntegrationVersion(
      o.integrationVersion!,
    );
    checkEnterpriseCrmFrontendsEventbusProtoEventParameters(o.parameters!);
...
api.GoogleCloudIntegrationsV1alphaTestIntegrationsResponse
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaTestIntegrationsResponse < 3) {
    ...
    o.executionFailed = true;
    o.executionId = 'foo';
    o.parameterEntries = buildUnnamed151();
    o.parameters = buildUnnamed152();
  }
  buildCounterGoogleCloudIntegrationsV1alphaTestIntegrationsResponse--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaTestIntegrationsResponse(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaTestIntegrationsResponse < 3) {
    ...
    unittest.expect(o.executionFailed!, unittest.isTrue);
    unittest.expect(o.executionId!, unittest.equals('foo'));
    checkUnnamed151(o.parameterEntries!);
    checkUnnamed152(o.parameters!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaTestIntegrationsResponse--;
}

core.List<api.GoogleCloudIntegrationsV1alphaAssertion> buildUnnamed153() => [
      buildGoogleCloudIntegrationsV1alphaAssertion(),
      buildGoogleCloudIntegrationsV1alphaAssertion(),
    ];

void checkUnnamed153(core.List<api.GoogleCloudIntegrationsV1alphaAssertion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleCloudIntegrationsV1alphaNextTask> buildUnnamed156() => [
      buildGoogleCloudIntegrationsV1alphaNextTask(),
      buildGoogleCloudIntegrationsV1alphaNextTask(),
    ];

void checkUnnamed156(core.List<api.GoogleCloudIntegrationsV1alphaNextTask> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudIntegrationsV1alphaNextTask(o[0]);
  checkGoogleCloudIntegrationsV1alphaNextTask(o[1]);
}
...
api.GoogleCloudIntegrationsV1alphaUnshareTemplateRequest
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaUnshareTemplateRequest < 3) {
    o.resourceNames = buildUnnamed158();
  }
  buildCounterGoogleCloudIntegrationsV1alphaUnshareTemplateRequest--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaUnshareTemplateRequest(
  ...
  buildCounterGoogleCloudIntegrationsV1alphaUnshareTemplateRequest++;
  if (buildCounterGoogleCloudIntegrationsV1alphaUnshareTemplateRequest < 3) {
    checkUnnamed158(o.resourceNames!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaUnshareTemplateRequest--;
}
...
api.GoogleCloudIntegrationsV1alphaUseTemplateRequest
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaUseTemplateRequest < 3) {
    o.integrationDetails =
        buildGoogleCloudIntegrationsV1alphaUseTemplateRequestIntegrationDetails();
    o.integrationRegion = 'foo';
    o.subIntegrations = buildUnnamed159();
  }
  buildCounterGoogleCloudIntegrationsV1alphaUseTemplateRequest--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaUseTemplateRequest(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaUseTemplateRequest < 3) {
    ...
    unittest.expect(o.integrationRegion!, unittest.equals('foo'));
    checkUnnamed159(o.subIntegrations!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaUseTemplateRequest--;
}
...
void checkGoogleCloudIntegrationsV1alphaUseTemplateRequestIntegrationDetails(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaUseTemplateRequestIntegrationDetails <
      3) {
    unittest.expect(o.integration!, unittest.equals('foo'));
    unittest.expect(o.integrationDescription!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudIntegrationsV1alphaUseTemplateRequestIntegrationDetails--;
}
...
api.GoogleCloudIntegrationsV1alphaUseTemplateResponse
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaUseTemplateResponse < 3) {
    o.integrationVersion =
        buildGoogleCloudIntegrationsV1alphaIntegrationVersion();
    o.subIntegrationVersions = buildUnnamed160();
  }
  buildCounterGoogleCloudIntegrationsV1alphaUseTemplateResponse--;
  return o;
}
...
void checkGoogleCloudIntegrationsV1alphaUseTemplateResponse(
  ...
  if (buildCounterGoogleCloudIntegrationsV1alphaUseTemplateResponse < 3) {
    ...
    checkUnnamed160(o.subIntegrationVersions!);
  }
  buildCounterGoogleCloudIntegrationsV1alphaUseTemplateResponse--;
}
...
void checkGoogleInternalCloudCrmEventbusV3PostToQueueWithTriggerIdRequest(
  ...
  if (buildCounterGoogleInternalCloudCrmEventbusV3PostToQueueWithTriggerIdRequest <
    ...
    unittest.expect(o.quotaRetryCount!, unittest.equals(42));
    unittest.expect(o.requestId!, unittest.equals('foo'));
...
void main() {
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildEnterpriseCrmEventbusProtoBaseAlertConfigThresholdValue();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.EnterpriseCrmEventbusProtoBaseAlertConfigThresholdValue
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
  ...
  unittest.group(
    'obj-schema-EnterpriseCrmEventbusProtoBooleanParameterArray',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-EnterpriseCrmEventbusProtoBuganizerNotification',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-EnterpriseCrmEventbusProtoCloudLoggingDetails',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-EnterpriseCrmEventbusProtoCloudSchedulerConfig',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-EnterpriseCrmEventbusProtoCustomSuspensionRequest',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-EnterpriseCrmEventbusProtoDoubleParameterArray',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-EnterpriseCrmEventbusProtoEventExecutionDetails',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-EnterpriseCrmEventbusProtoEventExecutionSnapshot',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-EnterpriseCrmEventbusProtoParamSpecEntryConfig',
    () {
      unittest.test('to-json--from-json', () async {
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildEnterpriseCrmEventbusProtoParamSpecEntryProtoDefinition();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.EnterpriseCrmEventbusProtoParamSpecEntryProtoDefinition
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
  ...
  unittest.group(
    'obj-schema-EnterpriseCrmEventbusProtoProtoParameterArray',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-EnterpriseCrmEventbusProtoStringParameterArray',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-EnterpriseCrmEventbusProtoSuspensionExpiration',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-EnterpriseCrmEventbusProtoTaskExecutionDetails',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-EnterpriseCrmEventbusProtoWorkflowAlertConfig',
    () {
      unittest.test('to-json--from-json', () async {
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildEnterpriseCrmFrontendsEventbusProtoBooleanParameterArray();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.EnterpriseCrmFrontendsEventbusProtoBooleanParameterArray
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildEnterpriseCrmFrontendsEventbusProtoDoubleParameterArray();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.EnterpriseCrmFrontendsEventbusProtoDoubleParameterArray
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildEnterpriseCrmFrontendsEventbusProtoEventExecutionDetails();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.EnterpriseCrmFrontendsEventbusProtoEventExecutionDetails
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
  ...
  unittest.group(
    'obj-schema-EnterpriseCrmFrontendsEventbusProtoParamSpecEntry',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-EnterpriseCrmFrontendsEventbusProtoParameterEntry',
    () {
      unittest.test('to-json--from-json', () async {
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildEnterpriseCrmFrontendsEventbusProtoStringParameterArray();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.EnterpriseCrmFrontendsEventbusProtoStringParameterArray
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
  ...
  unittest.group(
    'obj-schema-EnterpriseCrmFrontendsEventbusProtoTaskConfig',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-EnterpriseCrmFrontendsEventbusProtoTaskEntity',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-EnterpriseCrmFrontendsEventbusProtoTriggerConfig',
    () {
      unittest.test('to-json--from-json', () async {
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudConnectorsV1AuthConfigOauth2ClientCredentials();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudConnectorsV1AuthConfigOauth2ClientCredentials
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
  ...
  unittest.group(
    'obj-schema-GoogleCloudConnectorsV1AuthConfigOauth2JwtBearer',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudConnectorsV1AuthConfigSshPublicKey',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudConnectorsV1AuthConfigUserPassword',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaApiTriggerResource',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaAssertionResult',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaClientCertificate',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaCloudLoggingDetails',
    () {
      unittest.test('to-json--from-json', () async {
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudIntegrationsV1alphaConditionalFailurePolicies();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudIntegrationsV1alphaConditionalFailurePolicies
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudIntegrationsV1alphaCreateCloudFunctionRequest();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudIntegrationsV1alphaCreateCloudFunctionRequest
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudIntegrationsV1alphaDownloadExecutionResponse();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudIntegrationsV1alphaDownloadExecutionResponse
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaErrorCatcherConfig',
    () {
      unittest.test('to-json--from-json', () async {
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudIntegrationsV1alphaExecuteIntegrationsRequest();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudIntegrationsV1alphaExecuteIntegrationsRequest
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaExecutionDetails',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaExecutionReplayInfo',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaExecutionSnapshot',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaGenerateOpenApiSpecRequest',
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudIntegrationsV1alphaGenerateOpenApiSpecRequest();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudIntegrationsV1alphaGenerateOpenApiSpecRequest
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaGenerateOpenApiSpecResponse',
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudIntegrationsV1alphaGenerateOpenApiSpecResponse();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudIntegrationsV1alphaGenerateOpenApiSpecResponse
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudIntegrationsV1alphaGetClientMetadataResponse();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudIntegrationsV1alphaGetClientMetadataResponse
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaGetClientResponse',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaIntParameterArray',
    () {
      unittest.test('to-json--from-json', () async {
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudIntegrationsV1alphaIntegrationConfigParameter();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudIntegrationsV1alphaIntegrationConfigParameter
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaIntegrationVersion',
    () {
      unittest.test('to-json--from-json', () async {
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudIntegrationsV1alphaIntegrationVersionTemplate();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudIntegrationsV1alphaIntegrationVersionTemplate
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudIntegrationsV1alphaListSfdcInstancesResponse();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudIntegrationsV1alphaListSfdcInstancesResponse
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaParameterMapEntry',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaParameterMapField',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaProjectProperties',
    () {
      unittest.test('to-json--from-json', () async {
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudIntegrationsV1alphaResolveSuspensionResponse();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudIntegrationsV1alphaResolveSuspensionResponse
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaRuntimeActionSchema',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaRuntimeEntitySchema',
    () {
      unittest.test('to-json--from-json', () async {
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudIntegrationsV1alphaServiceAccountCredentials();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudIntegrationsV1alphaServiceAccountCredentials
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaSuspensionAudit',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaTemplateComponent',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaUseTemplateRequest',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaUseTemplateResponse',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudIntegrationsV1alphaUsernameAndPassword',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group('resource-ProjectsResource', () {
    unittest.test('method--getClientmetadata', () async {
      ...
      final response = await res.getClientmetadata(
        arg_parent,
        $fields: arg_$fields,
      );
      checkGoogleCloudIntegrationsV1alphaGetClientMetadataResponse(
        response as api.GoogleCloudIntegrationsV1alphaGetClientMetadataResponse,
      );
    });
  });

  unittest.group('resource-ProjectsLocationsResource', () {
    unittest.test('method--generateOpenApiSpec', () async {
      final mock = HttpServerMock();
      ...
      final response = await res.generateOpenApiSpec(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
      checkGoogleCloudIntegrationsV1alphaGenerateOpenApiSpecResponse(
        response
            as api.GoogleCloudIntegrationsV1alphaGenerateOpenApiSpecResponse,
      );
    });
  ...
  unittest.group('resource-ProjectsLocationsAppsScriptProjectsResource', () {
    ...
    unittest.test('method--link', () async {
      ...
      checkGoogleCloudIntegrationsV1alphaLinkAppsScriptProjectResponse(
        response
  ...
  unittest.group('resource-ProjectsLocationsAuthConfigsResource', () {
    unittest.test('method--create', () async {
      ...
      final response = await res.create(
        ...
        clientCertificate_sslCertificate: arg_clientCertificate_sslCertificate,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--list', () async {
      ...
      checkGoogleCloudIntegrationsV1alphaListAuthConfigsResponse(
        response as api.GoogleCloudIntegrationsV1alphaListAuthConfigsResponse,
      );
    });
  ...
  unittest.group('resource-ProjectsLocationsCertificatesResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      checkGoogleCloudIntegrationsV1alphaListCertificatesResponse(
        response as api.GoogleCloudIntegrationsV1alphaListCertificatesResponse,
      );
    });
  ...
  unittest.group('resource-ProjectsLocationsClientsResource', () {
    unittest.test('method--deprovision', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.GoogleCloudIntegrationsV1alphaDeprovisionClientRequest
              .fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
      ...
      final response = await res.deprovision(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--switch_', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.GoogleCloudIntegrationsV1alphaSwitchEncryptionRequest
              .fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
      ...
      final response = await res.switch_(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--switchVariableMasking', () async {
      ...
      final response = await res.switchVariableMasking(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-ProjectsLocationsCloudFunctionsResource', () {
    unittest.test('method--create', () async {
      ...
      checkGoogleCloudIntegrationsV1alphaCreateCloudFunctionResponse(
        response
  ...
  unittest.group('resource-ProjectsLocationsConnectionsResource', () {
    unittest.test('method--getConnectionSchemaMetadata', () async {
      ...
      checkGoogleCloudIntegrationsV1alphaConnectionSchemaMetadata(
        response as api.GoogleCloudIntegrationsV1alphaConnectionSchemaMetadata,
      );
    });
    ...
    unittest.test('method--list', () async {
      ...
      checkGoogleCloudIntegrationsV1alphaListConnectionsResponse(
        response as api.GoogleCloudIntegrationsV1alphaListConnectionsResponse,
      );
    });
  });
  ...
  unittest.group('resource-ProjectsLocationsIntegrationsResource', () {
    ...
    unittest.test('method--execute', () async {
      ...
      checkGoogleCloudIntegrationsV1alphaExecuteIntegrationsResponse(
        response
    ...
    unittest.test('method--executeEvent', () async {
      ...
      final response = await res.executeEvent(
        arg_name,
    ...
    unittest.test('method--list', () async {
      ...
      checkGoogleCloudIntegrationsV1alphaListIntegrationsResponse(
        response as api.GoogleCloudIntegrationsV1alphaListIntegrationsResponse,
      );
    });
    ...
    unittest.test('method--schedule', () async {
      ...
      final response = await res.schedule(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
      checkGoogleCloudIntegrationsV1alphaScheduleIntegrationsResponse(
        response
    ...
    unittest.test('method--test', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.GoogleCloudIntegrationsV1alphaTestIntegrationsRequest
              .fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
      ...
      checkGoogleCloudIntegrationsV1alphaTestIntegrationsResponse(
        response as api.GoogleCloudIntegrationsV1alphaTestIntegrationsResponse,
      );
    });
  });
  ...
  unittest.group('resource-ProjectsLocationsIntegrationsExecutionsResource',
    ...
    unittest.test('method--cancel', () async {
      ...
      checkGoogleCloudIntegrationsV1alphaCancelExecutionResponse(
        response as api.GoogleCloudIntegrationsV1alphaCancelExecutionResponse,
      );
    });
    ...
    unittest.test('method--download', () async {
      ...
      checkGoogleCloudIntegrationsV1alphaDownloadExecutionResponse(
        response as api.GoogleCloudIntegrationsV1alphaDownloadExecutionResponse,
      );
    });
    ...
    unittest.test('method--list', () async {
      ...
      final arg_filterParams_eventStatuses = buildUnnamed161();
      ...
      final arg_filterParams_taskStatuses = buildUnnamed162();
    ...
    unittest.test('method--replay', () async {
      ...
      final response = await res.replay(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
      checkGoogleCloudIntegrationsV1alphaReplayExecutionResponse(
        response as api.GoogleCloudIntegrationsV1alphaReplayExecutionResponse,
      );
    });
  });
  ...
  unittest.group(
    ...
    () {
      unittest.test('method--lift', () async {
        ...
        mock.register(
          unittest.expectAsync2((http.BaseRequest req, json) {
            final obj = api.GoogleCloudIntegrationsV1alphaLiftSuspensionRequest
                .fromJson(
              json as core.Map<core.String, core.dynamic>,
            );
      ...
      unittest.test('method--list', () async {
        ...
        checkGoogleCloudIntegrationsV1alphaListSuspensionsResponse(
          response as api.GoogleCloudIntegrationsV1alphaListSuspensionsResponse,
        );
      });
      ...
      unittest.test('method--resolve', () async {
        ...
        checkGoogleCloudIntegrationsV1alphaResolveSuspensionResponse(
          response
  ...
  unittest.group('resource-ProjectsLocationsIntegrationsVersionsResource', () {
    ...
    unittest.test('method--download', () async {
      ...
      final arg_files = buildUnnamed163();
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final path = req.url.path;
          ...
          unittest.expect(queryMap['files']!, unittest.equals(arg_files));
          unittest.expect(
            queryMap['fields']!.first,
            unittest.equals(arg_$fields),
          );
    ...
    unittest.test('method--downloadJsonPackage', () async {
      ...
      final res =
          api.IntegrationsApi(mock).projects.locations.integrations.versions;
      final arg_name = 'foo';
      final arg_files = buildUnnamed164();
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final path = req.url.path;
      ...
      final response = await res.downloadJsonPackage(
        arg_name,
        files: arg_files,
        $fields: arg_$fields,
      );
      checkGoogleCloudIntegrationsV1alphaDownloadJsonPackageResponse(
        response
    ...
    unittest.test('method--unpublish', () async {
      ...
      final response = await res.unpublish(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
  ...
  unittest.group(
    ...
    unittest.test('method--download', () async {
      ...
      checkGoogleCloudIntegrationsV1alphaDownloadTestCaseResponse(
        response as api.GoogleCloudIntegrationsV1alphaDownloadTestCaseResponse,
      );
    });
    ...
    unittest.test('method--executeTest', () async {
      ...
      final response = await res.executeTest(
        arg_request,
        arg_testCaseName,
        $fields: arg_$fields,
      );
      checkGoogleCloudIntegrationsV1alphaExecuteTestCaseResponse(
        response as api.GoogleCloudIntegrationsV1alphaExecuteTestCaseResponse,
      );
    });
    ...
    unittest.test('method--listExecutions', () async {
      ...
      final response = await res.listExecutions(
        arg_parent,
        filter: arg_filter,
        orderBy: arg_orderBy,
        pageSize: arg_pageSize,
      ...
      checkGoogleCloudIntegrationsV1alphaListTestCaseExecutionsResponse(
        response
  ...
  unittest.group(
    ...
    () {
      ...
      unittest.test('method--list', () async {
        ...
        final arg_filterParams_customFilter = 'foo';
        final arg_filterParams_endTime = 'foo';
        final arg_filterParams_eventStatuses = buildUnnamed165();
        final arg_filterParams_executionId = 'foo';
        final arg_filterParams_parameterKey = 'foo';
        final arg_filterParams_parameterPairKey = 'foo';
        final arg_filterParams_parameterPairValue = 'foo';
        ...
        final arg_filterParams_parameterValue = 'foo';
        final arg_filterParams_startTime = 'foo';
        final arg_filterParams_taskStatuses = buildUnnamed166();
        final arg_filterParams_workflowName = 'foo';
        final arg_orderBy = 'foo';
        final arg_pageSize = 42;
        final arg_pageToken = 'foo';
  ...
  unittest.group(
    ...
    unittest.test('method--download', () async {
      ...
      final arg_name = 'foo';
      final arg_fileFormat = 'foo';
      final arg_files = buildUnnamed167();
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final path = req.url.path;
    ...
    unittest.test('method--takeoverEditLock', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.GoogleCloudIntegrationsV1alphaTakeoverEditLockRequest
              .fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
      ...
      final response = await res.takeoverEditLock(
        arg_request,
        arg_integrationVersion,
        $fields: arg_$fields,
      );
      checkGoogleCloudIntegrationsV1alphaTakeoverEditLockResponse(
        response as api.GoogleCloudIntegrationsV1alphaTakeoverEditLockResponse,
      );
    });
  ...
  unittest.group('resource-ProjectsLocationsProductsSfdcInstancesResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      checkGoogleCloudIntegrationsV1alphaListSfdcInstancesResponse(
        response as api.GoogleCloudIntegrationsV1alphaListSfdcInstancesResponse,
      );
    });
  ...
  unittest.group(
    ...
    () {
      ...
      unittest.test('method--list', () async {
        ...
        checkGoogleCloudIntegrationsV1alphaListSfdcChannelsResponse(
          response
  ...
  unittest.group('resource-ProjectsLocationsSfdcInstancesSfdcChannelsResource',
    ...
    unittest.test('method--list', () async {
      ...
      checkGoogleCloudIntegrationsV1alphaListSfdcChannelsResponse(
        response as api.GoogleCloudIntegrationsV1alphaListSfdcChannelsResponse,
      );
    });
  ...
  unittest.group('resource-ProjectsLocationsTemplatesResource', () {
    ...
    unittest.test('method--download', () async {
      ...
      checkGoogleCloudIntegrationsV1alphaDownloadTemplateResponse(
        response as api.GoogleCloudIntegrationsV1alphaDownloadTemplateResponse,
      );
    });
    ...
    unittest.test('method--search', () async {
      ...
      checkGoogleCloudIntegrationsV1alphaSearchTemplatesResponse(
        response as api.GoogleCloudIntegrationsV1alphaSearchTemplatesResponse,
      );
    });
