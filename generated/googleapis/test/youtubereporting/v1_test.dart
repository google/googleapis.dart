...
core.List<api.GdataCompositeMedia> buildUnnamed4026() {
  var o = <api.GdataCompositeMedia>[];
...
void checkUnnamed4026(core.List<api.GdataCompositeMedia> o) {
...
api.GdataMedia buildGdataMedia() {
  ...
  if (buildCounterGdataMedia < 3) {
    ...
    o.blobRef = 'foo';
    o.blobstore2Info = buildGdataBlobstore2Info();
    o.compositeMedia = buildUnnamed4026();
    o.contentType = 'foo';
...
void checkGdataMedia(api.GdataMedia o) {
  ...
  if (buildCounterGdataMedia < 3) {
    ...
    checkGdataBlobstore2Info(o.blobstore2Info! as api.GdataBlobstore2Info);
    checkUnnamed4026(o.compositeMedia!);
    unittest.expect(
      o.contentType!,
      unittest.equals('foo'),
    );
...
core.List<api.Job> buildUnnamed4027() {
  var o = <api.Job>[];
  o.add(buildJob());
  o.add(buildJob());
  return o;
...
void checkUnnamed4027(core.List<api.Job> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ReportType> buildUnnamed4028() {
...
void checkUnnamed4028(core.List<api.ReportType> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListReportTypesResponse buildListReportTypesResponse() {
  ...
  if (buildCounterListReportTypesResponse < 3) {
    o.nextPageToken = 'foo';
    o.reportTypes = buildUnnamed4028();
  }
  buildCounterListReportTypesResponse--;
  return o;
}
...
void checkListReportTypesResponse(api.ListReportTypesResponse o) {
  ...
  if (buildCounterListReportTypesResponse < 3) {
    ...
    checkUnnamed4028(o.reportTypes!);
  }
  buildCounterListReportTypesResponse--;
}

core.List<api.Report> buildUnnamed4029() {
  var o = <api.Report>[];
  o.add(buildReport());
  o.add(buildReport());
  return o;
...
void checkUnnamed4029(core.List<api.Report> o) {
  unittest.expect(o, unittest.hasLength(2));
