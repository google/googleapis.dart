...
checkUnnamed1283(core.List<api.Job> o) {
...
checkUnnamed1284(core.List<api.ReportType> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReportType(o[0]);
  checkReportType(o[1]);
}
...
buildListReportTypesResponse() {
  ...
  if (buildCounterListReportTypesResponse < 3) {
    o.nextPageToken = "foo";
    o.reportTypes = buildUnnamed1284();
  }
  buildCounterListReportTypesResponse--;
  return o;
}
...
checkListReportTypesResponse(api.ListReportTypesResponse o) {
  ...
  if (buildCounterListReportTypesResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed1284(o.reportTypes);
  }
  buildCounterListReportTypesResponse--;
}
...
checkUnnamed1285(core.List<api.Report> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReport(o[0]);
  checkReport(o[1]);
}
...
main() {
  ...
  unittest.group("resource-JobsReportsResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      res.list(arg_jobId, onBehalfOfContentOwner: arg_onBehalfOfContentOwner, pageSize: arg_pageSize, pageToken: arg_pageToken).then(unittest.expectAsync(((api.ListReportsResponse response) {
