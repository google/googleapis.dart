...
checkUnnamed326(core.List<api.GdataCompositeMedia> o) {
...
buildGdataMedia() {
  ...
  if (buildCounterGdataMedia < 3) {
    ...
    o.blobRef = "foo";
    o.blobstore2Info = buildGdataBlobstore2Info();
    o.compositeMedia = buildUnnamed326();
    o.contentType = "foo";
...
checkGdataMedia(api.GdataMedia o) {
  ...
  if (buildCounterGdataMedia < 3) {
    ...
    unittest.expect(o.blobRef, unittest.equals('foo'));
    checkGdataBlobstore2Info(o.blobstore2Info);
    checkUnnamed326(o.compositeMedia);
...
checkUnnamed327(core.List<api.Job> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJob(o[0]);
  checkJob(o[1]);
}
...
checkUnnamed328(core.List<api.ReportType> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReportType(o[0]);
  checkReportType(o[1]);
}
...
checkUnnamed329(core.List<api.Report> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReport(o[0]);
  checkReport(o[1]);
}
