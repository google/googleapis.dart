...
core.List<api.AuditLogConfig> buildUnnamed5188() => [
      buildAuditLogConfig(),
      buildAuditLogConfig(),
    ];

void checkUnnamed5188(core.List<api.AuditLogConfig> o) {
...
api.AuditConfig buildAuditConfig() {
  ...
  if (buildCounterAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed5188();
    o.service = 'foo';
  }
  buildCounterAuditConfig--;
  return o;
...
void checkAuditConfig(api.AuditConfig o) {
  buildCounterAuditConfig++;
  if (buildCounterAuditConfig < 3) {
    checkUnnamed5188(o.auditLogConfigs!);
    unittest.expect(
      o.service!,
      unittest.equals('foo'),
    );
...
api.AuditLogConfig buildAuditLogConfig() {
  ...
  if (buildCounterAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed5189();
    o.logType = 'foo';
  }
  buildCounterAuditLogConfig--;
  return o;
...
void checkAuditLogConfig(api.AuditLogConfig o) {
  buildCounterAuditLogConfig++;
  if (buildCounterAuditLogConfig < 3) {
    checkUnnamed5189(o.exemptedMembers!);
    unittest.expect(
      o.logType!,
      unittest.equals('foo'),
    );
...
core.List<api.Location> buildUnnamed5191() => [
      buildLocation(),
      buildLocation(),
    ];

void checkUnnamed5191(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
core.List<api.SecretVersion> buildUnnamed5192() => [
      buildSecretVersion(),
      buildSecretVersion(),
    ];

void checkUnnamed5192(core.List<api.SecretVersion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListSecretVersionsResponse(api.ListSecretVersionsResponse o) {
  ...
  if (buildCounterListSecretVersionsResponse < 3) {
    ...
    checkUnnamed5192(o.versions!);
  }
  buildCounterListSecretVersionsResponse--;
}

core.List<api.Secret> buildUnnamed5193() => [
      buildSecret(),
      buildSecret(),
    ];

void checkUnnamed5193(core.List<api.Secret> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSecret(o[0]);
  checkSecret(o[1]);
}
...
core.Map<core.String, core.String> buildUnnamed5194() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed5194(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.Location buildLocation() {
  ...
  if (buildCounterLocation < 3) {
    o.displayName = 'foo';
    o.labels = buildUnnamed5194();
    o.locationId = 'foo';
    o.metadata = buildUnnamed5195();
    o.name = 'foo';
  }
  buildCounterLocation--;
  return o;
...
void checkLocation(api.Location o) {
  ...
  if (buildCounterLocation < 3) {
    ...
    checkUnnamed5194(o.labels!);
    unittest.expect(
      o.locationId!,
      unittest.equals('foo'),
    );
    checkUnnamed5195(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
core.List<api.AuditConfig> buildUnnamed5196() => [
      buildAuditConfig(),
      buildAuditConfig(),
    ];

void checkUnnamed5196(core.List<api.AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAuditConfig(o[0]);
  checkAuditConfig(o[1]);
}

core.List<api.Binding> buildUnnamed5197() => [
      buildBinding(),
      buildBinding(),
    ];

void checkUnnamed5197(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
api.Policy buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.auditConfigs = buildUnnamed5196();
    o.bindings = buildUnnamed5197();
    o.etag = 'foo';
    o.version = 42;
  }
  buildCounterPolicy--;
...
void checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed5196(o.auditConfigs!);
    checkUnnamed5197(o.bindings!);
    unittest.expect(
      o.etag!,
      unittest.equals('foo'),
    );
...
core.List<api.Topic> buildUnnamed5199() => [
      buildTopic(),
      buildTopic(),
    ];

void checkUnnamed5199(core.List<api.Topic> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTopic(o[0]);
  checkTopic(o[1]);
}
...
api.TestIamPermissionsRequest buildTestIamPermissionsRequest() {
  ...
  if (buildCounterTestIamPermissionsRequest < 3) {
    o.permissions = buildUnnamed5200();
  }
  buildCounterTestIamPermissionsRequest--;
  return o;
}
...
void checkTestIamPermissionsRequest(api.TestIamPermissionsRequest o) {
  buildCounterTestIamPermissionsRequest++;
  if (buildCounterTestIamPermissionsRequest < 3) {
    checkUnnamed5200(o.permissions!);
  }
  buildCounterTestIamPermissionsRequest--;
}
...
api.TestIamPermissionsResponse buildTestIamPermissionsResponse() {
  ...
  if (buildCounterTestIamPermissionsResponse < 3) {
    o.permissions = buildUnnamed5201();
  }
  buildCounterTestIamPermissionsResponse--;
  return o;
}
...
void checkTestIamPermissionsResponse(api.TestIamPermissionsResponse o) {
  buildCounterTestIamPermissionsResponse++;
  if (buildCounterTestIamPermissionsResponse < 3) {
    checkUnnamed5201(o.permissions!);
  }
  buildCounterTestIamPermissionsResponse--;
}
...
core.List<api.Replica> buildUnnamed5202() => [
      buildReplica(),
      buildReplica(),
    ];

void checkUnnamed5202(core.List<api.Replica> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReplica(o[0]);
  checkReplica(o[1]);
}
...
void checkUserManaged(api.UserManaged o) {
  buildCounterUserManaged++;
  if (buildCounterUserManaged < 3) {
    checkUnnamed5202(o.replicas!);
  }
  buildCounterUserManaged--;
}

core.List<api.ReplicaStatus> buildUnnamed5203() => [
      buildReplicaStatus(),
      buildReplicaStatus(),
    ];

void checkUnnamed5203(core.List<api.ReplicaStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
