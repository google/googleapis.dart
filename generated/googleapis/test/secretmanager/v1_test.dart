...
core.List<api.SecretVersion> buildUnnamed6() => [
  buildSecretVersion(),
  buildSecretVersion(),
];

void checkUnnamed6(core.List<api.SecretVersion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Secret> buildUnnamed7() => [buildSecret(), buildSecret()];

void checkUnnamed7(core.List<api.Secret> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSecret(o[0]);
  checkSecret(o[1]);
}
...
core.List<api.Topic> buildUnnamed17() => [buildTopic(), buildTopic()];

void checkUnnamed17(core.List<api.Topic> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTopic(o[0]);
  checkTopic(o[1]);
}
...
api.Secret buildSecret() {
  ...
  if (buildCounterSecret < 3) {
    ...
    o.topics = buildUnnamed17();
    o.ttl = 'foo';
    o.versionAliases = buildUnnamed18();
...
void checkSecret(api.Secret o) {
  ...
  if (buildCounterSecret < 3) {
    ...
    checkUnnamed17(o.topics!);
    unittest.expect(o.ttl!, unittest.equals('foo'));
    checkUnnamed18(o.versionAliases!);
    unittest.expect(o.versionDestroyTtl!, unittest.equals('foo'));
  }
  buildCounterSecret--;
}
...
void checkSecretVersion(api.SecretVersion o) {
  ...
  if (buildCounterSecretVersion < 3) {
    ...
    unittest.expect(o.scheduledDestroyTime!, unittest.equals('foo'));
...
core.List<api.Replica> buildUnnamed23() => [buildReplica(), buildReplica()];

void checkUnnamed23(core.List<api.Replica> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReplica(o[0]);
  checkReplica(o[1]);
}
...
void checkUserManaged(api.UserManaged o) {
  buildCounterUserManaged++;
  if (buildCounterUserManaged < 3) {
    checkUnnamed23(o.replicas!);
  }
  buildCounterUserManaged--;
}

core.List<api.ReplicaStatus> buildUnnamed24() => [
  buildReplicaStatus(),
  buildReplicaStatus(),
];

void checkUnnamed24(core.List<api.ReplicaStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void main() {
  ...
  unittest.group('obj-schema-Automatic', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Automatic.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkAutomatic(od);
    });
  ...
  unittest.group('obj-schema-Rotation', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Rotation.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkRotation(od);
    });
  ...
  unittest.group('resource-ProjectsLocationsOperationsResource', () {
    unittest.test('method--cancel', () async {
      final mock = HttpServerMock();
      final res = api.SecretManagerApi(mock).projects.locations.operations;
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
  ...
  unittest.group('resource-ProjectsLocationsSecretsResource', () {
    unittest.test('method--addVersion', () async {
      ...
      final response = await res.addVersion(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
