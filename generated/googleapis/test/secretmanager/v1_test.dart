...
core.List<api.AuditLogConfig> buildUnnamed6626() => [
      buildAuditLogConfig(),
      buildAuditLogConfig(),
    ];

void checkUnnamed6626(core.List<api.AuditLogConfig> o) {
...
api.AuditConfig buildAuditConfig() {
  ...
  if (buildCounterAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed6626();
    o.service = 'foo';
  }
  buildCounterAuditConfig--;
  return o;
...
void checkAuditConfig(api.AuditConfig o) {
  buildCounterAuditConfig++;
  if (buildCounterAuditConfig < 3) {
    checkUnnamed6626(o.auditLogConfigs!);
    unittest.expect(
      o.service!,
      unittest.equals('foo'),
    );
...
api.AuditLogConfig buildAuditLogConfig() {
  ...
  if (buildCounterAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed6627();
    o.logType = 'foo';
  }
  buildCounterAuditLogConfig--;
  return o;
...
void checkAuditLogConfig(api.AuditLogConfig o) {
  buildCounterAuditLogConfig++;
  if (buildCounterAuditLogConfig < 3) {
    checkUnnamed6627(o.exemptedMembers!);
    unittest.expect(
      o.logType!,
      unittest.equals('foo'),
    );
...
core.List<core.String> buildUnnamed6628() => [
      'foo',
      'foo',
    ];

void checkUnnamed6628(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.Location> buildUnnamed6629() => [
      buildLocation(),
      buildLocation(),
    ];

void checkUnnamed6629(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
core.List<api.SecretVersion> buildUnnamed6630() => [
      buildSecretVersion(),
      buildSecretVersion(),
    ];

void checkUnnamed6630(core.List<api.SecretVersion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListSecretVersionsResponse(api.ListSecretVersionsResponse o) {
  ...
  if (buildCounterListSecretVersionsResponse < 3) {
    ...
    checkUnnamed6630(o.versions!);
  }
  buildCounterListSecretVersionsResponse--;
}

core.List<api.Secret> buildUnnamed6631() => [
      buildSecret(),
      buildSecret(),
    ];

void checkUnnamed6631(core.List<api.Secret> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSecret(o[0]);
  checkSecret(o[1]);
}
...
core.Map<core.String, core.String> buildUnnamed6632() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed6632(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.AuditConfig> buildUnnamed6634() => [
      buildAuditConfig(),
      buildAuditConfig(),
    ];

void checkUnnamed6634(core.List<api.AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAuditConfig(o[0]);
  checkAuditConfig(o[1]);
}

core.List<api.Binding> buildUnnamed6635() => [
      buildBinding(),
      buildBinding(),
    ];

void checkUnnamed6635(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
api.Policy buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.auditConfigs = buildUnnamed6634();
    o.bindings = buildUnnamed6635();
    o.etag = 'foo';
    o.version = 42;
  }
  buildCounterPolicy--;
...
void checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed6634(o.auditConfigs!);
    checkUnnamed6635(o.bindings!);
    unittest.expect(
      o.etag!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.String> buildUnnamed6636() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed6636(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.Topic> buildUnnamed6637() => [
      buildTopic(),
      buildTopic(),
    ];

void checkUnnamed6637(core.List<api.Topic> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTopic(o[0]);
  checkTopic(o[1]);
}
...
api.TestIamPermissionsRequest buildTestIamPermissionsRequest() {
  ...
  if (buildCounterTestIamPermissionsRequest < 3) {
    o.permissions = buildUnnamed6638();
  }
  buildCounterTestIamPermissionsRequest--;
  return o;
}
...
void checkTestIamPermissionsRequest(api.TestIamPermissionsRequest o) {
  buildCounterTestIamPermissionsRequest++;
  if (buildCounterTestIamPermissionsRequest < 3) {
    checkUnnamed6638(o.permissions!);
  }
  buildCounterTestIamPermissionsRequest--;
}
...
api.TestIamPermissionsResponse buildTestIamPermissionsResponse() {
  ...
  if (buildCounterTestIamPermissionsResponse < 3) {
    o.permissions = buildUnnamed6639();
  }
  buildCounterTestIamPermissionsResponse--;
  return o;
}
...
void checkTestIamPermissionsResponse(api.TestIamPermissionsResponse o) {
  buildCounterTestIamPermissionsResponse++;
  if (buildCounterTestIamPermissionsResponse < 3) {
    checkUnnamed6639(o.permissions!);
  }
  buildCounterTestIamPermissionsResponse--;
}
...
core.List<api.Replica> buildUnnamed6640() => [
      buildReplica(),
      buildReplica(),
    ];

void checkUnnamed6640(core.List<api.Replica> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReplica(o[0]);
  checkReplica(o[1]);
}
...
void checkUserManaged(api.UserManaged o) {
  buildCounterUserManaged++;
  if (buildCounterUserManaged < 3) {
    checkUnnamed6640(o.replicas!);
  }
  buildCounterUserManaged--;
}

core.List<api.ReplicaStatus> buildUnnamed6641() => [
      buildReplicaStatus(),
      buildReplicaStatus(),
    ];

void checkUnnamed6641(core.List<api.ReplicaStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
