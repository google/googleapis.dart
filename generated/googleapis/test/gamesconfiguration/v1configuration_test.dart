...
checkUnnamed2460(core.List<api.AchievementConfiguration> o) {
...
checkUnnamed2461(core.List<api.LeaderboardConfiguration> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2462(core.List<api.LocalizedString> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildLocalizedStringBundle() {
  ...
  if (buildCounterLocalizedStringBundle < 3) {
    o.kind = "foo";
    o.translations = buildUnnamed2462();
  }
  buildCounterLocalizedStringBundle--;
  return o;
}
...
checkLocalizedStringBundle(api.LocalizedStringBundle o) {
  ...
  if (buildCounterLocalizedStringBundle < 3) {
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed2462(o.translations);
  }
  buildCounterLocalizedStringBundle--;
}
