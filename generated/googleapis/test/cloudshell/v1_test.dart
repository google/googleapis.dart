...
void main() {
  ...
  unittest.group('resource-UsersEnvironmentsResource', () {
    unittest.test('method--addPublicKey', () async {
      ...
      final response = await res.addPublicKey(
        arg_request,
        arg_environment,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--authorize', () async {
      ...
      final response = await res.authorize(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--generateAccessToken', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            queryMap['expireTime']!.first,
            unittest.equals(arg_expireTime),
          );
          unittest.expect(queryMap['ttl']!.first, unittest.equals(arg_ttl));
          unittest.expect(
            queryMap['fields']!.first,
            unittest.equals(arg_$fields),
          );
    ...
    unittest.test('method--removePublicKey', () async {
      ...
      final response = await res.removePublicKey(
        arg_request,
        arg_environment,
        $fields: arg_$fields,
      );
