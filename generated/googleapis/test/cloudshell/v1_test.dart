...
checkUnnamed1769(core.List<api.PublicKey> o) {
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed1771();
    o.name = "foo";
    o.response = buildUnnamed1772();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed1771(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed1772(o.response);
  }
  buildCounterOperation--;
}
...
checkUnnamed1774(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
