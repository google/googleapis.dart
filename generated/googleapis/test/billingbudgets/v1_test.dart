...
core.List<api.GoogleCloudBillingBudgetsV1ThresholdRule> buildUnnamed307() => [
...
api.GoogleCloudBillingBudgetsV1Budget buildGoogleCloudBillingBudgetsV1Budget() {
  ...
  if (buildCounterGoogleCloudBillingBudgetsV1Budget < 3) {
    ...
    o.thresholdRules = buildUnnamed307();
  }
  buildCounterGoogleCloudBillingBudgetsV1Budget--;
  return o;
}
...
void checkGoogleCloudBillingBudgetsV1Budget(
  ...
  if (buildCounterGoogleCloudBillingBudgetsV1Budget < 3) {
    ...
    checkUnnamed307(o.thresholdRules!);
  }
  buildCounterGoogleCloudBillingBudgetsV1Budget--;
}
...
core.List<core.Object> buildUnnamed309() => [
      {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed309(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.List<core.Object>> buildUnnamed310() => {
      'x': buildUnnamed309(),
      'y': buildUnnamed309(),
    };

void checkUnnamed310(core.Map<core.String, core.List<core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed309(o['x']!);
  checkUnnamed309(o['y']!);
}
...
api.GoogleCloudBillingBudgetsV1Filter buildGoogleCloudBillingBudgetsV1Filter() {
  ...
  if (buildCounterGoogleCloudBillingBudgetsV1Filter < 3) {
    ...
    o.creditTypes = buildUnnamed308();
    o.creditTypesTreatment = 'foo';
    o.customPeriod = buildGoogleCloudBillingBudgetsV1CustomPeriod();
    o.labels = buildUnnamed310();
    o.projects = buildUnnamed311();
    o.services = buildUnnamed312();
    o.subaccounts = buildUnnamed313();
  }
  buildCounterGoogleCloudBillingBudgetsV1Filter--;
  return o;
}
...
void checkGoogleCloudBillingBudgetsV1Filter(
  ...
  if (buildCounterGoogleCloudBillingBudgetsV1Filter < 3) {
    ...
    checkUnnamed311(o.projects!);
    checkUnnamed312(o.services!);
    checkUnnamed313(o.subaccounts!);
  }
  buildCounterGoogleCloudBillingBudgetsV1Filter--;
}
...
core.List<api.GoogleCloudBillingBudgetsV1Budget> buildUnnamed314() => [
      buildGoogleCloudBillingBudgetsV1Budget(),
      buildGoogleCloudBillingBudgetsV1Budget(),
    ];

void checkUnnamed314(core.List<api.GoogleCloudBillingBudgetsV1Budget> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleCloudBillingBudgetsV1NotificationsRule
  ...
  if (buildCounterGoogleCloudBillingBudgetsV1NotificationsRule < 3) {
    ...
    o.monitoringNotificationChannels = buildUnnamed315();
    o.pubsubTopic = 'foo';
    o.schemaVersion = 'foo';
  }
  buildCounterGoogleCloudBillingBudgetsV1NotificationsRule--;
...
void checkGoogleCloudBillingBudgetsV1NotificationsRule(
  ...
  if (buildCounterGoogleCloudBillingBudgetsV1NotificationsRule < 3) {
    ...
    checkUnnamed315(o.monitoringNotificationChannels!);
    unittest.expect(
      o.pubsubTopic!,
      unittest.equals('foo'),
    );
