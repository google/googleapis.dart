...
buildActivityContentDetailsPromotedItem() {
  ...
  if (buildCounterActivityContentDetailsPromotedItem < 3) {
    ...
    o.forecastingUrl = buildUnnamed583();
    o.impressionUrl = buildUnnamed584();
    o.videoId = "foo";
  }
  buildCounterActivityContentDetailsPromotedItem--;
  return o;
...
checkActivityContentDetailsPromotedItem(api.ActivityContentDetailsPromotedItem o) {
  ...
  if (buildCounterActivityContentDetailsPromotedItem < 3) {
    ...
    checkUnnamed583(o.forecastingUrl);
    checkUnnamed584(o.impressionUrl);
...
checkUnnamed585(core.List<api.Activity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkActivity(o[0]);
  checkActivity(o[1]);
}
...
checkUnnamed586(core.List<api.Caption> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCaption(o[0]);
  checkCaption(o[1]);
}
...
checkUnnamed587(core.Map<core.String, api.ChannelLocalization> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildChannel() {
  ...
  if (buildCounterChannel < 3) {
    ...
    o.kind = "foo";
    o.localizations = buildUnnamed587();
...
checkChannel(api.Channel o) {
  ...
  if (buildCounterChannel < 3) {
    ...
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed587(o.localizations);
...
checkUnnamed588(core.List<api.PropertyValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed589(core.List<api.ChannelConversionPing> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed590(core.List<api.Channel> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkChannel(o[0]);
  checkChannel(o[1]);
}
...
checkUnnamed591(core.Map<core.String, api.ChannelSectionLocalization> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildChannelSection() {
  ...
  if (buildCounterChannelSection < 3) {
    ...
    o.id = "foo";
    o.kind = "foo";
    o.localizations = buildUnnamed591();
...
checkChannelSection(api.ChannelSection o) {
  ...
  if (buildCounterChannelSection < 3) {
    ...
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed591(o.localizations);
...
buildChannelSectionContentDetails() {
  ...
  if (buildCounterChannelSectionContentDetails < 3) {
    o.channels = buildUnnamed592();
    o.playlists = buildUnnamed593();
  }
  buildCounterChannelSectionContentDetails--;
  return o;
}
...
checkChannelSectionContentDetails(api.ChannelSectionContentDetails o) {
  buildCounterChannelSectionContentDetails++;
  if (buildCounterChannelSectionContentDetails < 3) {
    checkUnnamed592(o.channels);
    checkUnnamed593(o.playlists);
  }
  buildCounterChannelSectionContentDetails--;
}
...
checkUnnamed594(core.List<api.ChannelSection> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildChannelSectionTargeting() {
  ...
  if (buildCounterChannelSectionTargeting < 3) {
    o.countries = buildUnnamed595();
    o.languages = buildUnnamed596();
    o.regions = buildUnnamed597();
  }
  buildCounterChannelSectionTargeting--;
  return o;
}
...
checkChannelSectionTargeting(api.ChannelSectionTargeting o) {
  buildCounterChannelSectionTargeting++;
  if (buildCounterChannelSectionTargeting < 3) {
    checkUnnamed595(o.countries);
    checkUnnamed596(o.languages);
    checkUnnamed597(o.regions);
  }
  buildCounterChannelSectionTargeting--;
}
...
buildChannelSettings() {
  ...
  if (buildCounterChannelSettings < 3) {
    ...
    o.featuredChannelsUrls = buildUnnamed598();
    o.keywords = "foo";
...
checkChannelSettings(api.ChannelSettings o) {
  ...
  if (buildCounterChannelSettings < 3) {
    ...
    checkUnnamed598(o.featuredChannelsUrls);
...
buildChannelTopicDetails() {
  ...
  if (buildCounterChannelTopicDetails < 3) {
    o.topicCategories = buildUnnamed599();
    o.topicIds = buildUnnamed600();
  }
  buildCounterChannelTopicDetails--;
  return o;
}
...
checkChannelTopicDetails(api.ChannelTopicDetails o) {
  buildCounterChannelTopicDetails++;
  if (buildCounterChannelTopicDetails < 3) {
    checkUnnamed599(o.topicCategories);
    checkUnnamed600(o.topicIds);
  }
  buildCounterChannelTopicDetails--;
}
...
checkUnnamed601(core.List<api.Comment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkComment(o[0]);
  checkComment(o[1]);
}
...
checkUnnamed602(core.List<api.CommentThread> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildContentRating() {
  ...
  if (buildCounterContentRating < 3) {
    ...
    o.czfilmRating = "foo";
    o.djctqRating = "foo";
    o.djctqRatingReasons = buildUnnamed604();
    o.ecbmctRating = "foo";
    o.eefilmRating = "foo";
    o.egfilmRating = "foo";
    o.eirinRating = "foo";
    ...
    o.fmocRating = "foo";
    o.fpbRating = "foo";
    o.fpbRatingReasons = buildUnnamed605();
    o.fskRating = "foo";
    o.grfilmRating = "foo";
    o.icaaRating = "foo";
    o.ifcoRating = "foo";
...
checkContentRating(api.ContentRating o) {
  ...
  if (buildCounterContentRating < 3) {
    ...
    checkUnnamed604(o.djctqRatingReasons);
    ...
    checkUnnamed605(o.fpbRatingReasons);
...
checkUnnamed606(core.List<api.FanFundingEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed607(core.List<api.GuideCategory> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed608(core.List<api.I18nLanguage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed609(core.List<api.I18nRegion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkI18nRegion(o[0]);
  checkI18nRegion(o[1]);
}
...
checkUnnamed610(core.List<api.PromotedItem> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed611(core.List<api.LiveBroadcast> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed612(core.List<api.LiveBroadcastTopic> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed613(core.List<api.LiveChatMessage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed614(core.List<api.LiveChatModerator> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed615(core.List<api.LiveChatPollItem> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed617(core.List<api.LiveStreamConfigurationIssue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildLiveStreamHealthStatus() {
  ...
  if (buildCounterLiveStreamHealthStatus < 3) {
    o.configurationIssues = buildUnnamed617();
...
checkLiveStreamHealthStatus(api.LiveStreamHealthStatus o) {
  buildCounterLiveStreamHealthStatus++;
  if (buildCounterLiveStreamHealthStatus < 3) {
    checkUnnamed617(o.configurationIssues);
...
checkUnnamed618(core.List<api.LiveStream> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLiveStream(o[0]);
  checkLiveStream(o[1]);
}
...
checkUnnamed619(core.List<api.LocalizedString> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed620(core.Map<core.String, api.PlaylistLocalization> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPlaylist() {
  ...
  if (buildCounterPlaylist < 3) {
    ...
    o.id = "foo";
    o.kind = "foo";
    o.localizations = buildUnnamed620();
...
checkPlaylist(api.Playlist o) {
  ...
  if (buildCounterPlaylist < 3) {
    ...
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed620(o.localizations);
...
checkUnnamed621(core.List<api.PlaylistItem> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed622(core.List<api.Playlist> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPlaylist(o[0]);
  checkPlaylist(o[1]);
}
...
checkUnnamed624(core.List<api.SearchResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed625(core.List<api.Sponsor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSponsor(o[0]);
  checkSponsor(o[1]);
}
...
checkUnnamed626(core.List<api.Subscription> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed627(core.List<api.SuperChatEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed628(core.List<api.ThumbnailDetails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed629(core.Map<core.String, api.VideoLocalization> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildVideo() {
  ...
  if (buildCounterVideo < 3) {
    ...
    o.localizations = buildUnnamed629();
...
checkVideo(api.Video o) {
  ...
  if (buildCounterVideo < 3) {
    ...
    checkUnnamed629(o.localizations);
...
checkUnnamed630(core.List<api.VideoAbuseReportReason> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed631(core.List<api.VideoAbuseReportSecondaryReason> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildVideoAbuseReportReasonSnippet() {
  ...
  if (buildCounterVideoAbuseReportReasonSnippet < 3) {
    o.label = "foo";
    o.secondaryReasons = buildUnnamed631();
  }
  buildCounterVideoAbuseReportReasonSnippet--;
  return o;
}
...
checkVideoAbuseReportReasonSnippet(api.VideoAbuseReportReasonSnippet o) {
  ...
  if (buildCounterVideoAbuseReportReasonSnippet < 3) {
    ...
    checkUnnamed631(o.secondaryReasons);
  }
  buildCounterVideoAbuseReportReasonSnippet--;
}
...
checkUnnamed632(core.List<api.VideoCategory> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildVideoContentDetailsRegionRestriction() {
  ...
  if (buildCounterVideoContentDetailsRegionRestriction < 3) {
    o.allowed = buildUnnamed633();
    o.blocked = buildUnnamed634();
  }
  buildCounterVideoContentDetailsRegionRestriction--;
  return o;
}
...
checkVideoContentDetailsRegionRestriction(api.VideoContentDetailsRegionRestriction o) {
  buildCounterVideoContentDetailsRegionRestriction++;
  if (buildCounterVideoContentDetailsRegionRestriction < 3) {
    checkUnnamed633(o.allowed);
    checkUnnamed634(o.blocked);
  }
  buildCounterVideoContentDetailsRegionRestriction--;
}
...
checkUnnamed635(core.List<api.VideoFileDetailsAudioStream> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed636(core.List<api.VideoFileDetailsVideoStream> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildVideoFileDetails() {
  ...
  if (buildCounterVideoFileDetails < 3) {
    o.audioStreams = buildUnnamed635();
    o.bitrateBps = "foo";
    o.container = "foo";
    o.creationTime = "foo";
    o.durationMs = "foo";
    ...
    o.fileSize = "foo";
    o.fileType = "foo";
    o.videoStreams = buildUnnamed636();
  }
  buildCounterVideoFileDetails--;
  return o;
}
...
checkVideoFileDetails(api.VideoFileDetails o) {
  buildCounterVideoFileDetails++;
  if (buildCounterVideoFileDetails < 3) {
    checkUnnamed635(o.audioStreams);
    ...
    checkUnnamed636(o.videoStreams);
  }
  buildCounterVideoFileDetails--;
}
...
checkUnnamed637(core.List<api.VideoRating> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed638(core.List<api.Video> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVideo(o[0]);
  checkVideo(o[1]);
}
...
checkUnnamed645(core.List<api.VideoSuggestionsTagSuggestion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildVideoSuggestions() {
  ...
  if (buildCounterVideoSuggestions < 3) {
    o.editorSuggestions = buildUnnamed641();
    o.processingErrors = buildUnnamed642();
    o.processingHints = buildUnnamed643();
    o.processingWarnings = buildUnnamed644();
    o.tagSuggestions = buildUnnamed645();
  }
  buildCounterVideoSuggestions--;
  return o;
}
...
checkVideoSuggestions(api.VideoSuggestions o) {
  buildCounterVideoSuggestions++;
  if (buildCounterVideoSuggestions < 3) {
    checkUnnamed641(o.editorSuggestions);
    checkUnnamed642(o.processingErrors);
    checkUnnamed643(o.processingHints);
    checkUnnamed644(o.processingWarnings);
    checkUnnamed645(o.tagSuggestions);
  }
  buildCounterVideoSuggestions--;
}
...
buildVideoSuggestionsTagSuggestion() {
  ...
  if (buildCounterVideoSuggestionsTagSuggestion < 3) {
    o.categoryRestricts = buildUnnamed646();
    o.tag = "foo";
  }
  buildCounterVideoSuggestionsTagSuggestion--;
  return o;
...
checkVideoSuggestionsTagSuggestion(api.VideoSuggestionsTagSuggestion o) {
  buildCounterVideoSuggestionsTagSuggestion++;
  if (buildCounterVideoSuggestionsTagSuggestion < 3) {
    checkUnnamed646(o.categoryRestricts);
...
buildVideoTopicDetails() {
  ...
  if (buildCounterVideoTopicDetails < 3) {
    o.relevantTopicIds = buildUnnamed647();
    o.topicCategories = buildUnnamed648();
    o.topicIds = buildUnnamed649();
  }
  buildCounterVideoTopicDetails--;
  return o;
}
...
checkVideoTopicDetails(api.VideoTopicDetails o) {
  buildCounterVideoTopicDetails++;
  if (buildCounterVideoTopicDetails < 3) {
    checkUnnamed647(o.relevantTopicIds);
    checkUnnamed648(o.topicCategories);
    checkUnnamed649(o.topicIds);
  }
  buildCounterVideoTopicDetails--;
}
