...
checkUnnamed1617(core.List<api.ResourceRecordSet> o) {
...
checkUnnamed1618(core.List<api.ResourceRecordSet> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResourceRecordSet(o[0]);
  checkResourceRecordSet(o[1]);
}
...
buildChange() {
  ...
  if (buildCounterChange < 3) {
    o.additions = buildUnnamed1617();
    o.deletions = buildUnnamed1618();
    o.id = "foo";
    o.isServing = true;
    o.kind = "foo";
    o.startTime = "foo";
...
checkChange(api.Change o) {
  buildCounterChange++;
  if (buildCounterChange < 3) {
    checkUnnamed1617(o.additions);
    checkUnnamed1618(o.deletions);
...
checkUnnamed1619(core.List<api.Change> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkChange(o[0]);
  checkChange(o[1]);
}
...
checkUnnamed1620(core.List<api.DnsKeyDigest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1621(core.List<api.DnsKey> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDnsKey(o[0]);
  checkDnsKey(o[1]);
}
...
checkUnnamed1622(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildManagedZone() {
  ...
  if (buildCounterManagedZone < 3) {
    ...
    o.name = "foo";
    o.nameServerSet = "foo";
    o.nameServers = buildUnnamed1623();
...
checkManagedZone(api.ManagedZone o) {
  ...
  if (buildCounterManagedZone < 3) {
    ...
    checkUnnamed1623(o.nameServers);
...
checkUnnamed1624(core.List<api.DnsKeySpec> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDnsKeySpec(o[0]);
  checkDnsKeySpec(o[1]);
}
...
buildManagedZoneDnsSecConfig() {
  ...
  if (buildCounterManagedZoneDnsSecConfig < 3) {
    o.defaultKeySpecs = buildUnnamed1624();
    o.kind = "foo";
    o.nonExistence = "foo";
    o.state = "foo";
  }
...
checkManagedZoneDnsSecConfig(api.ManagedZoneDnsSecConfig o) {
  buildCounterManagedZoneDnsSecConfig++;
  if (buildCounterManagedZoneDnsSecConfig < 3) {
    checkUnnamed1624(o.defaultKeySpecs);
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed1625(core.List<api.ManagedZoneForwardingConfigNameServerTarget> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildManagedZoneForwardingConfig() {
  ...
  if (buildCounterManagedZoneForwardingConfig < 3) {
    o.kind = "foo";
    o.targetNameServers = buildUnnamed1625();
  }
  buildCounterManagedZoneForwardingConfig--;
  return o;
}
...
checkManagedZoneForwardingConfig(api.ManagedZoneForwardingConfig o) {
  ...
  if (buildCounterManagedZoneForwardingConfig < 3) {
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1625(o.targetNameServers);
  }
  buildCounterManagedZoneForwardingConfig--;
}
...
checkUnnamed1626(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkUnnamed1627(core.List<api.ManagedZonePrivateVisibilityConfigNetwork> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1628(core.List<api.ManagedZone> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildManagedZonesListResponse() {
  ...
  if (buildCounterManagedZonesListResponse < 3) {
    o.header = buildResponseHeader();
    o.kind = "foo";
    o.managedZones = buildUnnamed1628();
    o.nextPageToken = "foo";
  }
  buildCounterManagedZonesListResponse--;
  return o;
...
checkManagedZonesListResponse(api.ManagedZonesListResponse o) {
  ...
  if (buildCounterManagedZonesListResponse < 3) {
    checkResponseHeader(o.header);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1628(o.managedZones);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterManagedZonesListResponse--;
}
...
checkUnnamed1629(core.List<api.Policy> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPolicy(o[0]);
  checkPolicy(o[1]);
}
...
checkUnnamed1630(core.List<api.PolicyNetwork> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPolicyAlternativeNameServerConfig() {
  ...
  if (buildCounterPolicyAlternativeNameServerConfig < 3) {
    o.kind = "foo";
    o.targetNameServers = buildUnnamed1631();
  }
  buildCounterPolicyAlternativeNameServerConfig--;
  return o;
}
...
checkPolicyAlternativeNameServerConfig(
  ...
  if (buildCounterPolicyAlternativeNameServerConfig < 3) {
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed1631(o.targetNameServers);
  }
  buildCounterPolicyAlternativeNameServerConfig--;
}
...
checkUnnamed1632(core.List<api.DnsKeySpec> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDnsKeySpec(o[0]);
  checkDnsKeySpec(o[1]);
}
...
buildQuota() {
  ...
  if (buildCounterQuota < 3) {
    ...
    o.whitelistedKeySpecs = buildUnnamed1632();
  }
  buildCounterQuota--;
  return o;
}
...
checkQuota(api.Quota o) {
  ...
  if (buildCounterQuota < 3) {
    ...
    checkUnnamed1632(o.whitelistedKeySpecs);
  }
  buildCounterQuota--;
}
...
buildResourceRecordSet() {
  ...
  if (buildCounterResourceRecordSet < 3) {
    o.kind = "foo";
    o.name = "foo";
    o.rrdatas = buildUnnamed1633();
    o.signatureRrdatas = buildUnnamed1634();
    o.ttl = 42;
    o.type = "foo";
  }
  buildCounterResourceRecordSet--;
...
checkResourceRecordSet(api.ResourceRecordSet o) {
  ...
  if (buildCounterResourceRecordSet < 3) {
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed1633(o.rrdatas);
    checkUnnamed1634(o.signatureRrdatas);
...
checkUnnamed1635(core.List<api.ResourceRecordSet> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResourceRecordSet(o[0]);
  checkResourceRecordSet(o[1]);
}
