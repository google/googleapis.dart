...
checkUnnamed2027(core.List<core.Object> o) {
...
checkUnnamed2028(core.List<api.Arg> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkArg(o[0]);
  checkArg(o[1]);
}
...
checkUnnamed2029(core.List<api.Release> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRelease(o[0]);
  checkRelease(o[1]);
}
...
checkUnnamed2030(core.List<api.Ruleset> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRuleset(o[0]);
  checkRuleset(o[1]);
}
...
checkUnnamed2031(core.List<api.File> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFile(o[0]);
  checkFile(o[1]);
}
...
checkUnnamed2032(core.List<api.FunctionMock> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildTestCase() {
  ...
  if (buildCounterTestCase < 3) {
    o.expectation = "foo";
    o.functionMocks = buildUnnamed2032();
    o.request = {
      'list': [1, 2, 3],
      'bool': true,
      'string': 'foo'
...
checkTestCase(api.TestCase o) {
  ...
  if (buildCounterTestCase < 3) {
    ...
    checkUnnamed2032(o.functionMocks);
...
checkUnnamed2034(core.List<api.FunctionCall> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2035(core.List<api.VisitedExpression> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildTestResult() {
  ...
  if (buildCounterTestResult < 3) {
    o.debugMessages = buildUnnamed2033();
    o.errorPosition = buildSourcePosition();
    o.functionCalls = buildUnnamed2034();
    o.state = "foo";
    o.visitedExpressions = buildUnnamed2035();
  }
  buildCounterTestResult--;
  return o;
}
...
checkTestResult(api.TestResult o) {
  buildCounterTestResult++;
  if (buildCounterTestResult < 3) {
    checkUnnamed2033(o.debugMessages);
    checkSourcePosition(o.errorPosition);
    checkUnnamed2034(o.functionCalls);
    unittest.expect(o.state, unittest.equals('foo'));
    checkUnnamed2035(o.visitedExpressions);
  }
  buildCounterTestResult--;
}
...
checkUnnamed2036(core.List<api.Issue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIssue(o[0]);
  checkIssue(o[1]);
}
...
checkUnnamed2037(core.List<api.TestResult> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTestResult(o[0]);
  checkTestResult(o[1]);
}
...
buildTestRulesetResponse() {
  ...
  if (buildCounterTestRulesetResponse < 3) {
    o.issues = buildUnnamed2036();
    o.testResults = buildUnnamed2037();
  }
  buildCounterTestRulesetResponse--;
  return o;
}
...
checkTestRulesetResponse(api.TestRulesetResponse o) {
  buildCounterTestRulesetResponse++;
  if (buildCounterTestRulesetResponse < 3) {
    checkUnnamed2036(o.issues);
    checkUnnamed2037(o.testResults);
  }
  buildCounterTestRulesetResponse--;
}
...
checkUnnamed2038(core.List<api.TestCase> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTestCase(o[0]);
  checkTestCase(o[1]);
}
