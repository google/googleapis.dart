...
buildAndroidNotification() {
  ...
  if (buildCounterAndroidNotification < 3) {
    o.body = "foo";
    o.bodyLocArgs = buildUnnamed1181();
    o.bodyLocKey = "foo";
    o.channelId = "foo";
    o.clickAction = "foo";
    o.color = "foo";
    ...
    o.ticker = "foo";
    o.title = "foo";
    o.titleLocArgs = buildUnnamed1182();
    o.titleLocKey = "foo";
    o.vibrateTimings = buildUnnamed1183();
    o.visibility = "foo";
  }
  buildCounterAndroidNotification--;
  return o;
...
checkAndroidNotification(api.AndroidNotification o) {
  ...
  if (buildCounterAndroidNotification < 3) {
    ...
    checkUnnamed1181(o.bodyLocArgs);
    ...
    checkUnnamed1182(o.titleLocArgs);
    unittest.expect(o.titleLocKey, unittest.equals('foo'));
    checkUnnamed1183(o.vibrateTimings);
...
buildApnsConfig() {
  ...
  if (buildCounterApnsConfig < 3) {
    ...
    o.headers = buildUnnamed1184();
    o.payload = buildUnnamed1185();
  }
  buildCounterApnsConfig--;
  return o;
}
...
checkApnsConfig(api.ApnsConfig o) {
  ...
  if (buildCounterApnsConfig < 3) {
    ...
    checkUnnamed1184(o.headers);
    checkUnnamed1185(o.payload);
  }
  buildCounterApnsConfig--;
}
...
checkUnnamed1189(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildWebpushConfig() {
  ...
  if (buildCounterWebpushConfig < 3) {
    o.data = buildUnnamed1187();
    o.fcmOptions = buildWebpushFcmOptions();
    o.headers = buildUnnamed1188();
    o.notification = buildUnnamed1189();
  }
  buildCounterWebpushConfig--;
  return o;
}
...
checkWebpushConfig(api.WebpushConfig o) {
  buildCounterWebpushConfig++;
  if (buildCounterWebpushConfig < 3) {
    checkUnnamed1187(o.data);
    checkWebpushFcmOptions(o.fcmOptions);
    checkUnnamed1188(o.headers);
    checkUnnamed1189(o.notification);
  }
  buildCounterWebpushConfig--;
}
