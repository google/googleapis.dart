...
core.List<api.GoogleHomeEnterpriseSdmV1ParentRelation> buildUnnamed3346() => [
...
api.GoogleHomeEnterpriseSdmV1Device buildGoogleHomeEnterpriseSdmV1Device() {
  ...
  if (buildCounterGoogleHomeEnterpriseSdmV1Device < 3) {
    o.name = 'foo';
    o.parentRelations = buildUnnamed3346();
    o.traits = buildUnnamed3347();
    o.type = 'foo';
  }
  buildCounterGoogleHomeEnterpriseSdmV1Device--;
  return o;
...
void checkGoogleHomeEnterpriseSdmV1Device(
  ...
  if (buildCounterGoogleHomeEnterpriseSdmV1Device < 3) {
    ...
    checkUnnamed3346(o.parentRelations!);
    checkUnnamed3347(o.traits!);
    unittest.expect(
      o.type!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.Object> buildUnnamed3348() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed3348(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkGoogleHomeEnterpriseSdmV1ExecuteDeviceCommandRequest(
  ...
  if (buildCounterGoogleHomeEnterpriseSdmV1ExecuteDeviceCommandRequest < 3) {
    ...
    checkUnnamed3348(o.params!);
  }
  buildCounterGoogleHomeEnterpriseSdmV1ExecuteDeviceCommandRequest--;
}

core.Map<core.String, core.Object> buildUnnamed3349() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed3349(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkGoogleHomeEnterpriseSdmV1ExecuteDeviceCommandResponse(
  ...
  buildCounterGoogleHomeEnterpriseSdmV1ExecuteDeviceCommandResponse++;
  if (buildCounterGoogleHomeEnterpriseSdmV1ExecuteDeviceCommandResponse < 3) {
    checkUnnamed3349(o.results!);
  }
  buildCounterGoogleHomeEnterpriseSdmV1ExecuteDeviceCommandResponse--;
}

core.List<api.GoogleHomeEnterpriseSdmV1Device> buildUnnamed3350() => [
      buildGoogleHomeEnterpriseSdmV1Device(),
      buildGoogleHomeEnterpriseSdmV1Device(),
    ];

void checkUnnamed3350(core.List<api.GoogleHomeEnterpriseSdmV1Device> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleHomeEnterpriseSdmV1Room> buildUnnamed3351() => [
      buildGoogleHomeEnterpriseSdmV1Room(),
      buildGoogleHomeEnterpriseSdmV1Room(),
    ];

void checkUnnamed3351(core.List<api.GoogleHomeEnterpriseSdmV1Room> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkGoogleHomeEnterpriseSdmV1ListRoomsResponse(
  ...
  if (buildCounterGoogleHomeEnterpriseSdmV1ListRoomsResponse < 3) {
    ...
    checkUnnamed3351(o.rooms!);
  }
  buildCounterGoogleHomeEnterpriseSdmV1ListRoomsResponse--;
}

core.List<api.GoogleHomeEnterpriseSdmV1Structure> buildUnnamed3352() => [
      buildGoogleHomeEnterpriseSdmV1Structure(),
      buildGoogleHomeEnterpriseSdmV1Structure(),
    ];

void checkUnnamed3352(core.List<api.GoogleHomeEnterpriseSdmV1Structure> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed3353() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed3353(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkGoogleHomeEnterpriseSdmV1Room(api.GoogleHomeEnterpriseSdmV1Room o) {
  ...
  if (buildCounterGoogleHomeEnterpriseSdmV1Room < 3) {
    ...
    checkUnnamed3353(o.traits!);
  }
  buildCounterGoogleHomeEnterpriseSdmV1Room--;
}

core.Map<core.String, core.Object> buildUnnamed3354() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed3354(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
