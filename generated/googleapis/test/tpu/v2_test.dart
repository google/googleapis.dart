...
import 'package:googleapis/tpu/v2.dart' as api;
...
core.List<api.Node> buildUnnamed7() => [buildNode(), buildNode()];
...
core.List<api.RuntimeVersion> buildUnnamed13() => [
  buildRuntimeVersion(),
  buildRuntimeVersion(),
];

void checkUnnamed13(core.List<api.RuntimeVersion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListRuntimeVersionsResponse buildListRuntimeVersionsResponse() {
  ...
  if (buildCounterListRuntimeVersionsResponse < 3) {
    o.nextPageToken = 'foo';
    o.runtimeVersions = buildUnnamed13();
...
void checkListRuntimeVersionsResponse(api.ListRuntimeVersionsResponse o) {
  ...
  if (buildCounterListRuntimeVersionsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed13(o.runtimeVersions!);
...
core.int buildCounterMultisliceParams = 0;
api.MultisliceParams buildMultisliceParams() {
  final o = api.MultisliceParams();
  buildCounterMultisliceParams++;
  if (buildCounterMultisliceParams < 3) {
    o.nodeCount = 42;
    o.nodeIdPrefix = 'foo';
  }
  buildCounterMultisliceParams--;
...
void checkMultisliceParams(api.MultisliceParams o) {
  buildCounterMultisliceParams++;
  if (buildCounterMultisliceParams < 3) {
...
core.List<api.NetworkConfig> buildUnnamed20() => [
  buildNetworkConfig(),
  buildNetworkConfig(),
];

void checkUnnamed20(core.List<api.NetworkConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNetworkConfig(o[0]);
  checkNetworkConfig(o[1]);
}

core.List<api.NetworkEndpoint> buildUnnamed21() => [
  buildNetworkEndpoint(),
  buildNetworkEndpoint(),
];

void checkUnnamed21(core.List<api.NetworkEndpoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNetworkEndpoint(o[0]);
  checkNetworkEndpoint(o[1]);
}

core.List<api.Symptom> buildUnnamed22() => [buildSymptom(), buildSymptom()];

void checkUnnamed22(core.List<api.Symptom> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSymptom(o[0]);
  checkSymptom(o[1]);
}
...
api.Node buildNode() {
  ...
  if (buildCounterNode < 3) {
    ...
    o.networkConfigs = buildUnnamed20();
    o.networkEndpoints = buildUnnamed21();
...
void checkNode(api.Node o) {
  ...
  if (buildCounterNode < 3) {
    ...
    checkUnnamed20(o.networkConfigs!);
    checkUnnamed21(o.networkEndpoints!);
...
api.NodeSpec buildNodeSpec() {
  ...
  if (buildCounterNodeSpec < 3) {
    o.multisliceParams = buildMultisliceParams();
    o.node = buildNode();
    o.nodeId = 'foo';
    o.parent = 'foo';
  }
...
void checkNodeSpec(api.NodeSpec o) {
  buildCounterNodeSpec++;
  if (buildCounterNodeSpec < 3) {
    checkMultisliceParams(o.multisliceParams!);
    checkNode(o.node!);
...
core.List<api.NodeSpec> buildUnnamed29() => [buildNodeSpec(), buildNodeSpec()];

void checkUnnamed29(core.List<api.NodeSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNodeSpec(o[0]);
  checkNodeSpec(o[1]);
}
...
void main() {
  ...
  unittest.group('obj-schema-MultisliceParams', () {
    unittest.test('to-json--from-json', () async {
      final o = buildMultisliceParams();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.MultisliceParams.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkMultisliceParams(od);
    });
  });
