...
checkUnnamed4252(core.List<api.AcceleratorType> o) {
...
buildListAcceleratorTypesResponse() {
  ...
  if (buildCounterListAcceleratorTypesResponse < 3) {
    o.acceleratorTypes = buildUnnamed4252();
    o.nextPageToken = "foo";
  }
  buildCounterListAcceleratorTypesResponse--;
  return o;
...
checkListAcceleratorTypesResponse(api.ListAcceleratorTypesResponse o) {
  buildCounterListAcceleratorTypesResponse++;
  if (buildCounterListAcceleratorTypesResponse < 3) {
    checkUnnamed4252(o.acceleratorTypes);
...
checkUnnamed4253(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
checkUnnamed4254(core.List<api.Node> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNode(o[0]);
  checkNode(o[1]);
}
...
checkUnnamed4255(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkUnnamed4256(core.List<api.TensorFlowVersion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListTensorFlowVersionsResponse() {
  ...
  if (buildCounterListTensorFlowVersionsResponse < 3) {
    o.nextPageToken = "foo";
    o.tensorflowVersions = buildUnnamed4256();
  }
  buildCounterListTensorFlowVersionsResponse--;
  return o;
}
...
checkListTensorFlowVersionsResponse(api.ListTensorFlowVersionsResponse o) {
  ...
  if (buildCounterListTensorFlowVersionsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4256(o.tensorflowVersions);
  }
  buildCounterListTensorFlowVersionsResponse--;
}
...
checkUnnamed4258(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildLocation() {
  ...
  if (buildCounterLocation < 3) {
    o.displayName = "foo";
    o.labels = buildUnnamed4257();
    o.locationId = "foo";
    o.metadata = buildUnnamed4258();
    o.name = "foo";
  }
  buildCounterLocation--;
  return o;
...
checkLocation(api.Location o) {
  ...
  if (buildCounterLocation < 3) {
    ...
    checkUnnamed4257(o.labels);
    unittest.expect(o.locationId, unittest.equals('foo'));
    checkUnnamed4258(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
  }
  buildCounterLocation--;
}
...
checkUnnamed4259(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed4260(core.List<api.NetworkEndpoint> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildNode() {
  ...
  if (buildCounterNode < 3) {
    ...
    o.ipAddress = "foo";
    o.labels = buildUnnamed4259();
    o.name = "foo";
    o.network = "foo";
    o.networkEndpoints = buildUnnamed4260();
    o.port = "foo";
...
checkNode(api.Node o) {
  ...
  if (buildCounterNode < 3) {
    ...
    unittest.expect(o.ipAddress, unittest.equals('foo'));
    checkUnnamed4259(o.labels);
    unittest.expect(o.name, unittest.equals('foo'));
    unittest.expect(o.network, unittest.equals('foo'));
    checkUnnamed4260(o.networkEndpoints);
...
checkUnnamed4261(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4262(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed4261();
    o.name = "foo";
    o.response = buildUnnamed4262();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed4261(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed4262(o.response);
  }
  buildCounterOperation--;
}
...
core.int buildCounterResetNodeRequest = 0;
buildResetNodeRequest() {
  var o = new api.ResetNodeRequest();
  buildCounterResetNodeRequest++;
  if (buildCounterResetNodeRequest < 3) {}
  buildCounterResetNodeRequest--;
  return o;
}

checkResetNodeRequest(api.ResetNodeRequest o) {
  buildCounterResetNodeRequest++;
  if (buildCounterResetNodeRequest < 3) {}
  buildCounterResetNodeRequest--;
}
...
buildUnnamed4264() {
  ...
  o.add(buildUnnamed4263());
  o.add(buildUnnamed4263());
  return o;
}

checkUnnamed4264(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed4263(o[0]);
  checkUnnamed4263(o[1]);
}
...
main() {
  ...
  unittest.group("obj-schema-ResetNodeRequest", () {
    unittest.test("to-json--from-json", () {
      var o = buildResetNodeRequest();
      var od = new api.ResetNodeRequest.fromJson(o.toJson());
      checkResetNodeRequest(od);
    });
  });
  ...
  unittest.group("resource-ProjectsLocationsNodesResourceApi", () {
    ...
    unittest.test("method--reset", () {
      ...
      api.ProjectsLocationsNodesResourceApi res =
          new api.TpuApi(mock).projects.locations.nodes;
      var arg_request = buildResetNodeRequest();
      var arg_name = "foo";
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var obj = new api.ResetNodeRequest.fromJson(json);
        checkResetNodeRequest(obj);
