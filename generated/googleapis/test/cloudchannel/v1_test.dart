...
void checkGoogleCloudChannelV1BillableSku(
  ...
  if (buildCounterGoogleCloudChannelV1BillableSku < 3) {
    ...
    unittest.expect(o.skuDisplayName!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudChannelV1BillableSku--;
}
...
void checkGoogleCloudChannelV1ChangeOfferRequest(
  ...
  if (buildCounterGoogleCloudChannelV1ChangeOfferRequest < 3) {
    ...
    unittest.expect(o.priceReferenceId!, unittest.equals('foo'));
...
void checkGoogleCloudChannelV1CheckCloudIdentityAccountsExistRequest(
  ...
  if (buildCounterGoogleCloudChannelV1CheckCloudIdentityAccountsExistRequest <
    ...
    unittest.expect(o.primaryAdminEmail!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudChannelV1CheckCloudIdentityAccountsExistRequest--;
}
...
void checkGoogleCloudChannelV1CloudIdentityCustomerAccount(
  ...
  buildCounterGoogleCloudChannelV1CloudIdentityCustomerAccount++;
  if (buildCounterGoogleCloudChannelV1CloudIdentityCustomerAccount < 3) {
    unittest.expect(o.channelPartnerCloudIdentityId!, unittest.equals('foo'));
...
void checkGoogleCloudChannelV1Column(api.GoogleCloudChannelV1Column o) {
  buildCounterGoogleCloudChannelV1Column++;
  if (buildCounterGoogleCloudChannelV1Column < 3) {
    unittest.expect(o.columnId!, unittest.equals('foo'));
...
void checkGoogleCloudChannelV1ConditionalOverride(
  ...
  if (buildCounterGoogleCloudChannelV1ConditionalOverride < 3) {
    ...
    unittest.expect(o.rebillingBasis!, unittest.equals('foo'));
...
void checkGoogleCloudChannelV1Customer(api.GoogleCloudChannelV1Customer o) {
  ...
  if (buildCounterGoogleCloudChannelV1Customer < 3) {
    ...
    unittest.expect(o.correlationId!, unittest.equals('foo'));
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.customerAttestationState!, unittest.equals('foo'));
    unittest.expect(o.domain!, unittest.equals('foo'));
    unittest.expect(o.languageCode!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
...
core.int buildCounterGoogleCloudChannelV1DiscountComponent = 0;
api.GoogleCloudChannelV1DiscountComponent
buildGoogleCloudChannelV1DiscountComponent() {
  final o = api.GoogleCloudChannelV1DiscountComponent();
  buildCounterGoogleCloudChannelV1DiscountComponent++;
  if (buildCounterGoogleCloudChannelV1DiscountComponent < 3) {
    o.discountAbsolute = buildGoogleTypeMoney();
    o.discountPercentage = 42.0;
    o.discountType = 'foo';
  }
  buildCounterGoogleCloudChannelV1DiscountComponent--;
  return o;
...
void checkGoogleCloudChannelV1DiscountComponent(
  api.GoogleCloudChannelV1DiscountComponent o,
) {
  buildCounterGoogleCloudChannelV1DiscountComponent++;
  if (buildCounterGoogleCloudChannelV1DiscountComponent < 3) {
    checkGoogleTypeMoney(o.discountAbsolute!);
    unittest.expect(o.discountPercentage!, unittest.equals(42.0));
    unittest.expect(o.discountType!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudChannelV1DiscountComponent--;
}
...
void checkGoogleCloudChannelV1EntitlementChange(
  ...
  buildCounterGoogleCloudChannelV1EntitlementChange++;
  if (buildCounterGoogleCloudChannelV1EntitlementChange < 3) {
    unittest.expect(o.activationReason!, unittest.equals('foo'));
    ...
    unittest.expect(o.otherChangeReason!, unittest.equals('foo'));
...
core.int
buildCounterGoogleCloudChannelV1ListChannelPartnerRepricingConfigsResponse = 0;
...
core.List<api.GoogleCloudChannelV1DiscountComponent> buildUnnamed31() => [
  buildGoogleCloudChannelV1DiscountComponent(),
  buildGoogleCloudChannelV1DiscountComponent(),
];

void checkUnnamed31(core.List<api.GoogleCloudChannelV1DiscountComponent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudChannelV1DiscountComponent(o[0]);
  checkGoogleCloudChannelV1DiscountComponent(o[1]);
}
...
api.GoogleCloudChannelV1Price buildGoogleCloudChannelV1Price() {
  ...
  if (buildCounterGoogleCloudChannelV1Price < 3) {
    ...
    o.discount = 42.0;
    o.discountComponents = buildUnnamed31();
    o.effectivePrice = buildGoogleTypeMoney();
    o.externalPriceUri = 'foo';
    o.pricePeriod = buildGoogleCloudChannelV1Period();
  }
  buildCounterGoogleCloudChannelV1Price--;
  return o;
}
...
void checkGoogleCloudChannelV1Price(api.GoogleCloudChannelV1Price o) {
  ...
  if (buildCounterGoogleCloudChannelV1Price < 3) {
    ...
    checkUnnamed31(o.discountComponents!);
    checkGoogleTypeMoney(o.effectivePrice!);
    unittest.expect(o.externalPriceUri!, unittest.equals('foo'));
    checkGoogleCloudChannelV1Period(o.pricePeriod!);
  }
  buildCounterGoogleCloudChannelV1Price--;
}

core.List<api.GoogleCloudChannelV1PricePhase> buildUnnamed32() => [
  buildGoogleCloudChannelV1PricePhase(),
  buildGoogleCloudChannelV1PricePhase(),
];

void checkUnnamed32(core.List<api.GoogleCloudChannelV1PricePhase> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkGoogleCloudChannelV1PriceByResource(
  ...
  if (buildCounterGoogleCloudChannelV1PriceByResource < 3) {
    ...
    checkUnnamed32(o.pricePhases!);
    unittest.expect(o.resourceType!, unittest.equals('foo'));
  }
  buildCounterGoogleCloudChannelV1PriceByResource--;
}

core.List<api.GoogleCloudChannelV1PriceTier> buildUnnamed33() => [
  buildGoogleCloudChannelV1PriceTier(),
  buildGoogleCloudChannelV1PriceTier(),
];

void checkUnnamed33(core.List<api.GoogleCloudChannelV1PriceTier> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleCloudChannelV1SkuPurchaseGroup> buildUnnamed34() => [
  buildGoogleCloudChannelV1SkuPurchaseGroup(),
  buildGoogleCloudChannelV1SkuPurchaseGroup(),
];

void checkUnnamed34(core.List<api.GoogleCloudChannelV1SkuPurchaseGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildGoogleCloudChannelV1QueryEligibleBillingAccountsResponse() {
  ...
  if (buildCounterGoogleCloudChannelV1QueryEligibleBillingAccountsResponse <
      3) {
    o.skuPurchaseGroups = buildUnnamed34();
  }
  buildCounterGoogleCloudChannelV1QueryEligibleBillingAccountsResponse--;
  return o;
}
...
void checkGoogleCloudChannelV1RegisterSubscriberRequest(
  ...
  if (buildCounterGoogleCloudChannelV1RegisterSubscriberRequest < 3) {
    ...
    unittest.expect(o.integrator!, unittest.equals('foo'));
...
core.List<api.GoogleCloudChannelV1Column> buildUnnamed35() => [
  buildGoogleCloudChannelV1Column(),
  buildGoogleCloudChannelV1Column(),
];

void checkUnnamed35(core.List<api.GoogleCloudChannelV1Column> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleCloudChannelV1ConditionalOverride> buildUnnamed36() => [
  buildGoogleCloudChannelV1ConditionalOverride(),
  buildGoogleCloudChannelV1ConditionalOverride(),
];

void checkUnnamed36(core.List<api.GoogleCloudChannelV1ConditionalOverride> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildGoogleCloudChannelV1RepricingConfig() {
  ...
  if (buildCounterGoogleCloudChannelV1RepricingConfig < 3) {
    ...
    o.conditionalOverrides = buildUnnamed36();
...
void checkGoogleCloudChannelV1RepricingConfig(
  ...
  if (buildCounterGoogleCloudChannelV1RepricingConfig < 3) {
    ...
    checkUnnamed36(o.conditionalOverrides!);
...
core.int
buildCounterGoogleCloudChannelV1RepricingConfigChannelPartnerGranularity = 0;
...
core.List<api.GoogleCloudChannelV1ReportValue> buildUnnamed37() => [
  buildGoogleCloudChannelV1ReportValue(),
  buildGoogleCloudChannelV1ReportValue(),
];

void checkUnnamed37(core.List<api.GoogleCloudChannelV1ReportValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildGoogleCloudChannelV1SkuPurchaseGroup() {
  ...
  if (buildCounterGoogleCloudChannelV1SkuPurchaseGroup < 3) {
    o.billingAccountPurchaseInfos = buildUnnamed38();
    o.skus = buildUnnamed39();
  }
  buildCounterGoogleCloudChannelV1SkuPurchaseGroup--;
  return o;
}
...
void checkGoogleCloudChannelV1SkuPurchaseGroup(
  ...
  buildCounterGoogleCloudChannelV1SkuPurchaseGroup++;
  if (buildCounterGoogleCloudChannelV1SkuPurchaseGroup < 3) {
    checkUnnamed38(o.billingAccountPurchaseInfos!);
    checkUnnamed39(o.skus!);
  }
  buildCounterGoogleCloudChannelV1SkuPurchaseGroup--;
}
...
core.List<api.GoogleCloudChannelV1Entitlement> buildUnnamed41() => [
  buildGoogleCloudChannelV1Entitlement(),
  buildGoogleCloudChannelV1Entitlement(),
];

void checkUnnamed41(core.List<api.GoogleCloudChannelV1Entitlement> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudChannelV1Entitlement(o[0]);
  checkGoogleCloudChannelV1Entitlement(o[1]);
}
...
core.List<api.GoogleLongrunningOperation> buildUnnamed43() => [
  buildGoogleLongrunningOperation(),
  buildGoogleLongrunningOperation(),
];

void checkUnnamed43(core.List<api.GoogleLongrunningOperation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleTypePostalAddress buildGoogleTypePostalAddress() {
  ...
  if (buildCounterGoogleTypePostalAddress < 3) {
    o.addressLines = buildUnnamed48();
    o.administrativeArea = 'foo';
    o.languageCode = 'foo';
    o.locality = 'foo';
    o.organization = 'foo';
    o.postalCode = 'foo';
    o.recipients = buildUnnamed49();
    o.regionCode = 'foo';
    o.revision = 42;
    o.sortingCode = 'foo';
    o.sublocality = 'foo';
...
void main() {
  unittest.group(
    'obj-schema-GoogleCloudChannelV1ActivateEntitlementRequest',
    () {
  ...
  unittest.group(
    'obj-schema-GoogleCloudChannelV1BillingAccountPurchaseInfo',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudChannelV1ChangeRenewalSettingsRequest',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudChannelV1ChannelPartnerRepricingConfig',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudChannelV1CloudIdentityCustomerAccount',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group('obj-schema-GoogleCloudChannelV1DiscountComponent', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudChannelV1DiscountComponent();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudChannelV1DiscountComponent.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoogleCloudChannelV1DiscountComponent(od);
    });
  });
  ...
  unittest.group(
    'obj-schema-GoogleCloudChannelV1FetchReportResultsRequest',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudChannelV1FetchReportResultsResponse',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudChannelV1ListPurchasableOffersResponse',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudChannelV1ListPurchasableSkusResponse',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudChannelV1ListTransferableOffersRequest',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudChannelV1ListTransferableSkusRequest',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudChannelV1ListTransferableSkusResponse',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudChannelV1ProvisionCloudIdentityRequest',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudChannelV1RegisterSubscriberRequest',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudChannelV1RegisterSubscriberResponse',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudChannelV1SuspendEntitlementRequest',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudChannelV1TransferEntitlementsRequest',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudChannelV1UnregisterSubscriberRequest',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GoogleCloudChannelV1UnregisterSubscriberResponse',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group('resource-AccountsResource', () {
    ...
    unittest.test('method--listSubscribers', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            queryMap['integrator']!.first,
            unittest.equals(arg_integrator),
          );
          unittest.expect(
      ...
      final response = await res.listSubscribers(
        arg_account,
        integrator: arg_integrator,
    ...
    unittest.test('method--listTransferableOffers', () async {
      ...
      final response = await res.listTransferableOffers(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--listTransferableSkus', () async {
      ...
      final response = await res.listTransferableSkus(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
    ...
    () {
      ...
      unittest.test('method--list', () async {
        ...
        checkGoogleCloudChannelV1ListChannelPartnerRepricingConfigsResponse(
          response
              as api.GoogleCloudChannelV1ListChannelPartnerRepricingConfigsResponse,
        );
      });
  ...
  unittest.group('resource-AccountsCustomersResource', () {
    ...
    unittest.test('method--listPurchasableOffers', () async {
      ...
      final response = await res.listPurchasableOffers(
        arg_customer,
    ...
    unittest.test('method--listPurchasableSkus', () async {
      ...
      final response = await res.listPurchasableSkus(
        arg_customer,
    ...
    unittest.test('method--queryEligibleBillingAccounts', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(queryMap['skus']!, unittest.equals(arg_skus));
          unittest.expect(
            queryMap['fields']!.first,
            unittest.equals(arg_$fields),
          );
      ...
      final response = await res.queryEligibleBillingAccounts(
        arg_customer,
        skus: arg_skus,
        $fields: arg_$fields,
      );
      checkGoogleCloudChannelV1QueryEligibleBillingAccountsResponse(
        response
    ...
    unittest.test('method--transferEntitlements', () async {
      ...
      final response = await res.transferEntitlements(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-AccountsCustomersCustomerRepricingConfigsResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      checkGoogleCloudChannelV1ListCustomerRepricingConfigsResponse(
        response
  ...
  unittest.group('resource-AccountsCustomersEntitlementsResource', () {
    ...
    unittest.test('method--changeOffer', () async {
      ...
      final response = await res.changeOffer(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--changeParameters', () async {
      ...
      final response = await res.changeParameters(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--listEntitlementChanges', () async {
      ...
      final response = await res.listEntitlementChanges(
        arg_parent,
        filter: arg_filter,
        pageSize: arg_pageSize,
        pageToken: arg_pageToken,
    ...
    unittest.test('method--lookupOffer', () async {
      ...
      final response = await res.lookupOffer(
        arg_entitlement,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-AccountsReportJobsResource', () {
    unittest.test('method--fetchReportResults', () async {
      ...
      final response = await res.fetchReportResults(
        arg_request,
        arg_reportJob,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-IntegratorsResource', () {
    unittest.test('method--listSubscribers', () async {
      final mock = HttpServerMock();
      final res = api.CloudchannelApi(mock).integrators;
      final arg_integrator = 'foo';
      final arg_account = 'foo';
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
    ...
    unittest.test('method--registerSubscriber', () async {
      final mock = HttpServerMock();
      final res = api.CloudchannelApi(mock).integrators;
      final arg_request = buildGoogleCloudChannelV1RegisterSubscriberRequest();
      final arg_integrator = 'foo';
      ...
      final response = await res.registerSubscriber(
        arg_request,
        arg_integrator,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--unregisterSubscriber', () async {
      final mock = HttpServerMock();
      final res = api.CloudchannelApi(mock).integrators;
      final arg_request =
          buildGoogleCloudChannelV1UnregisterSubscriberRequest();
      ...
      final response = await res.unregisterSubscriber(
        arg_request,
        arg_integrator,
        $fields: arg_$fields,
      );
