    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudChannelV1ListCustomerRepricingConfigsResponse();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudChannelV1ListCustomerRepricingConfigsResponse
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudChannelV1QueryEligibleBillingAccountsResponse();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudChannelV1QueryEligibleBillingAccountsResponse
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
    ...
    () {
      unittest.test('to-json--from-json', () async {
        final o =
            buildGoogleCloudChannelV1TransferEntitlementsToGoogleRequest();
        final oJson = convert.jsonDecode(convert.jsonEncode(o));
        final od = api.GoogleCloudChannelV1TransferEntitlementsToGoogleRequest
            .fromJson(
          oJson as core.Map<core.String, core.dynamic>,
        );
