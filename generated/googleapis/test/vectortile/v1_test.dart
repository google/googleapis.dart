...
api.Area buildArea() {
  ...
  if (buildCounterArea < 3) {
    ...
    o.internalEdges = buildUnnamed1500();
    o.loopBreaks = buildUnnamed1501();
    o.triangleIndices = buildUnnamed1502();
    o.type = 'foo';
...
void checkArea(api.Area o) {
  ...
  if (buildCounterArea < 3) {
    ...
    checkUnnamed1500(o.internalEdges);
    checkUnnamed1501(o.loopBreaks);
    checkUnnamed1502(o.triangleIndices);
...
core.List<api.Relation> buildUnnamed1503() {
  var o = <api.Relation>[];
  o.add(buildRelation());
  o.add(buildRelation());
  return o;
...
void checkUnnamed1503(core.List<api.Relation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Feature> buildUnnamed1504() {
  var o = <api.Feature>[];
  o.add(buildFeature());
  o.add(buildFeature());
  return o;
...
void checkUnnamed1504(core.List<api.Feature> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFeature(o[0] as api.Feature);
  checkFeature(o[1] as api.Feature);
}

core.List<api.ProviderInfo> buildUnnamed1505() {
...
void checkUnnamed1505(core.List<api.ProviderInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.FeatureTile buildFeatureTile() {
  ...
  if (buildCounterFeatureTile < 3) {
    ...
    o.features = buildUnnamed1504();
    o.name = 'foo';
    o.providers = buildUnnamed1505();
    o.status = 'foo';
    o.versionId = 'foo';
  }
  buildCounterFeatureTile--;
...
void checkFeatureTile(api.FeatureTile o) {
  ...
  if (buildCounterFeatureTile < 3) {
    ...
    checkUnnamed1504(o.features);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed1505(o.providers);
...
core.List<api.Row> buildUnnamed1506() {
  var o = <api.Row>[];
  o.add(buildRow());
  o.add(buildRow());
  return o;
...
void checkUnnamed1506(core.List<api.Row> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Area> buildUnnamed1507() {
  var o = <api.Area>[];
  o.add(buildArea());
  o.add(buildArea());
  return o;
...
void checkUnnamed1507(core.List<api.Area> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkArea(o[0] as api.Area);
  checkArea(o[1] as api.Area);
}

core.List<api.ExtrudedArea> buildUnnamed1508() {
  var o = <api.ExtrudedArea>[];
...
void checkUnnamed1508(core.List<api.ExtrudedArea> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkExtrudedArea(o[0] as api.ExtrudedArea);
  checkExtrudedArea(o[1] as api.ExtrudedArea);
}

core.List<api.Line> buildUnnamed1509() {
  var o = <api.Line>[];
  o.add(buildLine());
  o.add(buildLine());
  return o;
...
void checkUnnamed1509(core.List<api.Line> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLine(o[0] as api.Line);
  checkLine(o[1] as api.Line);
}

core.List<api.ModeledVolume> buildUnnamed1510() {
...
void checkUnnamed1510(core.List<api.ModeledVolume> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Geometry buildGeometry() {
  ...
  if (buildCounterGeometry < 3) {
    o.areas = buildUnnamed1507();
    o.extrudedAreas = buildUnnamed1508();
    o.lines = buildUnnamed1509();
    o.modeledVolumes = buildUnnamed1510();
  }
  buildCounterGeometry--;
  return o;
}
...
void checkGeometry(api.Geometry o) {
  buildCounterGeometry++;
  if (buildCounterGeometry < 3) {
    checkUnnamed1507(o.areas);
    checkUnnamed1508(o.extrudedAreas);
    checkUnnamed1509(o.lines);
    checkUnnamed1510(o.modeledVolumes);
  }
  buildCounterGeometry--;
}
...
core.List<api.TriangleStrip> buildUnnamed1511() {
...
void checkUnnamed1511(core.List<api.TriangleStrip> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.int> buildUnnamed1512() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed1512(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42));
  unittest.expect(o[1], unittest.equals(42));
}
...
api.Row buildRow() {
  ...
  if (buildCounterRow < 3) {
    o.altitudeDiffs = buildUnnamed1512();
  }
  buildCounterRow--;
  return o;
}
...
void checkRow(api.Row o) {
  buildCounterRow++;
  if (buildCounterRow < 3) {
    checkUnnamed1512(o.altitudeDiffs);
  }
  buildCounterRow--;
}
...
core.List<core.int> buildUnnamed1513() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed1513(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42));
  unittest.expect(o[1], unittest.equals(42));
}
...
api.TriangleStrip buildTriangleStrip() {
  ...
  if (buildCounterTriangleStrip < 3) {
    o.vertexIndices = buildUnnamed1513();
  }
  buildCounterTriangleStrip--;
  return o;
}
...
void checkTriangleStrip(api.TriangleStrip o) {
  buildCounterTriangleStrip++;
  if (buildCounterTriangleStrip < 3) {
    checkUnnamed1513(o.vertexIndices);
  }
  buildCounterTriangleStrip--;
}

core.List<core.int> buildUnnamed1514() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed1514(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42));
  unittest.expect(o[1], unittest.equals(42));
}

core.List<core.int> buildUnnamed1515() {
  var o = <core.int>[];
  o.add(42);
  o.add(42);
  return o;
...
void checkUnnamed1515(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals(42));
  unittest.expect(o[1], unittest.equals(42));
}
...
api.Vertex2DList buildVertex2DList() {
  ...
  if (buildCounterVertex2DList < 3) {
    o.xOffsets = buildUnnamed1514();
    o.yOffsets = buildUnnamed1515();
  }
  buildCounterVertex2DList--;
  return o;
}
...
void checkVertex2DList(api.Vertex2DList o) {
  buildCounterVertex2DList++;
  if (buildCounterVertex2DList < 3) {
    checkUnnamed1514(o.xOffsets);
    checkUnnamed1515(o.yOffsets);
  }
  buildCounterVertex2DList--;
}
...
api.Vertex3DList buildVertex3DList() {
  ...
  if (buildCounterVertex3DList < 3) {
    o.xOffsets = buildUnnamed1516();
    o.yOffsets = buildUnnamed1517();
    o.zOffsets = buildUnnamed1518();
  }
  buildCounterVertex3DList--;
  return o;
}
...
void checkVertex3DList(api.Vertex3DList o) {
  buildCounterVertex3DList++;
  if (buildCounterVertex3DList < 3) {
    checkUnnamed1516(o.xOffsets);
    checkUnnamed1517(o.yOffsets);
    checkUnnamed1518(o.zOffsets);
  }
  buildCounterVertex3DList--;
}
...
void main() {
  ...
  unittest.group('resource-TerraintilesResource', () {
    unittest.test('method--get', () {
      ...
      var arg_terrainFormats = buildUnnamed1519();
      var arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
