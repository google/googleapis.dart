...
void checkAlert(api.Alert o) {
  ...
  if (buildCounterAlert < 3) {
    ...
    checkLogMetadata(o.log!);
    checkMonitoredResourceMetadata(o.metadata!);
    checkMetric(o.metric!);
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.openTime!, unittest.equals('foo'));
    checkPolicySnapshot(o.policy!);
...
core.List<api.NotificationChannelStrategy> buildUnnamed4() => [
  buildNotificationChannelStrategy(),
  buildNotificationChannelStrategy(),
];

void checkUnnamed4(core.List<api.NotificationChannelStrategy> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNotificationChannelStrategy(o[0]);
  checkNotificationChannelStrategy(o[1]);
}
...
api.AlertStrategy buildAlertStrategy() {
  ...
  if (buildCounterAlertStrategy < 3) {
    o.autoClose = 'foo';
    o.notificationChannelStrategy = buildUnnamed4();
    o.notificationPrompts = buildUnnamed5();
...
void checkAlertStrategy(api.AlertStrategy o) {
  buildCounterAlertStrategy++;
  if (buildCounterAlertStrategy < 3) {
    unittest.expect(o.autoClose!, unittest.equals('foo'));
    checkUnnamed4(o.notificationChannelStrategy!);
    checkUnnamed5(o.notificationPrompts!);
...
core.int buildCounterBasicService = 0;
api.BasicService buildBasicService() {
  final o = api.BasicService();
  buildCounterBasicService++;
  if (buildCounterBasicService < 3) {
    o.serviceLabels = buildUnnamed6();
    o.serviceType = 'foo';
  }
  buildCounterBasicService--;
  return o;
...
void checkBasicService(api.BasicService o) {
  buildCounterBasicService++;
  if (buildCounterBasicService < 3) {
    checkUnnamed6(o.serviceLabels!);
...
api.BasicSli buildBasicSli() {
  ...
  if (buildCounterBasicSli < 3) {
    ...
    o.location = buildUnnamed7();
    o.method = buildUnnamed8();
    o.version = buildUnnamed9();
  }
  buildCounterBasicSli--;
  return o;
}
...
void checkBasicSli(api.BasicSli o) {
  ...
  if (buildCounterBasicSli < 3) {
    ...
    checkUnnamed7(o.location!);
    checkUnnamed8(o.method!);
    checkUnnamed9(o.version!);
  }
  buildCounterBasicSli--;
}

core.int buildCounterBooleanTest = 0;
api.BooleanTest buildBooleanTest() {
  final o = api.BooleanTest();
  buildCounterBooleanTest++;
  if (buildCounterBooleanTest < 3) {
    o.column = 'foo';
  }
  buildCounterBooleanTest--;
  return o;
...
void checkBooleanTest(api.BooleanTest o) {
  buildCounterBooleanTest++;
  if (buildCounterBooleanTest < 3) {
...
core.Map<core.String, api.TypedValue> buildUnnamed10() => {
  'x': buildTypedValue(),
  'y': buildTypedValue(),
};

void checkUnnamed10(core.Map<core.String, api.TypedValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTypedValue(o['x']!);
  checkTypedValue(o['y']!);
}

core.List<api.CollectdValue> buildUnnamed11() => [
  buildCollectdValue(),
  buildCollectdValue(),
];

void checkUnnamed11(core.List<api.CollectdValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkCollectdPayload(api.CollectdPayload o) {
  ...
  if (buildCounterCollectdPayload < 3) {
    ...
    checkUnnamed11(o.values!);
  }
  buildCounterCollectdPayload--;
}

core.List<api.CollectdValueError> buildUnnamed12() => [
  buildCollectdValueError(),
  buildCollectdValueError(),
];

void checkUnnamed12(core.List<api.CollectdValueError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Condition buildCondition() {
  ...
  if (buildCounterCondition < 3) {
    ...
    o.conditionPrometheusQueryLanguage =
        buildPrometheusQueryLanguageCondition();
    o.conditionSql = buildSqlCondition();
...
void checkCondition(api.Condition o) {
  ...
  if (buildCounterCondition < 3) {
    ...
    checkPrometheusQueryLanguageCondition(o.conditionPrometheusQueryLanguage!);
    checkSqlCondition(o.conditionSql!);
...
core.List<api.CollectdPayload> buildUnnamed13() => [
  buildCollectdPayload(),
  buildCollectdPayload(),
];

void checkUnnamed13(core.List<api.CollectdPayload> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.CreateCollectdTimeSeriesRequest buildCreateCollectdTimeSeriesRequest() {
  ...
  if (buildCounterCreateCollectdTimeSeriesRequest < 3) {
    o.collectdPayloads = buildUnnamed13();
...
void checkCreateCollectdTimeSeriesRequest(
  ...
  buildCounterCreateCollectdTimeSeriesRequest++;
  if (buildCounterCreateCollectdTimeSeriesRequest < 3) {
    checkUnnamed13(o.collectdPayloads!);
...
core.List<api.CollectdPayloadError> buildUnnamed14() => [
  buildCollectdPayloadError(),
  buildCollectdPayloadError(),
];

void checkUnnamed14(core.List<api.CollectdPayloadError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.CreateCollectdTimeSeriesResponse buildCreateCollectdTimeSeriesResponse() {
  ...
  if (buildCounterCreateCollectdTimeSeriesResponse < 3) {
    o.payloadErrors = buildUnnamed14();
...
void checkCreateCollectdTimeSeriesResponse(
  ...
  buildCounterCreateCollectdTimeSeriesResponse++;
  if (buildCounterCreateCollectdTimeSeriesResponse < 3) {
    checkUnnamed14(o.payloadErrors!);
    checkCreateTimeSeriesSummary(o.summary!);
  }
  buildCounterCreateCollectdTimeSeriesResponse--;
}

core.List<api.TimeSeries> buildUnnamed15() => [
  buildTimeSeries(),
  buildTimeSeries(),
];

void checkUnnamed15(core.List<api.TimeSeries> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTimeSeries(o[0]);
  checkTimeSeries(o[1]);
}
...
void checkCreateTimeSeriesRequest(api.CreateTimeSeriesRequest o) {
  buildCounterCreateTimeSeriesRequest++;
  if (buildCounterCreateTimeSeriesRequest < 3) {
    checkUnnamed15(o.timeSeries!);
  }
  buildCounterCreateTimeSeriesRequest--;
}

core.List<api.Error> buildUnnamed16() => [buildError(), buildError()];

void checkUnnamed16(core.List<api.Error> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkError(o[0]);
  checkError(o[1]);
}
...
core.int buildCounterCriteria = 0;
api.Criteria buildCriteria() {
...
core.int buildCounterDaily = 0;
api.Daily buildDaily() {
  final o = api.Daily();
  buildCounterDaily++;
  if (buildCounterDaily < 3) {
    o.executionTime = buildTimeOfDay();
    o.periodicity = 42;
  }
  buildCounterDaily--;
  return o;
...
void checkDaily(api.Daily o) {
  buildCounterDaily++;
  if (buildCounterDaily < 3) {
    checkTimeOfDay(o.executionTime!);
    unittest.expect(o.periodicity!, unittest.equals(42));
  }
  buildCounterDaily--;
}
...
core.List<api.Exemplar> buildUnnamed19() => [buildExemplar(), buildExemplar()];

void checkUnnamed19(core.List<api.Exemplar> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkExemplar(o[0]);
  checkExemplar(o[1]);
}
...
api.Distribution buildDistribution() {
  ...
  if (buildCounterDistribution < 3) {
    o.bucketCounts = buildUnnamed18();
    o.bucketOptions = buildBucketOptions();
    o.count = 'foo';
    o.exemplars = buildUnnamed19();
    o.mean = 42.0;
    o.range = buildRange();
...
void checkDistribution(api.Distribution o) {
  buildCounterDistribution++;
  if (buildCounterDistribution < 3) {
    checkUnnamed18(o.bucketCounts!);
    checkBucketOptions(o.bucketOptions!);
    unittest.expect(o.count!, unittest.equals('foo'));
    checkUnnamed19(o.exemplars!);
...
core.List<api.Link> buildUnnamed20() => [buildLink(), buildLink()];

void checkUnnamed20(core.List<api.Link> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLink(o[0]);
  checkLink(o[1]);
}
...
core.List<core.double> buildUnnamed23() => [42.0, 42.0];

void checkUnnamed23(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.int buildCounterForecastOptions = 0;
api.ForecastOptions buildForecastOptions() {
  final o = api.ForecastOptions();
  buildCounterForecastOptions++;
  if (buildCounterForecastOptions < 3) {
    o.forecastHorizon = 'foo';
  }
  buildCounterForecastOptions--;
  return o;
}

void checkForecastOptions(api.ForecastOptions o) {
  buildCounterForecastOptions++;
  if (buildCounterForecastOptions < 3) {
    unittest.expect(o.forecastHorizon!, unittest.equals('foo'));
  }
  buildCounterForecastOptions--;
}
...
void checkGkeWorkload(api.GkeWorkload o) {
  ...
  if (buildCounterGkeWorkload < 3) {
    ...
    unittest.expect(o.namespaceName!, unittest.equals('foo'));
    unittest.expect(o.projectId!, unittest.equals('foo'));
    unittest.expect(o.topLevelControllerName!, unittest.equals('foo'));
    unittest.expect(o.topLevelControllerType!, unittest.equals('foo'));
  }
  buildCounterGkeWorkload--;
}
...
core.int buildCounterHourly = 0;
api.Hourly buildHourly() {
  final o = api.Hourly();
  buildCounterHourly++;
  if (buildCounterHourly < 3) {
    o.minuteOffset = 42;
    o.periodicity = 42;
  }
  buildCounterHourly--;
...
void checkHourly(api.Hourly o) {
  buildCounterHourly++;
  if (buildCounterHourly < 3) {
    unittest.expect(o.minuteOffset!, unittest.equals(42));
    unittest.expect(o.periodicity!, unittest.equals(42));
  }
  buildCounterHourly--;
}

core.List<api.ResponseStatusCode> buildUnnamed24() => [
  buildResponseStatusCode(),
  buildResponseStatusCode(),
];

void checkUnnamed24(core.List<api.ResponseStatusCode> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResponseStatusCode(o[0]);
  checkResponseStatusCode(o[1]);
}
...
api.HttpCheck buildHttpCheck() {
  ...
  if (buildCounterHttpCheck < 3) {
    o.acceptedResponseStatusCodes = buildUnnamed24();
...
void checkHttpCheck(api.HttpCheck o) {
  buildCounterHttpCheck++;
  if (buildCounterHttpCheck < 3) {
    checkUnnamed24(o.acceptedResponseStatusCodes!);
    checkBasicAuthentication(o.authInfo!);
    unittest.expect(o.body!, unittest.equals('foo'));
    unittest.expect(o.contentType!, unittest.equals('foo'));
    unittest.expect(o.customContentType!, unittest.equals('foo'));
...
void checkJsonPathMatcher(api.JsonPathMatcher o) {
  buildCounterJsonPathMatcher++;
  if (buildCounterJsonPathMatcher < 3) {
    unittest.expect(o.jsonMatcher!, unittest.equals('foo'));
    unittest.expect(o.jsonPath!, unittest.equals('foo'));
  }
  buildCounterJsonPathMatcher--;
}
...
core.List<api.AlertPolicy> buildUnnamed26() => [
  buildAlertPolicy(),
  buildAlertPolicy(),
];

void checkUnnamed26(core.List<api.AlertPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListAlertPoliciesResponse buildListAlertPoliciesResponse() {
  ...
  if (buildCounterListAlertPoliciesResponse < 3) {
    o.alertPolicies = buildUnnamed26();
    o.nextPageToken = 'foo';
    o.totalSize = 42;
  }
  buildCounterListAlertPoliciesResponse--;
...
void checkListAlertPoliciesResponse(api.ListAlertPoliciesResponse o) {
  buildCounterListAlertPoliciesResponse++;
  if (buildCounterListAlertPoliciesResponse < 3) {
    checkUnnamed26(o.alertPolicies!);
...
core.List<api.Alert> buildUnnamed27() => [buildAlert(), buildAlert()];

void checkUnnamed27(core.List<api.Alert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAlert(o[0]);
  checkAlert(o[1]);
}
...
core.List<api.MonitoredResource> buildUnnamed28() => [
  buildMonitoredResource(),
  buildMonitoredResource(),
];

void checkUnnamed28(core.List<api.MonitoredResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Group> buildUnnamed29() => [buildGroup(), buildGroup()];

void checkUnnamed29(core.List<api.Group> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGroup(o[0]);
  checkGroup(o[1]);
}
...
void checkListGroupsResponse(api.ListGroupsResponse o) {
  buildCounterListGroupsResponse++;
  if (buildCounterListGroupsResponse < 3) {
    checkUnnamed29(o.group!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListGroupsResponse--;
}

core.List<api.MetricDescriptor> buildUnnamed30() => [
  buildMetricDescriptor(),
  buildMetricDescriptor(),
];

void checkUnnamed30(core.List<api.MetricDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListMetricDescriptorsResponse buildListMetricDescriptorsResponse() {
  ...
  if (buildCounterListMetricDescriptorsResponse < 3) {
    o.metricDescriptors = buildUnnamed30();
    o.nextPageToken = 'foo';
  }
  buildCounterListMetricDescriptorsResponse--;
  return o;
...
void checkListMetricDescriptorsResponse(api.ListMetricDescriptorsResponse o) {
  buildCounterListMetricDescriptorsResponse++;
  if (buildCounterListMetricDescriptorsResponse < 3) {
    checkUnnamed30(o.metricDescriptors!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListMetricDescriptorsResponse--;
}

core.List<api.MonitoredResourceDescriptor> buildUnnamed31() => [
  buildMonitoredResourceDescriptor(),
  buildMonitoredResourceDescriptor(),
];

void checkUnnamed31(core.List<api.MonitoredResourceDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListMonitoredResourceDescriptorsResponse() {
  ...
  if (buildCounterListMonitoredResourceDescriptorsResponse < 3) {
    o.nextPageToken = 'foo';
    o.resourceDescriptors = buildUnnamed31();
  }
  buildCounterListMonitoredResourceDescriptorsResponse--;
  return o;
}
...
void checkListMonitoredResourceDescriptorsResponse(
  ...
  if (buildCounterListMonitoredResourceDescriptorsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed31(o.resourceDescriptors!);
  }
  buildCounterListMonitoredResourceDescriptorsResponse--;
}

core.List<api.NotificationChannelDescriptor> buildUnnamed32() => [
  buildNotificationChannelDescriptor(),
  buildNotificationChannelDescriptor(),
];

void checkUnnamed32(core.List<api.NotificationChannelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListNotificationChannelDescriptorsResponse() {
  ...
  if (buildCounterListNotificationChannelDescriptorsResponse < 3) {
    o.channelDescriptors = buildUnnamed32();
    o.nextPageToken = 'foo';
  }
  buildCounterListNotificationChannelDescriptorsResponse--;
  return o;
...
void checkListNotificationChannelDescriptorsResponse(
  ...
  buildCounterListNotificationChannelDescriptorsResponse++;
  if (buildCounterListNotificationChannelDescriptorsResponse < 3) {
    checkUnnamed32(o.channelDescriptors!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListNotificationChannelDescriptorsResponse--;
}

core.List<api.NotificationChannel> buildUnnamed33() => [
  buildNotificationChannel(),
  buildNotificationChannel(),
];

void checkUnnamed33(core.List<api.NotificationChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListNotificationChannelsResponse buildListNotificationChannelsResponse() {
  ...
  if (buildCounterListNotificationChannelsResponse < 3) {
    o.nextPageToken = 'foo';
    o.notificationChannels = buildUnnamed33();
    o.totalSize = 42;
  }
  buildCounterListNotificationChannelsResponse--;
  return o;
...
void checkListNotificationChannelsResponse(
  ...
  if (buildCounterListNotificationChannelsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed33(o.notificationChannels!);
    unittest.expect(o.totalSize!, unittest.equals(42));
  }
  buildCounterListNotificationChannelsResponse--;
}

core.List<api.ServiceLevelObjective> buildUnnamed34() => [
  buildServiceLevelObjective(),
  buildServiceLevelObjective(),
];

void checkUnnamed34(core.List<api.ServiceLevelObjective> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListServiceLevelObjectivesResponse() {
  ...
  if (buildCounterListServiceLevelObjectivesResponse < 3) {
    o.nextPageToken = 'foo';
    o.serviceLevelObjectives = buildUnnamed34();
  }
  buildCounterListServiceLevelObjectivesResponse--;
  return o;
}
...
void checkListServiceLevelObjectivesResponse(
  ...
  if (buildCounterListServiceLevelObjectivesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed34(o.serviceLevelObjectives!);
  }
  buildCounterListServiceLevelObjectivesResponse--;
}

core.List<api.Service> buildUnnamed35() => [buildService(), buildService()];

void checkUnnamed35(core.List<api.Service> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkService(o[0]);
  checkService(o[1]);
}
...
void checkListServicesResponse(api.ListServicesResponse o) {
  ...
  if (buildCounterListServicesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed35(o.services!);
  }
  buildCounterListServicesResponse--;
}

core.List<api.Snooze> buildUnnamed36() => [buildSnooze(), buildSnooze()];

void checkUnnamed36(core.List<api.Snooze> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSnooze(o[0]);
  checkSnooze(o[1]);
}

core.int buildCounterListSnoozesResponse = 0;
api.ListSnoozesResponse buildListSnoozesResponse() {
  final o = api.ListSnoozesResponse();
  buildCounterListSnoozesResponse++;
  if (buildCounterListSnoozesResponse < 3) {
    o.nextPageToken = 'foo';
    o.snoozes = buildUnnamed36();
  }
  buildCounterListSnoozesResponse--;
  return o;
}

void checkListSnoozesResponse(api.ListSnoozesResponse o) {
  buildCounterListSnoozesResponse++;
  if (buildCounterListSnoozesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed36(o.snoozes!);
  }
  buildCounterListSnoozesResponse--;
}
...
core.List<api.TimeSeries> buildUnnamed38() => [
  buildTimeSeries(),
  buildTimeSeries(),
];

void checkUnnamed38(core.List<api.TimeSeries> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTimeSeries(o[0]);
  checkTimeSeries(o[1]);
}
...
api.ListTimeSeriesResponse buildListTimeSeriesResponse() {
  ...
  if (buildCounterListTimeSeriesResponse < 3) {
    o.executionErrors = buildUnnamed37();
    o.nextPageToken = 'foo';
    o.timeSeries = buildUnnamed38();
    o.unit = 'foo';
...
void checkListTimeSeriesResponse(api.ListTimeSeriesResponse o) {
  buildCounterListTimeSeriesResponse++;
  if (buildCounterListTimeSeriesResponse < 3) {
    checkUnnamed37(o.executionErrors!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed38(o.timeSeries!);
...
core.List<api.UptimeCheckConfig> buildUnnamed40() => [
  buildUptimeCheckConfig(),
  buildUptimeCheckConfig(),
];

void checkUnnamed40(core.List<api.UptimeCheckConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListUptimeCheckConfigsResponse buildListUptimeCheckConfigsResponse() {
  ...
  if (buildCounterListUptimeCheckConfigsResponse < 3) {
    o.nextPageToken = 'foo';
    o.totalSize = 42;
    o.uptimeCheckConfigs = buildUnnamed40();
  }
  buildCounterListUptimeCheckConfigsResponse--;
  return o;
}
...
void checkListUptimeCheckConfigsResponse(api.ListUptimeCheckConfigsResponse o) {
  ...
  if (buildCounterListUptimeCheckConfigsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    unittest.expect(o.totalSize!, unittest.equals(42));
    checkUnnamed40(o.uptimeCheckConfigs!);
  }
  buildCounterListUptimeCheckConfigsResponse--;
}

core.List<api.UptimeCheckIp> buildUnnamed41() => [
  buildUptimeCheckIp(),
  buildUptimeCheckIp(),
];

void checkUnnamed41(core.List<api.UptimeCheckIp> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListUptimeCheckIpsResponse buildListUptimeCheckIpsResponse() {
  ...
  if (buildCounterListUptimeCheckIpsResponse < 3) {
    o.nextPageToken = 'foo';
    o.uptimeCheckIps = buildUnnamed41();
  }
  buildCounterListUptimeCheckIpsResponse--;
  return o;
}
...
void checkListUptimeCheckIpsResponse(api.ListUptimeCheckIpsResponse o) {
  ...
  if (buildCounterListUptimeCheckIpsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed41(o.uptimeCheckIps!);
  }
  buildCounterListUptimeCheckIpsResponse--;
}
...
api.LogMatch buildLogMatch() {
  ...
  if (buildCounterLogMatch < 3) {
    o.filter = 'foo';
    o.labelExtractors = buildUnnamed42();
  }
  buildCounterLogMatch--;
  return o;
}
...
void checkLogMatch(api.LogMatch o) {
  ...
  if (buildCounterLogMatch < 3) {
    unittest.expect(o.filter!, unittest.equals('foo'));
    checkUnnamed42(o.labelExtractors!);
  }
  buildCounterLogMatch--;
}
...
core.int buildCounterLogMetadata = 0;
api.LogMetadata buildLogMetadata() {
  final o = api.LogMetadata();
  buildCounterLogMetadata++;
  if (buildCounterLogMetadata < 3) {
    o.extractedLabels = buildUnnamed43();
  }
  buildCounterLogMetadata--;
  return o;
}

void checkLogMetadata(api.LogMetadata o) {
  buildCounterLogMetadata++;
  if (buildCounterLogMetadata < 3) {
    checkUnnamed43(o.extractedLabels!);
  }
  buildCounterLogMetadata--;
}
...
core.List<api.Aggregation> buildUnnamed45() => [
  buildAggregation(),
  buildAggregation(),
];

void checkUnnamed45(core.List<api.Aggregation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.LabelDescriptor> buildUnnamed46() => [
  buildLabelDescriptor(),
  buildLabelDescriptor(),
];

void checkUnnamed46(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MetricDescriptor buildMetricDescriptor() {
  ...
  if (buildCounterMetricDescriptor < 3) {
    ...
    o.metricKind = 'foo';
    o.monitoredResourceTypes = buildUnnamed47();
    o.name = 'foo';
    o.type = 'foo';
    o.unit = 'foo';
    o.valueType = 'foo';
...
void checkMetricDescriptor(api.MetricDescriptor o) {
  ...
  if (buildCounterMetricDescriptor < 3) {
    ...
    checkUnnamed47(o.monitoredResourceTypes!);
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.type!, unittest.equals('foo'));
    unittest.expect(o.unit!, unittest.equals('foo'));
    unittest.expect(o.valueType!, unittest.equals('foo'));
...
api.MetricDescriptorMetadata buildMetricDescriptorMetadata() {
  ...
  if (buildCounterMetricDescriptorMetadata < 3) {
    ...
    o.launchStage = 'foo';
    o.samplePeriod = 'foo';
    o.timeSeriesResourceHierarchyLevel = buildUnnamed48();
  }
  buildCounterMetricDescriptorMetadata--;
  return o;
}
...
void checkMetricDescriptorMetadata(api.MetricDescriptorMetadata o) {
  ...
  if (buildCounterMetricDescriptorMetadata < 3) {
    ...
    checkUnnamed48(o.timeSeriesResourceHierarchyLevel!);
  }
  buildCounterMetricDescriptorMetadata--;
}
...
core.List<api.Aggregation> buildUnnamed49() => [
  buildAggregation(),
  buildAggregation(),
];

void checkUnnamed49(core.List<api.Aggregation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAggregation(o[0]);
  checkAggregation(o[1]);
}

core.List<api.Aggregation> buildUnnamed50() => [
  buildAggregation(),
  buildAggregation(),
];

void checkUnnamed50(core.List<api.Aggregation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAggregation(o[0]);
  checkAggregation(o[1]);
}
...
api.MetricThreshold buildMetricThreshold() {
  ...
  if (buildCounterMetricThreshold < 3) {
    o.aggregations = buildUnnamed49();
    o.comparison = 'foo';
    o.denominatorAggregations = buildUnnamed50();
    o.denominatorFilter = 'foo';
    o.duration = 'foo';
    o.evaluationMissingData = 'foo';
    o.filter = 'foo';
    o.forecastOptions = buildForecastOptions();
...
void checkMetricThreshold(api.MetricThreshold o) {
  buildCounterMetricThreshold++;
  if (buildCounterMetricThreshold < 3) {
    checkUnnamed49(o.aggregations!);
    unittest.expect(o.comparison!, unittest.equals('foo'));
    checkUnnamed50(o.denominatorAggregations!);
    unittest.expect(o.denominatorFilter!, unittest.equals('foo'));
    unittest.expect(o.duration!, unittest.equals('foo'));
    unittest.expect(o.evaluationMissingData!, unittest.equals('foo'));
    unittest.expect(o.filter!, unittest.equals('foo'));
    checkForecastOptions(o.forecastOptions!);
...
core.int buildCounterMinutes = 0;
api.Minutes buildMinutes() {
  final o = api.Minutes();
  buildCounterMinutes++;
  if (buildCounterMinutes < 3) {
    o.periodicity = 42;
  }
  buildCounterMinutes--;
  return o;
...
void checkMinutes(api.Minutes o) {
  buildCounterMinutes++;
  if (buildCounterMinutes < 3) {
    unittest.expect(o.periodicity!, unittest.equals(42));
  }
...
core.List<api.LabelDescriptor> buildUnnamed52() => [
  buildLabelDescriptor(),
  buildLabelDescriptor(),
];

void checkUnnamed52(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelDescriptor(o[0]);
  checkLabelDescriptor(o[1]);
}
...
api.MonitoredResourceMetadata buildMonitoredResourceMetadata() {
  ...
  if (buildCounterMonitoredResourceMetadata < 3) {
    o.systemLabels = buildUnnamed53();
    o.userLabels = buildUnnamed54();
  }
  buildCounterMonitoredResourceMetadata--;
  return o;
}
...
void checkMonitoredResourceMetadata(api.MonitoredResourceMetadata o) {
  buildCounterMonitoredResourceMetadata++;
  if (buildCounterMonitoredResourceMetadata < 3) {
    checkUnnamed53(o.systemLabels!);
    checkUnnamed54(o.userLabels!);
  }
  buildCounterMonitoredResourceMetadata--;
}
...
core.List<api.MutationRecord> buildUnnamed56() => [
  buildMutationRecord(),
  buildMutationRecord(),
];

void checkUnnamed56(core.List<api.MutationRecord> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.NotificationChannel buildNotificationChannel() {
  ...
  if (buildCounterNotificationChannel < 3) {
    ...
    o.mutationRecords = buildUnnamed56();
    o.name = 'foo';
    o.type = 'foo';
...
void checkNotificationChannel(api.NotificationChannel o) {
  ...
  if (buildCounterNotificationChannel < 3) {
    ...
    checkUnnamed56(o.mutationRecords!);
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.type!, unittest.equals('foo'));
...
api.NotificationChannelDescriptor buildNotificationChannelDescriptor() {
  ...
  if (buildCounterNotificationChannelDescriptor < 3) {
    ...
    o.launchStage = 'foo';
    o.name = 'foo';
    o.supportedTiers = buildUnnamed59();
    o.type = 'foo';
  }
  buildCounterNotificationChannelDescriptor--;
  return o;
...
void checkNotificationChannelDescriptor(api.NotificationChannelDescriptor o) {
  ...
  if (buildCounterNotificationChannelDescriptor < 3) {
    ...
    unittest.expect(o.launchStage!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed59(o.supportedTiers!);
    unittest.expect(o.type!, unittest.equals('foo'));
  }
  buildCounterNotificationChannelDescriptor--;
}
...
core.int buildCounterNotificationChannelStrategy = 0;
api.NotificationChannelStrategy buildNotificationChannelStrategy() {
  final o = api.NotificationChannelStrategy();
  buildCounterNotificationChannelStrategy++;
  if (buildCounterNotificationChannelStrategy < 3) {
    o.notificationChannelNames = buildUnnamed60();
    o.renotifyInterval = 'foo';
  }
  buildCounterNotificationChannelStrategy--;
  return o;
}

void checkNotificationChannelStrategy(api.NotificationChannelStrategy o) {
  buildCounterNotificationChannelStrategy++;
  if (buildCounterNotificationChannelStrategy < 3) {
    checkUnnamed60(o.notificationChannelNames!);
    unittest.expect(o.renotifyInterval!, unittest.equals('foo'));
  }
  buildCounterNotificationChannelStrategy--;
}
...
void checkPingConfig(api.PingConfig o) {
  buildCounterPingConfig++;
  if (buildCounterPingConfig < 3) {
    unittest.expect(o.pingsCount!, unittest.equals(42));
  }
  buildCounterPingConfig--;
}
...
core.List<api.TypedValue> buildUnnamed61() => [
  buildTypedValue(),
  buildTypedValue(),
];

void checkUnnamed61(core.List<api.TypedValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTypedValue(o[0]);
  checkTypedValue(o[1]);
}
...
core.int buildCounterPolicySnapshot = 0;
api.PolicySnapshot buildPolicySnapshot() {
  final o = api.PolicySnapshot();
  buildCounterPolicySnapshot++;
  if (buildCounterPolicySnapshot < 3) {
    o.displayName = 'foo';
    o.name = 'foo';
    o.severity = 'foo';
...
void checkPolicySnapshot(api.PolicySnapshot o) {
  buildCounterPolicySnapshot++;
  if (buildCounterPolicySnapshot < 3) {
    unittest.expect(o.displayName!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
...
core.int buildCounterPrometheusQueryLanguageCondition = 0;
api.PrometheusQueryLanguageCondition buildPrometheusQueryLanguageCondition() {
  final o = api.PrometheusQueryLanguageCondition();
...
void checkPrometheusQueryLanguageCondition(
  api.PrometheusQueryLanguageCondition o,
) {
  buildCounterPrometheusQueryLanguageCondition++;
  if (buildCounterPrometheusQueryLanguageCondition < 3) {
    unittest.expect(o.alertRule!, unittest.equals('foo'));
    unittest.expect(o.disableMetricValidation!, unittest.isTrue);
    unittest.expect(o.duration!, unittest.equals('foo'));
    unittest.expect(o.evaluationInterval!, unittest.equals('foo'));
    checkUnnamed63(o.labels!);
    unittest.expect(o.query!, unittest.equals('foo'));
    unittest.expect(o.ruleGroup!, unittest.equals('foo'));
  }
  buildCounterPrometheusQueryLanguageCondition--;
}
...
core.List<api.Status> buildUnnamed64() => [buildStatus(), buildStatus()];

void checkUnnamed64(core.List<api.Status> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatus(o[0]);
  checkStatus(o[1]);
}

core.List<api.TimeSeriesData> buildUnnamed65() => [
  buildTimeSeriesData(),
  buildTimeSeriesData(),
];

void checkUnnamed65(core.List<api.TimeSeriesData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.QueryTimeSeriesResponse buildQueryTimeSeriesResponse() {
  ...
  if (buildCounterQueryTimeSeriesResponse < 3) {
    o.nextPageToken = 'foo';
    o.partialErrors = buildUnnamed64();
    o.timeSeriesData = buildUnnamed65();
...
void checkQueryTimeSeriesResponse(api.QueryTimeSeriesResponse o) {
  ...
  if (buildCounterQueryTimeSeriesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed64(o.partialErrors!);
    checkUnnamed65(o.timeSeriesData!);
...
core.int buildCounterResponseStatusCode = 0;
api.ResponseStatusCode buildResponseStatusCode() {
  final o = api.ResponseStatusCode();
  buildCounterResponseStatusCode++;
  if (buildCounterResponseStatusCode < 3) {
    o.statusClass = 'foo';
    o.statusValue = 42;
  }
  buildCounterResponseStatusCode--;
...
void checkResponseStatusCode(api.ResponseStatusCode o) {
  buildCounterResponseStatusCode++;
  if (buildCounterResponseStatusCode < 3) {
    unittest.expect(o.statusClass!, unittest.equals('foo'));
    unittest.expect(o.statusValue!, unittest.equals(42));
  }
  buildCounterResponseStatusCode--;
}

core.int buildCounterRowCountTest = 0;
api.RowCountTest buildRowCountTest() {
  final o = api.RowCountTest();
  buildCounterRowCountTest++;
  if (buildCounterRowCountTest < 3) {
    o.comparison = 'foo';
    o.threshold = 'foo';
  }
  buildCounterRowCountTest--;
...
void checkRowCountTest(api.RowCountTest o) {
  buildCounterRowCountTest++;
  if (buildCounterRowCountTest < 3) {
    unittest.expect(o.comparison!, unittest.equals('foo'));
    unittest.expect(o.threshold!, unittest.equals('foo'));
...
api.Service buildService() {
  ...
  if (buildCounterService < 3) {
    ...
    o.basicService = buildBasicService();
...
void checkService(api.Service o) {
  ...
  if (buildCounterService < 3) {
    ...
    checkBasicService(o.basicService!);
...
void checkServiceLevelObjective(api.ServiceLevelObjective o) {
  ...
  if (buildCounterServiceLevelObjective < 3) {
    ...
    checkUnnamed67(o.userLabels!);
  }
  buildCounterServiceLevelObjective--;
}

core.int buildCounterSnooze = 0;
api.Snooze buildSnooze() {
  final o = api.Snooze();
  buildCounterSnooze++;
  if (buildCounterSnooze < 3) {
    o.criteria = buildCriteria();
    o.displayName = 'foo';
    o.interval = buildTimeInterval();
    o.name = 'foo';
  }
...
void checkSnooze(api.Snooze o) {
  buildCounterSnooze++;
  if (buildCounterSnooze < 3) {
    checkCriteria(o.criteria!);
    unittest.expect(o.displayName!, unittest.equals('foo'));
    checkTimeInterval(o.interval!);
    unittest.expect(o.name!, unittest.equals('foo'));
  }
...
core.int buildCounterSqlCondition = 0;
api.SqlCondition buildSqlCondition() {
  final o = api.SqlCondition();
  buildCounterSqlCondition++;
  if (buildCounterSqlCondition < 3) {
    o.booleanTest = buildBooleanTest();
    o.daily = buildDaily();
    o.hourly = buildHourly();
    o.minutes = buildMinutes();
    o.query = 'foo';
    o.rowCountTest = buildRowCountTest();
  }
  buildCounterSqlCondition--;
  return o;
}

void checkSqlCondition(api.SqlCondition o) {
  buildCounterSqlCondition++;
  if (buildCounterSqlCondition < 3) {
    checkBooleanTest(o.booleanTest!);
    checkDaily(o.daily!);
    checkHourly(o.hourly!);
    checkMinutes(o.minutes!);
    unittest.expect(o.query!, unittest.equals('foo'));
    checkRowCountTest(o.rowCountTest!);
  }
  buildCounterSqlCondition--;
}
...
core.List<api.Point> buildUnnamed70() => [buildPoint(), buildPoint()];
...
core.List<api.LabelValue> buildUnnamed71() => [
  buildLabelValue(),
  buildLabelValue(),
];

void checkUnnamed71(core.List<api.LabelValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelValue(o[0]);
  checkLabelValue(o[1]);
}

core.List<api.PointData> buildUnnamed72() => [
  buildPointData(),
  buildPointData(),
];

void checkUnnamed72(core.List<api.PointData> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPointData(o[0]);
  checkPointData(o[1]);
}
...
api.TimeSeriesData buildTimeSeriesData() {
  ...
  if (buildCounterTimeSeriesData < 3) {
    o.labelValues = buildUnnamed71();
    o.pointData = buildUnnamed72();
  }
  buildCounterTimeSeriesData--;
  return o;
}
...
void checkTimeSeriesData(api.TimeSeriesData o) {
  buildCounterTimeSeriesData++;
  if (buildCounterTimeSeriesData < 3) {
    checkUnnamed71(o.labelValues!);
    checkUnnamed72(o.pointData!);
  }
  buildCounterTimeSeriesData--;
}

core.List<api.LabelDescriptor> buildUnnamed73() => [
  buildLabelDescriptor(),
  buildLabelDescriptor(),
];

void checkUnnamed73(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelDescriptor(o[0]);
  checkLabelDescriptor(o[1]);
}

core.List<api.ValueDescriptor> buildUnnamed74() => [
  buildValueDescriptor(),
  buildValueDescriptor(),
];

void checkUnnamed74(core.List<api.ValueDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TimeSeriesDescriptor buildTimeSeriesDescriptor() {
  ...
  if (buildCounterTimeSeriesDescriptor < 3) {
    o.labelDescriptors = buildUnnamed73();
    o.pointDescriptors = buildUnnamed74();
  }
  buildCounterTimeSeriesDescriptor--;
  return o;
}
...
void checkTimeSeriesDescriptor(api.TimeSeriesDescriptor o) {
  buildCounterTimeSeriesDescriptor++;
  if (buildCounterTimeSeriesDescriptor < 3) {
    checkUnnamed73(o.labelDescriptors!);
    checkUnnamed74(o.pointDescriptors!);
  }
  buildCounterTimeSeriesDescriptor--;
}
...
core.List<api.ContentMatcher> buildUnnamed75() => [
  buildContentMatcher(),
  buildContentMatcher(),
];

void checkUnnamed75(core.List<api.ContentMatcher> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContentMatcher(o[0]);
  checkContentMatcher(o[1]);
}

core.List<api.InternalChecker> buildUnnamed76() => [
  buildInternalChecker(),
  buildInternalChecker(),
];

void checkUnnamed76(core.List<api.InternalChecker> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.UptimeCheckConfig buildUptimeCheckConfig() {
  ...
  if (buildCounterUptimeCheckConfig < 3) {
    o.checkerType = 'foo';
    o.contentMatchers = buildUnnamed75();
    o.disabled = true;
    o.displayName = 'foo';
    o.httpCheck = buildHttpCheck();
    o.internalCheckers = buildUnnamed76();
    o.isInternal = true;
...
void checkUptimeCheckConfig(api.UptimeCheckConfig o) {
  buildCounterUptimeCheckConfig++;
  if (buildCounterUptimeCheckConfig < 3) {
    unittest.expect(o.checkerType!, unittest.equals('foo'));
    checkUnnamed75(o.contentMatchers!);
    unittest.expect(o.disabled!, unittest.isTrue);
    unittest.expect(o.displayName!, unittest.equals('foo'));
    checkHttpCheck(o.httpCheck!);
    checkUnnamed76(o.internalCheckers!);
...
void main() {
  ...
  unittest.group('obj-schema-AppEngine', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.AppEngine.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkAppEngine(od);
    });
  ...
  unittest.group('obj-schema-BasicService', () {
    unittest.test('to-json--from-json', () async {
      final o = buildBasicService();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.BasicService.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkBasicService(od);
    });
  });
  ...
  unittest.group('obj-schema-BasicSli', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.BasicSli.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkBasicSli(od);
    });
  ...
  unittest.group('obj-schema-BooleanTest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildBooleanTest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.BooleanTest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkBooleanTest(od);
    });
  ...
  unittest.group('obj-schema-Criteria', () {
    unittest.test('to-json--from-json', () async {
      final o = buildCriteria();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Criteria.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkCriteria(od);
    });
  ...
  unittest.group('obj-schema-Daily', () {
    unittest.test('to-json--from-json', () async {
      final o = buildDaily();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Daily.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkDaily(od);
    });
  ...
  unittest.group('obj-schema-Exemplar', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Exemplar.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkExemplar(od);
    });
  ...
  unittest.group('obj-schema-Explicit', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Explicit.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkExplicit(od);
    });
  ...
  unittest.group('obj-schema-ForecastOptions', () {
    unittest.test('to-json--from-json', () async {
      final o = buildForecastOptions();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ForecastOptions.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkForecastOptions(od);
    });
  });

  unittest.group(
    'obj-schema-GetNotificationChannelVerificationCodeRequest',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group(
    'obj-schema-GetNotificationChannelVerificationCodeResponse',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group('obj-schema-GkeService', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GkeService.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGkeService(od);
    });
  ...
  unittest.group('obj-schema-Hourly', () {
    unittest.test('to-json--from-json', () async {
      final o = buildHourly();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Hourly.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkHourly(od);
    });
  ...
  unittest.group('obj-schema-HttpCheck', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.HttpCheck.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkHttpCheck(od);
    });
  ...
  unittest.group('obj-schema-ListSnoozesResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildListSnoozesResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListSnoozesResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkListSnoozesResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-LogMatch', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.LogMatch.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkLogMatch(od);
    });
  ...
  unittest.group('obj-schema-LogMetadata', () {
    unittest.test('to-json--from-json', () async {
      final o = buildLogMetadata();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.LogMetadata.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkLogMetadata(od);
    });
  ...
  unittest.group('obj-schema-MeshIstio', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.MeshIstio.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkMeshIstio(od);
    });
  ...
  unittest.group('obj-schema-Minutes', () {
    unittest.test('to-json--from-json', () async {
      final o = buildMinutes();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Minutes.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkMinutes(od);
    });
  ...
  unittest.group('obj-schema-NotificationChannelStrategy', () {
    unittest.test('to-json--from-json', () async {
      final o = buildNotificationChannelStrategy();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.NotificationChannelStrategy.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkNotificationChannelStrategy(od);
    });
  });
  ...
  unittest.group('obj-schema-PingConfig', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.PingConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPingConfig(od);
    });
  ...
  unittest.group('obj-schema-PointData', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.PointData.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPointData(od);
    });
  ...
  unittest.group('obj-schema-PolicySnapshot', () {
    unittest.test('to-json--from-json', () async {
      final o = buildPolicySnapshot();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.PolicySnapshot.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPolicySnapshot(od);
    });
  });

  unittest.group('obj-schema-PrometheusQueryLanguageCondition', () {
    unittest.test('to-json--from-json', () async {
      final o = buildPrometheusQueryLanguageCondition();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.PrometheusQueryLanguageCondition.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPrometheusQueryLanguageCondition(od);
    });
  });
  ...
  unittest.group('obj-schema-ResponseStatusCode', () {
    unittest.test('to-json--from-json', () async {
      final o = buildResponseStatusCode();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ResponseStatusCode.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkResponseStatusCode(od);
    });
  });

  unittest.group('obj-schema-RowCountTest', () {
    unittest.test('to-json--from-json', () async {
      final o = buildRowCountTest();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.RowCountTest.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkRowCountTest(od);
    });
  });

  unittest.group(
    'obj-schema-SendNotificationChannelVerificationCodeRequest',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group('obj-schema-Snooze', () {
    unittest.test('to-json--from-json', () async {
      final o = buildSnooze();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Snooze.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkSnooze(od);
    });
  ...
  unittest.group('obj-schema-SqlCondition', () {
    unittest.test('to-json--from-json', () async {
      final o = buildSqlCondition();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.SqlCondition.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkSqlCondition(od);
    });
  });
  ...
  unittest.group('obj-schema-TcpCheck', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.TcpCheck.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkTcpCheck(od);
    });
  ...
  unittest.group('obj-schema-Telemetry', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Telemetry.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkTelemetry(od);
    });
  ...
  unittest.group('obj-schema-TypedValue', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.TypedValue.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkTypedValue(od);
    });
  ...
  unittest.group('resource-FoldersTimeSeriesResource', () {
    unittest.test('method--list', () async {
      ...
      final arg_aggregation_groupByFields = buildUnnamed79();
      ...
      final arg_secondaryAggregation_groupByFields = buildUnnamed80();
  ...
  unittest.group('resource-OrganizationsTimeSeriesResource', () {
    unittest.test('method--list', () async {
      ...
      final arg_aggregation_alignmentPeriod = 'foo';
      final arg_aggregation_crossSeriesReducer = 'foo';
      final arg_aggregation_groupByFields = buildUnnamed81();
      final arg_aggregation_perSeriesAligner = 'foo';
      final arg_filter = 'foo';
      final arg_interval_endTime = 'foo';
      final arg_interval_startTime = 'foo';
      ...
      final arg_secondaryAggregation_alignmentPeriod = 'foo';
      final arg_secondaryAggregation_crossSeriesReducer = 'foo';
      final arg_secondaryAggregation_groupByFields = buildUnnamed82();
      final arg_secondaryAggregation_perSeriesAligner = 'foo';
      final arg_view = 'foo';
      final arg_$fields = 'foo';
      mock.register(
  ...
  unittest.group('resource-ProjectsAlertsResource', () {
    unittest.test('method--get', () async {
      final mock = HttpServerMock();
      final res = api.MonitoringApi(mock).projects.alerts;
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
  ...
  unittest.group('resource-ProjectsNotificationChannelsResource', () {
    ...
    unittest.test('method--getVerificationCode', () async {
      ...
      final response = await res.getVerificationCode(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-ProjectsSnoozesResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.MonitoringApi(mock).projects.snoozes;
      final arg_request = buildSnooze();
      final arg_parent = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.Snooze.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkSnooze(obj);
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildSnooze());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      ...
      checkSnooze(response as api.Snooze);
    });
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildListSnoozesResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      ...
      checkListSnoozesResponse(response as api.ListSnoozesResponse);
    });
  ...
  unittest.group('resource-ProjectsTimeSeriesResource', () {
    ...
    unittest.test('method--createService', () async {
      ...
      final response = await res.createService(
        arg_request,
        arg_name,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--list', () async {
      ...
      final arg_aggregation_alignmentPeriod = 'foo';
      final arg_aggregation_crossSeriesReducer = 'foo';
      final arg_aggregation_groupByFields = buildUnnamed83();
      final arg_aggregation_perSeriesAligner = 'foo';
      final arg_filter = 'foo';
      final arg_interval_endTime = 'foo';
      final arg_interval_startTime = 'foo';
      ...
      final arg_secondaryAggregation_alignmentPeriod = 'foo';
      final arg_secondaryAggregation_crossSeriesReducer = 'foo';
      final arg_secondaryAggregation_groupByFields = buildUnnamed84();
      final arg_secondaryAggregation_perSeriesAligner = 'foo';
      final arg_view = 'foo';
      final arg_$fields = 'foo';
      mock.register(
