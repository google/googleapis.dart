...
api.Aggregation buildAggregation() {
  ...
  if (buildCounterAggregation < 3) {
    ...
    o.groupByFields = buildUnnamed5241();
...
void checkAggregation(api.Aggregation o) {
  ...
  if (buildCounterAggregation < 3) {
    ...
    checkUnnamed5241(o.groupByFields!);
    unittest.expect(
      o.perSeriesAligner!,
      unittest.equals('foo'),
    );
...
core.List<api.Condition> buildUnnamed5242() => [
      buildCondition(),
      buildCondition(),
    ];

void checkUnnamed5242(core.List<api.Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCondition(o[0]);
  checkCondition(o[1]);
}
...
api.AlertPolicy buildAlertPolicy() {
  ...
  if (buildCounterAlertPolicy < 3) {
    ...
    o.name = 'foo';
    o.notificationChannels = buildUnnamed5243();
    o.userLabels = buildUnnamed5244();
...
void checkAlertPolicy(api.AlertPolicy o) {
  ...
  if (buildCounterAlertPolicy < 3) {
    ...
    checkUnnamed5243(o.notificationChannels!);
    checkUnnamed5244(o.userLabels!);
...
api.BasicSli buildBasicSli() {
  ...
  if (buildCounterBasicSli < 3) {
    ...
    o.location = buildUnnamed5245();
    o.method = buildUnnamed5246();
    o.version = buildUnnamed5247();
  }
  buildCounterBasicSli--;
  return o;
}
...
void checkBasicSli(api.BasicSli o) {
  ...
  if (buildCounterBasicSli < 3) {
    ...
    checkUnnamed5245(o.location!);
    checkUnnamed5246(o.method!);
    checkUnnamed5247(o.version!);
  }
  buildCounterBasicSli--;
}
...
core.Map<core.String, api.TypedValue> buildUnnamed5248() => {
      'x': buildTypedValue(),
      'y': buildTypedValue(),
    };

void checkUnnamed5248(core.Map<core.String, api.TypedValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTypedValue(o['x']!);
  checkTypedValue(o['y']!);
}

core.List<api.CollectdValue> buildUnnamed5249() => [
      buildCollectdValue(),
      buildCollectdValue(),
    ];

void checkUnnamed5249(core.List<api.CollectdValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.CollectdPayload buildCollectdPayload() {
  ...
  if (buildCounterCollectdPayload < 3) {
    o.endTime = 'foo';
    o.metadata = buildUnnamed5248();
    o.plugin = 'foo';
    o.pluginInstance = 'foo';
    o.startTime = 'foo';
    o.type = 'foo';
    o.typeInstance = 'foo';
    o.values = buildUnnamed5249();
  }
  buildCounterCollectdPayload--;
  return o;
}
...
void checkCollectdPayload(api.CollectdPayload o) {
  ...
  if (buildCounterCollectdPayload < 3) {
    ...
    checkUnnamed5249(o.values!);
  }
  buildCounterCollectdPayload--;
}

core.List<api.CollectdValueError> buildUnnamed5250() => [
      buildCollectdValueError(),
      buildCollectdValueError(),
    ];

void checkUnnamed5250(core.List<api.CollectdValueError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.CollectdPayloadError buildCollectdPayloadError() {
  ...
  if (buildCounterCollectdPayloadError < 3) {
    o.error = buildStatus();
    o.index = 42;
    o.valueErrors = buildUnnamed5250();
  }
  buildCounterCollectdPayloadError--;
  return o;
}
...
void checkCollectdPayloadError(api.CollectdPayloadError o) {
  ...
  if (buildCounterCollectdPayloadError < 3) {
    ...
    checkUnnamed5250(o.valueErrors!);
  }
  buildCounterCollectdPayloadError--;
}
...
core.List<api.CollectdPayload> buildUnnamed5251() => [
      buildCollectdPayload(),
      buildCollectdPayload(),
    ];

void checkUnnamed5251(core.List<api.CollectdPayload> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.CreateCollectdTimeSeriesRequest buildCreateCollectdTimeSeriesRequest() {
  ...
  if (buildCounterCreateCollectdTimeSeriesRequest < 3) {
    o.collectdPayloads = buildUnnamed5251();
...
void checkCreateCollectdTimeSeriesRequest(
  ...
  buildCounterCreateCollectdTimeSeriesRequest++;
  if (buildCounterCreateCollectdTimeSeriesRequest < 3) {
    checkUnnamed5251(o.collectdPayloads!);
    unittest.expect(
      o.collectdVersion!,
      unittest.equals('foo'),
    );
...
core.List<api.CollectdPayloadError> buildUnnamed5252() => [
      buildCollectdPayloadError(),
      buildCollectdPayloadError(),
    ];

void checkUnnamed5252(core.List<api.CollectdPayloadError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.CreateCollectdTimeSeriesResponse buildCreateCollectdTimeSeriesResponse() {
  ...
  if (buildCounterCreateCollectdTimeSeriesResponse < 3) {
    o.payloadErrors = buildUnnamed5252();
...
void checkCreateCollectdTimeSeriesResponse(
  ...
  buildCounterCreateCollectdTimeSeriesResponse++;
  if (buildCounterCreateCollectdTimeSeriesResponse < 3) {
    checkUnnamed5252(o.payloadErrors!);
    checkCreateTimeSeriesSummary(o.summary!);
  }
  buildCounterCreateCollectdTimeSeriesResponse--;
}

core.List<api.TimeSeries> buildUnnamed5253() => [
      buildTimeSeries(),
      buildTimeSeries(),
    ];

void checkUnnamed5253(core.List<api.TimeSeries> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTimeSeries(o[0]);
  checkTimeSeries(o[1]);
}
...
void checkCreateTimeSeriesRequest(api.CreateTimeSeriesRequest o) {
  buildCounterCreateTimeSeriesRequest++;
  if (buildCounterCreateTimeSeriesRequest < 3) {
    checkUnnamed5253(o.timeSeries!);
  }
  buildCounterCreateTimeSeriesRequest--;
}

core.List<api.Error> buildUnnamed5254() => [
      buildError(),
      buildError(),
    ];

void checkUnnamed5254(core.List<api.Error> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkError(o[0]);
  checkError(o[1]);
}
...
core.List<api.Exemplar> buildUnnamed5256() => [
      buildExemplar(),
      buildExemplar(),
    ];

void checkUnnamed5256(core.List<api.Exemplar> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkExemplar(o[0]);
  checkExemplar(o[1]);
}
...
api.Distribution buildDistribution() {
  ...
  if (buildCounterDistribution < 3) {
    o.bucketCounts = buildUnnamed5255();
    o.bucketOptions = buildBucketOptions();
    o.count = 'foo';
    o.exemplars = buildUnnamed5256();
    o.mean = 42.0;
    o.range = buildRange();
...
void checkDistribution(api.Distribution o) {
  buildCounterDistribution++;
  if (buildCounterDistribution < 3) {
    checkUnnamed5255(o.bucketCounts!);
    checkBucketOptions(o.bucketOptions!);
    unittest.expect(
      o.count!,
      unittest.equals('foo'),
    );
    checkUnnamed5256(o.exemplars!);
    unittest.expect(
      o.mean!,
...
core.Map<core.String, core.String> buildUnnamed5257() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed5257(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.Map<core.String, core.Object> buildUnnamed5258() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed5258(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed5259() => [
      buildUnnamed5258(),
      buildUnnamed5258(),
    ];

void checkUnnamed5259(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed5258(o[0]);
  checkUnnamed5258(o[1]);
}
...
api.Exemplar buildExemplar() {
  ...
  if (buildCounterExemplar < 3) {
    o.attachments = buildUnnamed5259();
    o.timestamp = 'foo';
    o.value = 42.0;
  }
  buildCounterExemplar--;
...
void checkExemplar(api.Exemplar o) {
  buildCounterExemplar++;
  if (buildCounterExemplar < 3) {
    checkUnnamed5259(o.attachments!);
    unittest.expect(
      o.timestamp!,
      unittest.equals('foo'),
    );
...
core.List<core.double> buildUnnamed5260() => [
      42.0,
      42.0,
    ];

void checkUnnamed5260(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals(42.0),
...
core.List<api.Option> buildUnnamed5261() => [
      buildOption(),
      buildOption(),
    ];

void checkUnnamed5261(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
core.Map<core.String, core.String> buildUnnamed5262() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed5262(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.AlertPolicy> buildUnnamed5263() => [
      buildAlertPolicy(),
      buildAlertPolicy(),
    ];

void checkUnnamed5263(core.List<api.AlertPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListAlertPoliciesResponse buildListAlertPoliciesResponse() {
  ...
  if (buildCounterListAlertPoliciesResponse < 3) {
    o.alertPolicies = buildUnnamed5263();
    o.nextPageToken = 'foo';
    o.totalSize = 42;
  }
  buildCounterListAlertPoliciesResponse--;
...
void checkListAlertPoliciesResponse(api.ListAlertPoliciesResponse o) {
  buildCounterListAlertPoliciesResponse++;
  if (buildCounterListAlertPoliciesResponse < 3) {
    checkUnnamed5263(o.alertPolicies!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.MonitoredResource> buildUnnamed5264() => [
      buildMonitoredResource(),
      buildMonitoredResource(),
    ];

void checkUnnamed5264(core.List<api.MonitoredResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Group> buildUnnamed5265() => [
      buildGroup(),
      buildGroup(),
    ];

void checkUnnamed5265(core.List<api.Group> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGroup(o[0]);
  checkGroup(o[1]);
}
...
core.List<api.MetricDescriptor> buildUnnamed5266() => [
      buildMetricDescriptor(),
      buildMetricDescriptor(),
    ];

void checkUnnamed5266(core.List<api.MetricDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListMetricDescriptorsResponse buildListMetricDescriptorsResponse() {
  ...
  if (buildCounterListMetricDescriptorsResponse < 3) {
    o.metricDescriptors = buildUnnamed5266();
    o.nextPageToken = 'foo';
  }
  buildCounterListMetricDescriptorsResponse--;
  return o;
...
void checkListMetricDescriptorsResponse(api.ListMetricDescriptorsResponse o) {
  buildCounterListMetricDescriptorsResponse++;
  if (buildCounterListMetricDescriptorsResponse < 3) {
    checkUnnamed5266(o.metricDescriptors!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.MonitoredResourceDescriptor> buildUnnamed5267() => [
      buildMonitoredResourceDescriptor(),
      buildMonitoredResourceDescriptor(),
    ];

void checkUnnamed5267(core.List<api.MonitoredResourceDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListMonitoredResourceDescriptorsResponse
  ...
  if (buildCounterListMonitoredResourceDescriptorsResponse < 3) {
    o.nextPageToken = 'foo';
    o.resourceDescriptors = buildUnnamed5267();
  }
  buildCounterListMonitoredResourceDescriptorsResponse--;
  return o;
}
...
void checkListMonitoredResourceDescriptorsResponse(
  ...
  if (buildCounterListMonitoredResourceDescriptorsResponse < 3) {
    ...
    checkUnnamed5267(o.resourceDescriptors!);
  }
  buildCounterListMonitoredResourceDescriptorsResponse--;
}

core.List<api.NotificationChannelDescriptor> buildUnnamed5268() => [
      buildNotificationChannelDescriptor(),
      buildNotificationChannelDescriptor(),
    ];

void checkUnnamed5268(core.List<api.NotificationChannelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListNotificationChannelDescriptorsResponse
  ...
  if (buildCounterListNotificationChannelDescriptorsResponse < 3) {
    o.channelDescriptors = buildUnnamed5268();
    o.nextPageToken = 'foo';
  }
  buildCounterListNotificationChannelDescriptorsResponse--;
  return o;
...
void checkListNotificationChannelDescriptorsResponse(
  ...
  buildCounterListNotificationChannelDescriptorsResponse++;
  if (buildCounterListNotificationChannelDescriptorsResponse < 3) {
    checkUnnamed5268(o.channelDescriptors!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.NotificationChannel> buildUnnamed5269() => [
      buildNotificationChannel(),
      buildNotificationChannel(),
    ];

void checkUnnamed5269(core.List<api.NotificationChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListNotificationChannelsResponse buildListNotificationChannelsResponse() {
  ...
  if (buildCounterListNotificationChannelsResponse < 3) {
    o.nextPageToken = 'foo';
    o.notificationChannels = buildUnnamed5269();
    o.totalSize = 42;
  }
  buildCounterListNotificationChannelsResponse--;
  return o;
...
void checkListNotificationChannelsResponse(
  ...
  if (buildCounterListNotificationChannelsResponse < 3) {
    ...
    checkUnnamed5269(o.notificationChannels!);
    unittest.expect(
      o.totalSize!,
      unittest.equals(42),
    );
...
core.List<api.ServiceLevelObjective> buildUnnamed5270() => [
      buildServiceLevelObjective(),
      buildServiceLevelObjective(),
    ];

void checkUnnamed5270(core.List<api.ServiceLevelObjective> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListServiceLevelObjectivesResponse
  ...
  if (buildCounterListServiceLevelObjectivesResponse < 3) {
    o.nextPageToken = 'foo';
    o.serviceLevelObjectives = buildUnnamed5270();
  }
  buildCounterListServiceLevelObjectivesResponse--;
  return o;
}
...
void checkListServiceLevelObjectivesResponse(
  ...
  if (buildCounterListServiceLevelObjectivesResponse < 3) {
    ...
    checkUnnamed5270(o.serviceLevelObjectives!);
  }
  buildCounterListServiceLevelObjectivesResponse--;
}

core.List<api.Service> buildUnnamed5271() => [
      buildService(),
      buildService(),
    ];

void checkUnnamed5271(core.List<api.Service> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkService(o[0]);
  checkService(o[1]);
}
...
void checkListServicesResponse(api.ListServicesResponse o) {
  ...
  if (buildCounterListServicesResponse < 3) {
    ...
    checkUnnamed5271(o.services!);
  }
  buildCounterListServicesResponse--;
}

core.List<api.Status> buildUnnamed5272() => [
      buildStatus(),
      buildStatus(),
    ];

void checkUnnamed5272(core.List<api.Status> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatus(o[0]);
  checkStatus(o[1]);
}

core.List<api.TimeSeries> buildUnnamed5273() => [
      buildTimeSeries(),
      buildTimeSeries(),
    ];

void checkUnnamed5273(core.List<api.TimeSeries> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTimeSeries(o[0]);
  checkTimeSeries(o[1]);
}
...
api.ListTimeSeriesResponse buildListTimeSeriesResponse() {
  ...
  if (buildCounterListTimeSeriesResponse < 3) {
    o.executionErrors = buildUnnamed5272();
    o.nextPageToken = 'foo';
    o.timeSeries = buildUnnamed5273();
    o.unit = 'foo';
  }
  buildCounterListTimeSeriesResponse--;
  return o;
...
void checkListTimeSeriesResponse(api.ListTimeSeriesResponse o) {
  buildCounterListTimeSeriesResponse++;
  if (buildCounterListTimeSeriesResponse < 3) {
    checkUnnamed5272(o.executionErrors!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
    checkUnnamed5273(o.timeSeries!);
    unittest.expect(
      o.unit!,
      unittest.equals('foo'),
    );
...
core.List<api.UptimeCheckConfig> buildUnnamed5274() => [
      buildUptimeCheckConfig(),
      buildUptimeCheckConfig(),
    ];

void checkUnnamed5274(core.List<api.UptimeCheckConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListUptimeCheckConfigsResponse buildListUptimeCheckConfigsResponse() {
  ...
  if (buildCounterListUptimeCheckConfigsResponse < 3) {
    o.nextPageToken = 'foo';
    o.totalSize = 42;
    o.uptimeCheckConfigs = buildUnnamed5274();
  }
  buildCounterListUptimeCheckConfigsResponse--;
  return o;
}
...
void checkListUptimeCheckConfigsResponse(api.ListUptimeCheckConfigsResponse o) {
  ...
  if (buildCounterListUptimeCheckConfigsResponse < 3) {
    ...
    checkUnnamed5274(o.uptimeCheckConfigs!);
  }
  buildCounterListUptimeCheckConfigsResponse--;
}

core.List<api.UptimeCheckIp> buildUnnamed5275() => [
      buildUptimeCheckIp(),
      buildUptimeCheckIp(),
    ];

void checkUnnamed5275(core.List<api.UptimeCheckIp> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListUptimeCheckIpsResponse buildListUptimeCheckIpsResponse() {
  ...
  if (buildCounterListUptimeCheckIpsResponse < 3) {
    o.nextPageToken = 'foo';
    o.uptimeCheckIps = buildUnnamed5275();
  }
  buildCounterListUptimeCheckIpsResponse--;
  return o;
}
...
void checkListUptimeCheckIpsResponse(api.ListUptimeCheckIpsResponse o) {
  ...
  if (buildCounterListUptimeCheckIpsResponse < 3) {
    ...
    checkUnnamed5275(o.uptimeCheckIps!);
  }
  buildCounterListUptimeCheckIpsResponse--;
}

core.Map<core.String, core.String> buildUnnamed5276() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed5276(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.LogMatch buildLogMatch() {
  ...
  if (buildCounterLogMatch < 3) {
    o.filter = 'foo';
    o.labelExtractors = buildUnnamed5276();
  }
  buildCounterLogMatch--;
  return o;
}
...
void checkLogMatch(api.LogMatch o) {
  ...
  if (buildCounterLogMatch < 3) {
    ...
    checkUnnamed5276(o.labelExtractors!);
  }
  buildCounterLogMatch--;
}
...
core.List<api.Aggregation> buildUnnamed5278() => [
      buildAggregation(),
      buildAggregation(),
    ];

void checkUnnamed5278(core.List<api.Aggregation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MetricAbsence buildMetricAbsence() {
  ...
  if (buildCounterMetricAbsence < 3) {
    o.aggregations = buildUnnamed5278();
    o.duration = 'foo';
    o.filter = 'foo';
...
void checkMetricAbsence(api.MetricAbsence o) {
  buildCounterMetricAbsence++;
  if (buildCounterMetricAbsence < 3) {
    checkUnnamed5278(o.aggregations!);
    unittest.expect(
      o.duration!,
      unittest.equals('foo'),
    );
...
core.List<api.LabelDescriptor> buildUnnamed5279() => [
      buildLabelDescriptor(),
      buildLabelDescriptor(),
    ];

void checkUnnamed5279(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MetricDescriptor buildMetricDescriptor() {
  ...
  if (buildCounterMetricDescriptor < 3) {
    ...
    o.metricKind = 'foo';
    o.monitoredResourceTypes = buildUnnamed5280();
    o.name = 'foo';
    o.type = 'foo';
    o.unit = 'foo';
    o.valueType = 'foo';
...
void checkMetricDescriptor(api.MetricDescriptor o) {
  ...
  if (buildCounterMetricDescriptor < 3) {
    ...
    checkUnnamed5280(o.monitoredResourceTypes!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
core.List<api.Aggregation> buildUnnamed5281() => [
      buildAggregation(),
      buildAggregation(),
    ];

void checkUnnamed5281(core.List<api.Aggregation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAggregation(o[0]);
  checkAggregation(o[1]);
}

core.List<api.Aggregation> buildUnnamed5282() => [
      buildAggregation(),
      buildAggregation(),
    ];

void checkUnnamed5282(core.List<api.Aggregation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAggregation(o[0]);
  checkAggregation(o[1]);
}
...
api.MetricThreshold buildMetricThreshold() {
  ...
  if (buildCounterMetricThreshold < 3) {
    o.aggregations = buildUnnamed5281();
    o.comparison = 'foo';
    o.denominatorAggregations = buildUnnamed5282();
...
void checkMetricThreshold(api.MetricThreshold o) {
  buildCounterMetricThreshold++;
  if (buildCounterMetricThreshold < 3) {
    checkUnnamed5281(o.aggregations!);
    unittest.expect(
      o.comparison!,
      unittest.equals('foo'),
    );
    checkUnnamed5282(o.denominatorAggregations!);
    unittest.expect(
      o.denominatorFilter!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.String> buildUnnamed5283() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed5283(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.LabelDescriptor> buildUnnamed5284() => [
      buildLabelDescriptor(),
      buildLabelDescriptor(),
    ];

void checkUnnamed5284(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelDescriptor(o[0]);
  checkLabelDescriptor(o[1]);
}
...
core.Map<core.String, core.Object> buildUnnamed5285() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed5285(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MonitoredResourceMetadata buildMonitoredResourceMetadata() {
  ...
  if (buildCounterMonitoredResourceMetadata < 3) {
    o.systemLabels = buildUnnamed5285();
    o.userLabels = buildUnnamed5286();
  }
  buildCounterMonitoredResourceMetadata--;
  return o;
}
...
void checkMonitoredResourceMetadata(api.MonitoredResourceMetadata o) {
  buildCounterMonitoredResourceMetadata++;
  if (buildCounterMonitoredResourceMetadata < 3) {
    checkUnnamed5285(o.systemLabels!);
    checkUnnamed5286(o.userLabels!);
  }
  buildCounterMonitoredResourceMetadata--;
}
...
core.List<api.MutationRecord> buildUnnamed5288() => [
      buildMutationRecord(),
      buildMutationRecord(),
    ];

void checkUnnamed5288(core.List<api.MutationRecord> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.NotificationChannel buildNotificationChannel() {
  ...
  if (buildCounterNotificationChannel < 3) {
    ...
    o.displayName = 'foo';
    o.enabled = true;
    o.labels = buildUnnamed5287();
    o.mutationRecords = buildUnnamed5288();
    o.name = 'foo';
    o.type = 'foo';
    o.userLabels = buildUnnamed5289();
...
void checkNotificationChannel(api.NotificationChannel o) {
  ...
  if (buildCounterNotificationChannel < 3) {
    ...
    unittest.expect(o.enabled!, unittest.isTrue);
    checkUnnamed5287(o.labels!);
    checkUnnamed5288(o.mutationRecords!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
core.List<api.LabelDescriptor> buildUnnamed5290() => [
      buildLabelDescriptor(),
      buildLabelDescriptor(),
    ];

void checkUnnamed5290(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelDescriptor(o[0]);
  checkLabelDescriptor(o[1]);
}
...
core.Map<core.String, core.Object> buildUnnamed5291() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed5291(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.TypedValue> buildUnnamed5292() => [
      buildTypedValue(),
      buildTypedValue(),
    ];

void checkUnnamed5292(core.List<api.TypedValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTypedValue(o[0]);
  checkTypedValue(o[1]);
}
...
core.List<api.Status> buildUnnamed5293() => [
      buildStatus(),
      buildStatus(),
    ];

void checkUnnamed5293(core.List<api.Status> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatus(o[0]);
  checkStatus(o[1]);
}

core.List<api.TimeSeriesData> buildUnnamed5294() => [
      buildTimeSeriesData(),
      buildTimeSeriesData(),
    ];

void checkUnnamed5294(core.List<api.TimeSeriesData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.QueryTimeSeriesResponse buildQueryTimeSeriesResponse() {
  ...
  if (buildCounterQueryTimeSeriesResponse < 3) {
    o.nextPageToken = 'foo';
    o.partialErrors = buildUnnamed5293();
    o.timeSeriesData = buildUnnamed5294();
...
void checkQueryTimeSeriesResponse(api.QueryTimeSeriesResponse o) {
  ...
  if (buildCounterQueryTimeSeriesResponse < 3) {
    ...
    checkUnnamed5293(o.partialErrors!);
    checkUnnamed5294(o.timeSeriesData!);
...
core.Map<core.String, core.String> buildUnnamed5296() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed5296(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.Map<core.String, core.Object> buildUnnamed5297() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed5297(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed5298() => [
      buildUnnamed5297(),
      buildUnnamed5297(),
    ];

void checkUnnamed5298(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed5297(o[0]);
  checkUnnamed5297(o[1]);
}
...
core.List<api.Point> buildUnnamed5299() => [
      buildPoint(),
      buildPoint(),
    ];

void checkUnnamed5299(core.List<api.Point> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPoint(o[0]);
  checkPoint(o[1]);
}
...
core.List<api.LabelValue> buildUnnamed5300() => [
      buildLabelValue(),
      buildLabelValue(),
    ];

void checkUnnamed5300(core.List<api.LabelValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelValue(o[0]);
  checkLabelValue(o[1]);
}

core.List<api.PointData> buildUnnamed5301() => [
      buildPointData(),
      buildPointData(),
    ];

void checkUnnamed5301(core.List<api.PointData> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPointData(o[0]);
  checkPointData(o[1]);
}
...
api.TimeSeriesData buildTimeSeriesData() {
  ...
  if (buildCounterTimeSeriesData < 3) {
    o.labelValues = buildUnnamed5300();
    o.pointData = buildUnnamed5301();
  }
  buildCounterTimeSeriesData--;
  return o;
}
...
void checkTimeSeriesData(api.TimeSeriesData o) {
  buildCounterTimeSeriesData++;
  if (buildCounterTimeSeriesData < 3) {
    checkUnnamed5300(o.labelValues!);
    checkUnnamed5301(o.pointData!);
  }
  buildCounterTimeSeriesData--;
}

core.List<api.LabelDescriptor> buildUnnamed5302() => [
      buildLabelDescriptor(),
      buildLabelDescriptor(),
    ];

void checkUnnamed5302(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelDescriptor(o[0]);
  checkLabelDescriptor(o[1]);
}

core.List<api.ValueDescriptor> buildUnnamed5303() => [
      buildValueDescriptor(),
      buildValueDescriptor(),
    ];

void checkUnnamed5303(core.List<api.ValueDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TimeSeriesDescriptor buildTimeSeriesDescriptor() {
  ...
  if (buildCounterTimeSeriesDescriptor < 3) {
    o.labelDescriptors = buildUnnamed5302();
    o.pointDescriptors = buildUnnamed5303();
  }
  buildCounterTimeSeriesDescriptor--;
  return o;
}
...
void checkTimeSeriesDescriptor(api.TimeSeriesDescriptor o) {
  buildCounterTimeSeriesDescriptor++;
  if (buildCounterTimeSeriesDescriptor < 3) {
    checkUnnamed5302(o.labelDescriptors!);
    checkUnnamed5303(o.pointDescriptors!);
  }
  buildCounterTimeSeriesDescriptor--;
}
...
core.List<api.Field> buildUnnamed5304() => [
      buildField(),
      buildField(),
    ];

void checkUnnamed5304(core.List<api.Field> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkField(o[0]);
  checkField(o[1]);
}
...
core.List<api.Option> buildUnnamed5306() => [
      buildOption(),
      buildOption(),
    ];

void checkUnnamed5306(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
api.Type buildType() {
  ...
  if (buildCounterType < 3) {
    o.fields = buildUnnamed5304();
    o.name = 'foo';
    o.oneofs = buildUnnamed5305();
    o.options = buildUnnamed5306();
...
void checkType(api.Type o) {
  buildCounterType++;
  if (buildCounterType < 3) {
    checkUnnamed5304(o.fields!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed5305(o.oneofs!);
    checkUnnamed5306(o.options!);
...
core.List<api.ContentMatcher> buildUnnamed5307() => [
      buildContentMatcher(),
      buildContentMatcher(),
    ];

void checkUnnamed5307(core.List<api.ContentMatcher> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContentMatcher(o[0]);
  checkContentMatcher(o[1]);
}

core.List<api.InternalChecker> buildUnnamed5308() => [
      buildInternalChecker(),
      buildInternalChecker(),
    ];

void checkUnnamed5308(core.List<api.InternalChecker> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.UptimeCheckConfig buildUptimeCheckConfig() {
  ...
  if (buildCounterUptimeCheckConfig < 3) {
    o.contentMatchers = buildUnnamed5307();
    o.displayName = 'foo';
    o.httpCheck = buildHttpCheck();
    o.internalCheckers = buildUnnamed5308();
    o.isInternal = true;
    o.monitoredResource = buildMonitoredResource();
    o.name = 'foo';
    o.period = 'foo';
    o.resourceGroup = buildResourceGroup();
    o.selectedRegions = buildUnnamed5309();
...
void checkUptimeCheckConfig(api.UptimeCheckConfig o) {
  buildCounterUptimeCheckConfig++;
  if (buildCounterUptimeCheckConfig < 3) {
    checkUnnamed5307(o.contentMatchers!);
    unittest.expect(
      o.displayName!,
      unittest.equals('foo'),
    );
    checkHttpCheck(o.httpCheck!);
    checkUnnamed5308(o.internalCheckers!);
    ...
    checkUnnamed5309(o.selectedRegions!);
...
void main() {
  ...
  unittest.group('resource-FoldersTimeSeriesResource', () {
    unittest.test('method--list', () async {
      ...
      final arg_aggregation_groupByFields = buildUnnamed5310();
      ...
      final arg_secondaryAggregation_groupByFields = buildUnnamed5311();
  ...
  unittest.group('resource-OrganizationsTimeSeriesResource', () {
    unittest.test('method--list', () async {
      ...
      final arg_aggregation_alignmentPeriod = 'foo';
      final arg_aggregation_crossSeriesReducer = 'foo';
      final arg_aggregation_groupByFields = buildUnnamed5312();
      final arg_aggregation_perSeriesAligner = 'foo';
      final arg_filter = 'foo';
      final arg_interval_endTime = 'foo';
      final arg_interval_startTime = 'foo';
      ...
      final arg_secondaryAggregation_alignmentPeriod = 'foo';
      final arg_secondaryAggregation_crossSeriesReducer = 'foo';
      final arg_secondaryAggregation_groupByFields = buildUnnamed5313();
      final arg_secondaryAggregation_perSeriesAligner = 'foo';
      final arg_view = 'foo';
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
  ...
  unittest.group('resource-ProjectsTimeSeriesResource', () {
    ...
    unittest.test('method--list', () async {
      ...
      final arg_aggregation_alignmentPeriod = 'foo';
      final arg_aggregation_crossSeriesReducer = 'foo';
      final arg_aggregation_groupByFields = buildUnnamed5314();
      final arg_aggregation_perSeriesAligner = 'foo';
      final arg_filter = 'foo';
      final arg_interval_endTime = 'foo';
      final arg_interval_startTime = 'foo';
      ...
      final arg_secondaryAggregation_alignmentPeriod = 'foo';
      final arg_secondaryAggregation_crossSeriesReducer = 'foo';
      final arg_secondaryAggregation_groupByFields = buildUnnamed5315();
      final arg_secondaryAggregation_perSeriesAligner = 'foo';
      final arg_view = 'foo';
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
