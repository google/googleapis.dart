...
buildAggregation() {
  ...
  if (buildCounterAggregation < 3) {
    ...
    o.groupByFields = buildUnnamed4583();
...
checkAggregation(api.Aggregation o) {
  ...
  if (buildCounterAggregation < 3) {
    ...
    checkUnnamed4583(o.groupByFields);
...
checkUnnamed4584(core.List<api.Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCondition(o[0]);
  checkCondition(o[1]);
}
...
checkUnnamed4586(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAlertPolicy() {
  ...
  if (buildCounterAlertPolicy < 3) {
    ...
    o.name = "foo";
    o.notificationChannels = buildUnnamed4585();
    o.userLabels = buildUnnamed4586();
...
checkAlertPolicy(api.AlertPolicy o) {
  ...
  if (buildCounterAlertPolicy < 3) {
    ...
    checkUnnamed4585(o.notificationChannels);
    checkUnnamed4586(o.userLabels);
...
checkUnnamed4588(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
checkUnnamed4589(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
buildBasicSli() {
  ...
  if (buildCounterBasicSli < 3) {
    ...
    o.location = buildUnnamed4587();
    o.method = buildUnnamed4588();
    o.version = buildUnnamed4589();
  }
  buildCounterBasicSli--;
  return o;
}
...
checkBasicSli(api.BasicSli o) {
  ...
  if (buildCounterBasicSli < 3) {
    ...
    checkUnnamed4587(o.location);
    checkUnnamed4588(o.method);
    checkUnnamed4589(o.version);
  }
  buildCounterBasicSli--;
}
...
checkUnnamed4590(core.Map<core.String, api.TypedValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTypedValue(o["x"]);
  checkTypedValue(o["y"]);
}
...
checkUnnamed4591(core.List<api.CollectdValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildCollectdPayload() {
  ...
  if (buildCounterCollectdPayload < 3) {
    o.endTime = "foo";
    o.metadata = buildUnnamed4590();
    o.plugin = "foo";
    o.pluginInstance = "foo";
    o.startTime = "foo";
    o.type = "foo";
    o.typeInstance = "foo";
    o.values = buildUnnamed4591();
  }
  buildCounterCollectdPayload--;
  return o;
}
...
checkUnnamed4592(core.List<api.CollectdValueError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildCollectdPayloadError() {
  ...
  if (buildCounterCollectdPayloadError < 3) {
    o.error = buildStatus();
    o.index = 42;
    o.valueErrors = buildUnnamed4592();
  }
  buildCounterCollectdPayloadError--;
  return o;
}
...
checkCollectdPayloadError(api.CollectdPayloadError o) {
  ...
  if (buildCounterCollectdPayloadError < 3) {
    ...
    checkUnnamed4592(o.valueErrors);
  }
  buildCounterCollectdPayloadError--;
}
...
checkUnnamed4593(core.List<api.CollectdPayload> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildCreateCollectdTimeSeriesRequest() {
  ...
  if (buildCounterCreateCollectdTimeSeriesRequest < 3) {
    o.collectdPayloads = buildUnnamed4593();
...
checkCreateCollectdTimeSeriesRequest(api.CreateCollectdTimeSeriesRequest o) {
  buildCounterCreateCollectdTimeSeriesRequest++;
  if (buildCounterCreateCollectdTimeSeriesRequest < 3) {
    checkUnnamed4593(o.collectdPayloads);
...
checkUnnamed4594(core.List<api.CollectdPayloadError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildCreateCollectdTimeSeriesResponse() {
  ...
  if (buildCounterCreateCollectdTimeSeriesResponse < 3) {
    o.payloadErrors = buildUnnamed4594();
...
checkCreateCollectdTimeSeriesResponse(api.CreateCollectdTimeSeriesResponse o) {
  buildCounterCreateCollectdTimeSeriesResponse++;
  if (buildCounterCreateCollectdTimeSeriesResponse < 3) {
    checkUnnamed4594(o.payloadErrors);
...
checkUnnamed4595(core.List<api.TimeSeries> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTimeSeries(o[0]);
  checkTimeSeries(o[1]);
}
...
checkUnnamed4596(core.List<api.Error> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkError(o[0]);
  checkError(o[1]);
}
...
checkUnnamed4598(core.List<api.Exemplar> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkExemplar(o[0]);
  checkExemplar(o[1]);
}
...
buildDistribution() {
  ...
  if (buildCounterDistribution < 3) {
    o.bucketCounts = buildUnnamed4597();
    o.bucketOptions = buildBucketOptions();
    o.count = "foo";
    o.exemplars = buildUnnamed4598();
    o.mean = 42.0;
    o.range = buildRange();
...
checkDistribution(api.Distribution o) {
  buildCounterDistribution++;
  if (buildCounterDistribution < 3) {
    checkUnnamed4597(o.bucketCounts);
    checkBucketOptions(o.bucketOptions);
    unittest.expect(o.count, unittest.equals('foo'));
    checkUnnamed4598(o.exemplars);
...
checkUnnamed4599(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed4600(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed4601() {
  ...
  o.add(buildUnnamed4600());
  o.add(buildUnnamed4600());
  return o;
}

checkUnnamed4601(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed4600(o[0]);
  checkUnnamed4600(o[1]);
}
...
buildExemplar() {
  ...
  if (buildCounterExemplar < 3) {
    o.attachments = buildUnnamed4601();
    o.timestamp = "foo";
    o.value = 42.0;
  }
  buildCounterExemplar--;
...
checkExemplar(api.Exemplar o) {
  buildCounterExemplar++;
  if (buildCounterExemplar < 3) {
    checkUnnamed4601(o.attachments);
...
checkUnnamed4602(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4603(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
checkUnnamed4604(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed4605(core.List<api.AlertPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListAlertPoliciesResponse() {
  ...
  if (buildCounterListAlertPoliciesResponse < 3) {
    o.alertPolicies = buildUnnamed4605();
    o.nextPageToken = "foo";
    o.totalSize = 42;
  }
  buildCounterListAlertPoliciesResponse--;
...
checkListAlertPoliciesResponse(api.ListAlertPoliciesResponse o) {
  buildCounterListAlertPoliciesResponse++;
  if (buildCounterListAlertPoliciesResponse < 3) {
    checkUnnamed4605(o.alertPolicies);
...
checkUnnamed4606(core.List<api.MonitoredResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4607(core.List<api.Group> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGroup(o[0]);
  checkGroup(o[1]);
}
...
checkUnnamed4608(core.List<api.MetricDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListMetricDescriptorsResponse() {
  ...
  if (buildCounterListMetricDescriptorsResponse < 3) {
    o.metricDescriptors = buildUnnamed4608();
    o.nextPageToken = "foo";
  }
  buildCounterListMetricDescriptorsResponse--;
  return o;
...
checkListMetricDescriptorsResponse(api.ListMetricDescriptorsResponse o) {
  buildCounterListMetricDescriptorsResponse++;
  if (buildCounterListMetricDescriptorsResponse < 3) {
    checkUnnamed4608(o.metricDescriptors);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListMetricDescriptorsResponse--;
}
...
checkUnnamed4609(core.List<api.MonitoredResourceDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListMonitoredResourceDescriptorsResponse() {
  ...
  if (buildCounterListMonitoredResourceDescriptorsResponse < 3) {
    o.nextPageToken = "foo";
    o.resourceDescriptors = buildUnnamed4609();
  }
  buildCounterListMonitoredResourceDescriptorsResponse--;
  return o;
}
...
checkListMonitoredResourceDescriptorsResponse(
  ...
  if (buildCounterListMonitoredResourceDescriptorsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4609(o.resourceDescriptors);
  }
  buildCounterListMonitoredResourceDescriptorsResponse--;
}
...
checkUnnamed4610(core.List<api.NotificationChannelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListNotificationChannelDescriptorsResponse() {
  ...
  if (buildCounterListNotificationChannelDescriptorsResponse < 3) {
    o.channelDescriptors = buildUnnamed4610();
    o.nextPageToken = "foo";
  }
  buildCounterListNotificationChannelDescriptorsResponse--;
  return o;
...
checkListNotificationChannelDescriptorsResponse(
  ...
  buildCounterListNotificationChannelDescriptorsResponse++;
  if (buildCounterListNotificationChannelDescriptorsResponse < 3) {
    checkUnnamed4610(o.channelDescriptors);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListNotificationChannelDescriptorsResponse--;
}
...
checkUnnamed4611(core.List<api.NotificationChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListNotificationChannelsResponse() {
  ...
  if (buildCounterListNotificationChannelsResponse < 3) {
    o.nextPageToken = "foo";
    o.notificationChannels = buildUnnamed4611();
    o.totalSize = 42;
  }
  buildCounterListNotificationChannelsResponse--;
  return o;
...
checkListNotificationChannelsResponse(api.ListNotificationChannelsResponse o) {
  ...
  if (buildCounterListNotificationChannelsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4611(o.notificationChannels);
    unittest.expect(o.totalSize, unittest.equals(42));
  }
  buildCounterListNotificationChannelsResponse--;
}
...
checkUnnamed4612(core.List<api.ServiceLevelObjective> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListServiceLevelObjectivesResponse() {
  ...
  if (buildCounterListServiceLevelObjectivesResponse < 3) {
    o.nextPageToken = "foo";
    o.serviceLevelObjectives = buildUnnamed4612();
  }
  buildCounterListServiceLevelObjectivesResponse--;
  return o;
}
...
checkListServiceLevelObjectivesResponse(
  ...
  if (buildCounterListServiceLevelObjectivesResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4612(o.serviceLevelObjectives);
  }
  buildCounterListServiceLevelObjectivesResponse--;
}
...
checkUnnamed4613(core.List<api.Service> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkService(o[0]);
  checkService(o[1]);
}
...
checkUnnamed4614(core.List<api.Status> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatus(o[0]);
  checkStatus(o[1]);
}
...
checkUnnamed4615(core.List<api.TimeSeries> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTimeSeries(o[0]);
  checkTimeSeries(o[1]);
}
...
buildListTimeSeriesResponse() {
  ...
  if (buildCounterListTimeSeriesResponse < 3) {
    o.executionErrors = buildUnnamed4614();
    o.nextPageToken = "foo";
    o.timeSeries = buildUnnamed4615();
    o.unit = "foo";
  }
  buildCounterListTimeSeriesResponse--;
  return o;
...
checkListTimeSeriesResponse(api.ListTimeSeriesResponse o) {
  buildCounterListTimeSeriesResponse++;
  if (buildCounterListTimeSeriesResponse < 3) {
    checkUnnamed4614(o.executionErrors);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4615(o.timeSeries);
...
checkUnnamed4616(core.List<api.UptimeCheckConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListUptimeCheckConfigsResponse() {
  ...
  if (buildCounterListUptimeCheckConfigsResponse < 3) {
    o.nextPageToken = "foo";
    o.totalSize = 42;
    o.uptimeCheckConfigs = buildUnnamed4616();
  }
  buildCounterListUptimeCheckConfigsResponse--;
  return o;
}
...
checkListUptimeCheckConfigsResponse(api.ListUptimeCheckConfigsResponse o) {
  ...
  if (buildCounterListUptimeCheckConfigsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    unittest.expect(o.totalSize, unittest.equals(42));
    checkUnnamed4616(o.uptimeCheckConfigs);
  }
  buildCounterListUptimeCheckConfigsResponse--;
}
...
checkUnnamed4617(core.List<api.UptimeCheckIp> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListUptimeCheckIpsResponse() {
  ...
  if (buildCounterListUptimeCheckIpsResponse < 3) {
    o.nextPageToken = "foo";
    o.uptimeCheckIps = buildUnnamed4617();
  }
  buildCounterListUptimeCheckIpsResponse--;
  return o;
}
...
checkListUptimeCheckIpsResponse(api.ListUptimeCheckIpsResponse o) {
  ...
  if (buildCounterListUptimeCheckIpsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4617(o.uptimeCheckIps);
  }
  buildCounterListUptimeCheckIpsResponse--;
}
...
checkUnnamed4618(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed4619(core.List<api.Aggregation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildMetricAbsence() {
  ...
  if (buildCounterMetricAbsence < 3) {
    o.aggregations = buildUnnamed4619();
    o.duration = "foo";
    o.filter = "foo";
...
checkMetricAbsence(api.MetricAbsence o) {
  buildCounterMetricAbsence++;
  if (buildCounterMetricAbsence < 3) {
    checkUnnamed4619(o.aggregations);
...
checkUnnamed4620(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildMetricDescriptor() {
  ...
  if (buildCounterMetricDescriptor < 3) {
    ...
    o.metricKind = "foo";
    o.monitoredResourceTypes = buildUnnamed4621();
    o.name = "foo";
    o.type = "foo";
    o.unit = "foo";
    o.valueType = "foo";
...
checkMetricDescriptor(api.MetricDescriptor o) {
  ...
  if (buildCounterMetricDescriptor < 3) {
    ...
    checkUnnamed4621(o.monitoredResourceTypes);
    unittest.expect(o.name, unittest.equals('foo'));
    unittest.expect(o.type, unittest.equals('foo'));
    unittest.expect(o.unit, unittest.equals('foo'));
    unittest.expect(o.valueType, unittest.equals('foo'));
...
checkUnnamed4622(core.List<api.Aggregation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAggregation(o[0]);
  checkAggregation(o[1]);
}
...
checkUnnamed4623(core.List<api.Aggregation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAggregation(o[0]);
  checkAggregation(o[1]);
}
...
buildMetricThreshold() {
  ...
  if (buildCounterMetricThreshold < 3) {
    o.aggregations = buildUnnamed4622();
    o.comparison = "foo";
    o.denominatorAggregations = buildUnnamed4623();
...
checkMetricThreshold(api.MetricThreshold o) {
  buildCounterMetricThreshold++;
  if (buildCounterMetricThreshold < 3) {
    checkUnnamed4622(o.aggregations);
    unittest.expect(o.comparison, unittest.equals('foo'));
    checkUnnamed4623(o.denominatorAggregations);
...
checkUnnamed4624(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed4625(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelDescriptor(o[0]);
  checkLabelDescriptor(o[1]);
}
...
checkUnnamed4626(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildMonitoredResourceMetadata() {
  ...
  if (buildCounterMonitoredResourceMetadata < 3) {
    o.systemLabels = buildUnnamed4626();
    o.userLabels = buildUnnamed4627();
  }
  buildCounterMonitoredResourceMetadata--;
  return o;
}
...
checkMonitoredResourceMetadata(api.MonitoredResourceMetadata o) {
  buildCounterMonitoredResourceMetadata++;
  if (buildCounterMonitoredResourceMetadata < 3) {
    checkUnnamed4626(o.systemLabels);
    checkUnnamed4627(o.userLabels);
  }
  buildCounterMonitoredResourceMetadata--;
}
...
checkUnnamed4628(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed4629(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
buildNotificationChannel() {
  ...
  if (buildCounterNotificationChannel < 3) {
    ...
    o.displayName = "foo";
    o.enabled = true;
    o.labels = buildUnnamed4628();
    o.name = "foo";
    o.type = "foo";
    o.userLabels = buildUnnamed4629();
...
checkNotificationChannel(api.NotificationChannel o) {
  ...
  if (buildCounterNotificationChannel < 3) {
    ...
    unittest.expect(o.displayName, unittest.equals('foo'));
    unittest.expect(o.enabled, unittest.isTrue);
    checkUnnamed4628(o.labels);
    unittest.expect(o.name, unittest.equals('foo'));
    unittest.expect(o.type, unittest.equals('foo'));
    checkUnnamed4629(o.userLabels);
...
checkUnnamed4630(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelDescriptor(o[0]);
  checkLabelDescriptor(o[1]);
}
...
checkUnnamed4631(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4632(core.List<api.TypedValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTypedValue(o[0]);
  checkTypedValue(o[1]);
}
...
checkUnnamed4633(core.List<api.Status> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatus(o[0]);
  checkStatus(o[1]);
}
...
checkUnnamed4634(core.List<api.TimeSeriesData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildQueryTimeSeriesResponse() {
  ...
  if (buildCounterQueryTimeSeriesResponse < 3) {
    o.nextPageToken = "foo";
    o.partialErrors = buildUnnamed4633();
    o.timeSeriesData = buildUnnamed4634();
...
checkQueryTimeSeriesResponse(api.QueryTimeSeriesResponse o) {
  ...
  if (buildCounterQueryTimeSeriesResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4633(o.partialErrors);
    checkUnnamed4634(o.timeSeriesData);
...
checkUnnamed4637(core.List<api.Point> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPoint(o[0]);
  checkPoint(o[1]);
}
...
checkUnnamed4638(core.List<api.LabelValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelValue(o[0]);
  checkLabelValue(o[1]);
}
...
checkUnnamed4639(core.List<api.PointData> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPointData(o[0]);
  checkPointData(o[1]);
}
...
buildTimeSeriesData() {
  ...
  if (buildCounterTimeSeriesData < 3) {
    o.labelValues = buildUnnamed4638();
    o.pointData = buildUnnamed4639();
  }
  buildCounterTimeSeriesData--;
  return o;
}
...
checkTimeSeriesData(api.TimeSeriesData o) {
  buildCounterTimeSeriesData++;
  if (buildCounterTimeSeriesData < 3) {
    checkUnnamed4638(o.labelValues);
    checkUnnamed4639(o.pointData);
  }
  buildCounterTimeSeriesData--;
}
...
checkUnnamed4640(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelDescriptor(o[0]);
  checkLabelDescriptor(o[1]);
}
...
checkUnnamed4641(core.List<api.ValueDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildTimeSeriesDescriptor() {
  ...
  if (buildCounterTimeSeriesDescriptor < 3) {
    o.labelDescriptors = buildUnnamed4640();
    o.pointDescriptors = buildUnnamed4641();
  }
  buildCounterTimeSeriesDescriptor--;
  return o;
}
...
checkTimeSeriesDescriptor(api.TimeSeriesDescriptor o) {
  buildCounterTimeSeriesDescriptor++;
  if (buildCounterTimeSeriesDescriptor < 3) {
    checkUnnamed4640(o.labelDescriptors);
    checkUnnamed4641(o.pointDescriptors);
  }
  buildCounterTimeSeriesDescriptor--;
}
...
checkUnnamed4642(core.List<api.Field> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkField(o[0]);
  checkField(o[1]);
}
...
checkUnnamed4644(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
buildType() {
  ...
  if (buildCounterType < 3) {
    o.fields = buildUnnamed4642();
    o.name = "foo";
    o.oneofs = buildUnnamed4643();
    o.options = buildUnnamed4644();
...
checkType(api.Type o) {
  buildCounterType++;
  if (buildCounterType < 3) {
    checkUnnamed4642(o.fields);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed4643(o.oneofs);
    checkUnnamed4644(o.options);
...
checkUnnamed4645(core.List<api.ContentMatcher> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4646(core.List<api.InternalChecker> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUptimeCheckConfig() {
  ...
  if (buildCounterUptimeCheckConfig < 3) {
    o.contentMatchers = buildUnnamed4645();
    o.displayName = "foo";
    o.httpCheck = buildHttpCheck();
    o.internalCheckers = buildUnnamed4646();
    o.isInternal = true;
    o.monitoredResource = buildMonitoredResource();
    o.name = "foo";
    o.period = "foo";
    o.resourceGroup = buildResourceGroup();
    o.selectedRegions = buildUnnamed4647();
...
checkUptimeCheckConfig(api.UptimeCheckConfig o) {
  buildCounterUptimeCheckConfig++;
  if (buildCounterUptimeCheckConfig < 3) {
    checkUnnamed4645(o.contentMatchers);
    unittest.expect(o.displayName, unittest.equals('foo'));
    checkHttpCheck(o.httpCheck);
    checkUnnamed4646(o.internalCheckers);
    ...
    checkUnnamed4647(o.selectedRegions);
...
main() {
  ...
  unittest.group("resource-ProjectsTimeSeriesResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_interval_startTime = "foo";
      var arg_pageSize = 42;
      var arg_secondaryAggregation_groupByFields = buildUnnamed4648();
      var arg_secondaryAggregation_crossSeriesReducer = "foo";
      var arg_aggregation_perSeriesAligner = "foo";
      var arg_orderBy = "foo";
      var arg_aggregation_groupByFields = buildUnnamed4649();
