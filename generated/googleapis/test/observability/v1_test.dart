...
import 'package:googleapis/observability/v1.dart' as api;
...
core.List<api.Dataset> buildUnnamed1() => [buildDataset(), buildDataset()];

void checkUnnamed1(core.List<api.Dataset> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataset(o[0]);
  checkDataset(o[1]);
}
...
void checkListDatasetsResponse(api.ListDatasetsResponse o) {
  buildCounterListDatasetsResponse++;
  if (buildCounterListDatasetsResponse < 3) {
    checkUnnamed1(o.datasets!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListDatasetsResponse--;
}

core.List<api.Link> buildUnnamed2() => [buildLink(), buildLink()];

void checkUnnamed2(core.List<api.Link> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLink(o[0]);
  checkLink(o[1]);
}
...
core.List<api.TraceScope> buildUnnamed6() => [
  buildTraceScope(),
  buildTraceScope(),
];

void checkUnnamed6(core.List<api.TraceScope> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTraceScope(o[0]);
  checkTraceScope(o[1]);
}

core.int buildCounterListTraceScopesResponse = 0;
api.ListTraceScopesResponse buildListTraceScopesResponse() {
  final o = api.ListTraceScopesResponse();
  buildCounterListTraceScopesResponse++;
  if (buildCounterListTraceScopesResponse < 3) {
    o.nextPageToken = 'foo';
    o.traceScopes = buildUnnamed6();
  }
  buildCounterListTraceScopesResponse--;
  return o;
}

void checkListTraceScopesResponse(api.ListTraceScopesResponse o) {
  buildCounterListTraceScopesResponse++;
  if (buildCounterListTraceScopesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed6(o.traceScopes!);
  }
  buildCounterListTraceScopesResponse--;
}

core.List<api.View> buildUnnamed7() => [buildView(), buildView()];

void checkUnnamed7(core.List<api.View> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkView(o[0]);
  checkView(o[1]);
}
...
void checkScope(api.Scope o) {
  buildCounterScope++;
  if (buildCounterScope < 3) {
    unittest.expect(o.logScope!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.traceScope!, unittest.equals('foo'));
    unittest.expect(o.updateTime!, unittest.equals('foo'));
  }
  buildCounterScope--;
}
...
void checkSettings(api.Settings o) {
  buildCounterSettings++;
  if (buildCounterSettings < 3) {
    unittest.expect(o.defaultStorageLocation!, unittest.equals('foo'));
...
core.int buildCounterTraceScope = 0;
api.TraceScope buildTraceScope() {
  final o = api.TraceScope();
  buildCounterTraceScope++;
  if (buildCounterTraceScope < 3) {
    o.createTime = 'foo';
    o.description = 'foo';
    o.name = 'foo';
    o.resourceNames = buildUnnamed14();
    o.updateTime = 'foo';
  }
  buildCounterTraceScope--;
  return o;
...
void checkTraceScope(api.TraceScope o) {
  buildCounterTraceScope++;
  if (buildCounterTraceScope < 3) {
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.description!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed14(o.resourceNames!);
    unittest.expect(o.updateTime!, unittest.equals('foo'));
  }
  buildCounterTraceScope--;
}

core.int buildCounterView = 0;
api.View buildView() {
  final o = api.View();
  buildCounterView++;
  if (buildCounterView < 3) {
    o.createTime = 'foo';
    o.description = 'foo';
    o.displayName = 'foo';
    o.name = 'foo';
...
void main() {
  ...
  unittest.group('obj-schema-ListTraceScopesResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildListTraceScopesResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.ListTraceScopesResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkListTraceScopesResponse(od);
    });
  });
  ...
  unittest.group('obj-schema-TraceScope', () {
    unittest.test('to-json--from-json', () async {
      final o = buildTraceScope();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.TraceScope.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkTraceScope(od);
    });
  ...
  unittest.group('obj-schema-View', () {
    unittest.test('to-json--from-json', () async {
      final o = buildView();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.View.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkView(od);
    });
  ...
  unittest.group('resource-FoldersLocationsResource', () {
    unittest.test('method--get', () async {
      ...
      final res = api.CloudObservabilityApi(mock).folders.locations;
      final arg_name = 'foo';
  ...
  unittest.group('resource-FoldersLocationsOperationsResource', () {
    unittest.test('method--cancel', () async {
      final mock = HttpServerMock();
      final res = api.CloudObservabilityApi(mock).folders.locations.operations;
  ...
  unittest.group('resource-OrganizationsLocationsResource', () {
    unittest.test('method--get', () async {
      final mock = HttpServerMock();
      final res = api.CloudObservabilityApi(mock).organizations.locations;
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
  ...
  unittest.group('resource-ProjectsLocationsResource', () {
    unittest.test('method--get', () async {
      final mock = HttpServerMock();
      final res = api.CloudObservabilityApi(mock).projects.locations;
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
  ...
  unittest.group('resource-ProjectsLocationsBucketsResource', () {
    unittest.test('method--create', () async {
      final mock = HttpServerMock();
      final res = api.CloudObservabilityApi(mock).projects.locations.buckets;
    ...
    unittest.test('method--get', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildView());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.get(arg_name, $fields: arg_$fields);
      checkView(response as api.View);
    });
  ...
  unittest.group('resource-ProjectsLocationsOperationsResource', () {
    unittest.test('method--cancel', () async {
      final mock = HttpServerMock();
      final res = api.CloudObservabilityApi(mock).projects.locations.operations;
      final arg_request = buildCancelOperationRequest();
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
  ...
  unittest.group('resource-ProjectsLocationsScopesResource', () {
    unittest.test('method--get', () async {
      final mock = HttpServerMock();
      final res = api.CloudObservabilityApi(mock).projects.locations.scopes;
      final arg_name = 'foo';
      final arg_$fields = 'foo';
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
  ...
  unittest.group('resource-ProjectsLocationsTraceScopesResource', () {
    unittest.test('method--create', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          final obj = api.TraceScope.fromJson(
            json as core.Map<core.String, core.dynamic>,
          );
          checkTraceScope(obj);
          ...
          unittest.expect(
            queryMap['traceScopeId']!.first,
            unittest.equals(arg_traceScopeId),
          );
          unittest.expect(
            queryMap['fields']!.first,
            unittest.equals(arg_$fields),
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildTraceScope());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.create(
        arg_request,
        arg_parent,
        traceScopeId: arg_traceScopeId,
        $fields: arg_$fields,
      );
      checkTraceScope(response as api.TraceScope);
    });
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(buildListTraceScopesResponse());
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      ...
      checkListTraceScopesResponse(response as api.ListTraceScopesResponse);
    });
