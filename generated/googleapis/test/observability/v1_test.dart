...
core.List<api.TraceScope> buildUnnamed2() => [
  buildTraceScope(),
  buildTraceScope(),
];

void checkUnnamed2(core.List<api.TraceScope> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTraceScope(o[0]);
  checkTraceScope(o[1]);
}
