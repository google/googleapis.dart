...
import 'package:googleapis/apphub/v1alpha.dart' as api;
...
void checkCriticality(api.Criticality o) {
  ...
  if (buildCounterCriticality < 3) {
    ...
    unittest.expect(o.missionCritical!, unittest.isTrue);
...
core.List<api.DiscoveredService> buildUnnamed6() => [
  buildDiscoveredService(),
  buildDiscoveredService(),
];

void checkUnnamed6(core.List<api.DiscoveredService> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.int buildCounterFindUnregisteredServicesResponse = 0;
api.FindUnregisteredServicesResponse buildFindUnregisteredServicesResponse() {
  final o = api.FindUnregisteredServicesResponse();
  buildCounterFindUnregisteredServicesResponse++;
  if (buildCounterFindUnregisteredServicesResponse < 3) {
    o.discoveredServices = buildUnnamed6();
    o.nextPageToken = 'foo';
...
void checkFindUnregisteredServicesResponse(
  api.FindUnregisteredServicesResponse o,
) {
  buildCounterFindUnregisteredServicesResponse++;
  if (buildCounterFindUnregisteredServicesResponse < 3) {
    checkUnnamed6(o.discoveredServices!);
...
core.List<api.DiscoveredWorkload> buildUnnamed8() => [
  buildDiscoveredWorkload(),
  buildDiscoveredWorkload(),
];

void checkUnnamed8(core.List<api.DiscoveredWorkload> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.int buildCounterFindUnregisteredWorkloadsResponse = 0;
api.FindUnregisteredWorkloadsResponse buildFindUnregisteredWorkloadsResponse() {
  final o = api.FindUnregisteredWorkloadsResponse();
  buildCounterFindUnregisteredWorkloadsResponse++;
  if (buildCounterFindUnregisteredWorkloadsResponse < 3) {
    o.discoveredWorkloads = buildUnnamed8();
    o.nextPageToken = 'foo';
...
void checkFindUnregisteredWorkloadsResponse(
  api.FindUnregisteredWorkloadsResponse o,
) {
  buildCounterFindUnregisteredWorkloadsResponse++;
  if (buildCounterFindUnregisteredWorkloadsResponse < 3) {
    checkUnnamed8(o.discoveredWorkloads!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
...
core.List<api.Application> buildUnnamed10() => [
  buildApplication(),
  buildApplication(),
];

void checkUnnamed10(core.List<api.Application> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.DiscoveredService> buildUnnamed12() => [
  buildDiscoveredService(),
  buildDiscoveredService(),
];

void checkUnnamed12(core.List<api.DiscoveredService> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDiscoveredService(o[0]);
  checkDiscoveredService(o[1]);
}
...
api.ListDiscoveredServicesResponse buildListDiscoveredServicesResponse() {
  ...
  if (buildCounterListDiscoveredServicesResponse < 3) {
    o.discoveredServices = buildUnnamed12();
    o.nextPageToken = 'foo';
...
void checkListDiscoveredServicesResponse(api.ListDiscoveredServicesResponse o) {
  buildCounterListDiscoveredServicesResponse++;
  if (buildCounterListDiscoveredServicesResponse < 3) {
    checkUnnamed12(o.discoveredServices!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
...
core.List<api.DiscoveredWorkload> buildUnnamed14() => [
  buildDiscoveredWorkload(),
  buildDiscoveredWorkload(),
];

void checkUnnamed14(core.List<api.DiscoveredWorkload> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDiscoveredWorkload(o[0]);
  checkDiscoveredWorkload(o[1]);
}
...
api.ListDiscoveredWorkloadsResponse buildListDiscoveredWorkloadsResponse() {
  ...
  if (buildCounterListDiscoveredWorkloadsResponse < 3) {
    o.discoveredWorkloads = buildUnnamed14();
    o.nextPageToken = 'foo';
...
void checkListDiscoveredWorkloadsResponse(
  ...
  buildCounterListDiscoveredWorkloadsResponse++;
  if (buildCounterListDiscoveredWorkloadsResponse < 3) {
    checkUnnamed14(o.discoveredWorkloads!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
...
core.List<api.ServiceProjectAttachment> buildUnnamed18() => [
  buildServiceProjectAttachment(),
  buildServiceProjectAttachment(),
];

void checkUnnamed18(core.List<api.ServiceProjectAttachment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListServiceProjectAttachmentsResponse() {
  ...
  if (buildCounterListServiceProjectAttachmentsResponse < 3) {
    o.nextPageToken = 'foo';
    o.serviceProjectAttachments = buildUnnamed18();
...
void checkListServiceProjectAttachmentsResponse(
  ...
  if (buildCounterListServiceProjectAttachmentsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed18(o.serviceProjectAttachments!);
    checkUnnamed19(o.unreachable!);
  }
  buildCounterListServiceProjectAttachmentsResponse--;
}

core.List<api.Service> buildUnnamed20() => [buildService(), buildService()];
...
core.List<api.Workload> buildUnnamed23() => [buildWorkload(), buildWorkload()];

void checkUnnamed23(core.List<api.Workload> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWorkload(o[0]);
  checkWorkload(o[1]);
}
...
core.List<api.Binding> buildUnnamed29() => [buildBinding(), buildBinding()];
...
void main() {
  ...
  unittest.group('obj-schema-FindUnregisteredServicesResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildFindUnregisteredServicesResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.FindUnregisteredServicesResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkFindUnregisteredServicesResponse(od);
    });
  });

  unittest.group('obj-schema-FindUnregisteredWorkloadsResponse', () {
    unittest.test('to-json--from-json', () async {
      final o = buildFindUnregisteredWorkloadsResponse();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.FindUnregisteredWorkloadsResponse.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkFindUnregisteredWorkloadsResponse(od);
    });
  });
  ...
  unittest.group('resource-ProjectsLocationsDiscoveredServicesResource', () {
    unittest.test('method--findUnregistered', () async {
      final mock = HttpServerMock();
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildFindUnregisteredServicesResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.findUnregistered(
        arg_parent,
        filter: arg_filter,
        orderBy: arg_orderBy,
        pageSize: arg_pageSize,
      ...
      checkFindUnregisteredServicesResponse(
        response as api.FindUnregisteredServicesResponse,
      );
    });
    ...
    unittest.test('method--findUnregistered', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildFindUnregisteredWorkloadsResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      ...
      checkFindUnregisteredWorkloadsResponse(
        response as api.FindUnregisteredWorkloadsResponse,
      );
    });
