...
import 'package:googleapis/appengine/v1beta.dart' as api;
...
core.List<api.CustomMetric> buildUnnamed4() => [
  buildCustomMetric(),
  buildCustomMetric(),
];

void checkUnnamed4(core.List<api.CustomMetric> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.FirewallRule> buildUnnamed6() => [
  buildFirewallRule(),
  buildFirewallRule(),
];

void checkUnnamed6(core.List<api.FirewallRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFirewallRule(o[0]);
  checkFirewallRule(o[1]);
}
...
core.Map<core.String, api.FileInfo> buildUnnamed7() => {
  'x': buildFileInfo(),
  'y': buildFileInfo(),
};

void checkUnnamed7(core.Map<core.String, api.FileInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFileInfo(o['x']!);
  checkFileInfo(o['y']!);
}
...
core.List<api.ResourceRecord> buildUnnamed8() => [
  buildResourceRecord(),
  buildResourceRecord(),
];

void checkUnnamed8(core.List<api.ResourceRecord> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DomainMapping buildDomainMapping() {
  ...
  if (buildCounterDomainMapping < 3) {
    o.id = 'foo';
    o.name = 'foo';
    o.resourceRecords = buildUnnamed8();
...
void checkDomainMapping(api.DomainMapping o) {
  ...
  if (buildCounterDomainMapping < 3) {
    unittest.expect(o.id!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed8(o.resourceRecords!);
...
void main() {
  ...
  unittest.group('obj-schema-BuildInfo', () {
    unittest.test('to-json--from-json', () async {
      final o = buildBuildInfo();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.BuildInfo.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkBuildInfo(od);
    });
    ...
    unittest.test('method--get', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          unittest.expect(
            path.substring(pathOffset, pathOffset + 16),
            unittest.equals('v1beta/projects/'),
          );
          pathOffset += 16;
          index = path.indexOf('/locations/', pathOffset);
          unittest.expect(index >= 0, unittest.isTrue);
