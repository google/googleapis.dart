...
checkUnnamed3374(core.List<api.FileHashes> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFileHashes(o[0]);
  checkFileHashes(o[1]);
}
...
checkUnnamed3377(core.List<api.Secret> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSecret(o[0]);
  checkSecret(o[1]);
}
...
checkUnnamed3378(core.List<api.BuildStep> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuildStep(o[0]);
  checkBuildStep(o[1]);
}
...
checkUnnamed3381(core.Map<core.String, api.TimeSpan> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTimeSpan(o["x"]);
  checkTimeSpan(o["y"]);
}
...
buildBuild() {
  ...
  if (buildCounterBuild < 3) {
    ...
    o.finishTime = "foo";
    o.id = "foo";
    o.images = buildUnnamed3376();
    o.logUrl = "foo";
    o.logsBucket = "foo";
    o.options = buildBuildOptions();
    o.projectId = "foo";
    o.results = buildResults();
    o.secrets = buildUnnamed3377();
    ...
    o.substitutions = buildUnnamed3379();
    o.tags = buildUnnamed3380();
    o.timeout = "foo";
    o.timing = buildUnnamed3381();
  }
  buildCounterBuild--;
  return o;
}
...
checkBuild(api.Build o) {
  ...
  if (buildCounterBuild < 3) {
    ...
    checkUnnamed3379(o.substitutions);
    checkUnnamed3380(o.tags);
    unittest.expect(o.timeout, unittest.equals('foo'));
    checkUnnamed3381(o.timing);
  }
  buildCounterBuild--;
}
...
buildBuildOptions() {
  ...
  if (buildCounterBuildOptions < 3) {
    ...
    o.sourceProvenanceHash = buildUnnamed3382();
...
checkBuildOptions(api.BuildOptions o) {
  ...
  if (buildCounterBuildOptions < 3) {
    ...
    checkUnnamed3382(o.sourceProvenanceHash);
...
checkUnnamed3386(core.List<api.Volume> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVolume(o[0]);
  checkVolume(o[1]);
}
...
buildBuildStep() {
  ...
  if (buildCounterBuildStep < 3) {
    o.args = buildUnnamed3383();
    o.dir = "foo";
    o.entrypoint = "foo";
    o.env = buildUnnamed3384();
    o.id = "foo";
    o.name = "foo";
    o.secretEnv = buildUnnamed3385();
    o.status = "foo";
    o.timeout = "foo";
    o.timing = buildTimeSpan();
    o.volumes = buildUnnamed3386();
    o.waitFor = buildUnnamed3387();
  }
  buildCounterBuildStep--;
  return o;
}
...
checkBuildStep(api.BuildStep o) {
  buildCounterBuildStep++;
  if (buildCounterBuildStep < 3) {
    checkUnnamed3383(o.args);
    unittest.expect(o.dir, unittest.equals('foo'));
    unittest.expect(o.entrypoint, unittest.equals('foo'));
    checkUnnamed3384(o.env);
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed3385(o.secretEnv);
    unittest.expect(o.status, unittest.equals('foo'));
    unittest.expect(o.timeout, unittest.equals('foo'));
    checkTimeSpan(o.timing);
    checkUnnamed3386(o.volumes);
    checkUnnamed3387(o.waitFor);
  }
  buildCounterBuildStep--;
}
...
buildBuildTrigger() {
  ...
  if (buildCounterBuildTrigger < 3) {
    ...
    o.filename = "foo";
    o.id = "foo";
    o.substitutions = buildUnnamed3388();
...
checkBuildTrigger(api.BuildTrigger o) {
  ...
  if (buildCounterBuildTrigger < 3) {
    ...
    unittest.expect(o.id, unittest.equals('foo'));
    checkUnnamed3388(o.substitutions);
...
checkUnnamed3389(core.List<api.Hash> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHash(o[0]);
  checkHash(o[1]);
}
...
checkUnnamed3390(core.List<api.BuildTrigger> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3391(core.List<api.Build> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuild(o[0]);
  checkBuild(o[1]);
}
...
checkUnnamed3392(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkUnnamed3394(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed3393();
    o.name = "foo";
    o.response = buildUnnamed3394();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed3393(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed3394(o.response);
  }
  buildCounterOperation--;
}
...
checkUnnamed3396(core.List<api.BuiltImage> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuiltImage(o[0]);
  checkBuiltImage(o[1]);
}
...
buildResults() {
  ...
  if (buildCounterResults < 3) {
    ...
    o.buildStepImages = buildUnnamed3395();
    o.images = buildUnnamed3396();
    o.numArtifacts = "foo";
  }
  buildCounterResults--;
  return o;
...
checkResults(api.Results o) {
  ...
  if (buildCounterResults < 3) {
    ...
    checkUnnamed3395(o.buildStepImages);
    checkUnnamed3396(o.images);
...
checkUnnamed3397(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed3398(core.Map<core.String, api.FileHashes> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFileHashes(o["x"]);
  checkFileHashes(o["y"]);
}
...
checkUnnamed3400(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
