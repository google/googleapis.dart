...
void checkApprovalResult(api.ApprovalResult o) {
  buildCounterApprovalResult++;
  if (buildCounterApprovalResult < 3) {
    unittest.expect(o.approvalTime!, unittest.equals('foo'));
    unittest.expect(o.approverAccount!, unittest.equals('foo'));
...
core.List<api.GenericArtifact> buildUnnamed1() => [
  buildGenericArtifact(),
  buildGenericArtifact(),
];

void checkUnnamed1(core.List<api.GenericArtifact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGenericArtifact(o[0]);
  checkGenericArtifact(o[1]);
}

core.List<api.GoModule> buildUnnamed2() => [buildGoModule(), buildGoModule()];

void checkUnnamed2(core.List<api.GoModule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoModule(o[0]);
  checkGoModule(o[1]);
}
...
core.List<api.MavenArtifact> buildUnnamed4() => [
  buildMavenArtifact(),
  buildMavenArtifact(),
];

void checkUnnamed4(core.List<api.MavenArtifact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMavenArtifact(o[0]);
  checkMavenArtifact(o[1]);
}

core.List<api.NpmPackage> buildUnnamed5() => [
  buildNpmPackage(),
  buildNpmPackage(),
];

void checkUnnamed5(core.List<api.NpmPackage> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNpmPackage(o[0]);
  checkNpmPackage(o[1]);
}

core.List<api.Oci> buildUnnamed6() => [buildOci(), buildOci()];

void checkUnnamed6(core.List<api.Oci> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOci(o[0]);
  checkOci(o[1]);
}

core.List<api.PythonPackage> buildUnnamed7() => [
  buildPythonPackage(),
  buildPythonPackage(),
];

void checkUnnamed7(core.List<api.PythonPackage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Artifacts buildArtifacts() {
  ...
  if (buildCounterArtifacts < 3) {
    o.genericArtifacts = buildUnnamed1();
    o.goModules = buildUnnamed2();
    o.images = buildUnnamed3();
    o.mavenArtifacts = buildUnnamed4();
    o.npmPackages = buildUnnamed5();
    o.objects = buildArtifactObjects();
    o.oci = buildUnnamed6();
    o.pythonPackages = buildUnnamed7();
  }
  buildCounterArtifacts--;
  return o;
}
...
void checkArtifacts(api.Artifacts o) {
  buildCounterArtifacts++;
  if (buildCounterArtifacts < 3) {
    checkUnnamed1(o.genericArtifacts!);
    checkUnnamed2(o.goModules!);
    checkUnnamed3(o.images!);
    checkUnnamed4(o.mavenArtifacts!);
    checkUnnamed5(o.npmPackages!);
    checkArtifactObjects(o.objects!);
    checkUnnamed6(o.oci!);
    checkUnnamed7(o.pythonPackages!);
  }
  buildCounterArtifacts--;
}
...
core.List<api.CreateGitLabConnectedRepositoryRequest> buildUnnamed9() => [
  buildCreateGitLabConnectedRepositoryRequest(),
  buildCreateGitLabConnectedRepositoryRequest(),
];

void checkUnnamed9(core.List<api.CreateGitLabConnectedRepositoryRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.BitbucketServerRepositoryId> buildUnnamed10() => [
  buildBitbucketServerRepositoryId(),
  buildBitbucketServerRepositoryId(),
];

void checkUnnamed10(core.List<api.BitbucketServerRepositoryId> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BitbucketServerConfig buildBitbucketServerConfig() {
  ...
  if (buildCounterBitbucketServerConfig < 3) {
    o.apiKey = 'foo';
    o.connectedRepositories = buildUnnamed10();
    o.createTime = 'foo';
    o.hostUri = 'foo';
    o.name = 'foo';
    o.peeredNetwork = 'foo';
...
void checkBitbucketServerConfig(api.BitbucketServerConfig o) {
  ...
  if (buildCounterBitbucketServerConfig < 3) {
    ...
    checkUnnamed10(o.connectedRepositories!);
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.hostUri!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.peeredNetwork!, unittest.equals('foo'));
    unittest.expect(o.peeredNetworkIpRange!, unittest.equals('foo'));
    checkBitbucketServerSecrets(o.secrets!);
    unittest.expect(o.sslCa!, unittest.equals('foo'));
    unittest.expect(o.username!, unittest.equals('foo'));
    unittest.expect(o.webhookKey!, unittest.equals('foo'));
  }
  buildCounterBitbucketServerConfig--;
}
...
void checkBitbucketServerRepository(api.BitbucketServerRepository o) {
  buildCounterBitbucketServerRepository++;
  if (buildCounterBitbucketServerRepository < 3) {
    unittest.expect(o.browseUri!, unittest.equals('foo'));
...
void checkBitbucketServerRepositoryId(api.BitbucketServerRepositoryId o) {
  buildCounterBitbucketServerRepositoryId++;
  if (buildCounterBitbucketServerRepositoryId < 3) {
    unittest.expect(o.projectKey!, unittest.equals('foo'));
    unittest.expect(o.repoSlug!, unittest.equals('foo'));
    unittest.expect(o.webhookId!, unittest.equals(42));
  }
  buildCounterBitbucketServerRepositoryId--;
}
...
void checkBitbucketServerSecrets(api.BitbucketServerSecrets o) {
  buildCounterBitbucketServerSecrets++;
  if (buildCounterBitbucketServerSecrets < 3) {
    unittest.expect(o.adminAccessTokenVersionName!, unittest.equals('foo'));
    unittest.expect(o.readAccessTokenVersionName!, unittest.equals('foo'));
    unittest.expect(o.webhookSecretVersionName!, unittest.equals('foo'));
  }
  buildCounterBitbucketServerSecrets--;
}
...
void checkBitbucketServerTriggerConfig(api.BitbucketServerTriggerConfig o) {
  ...
  if (buildCounterBitbucketServerTriggerConfig < 3) {
    ...
    unittest.expect(o.bitbucketServerConfigResource!, unittest.equals('foo'));
    unittest.expect(o.projectKey!, unittest.equals('foo'));
...
core.List<api.Dependency> buildUnnamed11() => [
  buildDependency(),
  buildDependency(),
];

void checkUnnamed11(core.List<api.Dependency> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDependency(o[0]);
  checkDependency(o[1]);
}
...
core.List<api.Secret> buildUnnamed13() => [buildSecret(), buildSecret()];

void checkUnnamed13(core.List<api.Secret> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSecret(o[0]);
  checkSecret(o[1]);
}

core.List<api.BuildStep> buildUnnamed14() => [
  buildBuildStep(),
  buildBuildStep(),
];

void checkUnnamed14(core.List<api.BuildStep> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuildStep(o[0]);
  checkBuildStep(o[1]);
}
...
core.Map<core.String, api.TimeSpan> buildUnnamed17() => {
  'x': buildTimeSpan(),
  'y': buildTimeSpan(),
};

void checkUnnamed17(core.Map<core.String, api.TimeSpan> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTimeSpan(o['x']!);
  checkTimeSpan(o['y']!);
}

core.List<api.Warning> buildUnnamed18() => [buildWarning(), buildWarning()];

void checkUnnamed18(core.List<api.Warning> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWarning(o[0]);
  checkWarning(o[1]);
}
...
api.Build buildBuild() {
  ...
  if (buildCounterBuild < 3) {
    ...
    o.status = 'foo';
    o.statusDetail = 'foo';
    o.steps = buildUnnamed14();
    o.substitutions = buildUnnamed15();
    o.tags = buildUnnamed16();
    o.timeout = 'foo';
    o.timing = buildUnnamed17();
...
void checkBuild(api.Build o) {
  ...
  if (buildCounterBuild < 3) {
    ...
    checkUnnamed14(o.steps!);
    checkUnnamed15(o.substitutions!);
    checkUnnamed16(o.tags!);
    unittest.expect(o.timeout!, unittest.equals('foo'));
    checkUnnamed17(o.timing!);
...
core.List<api.Volume> buildUnnamed22() => [buildVolume(), buildVolume()];
...
api.BuildOptions buildBuildOptions() {
  ...
  if (buildCounterBuildOptions < 3) {
    ...
    o.enableStructuredLogging = true;
    ...
    o.secretEnv = buildUnnamed20();
    o.sourceProvenanceHash = buildUnnamed21();
...
void checkBuildOptions(api.BuildOptions o) {
  ...
  if (buildCounterBuildOptions < 3) {
    ...
    unittest.expect(o.defaultLogsBucketBehavior!, unittest.equals('foo'));
    unittest.expect(o.diskSizeGb!, unittest.equals('foo'));
    unittest.expect(o.dynamicSubstitutions!, unittest.isTrue);
    unittest.expect(o.enableStructuredLogging!, unittest.isTrue);
    ...
    checkUnnamed20(o.secretEnv!);
    checkUnnamed21(o.sourceProvenanceHash!);
...
api.BuildStep buildBuildStep() {
  ...
  if (buildCounterBuildStep < 3) {
    o.allowExitCodes = buildUnnamed23();
    o.allowFailure = true;
    o.args = buildUnnamed24();
    o.automapSubstitutions = true;
    o.dir = 'foo';
    o.entrypoint = 'foo';
    o.env = buildUnnamed25();
    o.exitCode = 42;
    o.id = 'foo';
    o.name = 'foo';
    o.pullTiming = buildTimeSpan();
    o.script = 'foo';
    o.secretEnv = buildUnnamed26();
    o.status = 'foo';
    o.timeout = 'foo';
    o.timing = buildTimeSpan();
    o.volumes = buildUnnamed27();
    o.waitFor = buildUnnamed28();
  }
  buildCounterBuildStep--;
  return o;
}
...
void checkBuildStep(api.BuildStep o) {
  buildCounterBuildStep++;
  if (buildCounterBuildStep < 3) {
    checkUnnamed23(o.allowExitCodes!);
...
api.BuildTrigger buildBuildTrigger() {
  ...
  if (buildCounterBuildTrigger < 3) {
    ...
    o.id = 'foo';
    o.ignoredFiles = buildUnnamed29();
    o.includeBuildLogs = 'foo';
    o.includedFiles = buildUnnamed30();
    o.name = 'foo';
    ...
    o.substitutions = buildUnnamed31();
...
void checkBuildTrigger(api.BuildTrigger o) {
  ...
  if (buildCounterBuildTrigger < 3) {
    ...
    unittest.expect(o.id!, unittest.equals('foo'));
    checkUnnamed29(o.ignoredFiles!);
    unittest.expect(o.includeBuildLogs!, unittest.equals('foo'));
    checkUnnamed30(o.includedFiles!);
    unittest.expect(o.name!, unittest.equals('foo'));
    ...
    checkUnnamed31(o.substitutions!);
...
void checkBuiltImage(api.BuiltImage o) {
  ...
  if (buildCounterBuiltImage < 3) {
    ...
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.ociMediaType!, unittest.equals('foo'));
...
api.Dependency buildDependency() {
  ...
  if (buildCounterDependency < 3) {
    o.empty = true;
    o.genericArtifact = buildGenericArtifactDependency();
    o.gitSource = buildGitSourceDependency();
  }
  buildCounterDependency--;
  return o;
}
...
void checkDependency(api.Dependency o) {
  buildCounterDependency++;
  if (buildCounterDependency < 3) {
    unittest.expect(o.empty!, unittest.isTrue);
    checkGenericArtifactDependency(o.genericArtifact!);
    checkGitSourceDependency(o.gitSource!);
  }
  buildCounterDependency--;
}
...
void checkDeveloperConnectEventConfig(api.DeveloperConnectEventConfig o) {
  ...
  if (buildCounterDeveloperConnectEventConfig < 3) {
    unittest.expect(o.gitRepositoryLink!, unittest.equals('foo'));
    unittest.expect(o.gitRepositoryLinkType!, unittest.equals('foo'));
    checkPullRequestFilter(o.pullRequest!);
    checkPushFilter(o.push!);
  }
  buildCounterDeveloperConnectEventConfig--;
...
core.List<api.Hash> buildUnnamed33() => [buildHash(), buildHash()];

void checkUnnamed33(core.List<api.Hash> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHash(o[0]);
  checkHash(o[1]);
}
...
void checkFileHashes(api.FileHashes o) {
  buildCounterFileHashes++;
  if (buildCounterFileHashes < 3) {
    checkUnnamed33(o.fileHash!);
  }
  buildCounterFileHashes--;
}

core.int buildCounterGenericArtifact = 0;
api.GenericArtifact buildGenericArtifact() {
  final o = api.GenericArtifact();
  buildCounterGenericArtifact++;
  if (buildCounterGenericArtifact < 3) {
    o.folder = 'foo';
    o.registryPath = 'foo';
  }
  buildCounterGenericArtifact--;
...
void checkGenericArtifact(api.GenericArtifact o) {
  buildCounterGenericArtifact++;
  if (buildCounterGenericArtifact < 3) {
    unittest.expect(o.folder!, unittest.equals('foo'));
    unittest.expect(o.registryPath!, unittest.equals('foo'));
  }
  buildCounterGenericArtifact--;
}

core.int buildCounterGenericArtifactDependency = 0;
api.GenericArtifactDependency buildGenericArtifactDependency() {
  final o = api.GenericArtifactDependency();
  buildCounterGenericArtifactDependency++;
  if (buildCounterGenericArtifactDependency < 3) {
    o.destPath = 'foo';
    o.resource = 'foo';
  }
  buildCounterGenericArtifactDependency--;
...
void checkGenericArtifactDependency(api.GenericArtifactDependency o) {
  buildCounterGenericArtifactDependency++;
  if (buildCounterGenericArtifactDependency < 3) {
    unittest.expect(o.destPath!, unittest.equals('foo'));
...
void checkGitFileSource(api.GitFileSource o) {
  buildCounterGitFileSource++;
  if (buildCounterGitFileSource < 3) {
    unittest.expect(o.bitbucketServerConfig!, unittest.equals('foo'));
    unittest.expect(o.githubEnterpriseConfig!, unittest.equals('foo'));
    unittest.expect(o.path!, unittest.equals('foo'));
    unittest.expect(o.repoType!, unittest.equals('foo'));
    unittest.expect(o.repository!, unittest.equals('foo'));
    unittest.expect(o.revision!, unittest.equals('foo'));
...
void checkGitHubEnterpriseConfig(api.GitHubEnterpriseConfig o) {
  ...
  if (buildCounterGitHubEnterpriseConfig < 3) {
    ...
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.displayName!, unittest.equals('foo'));
    unittest.expect(o.hostUrl!, unittest.equals('foo'));
    unittest.expect(o.name!, unittest.equals('foo'));
    unittest.expect(o.peeredNetwork!, unittest.equals('foo'));
...
void checkGitHubEnterpriseSecrets(api.GitHubEnterpriseSecrets o) {
  buildCounterGitHubEnterpriseSecrets++;
  if (buildCounterGitHubEnterpriseSecrets < 3) {
    unittest.expect(o.oauthClientIdName!, unittest.equals('foo'));
    unittest.expect(o.oauthClientIdVersionName!, unittest.equals('foo'));
    unittest.expect(o.oauthSecretName!, unittest.equals('foo'));
    unittest.expect(o.oauthSecretVersionName!, unittest.equals('foo'));
    unittest.expect(o.privateKeyName!, unittest.equals('foo'));
    unittest.expect(o.privateKeyVersionName!, unittest.equals('foo'));
    unittest.expect(o.webhookSecretName!, unittest.equals('foo'));
    unittest.expect(o.webhookSecretVersionName!, unittest.equals('foo'));
  }
  buildCounterGitHubEnterpriseSecrets--;
}
...
void checkGitHubEventsConfig(api.GitHubEventsConfig o) {
  buildCounterGitHubEventsConfig++;
  if (buildCounterGitHubEventsConfig < 3) {
    unittest.expect(o.enterpriseConfigResourceName!, unittest.equals('foo'));
...
core.List<api.GitLabRepositoryId> buildUnnamed34() => [
  buildGitLabRepositoryId(),
  buildGitLabRepositoryId(),
];

void checkUnnamed34(core.List<api.GitLabRepositoryId> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GitLabConfig buildGitLabConfig() {
  ...
  if (buildCounterGitLabConfig < 3) {
    o.connectedRepositories = buildUnnamed34();
    o.createTime = 'foo';
...
void checkGitLabConfig(api.GitLabConfig o) {
  buildCounterGitLabConfig++;
  if (buildCounterGitLabConfig < 3) {
    checkUnnamed34(o.connectedRepositories!);
    unittest.expect(o.createTime!, unittest.equals('foo'));
...
void checkGitLabEventsConfig(api.GitLabEventsConfig o) {
  ...
  if (buildCounterGitLabEventsConfig < 3) {
    ...
    unittest.expect(o.gitlabConfigResource!, unittest.equals('foo'));
    unittest.expect(o.projectNamespace!, unittest.equals('foo'));
    checkPullRequestFilter(o.pullRequest!);
    checkPushFilter(o.push!);
  }
  buildCounterGitLabEventsConfig--;
...
void checkGitLabSecrets(api.GitLabSecrets o) {
  buildCounterGitLabSecrets++;
  if (buildCounterGitLabSecrets < 3) {
    unittest.expect(o.apiAccessTokenVersion!, unittest.equals('foo'));
    unittest.expect(o.apiKeyVersion!, unittest.equals('foo'));
    unittest.expect(o.readAccessTokenVersion!, unittest.equals('foo'));
    unittest.expect(o.webhookSecretVersion!, unittest.equals('foo'));
  }
  buildCounterGitLabSecrets--;
}
...
core.int buildCounterGitSourceDependency = 0;
api.GitSourceDependency buildGitSourceDependency() {
  final o = api.GitSourceDependency();
  buildCounterGitSourceDependency++;
  if (buildCounterGitSourceDependency < 3) {
    o.depth = 'foo';
    o.destPath = 'foo';
    o.recurseSubmodules = true;
    o.repository = buildGitSourceRepository();
    o.revision = 'foo';
  }
  buildCounterGitSourceDependency--;
  return o;
...
void checkGitSourceDependency(api.GitSourceDependency o) {
  buildCounterGitSourceDependency++;
  if (buildCounterGitSourceDependency < 3) {
    unittest.expect(o.depth!, unittest.equals('foo'));
    unittest.expect(o.destPath!, unittest.equals('foo'));
    unittest.expect(o.recurseSubmodules!, unittest.isTrue);
    checkGitSourceRepository(o.repository!);
    unittest.expect(o.revision!, unittest.equals('foo'));
  }
  buildCounterGitSourceDependency--;
}

core.int buildCounterGitSourceRepository = 0;
api.GitSourceRepository buildGitSourceRepository() {
  final o = api.GitSourceRepository();
  buildCounterGitSourceRepository++;
  if (buildCounterGitSourceRepository < 3) {
    o.developerConnect = 'foo';
    o.url = 'foo';
  }
  buildCounterGitSourceRepository--;
  return o;
...
void checkGitSourceRepository(api.GitSourceRepository o) {
  buildCounterGitSourceRepository++;
  if (buildCounterGitSourceRepository < 3) {
    unittest.expect(o.developerConnect!, unittest.equals('foo'));
    unittest.expect(o.url!, unittest.equals('foo'));
  }
  buildCounterGitSourceRepository--;
}

core.int buildCounterGoModule = 0;
api.GoModule buildGoModule() {
  final o = api.GoModule();
  buildCounterGoModule++;
  if (buildCounterGoModule < 3) {
    o.modulePath = 'foo';
    o.moduleVersion = 'foo';
    o.repositoryLocation = 'foo';
    o.repositoryName = 'foo';
    o.repositoryProjectId = 'foo';
    o.sourcePath = 'foo';
  }
  buildCounterGoModule--;
  return o;
...
void checkGoModule(api.GoModule o) {
  buildCounterGoModule++;
  if (buildCounterGoModule < 3) {
    unittest.expect(o.modulePath!, unittest.equals('foo'));
    unittest.expect(o.moduleVersion!, unittest.equals('foo'));
    unittest.expect(o.repositoryLocation!, unittest.equals('foo'));
    unittest.expect(o.repositoryName!, unittest.equals('foo'));
    unittest.expect(o.repositoryProjectId!, unittest.equals('foo'));
...
void checkHttpConfig(api.HttpConfig o) {
  buildCounterHttpConfig++;
  if (buildCounterHttpConfig < 3) {
    unittest.expect(o.proxySecretVersionName!, unittest.equals('foo'));
  }
  buildCounterHttpConfig--;
}
...
void checkInlineSecret(api.InlineSecret o) {
  buildCounterInlineSecret++;
  if (buildCounterInlineSecret < 3) {
    checkUnnamed37(o.envMap!);
    unittest.expect(o.kmsKeyName!, unittest.equals('foo'));
  }
  buildCounterInlineSecret--;
}

core.List<api.BitbucketServerConfig> buildUnnamed38() => [
  buildBitbucketServerConfig(),
  buildBitbucketServerConfig(),
];

void checkUnnamed38(core.List<api.BitbucketServerConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListBitbucketServerConfigsResponse() {
  ...
  if (buildCounterListBitbucketServerConfigsResponse < 3) {
    o.bitbucketServerConfigs = buildUnnamed38();
    o.nextPageToken = 'foo';
  }
  buildCounterListBitbucketServerConfigsResponse--;
  return o;
...
void checkListBitbucketServerConfigsResponse(
  ...
  buildCounterListBitbucketServerConfigsResponse++;
  if (buildCounterListBitbucketServerConfigsResponse < 3) {
    checkUnnamed38(o.bitbucketServerConfigs!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListBitbucketServerConfigsResponse--;
}

core.List<api.BitbucketServerRepository> buildUnnamed39() => [
  buildBitbucketServerRepository(),
  buildBitbucketServerRepository(),
];

void checkUnnamed39(core.List<api.BitbucketServerRepository> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListBitbucketServerRepositoriesResponse() {
  ...
  if (buildCounterListBitbucketServerRepositoriesResponse < 3) {
    o.bitbucketServerRepositories = buildUnnamed39();
    o.nextPageToken = 'foo';
  }
  buildCounterListBitbucketServerRepositoriesResponse--;
  return o;
...
void checkListBitbucketServerRepositoriesResponse(
  ...
  buildCounterListBitbucketServerRepositoriesResponse++;
  if (buildCounterListBitbucketServerRepositoriesResponse < 3) {
    checkUnnamed39(o.bitbucketServerRepositories!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListBitbucketServerRepositoriesResponse--;
}

core.List<api.BuildTrigger> buildUnnamed40() => [
  buildBuildTrigger(),
  buildBuildTrigger(),
];

void checkUnnamed40(core.List<api.BuildTrigger> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Build> buildUnnamed41() => [buildBuild(), buildBuild()];

void checkUnnamed41(core.List<api.Build> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuild(o[0]);
  checkBuild(o[1]);
}
...
void checkListBuildsResponse(api.ListBuildsResponse o) {
  buildCounterListBuildsResponse++;
  if (buildCounterListBuildsResponse < 3) {
    checkUnnamed41(o.builds!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListBuildsResponse--;
}

core.List<api.GitLabConfig> buildUnnamed42() => [
  buildGitLabConfig(),
  buildGitLabConfig(),
];

void checkUnnamed42(core.List<api.GitLabConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListGitLabConfigsResponse buildListGitLabConfigsResponse() {
  ...
  if (buildCounterListGitLabConfigsResponse < 3) {
    o.gitlabConfigs = buildUnnamed42();
    o.nextPageToken = 'foo';
  }
  buildCounterListGitLabConfigsResponse--;
  return o;
...
void checkListGitLabConfigsResponse(api.ListGitLabConfigsResponse o) {
  buildCounterListGitLabConfigsResponse++;
  if (buildCounterListGitLabConfigsResponse < 3) {
    checkUnnamed42(o.gitlabConfigs!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListGitLabConfigsResponse--;
}

core.List<api.GitLabRepository> buildUnnamed43() => [
  buildGitLabRepository(),
  buildGitLabRepository(),
];

void checkUnnamed43(core.List<api.GitLabRepository> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListGitLabRepositoriesResponse buildListGitLabRepositoriesResponse() {
  ...
  if (buildCounterListGitLabRepositoriesResponse < 3) {
    o.gitlabRepositories = buildUnnamed43();
    o.nextPageToken = 'foo';
  }
  buildCounterListGitLabRepositoriesResponse--;
  return o;
...
void checkListGitLabRepositoriesResponse(api.ListGitLabRepositoriesResponse o) {
  buildCounterListGitLabRepositoriesResponse++;
  if (buildCounterListGitLabRepositoriesResponse < 3) {
    checkUnnamed43(o.gitlabRepositories!);
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
  }
  buildCounterListGitLabRepositoriesResponse--;
}

core.List<api.GitHubEnterpriseConfig> buildUnnamed44() => [
  buildGitHubEnterpriseConfig(),
  buildGitHubEnterpriseConfig(),
];

void checkUnnamed44(core.List<api.GitHubEnterpriseConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.WorkerPool> buildUnnamed45() => [
  buildWorkerPool(),
  buildWorkerPool(),
];

void checkUnnamed45(core.List<api.WorkerPool> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWorkerPool(o[0]);
  checkWorkerPool(o[1]);
}
...
void checkNetworkConfig(api.NetworkConfig o) {
  buildCounterNetworkConfig++;
  if (buildCounterNetworkConfig < 3) {
    unittest.expect(o.egressOption!, unittest.equals('foo'));
    unittest.expect(o.peeredNetwork!, unittest.equals('foo'));
    unittest.expect(o.peeredNetworkIpRange!, unittest.equals('foo'));
  }
  buildCounterNetworkConfig--;
...
core.int buildCounterOci = 0;
api.Oci buildOci() {
  final o = api.Oci();
  buildCounterOci++;
  if (buildCounterOci < 3) {
    o.file = 'foo';
    o.registryPath = 'foo';
...
api.RepoSource buildRepoSource() {
  ...
  if (buildCounterRepoSource < 3) {
    ...
    o.projectId = 'foo';
    o.repoName = 'foo';
    o.substitutions = buildUnnamed50();
    o.tagName = 'foo';
  }
  buildCounterRepoSource--;
  return o;
...
void checkRepoSource(api.RepoSource o) {
  ...
  if (buildCounterRepoSource < 3) {
    ...
    checkUnnamed50(o.substitutions!);
...
void checkRepositoryEventConfig(api.RepositoryEventConfig o) {
  ...
  if (buildCounterRepositoryEventConfig < 3) {
    ...
    checkPushFilter(o.push!);
    unittest.expect(o.repository!, unittest.equals('foo'));
    unittest.expect(o.repositoryType!, unittest.equals('foo'));
  }
  buildCounterRepositoryEventConfig--;
}
...
core.List<api.UploadedGenericArtifact> buildUnnamed53() => [
  buildUploadedGenericArtifact(),
  buildUploadedGenericArtifact(),
];

void checkUnnamed53(core.List<api.UploadedGenericArtifact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUploadedGenericArtifact(o[0]);
  checkUploadedGenericArtifact(o[1]);
}

core.List<api.UploadedGoModule> buildUnnamed54() => [
  buildUploadedGoModule(),
  buildUploadedGoModule(),
];

void checkUnnamed54(core.List<api.UploadedGoModule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUploadedGoModule(o[0]);
  checkUploadedGoModule(o[1]);
}

core.List<api.BuiltImage> buildUnnamed55() => [
  buildBuiltImage(),
  buildBuiltImage(),
];

void checkUnnamed55(core.List<api.BuiltImage> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBuiltImage(o[0]);
  checkBuiltImage(o[1]);
}

core.List<api.UploadedMavenArtifact> buildUnnamed56() => [
  buildUploadedMavenArtifact(),
  buildUploadedMavenArtifact(),
];

void checkUnnamed56(core.List<api.UploadedMavenArtifact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUploadedMavenArtifact(o[0]);
  checkUploadedMavenArtifact(o[1]);
}

core.List<api.UploadedNpmPackage> buildUnnamed57() => [
  buildUploadedNpmPackage(),
  buildUploadedNpmPackage(),
];

void checkUnnamed57(core.List<api.UploadedNpmPackage> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUploadedNpmPackage(o[0]);
  checkUploadedNpmPackage(o[1]);
}

core.List<api.UploadedPythonPackage> buildUnnamed58() => [
  buildUploadedPythonPackage(),
  buildUploadedPythonPackage(),
];

void checkUnnamed58(core.List<api.UploadedPythonPackage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Results buildResults() {
  ...
  if (buildCounterResults < 3) {
    ...
    o.buildStepImages = buildUnnamed51();
    o.buildStepOutputs = buildUnnamed52();
    o.genericArtifacts = buildUnnamed53();
    o.goModules = buildUnnamed54();
    o.images = buildUnnamed55();
    o.mavenArtifacts = buildUnnamed56();
    o.npmPackages = buildUnnamed57();
    o.numArtifacts = 'foo';
    o.pythonPackages = buildUnnamed58();
  }
  buildCounterResults--;
  return o;
}
...
void checkResults(api.Results o) {
  ...
  if (buildCounterResults < 3) {
    ...
    checkUnnamed51(o.buildStepImages!);
    checkUnnamed52(o.buildStepOutputs!);
    checkUnnamed53(o.genericArtifacts!);
    checkUnnamed54(o.goModules!);
    checkUnnamed55(o.images!);
    checkUnnamed56(o.mavenArtifacts!);
    checkUnnamed57(o.npmPackages!);
    unittest.expect(o.numArtifacts!, unittest.equals('foo'));
    checkUnnamed58(o.pythonPackages!);
  }
  buildCounterResults--;
}
...
core.List<api.InlineSecret> buildUnnamed60() => [
  buildInlineSecret(),
  buildInlineSecret(),
];

void checkUnnamed60(core.List<api.InlineSecret> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInlineSecret(o[0]);
  checkInlineSecret(o[1]);
}

core.List<api.SecretManagerSecret> buildUnnamed61() => [
  buildSecretManagerSecret(),
  buildSecretManagerSecret(),
];

void checkUnnamed61(core.List<api.SecretManagerSecret> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Secrets buildSecrets() {
  ...
  if (buildCounterSecrets < 3) {
    o.inline = buildUnnamed60();
    o.secretManager = buildUnnamed61();
  }
  buildCounterSecrets--;
  return o;
}
...
void checkSecrets(api.Secrets o) {
  buildCounterSecrets++;
  if (buildCounterSecrets < 3) {
    checkUnnamed60(o.inline!);
    checkUnnamed61(o.secretManager!);
  }
  buildCounterSecrets--;
}
...
core.Map<core.String, api.FileHashes> buildUnnamed62() => {
  'x': buildFileHashes(),
  'y': buildFileHashes(),
};

void checkUnnamed62(core.Map<core.String, api.FileHashes> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFileHashes(o['x']!);
  checkFileHashes(o['y']!);
}
...
void checkStorageSource(api.StorageSource o) {
  ...
  if (buildCounterStorageSource < 3) {
    ...
    unittest.expect(o.sourceFetcher!, unittest.equals('foo'));
  }
  buildCounterStorageSource--;
}
...
core.int buildCounterUploadedGenericArtifact = 0;
api.UploadedGenericArtifact buildUploadedGenericArtifact() {
  final o = api.UploadedGenericArtifact();
  buildCounterUploadedGenericArtifact++;
  if (buildCounterUploadedGenericArtifact < 3) {
    o.artifactFingerprint = buildFileHashes();
    o.artifactRegistryPackage = 'foo';
...
void checkUploadedGenericArtifact(api.UploadedGenericArtifact o) {
  buildCounterUploadedGenericArtifact++;
  if (buildCounterUploadedGenericArtifact < 3) {
    checkFileHashes(o.artifactFingerprint!);
    unittest.expect(o.artifactRegistryPackage!, unittest.equals('foo'));
...
core.int buildCounterUploadedGoModule = 0;
api.UploadedGoModule buildUploadedGoModule() {
...
void main() {
  ...
  unittest.group('obj-schema-Artifacts', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Artifacts.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkArtifacts(od);
    });
  ...
  unittest.group(
    'obj-schema-BatchCreateGitLabConnectedRepositoriesRequest',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group('obj-schema-BuildStep', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.BuildStep.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkBuildStep(od);
    });
  ...
  unittest.group('obj-schema-BuiltImage', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.BuiltImage.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkBuiltImage(od);
    });
  ...
  unittest.group(
    'obj-schema-CreateBitbucketServerConnectedRepositoryRequest',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group('obj-schema-GenericArtifact', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGenericArtifact();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GenericArtifact.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGenericArtifact(od);
    });
  });

  unittest.group('obj-schema-GenericArtifactDependency', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGenericArtifactDependency();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GenericArtifactDependency.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGenericArtifactDependency(od);
    });
  });
  ...
  unittest.group('obj-schema-GitConfig', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GitConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGitConfig(od);
    });
  ...
  unittest.group('obj-schema-GitSourceDependency', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGitSourceDependency();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GitSourceDependency.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGitSourceDependency(od);
    });
  });

  unittest.group('obj-schema-GitSourceRepository', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGitSourceRepository();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GitSourceRepository.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGitSourceRepository(od);
    });
  });

  unittest.group('obj-schema-GoModule', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoModule();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoModule.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGoModule(od);
    });
  ...
  unittest.group('obj-schema-HttpConfig', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.HttpConfig.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkHttpConfig(od);
    });
  ...
  unittest.group('obj-schema-Oci', () {
    unittest.test('to-json--from-json', () async {
      final o = buildOci();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.Oci.fromJson(oJson as core.Map<core.String, core.dynamic>);
      checkOci(od);
    });
  });
  ...
  unittest.group('obj-schema-PoolOption', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.PoolOption.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPoolOption(od);
    });
  ...
  unittest.group('obj-schema-PushFilter', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.PushFilter.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkPushFilter(od);
    });
  ...
  unittest.group(
    'obj-schema-RemoveBitbucketServerConnectedRepositoryRequest',
    () {
      unittest.test('to-json--from-json', () async {
  ...
  unittest.group('obj-schema-TimeSpan', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.TimeSpan.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkTimeSpan(od);
    });
  ...
  unittest.group('obj-schema-UploadedGenericArtifact', () {
    unittest.test('to-json--from-json', () async {
      final o = buildUploadedGenericArtifact();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.UploadedGenericArtifact.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkUploadedGenericArtifact(od);
    });
  });

  unittest.group('obj-schema-UploadedGoModule', () {
    unittest.test('to-json--from-json', () async {
      final o = buildUploadedGoModule();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.UploadedGoModule.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkUploadedGoModule(od);
    });
  });
  ...
  unittest.group('resource-GithubDotComWebhookResource', () {
    unittest.test('method--receive', () async {
      ...
      final response = await res.receive(
        arg_request,
  ...
  unittest.group('resource-LocationsResource', () {
    unittest.test('method--regionalWebhook', () async {
      ...
      final response = await res.regionalWebhook(
        arg_request,
        arg_location,
        webhookKey: arg_webhookKey,
        $fields: arg_$fields,
  ...
  unittest.group('resource-ProjectsLocationsResource', () {
    unittest.test('method--getDefaultServiceAccount', () async {
      ...
      final response = await res.getDefaultServiceAccount(
        arg_name,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-ProjectsLocationsGitLabConfigsResource', () {
    unittest.test('method--create', () async {
      ...
      final response = await res.create(
        arg_request,
        arg_parent,
        gitlabConfigId: arg_gitlabConfigId,
        $fields: arg_$fields,
      );
      checkOperation(response as api.Operation);
    });
    ...
    unittest.test('method--list', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildListGitLabRepositoriesResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
    ...
    unittest.test('method--webhook', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final h = {'content-type': 'application/json; charset=utf-8'};
          final resp = convert.json.encode(
            buildReceiveTriggerWebhookResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
    ...
    unittest.test('method--webhook', () async {
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          pathOffset = index;
          unittest.expect(subPart, unittest.equals('$arg_trigger'));
          unittest.expect(
            path.substring(pathOffset, pathOffset + 8),
