...
core.List<api.AspectRule> buildUnnamed3() => [
  buildAspectRule(),
  buildAspectRule(),
];

void checkUnnamed3(core.List<api.AspectRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAspectRule(o[0]);
  checkAspectRule(o[1]);
}
...
api.Aspect buildAspect() {
  ...
  if (buildCounterAspect < 3) {
    o.kind = 'foo';
    o.rules = buildUnnamed3();
    o.spec = buildUnnamed4();
  }
  buildCounterAspect--;
  return o;
}
...
void checkAspect(api.Aspect o) {
  ...
  if (buildCounterAspect < 3) {
    ...
    checkUnnamed3(o.rules!);
    checkUnnamed4(o.spec!);
  }
  buildCounterAspect--;
}
...
core.int buildCounterAspectRule = 0;
api.AspectRule buildAspectRule() {
  final o = api.AspectRule();
  buildCounterAspectRule++;
  if (buildCounterAspectRule < 3) {
    o.config = buildUnnamed5();
    o.selector = 'foo';
  }
  buildCounterAspectRule--;
  return o;
...
void checkAspectRule(api.AspectRule o) {
  buildCounterAspectRule++;
  if (buildCounterAspectRule < 3) {
    checkUnnamed5(o.config!);
    unittest.expect(o.selector!, unittest.equals('foo'));
  }
  buildCounterAspectRule--;
}

core.List<api.AuditLogConfig> buildUnnamed6() => [
  buildAuditLogConfig(),
  buildAuditLogConfig(),
];

void checkUnnamed6(core.List<api.AuditLogConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, api.BackendRule> buildUnnamed13() => {
  'x': buildBackendRule(),
  'y': buildBackendRule(),
};

void checkUnnamed13(core.Map<core.String, api.BackendRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BackendRule buildBackendRule() {
  ...
  if (buildCounterBackendRule < 3) {
    ...
    o.overridesByRequestProtocol = buildUnnamed13();
...
void checkBackendRule(api.BackendRule o) {
  ...
  if (buildCounterBackendRule < 3) {
    ...
    checkUnnamed13(o.overridesByRequestProtocol!);
...
api.BatchingDescriptorProto buildBatchingDescriptorProto() {
  ...
  if (buildCounterBatchingDescriptorProto < 3) {
    o.batchedField = 'foo';
    o.discriminatorFields = buildUnnamed14();
...
void checkBatchingDescriptorProto(api.BatchingDescriptorProto o) {
  ...
  if (buildCounterBatchingDescriptorProto < 3) {
    ...
    checkUnnamed14(o.discriminatorFields!);
...
core.List<api.ConfigChange> buildUnnamed18() => [
  buildConfigChange(),
  buildConfigChange(),
];

void checkUnnamed18(core.List<api.ConfigChange> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ChangeReport buildChangeReport() {
  ...
  if (buildCounterChangeReport < 3) {
    o.configChanges = buildUnnamed18();
  }
  buildCounterChangeReport--;
  return o;
}
...
void checkChangeReport(api.ChangeReport o) {
  buildCounterChangeReport++;
  if (buildCounterChangeReport < 3) {
    checkUnnamed18(o.configChanges!);
  }
  buildCounterChangeReport--;
}
...
core.List<api.Advice> buildUnnamed20() => [buildAdvice(), buildAdvice()];

void checkUnnamed20(core.List<api.Advice> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdvice(o[0]);
  checkAdvice(o[1]);
}
...
core.List<api.ConfigFile> buildUnnamed21() => [
  buildConfigFile(),
  buildConfigFile(),
];

void checkUnnamed21(core.List<api.ConfigFile> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkConfigFile(o[0]);
  checkConfigFile(o[1]);
}
...
core.List<api.ContextRule> buildUnnamed22() => [
  buildContextRule(),
  buildContextRule(),
];

void checkUnnamed22(core.List<api.ContextRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ContextRule buildContextRule() {
  ...
  if (buildCounterContextRule < 3) {
    o.allowedRequestExtensions = buildUnnamed23();
    o.allowedResponseExtensions = buildUnnamed24();
    o.provided = buildUnnamed25();
    o.requested = buildUnnamed26();
    o.selector = 'foo';
  }
  buildCounterContextRule--;
  return o;
...
void checkContextRule(api.ContextRule o) {
  buildCounterContextRule++;
  if (buildCounterContextRule < 3) {
    checkUnnamed23(o.allowedRequestExtensions!);
    checkUnnamed24(o.allowedResponseExtensions!);
    checkUnnamed25(o.provided!);
    checkUnnamed26(o.requested!);
    unittest.expect(o.selector!, unittest.equals('foo'));
  }
  buildCounterContextRule--;
}

core.List<api.MethodPolicy> buildUnnamed27() => [
  buildMethodPolicy(),
  buildMethodPolicy(),
];

void checkUnnamed27(core.List<api.MethodPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Control buildControl() {
  ...
  if (buildCounterControl < 3) {
    o.environment = 'foo';
    o.methodPolicies = buildUnnamed27();
  }
  buildCounterControl--;
  return o;
}
...
void checkControl(api.Control o) {
  ...
  if (buildCounterControl < 3) {
    ...
    checkUnnamed27(o.methodPolicies!);
  }
  buildCounterControl--;
}
...
core.List<api.CustomErrorRule> buildUnnamed28() => [
  buildCustomErrorRule(),
  buildCustomErrorRule(),
];

void checkUnnamed28(core.List<api.CustomErrorRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.DocumentationRule> buildUnnamed31() => [
  buildDocumentationRule(),
  buildDocumentationRule(),
];

void checkUnnamed31(core.List<api.DocumentationRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDocumentationRule(o[0]);
  checkDocumentationRule(o[1]);
}

core.List<api.Page> buildUnnamed32() => [buildPage(), buildPage()];

void checkUnnamed32(core.List<api.Page> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPage(o[0]);
  checkPage(o[1]);
}
...
api.Documentation buildDocumentation() {
  ...
  if (buildCounterDocumentation < 3) {
    ...
    o.overview = 'foo';
    o.pages = buildUnnamed30();
    o.rules = buildUnnamed31();
    o.sectionOverrides = buildUnnamed32();
...
void checkDocumentation(api.Documentation o) {
  ...
  if (buildCounterDocumentation < 3) {
    ...
    checkUnnamed30(o.pages!);
    checkUnnamed31(o.rules!);
    checkUnnamed32(o.sectionOverrides!);
...
api.DotnetSettings buildDotnetSettings() {
  ...
  if (buildCounterDotnetSettings < 3) {
    o.common = buildCommonLanguageSettings();
    o.forcedNamespaceAliases = buildUnnamed33();
    o.handwrittenSignatures = buildUnnamed34();
    o.ignoredResources = buildUnnamed35();
    o.renamedResources = buildUnnamed36();
    o.renamedServices = buildUnnamed37();
  }
  buildCounterDotnetSettings--;
  return o;
}
...
void checkDotnetSettings(api.DotnetSettings o) {
  ...
  if (buildCounterDotnetSettings < 3) {
    checkCommonLanguageSettings(o.common!);
    checkUnnamed33(o.forcedNamespaceAliases!);
    checkUnnamed34(o.handwrittenSignatures!);
    checkUnnamed35(o.ignoredResources!);
    checkUnnamed36(o.renamedResources!);
    checkUnnamed37(o.renamedServices!);
  }
  buildCounterDotnetSettings--;
}
...
core.List<api.EnumValue> buildUnnamed39() => [
  buildEnumValue(),
  buildEnumValue(),
];

void checkUnnamed39(core.List<api.EnumValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEnumValue(o[0]);
  checkEnumValue(o[1]);
}
...
core.List<api.Option> buildUnnamed41() => [buildOption(), buildOption()];
...
core.List<api.Option> buildUnnamed42() => [buildOption(), buildOption()];

void checkUnnamed42(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
api.GenerateConfigReportRequest buildGenerateConfigReportRequest() {
  ...
  if (buildCounterGenerateConfigReportRequest < 3) {
    o.newConfig = buildUnnamed43();
    o.oldConfig = buildUnnamed44();
  }
  buildCounterGenerateConfigReportRequest--;
  return o;
}
...
void checkGenerateConfigReportRequest(api.GenerateConfigReportRequest o) {
  buildCounterGenerateConfigReportRequest++;
  if (buildCounterGenerateConfigReportRequest < 3) {
    checkUnnamed43(o.newConfig!);
    checkUnnamed44(o.oldConfig!);
  }
  buildCounterGenerateConfigReportRequest--;
}

core.List<api.ChangeReport> buildUnnamed45() => [
  buildChangeReport(),
  buildChangeReport(),
];

void checkUnnamed45(core.List<api.ChangeReport> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkChangeReport(o[0]);
  checkChangeReport(o[1]);
}

core.List<api.Diagnostic> buildUnnamed46() => [
  buildDiagnostic(),
  buildDiagnostic(),
];

void checkUnnamed46(core.List<api.Diagnostic> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDiagnostic(o[0]);
  checkDiagnostic(o[1]);
}
...
api.GenerateConfigReportResponse buildGenerateConfigReportResponse() {
  ...
  if (buildCounterGenerateConfigReportResponse < 3) {
    o.changeReports = buildUnnamed45();
    o.diagnostics = buildUnnamed46();
    o.id = 'foo';
    o.serviceName = 'foo';
  }
  buildCounterGenerateConfigReportResponse--;
...
void checkGenerateConfigReportResponse(api.GenerateConfigReportResponse o) {
  buildCounterGenerateConfigReportResponse++;
  if (buildCounterGenerateConfigReportResponse < 3) {
    checkUnnamed45(o.changeReports!);
    checkUnnamed46(o.diagnostics!);
    unittest.expect(o.id!, unittest.equals('foo'));
...
api.GoSettings buildGoSettings() {
  ...
  if (buildCounterGoSettings < 3) {
    o.common = buildCommonLanguageSettings();
    o.renamedServices = buildUnnamed47();
  }
  buildCounterGoSettings--;
  return o;
}
...
void checkGoSettings(api.GoSettings o) {
  ...
  if (buildCounterGoSettings < 3) {
    checkCommonLanguageSettings(o.common!);
    checkUnnamed47(o.renamedServices!);
  }
  buildCounterGoSettings--;
}

core.List<api.HttpRule> buildUnnamed48() => [buildHttpRule(), buildHttpRule()];

void checkUnnamed48(core.List<api.HttpRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHttpRule(o[0]);
  checkHttpRule(o[1]);
}
...
core.List<api.HttpRule> buildUnnamed49() => [buildHttpRule(), buildHttpRule()];

void checkUnnamed49(core.List<api.HttpRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHttpRule(o[0]);
  checkHttpRule(o[1]);
}
...
api.HttpRule buildHttpRule() {
  ...
  if (buildCounterHttpRule < 3) {
    o.additionalBindings = buildUnnamed49();
    o.body = 'foo';
...
void checkHttpRule(api.HttpRule o) {
  buildCounterHttpRule++;
  if (buildCounterHttpRule < 3) {
    checkUnnamed49(o.additionalBindings!);
...
api.JavaSettings buildJavaSettings() {
  ...
  if (buildCounterJavaSettings < 3) {
    ...
    o.serviceClassNames = buildUnnamed50();
  }
  buildCounterJavaSettings--;
  return o;
}
...
void checkJavaSettings(api.JavaSettings o) {
  ...
  if (buildCounterJavaSettings < 3) {
    ...
    checkUnnamed50(o.serviceClassNames!);
  }
  buildCounterJavaSettings--;
}
...
core.List<api.Service> buildUnnamed53() => [buildService(), buildService()];

void checkUnnamed53(core.List<api.Service> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkService(o[0]);
  checkService(o[1]);
}
...
api.ListServiceConfigsResponse buildListServiceConfigsResponse() {
  ...
  if (buildCounterListServiceConfigsResponse < 3) {
    o.nextPageToken = 'foo';
    o.serviceConfigs = buildUnnamed53();
  }
  buildCounterListServiceConfigsResponse--;
  return o;
}
...
void checkListServiceConfigsResponse(api.ListServiceConfigsResponse o) {
  ...
  if (buildCounterListServiceConfigsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed53(o.serviceConfigs!);
  }
  buildCounterListServiceConfigsResponse--;
}

core.List<api.Rollout> buildUnnamed54() => [buildRollout(), buildRollout()];

void checkUnnamed54(core.List<api.Rollout> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRollout(o[0]);
  checkRollout(o[1]);
}
...
void checkListServiceRolloutsResponse(api.ListServiceRolloutsResponse o) {
  ...
  if (buildCounterListServiceRolloutsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed54(o.rollouts!);
  }
  buildCounterListServiceRolloutsResponse--;
}

core.List<api.ManagedService> buildUnnamed55() => [
  buildManagedService(),
  buildManagedService(),
];

void checkUnnamed55(core.List<api.ManagedService> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.LoggingDestination> buildUnnamed57() => [
  buildLoggingDestination(),
  buildLoggingDestination(),
];

void checkUnnamed57(core.List<api.LoggingDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLoggingDestination(o[0]);
  checkLoggingDestination(o[1]);
}

core.List<api.LoggingDestination> buildUnnamed58() => [
  buildLoggingDestination(),
  buildLoggingDestination(),
];

void checkUnnamed58(core.List<api.LoggingDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLoggingDestination(o[0]);
  checkLoggingDestination(o[1]);
}
...
api.Logging buildLogging() {
  ...
  if (buildCounterLogging < 3) {
    o.consumerDestinations = buildUnnamed57();
    o.producerDestinations = buildUnnamed58();
  }
  buildCounterLogging--;
  return o;
}
...
void checkLogging(api.Logging o) {
  buildCounterLogging++;
  if (buildCounterLogging < 3) {
    checkUnnamed57(o.consumerDestinations!);
    checkUnnamed58(o.producerDestinations!);
  }
  buildCounterLogging--;
}
...
core.List<api.Option> buildUnnamed60() => [buildOption(), buildOption()];

void checkUnnamed60(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
core.List<api.FieldPolicy> buildUnnamed61() => [
  buildFieldPolicy(),
  buildFieldPolicy(),
];

void checkUnnamed61(core.List<api.FieldPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MethodPolicy buildMethodPolicy() {
  ...
  if (buildCounterMethodPolicy < 3) {
    o.requestPolicies = buildUnnamed61();
    o.selector = 'foo';
  }
  buildCounterMethodPolicy--;
  return o;
...
void checkMethodPolicy(api.MethodPolicy o) {
  buildCounterMethodPolicy++;
  if (buildCounterMethodPolicy < 3) {
    checkUnnamed61(o.requestPolicies!);
    unittest.expect(o.selector!, unittest.equals('foo'));
  }
  buildCounterMethodPolicy--;
}
...
api.MethodSettings buildMethodSettings() {
  ...
  if (buildCounterMethodSettings < 3) {
    o.autoPopulatedFields = buildUnnamed62();
...
void checkMethodSettings(api.MethodSettings o) {
  buildCounterMethodSettings++;
  if (buildCounterMethodSettings < 3) {
    checkUnnamed62(o.autoPopulatedFields!);
...
api.MetricDescriptor buildMetricDescriptor() {
  ...
  if (buildCounterMetricDescriptor < 3) {
    ...
    o.metricKind = 'foo';
    o.monitoredResourceTypes = buildUnnamed64();
    o.name = 'foo';
    o.type = 'foo';
    o.unit = 'foo';
    o.valueType = 'foo';
...
void checkMetricDescriptor(api.MetricDescriptor o) {
  ...
  if (buildCounterMetricDescriptor < 3) {
    ...
    checkUnnamed64(o.monitoredResourceTypes!);
    unittest.expect(o.name!, unittest.equals('foo'));
...
api.MetricDescriptorMetadata buildMetricDescriptorMetadata() {
  ...
  if (buildCounterMetricDescriptorMetadata < 3) {
    ...
    o.launchStage = 'foo';
    o.samplePeriod = 'foo';
    o.timeSeriesResourceHierarchyLevel = buildUnnamed65();
  }
  buildCounterMetricDescriptorMetadata--;
  return o;
}
...
void checkMetricDescriptorMetadata(api.MetricDescriptorMetadata o) {
  ...
  if (buildCounterMetricDescriptorMetadata < 3) {
    ...
    checkUnnamed65(o.timeSeriesResourceHierarchyLevel!);
  }
  buildCounterMetricDescriptorMetadata--;
}
...
api.MetricRule buildMetricRule() {
  ...
  if (buildCounterMetricRule < 3) {
    o.agenticMetricCosts = buildUnnamed66();
    o.metricCosts = buildUnnamed67();
    o.nonagenticMetricCosts = buildUnnamed68();
    o.selector = 'foo';
  }
  buildCounterMetricRule--;
  return o;
...
void checkMetricRule(api.MetricRule o) {
  buildCounterMetricRule++;
  if (buildCounterMetricRule < 3) {
    checkUnnamed66(o.agenticMetricCosts!);
    checkUnnamed67(o.metricCosts!);
    checkUnnamed68(o.nonagenticMetricCosts!);
    unittest.expect(o.selector!, unittest.equals('foo'));
  }
  buildCounterMetricRule--;
}
...
core.List<api.MonitoringDestination> buildUnnamed70() => [
  buildMonitoringDestination(),
  buildMonitoringDestination(),
];

void checkUnnamed70(core.List<api.MonitoringDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMonitoringDestination(o[0]);
  checkMonitoringDestination(o[1]);
}

core.List<api.MonitoringDestination> buildUnnamed71() => [
  buildMonitoringDestination(),
  buildMonitoringDestination(),
];

void checkUnnamed71(core.List<api.MonitoringDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMonitoringDestination(o[0]);
  checkMonitoringDestination(o[1]);
}
...
api.Monitoring buildMonitoring() {
  ...
  if (buildCounterMonitoring < 3) {
    o.consumerDestinations = buildUnnamed70();
    o.producerDestinations = buildUnnamed71();
  }
  buildCounterMonitoring--;
  return o;
}
...
void checkMonitoring(api.Monitoring o) {
  buildCounterMonitoring++;
  if (buildCounterMonitoring < 3) {
    checkUnnamed70(o.consumerDestinations!);
    checkUnnamed71(o.producerDestinations!);
  }
  buildCounterMonitoring--;
}
...
void checkOption(api.Option o) {
  ...
  if (buildCounterOption < 3) {
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed75(o.value!);
  }
  buildCounterOption--;
}

core.List<api.Page> buildUnnamed76() => [buildPage(), buildPage()];

void checkUnnamed76(core.List<api.Page> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPage(o[0]);
  checkPage(o[1]);
}
...
core.List<api.Binding> buildUnnamed78() => [buildBinding(), buildBinding()];
...
core.List<api.ClientLibrarySettings> buildUnnamed80() => [
  buildClientLibrarySettings(),
  buildClientLibrarySettings(),
];

void checkUnnamed80(core.List<api.ClientLibrarySettings> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkClientLibrarySettings(o[0]);
  checkClientLibrarySettings(o[1]);
}

core.List<api.MethodSettings> buildUnnamed81() => [
  buildMethodSettings(),
  buildMethodSettings(),
];

void checkUnnamed81(core.List<api.MethodSettings> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Publishing buildPublishing() {
  ...
  if (buildCounterPublishing < 3) {
    o.apiShortName = 'foo';
    o.codeownerGithubTeams = buildUnnamed79();
    o.docTagPrefix = 'foo';
    o.documentationUri = 'foo';
    o.githubLabel = 'foo';
    o.librarySettings = buildUnnamed80();
    o.methodSettings = buildUnnamed81();
    o.newIssueUri = 'foo';
    o.organization = 'foo';
...
void checkPublishing(api.Publishing o) {
  ...
  if (buildCounterPublishing < 3) {
    ...
    checkUnnamed79(o.codeownerGithubTeams!);
    ...
    checkUnnamed80(o.librarySettings!);
    checkUnnamed81(o.methodSettings!);
...
core.List<api.QuotaLimit> buildUnnamed82() => [
  buildQuotaLimit(),
  buildQuotaLimit(),
];

void checkUnnamed82(core.List<api.QuotaLimit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQuotaLimit(o[0]);
  checkQuotaLimit(o[1]);
}

core.List<api.MetricRule> buildUnnamed83() => [
  buildMetricRule(),
  buildMetricRule(),
];

void checkUnnamed83(core.List<api.MetricRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetricRule(o[0]);
  checkMetricRule(o[1]);
}
...
api.Quota buildQuota() {
  ...
  if (buildCounterQuota < 3) {
    o.limits = buildUnnamed82();
    o.metricRules = buildUnnamed83();
  }
  buildCounterQuota--;
  return o;
}
...
void checkQuota(api.Quota o) {
  buildCounterQuota++;
  if (buildCounterQuota < 3) {
    checkUnnamed82(o.limits!);
    checkUnnamed83(o.metricRules!);
  }
  buildCounterQuota--;
}
...
void checkSelectiveGapicGeneration(api.SelectiveGapicGeneration o) {
  ...
  if (buildCounterSelectiveGapicGeneration < 3) {
    ...
    checkUnnamed85(o.methods!);
  }
  buildCounterSelectiveGapicGeneration--;
}

core.List<api.Api> buildUnnamed86() => [buildApi(), buildApi()];

void checkUnnamed86(core.List<api.Api> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApi(o[0]);
  checkApi(o[1]);
}

core.List<api.Aspect> buildUnnamed87() => [buildAspect(), buildAspect()];

void checkUnnamed87(core.List<api.Aspect> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAspect(o[0]);
  checkAspect(o[1]);
}

core.List<api.Endpoint> buildUnnamed88() => [buildEndpoint(), buildEndpoint()];

void checkUnnamed88(core.List<api.Endpoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEndpoint(o[0]);
  checkEndpoint(o[1]);
}

core.List<api.Enum> buildUnnamed89() => [buildEnum(), buildEnum()];

void checkUnnamed89(core.List<api.Enum> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEnum(o[0]);
  checkEnum(o[1]);
}

core.List<api.LogDescriptor> buildUnnamed90() => [
  buildLogDescriptor(),
  buildLogDescriptor(),
];

void checkUnnamed90(core.List<api.LogDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogDescriptor(o[0]);
  checkLogDescriptor(o[1]);
}

core.List<api.MetricDescriptor> buildUnnamed91() => [
  buildMetricDescriptor(),
  buildMetricDescriptor(),
];

void checkUnnamed91(core.List<api.MetricDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetricDescriptor(o[0]);
  checkMetricDescriptor(o[1]);
}

core.List<api.MonitoredResourceDescriptor> buildUnnamed92() => [
  buildMonitoredResourceDescriptor(),
  buildMonitoredResourceDescriptor(),
];

void checkUnnamed92(core.List<api.MonitoredResourceDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMonitoredResourceDescriptor(o[0]);
  checkMonitoredResourceDescriptor(o[1]);
}

core.List<api.Type> buildUnnamed93() => [buildType(), buildType()];

void checkUnnamed93(core.List<api.Type> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkType(o[0]);
  checkType(o[1]);
}

core.List<api.Type> buildUnnamed94() => [buildType(), buildType()];

void checkUnnamed94(core.List<api.Type> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkType(o[0]);
  checkType(o[1]);
}
...
api.Service buildService() {
  ...
  if (buildCounterService < 3) {
    o.apis = buildUnnamed86();
    o.aspects = buildUnnamed87();
    ...
    o.endpoints = buildUnnamed88();
    o.enums = buildUnnamed89();
    o.http = buildHttp();
    o.id = 'foo';
    o.logging = buildLogging();
    o.logs = buildUnnamed90();
    o.metrics = buildUnnamed91();
    o.monitoredResources = buildUnnamed92();
    ...
    o.systemTypes = buildUnnamed93();
    o.title = 'foo';
    o.types = buildUnnamed94();
    o.usage = buildUsage();
  }
  buildCounterService--;
  return o;
...
void checkService(api.Service o) {
  buildCounterService++;
  if (buildCounterService < 3) {
    checkUnnamed86(o.apis!);
    checkUnnamed87(o.aspects!);
    ...
    checkUnnamed88(o.endpoints!);
    checkUnnamed89(o.enums!);
    checkHttp(o.http!);
    unittest.expect(o.id!, unittest.equals('foo'));
    checkLogging(o.logging!);
    checkUnnamed90(o.logs!);
    checkUnnamed91(o.metrics!);
    checkUnnamed92(o.monitoredResources!);
    ...
    checkUnnamed93(o.systemTypes!);
    unittest.expect(o.title!, unittest.equals('foo'));
    checkUnnamed94(o.types!);
    checkUsage(o.usage!);
  }
  buildCounterService--;
}
...
core.List<api.SystemParameter> buildUnnamed99() => [
  buildSystemParameter(),
  buildSystemParameter(),
];

void checkUnnamed99(core.List<api.SystemParameter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.SystemParameterRule> buildUnnamed100() => [
  buildSystemParameterRule(),
  buildSystemParameterRule(),
];

void checkUnnamed100(core.List<api.SystemParameterRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.double> buildUnnamed103() => {'x': 42.0, 'y': 42.0};

void checkUnnamed103(core.Map<core.String, core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkTrafficPercentStrategy(api.TrafficPercentStrategy o) {
  buildCounterTrafficPercentStrategy++;
  if (buildCounterTrafficPercentStrategy < 3) {
    checkUnnamed103(o.percentages!);
  }
  buildCounterTrafficPercentStrategy--;
}

core.List<api.Field> buildUnnamed104() => [buildField(), buildField()];

void checkUnnamed104(core.List<api.Field> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkField(o[0]);
  checkField(o[1]);
}
...
core.List<api.Option> buildUnnamed106() => [buildOption(), buildOption()];

void checkUnnamed106(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
api.Type buildType() {
  ...
  if (buildCounterType < 3) {
    o.edition = 'foo';
    o.fields = buildUnnamed104();
    o.name = 'foo';
    o.oneofs = buildUnnamed105();
...
void checkType(api.Type o) {
  ...
  if (buildCounterType < 3) {
    unittest.expect(o.edition!, unittest.equals('foo'));
    checkUnnamed104(o.fields!);
    unittest.expect(o.name!, unittest.equals('foo'));
    checkUnnamed105(o.oneofs!);
...
core.List<api.UsageRule> buildUnnamed108() => [
  buildUsageRule(),
  buildUsageRule(),
];

void checkUnnamed108(core.List<api.UsageRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUsageRule(o[0]);
  checkUsageRule(o[1]);
}
...
api.Usage buildUsage() {
  ...
  if (buildCounterUsage < 3) {
    ...
    o.requirements = buildUnnamed107();
...
void checkUsage(api.Usage o) {
  ...
  if (buildCounterUsage < 3) {
    ...
    checkUnnamed107(o.requirements!);
...
void main() {
  ...
  unittest.group('obj-schema-AspectRule', () {
    unittest.test('to-json--from-json', () async {
      final o = buildAspectRule();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.AspectRule.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkAspectRule(od);
    });
