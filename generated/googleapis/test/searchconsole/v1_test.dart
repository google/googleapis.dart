...
checkUnnamed3371(core.List<api.MobileFriendlyIssue> o) {
...
checkUnnamed3372(core.List<api.ResourceIssue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildRunMobileFriendlyTestResponse() {
  ...
  if (buildCounterRunMobileFriendlyTestResponse < 3) {
    ...
    o.mobileFriendlyIssues = buildUnnamed3371();
    o.resourceIssues = buildUnnamed3372();
...
checkRunMobileFriendlyTestResponse(api.RunMobileFriendlyTestResponse o) {
  ...
  if (buildCounterRunMobileFriendlyTestResponse < 3) {
    ...
    checkUnnamed3371(o.mobileFriendlyIssues);
    checkUnnamed3372(o.resourceIssues);
