...
checkUnnamed4347(core.List<api.MobileFriendlyIssue> o) {
...
checkUnnamed4348(core.List<api.ResourceIssue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildRunMobileFriendlyTestResponse() {
  ...
  if (buildCounterRunMobileFriendlyTestResponse < 3) {
    ...
    o.mobileFriendlyIssues = buildUnnamed4347();
    o.resourceIssues = buildUnnamed4348();
...
checkRunMobileFriendlyTestResponse(api.RunMobileFriendlyTestResponse o) {
  ...
  if (buildCounterRunMobileFriendlyTestResponse < 3) {
    ...
    checkUnnamed4347(o.mobileFriendlyIssues);
    checkUnnamed4348(o.resourceIssues);
