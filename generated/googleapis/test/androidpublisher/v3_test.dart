...
core.List<api.Apk> buildUnnamed1512() {
  var o = <api.Apk>[];
  o.add(buildApk());
  o.add(buildApk());
  return o;
...
void checkUnnamed1512(core.List<api.Apk> o) {
...
core.List<api.Bundle> buildUnnamed1513() {
  var o = <api.Bundle>[];
  o.add(buildBundle());
  o.add(buildBundle());
  return o;
...
void checkUnnamed1513(core.List<api.Bundle> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.DeviceSpec buildDeviceSpec() {
  ...
  if (buildCounterDeviceSpec < 3) {
    o.screenDensity = 42;
    o.supportedAbis = buildUnnamed1515();
    o.supportedLocales = buildUnnamed1516();
  }
  buildCounterDeviceSpec--;
  return o;
}
...
void checkDeviceSpec(api.DeviceSpec o) {
  ...
  if (buildCounterDeviceSpec < 3) {
    ...
    checkUnnamed1515(o.supportedAbis);
    checkUnnamed1516(o.supportedLocales);
  }
  buildCounterDeviceSpec--;
}
...
core.List<api.UsesPermission> buildUnnamed1520() {
...
void checkUnnamed1520(core.List<api.UsesPermission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ExternallyHostedApk buildExternallyHostedApk() {
  ...
  if (buildCounterExternallyHostedApk < 3) {
    ...
    o.certificateBase64s = buildUnnamed1517();
    ...
    o.maximumSdk = 42;
    o.minimumSdk = 42;
    o.nativeCodes = buildUnnamed1518();
    o.packageName = 'foo';
    o.usesFeatures = buildUnnamed1519();
    o.usesPermissions = buildUnnamed1520();
    o.versionCode = 42;
    o.versionName = 'foo';
  }
  buildCounterExternallyHostedApk--;
...
void checkExternallyHostedApk(api.ExternallyHostedApk o) {
  ...
  if (buildCounterExternallyHostedApk < 3) {
    ...
    checkUnnamed1517(o.certificateBase64s);
    ...
    checkUnnamed1518(o.nativeCodes);
    unittest.expect(o.packageName, unittest.equals('foo'));
    checkUnnamed1519(o.usesFeatures);
    checkUnnamed1520(o.usesPermissions);
    unittest.expect(o.versionCode, unittest.equals(42));
...
core.List<api.Image> buildUnnamed1521() {
  var o = <api.Image>[];
  o.add(buildImage());
  o.add(buildImage());
  return o;
...
void checkUnnamed1521(core.List<api.Image> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkImagesDeleteAllResponse(api.ImagesDeleteAllResponse o) {
  buildCounterImagesDeleteAllResponse++;
  if (buildCounterImagesDeleteAllResponse < 3) {
    checkUnnamed1521(o.deleted);
  }
  buildCounterImagesDeleteAllResponse--;
}

core.List<api.Image> buildUnnamed1522() {
  var o = <api.Image>[];
  o.add(buildImage());
  o.add(buildImage());
  return o;
...
void checkUnnamed1522(core.List<api.Image> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkImage(o[0] as api.Image);
  checkImage(o[1] as api.Image);
}
...
core.Map<core.String, api.InAppProductListing> buildUnnamed1523() {
...
void checkUnnamed1523(core.Map<core.String, api.InAppProductListing> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInAppProductListing(o['x'] as api.InAppProductListing);
  checkInAppProductListing(o['y'] as api.InAppProductListing);
}

core.Map<core.String, api.Price> buildUnnamed1524() {
...
void checkUnnamed1524(core.Map<core.String, api.Price> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.InAppProduct buildInAppProduct() {
  ...
  if (buildCounterInAppProduct < 3) {
    ...
    o.gracePeriod = 'foo';
    o.listings = buildUnnamed1523();
    o.packageName = 'foo';
    o.prices = buildUnnamed1524();
    o.purchaseType = 'foo';
    o.sku = 'foo';
    o.status = 'foo';
...
void checkInAppProduct(api.InAppProduct o) {
  ...
  if (buildCounterInAppProduct < 3) {
    ...
    checkUnnamed1523(o.listings);
    unittest.expect(o.packageName, unittest.equals('foo'));
    checkUnnamed1524(o.prices);
...
core.List<api.InAppProduct> buildUnnamed1526() {
  var o = <api.InAppProduct>[];
...
void checkUnnamed1526(core.List<api.InAppProduct> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.InappproductsListResponse buildInappproductsListResponse() {
  ...
  if (buildCounterInappproductsListResponse < 3) {
    o.inappproduct = buildUnnamed1526();
    o.kind = 'foo';
...
void checkInappproductsListResponse(api.InappproductsListResponse o) {
  buildCounterInappproductsListResponse++;
  if (buildCounterInappproductsListResponse < 3) {
    checkUnnamed1526(o.inappproduct);
    unittest.expect(o.kind, unittest.equals('foo'));
...
core.List<api.Listing> buildUnnamed1527() {
  var o = <api.Listing>[];
  o.add(buildListing());
  o.add(buildListing());
  return o;
...
void checkUnnamed1527(core.List<api.Listing> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Comment> buildUnnamed1528() {
  var o = <api.Comment>[];
  o.add(buildComment());
  o.add(buildComment());
  return o;
...
void checkUnnamed1528(core.List<api.Comment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Review> buildUnnamed1529() {
  var o = <api.Review>[];
  o.add(buildReview());
  o.add(buildReview());
  return o;
...
void checkUnnamed1529(core.List<api.Review> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Variant> buildUnnamed1530() {
  var o = <api.Variant>[];
  o.add(buildVariant());
  o.add(buildVariant());
  return o;
...
void checkUnnamed1530(core.List<api.Variant> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Testers buildTesters() {
  ...
  if (buildCounterTesters < 3) {
    o.googleGroups = buildUnnamed1531();
  }
  buildCounterTesters--;
  return o;
}
...
void checkTesters(api.Testers o) {
  buildCounterTesters++;
  if (buildCounterTesters < 3) {
    checkUnnamed1531(o.googleGroups);
  }
  buildCounterTesters--;
}
...
core.List<api.TrackRelease> buildUnnamed1532() {
...
void checkUnnamed1532(core.List<api.TrackRelease> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkTrack(api.Track o) {
  buildCounterTrack++;
  if (buildCounterTrack < 3) {
    checkUnnamed1532(o.releases);
    unittest.expect(o.track, unittest.equals('foo'));
  }
  buildCounterTrack--;
}

core.List<api.LocalizedText> buildUnnamed1533() {
  var o = <api.LocalizedText>[];
...
void checkUnnamed1533(core.List<api.LocalizedText> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TrackRelease buildTrackRelease() {
  ...
  if (buildCounterTrackRelease < 3) {
    ...
    o.name = 'foo';
    o.releaseNotes = buildUnnamed1533();
    o.status = 'foo';
    o.userFraction = 42.0;
    o.versionCodes = buildUnnamed1534();
  }
  buildCounterTrackRelease--;
  return o;
}
...
void checkTrackRelease(api.TrackRelease o) {
  ...
  if (buildCounterTrackRelease < 3) {
    ...
    checkUnnamed1533(o.releaseNotes);
    unittest.expect(o.status, unittest.equals('foo'));
    unittest.expect(o.userFraction, unittest.equals(42.0));
    checkUnnamed1534(o.versionCodes);
  }
  buildCounterTrackRelease--;
}

core.List<api.Track> buildUnnamed1535() {
  var o = <api.Track>[];
  o.add(buildTrack());
  o.add(buildTrack());
  return o;
...
void checkUnnamed1535(core.List<api.Track> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.VoidedPurchase> buildUnnamed1536() {
  var o = <api.VoidedPurchase>[];
...
void checkUnnamed1536(core.List<api.VoidedPurchase> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.VoidedPurchasesListResponse buildVoidedPurchasesListResponse() {
  ...
  if (buildCounterVoidedPurchasesListResponse < 3) {
    o.pageInfo = buildPageInfo();
    o.tokenPagination = buildTokenPagination();
    o.voidedPurchases = buildUnnamed1536();
  }
  buildCounterVoidedPurchasesListResponse--;
  return o;
}
...
void checkVoidedPurchasesListResponse(api.VoidedPurchasesListResponse o) {
  ...
  if (buildCounterVoidedPurchasesListResponse < 3) {
    checkPageInfo(o.pageInfo as api.PageInfo);
    checkTokenPagination(o.tokenPagination as api.TokenPagination);
    checkUnnamed1536(o.voidedPurchases);
  }
  buildCounterVoidedPurchasesListResponse--;
}
