...
checkUnnamed1273(core.List<api.PlusDomainsAclentryResource> o) {
...
checkUnnamed1274(core.List<api.ActivityObjectAttachmentsPreviewThumbnails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1275(core.List<api.ActivityObjectAttachmentsThumbnails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildActivityObjectAttachments() {
  ...
  if (buildCounterActivityObjectAttachments < 3) {
    ...
    o.objectType = "foo";
    o.previewThumbnails = buildUnnamed1274();
    o.thumbnails = buildUnnamed1275();
    o.url = "foo";
  }
  buildCounterActivityObjectAttachments--;
  return o;
...
checkActivityObjectAttachments(api.ActivityObjectAttachments o) {
  ...
  if (buildCounterActivityObjectAttachments < 3) {
    ...
    checkUnnamed1274(o.previewThumbnails);
    checkUnnamed1275(o.thumbnails);
    unittest.expect(o.url, unittest.equals('foo'));
  }
  buildCounterActivityObjectAttachments--;
}
...
checkUnnamed1276(core.List<api.ActivityObjectAttachments> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildActivityObject() {
  ...
  if (buildCounterActivityObject < 3) {
    ...
    o.attachments = buildUnnamed1276();
    o.content = "foo";
    o.id = "foo";
    o.objectType = "foo";
...
checkActivityObject(api.ActivityObject o) {
  ...
  if (buildCounterActivityObject < 3) {
    ...
    checkUnnamed1276(o.attachments);
    unittest.expect(o.content, unittest.equals('foo'));
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.objectType, unittest.equals('foo'));
...
checkUnnamed1277(core.List<api.Activity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkActivity(o[0]);
  checkActivity(o[1]);
}
...
checkUnnamed1278(core.List<api.Audience> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAudience(o[0]);
  checkAudience(o[1]);
}
...
checkUnnamed1279(core.List<api.Circle> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCircle(o[0]);
  checkCircle(o[1]);
}
...
checkUnnamed1280(core.List<api.CommentInReplyTo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1281(core.List<api.Comment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkComment(o[0]);
  checkComment(o[1]);
}
...
checkUnnamed1282(core.List<api.Videostream> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1283(core.List<api.Person> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPerson(o[0]);
  checkPerson(o[1]);
}
...
checkUnnamed1284(core.List<api.PersonEmails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1285(core.List<api.PersonOrganizations> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1286(core.List<api.PersonPlacesLived> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1287(core.List<api.PersonUrls> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPersonUrls(o[0]);
  checkPersonUrls(o[1]);
}
...
buildPerson() {
  ...
  if (buildCounterPerson < 3) {
    ...
    o.objectType = "foo";
    o.occupation = "foo";
    o.organizations = buildUnnamed1285();
    o.placesLived = buildUnnamed1286();
    o.plusOneCount = 42;
...
checkPerson(api.Person o) {
  ...
  if (buildCounterPerson < 3) {
    ...
    checkUnnamed1285(o.organizations);
    checkUnnamed1286(o.placesLived);
...
main() {
  ...
  unittest.group("resource-CirclesResourceApi", () {
    unittest.test("method--addPeople", () {
      ...
      var arg_email = buildUnnamed1288();
      var arg_userId = buildUnnamed1289();
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
        var index;
    ...
    unittest.test("method--removePeople", () {
      ...
      api.CirclesResourceApi res = new api.PlusDomainsApi(mock).circles;
      var arg_circleId = "foo";
      var arg_email = buildUnnamed1290();
      var arg_userId = buildUnnamed1291();
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
        var index;
