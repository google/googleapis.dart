...
checkUnnamed927(core.List<api.PlusDomainsAclentryResource> o) {
...
checkUnnamed928(core.List<api.ActivityObjectAttachmentsPreviewThumbnails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed929(core.List<api.ActivityObjectAttachmentsThumbnails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildActivityObjectAttachments() {
  ...
  if (buildCounterActivityObjectAttachments < 3) {
    ...
    o.objectType = "foo";
    o.previewThumbnails = buildUnnamed928();
    o.thumbnails = buildUnnamed929();
    o.url = "foo";
  }
  buildCounterActivityObjectAttachments--;
  return o;
...
checkActivityObjectAttachments(api.ActivityObjectAttachments o) {
  ...
  if (buildCounterActivityObjectAttachments < 3) {
    ...
    checkUnnamed928(o.previewThumbnails);
    checkUnnamed929(o.thumbnails);
    unittest.expect(o.url, unittest.equals('foo'));
  }
  buildCounterActivityObjectAttachments--;
}
...
checkUnnamed930(core.List<api.ActivityObjectAttachments> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed931(core.List<api.Activity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkActivity(o[0]);
  checkActivity(o[1]);
}
...
checkUnnamed932(core.List<api.Audience> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAudience(o[0]);
  checkAudience(o[1]);
}
...
checkUnnamed933(core.List<api.Circle> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCircle(o[0]);
  checkCircle(o[1]);
}
...
checkUnnamed934(core.List<api.CommentInReplyTo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed935(core.List<api.Comment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkComment(o[0]);
  checkComment(o[1]);
}
...
checkUnnamed936(core.List<api.Videostream> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed937(core.List<api.Person> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPerson(o[0]);
  checkPerson(o[1]);
}
...
checkUnnamed938(core.List<api.PersonEmails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed939(core.List<api.PersonOrganizations> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed940(core.List<api.PersonPlacesLived> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed941(core.List<api.PersonUrls> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPersonUrls(o[0]);
  checkPersonUrls(o[1]);
}
...
buildPerson() {
  ...
  if (buildCounterPerson < 3) {
    ...
    o.objectType = "foo";
    o.occupation = "foo";
    o.organizations = buildUnnamed939();
    o.placesLived = buildUnnamed940();
    o.plusOneCount = 42;
    o.relationshipStatus = "foo";
    o.skills = "foo";
    o.tagline = "foo";
    o.url = "foo";
    o.urls = buildUnnamed941();
    o.verified = true;
  }
  buildCounterPerson--;
  return o;
...
checkPerson(api.Person o) {
  ...
  if (buildCounterPerson < 3) {
    ...
    checkUnnamed939(o.organizations);
    checkUnnamed940(o.placesLived);
...
main() {
  ...
  unittest.group("resource-CirclesResourceApi", () {
    unittest.test("method--addPeople", () {
      ...
      var arg_email = buildUnnamed942();
      var arg_userId = buildUnnamed943();
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
        var index;
    ...
    unittest.test("method--removePeople", () {
      ...
      api.CirclesResourceApi res = new api.PlusDomainsApi(mock).circles;
      var arg_circleId = "foo";
      var arg_email = buildUnnamed944();
      var arg_userId = buildUnnamed945();
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
        var index;
