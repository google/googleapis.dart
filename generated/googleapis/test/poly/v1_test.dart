...
core.List<api.Format> buildUnnamed5236() {
  var o = <api.Format>[];
  o.add(buildFormat());
  o.add(buildFormat());
  return o;
...
void checkUnnamed5236(core.List<api.Format> o) {
...
core.List<api.File> buildUnnamed5237() {
  var o = <api.File>[];
  o.add(buildFile());
  o.add(buildFile());
  return o;
...
void checkUnnamed5237(core.List<api.File> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Asset> buildUnnamed5238() {
  var o = <api.Asset>[];
  o.add(buildAsset());
  o.add(buildAsset());
  return o;
...
void checkUnnamed5238(core.List<api.Asset> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Asset> buildUnnamed5239() {
  var o = <api.Asset>[];
  o.add(buildAsset());
  o.add(buildAsset());
  return o;
...
void checkUnnamed5239(core.List<api.Asset> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAsset(o[0] as api.Asset);
  checkAsset(o[1] as api.Asset);
}
...
core.List<api.UserAsset> buildUnnamed5240() {
  var o = <api.UserAsset>[];
...
void checkUnnamed5240(core.List<api.UserAsset> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.RemixInfo buildRemixInfo() {
  ...
  if (buildCounterRemixInfo < 3) {
    o.sourceAsset = buildUnnamed5241();
  }
  buildCounterRemixInfo--;
  return o;
}
...
void checkRemixInfo(api.RemixInfo o) {
  buildCounterRemixInfo++;
  if (buildCounterRemixInfo < 3) {
    checkUnnamed5241(o.sourceAsset!);
  }
  buildCounterRemixInfo--;
}

core.List<api.AssetImportMessage> buildUnnamed5242() {
  var o = <api.AssetImportMessage>[];
...
void checkUnnamed5242(core.List<api.AssetImportMessage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.StartAssetImportResponse buildStartAssetImportResponse() {
  ...
  if (buildCounterStartAssetImportResponse < 3) {
    o.assetId = 'foo';
    o.assetImportId = 'foo';
    o.assetImportMessages = buildUnnamed5242();
    o.publishUrl = 'foo';
  }
  buildCounterStartAssetImportResponse--;
  return o;
...
void checkStartAssetImportResponse(api.StartAssetImportResponse o) {
  ...
  if (buildCounterStartAssetImportResponse < 3) {
    ...
    checkUnnamed5242(o.assetImportMessages!);
    unittest.expect(
      o.publishUrl!,
      unittest.equals('foo'),
    );
