...
core.List<api.DeliveryPipeline> buildUnnamed13() => [
      buildDeliveryPipeline(),
      buildDeliveryPipeline(),
    ];

void checkUnnamed13(core.List<api.DeliveryPipeline> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListDeliveryPipelinesResponse buildListDeliveryPipelinesResponse() {
  ...
  if (buildCounterListDeliveryPipelinesResponse < 3) {
    o.deliveryPipelines = buildUnnamed13();
    o.nextPageToken = 'foo';
...
void checkListDeliveryPipelinesResponse(api.ListDeliveryPipelinesResponse o) {
  buildCounterListDeliveryPipelinesResponse++;
  if (buildCounterListDeliveryPipelinesResponse < 3) {
    checkUnnamed13(o.deliveryPipelines!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.JobRun> buildUnnamed15() => [
      buildJobRun(),
      buildJobRun(),
    ];

void checkUnnamed15(core.List<api.JobRun> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJobRun(o[0]);
  checkJobRun(o[1]);
}
...
core.List<api.Release> buildUnnamed19() => [
      buildRelease(),
      buildRelease(),
    ];

void checkUnnamed19(core.List<api.Release> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRelease(o[0]);
  checkRelease(o[1]);
}
...
void checkListReleasesResponse(api.ListReleasesResponse o) {
  ...
  if (buildCounterListReleasesResponse < 3) {
    ...
    checkUnnamed19(o.releases!);
    checkUnnamed20(o.unreachable!);
  }
  buildCounterListReleasesResponse--;
}

core.List<api.Rollout> buildUnnamed21() => [
      buildRollout(),
      buildRollout(),
    ];

void checkUnnamed21(core.List<api.Rollout> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRollout(o[0]);
  checkRollout(o[1]);
}
...
void checkListRolloutsResponse(api.ListRolloutsResponse o) {
  ...
  if (buildCounterListRolloutsResponse < 3) {
    ...
    checkUnnamed21(o.rollouts!);
    checkUnnamed22(o.unreachable!);
  }
  buildCounterListRolloutsResponse--;
}

core.List<api.Target> buildUnnamed23() => [
      buildTarget(),
      buildTarget(),
    ];

void checkUnnamed23(core.List<api.Target> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTarget(o[0]);
  checkTarget(o[1]);
}
...
core.List<api.BuildArtifact> buildUnnamed34() => [
      buildBuildArtifact(),
      buildBuildArtifact(),
    ];

void checkUnnamed34(core.List<api.BuildArtifact> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, api.TargetArtifact> buildUnnamed36() => {
      'x': buildTargetArtifact(),
      'y': buildTargetArtifact(),
    };

void checkUnnamed36(core.Map<core.String, api.TargetArtifact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTargetArtifact(o['x']!);
  checkTargetArtifact(o['y']!);
}

core.Map<core.String, api.TargetRender> buildUnnamed37() => {
      'x': buildTargetRender(),
      'y': buildTargetRender(),
    };

void checkUnnamed37(core.Map<core.String, api.TargetRender> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTargetRender(o['x']!);
  checkTargetRender(o['y']!);
}

core.List<api.Target> buildUnnamed38() => [
      buildTarget(),
      buildTarget(),
    ];
...
api.Release buildRelease() {
  ...
  if (buildCounterRelease < 3) {
    ...
    o.buildArtifacts = buildUnnamed34();
    ...
    o.targetArtifacts = buildUnnamed36();
    o.targetRenders = buildUnnamed37();
    o.targetSnapshots = buildUnnamed38();
    o.uid = 'foo';
  }
  buildCounterRelease--;
  return o;
...
void checkRelease(api.Release o) {
  ...
  if (buildCounterRelease < 3) {
    ...
    checkUnnamed34(o.buildArtifacts!);
    ...
    checkUnnamed36(o.targetArtifacts!);
    checkUnnamed37(o.targetRenders!);
    checkUnnamed38(o.targetSnapshots!);
    unittest.expect(
      o.uid!,
      unittest.equals('foo'),
    );
...
core.List<api.Phase> buildUnnamed41() => [
      buildPhase(),
      buildPhase(),
    ];

void checkUnnamed41(core.List<api.Phase> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPhase(o[0]);
  checkPhase(o[1]);
}
...
core.List<api.Stage> buildUnnamed42() => [
      buildStage(),
      buildStage(),
    ];

void checkUnnamed42(core.List<api.Stage> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStage(o[0]);
  checkStage(o[1]);
}
...
core.List<api.ExecutionConfig> buildUnnamed47() => [
      buildExecutionConfig(),
      buildExecutionConfig(),
    ];

void checkUnnamed47(core.List<api.ExecutionConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Target buildTarget() {
  ...
  if (buildCounterTarget < 3) {
    ...
    o.description = 'foo';
    o.etag = 'foo';
    o.executionConfigs = buildUnnamed47();
...
void checkTarget(api.Target o) {
  ...
  if (buildCounterTarget < 3) {
    ...
    checkUnnamed47(o.executionConfigs!);
...
core.Map<core.String, api.PhaseArtifact> buildUnnamed49() => {
      'x': buildPhaseArtifact(),
      'y': buildPhaseArtifact(),
    };

void checkUnnamed49(core.Map<core.String, api.PhaseArtifact> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.TargetArtifact buildTargetArtifact() {
  ...
  if (buildCounterTargetArtifact < 3) {
    o.artifactUri = 'foo';
    o.manifestPath = 'foo';
    o.phaseArtifacts = buildUnnamed49();
    o.skaffoldConfigPath = 'foo';
  }
  buildCounterTargetArtifact--;
  return o;
...
void checkTargetArtifact(api.TargetArtifact o) {
  ...
  if (buildCounterTargetArtifact < 3) {
    ...
    checkUnnamed49(o.phaseArtifacts!);
    unittest.expect(
      o.skaffoldConfigPath!,
      unittest.equals('foo'),
    );
...
api.TargetsPresentCondition buildTargetsPresentCondition() {
  ...
  if (buildCounterTargetsPresentCondition < 3) {
    o.missingTargets = buildUnnamed50();
    o.status = true;
    o.updateTime = 'foo';
  }
  buildCounterTargetsPresentCondition--;
...
void checkTargetsPresentCondition(api.TargetsPresentCondition o) {
  buildCounterTargetsPresentCondition++;
  if (buildCounterTargetsPresentCondition < 3) {
    checkUnnamed50(o.missingTargets!);
    unittest.expect(o.status!, unittest.isTrue);
    unittest.expect(
      o.updateTime!,
      unittest.equals('foo'),
