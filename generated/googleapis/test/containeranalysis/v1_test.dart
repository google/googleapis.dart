...
core.List<api.File> buildUnnamed26() => [
      buildFile(),
      buildFile(),
    ];
...
core.List<api.Layer> buildUnnamed35() => [
      buildLayer(),
      buildLayer(),
    ];
...
core.List<api.Subject> buildUnnamed37() => [
      buildSubject(),
      buildSubject(),
    ];
...
core.List<api.Subject> buildUnnamed38() => [
      buildSubject(),
      buildSubject(),
    ];
...
core.List<api.Note> buildUnnamed41() => [
      buildNote(),
      buildNote(),
    ];
...
core.List<api.Digest> buildUnnamed49() => [
      buildDigest(),
      buildDigest(),
    ];
...
core.List<api.Subject> buildUnnamed63() => [
      buildSubject(),
      buildSubject(),
    ];
...
core.List<api.Material> buildUnnamed67() => [
      buildMaterial(),
      buildMaterial(),
    ];
...
core.List<api.Detail> buildUnnamed85() => [
      buildDetail(),
      buildDetail(),
    ];
...
core.List<api.Category> buildUnnamed92() => [
      buildCategory(),
      buildCategory(),
    ];
...
void main() {
  ...
  unittest.group('obj-schema-SecretNote', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od =
          api.SecretNote.fromJson(oJson as core.Map<core.String, core.dynamic>);
      checkSecretNote(od);
    });
  });
