...
checkUnnamed2334(core.List<api.FieldMask> o) {
...
checkUnnamed2336(core.List<api.MobileAppPanel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2337(core.List<api.FieldMask> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFieldMask(o[0]);
  checkFieldMask(o[1]);
}
...
checkUnnamed2339(core.List<api.SurveyQuestion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSurvey() {
  ...
  if (buildCounterSurvey < 3) {
    ...
    o.customerData = "foo";
    o.description = "foo";
    o.owners = buildUnnamed2338();
    o.questions = buildUnnamed2339();
...
checkSurvey(api.Survey o) {
  ...
  if (buildCounterSurvey < 3) {
    ...
    checkUnnamed2338(o.owners);
    checkUnnamed2339(o.questions);
...
buildSurveyAudience() {
  ...
  if (buildCounterSurveyAudience < 3) {
    o.ages = buildUnnamed2340();
    o.country = "foo";
    o.countrySubdivision = "foo";
    o.gender = "foo";
    o.languages = buildUnnamed2341();
    o.mobileAppPanelId = "foo";
...
checkUnnamed2343(core.List<api.SurveyQuestionImage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkSurveyQuestion(api.SurveyQuestion o) {
  ...
  if (buildCounterSurveyQuestion < 3) {
    ...
    checkUnnamed2344(o.openTextSuggestions);
    ...
    checkUnnamed2345(o.thresholdAnswers);
...
checkUnnamed2346(core.List<api.Survey> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSurvey(o[0]);
  checkSurvey(o[1]);
}
