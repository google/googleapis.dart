...
class DfareportingApi {
  ...
  DfareportingApi(http.Client client, {core.String rootUrl: "https://www.googleapis.com/", core.String servicePath: "dfareporting/v2.8/"}) :
...
class ConversionsResourceApi {
   ...
   * this method will complete with the same error.
   */
  async.Future<ConversionsBatchUpdateResponse> batchupdate(ConversionsBatchUpdateRequest request, core.String profileId) {
    var _url = null;
    var _queryParams = new core.Map();
    var _uploadMedia = null;
    var _uploadOptions = null;
    ...
    _url = 'userprofiles/' + commons.Escaper.ecapeVariable('$profileId') + '/conversions/batchupdate';
    ...
    var _response = _requester.request(_url,
                                       ...
                                       uploadMedia: _uploadMedia,
                                       downloadOptions: _downloadOptions);
    return _response.then((data) => new ConversionsBatchUpdateResponse.fromJson(data));
  }
...
class CreativeAssetsResourceApi {
  ...
  async.Future<CreativeAssetMetadata> insert(CreativeAssetMetadata request, core.String profileId, core.String advertiserId, {commons.UploadOptions uploadOptions : commons.UploadOptions.Default, commons.Media uploadMedia}) {
    ...
    if (_uploadMedia == null) {
      ...
      _url = '/resumable/upload/dfareporting/v2.8/userprofiles/' + commons.Escaper.ecapeVariable('$profileId') + '/creativeAssets/' + commons.Escaper.ecapeVariable('$advertiserId') + '/creativeAssets';
    } else {
      _url = '/upload/dfareporting/v2.8/userprofiles/' + commons.Escaper.ecapeVariable('$profileId') + '/creativeAssets/' + commons.Escaper.ecapeVariable('$advertiserId') + '/creativeAssets';
    }
...
class Campaign {
  ...
  Campaign.fromJson(core.Map _json) {
    ...
    if (_json.containsKey("adBlockingConfiguration")) {
      adBlockingConfiguration = new AdBlockingConfiguration.fromJson(_json["adBlockingConfiguration"]);
    }
