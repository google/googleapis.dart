...
class ProjectsLocationsServicesResource {
  ...
  async.Future<Operation> alterTableProperties(
    ...
    final url_ =
        'v1beta/' + core.Uri.encodeFull('$service') + ':alterTableProperties';
  ...
  async.Future<Operation> cancelMigration(
    ...
    final url_ =
        'v1beta/' + core.Uri.encodeFull('$service') + ':cancelMigration';
  ...
  async.Future<Operation> completeMigration(
    ...
    final url_ =
        'v1beta/' + core.Uri.encodeFull('$service') + ':completeMigration';
  ...
  async.Future<Operation> startMigration(
    ...
    final url_ =
        'v1beta/' + core.Uri.encodeFull('$service') + ':startMigration';
...
class ProjectsLocationsServicesMigrationExecutionsResource {
  ...
  async.Future<ListMigrationExecutionsResponse> list(
    ...
    final url_ =
        'v1beta/' + core.Uri.encodeFull('$parent') + '/migrationExecutions';
