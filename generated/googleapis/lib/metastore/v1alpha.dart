...
/// Dataproc Metastore API - v1alpha
///
...
class ProjectsLocationsFederationsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$parent') + '/federations';
...
class ProjectsLocationsServicesResource {
  ...
  async.Future<Operation> alterLocation(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$service') + ':alterLocation';
  ...
  async.Future<Operation> alterTableProperties(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$service') + ':alterTableProperties';
  ...
  async.Future<Operation> cancelMigration(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$service') + ':cancelMigration';
  ...
  async.Future<Operation> completeMigration(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$service') + ':completeMigration';
  ...
  async.Future<Operation> exportMetadata(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$service') + ':exportMetadata';
  ...
  async.Future<Operation> moveTableToDatabase(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$service') + ':moveTableToDatabase';
  ...
  async.Future<Operation> queryMetadata(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$service') + ':queryMetadata';
  ...
  async.Future<RemoveIamPolicyResponse> removeIamPolicy(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$resource') + ':removeIamPolicy';
  ...
  async.Future<Operation> restore(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$service') + ':restore';
  ...
  async.Future<Operation> startMigration(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$service') + ':startMigration';
...
class ProjectsLocationsServicesMetadataImportsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$parent') + '/metadataImports';
...
class ProjectsLocationsServicesMigrationExecutionsResource {
  ...
  async.Future<ListMigrationExecutionsResponse> list(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$parent') + '/migrationExecutions';
...
typedef BackendMetastore = $BackendMetastore;
...
typedef CustomRegionConfig = $CustomRegionConfig;
...
class DataplexConfig {
  ...
  DataplexConfig.fromJson(core.Map json_)
    : this(
        lakeResources: (json_['lakeResources']
                as core.Map<core.String, core.dynamic>?)
            ?.map(
              (key, value) => core.MapEntry(
                key,
                Lake.fromJson(value as core.Map<core.String, core.dynamic>),
              ),
            ),
      );
...
typedef EncryptionConfig = $EncryptionConfig02;
...
class MetadataIntegration {
  ...
  MetadataIntegration({this.dataCatalogConfig, this.dataplexConfig});
...
class MultiRegionConfig {
  ...
  core.List<RootCACertificate>? certificates;
  CustomRegionConfig? customRegionConfig;

  MultiRegionConfig({this.certificates, this.customRegionConfig});

  MultiRegionConfig.fromJson(core.Map json_)
    : this(
        certificates:
            (json_['certificates'] as core.List?)
                ?.map(
                  (value) => RootCACertificate.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
        customRegionConfig:
            json_.containsKey('customRegionConfig')
                ? CustomRegionConfig.fromJson(
                  json_['customRegionConfig']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
      );
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (customRegionConfig != null) 'customRegionConfig': customRegionConfig!,
  };
}
...
class NetworkConfig {
  ...
  NetworkConfig({this.consumers, this.customRoutesEnabled});
    ...
    : this(
        consumers:
            (json_['consumers'] as core.List?)
                ...
                .toList(),
        customRoutesEnabled: json_['customRoutesEnabled'] as core.bool?,
      );
...
typedef RemoveIamPolicyRequest = $RemoveIamPolicyRequest;

/// Response message for DataprocMetastore.RemoveIamPolicy.
typedef RemoveIamPolicyResponse = $RemoveIamPolicyResponse;
...
/// A gRPC client must install all root CA certificates to connect to a
/// multi-regional Dataproc Metastore service and achieve failover.
typedef RootCACertificate = $RootCACertificate;
...
class Service {
  ...
  /// Specifies the multi-region configuration information for the Hive
  /// metastore service.
  ///
  /// Optional.
    ...
    : this(
        ...
        metadataManagementActivity:
            json_.containsKey('metadataManagementActivity')
                ...
                : null,
        multiRegionConfig:
            json_.containsKey('multiRegionConfig')
                ? MultiRegionConfig.fromJson(
                  json_['multiRegionConfig']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
        name: json_['name'] as core.String?,
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (metadataManagementActivity != null)
      'metadataManagementActivity': metadataManagementActivity!,
    if (multiRegionConfig != null) 'multiRegionConfig': multiRegionConfig!,
    if (name != null) 'name': name!,
