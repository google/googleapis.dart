...
class ProjectsLocationsCatalogsBranchesProductsResource {
  ...
  async.Future<GoogleCloudRetailV2Product> patch(
    ...
    if (allowMissing != null) {
      _queryParams['allowMissing'] = ['${allowMissing}'];
    }
    if (updateMask != null) {
      _queryParams['updateMask'] = [updateMask];
    }
...
class ProjectsLocationsCatalogsUserEventsResource {
  ...
  async.Future<GoogleApiHttpBody> collect(
    ...
    if (ets != null) {
      _queryParams['ets'] = [ets];
    }
    if (uri != null) {
      _queryParams['uri'] = [uri];
    }
    if (userEvent != null) {
      _queryParams['userEvent'] = [userEvent];
    }
    if ($fields != null) {
      _queryParams['fields'] = [$fields];
    }
...
class GoogleCloudRetailV2UserEvent {
  ...
  /// of search_query or filter is required for `search` events. Other event
