...
class ProjectsLocationsParametersVersionsResource {
  ...
  async.Future<ParameterVersion> create(
    ...
    final body_ = convert.json.encode(request);
    final queryParams_ = <core.String, core.List<core.String>>{
      'parameterVersionId': ?parameterVersionId == null
          ? null
          : [parameterVersionId],
      'requestId': ?requestId == null ? null : [requestId],
      'fields': ?$fields == null ? null : [$fields],
...
class ListParameterVersionsResponse {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final nextPageToken = this.nextPageToken;
    final parameterVersions = this.parameterVersions;
...
class Parameter {
  ...
  /// Input only.
  ///
  /// Immutable. Tag keys and tag values that are bound to this Parameter. You
...
class ParameterVersion {
  ...
  /// - "SERVER_GENERATED" : The checksum was generated by the server.
  /// - "USER_SPECIFIED" : The checksum was provided by the user.
  core.String? checksumSource;
  ...
  ParameterVersion.fromJson(core.Map json_)
    : this(
        checksumSource: json_['checksumSource'] as core.String?,
        createTime: json_['createTime'] as core.String?,
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final checksumSource = this.checksumSource;
    final createTime = this.createTime;
...
class ParameterVersionPayload {
  ...
  ParameterVersionPayload({this.data, this.dataCrc32c});
...
class TemplateVersionPayload {
  ...
  TemplateVersionPayload({this.data});

  TemplateVersionPayload.fromJson(core.Map json_)
