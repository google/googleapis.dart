...
class IamResource {
  ...
  troubleshoot(
    ...
    const url_ = 'v1beta/iam:troubleshoot';
    ...
    return GoogleCloudPolicytroubleshooterV1betaTroubleshootIamPolicyResponse.fromJson(
...
class GoogleCloudPolicytroubleshooterV1betaAccessTuple {
  ...
  GoogleCloudPolicytroubleshooterV1betaAccessTuple.fromJson(core.Map json_)
    : this(
...
class GoogleCloudPolicytroubleshooterV1betaExplainedPolicy {
  ...
  /// field is omitted.
  core.List<GoogleCloudPolicytroubleshooterV1betaBindingExplanation>?
  bindingExplanations;
  ...
  GoogleCloudPolicytroubleshooterV1betaExplainedPolicy.fromJson(core.Map json_)
    : this(
        access: json_['access'] as core.String?,
        bindingExplanations:
...
class GoogleCloudPolicytroubleshooterV1betaTroubleshootIamPolicyRequest {
  ...
  /// a resource.
  GoogleCloudPolicytroubleshooterV1betaAccessTuple? accessTuple;
...
class GoogleCloudPolicytroubleshooterV1betaTroubleshootIamPolicyResponse {
  ...
  core.List<GoogleCloudPolicytroubleshooterV1betaExplainedPolicy>?
  explainedPolicies;
