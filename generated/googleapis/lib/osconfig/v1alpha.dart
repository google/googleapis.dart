...
class InstanceOSPoliciesCompliance {
  ...
  InstanceOSPoliciesCompliance.fromJson(core.Map json_)
    : this(
        detailedState: json_['detailedState'] as core.String?,
        detailedStateReason: json_['detailedStateReason'] as core.String?,
        instance: json_['instance'] as core.String?,
        lastComplianceCheckTime:
            json_['lastComplianceCheckTime'] as core.String?,
        lastComplianceRunId: json_['lastComplianceRunId'] as core.String?,
...
class InstanceOSPoliciesComplianceOSPolicyCompliance {
  ...
  InstanceOSPoliciesComplianceOSPolicyCompliance.fromJson(core.Map json_)
    : this(
        osPolicyAssignment: json_['osPolicyAssignment'] as core.String?,
        osPolicyId: json_['osPolicyId'] as core.String?,
        osPolicyResourceCompliances:
            (json_['osPolicyResourceCompliances'] as core.List?)
                ?.map(
                  (value) => OSPolicyResourceCompliance.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    if (osPolicyAssignment != null) 'osPolicyAssignment': osPolicyAssignment!,
...
class InventoryItem {
  ...
  InventoryItem.fromJson(core.Map json_)
    : this(
        availablePackage:
            json_.containsKey('availablePackage')
        ...
        installedPackage:
            json_.containsKey('installedPackage')
                ? InventorySoftwarePackage.fromJson(
...
class InventorySoftwarePackage {
    ...
    : this(
        ...
        windowsApplication:
            json_.containsKey('windowsApplication')
                ? InventoryWindowsApplication.fromJson(
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (windowsApplication != null) 'windowsApplication': windowsApplication!,
    ...
    : this(
        instanceOsPoliciesCompliances:
            (json_['instanceOsPoliciesCompliances'] as core.List?)
                ?.map(
                  (value) => InstanceOSPoliciesCompliance.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
class ListInventoriesResponse {
  ...
  ListInventoriesResponse({this.inventories, this.nextPageToken});
    ...
    : this(
        ...
        osPolicyAssignmentReports:
            (json_['osPolicyAssignmentReports'] as core.List?)
                ?.map(
                  (value) => OSPolicyAssignmentReport.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
    ...
    : this(
        ...
        osPolicyAssignments:
            (json_['osPolicyAssignments'] as core.List?)
                ?.map(
                  (value) => OSPolicyAssignment.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
    ...
    : this(
        ...
        vulnerabilityReports:
            (json_['vulnerabilityReports'] as core.List?)
                ?.map(
                  (value) => VulnerabilityReport.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
class OSPolicyAssignmentReport {
  ...
  OSPolicyAssignmentReport.fromJson(core.Map json_)
    : this(
        instance: json_['instance'] as core.String?,
        lastRunId: json_['lastRunId'] as core.String?,
        name: json_['name'] as core.String?,
        osPolicyAssignment: json_['osPolicyAssignment'] as core.String?,
        osPolicyCompliances:
            (json_['osPolicyCompliances'] as core.List?)
...
class OSPolicyAssignmentReportOSPolicyCompliance {
  ...
  OSPolicyAssignmentReportOSPolicyCompliance.fromJson(core.Map json_)
    : this(
        ...
        complianceStateReason: json_['complianceStateReason'] as core.String?,
        osPolicyId: json_['osPolicyId'] as core.String?,
        osPolicyResourceCompliances:
            (json_['osPolicyResourceCompliances'] as core.List?)
                ?.map(
...
class OSPolicyAssignmentReportOSPolicyComplianceOSPolicyResourceCompliance {
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (execResourceOutput != null) 'execResourceOutput': execResourceOutput!,
    if (osPolicyResourceId != null) 'osPolicyResourceId': osPolicyResourceId!,
  };
}
  ...
  OSPolicyResourceCompliance.fromJson(core.Map json_)
    : this(
        configSteps:
            (json_['configSteps'] as core.List?)
                ?.map(
                  (value) => OSPolicyResourceConfigStep.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
class OSPolicyResourceComplianceExecResourceOutput {
  ...
  OSPolicyResourceComplianceExecResourceOutput({this.enforcementOutput});
...
class OSPolicyResourceConfigStep {
  ...
  OSPolicyResourceConfigStep({this.errorMessage, this.outcome, this.type});
...
class OSPolicyResourceGroup {
  ...
  OSPolicyResourceGroup({this.inventoryFilters, this.osFilter, this.resources});
    ...
    : this(
        ...
        vulnerabilities:
            (json_['vulnerabilities'] as core.List?)
                ?.map(
                  (value) => VulnerabilityReportVulnerability.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
    ...
    : this(
        ...
        items:
            (json_['items'] as core.List?)
                ?.map(
                  (value) => VulnerabilityReportVulnerabilityItem.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
