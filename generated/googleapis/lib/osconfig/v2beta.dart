...
class FoldersLocationsGlobalPolicyOrchestratorsResource {
  ...
  async.Future<Operation> create(
    GoogleCloudOsconfigV2betaPolicyOrchestrator request,
    core.String parent, {
    ...
    final url_ =
        'v2beta/' + core.Uri.encodeFull('$parent') + '/policyOrchestrators';
  ...
  /// response.
  ///
  /// Completes with a [GoogleCloudOsconfigV2betaPolicyOrchestrator].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<GoogleCloudOsconfigV2betaPolicyOrchestrator> get(
    core.String name, {
    core.String? $fields,
  }) async {
    final queryParams_ = <core.String, core.List<core.String>>{
    ...
    return GoogleCloudOsconfigV2betaPolicyOrchestrator.fromJson(
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<GoogleCloudOsconfigV2betaListPolicyOrchestratorsResponse> list(
    core.String parent, {
    core.String? filter,
    core.String? orderBy,
    core.int? pageSize,
    ...
    return GoogleCloudOsconfigV2betaListPolicyOrchestratorsResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
...
typedef GoogleCloudOsconfigV2betaOrchestrationScopeLocationSelector =
    $OrchestrationScope_LocationSelector;

/// Selector containing Cloud Resource Manager resource hierarchy nodes.
typedef GoogleCloudOsconfigV2betaOrchestrationScopeResourceHierarchySelector =
...
class GoogleCloudOsconfigV2betaOrchestrationScopeSelector {
  ...
  GoogleCloudOsconfigV2betaOrchestrationScopeLocationSelector? locationSelector;
  ...
  GoogleCloudOsconfigV2betaOrchestrationScopeSelector.fromJson(core.Map json_)
    : this(
        locationSelector:
...
class GoogleCloudOsconfigV2betaListPolicyOrchestratorsResponse {
  ...
  core.List<GoogleCloudOsconfigV2betaPolicyOrchestrator>? policyOrchestrators;
    ...
    core.Map json_,
        ...
        policyOrchestrators:
            (json_['policyOrchestrators'] as core.List?)
                ?.map(
                  (value) =>
                      GoogleCloudOsconfigV2betaPolicyOrchestrator.fromJson(
...
class GoogleCloudOsconfigV2betaOrchestratedResource {
  ...
  GoogleCloudOsconfigV2betaOrchestratedResource.fromJson(core.Map json_)
    : this(
...
class GoogleCloudOsconfigV2betaOrchestrationScope {
  ...
  ///
  /// Optional.
  core.List<GoogleCloudOsconfigV2betaOrchestrationScopeSelector>? selectors;

  GoogleCloudOsconfigV2betaOrchestrationScope({this.selectors});

  GoogleCloudOsconfigV2betaOrchestrationScope.fromJson(core.Map json_)
    : this(
        selectors:
...
class GoogleCloudOsconfigV2betaPolicyOrchestrator {
  ...
  ///
  /// Required.
  GoogleCloudOsconfigV2betaOrchestratedResource? orchestratedResource;
  ...
  ///
  /// Optional.
  GoogleCloudOsconfigV2betaOrchestrationScope? orchestrationScope;
  ...
  GoogleCloudOsconfigV2betaPolicyOrchestrator.fromJson(core.Map json_)
    : this(
        ...
        orchestratedResource:
            json_.containsKey('orchestratedResource')
                ? GoogleCloudOsconfigV2betaOrchestratedResource.fromJson(
        ...
        orchestrationScope:
            json_.containsKey('orchestrationScope')
                ? GoogleCloudOsconfigV2betaOrchestrationScope.fromJson(
