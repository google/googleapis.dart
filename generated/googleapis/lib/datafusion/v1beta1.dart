...
///       - [ProjectsLocationsInstancesNamespacesResource]
...
class ProjectsLocationsResource {
  ...
  async.Future<RemoveIamPolicyResponse> removeIamPolicy(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$resource') + ':removeIamPolicy';
...
class ProjectsLocationsInstancesResource {
  ...
  ProjectsLocationsInstancesNamespacesResource get namespaces =>
      ProjectsLocationsInstancesNamespacesResource(_requester);
  ...
  async.Future<Operation> restart(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':restart';
  ...
  /// projects/{project}/locations/{location}/instances/{instance} Instance will
  /// be upgraded with the latest stable version of the Data Fusion.
  /// Value must have pattern
  /// `^projects/\[^/\]+/locations/\[^/\]+/instances/\[^/\]+$`.
  ///
  /// [$fields] - Selector specifying which fields to include in a partial
...
class ProjectsLocationsInstancesDnsPeeringsResource {
  ...
  async.Future<DnsPeering> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/dnsPeerings';
...
class ProjectsLocationsInstancesNamespacesResource {
  final commons.ApiRequester _requester;

  ProjectsLocationsInstancesNamespacesResource(commons.ApiRequester client)
    : _requester = client;
  ...
  /// information associated with a namespace gets returned (e.g. IAM policy set
  /// on the namespace)
...
class IAMPolicy {
  ...
  IAMPolicy({this.policy, this.status});
...
class Instance {
  ...
  Instance.fromJson(core.Map json_)
    : this(
        ...
        eventPublishConfig:
            json_.containsKey('eventPublishConfig')
        ...
        loggingConfig:
            json_.containsKey('loggingConfig')
                ...
                : null,
        maintenanceEvents:
            (json_['maintenanceEvents'] as core.List?)
                ?.map(
...
class MaintenanceWindow {
  ...
  MaintenanceWindow.fromJson(core.Map json_)
    : this(
        recurringTimeWindow:
            json_.containsKey('recurringTimeWindow')
...
class Namespace {
  ...
  Namespace({this.iamPolicy, this.name});
...
typedef RemoveIamPolicyResponse = $Empty;
