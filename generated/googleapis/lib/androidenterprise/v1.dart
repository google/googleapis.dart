...
class EnterprisesResource {
  ...
  /// hour.
  ///
  /// [enrollmentToken_enrollmentTokenType] - \[Required\] The type of the
  /// enrollment token.
  /// Possible string values are:
  ...
  ///
  /// [enrollmentToken_token] - The token value that's passed to the device and
  /// authorizes the device to enroll. This is a read-only field generated by
  /// the server.
  ///
  /// [$fields] - Selector specifying which fields to include in a partial
  /// response.
  ...
  async.Future<CreateEnrollmentTokenResponse> createEnrollmentToken(
    ...
    final queryParams_ = <core.String, core.List<core.String>>{
      ...
      if (enrollmentToken_token != null)
        'enrollmentToken.token': [enrollmentToken_token],
      if ($fields != null) 'fields': [$fields],
    };
...
class CreateEnrollmentTokenResponse {
  ...
  CreateEnrollmentTokenResponse({this.enrollmentToken, this.token});
...
class EnrollmentToken {
  ...
  EnrollmentToken({this.duration, this.enrollmentTokenType, this.token});
