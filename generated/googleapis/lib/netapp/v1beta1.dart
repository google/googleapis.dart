...
class ProjectsLocationsActiveDirectoriesResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/activeDirectories';
...
class ProjectsLocationsBackupPoliciesResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/backupPolicies';
...
class ProjectsLocationsBackupVaultsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/backupVaults';
...
class ProjectsLocationsKmsConfigsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/kmsConfigs';
  ...
  async.Future<Operation> encrypt(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':encrypt';
  ...
  async.Future<VerifyKmsConfigResponse> verify(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':verify';
...
class ProjectsLocationsStoragePoolsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/storagePools';
  ...
  async.Future<Operation> switch_(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':switch';
  ...
  async.Future<Operation> validateDirectoryService(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$name') + ':validateDirectoryService';
...
class ProjectsLocationsVolumesResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/volumes';
...
class ProjectsLocationsVolumesQuotaRulesResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/quotaRules';
...
class ProjectsLocationsVolumesReplicationsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/replications';
  ...
  async.Future<Operation> establishPeering(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$name') + ':establishPeering';
  ...
  async.Future<Operation> reverseDirection(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$name') + ':reverseDirection';
  ...
  async.Future<Operation> sync(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':sync';
