...
typedef ActiveDirectory = $ActiveDirectory;

/// A NetApp Backup.
typedef Backup = $Backup01;

/// BackupConfig contains backup related config on a volume.
typedef BackupConfig = $BackupConfig;

/// Backup Policy.
typedef BackupPolicy = $BackupPolicy;

/// Retention policy for backups in the backup vault
typedef BackupRetentionPolicy = $BackupRetentionPolicy;
...
typedef DailySchedule = $DailySchedule;
...
typedef EstablishPeeringRequest = $EstablishPeeringRequest;
...
typedef HourlySchedule = $HourlySchedule;

/// HybridPeeringDetails contains details about the hybrid peering.
typedef HybridPeeringDetails = $HybridPeeringDetails;
...
typedef MonthlySchedule = $MonthlySchedule;

/// View only mount options for a volume.
typedef MountOption = $MountOption;
...
typedef RestoreParameters = $RestoreParameters;
...
typedef RevertVolumeRequest = $RevertVolumeRequest;

/// An export policy rule describing various export options.
typedef SimpleExportPolicyRule = $SimpleExportPolicyRule;

/// Snapshot is a point-in-time version of a Volume's content.
typedef Snapshot = $Snapshot01;
...
typedef StopReplicationRequest = $StopReplicationRequest;
...
typedef StoragePool = $StoragePool;
...
typedef TieringPolicy = $TieringPolicy;

/// TransferStats reports all statistics related to replication transfer.
typedef TransferStats = $TransferStats;

/// ValidateDirectoryServiceRequest validates the directory service policy
/// attached to the storage pool.
typedef ValidateDirectoryServiceRequest = $ValidateDirectoryServiceRequest;
...
/// and error message.
typedef VerifyKmsConfigResponse = $VerifyKmsConfigResponse;
...
/// 23:50
typedef WeeklySchedule = $WeeklySchedule00;
