...
class FoldersLocationsReplaysResource {
  ...
  async.Future<GoogleLongrunningOperation> create(
    GoogleCloudPolicysimulatorV1betaReplay request,
    core.String parent, {
    core.String? $fields,
  }) async {
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$parent') + '/replays';
  ...
  /// response.
  ///
  /// Completes with a [GoogleCloudPolicysimulatorV1betaReplay].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<GoogleCloudPolicysimulatorV1betaReplay> get(
    core.String name, {
    core.String? $fields,
  }) async {
    final queryParams_ = <core.String, core.List<core.String>>{
    ...
    return GoogleCloudPolicysimulatorV1betaReplay.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
  ...
  /// Value must have pattern `^folders/\[^/\]+/locations/\[^/\]+$`.
  ///
  /// [pageSize] - The maximum number of Replay objects to return. Defaults to
  /// 50. The maximum value is 1000; values above 1000 are rounded down to 1000.
  ///
  ...
  /// response.
  ///
  /// Completes with a [GoogleCloudPolicysimulatorV1betaListReplaysResponse].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<GoogleCloudPolicysimulatorV1betaListReplaysResponse> list(
    core.String parent, {
    core.int? pageSize,
    ...
    return GoogleCloudPolicysimulatorV1betaListReplaysResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
}
...
class FoldersLocationsReplaysResultsResource {
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<GoogleCloudPolicysimulatorV1betaListReplayResultsResponse> list(
    core.String parent, {
    core.int? pageSize,
    core.String? pageToken,
    core.String? $fields,
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$parent') + '/results';
    ...
    return GoogleCloudPolicysimulatorV1betaListReplayResultsResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
}
...
class OrganizationsLocationsOrgPolicyViolationsPreviewsResource {
  ...
  /// this method will complete with the same error.
  async.Future<GoogleLongrunningOperation> create(
    GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview request,
    core.String parent, {
  ...
  /// GenerateOrgPolicyViolationsPreview generates an OrgPolicyViolationsPreview
  ...
  async.Future<GoogleLongrunningOperation> generate(
    ...
    final url_ =
        'v1beta/' +
        core.Uri.encodeFull('$parent') +
        '/orgPolicyViolationsPreviews:generate';
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview> get(
    core.String name, {
    core.String? $fields,
  }) async {
    final queryParams_ = <core.String, core.List<core.String>>{
    ...
    return GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
  ...
  list(
    ...
    return GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
}
...
class OrganizationsLocationsOrgPolicyViolationsPreviewsOrgPolicyViolationsResource {
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse>
  list(
    core.String parent, {
    core.int? pageSize,
    core.String? pageToken,
    ...
    final url_ =
        'v1beta/' + core.Uri.encodeFull('$parent') + '/orgPolicyViolations';
    ...
    return GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
}
...
class GoogleCloudPolicysimulatorV1betaAccessStateDiff {
  ...
  GoogleCloudPolicysimulatorV1betaExplainedAccess? baseline;

  /// The results of evaluating the access tuple under the proposed (simulated)
  /// policies.
  ///
  /// If the AccessState couldn't be fully evaluated, this field explains why.
  GoogleCloudPolicysimulatorV1betaExplainedAccess? simulated;
  ...
  GoogleCloudPolicysimulatorV1betaAccessStateDiff.fromJson(core.Map json_)
    : this(
        accessChange: json_['accessChange'] as core.String?,
        baseline:
            json_.containsKey('baseline')
                ? GoogleCloudPolicysimulatorV1betaExplainedAccess.fromJson(
...
typedef GoogleCloudPolicysimulatorV1betaAccessTuple = $AccessTuple;
...
class GoogleCloudPolicysimulatorV1betaBindingExplanation {
  ...
  GoogleCloudPolicysimulatorV1betaBindingExplanation.fromJson(core.Map json_)
    : this(
...
typedef GoogleCloudPolicysimulatorV1betaBindingExplanationAnnotatedMembership =
...
class GoogleCloudPolicysimulatorV1betaExplainedAccess {
  ...
  ///
  /// If the `AccessState` is `GRANTED` or `NOT_GRANTED`, this field is omitted.
  core.List<GoogleCloudPolicysimulatorV1betaExplainedPolicy>? policies;
  ...
  GoogleCloudPolicysimulatorV1betaExplainedAccess.fromJson(core.Map json_)
    : this(
        ...
        policies:
            (json_['policies'] as core.List?)
                ?.map(
                  (value) =>
                      GoogleCloudPolicysimulatorV1betaExplainedPolicy.fromJson(
                        value as core.Map<core.String, core.dynamic>,
                      ),
                )
                .toList(),
...
class GoogleCloudPolicysimulatorV1betaExplainedPolicy {
  ...
  core.List<GoogleCloudPolicysimulatorV1betaBindingExplanation>?
  bindingExplanations;
  ...
  GoogleCloudPolicysimulatorV1betaExplainedPolicy.fromJson(core.Map json_)
    : this(
        access: json_['access'] as core.String?,
        bindingExplanations:
...
class GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsPreviewsResponse {
  ...
  core.List<GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview>?
  orgPolicyViolationsPreviews;
...
class GoogleCloudPolicysimulatorV1betaListOrgPolicyViolationsResponse {
  ...
  core.List<GoogleCloudPolicysimulatorV1betaOrgPolicyViolation>?
  orgPolicyViolations;
...
class GoogleCloudPolicysimulatorV1betaListReplayResultsResponse {
  ...
  core.List<GoogleCloudPolicysimulatorV1betaReplayResult>? replayResults;
    ...
    core.Map json_,
        ...
        replayResults:
            (json_['replayResults'] as core.List?)
                ?.map(
                  (value) =>
                      GoogleCloudPolicysimulatorV1betaReplayResult.fromJson(
                        value as core.Map<core.String, core.dynamic>,
                      ),
                )
                .toList(),
...
class GoogleCloudPolicysimulatorV1betaListReplaysResponse {
  ...
  core.List<GoogleCloudPolicysimulatorV1betaReplay>? replays;
  ...
  GoogleCloudPolicysimulatorV1betaListReplaysResponse.fromJson(core.Map json_)
    : this(
        nextPageToken: json_['nextPageToken'] as core.String?,
        replays:
            (json_['replays'] as core.List?)
                ?.map(
                  (value) => GoogleCloudPolicysimulatorV1betaReplay.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
class GoogleCloudPolicysimulatorV1betaOrgPolicyOverlay {
  ...
  ///
  /// Optional.
  core.List<GoogleCloudPolicysimulatorV1betaOrgPolicyOverlayPolicyOverlay>?
  policies;
  ...
  GoogleCloudPolicysimulatorV1betaOrgPolicyOverlay.fromJson(core.Map json_)
    : this(
        customConstraints:
...
class GoogleCloudPolicysimulatorV1betaOrgPolicyViolation {
  ...
  GoogleCloudPolicysimulatorV1betaResourceContext? resource;
  ...
  GoogleCloudPolicysimulatorV1betaOrgPolicyViolation.fromJson(core.Map json_)
    : this(
        customConstraint:
            json_.containsKey('customConstraint')
                ? GoogleCloudOrgpolicyV2CustomConstraint.fromJson(
        ...
        resource:
            json_.containsKey('resource')
                ? GoogleCloudPolicysimulatorV1betaResourceContext.fromJson(
...
class GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreview {
  ...
  ///
  /// Required.
  GoogleCloudPolicysimulatorV1betaOrgPolicyOverlay? overlay;
...
/// A summary of the state of all resources scanned for compliance with the
/// changed OrgPolicy.
typedef GoogleCloudPolicysimulatorV1betaOrgPolicyViolationsPreviewResourceCounts =
...
class GoogleCloudPolicysimulatorV1betaReplay {
  ...
  ///
  /// Required.
  GoogleCloudPolicysimulatorV1betaReplayConfig? config;
  ...
  ///
  /// Output only.
  GoogleCloudPolicysimulatorV1betaReplayResultsSummary? resultsSummary;
  ...
  GoogleCloudPolicysimulatorV1betaReplay.fromJson(core.Map json_)
    : this(
        config:
            json_.containsKey('config')
                ? GoogleCloudPolicysimulatorV1betaReplayConfig.fromJson(
...
class GoogleCloudPolicysimulatorV1betaReplayConfig {
  ...
  GoogleCloudPolicysimulatorV1betaReplayConfig.fromJson(core.Map json_)
    : this(
...
class GoogleCloudPolicysimulatorV1betaReplayDiff {
  ...
  /// field.
  GoogleCloudPolicysimulatorV1betaAccessStateDiff? accessDiff;

  GoogleCloudPolicysimulatorV1betaReplayDiff({this.accessDiff});

  GoogleCloudPolicysimulatorV1betaReplayDiff.fromJson(core.Map json_)
    : this(
        accessDiff:
            json_.containsKey('accessDiff')
                ? GoogleCloudPolicysimulatorV1betaAccessStateDiff.fromJson(
...
class GoogleCloudPolicysimulatorV1betaReplayResult {
  ...
  GoogleCloudPolicysimulatorV1betaAccessTuple? accessTuple;
  ...
  /// proposed policies.
  GoogleCloudPolicysimulatorV1betaReplayDiff? diff;
  ...
  GoogleCloudPolicysimulatorV1betaReplayResult.fromJson(core.Map json_)
    : this(
        accessTuple:
            json_.containsKey('accessTuple')
                ? GoogleCloudPolicysimulatorV1betaAccessTuple.fromJson(
                  json_['accessTuple'] as core.Map<core.String, core.dynamic>,
                )
                : null,
        diff:
            json_.containsKey('diff')
                ? GoogleCloudPolicysimulatorV1betaReplayDiff.fromJson(
...
class GoogleCloudPolicysimulatorV1betaReplayResultsSummary {
  ...
  GoogleCloudPolicysimulatorV1betaReplayResultsSummary.fromJson(core.Map json_)
    : this(
...
typedef GoogleCloudPolicysimulatorV1betaResourceContext = $ResourceContext;
