...
class GoogleFirebaseAppcheckV1BatchGetPlayIntegrityConfigsResponse {
  ...
  GoogleFirebaseAppcheckV1BatchGetPlayIntegrityConfigsResponse.fromJson(
    core.Map json_,
        ...
        configs: (json_['configs'] as core.List?)
            ?.map(
              (value) => GoogleFirebaseAppcheckV1PlayIntegrityConfig.fromJson(
                value as core.Map<core.String, core.dynamic>,
              ),
            )
            .toList(),
...
class GoogleFirebaseAppcheckV1BatchUpdateServicesRequest {
  ...
  GoogleFirebaseAppcheckV1BatchUpdateServicesRequest.fromJson(core.Map json_)
    : this(
        requests: (json_['requests'] as core.List?)
            ?.map(
              (value) => GoogleFirebaseAppcheckV1UpdateServiceRequest.fromJson(
                value as core.Map<core.String, core.dynamic>,
              ),
            )
            .toList(),
...
class GoogleFirebaseAppcheckV1ExchangeAppAttestAttestationResponse {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    final artifact = this.artifact;
    return {'appCheckToken': ?appCheckToken, 'artifact': ?artifact};
  }
}
...
class GoogleFirebaseAppcheckV1ExchangeCustomTokenRequest {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    final limitedUse = this.limitedUse;
    return {'customToken': ?customToken, 'limitedUse': ?limitedUse};
  }
}
...
class GoogleFirebaseAppcheckV1Service {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final enforcementMode = this.enforcementMode;
    final name = this.name;
    return {'enforcementMode': ?enforcementMode, 'name': ?name};
  }
}
