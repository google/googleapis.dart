...
class ProjectsLocationsRolloutKindsResource {
  ...
  async.Future<RolloutKind> create(
    ...
    final queryParams_ = <core.String, core.List<core.String>>{
      'requestId': ?requestId == null ? null : [requestId],
      'rolloutKindId': ?rolloutKindId == null ? null : [rolloutKindId],
      'validateOnly': ?validateOnly == null ? null : ['${validateOnly}'],
      'fields': ?$fields == null ? null : [$fields],
    };

    final url_ = 'v1/' + core.Uri.encodeFull('$parent') + '/rolloutKinds';
...
class ProjectsLocationsSaasResource {
  ...
  async.Future<Saas> create(
    ...
    final queryParams_ = <core.String, core.List<core.String>>{
      'requestId': ?requestId == null ? null : [requestId],
      'saasId': ?saasId == null ? null : [saasId],
      'validateOnly': ?validateOnly == null ? null : ['${validateOnly}'],
      'fields': ?$fields == null ? null : [$fields],
    };

    final url_ = 'v1/' + core.Uri.encodeFull('$parent') + '/saas';
...
class ProjectsLocationsTenantsResource {
  ...
  async.Future<Tenant> create(
    ...
    final url_ = 'v1/' + core.Uri.encodeFull('$parent') + '/tenants';
...
class ProjectsLocationsUnitKindsResource {
  ...
  async.Future<UnitKind> create(
    ...
    final queryParams_ = <core.String, core.List<core.String>>{
      'requestId': ?requestId == null ? null : [requestId],
      'unitKindId': ?unitKindId == null ? null : [unitKindId],
      'validateOnly': ?validateOnly == null ? null : ['${validateOnly}'],
      'fields': ?$fields == null ? null : [$fields],
    };

    final url_ = 'v1/' + core.Uri.encodeFull('$parent') + '/unitKinds';
...
class ProjectsLocationsUnitOperationsResource {
  ...
  async.Future<UnitOperation> create(
    ...
    final queryParams_ = <core.String, core.List<core.String>>{
      'requestId': ?requestId == null ? null : [requestId],
      'unitOperationId': ?unitOperationId == null ? null : [unitOperationId],
      'validateOnly': ?validateOnly == null ? null : ['${validateOnly}'],
      'fields': ?$fields == null ? null : [$fields],
    };

    final url_ = 'v1/' + core.Uri.encodeFull('$parent') + '/unitOperations';
...
class ProjectsLocationsUnitsResource {
  ...
  async.Future<Unit> create(
    ...
    final url_ = 'v1/' + core.Uri.encodeFull('$parent') + '/units';
...
class Blueprint {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    return {'engine': ?engine, 'package': ?package, 'version': ?version};
  }
}
...
class Dependency {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    return {'alias': ?alias, 'unitKind': ?unitKind};
  }
}
...
class ErrorBudget {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final allowedCount = this.allowedCount;
    final allowedPercentage = this.allowedPercentage;
    return {
...
class FlagUpdate {
  /// Flag release being applied by UnitOperation.
  ///
  /// Required.
  core.String? flagRelease;

  FlagUpdate({this.flagRelease});
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    return {'flagRelease': ?flagRelease};
  }
}
...
class FromMapping {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    final outputVariable = this.outputVariable;
    return {'dependency': ?dependency, 'outputVariable': ?outputVariable};
  }
}
...
class ListRolloutKindsResponse {
  ...
  ListRolloutKindsResponse.fromJson(core.Map json_)
    : this(
        nextPageToken: json_['nextPageToken'] as core.String?,
        rolloutKinds: (json_['rolloutKinds'] as core.List?)
            ?.map(
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final nextPageToken = this.nextPageToken;
    final rolloutKinds = this.rolloutKinds;
    final unreachable = this.unreachable;
    return {
      'nextPageToken': ?nextPageToken,
      'rolloutKinds': ?rolloutKinds,
      'unreachable': ?unreachable,
    };
  }
}
...
class ListSaasResponse {
  ...
  ListSaasResponse.fromJson(core.Map json_)
    : this(
        nextPageToken: json_['nextPageToken'] as core.String?,
        saas: (json_['saas'] as core.List?)
            ?.map(
              (value) =>
                  Saas.fromJson(value as core.Map<core.String, core.dynamic>),
            )
            .toList(),
        unreachable: (json_['unreachable'] as core.List?)
            ?.map((value) => value as core.String)
...
class ListUnitKindsResponse {
  ...
  ListUnitKindsResponse.fromJson(core.Map json_)
    : this(
        nextPageToken: json_['nextPageToken'] as core.String?,
        unitKinds: (json_['unitKinds'] as core.List?)
            ?.map(
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final nextPageToken = this.nextPageToken;
    final unitKinds = this.unitKinds;
    final unreachable = this.unreachable;
    return {
      'nextPageToken': ?nextPageToken,
      'unitKinds': ?unitKinds,
...
class ListUnitOperationsResponse {
  ...
  ListUnitOperationsResponse.fromJson(core.Map json_)
    : this(
        nextPageToken: json_['nextPageToken'] as core.String?,
        unitOperations: (json_['unitOperations'] as core.List?)
            ?.map(
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final nextPageToken = this.nextPageToken;
    final unitOperations = this.unitOperations;
    final unreachable = this.unreachable;
    return {
      'nextPageToken': ?nextPageToken,
  ...
  ListUnitsResponse.fromJson(core.Map json_)
    : this(
        ...
        units: (json_['units'] as core.List?)
            ?.map(
              (value) =>
                  Unit.fromJson(value as core.Map<core.String, core.dynamic>),
            )
            .toList(),
        unreachable: (json_['unreachable'] as core.List?)
            ?.map((value) => value as core.String)
...
class MaintenanceSettings {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final pinnedUntilTime = this.pinnedUntilTime;
    return {'pinnedUntilTime': ?pinnedUntilTime};
  }
}
...
class Provision {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    return {'inputVariables': ?inputVariables, 'release': ?release};
  }
}
...
class Release {
  ...
  Release.fromJson(core.Map json_)
    : this(
        ...
        blueprint: json_.containsKey('blueprint')
            ? Blueprint.fromJson(
        ...
        inputVariableDefaults: (json_['inputVariableDefaults'] as core.List?)
            ?.map(
              (value) => UnitVariable.fromJson(
                value as core.Map<core.String, core.dynamic>,
              ),
        ...
        outputVariables: (json_['outputVariables'] as core.List?)
            ...
            .toList(),
        releaseRequirements: json_.containsKey('releaseRequirements')
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    final inputVariableDefaults = this.inputVariableDefaults;
    final inputVariables = this.inputVariables;
    final labels = this.labels;
    final name = this.name;
    final outputVariables = this.outputVariables;
    final releaseRequirements = this.releaseRequirements;
    final uid = this.uid;
    final unitKind = this.unitKind;
...
class ReleaseRequirements {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final upgradeableFromReleases = this.upgradeableFromReleases;
    return {'upgradeableFromReleases': ?upgradeableFromReleases};
  }
}
...
class Rollout {
  ...
  /// The timestamp when the resource was marked for deletion (deletion is an
  ...
  ///
  /// Contains a CEL(https://github.com/google/cel-spec) expression consisting
  /// of a conjunction of Rollout.unit_filter and RolloutKind.unit_filter. This
  /// field captures the filter applied by the Rollout to determine the Unit
  /// population. If the associated RolloutKind's unit_filter is modified after
  ...
  ///
  /// Release and FlagRelease are mutually exclusive. Note: `release` comment
  ...
  Rollout.fromJson(core.Map json_)
    : this(
        ...
        effectiveUnitFilter: json_['effectiveUnitFilter'] as core.String?,
        endTime: json_['endTime'] as core.String?,
        etag: json_['etag'] as core.String?,
        flagRelease: json_['flagRelease'] as core.String?,
        labels: (json_['labels'] as core.Map<core.String, core.dynamic>?)?.map(
          (key, value) => core.MapEntry(key, value as core.String),
        ),
        name: json_['name'] as core.String?,
...
class RolloutControl {
  ...
  RolloutControl.fromJson(core.Map json_)
    : this(
        ...
        runParams: json_.containsKey('runParams')
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    final runParams = this.runParams;
    return {'action': ?action, 'runParams': ?runParams};
  }
}
...
class RolloutKind {
  ...
  RolloutKind.fromJson(core.Map json_)
    : this(
        ...
        createTime: json_['createTime'] as core.String?,
        errorBudget: json_.containsKey('errorBudget')
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final annotations = this.annotations;
    final createTime = this.createTime;
    final errorBudget = this.errorBudget;
    final etag = this.etag;
    final labels = this.labels;
    final name = this.name;
    final rolloutOrchestrationStrategy = this.rolloutOrchestrationStrategy;
...
class RolloutStats {
  /// Estimated number of units based.
  ///
  /// The estimation is computed upon creation of the rollout.
  ///
  /// Optional. Output only.
  core.String? estimatedTotalUnitCount;
  ...
  RolloutStats.fromJson(core.Map json_)
    : this(
        estimatedTotalUnitCount:
            json_['estimatedTotalUnitCount'] as core.String?,
        operationsByState: (json_['operationsByState'] as core.List?)
            ?.map(
...
class RunRolloutActionParams {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final retryFailedOperations = this.retryFailedOperations;
    return {'retryFailedOperations': ?retryFailedOperations};
  }
}
...
class Saas {
  ...
  ///
  /// Output only.
  core.List<SaasCondition>? conditions;
...
class SaasCondition {
  ...
  SaasCondition.fromJson(core.Map json_)
    : this(
...
class Tenant {
  ...
  ///
  /// Part of the App Lifecycle Manager common data model.
  ///
  /// Required. Immutable.
  core.String? saas;
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final annotations = this.annotations;
    final consumerResource = this.consumerResource;
    final createTime = this.createTime;
    final etag = this.etag;
    final labels = this.labels;
    final name = this.name;
...
class ToMapping {
  ...
  /// Tells App Lifecycle Manager if this mapping should be used during lookup
  /// or not
  ///
  /// Optional.
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final dependency = this.dependency;
    final ignoreForLookup = this.ignoreForLookup;
    final inputVariable = this.inputVariable;
    return {
...
class Unit {
  ...
  ///
  /// Optional. Output only.
  core.List<core.String>? flagRevisions;
  ...
  /// Indicates whether the resource location satisfies Zone Separation
  /// constraints.
  ///
  ...
  Unit.fromJson(core.Map json_)
    : this(
        ...
        dependencies: (json_['dependencies'] as core.List?)
            ...
            .toList(),
        dependents: (json_['dependents'] as core.List?)
            ?.map(
              (value) => UnitDependency.fromJson(
                value as core.Map<core.String, core.dynamic>,
              ),
            ...
            .toList(),
        etag: json_['etag'] as core.String?,
        flagRevisions: (json_['flagRevisions'] as core.List?)
            ?.map((value) => value as core.String)
            .toList(),
        inputVariables: (json_['inputVariables'] as core.List?)
            ?.map(
        ...
        maintenance: json_.containsKey('maintenance')
        ...
        name: json_['name'] as core.String?,
        ongoingOperations: (json_['ongoingOperations'] as core.List?)
            ?.map((value) => value as core.String)
            .toList(),
        outputVariables: (json_['outputVariables'] as core.List?)
            ?.map(
            ...
            .toList(),
        pendingOperations: (json_['pendingOperations'] as core.List?)
            ?.map((value) => value as core.String)
            .toList(),
        release: json_['release'] as core.String?,
        satisfiesPzi: json_['satisfiesPzi'] as core.bool?,
        satisfiesPzs: json_['satisfiesPzs'] as core.bool?,
        scheduledOperations: (json_['scheduledOperations'] as core.List?)
            ?.map((value) => value as core.String)
            .toList(),
        state: json_['state'] as core.String?,
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    final etag = this.etag;
    final flagRevisions = this.flagRevisions;
    final inputVariables = this.inputVariables;
    final labels = this.labels;
    final maintenance = this.maintenance;
    final managementMode = this.managementMode;
    final name = this.name;
    final ongoingOperations = this.ongoingOperations;
    final outputVariables = this.outputVariables;
    final pendingOperations = this.pendingOperations;
    final release = this.release;
    final satisfiesPzi = this.satisfiesPzi;
    final satisfiesPzs = this.satisfiesPzs;
    final scheduledOperations = this.scheduledOperations;
    final state = this.state;
    final systemCleanupAt = this.systemCleanupAt;
    final systemManagedState = this.systemManagedState;
...
class UnitKind {
  ...
  ///
  /// Newly created units will use the flag default_flag_revisions present at
  ...
  /// the producer wants to manage with App Lifecycle Manager.
  ///
  /// Part of the App Lifecycle Manager common data model. Immutable once set.
  ///
  /// Required. Immutable.
  core.String? saas;
  ...
  UnitKind.fromJson(core.Map json_)
    : this(
        ...
        dependencies: (json_['dependencies'] as core.List?)
            ...
            .toList(),
        etag: json_['etag'] as core.String?,
        inputVariableMappings: (json_['inputVariableMappings'] as core.List?)
            ?.map(
        ...
        name: json_['name'] as core.String?,
        outputVariableMappings: (json_['outputVariableMappings'] as core.List?)
            ?.map(
              (value) => VariableMapping.fromJson(
                value as core.Map<core.String, core.dynamic>,
              ),
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    final dependencies = this.dependencies;
    final etag = this.etag;
    final inputVariableMappings = this.inputVariableMappings;
    final labels = this.labels;
    final name = this.name;
    final outputVariableMappings = this.outputVariableMappings;
    final saas = this.saas;
    final uid = this.uid;
    final updateTime = this.updateTime;
    return {
...
/// in all unit operations. Next: 22
class UnitOperation {
  /// Annotations is an unstructured key-value map stored with a resource that
  /// may be set by external tools to store and retrieve arbitrary metadata.
  ///
  ...
  UnitOperation.fromJson(core.Map json_)
    : this(
        ...
        createTime: json_['createTime'] as core.String?,
        deleteTime: json_['deleteTime'] as core.String?,
        deprovision: json_.containsKey('deprovision')
        ...
        etag: json_['etag'] as core.String?,
        flagUpdate: json_.containsKey('flagUpdate')
            ? FlagUpdate.fromJson(
                json_['flagUpdate'] as core.Map<core.String, core.dynamic>,
              )
            : null,
        labels: (json_['labels'] as core.Map<core.String, core.dynamic>?)?.map(
          (key, value) => core.MapEntry(key, value as core.String),
        ...
        provision: json_.containsKey('provision')
            ? Provision.fromJson(
...
class UnitVariable {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    return {'type': ?type, 'value': ?value, 'variable': ?variable};
  }
}
...
class VariableMapping {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    final to = this.to;
    final variable = this.variable;
    return {'from': ?from, 'to': ?to, 'variable': ?variable};
  }
}
