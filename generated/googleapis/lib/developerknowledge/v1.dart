...
class AnswerQueryRequest {
  /// Applies a strict filter to the search results used to ground the answer.
  ///
  /// The expression supports a subset of the syntax described at
  ...
  AnswerQueryRequest({this.filter, this.query});
