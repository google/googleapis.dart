...
class GoogleCloudKnowledgeV1alpha1BatchUpdateQuestionAnswerEntriesResponse {
  /// The list of question-answer-entries.
  core.List<GoogleCloudKnowledgeV1alpha1QuestionAnswerEntry>
  ...
  GoogleCloudKnowledgeV1alpha1BatchUpdateQuestionAnswerEntriesResponse.fromJson(
      core.Map _json) {
    if (_json.containsKey("questionAnswerEntries")) {
      questionAnswerEntries = (_json["questionAnswerEntries"] as core.List)
          .map<GoogleCloudKnowledgeV1alpha1QuestionAnswerEntry>((value) =>
              new GoogleCloudKnowledgeV1alpha1QuestionAnswerEntry.fromJson(
                  value))
          .toList();
    }
  }
  ...
  core.Map<core.String, core.Object> toJson() {
    final core.Map<core.String, core.Object> _json =
        new core.Map<core.String, core.Object>();
    if (questionAnswerEntries != null) {
      _json["questionAnswerEntries"] =
          questionAnswerEntries.map((value) => (value).toJson()).toList();
    }
    return _json;
  }
}
...
class GoogleCloudKnowledgeV1alpha1QuestionAnswerEntry {
  ...
  GoogleCloudKnowledgeV1alpha1QuestionAnswerEntry();

  GoogleCloudKnowledgeV1alpha1QuestionAnswerEntry.fromJson(core.Map _json) {
    if (_json.containsKey("answer")) {
      answer = _json["answer"];
    }
    if (_json.containsKey("name")) {
