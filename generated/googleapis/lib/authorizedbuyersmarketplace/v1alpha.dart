...
/// Authorized Buyers Marketplace API - v1alpha
///
...
class BiddersAuctionPackagesResource {
  ...
  ///
  /// Buyers can use the URL path "/v1alpha/buyers/{accountId}/auctionPackages"
  /// to list auction packages for the current buyer and its clients. Bidders
  /// can use the URL path "/v1alpha/bidders/{accountId}/auctionPackages" to
  /// list auction packages for the bidder, its media planners, its buyers, and
  /// all their clients.
  ///
  /// Request parameters:
  ///
  ...
  async.Future<ListAuctionPackagesResponse> list(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$parent') + '/auctionPackages';
...
class BiddersFinalizedDealsResource {
  ...
  ///
  /// Use the URL path "/v1alpha/buyers/{accountId}/finalizedDeals" to list
  /// finalized deals for the current buyer and its clients. Bidders can use the
  /// URL path "/v1alpha/bidders/{accountId}/finalizedDeals" to list finalized
  ...
  async.Future<ListFinalizedDealsResponse> list(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$parent') + '/finalizedDeals';
...
class BuyersResource {
  ...
  BuyersDataSegmentsResource get dataSegments =>
      BuyersDataSegmentsResource(_requester);
...
class BuyersAuctionPackagesResource {
  ...
  async.Future<AuctionPackage> subscribe(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$name') + ':subscribe';
  ...
  async.Future<AuctionPackage> subscribeClients(
    ...
    final url_ =
        'v1alpha/' +
        core.Uri.encodeFull('$auctionPackage') +
        ':subscribeClients';
  ...
  async.Future<AuctionPackage> unsubscribe(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$name') + ':unsubscribe';
...
class BuyersClientsResource {
  ...
  async.Future<Client> activate(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$name') + ':activate';
  ...
  async.Future<Client> create(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$parent') + '/clients';
  ...
  async.Future<Client> deactivate(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$name') + ':deactivate';
...
class BuyersClientsUsersResource {
  ...
  async.Future<ClientUser> create(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$parent') + '/users';
...
class BuyersDataSegmentsResource {
  final commons.ApiRequester _requester;

  BuyersDataSegmentsResource(commons.ApiRequester client) : _requester = client;
  ...
  /// Value must have pattern `^buyers/\[^/\]+/dataSegments/\[^/\]+$`.
  ///
  /// [$fields] - Selector specifying which fields to include in a partial
  /// response.
  ///
  ...
  async.Future<DataSegment> create(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$parent') + '/dataSegments';
...
class BuyersFinalizedDealsResource {
  ...
  async.Future<FinalizedDeal> addCreative(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$deal') + ':addCreative';
  ...
  async.Future<FinalizedDeal> setReadyToServe(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$deal') + ':setReadyToServe';
...
class BuyersProposalsResource {
  ...
  async.Future<Proposal> accept(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$name') + ':accept';
  ...
  async.Future<Proposal> addNote(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$proposal') + ':addNote';
  ...
  async.Future<Proposal> cancelNegotiation(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$proposal') + ':cancelNegotiation';
  ...
  async.Future<ListProposalsResponse> list(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$parent') + '/proposals';
  ...
  async.Future<Proposal> sendRfp(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$buyer') + '/proposals:sendRfp';
...
class BuyersProposalsDealsResource {
  ...
  async.Future<BatchUpdateDealsResponse> batchUpdate(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$parent') + '/deals:batchUpdate';
  ...
  async.Future<ListDealsResponse> list(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$parent') + '/deals';
...
class BuyersPublisherProfilesResource {
  ...
  async.Future<ListPublisherProfilesResponse> list(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$parent') + '/publisherProfiles';
...
class Deal {
  ...
  Deal.fromJson(core.Map json_)
    : this(
        ...
        creativeRequirements:
            json_.containsKey('creativeRequirements')
        ...
        deliveryControl:
            json_.containsKey('deliveryControl')
        ...
        mediaPlanner:
            json_.containsKey('mediaPlanner')
        ...
        preferredDealTerms:
            json_.containsKey('preferredDealTerms')
                ...
                : null,
        privateAuctionTerms:
            json_.containsKey('privateAuctionTerms')
        ...
        sellerTimeZone:
            json_.containsKey('sellerTimeZone')
                ? TimeZone.fromJson(
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (name != null) 'name': name!,
    if (preferredDealTerms != null) 'preferredDealTerms': preferredDealTerms!,
...
class FinalizedDeal {
  ...
  FinalizedDeal.fromJson(core.Map json_)
    : this(
        deal:
            json_.containsKey('deal')
                ? Deal.fromJson(
                  json_['deal'] as core.Map<core.String, core.dynamic>,
                )
                : null,
        dealPausingInfo:
            json_.containsKey('dealPausingInfo')
...
class MarketplaceTargeting {
  ...
  MarketplaceTargeting.fromJson(core.Map json_)
    : this(
        ...
        inventoryTypeTargeting:
            json_.containsKey('inventoryTypeTargeting')
                ...
                : null,
        placementTargeting:
            json_.containsKey('placementTargeting')
        ...
        verticalTargeting:
            json_.containsKey('verticalTargeting')
                ...
                : null,
        videoTargeting:
            json_.containsKey('videoTargeting')
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (inventoryTypeTargeting != null)
      'inventoryTypeTargeting': inventoryTypeTargeting!,
    if (placementTargeting != null) 'placementTargeting': placementTargeting!,
...
class MobileApplicationTargeting {
  ...
  MobileApplicationTargeting.fromJson(core.Map json_)
    : this(
        firstPartyTargeting:
            json_.containsKey('firstPartyTargeting')
  ...
  OperatingSystemTargeting.fromJson(core.Map json_)
    : this(
        operatingSystemCriteria:
            json_.containsKey('operatingSystemCriteria')
                ? CriteriaTargeting.fromJson(
    ...
    : this(
        mobileApplicationTargeting:
            json_.containsKey('mobileApplicationTargeting')
                ...
                : null,
        uriTargeting:
            json_.containsKey('uriTargeting')
...
class PrivateAuctionTerms {
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (openAuctionAllowed != null) 'openAuctionAllowed': openAuctionAllowed!,
  };
}
...
class PublisherProfile {
  ...
  PublisherProfile.fromJson(core.Map json_)
    : this(
        ...
        pitchStatement: json_['pitchStatement'] as core.String?,
        programmaticDealsContact:
            json_['programmaticDealsContact'] as core.String?,
        publisherCode: json_['publisherCode'] as core.String?,
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (directDealsContact != null) 'directDealsContact': directDealsContact!,
    if (displayName != null) 'displayName': displayName!,
  ...
  TechnologyTargeting.fromJson(core.Map json_)
    : this(
        ...
        deviceCategoryTargeting:
            json_.containsKey('deviceCategoryTargeting')
                ? CriteriaTargeting.fromJson(
