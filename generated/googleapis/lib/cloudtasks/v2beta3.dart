...
class ProjectsLocationsResource {
  ...
  async.Future<Location> get(core.String name, {core.String? $fields}) async {
    ...
    final url_ = 'v2beta3/' + core.Uri.encodeFull('$name');
  ...
  async.Future<ListLocationsResponse> list(
    ...
    final url_ = 'v2beta3/' + core.Uri.encodeFull('$name') + '/locations';
...
class ProjectsLocationsQueuesResource {
  ...
  async.Future<Queue> create(
    ...
    final url_ = 'v2beta3/' + core.Uri.encodeFull('$parent') + '/queues';
  ...
  /// returned except \[Queue.stats\]. \[Queue.stats\] will be returned only if
  /// it was explicitly specified in the mask.
  ///
  /// [$fields] - Selector specifying which fields to include in a partial
  /// response.
  ///
  ...
  async.Future<Policy> getIamPolicy(
    ...
    final url_ =
        'v2beta3/' + core.Uri.encodeFull('$resource') + ':getIamPolicy';
  ...
  async.Future<Queue> pause(
    ...
    final url_ = 'v2beta3/' + core.Uri.encodeFull('$name') + ':pause';
  ...
  async.Future<Queue> purge(
    ...
    final url_ = 'v2beta3/' + core.Uri.encodeFull('$name') + ':purge';
  ...
  async.Future<Queue> resume(
    ...
    final url_ = 'v2beta3/' + core.Uri.encodeFull('$name') + ':resume';
  ...
  async.Future<Policy> setIamPolicy(
    ...
    final url_ =
        'v2beta3/' + core.Uri.encodeFull('$resource') + ':setIamPolicy';
  ...
  async.Future<TestIamPermissionsResponse> testIamPermissions(
    ...
    final url_ =
        'v2beta3/' + core.Uri.encodeFull('$resource') + ':testIamPermissions';
...
class ProjectsLocationsQueuesTasksResource {
  ...
  /// a random task ID is assigned to the task.
  ///
  /// [$fields] - Selector specifying which fields to include in a partial
  /// response.
  ///
  ...
  async.Future<Task> create(
    ...
    final url_ = 'v2beta3/' + core.Uri.encodeFull('$parent') + '/tasks';
  ...
  async.Future<Task> run(
    ...
    final url_ = 'v2beta3/' + core.Uri.encodeFull('$name') + ':run';
...
///
/// The task will be delivered to the App Engine application hostname specified
/// by its AppEngineHttpQueue and AppEngineHttpRequest. The documentation for
/// AppEngineHttpRequest explains how the task's host URL is constructed. Using
...
class AppEngineHttpQueue {
  ...
  ///
  /// If set, `app_engine_routing_override` is used for all tasks in the queue,
  ...
  AppEngineHttpQueue.fromJson(core.Map json_)
    : this(
...
class Attempt {
  ...
  Attempt.fromJson(core.Map json_)
    : this(
        ...
        responseStatus:
            json_.containsKey('responseStatus')
                ? Status.fromJson(
...
class HttpRequest {
  ...
  /// the task and are predefined in Cloud Tasks. * Host: This will be computed
...
class HttpTarget {
  ...
  /// The HTTP method to use for the request.
  ///
  /// When specified, it overrides HttpRequest.http_method for the task. Note
  /// that if the value is set to HttpMethod.GET the HttpRequest.body of the
  /// task will be ignored at execution time.
  /// Possible string values are:
  /// - "HTTP_METHOD_UNSPECIFIED" : HTTP method unspecified
  /// - "POST" : HTTP POST
  /// - "GET" : HTTP GET
  ...
  /// If specified, an
  /// [OAuth token](https://developers.google.com/identity/protocols/OAuth2) is
...
/// Pull Message.
///
/// This proto can only be used for tasks in a queue which has PULL type. It
/// currently exists for backwards compatibility with the App Engine Task Queue
/// SDK. This message type maybe returned with methods list and get, when the
/// response view is FULL.
class PullMessage {
  ...
  /// The tasks's tag.
  ///
  /// The tag is less than 500 characters. SDK compatibility: Although the SDK
  ...
  PullMessage({this.payload, this.tag});

  PullMessage.fromJson(core.Map json_)
    : this(
...
class Queue {
  ...
  /// The realtime, informational statistics for a queue.
  ///
  /// In order to receive the statistics the caller should include this field in
  /// the FieldMask.
  ///
  /// Output only.
  QueueStats? stats;
  ...
  /// of whether it was dispatched or not. The minimum value is 10 days. The
  /// maximum value is 10 years. The value must be given as a string that
  /// indicates the length of time (in seconds) followed by `s` (for "seconds").
  /// For more information on the format, see the documentation for
  ...
  ///
  /// After a task is deleted or executed, the task's tombstone is retained for
  /// the length of time specified by `tombstone_ttl`. The tombstone is used by
  /// task de-duplication; another task with the same name can't be created
  /// until the tombstone has expired. For more information about task
  /// de-duplication, see the documentation for CreateTaskRequest. The minimum
  /// value is 1 hour. The maximum value is 9 days. The value must be given as a
  /// string that indicates the length of time (in seconds) followed by `s` (for
  /// "seconds"). For more information on the format, see the documentation for
  /// [Duration](https://protobuf.dev/reference/protobuf/google.protobuf/#duration).
  /// Queues created by Cloud Tasks have a default `tombstone_ttl` of 1 hour.
  core.String? tombstoneTtl;

  /// The type of a queue (push or pull).
  ///
  ...
  Queue.fromJson(core.Map json_)
    : this(
        appEngineHttpQueue:
            json_.containsKey('appEngineHttpQueue')
                ? AppEngineHttpQueue.fromJson(
                  json_['appEngineHttpQueue']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
        httpTarget:
        ...
        stats:
            json_.containsKey('stats')
                ...
                : null,
        taskTtl: json_['taskTtl'] as core.String?,
        tombstoneTtl: json_['tombstoneTtl'] as core.String?,
        type: json_['type'] as core.String?,
      );

  core.Map<core.String, core.dynamic> toJson() => {
    if (appEngineHttpQueue != null) 'appEngineHttpQueue': appEngineHttpQueue!,
    ...
    if (taskTtl != null) 'taskTtl': taskTtl!,
    if (tombstoneTtl != null) 'tombstoneTtl': tombstoneTtl!,
    if (type != null) 'type': type!,
  };
}

/// Statistics for a queue.
typedef QueueStats = $QueueStats;
...
class RateLimits {
  ...
  /// The default value of `max_burst_size` is picked by Cloud Tasks based on
  /// the value of max_dispatches_per_second. The maximum value of
  /// `max_burst_size` is 500. For App Engine queues that were created or
  ...
  /// `max_burst_size`, `max_burst_size` value will get updated if UpdateQueue
  /// is updating max_dispatches_per_second.
  ...
  RateLimits.fromJson(core.Map json_)
    : this(
        ...
        maxConcurrentDispatches: json_['maxConcurrentDispatches'] as core.int?,
...
class Task {
  ...
  /// Pull Message contained in a task in a PULL queue type.
  ///
  /// This payload type cannot be explicitly set through Cloud Tasks API. Its
  ...
  Task.fromJson(core.Map json_)
    : this(
        appEngineHttpRequest:
            json_.containsKey('appEngineHttpRequest')
        ...
        firstAttempt:
            json_.containsKey('firstAttempt')
                ? Attempt.fromJson(
        ...
        name: json_['name'] as core.String?,
        pullMessage:
            json_.containsKey('pullMessage')
                ? PullMessage.fromJson(
                  json_['pullMessage'] as core.Map<core.String, core.dynamic>,
                )
                : null,
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (name != null) 'name': name!,
    if (pullMessage != null) 'pullMessage': pullMessage!,
...
class UriOverride {
  ...
  UriOverride.fromJson(core.Map json_)
    : this(
        ...
        pathOverride:
            json_.containsKey('pathOverride')
