...
/// Network Management API - v1beta1
///
...
class OrganizationsLocationsVpcFlowLogsConfigsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/vpcFlowLogsConfigs';
...
class ProjectsLocationsGlobalConnectivityTestsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/connectivityTests';
  ...
  async.Future<Operation> rerun(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':rerun';
...
class Endpoint {
  ...
  Endpoint.fromJson(core.Map json_)
    : this(
        alloyDbInstance: json_['alloyDbInstance'] as core.String?,
        appEngineVersion:
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    if (alloyDbInstance != null) 'alloyDbInstance': alloyDbInstance!,
