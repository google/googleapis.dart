...
class Transport {
  ...
  Transport.fromJson(core.Map _json) {
...
class Trigger {
  ...
  Trigger.fromJson(core.Map _json) {
    ...
    if (_json.containsKey('transport')) {
      transport = Transport.fromJson(
          _json['transport'] as core.Map<core.String, core.dynamic>);
    }
  ...
  core.Map<core.String, core.Object> toJson() {
    ...
    if (transport != null) {
      _json['transport'] = transport.toJson();
    }
    if (uid != null) {
      _json['uid'] = uid;
    }
