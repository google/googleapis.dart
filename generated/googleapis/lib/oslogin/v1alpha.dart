...
class ProjectsLocationsResource {
  ...
  signSshPublicKey(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$parent') + ':signSshPublicKey';
    ...
    return GoogleCloudOsloginControlplaneRegionalV1alphaSignSshPublicKeyResponse.fromJson(
...
class UsersResource {
  ...
  async.Future<LoginProfile> getLoginProfile(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$name') + '/loginProfile';
  ...
  ///
  /// [regions] - Optional. The regions to wait for a POSIX account to be
  /// written to before returning a response. If unspecified, defaults to all
  ...
  async.Future<ImportSshPublicKeyResponse> importSshPublicKey(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$parent') + ':importSshPublicKey';
...
class UsersSshPublicKeysResource {
  ...
  async.Future<SshPublicKey> create(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$parent') + '/sshPublicKeys';
...
typedef GoogleCloudOsloginControlplaneRegionalV1alphaSignSshPublicKeyRequest =
    $SignSshPublicKeyRequest00;

/// The response message for signing an SSH public key.
typedef GoogleCloudOsloginControlplaneRegionalV1alphaSignSshPublicKeyResponse =
