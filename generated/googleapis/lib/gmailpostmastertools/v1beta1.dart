...
class DomainsTrafficStatsResource {
  ...
  async.Future<ListTrafficStatsResponse> list(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/trafficStats';
...
class IpReputation {
  ...
  ///
  /// This metric only pertains to traffic that passed
  /// [SPF](http://www.openspf.org/) or [DKIM](http://www.dkim.org/). Deprecated
  ...
  IpReputation({this.ipCount, this.numIps, this.reputation, this.sampleIps});

  IpReputation.fromJson(core.Map json_)
    : this(
        ipCount: json_['ipCount'] as core.String?,
        numIps: json_['numIps'] as core.String?,
