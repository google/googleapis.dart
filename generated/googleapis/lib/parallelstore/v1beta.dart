...
class ProjectsLocationsInstancesResource {
  ...
  async.Future<Operation> exportData(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$name') + ':exportData';
  ...
  async.Future<Operation> importData(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$name') + ':importData';
...
typedef TransferMetadataOptions = $TransferMetadataOptions;
