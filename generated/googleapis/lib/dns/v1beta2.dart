...
class ManagedZonesResource {
  ...
  async.Future<GoogleIamV1Policy> getIamPolicy(
    ...
    final url_ =
        'dns/v1beta2/' + core.Uri.encodeFull('$resource') + ':getIamPolicy';
  ...
  async.Future<GoogleIamV1Policy> setIamPolicy(
    ...
    final url_ =
        'dns/v1beta2/' + core.Uri.encodeFull('$resource') + ':setIamPolicy';
...
class ProjectsResource {
  ...
  async.Future<Project> get(
    ...
    final url_ = 'dns/v1beta2/projects/' + commons.escapeVariable('$project');
