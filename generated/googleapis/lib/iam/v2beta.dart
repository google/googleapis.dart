...
/// Identity and Access Management (IAM) API - v2beta
///
...
class PoliciesResource {
  ...
  async.Future<GoogleLongrunningOperation> createPolicy(
    ...
    final url_ = 'v2beta/' + core.Uri.encodeFull('$parent');
  ...
  /// response.
  ///
  /// Completes with a [GoogleIamV2betaPolicy].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<GoogleIamV2betaPolicy> get(
    core.String name, {
    core.String? $fields,
  }) async {
    final queryParams_ = <core.String, core.List<core.String>>{
    ...
    return GoogleIamV2betaPolicy.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
  ...
  /// response.
  ///
  /// Completes with a [GoogleIamV2betaListPoliciesResponse].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<GoogleIamV2betaListPoliciesResponse> listPolicies(
    core.String parent, {
    core.int? pageSize,
    ...
    return GoogleIamV2betaListPoliciesResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
...
class GoogleIamV2betaDenyRule {
  ...
  GoogleIamV2betaDenyRule.fromJson(core.Map json_)
    : this(
        denialCondition:
...
class GoogleIamV2betaListPoliciesResponse {
  ...
  core.List<GoogleIamV2betaPolicy>? policies;

  GoogleIamV2betaListPoliciesResponse({this.nextPageToken, this.policies});

  GoogleIamV2betaListPoliciesResponse.fromJson(core.Map json_)
    : this(
        nextPageToken: json_['nextPageToken'] as core.String?,
        policies:
            (json_['policies'] as core.List?)
                ?.map(
                  (value) => GoogleIamV2betaPolicy.fromJson(
...
class GoogleIamV2betaPolicy {
  ...
  core.List<GoogleIamV2betaPolicyRule>? rules;
  ...
  GoogleIamV2betaPolicy.fromJson(core.Map json_)
    : this(
        ...
        rules:
            (json_['rules'] as core.List?)
                ?.map(
                  (value) => GoogleIamV2betaPolicyRule.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
class GoogleIamV2betaPolicyRule {
  ...
  GoogleIamV2betaDenyRule? denyRule;
  ...
  GoogleIamV2betaPolicyRule({this.denyRule, this.description});

  GoogleIamV2betaPolicyRule.fromJson(core.Map json_)
    : this(
        denyRule:
            json_.containsKey('denyRule')
                ? GoogleIamV2betaDenyRule.fromJson(
