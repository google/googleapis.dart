...
class ProjectsLocationsAcceleratorTypesResource {
  ...
  async.Future<ListAcceleratorTypesResponse> list(
    ...
    final url_ =
        'v1alpha1/' + core.Uri.encodeFull('$parent') + '/acceleratorTypes';
...
class ProjectsLocationsNodesResource {
  ...
  async.Future<Operation> reimage(
    ...
    final url_ = 'v1alpha1/' + core.Uri.encodeFull('$name') + ':reimage';
  ...
  async.Future<Operation> start(
    ...
    final url_ = 'v1alpha1/' + core.Uri.encodeFull('$name') + ':start';
  ...
  async.Future<Operation> stop(
    ...
    final url_ = 'v1alpha1/' + core.Uri.encodeFull('$name') + ':stop';
...
class ProjectsLocationsTensorflowVersionsResource {
  ...
  async.Future<ListTensorFlowVersionsResponse> list(
    ...
    final url_ =
        'v1alpha1/' + core.Uri.encodeFull('$parent') + '/tensorflowVersions';
