...
library doubleclickbidmanager_v2;
...
class Parameters {
  ...
  /// can be used. **Warning:** The `AUDIENCE_COMPOSITION` report type will be
  /// deprecated in Display & Video 360 on **June 8, 2023**. Once deprecated,
  /// you will no longer be able to create new or retrieve existing Query and
  /// Report resources of this type.
  /// Possible string values are:
  ...
  /// - "AUDIENCE_COMPOSITION" : Audience Composition report. **Warning:** This
