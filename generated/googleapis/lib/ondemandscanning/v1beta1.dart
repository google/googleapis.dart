...
class AnalyzePackagesRequest {
  ...
  AnalyzePackagesRequest({this.packages, this.resourceUri});
...
class BinarySourceInfo {
  ...
  BinarySourceInfo.fromJson(core.Map json_)
    : this(
        binaryVersion:
            json_.containsKey('binaryVersion')
...
class ListVulnerabilitiesResponse {
  ...
  ListVulnerabilitiesResponse({this.nextPageToken, this.occurrences});
