...
class ProjectsJobsResource {
  ...
  async.Future<Empty> batchDelete(
    ...
    final url_ = 'v3/' + core.Uri.encodeFull('$parent') + '/jobs:batchDelete';
  ...
  async.Future<SearchJobsResponse> search(
    ...
    final url_ = 'v3/' + core.Uri.encodeFull('$parent') + '/jobs:search';
...
class ClientEvent {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    final parentEventId = this.parentEventId;
...
class CompensationHistogramRequest {
    ...
    : this(
        bucketingOption: json_.containsKey('bucketingOption')
            ? NumericBucketingOption.fromJson(
                json_['bucketingOption'] as core.Map<core.String, core.dynamic>,
              )
            : null,
        type: json_['type'] as core.String?,
      );
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final bucketingOption = this.bucketingOption;
    final type = this.type;
    return {'bucketingOption': ?bucketingOption, 'type': ?type};
  }
}
...
class CreateClientEventRequest {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final clientEvent = this.clientEvent;
...
class CustomAttributeHistogramRequest {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final key = this.key;
    final longValueHistogramBucketingOption =
        this.longValueHistogramBucketingOption;
    final stringValueHistogram = this.stringValueHistogram;
    return {
      'key': ?key,
...
class CustomAttributeHistogramResult {
  ...
  CustomAttributeHistogramResult.fromJson(core.Map json_)
    : this(
        key: json_['key'] as core.String?,
        longValueHistogramResult: json_.containsKey('longValueHistogramResult')
            ? NumericBucketingResult.fromJson(
...
class HistogramFacets {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final compensationHistogramFacets = this.compensationHistogramFacets;
    final customAttributeHistogramFacets = this.customAttributeHistogramFacets;
    final simpleHistogramFacets = this.simpleHistogramFacets;
    return {
...
class HistogramResult {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    return {'searchType': ?searchType, 'values': ?values};
  }
}
...
class HistogramResults {
    ...
    : this(
        ...
        customAttributeHistogramResults:
            (json_['customAttributeHistogramResults'] as core.List?)
                ...
                .toList(),
        simpleHistogramResults: (json_['simpleHistogramResults'] as core.List?)
            ?.map(
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final compensationHistogramResults = this.compensationHistogramResults;
    final customAttributeHistogramResults =
        this.customAttributeHistogramResults;
    final simpleHistogramResults = this.simpleHistogramResults;
    return {
...
class JobQuery {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    final companyNames = this.companyNames;
...
class NumericBucketingOption {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final bucketBounds = this.bucketBounds;
    final requiresMinMax = this.requiresMinMax;
    return {'bucketBounds': ?bucketBounds, 'requiresMinMax': ?requiresMinMax};
  }
}
...
class SearchJobsRequest {
    ...
    : this(
        ...
        histogramFacets: json_.containsKey('histogramFacets')
            ? HistogramFacets.fromJson(
                json_['histogramFacets'] as core.Map<core.String, core.dynamic>,
              )
            : null,
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    final histogramFacets = this.histogramFacets;
    ...
    final requirePreciseResultSize = this.requirePreciseResultSize;
...
class SpellingCorrection {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    return {'corrected': ?corrected, 'correctedText': ?correctedText};
  }
}
...
class UpdateCompanyRequest {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    return {'company': ?company, 'updateMask': ?updateMask};
  }
}
...
class UpdateJobRequest {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final job = this.job;
    final updateMask = this.updateMask;
    return {'job': ?job, 'updateMask': ?updateMask};
  }
}
