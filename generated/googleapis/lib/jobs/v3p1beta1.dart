...
/// Cloud Talent Solution API - v3p1beta1
///
...
class ProjectsResource {
  ...
  async.Future<CompleteQueryResponse> complete(
    ...
    final url_ = 'v3p1beta1/' + core.Uri.encodeFull('$name') + ':complete';
...
class ProjectsClientEventsResource {
  ...
  async.Future<ClientEvent> create(
    ...
    final url_ =
        'v3p1beta1/' + core.Uri.encodeFull('$parent') + '/clientEvents';
...
class ProjectsCompaniesResource {
  ...
  async.Future<Company> create(
    ...
    final url_ = 'v3p1beta1/' + core.Uri.encodeFull('$parent') + '/companies';
  ...
  async.Future<Empty> delete(core.String name, {core.String? $fields}) async {
    ...
    final url_ = 'v3p1beta1/' + core.Uri.encodeFull('$name');
...
class ProjectsJobsResource {
  ...
  async.Future<Empty> batchDelete(
    ...
    final url_ =
        'v3p1beta1/' + core.Uri.encodeFull('$parent') + '/jobs:batchDelete';
  ...
  async.Future<Job> create(
    ...
    final url_ = 'v3p1beta1/' + core.Uri.encodeFull('$parent') + '/jobs';
  ...
  async.Future<SearchJobsResponse> search(
    ...
    final url_ = 'v3p1beta1/' + core.Uri.encodeFull('$parent') + '/jobs:search';
  ...
  async.Future<SearchJobsResponse> searchForAlert(
    ...
    final url_ =
        'v3p1beta1/' + core.Uri.encodeFull('$parent') + '/jobs:searchForAlert';
...
class HistogramQuery {
  ...
  /// buckets)`: Count the number of matching entity within each bucket. A
  ...
  /// separator surrounded by square brackets. For example, \[1, 2, 3\] and
  /// \["one", "two", "three"\]. Built-in constants: * MIN (minimum number
  ...
  /// or bucket(1, 10). Job histogram facets: * company_id: histogram by
  ...
  /// "MEDIUM", "BIG". * publish_time_in_day: histogram by the Job.publish_time
  ...
  /// specify list of numeric buckets in spec. * publish_time_in_year: histogram
  /// by the Job.publish_time in years. Must specify list of numeric buckets in
  /// spec. * degree_type: histogram by the Job.degree_type. For example,
  ...
  /// For example, "WEEKLY", "MONTHLY". * base_compensation: histogram by the
...
class SearchJobsRequest {
  ...
  /// to the SearchJobsRequest.custom_ranking_info.ranking_expression with
