...
///     - [ProjectsLocationsAssistantSessionsResource]
...
class ProjectsLocationsResource {
  ...
  ProjectsLocationsAssistantSessionsResource get assistantSessions =>
      ProjectsLocationsAssistantSessionsResource(_requester);
...
class ProjectsLocationsAssistantSessionsResource {
  final commons.ApiRequester _requester;

  ProjectsLocationsAssistantSessionsResource(commons.ApiRequester client)
    : _requester = client;
  ...
  /// Request parameters:
  ///
  /// [parent] - Required. The parent resource where this assistant session will
  /// be created. Format: projects/{project}/locations/{location}
  /// Value must have pattern `^projects/\[^/\]+/locations/\[^/\]+$`.
  ///
  /// [assistantSessionId] - Optional. The ID to use for the assistant session,
  /// which will become the final component of the assistant session's resource
  /// name. If not provided, a random UUID will be generated by the server. This
  /// value should be 4-64 characters and must match the regular expression
  /// `^[a-z0-9-]{4,64}$`.
  ///
  /// [$fields] - Selector specifying which fields to include in a partial
  /// response.
  ///
  /// Completes with a [GoogleCloudContactcenterinsightsV1AssistantSession].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<GoogleCloudContactcenterinsightsV1AssistantSession> create(
    GoogleCloudContactcenterinsightsV1AssistantSession request,
    core.String parent, {
    core.String? assistantSessionId,
    core.String? $fields,
  }) async {
    final body_ = convert.json.encode(request);
    final queryParams_ = <core.String, core.List<core.String>>{
    ...
    final url_ = 'v1/' + core.Uri.encodeFull('$parent') + '/assistantSessions';
    ...
    return GoogleCloudContactcenterinsightsV1AssistantSession.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
  ...
  /// Request parameters:
  ///
  /// [name] - Required. The name of the assistant session to retrieve. Format:
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<GoogleCloudContactcenterinsightsV1AssistantSession> get(
    core.String name, {
    core.String? $fields,
  }) async {
    final queryParams_ = <core.String, core.List<core.String>>{
  ...
  /// assistant sessions. Format: `projects/{project}/locations/{location}`
  /// Value must have pattern `^projects/\[^/\]+/locations/\[^/\]+$`.
  ///
  /// [filter] - Optional. A filter to reduce results to a specific subset.
  ///
  /// [pageSize] - Optional. The maximum number of assistant sessions to return
  /// in a single response. If unspecified, at most 100 assistant sessions will
  /// be returned. The maximum value is 1000; values above 1000 will be coerced
  /// to 1000.
  ///
  /// [pageToken] - Optional. A page token, received from a previous
  /// `ListAssistantSessions` call. Provide this to retrieve the subsequent
  /// page.
  ///
  /// [$fields] - Selector specifying which fields to include in a partial
  /// response.
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<GoogleCloudContactcenterinsightsV1ListAssistantSessionsResponse>
  list(
    core.String parent, {
    core.String? filter,
    core.int? pageSize,
    ...
    return GoogleCloudContactcenterinsightsV1ListAssistantSessionsResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
  ...
  /// Request parameters:
  ///
  /// [name] - Required. The name of the assistant session to stream chat.
  /// Format:
  /// `projects/{project}/locations/{location}/assistantSessions/{assistant_session}`
  /// Value must have pattern
  /// `^projects/\[^/\]+/locations/\[^/\]+/assistantSessions/\[^/\]+$`.
  ...
  /// response.
  ///
  /// Completes with a [GoogleCloudContactcenterinsightsV1StreamChatResponse].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<GoogleCloudContactcenterinsightsV1StreamChatResponse> streamChat(
    GoogleCloudContactcenterinsightsV1StreamChatRequest request,
    core.String name, {
    core.String? $fields,
  }) async {
    final body_ = convert.json.encode(request);
    ...
    final url_ = 'v1/' + core.Uri.encodeFull('$name') + ':streamChat';
    ...
    return GoogleCloudContactcenterinsightsV1StreamChatResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
}
...
class GoogleCloudContactcenterinsightsV1AssistantChunk {
  ...
  GoogleCloudContactcenterinsightsV1AssistantChunk({this.text});

  GoogleCloudContactcenterinsightsV1AssistantChunk.fromJson(core.Map json_)
...
class GoogleCloudContactcenterinsightsV1AssistantMessage {
  ...
  ///
  /// Required.
  core.List<GoogleCloudContactcenterinsightsV1AssistantChunk>? chunks;
  ...
  GoogleCloudContactcenterinsightsV1AssistantMessage.fromJson(core.Map json_)
    : this(
        chunks: (json_['chunks'] as core.List?)
            ?.map(
              (value) =>
                  GoogleCloudContactcenterinsightsV1AssistantChunk.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
            )
            .toList(),
...
class GoogleCloudContactcenterinsightsV1AssistantSession {
  ...
  /// History of messages in the session.
  ///
  /// Optional.
  core.List<GoogleCloudContactcenterinsightsV1AssistantMessage>? messages;

  /// Identifier.
  ///
  /// Resource name of the session. Format:
  /// projects/{project}/locations/{location}/assistantSessions/{assistant_session}
  core.String? name;
  ...
  GoogleCloudContactcenterinsightsV1AssistantSession.fromJson(core.Map json_)
    : this(
        createTime: json_['createTime'] as core.String?,
        displayName: json_['displayName'] as core.String?,
        messages: (json_['messages'] as core.List?)
            ?.map(
              (value) =>
                  GoogleCloudContactcenterinsightsV1AssistantMessage.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
            )
            .toList(),
        name: json_['name'] as core.String?,
        requester: json_['requester'] as core.String?,
        state: json_['state'] as core.String?,
        updateTime: json_['updateTime'] as core.String?,
      );
...
class GoogleCloudContactcenterinsightsV1Conversation {
  ...
  /// JSON metadata encoded as a string.
  ///
  /// This field is primarily used by Insights integrations with various
  /// telephony systems and must be in one of Insight's supported formats.
  ///
  /// Optional.
...
class GoogleCloudContactcenterinsightsV1ConversationQualityMetadataAgentInfo {
  ...
  GoogleCloudContactcenterinsightsV1ConversationQualityMetadataAgentInfo.fromJson(
    core.Map json_,
        ...
        entrySubagentId: json_['entrySubagentId'] as core.String?,
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    final entrySubagentId = this.entrySubagentId;
...
class GoogleCloudContactcenterinsightsV1GcsSource {
  /// Deprecated: Use `audio_uris` instead.
  ///
  /// Cloud Storage URI that points to a file that contains the conversation
  /// audio.
  ///
  ...
  /// Cloud Storage URIs that point to files that contain the conversation
  /// audio.
  ///
  /// Supports both single audio files and multi-leg session recordings (e.g.,
  /// call transfers, rolling recording buffers).
  ///
  /// Immutable.
  core.List<core.String>? audioUris;
  ...
  GoogleCloudContactcenterinsightsV1GcsSource.fromJson(core.Map json_)
    : this(
        audioUri: json_['audioUri'] as core.String?,
        audioUris: (json_['audioUris'] as core.List?)
            ?.map((value) => value as core.String)
            .toList(),
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final audioUri = this.audioUri;
    final audioUris = this.audioUris;
...
class GoogleCloudContactcenterinsightsV1ListAssistantSessionsResponse {
  ...
  core.List<GoogleCloudContactcenterinsightsV1AssistantSession>?
  assistantSessions;
  ...
  GoogleCloudContactcenterinsightsV1ListAssistantSessionsResponse.fromJson(
    core.Map json_,
  ) : this(
        assistantSessions: (json_['assistantSessions'] as core.List?)
            ?.map(
              (value) =>
                  GoogleCloudContactcenterinsightsV1AssistantSession.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
            )
            .toList(),
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final assistantSessions = this.assistantSessions;
    final nextPageToken = this.nextPageToken;
    return {
...
class GoogleCloudContactcenterinsightsV1QaScorecard {
  ...
  /// - "QA_SCORECARD_SOURCE_INTENT_TAXONOMY" : The scorecard is derived from
  /// the custom intent taxonomy. Customers can edit question content, but
  /// cannot delete the scorecard or add/remove questions.
  core.String? source;
...
class GoogleCloudContactcenterinsightsV1RedirectAction {
  ...
  core.Map<core.String, core.String>? queryParams;
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    return {'queryParams': ?queryParams, 'relativePath': ?relativePath};
  }
}
...
class GoogleCloudContactcenterinsightsV1SignedAudioUris {
  ...
  /// The signed URIs for the audio from the Cloud Storage conversation source
  /// when multiple audio files exist (e.g. multi-leg conversations).
  ///
  /// Output only.
  core.List<core.String>? signedGcsAudioUris;
  ...
  GoogleCloudContactcenterinsightsV1SignedAudioUris.fromJson(core.Map json_)
    : this(
        ...
        signedGcsAudioUris: (json_['signedGcsAudioUris'] as core.List?)
            ?.map((value) => value as core.String)
            .toList(),
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    final signedGcsAudioUris = this.signedGcsAudioUris;
    ...
    return {
      ...
      'signedGcsAudioUris': ?signedGcsAudioUris,
...
class GoogleCloudContactcenterinsightsV1StreamChatRequest {
  ...
  GoogleCloudContactcenterinsightsV1StreamChatRequest({this.message});

  GoogleCloudContactcenterinsightsV1StreamChatRequest.fromJson(core.Map json_)
...
class GoogleCloudContactcenterinsightsV1StreamChatResponse {
  ...
  GoogleCloudContactcenterinsightsV1AssistantChunk? chunk;
  ...
  GoogleCloudContactcenterinsightsV1StreamChatResponse.fromJson(core.Map json_)
    : this(
        chunk: json_.containsKey('chunk')
            ? GoogleCloudContactcenterinsightsV1AssistantChunk.fromJson(
