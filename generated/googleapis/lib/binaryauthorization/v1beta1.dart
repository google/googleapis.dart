...
class ProjectsAttestorsResource {
  ...
  async.Future<Attestor> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/attestors';
  ...
  Attestor.fromJson(core.Map json_)
    : this(
        ...
        userOwnedDrydockNote:
            json_.containsKey('userOwnedDrydockNote')
                ? UserOwnedDrydockNote.fromJson(
                  json_['userOwnedDrydockNote']
...
class PkixPublicKey {
  ...
  PkixPublicKey({this.publicKeyPem, this.signatureAlgorithm});
...
class UserOwnedDrydockNote {
  ...
  /// The Drydock resource name of a ATTESTATION_AUTHORITY Note, created by the
  /// user, in the format: `projects / * /notes / * ` (or the legacy `providers
  /// / * /notes / * `).
  ///
  /// This field may not be updated. An attestation by this attestor is stored
  /// as a Drydock ATTESTATION_AUTHORITY Occurrence that names a container image
  ...
  UserOwnedDrydockNote.fromJson(core.Map json_)
    : this(
