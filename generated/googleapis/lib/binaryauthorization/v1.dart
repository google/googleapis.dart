...
class AdmissionWhitelistPattern {
  ...
  AdmissionWhitelistPattern({this.namePattern});
...
class AllowlistResult {
  ...
  AllowlistResult({this.matchedPattern});
...
class EvaluateGkePolicyRequest {
  ...
  EvaluateGkePolicyRequest({this.resource});
...
class EvaluateGkePolicyResponse {
  ...
  EvaluateGkePolicyResponse({this.results, this.verdict});
...
class IamPolicy {
  ...
  IamPolicy({this.bindings, this.etag, this.version});
...
class ImageAllowlist {
  ...
  ImageAllowlist({this.allowPattern});
...
class ListAttestorsResponse {
  ...
  ListAttestorsResponse({this.attestors, this.nextPageToken});
...
class ListPlatformPoliciesResponse {
  ...
  ListPlatformPoliciesResponse({this.nextPageToken, this.platformPolicies});
...
class PkixPublicKey {
  ...
  /// contents of the `key_id` field exactly. The ID may be explicitly provided
  /// by the caller, but it MUST be a valid RFC3986 URI. If `key_id` is left
  /// blank and this `PkixPublicKey` is not used in the context of a wrapper
  /// (see next paragraph), a default key ID will be computed based on the
  /// digest of the DER encoding of the public key. If this `PkixPublicKey` is
  ...
  /// or be left blank, in which case it behaves exactly as though it is equal
...
class PkixPublicKeySet {
  ...
  PkixPublicKeySet({this.pkixPublicKeys});
    ...
    : this(
        admissionWhitelistPatterns:
            (json_['admissionWhitelistPatterns'] as core.List?)
                ?.map(
                  (value) => AdmissionWhitelistPattern.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
class SigstoreAuthority {
  ...
  SigstoreAuthority({this.displayName, this.publicKeySet});
...
class SigstorePublicKey {
  ...
  SigstorePublicKey({this.publicKeyPem});
...
class SigstorePublicKeySet {
  ...
  SigstorePublicKeySet({this.publicKeys});
...
class SigstoreSignatureCheck {
  ...
  SigstoreSignatureCheck({this.sigstoreAuthorities});
    ...
    : this(
        attestationAuthenticators:
            (json_['attestationAuthenticators'] as core.List?)
                ?.map(
                  (value) => AttestationAuthenticator.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
class TrustedDirectoryCheck {
  ...
  TrustedDirectoryCheck({this.trustedDirPatterns});
...
class VerificationRule {
  ...
  /// A CEL expression for specifying custom constraints on the provenance
  /// payload.
  ///
  /// This can be used when users want to specify expectations on provenance
  /// fields that are not covered by the general check. For example, users can
  /// use this field to require that certain parameters should never be used
    ...
    : this(
        ...
        containerAnalysisVulnerabilityProjects:
            (json_['containerAnalysisVulnerabilityProjects'] as core.List?)
                ?.map((value) => value as core.String)
                .toList(),
        maximumFixableSeverity: json_['maximumFixableSeverity'] as core.String?,
