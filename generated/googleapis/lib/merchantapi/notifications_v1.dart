...
class AccountsNotificationsubscriptionsResource {
  ...
  ///
  /// For standalone or sub-accounts, the business can create a subscription for
  /// self. For advanced accounts, the business can create a subscription for
  ...
  /// Value must have pattern `^accounts/\[^/\]+$`.
  ///
  /// [pageSize] - Optional. The maximum number of notification subscriptions to
  /// return in a page. The default value for `page_size` is 100. The maximum
  ...
  /// Generated by the Merchant API upon creation of a new
