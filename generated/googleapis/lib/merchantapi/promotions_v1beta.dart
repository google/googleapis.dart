...
/// Merchant API - promotions_v1beta
///
...
class AccountsPromotionsResource {
  ...
  async.Future<Promotion> get(core.String name, {core.String? $fields}) async {
    ...
    final url_ = 'promotions/v1beta/' + core.Uri.encodeFull('$name');
  ...
  /// Value must have pattern `^accounts/\[^/\]+$`.
  ///
  /// [pageSize] - Output only. The maximum number of promotions to return. The
  ...
  async.Future<ListPromotionsResponse> list(
    ...
    final url_ =
        'promotions/v1beta/' + core.Uri.encodeFull('$parent') + '/promotions';
    ...
    : this(
        brandExclusion:
            (json_['brandExclusion'] as core.List?)
                ...
                .toList(),
        brandInclusion:
            (json_['brandInclusion'] as core.List?)
                ?.map((value) => value as core.String)
                .toList(),
        ...
        itemGroupIdInclusion:
            (json_['itemGroupIdInclusion'] as core.List?)
                ?.map((value) => value as core.String)
                .toList(),
        itemIdExclusion:
            (json_['itemIdExclusion'] as core.List?)
                ...
                .toList(),
        itemIdInclusion:
            (json_['itemIdInclusion'] as core.List?)
                ?.map((value) => value as core.String)
                .toList(),
        ...
        productTypeInclusion:
            (json_['productTypeInclusion'] as core.List?)
                ?.map((value) => value as core.String)
                .toList(),
        promotionDestinations:
            (json_['promotionDestinations'] as core.List?)
                ?.map((value) => value as core.String)
                .toList(),
        ...
        storeCodesExclusion:
            (json_['storeCodesExclusion'] as core.List?)
                ?.map((value) => value as core.String)
                .toList(),
        storeCodesInclusion:
            (json_['storeCodesInclusion'] as core.List?)
                ?.map((value) => value as core.String)
                .toList(),
      );
