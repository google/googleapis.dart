...
class AccountsLfpSalesResource {
  ...
  async.Future<LfpSale> insert(
    ...
    final url_ =
        'lfp/v1/' + core.Uri.encodeFull('$parent') + '/lfpSales:insert';
...
class AccountsLfpStoresResource {
  ...
  async.Future<LfpStore> insert(
    ...
    final url_ =
        'lfp/v1/' + core.Uri.encodeFull('$parent') + '/lfpStores:insert';
...
class LfpStore {
  /// [Google My Business category id](https://support.google.com/business/answer/7249669).
  ///
  /// Optional.
