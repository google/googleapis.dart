...
class AccountsResource {
  ...
  async.Future<Account> createAndConfigure(
    ...
    const url_ = 'accounts/v1beta/accounts:createAndConfigure';
  ...
  async.Future<Empty> delete(
    ...
    final url_ = 'accounts/v1beta/' + core.Uri.encodeFull('$name');
  ...
  async.Future<ListAccountsResponse> list({
    ...
    const url_ = 'accounts/v1beta/accounts';
...
class AccountsDeveloperRegistrationResource {
  ...
  async.Future<DeveloperRegistration> registerGcp(
    ...
    final url_ =
        'accounts/v1beta/' + core.Uri.encodeFull('$name') + ':registerGcp';
  ...
  async.Future<Empty> unregisterGcp(
    ...
    final url_ =
        'accounts/v1beta/' + core.Uri.encodeFull('$name') + ':unregisterGcp';
...
class AccountsGbpAccountsResource {
  ...
  async.Future<ListGbpAccountsResponse> list(
    ...
    final url_ =
        'accounts/v1beta/' + core.Uri.encodeFull('$parent') + '/gbpAccounts';
...
class AccountsHomepageResource {
  ...
  async.Future<Homepage> claim(
    ...
    final url_ = 'accounts/v1beta/' + core.Uri.encodeFull('$name') + ':claim';
  ...
  async.Future<Homepage> unclaim(
    ...
    final url_ = 'accounts/v1beta/' + core.Uri.encodeFull('$name') + ':unclaim';
...
class AccountsIssuesResource {
  ...
  async.Future<ListAccountIssuesResponse> list(
    ...
    final url_ =
        'accounts/v1beta/' + core.Uri.encodeFull('$parent') + '/issues';
...
class AccountsOmnichannelSettingsLfpProvidersResource {
  ...
  async.Future<LinkLfpProviderResponse> linkLfpProvider(
    ...
    final url_ =
        'accounts/v1beta/' + core.Uri.encodeFull('$name') + ':linkLfpProvider';
...
class AccountsOnlineReturnPoliciesResource {
  ...
  /// Request parameters:
  ///
  /// [name] - Identifier. The name of the `OnlineReturnPolicy` resource.
  /// Format: `accounts/{account}/onlineReturnPolicies/{return_policy}`
  /// Value must have pattern `^accounts/\[^/\]+/onlineReturnPolicies/\[^/\]+$`.
  ///
  /// [updateMask] - Optional. Only support updating the entire
  /// OnlineReturnPolicy message. For update_mask, always use `*`.
  ///
  /// [$fields] - Selector specifying which fields to include in a partial
  /// response.
  ///
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<OnlineReturnPolicy> patch(
    OnlineReturnPolicy request,
    core.String name, {
    core.String? updateMask,
    core.String? $fields,
...
class AccountsProgramsResource {
  ...
  async.Future<Program> disable(
    ...
    final url_ = 'accounts/v1beta/' + core.Uri.encodeFull('$name') + ':disable';
  ...
  async.Future<Program> enable(
    ...
    final url_ = 'accounts/v1beta/' + core.Uri.encodeFull('$name') + ':enable';
  ...
  async.Future<ListProgramsResponse> list(
    ...
    final url_ =
        'accounts/v1beta/' + core.Uri.encodeFull('$parent') + '/programs';
...
class AccountsRegionsResource {
  ...
  async.Future<Region> create(
    ...
    final url_ =
        'accounts/v1beta/' + core.Uri.encodeFull('$parent') + '/regions';
...
class AccountsRelationshipsResource {
  ...
  async.Future<ListAccountRelationshipsResponse> list(
    ...
    final url_ =
        'accounts/v1beta/' + core.Uri.encodeFull('$parent') + '/relationships';
...
class AccountsServicesResource {
  ...
  async.Future<AccountService> approve(
    ...
    final url_ = 'accounts/v1beta/' + core.Uri.encodeFull('$name') + ':approve';
  ...
  async.Future<ListAccountServicesResponse> list(
    ...
    final url_ =
        'accounts/v1beta/' + core.Uri.encodeFull('$parent') + '/services';
  ...
  async.Future<Empty> reject(
    ...
    final url_ = 'accounts/v1beta/' + core.Uri.encodeFull('$name') + ':reject';
...
class AccountsUsersResource {
  ...
  async.Future<User> create(
    ...
    final url_ = 'accounts/v1beta/' + core.Uri.encodeFull('$parent') + '/users';
...
class TermsOfServiceResource {
  ...
  async.Future<AcceptTermsOfServiceResponse> accept(
    ...
    final url_ = 'accounts/v1beta/' + core.Uri.encodeFull('$name') + ':accept';
  ...
  async.Future<TermsOfService> retrieveLatest({
    ...
    const url_ = 'accounts/v1beta/termsOfService:retrieveLatest';
...
class CreateAndConfigureAccountRequest {
  ...
  /// Users to be added to the account.
  ///
  /// This field is deprecated and will not exist after the API evolves out of
  /// beta. Use the `user` field instead.
  ///
  /// Optional.
  @core.Deprecated(
    'Not supported. Member documentation may have more information.',
  )
  core.List<CreateUserRequest>? users;
    ...
    : this(
        ...
        users:
            (json_['users'] as core.List?)
                ?.map(
                  (value) => CreateUserRequest.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
class CreateUserRequest {
  /// The resource name of the account for which a user will be created.
  ///
  /// Format: `accounts/{account}`
  ///
  /// Required.
  ...
  CreateUserRequest({this.parent, this.user, this.userId});
...
/// [inventory verification](https://support.google.com/merchants/answer/14684499?hl=en&ref_topic=15145634&sjid=6892280366904591178-NC).
