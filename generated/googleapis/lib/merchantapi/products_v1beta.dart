...
class AccountsProductInputsResource {
  ...
  async.Future<Empty> delete(
    ...
    final url_ = 'products/v1beta/' + core.Uri.encodeFull('$name');
  ...
  /// source\](/merchant/api/guides/data-sources/overview) to be able to insert
  /// a product. The unique identifier of the data source is passed as a query
  /// parameter in the request URL. If a product input with the same
  ...
  /// see \[Overview of Data sources
  /// sub-API\](/merchant/api/guides/data-sources/overview). Only API data
  /// sources are supported. Format:
  /// `accounts/{account}/dataSources/{datasource}`. For example,
  /// `accounts/123456/dataSources/104628`.
  ///
  /// [$fields] - Selector specifying which fields to include in a partial
...
class AccountsProductsResource {
  ...
  async.Future<ListProductsResponse> list(
    ...
    final url_ =
        'products/v1beta/' + core.Uri.encodeFull('$parent') + '/products';
...
class Attributes {
  ...
  /// projects, ensuring that discounts on business offers do not fall below
  ...
  /// unchecked check boxes in Merchant Center). For more information, see
  ...
  /// item.
  ///
  /// You can provide up to 10 GTINs. Deprecated: Use `gtins` instead.
  @core.Deprecated(
  ...
  /// included unless provided in `excludedDestinations`. For more information,
  /// see
  ...
  ///
  /// Recommended for apparel items. For example, "US", "UK", "DE". For more
  /// information, see
  ...
  /// [Size type](https://support.google.com/merchants/answer/6324497). For
  /// example, "petite", "plus size".
...
class Product {
  ...
  /// The [channel](https://support.google.com/merchants/answer/7361332) of the
  /// product.
  ///
  /// Output only.
  /// Possible string values are:
...
class ProductStructuredDescription {
  ...
  ///
  /// Following [IPTC](https://cv.iptc.org/newscodes/digitalsourcetype). Maximum
