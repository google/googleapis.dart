...
class AccountsDataSourcesResource {
  ...
  async.Future<DataSource> create(
    ...
    final url_ =
        'datasources/v1/' + core.Uri.encodeFull('$parent') + '/dataSources';
...
class PrimaryProductDataSource {
  ...
  /// [Create a primary data source for products](https://developers.google.com/merchant/api/guides/data-sources/api-sources#create-primary-data-source).
  ...
  /// Determines whether the products of this data source are **only** targeting
  /// local destinations.
  ///
  /// Legacy local products are prefixed with `local~` in the product resource
  /// ID. For example, `accounts/123/products/local~en~US~sku123`.
  ///
  /// Optional. Immutable.
