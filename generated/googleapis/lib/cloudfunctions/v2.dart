...
class ProjectsLocationsFunctionsResource {
  ...
  async.Future<Operation> create(
    ...
    final _url = 'v2/' + core.Uri.encodeFull('$parent') + '/functions';
  ...
  async.Future<GenerateDownloadUrlResponse> generateDownloadUrl(
    ...
    final _url = 'v2/' + core.Uri.encodeFull('$name') + ':generateDownloadUrl';
...
class ProjectsLocationsRuntimesResource {
  ...
  async.Future<ListRuntimesResponse> list(
    ...
    final _url = 'v2/' + core.Uri.encodeFull('$parent') + '/runtimes';
...
class GoogleCloudFunctionsV2StateMessage {
  ...
  GoogleCloudFunctionsV2StateMessage.fromJson(core.Map _json)
      : this(
