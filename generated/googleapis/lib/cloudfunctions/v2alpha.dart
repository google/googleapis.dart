...
class ProjectsLocationsFunctionsResource {
  ...
  async.Future<Operation> abortFunctionUpgrade(
    ...
    final url_ =
        'v2alpha/' + core.Uri.encodeFull('$name') + ':abortFunctionUpgrade';
  ...
  async.Future<Operation> commitFunctionUpgrade(
    ...
    final url_ =
        'v2alpha/' + core.Uri.encodeFull('$name') + ':commitFunctionUpgrade';
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v2alpha/' + core.Uri.encodeFull('$parent') + '/functions';
  ...
  async.Future<Operation> detachFunction(
    ...
    final url_ = 'v2alpha/' + core.Uri.encodeFull('$name') + ':detachFunction';
  ...
  async.Future<GenerateDownloadUrlResponse> generateDownloadUrl(
    ...
    final url_ =
        'v2alpha/' + core.Uri.encodeFull('$name') + ':generateDownloadUrl';
  ...
  async.Future<Policy> getIamPolicy(
    ...
    final url_ =
        'v2alpha/' + core.Uri.encodeFull('$resource') + ':getIamPolicy';
  ...
  async.Future<Policy> setIamPolicy(
    ...
    final url_ =
        'v2alpha/' + core.Uri.encodeFull('$resource') + ':setIamPolicy';
  ...
  async.Future<TestIamPermissionsResponse> testIamPermissions(
    ...
    final url_ =
        'v2alpha/' + core.Uri.encodeFull('$resource') + ':testIamPermissions';
...
class ProjectsLocationsRuntimesResource {
  ...
  async.Future<ListRuntimesResponse> list(
    ...
    final url_ = 'v2alpha/' + core.Uri.encodeFull('$parent') + '/runtimes';
...
class Function_ {
  ...
  ///
  /// Output only.
  core.List<GoogleCloudFunctionsV2alphaStateMessage>? stateMessages;
    ...
    : this(
        ...
        stateMessages:
            (json_['stateMessages'] as core.List?)
                ?.map(
                  (value) => GoogleCloudFunctionsV2alphaStateMessage.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
typedef GoogleCloudFunctionsV2alphaStateMessage = $StateMessage;
