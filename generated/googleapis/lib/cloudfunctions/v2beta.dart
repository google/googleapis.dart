...
class ProjectsLocationsFunctionsResource {
  ...
  async.Future<Operation> abortFunctionUpgrade(
    ...
    final url_ =
        'v2beta/' + core.Uri.encodeFull('$name') + ':abortFunctionUpgrade';
  ...
  async.Future<Operation> commitFunctionUpgrade(
    ...
    final url_ =
        'v2beta/' + core.Uri.encodeFull('$name') + ':commitFunctionUpgrade';
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v2beta/' + core.Uri.encodeFull('$parent') + '/functions';
  ...
  async.Future<Operation> detachFunction(
    ...
    final url_ = 'v2beta/' + core.Uri.encodeFull('$name') + ':detachFunction';
  ...
  async.Future<Policy> getIamPolicy(
    ...
    final url_ = 'v2beta/' + core.Uri.encodeFull('$resource') + ':getIamPolicy';
  ...
  async.Future<Policy> setIamPolicy(
    ...
    final url_ = 'v2beta/' + core.Uri.encodeFull('$resource') + ':setIamPolicy';
...
class ProjectsLocationsRuntimesResource {
  ...
  async.Future<ListRuntimesResponse> list(
    ...
    final url_ = 'v2beta/' + core.Uri.encodeFull('$parent') + '/runtimes';
...
class Function_ {
  ...
  Function_.fromJson(core.Map json_)
    : this(
        ...
        serviceConfig:
            json_.containsKey('serviceConfig')
        ...
        stateMessages:
            (json_['stateMessages'] as core.List?)
                ?.map(
                  (value) => GoogleCloudFunctionsV2betaStateMessage.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
class GenerateUploadUrlResponse {
  ...
  GenerateUploadUrlResponse({this.storageSource, this.uploadUrl});
...
typedef GoogleCloudFunctionsV2betaStateMessage = $StateMessage;
...
class ListRuntimesResponse {
  ...
  ListRuntimesResponse({this.runtimes});
...
class Runtime {
  ...
  Runtime.fromJson(core.Map json_)
    : this(
        decommissionDate:
            json_.containsKey('decommissionDate')
                ? Date.fromJson(
                  json_['decommissionDate']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
        deprecationDate:
...
class SourceProvenance {
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    if (gitUri != null) 'gitUri': gitUri!,
    if (resolvedRepoSource != null) 'resolvedRepoSource': resolvedRepoSource!,
