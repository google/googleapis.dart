...
class BillingAccountsBudgetsResource {
  ...
  async.Future<GoogleCloudBillingBudgetsV1beta1Budget> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/budgets';
    ...
    return GoogleCloudBillingBudgetsV1beta1Budget.fromJson(
  ...
  async.Future<GoogleCloudBillingBudgetsV1beta1ListBudgetsResponse> list(
    ...
    return GoogleCloudBillingBudgetsV1beta1ListBudgetsResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
...
class GoogleCloudBillingBudgetsV1beta1AllUpdatesRule {
  ...
  /// Required when AllUpdatesRule.pubsub_topic is set.
  ///
  ...
  GoogleCloudBillingBudgetsV1beta1AllUpdatesRule.fromJson(core.Map json_)
    : this(
...
class GoogleCloudBillingBudgetsV1beta1Budget {
  ...
  /// ALL_USERS.
  /// - "ALL_USERS" : The Budget is fully accessible to both billing account
  /// users and resource users, provided that they have the required IAM
  /// permissions.
  ...
  GoogleCloudBillingBudgetsV1beta1Budget.fromJson(core.Map json_)
    : this(
        allUpdatesRule:
            json_.containsKey('allUpdatesRule')
                ? GoogleCloudBillingBudgetsV1beta1AllUpdatesRule.fromJson(
                  json_['allUpdatesRule']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
        amount:
            json_.containsKey('amount')
                ? GoogleCloudBillingBudgetsV1beta1BudgetAmount.fromJson(
                  json_['amount'] as core.Map<core.String, core.dynamic>,
                )
                : null,
        budgetFilter:
            json_.containsKey('budgetFilter')
                ? GoogleCloudBillingBudgetsV1beta1Filter.fromJson(
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    if (allUpdatesRule != null) 'allUpdatesRule': allUpdatesRule!,
...
class GoogleCloudBillingBudgetsV1beta1BudgetAmount {
  ...
  GoogleCloudBillingBudgetsV1beta1BudgetAmount.fromJson(core.Map json_)
    : this(
        lastPeriodAmount:
...
class GoogleCloudBillingBudgetsV1beta1CreateBudgetRequest {
  ...
  GoogleCloudBillingBudgetsV1beta1CreateBudgetRequest({this.budget});

  GoogleCloudBillingBudgetsV1beta1CreateBudgetRequest.fromJson(core.Map json_)
    : this(
        budget:
...
class GoogleCloudBillingBudgetsV1beta1CustomPeriod {
  ...
  GoogleCloudBillingBudgetsV1beta1CustomPeriod({this.endDate, this.startDate});

  GoogleCloudBillingBudgetsV1beta1CustomPeriod.fromJson(core.Map json_)
    : this(
        endDate:
...
class GoogleCloudBillingBudgetsV1beta1Filter {
  ...
  ///
  /// Optional.
  GoogleCloudBillingBudgetsV1beta1CustomPeriod? customPeriod;
  ...
  ///
  /// If omitted, the report will include all labeled and unlabeled usage. An
  ...
  GoogleCloudBillingBudgetsV1beta1Filter.fromJson(core.Map json_)
    : this(
        ...
        customPeriod:
            json_.containsKey('customPeriod')
                ? GoogleCloudBillingBudgetsV1beta1CustomPeriod.fromJson(
...
typedef GoogleCloudBillingBudgetsV1beta1LastPeriodAmount = $Empty;
...
class GoogleCloudBillingBudgetsV1beta1ListBudgetsResponse {
  ...
  GoogleCloudBillingBudgetsV1beta1ListBudgetsResponse.fromJson(core.Map json_)
    : this(
        budgets:
            (json_['budgets'] as core.List?)
                ?.map(
                  (value) => GoogleCloudBillingBudgetsV1beta1Budget.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
typedef GoogleCloudBillingBudgetsV1beta1ThresholdRule = $ThresholdRule;
...
class GoogleCloudBillingBudgetsV1beta1UpdateBudgetRequest {
  ...
  GoogleCloudBillingBudgetsV1beta1UpdateBudgetRequest.fromJson(core.Map json_)
    : this(
        budget:
            json_.containsKey('budget')
                ? GoogleCloudBillingBudgetsV1beta1Budget.fromJson(
