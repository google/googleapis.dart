...
class ProjectsResource {
  ...
  async.Future<DetectLanguageResponse> detectLanguage(
    ...
    final url_ =
        'v3beta1/' + core.Uri.encodeFull('$parent') + ':detectLanguage';
  ...
  async.Future<SupportedLanguages> getSupportedLanguages(
    ...
    final url_ =
        'v3beta1/' + core.Uri.encodeFull('$parent') + '/supportedLanguages';
  ...
  async.Future<TranslateTextResponse> translateText(
    ...
    final url_ = 'v3beta1/' + core.Uri.encodeFull('$parent') + ':translateText';
...
class ProjectsLocationsResource {
  ...
  async.Future<Operation> batchTranslateDocument(
    ...
    final url_ =
        'v3beta1/' + core.Uri.encodeFull('$parent') + ':batchTranslateDocument';
  ...
  async.Future<Operation> batchTranslateText(
    ...
    final url_ =
        'v3beta1/' + core.Uri.encodeFull('$parent') + ':batchTranslateText';
  ...
  async.Future<TranslateDocumentResponse> translateDocument(
    ...
    final url_ =
        'v3beta1/' + core.Uri.encodeFull('$parent') + ':translateDocument';
...
class ProjectsLocationsGlossariesResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v3beta1/' + core.Uri.encodeFull('$parent') + '/glossaries';
...
class ProjectsLocationsOperationsResource {
  ...
  async.Future<Operation> wait(
    ...
    final url_ = 'v3beta1/' + core.Uri.encodeFull('$name') + ':wait';
...
class BatchTranslateDocumentRequest {
  ...
  /// File format conversion map to be applied to all input files.
  ///
...
class DetectLanguageResponse {
  ...
  /// order.
  ///
  /// The most probable language first.
...
class GcsDestination {
  /// There must be no files under 'output_uri_prefix'.
  ///
