...
class FilesResourceApi {
  ...
  /// files. Only the owner may untrash a file.
  ///
  /// Request parameters:
  ///
...
class File {
  ...
  /// The size of the file in bytes. This field is populated for files with
  /// content stored in Google Drive and for files in Docs Editors; it is not
  /// populated for shortcut files.
  ...
  /// with content stored in Google Drive; it is not populated for Docs Editors
  /// or shortcut files.
...
class Revision {
  ...
  /// Drive, excluding Docs Editors files. Revisions can also be pinned when
  /// they are created through the drive.files.insert/update/copy by using the
  /// pinned query parameter. Pinned revisions are stored indefinitely using
  ...
  /// only populated and can only be modified for Docs Editors files.
