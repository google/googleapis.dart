...
///   - [AccountsPasskeyEnrollmentResource]
///   - [AccountsPasskeySignInResource]
...
class AccountsResource {
  ...
  AccountsPasskeyEnrollmentResource get passkeyEnrollment =>
      AccountsPasskeyEnrollmentResource(_requester);
  AccountsPasskeySignInResource get passkeySignIn =>
      AccountsPasskeySignInResource(_requester);
...
class AccountsPasskeyEnrollmentResource {
  final commons.ApiRequester _requester;

  AccountsPasskeyEnrollmentResource(commons.ApiRequester client)
      : _requester = client;
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<GoogleCloudIdentitytoolkitV2FinalizePasskeyEnrollmentResponse>
      finalize(
    GoogleCloudIdentitytoolkitV2FinalizePasskeyEnrollmentRequest request, {
    core.String? $fields,
  }) async {
    final body_ = convert.json.encode(request);
    final queryParams_ = <core.String, core.List<core.String>>{
    ...
    const url_ = 'v2/accounts/passkeyEnrollment:finalize';
    ...
    return GoogleCloudIdentitytoolkitV2FinalizePasskeyEnrollmentResponse
        .fromJson(response_ as core.Map<core.String, core.dynamic>);
  }

  /// Step one of the passkey enrollment process.
  ///
  /// Returns a challenge and parameters for creation of the passkey credential.
  ///
  /// [request] - The metadata request object.
  ///
  /// Request parameters:
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<GoogleCloudIdentitytoolkitV2StartPasskeyEnrollmentResponse>
      start(
    GoogleCloudIdentitytoolkitV2StartPasskeyEnrollmentRequest request, {
    core.String? $fields,
  }) async {
    final body_ = convert.json.encode(request);
    final queryParams_ = <core.String, core.List<core.String>>{
    ...
    const url_ = 'v2/accounts/passkeyEnrollment:start';
    ...
    return GoogleCloudIdentitytoolkitV2StartPasskeyEnrollmentResponse.fromJson(
        response_ as core.Map<core.String, core.dynamic>);
  }
}

class AccountsPasskeySignInResource {
  final commons.ApiRequester _requester;

  AccountsPasskeySignInResource(commons.ApiRequester client)
      : _requester = client;
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<GoogleCloudIdentitytoolkitV2FinalizePasskeySignInResponse>
      finalize(
    GoogleCloudIdentitytoolkitV2FinalizePasskeySignInRequest request, {
    core.String? $fields,
  }) async {
    final body_ = convert.json.encode(request);
    final queryParams_ = <core.String, core.List<core.String>>{
    ...
    const url_ = 'v2/accounts/passkeySignIn:finalize';
    ...
    return GoogleCloudIdentitytoolkitV2FinalizePasskeySignInResponse.fromJson(
        response_ as core.Map<core.String, core.dynamic>);
  }
  ...
  /// response.
  ///
  /// Completes with a [GoogleCloudIdentitytoolkitV2StartPasskeySignInResponse].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<GoogleCloudIdentitytoolkitV2StartPasskeySignInResponse> start(
    GoogleCloudIdentitytoolkitV2StartPasskeySignInRequest request, {
    core.String? $fields,
  }) async {
    final body_ = convert.json.encode(request);
    final queryParams_ = <core.String, core.List<core.String>>{
    ...
    const url_ = 'v2/accounts/passkeySignIn:start';
    ...
    return GoogleCloudIdentitytoolkitV2StartPasskeySignInResponse.fromJson(
        response_ as core.Map<core.String, core.dynamic>);
  }
}
...
class GoogleCloudIdentitytoolkitV2AuthenticatorAssertionResponse {
  ...
  core.String? authenticatorData;
  core.List<core.int> get authenticatorDataAsBytes =>
      convert.base64.decode(authenticatorData!);

  set authenticatorDataAsBytes(core.List<core.int> bytes_) {
    authenticatorData =
  ...
  core.List<core.int> get clientDataJsonAsBytes =>
      convert.base64.decode(clientDataJson!);

  set clientDataJsonAsBytes(core.List<core.int> bytes_) {
    clientDataJson =
        convert.base64.encode(bytes_).replaceAll('/', '_').replaceAll('+', '-');
  }
  ...
  core.List<core.int> get userHandleAsBytes =>
      convert.base64.decode(userHandle!);

  set userHandleAsBytes(core.List<core.int> bytes_) {
    userHandle =
        convert.base64.encode(bytes_).replaceAll('/', '_').replaceAll('+', '-');
  }
  ...
  GoogleCloudIdentitytoolkitV2AuthenticatorAssertionResponse.fromJson(
      core.Map json_)
      : this(
          authenticatorData: json_.containsKey('authenticatorData')
              ? json_['authenticatorData'] as core.String
              : null,
          clientDataJson: json_.containsKey('clientDataJson')
              ? json_['clientDataJson'] as core.String
              : null,
          signature: json_.containsKey('signature')
              ? json_['signature'] as core.String
              : null,
          userHandle: json_.containsKey('userHandle')
              ? json_['userHandle'] as core.String
              : null,
        );

  core.Map<core.String, core.dynamic> toJson() => {
        if (authenticatorData != null) 'authenticatorData': authenticatorData!,
        if (clientDataJson != null) 'clientDataJson': clientDataJson!,
...
class GoogleCloudIdentitytoolkitV2AuthenticatorAttestationResponse {
  ...
  core.String? attestationObject;
  core.List<core.int> get attestationObjectAsBytes =>
      convert.base64.decode(attestationObject!);

  set attestationObjectAsBytes(core.List<core.int> bytes_) {
    attestationObject =
        convert.base64.encode(bytes_).replaceAll('/', '_').replaceAll('+', '-');
  }
  ...
  core.List<core.String>? transports;
  ...
  GoogleCloudIdentitytoolkitV2AuthenticatorAttestationResponse.fromJson(
      core.Map json_)
      : this(
          attestationObject: json_.containsKey('attestationObject')
              ? json_['attestationObject'] as core.String
              : null,
          clientDataJson: json_.containsKey('clientDataJson')
              ? json_['clientDataJson'] as core.String
              : null,
          transports: json_.containsKey('transports')
...
class GoogleCloudIdentitytoolkitV2AuthenticatorAuthenticationResponse {
  ...
  core.List<core.int> get credentialIdAsBytes =>
      convert.base64.decode(credentialId!);

  set credentialIdAsBytes(core.List<core.int> bytes_) {
    credentialId =
        convert.base64.encode(bytes_).replaceAll('/', '_').replaceAll('+', '-');
  }
  ...
  GoogleCloudIdentitytoolkitV2AuthenticatorAuthenticationResponse.fromJson(
      core.Map json_)
      : this(
          authenticatorAssertionResponse:
              json_.containsKey('authenticatorAssertionResponse')
                  ? GoogleCloudIdentitytoolkitV2AuthenticatorAssertionResponse
                      .fromJson(json_['authenticatorAssertionResponse']
                          as core.Map<core.String, core.dynamic>)
                  : null,
...
class GoogleCloudIdentitytoolkitV2AuthenticatorRegistrationResponse {
  ...
  GoogleCloudIdentitytoolkitV2AuthenticatorRegistrationResponse.fromJson(
      core.Map json_)
      : this(
          authenticatorAttestationResponse:
              json_.containsKey('authenticatorAttestationResponse')
                  ? GoogleCloudIdentitytoolkitV2AuthenticatorAttestationResponse
                      .fromJson(json_['authenticatorAttestationResponse']
                          as core.Map<core.String, core.dynamic>)
                  : null,
          credentialId: json_.containsKey('credentialId')
              ? json_['credentialId'] as core.String
...
class GoogleCloudIdentitytoolkitV2AuthenticatorSelectionCriteria {
  ...
  GoogleCloudIdentitytoolkitV2AuthenticatorSelectionCriteria.fromJson(
      core.Map json_)
      : this(
          authenticatorAttachment: json_.containsKey('authenticatorAttachment')
              ? json_['authenticatorAttachment'] as core.String
              : null,
          requireResidentKey: json_.containsKey('requireResidentKey')
              ? json_['requireResidentKey'] as core.bool
              : null,
          userVerification: json_.containsKey('userVerification')
              ? json_['userVerification'] as core.String
              : null,
        );
...
///
/// Registers passkey as a first factor for the user.
class GoogleCloudIdentitytoolkitV2FinalizePasskeyEnrollmentRequest {
  /// The registration object from the authenticator.
  ///
  /// Optional.
  GoogleCloudIdentitytoolkitV2AuthenticatorRegistrationResponse?
      authenticatorRegistrationResponse;

  /// The GCIP ID token of the signed-in user
  ///
  /// Required.
  core.String? idToken;
  ...
  GoogleCloudIdentitytoolkitV2FinalizePasskeyEnrollmentRequest({
    this.authenticatorRegistrationResponse,
    this.idToken,
    this.tenantId,
  });

  GoogleCloudIdentitytoolkitV2FinalizePasskeyEnrollmentRequest.fromJson(
      core.Map json_)
      : this(
          authenticatorRegistrationResponse: json_
                  .containsKey('authenticatorRegistrationResponse')
              ? GoogleCloudIdentitytoolkitV2AuthenticatorRegistrationResponse
                  .fromJson(json_['authenticatorRegistrationResponse']
                      as core.Map<core.String, core.dynamic>)
              : null,
          idToken: json_.containsKey('idToken')
              ? json_['idToken'] as core.String
  ...
  core.Map<core.String, core.dynamic> toJson() => {
        if (authenticatorRegistrationResponse != null)
          'authenticatorRegistrationResponse':
              authenticatorRegistrationResponse!,
        if (idToken != null) 'idToken': idToken!,
        if (tenantId != null) 'tenantId': tenantId!,
...
typedef GoogleCloudIdentitytoolkitV2FinalizePasskeyEnrollmentResponse
    = $Response;

/// Request to finalize a passkey sign-in.
class GoogleCloudIdentitytoolkitV2FinalizePasskeySignInRequest {
  /// The authentication response object from the authenticator.
  ///
  /// Required.
  GoogleCloudIdentitytoolkitV2AuthenticatorAuthenticationResponse?
      authenticatorAuthenticationResponse;

  /// The session ID that was passed into StartPasskeySignIn, if any.
  ///
  /// Optional.
  core.String? sessionId;
  core.List<core.int> get sessionIdAsBytes => convert.base64.decode(sessionId!);

  set sessionIdAsBytes(core.List<core.int> bytes_) {
    sessionId =
        convert.base64.encode(bytes_).replaceAll('/', '_').replaceAll('+', '-');
  }
  ...
  GoogleCloudIdentitytoolkitV2FinalizePasskeySignInRequest({
    this.authenticatorAuthenticationResponse,
    this.sessionId,
    this.tenantId,
  });

  GoogleCloudIdentitytoolkitV2FinalizePasskeySignInRequest.fromJson(
      core.Map json_)
      : this(
          authenticatorAuthenticationResponse: json_
                  .containsKey('authenticatorAuthenticationResponse')
              ? GoogleCloudIdentitytoolkitV2AuthenticatorAuthenticationResponse
                  .fromJson(json_['authenticatorAuthenticationResponse']
                      as core.Map<core.String, core.dynamic>)
              : null,
  ...
  core.Map<core.String, core.dynamic> toJson() => {
        if (authenticatorAuthenticationResponse != null)
          'authenticatorAuthenticationResponse':
              authenticatorAuthenticationResponse!,
...
typedef GoogleCloudIdentitytoolkitV2FinalizePasskeySignInResponse = $Response;
...
class GoogleCloudIdentitytoolkitV2PublicKeyCredentialCreationOptions {
  ...
  core.List<GoogleCloudIdentitytoolkitV2PublicKeyCredentialDescriptor>?
      excludeCredentials;

  /// Lists the supported key types and signature algorithms.
  core.List<GoogleCloudIdentitytoolkitV2PublicKeyCredentialParameters>?
      pubKeyCredParams;

  /// The relying party attributes for creating a new credential.
  GoogleCloudIdentitytoolkitV2RpEntity? rp;

  /// The user attributes for creating a new credential.
  GoogleCloudIdentitytoolkitV2UserEntity? user;
  ...
  GoogleCloudIdentitytoolkitV2PublicKeyCredentialCreationOptions.fromJson(
      core.Map json_)
      : this(
          authenticatorSelection: json_.containsKey('authenticatorSelection')
              ? GoogleCloudIdentitytoolkitV2AuthenticatorSelectionCriteria
                  .fromJson(json_['authenticatorSelection']
                      as core.Map<core.String, core.dynamic>)
              : null,
          challenge: json_.containsKey('challenge')
              ? json_['challenge'] as core.String
              : null,
          excludeCredentials: json_.containsKey('excludeCredentials')
              ? (json_['excludeCredentials'] as core.List)
                  .map((value) =>
                  ...
                  .toList()
              : null,
          pubKeyCredParams: json_.containsKey('pubKeyCredParams')
              ? (json_['pubKeyCredParams'] as core.List)
                  .map((value) =>
                  ...
                  .toList()
              : null,
          rp: json_.containsKey('rp')
              ? GoogleCloudIdentitytoolkitV2RpEntity.fromJson(
                  json_['rp'] as core.Map<core.String, core.dynamic>)
              : null,
          user: json_.containsKey('user')
              ? GoogleCloudIdentitytoolkitV2UserEntity.fromJson(
  ...
  core.Map<core.String, core.dynamic> toJson() => {
        ...
        if (pubKeyCredParams != null) 'pubKeyCredParams': pubKeyCredParams!,
        if (rp != null) 'rp': rp!,
...
class GoogleCloudIdentitytoolkitV2PublicKeyCredentialDescriptor {
  ...
  GoogleCloudIdentitytoolkitV2PublicKeyCredentialDescriptor.fromJson(
      core.Map json_)
      : this(
          credentialId: json_.containsKey('credentialId')
              ? json_['credentialId'] as core.String
...
class GoogleCloudIdentitytoolkitV2PublicKeyCredentialParameters {
  ...
  GoogleCloudIdentitytoolkitV2PublicKeyCredentialParameters.fromJson(
      core.Map json_)
      : this(
...
class GoogleCloudIdentitytoolkitV2PublicKeyCredentialRequestOptions {
  ...
  GoogleCloudIdentitytoolkitV2PublicKeyCredentialRequestOptions.fromJson(
      core.Map json_)
      : this(
          challenge: json_.containsKey('challenge')
              ? json_['challenge'] as core.String
...
class GoogleCloudIdentitytoolkitV2RpEntity {
  ...
  GoogleCloudIdentitytoolkitV2RpEntity.fromJson(core.Map json_)
      : this(
...
/// Starts passkey enrollment for passkey as a first factor by returning the
/// FIDO challenge.
class GoogleCloudIdentitytoolkitV2StartPasskeyEnrollmentRequest {
  ...
  GoogleCloudIdentitytoolkitV2StartPasskeyEnrollmentRequest.fromJson(
      core.Map json_)
      : this(
          idToken: json_.containsKey('idToken')
              ? json_['idToken'] as core.String
...
class GoogleCloudIdentitytoolkitV2StartPasskeyEnrollmentResponse {
  ...
  GoogleCloudIdentitytoolkitV2StartPasskeyEnrollmentResponse.fromJson(
      core.Map json_)
      : this(
          credentialCreationOptions: json_
                  .containsKey('credentialCreationOptions')
              ? GoogleCloudIdentitytoolkitV2PublicKeyCredentialCreationOptions
                  .fromJson(json_['credentialCreationOptions']
                      as core.Map<core.String, core.dynamic>)
              : null,
        );
...
class GoogleCloudIdentitytoolkitV2StartPasskeySignInRequest {
  /// The developer can bind their own concept of a user session to this flow.
  ///
  /// Optional.
  core.String? sessionId;
  core.List<core.int> get sessionIdAsBytes => convert.base64.decode(sessionId!);
  ...
  GoogleCloudIdentitytoolkitV2StartPasskeySignInRequest.fromJson(core.Map json_)
      : this(
          sessionId: json_.containsKey('sessionId')
              ? json_['sessionId'] as core.String
              : null,
...
class GoogleCloudIdentitytoolkitV2StartPasskeySignInResponse {
  ...
  GoogleCloudIdentitytoolkitV2StartPasskeySignInResponse.fromJson(
      core.Map json_)
      : this(
          credentialRequestOptions: json_
                  .containsKey('credentialRequestOptions')
              ? GoogleCloudIdentitytoolkitV2PublicKeyCredentialRequestOptions
                  .fromJson(json_['credentialRequestOptions']
                      as core.Map<core.String, core.dynamic>)
              : null,
        );
...
class GoogleCloudIdentitytoolkitV2UserEntity {
  ...
  GoogleCloudIdentitytoolkitV2UserEntity.fromJson(core.Map json_)
      : this(
          id: json_.containsKey('id') ? json_['id'] as core.String : null,
        );
