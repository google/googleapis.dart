...
class ScanConfigError {
  ...
  /// is mapped to an IP address which is not reserved for
  /// the current project.
  ...
  /// an IP address which is not reserved for the
  /// current project.
  ...
  /// project was not whitelisted for
  ...
  /// to an IP address which is not reserved
