...
class ProjectsLocationsSecretsResource {
  ...
  async.Future<SecretVersion> addVersion(
    ...
    final url_ = 'v1beta2/' + core.Uri.encodeFull('$parent') + ':addVersion';
  ...
  async.Future<Secret> create(
    ...
    final url_ = 'v1beta2/' + core.Uri.encodeFull('$parent') + '/secrets';
...
class ProjectsLocationsSecretsVersionsResource {
  ...
  async.Future<AccessSecretVersionResponse> access(
    ...
    final url_ = 'v1beta2/' + core.Uri.encodeFull('$name') + ':access';
  ...
  async.Future<SecretVersion> destroy(
    ...
    final url_ = 'v1beta2/' + core.Uri.encodeFull('$name') + ':destroy';
  ...
  async.Future<SecretVersion> disable(
    ...
    final url_ = 'v1beta2/' + core.Uri.encodeFull('$name') + ':disable';
  ...
  async.Future<SecretVersion> enable(
    ...
    final url_ = 'v1beta2/' + core.Uri.encodeFull('$name') + ':enable';
  ...
  async.Future<ListSecretVersionsResponse> list(
    ...
    final url_ = 'v1beta2/' + core.Uri.encodeFull('$parent') + '/versions';
