...
class ProjectsLocationsApplicationsServicesResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$parent') + '/services';
...
class ProjectsLocationsApplicationsWorkloadsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$parent') + '/workloads';
...
class ProjectsLocationsDiscoveredServicesResource {
  ...
  /// response.
  ///
  /// Completes with a [FindUnregisteredServicesResponse].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<FindUnregisteredServicesResponse> findUnregistered(
    core.String parent, {
    core.String? filter,
    core.String? orderBy,
    core.int? pageSize,
    ...
    return FindUnregisteredServicesResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
  ...
  async.Future<ListDiscoveredServicesResponse> list(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$parent') + '/discoveredServices';
...
class ProjectsLocationsDiscoveredWorkloadsResource {
  ...
  /// response.
  ///
  /// Completes with a [FindUnregisteredWorkloadsResponse].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<FindUnregisteredWorkloadsResponse> findUnregistered(
    core.String parent, {
    core.String? filter,
    core.String? orderBy,
    core.int? pageSize,
    ...
    return FindUnregisteredWorkloadsResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
  ...
  async.Future<ListDiscoveredWorkloadsResponse> list(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$parent') + '/discoveredWorkloads';
...
class Channel {
  ...
  Channel.fromJson(core.Map json_) : this(uri: json_['uri'] as core.String?);
...
class ContactInfo {
  ...
  ContactInfo({this.channel, this.displayName, this.email});
...
class Criticality {
  ...
  /// dashes. Can have a maximum length of 63 characters. Deprecated: Please
  ...
  Criticality({this.level, this.missionCritical, this.type});

  Criticality.fromJson(core.Map json_)
    : this(
        level: json_['level'] as core.String?,
        missionCritical: json_['missionCritical'] as core.bool?,
        type: json_['type'] as core.String?,
      );

  core.Map<core.String, core.dynamic> toJson() => {
    if (level != null) 'level': level!,
    if (missionCritical != null) 'missionCritical': missionCritical!,
...
class DiscoveredService {
  ...
  DiscoveredService.fromJson(core.Map json_)
    : this(
        name: json_['name'] as core.String?,
        serviceProperties:
            json_.containsKey('serviceProperties')
                ...
                : null,
        serviceReference:
            json_.containsKey('serviceReference')
...
class DiscoveredWorkload {
    ...
    : this(
        ...
        workloadProperties:
            json_.containsKey('workloadProperties')
                ...
                : null,
        workloadReference:
            json_.containsKey('workloadReference')
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    if (name != null) 'name': name!,
    if (workloadProperties != null) 'workloadProperties': workloadProperties!,
...
class Environment {
  ...
  Environment({this.environment, this.type});
...
class FindUnregisteredServicesResponse {
  ...
  FindUnregisteredServicesResponse.fromJson(core.Map json_)
    : this(
        discoveredServices:
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    if (discoveredServices != null) 'discoveredServices': discoveredServices!,
...
class FindUnregisteredWorkloadsResponse {
  ...
  FindUnregisteredWorkloadsResponse.fromJson(core.Map json_)
    : this(
        discoveredWorkloads:
...
class LookupDiscoveredServiceResponse {
  ...
  LookupDiscoveredServiceResponse.fromJson(core.Map json_)
    : this(
        discoveredService:
            json_.containsKey('discoveredService')
...
class LookupDiscoveredWorkloadResponse {
  ...
  LookupDiscoveredWorkloadResponse.fromJson(core.Map json_)
    : this(
        discoveredWorkload:
            json_.containsKey('discoveredWorkload')
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    if (discoveredWorkload != null) 'discoveredWorkload': discoveredWorkload!,
  };
}
...
class Service {
  ...
  Service.fromJson(core.Map json_)
    : this(
        ...
        createTime: json_['createTime'] as core.String?,
        description: json_['description'] as core.String?,
        discoveredService: json_['discoveredService'] as core.String?,
        displayName: json_['displayName'] as core.String?,
        name: json_['name'] as core.String?,
        serviceProperties:
            json_.containsKey('serviceProperties')
...
class ServiceReference {
  /// Additional path under the resource URI (demultiplexing one resource URI
  /// into multiple entries).
  ///
  /// Smallest unit a policy can be attached to. Examples: URL Map path entry.
  ///
  /// Output only.
  core.String? path;
  ...
  ServiceReference({this.path, this.uri});
...
class Workload {
  ...
  Workload.fromJson(core.Map json_)
    : this(
        ...
        createTime: json_['createTime'] as core.String?,
        description: json_['description'] as core.String?,
        discoveredWorkload: json_['discoveredWorkload'] as core.String?,
        displayName: json_['displayName'] as core.String?,
        name: json_['name'] as core.String?,
        state: json_['state'] as core.String?,
        uid: json_['uid'] as core.String?,
