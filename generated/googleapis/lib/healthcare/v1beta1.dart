...
///       - [ProjectsLocationsDatasetsAnnotationStoresResource]
...
class ProjectsLocationsDatasetsResource {
  ...
  ProjectsLocationsDatasetsAnnotationStoresResource get annotationStores =>
      ProjectsLocationsDatasetsAnnotationStoresResource(_requester);
  ...
  /// details are logged to Cloud Logging. For more information, see
  ...
  async.Future<Operation> deidentify(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$sourceDataset') + ':deidentify';
...
class ProjectsLocationsDatasetsAnnotationStoresResource {
  final commons.ApiRequester _requester;

  ProjectsLocationsDatasetsAnnotationStoresResource(commons.ApiRequester client)
    : _requester = client;
...
class ProjectsLocationsDatasetsConsentStoresResource {
  ...
  async.Future<CheckDataAccessResponse> checkDataAccess(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$consentStore') + ':checkDataAccess';
  ...
  async.Future<ConsentStore> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/consentStores';
  ...
  async.Future<EvaluateUserConsentsResponse> evaluateUserConsents(
    ...
    final url_ =
        'v1beta1/' +
        core.Uri.encodeFull('$consentStore') +
  ...
  /// expression to negate it. Only filtering on labels is supported. For
...
class ProjectsLocationsDatasetsConsentStoresAttributeDefinitionsResource {
  ...
  async.Future<AttributeDefinition> create(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/attributeDefinitions';
  ...
  /// string, it is not treated as special, it's just another part of the
  /// character string to be matched. You can prepend the `NOT` operator to an
  /// expression to negate it. The only field available for filtering is
...
class ProjectsLocationsDatasetsConsentStoresConsentArtifactsResource {
  ...
  async.Future<ConsentArtifact> create(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/consentArtifacts';
...
class ProjectsLocationsDatasetsConsentStoresConsentsResource {
  ...
  async.Future<Consent> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/consents';
  ...
  async.Future<Empty> deleteRevision(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':deleteRevision';
  ...
  async.Future<ListConsentRevisionsResponse> listRevisions(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':listRevisions';
  ...
  async.Future<Consent> reject(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':reject';
...
class ProjectsLocationsDatasetsConsentStoresUserDataMappingsResource {
  ...
  async.Future<ArchiveUserDataMappingResponse> archive(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':archive';
  ...
  async.Future<UserDataMapping> create(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/userDataMappings';
...
class ProjectsLocationsDatasetsDicomStoresResource {
  ...
  async.Future<DicomStore> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/dicomStores';
  ...
  ///
  /// The metadata field type is OperationMetadata. If the request is
  /// successful, the response field type is DeidentifyDicomStoreSummary. The
  /// LRO result may still be successful if de-identification fails for some
  /// DICOM instances. The output DICOM store will not contain these failed
  /// resources. The number of resources processed are tracked in
  ...
  async.Future<Operation> deidentify(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$sourceStore') + ':deidentify';
  ...
  /// [Viewing errors in Cloud Logging](https://cloud.google.com/healthcare/docs/how-tos/logging).
  ...
  async.Future<DicomStoreMetrics> getDICOMStoreMetrics(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$name') + ':getDICOMStoreMetrics';
...
class ProjectsLocationsDatasetsDicomStoresDicomWebStudiesResource {
  ...
  async.Future<StudyMetrics> getStudyMetrics(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$study') + ':getStudyMetrics';
...
class ProjectsLocationsDatasetsDicomStoresDicomWebStudiesSeriesResource {
  ...
  async.Future<SeriesMetrics> getSeriesMetrics(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$series') + ':getSeriesMetrics';
...
class ProjectsLocationsDatasetsDicomStoresDicomWebStudiesSeriesInstancesResource {
  ...
  async.Future<StorageInfo> getStorageInfo(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$resource') + ':getStorageInfo';
...
class ProjectsLocationsDatasetsDicomStoresStudiesSeriesResource {
  ...
  /// DeleteSeries deletes all instances within the given study and series using
  /// a long running operation.
  ///
  /// The method returns an Operation which will be marked successful when the
  /// deletion is complete. Warning: Instances cannot be inserted into a series
  /// that is being deleted by an operation until the operation completes. For
  /// samples that show how to call DeleteSeries, see
  /// [Delete a study, series, or instance](https://cloud.google.com/healthcare/docs/how-tos/dicomweb#delete-dicom).
  ///
  /// Request parameters:
  ///
...
class ProjectsLocationsDatasetsFhirStoresResource {
  ...
  async.Future<Operation> applyAdminConsents(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$name') + ':applyAdminConsents';
  ...
  async.Future<Operation> applyConsents(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':applyConsents';
  ...
  /// Request parameters:
  ///
  /// [name] - Required. Name of the `Group` resource that is exported, in
  /// format
  ...
  async.Future<HttpBody> bulkExportGroup(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + r'/$export';
  ...
  /// in the FHIR store according to the defined search parameters.
  ///
  /// The search parameters provided in this request will replace any previous
  /// search configuration. The target SearchParameter resources need to exist
  /// in the store before calling ConfigureSearch, otherwise an error will
  ...
  /// Request parameters:
  ///
  /// [name] - Required. The name of the FHIR store to configure, in the format
  /// `projects/{project_id}/locations/{location_id}/datasets/{dataset_id}/fhirStores/{fhir_store_id}`.
  /// Value must have pattern
  /// `^projects/\[^/\]+/locations/\[^/\]+/datasets/\[^/\]+/fhirStores/\[^/\]+$`.
  ///
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<Operation> configureSearch(
    ConfigureSearchRequest request,
    core.String name, {
    core.String? $fields,
  }) async {
    final body_ = convert.json.encode(request);
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':configureSearch';
  ...
  async.Future<FhirStore> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/fhirStores';
  ...
  ///
  /// The metadata field type is OperationMetadata. If the request is
  /// successful, the response field type is DeidentifyFhirStoreSummary. The
  /// number of resources processed are tracked in Operation.metadata. Error
  /// details are logged to Cloud Logging. For more information, see
  /// [Viewing error logs in Cloud Logging](https://cloud.google.com/healthcare/docs/how-tos/logging).
  ///
  ...
  async.Future<ExplainDataAccessResponse> explainDataAccess(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$name') + ':explainDataAccess';
  ...
  ///
  /// The exported resource, along with previous versions, will be exported in
  /// one or more FHIR history bundles. This method returns an Operation that
  /// can be used to track the status of the export by calling GetOperation.
  /// Immediate fatal errors appear in the error field, errors are also logged
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<Operation> exportHistory(
    ExportResourcesHistoryRequest request,
    core.String name, {
    core.String? $fields,
  }) async {
    final body_ = convert.json.encode(request);
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':exportHistory';
  ...
  async.Future<FhirStoreMetrics> getFHIRStoreMetrics(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$name') + ':getFHIRStoreMetrics';
  ...
  /// and count one success for each resource in the input, which might result
  /// in a success count larger than the number of resources in the FHIR store.
  /// This often occurs when importing data organized in bundles produced by
  ...
  /// input data are specified by the parameters in ImportResourcesRequest. Note
  ...
  /// Import resource historical versions from Cloud Storage source to
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<Operation> importHistory(
    ImportResourcesHistoryRequest request,
    core.String name, {
    core.String? $fields,
  }) async {
    final body_ = convert.json.encode(request);
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':importHistory';
  ...
  async.Future<Operation> rollback(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':rollback';
...
class ProjectsLocationsDatasetsFhirStoresFhirResource {
  ...
  async.Future<HttpBody> BinaryCreate(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/fhir/Binary';
  ...
  /// [R5](https://www.hl7.org/fhir/R5/operation-conceptmap-translate.html)). On
  /// success, the response body contains a JSON-encoded representation of a
  /// FHIR Parameters resource, which includes the translation result. Errors
  ...
  ///
  /// [url] - The canonical url of the concept map to use. If unset, the source
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<HttpBody> ConceptMapSearchTranslate(
    core.String parent, {
    core.String? code,
    core.String? conceptMapVersion,
    core.String? source,
    core.String? system,
    core.String? target,
    core.String? url,
    ...
    final queryParams_ = <core.String, core.List<core.String>>{
      ...
      if (conceptMapVersion != null) 'conceptMapVersion': [conceptMapVersion],
  ...
  ///
  /// You can provide your own concept maps to translate any code system to
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<HttpBody> ConceptMapTranslate(
    core.String name, {
    core.String? code,
    core.String? conceptMapVersion,
    core.String? system,
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + r'/$translate';
  ...
  ///
  /// Implements the FHIR extended operation Encounter-everything
  /// ([DSTU2](https://hl7.org/fhir/DSTU2/encounter-operations.html#everything),
  /// [STU3](https://hl7.org/fhir/STU3/encounter-operations.html#everything),
  /// [R4](https://hl7.org/fhir/R4/encounter-operation-everything.html), or
  /// [R5](https://hl7.org/fhir/R5/encounter-operation-everything.html)). On
  /// success, the response body contains a JSON-encoded representation of a
  ...
  /// binaries. * Resources directly referencing the Encounter resource that
  ...
  /// [R5](http://hl7.org/fhir/R5/compartmentdefinition-encounter.html)), which
  ...
  /// Request parameters:
  ///
  /// [name] - Required. Name of the Encounter resource for which the
  ...
  ///
  /// [P_pageToken] - Optional. Used to retrieve the next or previous page of
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<HttpBody> EncounterEverything(
    core.String name, {
    core.int? P_count,
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + r'/$everything';
  ...
  /// [R5](https://hl7.org/fhir/R5/observation-operation-lastn.html)). DSTU2
  /// doesn't define the Observation-lastn method, but the server supports it
  /// the same way it supports STU3. Search terms are provided as query
  ...
  /// parameters can also be provided. This operation accepts an additional
  /// query parameter `max`, which specifies N, the maximum number of
  /// Observations to return from each group, with a default of 1. Searches with
  /// over 1000 results are rejected. Results are counted before grouping and
  /// limiting the results with `max`. To stay within the limit, constrain these
  /// searches using Observation search parameters such as `_lastUpdated` or
  /// `date`. On success, the response body contains a JSON-encoded
  /// representation of a `Bundle` resource of type `searchset`, containing the
  /// results of the operation. Errors generated by the FHIR store contain a
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<HttpBody> ObservationLastn(
    core.String parent, {
    core.String? $fields,
  }) async {
    final queryParams_ = <core.String, core.List<core.String>>{
  ...
  /// resource.
  ///
  /// Can also support the case when the target resource doesn't exist, for
  /// example, if the target has been deleted. On success, the response body
  /// contains a Bundle with type `searchset`, where each entry in the Bundle
  /// contains the full content of the resource. If the operation fails, an
  /// `OperationOutcome` is returned describing the failure. If the request
  /// cannot be mapped to a valid API method on a FHIR store, a generic Google
  /// Cloud error might be returned instead.
  ///
  /// Request parameters:
  ///
  ...
  /// is used. May not be larger than 1000.
  ///
  /// [P_pageToken] - Used to retrieve the next page of results when using
  /// pagination. Set `_page_token` to the value of _page_token set in next page
  /// links' url. Next page are returned in the response bundle's links field,
  /// where `link.relation` is "next". Omit `_page_token` if no previous request
  /// has been made.
  ///
  /// [P_summary] - Used to simplify the representation of the returned
  /// resources. `_summary=text` returns only the `text`, `id`, and `meta`
  /// top-level fields. `_summary=data` removes the `text` field and returns all
  /// other fields. `_summary=false` returns all parts of the resource(s).
  /// Either not providing this parameter or providing an empty value to this
  /// parameter also returns all parts of the resource(s).
  ///
  /// [P_type] - String of comma-delimited FHIR resource types. If provided,
  /// only resources of the specified resource type(s) are returned. If not
  /// provided or an empty value is provided, no filter on the returned resource
  /// type(s) is applied.
  ///
  /// [target] - Required. The target whose incoming references are requested.
  /// This param is required and must not be empty. It uses the format
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<HttpBody> ResourceIncomingReferences(
    core.String parent, {
    core.int? P_count,
    core.String? P_pageToken,
    core.String? P_summary,
    core.String? P_type,
    core.String? target,
    core.String? $fields,
  }) async {
    final queryParams_ = <core.String, core.List<core.String>>{
      if (P_count != null) '_count': ['${P_count}'],
      if (P_pageToken != null) '_page_token': [P_pageToken],
      if (P_summary != null) '_summary': [P_summary],
      if (P_type != null) '_type': [P_type],
      if (target != null) 'target': [target],
      if ($fields != null) 'fields': [$fields],
    };
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + r'/fhir/$references';
  ...
  async.Future<Empty> ResourcePurge(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + r'/$purge';
  ...
  async.Future<HttpBody> bulkExport(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + r'/fhir/$export';
  ...
  async.Future<HttpBody> capabilities(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + '/fhir/metadata';
  ...
  /// ([DSTU2](https://hl7.org/fhir/DSTU2/http.html#2.1.0.12.1),
  /// [STU3](https://hl7.org/fhir/STU3/http.html#2.21.0.13.1),
  /// [R4](https://hl7.org/fhir/R4/http.html#3.1.0.7.1),
  /// [R5](https://hl7.org/fhir/R5/http.html#3.1.0.7.1)). If multiple resources
  /// match, all matching resources are deleted. Search terms are provided as
  /// query parameters following the same pattern as the search method. Not all
  /// FHIR resources that match the search query might be deleted because, by
  /// default, a maximum of 100 FHIR resources can be deleted. The number of
  /// FHIR resources that can be deleted depends on the page size of the
  ...
  /// the FHIR store, the deleted resources are moved to a history repository
  ...
  /// same pattern as the search method. If the search criteria identify more
  /// than one match, the request returns a `412 Precondition Failed` error. The
  ...
  /// permission on the parent FHIR store and the
  ...
  /// [R5](https://hl7.org/fhir/R5/http.html#cond-update)). Search terms are
  /// provided as query parameters following the same pattern as the search
  /// method. If the search criteria identify more than one match, the request
  /// returns a `412 Precondition Failed` error. If the search criteria identify
  /// zero matches, and the supplied resource body contains an `id`, and the
  /// FHIR store has enable_update_create set, creates the resource with the
  ...
  /// resource is created with a server-assigned ID as per the create method.
  /// The request body must contain a JSON-encoded FHIR resource, and the
  /// request headers must contain `Content-Type: application/fhir+json`. On
  ...
  /// an `If-None-Exist` header containing a FHIR search query. If no resources
  /// match this search query, the server processes the create operation as
  /// normal. The request body must contain a JSON-encoded FHIR resource, and
  ...
  ///
  /// Implements the FHIR standard batch/transaction interaction and history
  /// operations. ([DSTU2](https://hl7.org/fhir/DSTU2/http.html#transaction),
  ...
  /// `transaction` or `history` bundle, the response body contains a
  /// JSON-encoded `OperationOutcome` resource describing the reason for the
  /// error. If the request cannot be mapped to a valid API method on a FHIR
  ...
  /// permission. `history` bundles also check the `import` permission. You can
  /// use audit logs to view the permissions for `executeBundle` and each
  /// request in the bundle. For more information, see
  ...
  async.Future<HttpBody> executeBundle(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/fhir';
  ...
  async.Future<HttpBody> history(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + '/_history';
  ...
  async.Future<HttpBody> search(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/fhir/_search';
...
class ProjectsLocationsDatasetsHl7V2StoresResource {
  ...
  async.Future<Hl7V2Store> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/hl7V2Stores';
  ...
  async.Future<Hl7V2StoreMetrics> getHL7v2StoreMetrics(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$name') + ':getHL7v2StoreMetrics';
...
class ProjectsLocationsDatasetsHl7V2StoresMessagesResource {
  ...
  /// response.
  ///
  /// Completes with a [BatchGetMessagesResponse].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<BatchGetMessagesResponse> batchGet(
    core.String parent, {
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/messages:batchGet';
    ...
    return BatchGetMessagesResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
  ...
  async.Future<Message> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/messages';
  ...
  async.Future<IngestMessageResponse> ingest(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/messages:ingest';
  ...
  /// contents such as Message.create_time can't be altered. Only the
...
class ProjectsLocationsServicesNlpResource {
  ...
  async.Future<AnalyzeEntitiesResponse> analyzeEntities(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$nlpService') + ':analyzeEntities';
...
class Action {
  ...
  /// PixelData
  ImageConfig? cleanImageTag;

  /// Inspect text and transform sensitive text.
  ///
  /// Configurable via TextConfig. Supported Value Representations: AE, LO, LT,
  ...
  /// Select all tags with the listed tag IDs, names, or Value Representations
  /// (VRs).
  ///
  ...
  ///
  /// Supported
  /// [Value Representation](http://dicom.nema.org/medical/dicom/2018e/output/chtml/part05/sect_6.2.html#table_6.2-1):
  /// SQ
  ...
  Action.fromJson(core.Map json_)
    : this(
        cleanImageTag:
            json_.containsKey('cleanImageTag')
                ? ImageConfig.fromJson(
                  json_['cleanImageTag'] as core.Map<core.String, core.dynamic>,
                )
                : null,
        cleanTextTag:
            json_.containsKey('cleanTextTag')
                ? CleanTextTag.fromJson(
                  json_['cleanTextTag'] as core.Map<core.String, core.dynamic>,
                )
                : null,
        deleteTag:
            json_.containsKey('deleteTag')
                ? DeleteTag.fromJson(
                  json_['deleteTag'] as core.Map<core.String, core.dynamic>,
                )
                : null,
        keepTag:
            json_.containsKey('keepTag')
                ? KeepTag.fromJson(
                  json_['keepTag'] as core.Map<core.String, core.dynamic>,
                )
                : null,
        queries:
            (json_['queries'] as core.List?)
                ...
                .toList(),
        recurseTag:
            json_.containsKey('recurseTag')
                ? RecurseTag.fromJson(
                  json_['recurseTag'] as core.Map<core.String, core.dynamic>,
                )
                : null,
        regenUidTag:
            json_.containsKey('regenUidTag')
                ? RegenUidTag.fromJson(
                  json_['regenUidTag'] as core.Map<core.String, core.dynamic>,
                )
                : null,
        removeTag:
            json_.containsKey('removeTag')
                ? RemoveTag.fromJson(
                  json_['removeTag'] as core.Map<core.String, core.dynamic>,
                )
                : null,
        resetTag:
            json_.containsKey('resetTag')
                ? ResetTag.fromJson(
                  json_['resetTag'] as core.Map<core.String, core.dynamic>,
                )
                : null,
      );

  core.Map<core.String, core.dynamic> toJson() => {
    if (cleanImageTag != null) 'cleanImageTag': cleanImageTag!,
    if (cleanTextTag != null) 'cleanTextTag': cleanTextTag!,
    if (deleteTag != null) 'deleteTag': deleteTag!,
    if (keepTag != null) 'keepTag': keepTag!,
    if (queries != null) 'queries': queries!,
    if (recurseTag != null) 'recurseTag': recurseTag!,
    if (regenUidTag != null) 'regenUidTag': regenUidTag!,
    if (removeTag != null) 'removeTag': removeTag!,
    if (resetTag != null) 'resetTag': resetTag!,
  };
}
...
class BatchGetMessagesResponse {
  ...
  ///
  /// See `MessageView` for populated fields.
  core.List<Message>? messages;

  BatchGetMessagesResponse({this.messages});

  BatchGetMessagesResponse.fromJson(core.Map json_)
    : this(
        messages:
...
typedef CharacterMaskField = $Empty;
...
/// [Clean Descriptors Option](http://dicom.nema.org/medical/dicom/2018e/output/chtml/part15/sect_E.3.5.html),
...
/// of the tags marked for removal (action codes D, Z, X, and U) in the
/// [Basic Profile](http://dicom.nema.org/medical/dicom/2018e/output/chtml/part15/chapter_E.html).
/// These contextual phrases are replaced with the token "\[CTX\]". This option
/// uses an additional infoType during inspection.
typedef CleanDescriptorsOption = $Empty;
...
/// Xhtml.
typedef CleanTextField = $Empty;

/// Inspect text and transform sensitive text.
///
/// Configurable using TextConfig. Supported
/// [Value Representations](http://dicom.nema.org/medical/dicom/2018e/output/chtml/part05/sect_6.2.html#table_6.2-1):
/// AE, LO, LT, PN, SH, ST, UC, UT, DA, DT, AS
typedef CleanTextTag = $Empty;

/// Request to configure the search parameters for the specified FHIR store.
class ConfigureSearchRequest {
  /// The canonical URLs of the search parameters that are intended to be used
  /// for the FHIR store.
  ///
  /// See https://www.hl7.org/fhir/references.html#canonical for explanation on
  /// FHIR canonical urls
  core.List<core.String>? canonicalUrls;
  ...
  ConfigureSearchRequest({this.canonicalUrls, this.validateOnly});

  ConfigureSearchRequest.fromJson(core.Map json_)
    : this(
        canonicalUrls:
            (json_['canonicalUrls'] as core.List?)
                ?.map((value) => value as core.String)
                .toList(),
        validateOnly: json_['validateOnly'] as core.bool?,
      );
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    if (canonicalUrls != null) 'canonicalUrls': canonicalUrls!,
    if (validateOnly != null) 'validateOnly': validateOnly!,
  };
}
...
class Consent {
  ...
  ///
  /// Optional.
  core.List<GoogleCloudHealthcareV1beta1ConsentPolicy>? policies;
    ...
    : this(
        ...
        policies:
            (json_['policies'] as core.List?)
                ?.map(
                  (value) => GoogleCloudHealthcareV1beta1ConsentPolicy.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
/// profile are collected into a contextual phrase list.
///
...
typedef ContextualDeidConfig = $Empty;
...
class CryptoHashConfig {
  ...
  /// crypto_key nor kms_wrapped is specified. Must not be set if kms_wrapped is
  /// set.
...
class DateShiftConfig {
  ...
  /// KMS wrapped key.
  ///
  /// If kms_wrapped is not set, then crypto_key is used to calculate the date
  /// shift. If neither is set, a default key is generated for each de-identify
  /// operation. Must not be set if crypto_key is set.
  KmsWrappedCryptoKey? kmsWrapped;
...
///
/// See
/// [date shifting](https://cloud.google.com/dlp/docs/concepts-date-shifting)
/// for more information. Supported
/// [types](https://www.hl7.org/fhir/datatypes.html): Date, DateTime.
typedef DateShiftField = $Empty;
...
class DeidentifyConfig {
  ...
  ///
  /// Deprecated. Use `dicom_tag_config` instead.
  @core.Deprecated(
  ...
  ///
  /// Deprecated. Use `fhir_field_config` instead.
  @core.Deprecated(
    'Not supported. Member documentation may have more information.',
  )
  FhirConfig? fhir;
  ...
  ///
  /// Deprecated. Use `dicom_tag_config.options.clean_image` instead.
  @core.Deprecated(
    'Not supported. Member documentation may have more information.',
  )
  ImageConfig? image;
  ...
  DeidentifyOperationMetadata? operationMetadata;
  ...
  /// `ORGANIZATION_NAME` infoTypes. If the deprecated DicomConfig or FhirConfig
  /// are used, then `LOCATION` must be excluded within TextConfig, and must
    ...
    : this(
        dicom:
            json_.containsKey('dicom')
                ...
                : null,
        dicomTagConfig:
            json_.containsKey('dicomTagConfig')
                ? DicomTagConfig.fromJson(
                  json_['dicomTagConfig']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
        fhir:
            json_.containsKey('fhir')
                ...
                : null,
        fhirFieldConfig:
            json_.containsKey('fhirFieldConfig')
                ? FhirFieldConfig.fromJson(
                  json_['fhirFieldConfig']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
        image:
            json_.containsKey('image')
                ...
                : null,
        operationMetadata:
            json_.containsKey('operationMetadata')
                ? DeidentifyOperationMetadata.fromJson(
                  json_['operationMetadata']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
        text:
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (dicomTagConfig != null) 'dicomTagConfig': dicomTagConfig!,
    if (fhir != null) 'fhir': fhir!,
    if (fhirFieldConfig != null) 'fhirFieldConfig': fhirFieldConfig!,
    if (image != null) 'image': image!,
    if (operationMetadata != null) 'operationMetadata': operationMetadata!,
...
class DeidentifyOperationMetadata {
  ...
  DeidentifyOperationMetadata.fromJson(core.Map json_)
    : this(
        fhirOutput:
            json_.containsKey('fhirOutput')
                ? FhirOutput.fromJson(
                  json_['fhirOutput'] as core.Map<core.String, core.dynamic>,
                )
                : null,
      );

  core.Map<core.String, core.dynamic> toJson() => {
    if (fhirOutput != null) 'fhirOutput': fhirOutput!,
  };
}

/// Delete tag.
typedef DeleteTag = $Empty;
...
class DicomConfig {
  ...
  /// - "MINIMAL_KEEP_LIST_PROFILE" : Keep only the tags required to produce
  /// valid DICOM objects.
...
class DicomStore {
  ...
  ///
  /// Optional.
  core.List<GoogleCloudHealthcareV1beta1DicomStreamConfig>? streamConfigs;
    ...
    : this(
        ...
        streamConfigs:
            (json_['streamConfigs'] as core.List?)
                ?.map(
                  (value) =>
                      GoogleCloudHealthcareV1beta1DicomStreamConfig.fromJson(
                        value as core.Map<core.String, core.dynamic>,
                      ),
                )
                .toList(),
...
class DicomTagConfig {
  ...
  DicomTagConfig.fromJson(core.Map json_)
    : this(
        actions:
...
class EntityMention {
  ...
  ///
  /// For example, for an entity mention of type `DATE` this can be its more
  ...
  /// `STAGE_DATE`
  core.List<Feature>? additionalInfo;
  ...
  EntityMention.fromJson(core.Map json_)
    : this(
        additionalInfo:
            (json_['additionalInfo'] as core.List?)
                ?.map(
    ...
    : this(
        ...
        gcsDestination:
            json_.containsKey('gcsDestination')
                ? GoogleCloudHealthcareV1beta1DicomGcsDestination.fromJson(
...
class ExportResourcesHistoryRequest {
  ...
  /// one or more objects per resource type depending on the volume of the
  /// resources exported. When there is only one object per resource type, the
  /// object name is in the form of `{operation_id})_history_{resource_type}`.
  /// When there are multiple objects for a given resource type, the object
  ...
  GoogleCloudHealthcareV1beta1FhirGcsDestination? gcsDestination;

  /// If provided and non-zero, places a limit on the number of resource
  /// versions that are returned for a given resource.
  ///
  /// For example, if the limit is `100` and a resource has over 100 versions,
  /// only the 100 most recent versions will be returned. Must be positive.
  core.String? maxResourceVersions;

  ExportResourcesHistoryRequest({
    this.P_since,
    this.P_type,
    this.gcsDestination,
    this.maxResourceVersions,
  });

  ExportResourcesHistoryRequest.fromJson(core.Map json_)
    : this(
        P_since: json_['_since'] as core.String?,
        P_type: json_['_type'] as core.String?,
        gcsDestination:
            json_.containsKey('gcsDestination')
                ? GoogleCloudHealthcareV1beta1FhirGcsDestination.fromJson(
                  json_['gcsDestination']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
        maxResourceVersions: json_['maxResourceVersions'] as core.String?,
      );
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (P_type != null) '_type': P_type!,
    if (gcsDestination != null) 'gcsDestination': gcsDestination!,
    if (maxResourceVersions != null)
      'maxResourceVersions': maxResourceVersions!,
  };
}
...
class FhirFieldConfig {
  /// Specifies FHIR paths to match and how to transform them.
  ///
  /// Any field that is not matched by a FieldMetadata `action` is passed
  /// through to the output dataset unmodified. All extensions will be processed
  /// according to keep_extensions. If a field can be matched by more than one
  /// FieldMetadata `action`, the first `action` option is applied. Overrides
  /// options and the union field `profile` in FhirFieldConfig.
  core.List<GoogleCloudHealthcareV1beta1DeidentifyFieldMetadata>?
  fieldMetadataList;

  /// Specifies additional options, overriding the base ProfileType.
  GoogleCloudHealthcareV1beta1DeidentifyOptions? options;
  ...
  /// - "BASIC" : Transforms known
  /// [HIPAA 18](https://www.hhs.gov/hipaa/for-professionals/privacy/special-topics/de-identification/index.html#standard)
  /// fields and cleans known unstructured text fields.
  ...
  FhirFieldConfig({this.fieldMetadataList, this.options, this.profileType});

  FhirFieldConfig.fromJson(core.Map json_)
    : this(
        fieldMetadataList:
            (json_['fieldMetadataList'] as core.List?)
                ?.map(
        ...
        options:
            json_.containsKey('options')
                ? GoogleCloudHealthcareV1beta1DeidentifyOptions.fromJson(
                  json_['options'] as core.Map<core.String, core.dynamic>,
                )
                : null,
        profileType: json_['profileType'] as core.String?,
...
class FhirNotificationConfig {
  ...
  /// Whether to send full FHIR resource to this Pub/Sub topic for Create and
  /// Update operation.
  ///
...
class FhirOutput {
  ...
  /// operation metadata is only generated for DICOM de-identification
  /// operations.
  core.String? fhirStore;

  FhirOutput({this.fhirStore});

  FhirOutput.fromJson(core.Map json_)
    : this(fhirStore: json_['fhirStore'] as core.String?);
...
class FhirStore {
  ...
  /// Whether to allow ExecuteBundle to accept history bundles, and directly
  /// insert and overwrite historical resource versions into the FHIR store.
  ///
  /// If set to false, using history bundles fails with an error. Defaults to
  /// false.
  ///
  /// Optional.
  core.bool? enableHistoryModifications;
  ...
  FhirStore.fromJson(core.Map json_)
    : this(
        ...
        enableHistoryModifications:
            json_['enableHistoryModifications'] as core.bool?,
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (enableHistoryModifications != null)
...
class FieldMetadata {
  ...
  /// field name or FHIR type name. All types begin with an upper case letter.
  /// For example, the resource field "Patient.Address.city", which uses a
  ...
  /// matched by "Address.city" (Patient omitted). Partial matching and type
  /// matching can be combined. For example, "Patient.Address.city" can be
  /// matched by "Address.String". For "choice" types (those defined in the FHIR
  /// spec with the form: field\[x\]), use two separate components. For example,
  ...
  /// HumanName(for example HumanName.given, HumanName.family) can be omitted.
...
typedef GoogleCloudHealthcareV1beta1ConsentGcsDestination =
    $ConsentGcsDestination;
...
class GoogleCloudHealthcareV1beta1ConsentPolicy {
  ...
  GoogleCloudHealthcareV1beta1ConsentPolicy.fromJson(core.Map json_)
    : this(
        authorizationRule:
...
class GoogleCloudHealthcareV1beta1DeidentifyFieldMetadata {
  ...
  ///
  /// Each path is a period-separated list where each component is either a
  /// field name or FHIR [type](https://www.hl7.org/fhir/datatypes.html) name.
  /// All types begin with an upper case letter. For example, the resource field
  /// `Patient.Address.city`, which uses a
  /// [string](https://www.hl7.org/fhir/datatypes-definitions.html#Address.city)
  ...
  /// matching can be combined, for example `Patient.Address.city` can be
  /// matched by `Address.String`. For "choice" types (those defined in the FHIR
  /// spec with the format `field[x]`), use two separate components. For
  /// example, `deceasedAge.unit` is matched by `Deceased.Age.unit`. The
  /// following types are supported: AdministrativeGenderCode, Base64Binary,
  /// Boolean, Code, Date, DateTime, Decimal, HumanName, Id, Instant, Integer,
  /// LanguageCode, Markdown, Oid, PositiveInt, String, UnsignedInt, Uri, Uuid,
  /// Xhtml. The sub-type for HumanName (for example `HumanName.given`,
  ...
  GoogleCloudHealthcareV1beta1DeidentifyFieldMetadata.fromJson(core.Map json_)
    : this(
        characterMaskField:
            json_.containsKey('characterMaskField')
                ? CharacterMaskField.fromJson(
                  json_['characterMaskField']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
        cleanTextField:
            json_.containsKey('cleanTextField')
                ? CleanTextField.fromJson(
                  json_['cleanTextField']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
        cryptoHashField:
            json_.containsKey('cryptoHashField')
                ? CryptoHashField.fromJson(
                  json_['cryptoHashField']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
        dateShiftField:
            json_.containsKey('dateShiftField')
                ? DateShiftField.fromJson(
                  json_['dateShiftField']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
        keepField:
            json_.containsKey('keepField')
                ? KeepField.fromJson(
                  json_['keepField'] as core.Map<core.String, core.dynamic>,
                )
                : null,
        paths:
            (json_['paths'] as core.List?)
                ...
                .toList(),
        removeField:
            json_.containsKey('removeField')
                ? RemoveField.fromJson(
                  json_['removeField'] as core.Map<core.String, core.dynamic>,
                )
                : null,
      );

  core.Map<core.String, core.dynamic> toJson() => {
    if (characterMaskField != null) 'characterMaskField': characterMaskField!,
    if (cleanTextField != null) 'cleanTextField': cleanTextField!,
    if (cryptoHashField != null) 'cryptoHashField': cryptoHashField!,
    if (dateShiftField != null) 'dateShiftField': dateShiftField!,
    if (keepField != null) 'keepField': keepField!,
    if (paths != null) 'paths': paths!,
    if (removeField != null) 'removeField': removeField!,
  };
}
...
class GoogleCloudHealthcareV1beta1DeidentifyOptions {
  ...
  ContextualDeidConfig? contextualDeid;
  ...
  KeepExtensionsConfig? keepExtensions;
  ...
  GoogleCloudHealthcareV1beta1DeidentifyOptions.fromJson(core.Map json_)
    : this(
        characterMaskConfig:
            json_.containsKey('characterMaskConfig')
                ...
                : null,
        contextualDeid:
            json_.containsKey('contextualDeid')
                ? ContextualDeidConfig.fromJson(
                  json_['contextualDeid']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
        cryptoHashConfig:
        ...
        dateShiftConfig:
            json_.containsKey('dateShiftConfig')
                ...
                : null,
        keepExtensions:
            json_.containsKey('keepExtensions')
                ? KeepExtensionsConfig.fromJson(
                  json_['keepExtensions']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
      );
...
class GoogleCloudHealthcareV1beta1DicomBigQueryDestination {
  ...
  GoogleCloudHealthcareV1beta1DicomBigQueryDestination.fromJson(core.Map json_)
    : this(
...
class GoogleCloudHealthcareV1beta1DicomGcsDestination {
  ...
  GoogleCloudHealthcareV1beta1DicomGcsDestination.fromJson(core.Map json_)
    : this(
...
/// Specifies the configuration for importing data from Cloud Storage.
typedef GoogleCloudHealthcareV1beta1DicomGcsSource = $DicomGcsSource;
...
class GoogleCloudHealthcareV1beta1DicomStreamConfig {
  ...
  GoogleCloudHealthcareV1beta1DicomStreamConfig({this.bigqueryDestination});

  GoogleCloudHealthcareV1beta1DicomStreamConfig.fromJson(core.Map json_)
    : this(
        bigqueryDestination:
            json_.containsKey('bigqueryDestination')
                ? GoogleCloudHealthcareV1beta1DicomBigQueryDestination.fromJson(
...
class GoogleCloudHealthcareV1beta1FhirBigQueryDestination {
  /// Setting this field will enable BigQuery's Change Data Capture (CDC) on the
  /// destination tables.
  ///
  /// Use this field if you: - Want to only keep the latest version of each
  /// resource. Updates and deletes to an existing resource will overwrite the
  /// corresponding row. - Have a store with enabled history modifications and
  /// want to keep the entire history of resource versions but want the history
  /// to be mutable. Updates and deletes to a specific resource version will
  ...
  GoogleCloudHealthcareV1beta1FhirBigQueryDestination.fromJson(core.Map json_)
    : this(
        changeDataCaptureConfig:
            json_.containsKey('changeDataCaptureConfig')
                ? GoogleCloudHealthcareV1beta1FhirChangeDataCaptureConfig.fromJson(
                  json_['changeDataCaptureConfig']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    if (changeDataCaptureConfig != null)
      'changeDataCaptureConfig': changeDataCaptureConfig!,
...
class GoogleCloudHealthcareV1beta1FhirChangeDataCaptureConfig {
  /// Configures how historical versions of FHIR resources will be reflected in
  /// the destination table through updates and deletes.
  ///
  ...
  /// - "KEEP_ALL_VERSIONS" : Historical versions of resources will be
  /// maintained. However, history mutation is allowed. Updates will overwrite
  /// the row matching the resource ID and version if it exists in the table.
  /// This option is only supported for stores with history enabled.
  core.String? historyMode;

  GoogleCloudHealthcareV1beta1FhirChangeDataCaptureConfig({this.historyMode});

  GoogleCloudHealthcareV1beta1FhirChangeDataCaptureConfig.fromJson(
    core.Map json_,
  ) : this(historyMode: json_['historyMode'] as core.String?);

  core.Map<core.String, core.dynamic> toJson() => {
    if (historyMode != null) 'historyMode': historyMode!,
  };
}
...
class GoogleCloudHealthcareV1beta1FhirGcsDestination {
  ...
  GoogleCloudHealthcareV1beta1FhirGcsDestination({this.uriPrefix});

  GoogleCloudHealthcareV1beta1FhirGcsDestination.fromJson(core.Map json_)
...
/// Specifies the configuration for importing data from Cloud Storage.
typedef GoogleCloudHealthcareV1beta1FhirGcsSource = $GcsSource00;
...
class Hl7V2NotificationConfig {
  ...
  /// operator to an expression to negate it. Fields/functions available for
  /// filtering are: * `message_type`, from the MSH-9.1 field. For example, `NOT
  ...
  /// For example, `send_date < "2017-01-02"`. * `send_time`, the timestamp when
  /// the message was sent, using the RFC3339 time format for comparisons, from
  /// the MSH-7 segment. For example, `send_time < "2017-01-02T00:00:00-05:00"`.
  /// * `create_time`, the timestamp when the message was created in the HL7v2
  /// store. Use the RFC3339 time format for comparisons. For example,
  /// `create_time < "2017-01-02T00:00:00-05:00"`. * `send_facility`, the care
  /// center that the message came from, from the MSH-4 segment. For example,
  ...
  /// PID-2, PID-3, or PID-4 segments. For example, `PatientId("123456",
...
class Hl7V2Store {
  ...
  /// published on.
  ///
  /// Only the message name is sent as part of the notification. If this is
  /// unset, no notifications are sent. Supplied by the client.
  @core.Deprecated(
    'Not supported. Member documentation may have more information.',
  )
  NotificationConfig? notificationConfig;
...
class ImageConfig {
  ...
  /// `text_redaction_mode`.
  ///
  /// Can only be used when `text_redaction_mode` is set to
  /// `REDACT_SENSITIVE_TEXT`, `REDACT_SENSITIVE_TEXT_CLEAN_DESCRIPTORS` or
  /// `TEXT_REDACTION_MODE_UNSPECIFIED`.
  core.List<core.String>? additionalInfoTypes;
  ...
  /// `REDACT_SENSITIVE_TEXT` with the addition of the
  /// [Clean Descriptors Option](https://dicom.nema.org/medical/dicom/2018e/output/chtml/part15/sect_E.3.5.html)
  /// enabled: When cleaning text, the process attempts to transform phrases
  /// matching any of the tags marked for removal (action codes D, Z, X, and U)
  /// in the
  /// [Basic Profile](https://dicom.nema.org/medical/dicom/2018e/output/chtml/part15/chapter_E.html).
  /// These contextual phrases are replaced with the token "\[CTX\]". This mode
  /// uses an additional InfoType during inspection.
  ...
  ImageConfig.fromJson(core.Map json_)
    : this(
        additionalInfoTypes:
            (json_['additionalInfoTypes'] as core.List?)
                ?.map((value) => value as core.String)
                .toList(),
        excludeInfoTypes:
            (json_['excludeInfoTypes'] as core.List?)
                ?.map((value) => value as core.String)
                .toList(),
        textRedactionMode: json_['textRedactionMode'] as core.String?,
      );
    ...
    : this(
        ...
        gcsSource:
            json_.containsKey('gcsSource')
                ? GoogleCloudHealthcareV1beta1DicomGcsSource.fromJson(
...
class ImportResourcesHistoryRequest {
  ...
  /// The Cloud Healthcare Service Agent requires the
  /// `roles/storage.objectAdmin` Cloud IAM roles on the Cloud Storage location.
  /// The Healthcare Service Agent Each Cloud Storage object should be a text
  /// file that contains the format specified in ContentStructure.
  GoogleCloudHealthcareV1beta1FhirGcsSource? gcsSource;

  /// The maximum number of errors before the server cancels the operation.
  ///
  /// If not specified or set to 0, defaults to 100. -1 means no maximum, the
  /// server tries to process all input. Since the server executes the operation
  /// in parallel, it might not stop the operation after exactly this number of
  /// errors occur.
  core.String? maxErrorCount;
  ...
  ImportResourcesHistoryRequest.fromJson(core.Map json_)
    : this(
        contentStructure: json_['contentStructure'] as core.String?,
        gcsSource:
            json_.containsKey('gcsSource')
                ? GoogleCloudHealthcareV1beta1FhirGcsSource.fromJson(
                  json_['gcsSource'] as core.Map<core.String, core.dynamic>,
                )
                : null,
        maxErrorCount: json_['maxErrorCount'] as core.String?,
      );

  core.Map<core.String, core.dynamic> toJson() => {
    if (contentStructure != null) 'contentStructure': contentStructure!,
    if (gcsSource != null) 'gcsSource': gcsSource!,
    if (maxErrorCount != null) 'maxErrorCount': maxErrorCount!,
  };
}
...
class ImportResourcesRequest {
  ...
  /// The Cloud Healthcare Service Agent requires the
  /// `roles/storage.objectViewer` Cloud IAM roles on the Cloud Storage
  /// location. The Healthcare Service Agent Each Cloud Storage object should be
  /// a text file that contains the format specified in ContentStructure.
  GoogleCloudHealthcareV1beta1FhirGcsSource? gcsSource;
...
class InfoTypeTransformation {
  ...
  ///
  /// If this is not specified, this transformation becomes the default
  /// transformation, and is used for any `info_type` that is not specified in
...
/// The behavior for handling FHIR extensions that aren't otherwise specified
/// for de-identification.
///
/// If provided, all extensions are preserved during de-identification by
/// default. If unspecified, all extensions are removed during de-identification
/// by default.
typedef KeepExtensionsConfig = $Empty;

/// Keep field unchanged.
typedef KeepField = $Empty;

/// Keep tag unchanged.
typedef KeepTag = $Empty;
...
class Options {
  ...
  Options.fromJson(core.Map json_)
    : this(
        cleanDescriptors:
            json_.containsKey('cleanDescriptors')
                ? CleanDescriptorsOption.fromJson(
                  json_['cleanDescriptors']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
        cleanImage:
            json_.containsKey('cleanImage')
                ? ImageConfig.fromJson(
                  json_['cleanImage'] as core.Map<core.String, core.dynamic>,
                )
                : null,
        primaryIds: json_['primaryIds'] as core.String?,
      );

  core.Map<core.String, core.dynamic> toJson() => {
    if (cleanDescriptors != null) 'cleanDescriptors': cleanDescriptors!,
    if (cleanImage != null) 'cleanImage': cleanImage!,
    if (primaryIds != null) 'primaryIds': primaryIds!,
  };
}
...
class QueryAccessibleDataRequest {
  ...
  /// location. The object name is in the following format:
  /// query-accessible-data-result-{operation_id}.txt where each line contains a
  /// single data_id.
  GoogleCloudHealthcareV1beta1ConsentGcsDestination? gcsDestination;
...
/// Remove field.
typedef RemoveField = $Empty;

/// Replace with empty tag.
typedef RemoveTag = $Empty;
...
class RollbackFhirResourceFilteringFields {
  ...
  ///
  /// Only changes made by these operations will be rolled back.
  ///
  /// Optional.
...
class RollbackFhirResourcesRequest {
  ...
  /// Tag represents fields that HDE needs to identify resources that will be
  /// reverted.
  ///
...
class SchemaConfig {
  ...
  /// the FHIR data being exported, with no additional simplification. This type
...
class SearchConfig {
  /// A list of search parameters in this FHIR store that are used to configure
  /// this FHIR store.
  core.List<SearchParameter>? searchParameters;

  SearchConfig({this.searchParameters});

  SearchConfig.fromJson(core.Map json_)
    : this(
        searchParameters:
            (json_['searchParameters'] as core.List?)
                ?.map(
                  (value) => SearchParameter.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
class SearchParameter {
  ...
  SearchParameter.fromJson(core.Map json_)
    : this(
...
class StreamConfig {
  ...
  /// the existing tables (if any) that are named after the resource types, e.g.
  ...
  /// does not stream in new data. One resolution in this case is to delete the
  /// incompatible table and let the server recreate one, though the newly
  /// created table only contains data after the table recreation. BigQuery
  /// imposes a 1 MB limit on streaming insert row size, therefore any resource
  /// mutation that generates more than 1 MB of BigQuery data will not be
  /// streamed. Results are written to BigQuery tables according to the
  ...
  /// mutation cannot be streamed to BigQuery, errors will be logged to Cloud
  /// Logging (see
  /// [Viewing error logs in Cloud Logging](https://cloud.google.com/healthcare/docs/how-tos/logging)).
  GoogleCloudHealthcareV1beta1FhirBigQueryDestination? bigqueryDestination;
