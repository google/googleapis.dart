...
///
/// Create an instance of [IDSApi] to access these resources:
///
/// - [ProjectsResource]
...
/// Cloud IDS (Cloud Intrusion Detection System) detects malware, spyware,
/// command-and-control attacks, and other network-based threats.
///
/// Its security efficacy is industry leading, built with Palo Alto Networks
/// technologies. When you use this product, your organization name and
...
class IDSApi {
  ...
  IDSApi(http.Client client,
      {core.String rootUrl = 'https://ids.googleapis.com/',
...
class ProjectsLocationsEndpointsResource {
  ...
  /// Value must have pattern `^projects/\[^/\]+/locations/\[^/\]+$`.
  ///
  /// [filter] - Optional. The filter expression, following the syntax outlined
  ...
  ///
  /// [pageSize] - Optional. The maximum number of endpoints to return. The
...
///
/// It defines a forwarding rule to which packets can be sent for IDS
/// inspection.
class Endpoint {
  ...
  /// The fully qualified URL of the network to which the IDS Endpoint is
  /// attached.
  ///
  /// Required.
  core.String? network;
  ...
  Endpoint.fromJson(core.Map _json)
      : this(
          ...
          description: _json.containsKey('description')
              ...
              : null,
          endpointForwardingRule: _json.containsKey('endpointForwardingRule')
              ? _json['endpointForwardingRule'] as core.String
              : null,
          endpointIp: _json.containsKey('endpointIp')
              ? _json['endpointIp'] as core.String
              : null,
          ...
          trafficLogs: _json.containsKey('trafficLogs')
              ? _json['trafficLogs'] as core.bool
              : null,
