...
class ProjectsLocationsBackupsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$parent') + '/backups';
...
class ProjectsLocationsClustersResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$parent') + '/clusters';
  ...
  async.Future<Operation> export(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$name') + ':export';
  ...
  async.Future<Operation> import(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$name') + ':import';
  ...
  async.Future<Operation> promote(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$name') + ':promote';
  ...
  async.Future<Operation> restore(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$parent') + '/clusters:restore';
  ...
  async.Future<Operation> switchover(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$name') + ':switchover';
  ...
  async.Future<Operation> upgrade(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$name') + ':upgrade';
...
class ProjectsLocationsClustersInstancesResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$parent') + '/instances';
  ...
  async.Future<Operation> failover(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$name') + ':failover';
  ...
  async.Future<ConnectionInfo> getConnectionInfo(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$parent') + '/connectionInfo';
  ...
  async.Future<Operation> injectFault(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$name') + ':injectFault';
...
class ProjectsLocationsSupportedDatabaseFlagsResource {
  ...
  async.Future<ListSupportedDatabaseFlagsResponse> list(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$parent') + '/supportedDatabaseFlags';
...
class Cluster {
  ...
  GeminiClusterConfig? geminiConfig;
  ...
  /// AlloyDB per-cluster service account.
  ///
  /// This service account is created per-cluster per-project, and is different
  /// from the per-project service account. The per-cluster service account
...
typedef ConnectionInfo = $ConnectionInfo;

/// Configuration for Managed Connection Pool (MCP).
typedef ConnectionPoolConfig = $ConnectionPoolConfig;
...
/// product.
typedef GCAInstanceConfig = $GCAInstanceConfig;
...
/// Deprecated and unused.
///
/// This message will be removed in the near future.
typedef GeminiClusterConfig = $Config00;

/// Deprecated and unused.
///
/// This message will be removed in the near future.
typedef GeminiInstanceConfig = $Config00;
...
class Instance {
  ...
  /// Configuration parameters related to Gemini Cloud Assist.
  ///
  /// Output only.
  GCAInstanceConfig? gcaConfig;
  ...
  /// non-default update policy, you must specify explicitly specify the value
  ...
  Instance.fromJson(core.Map json_)
    : this(
        ...
        etag: json_['etag'] as core.String?,
        gcaConfig:
            json_.containsKey('gcaConfig')
                ? GCAInstanceConfig.fromJson(
                  json_['gcaConfig'] as core.Map<core.String, core.dynamic>,
                )
                : null,
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (displayName != null) 'displayName': displayName!,
    if (etag != null) 'etag': etag!,
    if (gcaConfig != null) 'gcaConfig': gcaConfig!,
...
typedef ObservabilityInstanceConfig = $ObservabilityInstanceConfig;
...
typedef UpdatePolicy = $UpdatePolicy;

/// Upgrades a cluster.
typedef UpgradeClusterRequest = $UpgradeClusterRequest;
