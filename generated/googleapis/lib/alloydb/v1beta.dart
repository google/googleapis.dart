...
class ProjectsLocationsClustersResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$parent') + '/clusters';
  ...
  async.Future<Operation> export(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$name') + ':export';
  ...
  async.Future<Operation> import(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$name') + ':import';
  ...
  async.Future<Operation> promote(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$name') + ':promote';
  ...
  async.Future<Operation> restore(
    ...
    final url_ =
        'v1beta/' + core.Uri.encodeFull('$parent') + '/clusters:restore';
  ...
  async.Future<Operation> switchover(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$name') + ':switchover';
  ...
  async.Future<Operation> upgrade(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$name') + ':upgrade';
...
class ProjectsLocationsClustersInstancesResource {
  ...
  async.Future<Operation> failover(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$name') + ':failover';
  ...
  async.Future<ConnectionInfo> getConnectionInfo(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$parent') + '/connectionInfo';
  ...
  async.Future<Operation> injectFault(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$name') + ':injectFault';
  ...
  async.Future<Operation> restart(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$name') + ':restart';
...
class ProjectsLocationsClustersUsersResource {
  ...
  async.Future<User> create(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$parent') + '/users';
...
class ProjectsLocationsSupportedDatabaseFlagsResource {
  ...
  async.Future<ListSupportedDatabaseFlagsResponse> list(
    ...
    final url_ =
        'v1beta/' + core.Uri.encodeFull('$parent') + '/supportedDatabaseFlags';
