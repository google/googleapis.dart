...
/// Serverless VPC Access API - v1beta1
///
...
class ProjectsLocationsConnectorsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/connectors';
...
class Connector {
  ...
  Connector.fromJson(core.Map json_)
    : this(
        ...
        lastRestartTime: json_['lastRestartTime'] as core.String?,
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (lastRestartTime != null) 'lastRestartTime': lastRestartTime!,
