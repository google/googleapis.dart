...
class ProjectsLocationsEnvironmentsResource {
  ...
  get userWorkloadsConfigMaps =>
      ProjectsLocationsEnvironmentsUserWorkloadsConfigMapsResource(_requester);
  ProjectsLocationsEnvironmentsUserWorkloadsSecretsResource
  ...
  /// Request parameters:
  ///
  /// [environment] - The resource name of the environment to check upgrade for,
  /// in the form:
  ...
  async.Future<Operation> checkUpgrade(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$environment') + ':checkUpgrade';
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/environments';
  ...
  async.Future<Operation> databaseFailover(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$environment') + ':databaseFailover';
  ...
  async.Future<Operation> loadSnapshot(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$environment') + ':loadSnapshot';
  ...
  /// entire map field by providing the map field's path in the `updateMask`.
  /// The new value of the field will be that which is provided in the patch
  ...
  /// "pypiPackages":{ "botocore":"==1.7.14" } } } } **Note:** Only the
  /// following fields can be updated: * `config.softwareConfig.pypiPackages` *
  /// Replace all custom custom PyPI packages. If a replacement package map is
  /// not included in `environment`, all custom PyPI packages are cleared. It is
  ...
  /// image version cannot effect a version downgrade, and must match the
  ...
  /// values. * `config.softwareConfig.schedulerCount` * Horizontally scale the
  ...
  async.Future<Operation> restartWebServer(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$name') + ':restartWebServer';
  ...
  async.Future<Operation> saveSnapshot(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$environment') + ':saveSnapshot';
...
class ProjectsLocationsEnvironmentsUserWorkloadsSecretsResource {
  ...
  async.Future<UserWorkloadsSecret> create(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/userWorkloadsSecrets';
...
class ProjectsLocationsImageVersionsResource {
  ...
  async.Future<ListImageVersionsResponse> list(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/imageVersions';
...
class CheckUpgradeRequest {
  ...
  CheckUpgradeRequest({this.imageVersion});
...
class DataRetentionConfig {
  /// The number of days describing for how long to store event-based records in
  /// airflow database.
  ///
  /// If the retention mechanism is enabled this value must be a positive
  /// integer otherwise, value should be set to 0.
  ///
  /// Optional.
  @core.Deprecated(
    'Not supported. Member documentation may have more information.',
  )
  core.int? airflowDatabaseRetentionDays;
  ...
  DataRetentionConfig({
    this.airflowDatabaseRetentionDays,
  ...
  DataRetentionConfig.fromJson(core.Map json_)
    : this(
        airflowDatabaseRetentionDays:
            json_['airflowDatabaseRetentionDays'] as core.int?,
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    if (airflowDatabaseRetentionDays != null)
      'airflowDatabaseRetentionDays': airflowDatabaseRetentionDays!,
...
class IPAllocationPolicy {
  ...
  /// The IP address range of the services IP addresses in this cluster.
  ///
  /// For Cloud Composer environments in versions composer-1.*.*-airflow-*.*.*,
  /// this field is applicable only when `use_ip_aliases` is true. Set to blank
  /// to have GKE choose a range with the default size. Set to /netmask (e.g.
  ...
  /// the cluster.
  ///
  /// Specify either `services_secondary_range_name` or
  /// `services_ipv4_cidr_block` but not both. For Cloud Composer environments
  /// in versions composer-1.*.*-airflow-*.*.*, this field is applicable only
...
class ListEnvironmentsResponse {
  ...
  ListEnvironmentsResponse({this.environments, this.nextPageToken});
...
class ListImageVersionsResponse {
  ...
  ListImageVersionsResponse({this.imageVersions, this.nextPageToken});
    ...
    : this(
        ...
        userWorkloadsConfigMaps:
            (json_['userWorkloadsConfigMaps'] as core.List?)
                ?.map(
                  (value) => UserWorkloadsConfigMap.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
class ListWorkloadsResponse {
  ...
  ListWorkloadsResponse({this.nextPageToken, this.workloads});
...
class MaintenanceWindow {
  ...
  /// value for end_time must be in the future, relative to `start_time`.
  ///
  /// Required.
  core.String? endTime;
  ...
  MaintenanceWindow({this.endTime, this.recurrence, this.startTime});
...
class MasterAuthorizedNetworksConfig {
  ...
  MasterAuthorizedNetworksConfig({this.cidrBlocks, this.enabled});
...
class NodeConfig {
  ...
  /// The IPAllocationPolicy fields for the GKE cluster.
  ///
  /// Optional.
  ...
  /// The maximum number of pods per node in the Cloud Composer GKE cluster.
  ///
  /// The value must be between 8 and 110 and it can be set only if the
  ...
  /// created GKE cluster, and to the default "Maximum Pods per Node" value
  /// which is used for newly created node pools if their value is not
  /// explicitly set during node pool creation. For more information, see
  ...
  /// unspecified, the default network in the environment's project is used. If
  /// a \[Custom Subnet Network\](/vpc/docs/vpc#vpc_networks_and_subnets) is
  ...
  /// The Google Cloud Platform Service Account to be used by the workloads.
  ///
  ...
  NodeConfig.fromJson(core.Map json_)
    : this(
        ...
        maxPodsPerNode: json_['maxPodsPerNode'] as core.int?,
...
class PrivateClusterConfig {
  ...
  ///
  /// This range is used for assigning internal IP addresses to the cluster
