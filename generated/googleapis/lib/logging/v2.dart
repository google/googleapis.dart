...
class AppHubWorkload {
  ...
  AppHubWorkload({this.criticalityType, this.environmentType, this.id});
...
class ListLogEntriesRequest {
  ...
  /// equal timestamps are returned in order of their insert_id values.We
  /// recommend setting the order_by field to "timestamp desc" when listing
  /// recently ingested log entries. If not set, the default value of "timestamp
  /// asc" may take a long time to fetch matching logs that are only recently
  /// ingested.
  ///
  /// Optional.
  core.String? orderBy;
...
class LogMetric {
  ...
  LogMetric.fromJson(core.Map json_)
    : this(
        ...
        updateTime: json_['updateTime'] as core.String?,
        valueExtractor: json_['valueExtractor'] as core.String?,
...
class LogSink {
  ...
  LogSink.fromJson(core.Map json_)
    : this(
        ...
        name: json_['name'] as core.String?,
        outputVersionFormat: json_['outputVersionFormat'] as core.String?,
        resourceName: json_['resourceName'] as core.String?,
        updateTime: json_['updateTime'] as core.String?,
...
class LogSplit {
  ...
  LogSplit.fromJson(core.Map json_)
    : this(
        ...
        totalSplits: json_['totalSplits'] as core.int?,
