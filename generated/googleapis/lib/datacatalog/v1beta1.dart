    ...
    : this(
        ...
        subcolumns:
            (json_['subcolumns'] as core.List?)
                ?.map(
                  (value) => GoogleCloudDatacatalogV1beta1ColumnSchema.fromJson(
...
class GoogleCloudDatacatalogV1beta1ExportTaxonomiesResponse {
  ...
  GoogleCloudDatacatalogV1beta1ExportTaxonomiesResponse({this.taxonomies});
...
class GoogleCloudDatacatalogV1beta1FieldType {
  ...
  GoogleCloudDatacatalogV1beta1FieldType({this.enumType, this.primitiveType});
...
class GoogleCloudDatacatalogV1beta1FieldTypeEnumType {
  ...
  GoogleCloudDatacatalogV1beta1FieldTypeEnumType({this.allowedValues});
...
class GoogleCloudDatacatalogV1beta1FieldTypeEnumTypeEnumValue {
  ...
  GoogleCloudDatacatalogV1beta1FieldTypeEnumTypeEnumValue({this.displayName});
    ...
    : this(
        ...
        sampleGcsFileSpecs:
            (json_['sampleGcsFileSpecs'] as core.List?)
                ?.map(
                  (value) => GoogleCloudDatacatalogV1beta1GcsFileSpec.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
class GoogleCloudDatacatalogV1beta1ImportTaxonomiesRequest {
  ...
  GoogleCloudDatacatalogV1beta1ImportTaxonomiesRequest({this.inlineSource});
...
class GoogleCloudDatacatalogV1beta1ImportTaxonomiesResponse {
  ...
  GoogleCloudDatacatalogV1beta1ImportTaxonomiesResponse({this.taxonomies});
  ...
  GoogleCloudDatacatalogV1beta1ImportTaxonomiesResponse.fromJson(core.Map json_)
    : this(
        taxonomies:
            (json_['taxonomies'] as core.List?)
                ?.map(
                  (value) => GoogleCloudDatacatalogV1beta1Taxonomy.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
class GoogleCloudDatacatalogV1beta1InlineSource {
  ...
  GoogleCloudDatacatalogV1beta1InlineSource({this.taxonomies});
    ...
    : this(
        entries:
            (json_['entries'] as core.List?)
                ?.map(
                  (value) => GoogleCloudDatacatalogV1beta1Entry.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
    ...
    : this(
        entryGroups:
            (json_['entryGroups'] as core.List?)
                ?.map(
                  (value) => GoogleCloudDatacatalogV1beta1EntryGroup.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
    ...
    : this(
        ...
        policyTags:
            (json_['policyTags'] as core.List?)
                ?.map(
                  (value) => GoogleCloudDatacatalogV1beta1PolicyTag.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
    ...
    : this(
        ...
        tags:
            (json_['tags'] as core.List?)
                ?.map(
                  (value) => GoogleCloudDatacatalogV1beta1Tag.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
typedef GoogleCloudDatacatalogV1beta1RenameTagTemplateFieldEnumValueRequest =
    $RenameTagTemplateFieldEnumValueRequest;

/// Request message for RenameTagTemplateField.
typedef GoogleCloudDatacatalogV1beta1RenameTagTemplateFieldRequest =
...
class GoogleCloudDatacatalogV1beta1Schema {
  ...
  GoogleCloudDatacatalogV1beta1Schema({this.columns});
...
class GoogleCloudDatacatalogV1beta1SearchCatalogRequestScope {
  /// If `true`, include Google Cloud public datasets in the search results.
  ///
  /// Info on Google Cloud public datasets is available at
...
class GoogleCloudDatacatalogV1beta1TableSpec {
  ...
  GoogleCloudDatacatalogV1beta1TableSpec({this.groupedEntry});
...
/// Holds an enum value.
typedef GoogleCloudDatacatalogV1beta1TagFieldEnumValue = $TagFieldEnumValue;
...
typedef GoogleCloudDatacatalogV1beta1TaxonomyService = $TaxonomyService;
...
/// Table view specification.
typedef GoogleCloudDatacatalogV1beta1ViewSpec = $ViewSpec;
