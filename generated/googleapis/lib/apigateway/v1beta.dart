...
class ProjectsLocationsApisResource {
  ...
  async.Future<ApigatewayOperation> create(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$parent') + '/apis';
...
class ProjectsLocationsApisConfigsResource {
  ...
  async.Future<ApigatewayOperation> create(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$parent') + '/configs';
...
class ProjectsLocationsGatewaysResource {
  ...
  async.Future<ApigatewayOperation> create(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$parent') + '/gateways';
    ...
    : this(
        ...
        gatewayConfig:
            json_.containsKey('gatewayConfig')
                ? ApigatewayGatewayConfig.fromJson(
...
class ApigatewayBackendConfig {
  /// Google Cloud IAM service account used to sign OIDC tokens for backends
  /// that have authentication configured
  /// (https://cloud.google.com/service-infrastructure/docs/service-management/reference/rest/v1/services.configs#backend).
  ///
  /// This may either be the Service Account's email (i.e.
  /// "{ACCOUNT_ID}@{PROJECT}.iam.gserviceaccount.com") or its full resource
  /// name (i.e. "projects/{PROJECT}/accounts/{UNIQUE_ID}"). This is most often
  /// used when the backend is a GCP resource such as a Cloud Run Service or an
  /// IAP-secured service. Note that this token is always sent as an
  /// authorization header bearer token. The audience of the OIDC token is
  ...
  core.String? googleServiceAccount;

  ApigatewayBackendConfig({this.googleServiceAccount});

  ApigatewayBackendConfig.fromJson(core.Map json_)
    : this(googleServiceAccount: json_['googleServiceAccount'] as core.String?);
...
class ApigatewayGatewayConfig {
  ...
  ApigatewayBackendConfig? backendConfig;

  ApigatewayGatewayConfig({this.backendConfig});

  ApigatewayGatewayConfig.fromJson(core.Map json_)
    : this(
        backendConfig:
            json_.containsKey('backendConfig')
                ? ApigatewayBackendConfig.fromJson(
                  json_['backendConfig'] as core.Map<core.String, core.dynamic>,
                )
                : null,
      );

  core.Map<core.String, core.dynamic> toJson() => {
    if (backendConfig != null) 'backendConfig': backendConfig!,
  };
}
