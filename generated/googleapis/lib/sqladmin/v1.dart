...
class InstancesResource {
  ...
  async.Future<Operation> insert(
    ...
    final url_ =
        'v1/projects/' + commons.escapeVariable('$project') + '/instances';
  ...
  async.Future<Operation> pointInTimeRestore(
    ...
    final url_ = 'v1/' + core.Uri.encodeFull('$parent') + ':pointInTimeRestore';
  ...
  /// project ID. The instance ID contains lowercase letters, numbers, and
...
class OperationsResource {
  ...
  async.Future<OperationsListResponse> list(
    ...
    final url_ =
        'v1/projects/' + commons.escapeVariable('$project') + '/operations';
...
class TiersResource {
  ...
  async.Future<TiersListResponse> list(
    ...
    final url_ = 'v1/projects/' + commons.escapeVariable('$project') + '/tiers';
...
typedef AdvancedMachineFeatures = $AdvancedMachineFeatures02;

/// An Admin API warning message.
typedef ApiWarning = $ApiWarning;

/// An available database version.
///
/// It can be a major or a minor version.
typedef AvailableDatabaseVersion = $AvailableDatabaseVersion;
...
class Backup {
  ...
  /// The instance setting of the source instance that's associated with this
  /// backup.
  ///
  /// Optional. Output only.
...
class BackupConfiguration {
  ...
  /// This value contains the storage location of transactional logs used to
  /// perform point-in-time recovery (PITR) for the database.
  ///
  /// Output only.
  /// Possible string values are:
...
/// Backup context.
typedef BackupContext = $BackupContext;

/// Backup Reencryption Config
typedef BackupReencryptionConfig = $BackupReencryptionConfig;

/// We currently only support backup retention by specifying the number of
/// backups we will retain.
typedef BackupRetentionSettings = $BackupRetentionSettings;
...
typedef BinLogCoordinates = $BinLogCoordinates;
...
class CloneContext {
  ...
  /// This value cannot be the same as the preferred_zone field. This field
  ...
  /// instance. This field applies to all DB types.
  ///
  /// Optional.
...
class ConnectSettings {
  ...
  ///
  /// For example, `us-central1`, `europe-west1`. The region cannot be changed
...
/// configuration.
typedef ConnectionPoolFlags = $ConnectionPoolFlags;

/// Data cache configurations.
typedef DataCacheConfig = $DataCacheConfig;
...
typedef DatabaseFlags = $DatabaseFlags;
...
class DemoteContext {
  ...
  /// The name of the instance which acts as the on-premises primary instance in
...
class DenyMaintenancePeriod {
  ...
  /// be empty. In this case, it means the no maintenance interval recurs every
...
typedef DiskEncryptionConfiguration = $DiskEncryptionConfiguration;

/// Disk encryption status for an instance.
typedef DiskEncryptionStatus = $DiskEncryptionStatus;

/// DNS metadata.
typedef DnsNameMapping = $DnsNameMapping;
...
class ExportContextTdeExportOptions {
  ...
  ///
  /// The instance must have write access to the bucket. Applicable only for SQL
  /// Server instances.
  ///
  /// Required.
...
typedef ExternalSyncSelectedObject = $ExternalSyncSelectedObject;

/// Database instance failover context.
typedef FailoverContext = $FailoverContext;
...
/// Gemini instance configuration.
typedef GeminiInstanceConfig = $GeminiInstanceConfig;

/// Ephemeral certificate creation request.
typedef GenerateEphemeralCertRequest = $GenerateEphemeralCertRequest;
...
/// configuration.
typedef InsightsConfig = $InsightsConfig;

/// Reference to another Cloud SQL instance.
typedef InstanceReference = $InstanceReference01;
...
class InstancesDemoteRequest {
  /// Contains details about the demote operation.
  ///
  /// Required.
...
class InstancesRotateServerCertificateRequest {
  /// Contains details about the rotate server certificate operation.
  ///
  /// Optional.
...
typedef LocationPreference = $LocationPreference;

/// Maintenance window.
///
/// This specifies when a Cloud SQL instance is restarted for system maintenance
/// purposes.
typedef MaintenanceWindow = $MaintenanceWindow01;

/// Read-replica configuration specific to MySQL databases.
typedef MySqlReplicaConfiguration = $MySqlReplicaConfiguration;
...
class OnPremisesConfiguration {
  ...
  /// SSL option for replica connection to the on-premises source.
  ///
  /// Optional.
  /// Possible string values are:
...
typedef OperationError = $OperationError01;
...
typedef PasswordStatus = $PasswordStatus;

/// Database instance local user password validation policy
typedef PasswordValidationPolicy = $PasswordValidationPolicy;

/// Perform disk shrink context.
typedef PerformDiskShrinkContext = $PerformDiskShrinkContext;

/// The context to perform a point-in-time recovery of an instance managed by
/// Google Cloud Backup and Disaster Recovery.
typedef PointInTimeRestoreContext = $PointInTimeRestoreContext;
...
typedef PscAutoConnectionConfig = $PscAutoConnectionConfig01;
...
///
/// A DR replica is a cross-region replica that you designate for failover in
/// the event that the primary instance experiences regional failure. Applicable
/// to MySQL and PostgreSQL.
typedef ReplicationCluster = $ReplicationCluster;
typedef Reschedule = $Reschedule;

/// Database instance restore from backup context.
///
/// Backup context contains source instance id and project id.
typedef RestoreBackupContext = $RestoreBackupContext;

/// Instance rotate server CA context.
typedef RotateServerCaContext = $RotateServerCaContext;
...
/// A list of objects that the user selects for replication from an external
/// source instance.
typedef SelectedObjects = $SelectedObjects;
...
typedef SqlActiveDirectoryConfig = $SqlActiveDirectoryConfig;
...
typedef SqlInstancesAcquireSsrsLeaseResponse = $SsrsLeaseResponse;

/// Instance get disk shrink config response.
typedef SqlInstancesGetDiskShrinkConfigResponse =
    $SqlInstancesGetDiskShrinkConfigResponse;

/// Instance get latest recovery time response.
typedef SqlInstancesGetLatestRecoveryTimeResponse =
    $SqlInstancesGetLatestRecoveryTimeResponse;

/// Response for the release SSRS lease request.
typedef SqlInstancesReleaseSsrsLeaseResponse = $SsrsLeaseResponse;
...
typedef SqlOutOfDiskReport = $SqlOutOfDiskReport;

/// Any scheduled maintenance for this instance.
typedef SqlScheduledMaintenance = $SqlScheduledMaintenance;

/// SQL Server specific audit configuration.
typedef SqlServerAuditConfig = $SqlServerAuditConfig;

/// Represents a Sql Server database on the Cloud SQL instance.
typedef SqlServerDatabaseDetails = $SqlServerDatabaseDetails;

/// Represents a Sql Server user on the Cloud SQL instance.
typedef SqlServerUserDetails = $SqlServerUserDetails;

/// The sub operation type based on the operation type.
typedef SqlSubOperationType = $SqlSubOperationType;
...
typedef SslCertsCreateEphemeralRequest = $SslCertsCreateEphemeralRequest;

/// SslCerts insert request.
typedef SslCertsInsertRequest = $SslCertsInsertRequest;
...
typedef TruncateLogContext = $TruncateLogContext;
