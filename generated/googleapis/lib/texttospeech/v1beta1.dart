...
/// Cloud Text-to-Speech API - v1beta1
///
...
class ProjectsLocationsResource {
  ...
  async.Future<Operation> synthesizeLongAudio(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + ':synthesizeLongAudio';
...
class TextResource {
  ...
  async.Future<SynthesizeSpeechResponse> synthesize(
    ...
    const url_ = 'v1beta1/text:synthesize';
...
class SynthesizeSpeechRequest {
  ...
  core.List<core.String>? enableTimePointing;
    ...
    : this(
        ...
        audioConfig:
            json_.containsKey('audioConfig')
                ...
                : null,
        enableTimePointing:
            (json_['enableTimePointing'] as core.List?)
                ?.map((value) => value as core.String)
                .toList(),
        input:
            json_.containsKey('input')
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    if (advancedVoiceOptions != null)
      'advancedVoiceOptions': advancedVoiceOptions!,
    if (audioConfig != null) 'audioConfig': audioConfig!,
    if (enableTimePointing != null) 'enableTimePointing': enableTimePointing!,
    if (input != null) 'input': input!,
    if (voice != null) 'voice': voice!,
  };
}
...
class SynthesizeSpeechResponse {
  ...
  /// A link between a position in the original request input and a
  /// corresponding time in the output audio.
  ///
  /// It's only supported via `` of SSML input.
  core.List<Timepoint>? timepoints;
...
class Timepoint {
  ...
  Timepoint({this.markName, this.timeSeconds});

  Timepoint.fromJson(core.Map json_)
    : this(
        markName: json_['markName'] as core.String?,
        timeSeconds: (json_['timeSeconds'] as core.num?)?.toDouble(),
      );

  core.Map<core.String, core.dynamic> toJson() => {
    if (markName != null) 'markName': markName!,
