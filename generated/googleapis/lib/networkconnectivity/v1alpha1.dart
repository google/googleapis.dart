...
class AllocationOptions {
  /// Allocation strategy.
  ///
  /// Not setting this field when the allocation is requested means an
...
class InternalRange {
  ...
  /// resource, but one of the peers can. This represents donating a range for
  /// peers to use.
  ...
  /// for various use cases such as usage on-premises, with dynamic route
  ...
  /// range that is referred to. Can be empty.
  ///
  /// Output only.
...
class RouterApplianceInstance {
  ...
  RouterApplianceInstance.fromJson(core.Map json_)
    : this(
        ...
        networkInterface: json_['networkInterface'] as core.String?,
