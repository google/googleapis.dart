...
class ProjectsLocationsGlobalHubsResource {
  ...
  async.Future<GoogleLongrunningOperation> create(
    ...
    final _url = 'v1/' + core.Uri.encodeFull('$parent') + '/hubs';
...
class ProjectsLocationsSpokesResource {
  ...
  async.Future<GoogleLongrunningOperation> create(
    ...
    final _url = 'v1/' + core.Uri.encodeFull('$parent') + '/spokes';
  ...
  Hub.fromJson(core.Map _json)
      : this(
          ...
          labels: _json.containsKey('labels')
              ...
              : null,
          name: _json.containsKey('name') ? _json['name'] as core.String : null,
          routingVpcs: _json.containsKey('routingVpcs')
              ? (_json['routingVpcs'] as core.List)
...
class LinkedInterconnectAttachments {
  ...
  LinkedInterconnectAttachments.fromJson(core.Map _json)
      : this(
          siteToSiteDataTransfer: _json.containsKey('siteToSiteDataTransfer')
              ? _json['siteToSiteDataTransfer'] as core.bool
              : null,
...
class LinkedRouterApplianceInstances {
  ...
  LinkedRouterApplianceInstances.fromJson(core.Map _json)
      : this(
...
class LinkedVpnTunnels {
  ...
  LinkedVpnTunnels.fromJson(core.Map _json)
      : this(
          siteToSiteDataTransfer: _json.containsKey('siteToSiteDataTransfer')
              ? _json['siteToSiteDataTransfer'] as core.bool
              : null,
...
class Spoke {
  ...
  /// The URI of the hub that this spoke is attached to.
  ///
  /// Immutable.
  core.String? hub;
