...
///       - [ProjectsLocationsInstancesSharesResource]
...
class ProjectsLocationsInstancesResource {
  ...
  ProjectsLocationsInstancesSharesResource get shares =>
      ProjectsLocationsInstancesSharesResource(_requester);
  ...
  ///
  /// [force] - If set to true, any snapshots of the instance will also be
  ...
  async.Future<Operation> promoteReplica(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':promoteReplica';
  ...
  async.Future<Operation> revert(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':revert';
...
class ProjectsLocationsInstancesSharesResource {
  final commons.ApiRequester _requester;

  ProjectsLocationsInstancesSharesResource(commons.ApiRequester client)
    : _requester = client;
  ...
  /// Request parameters:
  ///
  /// [parent] - Required. The Filestore Instance to create the share for, in
  /// the format
  /// `projects/{project_id}/locations/{location}/instances/{instance_id}`
  /// Value must have pattern
  /// `^projects/\[^/\]+/locations/\[^/\]+/instances/\[^/\]+$`.
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/shares';
  ...
  /// Request parameters:
  ///
  /// [name] - Required. The share resource name, in the format
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<Share> get(core.String name, {core.String? $fields}) async {
    final queryParams_ = <core.String, core.List<core.String>>{
      if ($fields != null) 'fields': [$fields],
    };
    ...
    return Share.fromJson(response_ as core.Map<core.String, core.dynamic>);
  }
  ...
  /// Request parameters:
  ///
  /// [parent] - Required. The instance for which to retrieve share information,
  /// in the format
  /// `projects/{project_id}/locations/{location}/instances/{instance_id}`.
  /// Value must have pattern
  /// `^projects/\[^/\]+/locations/\[^/\]+/instances/\[^/\]+$`.
  ...
  /// response.
  ///
  /// Completes with a [ListSharesResponse].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<ListSharesResponse> list(
    core.String parent, {
    core.String? filter,
    core.String? orderBy,
    core.int? pageSize,
    ...
    return ListSharesResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
...
class ProjectsLocationsInstancesSnapshotsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/snapshots';
...
class DirectoryServicesConfig {
  ...
  DirectoryServicesConfig({this.ldap, this.managedActiveDirectory});
  ...
  DirectoryServicesConfig.fromJson(core.Map json_)
    : this(
        ...
        managedActiveDirectory:
            json_.containsKey('managedActiveDirectory')
                ? ManagedActiveDirectoryConfig.fromJson(
                  json_['managedActiveDirectory']
...
class Instance {
  ...
  core.String? maxShareCount;

  /// Indicates whether this instance uses a multi-share configuration with
  /// which it can have more than one file-share or none at all.
  ///
  /// File-shares are added, updated and removed through the separate file-share
  /// APIs.
  ...
  Instance.fromJson(core.Map json_)
    : this(
        ...
        maxShareCount: json_['maxShareCount'] as core.String?,
        multiShareEnabled: json_['multiShareEnabled'] as core.bool?,
        name: json_['name'] as core.String?,
        networks:
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (maxShareCount != null) 'maxShareCount': maxShareCount!,
    if (multiShareEnabled != null) 'multiShareEnabled': multiShareEnabled!,
    if (name != null) 'name': name!,
...
class ListSharesResponse {
  ...
  ListSharesResponse({this.nextPageToken, this.shares, this.unreachable});

  ListSharesResponse.fromJson(core.Map json_)
    : this(
        nextPageToken: json_['nextPageToken'] as core.String?,
        shares:
            (json_['shares'] as core.List?)
                ?.map(
                  (value) => Share.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
class ManagedActiveDirectoryConfig {
  /// The computer name is used as a prefix in the command to mount the remote
  /// target.
  ///
  /// For example: if the computer is `my-computer`, the mount command will look
  /// like: `$mount -o vers=4.1,sec=krb5 my-computer.filestore.: `.
  ///
  /// Required.
  ...
  ManagedActiveDirectoryConfig.fromJson(core.Map json_)
    : this(
        computer: json_['computer'] as core.String?,
        domain: json_['domain'] as core.String?,
      );
...
class NfsExportOptions {
  ...
  core.List<core.String>? securityFlavors;
  ...
  NfsExportOptions.fromJson(core.Map json_)
    : this(
        ...
        network: json_['network'] as core.String?,
        securityFlavors:
            (json_['securityFlavors'] as core.List?)
                ?.map((value) => value as core.String)
                .toList(),
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (network != null) 'network': network!,
    if (securityFlavors != null) 'securityFlavors': securityFlavors!,
...
/// A Filestore share.
class Share {
  /// Full name of the Cloud Filestore Backup resource that this Share is
  /// restored from, in the format of
  /// projects/{project_id}/locations/{location_id}/backups/{backup_id}.
  ///
  ...
  /// File share capacity in gigabytes (GB).
  ///
  /// Filestore defines 1 GB as 1024^3 bytes. Must be greater than 0.
  core.String? capacityGb;
  ...
  ///
  /// Must be 63 characters or less and consist of uppercase or lowercase
  ...
  Share.fromJson(core.Map json_)
    : this(
        ...
        mountName: json_['mountName'] as core.String?,
        name: json_['name'] as core.String?,
        nfsExportOptions:
            (json_['nfsExportOptions'] as core.List?)
                ?.map(
