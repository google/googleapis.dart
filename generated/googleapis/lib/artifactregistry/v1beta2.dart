...
class ProjectsLocationsRepositoriesResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta2/' + core.Uri.encodeFull('$parent') + '/repositories';
...
class ProjectsLocationsRepositoriesAptArtifactsResource {
  ...
  async.Future<Operation> import(
    ...
    final url_ =
        'v1beta2/' + core.Uri.encodeFull('$parent') + '/aptArtifacts:import';
  ...
  async.Future<UploadAptArtifactMediaResponse> upload(
    ...
    if (uploadMedia == null) {
      url_ =
          'v1beta2/' + core.Uri.encodeFull('$parent') + '/aptArtifacts:create';
    } else {
      url_ =
          '/upload/v1beta2/' +
...
class ProjectsLocationsRepositoriesFilesResource {
  ...
  /// response.
  ///
  /// Completes with a [GoogleDevtoolsArtifactregistryV1beta2File].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<GoogleDevtoolsArtifactregistryV1beta2File> get(
    core.String name, {
    core.String? $fields,
  }) async {
    final queryParams_ = <core.String, core.List<core.String>>{
    ...
    return GoogleDevtoolsArtifactregistryV1beta2File.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
  ...
  async.Future<ListFilesResponse> list(
    ...
    final url_ = 'v1beta2/' + core.Uri.encodeFull('$parent') + '/files';
...
class ProjectsLocationsRepositoriesPackagesResource {
  ...
  async.Future<ListPackagesResponse> list(
    ...
    final url_ = 'v1beta2/' + core.Uri.encodeFull('$parent') + '/packages';
...
class ProjectsLocationsRepositoriesPackagesTagsResource {
  ...
  async.Future<Tag> create(
    ...
    final url_ = 'v1beta2/' + core.Uri.encodeFull('$parent') + '/tags';
...
class ProjectsLocationsRepositoriesYumArtifactsResource {
  ...
  async.Future<Operation> import(
    ...
    final url_ =
        'v1beta2/' + core.Uri.encodeFull('$parent') + '/yumArtifacts:import';
  ...
  async.Future<UploadYumArtifactMediaResponse> upload(
    ...
    if (uploadMedia == null) {
      url_ =
          'v1beta2/' + core.Uri.encodeFull('$parent') + '/yumArtifacts:create';
    } else {
      url_ =
          '/upload/v1beta2/' +
          core.Uri.encodeFull('$parent') +
...
class GoogleDevtoolsArtifactregistryV1beta2File {
  ...
  GoogleDevtoolsArtifactregistryV1beta2File.fromJson(core.Map json_)
    : this(
...
class ListFilesResponse {
  /// The files returned.
  core.List<GoogleDevtoolsArtifactregistryV1beta2File>? files;
    ...
    : this(
        files:
            (json_['files'] as core.List?)
                ?.map(
                  (value) => GoogleDevtoolsArtifactregistryV1beta2File.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
