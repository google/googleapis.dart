...
class FoldersResource {
  ...
  FoldersOperationsResource get operations =>
      FoldersOperationsResource(_requester);
  ...
  /// location.
  ///
  /// The output format is newline-delimited JSON. This API implements the
  /// google.longrunning.Operation API allowing you to keep track of the export.
  /// We recommend intervals of at least 2 seconds with exponential retry to
  /// poll the export operation result. For regular-size resource parent, the
  ...
  /// as "projects/my-project-id"), a project number (such as "projects/12345"),
  ...
  async.Future<Operation> exportAssets(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + ':exportAssets';
...
class FoldersOperationsResource {
  final commons.ApiRequester _requester;

  FoldersOperationsResource(commons.ApiRequester client) : _requester = client;
  ...
  /// Value must have pattern `^folders/\[^/\]+/operations/\[^/\]+/.*$`.
  ///
  /// [$fields] - Selector specifying which fields to include in a partial
  /// response.
  ///
...
class OrganizationsResource {
  ...
  async.Future<BatchGetAssetsHistoryResponse> batchGetAssetsHistory(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + ':batchGetAssetsHistory';
...
class ExportAssetsRequest {
  ...
  ///
  /// For example: "google.compute.Disk". If specified, only matching assets
  /// will be returned. See
  /// [Introduction to Cloud Asset Inventory](https://cloud.google.com/resource-manager/docs/cloud-asset-inventory/overview)
  ...
  ///
  /// All results will be in newline delimited JSON format.
  ///
  /// Required.
  ...
  ///
  /// This can only be set to a timestamp between 2018-10-02 UTC (inclusive) and
  /// the current time. If not specified, the current time will be used. Due to
...
class GcsDestination {
  ...
  ///
  /// For example: "gs://bucket_name/object_name_prefix". Each object URI is in
...
class TemporalAsset {
  ...
  TemporalAsset({this.asset, this.deleted, this.window});
