...
/// Managed Service for Microsoft Active Directory API - v1beta1
///
...
class ProjectsLocationsGlobalDomainsResource {
  ...
  async.Future<Operation> attachTrust(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':attachTrust';
  ...
  async.Future<Operation> detachTrust(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':detachTrust';
  ...
  async.Future<Operation> disableMigration(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$domain') + ':disableMigration';
  ...
  async.Future<DomainJoinMachineResponse> domainJoinMachine(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$domain') + ':domainJoinMachine';
  ...
  async.Future<Operation> enableMigration(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$domain') + ':enableMigration';
  ...
  async.Future<Operation> extendSchema(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$domain') + ':extendSchema';
  ...
  async.Future<LDAPSSettings> getLdapssettings(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + '/ldapssettings';
  ...
  async.Future<Operation> reconfigureTrust(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$name') + ':reconfigureTrust';
  ...
  async.Future<ResetAdminPasswordResponse> resetAdminPassword(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$name') + ':resetAdminPassword';
  ...
  async.Future<Operation> validateTrust(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':validateTrust';
...
class ProjectsLocationsGlobalDomainsSqlIntegrationsResource {
  ...
  async.Future<ListSqlIntegrationsResponse> list(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/sqlIntegrations';
...
class ProjectsLocationsGlobalPeeringsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/peerings';
...
class DomainJoinMachineRequest {
  ...
  /// OU name to which the VM needs to be domain joined.
  ///
  /// If the field is not provided, the VM is joined to the default OU which is
  /// created. The default OU for the domain join api is created as GCE
  /// Instances under the Cloud OU. Example - OU=GCE
  /// Instances,OU=Cloud,DC=ad,DC=test,DC=com If the field is provided, then the
  /// custom OU is searched for under GCE Instances OU. Example - if
...
class DomainJoinMachineResponse {
  /// The response is the offline domain join blob that is returned after
  /// running the djoin command.
  ///
  /// To correctly use the response of the API, please refer to the sample
  /// usage.
...
class Trust {
  ...
  /// Input only.
  ///
  /// The trust secret used for the handshake with the target domain. It will
  /// not be stored.
  ...
  Trust.fromJson(core.Map json_)
    : this(
        createTime: json_['createTime'] as core.String?,
        lastTrustHeartbeatTime: json_['lastTrustHeartbeatTime'] as core.String?,
