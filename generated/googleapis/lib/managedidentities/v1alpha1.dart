...
/// Managed Service for Microsoft Active Directory API - v1alpha1
///
...
class ProjectsLocationsGlobalDomainsResource {
  ...
  async.Future<Operation> attachTrust(
    ...
    final url_ = 'v1alpha1/' + core.Uri.encodeFull('$name') + ':attachTrust';
  ...
  /// number or a letter. * Must not start with period. * Must be unique within
  /// the project. * First segment length (mydomain form example above)
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1alpha1/' + core.Uri.encodeFull('$parent') + '/domains';
  ...
  async.Future<Operation> detachTrust(
    ...
    final url_ = 'v1alpha1/' + core.Uri.encodeFull('$name') + ':detachTrust';
  ...
  async.Future<Operation> disableMigration(
    ...
    final url_ =
        'v1alpha1/' + core.Uri.encodeFull('$domain') + ':disableMigration';
  ...
  async.Future<DomainJoinMachineResponse> domainJoinMachine(
    ...
    final url_ =
        'v1alpha1/' + core.Uri.encodeFull('$domain') + ':domainJoinMachine';
  ...
  async.Future<Operation> enableMigration(
    ...
    final url_ =
        'v1alpha1/' + core.Uri.encodeFull('$domain') + ':enableMigration';
  ...
  async.Future<Operation> extendSchema(
    ...
    final url_ = 'v1alpha1/' + core.Uri.encodeFull('$domain') + ':extendSchema';
  ...
  async.Future<LDAPSSettings> getLdapssettings(
    ...
    final url_ = 'v1alpha1/' + core.Uri.encodeFull('$name') + '/ldapssettings';
  ...
  /// include these fields from Domain: * `labels` * `locations` *
  ...
  async.Future<Operation> reconfigureTrust(
    ...
    final url_ =
        'v1alpha1/' + core.Uri.encodeFull('$name') + ':reconfigureTrust';
  ...
  async.Future<ResetAdminPasswordResponse> resetAdminPassword(
    ...
    final url_ =
        'v1alpha1/' + core.Uri.encodeFull('$name') + ':resetAdminPassword';
  ...
  async.Future<Operation> restore(
    ...
    final url_ = 'v1alpha1/' + core.Uri.encodeFull('$name') + ':restore';
  ...
  async.Future<Operation> validateTrust(
    ...
    final url_ = 'v1alpha1/' + core.Uri.encodeFull('$name') + ':validateTrust';
...
class ProjectsLocationsGlobalDomainsBackupsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1alpha1/' + core.Uri.encodeFull('$parent') + '/backups';
...
class ProjectsLocationsGlobalDomainsSqlIntegrationsResource {
  ...
  async.Future<ListSQLIntegrationsResponse> list(
    ...
    final url_ =
        'v1alpha1/' + core.Uri.encodeFull('$parent') + '/sqlIntegrations';
...
class ProjectsLocationsGlobalPeeringsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1alpha1/' + core.Uri.encodeFull('$parent') + '/peerings';
  ...
  ///
  /// [filter] - Optional. Filter specifying constraints of a list operation.
  /// For example, `peering.authoized_network ="/projects/myprojectid"`.
  ///
  /// [orderBy] - Optional. Specifies the ordering of results following syntax
  /// at https://cloud.google.com/apis/design/design_patterns#sorting_order.
  ///
...
/// which indicates that the resource is being reconciled.
///
/// At this point, Get will reflect an intermediate state.
class Domain {
  ...
  ///
  /// Network can be added using UpdateDomain later. Domain is only available on
  /// network part of authorized_networks. Caller needs to make sure that CIDR
  /// subnets do not overlap between networks, else domain creation will fail.
  ///
  /// Optional.
  ...
  /// Fully-qualified domain name of the exposed domain used by clients to
  /// connect to the service.
  ///
  /// Similar to what would be chosen for an Active Directory that is set up on
  /// an internal network.
  ///
  /// Output only.
  core.String? fqdn;
  ...
  /// operations.
  ///
  /// If not specified `setupadmin` would be used.
  ///
  /// Optional.
  core.String? managedIdentitiesAdminName;

  /// Unique name of the domain in this scope including projects and location
  /// using the form:
  /// `projects/{project_id}/locations/global/domains/{domain_name}`.
  ///
  /// Output only.
  ...
  Domain.fromJson(core.Map json_)
    : this(
        ...
        managedIdentitiesAdminName:
            json_['managedIdentitiesAdminName'] as core.String?,
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (managedIdentitiesAdminName != null)
...
class EnableMigrationRequest {
  /// Period after which the migration would be auto disabled.
  ///
  /// If unspecified, a default timeout of 48h is used.
  ///
  /// Optional.
  core.String? enableDuration;
  ...
  EnableMigrationRequest({this.enableDuration, this.migratingDomains});

  EnableMigrationRequest.fromJson(core.Map json_)
    : this(
        enableDuration: json_['enableDuration'] as core.String?,
        migratingDomains:
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    if (enableDuration != null) 'enableDuration': enableDuration!,
...
class ReconfigureTrustRequest {
  ...
  ReconfigureTrustRequest({this.trust});
...
class SQLIntegration {
  ...
  /// The current state of the managed OU.
  ///
  /// Output only.
  /// Possible string values are:
  /// - "STATE_UNSPECIFIED" : Not Set
  ...
  /// Last update time for this SQL instance.
  ///
  /// Output only.
  core.String? updateTime;
  ...
  SQLIntegration.fromJson(core.Map json_)
    : this(
        createTime: json_['createTime'] as core.String?,
        name: json_['name'] as core.String?,
        sqlInstance: json_['sqlInstance'] as core.String?,
        state: json_['state'] as core.String?,
        updateTime: json_['updateTime'] as core.String?,
      );
...
/// users in one domain to be authenticated by a dc in another domain.
///
/// Refer
...
class Trust {
  ...
  ///
  /// Output only.
  core.String? lastKnownTrustConnectedHeartbeatTime;
  ...
  /// Additional information about the current state of this trust, if
  /// available.
  ///
  /// Output only.
  ...
  ///
  /// The trust secret used for handshake with target domain.
  ...
  Trust({
    this.createTime,
    this.lastKnownTrustConnectedHeartbeatTime,
  ...
  Trust.fromJson(core.Map json_)
    : this(
        ...
        lastKnownTrustConnectedHeartbeatTime:
            json_['lastKnownTrustConnectedHeartbeatTime'] as core.String?,
        ...
        trustType: json_['trustType'] as core.String?,
        updateTime: json_['updateTime'] as core.String?,
      );

  core.Map<core.String, core.dynamic> toJson() => {
    if (createTime != null) 'createTime': createTime!,
    if (lastKnownTrustConnectedHeartbeatTime != null)
      'lastKnownTrustConnectedHeartbeatTime':
          lastKnownTrustConnectedHeartbeatTime!,
