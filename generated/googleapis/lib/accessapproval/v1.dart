...
class EnrolledService {
  ...
  /// * Artifact Registry * BigQuery * Cloud Bigtable * Cloud Key Management
  /// Service * Compute Engine * Cloud Composer * Cloud Dataflow * Cloud
  /// Dataproc * Cloud DLP * Cloud EKM * Cloud HSM * Cloud Identity and Access
  /// Management * Cloud Logging * Cloud NAT * Cloud Pub/Sub * Cloud Spanner *
