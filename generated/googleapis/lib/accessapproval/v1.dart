...
class EnrolledService {
  ...
  /// * Cloud Dataflow * Cloud Dataproc * Cloud DLP * Cloud EKM * Cloud HSM *
  /// Cloud Identity and Access Management * Cloud Logging * Cloud NAT * Cloud
  /// Pub/Sub * Cloud Spanner * Cloud SQL * Cloud Storage * Google Kubernetes
