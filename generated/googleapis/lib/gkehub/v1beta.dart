...
class OrganizationsLocationsFleetsResource {
  ...
  async.Future<ListFleetsResponse> list(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$parent') + '/fleets';
...
class ProjectsLocationsFeaturesResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$parent') + '/features';
...
class ProjectsLocationsMembershipsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$parent') + '/memberships';
  ...
  async.Future<GenerateConnectManifestResponse> generateConnectManifest(
    ...
    final url_ =
        'v1beta/' + core.Uri.encodeFull('$name') + ':generateConnectManifest';
...
class ProjectsLocationsMembershipsBindingsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$parent') + '/bindings';
...
class ProjectsLocationsMembershipsRbacrolebindingsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ =
        'v1beta/' + core.Uri.encodeFull('$parent') + '/rbacrolebindings';
...
class ProjectsLocationsScopesResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$parent') + '/scopes';
  ...
  async.Future<ListBoundMembershipsResponse> listMemberships(
    ...
    final url_ =
        'v1beta/' + core.Uri.encodeFull('$scopeName') + ':listMemberships';
  ...
  async.Future<ListPermittedScopesResponse> listPermitted(
    ...
    final url_ =
        'v1beta/' + core.Uri.encodeFull('$parent') + '/scopes:listPermitted';
...
class ProjectsLocationsScopesNamespacesResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta/' + core.Uri.encodeFull('$parent') + '/namespaces';
...
class AppDevExperienceFeatureState {
  ...
  AppDevExperienceFeatureState({this.networkingInstallSucceeded});
...
class ClusterUpgradeGKEUpgradeFeatureState {
  ...
  ClusterUpgradeGKEUpgradeFeatureState({this.conditions, this.upgradeState});
...
class ClusterUpgradeGKEUpgradeOverride {
  ...
  ClusterUpgradeGKEUpgradeOverride({this.postConditions, this.upgrade});
...
class ClusterUpgradeGKEUpgradeState {
  ...
  ClusterUpgradeGKEUpgradeState({this.stats, this.status, this.upgrade});
...
class ClusterUpgradeMembershipState {
  ...
  ClusterUpgradeMembershipState({this.ignored, this.upgrades});
...
class Feature {
  ...
  Feature.fromJson(core.Map json_)
    : this(
        ...
        scopeStates:
            (json_['scopeStates'] as core.Map<core.String, core.dynamic>?)?.map(
              (key, value) => core.MapEntry(
                key,
...
class FleetObservabilityFeatureSpec {
  ...
  FleetObservabilityFeatureSpec({this.loggingConfig});
...
class FleetObservabilityFeatureState {
  ...
  FleetObservabilityFeatureState({this.logging, this.monitoring});
...
class FleetObservabilityFleetObservabilityMonitoringState {
  ...
  FleetObservabilityFleetObservabilityMonitoringState({this.state});
...
class ListFleetsResponse {
  ...
  ListFleetsResponse({this.fleets, this.nextPageToken});
...
class ListScopeNamespacesResponse {
  ...
  ListScopeNamespacesResponse({this.nextPageToken, this.scopeNamespaces});
...
class ListScopesResponse {
  ...
  ListScopesResponse({this.nextPageToken, this.scopes});
...
class MembershipFeatureState {
  ...
  MeteringMembershipState? metering;
    ...
    : this(
        ...
        metering:
            json_.containsKey('metering')
                ? MeteringMembershipState.fromJson(
...
typedef MembershipSpec = $Spec01;

/// MembershipState describes the state of a Membership resource.
typedef MembershipState = $MembershipState;

/// **Metering**: Per-Membership Feature State.
typedef MeteringMembershipState = $State00;
...
/// feature.
typedef MultiClusterIngressFeatureSpec = $MultiClusterIngressFeatureSpec;
