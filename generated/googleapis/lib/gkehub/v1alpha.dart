...
class OrganizationsLocationsFleetsResource {
  ...
  async.Future<ListFleetsResponse> list(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$parent') + '/fleets';
...
class ProjectsLocationsFeaturesResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$parent') + '/features';
...
class ProjectsLocationsMembershipsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$parent') + '/memberships';
  ...
  async.Future<GenerateConnectManifestResponse> generateConnectManifest(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$name') + ':generateConnectManifest';
  ...
  ///
  /// [parent] - Required. The parent (project and location) where the
  /// Memberships of admin cluster will be listed. Specified in the format
  /// `projects / * /locations / * `.
  /// Value must have pattern `^projects/\[^/\]+/locations/\[^/\]+$`.
  ///
  ...
  /// response.
  ///
  /// Completes with a [ListAdminClusterMembershipsResponse].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<ListAdminClusterMembershipsResponse> listAdmin(
    core.String parent, {
    core.String? filter,
    core.String? orderBy,
    core.int? pageSize,
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$parent') + '/memberships:listAdmin';
    ...
    return ListAdminClusterMembershipsResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
  ...
  ///
  /// It checks the following: 1. Caller has the required
  ...
  /// response.
  ///
  /// Completes with a [ValidateCreateMembershipResponse].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<ValidateCreateMembershipResponse> validateCreate(
    ValidateCreateMembershipRequest request,
    core.String parent, {
    core.String? $fields,
  }) async {
    final body_ = convert.json.encode(request);
    ...
    return ValidateCreateMembershipResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
...
class ProjectsLocationsMembershipsBindingsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$parent') + '/bindings';
...
class ProjectsLocationsMembershipsRbacrolebindingsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$parent') + '/rbacrolebindings';
...
class ProjectsLocationsScopesResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$parent') + '/scopes';
  ...
  async.Future<ListBoundMembershipsResponse> listMemberships(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$scopeName') + ':listMemberships';
  ...
  async.Future<ListPermittedScopesResponse> listPermitted(
    ...
    final url_ =
        'v1alpha/' + core.Uri.encodeFull('$parent') + '/scopes:listPermitted';
...
class ProjectsLocationsScopesNamespacesResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1alpha/' + core.Uri.encodeFull('$parent') + '/namespaces';
...
class CloudAuditLoggingFeatureSpec {
  ...
  ///
  /// These accounts must already exist, but do not need to have any permissions
  /// granted to them. The customer's entitlements will be checked prior to
  /// allowlisting (i.e. the customer must be an Anthos customer.)
  core.List<core.String>? allowlistedServiceAccounts;

  CloudAuditLoggingFeatureSpec({this.allowlistedServiceAccounts});

  CloudAuditLoggingFeatureSpec.fromJson(core.Map json_)
    : this(
        allowlistedServiceAccounts:
            (json_['allowlistedServiceAccounts'] as core.List?)
                ?.map((value) => value as core.String)
                .toList(),
      );
...
typedef CloudBuildMembershipSpec = $Spec01;
...
class ClusterUpgradeMembershipState {
  ...
  ClusterUpgradeMembershipState({this.ignored, this.scopes, this.upgrades});
...
class ClusterUpgradeScopeSpec {
  ...
  /// This scope consumes upgrades that have COMPLETE status code in the
  /// upstream scopes.
  ///
  /// See UpgradeStatus.Code for code definitions. The scope name should be in
  /// the form: `projects/{p}/locations/global/scopes/{s}` Where {p} is the
  /// project, {s} is a valid Scope in this project. {p} WILL match the
  /// Feature's project. This is defined as repeated for future proof reasons.
  /// Initial implementation will enforce at most one upstream scope.
  core.List<core.String>? upstreamScopes;
  ...
  ClusterUpgradeScopeSpec.fromJson(core.Map json_)
    : this(
        gkeUpgradeOverrides:
            (json_['gkeUpgradeOverrides'] as core.List?)
                ?.map(
        ...
        postConditions:
            json_.containsKey('postConditions')
                ...
                : null,
        upstreamScopes:
            (json_['upstreamScopes'] as core.List?)
                ?.map((value) => value as core.String)
                .toList(),
      );
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    if (gkeUpgradeOverrides != null)
      'gkeUpgradeOverrides': gkeUpgradeOverrides!,
    if (postConditions != null) 'postConditions': postConditions!,
    if (upstreamScopes != null) 'upstreamScopes': upstreamScopes!,
  };
}
...
class ClusterUpgradeScopeState {
  ...
  ///
  /// The scope name should be in the form:
  /// `projects/{p}/locations/gloobal/scopes/{s}` Where {p} is the project, {s}
  /// is a valid Scope in this project. {p} WILL match the Feature's project.
  core.List<core.String>? downstreamScopes;
  ...
  ClusterUpgradeScopeState.fromJson(core.Map json_)
    : this(
        downstreamScopes:
            (json_['downstreamScopes'] as core.List?)
                ?.map((value) => value as core.String)
                .toList(),
        gkeState:
            json_.containsKey('gkeState')
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    if (downstreamScopes != null) 'downstreamScopes': downstreamScopes!,
    if (gkeState != null) 'gkeState': gkeState!,
    if (ignored != null) 'ignored': ignored!,
  };
}
...
class CommonFeatureSpec {
  ...
  CloudAuditLoggingFeatureSpec? cloudauditlogging;
  ...
  NamespaceActuationFeatureSpec? namespaceactuation;
  ...
  FeatureSpec? workloadcertificate;
    ...
    : this(
        appdevexperience:
            json_.containsKey('appdevexperience')
                ...
                : null,
        cloudauditlogging:
            json_.containsKey('cloudauditlogging')
                ? CloudAuditLoggingFeatureSpec.fromJson(
                  json_['cloudauditlogging']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
        clusterupgrade:
        ...
        multiclusteringress:
            json_.containsKey('multiclusteringress')
                ...
                : null,
        namespaceactuation:
            json_.containsKey('namespaceactuation')
                ? NamespaceActuationFeatureSpec.fromJson(
                  json_['namespaceactuation']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (cloudauditlogging != null) 'cloudauditlogging': cloudauditlogging!,
    ...
    if (namespaceactuation != null) 'namespaceactuation': namespaceactuation!,
...
class CommonFeatureState {
  ...
  NamespaceActuationFeatureState? namespaceactuation;
  ...
  CommonFeatureState.fromJson(core.Map json_)
    : this(
        ...
        namespaceactuation:
            json_.containsKey('namespaceactuation')
                ? NamespaceActuationFeatureState.fromJson(
                  json_['namespaceactuation']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
...
/// feature.
class FeatureSpec {
  /// Specifies default membership spec.
  ///
  /// Users can override the default in the member_configs for each member.
  MembershipSpec? defaultConfig;

  /// Specifies CA configuration.
  ///
  /// Immutable.
  /// Possible string values are:
  /// - "GOOGLE_CA_PROVISIONING_UNSPECIFIED" : Disable default Google managed
  /// CA.
  ...
  /// the entire certificate provisioning process is using the default CA which
  /// is free.
  core.String? provisionGoogleCa;
    ...
    : this(
        defaultConfig:
            json_.containsKey('defaultConfig')
                ...
                : null,
        provisionGoogleCa: json_['provisionGoogleCa'] as core.String?,
      );

  core.Map<core.String, core.dynamic> toJson() => {
    if (defaultConfig != null) 'defaultConfig': defaultConfig!,
    if (provisionGoogleCa != null) 'provisionGoogleCa': provisionGoogleCa!,
  };
}
...
class ListAdminClusterMembershipsResponse {
  ...
  core.List<Membership>? adminClusterMemberships;

  /// A token to request the next page of resources from the
  /// `ListAdminClusterMemberships` method.
  ///
  ...
  ListAdminClusterMembershipsResponse({
    this.adminClusterMemberships,
    this.nextPageToken,
    this.unreachable,
  });

  ListAdminClusterMembershipsResponse.fromJson(core.Map json_)
    : this(
        adminClusterMemberships:
            (json_['adminClusterMemberships'] as core.List?)
                ?.map(
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    if (adminClusterMemberships != null)
      'adminClusterMemberships': adminClusterMemberships!,
...
class MembershipFeatureSpec {
  ...
  CloudBuildMembershipSpec? cloudbuild;
  ...
  NamespaceActuationMembershipSpec? namespaceactuation;
  ...
  /// Workload Certificate spec.
  MembershipSpec? workloadcertificate;
    ...
    : this(
        cloudbuild:
            json_.containsKey('cloudbuild')
                ? CloudBuildMembershipSpec.fromJson(
        ...
        namespaceactuation:
            json_.containsKey('namespaceactuation')
                ? NamespaceActuationMembershipSpec.fromJson(
                  json_['namespaceactuation']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
...
class MembershipFeatureState {
  ...
  NamespaceActuationMembershipState? namespaceactuation;
  ...
  MembershipFeatureState.fromJson(core.Map json_)
    : this(
        ...
        namespaceactuation:
            json_.containsKey('namespaceactuation')
                ? NamespaceActuationMembershipState.fromJson(
                  json_['namespaceactuation']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
...
class MembershipSpec {
  ...
  MembershipSpec.fromJson(core.Map json_)
    : this(
...
class NamespaceActuationFeatureSpec {
  ...
  /// cluster namespaces for each fleet namespace and it deletes only the ones
  /// it created, which are identified by a label.
  ...
  core.String? actuationMode;

  NamespaceActuationFeatureSpec({this.actuationMode});

  NamespaceActuationFeatureSpec.fromJson(core.Map json_)
    : this(actuationMode: json_['actuationMode'] as core.String?);

  core.Map<core.String, core.dynamic> toJson() => {
    if (actuationMode != null) 'actuationMode': actuationMode!,
  };
}

/// NamespaceActuation Feature State.
typedef NamespaceActuationFeatureState = $Empty;

/// **Namespace Actuation**: The membership-specific input for
/// NamespaceActuation feature.
typedef NamespaceActuationMembershipSpec = $Empty;

/// **Namespace Actuation**: An empty state left as an example
/// membership-specific Feature state.
typedef NamespaceActuationMembershipState = $Empty;
...
class ScopeFeatureSpec {
  ...
  ClusterUpgradeScopeSpec? clusterupgrade;

  ScopeFeatureSpec({this.clusterupgrade});

  ScopeFeatureSpec.fromJson(core.Map json_)
    : this(
        clusterupgrade:
            json_.containsKey('clusterupgrade')
                ? ClusterUpgradeScopeSpec.fromJson(
                  json_['clusterupgrade']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
...
class ScopeFeatureState {
  ...
  ClusterUpgradeScopeState? clusterupgrade;
  ...
  ScopeFeatureState({this.clusterupgrade, this.state});

  ScopeFeatureState.fromJson(core.Map json_)
    : this(
        clusterupgrade:
            json_.containsKey('clusterupgrade')
                ? ClusterUpgradeScopeState.fromJson(
                  json_['clusterupgrade']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
...
class ServiceMeshFeatureState {
  ...
  ServiceMeshFeatureState({this.analysisMessages, this.conditions});
...
typedef ServiceMeshMembershipSpec = $Spec03;
...
class ValidateCreateMembershipRequest {
  /// Membership resource to be created.
  ///
  /// Required.
  Membership? membership;

  /// Client chosen membership id.
  ///
  /// Required.
  core.String? membershipId;

  ValidateCreateMembershipRequest({this.membership, this.membershipId});

  ValidateCreateMembershipRequest.fromJson(core.Map json_)
    : this(
        membership:
            json_.containsKey('membership')
                ...
                : null,
        membershipId: json_['membershipId'] as core.String?,
      );
...
class ValidateCreateMembershipResponse {
  ...
  core.List<ValidationResult>? validationResults;

  ValidateCreateMembershipResponse({this.validationResults});

  ValidateCreateMembershipResponse.fromJson(core.Map json_)
    : this(
        validationResults:
            (json_['validationResults'] as core.List?)
                ?.map(
                  (value) => ValidationResult.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
class ValidationResult {
  ...
  /// - "MEMBERSHIP_ID" : MEMBERSHIP_ID validator validates that the
  /// membership_id is still available.
  /// - "CROSS_PROJECT_PERMISSION" : CROSS_PROJECT_PERMISSION validator
  /// validates that the cross-project role binding for the service agent is in
  /// place.
  ...
  ValidationResult({this.result, this.success, this.validator});

  ValidationResult.fromJson(core.Map json_)
    : this(
        result: json_['result'] as core.String?,
        success: json_['success'] as core.bool?,
        validator: json_['validator'] as core.String?,
      );
...
class WorkloadIdentityMembershipState {
  ...
  WorkloadIdentityMembershipState({this.description});
