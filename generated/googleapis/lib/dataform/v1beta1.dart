...
class ProjectsLocationsRepositoriesResource {
  ...
  async.Future<CommitRepositoryChangesResponse> commit(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':commit';
  ...
  computeAccessTokenStatus(core.String name, {core.String? $fields}) async {
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$name') + ':computeAccessTokenStatus';
  ...
  async.Future<FetchRepositoryHistoryResponse> fetchHistory(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':fetchHistory';
  ...
  async.Future<FetchRemoteBranchesResponse> fetchRemoteBranches(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$name') + ':fetchRemoteBranches';
  ...
  async.Future<QueryRepositoryDirectoryContentsResponse> queryDirectoryContents(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$name') + ':queryDirectoryContents';
  ...
  async.Future<ReadRepositoryFileResponse> readFile(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':readFile';
...
class ProjectsLocationsRepositoriesCompilationResultsResource {
  ...
  async.Future<CompilationResult> create(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/compilationResults';
...
class ProjectsLocationsRepositoriesReleaseConfigsResource {
  ...
  async.Future<ReleaseConfig> create(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/releaseConfigs';
...
class ProjectsLocationsRepositoriesWorkflowConfigsResource {
  ...
  async.Future<WorkflowConfig> create(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/workflowConfigs';
...
class ProjectsLocationsRepositoriesWorkflowInvocationsResource {
  ...
  async.Future<WorkflowInvocation> create(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/workflowInvocations';
...
class ProjectsLocationsRepositoriesWorkspacesResource {
  ...
  async.Future<Workspace> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/workspaces';
  ...
  async.Future<FetchFileDiffResponse> fetchFileDiff(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$workspace') + ':fetchFileDiff';
  ...
  async.Future<FetchFileGitStatusesResponse> fetchFileGitStatuses(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$name') + ':fetchFileGitStatuses';
  ...
  async.Future<FetchGitAheadBehindResponse> fetchGitAheadBehind(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$name') + ':fetchGitAheadBehind';
  ...
  async.Future<InstallNpmPackagesResponse> installNpmPackages(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$workspace') + ':installNpmPackages';
  ...
  async.Future<MakeDirectoryResponse> makeDirectory(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$workspace') + ':makeDirectory';
  ...
  async.Future<MoveDirectoryResponse> moveDirectory(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$workspace') + ':moveDirectory';
  ...
  async.Future<MoveFileResponse> moveFile(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$workspace') + ':moveFile';
  ...
  async.Future<PullGitCommitsResponse> pull(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':pull';
  ...
  async.Future<PushGitCommitsResponse> push(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':push';
  ...
  async.Future<ReadFileResponse> readFile(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$workspace') + ':readFile';
  ...
  async.Future<RemoveDirectoryResponse> removeDirectory(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$workspace') + ':removeDirectory';
  ...
  async.Future<RemoveFileResponse> removeFile(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$workspace') + ':removeFile';
  ...
  async.Future<ResetWorkspaceChangesResponse> reset(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':reset';
  ...
  async.Future<SearchFilesResponse> searchFiles(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$workspace') + ':searchFiles';
  ...
  async.Future<WriteFileResponse> writeFile(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$workspace') + ':writeFile';
...
class Config {
  ...
  Config({this.defaultKmsKeyName, this.name});
...
typedef ReadRepositoryFileResponse = $Shared20;
...
class Repository {
  ...
  /// roles/dataform.admin role on the created repository. To modify access to
...
///
/// Primarily used by the UI (`console.cloud.google.com`). `schema_suffix` and
