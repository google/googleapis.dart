...
class CustomersUserinvitationsResource {
  ...
  async.Future<IsInvitableUserResponse> isInvitableUser(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':isInvitableUser';
  ...
  async.Future<ListUserInvitationsResponse> list(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/userinvitations';
  ...
  async.Future<Operation> send(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':send';
...
class DevicesResource {
  ...
  async.Future<Operation> cancelWipe(
    CancelWipeDeviceRequest request,
    core.String name, {
    core.String? $fields,
  }) async {
    final body_ = convert.json.encode(request);
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':cancelWipe';
  ...
  /// [customer] - Optional.
  /// [Resource name](https://cloud.google.com/apis/design/resource_names) of
  /// the Customer in format: `customers/{customer_id}`, where customer_id is
  ...
  /// `serial_number`. `desc` may be specified optionally to specify results to
  /// be sorted in descending order. Default order is ascending.
  ///
  ...
  async.Future<Operation> wipe(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':wipe';
...
class DevicesDeviceUsersResource {
  ...
  async.Future<Operation> approve(
    ApproveDeviceUserRequest request,
    core.String name, {
    core.String? $fields,
  }) async {
    final body_ = convert.json.encode(request);
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':approve';
  ...
  async.Future<Operation> block(
    BlockDeviceUserRequest request,
    core.String name, {
    core.String? $fields,
  }) async {
    final body_ = convert.json.encode(request);
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':block';
  ...
  /// this method will complete with the same error.
  async.Future<Operation> cancelWipe(
    CancelWipeDeviceUserRequest request,
    core.String name, {
    core.String? $fields,
  }) async {
    final body_ = convert.json.encode(request);
  ...
  /// response.
  ///
  /// Completes with a [ListDeviceUsersResponse].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<ListDeviceUsersResponse> list(
    core.String parent, {
    core.String? customer,
    core.String? filter,
    core.String? orderBy,
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/deviceUsers';
    ...
    return ListDeviceUsersResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
  ...
  /// response.
  ///
  /// Completes with a [LookupSelfDeviceUsersResponse].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<LookupSelfDeviceUsersResponse> lookup(
    core.String parent, {
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + ':lookup';
    ...
    return LookupSelfDeviceUsersResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
...
class GroupsResource {
  ...
  /// `id` must be the email address of an existing group or user. For
  ...
  async.Future<LookupGroupNameResponse> lookup({
    ...
    const url_ = 'v1beta1/groups:lookup';
  ...
  async.Future<SearchGroupsResponse> search({
    ...
    const url_ = 'v1beta1/groups:search';
...
class GroupsMembershipsResource {
  ...
  /// Identity Premium accounts. A member has membership to a group as long as
  ...
  /// collection id "-". When `group_id` is specified, the membership graph will
  ...
  async.Future<LookupMembershipNameResponse> lookup(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/memberships:lookup';
  ...
  async.Future<ModifyMembershipRolesResponse> modifyMembershipRoles(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$name') + ':modifyMembershipRoles';
  ...
  /// **Note:** This feature is only available to Google Workspace Enterprise
  /// Standard, Enterprise Plus, and Enterprise for Education; and Cloud
  /// Identity Premium accounts. A transitive group is any group that has a
  ...
  /// **Note:** This feature is only available to Google Workspace Enterprise
  /// Standard, Enterprise Plus, and Enterprise for Education; and Cloud
  /// Identity Premium accounts. A transitive membership is any direct or
...
class InboundSamlSsoProfilesResource {
  ...
  async.Future<Operation> create(
    ...
    const url_ = 'v1beta1/inboundSamlSsoProfiles';
...
class InboundSamlSsoProfilesIdpCredentialsResource {
  ...
  async.Future<Operation> add(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/idpCredentials:add';
  ...
  async.Future<ListIdpCredentialsResponse> list(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/idpCredentials';
...
class InboundSsoAssignmentsResource {
  ...
  async.Future<Operation> create(
    ...
    const url_ = 'v1beta1/inboundSsoAssignments';
...
class OrgUnitsResource {
  ...
  OrgUnitsMembershipsResource get memberships =>
      OrgUnitsMembershipsResource(_requester);

  OrgUnitsResource(commons.ApiRequester client) : _requester = client;
}

class OrgUnitsMembershipsResource {
  final commons.ApiRequester _requester;

  OrgUnitsMembershipsResource(commons.ApiRequester client)
    : _requester = client;

  /// List OrgMembership resources in an OrgUnit treated as 'parent'.
  ///
  /// Parent format: orgUnits/{$orgUnitId} where `$orgUnitId` is the `orgUnitId`
  ...
  /// resource\](https://developers.google.com/admin-sdk/directory/reference/rest/v1/orgunits).
  /// Value must have pattern `^orgUnits/\[^/\]+$`.
  ///
  ...
  /// customer. Format: customers/{$customerId} where `$customerId` is the `id`
  ...
  ///
  /// [filter] - The search query. Must be specified in
  /// [Common Expression Language](https://opensource.google/projects/cel). May
  /// only contain equality operators on the `type` (e.g., `type ==
  /// 'shared_drive'`).
  ///
  /// [pageSize] - The maximum number of results to return. The service may
  /// return fewer than this value. If omitted (or defaulted to zero) the server
  /// will default to 50. The maximum allowed value is 100, though requests with
  /// page_size greater than that will be silently interpreted as 100.
  ///
  /// [pageToken] - A page token, received from a previous
  /// `OrgMembershipsService.ListOrgMemberships` call. Provide this to retrieve
  /// the subsequent page. When paginating, all other parameters provided to
  /// `ListOrgMembershipsRequest` must match the call that provided the page
  /// token.
  ///
  /// [$fields] - Selector specifying which fields to include in a partial
  /// response.
  ///
  /// Completes with a [ListOrgMembershipsResponse].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<ListOrgMembershipsResponse> list(
    core.String parent, {
    core.String? customer,
    core.String? filter,
    core.int? pageSize,
    ...
    return ListOrgMembershipsResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
  ...
  ///
  /// NOTE: This is an atomic copy-and-delete. The resource will have a new copy
  /// under the destination OrgUnit and be deleted from the source OrgUnit. The
  ...
  /// Request parameters:
  ///
  /// [name] - Required. Immutable. The
  /// [resource name](https://cloud.google.com/apis/design/resource_names) of
  /// the OrgMembership. Format: orgUnits/{$orgUnitId}/memberships/{$membership}
  /// The `$orgUnitId` is the `orgUnitId` from the \[Admin SDK `OrgUnit`
  /// resource\](https://developers.google.com/admin-sdk/directory/reference/rest/v1/orgunits).
  /// To manage a Membership without specifying source `orgUnitId`, this API
  /// also supports the wildcard character '-' for `$orgUnitId` per
  ...
  /// Value must have pattern `^orgUnits/\[^/\]+/memberships/\[^/\]+$`.
  ///
  /// [$fields] - Selector specifying which fields to include in a partial
  /// response.
  ///
  ...
  async.Future<Operation> move(
    MoveOrgMembershipRequest request,
    core.String name, {
    core.String? $fields,
  }) async {
    final body_ = convert.json.encode(request);
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':move';
...
typedef AndroidAttributes = $AndroidAttributes;

/// Request message for approving the device to access user data.
typedef ApproveDeviceUserRequest = $Request05;

/// Request message for blocking account on device.
typedef BlockDeviceUserRequest = $Request05;
...
class BrowserAttributes {
  ...
  BrowserAttributes.fromJson(core.Map json_)
    : this(
        chromeBrowserInfo:
            json_.containsKey('chromeBrowserInfo')
                ? BrowserInfo.fromJson(
...
class CertificateAttributes {
  ...
  CertificateAttributes.fromJson(core.Map json_)
    : this(
        certificateTemplate:
...
typedef CertificateTemplate = $CertificateTemplate;
...
class ClientState {
  ...
  core.Map<core.String, CustomAttributeValue>? keyValuePairs;
  ...
  ClientState.fromJson(core.Map json_)
    : this(
        assetTags:
...
class CreateDeviceRequest {
  ...
  ///
  /// The name field within this device is ignored in the create method. A new
  /// name is created by the method, and returned within the response. Only the
  /// fields `device_type`, `serial_number` and `asset_tag` (if present) are
  /// used to create the device. All other fields are ignored. The `device_type`
  /// and `serial_number` fields are required.
  ///
  /// Required.
  Device? device;

  CreateDeviceRequest({this.customer, this.device});

  CreateDeviceRequest.fromJson(core.Map json_)
    : this(
...
typedef CustomAttributeValue = $CustomAttributeValue;

/// A Device within the Cloud Identity Devices API.
///
/// Represents a Device known to Google Cloud, independent of the device
/// ownership, type, and whether it is assigned or in use by a user. Important:
/// Device API scopes require that you use domain-wide delegation to access the
...
class Device {
  ...
  ///
  /// Output only.
  AndroidAttributes? androidSpecificAttributes;
  ...
  core.List<core.String>? clientTypes;
  ...
  Device.fromJson(core.Map json_)
    : this(
        ...
        clientTypes:
            (json_['clientTypes'] as core.List?)
                ?.map((value) => value as core.String)
                .toList(),
        ...
        endpointVerificationSpecificAttributes:
            json_.containsKey('endpointVerificationSpecificAttributes')
                ? EndpointVerificationSpecificAttributes.fromJson(
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (clientTypes != null) 'clientTypes': clientTypes!,
...
class DeviceUser {
  ...
  DeviceUser.fromJson(core.Map json_)
    : this(
        compromisedState: json_['compromisedState'] as core.String?,
        createTime: json_['createTime'] as core.String?,
...
class EndpointVerificationSpecificAttributes {
  ...
  core.List<BrowserAttributes>? browserAttributes;

  /// Details of certificates.
  core.List<CertificateAttributes>? certificateAttributes;
  ...
  EndpointVerificationSpecificAttributes.fromJson(core.Map json_)
    : this(
        additionalSignals:
        ...
        browserAttributes:
            (json_['browserAttributes'] as core.List?)
                ?.map(
                  (value) => BrowserAttributes.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
        certificateAttributes:
            (json_['certificateAttributes'] as core.List?)
                ?.map(
                  (value) => CertificateAttributes.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
class Group {
  ...
  /// The POSIX groups associated with the `Group`.
  ///
  /// Optional.
  core.List<PosixGroup>? posixGroups;
  ...
  Group.fromJson(core.Map json_)
    : this(
        ...
        posixGroups:
            (json_['posixGroups'] as core.List?)
                ?.map(
                  (value) => PosixGroup.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (name != null) 'name': name!,
    if (parent != null) 'parent': parent!,
    if (posixGroups != null) 'posixGroups': posixGroups!,
...
class ListDeviceUsersResponse {
  ...
  core.List<DeviceUser>? deviceUsers;
  ...
  ListDeviceUsersResponse({this.deviceUsers, this.nextPageToken});

  ListDeviceUsersResponse.fromJson(core.Map json_)
    : this(
        deviceUsers:
            (json_['deviceUsers'] as core.List?)
                ?.map(
                  (value) => DeviceUser.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
class ListOrgMembershipsResponse {
  ...
  core.List<OrgMembership>? orgMemberships;

  ListOrgMembershipsResponse({this.nextPageToken, this.orgMemberships});

  ListOrgMembershipsResponse.fromJson(core.Map json_)
    : this(
        nextPageToken: json_['nextPageToken'] as core.String?,
        orgMemberships:
            (json_['orgMemberships'] as core.List?)
                ?.map(
                  (value) => OrgMembership.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
class LookupSelfDeviceUsersResponse {
  /// The customer Id that may be passed back to other Devices API methods such
  /// as List, Get, etc.
  core.String? customer;
  ...
  LookupSelfDeviceUsersResponse.fromJson(core.Map json_)
    : this(
        customer: json_['customer'] as core.String?,
        names:
...
class Membership {
  ...
  Membership.fromJson(core.Map json_)
    : this(
        ...
        memberKey:
            json_.containsKey('memberKey')
                ? EntityKey.fromJson(
                  json_['memberKey'] as core.Map<core.String, core.dynamic>,
                )
                : null,
        name: json_['name'] as core.String?,
        preferredMemberKey:
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (memberKey != null) 'memberKey': memberKey!,
    if (name != null) 'name': name!,
    if (preferredMemberKey != null) 'preferredMemberKey': preferredMemberKey!,
    if (roles != null) 'roles': roles!,
...
class MoveOrgMembershipRequest {
  /// Customer on whose membership change is made.
  ///
  /// All authorization will happen on the role assignments of this customer.
  /// Format: customers/{$customerId} where `$customerId` is the `id` from the
  /// \[Admin SDK `Customer`
  /// resource\](https://developers.google.com/admin-sdk/directory/reference/rest/v1/customers).
  /// You may also use `customers/my_customer` to specify your own organization.
  ///
  ...
  /// OrgUnit where the membership will be moved to.
  ///
  ...
  MoveOrgMembershipRequest({this.customer, this.destinationOrgUnit});

  MoveOrgMembershipRequest.fromJson(core.Map json_)
    : this(
        customer: json_['customer'] as core.String?,
...
///
/// An `OrgMembership` defines a relationship between an `OrgUnit` and an entity
/// belonging to that `OrgUnit`, referred to as a "member".
class OrgMembership {
  /// Org member id as full resource name.
  ///
  /// Format for shared drive resource:
  /// //drive.googleapis.com/drives/{$memberId} where `$memberId` is the `id`
  ...
  ///
  /// This follows https://aip.dev/122 Format for shared drive resource:
  /// https://drive.googleapis.com/drive/v3/drives/{$memberId} where `$memberId`
  /// is the `id` from \[Drive API (V3) `Drive`
  /// resource\](https://developers.google.com/drive/api/v3/reference/drives#resource).
  core.String? memberUri;

  /// The [resource name](https://cloud.google.com/apis/design/resource_names)
  /// of the OrgMembership.
  ///
  /// Format: orgUnits/{$orgUnitId}/memberships/{$membership} The `$orgUnitId`
  /// is the `orgUnitId` from the \[Admin SDK `OrgUnit`
  /// resource\](https://developers.google.com/admin-sdk/directory/reference/rest/v1/orgunits).
  /// The `$membership` shall be of the form `{$entityType};{$memberId}`, where
  /// `$entityType` is the enum value of \[OrgMembership.EntityType\], and
  ...
  /// Entity type for the org member.
  ///
  /// Immutable.
  /// Possible string values are:
  ...
  OrgMembership({this.member, this.memberUri, this.name, this.type});

  OrgMembership.fromJson(core.Map json_)
    : this(
        member: json_['member'] as core.String?,
        memberUri: json_['memberUri'] as core.String?,
        name: json_['name'] as core.String?,
        type: json_['type'] as core.String?,
      );
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    if (member != null) 'member': member!,
    if (memberUri != null) 'memberUri': memberUri!,
    if (name != null) 'name': name!,
    if (type != null) 'type': type!,
  };
}
...
class PosixGroup {
  ...
  ///
  /// If not specified it will default to empty value.
  core.String? systemId;

  PosixGroup({this.gid, this.name, this.systemId});

  PosixGroup.fromJson(core.Map json_)
    : this(
...
class UpdateMembershipRolesParams {
  ...
  /// The `MembershipRole`s to be updated.
  ///
  /// Only `MEMBER` `MembershipRoles` can currently be updated. May only contain
  /// a `MembershipRole` with `name` `MEMBER`.
...
class WipeDeviceRequest {
  ...
  WipeDeviceRequest({this.customer, this.removeResetLock});

  WipeDeviceRequest.fromJson(core.Map json_)
    : this(
        customer: json_['customer'] as core.String?,
...
typedef WipeDeviceUserRequest = $Request05;
