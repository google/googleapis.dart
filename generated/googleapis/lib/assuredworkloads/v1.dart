...
class OrganizationsLocationsWorkloadsResource {
  ...
  restrictAllowedResources(
    ...
    return GoogleCloudAssuredworkloadsV1RestrictAllowedResourcesResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
}
...
class GoogleCloudAssuredworkloadsV1AcknowledgeViolationRequest {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final acknowledgeType = this.acknowledgeType;
...
class GoogleCloudAssuredworkloadsV1AnalyzeWorkloadMoveResponse {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final assetMoveAnalyses = this.assetMoveAnalyses;
    final nextPageToken = this.nextPageToken;
    return {
      'assetMoveAnalyses': ?assetMoveAnalyses,
...
class GoogleCloudAssuredworkloadsV1AssetMoveAnalysis {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final analysisGroups = this.analysisGroups;
...
class GoogleCloudAssuredworkloadsV1ListWorkloadUpdatesResponse {
  ...
  GoogleCloudAssuredworkloadsV1ListWorkloadUpdatesResponse.fromJson(
    core.Map json_,
        ...
        workloadUpdates: (json_['workloadUpdates'] as core.List?)
            ?.map(
              (value) => GoogleCloudAssuredworkloadsV1WorkloadUpdate.fromJson(
                value as core.Map<core.String, core.dynamic>,
              ),
            )
            .toList(),
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final nextPageToken = this.nextPageToken;
    final workloadUpdates = this.workloadUpdates;
    return {
      'nextPageToken': ?nextPageToken,
      'workloadUpdates': ?workloadUpdates,
    };
  }
}
  ...
  GoogleCloudAssuredworkloadsV1OrgPolicyUpdate.fromJson(core.Map json_)
    : this(
        ...
        suggestedPolicy: json_.containsKey('suggestedPolicy')
            ? GoogleCloudAssuredworkloadsV1OrgPolicy.fromJson(
                json_['suggestedPolicy'] as core.Map<core.String, core.dynamic>,
              )
            : null,
      );

  core.Map<core.String, core.dynamic> toJson() {
    final appliedPolicy = this.appliedPolicy;
    final suggestedPolicy = this.suggestedPolicy;
    return {
...
class GoogleCloudAssuredworkloadsV1UpdateDetails {
  ...
  GoogleCloudAssuredworkloadsV1UpdateDetails({this.orgPolicyUpdate});
    ...
    : this(
        orgPolicyUpdate: json_.containsKey('orgPolicyUpdate')
            ? GoogleCloudAssuredworkloadsV1OrgPolicyUpdate.fromJson(
                json_['orgPolicyUpdate'] as core.Map<core.String, core.dynamic>,
              )
            : null,
      );

  core.Map<core.String, core.dynamic> toJson() {
    final orgPolicyUpdate = this.orgPolicyUpdate;
    return {'orgPolicyUpdate': ?orgPolicyUpdate};
  }
}
...
class GoogleCloudAssuredworkloadsV1Workload {
  ...
  /// Required. Immutable.
  /// Possible string values are:
  /// - "COMPLIANCE_REGIME_UNSPECIFIED" : The default value. This value is used
  /// if the control package is omitted or unknown.
  /// - "ASSURED_WORKLOADS_FOR_PARTNERS" : Specifies a
  /// [Sovereign Controls by Partners](https://cloud.google.com/sovereign-controls-by-partners/docs/overview)
  ...
  /// Protected B
  /// - "DATA_BOUNDARY_FOR_CJIS" : Data Boundary for Criminal Justice
  ...
  /// Publication 1075
  /// - "DATA_BOUNDARY_FOR_ITAR" : Data Boundary for International Traffic in
  ...
  /// Support
  /// - "AU_REGIONS_AND_US_SUPPORT" : Use the
  /// AUSTRALIA_DATA_BOUNDARY_AND_SUPPORT enum for this control package instead,
  ...
  /// US_DATA_BOUNDARY_FOR_HEALTHCARE_AND_LIFE_SCIENCES_WITH_SUPPORT enum for
  /// this control package instead, as the name of the associated Assured
  /// Workloads control package has changed.
  /// - "HIPAA" : Deprecated: Consider using the Data Boundary for US Healthcare
  /// and Life Sciences control package instead.
  /// - "HITRUST" : Deprecated: Consider using the Data Boundary for US
  /// Healthcare and Life Sciences control package instead.
  ...
  /// instead, as the name of the associated Assured Workloads control package
  /// has changed.
  /// - "IRS_1075" : Use the DATA_BOUNDARY_FOR_IRS_PUBLICATION_1075 enum for
  /// this control package instead, as the name of the associated Assured
  /// Workloads control package has changed.
  /// - "ISR_REGIONS" : Use the ISRAEL_DATA_BOUNDARY_AND_SUPPORT enum for this
  /// control package instead, as the name of the associated Assured Workloads
  /// control package has changed.
  /// - "ISR_REGIONS_AND_SUPPORT" : Use the ISRAEL_DATA_BOUNDARY_AND_SUPPORT
  /// enum for this control package instead, as the name of the associated
  /// Assured Workloads control package has changed.
  ...
  /// instead, as the name of the associated Assured Workloads control package
  /// has changed.
  /// - "REGIONAL_CONTROLS" : Use the REGIONAL_DATA_BOUNDARY enum for this
  /// control package instead, as the name of the associated Assured Workloads
  /// control package has changed.
  /// - "US_REGIONAL_ACCESS" : Use the US_DATA_BOUNDARY_AND_SUPPORT enum for
  /// this control package instead, as the name of the associated Assured
  /// Workloads control package has changed.
  ...
  ///
  /// This field is required for creating SIA/PSN/CNTXT/Telefonica partner
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    final complianceRegime = this.complianceRegime;
    final complianceStatus = this.complianceStatus;
    final compliantButDisallowedServices = this.compliantButDisallowedServices;
    final createTime = this.createTime;
    final displayName = this.displayName;
    final ekmProvisioningResponse = this.ekmProvisioningResponse;
    final enableSovereignControls = this.enableSovereignControls;
    final etag = this.etag;
    final kajEnrollmentState = this.kajEnrollmentState;
    final kmsSettings = this.kmsSettings;
    final labels = this.labels;
    final name = this.name;
    final partner = this.partner;
    final partnerPermissions = this.partnerPermissions;
    final partnerServicesBillingAccount = this.partnerServicesBillingAccount;
    final provisionedResourcesParent = this.provisionedResourcesParent;
    final resourceMonitoringEnabled = this.resourceMonitoringEnabled;
    final resourceSettings = this.resourceSettings;
    final resources = this.resources;
    final saaEnrollmentResponse = this.saaEnrollmentResponse;
    final violationNotificationsEnabled = this.violationNotificationsEnabled;
    final workloadOptions = this.workloadOptions;
    return {
...
class GoogleCloudAssuredworkloadsV1WorkloadEkmProvisioningResponse {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final ekmProvisioningErrorDomain = this.ekmProvisioningErrorDomain;
    final ekmProvisioningErrorMapping = this.ekmProvisioningErrorMapping;
    final ekmProvisioningState = this.ekmProvisioningState;
    return {
...
class GoogleCloudAssuredworkloadsV1WorkloadPartnerPermissions {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final accessTransparencyLogsSupportCaseViewer =
        this.accessTransparencyLogsSupportCaseViewer;
    final assuredWorkloadsMonitoring = this.assuredWorkloadsMonitoring;
    final dataLogsViewer = this.dataLogsViewer;
    final serviceAccessApprover = this.serviceAccessApprover;
    return {
      'accessTransparencyLogsSupportCaseViewer':
          ?accessTransparencyLogsSupportCaseViewer,
...
class GoogleCloudAssuredworkloadsV1WorkloadSaaEnrollmentResponse {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final setupErrors = this.setupErrors;
    final setupStatus = this.setupStatus;
    return {'setupErrors': ?setupErrors, 'setupStatus': ?setupStatus};
  }
}
...
class GoogleCloudAssuredworkloadsV1WorkloadWorkloadOptions {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final kajEnrollmentType = this.kajEnrollmentType;
    return {'kajEnrollmentType': ?kajEnrollmentType};
  }
}
