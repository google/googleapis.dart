...
typedef BulkInsertOperationStatus = $BulkInsertOperationStatus01;
typedef ConfigFile = $ConfigFile;

/// Describes additional debugging info.
typedef DebugInfo = $DebugInfo00;
...
typedef DeploymentsCancelPreviewRequest = $DeploymentsCancelPreviewRequest;
...
typedef DeploymentsStopRequest = $DeploymentsStopRequest;
    ...
    : this(
        errorInfo:
            json_.containsKey('errorInfo')
                ...
                : null,
        help:
            json_.containsKey('help')
                ? Help.fromJson(
                  json_['help'] as core.Map<core.String, core.dynamic>,
                )
                : null,
        localizedMessage:
            json_.containsKey('localizedMessage')
...
typedef QuotaExceededInfo = $QuotaExceededInfo01;
...
typedef ResourceAccessControl = $ResourceAccessControl;
...
typedef SetAutoscalerLinkOperationMetadata =
    $SetAutoscalerLinkOperationMetadata;
...
class SetCommonInstanceMetadataOperationMetadata {
  ...
  SetCommonInstanceMetadataOperationMetadata.fromJson(core.Map json_)
    : this(
        clientOperationId: json_['clientOperationId'] as core.String?,
        perLocationOperations: (json_['perLocationOperations']
                as core.Map<core.String, core.dynamic>?)
            ?.map(
              (key, value) => core.MapEntry(
                key,
