...
/// Cloud Deployment Manager V2 API - v2beta
///
...
class CompositeTypesResource {
  ...
  async.Future<Operation> delete(
    ...
    final url_ =
        'deploymentmanager/v2beta/projects/' +
...
class CollectionOverride {
  ...
  CollectionOverride({this.collection, this.options});
...
class Options {
  ...
  /// InputMappings, this must be a valid json schema draft-04.
  ///
    ...
    : this(
        ...
        validationOptions:
            json_.containsKey('validationOptions')
                ...
                : null,
        virtualProperties: json_['virtualProperties'] as core.String?,
      );
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (virtualProperties != null) 'virtualProperties': virtualProperties!,
  };
}
