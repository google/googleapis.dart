...
class AppsResource {
  ...
  async.Future<Application> get(
    ...
    final url_ = 'v1beta/apps/' + commons.escapeVariable('$appsId');
  ...
  async.Future<ListRuntimesResponse> listRuntimes(
    ...
    final url_ =
        'v1beta/apps/' + commons.escapeVariable('$appsId') + ':listRuntimes';
  ...
  async.Future<Operation> repair(
    ...
    final url_ = 'v1beta/apps/' + commons.escapeVariable('$appsId') + ':repair';
...
class AppsDomainMappingsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ =
        'v1beta/apps/' + commons.escapeVariable('$appsId') + '/domainMappings';
...
class AppsLocationsResource {
  ...
  async.Future<ListLocationsResponse> list(
    ...
    final url_ =
        'v1beta/apps/' + commons.escapeVariable('$appsId') + '/locations';
...
class AppsOperationsResource {
  ...
  async.Future<ListOperationsResponse> list(
    ...
    final url_ =
        'v1beta/apps/' + commons.escapeVariable('$appsId') + '/operations';
...
class AppsServicesResource {
  ...
  async.Future<ListServicesResponse> list(
    ...
    final url_ =
        'v1beta/apps/' + commons.escapeVariable('$appsId') + '/services';
...
class BuildInfo {
  ...
  BuildInfo.fromJson(core.Map json_)
    : this(cloudBuildId: json_['cloudBuildId'] as core.String?);
