...
class ProjectsLocationsResource {
  ...
  async.Future<ListLocationsResponse> list(
    ...
    final url_ = 'v1beta2/' + core.Uri.encodeFull('$name') + '/locations';
...
class ProjectsLocationsInstancesResource {
  ...
  async.Future<Operation> applyParameters(
    ...
    final url_ = 'v1beta2/' + core.Uri.encodeFull('$name') + ':applyParameters';
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<Operation> applySoftwareUpdate(
    ...
    final url_ =
        'v1beta2/' + core.Uri.encodeFull('$instance') + ':applySoftwareUpdate';
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta2/' + core.Uri.encodeFull('$parent') + '/instances';
  ...
  async.Future<Operation> updateParameters(
    ...
    final url_ =
        'v1beta2/' + core.Uri.encodeFull('$name') + ':updateParameters';
  ...
  async.Future<Operation> upgrade(
    GoogleCloudMemcacheV1beta2UpgradeInstanceRequest request,
    core.String name, {
    core.String? $fields,
  }) async {
    final body_ = convert.json.encode(request);
    ...
    final url_ = 'v1beta2/' + core.Uri.encodeFull('$name') + ':upgrade';
...
class ProjectsLocationsOperationsResource {
  ...
  async.Future<Empty> cancel(
    ...
    final url_ = 'v1beta2/' + core.Uri.encodeFull('$name') + ':cancel';
  ...
  async.Future<ListOperationsResponse> list(
    ...
    final url_ = 'v1beta2/' + core.Uri.encodeFull('$name') + '/operations';
...
class ApplySoftwareUpdateRequest {
  ...
  /// and apply software update to all nodes (where applicable) within the
  /// instance.
  core.bool? applyAll;

  /// Nodes to which we should apply the update to.
  ///
  /// Note all the selected nodes are updated in parallel.
  core.List<core.String>? nodeIds;

  ApplySoftwareUpdateRequest({this.applyAll, this.nodeIds});

  ApplySoftwareUpdateRequest.fromJson(core.Map json_)
    : this(
...
class GoogleCloudMemcacheV1beta2MaintenancePolicy {
  ...
  GoogleCloudMemcacheV1beta2MaintenancePolicy.fromJson(core.Map json_)
    : this(
...
typedef GoogleCloudMemcacheV1beta2UpgradeInstanceRequest =
    $UpgradeInstanceRequest00;
    ...
    : this(
        ...
        maintenancePolicy:
            json_.containsKey('maintenancePolicy')
                ? GoogleCloudMemcacheV1beta2MaintenancePolicy.fromJson(
        ...
        updateAvailable: json_['updateAvailable'] as core.bool?,
        updateTime: json_['updateTime'] as core.String?,
        zones:
...
class ListInstancesResponse {
  ...
  ListInstancesResponse({this.nextPageToken, this.resources, this.unreachable});
