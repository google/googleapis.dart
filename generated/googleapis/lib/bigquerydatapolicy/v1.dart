...
class DataMaskingPolicy {
  ...
  /// data. It differs from SHA-256 in that a unique random value is generated
  /// for each query and is added to the hash input, resulting in a different
  /// masked result for each query. Creating and updating a data policy with a
...
class RenameDataPolicyRequest {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final newDataPolicyId = this.newDataPolicyId;
    return {'newDataPolicyId': ?newDataPolicyId};
  }
}
