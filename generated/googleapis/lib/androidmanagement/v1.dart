...
class EnterprisesDevicesResourceApi {
  ...
  ///
  /// [wipeReasonMessage] - Optional short message displayed to the user before
  /// wiping the work profile on personal devices. This has no effect on company
  /// owned devices. The maximum message length is 200 characters.
  ///
  /// [$fields] - Selector specifying which fields to include in a partial
  /// response.
  ///
...
class KioskCustomization {
  ...
  /// are shown on the status bar in kiosk mode.
...
class Policy {
  ...
  /// the security posture of a device, we don't recommend overriding any of the
  /// default values.
