...
/// Security Token Service API - v1beta
///
...
class CloudSecurityTokenApi {
  ...
  V1betaResource get v1beta => V1betaResource(_requester);
...
class V1betaResource {
  ...
  V1betaResource(commons.ApiRequester client) : _requester = client;
  ...
  /// response.
  ///
  /// Completes with a [GoogleIdentityStsV1betaExchangeTokenResponse].
  ///
  ...
  async.Future<GoogleIdentityStsV1betaExchangeTokenResponse> token(
    GoogleIdentityStsV1betaExchangeTokenRequest request, {
    core.String? $fields,
  }) async {
    ...
    return GoogleIdentityStsV1betaExchangeTokenResponse.fromJson(
...
class GoogleIdentityStsV1betaExchangeTokenRequest {
  ...
  ///
  /// Must be `urn:ietf:params:oauth:token-type:access_token`, which indicates
  ...
  GoogleIdentityStsV1betaExchangeTokenRequest.fromJson(core.Map json_)
    : this(
...
class GoogleIdentityStsV1betaExchangeTokenResponse {
  ...
  GoogleIdentityStsV1betaExchangeTokenResponse.fromJson(core.Map json_)
    : this(
