...
class OrganizationsResource {
  ...
  async.Future<ListOrganizationsResponse> list({
    ...
    const url_ = 'v1beta1/organizations';
...
class ProjectsResource {
  ...
  async.Future<Project> create(
    ...
    final body_ = convert.json.encode(request);
    final queryParams_ = <core.String, core.List<core.String>>{
      if (useLegacyStack != null) 'useLegacyStack': ['${useLegacyStack}'],
      if ($fields != null) 'fields': [$fields],
    };
  ...
  async.Future<Empty> delete(
    ...
    final url_ = 'v1beta1/projects/' + commons.escapeVariable('$projectId');
  ...
  /// user has the `resourcemanager.projects.get` permission. NOTE: To perform a
...
class ListOrganizationsResponse {
  ...
  ListOrganizationsResponse({this.nextPageToken, this.organizations});

  ListOrganizationsResponse.fromJson(core.Map json_)
    : this(
