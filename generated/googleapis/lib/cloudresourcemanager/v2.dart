...
const userAgent = 'dart-api-client cloudresourcemanager/v2';
...
class FoldersResourceApi {
  ...
  /// be used to track the progress of the folder move workflow. Upon success
  ...
  /// on a Folder in the DELETE_REQUESTED state. In order to succeed, the
  /// Folder's parent must be in the ACTIVE state. In addition, reintroducing
  /// the folder into the tree must not violate folder naming, height and fanout
...
class SearchFoldersRequest {
  ...
  /// are: * Query `displayName=Test*` returns Folder resources whose display
  /// name starts with "Test". * Query `lifecycleState=ACTIVE` returns Folder
