...
class FoldersResource {
  ...
  /// Folder's that share its parent. + The addition of the Folder must not
  /// cause the active Folder hierarchy to exceed a height of 4. Note, the full
  /// active + deleted Folder hierarchy is allowed to reach a height of 8; this
  ...
  /// Folders under its parent to exceed 100. If the operation fails due to a
