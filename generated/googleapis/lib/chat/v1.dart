...
class CommonEventObject {
  ...
  core.Map<core.String, Inputs>? formInputs;
  ...
  /// - "DRAWINGS"
  /// - "CHAT"
  /// - "ALL_HOST_APPS" : This is only used for aggregating logs on the server.
  /// Clients should never send these values directly.
  core.String? hostApp;

  /// Name of the invoked function associated with the widget.
  ///
  /// This field is currently only set for chat.
  core.String? invokedFunction;

  /// Any additional parameters.
  core.Map<core.String, core.String>? parameters;

  /// The platform enum which indicates the platform where the add-on is
  /// running.
  /// Possible string values are:
  /// - "UNKNOWN_PLATFORM"
  /// - "WEB"
  ...
  CommonEventObject.fromJson(core.Map _json)
      : this(
          formInputs: _json.containsKey('formInputs')
              ? (_json['formInputs'] as core.Map<core.String, core.dynamic>)
                  .map(
              ...
              : null,
          hostApp: _json.containsKey('hostApp')
              ? _json['hostApp'] as core.String
              : null,
          invokedFunction: _json.containsKey('invokedFunction')
              ? _json['invokedFunction'] as core.String
              : null,
...
class DateInput {
  core.String? msSinceEpoch;

  DateInput({
    this.msSinceEpoch,
  });

  DateInput.fromJson(core.Map _json)
      : this(
          msSinceEpoch: _json.containsKey('msSinceEpoch')
              ? _json['msSinceEpoch'] as core.String
              : null,
        );

  core.Map<core.String, core.dynamic> toJson() => {
        if (msSinceEpoch != null) 'msSinceEpoch': msSinceEpoch!,
      };
}
...
class DateTimeInput {
  ...
  DateTimeInput.fromJson(core.Map _json)
      : this(
          hasDate: _json.containsKey('hasDate')
              ? _json['hasDate'] as core.bool
              : null,
  ...
  core.Map<core.String, core.dynamic> toJson() => {
        if (hasDate != null) 'hasDate': hasDate!,
...
class DeprecatedEvent {
  ...
  /// Possible string values are:
  /// - "TYPE_UNSPECIFIED" : This could be used when the corresponding event is
  /// not dialog related. For example an @mention.
  /// - "REQUEST_DIALOG" : For any user action that would result in a dialog
  /// opening.
  /// - "SUBMIT_DIALOG" : For card click events from any dialog.
  /// - "CANCEL_DIALOG" : For native cancellation button.
  core.String? dialogEventType;
      ...
      : this(
          ...
          configCompleteRedirectUrl:
              _json.containsKey('configCompleteRedirectUrl')
                  ...
                  : null,
          dialogEventType: _json.containsKey('dialogEventType')
              ? _json['dialogEventType'] as core.String
              : null,
          eventTime: _json.containsKey('eventTime')
              ? _json['eventTime'] as core.String
              : null,
          isDialogEvent: _json.containsKey('isDialogEvent')
              ? _json['isDialogEvent'] as core.bool
              : null,
...
typedef GoogleAppsCardV1SuggestionItem = $Shared09;
...
class Inputs {
  ...
  Inputs.fromJson(core.Map _json)
      : this(
          dateInput: _json.containsKey('dateInput')
              ? DateInput.fromJson(
                  _json['dateInput'] as core.Map<core.String, core.dynamic>)
              : null,
          dateTimeInput: _json.containsKey('dateTimeInput')
              ? DateTimeInput.fromJson(
                  _json['dateTimeInput'] as core.Map<core.String, core.dynamic>)
              : null,
          stringInputs: _json.containsKey('stringInputs')
              ? StringInputs.fromJson(
                  _json['stringInputs'] as core.Map<core.String, core.dynamic>)
              : null,
          timeInput: _json.containsKey('timeInput')
              ? TimeInput.fromJson(
                  _json['timeInput'] as core.Map<core.String, core.dynamic>)
              : null,
        );
...
///
/// For single-valued widgets, it will be a single value list; for multi-valued
...
class StringInputs {
  ...
  StringInputs.fromJson(core.Map _json)
      : this(
...
///
/// Formatted text supported.
typedef TextParagraph = $Shared09;
...
class TimeInput {
  ...
  TimeInput.fromJson(core.Map _json)
      : this(
...
///
/// The id is the tz database time zones such as "America/Toronto". The user
/// timezone offset, in milliseconds, from Coordinated Universal Time (UTC).
class TimeZone {
  core.String? id;
  core.int? offset;
