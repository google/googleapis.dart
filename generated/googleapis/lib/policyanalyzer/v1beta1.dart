...
class FoldersLocationsActivityTypesActivitiesResource {
  ...
  /// response.
  ///
  /// Completes with a [GoogleCloudPolicyanalyzerV1beta1QueryActivityResponse].
  ///
  ...
  async.Future<GoogleCloudPolicyanalyzerV1beta1QueryActivityResponse> query(
    core.String parent, {
    core.String? filter,
    core.int? pageSize,
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/activities:query';
    ...
    return GoogleCloudPolicyanalyzerV1beta1QueryActivityResponse.fromJson(
...
class GoogleCloudPolicyanalyzerV1beta1Activity {
  ...
  GoogleCloudPolicyanalyzerV1beta1ObservationPeriod? observationPeriod;
  ...
  GoogleCloudPolicyanalyzerV1beta1Activity.fromJson(core.Map json_)
    : this(
        activity:
...
class GoogleCloudPolicyanalyzerV1beta1ObservationPeriod {
  ...
  GoogleCloudPolicyanalyzerV1beta1ObservationPeriod.fromJson(core.Map json_)
    : this(
...
class GoogleCloudPolicyanalyzerV1beta1QueryActivityResponse {
  ...
  core.List<GoogleCloudPolicyanalyzerV1beta1Activity>? activities;
  ...
  GoogleCloudPolicyanalyzerV1beta1QueryActivityResponse.fromJson(core.Map json_)
    : this(
        activities:
            (json_['activities'] as core.List?)
                ?.map(
                  (value) => GoogleCloudPolicyanalyzerV1beta1Activity.fromJson(
