...
///       - [ServicesConsumerQuotaMetricsLimitsAdminOverridesResource]
///       - [ServicesConsumerQuotaMetricsLimitsConsumerOverridesResource]
library;
...
class ServicesResource {
  ...
  /// batch fails, and no state changes occur. Operation response type:
  ...
  async.Future<Operation> batchEnable(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/services:batchEnable';
  ...
  /// enabled. Operation response type: `google.protobuf.Empty`
  ///
  /// [request] - The metadata request object.
  ///
  /// Request parameters:
  ...
  /// Request parameters:
  ///
  /// [parent] - Name of the consumer and service to generate an identity for.
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<Operation> generateServiceIdentity(
    core.String parent, {
    core.String? $fields,
  }) async {
    final queryParams_ = <core.String, core.List<core.String>>{
  ...
  /// include services enabled on the project.
  ///
  /// Request parameters:
  ///
...
class ServicesConsumerQuotaMetricsResource {
  ...
  /// response.
  ///
  /// Completes with a [ConsumerQuotaMetric].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<ConsumerQuotaMetric> get(
    core.String name, {
    core.String? view,
    core.String? $fields,
  }) async {
    ...
    return ConsumerQuotaMetric.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<Operation> importAdminOverrides(
    ...
    final url_ =
        'v1beta1/' +
        core.Uri.encodeFull('$parent') +
        '/consumerQuotaMetrics:importAdminOverrides';
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<Operation> importConsumerOverrides(
  ...
  /// consumer, organized by service metric.
  ///
  ...
  /// response.
  ///
  /// Completes with a [ListConsumerQuotaMetricsResponse].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<ListConsumerQuotaMetricsResponse> list(
    core.String parent, {
    core.int? pageSize,
    core.String? pageToken,
    core.String? view,
    ...
    return ListConsumerQuotaMetricsResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
}
...
class ServicesConsumerQuotaMetricsLimitsResource {
  ...
  ServicesConsumerQuotaMetricsLimitsAdminOverridesResource get adminOverrides =>
      ServicesConsumerQuotaMetricsLimitsAdminOverridesResource(_requester);
  ServicesConsumerQuotaMetricsLimitsConsumerOverridesResource
  get consumerOverrides =>
      ServicesConsumerQuotaMetricsLimitsConsumerOverridesResource(_requester);
  ...
  /// response.
  ///
  /// Completes with a [ConsumerQuotaLimit].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<ConsumerQuotaLimit> get(
    core.String name, {
    core.String? view,
    core.String? $fields,
  }) async {
    ...
    return ConsumerQuotaLimit.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
}

class ServicesConsumerQuotaMetricsLimitsAdminOverridesResource {
  final commons.ApiRequester _requester;
  ...
  /// the request. QuotaSafetyCheck lists all such validations. If force is set
  /// to true, it is recommended to include a case id in "X-Goog-Request-Reason"
  ...
  /// be set. If force_only is specified, it is recommended to include a case id
  ...
  async.Future<Operation> create(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/adminOverrides';
  ...
  /// response.
  ///
  /// Completes with a [ListAdminOverridesResponse].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<ListAdminOverridesResponse> list(
    core.String parent, {
    core.int? pageSize,
    core.String? pageToken,
    core.String? $fields,
    ...
    return ListAdminOverridesResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
...
class ServicesConsumerQuotaMetricsLimitsConsumerOverridesResource {
  final commons.ApiRequester _requester;
  ...
  async.Future<Operation> create(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/consumerOverrides';
  ...
  /// response.
  ///
  /// Completes with a [ListConsumerOverridesResponse].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<ListConsumerOverridesResponse> list(
    core.String parent, {
    core.int? pageSize,
    core.String? pageToken,
    core.String? $fields,
    ...
    return ListConsumerOverridesResponse.fromJson(
      response_ as core.Map<core.String, core.dynamic>,
    );
  }
...
class ConsumerQuotaLimit {
  ...
  core.List<QuotaBucket>? quotaBuckets;
  ...
  ConsumerQuotaLimit.fromJson(core.Map json_)
    : this(
        allowsAdminOverrides: json_['allowsAdminOverrides'] as core.bool?,
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    if (allowsAdminOverrides != null)
      'allowsAdminOverrides': allowsAdminOverrides!,
...
class ConsumerQuotaMetric {
  ...
  core.List<ConsumerQuotaLimit>? consumerQuotaLimits;
  ...
  core.List<ConsumerQuotaLimit>? descendantConsumerQuotaLimits;
  ...
  ConsumerQuotaMetric.fromJson(core.Map json_)
    : this(
        consumerQuotaLimits:
            (json_['consumerQuotaLimits'] as core.List?)
                ?.map(
                  (value) => ConsumerQuotaLimit.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
typedef DisableServiceRequest = $Empty;
...
class ImportAdminOverridesRequest {
  ...
  /// would fail the request. QuotaSafetyCheck lists all such validations. If
  /// force is set to true, it is recommended to include a case id in
  ...
  /// still enforced. The 'force' and 'force_only' fields cannot both be set. If
  /// force_only is specified, it is recommended to include a case id in
  /// "X-Goog-Request-Reason" header when sending the request.
  core.List<core.String>? forceOnly;

  /// The import data is specified in the request message itself
  OverrideInlineSource? inlineSource;

  ImportAdminOverridesRequest({this.force, this.forceOnly, this.inlineSource});

  ImportAdminOverridesRequest.fromJson(core.Map json_)
    : this(
...
class ImportConsumerOverridesRequest {
  ...
  ImportConsumerOverridesRequest.fromJson(core.Map json_)
    : this(
        force: json_['force'] as core.bool?,
        forceOnly:
            (json_['forceOnly'] as core.List?)
...
class ListAdminOverridesResponse {
  ...
  ListAdminOverridesResponse({this.nextPageToken, this.overrides});

  ListAdminOverridesResponse.fromJson(core.Map json_)
    : this(
        nextPageToken: json_['nextPageToken'] as core.String?,
        overrides:
            (json_['overrides'] as core.List?)
                ?.map(
                  (value) => QuotaOverride.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
class ListConsumerOverridesResponse {
  ...
  ListConsumerOverridesResponse({this.nextPageToken, this.overrides});

  ListConsumerOverridesResponse.fromJson(core.Map json_)
    : this(
        nextPageToken: json_['nextPageToken'] as core.String?,
        overrides:
            (json_['overrides'] as core.List?)
...
class ListConsumerQuotaMetricsResponse {
  ...
  core.List<ConsumerQuotaMetric>? metrics;

  /// Token identifying which result to start with; returned by a previous list
  /// call.
  core.String? nextPageToken;

  ListConsumerQuotaMetricsResponse({this.metrics, this.nextPageToken});

  ListConsumerQuotaMetricsResponse.fromJson(core.Map json_)
    : this(
        metrics:
            (json_['metrics'] as core.List?)
                ?.map(
                  (value) => ConsumerQuotaMetric.fromJson(
                    value as core.Map<core.String, core.dynamic>,
                  ),
                )
                .toList(),
...
class OverrideInlineSource {
  ...
  OverrideInlineSource({this.overrides});

  OverrideInlineSource.fromJson(core.Map json_)
    : this(
        overrides:
            (json_['overrides'] as core.List?)
                ?.map(
...
class ProducerQuotaPolicy {
  ...
  /// `user` is not a valid key; the API does not support quota policies that
  ...
  ProducerQuotaPolicy.fromJson(core.Map json_)
    : this(
...
class QuotaBucket {
  ...
  QuotaBucket.fromJson(core.Map json_)
    : this(
        adminOverride:
            json_.containsKey('adminOverride')
                ? QuotaOverride.fromJson(
...
class QuotaOverride {
  ...
  QuotaOverride.fromJson(core.Map json_)
    : this(
...
///
/// Output only.
typedef RolloutInfo = $RolloutInfo;
...
class Service {
  ...
  Service({this.config, this.name, this.parent, this.state});
