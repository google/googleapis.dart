...
class OrganizationsLocationsAddressGroupsResource {
  ...
  async.Future<Operation> addItems(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$addressGroup') + ':addItems';
  ...
  async.Future<Operation> cloneItems(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$addressGroup') + ':cloneItems';
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/addressGroups';
  ...
  async.Future<ListAddressGroupReferencesResponse> listReferences(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$addressGroup') + ':listReferences';
  ...
  async.Future<Operation> removeItems(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$addressGroup') + ':removeItems';
...
class OrganizationsLocationsFirewallEndpointsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/firewallEndpoints';
...
class OrganizationsLocationsSecurityProfileGroupsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/securityProfileGroups';
...
class OrganizationsLocationsSecurityProfilesResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/securityProfiles';
...
class ProjectsLocationsAuthzPoliciesResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/authzPolicies';
...
class ProjectsLocationsDnsThreatDetectorsResource {
  ...
  async.Future<DnsThreatDetector> create(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/dnsThreatDetectors';
...
class ProjectsLocationsGatewaySecurityPoliciesRulesResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/rules';
...
class ProjectsLocationsInterceptDeploymentsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/interceptDeployments';
...
class ProjectsLocationsMirroringDeploymentsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/mirroringDeployments';
...
class ProjectsLocationsSacAttachmentsResource {
  ...
  async.Future<Operation> create(
    ...
    final queryParams_ = <core.String, core.List<core.String>>{
      if (requestId != null) 'requestId': [requestId],
      if (sacAttachmentId != null) 'sacAttachmentId': [sacAttachmentId],
      if ($fields != null) 'fields': [$fields],
    };

    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/sacAttachments';
...
class ProjectsLocationsSacRealmsResource {
  ...
  async.Future<Operation> create(
    ...
    final queryParams_ = <core.String, core.List<core.String>>{
      if (requestId != null) 'requestId': [requestId],
      if (sacRealmId != null) 'sacRealmId': [sacRealmId],
      if ($fields != null) 'fields': [$fields],
    };

    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/sacRealms';
...
class ProjectsLocationsTlsInspectionPoliciesResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ =
        'v1beta1/' + core.Uri.encodeFull('$parent') + '/tlsInspectionPolicies';
...
class ProjectsLocationsUrlListsResource {
  ...
  async.Future<Operation> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/urlLists';
...
class DnsThreatDetector {
  ...
  /// A list of Network resource names which are exempt from the configuration
  /// in this DnsThreatDetector.
  ///
...
typedef GoogleCloudNetworksecurityV1beta1GrpcEndpoint = $GrpcEndpoint;
...
class ListSACAttachmentsResponse {
  ...
  ListSACAttachmentsResponse.fromJson(core.Map json_)
    : this(
        nextPageToken: json_['nextPageToken'] as core.String?,
        sacAttachments:
            (json_['sacAttachments'] as core.List?)
                ?.map(
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    if (nextPageToken != null) 'nextPageToken': nextPageToken!,
    if (sacAttachments != null) 'sacAttachments': sacAttachments!,
    if (unreachable != null) 'unreachable': unreachable!,
  };
}
...
class ListSACRealmsResponse {
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    if (nextPageToken != null) 'nextPageToken': nextPageToken!,
    if (sacRealms != null) 'sacRealms': sacRealms!,
    if (unreachable != null) 'unreachable': unreachable!,
  };
}
...
/// with an SSE product.
class SACAttachment {
  /// Case-insensitive ISO-3166 alpha-2 country code used for localization.
  ///
  ...
  ///
  /// Optional.
  SACAttachmentSACAttachmentSymantecOptions? symantecOptions;

  /// Case-sensitive tzinfo identifier used for localization.
  ///
  /// Only valid for Symantec attachments.
  ///
  /// Optional.
  ...
  SACAttachment.fromJson(core.Map json_)
    : this(
        ...
        state: json_['state'] as core.String?,
        symantecOptions:
            json_.containsKey('symantecOptions')
                ? SACAttachmentSACAttachmentSymantecOptions.fromJson(
                  json_['symantecOptions']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (labels != null) 'labels': labels!,
    if (name != null) 'name': name!,
    if (nccGateway != null) 'nccGateway': nccGateway!,
    if (sacRealm != null) 'sacRealm': sacRealm!,
    if (state != null) 'state': state!,
    if (symantecOptions != null) 'symantecOptions': symantecOptions!,
...
class SACAttachmentSACAttachmentSymantecOptions {
  /// Name to be used when creating a location on the customer's behalf in
  /// Symantec's Location API.
  ///
  /// Not to be confused with Google Cloud locations.
  ///
  /// Immutable.
  core.String? symantecLocationName;

  /// Symantec data center identifier that this attachment will connect to.
  ///
  /// Immutable.
  core.String? symantecSite;
  ...
  SACAttachmentSACAttachmentSymantecOptions.fromJson(core.Map json_)
    : this(
        symantecLocationName: json_['symantecLocationName'] as core.String?,
        symantecSite: json_['symantecSite'] as core.String?,
      );

  core.Map<core.String, core.dynamic> toJson() => {
    if (symantecLocationName != null)
      'symantecLocationName': symantecLocationName!,
    if (symantecSite != null) 'symantecSite': symantecSite!,
  };
}
...
class SACRealm {
  ...
  ///
  /// Optional.
  SACRealmSACRealmSymantecOptions? symantecOptions;
  ...
  SACRealm.fromJson(core.Map json_)
    : this(
        ...
        symantecOptions:
            json_.containsKey('symantecOptions')
                ? SACRealmSACRealmSymantecOptions.fromJson(
                  json_['symantecOptions']
                      as core.Map<core.String, core.dynamic>,
                )
                : null,
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (securityService != null) 'securityService': securityService!,
    if (state != null) 'state': state!,
    if (symantecOptions != null) 'symantecOptions': symantecOptions!,
    if (updateTime != null) 'updateTime': updateTime!,
  };
...
class SACRealmSACRealmSymantecOptions {
  ...
  ///
  /// Output only.
  core.List<core.String>? availableSymantecSites;

  /// API Key used to call Symantec APIs on the user's behalf.
  ///
  /// Required if using Symantec Cloud SWG. P4SA account needs permissions
  /// granted to read this secret. A secret ID, secret name, or secret URI can
  /// be specified, but it will be parsed and stored as a secret URI in the form
  /// `projects/{project_number}/secrets/my-secret`.
  ///
  /// Optional.
  core.String? secretPath;

  /// Connection status to Symantec API.
  ///
  /// Output only.
  /// Possible string values are:
  /// - "SYMANTEC_CONNECTION_STATE_UNSPECIFIED" : No state specified. This
  /// should not be used.
  ...
  core.String? symantecConnectionState;
  ...
  SACRealmSACRealmSymantecOptions.fromJson(core.Map json_)
    : this(
        availableSymantecSites:
            (json_['availableSymantecSites'] as core.List?)
                ?.map((value) => value as core.String)
                .toList(),
        secretPath: json_['secretPath'] as core.String?,
        symantecConnectionState:
            json_['symantecConnectionState'] as core.String?,
      );

  core.Map<core.String, core.dynamic> toJson() => {
    if (availableSymantecSites != null)
      'availableSymantecSites': availableSymantecSites!,
    if (secretPath != null) 'secretPath': secretPath!,
    if (symantecConnectionState != null)
