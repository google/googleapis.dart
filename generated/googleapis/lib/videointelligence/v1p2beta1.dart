...
/// Cloud Video Intelligence API - v1p2beta1
///
...
class VideosResource {
  ...
  async.Future<GoogleLongrunningOperation> annotate(
    GoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest request, {
    core.String? $fields,
  }) async {
    ...
    const url_ = 'v1p2beta1/videos:annotate';
...
class GoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest {
  ...
  GoogleCloudVideointelligenceV1p2beta1VideoContext? videoContext;
...
typedef GoogleCloudVideointelligenceV1p2beta1ExplicitContentDetectionConfig =
    $ExplicitContentDetectionConfig;

/// Config for FACE_DETECTION.
typedef GoogleCloudVideointelligenceV1p2beta1FaceDetectionConfig =
    $FaceDetectionConfig;

/// Config for LABEL_DETECTION.
typedef GoogleCloudVideointelligenceV1p2beta1LabelDetectionConfig =
    $LabelDetectionConfig;

/// Config for OBJECT_TRACKING.
typedef GoogleCloudVideointelligenceV1p2beta1ObjectTrackingConfig =
    $ObjectTrackingConfig;

/// Config for PERSON_DETECTION.
typedef GoogleCloudVideointelligenceV1p2beta1PersonDetectionConfig =
    $PersonDetectionConfig;

/// Config for SHOT_CHANGE_DETECTION.
typedef GoogleCloudVideointelligenceV1p2beta1ShotChangeDetectionConfig =
    $ShotChangeDetectionConfig;

/// Provides "hints" to the speech recognizer to favor specific words and
/// phrases in the results.
typedef GoogleCloudVideointelligenceV1p2beta1SpeechContext = $SpeechContext00;
...
class GoogleCloudVideointelligenceV1p2beta1SpeechTranscriptionConfig {
  ...
  ///
  /// Optional.
  core.List<GoogleCloudVideointelligenceV1p2beta1SpeechContext>? speechContexts;
...
typedef GoogleCloudVideointelligenceV1p2beta1TextDetectionConfig =
    $TextDetectionConfig;
...
class GoogleCloudVideointelligenceV1p2beta1VideoContext {
  ...
  /// Config for FACE_DETECTION.
  GoogleCloudVideointelligenceV1p2beta1FaceDetectionConfig? faceDetectionConfig;
  ...
  /// Config for TEXT_DETECTION.
  GoogleCloudVideointelligenceV1p2beta1TextDetectionConfig? textDetectionConfig;
  ...
  GoogleCloudVideointelligenceV1p2beta1VideoContext.fromJson(core.Map json_)
    : this(
        explicitContentDetectionConfig:
