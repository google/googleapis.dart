...
/// Cloud Video Intelligence API - v1p3beta1
///
...
class VideosResource {
  ...
  async.Future<GoogleLongrunningOperation> annotate(
    GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest request, {
    core.String? $fields,
  }) async {
    ...
    const url_ = 'v1p3beta1/videos:annotate';
...
class GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest {
  ...
  GoogleCloudVideointelligenceV1p3beta1VideoContext? videoContext;
  ...
  GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest.fromJson(
    core.Map json_,
  ) : this(
        features:
        ...
        videoContext:
            json_.containsKey('videoContext')
                ? GoogleCloudVideointelligenceV1p3beta1VideoContext.fromJson(
...
typedef GoogleCloudVideointelligenceV1p3beta1ExplicitContentDetectionConfig =
    $ExplicitContentDetectionConfig;

/// Config for FACE_DETECTION.
typedef GoogleCloudVideointelligenceV1p3beta1FaceDetectionConfig =
    $FaceDetectionConfig;

/// Config for LABEL_DETECTION.
typedef GoogleCloudVideointelligenceV1p3beta1LabelDetectionConfig =
    $LabelDetectionConfig;

/// Config for OBJECT_TRACKING.
typedef GoogleCloudVideointelligenceV1p3beta1ObjectTrackingConfig =
    $ObjectTrackingConfig;

/// Config for PERSON_DETECTION.
typedef GoogleCloudVideointelligenceV1p3beta1PersonDetectionConfig =
    $PersonDetectionConfig;

/// Config for SHOT_CHANGE_DETECTION.
typedef GoogleCloudVideointelligenceV1p3beta1ShotChangeDetectionConfig =
    $ShotChangeDetectionConfig;

/// Provides "hints" to the speech recognizer to favor specific words and
/// phrases in the results.
typedef GoogleCloudVideointelligenceV1p3beta1SpeechContext = $SpeechContext00;
...
class GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig {
  ...
  ///
  /// Optional.
  core.List<GoogleCloudVideointelligenceV1p3beta1SpeechContext>? speechContexts;
  ...
  GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig.fromJson(
    core.Map json_,
  ) : this(
        audioTracks:
        ...
        speechContexts:
            (json_['speechContexts'] as core.List?)
                ?.map(
                  (value) =>
                      GoogleCloudVideointelligenceV1p3beta1SpeechContext.fromJson(
...
typedef GoogleCloudVideointelligenceV1p3beta1TextDetectionConfig =
    $TextDetectionConfig;
...
class GoogleCloudVideointelligenceV1p3beta1VideoContext {
  ...
  /// Config for FACE_DETECTION.
  GoogleCloudVideointelligenceV1p3beta1FaceDetectionConfig? faceDetectionConfig;
  ...
  /// Config for TEXT_DETECTION.
  GoogleCloudVideointelligenceV1p3beta1TextDetectionConfig? textDetectionConfig;
  ...
  GoogleCloudVideointelligenceV1p3beta1VideoContext.fromJson(core.Map json_)
    : this(
        explicitContentDetectionConfig:
            json_.containsKey('explicitContentDetectionConfig')
                ? GoogleCloudVideointelligenceV1p3beta1ExplicitContentDetectionConfig.fromJson(
        ...
        faceDetectionConfig:
            json_.containsKey('faceDetectionConfig')
                ? GoogleCloudVideointelligenceV1p3beta1FaceDetectionConfig.fromJson(
        ...
        labelDetectionConfig:
            json_.containsKey('labelDetectionConfig')
                ? GoogleCloudVideointelligenceV1p3beta1LabelDetectionConfig.fromJson(
        ...
        objectTrackingConfig:
            json_.containsKey('objectTrackingConfig')
                ? GoogleCloudVideointelligenceV1p3beta1ObjectTrackingConfig.fromJson(
        ...
        personDetectionConfig:
            json_.containsKey('personDetectionConfig')
                ? GoogleCloudVideointelligenceV1p3beta1PersonDetectionConfig.fromJson(
        ...
        shotChangeDetectionConfig:
            json_.containsKey('shotChangeDetectionConfig')
                ? GoogleCloudVideointelligenceV1p3beta1ShotChangeDetectionConfig.fromJson(
        ...
        textDetectionConfig:
            json_.containsKey('textDetectionConfig')
                ? GoogleCloudVideointelligenceV1p3beta1TextDetectionConfig.fromJson(
