...
class ProjectsLocationsJobsResource {
  ...
  async.Future<Job> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/jobs';
  ...
  /// Cron jobs using the Cloud Scheduler API. If the field is set to true, the
  /// job in the __cron queue with the corresponding name will be deleted
  /// instead.
  ///
  /// [$fields] - Selector specifying which fields to include in a partial
  /// response.
  ...
  /// [legacyAppEngineCron] - This field is used to manage the legacy App Engine
  /// Cron jobs using the Cloud Scheduler API. If the field is set to true, the
  /// jobs in the __cron queue will be listed instead.
  ///
  ...
  async.Future<Job> run(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$name') + ':run';
...
class Job {
  ...
  /// Cloud Scheduler API.
  ///
  /// If the field is set to true, the job will be considered a legacy job. Note
  /// that App Engine Cron jobs have fewer features than Cloud Scheduler jobs,
  /// e.g., are only limited to App Engine targets.
  ///
  /// Immutable.
  core.bool? legacyAppEngineCron;
  ...
  Job.fromJson(core.Map json_)
    : this(
        ...
        legacyAppEngineCron: json_['legacyAppEngineCron'] as core.bool?,
...
class RunJobRequest {
  ...
  /// Cloud Scheduler API.
  ///
  /// If the field is set to true, the job in the __cron queue with the
  /// corresponding name will be forced to run instead.
  core.bool? legacyAppEngineCron;

  RunJobRequest({this.legacyAppEngineCron});

  RunJobRequest.fromJson(core.Map json_)
    : this(legacyAppEngineCron: json_['legacyAppEngineCron'] as core.bool?);
