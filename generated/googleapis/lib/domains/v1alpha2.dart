...
class ProjectsLocationsResource {
  ...
  async.Future<Location> get(core.String name, {core.String? $fields}) async {
    ...
    final url_ = 'v1alpha2/' + core.Uri.encodeFull('$name');
  ...
  async.Future<ListLocationsResponse> list(
    ...
    final url_ = 'v1alpha2/' + core.Uri.encodeFull('$name') + '/locations';
...
class ProjectsLocationsOperationsResource {
  ...
  async.Future<ListOperationsResponse> list(
    ...
    final url_ = 'v1alpha2/' + core.Uri.encodeFull('$name') + '/operations';
...
class ProjectsLocationsRegistrationsResource {
  ...
  async.Future<Operation> export(
    ...
    final url_ = 'v1alpha2/' + core.Uri.encodeFull('$name') + ':export';
  ...
  async.Future<Policy> getIamPolicy(
    ...
    final url_ =
        'v1alpha2/' + core.Uri.encodeFull('$resource') + ':getIamPolicy';
  ...
  async.Future<Operation> import(
    ...
    final url_ =
        'v1alpha2/' + core.Uri.encodeFull('$parent') + '/registrations:import';
  ...
  async.Future<ListRegistrationsResponse> list(
    ...
    final url_ =
        'v1alpha2/' + core.Uri.encodeFull('$parent') + '/registrations';
  ...
  async.Future<Operation> renewDomain(
    ...
    final url_ =
        'v1alpha2/' + core.Uri.encodeFull('$registration') + ':renewDomain';
  ...
  async.Future<Policy> setIamPolicy(
    ...
    final url_ =
        'v1alpha2/' + core.Uri.encodeFull('$resource') + ':setIamPolicy';
  ...
  async.Future<TestIamPermissionsResponse> testIamPermissions(
    ...
    final url_ =
        'v1alpha2/' + core.Uri.encodeFull('$resource') + ':testIamPermissions';
