...
/// Cloud Speech-to-Text API - v1p1beta1
///
...
class OperationsResource {
  ...
  async.Future<Operation> get(core.String name, {core.String? $fields}) async {
    ...
    final url_ = 'v1p1beta1/operations/' + core.Uri.encodeFull('$name');
  ...
  async.Future<ListOperationsResponse> list({
    ...
    const url_ = 'v1p1beta1/operations';
...
class ProjectsLocationsCustomClassesResource {
  ...
  async.Future<CustomClass> create(
    ...
    final url_ =
        'v1p1beta1/' + core.Uri.encodeFull('$parent') + '/customClasses';
  ...
  async.Future<Empty> delete(core.String name, {core.String? $fields}) async {
    ...
    final url_ = 'v1p1beta1/' + core.Uri.encodeFull('$name');
...
class ProjectsLocationsPhraseSetsResource {
  ...
  async.Future<PhraseSet> create(
    ...
    final url_ = 'v1p1beta1/' + core.Uri.encodeFull('$parent') + '/phraseSets';
...
class SpeechResource {
  ...
  async.Future<Operation> longrunningrecognize(
    ...
    const url_ = 'v1p1beta1/speech:longrunningrecognize';
  ...
  async.Future<RecognizeResponse> recognize(
    ...
    const url_ = 'v1p1beta1/speech:recognize';
...
class RecognitionMetadata {
  ...
  RecognitionMetadata.fromJson(core.Map json_)
    : this(
        ...
        obfuscatedId: json_['obfuscatedId'] as core.String?,
  ...
  core.Map<core.String, core.dynamic> toJson() => {
    ...
    if (microphoneDistance != null) 'microphoneDistance': microphoneDistance!,
  ...
  RecognizeResponse.fromJson(core.Map json_)
    : this(
        ...
        speechAdaptationInfo:
            json_.containsKey('speechAdaptationInfo')
