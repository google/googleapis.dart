...
class ServicesTenancyUnitsResourceApi {
  ...
  /// first to resolve them before you can make another call to
  ...
  /// configuration is applied, but any existing settings on the project aren't
  /// modified. Specified policy bindings are applied. Existing bindings aren't
  /// modified. Specified services are activated. No service is deactivated. If
  /// specified, new billing configuration is applied. Omit a billing
  /// configuration to keep the existing one. A service account in the project
  /// is created if previously non existed. Specified labels will be appended to
  /// tenant project, note that the value of existing label key will be updated
  /// if the same label key is requested. The specified folder is ignored, as
  /// moving a tenant project to a different folder isn't supported. The
  ...
  async.Future<Operation> applyProjectConfig(
      ApplyTenantProjectConfigRequest request, core.String name,
      {core.String $fields}) {
    var _url;
    var _queryParams = new core.Map<core.String, core.List<core.String>>();
    var _uploadMedia;
  ...
  async.Future<Operation> attachProject(
      AttachTenantProjectRequest request, core.String name,
      {core.String $fields}) {
    var _url;
    var _queryParams = new core.Map<core.String, core.List<core.String>>();
    var _uploadMedia;
  ...
  /// tag. The mothod removes a project lien with a 'TenantManager' origin if
  /// that was added. It will then attempt to delete the project. If that
  ...
  /// resources with the same tag can't be added if there are existing resources
  /// in a DELETED state. Operation.
  ///
  /// [request] - The metadata request object.
  ///
  /// Request parameters:
  ...
  /// to find the tenant project number when creating VMs. Service producers
  /// must persist the tenant project's information after the project is
  /// created.
  ///
  /// Request parameters:
  ///
  ...
  /// tag. The method removes the project lien with 'TenantManager' origin if
  /// that was added. It then attempts to delete the project. If that operation
...
class AttachTenantProjectRequest {
  ...
  core.Map<core.String, core.Object> toJson() {
    ...
    if (externalResource != null) {
      _json["externalResource"] = externalResource;
    }
    if (reservedResource != null) {
      _json["reservedResource"] = reservedResource;
    }
    if (tag != null) {
      _json["tag"] = tag;
    }
    ...
    if (_json.containsKey("policies")) {
      policies = (_json["policies"] as core.List)
          .map<V1Beta1ProducerQuotaPolicy>(
              (value) => new V1Beta1ProducerQuotaPolicy.fromJson(value))
          .toList();
    }
  }
...
class V1Beta1ProducerQuotaPolicy {
  ...
  /// API does not support quota polcies that apply only to a specific user. *
