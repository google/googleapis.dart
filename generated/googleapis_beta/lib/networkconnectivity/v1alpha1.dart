...
///     - [ProjectsLocationsConnectionPoliciesResource]
///     - [ProjectsLocationsGlobalResource]
///       - [ProjectsLocationsGlobalHubsResource]
///     - [ProjectsLocationsInternalRangesResource]
///     - [ProjectsLocationsOperationsResource]
///     - [ProjectsLocationsServiceIdentifiersResource]
///     - [ProjectsLocationsServiceInstancesResource]
...
class ProjectsLocationsResource {
  ...
  ProjectsLocationsConnectionPoliciesResource get connectionPolicies =>
      ProjectsLocationsConnectionPoliciesResource(_requester);
  ...
  ProjectsLocationsServiceIdentifiersResource get serviceIdentifiers =>
      ProjectsLocationsServiceIdentifiersResource(_requester);
  ProjectsLocationsServiceInstancesResource get serviceInstances =>
      ProjectsLocationsServiceInstancesResource(_requester);
...
class ProjectsLocationsConnectionPoliciesResource {
  final commons.ApiRequester _requester;

  ProjectsLocationsConnectionPoliciesResource(commons.ApiRequester client)
      : _requester = client;
...
class ProjectsLocationsServiceIdentifiersResource {
  final commons.ApiRequester _requester;

  ProjectsLocationsServiceIdentifiersResource(commons.ApiRequester client)
      : _requester = client;
...
class ProjectsLocationsServiceInstancesResource {
  final commons.ApiRequester _requester;

  ProjectsLocationsServiceInstancesResource(commons.ApiRequester client)
      : _requester = client;
  ...
  Hub.fromJson(core.Map _json)
      : this(
          ...
          labels: _json.containsKey('labels')
              ...
              : null,
          name: _json.containsKey('name') ? _json['name'] as core.String : null,
          spokes: _json.containsKey('spokes')
              ? (_json['spokes'] as core.List)
                  .map((value) => value as core.String)
                  .toList()
              : null,
          state:
...
class ListHubsResponse {
  ...
  ListHubsResponse.fromJson(core.Map _json)
      : this(
          hubs: _json.containsKey('hubs')
              ? (_json['hubs'] as core.List)
  ...
  RouterApplianceInstance.fromJson(core.Map _json)
      : this(
          ipAddress: _json.containsKey('ipAddress')
              ...
              : null,
          networkInterface: _json.containsKey('networkInterface')
              ? _json['networkInterface'] as core.String
              : null,
          virtualMachine: _json.containsKey('virtualMachine')
              ? _json['virtualMachine'] as core.String
              : null,
        );
  ...
  Spoke.fromJson(core.Map _json)
      : this(
          ...
          description: _json.containsKey('description')
              ? _json['description'] as core.String
              : null,
          hub: _json.containsKey('hub') ? _json['hub'] as core.String : null,
          labels: _json.containsKey('labels')
              ? (_json['labels'] as core.Map<core.String, core.dynamic>).map(
                  (key, item) => core.MapEntry(
                    key,
          ...
          linkedInterconnectAttachments:
              _json.containsKey('linkedInterconnectAttachments')
                  ? (_json['linkedInterconnectAttachments'] as core.List)
                      .map((value) => value as core.String)
                      .toList()
                  : null,
          linkedRouterApplianceInstances:
              _json.containsKey('linkedRouterApplianceInstances')
                  ? (_json['linkedRouterApplianceInstances'] as core.List)
                      .map((value) => RouterApplianceInstance.fromJson(
                          value as core.Map<core.String, core.dynamic>))
                      .toList()
                  : null,
          linkedVpnTunnels: _json.containsKey('linkedVpnTunnels')
              ? (_json['linkedVpnTunnels'] as core.List)
                  .map((value) => value as core.String)
                  .toList()
              : null,
          name: _json.containsKey('name') ? _json['name'] as core.String : null,
