...
library googleapis_beta.dfareporting.v2_5beta1;
...
const core.String USER_AGENT = 'dart-api-client dfareporting/v2.5beta1';
...
class DfareportingApi {
  ...
  DfareportingApi(http.Client client, {core.String rootUrl: "https://www.googleapis.com/", core.String servicePath: "dfareporting/v2.5beta1/"}) :
...
class CreativeAssetsResourceApi {
  ...
  async.Future<CreativeAssetMetadata> insert(CreativeAssetMetadata request, core.String profileId, core.String advertiserId, {commons.UploadOptions uploadOptions : commons.UploadOptions.Default, commons.Media uploadMedia}) {
    ...
    if (_uploadMedia == null) {
      ...
      _url = '/resumable/upload/dfareporting/v2.5beta1/userprofiles/' + commons.Escaper.ecapeVariable('$profileId') + '/creativeAssets/' + commons.Escaper.ecapeVariable('$advertiserId') + '/creativeAssets';
    } else {
      _url = '/upload/dfareporting/v2.5beta1/userprofiles/' + commons.Escaper.ecapeVariable('$profileId') + '/creativeAssets/' + commons.Escaper.ecapeVariable('$advertiserId') + '/creativeAssets';
    }
