...
library googleapis_beta.cloudtasks.v2beta3;
...
const core.String USER_AGENT = 'dart-api-client cloudtasks/v2beta3';
...
class ProjectsLocationsResourceApi {
  ...
  async.Future<Location> get(core.String name, {core.String $fields}) {
    ...
    _url = 'v2beta3/' + commons.Escaper.ecapeVariableReserved('$name');
...
class ProjectsLocationsQueuesResourceApi {
  ...
  async.Future<Queue> pause(PauseQueueRequest request, core.String name,
    ...
    _url =
        'v2beta3/' + commons.Escaper.ecapeVariableReserved('$name') + ':pause';
  ...
  async.Future<Queue> purge(PurgeQueueRequest request, core.String name,
    ...
    _url =
        'v2beta3/' + commons.Escaper.ecapeVariableReserved('$name') + ':purge';
  ...
  async.Future<Queue> resume(ResumeQueueRequest request, core.String name,
    ...
    _url =
        'v2beta3/' + commons.Escaper.ecapeVariableReserved('$name') + ':resume';
...
class ProjectsLocationsQueuesTasksResourceApi {
  ...
  async.Future<Task> run(RunTaskRequest request, core.String name,
    ...
    _url = 'v2beta3/' + commons.Escaper.ecapeVariableReserved('$name') + ':run';
...
class AppEngineHttpQueue {
  ...
  AppEngineHttpQueue.fromJson(core.Map _json) {
...
class AppEngineHttpRequest {
  ...
  void set bodyAsBytes(core.List<core.int> _bytes) {
    body =
...
class Queue {
  ...
  Queue.fromJson(core.Map _json) {
    if (_json.containsKey("appEngineHttpQueue")) {
      appEngineHttpQueue =
          new AppEngineHttpQueue.fromJson(_json["appEngineHttpQueue"]);
    }
    if (_json.containsKey("name")) {
      name = _json["name"];
    }
  ...
  core.Map<core.String, core.Object> toJson() {
    ...
    if (appEngineHttpQueue != null) {
      _json["appEngineHttpQueue"] = (appEngineHttpQueue).toJson();
    }
    if (name != null) {
      _json["name"] = name;
    }
