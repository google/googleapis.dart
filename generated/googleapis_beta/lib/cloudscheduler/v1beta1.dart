...
library googleapis_beta.cloudscheduler.v1beta1;
...
const core.String USER_AGENT = 'dart-api-client cloudscheduler/v1beta1';
...
class ProjectsLocationsJobsResourceApi {
  ...
  async.Future<Job> run(RunJobRequest request, core.String name,
    ...
    _url = 'v1beta1/' + commons.Escaper.ecapeVariableReserved('$name') + ':run';
