...
library googleapis_beta.networkmanagement.v1beta1;
...
const core.String USER_AGENT = 'dart-api-client networkmanagement/v1beta1';
...
class ProjectsLocationsGlobalConnectivityTestsResourceApi {
  ...
  async.Future<Operation> rerun(
    ...
    _url =
        'v1beta1/' + commons.Escaper.ecapeVariableReserved('$name') + ':rerun';
...
class DropInfo {
  ...
  /// tries to access Google API and
  ...
  /// the health check probes to the backends and cause
