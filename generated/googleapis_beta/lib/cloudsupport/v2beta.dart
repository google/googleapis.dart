...
class CasesResource {
  ...
  /// unspecified, the first page is retrieved.
  ///
  /// [query] - An expression written in the Cloud filter language. Filter
  /// strings can use the following fields: - organization (A name of the form
  /// organizations/) - project (A name of the form projects/) - customer (A
  ...
  /// comments (e.g. "my search"). One of organization, project, or customer
...
class CaseClassification {
  ...
  ///
  /// Must be specified for case creation.
  core.String? id;
