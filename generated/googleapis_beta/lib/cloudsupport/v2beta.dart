...
class CaseClassificationsResource {
  ...
  async.Future<SearchCaseClassificationsResponse> search({
    ...
    final queryParams_ = <core.String, core.List<core.String>>{
      ...
      'product.productLine': ?product_productLine == null
          ? null
          : [product_productLine],
...
class CasesCommentsResource {
  ...
  /// --header "Authorization: Bearer $(gcloud auth print-access-token)" \
  /// "https://cloudsupport.googleapis.com/v2beta/$comment" ``` Python:
  /// ```python import googleapiclient.discovery api_version = "v2beta"
  /// supportApiService = googleapiclient.discovery.build(
  /// serviceName="cloudsupport", version=api_version,
  /// discoveryServiceUrl=f"https://cloudsupport.googleapis.com/$discovery/rest?version={api_version}",
...
class OrganizationsSupportEventSubscriptionsResource {
  ...
  async.Future<Empty> expunge(
    ...
    final url_ = 'v2beta/' + core.Uri.encodeFull('$name') + ':expunge';
  ...
  async.Future<SupportEventSubscription> undelete(
    ...
    final url_ = 'v2beta/' + core.Uri.encodeFull('$name') + ':undelete';
...
class Case {
    ...
    : this(
        classification: json_.containsKey('classification')
            ? CaseClassification.fromJson(
                json_['classification'] as core.Map<core.String, core.dynamic>,
              )
            : null,
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    final displayName = this.displayName;
    final escalated = this.escalated;
    final languageCode = this.languageCode;
    final name = this.name;
    final priority = this.priority;
    final severity = this.severity;
    final state = this.state;
    final subscriberEmailAddresses = this.subscriberEmailAddresses;
...
class CaseClassification {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    return {'displayName': ?displayName, 'id': ?id, 'product': ?product};
  }
}
...
class Comment {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    final creator = this.creator;
    final name = this.name;
    final plainTextBody = this.plainTextBody;
    return {
      'body': ?body,
      'createTime': ?createTime,
      'creator': ?creator,
...
class EmailMessage {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    final bodyContent = this.bodyContent;
    final ccEmailAddresses = this.ccEmailAddresses;
    final createTime = this.createTime;
    final name = this.name;
    final recipientEmailAddresses = this.recipientEmailAddresses;
...
class FeedItem {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    ...
    final deletedAttachment = this.deletedAttachment;
...
class ShowFeedResponse {
  ...
  core.Map<core.String, core.dynamic> toJson() {
    final feedItems = this.feedItems;
    final nextPageToken = this.nextPageToken;
    return {'feedItems': ?feedItems, 'nextPageToken': ?nextPageToken};
  }
}
