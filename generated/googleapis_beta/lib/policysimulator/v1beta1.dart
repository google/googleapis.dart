...
class FoldersLocationsReplaysResource {
  ...
  async.Future<GoogleLongrunningOperation> create(
    ...
    final _url = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/replays';
      ...
      : this(
          ...
          policies: _json.containsKey('policies')
              ? (_json['policies'] as core.List)
                  .map<GoogleCloudPolicysimulatorV1beta1ExplainedPolicy>(
                      (value) =>
      ...
      : this(
          ...
          bindingExplanations: _json.containsKey('bindingExplanations')
              ? (_json['bindingExplanations'] as core.List)
                  .map<GoogleCloudPolicysimulatorV1beta1BindingExplanation>(
                      (value) =>
                          GoogleCloudPolicysimulatorV1beta1BindingExplanation
                              .fromJson(
                                  value as core.Map<core.String, core.dynamic>))
...
class GoogleCloudPolicysimulatorV1beta1ReplayResultsSummary {
  ...
  GoogleCloudPolicysimulatorV1beta1ReplayResultsSummary.fromJson(core.Map _json)
      : this(
          differenceCount: _json.containsKey('differenceCount')
              ? _json['differenceCount'] as core.int
              : null,
