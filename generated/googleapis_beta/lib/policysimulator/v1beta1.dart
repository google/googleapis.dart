...
class FoldersLocationsReplaysResource {
  ...
  async.Future<GoogleLongrunningOperation> create(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/replays';
...
class FoldersLocationsReplaysResultsResource {
  ...
  async.Future<GoogleCloudPolicysimulatorV1beta1ListReplayResultsResponse> list(
    ...
    final url_ = 'v1beta1/' + core.Uri.encodeFull('$parent') + '/results';
...
class GoogleCloudPolicysimulatorV1beta1AccessStateDiff {
  ...
  GoogleCloudPolicysimulatorV1beta1AccessStateDiff.fromJson(core.Map json_)
      : this(
          accessChange: json_.containsKey('accessChange')
              ? json_['accessChange'] as core.String
              : null,
          baseline: json_.containsKey('baseline')
              ? GoogleCloudPolicysimulatorV1beta1ExplainedAccess.fromJson(
...
class GoogleCloudPolicysimulatorV1beta1AccessTuple {
  ...
  GoogleCloudPolicysimulatorV1beta1AccessTuple.fromJson(core.Map json_)
      : this(
...
class GoogleCloudPolicysimulatorV1beta1BindingExplanation {
  ...
  GoogleCloudPolicysimulatorV1beta1BindingExplanation.fromJson(core.Map json_)
      : this(
...
class GoogleCloudPolicysimulatorV1beta1ExplainedAccess {
  ...
  GoogleCloudPolicysimulatorV1beta1ExplainedAccess.fromJson(core.Map json_)
      : this(
...
class GoogleCloudPolicysimulatorV1beta1ExplainedPolicy {
  ...
  GoogleCloudPolicysimulatorV1beta1ExplainedPolicy.fromJson(core.Map json_)
      : this(
          access: json_.containsKey('access')
              ? json_['access'] as core.String
              : null,
...
class GoogleCloudPolicysimulatorV1beta1Replay {
  ...
  GoogleCloudPolicysimulatorV1beta1Replay.fromJson(core.Map json_)
      : this(
          config: json_.containsKey('config')
              ? GoogleCloudPolicysimulatorV1beta1ReplayConfig.fromJson(
...
class GoogleCloudPolicysimulatorV1beta1ReplayConfig {
  ...
  GoogleCloudPolicysimulatorV1beta1ReplayConfig.fromJson(core.Map json_)
      : this(
...
class GoogleCloudPolicysimulatorV1beta1ReplayDiff {
  ...
  GoogleCloudPolicysimulatorV1beta1ReplayDiff.fromJson(core.Map json_)
      : this(
          accessDiff: json_.containsKey('accessDiff')
              ? GoogleCloudPolicysimulatorV1beta1AccessStateDiff.fromJson(
...
class GoogleCloudPolicysimulatorV1beta1ReplayResult {
  ...
  GoogleCloudPolicysimulatorV1beta1ReplayResult.fromJson(core.Map json_)
      : this(
          accessTuple: json_.containsKey('accessTuple')
              ? GoogleCloudPolicysimulatorV1beta1AccessTuple.fromJson(
                  json_['accessTuple'] as core.Map<core.String, core.dynamic>)
              : null,
          diff: json_.containsKey('diff')
              ? GoogleCloudPolicysimulatorV1beta1ReplayDiff.fromJson(
...
class GoogleCloudPolicysimulatorV1beta1ReplayResultsSummary {
  ...
  GoogleCloudPolicysimulatorV1beta1ReplayResultsSummary.fromJson(core.Map json_)
      : this(
