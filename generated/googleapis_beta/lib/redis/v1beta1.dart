...
library googleapis_beta.redis.v1beta1;
...
const core.String USER_AGENT = 'dart-api-client redis/v1beta1';
...
class GoogleCloudCommonOperationMetadata {
  ...
  GoogleCloudCommonOperationMetadata.fromJson(core.Map _json) {
...
class GoogleCloudRedisV1beta1LocationMetadata {
  ...
  core.Map<core.String, GoogleCloudRedisV1beta1ZoneMetadata> availableZones;

  GoogleCloudRedisV1beta1LocationMetadata();

  GoogleCloudRedisV1beta1LocationMetadata.fromJson(core.Map _json) {
    if (_json.containsKey("availableZones")) {
      availableZones =
          commons.mapMap<core.Map, GoogleCloudRedisV1beta1ZoneMetadata>(
              _json["availableZones"].cast<core.String, core.Map>(),
              (core.Map item) =>
                  new GoogleCloudRedisV1beta1ZoneMetadata.fromJson(item));
    }
  }
  ...
  core.Map<core.String, core.Object> toJson() {
    ...
    if (availableZones != null) {
      _json["availableZones"] = commons.mapMap<
              GoogleCloudRedisV1beta1ZoneMetadata,
              core.Map<core.String, core.Object>>(availableZones,
          (GoogleCloudRedisV1beta1ZoneMetadata item) => (item).toJson());
    }
    return _json;
  }
}
...
class GoogleCloudRedisV1beta1ZoneMetadata {
  ...
  GoogleCloudRedisV1beta1ZoneMetadata.fromJson(core.Map _json) {}
