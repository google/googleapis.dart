...
buildActivityRule() {
  ...
  if (buildCounterActivityRule < 3) {
    o.actionNames = buildUnnamed5623();
    o.createTime = "foo";
    o.description = "foo";
    o.displayName = "foo";
    o.name = "foo";
    o.query = "foo";
    o.supersededAlerts = buildUnnamed5624();
...
checkActivityRule(api.ActivityRule o) {
  buildCounterActivityRule++;
  if (buildCounterActivityRule < 3) {
    checkUnnamed5623(o.actionNames);
    unittest.expect(o.createTime, unittest.equals('foo'));
    unittest.expect(o.description, unittest.equals('foo'));
    unittest.expect(o.displayName, unittest.equals('foo'));
    unittest.expect(o.name, unittest.equals('foo'));
    unittest.expect(o.query, unittest.equals('foo'));
    checkUnnamed5624(o.supersededAlerts);
...
checkUnnamed5625(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5626(core.List<api.RequestInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAppMakerSqlSetupNotification() {
  ...
  if (buildCounterAppMakerSqlSetupNotification < 3) {
    o.requestInfo = buildUnnamed5626();
  }
  buildCounterAppMakerSqlSetupNotification--;
  return o;
}
...
checkAppMakerSqlSetupNotification(api.AppMakerSqlSetupNotification o) {
  buildCounterAppMakerSqlSetupNotification++;
  if (buildCounterAppMakerSqlSetupNotification < 3) {
    checkUnnamed5626(o.requestInfo);
  }
  buildCounterAppMakerSqlSetupNotification--;
}
...
checkUnnamed5627(core.List<api.GmailMessageInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5629(core.Map<core.String, api.Status> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatus(o["x"]);
  checkStatus(o["y"]);
}
...
buildBatchDeleteAlertsResponse() {
  ...
  if (buildCounterBatchDeleteAlertsResponse < 3) {
    o.failedAlertStatus = buildUnnamed5629();
    o.successAlertIds = buildUnnamed5630();
  }
  buildCounterBatchDeleteAlertsResponse--;
  return o;
}
...
checkBatchDeleteAlertsResponse(api.BatchDeleteAlertsResponse o) {
  buildCounterBatchDeleteAlertsResponse++;
  if (buildCounterBatchDeleteAlertsResponse < 3) {
    checkUnnamed5629(o.failedAlertStatus);
    checkUnnamed5630(o.successAlertIds);
  }
  buildCounterBatchDeleteAlertsResponse--;
}
...
checkUnnamed5632(core.Map<core.String, api.Status> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatus(o["x"]);
  checkStatus(o["y"]);
}
...
buildBatchUndeleteAlertsResponse() {
  ...
  if (buildCounterBatchUndeleteAlertsResponse < 3) {
    o.failedAlertStatus = buildUnnamed5632();
    o.successAlertIds = buildUnnamed5633();
  }
  buildCounterBatchUndeleteAlertsResponse--;
  return o;
}
...
checkBatchUndeleteAlertsResponse(api.BatchUndeleteAlertsResponse o) {
  buildCounterBatchUndeleteAlertsResponse++;
  if (buildCounterBatchUndeleteAlertsResponse < 3) {
    checkUnnamed5632(o.failedAlertStatus);
    checkUnnamed5633(o.successAlertIds);
  }
  buildCounterBatchUndeleteAlertsResponse--;
}
...
checkUnnamed5634(core.List<api.CsvRow> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCsvRow(o[0]);
  checkCsvRow(o[1]);
}
...
checkUnnamed5637(core.List<api.DeviceCompromisedSecurityDetail> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildGmailMessageInfo() {
  ...
  if (buildCounterGmailMessageInfo < 3) {
    o.attachmentsSha256Hash = buildUnnamed5638();
    o.date = "foo";
...
checkGmailMessageInfo(api.GmailMessageInfo o) {
  buildCounterGmailMessageInfo++;
  if (buildCounterGmailMessageInfo < 3) {
    checkUnnamed5638(o.attachmentsSha256Hash);
...
buildGoogleOperations() {
  ...
  if (buildCounterGoogleOperations < 3) {
    o.affectedUserEmails = buildUnnamed5639();
...
checkGoogleOperations(api.GoogleOperations o) {
  buildCounterGoogleOperations++;
  if (buildCounterGoogleOperations < 3) {
    checkUnnamed5639(o.affectedUserEmails);
...
checkUnnamed5640(core.List<api.AlertFeedback> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5641(core.List<api.Alert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAlert(o[0]);
  checkAlert(o[1]);
}
...
checkUnnamed5642(core.List<api.GmailMessageInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGmailMessageInfo(o[0]);
  checkGmailMessageInfo(o[1]);
}
...
checkUnnamed5643(core.List<api.GmailMessageInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGmailMessageInfo(o[0]);
  checkGmailMessageInfo(o[1]);
}
...
buildRequestInfo() {
  ...
  if (buildCounterRequestInfo < 3) {
    o.appDeveloperEmail = buildUnnamed5644();
    o.appKey = "foo";
...
checkRequestInfo(api.RequestInfo o) {
  buildCounterRequestInfo++;
  if (buildCounterRequestInfo < 3) {
    checkUnnamed5644(o.appDeveloperEmail);
...
checkUnnamed5645(core.List<api.Notification> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSettings() {
  ...
  if (buildCounterSettings < 3) {
    o.notifications = buildUnnamed5645();
  }
  buildCounterSettings--;
  return o;
}
...
checkSettings(api.Settings o) {
  buildCounterSettings++;
  if (buildCounterSettings < 3) {
    checkUnnamed5645(o.notifications);
  }
  buildCounterSettings--;
}
...
checkUnnamed5646(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed5647() {
  ...
  o.add(buildUnnamed5646());
  o.add(buildUnnamed5646());
  return o;
}

checkUnnamed5647(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed5646(o[0]);
  checkUnnamed5646(o[1]);
}
...
checkUnnamed5648(core.List<api.SuspiciousActivitySecurityDetail> o) {
  unittest.expect(o, unittest.hasLength(2));
