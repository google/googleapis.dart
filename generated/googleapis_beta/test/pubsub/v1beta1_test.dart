...
checkUnnamed2682(core.List<api.Subscription> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListSubscriptionsResponse() {
  ...
  if (buildCounterListSubscriptionsResponse < 3) {
    o.nextPageToken = "foo";
    o.subscription = buildUnnamed2682();
  }
  buildCounterListSubscriptionsResponse--;
  return o;
}
...
checkListSubscriptionsResponse(api.ListSubscriptionsResponse o) {
  ...
  if (buildCounterListSubscriptionsResponse < 3) {
    ...
    checkUnnamed2682(o.subscription);
  }
  buildCounterListSubscriptionsResponse--;
}
...
checkUnnamed2683(core.List<api.Topic> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTopic(o[0]);
  checkTopic(o[1]);
}
...
checkUnnamed2685(core.List<api.PubsubMessage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2687(core.List<api.Label> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabel(o[0]);
  checkLabel(o[1]);
}
...
checkUnnamed2688(core.List<api.PullResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPullBatchResponse() {
  ...
  if (buildCounterPullBatchResponse < 3) {
    o.pullResponses = buildUnnamed2688();
  }
  buildCounterPullBatchResponse--;
  return o;
}
...
checkPullBatchResponse(api.PullBatchResponse o) {
  buildCounterPullBatchResponse++;
  if (buildCounterPullBatchResponse < 3) {
    checkUnnamed2688(o.pullResponses);
  }
  buildCounterPullBatchResponse--;
}
