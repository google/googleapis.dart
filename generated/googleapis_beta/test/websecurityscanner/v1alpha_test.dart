...
checkUnnamed5177(core.List<api.CrawledUrl> o) {
...
buildListCrawledUrlsResponse() {
  ...
  if (buildCounterListCrawledUrlsResponse < 3) {
    o.crawledUrls = buildUnnamed5177();
    o.nextPageToken = "foo";
  }
  buildCounterListCrawledUrlsResponse--;
  return o;
...
checkListCrawledUrlsResponse(api.ListCrawledUrlsResponse o) {
  buildCounterListCrawledUrlsResponse++;
  if (buildCounterListCrawledUrlsResponse < 3) {
    checkUnnamed5177(o.crawledUrls);
...
checkUnnamed5178(core.List<api.FindingTypeStats> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListFindingTypeStatsResponse() {
  ...
  if (buildCounterListFindingTypeStatsResponse < 3) {
    o.findingTypeStats = buildUnnamed5178();
  }
  buildCounterListFindingTypeStatsResponse--;
  return o;
}
...
checkListFindingTypeStatsResponse(api.ListFindingTypeStatsResponse o) {
  buildCounterListFindingTypeStatsResponse++;
  if (buildCounterListFindingTypeStatsResponse < 3) {
    checkUnnamed5178(o.findingTypeStats);
  }
  buildCounterListFindingTypeStatsResponse--;
}
...
checkUnnamed5179(core.List<api.Finding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFinding(o[0]);
  checkFinding(o[1]);
}
...
checkUnnamed5180(core.List<api.ScanConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkScanConfig(o[0]);
  checkScanConfig(o[1]);
}
...
buildListScanConfigsResponse() {
  ...
  if (buildCounterListScanConfigsResponse < 3) {
    o.nextPageToken = "foo";
    o.scanConfigs = buildUnnamed5180();
  }
  buildCounterListScanConfigsResponse--;
  return o;
}
...
checkListScanConfigsResponse(api.ListScanConfigsResponse o) {
  ...
  if (buildCounterListScanConfigsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed5180(o.scanConfigs);
  }
  buildCounterListScanConfigsResponse--;
}
...
checkUnnamed5181(core.List<api.ScanRun> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkScanRun(o[0]);
  checkScanRun(o[1]);
}
...
buildOutdatedLibrary() {
  ...
  if (buildCounterOutdatedLibrary < 3) {
    o.learnMoreUrls = buildUnnamed5182();
    o.libraryName = "foo";
    o.version = "foo";
  }
  buildCounterOutdatedLibrary--;
...
checkOutdatedLibrary(api.OutdatedLibrary o) {
  buildCounterOutdatedLibrary++;
  if (buildCounterOutdatedLibrary < 3) {
    checkUnnamed5182(o.learnMoreUrls);
...
checkUnnamed5183(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
checkUnnamed5184(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
checkUnnamed5185(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
buildScanConfig() {
  ...
  if (buildCounterScanConfig < 3) {
    ...
    o.blacklistPatterns = buildUnnamed5183();
    o.displayName = "foo";
    o.maxQps = 42;
    o.name = "foo";
    o.schedule = buildSchedule();
    o.startingUrls = buildUnnamed5184();
    o.targetPlatforms = buildUnnamed5185();
    o.userAgent = "foo";
  }
  buildCounterScanConfig--;
  return o;
...
checkScanConfig(api.ScanConfig o) {
  ...
  if (buildCounterScanConfig < 3) {
    ...
    checkUnnamed5183(o.blacklistPatterns);
    unittest.expect(o.displayName, unittest.equals('foo'));
    unittest.expect(o.maxQps, unittest.equals(42));
    unittest.expect(o.name, unittest.equals('foo'));
    checkSchedule(o.schedule);
    checkUnnamed5184(o.startingUrls);
    checkUnnamed5185(o.targetPlatforms);
...
checkUnnamed5186(core.List<api.Header> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHeader(o[0]);
  checkHeader(o[1]);
}
...
checkUnnamed5187(core.List<api.Header> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHeader(o[0]);
  checkHeader(o[1]);
}
...
buildVulnerableHeaders() {
  ...
  if (buildCounterVulnerableHeaders < 3) {
    o.headers = buildUnnamed5186();
    o.missingHeaders = buildUnnamed5187();
  }
  buildCounterVulnerableHeaders--;
  return o;
}
...
checkVulnerableHeaders(api.VulnerableHeaders o) {
  buildCounterVulnerableHeaders++;
  if (buildCounterVulnerableHeaders < 3) {
    checkUnnamed5186(o.headers);
    checkUnnamed5187(o.missingHeaders);
  }
  buildCounterVulnerableHeaders--;
}
...
checkUnnamed5188(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
buildVulnerableParameters() {
  ...
  if (buildCounterVulnerableParameters < 3) {
    o.parameterNames = buildUnnamed5188();
  }
  buildCounterVulnerableParameters--;
  return o;
}
...
checkVulnerableParameters(api.VulnerableParameters o) {
  buildCounterVulnerableParameters++;
  if (buildCounterVulnerableParameters < 3) {
    checkUnnamed5188(o.parameterNames);
  }
  buildCounterVulnerableParameters--;
}
...
checkUnnamed5189(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
buildXss() {
  ...
  if (buildCounterXss < 3) {
    o.errorMessage = "foo";
    o.stackTraces = buildUnnamed5189();
  }
  buildCounterXss--;
  return o;
}
...
checkXss(api.Xss o) {
  ...
  if (buildCounterXss < 3) {
    ...
    checkUnnamed5189(o.stackTraces);
  }
  buildCounterXss--;
}
