...
api.AndroidInstrumentationTest buildAndroidInstrumentationTest() {
  ...
  if (buildCounterAndroidInstrumentationTest < 3) {
    ...
    o.testTargets = buildUnnamed8069();
...
void checkAndroidInstrumentationTest(api.AndroidInstrumentationTest o) {
  ...
  if (buildCounterAndroidInstrumentationTest < 3) {
    ...
    checkUnnamed8069(o.testTargets!);
...
core.List<api.PerfSample> buildUnnamed8070() => [
      buildPerfSample(),
      buildPerfSample(),
    ];

void checkUnnamed8070(core.List<api.PerfSample> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPerfSample(o[0]);
  checkPerfSample(o[1]);
}
...
api.BatchCreatePerfSamplesRequest buildBatchCreatePerfSamplesRequest() {
  ...
  if (buildCounterBatchCreatePerfSamplesRequest < 3) {
    o.perfSamples = buildUnnamed8070();
  }
  buildCounterBatchCreatePerfSamplesRequest--;
  return o;
}
...
void checkBatchCreatePerfSamplesRequest(api.BatchCreatePerfSamplesRequest o) {
  buildCounterBatchCreatePerfSamplesRequest++;
  if (buildCounterBatchCreatePerfSamplesRequest < 3) {
    checkUnnamed8070(o.perfSamples!);
  }
  buildCounterBatchCreatePerfSamplesRequest--;
}

core.List<api.PerfSample> buildUnnamed8071() => [
      buildPerfSample(),
      buildPerfSample(),
    ];

void checkUnnamed8071(core.List<api.PerfSample> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPerfSample(o[0]);
  checkPerfSample(o[1]);
}
...
api.BatchCreatePerfSamplesResponse buildBatchCreatePerfSamplesResponse() {
  ...
  if (buildCounterBatchCreatePerfSamplesResponse < 3) {
    o.perfSamples = buildUnnamed8071();
  }
  buildCounterBatchCreatePerfSamplesResponse--;
  return o;
}
...
void checkBatchCreatePerfSamplesResponse(api.BatchCreatePerfSamplesResponse o) {
  buildCounterBatchCreatePerfSamplesResponse++;
  if (buildCounterBatchCreatePerfSamplesResponse < 3) {
    checkUnnamed8071(o.perfSamples!);
  }
  buildCounterBatchCreatePerfSamplesResponse--;
}
...
void checkEncounteredNonAndroidUiWidgetScreen(
  ...
  if (buildCounterEncounteredNonAndroidUiWidgetScreen < 3) {
    ...
    checkUnnamed8073(o.screenIds!);
  }
  buildCounterEncounteredNonAndroidUiWidgetScreen--;
}

core.List<api.EnvironmentDimensionValueEntry> buildUnnamed8074() => [
      buildEnvironmentDimensionValueEntry(),
      buildEnvironmentDimensionValueEntry(),
    ];

void checkUnnamed8074(core.List<api.EnvironmentDimensionValueEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEnvironmentDimensionValueEntry(o[0]);
  checkEnvironmentDimensionValueEntry(o[1]);
}

core.List<api.ShardSummary> buildUnnamed8075() => [
      buildShardSummary(),
      buildShardSummary(),
    ];

void checkUnnamed8075(core.List<api.ShardSummary> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Environment buildEnvironment() {
  ...
  if (buildCounterEnvironment < 3) {
    ...
    o.dimensionValue = buildUnnamed8074();
    o.displayName = 'foo';
    o.environmentId = 'foo';
    ...
    o.shardSummaries = buildUnnamed8075();
  }
  buildCounterEnvironment--;
  return o;
}
...
void checkEnvironment(api.Environment o) {
  ...
  if (buildCounterEnvironment < 3) {
    ...
    checkUnnamed8074(o.dimensionValue!);
    unittest.expect(
      o.displayName!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed8075(o.shardSummaries!);
  }
  buildCounterEnvironment--;
}
...
core.List<api.MatrixDimensionDefinition> buildUnnamed8076() => [
      buildMatrixDimensionDefinition(),
      buildMatrixDimensionDefinition(),
    ];

void checkUnnamed8076(core.List<api.MatrixDimensionDefinition> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Execution buildExecution() {
  ...
  if (buildCounterExecution < 3) {
    o.completionTime = buildTimestamp();
    o.creationTime = buildTimestamp();
    o.dimensionDefinitions = buildUnnamed8076();
    o.executionId = 'foo';
...
void checkExecution(api.Execution o) {
  ...
  if (buildCounterExecution < 3) {
    checkTimestamp(o.completionTime!);
    checkTimestamp(o.creationTime!);
    checkUnnamed8076(o.dimensionDefinitions!);
    unittest.expect(
      o.executionId!,
      unittest.equals('foo'),
    );
...
core.List<api.GraphicsStatsBucket> buildUnnamed8077() => [
      buildGraphicsStatsBucket(),
      buildGraphicsStatsBucket(),
    ];

void checkUnnamed8077(core.List<api.GraphicsStatsBucket> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Environment> buildUnnamed8078() => [
      buildEnvironment(),
      buildEnvironment(),
    ];

void checkUnnamed8078(core.List<api.Environment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListEnvironmentsResponse buildListEnvironmentsResponse() {
  ...
  if (buildCounterListEnvironmentsResponse < 3) {
    o.environments = buildUnnamed8078();
    o.executionId = 'foo';
    o.historyId = 'foo';
    o.nextPageToken = 'foo';
    o.projectId = 'foo';
...
void checkListEnvironmentsResponse(api.ListEnvironmentsResponse o) {
  buildCounterListEnvironmentsResponse++;
  if (buildCounterListEnvironmentsResponse < 3) {
    checkUnnamed8078(o.environments!);
    unittest.expect(
      o.executionId!,
      unittest.equals('foo'),
    );
...
core.List<api.Execution> buildUnnamed8079() => [
      buildExecution(),
      buildExecution(),
    ];

void checkUnnamed8079(core.List<api.Execution> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkExecution(o[0]);
  checkExecution(o[1]);
}
...
core.List<api.History> buildUnnamed8080() => [
      buildHistory(),
      buildHistory(),
    ];

void checkUnnamed8080(core.List<api.History> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHistory(o[0]);
  checkHistory(o[1]);
}
...
core.List<api.PerfSampleSeries> buildUnnamed8081() => [
      buildPerfSampleSeries(),
      buildPerfSampleSeries(),
    ];

void checkUnnamed8081(core.List<api.PerfSampleSeries> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListPerfSampleSeriesResponse buildListPerfSampleSeriesResponse() {
  ...
  if (buildCounterListPerfSampleSeriesResponse < 3) {
    o.perfSampleSeries = buildUnnamed8081();
  }
  buildCounterListPerfSampleSeriesResponse--;
  return o;
}
...
void checkListPerfSampleSeriesResponse(api.ListPerfSampleSeriesResponse o) {
  buildCounterListPerfSampleSeriesResponse++;
  if (buildCounterListPerfSampleSeriesResponse < 3) {
    checkUnnamed8081(o.perfSampleSeries!);
  }
  buildCounterListPerfSampleSeriesResponse--;
}

core.List<api.PerfSample> buildUnnamed8082() => [
      buildPerfSample(),
      buildPerfSample(),
    ];

void checkUnnamed8082(core.List<api.PerfSample> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPerfSample(o[0]);
  checkPerfSample(o[1]);
}
...
api.ListPerfSamplesResponse buildListPerfSamplesResponse() {
  ...
  if (buildCounterListPerfSamplesResponse < 3) {
    o.nextPageToken = 'foo';
    o.perfSamples = buildUnnamed8082();
  }
  buildCounterListPerfSamplesResponse--;
  return o;
}
...
void checkListPerfSamplesResponse(api.ListPerfSamplesResponse o) {
  ...
  if (buildCounterListPerfSamplesResponse < 3) {
    ...
    checkUnnamed8082(o.perfSamples!);
  }
  buildCounterListPerfSamplesResponse--;
}

core.List<api.ScreenshotCluster> buildUnnamed8083() => [
      buildScreenshotCluster(),
      buildScreenshotCluster(),
    ];

void checkUnnamed8083(core.List<api.ScreenshotCluster> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListScreenshotClustersResponse(api.ListScreenshotClustersResponse o) {
  buildCounterListScreenshotClustersResponse++;
  if (buildCounterListScreenshotClustersResponse < 3) {
    checkUnnamed8083(o.clusters!);
  }
  buildCounterListScreenshotClustersResponse--;
}

core.List<api.SuggestionClusterProto> buildUnnamed8084() => [
      buildSuggestionClusterProto(),
      buildSuggestionClusterProto(),
    ];

void checkUnnamed8084(core.List<api.SuggestionClusterProto> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Image> buildUnnamed8085() => [
      buildImage(),
      buildImage(),
    ];

void checkUnnamed8085(core.List<api.Image> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkImage(o[0]);
  checkImage(o[1]);
}
...
void checkListStepThumbnailsResponse(api.ListStepThumbnailsResponse o) {
  ...
  if (buildCounterListStepThumbnailsResponse < 3) {
    ...
    checkUnnamed8085(o.thumbnails!);
  }
  buildCounterListStepThumbnailsResponse--;
}

core.List<api.Step> buildUnnamed8086() => [
      buildStep(),
      buildStep(),
    ];

void checkUnnamed8086(core.List<api.Step> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStep(o[0]);
  checkStep(o[1]);
}
...
void checkListStepsResponse(api.ListStepsResponse o) {
  ...
  if (buildCounterListStepsResponse < 3) {
    ...
    checkUnnamed8086(o.steps!);
  }
  buildCounterListStepsResponse--;
}

core.List<api.TestCase> buildUnnamed8087() => [
      buildTestCase(),
      buildTestCase(),
    ];

void checkUnnamed8087(core.List<api.TestCase> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTestCase(o[0]);
  checkTestCase(o[1]);
}
...
core.List<api.TestSuiteOverview> buildUnnamed8088() => [
      buildTestSuiteOverview(),
      buildTestSuiteOverview(),
    ];

void checkUnnamed8088(core.List<api.TestSuiteOverview> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MergedResult buildMergedResult() {
  ...
  if (buildCounterMergedResult < 3) {
    o.outcome = buildOutcome();
    o.state = 'foo';
    o.testSuiteOverviews = buildUnnamed8088();
  }
  buildCounterMergedResult--;
  return o;
}
...
void checkMergedResult(api.MergedResult o) {
  ...
  if (buildCounterMergedResult < 3) {
    ...
    checkUnnamed8088(o.testSuiteOverviews!);
  }
  buildCounterMergedResult--;
}
...
core.List<api.NonSdkApiInsight> buildUnnamed8090() => [
      buildNonSdkApiInsight(),
      buildNonSdkApiInsight(),
    ];

void checkUnnamed8090(core.List<api.NonSdkApiInsight> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.NonSdkApi buildNonSdkApi() {
  ...
  if (buildCounterNonSdkApi < 3) {
    o.apiSignature = 'foo';
    o.exampleStackTraces = buildUnnamed8089();
    o.insights = buildUnnamed8090();
...
void checkNonSdkApi(api.NonSdkApi o) {
  ...
  if (buildCounterNonSdkApi < 3) {
    ...
    checkUnnamed8089(o.exampleStackTraces!);
    checkUnnamed8090(o.insights!);
    unittest.expect(
      o.invocationCount!,
      unittest.equals(42),
    );
...
api.NonSdkApiInsight buildNonSdkApiInsight() {
  ...
  if (buildCounterNonSdkApiInsight < 3) {
    o.exampleTraceMessages = buildUnnamed8091();
    o.matcherId = 'foo';
...
void checkNonSdkApiInsight(api.NonSdkApiInsight o) {
  buildCounterNonSdkApiInsight++;
  if (buildCounterNonSdkApiInsight < 3) {
    checkUnnamed8091(o.exampleTraceMessages!);
    unittest.expect(
      o.matcherId!,
      unittest.equals('foo'),
    );
...
api.NonSdkApiUsageViolation buildNonSdkApiUsageViolation() {
  ...
  if (buildCounterNonSdkApiUsageViolation < 3) {
    o.apiSignatures = buildUnnamed8092();
    o.uniqueApis = 42;
  }
  buildCounterNonSdkApiUsageViolation--;
  return o;
...
void checkNonSdkApiUsageViolation(api.NonSdkApiUsageViolation o) {
  buildCounterNonSdkApiUsageViolation++;
  if (buildCounterNonSdkApiUsageViolation < 3) {
    checkUnnamed8092(o.apiSignatures!);
    unittest.expect(
      o.uniqueApis!,
      unittest.equals(42),
    );
...
core.List<api.NonSdkApi> buildUnnamed8093() => [
      buildNonSdkApi(),
      buildNonSdkApi(),
    ];

void checkUnnamed8093(core.List<api.NonSdkApi> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNonSdkApi(o[0]);
  checkNonSdkApi(o[1]);
}
...
api.NonSdkApiUsageViolationReport buildNonSdkApiUsageViolationReport() {
  ...
  if (buildCounterNonSdkApiUsageViolationReport < 3) {
    o.exampleApis = buildUnnamed8093();
    o.minSdkVersion = 42;
...
void checkNonSdkApiUsageViolationReport(api.NonSdkApiUsageViolationReport o) {
  buildCounterNonSdkApiUsageViolationReport++;
  if (buildCounterNonSdkApiUsageViolationReport < 3) {
    checkUnnamed8093(o.exampleApis!);
    unittest.expect(
      o.minSdkVersion!,
      unittest.equals(42),
    );
...
api.OverlappingUIElements buildOverlappingUIElements() {
  ...
  if (buildCounterOverlappingUIElements < 3) {
    o.resourceName = buildUnnamed8094();
    o.screenId = 'foo';
  }
  buildCounterOverlappingUIElements--;
  return o;
...
void checkOverlappingUIElements(api.OverlappingUIElements o) {
  buildCounterOverlappingUIElements++;
  if (buildCounterOverlappingUIElements < 3) {
    checkUnnamed8094(o.resourceName!);
    unittest.expect(
      o.screenId!,
      unittest.equals('foo'),
    );
...
api.PerfMetricsSummary buildPerfMetricsSummary() {
  ...
  if (buildCounterPerfMetricsSummary < 3) {
    ...
    o.perfMetrics = buildUnnamed8095();
    o.projectId = 'foo';
    o.stepId = 'foo';
  }
  buildCounterPerfMetricsSummary--;
...
void checkPerfMetricsSummary(api.PerfMetricsSummary o) {
  ...
  if (buildCounterPerfMetricsSummary < 3) {
    ...
    checkUnnamed8095(o.perfMetrics!);
    unittest.expect(
      o.projectId!,
      unittest.equals('foo'),
    );
...
core.List<api.IndividualOutcome> buildUnnamed8096() => [
      buildIndividualOutcome(),
      buildIndividualOutcome(),
    ];

void checkUnnamed8096(core.List<api.IndividualOutcome> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PrimaryStep buildPrimaryStep() {
  ...
  if (buildCounterPrimaryStep < 3) {
    o.individualOutcome = buildUnnamed8096();
    o.rollUp = 'foo';
  }
  buildCounterPrimaryStep--;
  return o;
...
void checkPrimaryStep(api.PrimaryStep o) {
  buildCounterPrimaryStep++;
  if (buildCounterPrimaryStep < 3) {
    checkUnnamed8096(o.individualOutcome!);
    unittest.expect(
      o.rollUp!,
      unittest.equals('foo'),
    );
...
core.List<api.FileReference> buildUnnamed8097() => [
      buildFileReference(),
      buildFileReference(),
    ];

void checkUnnamed8097(core.List<api.FileReference> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.PublishXunitXmlFilesRequest buildPublishXunitXmlFilesRequest() {
  ...
  if (buildCounterPublishXunitXmlFilesRequest < 3) {
    o.xunitXmlFiles = buildUnnamed8097();
  }
  buildCounterPublishXunitXmlFilesRequest--;
  return o;
}
...
void checkPublishXunitXmlFilesRequest(api.PublishXunitXmlFilesRequest o) {
  buildCounterPublishXunitXmlFilesRequest++;
  if (buildCounterPublishXunitXmlFilesRequest < 3) {
    checkUnnamed8097(o.xunitXmlFiles!);
  }
  buildCounterPublishXunitXmlFilesRequest--;
}
...
core.List<api.Screen> buildUnnamed8098() => [
      buildScreen(),
      buildScreen(),
    ];

void checkUnnamed8098(core.List<api.Screen> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkScreen(o[0]);
  checkScreen(o[1]);
}
...
void checkScreenshotCluster(api.ScreenshotCluster o) {
  ...
  if (buildCounterScreenshotCluster < 3) {
    ...
    checkUnnamed8098(o.screens!);
  }
  buildCounterScreenshotCluster--;
}

core.List<api.StepSummary> buildUnnamed8099() => [
      buildStepSummary(),
      buildStepSummary(),
    ];

void checkUnnamed8099(core.List<api.StepSummary> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed8100() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed8100(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed8101() => [
      buildUnnamed8100(),
      buildUnnamed8100(),
    ];

void checkUnnamed8101(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed8100(o[0]);
  checkUnnamed8100(o[1]);
}
...
core.List<api.StepDimensionValueEntry> buildUnnamed8102() => [
      buildStepDimensionValueEntry(),
      buildStepDimensionValueEntry(),
    ];

void checkUnnamed8102(core.List<api.StepDimensionValueEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStepDimensionValueEntry(o[0]);
  checkStepDimensionValueEntry(o[1]);
}

core.List<api.StepLabelsEntry> buildUnnamed8103() => [
      buildStepLabelsEntry(),
      buildStepLabelsEntry(),
    ];

void checkUnnamed8103(core.List<api.StepLabelsEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Step buildStep() {
  ...
  if (buildCounterStep < 3) {
    ...
    o.dimensionValue = buildUnnamed8102();
    o.hasImages = true;
    o.labels = buildUnnamed8103();
...
void checkStep(api.Step o) {
  ...
  if (buildCounterStep < 3) {
    ...
    checkUnnamed8102(o.dimensionValue!);
    unittest.expect(o.hasImages!, unittest.isTrue);
    checkUnnamed8103(o.labels!);
...
core.List<api.SuggestionProto> buildUnnamed8104() => [
      buildSuggestionProto(),
      buildSuggestionProto(),
    ];

void checkUnnamed8104(core.List<api.SuggestionProto> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SuggestionClusterProto buildSuggestionClusterProto() {
  ...
  if (buildCounterSuggestionClusterProto < 3) {
    o.category = 'foo';
    o.suggestions = buildUnnamed8104();
  }
  buildCounterSuggestionClusterProto--;
  return o;
}
...
void checkSuggestionClusterProto(api.SuggestionClusterProto o) {
  ...
  if (buildCounterSuggestionClusterProto < 3) {
    ...
    checkUnnamed8104(o.suggestions!);
  }
  buildCounterSuggestionClusterProto--;
}
...
core.List<api.StackTrace> buildUnnamed8105() => [
      buildStackTrace(),
      buildStackTrace(),
    ];

void checkUnnamed8105(core.List<api.StackTrace> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStackTrace(o[0]);
  checkStackTrace(o[1]);
}

core.List<api.ToolOutputReference> buildUnnamed8106() => [
      buildToolOutputReference(),
      buildToolOutputReference(),
    ];

void checkUnnamed8106(core.List<api.ToolOutputReference> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkTestCase(api.TestCase o) {
  ...
  if (buildCounterTestCase < 3) {
    ...
    checkUnnamed8105(o.stackTraces!);
    ...
    checkUnnamed8106(o.toolOutputs!);
  }
  buildCounterTestCase--;
}
...
core.List<api.TestIssue> buildUnnamed8107() => [
      buildTestIssue(),
      buildTestIssue(),
    ];

void checkUnnamed8107(core.List<api.TestIssue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTestIssue(o[0]);
  checkTestIssue(o[1]);
}

core.List<api.TestSuiteOverview> buildUnnamed8108() => [
      buildTestSuiteOverview(),
      buildTestSuiteOverview(),
    ];

void checkUnnamed8108(core.List<api.TestSuiteOverview> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTestSuiteOverview(o[0]);
  checkTestSuiteOverview(o[1]);
}
...
api.TestExecutionStep buildTestExecutionStep() {
  ...
  if (buildCounterTestExecutionStep < 3) {
    o.testIssues = buildUnnamed8107();
    o.testSuiteOverviews = buildUnnamed8108();
...
void checkTestExecutionStep(api.TestExecutionStep o) {
  buildCounterTestExecutionStep++;
  if (buildCounterTestExecutionStep < 3) {
    checkUnnamed8107(o.testIssues!);
    checkUnnamed8108(o.testSuiteOverviews!);
...
core.List<api.FileReference> buildUnnamed8110() => [
      buildFileReference(),
      buildFileReference(),
    ];

void checkUnnamed8110(core.List<api.FileReference> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFileReference(o[0]);
  checkFileReference(o[1]);
}

core.List<api.ToolOutputReference> buildUnnamed8111() => [
      buildToolOutputReference(),
      buildToolOutputReference(),
    ];

void checkUnnamed8111(core.List<api.ToolOutputReference> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkToolOutputReference(o[0]);
  checkToolOutputReference(o[1]);
}
...
api.ToolExecution buildToolExecution() {
  ...
  if (buildCounterToolExecution < 3) {
    o.commandLineArguments = buildUnnamed8109();
    o.exitCode = buildToolExitCode();
    o.toolLogs = buildUnnamed8110();
    o.toolOutputs = buildUnnamed8111();
  }
  buildCounterToolExecution--;
  return o;
}
...
void checkToolExecution(api.ToolExecution o) {
  buildCounterToolExecution++;
  if (buildCounterToolExecution < 3) {
    checkUnnamed8109(o.commandLineArguments!);
    checkToolExitCode(o.exitCode!);
    checkUnnamed8110(o.toolLogs!);
    checkUnnamed8111(o.toolOutputs!);
  }
  buildCounterToolExecution--;
}
...
void main() {
  ...
  unittest.group(
    ...
    unittest.test('method--list', () async {
      ...
      final arg_executionId = 'foo';
      final arg_stepId = 'foo';
      final arg_filter = buildUnnamed8112();
      final arg_$fields = 'foo';
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        final path = (req.url).path;
        var pathOffset = 0;
