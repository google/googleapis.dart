...
checkUnnamed4047(core.List<api.AuditLogConfig> o) {
...
buildAuditConfig() {
  ...
  if (buildCounterAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed4047();
    o.service = "foo";
  }
  buildCounterAuditConfig--;
  return o;
...
checkAuditConfig(api.AuditConfig o) {
  buildCounterAuditConfig++;
  if (buildCounterAuditConfig < 3) {
    checkUnnamed4047(o.auditLogConfigs);
...
buildAuditLogConfig() {
  ...
  if (buildCounterAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed4048();
    o.logType = "foo";
  }
  buildCounterAuditLogConfig--;
  return o;
...
checkAuditLogConfig(api.AuditLogConfig o) {
  buildCounterAuditLogConfig++;
  if (buildCounterAuditLogConfig < 3) {
    checkUnnamed4048(o.exemptedMembers);
...
checkUnnamed4050(core.List<api.Ancestor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAncestor(o[0]);
  checkAncestor(o[1]);
}
...
checkUnnamed4051(core.List<api.Organization> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListOrganizationsResponse() {
  ...
  if (buildCounterListOrganizationsResponse < 3) {
    o.nextPageToken = "foo";
    o.organizations = buildUnnamed4051();
  }
  buildCounterListOrganizationsResponse--;
  return o;
}
...
checkListOrganizationsResponse(api.ListOrganizationsResponse o) {
  ...
  if (buildCounterListOrganizationsResponse < 3) {
    ...
    checkUnnamed4051(o.organizations);
  }
  buildCounterListOrganizationsResponse--;
}
...
checkUnnamed4052(core.List<api.Project> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProject(o[0]);
  checkProject(o[1]);
}
...
checkUnnamed4053(core.List<api.AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4054(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.auditConfigs = buildUnnamed4053();
    o.bindings = buildUnnamed4054();
    o.etag = "foo";
    o.version = 42;
  }
  buildCounterPolicy--;
...
checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed4053(o.auditConfigs);
    checkUnnamed4054(o.bindings);
...
checkUnnamed4055(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildTestIamPermissionsRequest() {
  ...
  if (buildCounterTestIamPermissionsRequest < 3) {
    o.permissions = buildUnnamed4056();
  }
  buildCounterTestIamPermissionsRequest--;
  return o;
}
...
checkTestIamPermissionsRequest(api.TestIamPermissionsRequest o) {
  buildCounterTestIamPermissionsRequest++;
  if (buildCounterTestIamPermissionsRequest < 3) {
    checkUnnamed4056(o.permissions);
  }
  buildCounterTestIamPermissionsRequest--;
}
...
buildTestIamPermissionsResponse() {
  ...
  if (buildCounterTestIamPermissionsResponse < 3) {
    o.permissions = buildUnnamed4057();
  }
  buildCounterTestIamPermissionsResponse--;
  return o;
}
...
checkTestIamPermissionsResponse(api.TestIamPermissionsResponse o) {
  buildCounterTestIamPermissionsResponse++;
  if (buildCounterTestIamPermissionsResponse < 3) {
    checkUnnamed4057(o.permissions);
  }
  buildCounterTestIamPermissionsResponse--;
}
