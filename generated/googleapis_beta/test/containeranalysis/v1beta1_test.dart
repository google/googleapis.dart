...
api.ArtifactRule buildArtifactRule() {
  ...
  if (buildCounterArtifactRule < 3) {
    o.artifactRule = buildUnnamed8423();
  }
  buildCounterArtifactRule--;
  return o;
}
...
void checkArtifactRule(api.ArtifactRule o) {
  buildCounterArtifactRule++;
  if (buildCounterArtifactRule < 3) {
    checkUnnamed8423(o.artifactRule!);
  }
  buildCounterArtifactRule--;
}
...
core.Map<core.String, api.Note> buildUnnamed8424() => {
      'x': buildNote(),
      'y': buildNote(),
    };

void checkUnnamed8424(core.Map<core.String, api.Note> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNote(o['x']!);
  checkNote(o['y']!);
}
...
void checkBatchCreateNotesRequest(api.BatchCreateNotesRequest o) {
  buildCounterBatchCreateNotesRequest++;
  if (buildCounterBatchCreateNotesRequest < 3) {
    checkUnnamed8424(o.notes!);
  }
  buildCounterBatchCreateNotesRequest--;
}

core.List<api.Note> buildUnnamed8425() => [
      buildNote(),
      buildNote(),
    ];

void checkUnnamed8425(core.List<api.Note> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNote(o[0]);
  checkNote(o[1]);
}
...
void checkBatchCreateNotesResponse(api.BatchCreateNotesResponse o) {
  buildCounterBatchCreateNotesResponse++;
  if (buildCounterBatchCreateNotesResponse < 3) {
    checkUnnamed8425(o.notes!);
  }
  buildCounterBatchCreateNotesResponse--;
}

core.List<api.Occurrence> buildUnnamed8426() => [
      buildOccurrence(),
      buildOccurrence(),
    ];

void checkUnnamed8426(core.List<api.Occurrence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOccurrence(o[0]);
  checkOccurrence(o[1]);
}
...
api.BatchCreateOccurrencesRequest buildBatchCreateOccurrencesRequest() {
  ...
  if (buildCounterBatchCreateOccurrencesRequest < 3) {
    o.occurrences = buildUnnamed8426();
  }
  buildCounterBatchCreateOccurrencesRequest--;
  return o;
}
...
void checkBatchCreateOccurrencesRequest(api.BatchCreateOccurrencesRequest o) {
  buildCounterBatchCreateOccurrencesRequest++;
  if (buildCounterBatchCreateOccurrencesRequest < 3) {
    checkUnnamed8426(o.occurrences!);
  }
  buildCounterBatchCreateOccurrencesRequest--;
}
...
api.BatchCreateOccurrencesResponse buildBatchCreateOccurrencesResponse() {
  ...
  if (buildCounterBatchCreateOccurrencesResponse < 3) {
    o.occurrences = buildUnnamed8427();
  }
  buildCounterBatchCreateOccurrencesResponse--;
  return o;
}
...
void checkBatchCreateOccurrencesResponse(api.BatchCreateOccurrencesResponse o) {
  buildCounterBatchCreateOccurrencesResponse++;
  if (buildCounterBatchCreateOccurrencesResponse < 3) {
    checkUnnamed8427(o.occurrences!);
  }
  buildCounterBatchCreateOccurrencesResponse--;
}
...
core.Map<core.String, core.String> buildUnnamed8429() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed8429(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<api.Artifact> buildUnnamed8430() => [
      buildArtifact(),
      buildArtifact(),
    ];

void checkUnnamed8430(core.List<api.Artifact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkArtifact(o[0]);
  checkArtifact(o[1]);
}

core.List<api.Command> buildUnnamed8431() => [
      buildCommand(),
      buildCommand(),
    ];

void checkUnnamed8431(core.List<api.Command> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCommand(o[0]);
  checkCommand(o[1]);
}
...
api.BuildProvenance buildBuildProvenance() {
  ...
  if (buildCounterBuildProvenance < 3) {
    o.buildOptions = buildUnnamed8429();
    o.builderVersion = 'foo';
    o.builtArtifacts = buildUnnamed8430();
    o.commands = buildUnnamed8431();
    o.createTime = 'foo';
    o.creator = 'foo';
    o.endTime = 'foo';
    o.id = 'foo';
...
void checkBuildProvenance(api.BuildProvenance o) {
  buildCounterBuildProvenance++;
  if (buildCounterBuildProvenance < 3) {
    checkUnnamed8429(o.buildOptions!);
    unittest.expect(
      o.builderVersion!,
      unittest.equals('foo'),
    );
    checkUnnamed8430(o.builtArtifacts!);
    checkUnnamed8431(o.commands!);
    unittest.expect(
      o.createTime!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.String> buildUnnamed8432() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed8432(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.ByProducts buildByProducts() {
  ...
  if (buildCounterByProducts < 3) {
    o.customValues = buildUnnamed8432();
  }
  buildCounterByProducts--;
  return o;
}
...
void checkByProducts(api.ByProducts o) {
  buildCounterByProducts++;
  if (buildCounterByProducts < 3) {
    checkUnnamed8432(o.customValues!);
  }
  buildCounterByProducts--;
}
...
api.Command buildCommand() {
  ...
  if (buildCounterCommand < 3) {
    o.args = buildUnnamed8433();
    o.dir = 'foo';
    o.env = buildUnnamed8434();
    o.id = 'foo';
    o.name = 'foo';
    o.waitFor = buildUnnamed8435();
  }
  buildCounterCommand--;
  return o;
}
...
void checkCommand(api.Command o) {
  buildCounterCommand++;
  if (buildCounterCommand < 3) {
    checkUnnamed8433(o.args!);
    unittest.expect(
      o.dir!,
      unittest.equals('foo'),
    );
    checkUnnamed8434(o.env!);
    unittest.expect(
      o.id!,
      unittest.equals('foo'),
    );
...
api.Deployable buildDeployable() {
  ...
  if (buildCounterDeployable < 3) {
    o.resourceUri = buildUnnamed8436();
  }
  buildCounterDeployable--;
  return o;
}
...
void checkDeployable(api.Deployable o) {
  buildCounterDeployable++;
  if (buildCounterDeployable < 3) {
    checkUnnamed8436(o.resourceUri!);
  }
  buildCounterDeployable--;
}

core.List<core.String> buildUnnamed8437() => [
      'foo',
      'foo',
    ];

void checkUnnamed8437(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.Deployment buildDeployment() {
  ...
  if (buildCounterDeployment < 3) {
    ...
    o.deployTime = 'foo';
    o.platform = 'foo';
    o.resourceUri = buildUnnamed8437();
    o.undeployTime = 'foo';
    o.userEmail = 'foo';
  }
  buildCounterDeployment--;
...
void checkDeployment(api.Deployment o) {
  ...
  if (buildCounterDeployment < 3) {
    ...
    checkUnnamed8437(o.resourceUri!);
    unittest.expect(
      o.undeployTime!,
      unittest.equals('foo'),
    );
...
core.List<api.Layer> buildUnnamed8438() => [
      buildLayer(),
      buildLayer(),
    ];

void checkUnnamed8438(core.List<api.Layer> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLayer(o[0]);
  checkLayer(o[1]);
}
...
core.Map<core.String, core.String> buildUnnamed8439() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed8439(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.Environment buildEnvironment() {
  ...
  if (buildCounterEnvironment < 3) {
    o.customValues = buildUnnamed8439();
  }
  buildCounterEnvironment--;
  return o;
}
...
void checkEnvironment(api.Environment o) {
  buildCounterEnvironment++;
  if (buildCounterEnvironment < 3) {
    checkUnnamed8439(o.customValues!);
  }
  buildCounterEnvironment--;
}
...
core.List<api.Hash> buildUnnamed8440() => [
      buildHash(),
      buildHash(),
    ];

void checkUnnamed8440(core.List<api.Hash> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHash(o[0]);
  checkHash(o[1]);
}
...
core.List<api.Signature> buildUnnamed8442() => [
      buildSignature(),
      buildSignature(),
    ];

void checkUnnamed8442(core.List<api.Signature> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSignature(o[0]);
  checkSignature(o[1]);
}
...
core.List<api.GrafeasV1beta1IntotoSignature> buildUnnamed8443() => [
      buildGrafeasV1beta1IntotoSignature(),
      buildGrafeasV1beta1IntotoSignature(),
    ];

void checkUnnamed8443(core.List<api.GrafeasV1beta1IntotoSignature> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.PackageIssue> buildUnnamed8444() => [
      buildPackageIssue(),
      buildPackageIssue(),
    ];

void checkUnnamed8444(core.List<api.PackageIssue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPackageIssue(o[0]);
  checkPackageIssue(o[1]);
}

core.List<api.RelatedUrl> buildUnnamed8445() => [
      buildRelatedUrl(),
      buildRelatedUrl(),
    ];

void checkUnnamed8445(core.List<api.RelatedUrl> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRelatedUrl(o[0]);
  checkRelatedUrl(o[1]);
}
...
api.GrafeasV1beta1VulnerabilityDetails
  ...
  if (buildCounterGrafeasV1beta1VulnerabilityDetails < 3) {
    ...
    o.packageIssue = buildUnnamed8444();
    o.relatedUrls = buildUnnamed8445();
    o.severity = 'foo';
...
void checkGrafeasV1beta1VulnerabilityDetails(
  ...
  if (buildCounterGrafeasV1beta1VulnerabilityDetails < 3) {
    ...
    checkUnnamed8444(o.packageIssue!);
    checkUnnamed8445(o.relatedUrls!);
    unittest.expect(
      o.severity!,
      unittest.equals('foo'),
    );
...
core.List<api.ArtifactRule> buildUnnamed8447() => [
      buildArtifactRule(),
      buildArtifactRule(),
    ];

void checkUnnamed8447(core.List<api.ArtifactRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkArtifactRule(o[0]);
  checkArtifactRule(o[1]);
}

core.List<api.ArtifactRule> buildUnnamed8448() => [
      buildArtifactRule(),
      buildArtifactRule(),
    ];

void checkUnnamed8448(core.List<api.ArtifactRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkArtifactRule(o[0]);
  checkArtifactRule(o[1]);
}

core.List<api.SigningKey> buildUnnamed8449() => [
      buildSigningKey(),
      buildSigningKey(),
    ];

void checkUnnamed8449(core.List<api.SigningKey> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSigningKey(o[0]);
  checkSigningKey(o[1]);
}
...
api.InToto buildInToto() {
  ...
  if (buildCounterInToto < 3) {
    o.expectedCommand = buildUnnamed8446();
    o.expectedMaterials = buildUnnamed8447();
    o.expectedProducts = buildUnnamed8448();
    o.signingKeys = buildUnnamed8449();
    o.stepName = 'foo';
    o.threshold = 'foo';
  }
  buildCounterInToto--;
...
void checkInToto(api.InToto o) {
  buildCounterInToto++;
  if (buildCounterInToto < 3) {
    checkUnnamed8446(o.expectedCommand!);
    checkUnnamed8447(o.expectedMaterials!);
    checkUnnamed8448(o.expectedProducts!);
    checkUnnamed8449(o.signingKeys!);
    unittest.expect(
      o.stepName!,
      unittest.equals('foo'),
    );
...
core.List<api.Location> buildUnnamed8450() => [
      buildLocation(),
      buildLocation(),
    ];

void checkUnnamed8450(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
core.List<api.GrafeasV1beta1IntotoArtifact> buildUnnamed8452() => [
      buildGrafeasV1beta1IntotoArtifact(),
      buildGrafeasV1beta1IntotoArtifact(),
    ];

void checkUnnamed8452(core.List<api.GrafeasV1beta1IntotoArtifact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGrafeasV1beta1IntotoArtifact(o[0]);
  checkGrafeasV1beta1IntotoArtifact(o[1]);
}

core.List<api.GrafeasV1beta1IntotoArtifact> buildUnnamed8453() => [
      buildGrafeasV1beta1IntotoArtifact(),
      buildGrafeasV1beta1IntotoArtifact(),
    ];

void checkUnnamed8453(core.List<api.GrafeasV1beta1IntotoArtifact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGrafeasV1beta1IntotoArtifact(o[0]);
  checkGrafeasV1beta1IntotoArtifact(o[1]);
}
...
api.Link buildLink() {
  ...
  if (buildCounterLink < 3) {
    ...
    o.command = buildUnnamed8451();
    o.environment = buildEnvironment();
    o.materials = buildUnnamed8452();
    o.products = buildUnnamed8453();
  }
  buildCounterLink--;
  return o;
}
...
void checkLink(api.Link o) {
  ...
  if (buildCounterLink < 3) {
    ...
    checkUnnamed8451(o.command!);
    checkEnvironment(o.environment!);
    checkUnnamed8452(o.materials!);
    checkUnnamed8453(o.products!);
  }
  buildCounterLink--;
}

core.List<api.Occurrence> buildUnnamed8454() => [
      buildOccurrence(),
      buildOccurrence(),
    ];

void checkUnnamed8454(core.List<api.Occurrence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOccurrence(o[0]);
  checkOccurrence(o[1]);
}
...
api.ListNoteOccurrencesResponse buildListNoteOccurrencesResponse() {
  ...
  if (buildCounterListNoteOccurrencesResponse < 3) {
    o.nextPageToken = 'foo';
    o.occurrences = buildUnnamed8454();
  }
  buildCounterListNoteOccurrencesResponse--;
  return o;
}
...
void checkListNoteOccurrencesResponse(api.ListNoteOccurrencesResponse o) {
  ...
  if (buildCounterListNoteOccurrencesResponse < 3) {
    ...
    checkUnnamed8454(o.occurrences!);
  }
  buildCounterListNoteOccurrencesResponse--;
}

core.List<api.Note> buildUnnamed8455() => [
      buildNote(),
      buildNote(),
    ];

void checkUnnamed8455(core.List<api.Note> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNote(o[0]);
  checkNote(o[1]);
}
...
void checkListNotesResponse(api.ListNotesResponse o) {
  ...
  if (buildCounterListNotesResponse < 3) {
    ...
    checkUnnamed8455(o.notes!);
  }
  buildCounterListNotesResponse--;
}

core.List<api.Occurrence> buildUnnamed8456() => [
      buildOccurrence(),
      buildOccurrence(),
    ];

void checkUnnamed8456(core.List<api.Occurrence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOccurrence(o[0]);
  checkOccurrence(o[1]);
}
...
api.ListOccurrencesResponse buildListOccurrencesResponse() {
  ...
  if (buildCounterListOccurrencesResponse < 3) {
    o.nextPageToken = 'foo';
    o.occurrences = buildUnnamed8456();
  }
  buildCounterListOccurrencesResponse--;
  return o;
}
...
void checkListOccurrencesResponse(api.ListOccurrencesResponse o) {
  ...
  if (buildCounterListOccurrencesResponse < 3) {
    ...
    checkUnnamed8456(o.occurrences!);
  }
  buildCounterListOccurrencesResponse--;
}

core.List<api.ScanConfig> buildUnnamed8457() => [
      buildScanConfig(),
      buildScanConfig(),
    ];

void checkUnnamed8457(core.List<api.ScanConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkScanConfig(o[0]);
  checkScanConfig(o[1]);
}
...
api.ListScanConfigsResponse buildListScanConfigsResponse() {
  ...
  if (buildCounterListScanConfigsResponse < 3) {
    o.nextPageToken = 'foo';
    o.scanConfigs = buildUnnamed8457();
  }
  buildCounterListScanConfigsResponse--;
  return o;
}
...
void checkListScanConfigsResponse(api.ListScanConfigsResponse o) {
  ...
  if (buildCounterListScanConfigsResponse < 3) {
    ...
    checkUnnamed8457(o.scanConfigs!);
  }
  buildCounterListScanConfigsResponse--;
}
...
core.List<api.RelatedUrl> buildUnnamed8459() => [
      buildRelatedUrl(),
      buildRelatedUrl(),
    ];

void checkUnnamed8459(core.List<api.RelatedUrl> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRelatedUrl(o[0]);
  checkRelatedUrl(o[1]);
}
...
api.Note buildNote() {
  ...
  if (buildCounterNote < 3) {
    ...
    o.relatedNoteNames = buildUnnamed8458();
    o.relatedUrl = buildUnnamed8459();
    o.shortDescription = 'foo';
    o.updateTime = 'foo';
...
void checkNote(api.Note o) {
  ...
  if (buildCounterNote < 3) {
    ...
    checkUnnamed8458(o.relatedNoteNames!);
    checkUnnamed8459(o.relatedUrl!);
    unittest.expect(
      o.shortDescription!,
      unittest.equals('foo'),
    );
...
core.List<api.Distribution> buildUnnamed8460() => [
      buildDistribution(),
      buildDistribution(),
    ];

void checkUnnamed8460(core.List<api.Distribution> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Package buildPackage() {
  ...
  if (buildCounterPackage < 3) {
    o.distribution = buildUnnamed8460();
    o.name = 'foo';
  }
  buildCounterPackage--;
  return o;
...
void checkPackage(api.Package o) {
  buildCounterPackage++;
  if (buildCounterPackage < 3) {
    checkUnnamed8460(o.distribution!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
core.List<api.Binding> buildUnnamed8461() => [
      buildBinding(),
      buildBinding(),
    ];

void checkUnnamed8461(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
core.List<api.SourceContext> buildUnnamed8462() => [
      buildSourceContext(),
      buildSourceContext(),
    ];

void checkUnnamed8462(core.List<api.SourceContext> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSourceContext(o[0]);
  checkSourceContext(o[1]);
}

core.Map<core.String, api.FileHashes> buildUnnamed8463() => {
      'x': buildFileHashes(),
      'y': buildFileHashes(),
    };

void checkUnnamed8463(core.Map<core.String, api.FileHashes> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFileHashes(o['x']!);
  checkFileHashes(o['y']!);
}
...
api.Source buildSource() {
  ...
  if (buildCounterSource < 3) {
    o.additionalContexts = buildUnnamed8462();
    o.artifactStorageSourceUri = 'foo';
    o.context = buildSourceContext();
    o.fileHashes = buildUnnamed8463();
  }
  buildCounterSource--;
  return o;
}
...
void checkSource(api.Source o) {
  buildCounterSource++;
  if (buildCounterSource < 3) {
    checkUnnamed8462(o.additionalContexts!);
    unittest.expect(
      o.artifactStorageSourceUri!,
      unittest.equals('foo'),
    );
    checkSourceContext(o.context!);
    checkUnnamed8463(o.fileHashes!);
  }
  buildCounterSource--;
}

core.Map<core.String, core.String> buildUnnamed8464() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed8464(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
core.List<core.Map<core.String, core.Object>> buildUnnamed8466() => [
      buildUnnamed8465(),
      buildUnnamed8465(),
    ];

void checkUnnamed8466(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed8465(o[0]);
  checkUnnamed8465(o[1]);
}
...
core.List<api.Detail> buildUnnamed8469() => [
      buildDetail(),
      buildDetail(),
    ];

void checkUnnamed8469(core.List<api.Detail> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDetail(o[0]);
  checkDetail(o[1]);
}

core.List<api.WindowsDetail> buildUnnamed8470() => [
      buildWindowsDetail(),
      buildWindowsDetail(),
    ];

void checkUnnamed8470(core.List<api.WindowsDetail> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Vulnerability buildVulnerability() {
  ...
  if (buildCounterVulnerability < 3) {
    ...
    o.details = buildUnnamed8469();
    o.severity = 'foo';
    o.sourceUpdateTime = 'foo';
    o.windowsDetails = buildUnnamed8470();
  }
  buildCounterVulnerability--;
  return o;
}
...
void checkVulnerability(api.Vulnerability o) {
  ...
  if (buildCounterVulnerability < 3) {
    ...
    checkUnnamed8470(o.windowsDetails!);
  }
  buildCounterVulnerability--;
}
...
core.List<api.FixableTotalByDigest> buildUnnamed8471() => [
      buildFixableTotalByDigest(),
      buildFixableTotalByDigest(),
    ];

void checkUnnamed8471(core.List<api.FixableTotalByDigest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkVulnerabilityOccurrencesSummary(
  ...
  buildCounterVulnerabilityOccurrencesSummary++;
  if (buildCounterVulnerabilityOccurrencesSummary < 3) {
    checkUnnamed8471(o.counts!);
  }
  buildCounterVulnerabilityOccurrencesSummary--;
}

core.List<api.KnowledgeBase> buildUnnamed8472() => [
      buildKnowledgeBase(),
      buildKnowledgeBase(),
    ];

void checkUnnamed8472(core.List<api.KnowledgeBase> o) {
  unittest.expect(o, unittest.hasLength(2));
