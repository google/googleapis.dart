library googleapis_beta.texttospeech.v1beta1.test;
...
import 'package:googleapis_beta/texttospeech/v1beta1.dart' as api;
...
checkUnnamed5190(core.List<core.String> o) {
...
buildAudioConfig() {
  ...
  if (buildCounterAudioConfig < 3) {
    o.audioEncoding = "foo";
    o.effectsProfileId = buildUnnamed5190();
    o.pitch = 42.0;
...
checkAudioConfig(api.AudioConfig o) {
  ...
  if (buildCounterAudioConfig < 3) {
    ...
    checkUnnamed5190(o.effectsProfileId);
...
checkUnnamed5191(core.List<api.Voice> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVoice(o[0]);
  checkVoice(o[1]);
}
...
buildVoice() {
  ...
  if (buildCounterVoice < 3) {
    o.languageCodes = buildUnnamed5192();
    o.name = "foo";
...
checkVoice(api.Voice o) {
  buildCounterVoice++;
  if (buildCounterVoice < 3) {
    checkUnnamed5192(o.languageCodes);
