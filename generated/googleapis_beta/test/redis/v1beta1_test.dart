...
buildGoogleCloudRedisV1beta1LocationMetadata() {
  ...
  if (buildCounterGoogleCloudRedisV1beta1LocationMetadata < 3) {
    o.availableZones = buildUnnamed5193();
  }
  buildCounterGoogleCloudRedisV1beta1LocationMetadata--;
  return o;
}
...
checkGoogleCloudRedisV1beta1LocationMetadata(
  ...
  buildCounterGoogleCloudRedisV1beta1LocationMetadata++;
  if (buildCounterGoogleCloudRedisV1beta1LocationMetadata < 3) {
    checkUnnamed5193(o.availableZones);
  }
  buildCounterGoogleCloudRedisV1beta1LocationMetadata--;
}
...
checkUnnamed5194(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5195(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
buildInstance() {
  ...
  if (buildCounterInstance < 3) {
    ...
    o.name = "foo";
    o.port = 42;
    o.redisConfigs = buildUnnamed5195();
    o.redisVersion = "foo";
...
checkInstance(api.Instance o) {
  ...
  if (buildCounterInstance < 3) {
    ...
    checkUnnamed5195(o.redisConfigs);
...
checkUnnamed5196(core.List<api.Instance> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInstance(o[0]);
  checkInstance(o[1]);
}
...
checkUnnamed5197(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
checkUnnamed5198(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkUnnamed5199(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed5201();
    o.name = "foo";
    o.response = buildUnnamed5202();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed5201(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed5202(o.response);
  }
  buildCounterOperation--;
}
...
checkUnnamed5203(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed5204() {
  ...
  o.add(buildUnnamed5203());
  o.add(buildUnnamed5203());
  return o;
}

checkUnnamed5204(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed5203(o[0]);
  checkUnnamed5203(o[1]);
}
