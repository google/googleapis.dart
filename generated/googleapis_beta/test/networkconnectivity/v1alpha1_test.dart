...
core.Map<core.String, api.AttributeValue> buildUnnamed7019() {
...
void checkUnnamed7019(core.Map<core.String, api.AttributeValue> o) {
...
api.Attributes buildAttributes() {
  ...
  if (buildCounterAttributes < 3) {
    o.attributeMap = buildUnnamed7019();
...
void checkAttributes(api.Attributes o) {
  buildCounterAttributes++;
  if (buildCounterAttributes < 3) {
    checkUnnamed7019(o.attributeMap);
    unittest.expect(o.droppedAttributesCount, unittest.equals(42));
  }
  buildCounterAttributes--;
}

core.List<api.AuditLogConfig> buildUnnamed7020() {
...
void checkUnnamed7020(core.List<api.AuditLogConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AuditConfig buildAuditConfig() {
  ...
  if (buildCounterAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed7020();
    o.service = 'foo';
  }
  buildCounterAuditConfig--;
  return o;
...
void checkAuditConfig(api.AuditConfig o) {
  buildCounterAuditConfig++;
  if (buildCounterAuditConfig < 3) {
    checkUnnamed7020(o.auditLogConfigs);
...
api.AuditLogConfig buildAuditLogConfig() {
  ...
  if (buildCounterAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed7021();
    o.logType = 'foo';
  }
  buildCounterAuditLogConfig--;
  return o;
...
void checkAuditLogConfig(api.AuditLogConfig o) {
  buildCounterAuditLogConfig++;
  if (buildCounterAuditLogConfig < 3) {
    checkUnnamed7021(o.exemptedMembers);
    unittest.expect(o.logType, unittest.equals('foo'));
  }
  buildCounterAuditLogConfig--;
}

core.List<api.ReportRequest> buildUnnamed7022() {
...
void checkUnnamed7022(core.List<api.ReportRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.BillingView buildBillingView() {
  ...
  if (buildCounterBillingView < 3) {
    o.reportRequests = buildUnnamed7022();
  }
  buildCounterBillingView--;
  return o;
}
...
void checkBillingView(api.BillingView o) {
  buildCounterBillingView++;
  if (buildCounterBillingView < 3) {
    checkUnnamed7022(o.reportRequests);
  }
  buildCounterBillingView--;
}
...
core.List<api.Exemplar> buildUnnamed7025() {
  var o = <api.Exemplar>[];
  o.add(buildExemplar());
  o.add(buildExemplar());
  return o;
...
void checkUnnamed7025(core.List<api.Exemplar> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Distribution buildDistribution() {
  ...
  if (buildCounterDistribution < 3) {
    o.bucketCounts = buildUnnamed7024();
    o.count = 'foo';
    o.exemplars = buildUnnamed7025();
...
void checkDistribution(api.Distribution o) {
  buildCounterDistribution++;
  if (buildCounterDistribution < 3) {
    checkUnnamed7024(o.bucketCounts);
    unittest.expect(o.count, unittest.equals('foo'));
    checkUnnamed7025(o.exemplars);
...
core.List<core.Map<core.String, core.Object>> buildUnnamed7027() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed7026());
  o.add(buildUnnamed7026());
  return o;
}

void checkUnnamed7027(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed7026(o[0]);
  checkUnnamed7026(o[1]);
}
...
api.Exemplar buildExemplar() {
  ...
  if (buildCounterExemplar < 3) {
    o.attachments = buildUnnamed7027();
    o.timestamp = 'foo';
    o.value = 42.0;
  }
  buildCounterExemplar--;
...
void checkExemplar(api.Exemplar o) {
  buildCounterExemplar++;
  if (buildCounterExemplar < 3) {
    checkUnnamed7027(o.attachments);
...
core.List<core.double> buildUnnamed7028() {
  var o = <core.double>[];
  o.add(42.0);
  o.add(42.0);
  return o;
...
void checkUnnamed7028(core.List<core.double> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleLongrunningOperation> buildUnnamed7029() {
...
void checkUnnamed7029(core.List<api.GoogleLongrunningOperation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleLongrunningOperation buildGoogleLongrunningOperation() {
  ...
  if (buildCounterGoogleLongrunningOperation < 3) {
    ...
    o.metadata = buildUnnamed7030();
    o.name = 'foo';
    o.response = buildUnnamed7031();
  }
  buildCounterGoogleLongrunningOperation--;
  return o;
}
...
void checkGoogleLongrunningOperation(api.GoogleLongrunningOperation o) {
  ...
  if (buildCounterGoogleLongrunningOperation < 3) {
    ...
    checkUnnamed7030(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed7031(o.response);
  }
  buildCounterGoogleLongrunningOperation--;
}

core.Map<core.String, core.Object> buildUnnamed7032() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed7032(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed7033() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed7032());
  o.add(buildUnnamed7032());
  return o;
}

void checkUnnamed7033(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed7032(o[0]);
  checkUnnamed7032(o[1]);
}
...
core.List<api.Hub> buildUnnamed7036() {
  var o = <api.Hub>[];
  o.add(buildHub());
  o.add(buildHub());
  return o;
...
void checkUnnamed7036(core.List<api.Hub> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListHubsResponse buildListHubsResponse() {
  ...
  if (buildCounterListHubsResponse < 3) {
    o.hubs = buildUnnamed7036();
    o.nextPageToken = 'foo';
    o.unreachable = buildUnnamed7037();
  }
  buildCounterListHubsResponse--;
  return o;
}
...
void checkListHubsResponse(api.ListHubsResponse o) {
  buildCounterListHubsResponse++;
  if (buildCounterListHubsResponse < 3) {
    checkUnnamed7036(o.hubs);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed7037(o.unreachable);
  }
  buildCounterListHubsResponse--;
}

core.List<api.Location> buildUnnamed7038() {
  var o = <api.Location>[];
  o.add(buildLocation());
  o.add(buildLocation());
  return o;
...
void checkUnnamed7038(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListLocationsResponse(api.ListLocationsResponse o) {
  buildCounterListLocationsResponse++;
  if (buildCounterListLocationsResponse < 3) {
    checkUnnamed7038(o.locations);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListLocationsResponse--;
}

core.List<api.Spoke> buildUnnamed7039() {
  var o = <api.Spoke>[];
  o.add(buildSpoke());
  o.add(buildSpoke());
  return o;
...
void checkUnnamed7039(core.List<api.Spoke> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListSpokesResponse buildListSpokesResponse() {
  ...
  if (buildCounterListSpokesResponse < 3) {
    o.nextPageToken = 'foo';
    o.spokes = buildUnnamed7039();
    o.unreachable = buildUnnamed7040();
  }
  buildCounterListSpokesResponse--;
  return o;
}
...
void checkListSpokesResponse(api.ListSpokesResponse o) {
  ...
  if (buildCounterListSpokesResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed7039(o.spokes);
    checkUnnamed7040(o.unreachable);
  }
  buildCounterListSpokesResponse--;
}
...
core.Map<core.String, core.Object> buildUnnamed7042() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed7042(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.String> buildUnnamed7043() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed7043(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o['x'], unittest.equals('foo'));
  unittest.expect(o['y'], unittest.equals('foo'));
}
...
api.LogEntry buildLogEntry() {
  ...
  if (buildCounterLogEntry < 3) {
    ...
    o.insertId = 'foo';
    o.labels = buildUnnamed7043();
    o.name = 'foo';
    o.operation = buildLogEntryOperation();
    o.protoPayload = buildUnnamed7044();
    o.severity = 'foo';
    o.sourceLocation = buildLogEntrySourceLocation();
    o.structPayload = buildUnnamed7045();
    o.textPayload = 'foo';
    o.timestamp = 'foo';
    o.trace = 'foo';
  }
...
core.List<api.MetricValue> buildUnnamed7047() {
  var o = <api.MetricValue>[];
...
void checkUnnamed7047(core.List<api.MetricValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MetricValueSet buildMetricValueSet() {
  ...
  if (buildCounterMetricValueSet < 3) {
    o.metricName = 'foo';
    o.metricValues = buildUnnamed7047();
  }
  buildCounterMetricValueSet--;
  return o;
}
...
void checkMetricValueSet(api.MetricValueSet o) {
  ...
  if (buildCounterMetricValueSet < 3) {
    ...
    checkUnnamed7047(o.metricValues);
  }
  buildCounterMetricValueSet--;
}
...
core.Map<core.String, core.Object> buildUnnamed7048() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed7048(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed7049() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed7048());
  o.add(buildUnnamed7048());
  return o;
}

void checkUnnamed7049(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed7048(o[0]);
  checkUnnamed7048(o[1]);
}
...
core.List<api.LogEntry> buildUnnamed7051() {
  var o = <api.LogEntry>[];
  o.add(buildLogEntry());
  o.add(buildLogEntry());
  return o;
...
void checkUnnamed7051(core.List<api.LogEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogEntry(o[0] as api.LogEntry);
  checkLogEntry(o[1] as api.LogEntry);
}

core.List<api.MetricValueSet> buildUnnamed7052() {
  var o = <api.MetricValueSet>[];
...
void checkUnnamed7052(core.List<api.MetricValueSet> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetricValueSet(o[0] as api.MetricValueSet);
  checkMetricValueSet(o[1] as api.MetricValueSet);
}

core.List<api.ResourceInfo> buildUnnamed7053() {
...
void checkUnnamed7053(core.List<api.ResourceInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResourceInfo(o[0] as api.ResourceInfo);
  checkResourceInfo(o[1] as api.ResourceInfo);
}

core.List<api.TraceSpan> buildUnnamed7054() {
  var o = <api.TraceSpan>[];
...
void checkUnnamed7054(core.List<api.TraceSpan> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.consumerId = 'foo';
    o.endTime = 'foo';
    o.extensions = buildUnnamed7049();
    o.importance = 'foo';
    o.labels = buildUnnamed7050();
    o.logEntries = buildUnnamed7051();
    o.metricValueSets = buildUnnamed7052();
    o.operationId = 'foo';
    o.operationName = 'foo';
    o.quotaProperties = buildQuotaProperties();
    o.resources = buildUnnamed7053();
    o.startTime = 'foo';
    o.traceSpans = buildUnnamed7054();
    o.userLabels = buildUnnamed7055();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    unittest.expect(o.endTime, unittest.equals('foo'));
    checkUnnamed7049(o.extensions);
    unittest.expect(o.importance, unittest.equals('foo'));
    checkUnnamed7050(o.labels);
    checkUnnamed7051(o.logEntries);
    checkUnnamed7052(o.metricValueSets);
    ...
    checkUnnamed7053(o.resources);
    unittest.expect(o.startTime, unittest.equals('foo'));
    checkUnnamed7054(o.traceSpans);
    checkUnnamed7055(o.userLabels);
  }
  buildCounterOperation--;
}
...
core.List<api.AuditConfig> buildUnnamed7056() {
  var o = <api.AuditConfig>[];
...
void checkUnnamed7056(core.List<api.AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAuditConfig(o[0] as api.AuditConfig);
  checkAuditConfig(o[1] as api.AuditConfig);
}

core.List<api.Binding> buildUnnamed7057() {
  var o = <api.Binding>[];
  o.add(buildBinding());
  o.add(buildBinding());
  return o;
...
void checkUnnamed7057(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Policy buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.auditConfigs = buildUnnamed7056();
    o.bindings = buildUnnamed7057();
    o.etag = 'foo';
    o.version = 42;
  }
  buildCounterPolicy--;
...
void checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed7056(o.auditConfigs);
    checkUnnamed7057(o.bindings);
...
core.List<api.Operation> buildUnnamed7058() {
  var o = <api.Operation>[];
...
void checkUnnamed7058(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.String> buildUnnamed7059() {
  var o = <core.String, core.String>{};
  o['x'] = 'foo';
  o['y'] = 'foo';
  return o;
...
void checkUnnamed7059(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o['x'], unittest.equals('foo'));
  unittest.expect(o['y'], unittest.equals('foo'));
}
...
core.List<api.RouterApplianceInstance> buildUnnamed7061() {
  var o = <api.RouterApplianceInstance>[];
...
void checkUnnamed7061(core.List<api.RouterApplianceInstance> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Spoke buildSpoke() {
  ...
  if (buildCounterSpoke < 3) {
    ...
    o.description = 'foo';
    o.hub = 'foo';
    o.labels = buildUnnamed7059();
    o.linkedInterconnectAttachments = buildUnnamed7060();
    o.linkedRouterApplianceInstances = buildUnnamed7061();
    o.linkedVpnTunnels = buildUnnamed7062();
    o.name = 'foo';
    o.state = 'foo';
    o.uniqueId = 'foo';
    o.updateTime = 'foo';
...
void checkSpoke(api.Spoke o) {
  ...
  if (buildCounterSpoke < 3) {
    ...
    checkUnnamed7059(o.labels);
    checkUnnamed7060(o.linkedInterconnectAttachments);
    checkUnnamed7061(o.linkedRouterApplianceInstances);
    checkUnnamed7062(o.linkedVpnTunnels);
    unittest.expect(o.name, unittest.equals('foo'));
    unittest.expect(o.state, unittest.equals('foo'));
    unittest.expect(o.uniqueId, unittest.equals('foo'));
    unittest.expect(o.updateTime, unittest.equals('foo'));
...
api.TestIamPermissionsRequest buildTestIamPermissionsRequest() {
  ...
  if (buildCounterTestIamPermissionsRequest < 3) {
    o.permissions = buildUnnamed7063();
  }
  buildCounterTestIamPermissionsRequest--;
  return o;
}
...
void checkTestIamPermissionsRequest(api.TestIamPermissionsRequest o) {
  buildCounterTestIamPermissionsRequest++;
  if (buildCounterTestIamPermissionsRequest < 3) {
    checkUnnamed7063(o.permissions);
  }
  buildCounterTestIamPermissionsRequest--;
}
...
api.TestIamPermissionsResponse buildTestIamPermissionsResponse() {
  ...
  if (buildCounterTestIamPermissionsResponse < 3) {
    o.permissions = buildUnnamed7064();
  }
  buildCounterTestIamPermissionsResponse--;
  return o;
}
...
void checkTestIamPermissionsResponse(api.TestIamPermissionsResponse o) {
  buildCounterTestIamPermissionsResponse++;
  if (buildCounterTestIamPermissionsResponse < 3) {
    checkUnnamed7064(o.permissions);
  }
  buildCounterTestIamPermissionsResponse--;
}
