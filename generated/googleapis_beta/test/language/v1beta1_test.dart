...
checkUnnamed3205(core.List<api.Entity> o) {
...
checkUnnamed3206(core.List<api.Sentence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSentence(o[0]);
  checkSentence(o[1]);
}
...
checkUnnamed3207(core.List<api.Sentence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSentence(o[0]);
  checkSentence(o[1]);
}
...
checkUnnamed3208(core.List<api.Token> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkToken(o[0]);
  checkToken(o[1]);
}
...
buildAnalyzeSyntaxResponse() {
  ...
  if (buildCounterAnalyzeSyntaxResponse < 3) {
    o.language = "foo";
    o.sentences = buildUnnamed3207();
    o.tokens = buildUnnamed3208();
  }
  buildCounterAnalyzeSyntaxResponse--;
  return o;
}
...
checkAnalyzeSyntaxResponse(api.AnalyzeSyntaxResponse o) {
  ...
  if (buildCounterAnalyzeSyntaxResponse < 3) {
    unittest.expect(o.language, unittest.equals('foo'));
    checkUnnamed3207(o.sentences);
    checkUnnamed3208(o.tokens);
  }
  buildCounterAnalyzeSyntaxResponse--;
}
...
checkUnnamed3209(core.List<api.Entity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEntity(o[0]);
  checkEntity(o[1]);
}
...
checkUnnamed3210(core.List<api.Sentence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSentence(o[0]);
  checkSentence(o[1]);
}
...
checkUnnamed3211(core.List<api.Token> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkToken(o[0]);
  checkToken(o[1]);
}
...
buildAnnotateTextResponse() {
  ...
  if (buildCounterAnnotateTextResponse < 3) {
    o.documentSentiment = buildSentiment();
    o.entities = buildUnnamed3209();
    o.language = "foo";
    o.sentences = buildUnnamed3210();
    o.tokens = buildUnnamed3211();
  }
  buildCounterAnnotateTextResponse--;
  return o;
}
...
checkAnnotateTextResponse(api.AnnotateTextResponse o) {
  ...
  if (buildCounterAnnotateTextResponse < 3) {
    checkSentiment(o.documentSentiment);
    checkUnnamed3209(o.entities);
    unittest.expect(o.language, unittest.equals('foo'));
    checkUnnamed3210(o.sentences);
    checkUnnamed3211(o.tokens);
  }
  buildCounterAnnotateTextResponse--;
}
...
checkUnnamed3212(core.List<api.EntityMention> o) {
  unittest.expect(o, unittest.hasLength(2));
  ...
  unittest.group("resource-DocumentsResourceApi", () {
    unittest.test("method--analyzeEntities", () {
      ...
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        ...
        pathOffset += 1;
        unittest.expect(path.substring(pathOffset, pathOffset + 33), unittest.equals("v1beta1/documents:analyzeEntities"));
        pathOffset += 33;
    ...
    unittest.test("method--analyzeSentiment", () {
      ...
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        ...
        unittest.expect(path.substring(pathOffset, pathOffset + 1), unittest.equals("/"));
        pathOffset += 1;
        unittest.expect(path.substring(pathOffset, pathOffset + 34), unittest.equals("v1beta1/documents:analyzeSentiment"));
        pathOffset += 34;
    ...
    unittest.test("method--annotateText", () {
      ...
      mock.register(unittest.expectAsync((http.BaseRequest req, json) {
        ...
        unittest.expect(path.substring(pathOffset, pathOffset + 1), unittest.equals("/"));
        pathOffset += 1;
        unittest.expect(path.substring(pathOffset, pathOffset + 30), unittest.equals("v1beta1/documents:annotateText"));
        pathOffset += 30;
