...
core.List<api.SourceReference> buildUnnamed8387() => [
      buildSourceReference(),
      buildSourceReference(),
    ];

void checkUnnamed8387(core.List<api.SourceReference> o) {
...
api.ErrorContext buildErrorContext() {
  ...
  if (buildCounterErrorContext < 3) {
    ...
    o.sourceReferences = buildUnnamed8387();
    o.user = 'foo';
  }
  buildCounterErrorContext--;
  return o;
...
void checkErrorContext(api.ErrorContext o) {
  ...
  if (buildCounterErrorContext < 3) {
    ...
    checkUnnamed8387(o.sourceReferences!);
    unittest.expect(
      o.user!,
      unittest.equals('foo'),
    );
...
core.List<api.TrackingIssue> buildUnnamed8388() => [
      buildTrackingIssue(),
      buildTrackingIssue(),
    ];

void checkUnnamed8388(core.List<api.TrackingIssue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ErrorGroup buildErrorGroup() {
  ...
  if (buildCounterErrorGroup < 3) {
    ...
    o.trackingIssues = buildUnnamed8388();
  }
  buildCounterErrorGroup--;
  return o;
}
...
void checkErrorGroup(api.ErrorGroup o) {
  ...
  if (buildCounterErrorGroup < 3) {
    ...
    checkUnnamed8388(o.trackingIssues!);
  }
  buildCounterErrorGroup--;
}

core.List<api.ServiceContext> buildUnnamed8389() => [
      buildServiceContext(),
      buildServiceContext(),
    ];

void checkUnnamed8389(core.List<api.ServiceContext> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkServiceContext(o[0]);
  checkServiceContext(o[1]);
}

core.List<api.TimedCount> buildUnnamed8390() => [
      buildTimedCount(),
      buildTimedCount(),
    ];

void checkUnnamed8390(core.List<api.TimedCount> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTimedCount(o[0]);
  checkTimedCount(o[1]);
}
...
api.ErrorGroupStats buildErrorGroupStats() {
  ...
  if (buildCounterErrorGroupStats < 3) {
    o.affectedServices = buildUnnamed8389();
    ...
    o.timedCounts = buildUnnamed8390();
  }
  buildCounterErrorGroupStats--;
  return o;
}
...
void checkErrorGroupStats(api.ErrorGroupStats o) {
  buildCounterErrorGroupStats++;
  if (buildCounterErrorGroupStats < 3) {
    checkUnnamed8389(o.affectedServices!);
    unittest.expect(
    ...
    checkUnnamed8390(o.timedCounts!);
  }
  buildCounterErrorGroupStats--;
}
...
core.List<api.ErrorEvent> buildUnnamed8391() => [
      buildErrorEvent(),
      buildErrorEvent(),
    ];

void checkUnnamed8391(core.List<api.ErrorEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkErrorEvent(o[0]);
  checkErrorEvent(o[1]);
}
...
api.ListEventsResponse buildListEventsResponse() {
  ...
  if (buildCounterListEventsResponse < 3) {
    o.errorEvents = buildUnnamed8391();
    o.nextPageToken = 'foo';
...
void checkListEventsResponse(api.ListEventsResponse o) {
  buildCounterListEventsResponse++;
  if (buildCounterListEventsResponse < 3) {
    checkUnnamed8391(o.errorEvents!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.ErrorGroupStats> buildUnnamed8392() => [
      buildErrorGroupStats(),
      buildErrorGroupStats(),
    ];

void checkUnnamed8392(core.List<api.ErrorGroupStats> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListGroupStatsResponse buildListGroupStatsResponse() {
  ...
  if (buildCounterListGroupStatsResponse < 3) {
    o.errorGroupStats = buildUnnamed8392();
    o.nextPageToken = 'foo';
    o.timeRangeBegin = 'foo';
  }
  buildCounterListGroupStatsResponse--;
...
void checkListGroupStatsResponse(api.ListGroupStatsResponse o) {
  buildCounterListGroupStatsResponse++;
  if (buildCounterListGroupStatsResponse < 3) {
    checkUnnamed8392(o.errorGroupStats!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
void main() {
  ...
  unittest.group('resource-ProjectsGroupStatsResource', () {
    unittest.test('method--list', () async {
      ...
      final arg_groupId = buildUnnamed8393();
      final arg_order = 'foo';
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_serviceFilter_resourceType = 'foo';
