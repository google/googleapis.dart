...
checkUnnamed4723(core.List<api.SourceReference> o) {
...
buildErrorContext() {
  ...
  if (buildCounterErrorContext < 3) {
    ...
    o.sourceReferences = buildUnnamed4723();
    o.user = "foo";
  }
  buildCounterErrorContext--;
  return o;
...
checkErrorContext(api.ErrorContext o) {
  ...
  if (buildCounterErrorContext < 3) {
    ...
    checkUnnamed4723(o.sourceReferences);
...
checkUnnamed4724(core.List<api.TrackingIssue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildErrorGroup() {
  ...
  if (buildCounterErrorGroup < 3) {
    o.groupId = "foo";
    o.name = "foo";
    o.trackingIssues = buildUnnamed4724();
  }
  buildCounterErrorGroup--;
  return o;
}
...
checkErrorGroup(api.ErrorGroup o) {
  ...
  if (buildCounterErrorGroup < 3) {
    ...
    checkUnnamed4724(o.trackingIssues);
  }
  buildCounterErrorGroup--;
}
...
checkUnnamed4725(core.List<api.ServiceContext> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4726(core.List<api.TimedCount> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTimedCount(o[0]);
  checkTimedCount(o[1]);
}
...
buildErrorGroupStats() {
  ...
  if (buildCounterErrorGroupStats < 3) {
    o.affectedServices = buildUnnamed4725();
    ...
    o.timedCounts = buildUnnamed4726();
  }
  buildCounterErrorGroupStats--;
  return o;
}
...
checkErrorGroupStats(api.ErrorGroupStats o) {
  buildCounterErrorGroupStats++;
  if (buildCounterErrorGroupStats < 3) {
    checkUnnamed4725(o.affectedServices);
    ...
    checkUnnamed4726(o.timedCounts);
  }
  buildCounterErrorGroupStats--;
}
...
checkUnnamed4727(core.List<api.ErrorEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkErrorEvent(o[0]);
  checkErrorEvent(o[1]);
}
...
buildListEventsResponse() {
  ...
  if (buildCounterListEventsResponse < 3) {
    o.errorEvents = buildUnnamed4727();
    o.nextPageToken = "foo";
...
checkListEventsResponse(api.ListEventsResponse o) {
  buildCounterListEventsResponse++;
  if (buildCounterListEventsResponse < 3) {
    checkUnnamed4727(o.errorEvents);
...
checkUnnamed4728(core.List<api.ErrorGroupStats> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListGroupStatsResponse() {
  ...
  if (buildCounterListGroupStatsResponse < 3) {
    o.errorGroupStats = buildUnnamed4728();
    o.nextPageToken = "foo";
    o.timeRangeBegin = "foo";
  }
  buildCounterListGroupStatsResponse--;
...
checkListGroupStatsResponse(api.ListGroupStatsResponse o) {
  buildCounterListGroupStatsResponse++;
  if (buildCounterListGroupStatsResponse < 3) {
    checkUnnamed4728(o.errorGroupStats);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    unittest.expect(o.timeRangeBegin, unittest.equals('foo'));
  }
  buildCounterListGroupStatsResponse--;
...
main() {
  ...
  unittest.group("resource-ProjectsGroupStatsResourceApi", () {
    unittest.test("method--list", () {
      ...
      var arg_groupId = buildUnnamed4729();
      var arg_serviceFilter_service = "foo";
      var arg_pageSize = 42;
      var arg_serviceFilter_version = "foo";
      var arg_order = "foo";
