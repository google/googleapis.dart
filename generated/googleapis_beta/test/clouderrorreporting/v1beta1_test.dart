...
checkUnnamed5295(core.List<api.SourceReference> o) {
...
buildErrorContext() {
  ...
  if (buildCounterErrorContext < 3) {
    ...
    o.sourceReferences = buildUnnamed5295();
    o.user = "foo";
  }
  buildCounterErrorContext--;
  return o;
...
checkErrorContext(api.ErrorContext o) {
  ...
  if (buildCounterErrorContext < 3) {
    ...
    checkUnnamed5295(o.sourceReferences);
...
checkUnnamed5296(core.List<api.TrackingIssue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildErrorGroup() {
  ...
  if (buildCounterErrorGroup < 3) {
    o.groupId = "foo";
    o.name = "foo";
    o.trackingIssues = buildUnnamed5296();
  }
  buildCounterErrorGroup--;
  return o;
}
...
checkErrorGroup(api.ErrorGroup o) {
  ...
  if (buildCounterErrorGroup < 3) {
    ...
    checkUnnamed5296(o.trackingIssues);
  }
  buildCounterErrorGroup--;
}
...
checkUnnamed5297(core.List<api.ServiceContext> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5298(core.List<api.TimedCount> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTimedCount(o[0]);
  checkTimedCount(o[1]);
}
...
buildErrorGroupStats() {
  ...
  if (buildCounterErrorGroupStats < 3) {
    o.affectedServices = buildUnnamed5297();
    ...
    o.timedCounts = buildUnnamed5298();
  }
  buildCounterErrorGroupStats--;
  return o;
}
...
checkErrorGroupStats(api.ErrorGroupStats o) {
  buildCounterErrorGroupStats++;
  if (buildCounterErrorGroupStats < 3) {
    checkUnnamed5297(o.affectedServices);
    ...
    checkUnnamed5298(o.timedCounts);
  }
  buildCounterErrorGroupStats--;
}
...
checkUnnamed5299(core.List<api.ErrorEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkErrorEvent(o[0]);
  checkErrorEvent(o[1]);
}
...
buildListEventsResponse() {
  ...
  if (buildCounterListEventsResponse < 3) {
    o.errorEvents = buildUnnamed5299();
    o.nextPageToken = "foo";
...
checkListEventsResponse(api.ListEventsResponse o) {
  buildCounterListEventsResponse++;
  if (buildCounterListEventsResponse < 3) {
    checkUnnamed5299(o.errorEvents);
...
checkUnnamed5300(core.List<api.ErrorGroupStats> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListGroupStatsResponse() {
  ...
  if (buildCounterListGroupStatsResponse < 3) {
    o.errorGroupStats = buildUnnamed5300();
    o.nextPageToken = "foo";
    o.timeRangeBegin = "foo";
  }
  buildCounterListGroupStatsResponse--;
...
checkListGroupStatsResponse(api.ListGroupStatsResponse o) {
  buildCounterListGroupStatsResponse++;
  if (buildCounterListGroupStatsResponse < 3) {
    checkUnnamed5300(o.errorGroupStats);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    unittest.expect(o.timeRangeBegin, unittest.equals('foo'));
  }
  buildCounterListGroupStatsResponse--;
...
main() {
  ...
  unittest.group("resource-ProjectsGroupStatsResourceApi", () {
    unittest.test("method--list", () {
      ...
      var arg_groupId = buildUnnamed5301();
      var arg_serviceFilter_service = "foo";
      var arg_pageSize = 42;
      var arg_serviceFilter_version = "foo";
      var arg_order = "foo";
