...
core.List<api.SourceReference> buildUnnamed8312() => [
      buildSourceReference(),
      buildSourceReference(),
    ];

void checkUnnamed8312(core.List<api.SourceReference> o) {
...
api.ErrorContext buildErrorContext() {
  ...
  if (buildCounterErrorContext < 3) {
    ...
    o.sourceReferences = buildUnnamed8312();
    o.user = 'foo';
  }
  buildCounterErrorContext--;
  return o;
...
void checkErrorContext(api.ErrorContext o) {
  ...
  if (buildCounterErrorContext < 3) {
    ...
    checkUnnamed8312(o.sourceReferences!);
    unittest.expect(
      o.user!,
      unittest.equals('foo'),
    );
...
core.List<api.TrackingIssue> buildUnnamed8313() => [
      buildTrackingIssue(),
      buildTrackingIssue(),
    ];

void checkUnnamed8313(core.List<api.TrackingIssue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ErrorGroup buildErrorGroup() {
  ...
  if (buildCounterErrorGroup < 3) {
    ...
    o.trackingIssues = buildUnnamed8313();
  }
  buildCounterErrorGroup--;
  return o;
}
...
void checkErrorGroup(api.ErrorGroup o) {
  ...
  if (buildCounterErrorGroup < 3) {
    ...
    checkUnnamed8313(o.trackingIssues!);
  }
  buildCounterErrorGroup--;
}

core.List<api.ServiceContext> buildUnnamed8314() => [
      buildServiceContext(),
      buildServiceContext(),
    ];

void checkUnnamed8314(core.List<api.ServiceContext> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkServiceContext(o[0]);
  checkServiceContext(o[1]);
}

core.List<api.TimedCount> buildUnnamed8315() => [
      buildTimedCount(),
      buildTimedCount(),
    ];

void checkUnnamed8315(core.List<api.TimedCount> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTimedCount(o[0]);
  checkTimedCount(o[1]);
}
...
api.ErrorGroupStats buildErrorGroupStats() {
  ...
  if (buildCounterErrorGroupStats < 3) {
    o.affectedServices = buildUnnamed8314();
    ...
    o.timedCounts = buildUnnamed8315();
  }
  buildCounterErrorGroupStats--;
  return o;
}
...
void checkErrorGroupStats(api.ErrorGroupStats o) {
  buildCounterErrorGroupStats++;
  if (buildCounterErrorGroupStats < 3) {
    checkUnnamed8314(o.affectedServices!);
    unittest.expect(
    ...
    checkUnnamed8315(o.timedCounts!);
  }
  buildCounterErrorGroupStats--;
}
...
core.List<api.ErrorEvent> buildUnnamed8316() => [
      buildErrorEvent(),
      buildErrorEvent(),
    ];

void checkUnnamed8316(core.List<api.ErrorEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkErrorEvent(o[0]);
  checkErrorEvent(o[1]);
}
...
api.ListEventsResponse buildListEventsResponse() {
  ...
  if (buildCounterListEventsResponse < 3) {
    o.errorEvents = buildUnnamed8316();
    o.nextPageToken = 'foo';
...
void checkListEventsResponse(api.ListEventsResponse o) {
  buildCounterListEventsResponse++;
  if (buildCounterListEventsResponse < 3) {
    checkUnnamed8316(o.errorEvents!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.ErrorGroupStats> buildUnnamed8317() => [
      buildErrorGroupStats(),
      buildErrorGroupStats(),
    ];

void checkUnnamed8317(core.List<api.ErrorGroupStats> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListGroupStatsResponse buildListGroupStatsResponse() {
  ...
  if (buildCounterListGroupStatsResponse < 3) {
    o.errorGroupStats = buildUnnamed8317();
    o.nextPageToken = 'foo';
    o.timeRangeBegin = 'foo';
  }
  buildCounterListGroupStatsResponse--;
...
void checkListGroupStatsResponse(api.ListGroupStatsResponse o) {
  buildCounterListGroupStatsResponse++;
  if (buildCounterListGroupStatsResponse < 3) {
    checkUnnamed8317(o.errorGroupStats!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<core.String> buildUnnamed8318() => [
      'foo',
      'foo',
    ];

void checkUnnamed8318(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
void main() {
  ...
  unittest.group('resource-ProjectsGroupStatsResource', () {
    unittest.test('method--list', () async {
      ...
      final arg_groupId = buildUnnamed8318();
      final arg_order = 'foo';
      final arg_pageSize = 42;
      final arg_pageToken = 'foo';
      final arg_serviceFilter_resourceType = 'foo';
