...
checkUnnamed3326(core.List<api.TrackingIssue> o) {
...
buildErrorGroup() {
  ...
  if (buildCounterErrorGroup < 3) {
    o.groupId = "foo";
    o.name = "foo";
    o.trackingIssues = buildUnnamed3326();
  }
  buildCounterErrorGroup--;
  return o;
}
...
checkErrorGroup(api.ErrorGroup o) {
  ...
  if (buildCounterErrorGroup < 3) {
    ...
    checkUnnamed3326(o.trackingIssues);
  }
  buildCounterErrorGroup--;
}
...
checkUnnamed3327(core.List<api.ServiceContext> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3328(core.List<api.TimedCount> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTimedCount(o[0]);
  checkTimedCount(o[1]);
}
...
buildErrorGroupStats() {
  ...
  if (buildCounterErrorGroupStats < 3) {
    o.affectedServices = buildUnnamed3327();
    ...
    o.timedCounts = buildUnnamed3328();
  }
  buildCounterErrorGroupStats--;
  return o;
}
...
checkErrorGroupStats(api.ErrorGroupStats o) {
  buildCounterErrorGroupStats++;
  if (buildCounterErrorGroupStats < 3) {
    checkUnnamed3327(o.affectedServices);
    ...
    checkUnnamed3328(o.timedCounts);
  }
  buildCounterErrorGroupStats--;
}
...
checkUnnamed3329(core.List<api.ErrorEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkErrorEvent(o[0]);
  checkErrorEvent(o[1]);
}
...
buildListEventsResponse() {
  ...
  if (buildCounterListEventsResponse < 3) {
    o.errorEvents = buildUnnamed3329();
    o.nextPageToken = "foo";
...
checkListEventsResponse(api.ListEventsResponse o) {
  buildCounterListEventsResponse++;
  if (buildCounterListEventsResponse < 3) {
    checkUnnamed3329(o.errorEvents);
...
checkUnnamed3330(core.List<api.ErrorGroupStats> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListGroupStatsResponse() {
  ...
  if (buildCounterListGroupStatsResponse < 3) {
    o.errorGroupStats = buildUnnamed3330();
    o.nextPageToken = "foo";
    o.timeRangeBegin = "foo";
  }
  buildCounterListGroupStatsResponse--;
...
checkListGroupStatsResponse(api.ListGroupStatsResponse o) {
  buildCounterListGroupStatsResponse++;
  if (buildCounterListGroupStatsResponse < 3) {
    checkUnnamed3330(o.errorGroupStats);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    unittest.expect(o.timeRangeBegin, unittest.equals('foo'));
  }
  buildCounterListGroupStatsResponse--;
...
main() {
  ...
  unittest.group("resource-ProjectsEventsResourceApi", () {
    unittest.test("method--list", () {
      ...
      res.list(arg_projectName, pageToken: arg_pageToken, serviceFilter_service: arg_serviceFilter_service, pageSize: arg_pageSize, serviceFilter_version: arg_serviceFilter_version, serviceFilter_resourceType: arg_serviceFilter_resourceType, timeRange_period: arg_timeRange_period, groupId: arg_groupId).then(unittest.expectAsync(((api.ListEventsResponse response) {
    ...
    unittest.test("method--report", () {
      ...
      res.report(arg_request, arg_projectName).then(unittest.expectAsync(((api.ReportErrorEventResponse response) {
  ...
  unittest.group("resource-ProjectsGroupStatsResourceApi", () {
    unittest.test("method--list", () {
      ...
      var arg_groupId = buildUnnamed3331();
      var arg_serviceFilter_service = "foo";
      var arg_pageSize = 42;
      var arg_serviceFilter_version = "foo";
      var arg_order = "foo";
      ...
      res.list(arg_projectName, serviceFilter_resourceType: arg_serviceFilter_resourceType, alignmentTime: arg_alignmentTime, timedCountDuration: arg_timedCountDuration, pageToken: arg_pageToken, timeRange_period: arg_timeRange_period, alignment: arg_alignment, groupId: arg_groupId, serviceFilter_service: arg_serviceFilter_service, pageSize: arg_pageSize, serviceFilter_version: arg_serviceFilter_version, order: arg_order).then(unittest.expectAsync(((api.ListGroupStatsResponse response) {
