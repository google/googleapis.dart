...
core.List<api.StreamMapping> buildUnnamed7307() {
...
void checkUnnamed7307(core.List<api.StreamMapping> o) {
...
api.AnalyticsDetails buildAnalyticsDetails() {
  ...
  if (buildCounterAnalyticsDetails < 3) {
    ...
    o.streamMappings = buildUnnamed7307();
  }
  buildCounterAnalyticsDetails--;
  return o;
}
...
void checkAnalyticsDetails(api.AnalyticsDetails o) {
  ...
  if (buildCounterAnalyticsDetails < 3) {
    ...
    checkUnnamed7307(o.streamMappings);
  }
  buildCounterAnalyticsDetails--;
}
...
core.List<api.AndroidApp> buildUnnamed7308() {
  var o = <api.AndroidApp>[];
...
void checkUnnamed7308(core.List<api.AndroidApp> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListAndroidAppsResponse(api.ListAndroidAppsResponse o) {
  buildCounterListAndroidAppsResponse++;
  if (buildCounterListAndroidAppsResponse < 3) {
    checkUnnamed7308(o.apps);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListAndroidAppsResponse--;
}

core.List<api.Location> buildUnnamed7309() {
  var o = <api.Location>[];
  o.add(buildLocation());
  o.add(buildLocation());
  return o;
...
void checkUnnamed7309(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListAvailableLocationsResponse(api.ListAvailableLocationsResponse o) {
  buildCounterListAvailableLocationsResponse++;
  if (buildCounterListAvailableLocationsResponse < 3) {
    checkUnnamed7309(o.locations);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListAvailableLocationsResponse--;
}

core.List<api.ProjectInfo> buildUnnamed7310() {
...
void checkUnnamed7310(core.List<api.ProjectInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListAvailableProjectsResponse buildListAvailableProjectsResponse() {
  ...
  if (buildCounterListAvailableProjectsResponse < 3) {
    o.nextPageToken = 'foo';
    o.projectInfo = buildUnnamed7310();
  }
  buildCounterListAvailableProjectsResponse--;
  return o;
}
...
void checkListAvailableProjectsResponse(api.ListAvailableProjectsResponse o) {
  ...
  if (buildCounterListAvailableProjectsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed7310(o.projectInfo);
  }
  buildCounterListAvailableProjectsResponse--;
}

core.List<api.FirebaseProject> buildUnnamed7311() {
  var o = <api.FirebaseProject>[];
...
void checkUnnamed7311(core.List<api.FirebaseProject> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListFirebaseProjectsResponse(api.ListFirebaseProjectsResponse o) {
  ...
  if (buildCounterListFirebaseProjectsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed7311(o.results);
  }
  buildCounterListFirebaseProjectsResponse--;
}

core.List<api.IosApp> buildUnnamed7312() {
  var o = <api.IosApp>[];
  o.add(buildIosApp());
  o.add(buildIosApp());
  return o;
...
void checkUnnamed7312(core.List<api.IosApp> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListIosAppsResponse(api.ListIosAppsResponse o) {
  buildCounterListIosAppsResponse++;
  if (buildCounterListIosAppsResponse < 3) {
    checkUnnamed7312(o.apps);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListIosAppsResponse--;
}

core.List<api.ShaCertificate> buildUnnamed7313() {
...
void checkUnnamed7313(core.List<api.ShaCertificate> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListShaCertificatesResponse buildListShaCertificatesResponse() {
  ...
  if (buildCounterListShaCertificatesResponse < 3) {
    o.certificates = buildUnnamed7313();
  }
  buildCounterListShaCertificatesResponse--;
  return o;
}
...
void checkListShaCertificatesResponse(api.ListShaCertificatesResponse o) {
  buildCounterListShaCertificatesResponse++;
  if (buildCounterListShaCertificatesResponse < 3) {
    checkUnnamed7313(o.certificates);
  }
  buildCounterListShaCertificatesResponse--;
}

core.List<api.WebApp> buildUnnamed7314() {
  var o = <api.WebApp>[];
  o.add(buildWebApp());
  o.add(buildWebApp());
  return o;
...
void checkUnnamed7314(core.List<api.WebApp> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed7316() {
...
void checkUnnamed7316(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.Map<core.String, core.Object> buildUnnamed7317() {
  var o = <core.String, core.Object>{};
  o['x'] = {
    'list': [1, 2, 3],
    'bool': true,
...
void checkUnnamed7317(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed7316();
    o.name = 'foo';
    o.response = buildUnnamed7317();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkUnnamed7316(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed7317(o.response);
  }
  buildCounterOperation--;
}
...
core.List<api.FirebaseAppInfo> buildUnnamed7318() {
  var o = <api.FirebaseAppInfo>[];
...
void checkUnnamed7318(core.List<api.FirebaseAppInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed7320() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed7319());
  o.add(buildUnnamed7319());
  return o;
}

void checkUnnamed7320(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed7319(o[0]);
  checkUnnamed7319(o[1]);
}
