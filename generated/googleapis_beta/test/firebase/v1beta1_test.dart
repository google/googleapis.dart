...
checkUnnamed5251(core.List<api.StreamMapping> o) {
...
buildAnalyticsDetails() {
  ...
  if (buildCounterAnalyticsDetails < 3) {
    ...
    o.streamMappings = buildUnnamed5251();
  }
  buildCounterAnalyticsDetails--;
  return o;
}
...
checkAnalyticsDetails(api.AnalyticsDetails o) {
  ...
  if (buildCounterAnalyticsDetails < 3) {
    ...
    checkUnnamed5251(o.streamMappings);
  }
  buildCounterAnalyticsDetails--;
}
...
checkUnnamed5252(core.List<api.AndroidApp> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAndroidApp(o[0]);
  checkAndroidApp(o[1]);
}
...
checkUnnamed5253(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
checkUnnamed5254(core.List<api.ProjectInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListAvailableProjectsResponse() {
  ...
  if (buildCounterListAvailableProjectsResponse < 3) {
    o.nextPageToken = "foo";
    o.projectInfo = buildUnnamed5254();
  }
  buildCounterListAvailableProjectsResponse--;
  return o;
}
...
checkListAvailableProjectsResponse(api.ListAvailableProjectsResponse o) {
  ...
  if (buildCounterListAvailableProjectsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed5254(o.projectInfo);
  }
  buildCounterListAvailableProjectsResponse--;
}
...
checkUnnamed5255(core.List<api.FirebaseProject> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5256(core.List<api.IosApp> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIosApp(o[0]);
  checkIosApp(o[1]);
}
...
checkUnnamed5257(core.List<api.ShaCertificate> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListShaCertificatesResponse() {
  ...
  if (buildCounterListShaCertificatesResponse < 3) {
    o.certificates = buildUnnamed5257();
  }
  buildCounterListShaCertificatesResponse--;
  return o;
}
...
checkListShaCertificatesResponse(api.ListShaCertificatesResponse o) {
  buildCounterListShaCertificatesResponse++;
  if (buildCounterListShaCertificatesResponse < 3) {
    checkUnnamed5257(o.certificates);
  }
  buildCounterListShaCertificatesResponse--;
}
...
checkUnnamed5258(core.List<api.WebApp> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWebApp(o[0]);
  checkWebApp(o[1]);
}
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed5260();
    o.name = "foo";
    o.response = buildUnnamed5261();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed5260(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed5261(o.response);
  }
  buildCounterOperation--;
}
...
checkUnnamed5262(core.List<api.FirebaseAppInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5263(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed5264() {
  ...
  o.add(buildUnnamed5263());
  o.add(buildUnnamed5263());
  return o;
}

checkUnnamed5264(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed5263(o[0]);
  checkUnnamed5263(o[1]);
}
