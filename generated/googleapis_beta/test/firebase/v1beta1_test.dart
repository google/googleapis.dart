...
core.List<api.StreamMapping> buildUnnamed8693() => [
      buildStreamMapping(),
      buildStreamMapping(),
    ];

void checkUnnamed8693(core.List<api.StreamMapping> o) {
...
api.AnalyticsDetails buildAnalyticsDetails() {
  ...
  if (buildCounterAnalyticsDetails < 3) {
    ...
    o.streamMappings = buildUnnamed8693();
  }
  buildCounterAnalyticsDetails--;
  return o;
}
...
void checkAnalyticsDetails(api.AnalyticsDetails o) {
  ...
  if (buildCounterAnalyticsDetails < 3) {
    ...
    checkUnnamed8693(o.streamMappings!);
  }
  buildCounterAnalyticsDetails--;
}
...
core.List<api.AndroidApp> buildUnnamed8694() => [
      buildAndroidApp(),
      buildAndroidApp(),
    ];

void checkUnnamed8694(core.List<api.AndroidApp> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAndroidApp(o[0]);
  checkAndroidApp(o[1]);
}
...
core.List<api.Location> buildUnnamed8695() => [
      buildLocation(),
      buildLocation(),
    ];

void checkUnnamed8695(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
core.List<api.ProjectInfo> buildUnnamed8696() => [
      buildProjectInfo(),
      buildProjectInfo(),
    ];

void checkUnnamed8696(core.List<api.ProjectInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListAvailableProjectsResponse buildListAvailableProjectsResponse() {
  ...
  if (buildCounterListAvailableProjectsResponse < 3) {
    o.nextPageToken = 'foo';
    o.projectInfo = buildUnnamed8696();
  }
  buildCounterListAvailableProjectsResponse--;
  return o;
}
...
void checkListAvailableProjectsResponse(api.ListAvailableProjectsResponse o) {
  ...
  if (buildCounterListAvailableProjectsResponse < 3) {
    ...
    checkUnnamed8696(o.projectInfo!);
  }
  buildCounterListAvailableProjectsResponse--;
}

core.List<api.FirebaseProject> buildUnnamed8697() => [
      buildFirebaseProject(),
      buildFirebaseProject(),
    ];

void checkUnnamed8697(core.List<api.FirebaseProject> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListFirebaseProjectsResponse(api.ListFirebaseProjectsResponse o) {
  ...
  if (buildCounterListFirebaseProjectsResponse < 3) {
    ...
    checkUnnamed8697(o.results!);
  }
  buildCounterListFirebaseProjectsResponse--;
}

core.List<api.IosApp> buildUnnamed8698() => [
      buildIosApp(),
      buildIosApp(),
    ];

void checkUnnamed8698(core.List<api.IosApp> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIosApp(o[0]);
  checkIosApp(o[1]);
}
...
core.List<api.ShaCertificate> buildUnnamed8699() => [
      buildShaCertificate(),
      buildShaCertificate(),
    ];

void checkUnnamed8699(core.List<api.ShaCertificate> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListShaCertificatesResponse buildListShaCertificatesResponse() {
  ...
  if (buildCounterListShaCertificatesResponse < 3) {
    o.certificates = buildUnnamed8699();
  }
  buildCounterListShaCertificatesResponse--;
  return o;
}
...
void checkListShaCertificatesResponse(api.ListShaCertificatesResponse o) {
  buildCounterListShaCertificatesResponse++;
  if (buildCounterListShaCertificatesResponse < 3) {
    checkUnnamed8699(o.certificates!);
  }
  buildCounterListShaCertificatesResponse--;
}

core.List<api.WebApp> buildUnnamed8700() => [
      buildWebApp(),
      buildWebApp(),
    ];

void checkUnnamed8700(core.List<api.WebApp> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWebApp(o[0]);
  checkWebApp(o[1]);
}
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed8702();
    o.name = 'foo';
    o.response = buildUnnamed8703();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error!);
    checkUnnamed8702(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed8703(o.response!);
  }
  buildCounterOperation--;
}
...
core.List<api.FirebaseAppInfo> buildUnnamed8704() => [
      buildFirebaseAppInfo(),
      buildFirebaseAppInfo(),
    ];

void checkUnnamed8704(core.List<api.FirebaseAppInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed8706() => [
      buildUnnamed8705(),
      buildUnnamed8705(),
    ];

void checkUnnamed8706(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed8705(o[0]);
  checkUnnamed8705(o[1]);
}
