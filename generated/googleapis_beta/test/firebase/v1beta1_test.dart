...
core.List<api.StreamMapping> buildUnnamed7742() {
...
void checkUnnamed7742(core.List<api.StreamMapping> o) {
...
api.AnalyticsDetails buildAnalyticsDetails() {
  ...
  if (buildCounterAnalyticsDetails < 3) {
    ...
    o.streamMappings = buildUnnamed7742();
  }
  buildCounterAnalyticsDetails--;
  return o;
}
...
void checkAnalyticsDetails(api.AnalyticsDetails o) {
  ...
  if (buildCounterAnalyticsDetails < 3) {
    ...
    checkUnnamed7742(o.streamMappings!);
  }
  buildCounterAnalyticsDetails--;
}
...
core.List<api.AndroidApp> buildUnnamed7743() {
  var o = <api.AndroidApp>[];
...
void checkUnnamed7743(core.List<api.AndroidApp> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Location> buildUnnamed7744() {
  var o = <api.Location>[];
  o.add(buildLocation());
  o.add(buildLocation());
  return o;
...
void checkUnnamed7744(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ProjectInfo> buildUnnamed7745() {
...
void checkUnnamed7745(core.List<api.ProjectInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListAvailableProjectsResponse buildListAvailableProjectsResponse() {
  ...
  if (buildCounterListAvailableProjectsResponse < 3) {
    o.nextPageToken = 'foo';
    o.projectInfo = buildUnnamed7745();
  }
  buildCounterListAvailableProjectsResponse--;
  return o;
}
...
void checkListAvailableProjectsResponse(api.ListAvailableProjectsResponse o) {
  ...
  if (buildCounterListAvailableProjectsResponse < 3) {
    ...
    checkUnnamed7745(o.projectInfo!);
  }
  buildCounterListAvailableProjectsResponse--;
}

core.List<api.FirebaseProject> buildUnnamed7746() {
  var o = <api.FirebaseProject>[];
...
void checkUnnamed7746(core.List<api.FirebaseProject> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkListFirebaseProjectsResponse(api.ListFirebaseProjectsResponse o) {
  ...
  if (buildCounterListFirebaseProjectsResponse < 3) {
    ...
    checkUnnamed7746(o.results!);
  }
  buildCounterListFirebaseProjectsResponse--;
}

core.List<api.IosApp> buildUnnamed7747() {
  var o = <api.IosApp>[];
  o.add(buildIosApp());
  o.add(buildIosApp());
  return o;
...
void checkUnnamed7747(core.List<api.IosApp> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.ShaCertificate> buildUnnamed7748() {
...
void checkUnnamed7748(core.List<api.ShaCertificate> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListShaCertificatesResponse buildListShaCertificatesResponse() {
  ...
  if (buildCounterListShaCertificatesResponse < 3) {
    o.certificates = buildUnnamed7748();
  }
  buildCounterListShaCertificatesResponse--;
  return o;
}
...
void checkListShaCertificatesResponse(api.ListShaCertificatesResponse o) {
  buildCounterListShaCertificatesResponse++;
  if (buildCounterListShaCertificatesResponse < 3) {
    checkUnnamed7748(o.certificates!);
  }
  buildCounterListShaCertificatesResponse--;
}

core.List<api.WebApp> buildUnnamed7749() {
  var o = <api.WebApp>[];
  o.add(buildWebApp());
  o.add(buildWebApp());
  return o;
...
void checkUnnamed7749(core.List<api.WebApp> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed7751();
    o.name = 'foo';
    o.response = buildUnnamed7752();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkUnnamed7751(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed7752(o.response!);
  }
  buildCounterOperation--;
}
...
core.List<api.FirebaseAppInfo> buildUnnamed7753() {
  var o = <api.FirebaseAppInfo>[];
...
void checkUnnamed7753(core.List<api.FirebaseAppInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed7755() {
  var o = <core.Map<core.String, core.Object>>[];
  o.add(buildUnnamed7754());
  o.add(buildUnnamed7754());
  return o;
}

void checkUnnamed7755(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed7754(o[0]);
  checkUnnamed7754(o[1]);
}
