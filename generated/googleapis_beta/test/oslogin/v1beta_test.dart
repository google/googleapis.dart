...
checkUnnamed4149(core.List<api.PosixAccount> o) {
...
checkUnnamed4150(core.Map<core.String, api.SshPublicKey> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildLoginProfile() {
  ...
  if (buildCounterLoginProfile < 3) {
    o.name = "foo";
    o.posixAccounts = buildUnnamed4149();
    o.sshPublicKeys = buildUnnamed4150();
    o.suspended = true;
  }
  buildCounterLoginProfile--;
  return o;
...
checkLoginProfile(api.LoginProfile o) {
  ...
  if (buildCounterLoginProfile < 3) {
    ...
    checkUnnamed4149(o.posixAccounts);
    checkUnnamed4150(o.sshPublicKeys);
