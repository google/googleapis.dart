...
checkUnnamed5595(core.List<api.PosixAccount> o) {
...
checkUnnamed5596(core.Map<core.String, api.SshPublicKey> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildLoginProfile() {
  ...
  if (buildCounterLoginProfile < 3) {
    o.name = "foo";
    o.posixAccounts = buildUnnamed5595();
    o.sshPublicKeys = buildUnnamed5596();
  }
  buildCounterLoginProfile--;
  return o;
}
...
checkLoginProfile(api.LoginProfile o) {
  ...
  if (buildCounterLoginProfile < 3) {
    ...
    checkUnnamed5595(o.posixAccounts);
    checkUnnamed5596(o.sshPublicKeys);
  }
  buildCounterLoginProfile--;
}
