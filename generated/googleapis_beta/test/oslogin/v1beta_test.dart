...
core.List<api.PosixAccount> buildUnnamed6782() {
...
void checkUnnamed6782(core.List<api.PosixAccount> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPosixAccount(o[0] as api.PosixAccount);
  checkPosixAccount(o[1] as api.PosixAccount);
}

core.Map<core.String, api.SshPublicKey> buildUnnamed6783() {
...
void checkUnnamed6783(core.Map<core.String, api.SshPublicKey> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.LoginProfile buildLoginProfile() {
  ...
  if (buildCounterLoginProfile < 3) {
    o.name = 'foo';
    o.posixAccounts = buildUnnamed6782();
    o.sshPublicKeys = buildUnnamed6783();
  }
  buildCounterLoginProfile--;
  return o;
}
...
void checkLoginProfile(api.LoginProfile o) {
  ...
  if (buildCounterLoginProfile < 3) {
    ...
    checkUnnamed6782(o.posixAccounts);
    checkUnnamed6783(o.sshPublicKeys);
  }
  buildCounterLoginProfile--;
}
