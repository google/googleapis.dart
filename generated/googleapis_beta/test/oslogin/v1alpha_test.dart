...
checkUnnamed4007(core.List<api.PosixAccount> o) {
...
checkUnnamed4008(core.Map<core.String, api.SshPublicKey> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildLoginProfile() {
  ...
  if (buildCounterLoginProfile < 3) {
    o.name = "foo";
    o.posixAccounts = buildUnnamed4007();
    o.sshPublicKeys = buildUnnamed4008();
  }
  buildCounterLoginProfile--;
  return o;
}
...
checkLoginProfile(api.LoginProfile o) {
  ...
  if (buildCounterLoginProfile < 3) {
    ...
    checkUnnamed4007(o.posixAccounts);
    checkUnnamed4008(o.sshPublicKeys);
  }
  buildCounterLoginProfile--;
}
