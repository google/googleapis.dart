...
core.List<api.AudioChannel> buildUnnamed8451() {
...
void checkUnnamed8451(core.List<api.AudioChannel> o) {
...
core.List<api.AudioChannelInput> buildUnnamed8452() {
...
void checkUnnamed8452(core.List<api.AudioChannelInput> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.AudioAtom> buildUnnamed8454() {
  var o = <api.AudioAtom>[];
...
void checkUnnamed8454(core.List<api.AudioAtom> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.AudioStream buildAudioStream() {
  ...
  if (buildCounterAudioStream < 3) {
    o.bitrateBps = 42;
    o.channelCount = 42;
    o.channelLayout = buildUnnamed8453();
    o.codec = 'foo';
    o.mapping = buildUnnamed8454();
...
void checkAudioStream(api.AudioStream o) {
  ...
  if (buildCounterAudioStream < 3) {
    ...
    checkUnnamed8453(o.channelLayout!);
    unittest.expect(
      o.codec!,
      unittest.equals('foo'),
    );
    checkUnnamed8454(o.mapping!);
    unittest.expect(
      o.sampleRateHertz!,
      unittest.equals(42),
    );
...
core.List<api.FailureDetail> buildUnnamed8456() {
  var o = <api.FailureDetail>[];
...
void checkUnnamed8456(core.List<api.FailureDetail> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Job buildJob() {
  ...
  if (buildCounterJob < 3) {
    ...
    o.createTime = 'foo';
    o.endTime = 'foo';
    o.failureDetails = buildUnnamed8456();
    o.failureReason = 'foo';
    o.inputUri = 'foo';
    o.name = 'foo';
...
void checkJob(api.Job o) {
  ...
  if (buildCounterJob < 3) {
    ...
    checkUnnamed8456(o.failureDetails!);
    unittest.expect(
      o.failureReason!,
      unittest.equals('foo'),
    );
...
core.List<api.AdBreak> buildUnnamed8457() {
  var o = <api.AdBreak>[];
  o.add(buildAdBreak());
  o.add(buildAdBreak());
  return o;
...
void checkUnnamed8457(core.List<api.AdBreak> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdBreak(o[0] as api.AdBreak);
  checkAdBreak(o[1] as api.AdBreak);
}

core.List<api.EditAtom> buildUnnamed8458() {
  var o = <api.EditAtom>[];
  o.add(buildEditAtom());
  o.add(buildEditAtom());
  return o;
...
void checkUnnamed8458(core.List<api.EditAtom> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEditAtom(o[0] as api.EditAtom);
  checkEditAtom(o[1] as api.EditAtom);
}

core.List<api.ElementaryStream> buildUnnamed8459() {
  var o = <api.ElementaryStream>[];
...
void checkUnnamed8460(core.List<api.Input> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInput(o[0] as api.Input);
  checkInput(o[1] as api.Input);
}

core.List<api.Manifest> buildUnnamed8461() {
  var o = <api.Manifest>[];
  o.add(buildManifest());
  o.add(buildManifest());
  return o;
...
void checkUnnamed8461(core.List<api.Manifest> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkManifest(o[0] as api.Manifest);
  checkManifest(o[1] as api.Manifest);
}

core.List<api.MuxStream> buildUnnamed8462() {
  var o = <api.MuxStream>[];
...
void checkUnnamed8462(core.List<api.MuxStream> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMuxStream(o[0] as api.MuxStream);
  checkMuxStream(o[1] as api.MuxStream);
}

core.List<api.Overlay> buildUnnamed8463() {
  var o = <api.Overlay>[];
  o.add(buildOverlay());
  o.add(buildOverlay());
  return o;
...
void checkUnnamed8463(core.List<api.Overlay> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOverlay(o[0] as api.Overlay);
  checkOverlay(o[1] as api.Overlay);
}

core.List<api.SpriteSheet> buildUnnamed8464() {
...
void checkUnnamed8464(core.List<api.SpriteSheet> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.JobConfig buildJobConfig() {
  ...
  if (buildCounterJobConfig < 3) {
    o.adBreaks = buildUnnamed8457();
    o.editList = buildUnnamed8458();
    o.elementaryStreams = buildUnnamed8459();
    o.inputs = buildUnnamed8460();
    o.manifests = buildUnnamed8461();
    o.muxStreams = buildUnnamed8462();
    o.output = buildOutput();
    o.overlays = buildUnnamed8463();
    o.pubsubDestination = buildPubsubDestination();
    o.spriteSheets = buildUnnamed8464();
  }
  buildCounterJobConfig--;
  return o;
}
...
void checkJobConfig(api.JobConfig o) {
  buildCounterJobConfig++;
  if (buildCounterJobConfig < 3) {
    checkUnnamed8457(o.adBreaks!);
    checkUnnamed8458(o.editList!);
    checkUnnamed8459(o.elementaryStreams!);
    checkUnnamed8460(o.inputs!);
    checkUnnamed8461(o.manifests!);
    checkUnnamed8462(o.muxStreams!);
    checkOutput(o.output! as api.Output);
    checkUnnamed8463(o.overlays!);
    checkPubsubDestination(o.pubsubDestination! as api.PubsubDestination);
    checkUnnamed8464(o.spriteSheets!);
  }
  buildCounterJobConfig--;
}
...
core.List<api.JobTemplate> buildUnnamed8465() {
  var o = <api.JobTemplate>[];
...
void checkUnnamed8465(core.List<api.JobTemplate> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListJobTemplatesResponse buildListJobTemplatesResponse() {
  ...
  if (buildCounterListJobTemplatesResponse < 3) {
    o.jobTemplates = buildUnnamed8465();
    o.nextPageToken = 'foo';
  }
  buildCounterListJobTemplatesResponse--;
  return o;
...
void checkListJobTemplatesResponse(api.ListJobTemplatesResponse o) {
  buildCounterListJobTemplatesResponse++;
  if (buildCounterListJobTemplatesResponse < 3) {
    checkUnnamed8465(o.jobTemplates!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Job> buildUnnamed8466() {
  var o = <api.Job>[];
  o.add(buildJob());
  o.add(buildJob());
  return o;
...
void checkUnnamed8466(core.List<api.Job> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MuxStream buildMuxStream() {
  ...
  if (buildCounterMuxStream < 3) {
    o.container = 'foo';
    o.elementaryStreams = buildUnnamed8468();
...
void checkMuxStream(api.MuxStream o) {
  ...
  if (buildCounterMuxStream < 3) {
    ...
    checkUnnamed8468(o.elementaryStreams!);
...
core.List<api.Animation> buildUnnamed8469() {
  var o = <api.Animation>[];
...
void checkUnnamed8469(core.List<api.Animation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.TextInput> buildUnnamed8470() {
  var o = <api.TextInput>[];
...
void checkUnnamed8470(core.List<api.TextInput> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.TextAtom> buildUnnamed8471() {
  var o = <api.TextAtom>[];
  o.add(buildTextAtom());
  o.add(buildTextAtom());
  return o;
...
void checkUnnamed8471(core.List<api.TextAtom> o) {
  unittest.expect(o, unittest.hasLength(2));
