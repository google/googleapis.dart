...
core.List<api.Error> buildUnnamed0() => [buildError(), buildError()];
...
void checkDiscoverConnectionProfileRequest(
  ...
  if (buildCounterDiscoverConnectionProfileRequest < 3) {
    ...
    unittest.expect(o.connectionProfileName!, unittest.equals('foo'));
    checkMysqlRdbms(o.mysqlRdbms!);
    checkOracleRdbms(o.oracleRdbms!);
    unittest.expect(o.recursionDepth!, unittest.equals(42));
...
void checkError(api.Error o) {
  ...
  if (buildCounterError < 3) {
    ...
    unittest.expect(o.errorUuid!, unittest.equals('foo'));
...
void checkGcsDestinationConfig(api.GcsDestinationConfig o) {
  ...
  if (buildCounterGcsDestinationConfig < 3) {
    ...
    unittest.expect(o.fileRotationInterval!, unittest.equals('foo'));
    unittest.expect(o.fileRotationMb!, unittest.equals(42));
    unittest.expect(o.gcsFileFormat!, unittest.equals('foo'));
...
void checkJsonFileFormat(api.JsonFileFormat o) {
  ...
  if (buildCounterJsonFileFormat < 3) {
    ...
    unittest.expect(o.schemaFileFormat!, unittest.equals('foo'));
  }
  buildCounterJsonFileFormat--;
}
...
core.List<api.PrivateConnection> buildUnnamed9() => [
  buildPrivateConnection(),
  buildPrivateConnection(),
];

void checkUnnamed9(core.List<api.PrivateConnection> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListPrivateConnectionsResponse buildListPrivateConnectionsResponse() {
  ...
  if (buildCounterListPrivateConnectionsResponse < 3) {
    o.nextPageToken = 'foo';
    o.privateConnections = buildUnnamed9();
...
void checkListPrivateConnectionsResponse(api.ListPrivateConnectionsResponse o) {
  ...
  if (buildCounterListPrivateConnectionsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed9(o.privateConnections!);
    checkUnnamed10(o.unreachable!);
  }
  buildCounterListPrivateConnectionsResponse--;
}

core.List<api.Route> buildUnnamed11() => [buildRoute(), buildRoute()];

void checkUnnamed11(core.List<api.Route> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRoute(o[0]);
  checkRoute(o[1]);
}
...
void checkListRoutesResponse(api.ListRoutesResponse o) {
  ...
  if (buildCounterListRoutesResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed11(o.routes!);
    checkUnnamed12(o.unreachable!);
  }
  buildCounterListRoutesResponse--;
}

core.List<api.StreamObject> buildUnnamed13() => [
  buildStreamObject(),
  buildStreamObject(),
];

void checkUnnamed13(core.List<api.StreamObject> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListStreamObjectsResponse buildListStreamObjectsResponse() {
  ...
  if (buildCounterListStreamObjectsResponse < 3) {
    o.nextPageToken = 'foo';
    o.streamObjects = buildUnnamed13();
  }
  buildCounterListStreamObjectsResponse--;
  return o;
}
...
void checkListStreamObjectsResponse(api.ListStreamObjectsResponse o) {
  ...
  if (buildCounterListStreamObjectsResponse < 3) {
    unittest.expect(o.nextPageToken!, unittest.equals('foo'));
    checkUnnamed13(o.streamObjects!);
  }
  buildCounterListStreamObjectsResponse--;
}

core.List<api.Stream> buildUnnamed14() => [buildStream(), buildStream()];

void checkUnnamed14(core.List<api.Stream> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStream(o[0]);
  checkStream(o[1]);
}
...
core.List<api.MysqlTable> buildUnnamed18() => [
  buildMysqlTable(),
  buildMysqlTable(),
];

void checkUnnamed18(core.List<api.MysqlTable> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMysqlTable(o[0]);
  checkMysqlTable(o[1]);
}
...
core.List<api.MysqlDatabase> buildUnnamed19() => [
  buildMysqlDatabase(),
  buildMysqlDatabase(),
];

void checkUnnamed19(core.List<api.MysqlDatabase> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.MysqlRdbms buildMysqlRdbms() {
  ...
  if (buildCounterMysqlRdbms < 3) {
    o.mysqlDatabases = buildUnnamed19();
  }
  buildCounterMysqlRdbms--;
  return o;
}
...
void checkMysqlRdbms(api.MysqlRdbms o) {
  buildCounterMysqlRdbms++;
  if (buildCounterMysqlRdbms < 3) {
    checkUnnamed19(o.mysqlDatabases!);
  }
  buildCounterMysqlRdbms--;
}
...
core.List<api.MysqlColumn> buildUnnamed20() => [
  buildMysqlColumn(),
  buildMysqlColumn(),
];

void checkUnnamed20(core.List<api.MysqlColumn> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkOracleColumn(api.OracleColumn o) {
  ...
  if (buildCounterOracleColumn < 3) {
    ...
    unittest.expect(o.nullable!, unittest.isTrue);
    unittest.expect(o.ordinalPosition!, unittest.equals(42));
    unittest.expect(o.precision!, unittest.equals(42));
    unittest.expect(o.primaryKey!, unittest.isTrue);
    unittest.expect(o.scale!, unittest.equals(42));
  }
  buildCounterOracleColumn--;
}
...
void checkOracleProfile(api.OracleProfile o) {
  ...
  if (buildCounterOracleProfile < 3) {
    ...
    unittest.expect(o.databaseService!, unittest.equals('foo'));
    unittest.expect(o.hostname!, unittest.equals('foo'));
    unittest.expect(o.password!, unittest.equals('foo'));
    unittest.expect(o.port!, unittest.equals(42));
    unittest.expect(o.username!, unittest.equals('foo'));
...
void checkPrivateConnectivity(api.PrivateConnectivity o) {
  buildCounterPrivateConnectivity++;
  if (buildCounterPrivateConnectivity < 3) {
    unittest.expect(o.privateConnectionName!, unittest.equals('foo'));
  }
  buildCounterPrivateConnectivity--;
}
...
void checkRoute(api.Route o) {
  ...
  if (buildCounterRoute < 3) {
    unittest.expect(o.createTime!, unittest.equals('foo'));
    unittest.expect(o.destinationAddress!, unittest.equals('foo'));
...
void checkSourceConfig(api.SourceConfig o) {
  ...
  if (buildCounterSourceConfig < 3) {
    ...
    unittest.expect(o.sourceConnectionProfileName!, unittest.equals('foo'));
  }
  buildCounterSourceConfig--;
}
...
core.List<api.Error> buildUnnamed31() => [buildError(), buildError()];

void checkUnnamed31(core.List<api.Error> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkError(o[0]);
  checkError(o[1]);
}
...
core.List<api.Error> buildUnnamed33() => [buildError(), buildError()];
...
void main() {
  ...
  unittest.group('obj-schema-GcsProfile', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GcsProfile.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkGcsProfile(od);
    });
  ...
  unittest.group('obj-schema-MysqlRdbms', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.MysqlRdbms.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkMysqlRdbms(od);
    });
  ...
  unittest.group('obj-schema-MysqlTable', () {
    unittest.test('to-json--from-json', () async {
      ...
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.MysqlTable.fromJson(
        oJson as core.Map<core.String, core.dynamic>,
      );
      checkMysqlTable(od);
    });
  ...
  unittest.group('resource-ProjectsLocationsResource', () {
    unittest.test('method--fetchStaticIps', () async {
      ...
      final response = await res.fetchStaticIps(
        arg_name,
      ...
      mock.register(
        unittest.expectAsync2((http.BaseRequest req, json) {
          ...
          final resp = convert.json.encode(
            buildDiscoverConnectionProfileResponse(),
          );
          return async.Future.value(stringResponse(200, h, resp));
        }),
        true,
      );
      final response = await res.discover(
        arg_request,
        arg_parent,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-ProjectsLocationsStreamsResource', () {
    ...
    unittest.test('method--fetchErrors', () async {
      ...
      final response = await res.fetchErrors(
        arg_request,
        arg_stream,
        $fields: arg_$fields,
      );
  ...
  unittest.group('resource-ProjectsLocationsStreamsObjectsResource', () {
    ...
    unittest.test('method--startBackfillJob', () async {
      ...
      final response = await res.startBackfillJob(
        arg_object,
        $fields: arg_$fields,
      );
    ...
    unittest.test('method--stopBackfillJob', () async {
      ...
      final response = await res.stopBackfillJob(
        arg_object,
        $fields: arg_$fields,
      );
