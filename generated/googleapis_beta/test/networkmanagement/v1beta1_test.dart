library googleapis_beta.networkmanagement.v1beta1.test;
...
import 'package:googleapis_beta/networkmanagement/v1beta1.dart' as api;
...
checkUnnamed5600(core.List<api.AuditLogConfig> o) {
...
buildAuditConfig() {
  ...
  if (buildCounterAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed5600();
    o.service = "foo";
  }
  buildCounterAuditConfig--;
  return o;
...
checkAuditConfig(api.AuditConfig o) {
  buildCounterAuditConfig++;
  if (buildCounterAuditConfig < 3) {
    checkUnnamed5600(o.auditLogConfigs);
...
checkUnnamed5601(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAuditLogConfig() {
  ...
  if (buildCounterAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed5601();
    o.logType = "foo";
  }
  buildCounterAuditLogConfig--;
  return o;
...
checkAuditLogConfig(api.AuditLogConfig o) {
  buildCounterAuditLogConfig++;
  if (buildCounterAuditLogConfig < 3) {
    checkUnnamed5601(o.exemptedMembers);
...
checkUnnamed5603(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildConnectivityTest() {
  ...
  if (buildCounterConnectivityTest < 3) {
    ...
    o.relatedProjects = buildUnnamed5604();
...
checkConnectivityTest(api.ConnectivityTest o) {
  ...
  if (buildCounterConnectivityTest < 3) {
    ...
    checkUnnamed5604(o.relatedProjects);
...
buildFirewallInfo() {
  ...
  if (buildCounterFirewallInfo < 3) {
    ...
    o.networkUri = "foo";
    o.priority = 42;
    o.targetServiceAccounts = buildUnnamed5605();
    o.targetTags = buildUnnamed5606();
    o.uri = "foo";
  }
  buildCounterFirewallInfo--;
  return o;
...
checkFirewallInfo(api.FirewallInfo o) {
  ...
  if (buildCounterFirewallInfo < 3) {
    ...
    checkUnnamed5605(o.targetServiceAccounts);
    checkUnnamed5606(o.targetTags);
...
checkUnnamed5607(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
buildInstanceInfo() {
  ...
  if (buildCounterInstanceInfo < 3) {
    ...
    o.interface = "foo";
    o.internalIp = "foo";
    o.networkTags = buildUnnamed5607();
    o.networkUri = "foo";
...
checkInstanceInfo(api.InstanceInfo o) {
  ...
  if (buildCounterInstanceInfo < 3) {
    ...
    checkUnnamed5607(o.networkTags);
    unittest.expect(o.networkUri, unittest.equals('foo'));
...
checkUnnamed5608(core.List<api.ConnectivityTest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5609(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
buildListConnectivityTestsResponse() {
  ...
  if (buildCounterListConnectivityTestsResponse < 3) {
    o.nextPageToken = "foo";
    o.resources = buildUnnamed5608();
    o.unreachable = buildUnnamed5609();
  }
  buildCounterListConnectivityTestsResponse--;
  return o;
}
...
checkListConnectivityTestsResponse(api.ListConnectivityTestsResponse o) {
  ...
  if (buildCounterListConnectivityTestsResponse < 3) {
    ...
    checkUnnamed5608(o.resources);
    checkUnnamed5609(o.unreachable);
  }
  buildCounterListConnectivityTestsResponse--;
}
...
checkUnnamed5610(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
checkUnnamed5611(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
buildLoadBalancerBackend() {
  ...
  if (buildCounterLoadBalancerBackend < 3) {
    o.displayName = "foo";
    o.healthCheckAllowingFirewallRules = buildUnnamed5612();
    o.healthCheckBlockingFirewallRules = buildUnnamed5613();
...
checkLoadBalancerBackend(api.LoadBalancerBackend o) {
  ...
  if (buildCounterLoadBalancerBackend < 3) {
    unittest.expect(o.displayName, unittest.equals('foo'));
    checkUnnamed5612(o.healthCheckAllowingFirewallRules);
    checkUnnamed5613(o.healthCheckBlockingFirewallRules);
...
checkUnnamed5614(core.List<api.LoadBalancerBackend> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5616(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5617(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5618(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5619(core.List<api.AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5620(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.auditConfigs = buildUnnamed5619();
    o.bindings = buildUnnamed5620();
    o.etag = "foo";
    o.version = 42;
  }
  buildCounterPolicy--;
...
checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed5619(o.auditConfigs);
    checkUnnamed5620(o.bindings);
...
checkUnnamed5621(core.List<api.Trace> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTrace(o[0]);
  checkTrace(o[1]);
}
...
buildRouteInfo() {
  ...
  if (buildCounterRouteInfo < 3) {
    o.destIpRange = "foo";
    o.displayName = "foo";
    o.instanceTags = buildUnnamed5622();
    o.networkUri = "foo";
    o.nextHop = "foo";
    o.nextHopType = "foo";
    o.priority = 42;
...
checkRouteInfo(api.RouteInfo o) {
  ...
  if (buildCounterRouteInfo < 3) {
    ...
    unittest.expect(o.displayName, unittest.equals('foo'));
    checkUnnamed5622(o.instanceTags);
    unittest.expect(o.networkUri, unittest.equals('foo'));
...
checkUnnamed5623(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed5624() {
  ...
  o.add(buildUnnamed5623());
  o.add(buildUnnamed5623());
  return o;
}

checkUnnamed5624(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed5623(o[0]);
  checkUnnamed5623(o[1]);
}
...
buildTestIamPermissionsRequest() {
  ...
  if (buildCounterTestIamPermissionsRequest < 3) {
    o.permissions = buildUnnamed5625();
  }
  buildCounterTestIamPermissionsRequest--;
  return o;
}
...
checkTestIamPermissionsRequest(api.TestIamPermissionsRequest o) {
  buildCounterTestIamPermissionsRequest++;
  if (buildCounterTestIamPermissionsRequest < 3) {
    checkUnnamed5625(o.permissions);
  }
  buildCounterTestIamPermissionsRequest--;
}
...
buildTestIamPermissionsResponse() {
  ...
  if (buildCounterTestIamPermissionsResponse < 3) {
    o.permissions = buildUnnamed5626();
  }
  buildCounterTestIamPermissionsResponse--;
  return o;
}
...
checkTestIamPermissionsResponse(api.TestIamPermissionsResponse o) {
  buildCounterTestIamPermissionsResponse++;
  if (buildCounterTestIamPermissionsResponse < 3) {
    checkUnnamed5626(o.permissions);
  }
  buildCounterTestIamPermissionsResponse--;
}
...
checkUnnamed5627(core.List<api.Step> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStep(o[0]);
  checkStep(o[1]);
}
