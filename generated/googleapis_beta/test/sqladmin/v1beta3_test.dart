...
checkUnnamed3739(core.List<api.BackupRun> o) {
...
checkUnnamed3740(core.List<api.IpMapping> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIpMapping(o[0]);
  checkIpMapping(o[1]);
}
...
buildDatabaseInstance() {
  ...
  if (buildCounterDatabaseInstance < 3) {
    ...
    o.instance = "foo";
    o.instanceType = "foo";
    o.ipAddresses = buildUnnamed3740();
    o.ipv6Address = "foo";
    o.kind = "foo";
    ...
    o.project = "foo";
    o.region = "foo";
    o.replicaNames = buildUnnamed3741();
...
checkDatabaseInstance(api.DatabaseInstance o) {
  ...
  if (buildCounterDatabaseInstance < 3) {
    ...
    checkUnnamed3740(o.ipAddresses);
    ...
    checkUnnamed3741(o.replicaNames);
...
buildExportContext() {
  ...
  if (buildCounterExportContext < 3) {
    o.database = buildUnnamed3742();
    o.kind = "foo";
    o.table = buildUnnamed3743();
    o.uri = "foo";
  }
  buildCounterExportContext--;
  return o;
...
checkExportContext(api.ExportContext o) {
  buildCounterExportContext++;
  if (buildCounterExportContext < 3) {
    checkUnnamed3742(o.database);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed3743(o.table);
...
buildFlag() {
  ...
  if (buildCounterFlag < 3) {
    o.allowedStringValues = buildUnnamed3744();
    o.appliesTo = buildUnnamed3745();
    o.kind = "foo";
    o.maxValue = "foo";
    o.minValue = "foo";
    o.name = "foo";
...
checkFlag(api.Flag o) {
  buildCounterFlag++;
  if (buildCounterFlag < 3) {
    checkUnnamed3744(o.allowedStringValues);
    checkUnnamed3745(o.appliesTo);
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed3746(core.List<api.Flag> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFlag(o[0]);
  checkFlag(o[1]);
}
...
checkUnnamed3748(core.List<api.OperationError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3749(core.List<api.DatabaseInstance> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildIpConfiguration() {
  ...
  if (buildCounterIpConfiguration < 3) {
    o.authorizedNetworks = buildUnnamed3750();
    o.enabled = true;
    o.kind = "foo";
    o.requireSsl = true;
  }
...
checkIpConfiguration(api.IpConfiguration o) {
  buildCounterIpConfiguration++;
  if (buildCounterIpConfiguration < 3) {
    checkUnnamed3750(o.authorizedNetworks);
    unittest.expect(o.enabled, unittest.isTrue);
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed3751(core.List<api.InstanceOperation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3753(core.List<api.BackupConfiguration> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3754(core.List<api.DatabaseFlags> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSettings() {
  ...
  if (buildCounterSettings < 3) {
    ...
    o.authorizedGaeApplications = buildUnnamed3752();
    o.backupConfiguration = buildUnnamed3753();
    o.databaseFlags = buildUnnamed3754();
...
checkSettings(api.Settings o) {
  ...
  if (buildCounterSettings < 3) {
    ...
    checkUnnamed3752(o.authorizedGaeApplications);
    checkUnnamed3753(o.backupConfiguration);
    checkUnnamed3754(o.databaseFlags);
...
checkUnnamed3755(core.List<api.SslCert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSslCert(o[0]);
  checkSslCert(o[1]);
}
...
checkUnnamed3757(core.List<api.Tier> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTier(o[0]);
  checkTier(o[1]);
}
