...
checkUnnamed4949(core.List<api.BackupRun> o) {
...
checkUnnamed4950(core.List<api.IpMapping> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIpMapping(o[0]);
  checkIpMapping(o[1]);
}
...
buildDatabaseInstance() {
  ...
  if (buildCounterDatabaseInstance < 3) {
    ...
    o.instance = "foo";
    o.instanceType = "foo";
    o.ipAddresses = buildUnnamed4950();
    o.ipv6Address = "foo";
    o.kind = "foo";
    ...
    o.project = "foo";
    o.region = "foo";
    o.replicaNames = buildUnnamed4951();
...
checkDatabaseInstance(api.DatabaseInstance o) {
  ...
  if (buildCounterDatabaseInstance < 3) {
    ...
    checkUnnamed4950(o.ipAddresses);
    ...
    checkUnnamed4951(o.replicaNames);
...
buildExportContext() {
  ...
  if (buildCounterExportContext < 3) {
    o.database = buildUnnamed4952();
    o.kind = "foo";
    o.table = buildUnnamed4953();
    o.uri = "foo";
  }
  buildCounterExportContext--;
  return o;
...
checkExportContext(api.ExportContext o) {
  buildCounterExportContext++;
  if (buildCounterExportContext < 3) {
    checkUnnamed4952(o.database);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed4953(o.table);
...
checkUnnamed4954(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
buildFlag() {
  ...
  if (buildCounterFlag < 3) {
    o.allowedStringValues = buildUnnamed4954();
    o.appliesTo = buildUnnamed4955();
    o.kind = "foo";
    o.maxValue = "foo";
    o.minValue = "foo";
    o.name = "foo";
...
checkFlag(api.Flag o) {
  buildCounterFlag++;
  if (buildCounterFlag < 3) {
    checkUnnamed4954(o.allowedStringValues);
    checkUnnamed4955(o.appliesTo);
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed4956(core.List<api.Flag> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFlag(o[0]);
  checkFlag(o[1]);
}
...
checkUnnamed4958(core.List<api.OperationError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4959(core.List<api.DatabaseInstance> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildIpConfiguration() {
  ...
  if (buildCounterIpConfiguration < 3) {
    o.authorizedNetworks = buildUnnamed4960();
    o.enabled = true;
    o.kind = "foo";
    o.requireSsl = true;
  }
...
checkIpConfiguration(api.IpConfiguration o) {
  buildCounterIpConfiguration++;
  if (buildCounterIpConfiguration < 3) {
    checkUnnamed4960(o.authorizedNetworks);
    unittest.expect(o.enabled, unittest.isTrue);
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed4961(core.List<api.InstanceOperation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4963(core.List<api.BackupConfiguration> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4964(core.List<api.DatabaseFlags> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSettings() {
  ...
  if (buildCounterSettings < 3) {
    ...
    o.authorizedGaeApplications = buildUnnamed4962();
    o.backupConfiguration = buildUnnamed4963();
    o.databaseFlags = buildUnnamed4964();
...
checkSettings(api.Settings o) {
  ...
  if (buildCounterSettings < 3) {
    ...
    checkUnnamed4962(o.authorizedGaeApplications);
    checkUnnamed4963(o.backupConfiguration);
    checkUnnamed4964(o.databaseFlags);
...
checkUnnamed4965(core.List<api.SslCert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSslCert(o[0]);
  checkSslCert(o[1]);
}
...
checkUnnamed4966(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
checkUnnamed4967(core.List<api.Tier> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTier(o[0]);
  checkTier(o[1]);
}
