...
core.List<api.BackupRun> buildUnnamed8136() => [
      buildBackupRun(),
      buildBackupRun(),
    ];

void checkUnnamed8136(core.List<api.BackupRun> o) {
...
core.List<api.IpMapping> buildUnnamed8137() => [
      buildIpMapping(),
      buildIpMapping(),
    ];

void checkUnnamed8137(core.List<api.IpMapping> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIpMapping(o[0]);
  checkIpMapping(o[1]);
}
...
api.ConnectSettings buildConnectSettings() {
  ...
  if (buildCounterConnectSettings < 3) {
    ...
    o.ipAddresses = buildUnnamed8137();
    o.kind = 'foo';
...
void checkConnectSettings(api.ConnectSettings o) {
  ...
  if (buildCounterConnectSettings < 3) {
    ...
    checkUnnamed8137(o.ipAddresses!);
    unittest.expect(
      o.kind!,
      unittest.equals('foo'),
    );
...
core.List<api.IpMapping> buildUnnamed8138() => [
      buildIpMapping(),
      buildIpMapping(),
    ];

void checkUnnamed8138(core.List<api.IpMapping> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIpMapping(o[0]);
  checkIpMapping(o[1]);
}
...
api.DatabaseInstance buildDatabaseInstance() {
  ...
  if (buildCounterDatabaseInstance < 3) {
    ...
    o.gceZone = 'foo';
    o.instanceType = 'foo';
    o.ipAddresses = buildUnnamed8138();
    o.ipv6Address = 'foo';
    o.kind = 'foo';
    ...
    o.replicaNames = buildUnnamed8139();
    o.rootPassword = 'foo';
    o.satisfiesPzs = true;
    ...
    o.state = 'foo';
    o.suspensionReason = buildUnnamed8140();
  }
  buildCounterDatabaseInstance--;
  return o;
}
...
void checkDatabaseInstance(api.DatabaseInstance o) {
  ...
  if (buildCounterDatabaseInstance < 3) {
    ...
    checkUnnamed8138(o.ipAddresses!);
    unittest.expect(
      o.ipv6Address!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed8139(o.replicaNames!);
    unittest.expect(
      o.rootPassword!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed8140(o.suspensionReason!);
  }
  buildCounterDatabaseInstance--;
}

core.List<api.Database> buildUnnamed8141() => [
      buildDatabase(),
      buildDatabase(),
    ];

void checkUnnamed8141(core.List<api.Database> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDatabase(o[0]);
  checkDatabase(o[1]);
}
...
api.Flag buildFlag() {
  ...
  if (buildCounterFlag < 3) {
    o.allowedIntValues = buildUnnamed8144();
    o.allowedStringValues = buildUnnamed8145();
    o.appliesTo = buildUnnamed8146();
    o.inBeta = true;
    o.kind = 'foo';
    o.maxValue = 'foo';
    o.minValue = 'foo';
...
void checkFlag(api.Flag o) {
  buildCounterFlag++;
  if (buildCounterFlag < 3) {
    checkUnnamed8144(o.allowedIntValues!);
    checkUnnamed8145(o.allowedStringValues!);
    checkUnnamed8146(o.appliesTo!);
...
core.List<api.Flag> buildUnnamed8147() => [
      buildFlag(),
      buildFlag(),
    ];

void checkUnnamed8147(core.List<api.Flag> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFlag(o[0]);
  checkFlag(o[1]);
}
...
core.List<api.DatabaseInstance> buildUnnamed8149() => [
      buildDatabaseInstance(),
      buildDatabaseInstance(),
    ];

void checkUnnamed8149(core.List<api.DatabaseInstance> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDatabaseInstance(o[0]);
  checkDatabaseInstance(o[1]);
}

core.List<api.ApiWarning> buildUnnamed8150() => [
      buildApiWarning(),
      buildApiWarning(),
    ];

void checkUnnamed8150(core.List<api.ApiWarning> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApiWarning(o[0]);
  checkApiWarning(o[1]);
}
...
void checkInstancesListResponse(api.InstancesListResponse o) {
  ...
  if (buildCounterInstancesListResponse < 3) {
    ...
    checkUnnamed8150(o.warnings!);
  }
  buildCounterInstancesListResponse--;
}

core.List<api.SslCert> buildUnnamed8151() => [
      buildSslCert(),
      buildSslCert(),
    ];

void checkUnnamed8151(core.List<api.SslCert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSslCert(o[0]);
  checkSslCert(o[1]);
}
...
core.List<api.AclEntry> buildUnnamed8152() => [
      buildAclEntry(),
      buildAclEntry(),
    ];

void checkUnnamed8152(core.List<api.AclEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAclEntry(o[0]);
  checkAclEntry(o[1]);
}
...
api.IpConfiguration buildIpConfiguration() {
  ...
  if (buildCounterIpConfiguration < 3) {
    o.authorizedNetworks = buildUnnamed8152();
    o.ipv4Enabled = true;
...
void checkIpConfiguration(api.IpConfiguration o) {
  buildCounterIpConfiguration++;
  if (buildCounterIpConfiguration < 3) {
    checkUnnamed8152(o.authorizedNetworks!);
...
core.List<api.OperationError> buildUnnamed8153() => [
      buildOperationError(),
      buildOperationError(),
    ];

void checkUnnamed8153(core.List<api.OperationError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Operation> buildUnnamed8154() => [
      buildOperation(),
      buildOperation(),
    ];

void checkUnnamed8154(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
core.List<core.String> buildUnnamed8155() => [
      'foo',
      'foo',
    ];

void checkUnnamed8155(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.DatabaseFlags> buildUnnamed8156() => [
      buildDatabaseFlags(),
      buildDatabaseFlags(),
    ];

void checkUnnamed8156(core.List<api.DatabaseFlags> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDatabaseFlags(o[0]);
  checkDatabaseFlags(o[1]);
}

core.List<api.DenyMaintenancePeriod> buildUnnamed8157() => [
      buildDenyMaintenancePeriod(),
      buildDenyMaintenancePeriod(),
    ];

void checkUnnamed8157(core.List<api.DenyMaintenancePeriod> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDenyMaintenancePeriod(o[0]);
  checkDenyMaintenancePeriod(o[1]);
}

core.Map<core.String, core.String> buildUnnamed8158() => {
      'x': 'foo',
      'y': 'foo',
    };

void checkUnnamed8158(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o['x']!,
    unittest.equals('foo'),
...
api.Settings buildSettings() {
  ...
  if (buildCounterSettings < 3) {
    ...
    o.authorizedGaeApplications = buildUnnamed8155();
    ...
    o.dataDiskType = 'foo';
    o.databaseFlags = buildUnnamed8156();
    o.databaseReplicationEnabled = true;
    o.denyMaintenancePeriods = buildUnnamed8157();
...
void checkSettings(api.Settings o) {
  ...
  if (buildCounterSettings < 3) {
    ...
    checkUnnamed8155(o.authorizedGaeApplications!);
    unittest.expect(
      o.availabilityType!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed8156(o.databaseFlags!);
    unittest.expect(o.databaseReplicationEnabled!, unittest.isTrue);
    checkUnnamed8157(o.denyMaintenancePeriods!);
...
core.List<api.SqlExternalSyncSettingError> buildUnnamed8159() => [
      buildSqlExternalSyncSettingError(),
      buildSqlExternalSyncSettingError(),
    ];

void checkUnnamed8159(core.List<api.SqlExternalSyncSettingError> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSqlExternalSyncSettingError(o[0]);
  checkSqlExternalSyncSettingError(o[1]);
}

core.List<api.SqlExternalSyncSettingError> buildUnnamed8160() => [
      buildSqlExternalSyncSettingError(),
      buildSqlExternalSyncSettingError(),
    ];

void checkUnnamed8160(core.List<api.SqlExternalSyncSettingError> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSqlExternalSyncSettingError(o[0]);
  checkSqlExternalSyncSettingError(o[1]);
}
...
api.SqlInstancesVerifyExternalSyncSettingsResponse
  ...
  if (buildCounterSqlInstancesVerifyExternalSyncSettingsResponse < 3) {
    o.errors = buildUnnamed8159();
    o.kind = 'foo';
    o.warnings = buildUnnamed8160();
  }
  buildCounterSqlInstancesVerifyExternalSyncSettingsResponse--;
  return o;
}
...
void checkSqlInstancesVerifyExternalSyncSettingsResponse(
  ...
  buildCounterSqlInstancesVerifyExternalSyncSettingsResponse++;
  if (buildCounterSqlInstancesVerifyExternalSyncSettingsResponse < 3) {
    checkUnnamed8159(o.errors!);
    unittest.expect(
      o.kind!,
      unittest.equals('foo'),
    );
    checkUnnamed8160(o.warnings!);
  }
  buildCounterSqlInstancesVerifyExternalSyncSettingsResponse--;
}
...
core.List<core.String> buildUnnamed8161() => [
      'foo',
      'foo',
    ];

void checkUnnamed8161(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.SqlServerUserDetails buildSqlServerUserDetails() {
  ...
  if (buildCounterSqlServerUserDetails < 3) {
    o.disabled = true;
    o.serverRoles = buildUnnamed8161();
  }
  buildCounterSqlServerUserDetails--;
  return o;
}
...
void checkSqlServerUserDetails(api.SqlServerUserDetails o) {
  ...
  if (buildCounterSqlServerUserDetails < 3) {
    ...
    checkUnnamed8161(o.serverRoles!);
  }
  buildCounterSqlServerUserDetails--;
}
...
core.List<api.SslCert> buildUnnamed8162() => [
      buildSslCert(),
      buildSslCert(),
    ];

void checkUnnamed8162(core.List<api.SslCert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSslCert(o[0]);
  checkSslCert(o[1]);
}
...
core.List<api.Tier> buildUnnamed8164() => [
      buildTier(),
      buildTier(),
    ];

void checkUnnamed8164(core.List<api.Tier> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTier(o[0]);
  checkTier(o[1]);
}
...
core.List<api.User> buildUnnamed8165() => [
      buildUser(),
      buildUser(),
    ];

void checkUnnamed8165(core.List<api.User> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUser(o[0]);
  checkUser(o[1]);
}
