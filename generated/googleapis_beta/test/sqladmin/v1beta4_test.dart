...
checkBackupContext(api.BackupContext o) {
  buildCounterBackupContext++;
  if (buildCounterBackupContext < 3) {
...
buildBackupRetentionSettings() {
  var o = new api.BackupRetentionSettings();
...
checkBackupRetentionSettings(api.BackupRetentionSettings o) {
  buildCounterBackupRetentionSettings++;
  if (buildCounterBackupRetentionSettings < 3) {
...
checkUnnamed6929(core.List<api.BackupRun> o) {
...
checkUnnamed6930(core.List<api.IpMapping> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIpMapping(o[0]);
  checkIpMapping(o[1]);
}
...
checkUnnamed6931(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed6932(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
buildDatabaseInstance() {
  ...
  if (buildCounterDatabaseInstance < 3) {
    ...
    o.gceZone = "foo";
    o.instanceType = "foo";
    o.ipAddresses = buildUnnamed6930();
    o.ipv6Address = "foo";
    o.kind = "foo";
    ...
    o.replicaNames = buildUnnamed6931();
    o.rootPassword = "foo";
    o.satisfiesPzs = true;
    ...
    o.state = "foo";
    o.suspensionReason = buildUnnamed6932();
  }
  buildCounterDatabaseInstance--;
  return o;
}
...
checkDatabaseInstance(api.DatabaseInstance o) {
  ...
  if (buildCounterDatabaseInstance < 3) {
    ...
    checkUnnamed6930(o.ipAddresses);
    ...
    checkUnnamed6931(o.replicaNames);
    ...
    checkUnnamed6932(o.suspensionReason);
  }
  buildCounterDatabaseInstance--;
}
...
checkUnnamed6933(core.List<api.Database> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDatabase(o[0]);
  checkDatabase(o[1]);
}
...
checkUnnamed6934(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
checkUnnamed6935(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
checkUnnamed6936(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
checkUnnamed6937(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
checkUnnamed6938(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
buildFlag() {
  ...
  if (buildCounterFlag < 3) {
    o.allowedIntValues = buildUnnamed6936();
    o.allowedStringValues = buildUnnamed6937();
    o.appliesTo = buildUnnamed6938();
    o.inBeta = true;
    o.kind = "foo";
    o.maxValue = "foo";
    o.minValue = "foo";
...
checkFlag(api.Flag o) {
  buildCounterFlag++;
  if (buildCounterFlag < 3) {
    checkUnnamed6936(o.allowedIntValues);
    checkUnnamed6937(o.allowedStringValues);
    checkUnnamed6938(o.appliesTo);
...
checkUnnamed6939(core.List<api.Flag> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFlag(o[0]);
  checkFlag(o[1]);
}
...
buildImportContextBakImportOptionsEncryptionOptions() {
  var o = new api.ImportContextBakImportOptionsEncryptionOptions();
...
buildImportContextBakImportOptions() {
  var o = new api.ImportContextBakImportOptions();
...
checkImportContextBakImportOptions(api.ImportContextBakImportOptions o) {
  buildCounterImportContextBakImportOptions++;
  if (buildCounterImportContextBakImportOptions < 3) {
...
checkUnnamed6940(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
checkInsightsConfig(api.InsightsConfig o) {
  buildCounterInsightsConfig++;
  if (buildCounterInsightsConfig < 3) {
...
checkUnnamed6941(core.List<api.DatabaseInstance> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed6942(core.List<api.ApiWarning> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApiWarning(o[0]);
  checkApiWarning(o[1]);
}
...
buildInstancesListResponse() {
  ...
  if (buildCounterInstancesListResponse < 3) {
    o.items = buildUnnamed6941();
    o.kind = "foo";
    o.nextPageToken = "foo";
    o.warnings = buildUnnamed6942();
  }
  buildCounterInstancesListResponse--;
  return o;
}
...
checkInstancesListResponse(api.InstancesListResponse o) {
  buildCounterInstancesListResponse++;
  if (buildCounterInstancesListResponse < 3) {
    checkUnnamed6941(o.items);
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed6942(o.warnings);
  }
  buildCounterInstancesListResponse--;
}
...
checkUnnamed6943(core.List<api.SslCert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSslCert(o[0]);
  checkSslCert(o[1]);
}
...
checkUnnamed6944(core.List<api.AclEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAclEntry(o[0]);
  checkAclEntry(o[1]);
}
...
buildIpConfiguration() {
  ...
  if (buildCounterIpConfiguration < 3) {
    o.authorizedNetworks = buildUnnamed6944();
    o.ipv4Enabled = true;
...
checkIpConfiguration(api.IpConfiguration o) {
  buildCounterIpConfiguration++;
  if (buildCounterIpConfiguration < 3) {
    checkUnnamed6944(o.authorizedNetworks);
...
checkUnnamed6945(core.List<api.OperationError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed6946(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkReschedule(api.Reschedule o) {
  buildCounterReschedule++;
  if (buildCounterReschedule < 3) {
...
checkUnnamed6947(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
checkUnnamed6948(core.List<api.DatabaseFlags> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed6949(core.List<api.DenyMaintenancePeriod> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed6950(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSettings() {
  ...
  if (buildCounterSettings < 3) {
    ...
    o.authorizedGaeApplications = buildUnnamed6947();
    ...
    o.dataDiskType = "foo";
    o.databaseFlags = buildUnnamed6948();
    o.databaseReplicationEnabled = true;
    o.denyMaintenancePeriods = buildUnnamed6949();
...
checkSettings(api.Settings o) {
  ...
  if (buildCounterSettings < 3) {
    ...
    checkUnnamed6947(o.authorizedGaeApplications);
    ...
    checkUnnamed6948(o.databaseFlags);
    unittest.expect(o.databaseReplicationEnabled, unittest.isTrue);
    checkUnnamed6949(o.denyMaintenancePeriods);
    ...
    checkUnnamed6950(o.userLabels);
  }
  buildCounterSettings--;
}

core.int buildCounterSqlActiveDirectoryConfig = 0;
buildSqlActiveDirectoryConfig() {
  var o = new api.SqlActiveDirectoryConfig();
...
checkSqlActiveDirectoryConfig(api.SqlActiveDirectoryConfig o) {
  buildCounterSqlActiveDirectoryConfig++;
  if (buildCounterSqlActiveDirectoryConfig < 3) {
...
buildSqlExternalSyncSettingError() {
  var o = new api.SqlExternalSyncSettingError();
...
checkSqlExternalSyncSettingError(api.SqlExternalSyncSettingError o) {
  buildCounterSqlExternalSyncSettingError++;
  if (buildCounterSqlExternalSyncSettingError < 3) {
...
buildSqlInstancesRescheduleMaintenanceRequestBody() {
  var o = new api.SqlInstancesRescheduleMaintenanceRequestBody();
...
checkUnnamed6951(core.List<api.SqlExternalSyncSettingError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSqlScheduledMaintenance() {
  var o = new api.SqlScheduledMaintenance();
...
checkSqlScheduledMaintenance(api.SqlScheduledMaintenance o) {
  buildCounterSqlScheduledMaintenance++;
  if (buildCounterSqlScheduledMaintenance < 3) {
...
buildSqlServerDatabaseDetails() {
  var o = new api.SqlServerDatabaseDetails();
...
checkSqlServerDatabaseDetails(api.SqlServerDatabaseDetails o) {
  buildCounterSqlServerDatabaseDetails++;
  if (buildCounterSqlServerDatabaseDetails < 3) {
...
checkUnnamed6952(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
buildSqlServerUserDetails() {
  var o = new api.SqlServerUserDetails();
  buildCounterSqlServerUserDetails++;
  if (buildCounterSqlServerUserDetails < 3) {
    o.disabled = true;
    o.serverRoles = buildUnnamed6952();
  }
  buildCounterSqlServerUserDetails--;
  return o;
}

checkSqlServerUserDetails(api.SqlServerUserDetails o) {
  buildCounterSqlServerUserDetails++;
  if (buildCounterSqlServerUserDetails < 3) {
    unittest.expect(o.disabled, unittest.isTrue);
    checkUnnamed6952(o.serverRoles);
  }
  buildCounterSqlServerUserDetails--;
}
...
checkUnnamed6953(core.List<api.SslCert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSslCert(o[0]);
  checkSslCert(o[1]);
}
...
checkUnnamed6954(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
checkUnnamed6955(core.List<api.Tier> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTier(o[0]);
  checkTier(o[1]);
}
...
checkUnnamed6956(core.List<api.User> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUser(o[0]);
  checkUser(o[1]);
}
...
main() {
  ...
  unittest.group("obj-schema-BackupContext", () {
    unittest.test("to-json--from-json", () {
      ...
      var od = new api.BackupContext.fromJson(o.toJson());
  ...
  unittest.group("obj-schema-BackupRetentionSettings", () {
    unittest.test("to-json--from-json", () {
      ...
      var od = new api.BackupRetentionSettings.fromJson(o.toJson());
  ...
  unittest.group("obj-schema-ImportContextBakImportOptionsEncryptionOptions",
    ...
    unittest.test("to-json--from-json", () {
      ...
      var od = new api.ImportContextBakImportOptionsEncryptionOptions.fromJson(
          o.toJson());
  ...
  unittest.group("obj-schema-ImportContextBakImportOptions", () {
    unittest.test("to-json--from-json", () {
      ...
      var od = new api.ImportContextBakImportOptions.fromJson(o.toJson());
  ...
  unittest.group("obj-schema-InsightsConfig", () {
    unittest.test("to-json--from-json", () {
      ...
      var od = new api.InsightsConfig.fromJson(o.toJson());
  ...
  unittest.group("obj-schema-Reschedule", () {
    unittest.test("to-json--from-json", () {
      ...
      var od = new api.Reschedule.fromJson(o.toJson());
      checkReschedule(od);
    });
  });
  ...
  unittest.group("obj-schema-SqlActiveDirectoryConfig", () {
    unittest.test("to-json--from-json", () {
      ...
      var od = new api.SqlActiveDirectoryConfig.fromJson(o.toJson());
  ...
  unittest.group("obj-schema-SqlExternalSyncSettingError", () {
    unittest.test("to-json--from-json", () {
      ...
      var od = new api.SqlExternalSyncSettingError.fromJson(o.toJson());
  ...
  unittest.group("obj-schema-SqlInstancesRescheduleMaintenanceRequestBody", () {
    unittest.test("to-json--from-json", () {
      ...
      var od = new api.SqlInstancesRescheduleMaintenanceRequestBody.fromJson(
          o.toJson());
  ...
  unittest.group("obj-schema-SqlInstancesVerifyExternalSyncSettingsResponse",
    ...
    unittest.test("to-json--from-json", () {
      ...
      var od = new api.SqlInstancesVerifyExternalSyncSettingsResponse.fromJson(
          o.toJson());
  ...
  unittest.group("obj-schema-SqlScheduledMaintenance", () {
    unittest.test("to-json--from-json", () {
      ...
      var od = new api.SqlScheduledMaintenance.fromJson(o.toJson());
  ...
  unittest.group("obj-schema-SqlServerDatabaseDetails", () {
    unittest.test("to-json--from-json", () {
      ...
      var od = new api.SqlServerDatabaseDetails.fromJson(o.toJson());
  ...
  unittest.group("obj-schema-SqlServerUserDetails", () {
    unittest.test("to-json--from-json", () {
      ...
      var od = new api.SqlServerUserDetails.fromJson(o.toJson());
  ...
  unittest.group("resource-ProjectsInstancesResourceApi", () {
    unittest.test("method--rescheduleMaintenance", () {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var obj =
            new api.SqlInstancesRescheduleMaintenanceRequestBody.fromJson(json);
