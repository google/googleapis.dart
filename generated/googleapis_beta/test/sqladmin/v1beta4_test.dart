...
core.List<api.BackupRun> buildUnnamed8177() => [
      buildBackupRun(),
      buildBackupRun(),
    ];

void checkUnnamed8177(core.List<api.BackupRun> o) {
...
core.List<api.IpMapping> buildUnnamed8178() => [
      buildIpMapping(),
      buildIpMapping(),
    ];

void checkUnnamed8178(core.List<api.IpMapping> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIpMapping(o[0]);
  checkIpMapping(o[1]);
}
...
api.ConnectSettings buildConnectSettings() {
  ...
  if (buildCounterConnectSettings < 3) {
    ...
    o.ipAddresses = buildUnnamed8178();
    o.kind = 'foo';
...
void checkConnectSettings(api.ConnectSettings o) {
  ...
  if (buildCounterConnectSettings < 3) {
    ...
    checkUnnamed8178(o.ipAddresses!);
    unittest.expect(
      o.kind!,
      unittest.equals('foo'),
    );
...
core.List<api.IpMapping> buildUnnamed8179() => [
      buildIpMapping(),
      buildIpMapping(),
    ];

void checkUnnamed8179(core.List<api.IpMapping> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIpMapping(o[0]);
  checkIpMapping(o[1]);
}

core.List<core.String> buildUnnamed8180() => [
      'foo',
      'foo',
    ];

void checkUnnamed8180(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<core.String> buildUnnamed8181() => [
      'foo',
      'foo',
    ];

void checkUnnamed8181(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.DatabaseInstance buildDatabaseInstance() {
  ...
  if (buildCounterDatabaseInstance < 3) {
    ...
    o.gceZone = 'foo';
    o.instanceType = 'foo';
    o.ipAddresses = buildUnnamed8179();
    o.ipv6Address = 'foo';
    o.kind = 'foo';
    ...
    o.replicaNames = buildUnnamed8180();
    o.rootPassword = 'foo';
    o.satisfiesPzs = true;
    ...
    o.state = 'foo';
    o.suspensionReason = buildUnnamed8181();
  }
  buildCounterDatabaseInstance--;
  return o;
}
...
void checkDatabaseInstance(api.DatabaseInstance o) {
  ...
  if (buildCounterDatabaseInstance < 3) {
    ...
    checkUnnamed8179(o.ipAddresses!);
    unittest.expect(
      o.ipv6Address!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed8180(o.replicaNames!);
    unittest.expect(
      o.rootPassword!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed8181(o.suspensionReason!);
  }
  buildCounterDatabaseInstance--;
}

core.List<api.Database> buildUnnamed8182() => [
      buildDatabase(),
      buildDatabase(),
    ];

void checkUnnamed8182(core.List<api.Database> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDatabase(o[0]);
  checkDatabase(o[1]);
}
...
core.List<core.String> buildUnnamed8186() => [
      'foo',
      'foo',
    ];

void checkUnnamed8186(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.Flag buildFlag() {
  ...
  if (buildCounterFlag < 3) {
    o.allowedIntValues = buildUnnamed8185();
    o.allowedStringValues = buildUnnamed8186();
    o.appliesTo = buildUnnamed8187();
    o.inBeta = true;
    o.kind = 'foo';
    o.maxValue = 'foo';
    o.minValue = 'foo';
...
void checkFlag(api.Flag o) {
  buildCounterFlag++;
  if (buildCounterFlag < 3) {
    checkUnnamed8185(o.allowedIntValues!);
    checkUnnamed8186(o.allowedStringValues!);
    checkUnnamed8187(o.appliesTo!);
...
core.List<api.Flag> buildUnnamed8188() => [
      buildFlag(),
      buildFlag(),
    ];

void checkUnnamed8188(core.List<api.Flag> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFlag(o[0]);
  checkFlag(o[1]);
}
...
core.List<api.DatabaseInstance> buildUnnamed8190() => [
      buildDatabaseInstance(),
      buildDatabaseInstance(),
    ];

void checkUnnamed8190(core.List<api.DatabaseInstance> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDatabaseInstance(o[0]);
  checkDatabaseInstance(o[1]);
}

core.List<api.ApiWarning> buildUnnamed8191() => [
      buildApiWarning(),
      buildApiWarning(),
    ];

void checkUnnamed8191(core.List<api.ApiWarning> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApiWarning(o[0]);
  checkApiWarning(o[1]);
}
...
api.InstancesListResponse buildInstancesListResponse() {
  ...
  if (buildCounterInstancesListResponse < 3) {
    o.items = buildUnnamed8190();
    o.kind = 'foo';
    o.nextPageToken = 'foo';
    o.warnings = buildUnnamed8191();
  }
  buildCounterInstancesListResponse--;
  return o;
}
...
void checkInstancesListResponse(api.InstancesListResponse o) {
  ...
  if (buildCounterInstancesListResponse < 3) {
    ...
    checkUnnamed8191(o.warnings!);
  }
  buildCounterInstancesListResponse--;
}

core.List<api.SslCert> buildUnnamed8192() => [
      buildSslCert(),
      buildSslCert(),
    ];

void checkUnnamed8192(core.List<api.SslCert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSslCert(o[0]);
  checkSslCert(o[1]);
}
...
core.List<api.AclEntry> buildUnnamed8193() => [
      buildAclEntry(),
      buildAclEntry(),
    ];

void checkUnnamed8193(core.List<api.AclEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAclEntry(o[0]);
  checkAclEntry(o[1]);
}
...
api.IpConfiguration buildIpConfiguration() {
  ...
  if (buildCounterIpConfiguration < 3) {
    o.authorizedNetworks = buildUnnamed8193();
    o.ipv4Enabled = true;
...
void checkIpConfiguration(api.IpConfiguration o) {
  buildCounterIpConfiguration++;
  if (buildCounterIpConfiguration < 3) {
    checkUnnamed8193(o.authorizedNetworks!);
...
core.List<api.OperationError> buildUnnamed8194() => [
      buildOperationError(),
      buildOperationError(),
    ];

void checkUnnamed8194(core.List<api.OperationError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Operation> buildUnnamed8195() => [
      buildOperation(),
      buildOperation(),
    ];

void checkUnnamed8195(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
core.List<api.DatabaseFlags> buildUnnamed8197() => [
      buildDatabaseFlags(),
      buildDatabaseFlags(),
    ];

void checkUnnamed8197(core.List<api.DatabaseFlags> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDatabaseFlags(o[0]);
  checkDatabaseFlags(o[1]);
}

core.List<api.DenyMaintenancePeriod> buildUnnamed8198() => [
      buildDenyMaintenancePeriod(),
      buildDenyMaintenancePeriod(),
    ];

void checkUnnamed8198(core.List<api.DenyMaintenancePeriod> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Settings buildSettings() {
  ...
  if (buildCounterSettings < 3) {
    ...
    o.authorizedGaeApplications = buildUnnamed8196();
    ...
    o.dataDiskType = 'foo';
    o.databaseFlags = buildUnnamed8197();
    o.databaseReplicationEnabled = true;
    o.denyMaintenancePeriods = buildUnnamed8198();
...
void checkSettings(api.Settings o) {
  ...
  if (buildCounterSettings < 3) {
    ...
    checkUnnamed8196(o.authorizedGaeApplications!);
    unittest.expect(
      o.availabilityType!,
      unittest.equals('foo'),
    );
    ...
    checkUnnamed8197(o.databaseFlags!);
    unittest.expect(o.databaseReplicationEnabled!, unittest.isTrue);
    checkUnnamed8198(o.denyMaintenancePeriods!);
...
core.List<api.SqlExternalSyncSettingError> buildUnnamed8200() => [
      buildSqlExternalSyncSettingError(),
      buildSqlExternalSyncSettingError(),
    ];

void checkUnnamed8200(core.List<api.SqlExternalSyncSettingError> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSqlExternalSyncSettingError(o[0]);
  checkSqlExternalSyncSettingError(o[1]);
}

core.List<api.SqlExternalSyncSettingError> buildUnnamed8201() => [
      buildSqlExternalSyncSettingError(),
      buildSqlExternalSyncSettingError(),
    ];

void checkUnnamed8201(core.List<api.SqlExternalSyncSettingError> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSqlExternalSyncSettingError(o[0]);
  checkSqlExternalSyncSettingError(o[1]);
}
...
api.SqlInstancesVerifyExternalSyncSettingsResponse
  ...
  if (buildCounterSqlInstancesVerifyExternalSyncSettingsResponse < 3) {
    o.errors = buildUnnamed8200();
    o.kind = 'foo';
    o.warnings = buildUnnamed8201();
  }
  buildCounterSqlInstancesVerifyExternalSyncSettingsResponse--;
  return o;
}
...
void checkSqlInstancesVerifyExternalSyncSettingsResponse(
  ...
  buildCounterSqlInstancesVerifyExternalSyncSettingsResponse++;
  if (buildCounterSqlInstancesVerifyExternalSyncSettingsResponse < 3) {
    checkUnnamed8200(o.errors!);
    unittest.expect(
      o.kind!,
      unittest.equals('foo'),
    );
    checkUnnamed8201(o.warnings!);
  }
  buildCounterSqlInstancesVerifyExternalSyncSettingsResponse--;
}
...
api.SqlServerUserDetails buildSqlServerUserDetails() {
  ...
  if (buildCounterSqlServerUserDetails < 3) {
    o.disabled = true;
    o.serverRoles = buildUnnamed8202();
  }
  buildCounterSqlServerUserDetails--;
  return o;
}
...
void checkSqlServerUserDetails(api.SqlServerUserDetails o) {
  ...
  if (buildCounterSqlServerUserDetails < 3) {
    ...
    checkUnnamed8202(o.serverRoles!);
  }
  buildCounterSqlServerUserDetails--;
}
...
core.List<api.SslCert> buildUnnamed8203() => [
      buildSslCert(),
      buildSslCert(),
    ];

void checkUnnamed8203(core.List<api.SslCert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSslCert(o[0]);
  checkSslCert(o[1]);
}
...
core.List<core.String> buildUnnamed8204() => [
      'foo',
      'foo',
    ];

void checkUnnamed8204(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
core.List<api.Tier> buildUnnamed8205() => [
      buildTier(),
      buildTier(),
    ];

void checkUnnamed8205(core.List<api.Tier> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTier(o[0]);
  checkTier(o[1]);
}
...
core.List<api.User> buildUnnamed8206() => [
      buildUser(),
      buildUser(),
    ];

void checkUnnamed8206(core.List<api.User> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUser(o[0]);
  checkUser(o[1]);
}
