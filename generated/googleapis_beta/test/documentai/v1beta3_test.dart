...
core.List<api.GoogleCloudDocumentaiV1beta3DocumentPageTable> buildUnnamed15() =>
    [
...
core.List<api.GoogleCloudDocumentaiV1beta3DocumentPageToken> buildUnnamed16() =>
    [
...
api.GoogleCloudDocumentaiV1beta3DocumentPageTable
  ...
  if (buildCounterGoogleCloudDocumentaiV1beta3DocumentPageTable < 3) {
    o.bodyRows = buildUnnamed25();
    o.detectedLanguages = buildUnnamed26();
    o.headerRows = buildUnnamed27();
    o.layout = buildGoogleCloudDocumentaiV1beta3DocumentPageLayout();
  }
  buildCounterGoogleCloudDocumentaiV1beta3DocumentPageTable--;
  return o;
...
void checkGoogleCloudDocumentaiV1beta3DocumentPageTable(
  ...
  buildCounterGoogleCloudDocumentaiV1beta3DocumentPageTable++;
  if (buildCounterGoogleCloudDocumentaiV1beta3DocumentPageTable < 3) {
    checkUnnamed25(o.bodyRows!);
    checkUnnamed26(o.detectedLanguages!);
    checkUnnamed27(o.headerRows!);
    checkGoogleCloudDocumentaiV1beta3DocumentPageLayout(o.layout!);
  }
  buildCounterGoogleCloudDocumentaiV1beta3DocumentPageTable--;
}
...
core.List<core.int> buildUnnamed33() => [
      42,
      42,
    ];
...
core.List<api.GoogleCloudDocumentaiV1beta3ProcessorType> buildUnnamed36() => [
...
api.GoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse
  ...
  if (buildCounterGoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse < 3) {
    o.processorTypes = buildUnnamed36();
  }
  buildCounterGoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse--;
  return o;
}
...
void checkGoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse(
  ...
  buildCounterGoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse++;
  if (buildCounterGoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse < 3) {
    checkUnnamed36(o.processorTypes!);
  }
  buildCounterGoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse--;
}
...
core.List<api.GoogleCloudDocumentaiV1beta3GcsDocument> buildUnnamed37() => [
      buildGoogleCloudDocumentaiV1beta3GcsDocument(),
      buildGoogleCloudDocumentaiV1beta3GcsDocument(),
    ];

void checkUnnamed37(core.List<api.GoogleCloudDocumentaiV1beta3GcsDocument> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.GoogleCloudDocumentaiV1beta3ProcessorVersion> buildUnnamed38() =>
    [
...
api.GoogleCloudDocumentaiV1beta3ListProcessorVersionsResponse
  ...
  if (buildCounterGoogleCloudDocumentaiV1beta3ListProcessorVersionsResponse <
      3) {
    o.nextPageToken = 'foo';
    o.processorVersions = buildUnnamed38();
  }
  buildCounterGoogleCloudDocumentaiV1beta3ListProcessorVersionsResponse--;
  return o;
}
...
void checkGoogleCloudDocumentaiV1beta3ListProcessorVersionsResponse(
  ...
  if (buildCounterGoogleCloudDocumentaiV1beta3ListProcessorVersionsResponse <
    ...
    checkUnnamed38(o.processorVersions!);
  }
  buildCounterGoogleCloudDocumentaiV1beta3ListProcessorVersionsResponse--;
}

core.List<api.GoogleCloudDocumentaiV1beta3Processor> buildUnnamed39() => [
      buildGoogleCloudDocumentaiV1beta3Processor(),
      buildGoogleCloudDocumentaiV1beta3Processor(),
    ];

void checkUnnamed39(core.List<api.GoogleCloudDocumentaiV1beta3Processor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.GoogleCloudDocumentaiV1beta3ProcessorType
  ...
  if (buildCounterGoogleCloudDocumentaiV1beta3ProcessorType < 3) {
    ...
    o.availableLocations = buildUnnamed40();
    o.category = 'foo';
    o.launchStage = 'foo';
    o.name = 'foo';
    o.type = 'foo';
...
void checkGoogleCloudDocumentaiV1beta3ProcessorType(
  ...
  if (buildCounterGoogleCloudDocumentaiV1beta3ProcessorType < 3) {
    ...
    checkUnnamed40(o.availableLocations!);
    unittest.expect(
      o.category!,
      unittest.equals('foo'),
    );
...
void checkGoogleCloudDocumentaiV1beta3ProcessorVersion(
  ...
  if (buildCounterGoogleCloudDocumentaiV1beta3ProcessorVersion < 3) {
    ...
    checkGoogleCloudDocumentaiV1beta3Schema(o.schema!);
    unittest.expect(
      o.state!,
      unittest.equals('foo'),
    );
...
core.List<api.GoogleCloudDocumentaiV1beta3SchemaEntityType> buildUnnamed41() =>
    [
...
void checkUnnamed41(
  ...
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleCloudDocumentaiV1beta3SchemaEntityType(o[0]);
  checkGoogleCloudDocumentaiV1beta3SchemaEntityType(o[1]);
}
...
core.List<api.GoogleCloudDocumentaiV1beta3SchemaEntityType> buildUnnamed43() =>
    [
      buildGoogleCloudDocumentaiV1beta3SchemaEntityType(),
      buildGoogleCloudDocumentaiV1beta3SchemaEntityType(),
    ];
...
api.GoogleCloudDocumentaiV1beta3SchemaEntityType
    buildGoogleCloudDocumentaiV1beta3SchemaEntityType() {
  final o = api.GoogleCloudDocumentaiV1beta3SchemaEntityType();
...
void main() {
  ...
  unittest.group('obj-schema-GoogleCloudDocumentaiV1beta3Schema', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudDocumentaiV1beta3Schema();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudDocumentaiV1beta3Schema.fromJson(
          oJson as core.Map<core.String, core.dynamic>);
      checkGoogleCloudDocumentaiV1beta3Schema(od);
    });
  });

  unittest.group('obj-schema-GoogleCloudDocumentaiV1beta3SchemaEntityType', () {
    unittest.test('to-json--from-json', () async {
      final o = buildGoogleCloudDocumentaiV1beta3SchemaEntityType();
      final oJson = convert.jsonDecode(convert.jsonEncode(o));
      final od = api.GoogleCloudDocumentaiV1beta3SchemaEntityType.fromJson(
          oJson as core.Map<core.String, core.dynamic>);
      checkGoogleCloudDocumentaiV1beta3SchemaEntityType(od);
    });
  });
