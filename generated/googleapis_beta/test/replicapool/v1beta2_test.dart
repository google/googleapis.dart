...
buildInstanceGroupManager() {
  ...
  if (buildCounterInstanceGroupManager < 3) {
    ...
    o.name = "foo";
    o.selfLink = "foo";
    o.targetPools = buildUnnamed1603();
    o.targetSize = 42;
  }
  buildCounterInstanceGroupManager--;
  return o;
...
checkInstanceGroupManager(api.InstanceGroupManager o) {
  ...
  if (buildCounterInstanceGroupManager < 3) {
    ...
    checkUnnamed1603(o.targetPools);
...
checkUnnamed1604(core.List<api.InstanceGroupManager> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildInstanceGroupManagersSetTargetPoolsRequest() {
  ...
  if (buildCounterInstanceGroupManagersSetTargetPoolsRequest < 3) {
    o.fingerprint = "foo";
    o.targetPools = buildUnnamed1608();
  }
  buildCounterInstanceGroupManagersSetTargetPoolsRequest--;
  return o;
}
...
checkInstanceGroupManagersSetTargetPoolsRequest(api.InstanceGroupManagersSetTargetPoolsRequest o) {
  ...
  if (buildCounterInstanceGroupManagersSetTargetPoolsRequest < 3) {
    unittest.expect(o.fingerprint, unittest.equals('foo'));
    checkUnnamed1608(o.targetPools);
  }
  buildCounterInstanceGroupManagersSetTargetPoolsRequest--;
}
...
checkUnnamed1609(core.List<api.OperationErrorErrors> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1610(core.List<api.OperationWarningsData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1611(core.List<api.OperationWarnings> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1612(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
