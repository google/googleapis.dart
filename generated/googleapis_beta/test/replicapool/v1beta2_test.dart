...
checkUnnamed3078(core.List<api.ReplicaPoolAutoHealingPolicy> o) {
...
buildInstanceGroupManager() {
  ...
  if (buildCounterInstanceGroupManager < 3) {
    o.autoHealingPolicies = buildUnnamed3078();
    ...
    o.name = "foo";
    o.selfLink = "foo";
    o.targetPools = buildUnnamed3079();
    o.targetSize = 42;
  }
  buildCounterInstanceGroupManager--;
  return o;
...
checkInstanceGroupManager(api.InstanceGroupManager o) {
  buildCounterInstanceGroupManager++;
  if (buildCounterInstanceGroupManager < 3) {
    checkUnnamed3078(o.autoHealingPolicies);
    ...
    checkUnnamed3079(o.targetPools);
...
checkUnnamed3080(core.List<api.InstanceGroupManager> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildInstanceGroupManagersSetTargetPoolsRequest() {
  ...
  if (buildCounterInstanceGroupManagersSetTargetPoolsRequest < 3) {
    o.fingerprint = "foo";
    o.targetPools = buildUnnamed3084();
  }
  buildCounterInstanceGroupManagersSetTargetPoolsRequest--;
  return o;
}
...
checkInstanceGroupManagersSetTargetPoolsRequest(api.InstanceGroupManagersSetTargetPoolsRequest o) {
  ...
  if (buildCounterInstanceGroupManagersSetTargetPoolsRequest < 3) {
    unittest.expect(o.fingerprint, unittest.equals('foo'));
    checkUnnamed3084(o.targetPools);
  }
  buildCounterInstanceGroupManagersSetTargetPoolsRequest--;
}
...
checkUnnamed3085(core.List<api.OperationErrorErrors> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3086(core.List<api.OperationWarningsData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3087(core.List<api.OperationWarnings> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3088(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
