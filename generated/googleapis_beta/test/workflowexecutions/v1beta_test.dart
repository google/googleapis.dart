...
import 'package:googleapis_beta/workflowexecutions/v1beta.dart' as api;
...
core.List<api.Execution> buildUnnamed6776() {
  var o = <api.Execution>[];
...
void checkUnnamed6776(core.List<api.Execution> o) {
...
void checkListExecutionsResponse(api.ListExecutionsResponse o) {
  buildCounterListExecutionsResponse++;
  if (buildCounterListExecutionsResponse < 3) {
    checkUnnamed6776(o.executions);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListExecutionsResponse--;
}

core.List<api.StackTraceElement> buildUnnamed6777() {
...
void checkUnnamed6777(core.List<api.StackTraceElement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void main() {
  ...
  unittest.group('obj-schema-StackTraceElement', () {
    unittest.test('to-json--from-json', () {
      ...
      var od = api.StackTraceElement.fromJson(o.toJson());
