...
api.InstanceOSPoliciesCompliance buildInstanceOSPoliciesCompliance() {
  ...
  if (buildCounterInstanceOSPoliciesCompliance < 3) {
    ...
    o.name = 'foo';
    o.osPolicyCompliances = buildUnnamed8717();
    o.state = 'foo';
  }
  buildCounterInstanceOSPoliciesCompliance--;
  return o;
...
void checkInstanceOSPoliciesCompliance(api.InstanceOSPoliciesCompliance o) {
  ...
  if (buildCounterInstanceOSPoliciesCompliance < 3) {
    ...
    checkUnnamed8717(o.osPolicyCompliances!);
    unittest.expect(
      o.state!,
      unittest.equals('foo'),
    );
...
core.List<api.OSPolicyResourceCompliance> buildUnnamed8718() => [
      buildOSPolicyResourceCompliance(),
      buildOSPolicyResourceCompliance(),
    ];

void checkUnnamed8718(core.List<api.OSPolicyResourceCompliance> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.InstanceOSPoliciesComplianceOSPolicyCompliance
  ...
  if (buildCounterInstanceOSPoliciesComplianceOSPolicyCompliance < 3) {
    ...
    o.osPolicyId = 'foo';
    o.osPolicyResourceCompliances = buildUnnamed8718();
    o.state = 'foo';
  }
  buildCounterInstanceOSPoliciesComplianceOSPolicyCompliance--;
  return o;
...
void checkInstanceOSPoliciesComplianceOSPolicyCompliance(
  ...
  if (buildCounterInstanceOSPoliciesComplianceOSPolicyCompliance < 3) {
    ...
    checkUnnamed8718(o.osPolicyResourceCompliances!);
    unittest.expect(
      o.state!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, api.InventoryItem> buildUnnamed8719() => {
      'x': buildInventoryItem(),
      'y': buildInventoryItem(),
    };

void checkUnnamed8719(core.Map<core.String, api.InventoryItem> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.InventoryWindowsUpdatePackage buildInventoryWindowsUpdatePackage() {
  ...
  if (buildCounterInventoryWindowsUpdatePackage < 3) {
    o.categories = buildUnnamed8720();
    o.description = 'foo';
    o.kbArticleIds = buildUnnamed8721();
    o.lastDeploymentChangeTime = 'foo';
    o.moreInfoUrls = buildUnnamed8722();
    o.revisionNumber = 42;
    o.supportUrl = 'foo';
    o.title = 'foo';
    o.updateId = 'foo';
...
void checkInventoryWindowsUpdatePackage(api.InventoryWindowsUpdatePackage o) {
  buildCounterInventoryWindowsUpdatePackage++;
  if (buildCounterInventoryWindowsUpdatePackage < 3) {
    checkUnnamed8720(o.categories!);
    unittest.expect(
      o.description!,
      unittest.equals('foo'),
    );
    checkUnnamed8721(o.kbArticleIds!);
    unittest.expect(
      o.lastDeploymentChangeTime!,
      unittest.equals('foo'),
    );
    checkUnnamed8722(o.moreInfoUrls!);
    unittest.expect(
      o.revisionNumber!,
      unittest.equals(42),
    );
...
core.List<api.InstanceOSPoliciesCompliance> buildUnnamed8723() => [
      buildInstanceOSPoliciesCompliance(),
      buildInstanceOSPoliciesCompliance(),
    ];

void checkUnnamed8723(core.List<api.InstanceOSPoliciesCompliance> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListInstanceOSPoliciesCompliancesResponse
  ...
  if (buildCounterListInstanceOSPoliciesCompliancesResponse < 3) {
    o.instanceOsPoliciesCompliances = buildUnnamed8723();
    o.nextPageToken = 'foo';
  }
  buildCounterListInstanceOSPoliciesCompliancesResponse--;
  return o;
...
void checkListInstanceOSPoliciesCompliancesResponse(
  ...
  buildCounterListInstanceOSPoliciesCompliancesResponse++;
  if (buildCounterListInstanceOSPoliciesCompliancesResponse < 3) {
    checkUnnamed8723(o.instanceOsPoliciesCompliances!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.Inventory> buildUnnamed8724() => [
      buildInventory(),
      buildInventory(),
    ];

void checkUnnamed8724(core.List<api.Inventory> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInventory(o[0]);
  checkInventory(o[1]);
}
...
api.ListInventoriesResponse buildListInventoriesResponse() {
  ...
  if (buildCounterListInventoriesResponse < 3) {
    o.inventories = buildUnnamed8724();
    o.nextPageToken = 'foo';
  }
  buildCounterListInventoriesResponse--;
  return o;
...
void checkListInventoriesResponse(api.ListInventoriesResponse o) {
  buildCounterListInventoriesResponse++;
  if (buildCounterListInventoriesResponse < 3) {
    checkUnnamed8724(o.inventories!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.OSPolicyAssignment> buildUnnamed8725() => [
      buildOSPolicyAssignment(),
      buildOSPolicyAssignment(),
    ];

void checkUnnamed8725(core.List<api.OSPolicyAssignment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListOSPolicyAssignmentRevisionsResponse
  ...
  if (buildCounterListOSPolicyAssignmentRevisionsResponse < 3) {
    o.nextPageToken = 'foo';
    o.osPolicyAssignments = buildUnnamed8725();
  }
  buildCounterListOSPolicyAssignmentRevisionsResponse--;
  return o;
}
...
void checkListOSPolicyAssignmentRevisionsResponse(
  ...
  if (buildCounterListOSPolicyAssignmentRevisionsResponse < 3) {
    ...
    checkUnnamed8725(o.osPolicyAssignments!);
  }
  buildCounterListOSPolicyAssignmentRevisionsResponse--;
}

core.List<api.OSPolicyAssignment> buildUnnamed8726() => [
      buildOSPolicyAssignment(),
      buildOSPolicyAssignment(),
    ];

void checkUnnamed8726(core.List<api.OSPolicyAssignment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOSPolicyAssignment(o[0]);
  checkOSPolicyAssignment(o[1]);
}
...
api.ListOSPolicyAssignmentsResponse buildListOSPolicyAssignmentsResponse() {
  ...
  if (buildCounterListOSPolicyAssignmentsResponse < 3) {
    o.nextPageToken = 'foo';
    o.osPolicyAssignments = buildUnnamed8726();
  }
  buildCounterListOSPolicyAssignmentsResponse--;
  return o;
}
...
void checkListOSPolicyAssignmentsResponse(
  ...
  if (buildCounterListOSPolicyAssignmentsResponse < 3) {
    ...
    checkUnnamed8726(o.osPolicyAssignments!);
  }
  buildCounterListOSPolicyAssignmentsResponse--;
}

core.List<api.VulnerabilityReport> buildUnnamed8727() => [
      buildVulnerabilityReport(),
      buildVulnerabilityReport(),
    ];

void checkUnnamed8727(core.List<api.VulnerabilityReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.ListVulnerabilityReportsResponse buildListVulnerabilityReportsResponse() {
  ...
  if (buildCounterListVulnerabilityReportsResponse < 3) {
    o.nextPageToken = 'foo';
    o.vulnerabilityReports = buildUnnamed8727();
  }
  buildCounterListVulnerabilityReportsResponse--;
  return o;
}
...
void checkListVulnerabilityReportsResponse(
  ...
  if (buildCounterListVulnerabilityReportsResponse < 3) {
    ...
    checkUnnamed8727(o.vulnerabilityReports!);
  }
  buildCounterListVulnerabilityReportsResponse--;
}

core.List<api.OSPolicyResourceGroup> buildUnnamed8728() => [
      buildOSPolicyResourceGroup(),
      buildOSPolicyResourceGroup(),
    ];

void checkUnnamed8728(core.List<api.OSPolicyResourceGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.OSPolicy buildOSPolicy() {
  ...
  if (buildCounterOSPolicy < 3) {
    ...
    o.id = 'foo';
    o.mode = 'foo';
    o.resourceGroups = buildUnnamed8728();
  }
  buildCounterOSPolicy--;
  return o;
}
...
void checkOSPolicy(api.OSPolicy o) {
  ...
  if (buildCounterOSPolicy < 3) {
    ...
    checkUnnamed8728(o.resourceGroups!);
  }
  buildCounterOSPolicy--;
}

core.List<api.OSPolicy> buildUnnamed8729() => [
      buildOSPolicy(),
      buildOSPolicy(),
    ];

void checkUnnamed8729(core.List<api.OSPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOSPolicy(o[0]);
  checkOSPolicy(o[1]);
}
...
core.List<api.OSPolicyAssignmentLabelSet> buildUnnamed8730() => [
      buildOSPolicyAssignmentLabelSet(),
      buildOSPolicyAssignmentLabelSet(),
    ];

void checkUnnamed8730(core.List<api.OSPolicyAssignmentLabelSet> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOSPolicyAssignmentLabelSet(o[0]);
  checkOSPolicyAssignmentLabelSet(o[1]);
}

core.List<api.OSPolicyAssignmentLabelSet> buildUnnamed8731() => [
      buildOSPolicyAssignmentLabelSet(),
      buildOSPolicyAssignmentLabelSet(),
    ];

void checkUnnamed8731(core.List<api.OSPolicyAssignmentLabelSet> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOSPolicyAssignmentLabelSet(o[0]);
  checkOSPolicyAssignmentLabelSet(o[1]);
}
...
api.OSPolicyAssignmentInstanceFilter buildOSPolicyAssignmentInstanceFilter() {
  ...
  if (buildCounterOSPolicyAssignmentInstanceFilter < 3) {
    o.all = true;
    o.exclusionLabels = buildUnnamed8730();
    o.inclusionLabels = buildUnnamed8731();
    o.osShortNames = buildUnnamed8732();
  }
  buildCounterOSPolicyAssignmentInstanceFilter--;
  return o;
}
...
void checkOSPolicyAssignmentInstanceFilter(
  ...
  if (buildCounterOSPolicyAssignmentInstanceFilter < 3) {
    ...
    checkUnnamed8730(o.exclusionLabels!);
    checkUnnamed8731(o.inclusionLabels!);
    checkUnnamed8732(o.osShortNames!);
  }
  buildCounterOSPolicyAssignmentInstanceFilter--;
}
...
core.List<api.OSPolicyResourceConfigStep> buildUnnamed8734() => [
      buildOSPolicyResourceConfigStep(),
      buildOSPolicyResourceConfigStep(),
    ];

void checkUnnamed8734(core.List<api.OSPolicyResourceConfigStep> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.OSPolicyResourceCompliance buildOSPolicyResourceCompliance() {
  ...
  if (buildCounterOSPolicyResourceCompliance < 3) {
    o.configSteps = buildUnnamed8734();
...
void checkOSPolicyResourceCompliance(api.OSPolicyResourceCompliance o) {
  buildCounterOSPolicyResourceCompliance++;
  if (buildCounterOSPolicyResourceCompliance < 3) {
    checkUnnamed8734(o.configSteps!);
...
core.List<api.OSPolicyResource> buildUnnamed8736() => [
      buildOSPolicyResource(),
      buildOSPolicyResource(),
    ];

void checkUnnamed8736(core.List<api.OSPolicyResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.Operation buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed8741();
    o.name = 'foo';
    o.response = buildUnnamed8742();
  }
  buildCounterOperation--;
  return o;
}
...
void checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error!);
    checkUnnamed8741(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed8742(o.response!);
  }
  buildCounterOperation--;
}
...
core.List<core.Map<core.String, core.Object>> buildUnnamed8744() => [
      buildUnnamed8743(),
      buildUnnamed8743(),
    ];

void checkUnnamed8744(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed8743(o[0]);
  checkUnnamed8743(o[1]);
}
...
core.List<api.VulnerabilityReportVulnerability> buildUnnamed8745() => [
      buildVulnerabilityReportVulnerability(),
      buildVulnerabilityReportVulnerability(),
    ];

void checkUnnamed8745(core.List<api.VulnerabilityReportVulnerability> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.VulnerabilityReport buildVulnerabilityReport() {
  ...
  if (buildCounterVulnerabilityReport < 3) {
    o.name = 'foo';
    o.updateTime = 'foo';
    o.vulnerabilities = buildUnnamed8745();
  }
  buildCounterVulnerabilityReport--;
  return o;
}
...
void checkVulnerabilityReport(api.VulnerabilityReport o) {
  ...
  if (buildCounterVulnerabilityReport < 3) {
    ...
    checkUnnamed8745(o.vulnerabilities!);
  }
  buildCounterVulnerabilityReport--;
}
...
api.VulnerabilityReportVulnerability buildVulnerabilityReportVulnerability() {
  ...
  if (buildCounterVulnerabilityReportVulnerability < 3) {
    o.availableInventoryItemIds = buildUnnamed8746();
    o.createTime = 'foo';
    o.details = buildVulnerabilityReportVulnerabilityDetails();
    o.installedInventoryItemIds = buildUnnamed8747();
    o.updateTime = 'foo';
  }
  buildCounterVulnerabilityReportVulnerability--;
  return o;
...
void checkVulnerabilityReportVulnerability(
  ...
  buildCounterVulnerabilityReportVulnerability++;
  if (buildCounterVulnerabilityReportVulnerability < 3) {
    checkUnnamed8746(o.availableInventoryItemIds!);
    unittest.expect(
      o.createTime!,
      unittest.equals('foo'),
    );
    checkVulnerabilityReportVulnerabilityDetails(o.details!);
    checkUnnamed8747(o.installedInventoryItemIds!);
    unittest.expect(
      o.updateTime!,
      unittest.equals('foo'),
    );
