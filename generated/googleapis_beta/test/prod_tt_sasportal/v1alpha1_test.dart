...
core.List<core.String> buildUnnamed8114() => [
      'foo',
      'foo',
    ];

void checkUnnamed8114(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(
    o[0],
    unittest.equals('foo'),
...
api.SasPortalDeployment buildSasPortalDeployment() {
  ...
  if (buildCounterSasPortalDeployment < 3) {
    o.allowedBillingModes = buildUnnamed8115();
    o.defaultBillingMode = 'foo';
    o.displayName = 'foo';
    o.frns = buildUnnamed8116();
    o.name = 'foo';
    o.sasUserIds = buildUnnamed8117();
  }
  buildCounterSasPortalDeployment--;
  return o;
}
...
void checkSasPortalDeployment(api.SasPortalDeployment o) {
  buildCounterSasPortalDeployment++;
  if (buildCounterSasPortalDeployment < 3) {
    checkUnnamed8115(o.allowedBillingModes!);
    unittest.expect(
    ...
    checkUnnamed8116(o.frns!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed8117(o.sasUserIds!);
  }
  buildCounterSasPortalDeployment--;
}

core.List<api.SasPortalChannelWithScore> buildUnnamed8118() => [
      buildSasPortalChannelWithScore(),
      buildSasPortalChannelWithScore(),
    ];

void checkUnnamed8118(core.List<api.SasPortalChannelWithScore> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSasPortalChannelWithScore(o[0]);
  checkSasPortalChannelWithScore(o[1]);
}

core.List<api.SasPortalFrequencyRange> buildUnnamed8119() => [
      buildSasPortalFrequencyRange(),
      buildSasPortalFrequencyRange(),
    ];

void checkUnnamed8119(core.List<api.SasPortalFrequencyRange> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSasPortalFrequencyRange(o[0]);
  checkSasPortalFrequencyRange(o[1]);
}

core.List<api.SasPortalDeviceGrant> buildUnnamed8120() => [
      buildSasPortalDeviceGrant(),
      buildSasPortalDeviceGrant(),
    ];

void checkUnnamed8120(core.List<api.SasPortalDeviceGrant> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SasPortalDevice buildSasPortalDevice() {
  ...
  if (buildCounterSasPortalDevice < 3) {
    ...
    o.currentChannels = buildUnnamed8118();
    o.deviceMetadata = buildSasPortalDeviceMetadata();
    o.displayName = 'foo';
    o.fccId = 'foo';
    o.grantRangeAllowlists = buildUnnamed8119();
    o.grants = buildUnnamed8120();
    o.name = 'foo';
...
void checkSasPortalDevice(api.SasPortalDevice o) {
  ...
  if (buildCounterSasPortalDevice < 3) {
    ...
    checkUnnamed8118(o.currentChannels!);
    ...
    checkUnnamed8119(o.grantRangeAllowlists!);
    checkUnnamed8120(o.grants!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
...
api.SasPortalDeviceConfig buildSasPortalDeviceConfig() {
  ...
  if (buildCounterSasPortalDeviceConfig < 3) {
    ...
    o.isSigned = true;
    o.measurementCapabilities = buildUnnamed8121();
...
void checkSasPortalDeviceConfig(api.SasPortalDeviceConfig o) {
  ...
  if (buildCounterSasPortalDeviceConfig < 3) {
    ...
    checkUnnamed8121(o.measurementCapabilities!);
...
core.List<api.SasPortalDpaMoveList> buildUnnamed8122() => [
      buildSasPortalDpaMoveList(),
      buildSasPortalDpaMoveList(),
    ];

void checkUnnamed8122(core.List<api.SasPortalDpaMoveList> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SasPortalDeviceGrant buildSasPortalDeviceGrant() {
  ...
  if (buildCounterSasPortalDeviceGrant < 3) {
    ...
    o.grantId = 'foo';
    o.maxEirp = 42.0;
    o.moveList = buildUnnamed8122();
    o.state = 'foo';
    o.suspensionReason = buildUnnamed8123();
  }
  buildCounterSasPortalDeviceGrant--;
  return o;
}
...
void checkSasPortalDeviceGrant(api.SasPortalDeviceGrant o) {
  ...
  if (buildCounterSasPortalDeviceGrant < 3) {
    ...
    checkUnnamed8122(o.moveList!);
    unittest.expect(
      o.state!,
      unittest.equals('foo'),
    );
    checkUnnamed8123(o.suspensionReason!);
  }
  buildCounterSasPortalDeviceGrant--;
}
...
core.List<api.SasPortalCustomer> buildUnnamed8124() => [
      buildSasPortalCustomer(),
      buildSasPortalCustomer(),
    ];

void checkUnnamed8124(core.List<api.SasPortalCustomer> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.SasPortalDeployment> buildUnnamed8125() => [
      buildSasPortalDeployment(),
      buildSasPortalDeployment(),
    ];

void checkUnnamed8125(core.List<api.SasPortalDeployment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SasPortalListDeploymentsResponse buildSasPortalListDeploymentsResponse() {
  ...
  if (buildCounterSasPortalListDeploymentsResponse < 3) {
    o.deployments = buildUnnamed8125();
    o.nextPageToken = 'foo';
  }
  buildCounterSasPortalListDeploymentsResponse--;
  return o;
...
void checkSasPortalListDeploymentsResponse(
  ...
  buildCounterSasPortalListDeploymentsResponse++;
  if (buildCounterSasPortalListDeploymentsResponse < 3) {
    checkUnnamed8125(o.deployments!);
    unittest.expect(
      o.nextPageToken!,
      unittest.equals('foo'),
    );
...
core.List<api.SasPortalDevice> buildUnnamed8126() => [
      buildSasPortalDevice(),
      buildSasPortalDevice(),
    ];

void checkUnnamed8126(core.List<api.SasPortalDevice> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.SasPortalNode> buildUnnamed8127() => [
      buildSasPortalNode(),
      buildSasPortalNode(),
    ];

void checkUnnamed8127(core.List<api.SasPortalNode> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SasPortalOperation buildSasPortalOperation() {
  ...
  if (buildCounterSasPortalOperation < 3) {
    ...
    o.metadata = buildUnnamed8129();
    o.name = 'foo';
    o.response = buildUnnamed8130();
  }
  buildCounterSasPortalOperation--;
  return o;
}
...
void checkSasPortalOperation(api.SasPortalOperation o) {
  ...
  if (buildCounterSasPortalOperation < 3) {
    ...
    checkUnnamed8129(o.metadata!);
    unittest.expect(
      o.name!,
      unittest.equals('foo'),
    );
    checkUnnamed8130(o.response!);
  }
  buildCounterSasPortalOperation--;
}

core.List<api.SasPortalAssignment> buildUnnamed8131() => [
      buildSasPortalAssignment(),
      buildSasPortalAssignment(),
    ];

void checkUnnamed8131(core.List<api.SasPortalAssignment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
api.SasPortalPolicy buildSasPortalPolicy() {
  ...
  if (buildCounterSasPortalPolicy < 3) {
    o.assignments = buildUnnamed8131();
    o.etag = 'foo';
  }
  buildCounterSasPortalPolicy--;
  return o;
...
void checkSasPortalPolicy(api.SasPortalPolicy o) {
  buildCounterSasPortalPolicy++;
  if (buildCounterSasPortalPolicy < 3) {
    checkUnnamed8131(o.assignments!);
    unittest.expect(
      o.etag!,
      unittest.equals('foo'),
    );
...
core.Map<core.String, core.Object> buildUnnamed8132() => {
      'x': {
        'list': [1, 2, 3],
        'bool': true,
        'string': 'foo'
...
void checkUnnamed8132(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<core.Map<core.String, core.Object>> buildUnnamed8133() => [
      buildUnnamed8132(),
      buildUnnamed8132(),
    ];

void checkUnnamed8133(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed8132(o[0]);
  checkUnnamed8132(o[1]);
}
...
api.SasPortalTestPermissionsRequest buildSasPortalTestPermissionsRequest() {
  ...
  if (buildCounterSasPortalTestPermissionsRequest < 3) {
    o.permissions = buildUnnamed8134();
    o.resource = 'foo';
  }
  buildCounterSasPortalTestPermissionsRequest--;
  return o;
...
void checkSasPortalTestPermissionsRequest(
  ...
  buildCounterSasPortalTestPermissionsRequest++;
  if (buildCounterSasPortalTestPermissionsRequest < 3) {
    checkUnnamed8134(o.permissions!);
    unittest.expect(
      o.resource!,
      unittest.equals('foo'),
    );
...
api.SasPortalTestPermissionsResponse buildSasPortalTestPermissionsResponse() {
  ...
  if (buildCounterSasPortalTestPermissionsResponse < 3) {
    o.permissions = buildUnnamed8135();
  }
  buildCounterSasPortalTestPermissionsResponse--;
  return o;
}
...
void checkSasPortalTestPermissionsResponse(
  ...
  buildCounterSasPortalTestPermissionsResponse++;
  if (buildCounterSasPortalTestPermissionsResponse < 3) {
    checkUnnamed8135(o.permissions!);
  }
  buildCounterSasPortalTestPermissionsResponse--;
}
