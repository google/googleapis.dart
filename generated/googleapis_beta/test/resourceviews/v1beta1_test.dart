...
checkUnnamed4052(core.List<api.ResourceView> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildRegionViewsListResponse() {
  ...
  if (buildCounterRegionViewsListResponse < 3) {
    o.nextPageToken = "foo";
    o.resourceViews = buildUnnamed4052();
  }
  buildCounterRegionViewsListResponse--;
  return o;
}
...
checkRegionViewsListResponse(api.RegionViewsListResponse o) {
  ...
  if (buildCounterRegionViewsListResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4052(o.resourceViews);
  }
  buildCounterRegionViewsListResponse--;
}
...
checkUnnamed4054(core.List<api.Label> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabel(o[0]);
  checkLabel(o[1]);
}
...
buildResourceView() {
  ...
  if (buildCounterResourceView < 3) {
    ...
    o.id = "foo";
    o.kind = "foo";
    o.labels = buildUnnamed4054();
    o.lastModified = "foo";
    o.members = buildUnnamed4055();
    o.name = "foo";
    o.numMembers = 42;
    o.selfLink = "foo";
  }
...
checkResourceView(api.ResourceView o) {
  ...
  if (buildCounterResourceView < 3) {
    ...
    checkUnnamed4054(o.labels);
    unittest.expect(o.lastModified, unittest.equals('foo'));
    checkUnnamed4055(o.members);
...
checkUnnamed4058(core.List<api.ResourceView> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResourceView(o[0]);
  checkResourceView(o[1]);
}
...
buildZoneViewsListResponse() {
  ...
  if (buildCounterZoneViewsListResponse < 3) {
    o.nextPageToken = "foo";
    o.resourceViews = buildUnnamed4058();
  }
  buildCounterZoneViewsListResponse--;
  return o;
}
...
checkZoneViewsListResponse(api.ZoneViewsListResponse o) {
  ...
  if (buildCounterZoneViewsListResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4058(o.resourceViews);
  }
  buildCounterZoneViewsListResponse--;
}
