...
checkUnnamed2724(core.List<api.ResourceView> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildRegionViewsListResponse() {
  ...
  if (buildCounterRegionViewsListResponse < 3) {
    o.nextPageToken = "foo";
    o.resourceViews = buildUnnamed2724();
  }
  buildCounterRegionViewsListResponse--;
  return o;
}
...
checkRegionViewsListResponse(api.RegionViewsListResponse o) {
  ...
  if (buildCounterRegionViewsListResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed2724(o.resourceViews);
  }
  buildCounterRegionViewsListResponse--;
}
...
checkUnnamed2726(core.List<api.Label> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabel(o[0]);
  checkLabel(o[1]);
}
...
buildResourceView() {
  ...
  if (buildCounterResourceView < 3) {
    ...
    o.id = "foo";
    o.kind = "foo";
    o.labels = buildUnnamed2726();
    o.lastModified = "foo";
    o.members = buildUnnamed2727();
    o.name = "foo";
    o.numMembers = 42;
    o.selfLink = "foo";
  }
...
checkResourceView(api.ResourceView o) {
  ...
  if (buildCounterResourceView < 3) {
    ...
    checkUnnamed2726(o.labels);
    unittest.expect(o.lastModified, unittest.equals('foo'));
    checkUnnamed2727(o.members);
...
checkUnnamed2730(core.List<api.ResourceView> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResourceView(o[0]);
  checkResourceView(o[1]);
}
...
buildZoneViewsListResponse() {
  ...
  if (buildCounterZoneViewsListResponse < 3) {
    o.nextPageToken = "foo";
    o.resourceViews = buildUnnamed2730();
  }
  buildCounterZoneViewsListResponse--;
  return o;
}
...
checkZoneViewsListResponse(api.ZoneViewsListResponse o) {
  ...
  if (buildCounterZoneViewsListResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed2730(o.resourceViews);
  }
  buildCounterZoneViewsListResponse--;
}
