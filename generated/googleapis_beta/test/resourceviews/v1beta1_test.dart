...
checkUnnamed3081(core.List<api.ResourceView> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildRegionViewsListResponse() {
  ...
  if (buildCounterRegionViewsListResponse < 3) {
    o.nextPageToken = "foo";
    o.resourceViews = buildUnnamed3081();
  }
  buildCounterRegionViewsListResponse--;
  return o;
}
...
checkRegionViewsListResponse(api.RegionViewsListResponse o) {
  ...
  if (buildCounterRegionViewsListResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed3081(o.resourceViews);
  }
  buildCounterRegionViewsListResponse--;
}
...
checkUnnamed3083(core.List<api.Label> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabel(o[0]);
  checkLabel(o[1]);
}
...
buildResourceView() {
  ...
  if (buildCounterResourceView < 3) {
    ...
    o.id = "foo";
    o.kind = "foo";
    o.labels = buildUnnamed3083();
    o.lastModified = "foo";
    o.members = buildUnnamed3084();
    o.name = "foo";
    o.numMembers = 42;
    o.selfLink = "foo";
  }
...
checkResourceView(api.ResourceView o) {
  ...
  if (buildCounterResourceView < 3) {
    ...
    checkUnnamed3083(o.labels);
    unittest.expect(o.lastModified, unittest.equals('foo'));
    checkUnnamed3084(o.members);
...
checkUnnamed3087(core.List<api.ResourceView> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResourceView(o[0]);
  checkResourceView(o[1]);
}
...
buildZoneViewsListResponse() {
  ...
  if (buildCounterZoneViewsListResponse < 3) {
    o.nextPageToken = "foo";
    o.resourceViews = buildUnnamed3087();
  }
  buildCounterZoneViewsListResponse--;
  return o;
}
...
checkZoneViewsListResponse(api.ZoneViewsListResponse o) {
  ...
  if (buildCounterZoneViewsListResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed3087(o.resourceViews);
  }
  buildCounterZoneViewsListResponse--;
}
