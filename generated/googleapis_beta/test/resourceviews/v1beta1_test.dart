...
checkUnnamed3631(core.List<api.ResourceView> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildRegionViewsListResponse() {
  ...
  if (buildCounterRegionViewsListResponse < 3) {
    o.nextPageToken = "foo";
    o.resourceViews = buildUnnamed3631();
  }
  buildCounterRegionViewsListResponse--;
  return o;
}
...
checkRegionViewsListResponse(api.RegionViewsListResponse o) {
  ...
  if (buildCounterRegionViewsListResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed3631(o.resourceViews);
  }
  buildCounterRegionViewsListResponse--;
}
...
checkUnnamed3633(core.List<api.Label> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabel(o[0]);
  checkLabel(o[1]);
}
...
buildResourceView() {
  ...
  if (buildCounterResourceView < 3) {
    ...
    o.id = "foo";
    o.kind = "foo";
    o.labels = buildUnnamed3633();
    o.lastModified = "foo";
    o.members = buildUnnamed3634();
    o.name = "foo";
    o.numMembers = 42;
    o.selfLink = "foo";
  }
...
checkResourceView(api.ResourceView o) {
  ...
  if (buildCounterResourceView < 3) {
    ...
    checkUnnamed3633(o.labels);
    unittest.expect(o.lastModified, unittest.equals('foo'));
    checkUnnamed3634(o.members);
...
checkUnnamed3637(core.List<api.ResourceView> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResourceView(o[0]);
  checkResourceView(o[1]);
}
...
buildZoneViewsListResponse() {
  ...
  if (buildCounterZoneViewsListResponse < 3) {
    o.nextPageToken = "foo";
    o.resourceViews = buildUnnamed3637();
  }
  buildCounterZoneViewsListResponse--;
  return o;
}
...
checkZoneViewsListResponse(api.ZoneViewsListResponse o) {
  ...
  if (buildCounterZoneViewsListResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed3637(o.resourceViews);
  }
  buildCounterZoneViewsListResponse--;
}
