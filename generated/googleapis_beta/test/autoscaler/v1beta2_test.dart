...
checkUnnamed2758(core.List<api.Autoscaler> o) {
...
checkUnnamed2759(core.List<api.AutoscalingPolicyCustomMetricUtilization> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAutoscalingPolicy() {
  ...
  if (buildCounterAutoscalingPolicy < 3) {
    ...
    o.customMetricUtilizations = buildUnnamed2759();
...
checkAutoscalingPolicy(api.AutoscalingPolicy o) {
  ...
  if (buildCounterAutoscalingPolicy < 3) {
    ...
    checkUnnamed2759(o.customMetricUtilizations);
...
checkUnnamed2760(core.List<api.OperationErrorErrors> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2761(core.List<api.OperationWarningsData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2762(core.List<api.OperationWarnings> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2763(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkUnnamed2764(core.List<api.ZoneMaintenanceWindows> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildZone() {
  ...
  if (buildCounterZone < 3) {
    ...
    o.id = "foo";
    o.kind = "foo";
    o.maintenanceWindows = buildUnnamed2764();
    o.name = "foo";
    o.region = "foo";
    o.selfLink = "foo";
    o.status = "foo";
...
checkZone(api.Zone o) {
  ...
  if (buildCounterZone < 3) {
    ...
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed2764(o.maintenanceWindows);
    unittest.expect(o.name, unittest.equals('foo'));
    unittest.expect(o.region, unittest.equals('foo'));
    unittest.expect(o.selfLink, unittest.equals('foo'));
    unittest.expect(o.status, unittest.equals('foo'));
...
checkUnnamed2765(core.List<api.Zone> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkZone(o[0]);
  checkZone(o[1]);
}
