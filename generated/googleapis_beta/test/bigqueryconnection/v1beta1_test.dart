library googleapis_beta.bigqueryconnection.v1beta1.test;
...
checkUnnamed6336(core.List<api.AuditLogConfig> o) {
...
buildAuditConfig() {
  ...
  if (buildCounterAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed6336();
    o.service = "foo";
  }
  buildCounterAuditConfig--;
  return o;
...
checkAuditConfig(api.AuditConfig o) {
  buildCounterAuditConfig++;
  if (buildCounterAuditConfig < 3) {
    checkUnnamed6336(o.auditLogConfigs);
...
checkUnnamed6337(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAuditLogConfig() {
  ...
  if (buildCounterAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed6337();
    o.logType = "foo";
  }
  buildCounterAuditLogConfig--;
  return o;
...
checkAuditLogConfig(api.AuditLogConfig o) {
  buildCounterAuditLogConfig++;
  if (buildCounterAuditLogConfig < 3) {
    checkUnnamed6337(o.exemptedMembers);
...
buildCloudSqlCredential() {
  var o = new api.CloudSqlCredential();
...
checkCloudSqlCredential(api.CloudSqlCredential o) {
  buildCounterCloudSqlCredential++;
  if (buildCounterCloudSqlCredential < 3) {
...
buildCloudSqlProperties() {
  var o = new api.CloudSqlProperties();
...
checkCloudSqlProperties(api.CloudSqlProperties o) {
  buildCounterCloudSqlProperties++;
  if (buildCounterCloudSqlProperties < 3) {
...
buildConnectionCredential() {
  var o = new api.ConnectionCredential();
...
checkConnectionCredential(api.ConnectionCredential o) {
  buildCounterConnectionCredential++;
  if (buildCounterConnectionCredential < 3) {
    checkCloudSqlCredential(o.cloudSql);
  }
  buildCounterConnectionCredential--;
}
...
checkUnnamed6339(core.List<api.Connection> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkConnection(o[0]);
  checkConnection(o[1]);
}
...
buildListConnectionsResponse() {
  ...
  if (buildCounterListConnectionsResponse < 3) {
    o.connections = buildUnnamed6339();
    o.nextPageToken = "foo";
  }
  buildCounterListConnectionsResponse--;
  return o;
...
checkListConnectionsResponse(api.ListConnectionsResponse o) {
  buildCounterListConnectionsResponse++;
  if (buildCounterListConnectionsResponse < 3) {
    checkUnnamed6339(o.connections);
...
checkUnnamed6340(core.List<api.AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed6341(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.auditConfigs = buildUnnamed6340();
    o.bindings = buildUnnamed6341();
    o.etag = "foo";
    o.version = 42;
  }
  buildCounterPolicy--;
...
checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed6340(o.auditConfigs);
    checkUnnamed6341(o.bindings);
...
main() {
  ...
  unittest.group("obj-schema-CloudSqlCredential", () {
    unittest.test("to-json--from-json", () {
      ...
      var od = new api.CloudSqlCredential.fromJson(o.toJson());
  ...
  unittest.group("obj-schema-CloudSqlProperties", () {
    unittest.test("to-json--from-json", () {
      ...
      var od = new api.CloudSqlProperties.fromJson(o.toJson());
  ...
  unittest.group("obj-schema-ConnectionCredential", () {
    unittest.test("to-json--from-json", () {
      ...
      var od = new api.ConnectionCredential.fromJson(o.toJson());
      checkConnectionCredential(od);
    });
  });
  ...
  unittest.group("resource-ProjectsLocationsConnectionsResourceApi", () {
    unittest.test("method--create", () {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        unittest.expect(
            queryMap["connectionId"].first, unittest.equals(arg_connectionId));
    ...
    unittest.test("method--updateCredential", () {
      ...
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var obj = new api.ConnectionCredential.fromJson(json);
        checkConnectionCredential(obj);
