...
core.List<api.CreateRowRequest> buildUnnamed8504() => [
      buildCreateRowRequest(),
      buildCreateRowRequest(),
    ];

void checkUnnamed8504(core.List<api.CreateRowRequest> o) {
...
void checkBatchDeleteRowsRequest(api.BatchDeleteRowsRequest o) {
  buildCounterBatchDeleteRowsRequest++;
  if (buildCounterBatchDeleteRowsRequest < 3) {
    checkUnnamed8506(o.names!);
  }
  buildCounterBatchDeleteRowsRequest--;
}

core.List<api.UpdateRowRequest> buildUnnamed8507() => [
      buildUpdateRowRequest(),
      buildUpdateRowRequest(),
    ];

void checkUnnamed8507(core.List<api.UpdateRowRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
void checkBatchUpdateRowsResponse(api.BatchUpdateRowsResponse o) {
  buildCounterBatchUpdateRowsResponse++;
  if (buildCounterBatchUpdateRowsResponse < 3) {
    checkUnnamed8508(o.rows!);
  }
  buildCounterBatchUpdateRowsResponse--;
}

core.List<api.LabeledItem> buildUnnamed8509() => [
      buildLabeledItem(),
      buildLabeledItem(),
    ];

void checkUnnamed8509(core.List<api.LabeledItem> o) {
  unittest.expect(o, unittest.hasLength(2));
...
core.List<api.Table> buildUnnamed8511() => [
      buildTable(),
      buildTable(),
    ];

void checkUnnamed8511(core.List<api.Table> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTable(o[0]);
  checkTable(o[1]);
}
...
void checkListTablesResponse(api.ListTablesResponse o) {
  ...
  if (buildCounterListTablesResponse < 3) {
    ...
    checkUnnamed8511(o.tables!);
  }
  buildCounterListTablesResponse--;
}

core.List<api.Workspace> buildUnnamed8512() => [
      buildWorkspace(),
      buildWorkspace(),
    ];

void checkUnnamed8512(core.List<api.Workspace> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWorkspace(o[0]);
  checkWorkspace(o[1]);
}
...
core.List<api.ColumnDescription> buildUnnamed8514() => [
      buildColumnDescription(),
      buildColumnDescription(),
    ];

void checkUnnamed8514(core.List<api.ColumnDescription> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkColumnDescription(o[0]);
  checkColumnDescription(o[1]);
}

core.List<api.SavedView> buildUnnamed8515() => [
      buildSavedView(),
      buildSavedView(),
    ];

void checkUnnamed8515(core.List<api.SavedView> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSavedView(o[0]);
  checkSavedView(o[1]);
}
...
api.Table buildTable() {
  ...
  if (buildCounterTable < 3) {
    o.columns = buildUnnamed8514();
    o.createTime = 'foo';
    o.displayName = 'foo';
    o.name = 'foo';
    o.savedViews = buildUnnamed8515();
    o.updateTime = 'foo';
  }
  buildCounterTable--;
  return o;
...
core.List<api.Table> buildUnnamed8516() => [
      buildTable(),
      buildTable(),
    ];

void checkUnnamed8516(core.List<api.Table> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTable(o[0]);
  checkTable(o[1]);
}
