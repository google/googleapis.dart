...
checkUnnamed5533(core.List<api.ResourceRecordSet> o) {
...
checkUnnamed5534(core.List<api.ResourceRecordSet> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResourceRecordSet(o[0]);
  checkResourceRecordSet(o[1]);
}
...
buildChange() {
  ...
  if (buildCounterChange < 3) {
    o.additions = buildUnnamed5533();
    o.deletions = buildUnnamed5534();
    o.id = "foo";
    o.isServing = true;
    o.kind = "foo";
    o.startTime = "foo";
...
checkChange(api.Change o) {
  buildCounterChange++;
  if (buildCounterChange < 3) {
    checkUnnamed5533(o.additions);
    checkUnnamed5534(o.deletions);
...
checkUnnamed5535(core.List<api.Change> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkChange(o[0]);
  checkChange(o[1]);
}
...
checkUnnamed5536(core.List<api.DnsKeyDigest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5537(core.List<api.DnsKey> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDnsKey(o[0]);
  checkDnsKey(o[1]);
}
...
checkUnnamed5538(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildManagedZone() {
  ...
  if (buildCounterManagedZone < 3) {
    ...
    o.id = "foo";
    o.kind = "foo";
    o.labels = buildUnnamed5538();
    o.name = "foo";
    o.nameServerSet = "foo";
    o.nameServers = buildUnnamed5539();
...
checkUnnamed5540(core.List<api.DnsKeySpec> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDnsKeySpec(o[0]);
  checkDnsKeySpec(o[1]);
}
...
buildManagedZoneDnsSecConfig() {
  ...
  if (buildCounterManagedZoneDnsSecConfig < 3) {
    o.defaultKeySpecs = buildUnnamed5540();
    o.kind = "foo";
    o.nonExistence = "foo";
    o.state = "foo";
  }
...
checkManagedZoneDnsSecConfig(api.ManagedZoneDnsSecConfig o) {
  buildCounterManagedZoneDnsSecConfig++;
  if (buildCounterManagedZoneDnsSecConfig < 3) {
    checkUnnamed5540(o.defaultKeySpecs);
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed5541(core.List<api.ManagedZoneForwardingConfigNameServerTarget> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildManagedZoneForwardingConfig() {
  ...
  if (buildCounterManagedZoneForwardingConfig < 3) {
    o.kind = "foo";
    o.targetNameServers = buildUnnamed5541();
  }
  buildCounterManagedZoneForwardingConfig--;
  return o;
}
...
checkManagedZoneForwardingConfig(api.ManagedZoneForwardingConfig o) {
  ...
  if (buildCounterManagedZoneForwardingConfig < 3) {
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed5541(o.targetNameServers);
  }
  buildCounterManagedZoneForwardingConfig--;
}
...
checkUnnamed5542(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkUnnamed5543(core.List<api.ManagedZonePrivateVisibilityConfigNetwork> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5544(core.List<api.ManagedZone> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildManagedZonesListResponse() {
  ...
  if (buildCounterManagedZonesListResponse < 3) {
    o.header = buildResponseHeader();
    o.kind = "foo";
    o.managedZones = buildUnnamed5544();
    o.nextPageToken = "foo";
  }
  buildCounterManagedZonesListResponse--;
  return o;
...
checkManagedZonesListResponse(api.ManagedZonesListResponse o) {
  ...
  if (buildCounterManagedZonesListResponse < 3) {
    checkResponseHeader(o.header);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed5544(o.managedZones);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterManagedZonesListResponse--;
}
...
checkUnnamed5545(core.List<api.Policy> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPolicy(o[0]);
  checkPolicy(o[1]);
}
...
checkUnnamed5546(core.List<api.PolicyNetwork> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPolicyAlternativeNameServerConfig() {
  ...
  if (buildCounterPolicyAlternativeNameServerConfig < 3) {
    o.kind = "foo";
    o.targetNameServers = buildUnnamed5547();
  }
  buildCounterPolicyAlternativeNameServerConfig--;
  return o;
}
...
checkPolicyAlternativeNameServerConfig(
  ...
  if (buildCounterPolicyAlternativeNameServerConfig < 3) {
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed5547(o.targetNameServers);
  }
  buildCounterPolicyAlternativeNameServerConfig--;
}
...
checkUnnamed5548(core.List<api.DnsKeySpec> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDnsKeySpec(o[0]);
  checkDnsKeySpec(o[1]);
}
...
buildQuota() {
  ...
  if (buildCounterQuota < 3) {
    ...
    o.whitelistedKeySpecs = buildUnnamed5548();
  }
  buildCounterQuota--;
  return o;
}
...
checkQuota(api.Quota o) {
  ...
  if (buildCounterQuota < 3) {
    ...
    checkUnnamed5548(o.whitelistedKeySpecs);
  }
  buildCounterQuota--;
}
...
buildResourceRecordSet() {
  ...
  if (buildCounterResourceRecordSet < 3) {
    o.kind = "foo";
    o.name = "foo";
    o.rrdatas = buildUnnamed5549();
    o.signatureRrdatas = buildUnnamed5550();
    o.ttl = 42;
    o.type = "foo";
  }
  buildCounterResourceRecordSet--;
...
checkResourceRecordSet(api.ResourceRecordSet o) {
  ...
  if (buildCounterResourceRecordSet < 3) {
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed5549(o.rrdatas);
    checkUnnamed5550(o.signatureRrdatas);
...
checkUnnamed5551(core.List<api.ResourceRecordSet> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResourceRecordSet(o[0]);
  checkResourceRecordSet(o[1]);
}
