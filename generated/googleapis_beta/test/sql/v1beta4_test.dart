library googleapis_beta.sql.v1beta4.test;
...
import 'package:googleapis_beta/sql/v1beta4.dart' as api;
...
checkUnnamed6096(core.List<api.BackupRun> o) {
...
checkUnnamed6097(core.List<api.IpMapping> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIpMapping(o[0]);
  checkIpMapping(o[1]);
}
...
buildDatabaseInstance() {
  ...
  if (buildCounterDatabaseInstance < 3) {
    ...
    o.gceZone = "foo";
    o.instanceType = "foo";
    o.ipAddresses = buildUnnamed6097();
    o.ipv6Address = "foo";
    o.kind = "foo";
    ...
    o.replicaNames = buildUnnamed6098();
    o.rootPassword = "foo";
    ...
    o.state = "foo";
    o.suspensionReason = buildUnnamed6099();
  }
  buildCounterDatabaseInstance--;
  return o;
}
...
checkDatabaseInstance(api.DatabaseInstance o) {
  ...
  if (buildCounterDatabaseInstance < 3) {
    ...
    checkUnnamed6097(o.ipAddresses);
    ...
    checkUnnamed6098(o.replicaNames);
    ...
    checkUnnamed6099(o.suspensionReason);
  }
  buildCounterDatabaseInstance--;
}
...
checkUnnamed6100(core.List<api.Database> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDatabase(o[0]);
  checkDatabase(o[1]);
}
...
checkUnnamed6102(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
checkUnnamed6103(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
checkUnnamed6105(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
buildFlag() {
  ...
  if (buildCounterFlag < 3) {
    o.allowedIntValues = buildUnnamed6103();
    o.allowedStringValues = buildUnnamed6104();
    o.appliesTo = buildUnnamed6105();
    o.inBeta = true;
    o.kind = "foo";
    o.maxValue = "foo";
    o.minValue = "foo";
...
checkFlag(api.Flag o) {
  buildCounterFlag++;
  if (buildCounterFlag < 3) {
    checkUnnamed6103(o.allowedIntValues);
    checkUnnamed6104(o.allowedStringValues);
    checkUnnamed6105(o.appliesTo);
...
checkUnnamed6106(core.List<api.Flag> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFlag(o[0]);
  checkFlag(o[1]);
}
...
checkUnnamed6107(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
checkUnnamed6108(core.List<api.DatabaseInstance> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed6109(core.List<api.ApiWarning> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApiWarning(o[0]);
  checkApiWarning(o[1]);
}
...
buildInstancesListResponse() {
  ...
  if (buildCounterInstancesListResponse < 3) {
    o.items = buildUnnamed6108();
    o.kind = "foo";
    o.nextPageToken = "foo";
    o.warnings = buildUnnamed6109();
  }
  buildCounterInstancesListResponse--;
  return o;
}
...
checkInstancesListResponse(api.InstancesListResponse o) {
  buildCounterInstancesListResponse++;
  if (buildCounterInstancesListResponse < 3) {
    checkUnnamed6108(o.items);
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed6109(o.warnings);
  }
  buildCounterInstancesListResponse--;
}
...
checkUnnamed6110(core.List<api.SslCert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSslCert(o[0]);
  checkSslCert(o[1]);
}
...
checkUnnamed6111(core.List<api.AclEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAclEntry(o[0]);
  checkAclEntry(o[1]);
}
...
buildIpConfiguration() {
  ...
  if (buildCounterIpConfiguration < 3) {
    o.authorizedNetworks = buildUnnamed6111();
    o.ipv4Enabled = true;
...
checkIpConfiguration(api.IpConfiguration o) {
  buildCounterIpConfiguration++;
  if (buildCounterIpConfiguration < 3) {
    checkUnnamed6111(o.authorizedNetworks);
...
checkUnnamed6112(core.List<api.OperationError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed6113(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkUnnamed6115(core.List<api.DatabaseFlags> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed6116(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSettings() {
  ...
  if (buildCounterSettings < 3) {
    ...
    o.authorizedGaeApplications = buildUnnamed6114();
    ...
    o.dataDiskType = "foo";
    o.databaseFlags = buildUnnamed6115();
...
checkSettings(api.Settings o) {
  ...
  if (buildCounterSettings < 3) {
    ...
    checkUnnamed6114(o.authorizedGaeApplications);
    ...
    checkUnnamed6115(o.databaseFlags);
...
checkUnnamed6117(core.List<api.SqlExternalSyncSettingError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSqlServerUserDetails() {
  ...
  if (buildCounterSqlServerUserDetails < 3) {
    o.disabled = true;
    o.serverRoles = buildUnnamed6118();
  }
  buildCounterSqlServerUserDetails--;
  return o;
}
...
checkSqlServerUserDetails(api.SqlServerUserDetails o) {
  ...
  if (buildCounterSqlServerUserDetails < 3) {
    ...
    checkUnnamed6118(o.serverRoles);
  }
  buildCounterSqlServerUserDetails--;
}
...
checkUnnamed6119(core.List<api.SslCert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSslCert(o[0]);
  checkSslCert(o[1]);
}
...
checkUnnamed6120(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
checkUnnamed6121(core.List<api.Tier> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTier(o[0]);
  checkTier(o[1]);
}
...
checkUnnamed6122(core.List<api.User> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUser(o[0]);
  checkUser(o[1]);
}
...
main() {
  ...
  unittest.group("resource-BackupRunsResourceApi", () {
    unittest.test("method--delete", () {
      ...
      api.BackupRunsResourceApi res = new api.SqlApi(mock).backupRuns;
      var arg_project = "foo";
  ...
  unittest.group("resource-DatabasesResourceApi", () {
    unittest.test("method--delete", () {
      var mock = new HttpServerMock();
      api.DatabasesResourceApi res = new api.SqlApi(mock).databases;
      var arg_project = "foo";
      var arg_instance = "foo";
  ...
  unittest.group("resource-FlagsResourceApi", () {
    unittest.test("method--list", () {
      var mock = new HttpServerMock();
      api.FlagsResourceApi res = new api.SqlApi(mock).flags;
  ...
  unittest.group("resource-InstancesResourceApi", () {
    unittest.test("method--addServerCa", () {
      var mock = new HttpServerMock();
      api.InstancesResourceApi res = new api.SqlApi(mock).instances;
      var arg_project = "foo";
      var arg_instance = "foo";
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
  ...
  unittest.group("resource-OperationsResourceApi", () {
    unittest.test("method--get", () {
      var mock = new HttpServerMock();
      api.OperationsResourceApi res = new api.SqlApi(mock).operations;
      var arg_project = "foo";
  ...
  unittest.group("resource-ProjectsInstancesResourceApi", () {
    unittest.test("method--rescheduleMaintenance", () {
      ...
      api.ProjectsInstancesResourceApi res =
          new api.SqlApi(mock).projects.instances;
  ...
  unittest.group("resource-SslCertsResourceApi", () {
    unittest.test("method--createEphemeral", () {
      var mock = new HttpServerMock();
      api.SslCertsResourceApi res = new api.SqlApi(mock).sslCerts;
  ...
  unittest.group("resource-TiersResourceApi", () {
    unittest.test("method--list", () {
      var mock = new HttpServerMock();
      api.TiersResourceApi res = new api.SqlApi(mock).tiers;
      var arg_project = "foo";
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
  ...
  unittest.group("resource-UsersResourceApi", () {
    unittest.test("method--delete", () {
      var mock = new HttpServerMock();
      api.UsersResourceApi res = new api.SqlApi(mock).users;
      var arg_project = "foo";
      var arg_instance = "foo";
      var arg_host = "foo";
      var arg_name = "foo";
