...
checkUnnamed6210(core.List<api.Operation> o) {
...
checkUnnamed6211(core.List<api.SpeechRecognitionResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed6212(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed6213(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed6212();
    o.name = "foo";
    o.response = buildUnnamed6213();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed6212(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed6213(o.response);
  }
  buildCounterOperation--;
}
...
checkUnnamed6214(core.List<api.WordInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWordInfo(o[0]);
  checkWordInfo(o[1]);
}
...
checkUnnamed6215(core.List<api.SpeechRecognitionAlternative> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSpeechRecognitionResult() {
  ...
  if (buildCounterSpeechRecognitionResult < 3) {
    o.alternatives = buildUnnamed6215();
    o.channelTag = 42;
    o.languageCode = "foo";
  }
  buildCounterSpeechRecognitionResult--;
...
checkSpeechRecognitionResult(api.SpeechRecognitionResult o) {
  buildCounterSpeechRecognitionResult++;
  if (buildCounterSpeechRecognitionResult < 3) {
    checkUnnamed6215(o.alternatives);
...
checkUnnamed6216(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed6217() {
  ...
  o.add(buildUnnamed6216());
  o.add(buildUnnamed6216());
  return o;
}

checkUnnamed6217(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed6216(o[0]);
  checkUnnamed6216(o[1]);
}
