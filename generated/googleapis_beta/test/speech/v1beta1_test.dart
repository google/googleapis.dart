...
checkUnnamed4716(core.Map<core.String, core.Object> o) {
...
checkUnnamed4717(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed4716();
    o.name = "foo";
    o.response = buildUnnamed4717();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed4716(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed4717(o.response);
  }
  buildCounterOperation--;
}
...
checkUnnamed4719(core.List<api.SpeechRecognitionAlternative> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSpeechRecognitionResult() {
  ...
  if (buildCounterSpeechRecognitionResult < 3) {
    o.alternatives = buildUnnamed4719();
  }
  buildCounterSpeechRecognitionResult--;
  return o;
}
...
checkSpeechRecognitionResult(api.SpeechRecognitionResult o) {
  buildCounterSpeechRecognitionResult++;
  if (buildCounterSpeechRecognitionResult < 3) {
    checkUnnamed4719(o.alternatives);
  }
  buildCounterSpeechRecognitionResult--;
}
...
checkUnnamed4720(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed4721() {
  ...
  o.add(buildUnnamed4720());
  o.add(buildUnnamed4720());
  return o;
}

checkUnnamed4721(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed4720(o[0]);
  checkUnnamed4720(o[1]);
}
...
checkUnnamed4722(core.List<api.SpeechRecognitionResult> o) {
  unittest.expect(o, unittest.hasLength(2));
