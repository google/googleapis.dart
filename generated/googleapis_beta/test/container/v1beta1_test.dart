...
buildCluster() {
  ...
  if (buildCounterCluster < 3) {
    ...
    o.endpoint = "foo";
    o.instanceGroupUrls = buildUnnamed1636();
...
checkCluster(api.Cluster o) {
  ...
  if (buildCounterCluster < 3) {
    ...
    checkUnnamed1636(o.instanceGroupUrls);
...
checkUnnamed1637(core.List<api.Cluster> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCluster(o[0]);
  checkCluster(o[1]);
}
...
checkUnnamed1639(core.List<api.Cluster> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCluster(o[0]);
  checkCluster(o[1]);
}
...
checkUnnamed1640(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkUnnamed1641(core.List<api.ServiceAccount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildNodeConfig() {
  ...
  if (buildCounterNodeConfig < 3) {
    o.machineType = "foo";
    o.serviceAccounts = buildUnnamed1641();
    o.sourceImage = "foo";
  }
  buildCounterNodeConfig--;
  return o;
...
checkNodeConfig(api.NodeConfig o) {
  ...
  if (buildCounterNodeConfig < 3) {
    ...
    checkUnnamed1641(o.serviceAccounts);
